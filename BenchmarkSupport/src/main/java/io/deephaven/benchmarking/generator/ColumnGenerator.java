...
/**
 * An interface that defines a class which will create Columns for a {@link io.deephaven.benchmarking.BenchmarkTable} including
 * {@link ColumnDefinition} creation and a method to create {@link io.deephaven.db.tables.Table#update(String...)} strings.
 *
...
public interface ColumnGenerator<T> {
    ...
    /**
     * Create a string suitable for use with {@link io.deephaven.db.tables.Table#update(String...)} calls
     * to generate data.
     *
