 ...
 * pauses are a dominant cause of safepoint pauses, but there are other triggers like: <ol>
 * <li>Deoptimization</li>
 * <li>Biased lock revocation</li>
 * <li>Thread dump</li>
 * <li>Heap inspection</li>
 * <li>Class redefinition</li> </ol> And others; you can see a full list <a href=
