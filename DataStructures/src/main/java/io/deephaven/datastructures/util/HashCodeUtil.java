        ...
        for (int i = 0; i < values.length; i++) {
            if (values[i] == null) {
                ...
                if (type == String.class) {
                    ...
                    hash = ((Integer) values[i]).intValue();
                } else if (type == Double.class) {
                    double val = ((Double) values[i]).doubleValue();
                    ...
                    long t = ((Long) values[i]).longValue();
                    hash = (int) (t ^ (t >>> 32));
                } else if (type == Date.class) {
                    long t = ((Date) values[i]).getTime();
                    hash = (int) (t ^ (t >>> 32));
                } else if (type == Byte.class) {
                    hash = ((Byte) values[i]).byteValue();
                } else if (type == Boolean.class) {
                    hash = ((Boolean)values[i]).hashCode();   //the hashcode should be fine in this case
                } else if (type.isEnum()){
