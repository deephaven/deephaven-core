...
public class DynamicDelayedLogEntryUnsafePoolImpl extends ThreadSafeLenientFixedSizePool<LogEntry> implements LogEntryPool {

    public DynamicDelayedLogEntryUnsafePoolImpl(String name, int entryCount) {
        super(name, entryCount,
                new Function.Nullary<LogEntry>() {
                    public LogEntry call() { return new DelayedLogEntryUnsafeImpl(); }
                }, null);
    }
