...
/**
 * Class for logger utilities for internal Logger usage. Not named LoggerUtil or LoggerUtils to avoid confusion with those
 * existing classes.
 */
class InternalLoggerUtil {
     ...
     */
    static void writeEntryToStream(final LogEntry entry, final OutputStream outputStream, final LogSink.Interceptor[] interceptors) throws IOException {
