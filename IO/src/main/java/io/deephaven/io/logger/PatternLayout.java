 ...
 * {@link org.apache.log4j.helpers.PatternParser} that creates a customized
 * {@link PatternConverter} that is very efficient for dates in our
 * preferred format.
 */
            ...
            if (loggingEvent.timeStamp!=m_nLastTimestamp) {
                ...
                if ((loggingEvent.timeStamp-nMilli)!=m_nLastTimestampNoMillis) {
                    ...
                    switch (m_calendar.get(Calendar.MONTH)) {
                        case Calendar.JANUARY:   m_buffer[0] = 'J'; m_buffer[1] = 'a'; m_buffer[2] = 'n'; break;
                        case Calendar.FEBRUARY:  m_buffer[0] = 'F'; m_buffer[1] = 'e'; m_buffer[2] = 'b'; break;
                        case Calendar.MARCH:     m_buffer[0] = 'M'; m_buffer[1] = 'a'; m_buffer[2] = 'r'; break;
                        case Calendar.APRIL:     m_buffer[0] = 'A'; m_buffer[1] = 'p'; m_buffer[2] = 'r'; break;
                        case Calendar.MAY:       m_buffer[0] = 'M'; m_buffer[1] = 'a'; m_buffer[2] = 'y'; break;
                        case Calendar.JUNE:      m_buffer[0] = 'J'; m_buffer[1] = 'u'; m_buffer[2] = 'n'; break;
                        case Calendar.JULY:      m_buffer[0] = 'J'; m_buffer[1] = 'u'; m_buffer[2] = 'l'; break;
                        case Calendar.AUGUST:    m_buffer[0] = 'A'; m_buffer[1] = 'u'; m_buffer[2] = 'g'; break;
                        case Calendar.SEPTEMBER: m_buffer[0] = 'S'; m_buffer[1] = 'e'; m_buffer[2] = 'p'; break;
                        case Calendar.OCTOBER:   m_buffer[0] = 'O'; m_buffer[1] = 'c'; m_buffer[2] = 't'; break;
                        case Calendar.NOVEMBER:  m_buffer[0] = 'N'; m_buffer[1] = 'o'; m_buffer[2] = 'v'; break;
                        case Calendar.DECEMBER:  m_buffer[0] = 'D'; m_buffer[1] = 'e'; m_buffer[2] = 'c'; break;
                        default: Assert.statementNeverExecuted(); break;
                    }
        ...
        public void format(byte[] bytes, long timestamp) {
            if (timestamp != m_nLastTimestamp) {
                ...
                if (noMillis != m_nLastTimestampNoMillis) {
                    ...
                    if (lastHour != nHour) {
                        switch (m_calendar.get(Calendar.MONTH)) {
                            case Calendar.JANUARY:   bytes[0] = 'J'; bytes[1] = 'a'; bytes[2] = 'n'; break;
                            case Calendar.FEBRUARY:  bytes[0] = 'F'; bytes[1] = 'e'; bytes[2] = 'b'; break;
                            case Calendar.MARCH:     bytes[0] = 'M'; bytes[1] = 'a'; bytes[2] = 'r'; break;
                            case Calendar.APRIL:     bytes[0] = 'A'; bytes[1] = 'p'; bytes[2] = 'r'; break;
                            case Calendar.MAY:       bytes[0] = 'M'; bytes[1] = 'a'; bytes[2] = 'y'; break;
                            case Calendar.JUNE:      bytes[0] = 'J'; bytes[1] = 'u'; bytes[2] = 'n'; break;
                            case Calendar.JULY:      bytes[0] = 'J'; bytes[1] = 'u'; bytes[2] = 'l'; break;
                            case Calendar.AUGUST:    bytes[0] = 'A'; bytes[1] = 'u'; bytes[2] = 'g'; break;
                            case Calendar.SEPTEMBER: bytes[0] = 'S'; bytes[1] = 'e'; bytes[2] = 'p'; break;
                            case Calendar.OCTOBER:   bytes[0] = 'O'; bytes[1] = 'c'; bytes[2] = 't'; break;
                            case Calendar.NOVEMBER:  bytes[0] = 'N'; bytes[1] = 'o'; bytes[2] = 'v'; break;
                            case Calendar.DECEMBER:  bytes[0] = 'D'; bytes[1] = 'e'; bytes[2] = 'c'; break;
                            default: Assert.statementNeverExecuted(); break;
                        }
                        bytes[3] = ' ';
