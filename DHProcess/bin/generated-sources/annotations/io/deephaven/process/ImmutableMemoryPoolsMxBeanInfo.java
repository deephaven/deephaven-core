...
final class ImmutableMemoryPoolsMxBeanInfo extends MemoryPoolsMxBeanInfo {
  ...
  public boolean equals(Object another) {
    ...
    return another instanceof ImmutableMemoryPoolsMxBeanInfo
        && equalTo(0, (ImmutableMemoryPoolsMxBeanInfo) another);
  }

  private boolean equalTo(int synthetic, ImmutableMemoryPoolsMxBeanInfo another) {
  ...
  public static final class Builder {
    ...
    public final Builder putUsages(String key, MemoryUsageInfo value) {
      this.usages.put(
          ...
          value == null ? Objects.requireNonNull(value, "usages value for key: " + key) : value);
      return this;
    }
    ...
    public final Builder putUsages(Map.Entry<String, ? extends MemoryUsageInfo> entry) {
      ...
      this.usages.put(
          ...
          v == null ? Objects.requireNonNull(v, "usages value for key: " + k) : v);
      return this;
    }
