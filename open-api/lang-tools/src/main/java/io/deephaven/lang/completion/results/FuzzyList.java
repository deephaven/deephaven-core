 ...
 *
 * The constructor takes the pattern String (user input),
 * then you can add-by-string-key any number of objects of type T.
 * The score for each String is used to sort entries which contain source object and string key.
 *
