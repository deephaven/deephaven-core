...
public class TestModelInputSerializerDeserializer extends BaseArrayTestCase {
    ...
    public void testSerializeDeserialize() throws IOException, ClassNotFoundException {
        final String filename = Configuration.getInstance().getTempPath("test")
            + "TestModelInputSerializerDeserializer.ser";
        ...
        final ModelInputDeserializer<Integer> deserializer =
            new ModelInputDeserializer<>(Integer.class, filename);
