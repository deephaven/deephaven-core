...
public class JShapes implements Shape {
    ...
    private static JShapes UP_TRIANGLE = new JShapes(new Polygon(new int[] {0, (int) SIZE / 2, (int) -SIZE / 2},
            new int[] {(int) -SIZE / 2, (int) SIZE / 2, (int) SIZE / 2}, 3));
    private static JShapes DIAMOND = new JShapes(new Polygon(new int[] {0, (int) SIZE / 2, 0, (int) -SIZE / 2},
    ...
    private static JShapes DOWN_TRIANGLE = new JShapes(new Polygon(new int[] {(int) -SIZE / 2, (int) SIZE / 2, 0},
            new int[] {(int) -SIZE / 2, (int) -SIZE / 2, (int) SIZE / 2}, 3));
