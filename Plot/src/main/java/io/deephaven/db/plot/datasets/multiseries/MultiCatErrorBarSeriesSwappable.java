...
import io.deephaven.db.plot.datasets.category.AbstractTableBasedCategoryDataSeries;
import io.deephaven.db.plot.datasets.category.CategoryTableDataSeriesInternal;
import io.deephaven.db.plot.datasets.categoryerrorbar.CategoryErrorBarDataSeriesKernel;
import io.deephaven.db.plot.datasets.categoryerrorbar.CategoryErrorBarDataSeriesInternal;
...
public class MultiCatErrorBarSeriesSwappable extends AbstractSwappableMultiSeries<CategoryErrorBarDataSeriesInternal>{
    ...
    @Override public <COLOR extends io.deephaven.gui.color.Paint> MultiCatErrorBarSeriesSwappable pointColor(final java.util.function.Function<java.lang.Comparable, COLOR> colors, final Object... keys) {
        ...
        chart().figure().registerFigureFunction(new io.deephaven.db.plot.util.functions.FigureImplFunction(f -> f.pointColor(new SelectableDataSetSwappableTable(getSwappableTable()), getX(), newColumn, keys), this));
        return this;
    }
    ...
    @Override public <LABEL> MultiCatErrorBarSeriesSwappable pointLabel(final java.util.function.Function<java.lang.Comparable, LABEL> labels, final Object... keys) {
        ...
        chart().figure().registerFigureFunction(new io.deephaven.db.plot.util.functions.FigureImplFunction(f -> f.pointLabel(new SelectableDataSetSwappableTable(getSwappableTable()), getX(), newColumn, keys), this));
        return this;
    }
    ...
    @Override public MultiCatErrorBarSeriesSwappable pointShape(final java.util.function.Function<java.lang.Comparable, java.lang.String> shapes, final Object... keys) {
        ...
        chart().figure().registerFigureFunction(new io.deephaven.db.plot.util.functions.FigureImplFunction(f -> f.pointShape(new SelectableDataSetSwappableTable(getSwappableTable()), getX(), newColumn, keys), this));
        return this;
    }
    ...
    @Override public <NUMBER extends java.lang.Number> MultiCatErrorBarSeriesSwappable pointSize(final java.util.function.Function<java.lang.Comparable, NUMBER> factors, final Object... keys) {
        ...
        chart().figure().registerFigureFunction(new io.deephaven.db.plot.util.functions.FigureImplFunction(f -> f.pointSize(new SelectableDataSetSwappableTable(getSwappableTable()), getX(), newColumn, keys), this));
        return this;
    }
    ...
    @Override public MultiCatErrorBarSeriesSwappable lineStyle(final io.deephaven.db.plot.LineStyle style, final Object... keys) {
        if(keys == null || keys.length == 0) {
    ...
    @Override public MultiCatErrorBarSeriesSwappable pointColor(final io.deephaven.db.plot.filters.SelectableDataSet sds, final java.lang.String keyColumn, final java.lang.String valueColumn, final Object... keys) {
        if(keys == null || keys.length == 0) {
    ...
    @Override public MultiCatErrorBarSeriesSwappable pointColor(final io.deephaven.db.tables.Table t, final java.lang.String keyColumn, final java.lang.String valueColumn, final Object... keys) {
    ...
    @Override public MultiCatErrorBarSeriesSwappable pointLabel(final io.deephaven.db.plot.filters.SelectableDataSet sds, final java.lang.String keyColumn, final java.lang.String valueColumn, final Object... keys) {
        if(keys == null || keys.length == 0) {
    ...
    @Override public MultiCatErrorBarSeriesSwappable pointLabel(final io.deephaven.db.tables.Table t, final java.lang.String keyColumn, final java.lang.String valueColumn, final Object... keys) {
    final io.deephaven.db.plot.util.tables.TableHandle tHandle = new io.deephaven.db.plot.util.tables.TableHandle(t, keyColumn, valueColumn);
    addTableHandle(tHandle);
        if(keys == null || keys.length == 0) {
    ...
    @Override public MultiCatErrorBarSeriesSwappable pointShape(final io.deephaven.db.plot.filters.SelectableDataSet sds, final java.lang.String keyColumn, final java.lang.String valueColumn, final Object... keys) {
        if(keys == null || keys.length == 0) {
    ...
    @Override public MultiCatErrorBarSeriesSwappable pointShape(final io.deephaven.db.tables.Table t, final java.lang.String keyColumn, final java.lang.String valueColumn, final Object... keys) {
    final io.deephaven.db.plot.util.tables.TableHandle tHandle = new io.deephaven.db.plot.util.tables.TableHandle(t, keyColumn, valueColumn);
    addTableHandle(tHandle);
        if(keys == null || keys.length == 0) {
    ...
    @Override public MultiCatErrorBarSeriesSwappable pointSize(final io.deephaven.db.plot.filters.SelectableDataSet sds, final java.lang.String keyColumn, final java.lang.String valueColumn, final Object... keys) {
        if(keys == null || keys.length == 0) {
    ...
    @Override public MultiCatErrorBarSeriesSwappable pointSize(final io.deephaven.db.tables.Table t, final java.lang.String keyColumn, final java.lang.String valueColumn, final Object... keys) {
    final io.deephaven.db.plot.util.tables.TableHandle tHandle = new io.deephaven.db.plot.util.tables.TableHandle(t, keyColumn, valueColumn);
    addTableHandle(tHandle);
        if(keys == null || keys.length == 0) {
