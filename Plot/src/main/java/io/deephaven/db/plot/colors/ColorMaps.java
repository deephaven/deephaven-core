...
public class ColorMaps implements Serializable {
     ...
     * <p>
     * Values less than or equal to {@code min} return the starting color.
     * Values greater than or equal to {@code max} return the ending color.
     ...
     * @param min        minimum
     * @param max        maximum
     * @return function for mapping double values to colors.  The starting color is blue (#0000FF) and the ending color is yellow (#FFFF00).
     */
     ...
     */
    public static Function<Double, Color> heatMap(final double min, final double max, final Color startColor, final Color endColor) {
     ...
     * @return function for mapping double values to colors
     */
    public static Function<Double, Color> heatMap(final double min, final double max, final Color startColor, final Color endColor, final Color nullColor) {
        return (Function<Double, Color> & Serializable) value -> {
            if (value == null || value == Double.NaN) {
                ...
                return new Color((int) (r1 + pert * (r2 - r1)), (int) (g1 + pert * (g2 - g1)), (int) (b1 + pert * (b2 - b1)));
            }
        };
    }

    /**
     * Maps {@link Range}s of values to specific colors.
     * Values inside a given {@link Range} return the corresponding {@link Paint}.
     * <p>
     * Values not in any of the specified {@link Range} return an out of range color.
     ...
     */
    public static <COLOR extends Paint> Function<Double, Paint> rangeMap(final Map<Range, COLOR> map, final Color outOfRangeColor) {
     ...
     * @return function for mapping double values to colors
     */
    public static <COLOR extends Paint> Function<Double, Paint> rangeMap(final Map<Range, COLOR> map, final Paint outOfRangeColor, final Paint nullColor) {
     ...
     * @return function which returns the color mapped to the first {@link SerializablePredicate} for which the input is true.  Out of range, null, and NaN values return null.
     */
    public static <COLOR extends Paint> Function<Double, Paint> predicateMap(final Map<SerializablePredicate<Double>, COLOR> map) {
     ...
     *
     * @param map             map from {@link SerializablePredicate} to color
     * @param outOfRangeColor color returned when the input satisfies no {@link SerializablePredicate} in the {@code map}
     * @param <COLOR>             type of {@link Paint} in {@code map}
     * @return function which returns the color mapped to the first {@link SerializablePredicate} for which the input is true.  Null and NaN inputs return null.
     */
    public static <COLOR extends Paint> Function<Double, Paint> predicateMap(final Map<SerializablePredicate<Double>, COLOR> map, final Color outOfRangeColor) {
     ...
     * @param <COLOR>         type of {@link Paint} in {@code map}
     * @return function which returns the color mapped to the first {@link SerializablePredicate} for which the input is true
     */
    public static <COLOR extends Paint> Function<Double, Paint> predicateMap(final Map<SerializablePredicate<Double>, COLOR> map, final Paint outOfRangeColor, final Paint nullColor) {
        Require.neqNull(map, "map");
     ...
     * @param <COLOR>         type of {@link Paint} in {@code map}
     * @return function which returns the color mapped to the first {@link Closure} for which the input is true.  Out of range, null, and NaN inputs return null.
     */
     ...
     * @param <COLOR>         type of {@link Paint} in {@code map}
     * @return function which returns the color mapped to the first {@link Closure} for which the input is true.  Null and NaN inputs return null.
     */
    public static <COLOR extends Paint> Function<Double, Paint> closureMap(final Map<Closure<Boolean>, COLOR> map, final Color outOfRangeColor) {
     ...
     */
    public static <COLOR extends Paint> Function<Double, Paint> closureMap(final Map<Closure<Boolean>, COLOR> map, final Paint outOfRangeColor, final Paint nullColor) {
