...
public abstract class AbstractMultiSeries<SERIES extends DataSeriesInternal> extends AbstractSeriesInternal implements MultiSeriesInternal<SERIES>, TableSnapshotSeries {
    ...
    @Override public AbstractMultiSeries<SERIES> lineStyle(final io.deephaven.db.plot.LineStyle style, final Object... keys) {
        throw new PlotUnsupportedOperationException("DataSeries " + this.getClass() + " does not support method lineStyle for arguments [class io.deephaven.db.plot.LineStyle]. If you think this method should work, try placing your keys into an Object array", this);
    }
    ...
    @Override public AbstractMultiSeries<SERIES> pointColor(final io.deephaven.db.plot.filters.SelectableDataSet sds, final java.lang.String keyColumn, final java.lang.String valueColumn, final Object... keys) {
        throw new PlotUnsupportedOperationException("DataSeries " + this.getClass() + " does not support method pointColor for arguments [interface io.deephaven.db.plot.filters.SelectableDataSet, class java.lang.String, class java.lang.String]. If you think this method should work, try placing your keys into an Object array", this);
    }



    @Override public AbstractMultiSeries<SERIES> pointColor(final io.deephaven.db.tables.Table t, final java.lang.String keyColumn, final java.lang.String valueColumn, final Object... keys) {
        throw new PlotUnsupportedOperationException("DataSeries " + this.getClass() + " does not support method pointColor for arguments [interface io.deephaven.db.tables.Table, class java.lang.String, class java.lang.String]. If you think this method should work, try placing your keys into an Object array", this);
    }
    ...
    @Override public AbstractMultiSeries<SERIES> pointLabel(final io.deephaven.db.plot.filters.SelectableDataSet sds, final java.lang.String keyColumn, final java.lang.String valueColumn, final Object... keys) {
        throw new PlotUnsupportedOperationException("DataSeries " + this.getClass() + " does not support method pointLabel for arguments [interface io.deephaven.db.plot.filters.SelectableDataSet, class java.lang.String, class java.lang.String]. If you think this method should work, try placing your keys into an Object array", this);
    }



    @Override public AbstractMultiSeries<SERIES> pointLabel(final io.deephaven.db.tables.Table t, final java.lang.String keyColumn, final java.lang.String valueColumn, final Object... keys) {
        throw new PlotUnsupportedOperationException("DataSeries " + this.getClass() + " does not support method pointLabel for arguments [interface io.deephaven.db.tables.Table, class java.lang.String, class java.lang.String]. If you think this method should work, try placing your keys into an Object array", this);
    }
    ...
    @Override public AbstractMultiSeries<SERIES> pointShape(final io.deephaven.db.plot.filters.SelectableDataSet sds, final java.lang.String keyColumn, final java.lang.String valueColumn, final Object... keys) {
        throw new PlotUnsupportedOperationException("DataSeries " + this.getClass() + " does not support method pointShape for arguments [interface io.deephaven.db.plot.filters.SelectableDataSet, class java.lang.String, class java.lang.String]. If you think this method should work, try placing your keys into an Object array", this);
    }



    @Override public AbstractMultiSeries<SERIES> pointShape(final io.deephaven.db.tables.Table t, final java.lang.String keyColumn, final java.lang.String valueColumn, final Object... keys) {
        throw new PlotUnsupportedOperationException("DataSeries " + this.getClass() + " does not support method pointShape for arguments [interface io.deephaven.db.tables.Table, class java.lang.String, class java.lang.String]. If you think this method should work, try placing your keys into an Object array", this);
    }
    ...
    @Override public AbstractMultiSeries<SERIES> pointSize(final io.deephaven.db.plot.filters.SelectableDataSet sds, final java.lang.String keyColumn, final java.lang.String valueColumn, final Object... keys) {
        throw new PlotUnsupportedOperationException("DataSeries " + this.getClass() + " does not support method pointSize for arguments [interface io.deephaven.db.plot.filters.SelectableDataSet, class java.lang.String, class java.lang.String]. If you think this method should work, try placing your keys into an Object array", this);
    }



    @Override public AbstractMultiSeries<SERIES> pointSize(final io.deephaven.db.tables.Table t, final java.lang.String keyColumn, final java.lang.String valueColumn, final Object... keys) {
        throw new PlotUnsupportedOperationException("DataSeries " + this.getClass() + " does not support method pointSize for arguments [interface io.deephaven.db.tables.Table, class java.lang.String, class java.lang.String]. If you think this method should work, try placing your keys into an Object array", this);
    }
    ...
    @Override public <T extends io.deephaven.gui.color.Paint> AbstractMultiSeries<SERIES> pointColor(final io.deephaven.db.plot.datasets.data.IndexableData<T> colors, final Object... keys) {
        throw new PlotUnsupportedOperationException("DataSeries " + this.getClass() + " does not support method pointColor for arguments [io.deephaven.db.plot.datasets.data.IndexableData<T>]. If you think this method should work, try placing your keys into an Object array", this);
    }



    @Override public AbstractMultiSeries<SERIES> pointColor(final io.deephaven.db.plot.filters.SelectableDataSet sds, final java.lang.String columnName, final Object... keys) {
        throw new PlotUnsupportedOperationException("DataSeries " + this.getClass() + " does not support method pointColor for arguments [interface io.deephaven.db.plot.filters.SelectableDataSet, class java.lang.String]. If you think this method should work, try placing your keys into an Object array", this);
    }



    @Override public AbstractMultiSeries<SERIES> pointColor(final io.deephaven.db.tables.Table t, final java.lang.String columnName, final Object... keys) {
        throw new PlotUnsupportedOperationException("DataSeries " + this.getClass() + " does not support method pointColor for arguments [interface io.deephaven.db.tables.Table, class java.lang.String]. If you think this method should work, try placing your keys into an Object array", this);
    }



    @Override public AbstractMultiSeries<SERIES> pointColorInteger(final io.deephaven.db.plot.datasets.data.IndexableData<java.lang.Integer> colors, final Object... keys) {
        throw new PlotUnsupportedOperationException("DataSeries " + this.getClass() + " does not support method pointColorInteger for arguments [io.deephaven.db.plot.datasets.data.IndexableData<java.lang.Integer>]. If you think this method should work, try placing your keys into an Object array", this);
    }
    ...
    @Override public AbstractMultiSeries<SERIES> pointLabel(final io.deephaven.db.plot.datasets.data.IndexableData<?> labels, final Object... keys) {
        throw new PlotUnsupportedOperationException("DataSeries " + this.getClass() + " does not support method pointLabel for arguments [io.deephaven.db.plot.datasets.data.IndexableData<?>]. If you think this method should work, try placing your keys into an Object array", this);
    }



    @Override public AbstractMultiSeries<SERIES> pointLabel(final io.deephaven.db.plot.filters.SelectableDataSet sds, final java.lang.String columnName, final Object... keys) {
        throw new PlotUnsupportedOperationException("DataSeries " + this.getClass() + " does not support method pointLabel for arguments [interface io.deephaven.db.plot.filters.SelectableDataSet, class java.lang.String]. If you think this method should work, try placing your keys into an Object array", this);
    }



    @Override public AbstractMultiSeries<SERIES> pointLabel(final io.deephaven.db.tables.Table t, final java.lang.String columnName, final Object... keys) {
        throw new PlotUnsupportedOperationException("DataSeries " + this.getClass() + " does not support method pointLabel for arguments [interface io.deephaven.db.tables.Table, class java.lang.String]. If you think this method should work, try placing your keys into an Object array", this);
    }
    ...
    @Override public AbstractMultiSeries<SERIES> pointShape(final io.deephaven.db.plot.datasets.data.IndexableData<java.lang.String> shapes, final Object... keys) {
        throw new PlotUnsupportedOperationException("DataSeries " + this.getClass() + " does not support method pointShape for arguments [io.deephaven.db.plot.datasets.data.IndexableData<java.lang.String>]. If you think this method should work, try placing your keys into an Object array", this);
    }



    @Override public AbstractMultiSeries<SERIES> pointShape(final io.deephaven.db.plot.filters.SelectableDataSet sds, final java.lang.String columnName, final Object... keys) {
        throw new PlotUnsupportedOperationException("DataSeries " + this.getClass() + " does not support method pointShape for arguments [interface io.deephaven.db.plot.filters.SelectableDataSet, class java.lang.String]. If you think this method should work, try placing your keys into an Object array", this);
    }



    @Override public AbstractMultiSeries<SERIES> pointShape(final io.deephaven.db.tables.Table t, final java.lang.String columnName, final Object... keys) {
        throw new PlotUnsupportedOperationException("DataSeries " + this.getClass() + " does not support method pointShape for arguments [interface io.deephaven.db.tables.Table, class java.lang.String]. If you think this method should work, try placing your keys into an Object array", this);
    }
    ...
    @Override public AbstractMultiSeries<SERIES> pointSize(final io.deephaven.db.plot.datasets.data.IndexableData<java.lang.Double> factors, final Object... keys) {
        throw new PlotUnsupportedOperationException("DataSeries " + this.getClass() + " does not support method pointSize for arguments [io.deephaven.db.plot.datasets.data.IndexableData<java.lang.Double>]. If you think this method should work, try placing your keys into an Object array", this);
    }



    @Override public AbstractMultiSeries<SERIES> pointSize(final io.deephaven.db.plot.filters.SelectableDataSet sds, final java.lang.String columnName, final Object... keys) {
        throw new PlotUnsupportedOperationException("DataSeries " + this.getClass() + " does not support method pointSize for arguments [interface io.deephaven.db.plot.filters.SelectableDataSet, class java.lang.String]. If you think this method should work, try placing your keys into an Object array", this);
    }



    @Override public AbstractMultiSeries<SERIES> pointSize(final io.deephaven.db.tables.Table t, final java.lang.String columnName, final Object... keys) {
        throw new PlotUnsupportedOperationException("DataSeries " + this.getClass() + " does not support method pointSize for arguments [interface io.deephaven.db.tables.Table, class java.lang.String]. If you think this method should work, try placing your keys into an Object array", this);
    }
