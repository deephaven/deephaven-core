...
public interface MultiSeries extends Series {
    ...
    MultiSeries lineStyle(final io.deephaven.db.plot.LineStyle style, final Object... keys);
    ...
    MultiSeries pointColor(final io.deephaven.db.plot.filters.SelectableDataSet sds, final java.lang.String keyColumn, final java.lang.String valueColumn, final Object... keys);


    MultiSeries pointColor(final io.deephaven.db.tables.Table t, final java.lang.String keyColumn, final java.lang.String valueColumn, final Object... keys);
    ...
    MultiSeries pointLabel(final io.deephaven.db.plot.filters.SelectableDataSet sds, final java.lang.String keyColumn, final java.lang.String valueColumn, final Object... keys);


    MultiSeries pointLabel(final io.deephaven.db.tables.Table t, final java.lang.String keyColumn, final java.lang.String valueColumn, final Object... keys);
    ...
    MultiSeries pointShape(final io.deephaven.db.plot.filters.SelectableDataSet sds, final java.lang.String keyColumn, final java.lang.String valueColumn, final Object... keys);


    MultiSeries pointShape(final io.deephaven.db.tables.Table t, final java.lang.String keyColumn, final java.lang.String valueColumn, final Object... keys);
    ...
    MultiSeries pointSize(final io.deephaven.db.plot.filters.SelectableDataSet sds, final java.lang.String keyColumn, final java.lang.String valueColumn, final Object... keys);


    MultiSeries pointSize(final io.deephaven.db.tables.Table t, final java.lang.String keyColumn, final java.lang.String valueColumn, final Object... keys);
    ...
    <T extends io.deephaven.gui.color.Paint> MultiSeries pointColor(final io.deephaven.db.plot.datasets.data.IndexableData<T> colors, final Object... keys);


    MultiSeries pointColor(final io.deephaven.db.plot.filters.SelectableDataSet sds, final java.lang.String columnName, final Object... keys);


    MultiSeries pointColor(final io.deephaven.db.tables.Table t, final java.lang.String columnName, final Object... keys);


    MultiSeries pointColorInteger(final io.deephaven.db.plot.datasets.data.IndexableData<java.lang.Integer> colors, final Object... keys);


    MultiSeries pointLabel(final java.lang.Object[] labels, final Object... keys);


    MultiSeries pointLabel(final io.deephaven.db.plot.datasets.data.IndexableData<?> labels, final Object... keys);


    MultiSeries pointLabel(final io.deephaven.db.plot.filters.SelectableDataSet sds, final java.lang.String columnName, final Object... keys);


    MultiSeries pointLabel(final io.deephaven.db.tables.Table t, final java.lang.String columnName, final Object... keys);
    ...
    MultiSeries pointShape(final io.deephaven.db.plot.datasets.data.IndexableData<java.lang.String> shapes, final Object... keys);


    MultiSeries pointShape(final io.deephaven.db.plot.filters.SelectableDataSet sds, final java.lang.String columnName, final Object... keys);


    MultiSeries pointShape(final io.deephaven.db.tables.Table t, final java.lang.String columnName, final Object... keys);
    ...
    MultiSeries pointSize(final io.deephaven.db.plot.datasets.data.IndexableData<java.lang.Double> factors, final Object... keys);


    MultiSeries pointSize(final io.deephaven.db.plot.filters.SelectableDataSet sds, final java.lang.String columnName, final Object... keys);


    MultiSeries pointSize(final io.deephaven.db.tables.Table t, final java.lang.String columnName, final Object... keys);
