...
public interface XYDataSeries extends DataSeries {
     ...
     * @param columnName column in {@code t} containing size scaling factors.  The size data for point i comes from row i.
     * @return this XYDataSeries
     */
     ...
     * default size.  Unspecified points use the default size.
     *
     * @param sds selectable data set (e.g. OneClick filterable table) containing factors to multiply the default size (1) by
     * @param columnName column in {@code sds} containing size scaling factors.  The size data for point i comes from row i.
     * @return this XYDataSeries
     */
     ...
     * Sets the point color.  Unspecified points use the default color.
     *
     * @param colors color palette indices.  The color for data point i comes from index i.  A value of 3 corresponds to the 3rd color from the color pallette.
     * @return this XYDataSeries
     */
