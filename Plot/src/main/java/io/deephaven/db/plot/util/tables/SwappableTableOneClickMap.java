...
public class SwappableTableOneClickMap extends SwappableTableOneClickAbstract {
    ...
    public SwappableTableOneClickMap(final Comparable seriesName, final long updateInterval, final TableMapHandle tableMapHandle, final Function<Table, Table> transform, final String... byColumns) {
        this(seriesName, updateInterval, tableMapHandle, transform, true, byColumns);
    }

    public SwappableTableOneClickMap(final Comparable seriesName, final long updateInterval, final TableMapHandle tableMapHandle, final Function<Table, Table> transform, final boolean requireAllFiltersToDisplay, final String... byColumns) {
