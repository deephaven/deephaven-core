...
public class MultiXYSeries extends AbstractTableMapHandleMultiSeries<XYDataSeriesInternal> {
    ...
    @Override public MultiXYSeries lineStyle(final io.deephaven.db.plot.LineStyle style, final Object... keys) {
        if(keys == null || keys.length == 0) {
    ...
    @Override public <T extends io.deephaven.gui.color.Paint> MultiXYSeries pointColor(final io.deephaven.db.plot.datasets.data.IndexableData<T> colors, final Object... keys) {
        if(keys == null || keys.length == 0) {
    ...
    @Override public MultiXYSeries pointColor(final io.deephaven.db.plot.filters.SelectableDataSet sds, final java.lang.String columnName, final Object... keys) {
        if(keys == null || keys.length == 0) {
    ...
    @Override public MultiXYSeries pointColor(final io.deephaven.db.tables.Table t, final java.lang.String columnName, final Object... keys) {
    ...
    @Override public MultiXYSeries pointColorInteger(final io.deephaven.db.plot.datasets.data.IndexableData<java.lang.Integer> colors, final Object... keys) {
        if(keys == null || keys.length == 0) {
    ...
    @Override public MultiXYSeries pointLabel(final io.deephaven.db.plot.datasets.data.IndexableData<?> labels, final Object... keys) {
        if(keys == null || keys.length == 0) {
    ...
    @Override public MultiXYSeries pointLabel(final io.deephaven.db.plot.filters.SelectableDataSet sds, final java.lang.String columnName, final Object... keys) {
        if(keys == null || keys.length == 0) {
    ...
    @Override public MultiXYSeries pointLabel(final io.deephaven.db.tables.Table t, final java.lang.String columnName, final Object... keys) {
    final io.deephaven.db.plot.util.tables.TableHandle tHandle = new io.deephaven.db.plot.util.tables.TableHandle(t, columnName);
    addTableHandle(tHandle);
        if(keys == null || keys.length == 0) {
    ...
    @Override public MultiXYSeries pointShape(final io.deephaven.db.plot.datasets.data.IndexableData<java.lang.String> shapes, final Object... keys) {
        if(keys == null || keys.length == 0) {
    ...
    @Override public MultiXYSeries pointShape(final io.deephaven.db.plot.filters.SelectableDataSet sds, final java.lang.String columnName, final Object... keys) {
        if(keys == null || keys.length == 0) {
    ...
    @Override public MultiXYSeries pointShape(final io.deephaven.db.tables.Table t, final java.lang.String columnName, final Object... keys) {
    final io.deephaven.db.plot.util.tables.TableHandle tHandle = new io.deephaven.db.plot.util.tables.TableHandle(t, columnName);
    addTableHandle(tHandle);
        if(keys == null || keys.length == 0) {
    ...
    @Override public MultiXYSeries pointSize(final io.deephaven.db.plot.datasets.data.IndexableData<java.lang.Double> factors, final Object... keys) {
        if(keys == null || keys.length == 0) {
    ...
    @Override public MultiXYSeries pointSize(final io.deephaven.db.plot.filters.SelectableDataSet sds, final java.lang.String columnName, final Object... keys) {
        if(keys == null || keys.length == 0) {
    ...
    @Override public MultiXYSeries pointSize(final io.deephaven.db.tables.Table t, final java.lang.String columnName, final Object... keys) {
    final io.deephaven.db.plot.util.tables.TableHandle tHandle = new io.deephaven.db.plot.util.tables.TableHandle(t, columnName);
    addTableHandle(tHandle);
        if(keys == null || keys.length == 0) {
