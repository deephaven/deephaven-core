...
public interface BaseFigure extends Serializable {
     ...
     * @return the new {@link Chart}. The {@link Chart} is placed in the next available grid space,
     *         starting at the upper left hand corner of the grid, going left to right, top to
     *         bottom. If no available space is found in the grid:
     *         <ul>
     *         <li>if this Figure was created with no specified grid size, then the Figure will
     *         resize itself to add the new {@link Chart};</li>
     ...
     * Adds a new {@link Chart} to this figure.
     *
     * @param index index from the Figure's grid to remove. The index starts at 0 in the upper left
     *        hand corner of the grid and increases going left to right, top to bottom. E.g. for a
     *        2x2 Figure, the indices would be [0, 1] [2, 3].
     * @throws RuntimeException if {@code index} is outside this Figure's grid
     * @return the new {@link Chart}. The {@link Chart} is placed at the grid space indicated by the
     *         {@code index}.
     */
     ...
     * @return the new {@link Chart}. The {@link Chart} is placed at the grid space [{@code rowNum},
     *         {@code colNum}.
     */
     ...
     * @throws io.deephaven.base.verify.RequirementFailure saveLocation is null
     */
    default BaseFigure save(String saveLocation, int width, int height, boolean wait,
        long timeoutSeconds) {
        throw new UnsupportedOperationException(getClass() + " does not implement save");
    }
}
