...
public interface BaseFigure extends Serializable {
     ...
     * @return the new {@link Chart}.  The {@link Chart} is placed in the next available grid space, starting at the upper left hand corner of the grid,
     *         going left to right, top to bottom.  If no available space is found in the grid:
     *        <ul>
     *            <li>if this Figure was created with no specified grid size, then the Figure will resize itself to add the new {@link Chart};</li>
     ...
     * Adds a new {@link Chart} to this figure.
     *
     * @param index index from the Figure's grid to remove.  The index starts at 0 in the upper left hand corner of the grid and increases
