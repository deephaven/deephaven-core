...
public class IntervalXYDataSeriesArray extends XYDataSeriesArray implements IntervalXYDataSeriesInternal, TableSnapshotSeries {
    ...
    public IntervalXYDataSeriesArray(final AxesImpl axes, final int id, final Comparable name, @NotNull final TableHandle tableHandle,
    ...
    public IntervalXYDataSeriesArray(final AxesImpl axes, final int id, final Comparable name, @NotNull final SwappableTable swappableTable,
                                     final IndexableNumericData startX, final IndexableNumericData midX, final IndexableNumericData endX,
                                     final IndexableNumericData startY, final IndexableNumericData midY, final IndexableNumericData endY) {
        this(axes, id, name, null, swappableTable, startX, midX, endX, startY, midY, endY);
    }

    private IntervalXYDataSeriesArray(final AxesImpl axes, final int id, final Comparable name, final TableHandle tableHandle, final SwappableTable swappableTable,
                                      final IndexableNumericData startX, final IndexableNumericData midX, final IndexableNumericData endX,
                                      final IndexableNumericData startY, final IndexableNumericData midY, final IndexableNumericData endY) {
     ...
     * <p>
     * {@code startX}, {@code midX}, and {@code endX} at each index
     * define the location of a bar in the chart.
     *
     ...
     *                                                    {@code endX}, {@code startY}, {@code midY},
     *                                                    and {@code endY} must not be null
     * @throws IllegalArgumentException                   {@code startX}, {@code midX}, {@code endX},
     *                                                    {@code startY}, {@code midY}, and {@code endY}
     *                                                    must be the same size
     */
    public IntervalXYDataSeriesArray(final AxesImpl axes, final int id, final Comparable name, final TableHandle tableHandle, final SwappableTable swappableTable,
                                     final IndexableNumericData startX, final IndexableNumericData midX, final IndexableNumericData endX,
                                     final IndexableNumericData startY, final IndexableNumericData midY, final IndexableNumericData endY,
        ...
        ArgumentValidations.assertSameSize(new IndexableNumericData[]{startX, midX, endX, startY, midY, endY}, new String[]{"startX", "midX", "endX", "startY", "midY", "endY"}, getPlotInfo());
    }
    ...
    @Override
    public double getStartX(final int item) { return startX.get(item); }

    @Override
    public double getEndX(final int item) { return endX.get(item); }

    @Override
    public double getStartY(final int item) { return startY.get(item); }

    @Override
    public double getEndY(final int item) { return endY.get(item); }
