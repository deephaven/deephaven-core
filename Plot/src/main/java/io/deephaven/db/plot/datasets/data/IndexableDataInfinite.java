...
/**
 * {@link IndexableData} dataset which ensures no {@link IndexOutOfBoundsException}s are thrown. Instead, null values
 * are returned.
 */
public class IndexableDataInfinite<T> extends IndexableData<T> {
    ...
    /**
     * Creates an IndexableDataInfinite instance, which wraps {@code data} such that out-of-bounds indices return null
     * values.
     *
     */
