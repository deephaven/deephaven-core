...
public class AxisTransformLambda implements AxisTransform, Serializable {
     ...
     */
    public AxisTransformLambda(final DoubleUnaryOperator dataToAxis, final DoubleUnaryOperator axisToData,
    ...
    /**
     * Creates an AxisTransformLambda instance where all dataset values are visible in the plot and the dataset to axis
     * space transform and its inverse are the identity function.
     */
    public AxisTransformLambda() {
        this((DoubleUnaryOperator & Serializable) v -> v, (DoubleUnaryOperator & Serializable) v -> v,
