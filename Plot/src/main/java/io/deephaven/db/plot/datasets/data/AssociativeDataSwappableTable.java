...
/**
 * An {@link AssociativeData} dataset backed by a {@link SwappableTable}.  Table columns hold the keys and
 * associated values.
 *
...
public class AssociativeDataSwappableTable<KEY,VALUE,VALUECOLUMN> extends LiveAssociativeData<KEY,VALUE,VALUECOLUMN> {
     ...
     *
     * Keys are held in the {@code keyColumn} of {@code swappableTable}.
     * Their associated values are held in the {@code valueColumn}.
     *
     ...
     *
     * @throws io.deephaven.base.verify.RequirementFailure {@code swappableTable}, {@code keyColumn},
     ...
     */
    public AssociativeDataSwappableTable(final SwappableTable swappableTable, final String keyColumn, final String valueColumn, final Class<KEY> keyColumnType, final Class<VALUECOLUMN> valueColumnType, final PlotInfo plotInfo) {
        super(plotInfo);
