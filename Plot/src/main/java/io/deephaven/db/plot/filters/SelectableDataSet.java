...
public interface SelectableDataSet<KEY_TYPE,VALUE_TYPE> {
     ...
     *
     * @param chart chart
     * @param tableTransform tableTransform applied to the tables in tableMaps. The purpose of this transform is to track the table definitions for tables inside tableMap
     * @param cols selected columns
     * @return table view on selected subset
     */
    SwappableTable getSwappableTable(final Comparable seriesName, final ChartImpl chart, Function<Table, Table> tableTransform, final String... cols);

    /**
     * Gets the view of the {@link Table} with the selected subset.
     * The table transform is the identity function.
     *
     * @param chart chart
     * @param cols selected columns
     * @return table view on selected subset
     ...
     */
    SelectableDataSet<KEY_TYPE, VALUE_TYPE> transform(@NotNull Object memoKey, @NotNull Function<Table, Table> transformation);
}
