...
public class MultiXYErrorBarSeries extends AbstractTableMapHandleMultiSeries<XYErrorBarDataSeriesInternal> {
     ...
     */
    public MultiXYErrorBarSeries(final AxesImpl axes, final int id, final Comparable name, final TableBackedTableMapHandle tableMapHandle, final String x, final String xLow, final String xHigh, final String y, final String yLow, final String yHigh, final String[] byColumns, final boolean drawXError, final boolean drawYError) {
    ...
    @Override public <T extends io.deephaven.gui.color.Paint> MultiXYErrorBarSeries pointColorByY(final java.util.function.Function<java.lang.Double, T> colors, final Object... keys) {
        ...
        chart().figure().registerFigureFunction(new io.deephaven.db.plot.util.functions.FigureImplFunction(f -> f.pointColor(getTableMapHandle().getTable(), newColumn, keys), this));
        return this;
    }
    ...
    @Override public MultiXYErrorBarSeries lineStyle(final io.deephaven.db.plot.LineStyle style, final Object... keys) {
        if(keys == null || keys.length == 0) {
    ...
    @Override public <T extends io.deephaven.gui.color.Paint> MultiXYErrorBarSeries pointColor(final io.deephaven.db.plot.datasets.data.IndexableData<T> colors, final Object... keys) {
        if(keys == null || keys.length == 0) {
    ...
    @Override public MultiXYErrorBarSeries pointColor(final io.deephaven.db.plot.filters.SelectableDataSet sds, final java.lang.String columnName, final Object... keys) {
        if(keys == null || keys.length == 0) {
    ...
    @Override public MultiXYErrorBarSeries pointColor(final io.deephaven.db.tables.Table t, final java.lang.String columnName, final Object... keys) {
    ...
    @Override public MultiXYErrorBarSeries pointColorInteger(final io.deephaven.db.plot.datasets.data.IndexableData<java.lang.Integer> colors, final Object... keys) {
        if(keys == null || keys.length == 0) {
    ...
    @Override public MultiXYErrorBarSeries pointLabel(final io.deephaven.db.plot.datasets.data.IndexableData<?> labels, final Object... keys) {
        if(keys == null || keys.length == 0) {
    ...
    @Override public MultiXYErrorBarSeries pointLabel(final io.deephaven.db.plot.filters.SelectableDataSet sds, final java.lang.String columnName, final Object... keys) {
        if(keys == null || keys.length == 0) {
    ...
    @Override public MultiXYErrorBarSeries pointLabel(final io.deephaven.db.tables.Table t, final java.lang.String columnName, final Object... keys) {
    final io.deephaven.db.plot.util.tables.TableHandle tHandle = new io.deephaven.db.plot.util.tables.TableHandle(t, columnName);
    addTableHandle(tHandle);
        if(keys == null || keys.length == 0) {
    ...
    @Override public MultiXYErrorBarSeries pointShape(final io.deephaven.db.plot.datasets.data.IndexableData<java.lang.String> shapes, final Object... keys) {
        if(keys == null || keys.length == 0) {
    ...
    @Override public MultiXYErrorBarSeries pointShape(final io.deephaven.db.plot.filters.SelectableDataSet sds, final java.lang.String columnName, final Object... keys) {
        if(keys == null || keys.length == 0) {
    ...
    @Override public MultiXYErrorBarSeries pointShape(final io.deephaven.db.tables.Table t, final java.lang.String columnName, final Object... keys) {
    final io.deephaven.db.plot.util.tables.TableHandle tHandle = new io.deephaven.db.plot.util.tables.TableHandle(t, columnName);
    addTableHandle(tHandle);
        if(keys == null || keys.length == 0) {
    ...
    @Override public MultiXYErrorBarSeries pointSize(final io.deephaven.db.plot.datasets.data.IndexableData<java.lang.Double> factors, final Object... keys) {
        if(keys == null || keys.length == 0) {
    ...
    @Override public MultiXYErrorBarSeries pointSize(final io.deephaven.db.plot.filters.SelectableDataSet sds, final java.lang.String columnName, final Object... keys) {
        if(keys == null || keys.length == 0) {
    ...
    @Override public MultiXYErrorBarSeries pointSize(final io.deephaven.db.tables.Table t, final java.lang.String columnName, final Object... keys) {
    final io.deephaven.db.plot.util.tables.TableHandle tHandle = new io.deephaven.db.plot.util.tables.TableHandle(t, columnName);
    addTableHandle(tHandle);
        if(keys == null || keys.length == 0) {
