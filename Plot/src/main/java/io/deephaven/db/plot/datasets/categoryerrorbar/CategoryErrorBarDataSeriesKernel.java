...
/**
 * The core of the Error Bar Category date series update and indexing.  This is used by the regular category data series to
...
public class CategoryErrorBarDataSeriesKernel {
    ...
    /**
     * Get the index key of the category within the original dataset.  This can be used to enforce a global ordering
     * of a MultiSeries cat plot.
     *
