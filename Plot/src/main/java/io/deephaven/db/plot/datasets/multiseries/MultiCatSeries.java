...
public class MultiCatSeries extends AbstractTableMapHandleMultiSeries<CategoryDataSeriesInternal> {
    ...
    @Override public <COLOR extends io.deephaven.gui.color.Paint> MultiCatSeries pointColor(final groovy.lang.Closure<COLOR> colors, final Object... keys) {
        return pointColor(new io.deephaven.db.plot.util.functions.ClosureFunction<>(colors), keys);
    }
    ...
    @Override public <COLOR extends io.deephaven.gui.color.Paint> MultiCatSeries pointColor(final java.util.function.Function<java.lang.Comparable, COLOR> colors, final Object... keys) {
        ...
        chart().figure().registerFigureFunction(new io.deephaven.db.plot.util.functions.FigureImplFunction(f -> f.pointColor(getTableMapHandle().getTable(), getX(), newColumn, keys), this));
        return this;
    }
    ...
    @Override public <COLOR extends java.lang.Integer> MultiCatSeries pointColorInteger(final groovy.lang.Closure<COLOR> colors, final Object... keys) {
        return pointColorInteger(new io.deephaven.db.plot.util.functions.ClosureFunction<>(colors), keys);
    }
    ...
    @Override public <LABEL> MultiCatSeries pointLabel(final groovy.lang.Closure<LABEL> labels, final Object... keys) {
        return pointLabel(new io.deephaven.db.plot.util.functions.ClosureFunction<>(labels), keys);
    }
    ...
    @Override public <LABEL> MultiCatSeries pointLabel(final java.util.function.Function<java.lang.Comparable, LABEL> labels, final Object... keys) {
        final String newColumn = io.deephaven.db.plot.datasets.ColumnNameConstants.POINT_LABEL + this.hashCode();
        applyFunction(labels, newColumn, getX(), java.lang.Object.class);
        chart().figure().registerFigureFunction(new io.deephaven.db.plot.util.functions.FigureImplFunction(f -> f.pointLabel(getTableMapHandle().getTable(), getX(), newColumn, keys), this));
        return this;
    }
    ...
    @Override public MultiCatSeries pointShape(final groovy.lang.Closure<java.lang.String> shapes, final Object... keys) {
        return pointShape(new io.deephaven.db.plot.util.functions.ClosureFunction<>(shapes), keys);
    }
    ...
    @Override public MultiCatSeries pointShape(final java.util.function.Function<java.lang.Comparable, java.lang.String> shapes, final Object... keys) {
        final String newColumn = io.deephaven.db.plot.datasets.ColumnNameConstants.POINT_SHAPE + this.hashCode();
        applyFunction(shapes, newColumn, getX(), java.lang.String.class);
        chart().figure().registerFigureFunction(new io.deephaven.db.plot.util.functions.FigureImplFunction(f -> f.pointShape(getTableMapHandle().getTable(), getX(), newColumn, keys), this));
        return this;
    }
    ...
    @Override public <NUMBER extends java.lang.Number> MultiCatSeries pointSize(final groovy.lang.Closure<NUMBER> factors, final Object... keys) {
        return pointSize(new io.deephaven.db.plot.util.functions.ClosureFunction<>(factors), keys);
    }
    ...
    @Override public <NUMBER extends java.lang.Number> MultiCatSeries pointSize(final java.util.function.Function<java.lang.Comparable, NUMBER> factors, final Object... keys) {
        final String newColumn = io.deephaven.db.plot.datasets.ColumnNameConstants.POINT_SIZE + this.hashCode();
        applyFunction(factors, newColumn, getX(), java.lang.Number.class);
        chart().figure().registerFigureFunction(new io.deephaven.db.plot.util.functions.FigureImplFunction(f -> f.pointSize(getTableMapHandle().getTable(), getX(), newColumn, keys), this));
        return this;
    }
    ...
    private io.deephaven.db.plot.util.PlotUtils.HashMapWithDefault<String, java.lang.Integer> groupSeriesNameTointMap = new io.deephaven.db.plot.util.PlotUtils.HashMapWithDefault<>();
    public io.deephaven.db.plot.util.PlotUtils.HashMapWithDefault<String, java.lang.Integer> groupSeriesNameTointMap() {
    ...
    @Override public MultiCatSeries lineStyle(final io.deephaven.db.plot.LineStyle style, final Object... keys) {
        if(keys == null || keys.length == 0) {
    ...
    private io.deephaven.db.plot.util.PlotUtils.HashMapWithDefault<String, java.lang.String> piePercentLabelFormatSeriesNameToStringMap = new io.deephaven.db.plot.util.PlotUtils.HashMapWithDefault<>();
    public io.deephaven.db.plot.util.PlotUtils.HashMapWithDefault<String, java.lang.String> piePercentLabelFormatSeriesNameToStringMap() {
    ...
    private io.deephaven.db.plot.util.PlotUtils.HashMapWithDefault<String, java.util.Map> pointColorSeriesNameToMapMap = new io.deephaven.db.plot.util.PlotUtils.HashMapWithDefault<>();
    public io.deephaven.db.plot.util.PlotUtils.HashMapWithDefault<String, java.util.Map> pointColorSeriesNameToMapMap() {
    ...
    private io.deephaven.db.plot.util.PlotUtils.HashMapWithDefault<String, java.lang.Object[]> pointColorSeriesNameToComparableStringMap = new io.deephaven.db.plot.util.PlotUtils.HashMapWithDefault<>();
    public io.deephaven.db.plot.util.PlotUtils.HashMapWithDefault<String, java.lang.Object[]> pointColorSeriesNameToComparableStringMap() {
    ...
    private io.deephaven.db.plot.util.PlotUtils.HashMapWithDefault<String, java.lang.Object[]> pointColorSeriesNameToComparableintMap = new io.deephaven.db.plot.util.PlotUtils.HashMapWithDefault<>();
    public io.deephaven.db.plot.util.PlotUtils.HashMapWithDefault<String, java.lang.Object[]> pointColorSeriesNameToComparableintMap() {
    ...
    private io.deephaven.db.plot.util.PlotUtils.HashMapWithDefault<String, java.lang.Object[]> pointColorSeriesNameToComparablePaintMap = new io.deephaven.db.plot.util.PlotUtils.HashMapWithDefault<>();
    public io.deephaven.db.plot.util.PlotUtils.HashMapWithDefault<String, java.lang.Object[]> pointColorSeriesNameToComparablePaintMap() {
    ...
    private io.deephaven.db.plot.util.PlotUtils.HashMapWithDefault<String, java.lang.Object[]> pointColorSeriesNameToSelectableDataSetStringStringMap = new io.deephaven.db.plot.util.PlotUtils.HashMapWithDefault<>();
    public io.deephaven.db.plot.util.PlotUtils.HashMapWithDefault<String, java.lang.Object[]> pointColorSeriesNameToSelectableDataSetStringStringMap() {
        return pointColorSeriesNameToSelectableDataSetStringStringMap;
    }
    @Override public MultiCatSeries pointColor(final io.deephaven.db.plot.filters.SelectableDataSet sds, final java.lang.String keyColumn, final java.lang.String valueColumn, final Object... keys) {
        if(keys == null || keys.length == 0) {
    ...
    private io.deephaven.db.plot.util.PlotUtils.HashMapWithDefault<String, java.lang.Object[]> pointColorSeriesNameToTableStringStringMap = new io.deephaven.db.plot.util.PlotUtils.HashMapWithDefault<>();
    public io.deephaven.db.plot.util.PlotUtils.HashMapWithDefault<String, java.lang.Object[]> pointColorSeriesNameToTableStringStringMap() {
        return pointColorSeriesNameToTableStringStringMap;
    }
    @Override public MultiCatSeries pointColor(final io.deephaven.db.tables.Table t, final java.lang.String keyColumn, final java.lang.String valueColumn, final Object... keys) {
    final io.deephaven.db.plot.util.tables.TableHandle tHandle = new io.deephaven.db.plot.util.tables.TableHandle(t, keyColumn, valueColumn);
    ...
    private io.deephaven.db.plot.util.PlotUtils.HashMapWithDefault<String, java.util.Map> pointColorByYSeriesNameToMapMap = new io.deephaven.db.plot.util.PlotUtils.HashMapWithDefault<>();
    public io.deephaven.db.plot.util.PlotUtils.HashMapWithDefault<String, java.util.Map> pointColorByYSeriesNameToMapMap() {
    ...
    private io.deephaven.db.plot.util.PlotUtils.HashMapWithDefault<String, java.util.Map> pointColorIntegerSeriesNameToMapMap = new io.deephaven.db.plot.util.PlotUtils.HashMapWithDefault<>();
    public io.deephaven.db.plot.util.PlotUtils.HashMapWithDefault<String, java.util.Map> pointColorIntegerSeriesNameToMapMap() {
    ...
    private io.deephaven.db.plot.util.PlotUtils.HashMapWithDefault<String, java.util.Map> pointLabelSeriesNameToMapMap = new io.deephaven.db.plot.util.PlotUtils.HashMapWithDefault<>();
    public io.deephaven.db.plot.util.PlotUtils.HashMapWithDefault<String, java.util.Map> pointLabelSeriesNameToMapMap() {
    ...
    private io.deephaven.db.plot.util.PlotUtils.HashMapWithDefault<String, java.lang.Object[]> pointLabelSeriesNameToComparableObjectMap = new io.deephaven.db.plot.util.PlotUtils.HashMapWithDefault<>();
    public io.deephaven.db.plot.util.PlotUtils.HashMapWithDefault<String, java.lang.Object[]> pointLabelSeriesNameToComparableObjectMap() {
    ...
    private io.deephaven.db.plot.util.PlotUtils.HashMapWithDefault<String, java.lang.Object[]> pointLabelSeriesNameToSelectableDataSetStringStringMap = new io.deephaven.db.plot.util.PlotUtils.HashMapWithDefault<>();
    public io.deephaven.db.plot.util.PlotUtils.HashMapWithDefault<String, java.lang.Object[]> pointLabelSeriesNameToSelectableDataSetStringStringMap() {
        return pointLabelSeriesNameToSelectableDataSetStringStringMap;
    }
    @Override public MultiCatSeries pointLabel(final io.deephaven.db.plot.filters.SelectableDataSet sds, final java.lang.String keyColumn, final java.lang.String valueColumn, final Object... keys) {
        if(keys == null || keys.length == 0) {
    ...
    private io.deephaven.db.plot.util.PlotUtils.HashMapWithDefault<String, java.lang.Object[]> pointLabelSeriesNameToTableStringStringMap = new io.deephaven.db.plot.util.PlotUtils.HashMapWithDefault<>();
    public io.deephaven.db.plot.util.PlotUtils.HashMapWithDefault<String, java.lang.Object[]> pointLabelSeriesNameToTableStringStringMap() {
        return pointLabelSeriesNameToTableStringStringMap;
    }
    @Override public MultiCatSeries pointLabel(final io.deephaven.db.tables.Table t, final java.lang.String keyColumn, final java.lang.String valueColumn, final Object... keys) {
    final io.deephaven.db.plot.util.tables.TableHandle tHandle = new io.deephaven.db.plot.util.tables.TableHandle(t, keyColumn, valueColumn);
    addTableHandle(tHandle);
        if(keys == null || keys.length == 0) {
    ...
    private io.deephaven.db.plot.util.PlotUtils.HashMapWithDefault<String, java.util.Map> pointShapeSeriesNameToMapMap = new io.deephaven.db.plot.util.PlotUtils.HashMapWithDefault<>();
    public io.deephaven.db.plot.util.PlotUtils.HashMapWithDefault<String, java.util.Map> pointShapeSeriesNameToMapMap() {
    ...
    private io.deephaven.db.plot.util.PlotUtils.HashMapWithDefault<String, java.lang.Object[]> pointShapeSeriesNameToComparableStringMap = new io.deephaven.db.plot.util.PlotUtils.HashMapWithDefault<>();
    public io.deephaven.db.plot.util.PlotUtils.HashMapWithDefault<String, java.lang.Object[]> pointShapeSeriesNameToComparableStringMap() {
    ...
    private io.deephaven.db.plot.util.PlotUtils.HashMapWithDefault<String, java.lang.Object[]> pointShapeSeriesNameToComparableShapeMap = new io.deephaven.db.plot.util.PlotUtils.HashMapWithDefault<>();
    public io.deephaven.db.plot.util.PlotUtils.HashMapWithDefault<String, java.lang.Object[]> pointShapeSeriesNameToComparableShapeMap() {
    ...
    private io.deephaven.db.plot.util.PlotUtils.HashMapWithDefault<String, java.lang.Object[]> pointShapeSeriesNameToSelectableDataSetStringStringMap = new io.deephaven.db.plot.util.PlotUtils.HashMapWithDefault<>();
    public io.deephaven.db.plot.util.PlotUtils.HashMapWithDefault<String, java.lang.Object[]> pointShapeSeriesNameToSelectableDataSetStringStringMap() {
        return pointShapeSeriesNameToSelectableDataSetStringStringMap;
    }
    @Override public MultiCatSeries pointShape(final io.deephaven.db.plot.filters.SelectableDataSet sds, final java.lang.String keyColumn, final java.lang.String valueColumn, final Object... keys) {
        if(keys == null || keys.length == 0) {
    ...
    private io.deephaven.db.plot.util.PlotUtils.HashMapWithDefault<String, java.lang.Object[]> pointShapeSeriesNameToTableStringStringMap = new io.deephaven.db.plot.util.PlotUtils.HashMapWithDefault<>();
    public io.deephaven.db.plot.util.PlotUtils.HashMapWithDefault<String, java.lang.Object[]> pointShapeSeriesNameToTableStringStringMap() {
        return pointShapeSeriesNameToTableStringStringMap;
    }
    @Override public MultiCatSeries pointShape(final io.deephaven.db.tables.Table t, final java.lang.String keyColumn, final java.lang.String valueColumn, final Object... keys) {
    final io.deephaven.db.plot.util.tables.TableHandle tHandle = new io.deephaven.db.plot.util.tables.TableHandle(t, keyColumn, valueColumn);
    addTableHandle(tHandle);
        if(keys == null || keys.length == 0) {
    ...
    private io.deephaven.db.plot.util.PlotUtils.HashMapWithDefault<String, java.util.Map> pointSizeSeriesNameToMapMap = new io.deephaven.db.plot.util.PlotUtils.HashMapWithDefault<>();
    public io.deephaven.db.plot.util.PlotUtils.HashMapWithDefault<String, java.util.Map> pointSizeSeriesNameToMapMap() {
    ...
    private io.deephaven.db.plot.util.PlotUtils.HashMapWithDefault<String, java.lang.Object[]> pointSizeSeriesNameToCATEGORYArrayNUMBERArrayMap = new io.deephaven.db.plot.util.PlotUtils.HashMapWithDefault<>();
    public io.deephaven.db.plot.util.PlotUtils.HashMapWithDefault<String, java.lang.Object[]> pointSizeSeriesNameToCATEGORYArrayNUMBERArrayMap() {
    ...
    private io.deephaven.db.plot.util.PlotUtils.HashMapWithDefault<String, java.lang.Object[]> pointSizeSeriesNameToCATEGORYArraydoubleArrayMap = new io.deephaven.db.plot.util.PlotUtils.HashMapWithDefault<>();
    public io.deephaven.db.plot.util.PlotUtils.HashMapWithDefault<String, java.lang.Object[]> pointSizeSeriesNameToCATEGORYArraydoubleArrayMap() {
    ...
    private io.deephaven.db.plot.util.PlotUtils.HashMapWithDefault<String, java.lang.Object[]> pointSizeSeriesNameToCATEGORYArrayintArrayMap = new io.deephaven.db.plot.util.PlotUtils.HashMapWithDefault<>();
    public io.deephaven.db.plot.util.PlotUtils.HashMapWithDefault<String, java.lang.Object[]> pointSizeSeriesNameToCATEGORYArrayintArrayMap() {
    ...
    private io.deephaven.db.plot.util.PlotUtils.HashMapWithDefault<String, java.lang.Object[]> pointSizeSeriesNameToCATEGORYArraylongArrayMap = new io.deephaven.db.plot.util.PlotUtils.HashMapWithDefault<>();
    public io.deephaven.db.plot.util.PlotUtils.HashMapWithDefault<String, java.lang.Object[]> pointSizeSeriesNameToCATEGORYArraylongArrayMap() {
    ...
    private io.deephaven.db.plot.util.PlotUtils.HashMapWithDefault<String, java.lang.Object[]> pointSizeSeriesNameToComparableNumberMap = new io.deephaven.db.plot.util.PlotUtils.HashMapWithDefault<>();
    public io.deephaven.db.plot.util.PlotUtils.HashMapWithDefault<String, java.lang.Object[]> pointSizeSeriesNameToComparableNumberMap() {
    ...
    private io.deephaven.db.plot.util.PlotUtils.HashMapWithDefault<String, java.lang.Object[]> pointSizeSeriesNameToComparabledoubleMap = new io.deephaven.db.plot.util.PlotUtils.HashMapWithDefault<>();
    public io.deephaven.db.plot.util.PlotUtils.HashMapWithDefault<String, java.lang.Object[]> pointSizeSeriesNameToComparabledoubleMap() {
    ...
    private io.deephaven.db.plot.util.PlotUtils.HashMapWithDefault<String, java.lang.Object[]> pointSizeSeriesNameToComparableintMap = new io.deephaven.db.plot.util.PlotUtils.HashMapWithDefault<>();
    public io.deephaven.db.plot.util.PlotUtils.HashMapWithDefault<String, java.lang.Object[]> pointSizeSeriesNameToComparableintMap() {
    ...
    private io.deephaven.db.plot.util.PlotUtils.HashMapWithDefault<String, java.lang.Object[]> pointSizeSeriesNameToComparablelongMap = new io.deephaven.db.plot.util.PlotUtils.HashMapWithDefault<>();
    public io.deephaven.db.plot.util.PlotUtils.HashMapWithDefault<String, java.lang.Object[]> pointSizeSeriesNameToComparablelongMap() {
    ...
    private io.deephaven.db.plot.util.PlotUtils.HashMapWithDefault<String, java.lang.Object[]> pointSizeSeriesNameToSelectableDataSetStringStringMap = new io.deephaven.db.plot.util.PlotUtils.HashMapWithDefault<>();
    public io.deephaven.db.plot.util.PlotUtils.HashMapWithDefault<String, java.lang.Object[]> pointSizeSeriesNameToSelectableDataSetStringStringMap() {
        return pointSizeSeriesNameToSelectableDataSetStringStringMap;
    }
    @Override public MultiCatSeries pointSize(final io.deephaven.db.plot.filters.SelectableDataSet sds, final java.lang.String keyColumn, final java.lang.String valueColumn, final Object... keys) {
        if(keys == null || keys.length == 0) {
    ...
    private io.deephaven.db.plot.util.PlotUtils.HashMapWithDefault<String, java.lang.Object[]> pointSizeSeriesNameToTableStringStringMap = new io.deephaven.db.plot.util.PlotUtils.HashMapWithDefault<>();
    public io.deephaven.db.plot.util.PlotUtils.HashMapWithDefault<String, java.lang.Object[]> pointSizeSeriesNameToTableStringStringMap() {
        return pointSizeSeriesNameToTableStringStringMap;
    }
    @Override public MultiCatSeries pointSize(final io.deephaven.db.tables.Table t, final java.lang.String keyColumn, final java.lang.String valueColumn, final Object... keys) {
    final io.deephaven.db.plot.util.tables.TableHandle tHandle = new io.deephaven.db.plot.util.tables.TableHandle(t, keyColumn, valueColumn);
    addTableHandle(tHandle);
        if(keys == null || keys.length == 0) {
    ...
    private <CATEGORY extends java.lang.Comparable, COLOR extends io.deephaven.gui.color.Paint, T extends io.deephaven.gui.color.Paint, LABEL, NUMBER extends java.lang.Number, COLOR0 extends java.lang.Integer> void $$initializeSeries$$(CategoryDataSeriesInternal series) {
        ...
        if(objectArray != null) {series.pointColor(((io.deephaven.db.plot.util.tables.TableHandle) objectArray[0]).getTable(), (java.lang.String) objectArray[1], (java.lang.String) objectArray[2]);}
        ...
        if(objectArray != null) {series.pointLabel(((io.deephaven.db.plot.util.tables.TableHandle) objectArray[0]).getTable(), (java.lang.String) objectArray[1], (java.lang.String) objectArray[2]);}
        ...
        if(objectArray != null) {series.pointShape(((io.deephaven.db.plot.util.tables.TableHandle) objectArray[0]).getTable(), (java.lang.String) objectArray[1], (java.lang.String) objectArray[2]);}
        ...
        if(objectArray != null) {series.pointLabel((io.deephaven.db.plot.filters.SelectableDataSet) objectArray[0], (java.lang.String) objectArray[1], (java.lang.String) objectArray[2]);}
        ...
        if(objectArray != null) {series.pointColor((io.deephaven.db.plot.filters.SelectableDataSet) objectArray[0], (java.lang.String) objectArray[1], (java.lang.String) objectArray[2]);}
        ...
        if(objectArray != null) {series.pointShape((io.deephaven.db.plot.filters.SelectableDataSet) objectArray[0], (java.lang.String) objectArray[1], (java.lang.String) objectArray[2]);}
        ...
        if(objectArray != null) {series.pointSize(((io.deephaven.db.plot.util.tables.TableHandle) objectArray[0]).getTable(), (java.lang.String) objectArray[1], (java.lang.String) objectArray[2]);}
        ...
        java.util.function.Consumer<io.deephaven.db.plot.LineStyle> consumer26 = series::lineStyle;
        ...
        if(objectArray != null) {series.pointSize((io.deephaven.db.plot.filters.SelectableDataSet) objectArray[0], (java.lang.String) objectArray[1], (java.lang.String) objectArray[2]);}
