...
/**
 * {@link IndexableData} dataset whose data is a column in a {@link SwappableTable}
...
public class IndexableDataSwappableTableDouble extends IndexableDataSwappableTable<Double> {
     ...
     * The data is a {@code column} in the {@code swappableTable}.
     * Indices are the row numbers of the column.
     *
     * @throws io.deephaven.base.verify.RequirementFailure {@code swappableTable} and
     ...
     */
    public IndexableDataSwappableTableDouble(SwappableTable swappableTable, String column, final PlotInfo plotInfo) {
        super(swappableTable, column, plotInfo);
        ArgumentValidations.assertIsNumeric(swappableTable.getTableDefinition(), column, "Non-numeric column cannot be converted to a double.  column=" + column, plotInfo);
    }
