...
public class MultiCatErrorBarSeries extends AbstractTableMapHandleMultiSeries<CategoryErrorBarDataSeriesInternal> {
    ...
    public MultiCatErrorBarSeries(final AxesImpl axes,
        ...
        ArgumentValidations.assertIsNumericOrTimeOrCharOrComparableInstance(tableMapHandle.getTableDefinition(), categories, "Invalid data type in category column: column=" + categories, getPlotInfo());
        ArgumentValidations.assertIsNumericOrTime(tableMapHandle.getTableDefinition(), values, "Invalid data type in category column: column=" + values, getPlotInfo());
        ArgumentValidations.assertIsNumericOrTime(tableMapHandle.getTableDefinition(), yLow, "Invalid data type in category column: column=" + yLow, getPlotInfo());
        ArgumentValidations.assertIsNumericOrTime(tableMapHandle.getTableDefinition(), yHigh, "Invalid data type in category column: column=" + yHigh, getPlotInfo());
    ...
    @Override public MultiCatErrorBarSeries lineStyle(final io.deephaven.db.plot.LineStyle style, final Object... keys) {
        if(keys == null || keys.length == 0) {
    ...
    @Override public MultiCatErrorBarSeries piePercentLabelFormat(final java.lang.String format, final Object... keys) {
        if(keys == null || keys.length == 0) {
    ...
    @Override public MultiCatErrorBarSeries pointColor(final io.deephaven.db.plot.filters.SelectableDataSet sds, final java.lang.String keyColumn, final java.lang.String valueColumn, final Object... keys) {
        if(keys == null || keys.length == 0) {
    ...
    @Override public MultiCatErrorBarSeries pointColor(final io.deephaven.db.tables.Table t, final java.lang.String keyColumn, final java.lang.String valueColumn, final Object... keys) {
    ...
    @Override public MultiCatErrorBarSeries pointLabel(final io.deephaven.db.plot.filters.SelectableDataSet sds, final java.lang.String keyColumn, final java.lang.String valueColumn, final Object... keys) {
        if(keys == null || keys.length == 0) {
    ...
    @Override public MultiCatErrorBarSeries pointLabel(final io.deephaven.db.tables.Table t, final java.lang.String keyColumn, final java.lang.String valueColumn, final Object... keys) {
    final io.deephaven.db.plot.util.tables.TableHandle tHandle = new io.deephaven.db.plot.util.tables.TableHandle(t, keyColumn, valueColumn);
    addTableHandle(tHandle);
        if(keys == null || keys.length == 0) {
    ...
    @Override public MultiCatErrorBarSeries pointShape(final io.deephaven.db.plot.filters.SelectableDataSet sds, final java.lang.String keyColumn, final java.lang.String valueColumn, final Object... keys) {
        if(keys == null || keys.length == 0) {
    ...
    @Override public MultiCatErrorBarSeries pointShape(final io.deephaven.db.tables.Table t, final java.lang.String keyColumn, final java.lang.String valueColumn, final Object... keys) {
    final io.deephaven.db.plot.util.tables.TableHandle tHandle = new io.deephaven.db.plot.util.tables.TableHandle(t, keyColumn, valueColumn);
    addTableHandle(tHandle);
        if(keys == null || keys.length == 0) {
    ...
    @Override public MultiCatErrorBarSeries pointSize(final io.deephaven.db.plot.filters.SelectableDataSet sds, final java.lang.String keyColumn, final java.lang.String valueColumn, final Object... keys) {
        if(keys == null || keys.length == 0) {
    ...
    @Override public MultiCatErrorBarSeries pointSize(final io.deephaven.db.tables.Table t, final java.lang.String keyColumn, final java.lang.String valueColumn, final Object... keys) {
    final io.deephaven.db.plot.util.tables.TableHandle tHandle = new io.deephaven.db.plot.util.tables.TableHandle(t, keyColumn, valueColumn);
    addTableHandle(tHandle);
        if(keys == null || keys.length == 0) {
