...
public class CategoryErrorBarDataSeriesSwappableTableMap extends AbstractSwappableTableBasedCategoryDataSeries implements CategoryErrorBarDataSeriesInternal, CategorySwappableTableDataSeriesInternal, TableSnapshotSeries {
    ...
    public <T extends Comparable> CategoryErrorBarDataSeriesSwappableTableMap(final AxesImpl axes,
        ...
        ArgumentValidations.assertIsNumericOrTime(swappableTable.getTableDefinition(), valueCol, "Invalid data type in data column: column=" + valueCol, getPlotInfo());
        ArgumentValidations.assertIsNumericOrTime(swappableTable.getTableDefinition(), errorBarLowCol, "Invalid data type in data column: column=" + errorBarLowCol, getPlotInfo());
        ArgumentValidations.assertIsNumericOrTime(swappableTable.getTableDefinition(), errorBarHighCol, "Invalid data type in data column: column=" + errorBarHighCol, getPlotInfo());
        ...
        this.kernel = new CategoryErrorBarDataSeriesKernel(categories, valueCol, errorBarLowCol, errorBarHighCol, getPlotInfo());
    }
     ...
     */
    private CategoryErrorBarDataSeriesSwappableTableMap(final CategoryErrorBarDataSeriesSwappableTableMap series, final AxesImpl axes) {
        super(series, axes);
