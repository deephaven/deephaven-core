...
public class IndexableNumericDataSwappableTable extends LiveIndexableNumericData {
     ...
     * The numeric data is a {@code column} in the {@code swappableTable}.
     ...
     */
    public IndexableNumericDataSwappableTable(final SwappableTable swappableTable, final String column, final PlotInfo plotInfo) {
        super(plotInfo);
    ...
    @Override
    public synchronized double get(int i) { return Double.NaN; }
