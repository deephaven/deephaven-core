 ...
 */
public class CategoryDataSeriesTableMap extends AbstractTableBasedCategoryDataSeries implements CategoryTableDataSeriesInternal, TableSnapshotSeries {
     ...
     * @throws RequirementFailure {@code chart}, {@code tableHandle},
    ...
    public <T extends Comparable> CategoryDataSeriesTableMap(final AxesImpl axes,
        ...
        ArgumentValidations.assertIsNumericOrTimeOrCharOrComparableInstance(tableHandle.getFinalTableDefinition(), categories, "Invalid data type in category column: column=" + categories, getPlotInfo());
        ArgumentValidations.assertIsNumericOrTime(tableHandle.getFinalTableDefinition(), values, "Invalid data type in data column: column=" + values, getPlotInfo());
