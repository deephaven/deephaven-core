...
public class IndexableDataSwappableTable<T> extends LiveIndexableData<T> {
     ...
     */
    public IndexableDataSwappableTable(final SwappableTable swappableTable, final String column, final PlotInfo plotInfo) {
        super(plotInfo);
    ...
    @Override
    public synchronized T get(int index) { return null; }
