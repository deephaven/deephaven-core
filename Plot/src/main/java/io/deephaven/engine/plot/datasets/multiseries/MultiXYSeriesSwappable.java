...
public class MultiXYSeriesSwappable extends AbstractSwappableMultiSeries<XYDataSeriesInternal> {
    ...
    @Override public MultiXYSeriesSwappable lineStyle(final io.deephaven.engine.plot.LineStyle style, final Object... keys) {
        if(keys == null || keys.length == 0) {
    ...
    @Override public <T extends io.deephaven.gui.color.Paint> MultiXYSeriesSwappable pointColor(final io.deephaven.engine.plot.datasets.data.IndexableData<T> colors, final Object... keys) {
        if(keys == null || keys.length == 0) {
    ...
    @Override public MultiXYSeriesSwappable pointColor(final io.deephaven.engine.plot.filters.SelectableDataSet sds, final java.lang.String columnName, final Object... keys) {
        if(keys == null || keys.length == 0) {
    ...
    @Override public MultiXYSeriesSwappable pointColor(final io.deephaven.engine.tables.Table t, final java.lang.String columnName, final Object... keys) {
    ...
    @Override public MultiXYSeriesSwappable pointColorInteger(final io.deephaven.engine.plot.datasets.data.IndexableData<java.lang.Integer> colors, final Object... keys) {
        if(keys == null || keys.length == 0) {
    ...
    @Override public MultiXYSeriesSwappable pointLabel(final io.deephaven.engine.plot.datasets.data.IndexableData<?> labels, final Object... keys) {
        if(keys == null || keys.length == 0) {
    ...
    @Override public MultiXYSeriesSwappable pointLabel(final io.deephaven.engine.plot.filters.SelectableDataSet sds, final java.lang.String columnName, final Object... keys) {
        if(keys == null || keys.length == 0) {
    ...
    @Override public MultiXYSeriesSwappable pointLabel(final io.deephaven.engine.tables.Table t, final java.lang.String columnName, final Object... keys) {
    final io.deephaven.engine.plot.util.tables.TableHandle tHandle = new io.deephaven.engine.plot.util.tables.TableHandle(t, columnName);
    addTableHandle(tHandle);
        if(keys == null || keys.length == 0) {
    ...
    @Override public MultiXYSeriesSwappable pointShape(final io.deephaven.engine.plot.datasets.data.IndexableData<java.lang.String> shapes, final Object... keys) {
        if(keys == null || keys.length == 0) {
    ...
    @Override public MultiXYSeriesSwappable pointShape(final io.deephaven.engine.plot.filters.SelectableDataSet sds, final java.lang.String columnName, final Object... keys) {
        if(keys == null || keys.length == 0) {
    ...
    @Override public MultiXYSeriesSwappable pointShape(final io.deephaven.engine.tables.Table t, final java.lang.String columnName, final Object... keys) {
    final io.deephaven.engine.plot.util.tables.TableHandle tHandle = new io.deephaven.engine.plot.util.tables.TableHandle(t, columnName);
    addTableHandle(tHandle);
        if(keys == null || keys.length == 0) {
    ...
    @Override public MultiXYSeriesSwappable pointSize(final io.deephaven.engine.plot.datasets.data.IndexableData<java.lang.Double> factors, final Object... keys) {
        if(keys == null || keys.length == 0) {
    ...
    @Override public MultiXYSeriesSwappable pointSize(final io.deephaven.engine.plot.filters.SelectableDataSet sds, final java.lang.String columnName, final Object... keys) {
        if(keys == null || keys.length == 0) {
    ...
    @Override public MultiXYSeriesSwappable pointSize(final io.deephaven.engine.tables.Table t, final java.lang.String columnName, final Object... keys) {
    final io.deephaven.engine.plot.util.tables.TableHandle tHandle = new io.deephaven.engine.plot.util.tables.TableHandle(t, columnName);
    addTableHandle(tHandle);
        if(keys == null || keys.length == 0) {
