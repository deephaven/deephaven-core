...
import io.deephaven.engine.plot.datasets.xyerrorbar.XYErrorBarDataSeriesInternal;
...
public class MultiXYErrorBarSeriesSwappable extends AbstractSwappableMultiSeries <XYErrorBarDataSeriesInternal>{
     ...
     */
    public MultiXYErrorBarSeriesSwappable(final AxesImpl axes, final int id, final Comparable name, SwappableTable swappableTable, final String x, final String xLow, final String xHigh, final String y, final String yLow, final String yHigh, final String[] byColumns, final boolean drawXError, final boolean drawYError) {
    ...
    @Override
    public XYErrorBarDataSeriesInternal createSeries(String seriesName, final BaseTable t, final DynamicSeriesNamer seriesNamer) {
    ...
    @Override public <T extends io.deephaven.gui.color.Paint> MultiXYErrorBarSeriesSwappable pointColorByY(final groovy.lang.Closure<T> colors, final Object... keys) {
        return pointColorByY(new io.deephaven.engine.plot.util.functions.ClosureFunction<>(colors), keys);
    }



    @Override public <T extends io.deephaven.gui.color.Paint> MultiXYErrorBarSeriesSwappable pointColorByY(final java.util.function.Function<java.lang.Double, T> colors, final Object... keys) {
        ...
        chart().figure().registerFigureFunction(new io.deephaven.engine.plot.util.functions.FigureImplFunction(f -> f.pointColor(new SelectableDataSetSwappableTable(getSwappableTable()), newColumn, keys), this));
        return this;
    }
    ...
    @Override public MultiXYErrorBarSeriesSwappable errorBarColor(final java.lang.String color, final Object... keys) {
    ...
    @Override public MultiXYErrorBarSeriesSwappable errorBarColor(final int color, final Object... keys) {
        if(keys == null || keys.length == 0) {
    ...
    @Override public MultiXYErrorBarSeriesSwappable errorBarColor(final io.deephaven.gui.color.Paint color, final Object... keys) {
        if(keys == null || keys.length == 0) {
    ...
    @Override public MultiXYErrorBarSeriesSwappable gradientVisible(final boolean visible, final Object... keys) {
        if(keys == null || keys.length == 0) {
    ...
    @Override public MultiXYErrorBarSeriesSwappable lineColor(final java.lang.String color, final Object... keys) {
        if(keys == null || keys.length == 0) {
    ...
    @Override public MultiXYErrorBarSeriesSwappable lineColor(final int color, final Object... keys) {
        if(keys == null || keys.length == 0) {
    ...
    @Override public MultiXYErrorBarSeriesSwappable lineColor(final io.deephaven.gui.color.Paint color, final Object... keys) {
        if(keys == null || keys.length == 0) {
    ...
    @Override public MultiXYErrorBarSeriesSwappable lineStyle(final io.deephaven.engine.plot.LineStyle style, final Object... keys) {
        if(keys == null || keys.length == 0) {
    ...
    @Override public MultiXYErrorBarSeriesSwappable linesVisible(final java.lang.Boolean visible, final Object... keys) {
        if(keys == null || keys.length == 0) {
    ...
    private io.deephaven.engine.plot.util.PlotUtils.HashMapWithDefault<String, int[]> pointColorSeriesNameTointArrayMap = new io.deephaven.engine.plot.util.PlotUtils.HashMapWithDefault<>();
    public io.deephaven.engine.plot.util.PlotUtils.HashMapWithDefault<String, int[]> pointColorSeriesNameTointArrayMap() {
        return pointColorSeriesNameTointArrayMap;
    }
    @Override public MultiXYErrorBarSeriesSwappable pointColor(final int[] colors, final Object... keys) {
        if(keys == null || keys.length == 0) {
    ...
    private io.deephaven.engine.plot.util.PlotUtils.HashMapWithDefault<String, io.deephaven.gui.color.Paint[]> pointColorSeriesNameToPaintArrayMap = new io.deephaven.engine.plot.util.PlotUtils.HashMapWithDefault<>();
    public io.deephaven.engine.plot.util.PlotUtils.HashMapWithDefault<String, io.deephaven.gui.color.Paint[]> pointColorSeriesNameToPaintArrayMap() {
        return pointColorSeriesNameToPaintArrayMap;
    }
    @Override public MultiXYErrorBarSeriesSwappable pointColor(final io.deephaven.gui.color.Paint[] colors, final Object... keys) {
        if(keys == null || keys.length == 0) {
    ...
    private io.deephaven.engine.plot.util.PlotUtils.HashMapWithDefault<String, java.lang.Integer[]> pointColorSeriesNameToIntegerArrayMap = new io.deephaven.engine.plot.util.PlotUtils.HashMapWithDefault<>();
    public io.deephaven.engine.plot.util.PlotUtils.HashMapWithDefault<String, java.lang.Integer[]> pointColorSeriesNameToIntegerArrayMap() {
        return pointColorSeriesNameToIntegerArrayMap;
    }
    @Override public MultiXYErrorBarSeriesSwappable pointColor(final java.lang.Integer[] colors, final Object... keys) {
        if(keys == null || keys.length == 0) {
    ...
    private io.deephaven.engine.plot.util.PlotUtils.HashMapWithDefault<String, java.lang.String[]> pointColorSeriesNameToStringArrayMap = new io.deephaven.engine.plot.util.PlotUtils.HashMapWithDefault<>();
    public io.deephaven.engine.plot.util.PlotUtils.HashMapWithDefault<String, java.lang.String[]> pointColorSeriesNameToStringArrayMap() {
        return pointColorSeriesNameToStringArrayMap;
    }
    @Override public MultiXYErrorBarSeriesSwappable pointColor(final java.lang.String[] colors, final Object... keys) {
        if(keys == null || keys.length == 0) {
    ...
    @Override public MultiXYErrorBarSeriesSwappable pointColor(final java.lang.String color, final Object... keys) {
        if(keys == null || keys.length == 0) {
    ...
    @Override public MultiXYErrorBarSeriesSwappable pointColor(final int color, final Object... keys) {
        if(keys == null || keys.length == 0) {
    ...
    @Override public MultiXYErrorBarSeriesSwappable pointColor(final io.deephaven.gui.color.Paint color, final Object... keys) {
        if(keys == null || keys.length == 0) {
    ...
    private io.deephaven.engine.plot.util.PlotUtils.HashMapWithDefault<String, io.deephaven.engine.plot.datasets.data.IndexableData> pointColorSeriesNameToIndexableDataMap = new io.deephaven.engine.plot.util.PlotUtils.HashMapWithDefault<>();
    public io.deephaven.engine.plot.util.PlotUtils.HashMapWithDefault<String, io.deephaven.engine.plot.datasets.data.IndexableData> pointColorSeriesNameToIndexableDataMap() {
        return pointColorSeriesNameToIndexableDataMap;
    }
    @Override public <T extends io.deephaven.gui.color.Paint> MultiXYErrorBarSeriesSwappable pointColor(final io.deephaven.engine.plot.datasets.data.IndexableData<T> colors, final Object... keys) {
        if(keys == null || keys.length == 0) {
    ...
    private io.deephaven.engine.plot.util.PlotUtils.HashMapWithDefault<String, java.lang.Object[]> pointColorSeriesNameToSelectableDataSetStringMap = new io.deephaven.engine.plot.util.PlotUtils.HashMapWithDefault<>();
    public io.deephaven.engine.plot.util.PlotUtils.HashMapWithDefault<String, java.lang.Object[]> pointColorSeriesNameToSelectableDataSetStringMap() {
        return pointColorSeriesNameToSelectableDataSetStringMap;
    }
    @Override public MultiXYErrorBarSeriesSwappable pointColor(final io.deephaven.engine.plot.filters.SelectableDataSet sds, final java.lang.String columnName, final Object... keys) {
        if(keys == null || keys.length == 0) {
    ...
    private io.deephaven.engine.plot.util.PlotUtils.HashMapWithDefault<String, java.lang.Object[]> pointColorSeriesNameToTableStringMap = new io.deephaven.engine.plot.util.PlotUtils.HashMapWithDefault<>();
    ...
    private io.deephaven.engine.plot.util.PlotUtils.HashMapWithDefault<String, io.deephaven.engine.plot.datasets.data.IndexableData> pointColorIntegerSeriesNameToIndexableDataMap = new io.deephaven.engine.plot.util.PlotUtils.HashMapWithDefault<>();
    public io.deephaven.engine.plot.util.PlotUtils.HashMapWithDefault<String, io.deephaven.engine.plot.datasets.data.IndexableData> pointColorIntegerSeriesNameToIndexableDataMap() {
        return pointColorIntegerSeriesNameToIndexableDataMap;
    }
    @Override public MultiXYErrorBarSeriesSwappable pointColorInteger(final io.deephaven.engine.plot.datasets.data.IndexableData<java.lang.Integer> colors, final Object... keys) {
        if(keys == null || keys.length == 0) {
    ...
    private io.deephaven.engine.plot.util.PlotUtils.HashMapWithDefault<String, java.lang.Object[]> pointLabelSeriesNameToObjectArrayMap = new io.deephaven.engine.plot.util.PlotUtils.HashMapWithDefault<>();
    public io.deephaven.engine.plot.util.PlotUtils.HashMapWithDefault<String, java.lang.Object[]> pointLabelSeriesNameToObjectArrayMap() {
        return pointLabelSeriesNameToObjectArrayMap;
    }
    @Override public MultiXYErrorBarSeriesSwappable pointLabel(final java.lang.Object[] labels, final Object... keys) {
        if(keys == null || keys.length == 0) {
    ...
    @Override public MultiXYErrorBarSeriesSwappable pointLabel(final java.lang.Object label, final Object... keys) {
        if(keys == null || keys.length == 0) {
    ...
    private io.deephaven.engine.plot.util.PlotUtils.HashMapWithDefault<String, io.deephaven.engine.plot.datasets.data.IndexableData> pointLabelSeriesNameToIndexableDataMap = new io.deephaven.engine.plot.util.PlotUtils.HashMapWithDefault<>();
    public io.deephaven.engine.plot.util.PlotUtils.HashMapWithDefault<String, io.deephaven.engine.plot.datasets.data.IndexableData> pointLabelSeriesNameToIndexableDataMap() {
        return pointLabelSeriesNameToIndexableDataMap;
    }
    @Override public MultiXYErrorBarSeriesSwappable pointLabel(final io.deephaven.engine.plot.datasets.data.IndexableData<?> labels, final Object... keys) {
        if(keys == null || keys.length == 0) {
    ...
    private io.deephaven.engine.plot.util.PlotUtils.HashMapWithDefault<String, java.lang.Object[]> pointLabelSeriesNameToSelectableDataSetStringMap = new io.deephaven.engine.plot.util.PlotUtils.HashMapWithDefault<>();
    public io.deephaven.engine.plot.util.PlotUtils.HashMapWithDefault<String, java.lang.Object[]> pointLabelSeriesNameToSelectableDataSetStringMap() {
        return pointLabelSeriesNameToSelectableDataSetStringMap;
    }
    @Override public MultiXYErrorBarSeriesSwappable pointLabel(final io.deephaven.engine.plot.filters.SelectableDataSet sds, final java.lang.String columnName, final Object... keys) {
        if(keys == null || keys.length == 0) {
    ...
    private io.deephaven.engine.plot.util.PlotUtils.HashMapWithDefault<String, java.lang.Object[]> pointLabelSeriesNameToTableStringMap = new io.deephaven.engine.plot.util.PlotUtils.HashMapWithDefault<>();
    ...
    @Override public MultiXYErrorBarSeriesSwappable pointLabelFormat(final java.lang.String format, final Object... keys) {
        if(keys == null || keys.length == 0) {
    ...
    private io.deephaven.engine.plot.util.PlotUtils.HashMapWithDefault<String, io.deephaven.gui.shape.Shape[]> pointShapeSeriesNameToShapeArrayMap = new io.deephaven.engine.plot.util.PlotUtils.HashMapWithDefault<>();
    public io.deephaven.engine.plot.util.PlotUtils.HashMapWithDefault<String, io.deephaven.gui.shape.Shape[]> pointShapeSeriesNameToShapeArrayMap() {
        return pointShapeSeriesNameToShapeArrayMap;
    }
    @Override public MultiXYErrorBarSeriesSwappable pointShape(final io.deephaven.gui.shape.Shape[] shapes, final Object... keys) {
        if(keys == null || keys.length == 0) {
    ...
    private io.deephaven.engine.plot.util.PlotUtils.HashMapWithDefault<String, java.lang.String[]> pointShapeSeriesNameToStringArrayMap = new io.deephaven.engine.plot.util.PlotUtils.HashMapWithDefault<>();
    public io.deephaven.engine.plot.util.PlotUtils.HashMapWithDefault<String, java.lang.String[]> pointShapeSeriesNameToStringArrayMap() {
        return pointShapeSeriesNameToStringArrayMap;
    }
    @Override public MultiXYErrorBarSeriesSwappable pointShape(final java.lang.String[] shapes, final Object... keys) {
        if(keys == null || keys.length == 0) {
    ...
    @Override public MultiXYErrorBarSeriesSwappable pointShape(final java.lang.String shape, final Object... keys) {
        if(keys == null || keys.length == 0) {
    ...
    @Override public MultiXYErrorBarSeriesSwappable pointShape(final io.deephaven.gui.shape.Shape shape, final Object... keys) {
        if(keys == null || keys.length == 0) {
    ...
    private io.deephaven.engine.plot.util.PlotUtils.HashMapWithDefault<String, io.deephaven.engine.plot.datasets.data.IndexableData> pointShapeSeriesNameToIndexableDataMap = new io.deephaven.engine.plot.util.PlotUtils.HashMapWithDefault<>();
    public io.deephaven.engine.plot.util.PlotUtils.HashMapWithDefault<String, io.deephaven.engine.plot.datasets.data.IndexableData> pointShapeSeriesNameToIndexableDataMap() {
        return pointShapeSeriesNameToIndexableDataMap;
    }
    @Override public MultiXYErrorBarSeriesSwappable pointShape(final io.deephaven.engine.plot.datasets.data.IndexableData<java.lang.String> shapes, final Object... keys) {
        if(keys == null || keys.length == 0) {
    ...
    private io.deephaven.engine.plot.util.PlotUtils.HashMapWithDefault<String, java.lang.Object[]> pointShapeSeriesNameToSelectableDataSetStringMap = new io.deephaven.engine.plot.util.PlotUtils.HashMapWithDefault<>();
    public io.deephaven.engine.plot.util.PlotUtils.HashMapWithDefault<String, java.lang.Object[]> pointShapeSeriesNameToSelectableDataSetStringMap() {
        return pointShapeSeriesNameToSelectableDataSetStringMap;
    }
    @Override public MultiXYErrorBarSeriesSwappable pointShape(final io.deephaven.engine.plot.filters.SelectableDataSet sds, final java.lang.String columnName, final Object... keys) {
        if(keys == null || keys.length == 0) {
    ...
    private io.deephaven.engine.plot.util.PlotUtils.HashMapWithDefault<String, java.lang.Object[]> pointShapeSeriesNameToTableStringMap = new io.deephaven.engine.plot.util.PlotUtils.HashMapWithDefault<>();
    ...
    private io.deephaven.engine.plot.util.PlotUtils.HashMapWithDefault<String, java.lang.Object> pointSizeSeriesNameToTArrayMap = new io.deephaven.engine.plot.util.PlotUtils.HashMapWithDefault<>();
    public io.deephaven.engine.plot.util.PlotUtils.HashMapWithDefault<String, java.lang.Object> pointSizeSeriesNameToTArrayMap() {
        return pointSizeSeriesNameToTArrayMap;
    }
    @Override public <T extends java.lang.Number> MultiXYErrorBarSeriesSwappable pointSize(final T[] factors, final Object... keys) {
        if(keys == null || keys.length == 0) {
    ...
    private io.deephaven.engine.plot.util.PlotUtils.HashMapWithDefault<String, double[]> pointSizeSeriesNameTodoubleArrayMap = new io.deephaven.engine.plot.util.PlotUtils.HashMapWithDefault<>();
    public io.deephaven.engine.plot.util.PlotUtils.HashMapWithDefault<String, double[]> pointSizeSeriesNameTodoubleArrayMap() {
        return pointSizeSeriesNameTodoubleArrayMap;
    }
    @Override public MultiXYErrorBarSeriesSwappable pointSize(final double[] factors, final Object... keys) {
        if(keys == null || keys.length == 0) {
    ...
    private io.deephaven.engine.plot.util.PlotUtils.HashMapWithDefault<String, int[]> pointSizeSeriesNameTointArrayMap = new io.deephaven.engine.plot.util.PlotUtils.HashMapWithDefault<>();
    public io.deephaven.engine.plot.util.PlotUtils.HashMapWithDefault<String, int[]> pointSizeSeriesNameTointArrayMap() {
        return pointSizeSeriesNameTointArrayMap;
    }
    @Override public MultiXYErrorBarSeriesSwappable pointSize(final int[] factors, final Object... keys) {
        if(keys == null || keys.length == 0) {
    ...
    private io.deephaven.engine.plot.util.PlotUtils.HashMapWithDefault<String, long[]> pointSizeSeriesNameTolongArrayMap = new io.deephaven.engine.plot.util.PlotUtils.HashMapWithDefault<>();
    public io.deephaven.engine.plot.util.PlotUtils.HashMapWithDefault<String, long[]> pointSizeSeriesNameTolongArrayMap() {
        return pointSizeSeriesNameTolongArrayMap;
    }
    @Override public MultiXYErrorBarSeriesSwappable pointSize(final long[] factors, final Object... keys) {
        if(keys == null || keys.length == 0) {
    ...
    @Override public MultiXYErrorBarSeriesSwappable pointSize(final java.lang.Number factor, final Object... keys) {
        if(keys == null || keys.length == 0) {
    ...
    private io.deephaven.engine.plot.util.PlotUtils.HashMapWithDefault<String, io.deephaven.engine.plot.datasets.data.IndexableData> pointSizeSeriesNameToIndexableDataMap = new io.deephaven.engine.plot.util.PlotUtils.HashMapWithDefault<>();
    public io.deephaven.engine.plot.util.PlotUtils.HashMapWithDefault<String, io.deephaven.engine.plot.datasets.data.IndexableData> pointSizeSeriesNameToIndexableDataMap() {
        return pointSizeSeriesNameToIndexableDataMap;
    }
    @Override public MultiXYErrorBarSeriesSwappable pointSize(final io.deephaven.engine.plot.datasets.data.IndexableData<java.lang.Double> factors, final Object... keys) {
        if(keys == null || keys.length == 0) {
    ...
    private io.deephaven.engine.plot.util.PlotUtils.HashMapWithDefault<String, java.lang.Object[]> pointSizeSeriesNameToSelectableDataSetStringMap = new io.deephaven.engine.plot.util.PlotUtils.HashMapWithDefault<>();
    public io.deephaven.engine.plot.util.PlotUtils.HashMapWithDefault<String, java.lang.Object[]> pointSizeSeriesNameToSelectableDataSetStringMap() {
        return pointSizeSeriesNameToSelectableDataSetStringMap;
    }
    @Override public MultiXYErrorBarSeriesSwappable pointSize(final io.deephaven.engine.plot.filters.SelectableDataSet sds, final java.lang.String columnName, final Object... keys) {
        if(keys == null || keys.length == 0) {
    ...
    private io.deephaven.engine.plot.util.PlotUtils.HashMapWithDefault<String, java.lang.Object[]> pointSizeSeriesNameToTableStringMap = new io.deephaven.engine.plot.util.PlotUtils.HashMapWithDefault<>();
    ...
    @Override public MultiXYErrorBarSeriesSwappable pointsVisible(final java.lang.Boolean visible, final Object... keys) {
        if(keys == null || keys.length == 0) {
    ...
    @Override public MultiXYErrorBarSeriesSwappable seriesColor(final java.lang.String color, final Object... keys) {
        if(keys == null || keys.length == 0) {
    ...
    @Override public MultiXYErrorBarSeriesSwappable seriesColor(final int color, final Object... keys) {
        if(keys == null || keys.length == 0) {
    ...
    @Override public MultiXYErrorBarSeriesSwappable seriesColor(final io.deephaven.gui.color.Paint color, final Object... keys) {
        if(keys == null || keys.length == 0) {
    ...
    @Override public MultiXYErrorBarSeriesSwappable toolTipPattern(final java.lang.String format, final Object... keys) {
        if(keys == null || keys.length == 0) {
    ...
    @Override public MultiXYErrorBarSeriesSwappable xToolTipPattern(final java.lang.String format, final Object... keys) {
        if(keys == null || keys.length == 0) {
    ...
    @Override public MultiXYErrorBarSeriesSwappable yToolTipPattern(final java.lang.String format, final Object... keys) {
        if(keys == null || keys.length == 0) {
    ...
    private <T extends io.deephaven.gui.color.Paint, T0 extends java.lang.Number> void $$initializeSeries$$(XYErrorBarDataSeriesInternal series) {
        ...
        java.util.function.Consumer<io.deephaven.engine.plot.datasets.data.IndexableData> consumer2 = series::pointShape;
        ...
        if(objectArray != null) {series.pointColor(((io.deephaven.engine.plot.util.tables.TableHandle) objectArray[0]).getTable(), (java.lang.String) objectArray[1]);}

        objectArray = pointSizeSeriesNameToSelectableDataSetStringMap.get(name);
        if(objectArray != null) {series.pointSize((io.deephaven.engine.plot.filters.SelectableDataSet) objectArray[0], (java.lang.String) objectArray[1]);}
        ...
        java.util.function.Consumer<io.deephaven.engine.plot.datasets.data.IndexableData> consumer5 = series::pointColor;
        ...
        if(objectArray != null) {series.pointShape((io.deephaven.engine.plot.filters.SelectableDataSet) objectArray[0], (java.lang.String) objectArray[1]);}

        objectArray = pointLabelSeriesNameToTableStringMap.get(name);
        if(objectArray != null) {series.pointLabel(((io.deephaven.engine.plot.util.tables.TableHandle) objectArray[0]).getTable(), (java.lang.String) objectArray[1]);}
        ...
        if(objectArray != null) {series.pointLabel((io.deephaven.engine.plot.filters.SelectableDataSet) objectArray[0], (java.lang.String) objectArray[1]);}
        ...
        if(objectArray != null) {series.pointColor((io.deephaven.engine.plot.filters.SelectableDataSet) objectArray[0], (java.lang.String) objectArray[1]);}
        ...
        java.util.function.Consumer<io.deephaven.engine.plot.LineStyle> consumer22 = series::lineStyle;
        ...
        java.util.function.Consumer<io.deephaven.engine.plot.datasets.data.IndexableData> consumer26 = series::pointColorInteger;
        ...
        java.util.function.Consumer<io.deephaven.engine.plot.datasets.data.IndexableData> consumer30 = series::pointLabel;
        ...
        if(objectArray != null) {series.pointShape(((io.deephaven.engine.plot.util.tables.TableHandle) objectArray[0]).getTable(), (java.lang.String) objectArray[1]);}
        ...
        java.util.function.Consumer<io.deephaven.engine.plot.datasets.data.IndexableData> consumer34 = series::pointSize;
        ...
        if(objectArray != null) {series.pointSize(((io.deephaven.engine.plot.util.tables.TableHandle) objectArray[0]).getTable(), (java.lang.String) objectArray[1]);}
