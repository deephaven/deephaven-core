...
import io.deephaven.engine.plot.axisformatters.NanosAxisFormat;
import io.deephaven.engine.plot.axistransformations.AxisTransform;
import io.deephaven.engine.plot.datasets.category.*;
import io.deephaven.engine.plot.datasets.categoryerrorbar.CategoryErrorBarDataSeriesMap;
import io.deephaven.engine.plot.datasets.categoryerrorbar.CategoryErrorBarDataSeriesSwappableTableMap;
import io.deephaven.engine.plot.datasets.categoryerrorbar.CategoryErrorBarDataSeriesTableMap;
import io.deephaven.engine.plot.datasets.data.*;
import io.deephaven.engine.plot.datasets.histogram.HistogramCalculator;
import io.deephaven.engine.plot.datasets.interval.IntervalXYDataSeriesArray;
import io.deephaven.engine.plot.datasets.multiseries.*;
import io.deephaven.engine.plot.datasets.ohlc.OHLCDataSeriesArray;
import io.deephaven.engine.plot.datasets.ohlc.OHLCDataSeriesSwappableTableArray;
import io.deephaven.engine.plot.datasets.ohlc.OHLCDataSeriesTableArray;
import io.deephaven.engine.plot.datasets.xy.XYDataSeriesArray;
import io.deephaven.engine.plot.datasets.xy.XYDataSeriesFunctionImpl;
import io.deephaven.engine.plot.datasets.xy.XYDataSeriesSwappableTableArray;
import io.deephaven.engine.plot.datasets.xy.XYDataSeriesTableArray;
import io.deephaven.engine.plot.datasets.xyerrorbar.XYErrorBarDataSeries;
import io.deephaven.engine.plot.datasets.xyerrorbar.XYErrorBarDataSeriesArray;
import io.deephaven.engine.plot.datasets.xyerrorbar.XYErrorBarDataSeriesSwappableTableArray;
...
import io.deephaven.engine.plot.util.functions.ClosureDoubleUnaryOperator;
...
public class AxesImpl implements Axes, PlotExceptionCause {
     ...
     */
    public ChartImpl chart() { return chart; }
    ...
    public PlotStyle getPlotStyle() {
        ...
        switch (chart.getChartType()){
            ...
            default:
                throw new PlotUnsupportedOperationException("No default plot style for chart type: " + chart.getChartType(), this);
        }
    }
    ...
    private void registerDataSeries(final SeriesCollection.SeriesType type, final boolean isMultiSeries, final SeriesInternal series){
    ...
    private static SelectableDataSet getLastBySelectableDataSet(final SelectableDataSet sds, final Collection<String> columns) {
        if(sds instanceof SelectableDataSetOneClick) {
    ...
    @Override
    public XYErrorBarDataSeriesArray errorBarXY(final Comparable seriesName, final Table t, final String x, final String xLow, final String xHigh, final String y, final String yLow, final String yHigh) {
        ...
        final XYErrorBarDataSeriesTableArray ds = new XYErrorBarDataSeriesTableArray(this, dataSeries.nextId(), seriesName, h, x, xLow, xHigh, y, yLow, yHigh, true, true);
        return errorBarXY(ds, hasXTimeAxis, hasYTimeAxis, new TableHandle[]{h}, null);
    }

    @Override
    public XYErrorBarDataSeriesArray errorBarXY(final Comparable seriesName, final SelectableDataSet sds, final String x, final String xLow, final String xHigh, final String y, final String yLow, final String yHigh) {
        ...
        final XYErrorBarDataSeriesSwappableTableArray ds = new XYErrorBarDataSeriesSwappableTableArray(this, dataSeries.nextId(), seriesName, t, x, xLow, xHigh, y, yLow, yHigh, true, true);
        return errorBarXY(ds, hasXTimeAxis, hasYTimeAxis, null, new SwappableTable[]{t});
    }

    @Override
    public MultiXYErrorBarSeries errorBarXYBy(final Comparable seriesName, final Table t, final String x, final String xLow, final String xHigh, final String y, final String yLow, final String yHigh, final String... byColumns) {
        ...
        final TableBackedTableMapHandle h = new TableBackedTableMapHandle(t, Arrays.asList(x, xLow, xHigh, y, yLow, yHigh), byColumns, new PlotInfo(this, seriesName));
        final MultiXYErrorBarSeries series = new MultiXYErrorBarSeries(this, dataSeries.nextId(), seriesName, h, x, xLow, xHigh, y, yLow, yHigh, byColumns, true, true);
    ...
    @Override
    public MultiXYErrorBarSeriesSwappable errorBarXYBy(final Comparable seriesName, final SelectableDataSet sds, final String x, final String xLow, final String xHigh, final String y, final String yLow, final String yHigh, final String... byColumns) {
        ...
        configureXYPlot();
        final MultiXYErrorBarSeriesSwappable series = new MultiXYErrorBarSeriesSwappable(this, dataSeries.nextId(), seriesName, t, x, xLow, xHigh, y, yLow, yHigh, byColumns, true, true);
    ...
    @Override
    public XYErrorBarDataSeries errorBarY( java.lang.Comparable seriesName, Table t, java.lang.String x, java.lang.String y, java.lang.String yLow, java.lang.String yHigh ) {
        final TableHandle h = new TableHandle(t, x, y, yLow, yHigh);
        final boolean hasXTimeAxis = ArgumentValidations.isTime(t, x, new PlotInfo(this, seriesName));
        final boolean hasYTimeAxis = ArgumentValidations.isTime(t, y, new PlotInfo(this, seriesName));
        final XYErrorBarDataSeriesTableArray ds = new XYErrorBarDataSeriesTableArray(this, dataSeries.nextId(), seriesName, h, x, null, null, y, yLow, yHigh, false, true);
        return errorBarXY(ds, hasXTimeAxis, hasYTimeAxis, new TableHandle[]{h}, null);
    }

    @Override
    public XYErrorBarDataSeries errorBarY( java.lang.Comparable seriesName, SelectableDataSet sds, java.lang.String x, java.lang.String y, java.lang.String yLow, java.lang.String yHigh ) {
        final SwappableTable t = sds.getSwappableTable(seriesName, chart, x, y, yLow, yHigh);

        final boolean hasXTimeAxis = ArgumentValidations.isTime(sds, x, new PlotInfo(this, seriesName));
        final boolean hasYTimeAxis = ArgumentValidations.isTime(sds, y, new PlotInfo(this, seriesName));

        final XYErrorBarDataSeriesSwappableTableArray ds = new XYErrorBarDataSeriesSwappableTableArray(this, dataSeries.nextId(), seriesName, t, x, null, null, y, yLow, yHigh, false, true);
        return errorBarXY(ds, hasXTimeAxis, hasYTimeAxis, null, new SwappableTable[]{t});
    }

    @Override
    public MultiXYErrorBarSeries errorBarYBy(final Comparable seriesName, final Table t, final String x, final String y, final String yLow, final String yHigh, final String... byColumns) {
        ArgumentValidations.assertNotNull(t, "t", new PlotInfo(this, seriesName));
        ArgumentValidations.assertNotNull(x, "x", new PlotInfo(this, seriesName));
        ArgumentValidations.assertNotNull(y, "y", new PlotInfo(this, seriesName));
        ArgumentValidations.assertNotNull(yLow, "yLow", new PlotInfo(this, seriesName));
        ...
        final TableBackedTableMapHandle h = new TableBackedTableMapHandle( t, Arrays.asList(x, y, yLow, yHigh), byColumns, new PlotInfo(this, seriesName));
        final MultiXYErrorBarSeries series = new MultiXYErrorBarSeries(this, dataSeries.nextId(), seriesName, h, x, null, null, y, yLow, yHigh, byColumns, false, true);
    ...
    @Override
    public MultiXYErrorBarSeriesSwappable errorBarYBy(final Comparable seriesName, final SelectableDataSet sds, final String x, final String y, final String yLow, final String yHigh, final String... byColumns) {
        ArgumentValidations.assertNotNull(sds, "sds", new PlotInfo(this, seriesName));
        ArgumentValidations.assertNotNull(x, "x", new PlotInfo(this, seriesName));
        ArgumentValidations.assertNotNull(y, "y", new PlotInfo(this, seriesName));
        ArgumentValidations.assertNotNull(yLow, "yLow", new PlotInfo(this, seriesName));
        ...
        final SwappableTable t = sds.getSwappableTable(seriesName, chart, columns);
        configureXYPlot();
        final MultiXYErrorBarSeriesSwappable series = new MultiXYErrorBarSeriesSwappable(this, dataSeries.nextId(), seriesName, t, x, null, null, y, yLow, yHigh, byColumns, false, true);
    ...
    @Override
    public XYErrorBarDataSeries errorBarX( java.lang.Comparable seriesName, Table t, java.lang.String x, java.lang.String xLow, java.lang.String xHigh, java.lang.String y ) {
        final TableHandle h = new TableHandle(t, x, xLow, xHigh, y);
        final boolean hasXTimeAxis = ArgumentValidations.isTime(t, x, new PlotInfo(this, seriesName));
        final boolean hasYTimeAxis = ArgumentValidations.isTime(t, y, new PlotInfo(this, seriesName));
        final XYErrorBarDataSeriesTableArray ds = new XYErrorBarDataSeriesTableArray(this, dataSeries.nextId(), seriesName, h, x, xLow, xHigh, y, null, null, true, false);
        return errorBarXY(ds, hasXTimeAxis, hasYTimeAxis, new TableHandle[]{h}, null);
    }

    @Override
    public XYErrorBarDataSeries errorBarX( java.lang.Comparable seriesName, SelectableDataSet sds, java.lang.String x, java.lang.String xLow, java.lang.String xHigh, java.lang.String y ) {
        final SwappableTable t = sds.getSwappableTable(seriesName, chart, x, xLow, xHigh, y);
        final boolean hasXTimeAxis = ArgumentValidations.isTime(sds, x, new PlotInfo(this, seriesName));
        final boolean hasYTimeAxis = ArgumentValidations.isTime(sds, y, new PlotInfo(this, seriesName));

        final XYErrorBarDataSeriesSwappableTableArray ds = new XYErrorBarDataSeriesSwappableTableArray(this, dataSeries.nextId(), seriesName, t, x, xLow, xHigh, y, null, null, true, false);
        return errorBarXY(ds, hasXTimeAxis, hasYTimeAxis, null, new SwappableTable[]{t});
    }

    @Override
    public MultiXYErrorBarSeries errorBarXBy(final Comparable seriesName, final Table t, final String x, final String xLow, final String xHigh, final String y, final String... byColumns) {
        ArgumentValidations.assertNotNull(t, "t", new PlotInfo(this, seriesName));
        ArgumentValidations.assertNotNull(x, "x", new PlotInfo(this, seriesName));
        ArgumentValidations.assertNotNull(xLow, "xLow", new PlotInfo(this, seriesName));
        ArgumentValidations.assertNotNull(xHigh, "xHigh", new PlotInfo(this, seriesName));
        ...
        final TableBackedTableMapHandle h = new TableBackedTableMapHandle( t, Arrays.asList(x, xLow, xHigh, y), byColumns, new PlotInfo(this, seriesName));
        final MultiXYErrorBarSeries series = new MultiXYErrorBarSeries(this, dataSeries.nextId(), seriesName, h, x, xLow, xHigh, y, null, null, byColumns, true, false);
    ...
    @Override
    public MultiXYErrorBarSeriesSwappable errorBarXBy(final Comparable seriesName, final SelectableDataSet sds, final String x, final String xLow, final String xHigh, final String y, final String... byColumns) {
        ArgumentValidations.assertNotNull(sds, "sds", new PlotInfo(this, seriesName));
        ArgumentValidations.assertNotNull(x, "x", new PlotInfo(this, seriesName));
        ArgumentValidations.assertNotNull(xLow, "xLow", new PlotInfo(this, seriesName));
        ArgumentValidations.assertNotNull(xHigh, "xHigh", new PlotInfo(this, seriesName));
        ...
        final SwappableTable t = sds.getSwappableTable(seriesName, chart, columns);
        configureXYPlot();
        final MultiXYErrorBarSeriesSwappable series = new MultiXYErrorBarSeriesSwappable(this, dataSeries.nextId(), seriesName, t, x, xLow, xHigh, y, null, null, byColumns, true, false);
    ...
    private XYErrorBarDataSeriesArray errorBarXY(final Comparable seriesName, final IndexableNumericData x, final IndexableNumericData xLow, final IndexableNumericData xHigh, final IndexableNumericData y, final IndexableNumericData yLow, final IndexableNumericData yHigh, final boolean hasXTimeAxis, final boolean hasYTimeAxis) {
        return errorBarXY(seriesName, x, xLow, xHigh, y, yLow, yHigh, true, true, hasXTimeAxis, hasYTimeAxis);
    }

    private XYErrorBarDataSeriesArray errorBarX(final Comparable seriesName, final IndexableNumericData x, final IndexableNumericData xLow, final IndexableNumericData xHigh, final IndexableNumericData y, final boolean drawXError, final boolean drawYError, final boolean hasXTimeAxis, final boolean hasYTimeAxis) {
        return errorBarXY(seriesName, x, xLow, xHigh, y, null, null, drawXError, drawYError, hasXTimeAxis, hasYTimeAxis);
    }

    private XYErrorBarDataSeriesArray errorBarY(final Comparable seriesName, final IndexableNumericData x, final IndexableNumericData y, final IndexableNumericData yLow, final IndexableNumericData yHigh, final boolean drawXError, final boolean drawYError, final boolean hasXTimeAxis, final boolean hasYTimeAxis) {
        return errorBarXY(seriesName, x, null, null, y, yLow, yHigh, drawXError, drawYError, hasXTimeAxis, hasYTimeAxis);
    }

    private XYErrorBarDataSeriesArray errorBarXY(final Comparable seriesName, final IndexableNumericData x, final IndexableNumericData xLow, final IndexableNumericData xHigh, final IndexableNumericData y, final IndexableNumericData yLow, final IndexableNumericData yHigh, final boolean drawXError, final boolean drawYError, final boolean hasXTimeAxis, final boolean hasYTimeAxis) {
        final XYErrorBarDataSeriesArray ds = new XYErrorBarDataSeriesArray(this, dataSeries.nextId(), seriesName, x, xLow, xHigh, y, yLow, yHigh, drawXError, drawYError);
        return errorBarXY(ds, hasXTimeAxis, hasYTimeAxis, null, null);
    }

    private XYErrorBarDataSeriesArray errorBarXY(final XYErrorBarDataSeriesArray series, final boolean hasXTimeAxis, final boolean hasYTimeAxis, final TableHandle[] tableHandles, final SwappableTable[] swappableTables) {
        configureXYPlot();
    ...
    @Override
    public CategoryDataSeries catErrorBar(final Comparable seriesName, final Table t, final String categories, final String values, final String yLow, final String yHigh) {
        ...
        return catPlot(new CategoryErrorBarDataSeriesTableMap(this, dataSeries.nextId(), seriesName, h, categories, values, yLow, yHigh), new TableHandle[]{h}, null);
    }

    @Override
    public CategoryDataSeries catErrorBar(final Comparable seriesName, final SelectableDataSet sds, final String categories, final String values, final String yLow, final String yHigh) {
        final SelectableDataSet lastBySelectableDataSet = getAggregatedSelectableDataSet(sds,
                () -> PlotUtils.createCategoryComboAgg(AggLast(values, yLow, yHigh)), Collections.singletonList(categories));
        final SwappableTable t = lastBySelectableDataSet.getSwappableTable(seriesName, chart, categories, values, yLow, yHigh, CategoryDataSeries.CAT_SERIES_ORDER_COLUMN);

        if( ArgumentValidations.isTime(lastBySelectableDataSet, values, new PlotInfo(this, seriesName)) ){
            axes[1].axisFormat(new NanosAxisFormat());
        }

        return catPlot(new CategoryErrorBarDataSeriesSwappableTableMap(this, dataSeries.nextId(), seriesName, t, categories, values, yLow, yHigh), null, new SwappableTable[]{t});
    }

    @Override
    public MultiSeries catErrorBarBy(final Comparable seriesName, final Table t, final String categories, final String values, final String yLow, final String yHigh, final String... byColumns) {
        ArgumentValidations.assertNotNull(t, "t", new PlotInfo(this, seriesName));
        ...
        final TableBackedTableMapHandle h = PlotUtils.createCategoryTableMapHandle( t, categories, new String[]{values, yLow, yHigh}, byColumns, new PlotInfo(this, seriesName));
        final MultiCatErrorBarSeries series = new MultiCatErrorBarSeries(this, dataSeries.nextId(), seriesName, h, categories, values, yLow, yHigh, byColumns);
    ...
    @Override
    public MultiSeries catErrorBarBy(final Comparable seriesName, final SelectableDataSet sds, final String categories, final String values, final String yLow, final String yHigh, final String... byColumns) {
        ArgumentValidations.assertNotNull(sds, "sds", new PlotInfo(this, seriesName));
        ArgumentValidations.assertNotNull(categories, "categories", new PlotInfo(this, seriesName));
        ArgumentValidations.assertNotNull(values, "values", new PlotInfo(this, seriesName));
        ArgumentValidations.assertNotNull(yLow, "yLow", new PlotInfo(this, seriesName));
        ...
        final MultiCatErrorBarSeriesSwappable series = new MultiCatErrorBarSeriesSwappable(this, dataSeries.nextId(), seriesName, t, categories, values, yLow, yHigh, byColumns);
    ...
    public XYDataSeriesFunctionImpl plot(final Comparable seriesName, final DoubleUnaryOperator function) {
        configureXYPlot();
        final XYDataSeriesFunctionImpl ds = new XYDataSeriesFunctionImpl(this, dataSeries.nextId(), seriesName, function);
    ...
    private XYDataSeriesArray plot(final XYDataSeriesArray series, final boolean hasXTimeAxis, final boolean hasYTimeAxis, final TableHandle[] tableHandles, final SwappableTable[] swappableTables) {
        configureXYPlot();
    ...
    @Override
    public XYDataSeriesArray plot(final Comparable seriesName, final IndexableNumericData x, final IndexableNumericData y, final boolean hasXTimeAxis, final boolean hasYTimeAxis) {
    ...
    @Override
    public XYDataSeriesArray plot(final Comparable seriesName, final SelectableDataSet sds, final String x, final String y) {
        final SwappableTable t = sds.getSwappableTable(seriesName, chart, x, y);
        final boolean hasXTimeAxis = ArgumentValidations.isTime(sds, x, new PlotInfo(this, seriesName));
        final boolean hasYTimeAxis = ArgumentValidations.isTime(sds, y, new PlotInfo(this, seriesName));

        final XYDataSeriesSwappableTableArray ds = new XYDataSeriesSwappableTableArray(this, dataSeries.nextId(), seriesName, t, x, y);
        return plot(ds, hasXTimeAxis, hasYTimeAxis, null, new SwappableTable[]{t});
    }

    @Override
    public MultiXYSeries plotBy(final Comparable seriesName, final Table t, final String x, final String y, final String... byColumns) {
        ArgumentValidations.assertNotNull(t, "t", new PlotInfo(this, seriesName));
        ArgumentValidations.assertNotNull(x, "x", new PlotInfo(this, seriesName));
        ArgumentValidations.assertNotNull(y, "y", new PlotInfo(this, seriesName));
        ArgumentValidations.assertNotNullAndNotEmpty(byColumns, "byColumns", new PlotInfo(this, seriesName));
        ...
        final TableBackedTableMapHandle h = new TableBackedTableMapHandle( t, Arrays.asList(x, y), byColumns, new PlotInfo(this, seriesName));
    ...
    @Override
    public MultiXYSeriesSwappable plotBy(final Comparable seriesName, final SelectableDataSet sds, final String x, final String y, final String... byColumns) {
        ArgumentValidations.assertNotNull(sds, "sds", new PlotInfo(this, seriesName));
        ArgumentValidations.assertNotNull(x, "x", new PlotInfo(this, seriesName));
        ArgumentValidations.assertNotNull(y, "y", new PlotInfo(this, seriesName));
        ArgumentValidations.assertNotNullAndNotEmpty(byColumns, "byColumns", new PlotInfo(this, seriesName));
        ...
        final MultiXYSeriesSwappable series = new MultiXYSeriesSwappable(this, dataSeries.nextId(), seriesName, t, x, y, byColumns);
    ...
    private void setUpPlotBySeries(final TableDefinition t, final String x, final String y, final SeriesInternal series) {
    ...
    @Override
    public OHLCDataSeriesArray ohlcPlot(final Comparable seriesName, final IndexableNumericData time, final IndexableNumericData open, final IndexableNumericData high, final IndexableNumericData low, final IndexableNumericData close) {
        configureOHLCPlot();
        final OHLCDataSeriesArray ds = new OHLCDataSeriesArray(this, dataSeries.nextId(), seriesName, time, open, high, low, close);
    ...
    @Override
    public OHLCDataSeriesTableArray ohlcPlot(final Comparable seriesName, final Table t, final String timeCol, final String openCol, final String highCol, final String lowCol, final String closeCol) {
        configureOHLCPlot();
        final TableHandle h = new TableHandle(t, timeCol, openCol, highCol, lowCol, closeCol);

        final OHLCDataSeriesTableArray ds = new OHLCDataSeriesTableArray(this, dataSeries.nextId(), seriesName, h, timeCol, openCol, highCol, lowCol, closeCol);
    ...
    @Override
    public OHLCDataSeriesArray ohlcPlot(final Comparable seriesName, final SelectableDataSet sds, final String timeCol, final String openCol, final String highCol, final String lowCol, final String closeCol) {
        configureOHLCPlot();
        final SwappableTable t = sds.getSwappableTable(seriesName, chart, timeCol, openCol, highCol, lowCol, closeCol);

        final OHLCDataSeriesSwappableTableArray ds = new OHLCDataSeriesSwappableTableArray(this, dataSeries.nextId(), seriesName, t, timeCol, openCol, highCol, lowCol, closeCol);
    ...
    @Override
    public MultiOHLCSeries ohlcPlotBy(final Comparable seriesName, final Table t, final String timeCol, final String openCol, final String highCol, final String lowCol, final String closeCol, final String... byColumns) {
        ArgumentValidations.assertNotNull(t, "t", new PlotInfo(this, seriesName));
        ...
        final TableBackedTableMapHandle h = new TableBackedTableMapHandle( t, Arrays.asList(timeCol, openCol, highCol, lowCol, closeCol), byColumns, new PlotInfo(this, seriesName));
        final MultiOHLCSeries series = new MultiOHLCSeries(this, dataSeries.nextId(), seriesName, h, timeCol, openCol, highCol, lowCol, closeCol, byColumns);
    ...
    @Override
    public MultiOHLCSeriesSwappable ohlcPlotBy(final Comparable seriesName, final SelectableDataSet sds, final String timeCol, final String openCol, final String highCol, final String lowCol, final String closeCol, final String... byColumns) {
        ArgumentValidations.assertNotNull(sds, "sds", new PlotInfo(this, seriesName));
        ArgumentValidations.assertNotNull(timeCol, "timeCol", new PlotInfo(this, seriesName));
        ArgumentValidations.assertNotNull(openCol, "openCol", new PlotInfo(this, seriesName));
        ArgumentValidations.assertNotNull(highCol, "highCol", new PlotInfo(this, seriesName));
        ...
        final SwappableTable t = sds.getSwappableTable(seriesName, chart, columns);
        configureOHLCPlot();
        final MultiOHLCSeriesSwappable series = new MultiOHLCSeriesSwappable(this, dataSeries.nextId(), seriesName, t, timeCol, openCol, highCol, lowCol, closeCol, byColumns);
    ...
    public IntervalXYDataSeriesArray histPlot(final Comparable seriesName, final Table counts) {
        ArgumentValidations.assertColumnsInTable(counts, new PlotInfo(this, seriesName), BIN_MIN, BIN_MID, BIN_MAX, COUNT);
        configureXYPlot();
        ...
        final IntervalXYDataSeriesArray ds = new IntervalXYDataSeriesArray(this, dataSeries.nextId(), seriesName, h, startX, midX, endX, y, y, y);
        ds.addTableHandle(h);
    ...
    @Override
    public IntervalXYDataSeriesArray histPlot(final Comparable seriesName, final Table t, final String columnName, final int nbins) {
        ArgumentValidations.assertIsNumeric(t, columnName, "Histogram can not be computed on non-numeric column: "+ columnName, new PlotInfo(this, seriesName));
        return histPlot(seriesName, HistogramCalculator.calc(t, columnName, nbins, new PlotInfo(this, seriesName)));
    }

    @Override
    public IntervalXYDataSeriesArray histPlot(final Comparable seriesName, final Table t, final String columnName, final double rangeMin, final double rangeMax, final int nbins) {
        ArgumentValidations.assertIsNumeric(t, columnName, "Histogram can not be computed on non-numeric column: "+ columnName, new PlotInfo(this, seriesName));
        return histPlot(seriesName, HistogramCalculator.calc(t, columnName, rangeMin, rangeMax, nbins, new PlotInfo(this, seriesName)));
    }
    ...
    private IntervalXYDataSeriesArray histPlot(final Comparable seriesName, final SwappableTable counts) {
        ...
        ArgumentValidations.assertColumnsInTable(counts.getTableDefinition(), new PlotInfo(this, seriesName), BIN_MIN, BIN_MID, BIN_MAX, COUNT);

        final IndexableNumericData startX = new IndexableNumericDataSwappableTable(counts, BIN_MIN, new PlotInfo(this, seriesName));
        final IndexableNumericData midX = new IndexableNumericDataSwappableTable(counts, BIN_MID, new PlotInfo(this, seriesName));
        final IndexableNumericData endX = new IndexableNumericDataSwappableTable(counts, BIN_MAX, new PlotInfo(this, seriesName));
        // does Y need separate values for min, mid, and max?
        final IndexableNumericData y = new IndexableNumericDataSwappableTable(counts, COUNT, new PlotInfo(this, seriesName));
        final IntervalXYDataSeriesArray ds = new IntervalXYDataSeriesArray(this, dataSeries.nextId(), seriesName, counts, startX, midX, endX, y, y, y);
    ...
    @Override
    public IntervalXYDataSeriesArray histPlot(final Comparable seriesName, final SelectableDataSet sds, final String columnName, final int nbins) {
        final PlotInfo plotInfo = new PlotInfo(this, seriesName);
        ArgumentValidations.assertIsNumeric(sds, columnName, "Histogram can not be computed on non-numeric column: " + columnName, plotInfo);
        ...
        final Function<Table, Table> tableTransform = (Function<Table, Table> & Serializable) t -> HistogramCalculator.calc(t, columnName, nbins, plotInfo, byCols);

        final List<String> allCols = new ArrayList<>(byCols);
        allCols.add(columnName);
        final SwappableTable ht = sds.getSwappableTable(seriesName, chart, tableTransform, allCols.toArray(CollectionUtil.ZERO_LENGTH_STRING_ARRAY));
        return histPlot(seriesName, ht);
    }

    @Override
    public IntervalXYDataSeriesArray histPlot(final Comparable seriesName, final SelectableDataSet sds, final String columnName, final double rangeMin, final double rangeMax, final int nbins) {
        final PlotInfo plotInfo = new PlotInfo(this, seriesName);
        ArgumentValidations.assertIsNumeric(sds, columnName, "Histogram can not be computed on non-numeric column: " + columnName, plotInfo);
        ...
        final Function<Table, Table> tableTransform = (Function<Table, Table> & Serializable) t -> HistogramCalculator.calc(t, columnName, rangeMin, rangeMax, nbins, plotInfo, byCols);
    ...
    public CategoryDataSeriesTableMap catHistPlot(final Comparable seriesName, final Table t, final String columnName) {
        ...
        final CategoryDataSeriesTableMap ds = new CategoryDataSeriesTableMap(this, dataSeries.nextId(), seriesName, h, columnName, COUNT);
        ds.addTableHandle(h);
    ...
    @Override
    public CategoryDataSeriesSwappableTableMap catHistPlot(final Comparable seriesName, final SelectableDataSet sds, final String columnName) {
        configureCategoryPlot();
        plotStyle(PlotStyle.HISTOGRAM);
        ...
        final Function<Table, Table> tableTransform = (Function<Table, Table> & Serializable) t -> PlotUtils.createCategoryHistogramTable(t, cols.toArray(CollectionUtil.ZERO_LENGTH_STRING_ARRAY));
        final SwappableTable counts = sds.getSwappableTable(seriesName, chart, tableTransform, columnName, CategoryDataSeries.CAT_SERIES_ORDER_COLUMN);
        final CategoryDataSeriesSwappableTableMap ds = new CategoryDataSeriesSwappableTableMap(this, dataSeries.nextId(), seriesName, counts, columnName, COUNT);
        ds.addSwappableTable(counts);
        registerDataSeries(SeriesCollection.SeriesType.CATEGORY, false, ds);
        return ds;
    }
    ...
    private CategoryDataSeriesInternal catPlot(final CategoryDataSeriesInternal ds, final TableHandle[] tableHandles, final SwappableTable[] swappableTables) {
        return catPlot(ds, tableHandles, swappableTables, false);
    }

    private CategoryDataSeriesInternal catPlot(final CategoryDataSeriesInternal ds, final TableHandle[] tableHandles, final SwappableTable[] swappableTables, final boolean hasYTimeAxis) {
        configureCategoryPlot();
    ...
    @Override
    public <T1 extends Comparable> CategoryDataSeriesInternal catPlot(final Comparable seriesName, final IndexableData<T1> categories, final IndexableNumericData values) {
        return catPlot(seriesName , categories, values, false);
    }

    private <T1 extends Comparable> CategoryDataSeriesInternal catPlot(final Comparable seriesName, final IndexableData<T1> categories, final IndexableNumericData values, final boolean hasYTimeAxis) {
        if (hasYTimeAxis) {
            axes[1].axisFormat(new NanosAxisFormat());
        }

        return catPlot(new CategoryDataSeriesMap(this, dataSeries.nextId(), seriesName, categories, values), null, null);
    }

    @Override
    public CategoryDataSeriesInternal catPlot(final Comparable seriesName, final Table t, final String categories, final String values) {
        final TableHandle h = PlotUtils.createCategoryTableHandle( t, categories, values);
        return catPlot(new CategoryDataSeriesTableMap(this, dataSeries.nextId(), seriesName, h, categories, values), new TableHandle[]{h}, null, ArgumentValidations.isTime(t, values, new PlotInfo(this, seriesName)));
    }

    @Override
    public CategoryDataSeriesInternal catPlot(final Comparable seriesName, final SelectableDataSet sds, final String categories, final String values) {
        final SelectableDataSet lastBySelectableDataSet = getAggregatedSelectableDataSet(sds,
                () -> PlotUtils.createCategoryComboAgg(AggLast(values)), Collections.singletonList(categories));
        final SwappableTable t = lastBySelectableDataSet.getSwappableTable(seriesName, chart, categories, values, CategoryDataSeries.CAT_SERIES_ORDER_COLUMN);
        return catPlot(new CategoryDataSeriesSwappableTableMap(this, dataSeries.nextId(), seriesName, t, categories, values), null, new SwappableTable[]{t}, ArgumentValidations.isTime(sds, values, new PlotInfo(this, seriesName)));
    }

    @Override
    public MultiCatSeries catPlotBy(final Comparable seriesName, final Table t, final String categories, final String values, final String... byColumns) {
        ArgumentValidations.assertNotNull(t, "t", new PlotInfo(this, seriesName));
        ArgumentValidations.assertNotNull(categories, "categories", new PlotInfo(this, seriesName));
        ArgumentValidations.assertNotNull(values, "values", new PlotInfo(this, seriesName));
        ArgumentValidations.assertNotNullAndNotEmpty(byColumns, "byColumns", new PlotInfo(this, seriesName));
        ...
        final TableBackedTableMapHandle h = PlotUtils.createCategoryTableMapHandle(t, categories, new String[]{values}, byColumns, new PlotInfo(this, seriesName));
        final MultiCatSeries series = new MultiCatSeries(this, dataSeries.nextId(), seriesName, h, categories, values, byColumns);
    ...
    @Override
    public MultiCatSeriesSwappable catPlotBy(final Comparable seriesName, final SelectableDataSet sds, final String categories, final String values, final String... byColumns) {
        ArgumentValidations.assertNotNull(sds, "sds", new PlotInfo(this, seriesName));
        ArgumentValidations.assertNotNull(categories, "categories", new PlotInfo(this, seriesName));
        ...
        final SwappableTable t = lastBySelectableDataSet.getSwappableTable(seriesName, chart, columns);
        configureCategoryPlot();
        final MultiCatSeriesSwappable series = new MultiCatSeriesSwappable(this, dataSeries.nextId(), seriesName, t, categories, values, byColumns);
    ...
    private CategoryDataSeriesInternal piePlot(final CategoryDataSeriesInternal ds, final TableHandle[] tableHandles, final SwappableTable[] swappableTables) {
        configurePiePlot();
    ...
    @Override
    public <T1 extends Comparable> CategoryDataSeriesInternal piePlot(final Comparable seriesName, final IndexableData<T1> categories, final IndexableNumericData values) {
        return piePlot(new CategoryDataSeriesMap(this, dataSeries.nextId(), seriesName, categories, values), null, null);
    }

    @Override
    public CategoryDataSeriesInternal piePlot(final Comparable seriesName, final Table t, final String categories, final String values) {
        final TableHandle h = PlotUtils.createCategoryTableHandle( t, categories, values);
        return piePlot(new CategoryDataSeriesTableMap(this, dataSeries.nextId(), seriesName, h, categories, values), new TableHandle[]{h}, null);
    }

    @Override
    public CategoryDataSeriesInternal piePlot(final Comparable seriesName, final SelectableDataSet sds, final String categories, final String values) {
        final SelectableDataSet lastBySelectableDataSet = getAggregatedSelectableDataSet(sds,
                () -> PlotUtils.createCategoryComboAgg(AggLast(values)), Collections.singletonList(categories));
        final SwappableTable t = lastBySelectableDataSet.getSwappableTable(seriesName, chart, categories, values, CategoryDataSeries.CAT_SERIES_ORDER_COLUMN);
        return piePlot(new CategoryDataSeriesSwappableTableMap(this, dataSeries.nextId(), seriesName, t, categories, values), null, new SwappableTable[]{t});
    }
    //endregion
    ...
    @Override public  XYDataSeriesArray plot(final Comparable seriesName, final Date[] x, final DBDateTime[] y) {
        return plot(seriesName, new IndexableNumericDataArrayDate(x, new PlotInfo(this, seriesName)), new IndexableNumericDataArrayDBDateTime(y, new PlotInfo(this, seriesName)), true, true);
    }
    ...
    @Override public  XYDataSeriesArray plot(final Comparable seriesName, final DBDateTime[] x, final Date[] y) {
        return plot(seriesName, new IndexableNumericDataArrayDBDateTime(x, new PlotInfo(this, seriesName)), new IndexableNumericDataArrayDate(y, new PlotInfo(this, seriesName)), true, true);
    }

    @Override public  XYDataSeriesArray plot(final Comparable seriesName, final DBDateTime[] x, final DBDateTime[] y) {
        return plot(seriesName, new IndexableNumericDataArrayDBDateTime(x, new PlotInfo(this, seriesName)), new IndexableNumericDataArrayDBDateTime(y, new PlotInfo(this, seriesName)), true, true);
    }

    @Override public  XYDataSeriesArray plot(final Comparable seriesName, final DBDateTime[] x, final short[] y) {
        return plot(seriesName, new IndexableNumericDataArrayDBDateTime(x, new PlotInfo(this, seriesName)), new IndexableNumericDataArrayShort(y, new PlotInfo(this, seriesName)), true, false);
    }

    @Override public  XYDataSeriesArray plot(final Comparable seriesName, final DBDateTime[] x, final int[] y) {
        return plot(seriesName, new IndexableNumericDataArrayDBDateTime(x, new PlotInfo(this, seriesName)), new IndexableNumericDataArrayInt(y, new PlotInfo(this, seriesName)), true, false);
    }

    @Override public  XYDataSeriesArray plot(final Comparable seriesName, final DBDateTime[] x, final long[] y) {
        return plot(seriesName, new IndexableNumericDataArrayDBDateTime(x, new PlotInfo(this, seriesName)), new IndexableNumericDataArrayLong(y, new PlotInfo(this, seriesName)), true, false);
    }

    @Override public  XYDataSeriesArray plot(final Comparable seriesName, final DBDateTime[] x, final float[] y) {
        return plot(seriesName, new IndexableNumericDataArrayDBDateTime(x, new PlotInfo(this, seriesName)), new IndexableNumericDataArrayFloat(y, new PlotInfo(this, seriesName)), true, false);
    }

    @Override public  XYDataSeriesArray plot(final Comparable seriesName, final DBDateTime[] x, final double[] y) {
        return plot(seriesName, new IndexableNumericDataArrayDBDateTime(x, new PlotInfo(this, seriesName)), new IndexableNumericDataArrayDouble(y, new PlotInfo(this, seriesName)), true, false);
    }

    @Override public <T1 extends Number> XYDataSeriesArray plot(final Comparable seriesName, final DBDateTime[] x, final T1[] y) {
        return plot(seriesName, new IndexableNumericDataArrayDBDateTime(x, new PlotInfo(this, seriesName)), new IndexableNumericDataArrayNumber<>(y, new PlotInfo(this, seriesName)), true, false);
    }

    @Override public <T1 extends Number> XYDataSeriesArray plot(final Comparable seriesName, final DBDateTime[] x, final List<T1> y) {
        return plot(seriesName, new IndexableNumericDataArrayDBDateTime(x, new PlotInfo(this, seriesName)), new IndexableNumericDataListNumber<>(y, new PlotInfo(this, seriesName)), true, false);
    }
    ...
    @Override public  XYDataSeriesArray plot(final Comparable seriesName, final short[] x, final DBDateTime[] y) {
        return plot(seriesName, new IndexableNumericDataArrayShort(x, new PlotInfo(this, seriesName)), new IndexableNumericDataArrayDBDateTime(y, new PlotInfo(this, seriesName)), false, true);
    }
    ...
    @Override public  XYDataSeriesArray plot(final Comparable seriesName, final int[] x, final DBDateTime[] y) {
        return plot(seriesName, new IndexableNumericDataArrayInt(x, new PlotInfo(this, seriesName)), new IndexableNumericDataArrayDBDateTime(y, new PlotInfo(this, seriesName)), false, true);
    }
    ...
    @Override public  XYDataSeriesArray plot(final Comparable seriesName, final long[] x, final DBDateTime[] y) {
        return plot(seriesName, new IndexableNumericDataArrayLong(x, new PlotInfo(this, seriesName)), new IndexableNumericDataArrayDBDateTime(y, new PlotInfo(this, seriesName)), false, true);
    }
    ...
    @Override public  XYDataSeriesArray plot(final Comparable seriesName, final float[] x, final DBDateTime[] y) {
        return plot(seriesName, new IndexableNumericDataArrayFloat(x, new PlotInfo(this, seriesName)), new IndexableNumericDataArrayDBDateTime(y, new PlotInfo(this, seriesName)), false, true);
    }
    ...
    @Override public  XYDataSeriesArray plot(final Comparable seriesName, final double[] x, final DBDateTime[] y) {
        return plot(seriesName, new IndexableNumericDataArrayDouble(x, new PlotInfo(this, seriesName)), new IndexableNumericDataArrayDBDateTime(y, new PlotInfo(this, seriesName)), false, true);
    }
    ...
    @Override public <T0 extends Number> XYDataSeriesArray plot(final Comparable seriesName, final T0[] x, final DBDateTime[] y) {
        return plot(seriesName, new IndexableNumericDataArrayNumber<>(x, new PlotInfo(this, seriesName)), new IndexableNumericDataArrayDBDateTime(y, new PlotInfo(this, seriesName)), false, true);
    }
    ...
    @Override public <T0 extends Number> XYDataSeriesArray plot(final Comparable seriesName, final List<T0> x, final DBDateTime[] y) {
        return plot(seriesName, new IndexableNumericDataListNumber<>(x, new PlotInfo(this, seriesName)), new IndexableNumericDataArrayDBDateTime(y, new PlotInfo(this, seriesName)), false, true);
    }
    ...
    @Override public  OHLCDataSeriesArray ohlcPlot(final Comparable seriesName, final DBDateTime[] time, final short[] open, final short[] high, final short[] low, final short[] close) {
        return ohlcPlot(seriesName, new IndexableNumericDataArrayDBDateTime(time, new PlotInfo(this, seriesName)), new IndexableNumericDataArrayShort(open, new PlotInfo(this, seriesName)), new IndexableNumericDataArrayShort(high, new PlotInfo(this, seriesName)), new IndexableNumericDataArrayShort(low, new PlotInfo(this, seriesName)), new IndexableNumericDataArrayShort(close, new PlotInfo(this, seriesName)));
    }
    ...
    @Override public  OHLCDataSeriesArray ohlcPlot(final Comparable seriesName, final DBDateTime[] time, final int[] open, final int[] high, final int[] low, final int[] close) {
        return ohlcPlot(seriesName, new IndexableNumericDataArrayDBDateTime(time, new PlotInfo(this, seriesName)), new IndexableNumericDataArrayInt(open, new PlotInfo(this, seriesName)), new IndexableNumericDataArrayInt(high, new PlotInfo(this, seriesName)), new IndexableNumericDataArrayInt(low, new PlotInfo(this, seriesName)), new IndexableNumericDataArrayInt(close, new PlotInfo(this, seriesName)));
    }
    ...
    @Override public  OHLCDataSeriesArray ohlcPlot(final Comparable seriesName, final DBDateTime[] time, final long[] open, final long[] high, final long[] low, final long[] close) {
        return ohlcPlot(seriesName, new IndexableNumericDataArrayDBDateTime(time, new PlotInfo(this, seriesName)), new IndexableNumericDataArrayLong(open, new PlotInfo(this, seriesName)), new IndexableNumericDataArrayLong(high, new PlotInfo(this, seriesName)), new IndexableNumericDataArrayLong(low, new PlotInfo(this, seriesName)), new IndexableNumericDataArrayLong(close, new PlotInfo(this, seriesName)));
    }
    ...
    @Override public  OHLCDataSeriesArray ohlcPlot(final Comparable seriesName, final DBDateTime[] time, final float[] open, final float[] high, final float[] low, final float[] close) {
        return ohlcPlot(seriesName, new IndexableNumericDataArrayDBDateTime(time, new PlotInfo(this, seriesName)), new IndexableNumericDataArrayFloat(open, new PlotInfo(this, seriesName)), new IndexableNumericDataArrayFloat(high, new PlotInfo(this, seriesName)), new IndexableNumericDataArrayFloat(low, new PlotInfo(this, seriesName)), new IndexableNumericDataArrayFloat(close, new PlotInfo(this, seriesName)));
    }
    ...
    @Override public  OHLCDataSeriesArray ohlcPlot(final Comparable seriesName, final DBDateTime[] time, final double[] open, final double[] high, final double[] low, final double[] close) {
        return ohlcPlot(seriesName, new IndexableNumericDataArrayDBDateTime(time, new PlotInfo(this, seriesName)), new IndexableNumericDataArrayDouble(open, new PlotInfo(this, seriesName)), new IndexableNumericDataArrayDouble(high, new PlotInfo(this, seriesName)), new IndexableNumericDataArrayDouble(low, new PlotInfo(this, seriesName)), new IndexableNumericDataArrayDouble(close, new PlotInfo(this, seriesName)));
    }
    ...
    @Override public <T1 extends Number,T2 extends Number,T3 extends Number,T4 extends Number> OHLCDataSeriesArray ohlcPlot(final Comparable seriesName, final DBDateTime[] time, final T1[] open, final T2[] high, final T3[] low, final T4[] close) {
        return ohlcPlot(seriesName, new IndexableNumericDataArrayDBDateTime(time, new PlotInfo(this, seriesName)), new IndexableNumericDataArrayNumber<>(open, new PlotInfo(this, seriesName)), new IndexableNumericDataArrayNumber<>(high, new PlotInfo(this, seriesName)), new IndexableNumericDataArrayNumber<>(low, new PlotInfo(this, seriesName)), new IndexableNumericDataArrayNumber<>(close, new PlotInfo(this, seriesName)));
    }
    ...
    @Override public <T1 extends Number,T2 extends Number,T3 extends Number,T4 extends Number> OHLCDataSeriesArray ohlcPlot(final Comparable seriesName, final DBDateTime[] time, final List<T1> open, final List<T2> high, final List<T3> low, final List<T4> close) {
        return ohlcPlot(seriesName, new IndexableNumericDataArrayDBDateTime(time, new PlotInfo(this, seriesName)), new IndexableNumericDataListNumber<>(open, new PlotInfo(this, seriesName)), new IndexableNumericDataListNumber<>(high, new PlotInfo(this, seriesName)), new IndexableNumericDataListNumber<>(low, new PlotInfo(this, seriesName)), new IndexableNumericDataListNumber<>(close, new PlotInfo(this, seriesName)));
    }
    ...
    @Override public  XYErrorBarDataSeriesArray errorBarXY(final Comparable seriesName, final DBDateTime[] x, final DBDateTime[] xLow, final DBDateTime[] xHigh, final DBDateTime[] y, final DBDateTime[] yLow, final DBDateTime[] yHigh) {
        return errorBarXY(seriesName, new IndexableNumericDataArrayDBDateTime(x, new PlotInfo(this, seriesName)), new IndexableNumericDataArrayDBDateTime(xLow, new PlotInfo(this, seriesName)), new IndexableNumericDataArrayDBDateTime(xHigh, new PlotInfo(this, seriesName)), new IndexableNumericDataArrayDBDateTime(y, new PlotInfo(this, seriesName)), new IndexableNumericDataArrayDBDateTime(yLow, new PlotInfo(this, seriesName)), new IndexableNumericDataArrayDBDateTime(yHigh, new PlotInfo(this, seriesName)), true, true, true, true);
    }
    ...
    @Override public  XYErrorBarDataSeriesArray errorBarXY(final Comparable seriesName, final DBDateTime[] x, final DBDateTime[] xLow, final DBDateTime[] xHigh, final short[] y, final short[] yLow, final short[] yHigh) {
        return errorBarXY(seriesName, new IndexableNumericDataArrayDBDateTime(x, new PlotInfo(this, seriesName)), new IndexableNumericDataArrayDBDateTime(xLow, new PlotInfo(this, seriesName)), new IndexableNumericDataArrayDBDateTime(xHigh, new PlotInfo(this, seriesName)), new IndexableNumericDataArrayShort(y, new PlotInfo(this, seriesName)), new IndexableNumericDataArrayShort(yLow, new PlotInfo(this, seriesName)), new IndexableNumericDataArrayShort(yHigh, new PlotInfo(this, seriesName)), true, true, true, false);
    }

    @Override public  XYErrorBarDataSeriesArray errorBarXY(final Comparable seriesName, final short[] x, final short[] xLow, final short[] xHigh, final DBDateTime[] y, final DBDateTime[] yLow, final DBDateTime[] yHigh) {
        return errorBarXY(seriesName, new IndexableNumericDataArrayShort(x, new PlotInfo(this, seriesName)), new IndexableNumericDataArrayShort(xLow, new PlotInfo(this, seriesName)), new IndexableNumericDataArrayShort(xHigh, new PlotInfo(this, seriesName)), new IndexableNumericDataArrayDBDateTime(y, new PlotInfo(this, seriesName)), new IndexableNumericDataArrayDBDateTime(yLow, new PlotInfo(this, seriesName)), new IndexableNumericDataArrayDBDateTime(yHigh, new PlotInfo(this, seriesName)), true, true, false, true);
    }

    @Override public  XYErrorBarDataSeriesArray errorBarXY(final Comparable seriesName, final DBDateTime[] x, final DBDateTime[] xLow, final DBDateTime[] xHigh, final int[] y, final int[] yLow, final int[] yHigh) {
        return errorBarXY(seriesName, new IndexableNumericDataArrayDBDateTime(x, new PlotInfo(this, seriesName)), new IndexableNumericDataArrayDBDateTime(xLow, new PlotInfo(this, seriesName)), new IndexableNumericDataArrayDBDateTime(xHigh, new PlotInfo(this, seriesName)), new IndexableNumericDataArrayInt(y, new PlotInfo(this, seriesName)), new IndexableNumericDataArrayInt(yLow, new PlotInfo(this, seriesName)), new IndexableNumericDataArrayInt(yHigh, new PlotInfo(this, seriesName)), true, true, true, false);
    }

    @Override public  XYErrorBarDataSeriesArray errorBarXY(final Comparable seriesName, final int[] x, final int[] xLow, final int[] xHigh, final DBDateTime[] y, final DBDateTime[] yLow, final DBDateTime[] yHigh) {
        return errorBarXY(seriesName, new IndexableNumericDataArrayInt(x, new PlotInfo(this, seriesName)), new IndexableNumericDataArrayInt(xLow, new PlotInfo(this, seriesName)), new IndexableNumericDataArrayInt(xHigh, new PlotInfo(this, seriesName)), new IndexableNumericDataArrayDBDateTime(y, new PlotInfo(this, seriesName)), new IndexableNumericDataArrayDBDateTime(yLow, new PlotInfo(this, seriesName)), new IndexableNumericDataArrayDBDateTime(yHigh, new PlotInfo(this, seriesName)), true, true, false, true);
    }

    @Override public  XYErrorBarDataSeriesArray errorBarXY(final Comparable seriesName, final DBDateTime[] x, final DBDateTime[] xLow, final DBDateTime[] xHigh, final long[] y, final long[] yLow, final long[] yHigh) {
        return errorBarXY(seriesName, new IndexableNumericDataArrayDBDateTime(x, new PlotInfo(this, seriesName)), new IndexableNumericDataArrayDBDateTime(xLow, new PlotInfo(this, seriesName)), new IndexableNumericDataArrayDBDateTime(xHigh, new PlotInfo(this, seriesName)), new IndexableNumericDataArrayLong(y, new PlotInfo(this, seriesName)), new IndexableNumericDataArrayLong(yLow, new PlotInfo(this, seriesName)), new IndexableNumericDataArrayLong(yHigh, new PlotInfo(this, seriesName)), true, true, true, false);
    }

    @Override public  XYErrorBarDataSeriesArray errorBarXY(final Comparable seriesName, final long[] x, final long[] xLow, final long[] xHigh, final DBDateTime[] y, final DBDateTime[] yLow, final DBDateTime[] yHigh) {
        return errorBarXY(seriesName, new IndexableNumericDataArrayLong(x, new PlotInfo(this, seriesName)), new IndexableNumericDataArrayLong(xLow, new PlotInfo(this, seriesName)), new IndexableNumericDataArrayLong(xHigh, new PlotInfo(this, seriesName)), new IndexableNumericDataArrayDBDateTime(y, new PlotInfo(this, seriesName)), new IndexableNumericDataArrayDBDateTime(yLow, new PlotInfo(this, seriesName)), new IndexableNumericDataArrayDBDateTime(yHigh, new PlotInfo(this, seriesName)), true, true, false, true);
    }

    @Override public  XYErrorBarDataSeriesArray errorBarXY(final Comparable seriesName, final DBDateTime[] x, final DBDateTime[] xLow, final DBDateTime[] xHigh, final float[] y, final float[] yLow, final float[] yHigh) {
        return errorBarXY(seriesName, new IndexableNumericDataArrayDBDateTime(x, new PlotInfo(this, seriesName)), new IndexableNumericDataArrayDBDateTime(xLow, new PlotInfo(this, seriesName)), new IndexableNumericDataArrayDBDateTime(xHigh, new PlotInfo(this, seriesName)), new IndexableNumericDataArrayFloat(y, new PlotInfo(this, seriesName)), new IndexableNumericDataArrayFloat(yLow, new PlotInfo(this, seriesName)), new IndexableNumericDataArrayFloat(yHigh, new PlotInfo(this, seriesName)), true, true, true, false);
    }

    @Override public  XYErrorBarDataSeriesArray errorBarXY(final Comparable seriesName, final float[] x, final float[] xLow, final float[] xHigh, final DBDateTime[] y, final DBDateTime[] yLow, final DBDateTime[] yHigh) {
        return errorBarXY(seriesName, new IndexableNumericDataArrayFloat(x, new PlotInfo(this, seriesName)), new IndexableNumericDataArrayFloat(xLow, new PlotInfo(this, seriesName)), new IndexableNumericDataArrayFloat(xHigh, new PlotInfo(this, seriesName)), new IndexableNumericDataArrayDBDateTime(y, new PlotInfo(this, seriesName)), new IndexableNumericDataArrayDBDateTime(yLow, new PlotInfo(this, seriesName)), new IndexableNumericDataArrayDBDateTime(yHigh, new PlotInfo(this, seriesName)), true, true, false, true);
    }

    @Override public  XYErrorBarDataSeriesArray errorBarXY(final Comparable seriesName, final DBDateTime[] x, final DBDateTime[] xLow, final DBDateTime[] xHigh, final double[] y, final double[] yLow, final double[] yHigh) {
        return errorBarXY(seriesName, new IndexableNumericDataArrayDBDateTime(x, new PlotInfo(this, seriesName)), new IndexableNumericDataArrayDBDateTime(xLow, new PlotInfo(this, seriesName)), new IndexableNumericDataArrayDBDateTime(xHigh, new PlotInfo(this, seriesName)), new IndexableNumericDataArrayDouble(y, new PlotInfo(this, seriesName)), new IndexableNumericDataArrayDouble(yLow, new PlotInfo(this, seriesName)), new IndexableNumericDataArrayDouble(yHigh, new PlotInfo(this, seriesName)), true, true, true, false);
    }

    @Override public  XYErrorBarDataSeriesArray errorBarXY(final Comparable seriesName, final double[] x, final double[] xLow, final double[] xHigh, final DBDateTime[] y, final DBDateTime[] yLow, final DBDateTime[] yHigh) {
        return errorBarXY(seriesName, new IndexableNumericDataArrayDouble(x, new PlotInfo(this, seriesName)), new IndexableNumericDataArrayDouble(xLow, new PlotInfo(this, seriesName)), new IndexableNumericDataArrayDouble(xHigh, new PlotInfo(this, seriesName)), new IndexableNumericDataArrayDBDateTime(y, new PlotInfo(this, seriesName)), new IndexableNumericDataArrayDBDateTime(yLow, new PlotInfo(this, seriesName)), new IndexableNumericDataArrayDBDateTime(yHigh, new PlotInfo(this, seriesName)), true, true, false, true);
    }

    @Override public <T3 extends Number,T4 extends Number,T5 extends Number> XYErrorBarDataSeriesArray errorBarXY(final Comparable seriesName, final DBDateTime[] x, final DBDateTime[] xLow, final DBDateTime[] xHigh, final T3[] y, final T4[] yLow, final T5[] yHigh) {
        return errorBarXY(seriesName, new IndexableNumericDataArrayDBDateTime(x, new PlotInfo(this, seriesName)), new IndexableNumericDataArrayDBDateTime(xLow, new PlotInfo(this, seriesName)), new IndexableNumericDataArrayDBDateTime(xHigh, new PlotInfo(this, seriesName)), new IndexableNumericDataArrayNumber<>(y, new PlotInfo(this, seriesName)), new IndexableNumericDataArrayNumber<>(yLow, new PlotInfo(this, seriesName)), new IndexableNumericDataArrayNumber<>(yHigh, new PlotInfo(this, seriesName)), true, true, true, false);
    }

    @Override public <T0 extends Number,T1 extends Number,T2 extends Number> XYErrorBarDataSeriesArray errorBarXY(final Comparable seriesName, final T0[] x, final T1[] xLow, final T2[] xHigh, final DBDateTime[] y, final DBDateTime[] yLow, final DBDateTime[] yHigh) {
        return errorBarXY(seriesName, new IndexableNumericDataArrayNumber<>(x, new PlotInfo(this, seriesName)), new IndexableNumericDataArrayNumber<>(xLow, new PlotInfo(this, seriesName)), new IndexableNumericDataArrayNumber<>(xHigh, new PlotInfo(this, seriesName)), new IndexableNumericDataArrayDBDateTime(y, new PlotInfo(this, seriesName)), new IndexableNumericDataArrayDBDateTime(yLow, new PlotInfo(this, seriesName)), new IndexableNumericDataArrayDBDateTime(yHigh, new PlotInfo(this, seriesName)), true, true, false, true);
    }

    @Override public <T3 extends Number,T4 extends Number,T5 extends Number> XYErrorBarDataSeriesArray errorBarXY(final Comparable seriesName, final DBDateTime[] x, final DBDateTime[] xLow, final DBDateTime[] xHigh, final List<T3> y, final List<T4> yLow, final List<T5> yHigh) {
        return errorBarXY(seriesName, new IndexableNumericDataArrayDBDateTime(x, new PlotInfo(this, seriesName)), new IndexableNumericDataArrayDBDateTime(xLow, new PlotInfo(this, seriesName)), new IndexableNumericDataArrayDBDateTime(xHigh, new PlotInfo(this, seriesName)), new IndexableNumericDataListNumber<>(y, new PlotInfo(this, seriesName)), new IndexableNumericDataListNumber<>(yLow, new PlotInfo(this, seriesName)), new IndexableNumericDataListNumber<>(yHigh, new PlotInfo(this, seriesName)), true, true, true, false);
    }

    @Override public <T0 extends Number,T1 extends Number,T2 extends Number> XYErrorBarDataSeriesArray errorBarXY(final Comparable seriesName, final List<T0> x, final List<T1> xLow, final List<T2> xHigh, final DBDateTime[] y, final DBDateTime[] yLow, final DBDateTime[] yHigh) {
        return errorBarXY(seriesName, new IndexableNumericDataListNumber<>(x, new PlotInfo(this, seriesName)), new IndexableNumericDataListNumber<>(xLow, new PlotInfo(this, seriesName)), new IndexableNumericDataListNumber<>(xHigh, new PlotInfo(this, seriesName)), new IndexableNumericDataArrayDBDateTime(y, new PlotInfo(this, seriesName)), new IndexableNumericDataArrayDBDateTime(yLow, new PlotInfo(this, seriesName)), new IndexableNumericDataArrayDBDateTime(yHigh, new PlotInfo(this, seriesName)), true, true, false, true);
    }
    ...
    @Override public  XYErrorBarDataSeriesArray errorBarX(final Comparable seriesName, final DBDateTime[] x, final DBDateTime[] xLow, final DBDateTime[] xHigh, final DBDateTime[] y) {
        return errorBarX(seriesName, new IndexableNumericDataArrayDBDateTime(x, new PlotInfo(this, seriesName)), new IndexableNumericDataArrayDBDateTime(xLow, new PlotInfo(this, seriesName)), new IndexableNumericDataArrayDBDateTime(xHigh, new PlotInfo(this, seriesName)), new IndexableNumericDataArrayDBDateTime(y, new PlotInfo(this, seriesName)), true, false, true, true);
    }
    ...
    @Override public  XYErrorBarDataSeriesArray errorBarX(final Comparable seriesName, final DBDateTime[] x, final DBDateTime[] xLow, final DBDateTime[] xHigh, final short[] y) {
        return errorBarX(seriesName, new IndexableNumericDataArrayDBDateTime(x, new PlotInfo(this, seriesName)), new IndexableNumericDataArrayDBDateTime(xLow, new PlotInfo(this, seriesName)), new IndexableNumericDataArrayDBDateTime(xHigh, new PlotInfo(this, seriesName)), new IndexableNumericDataArrayShort(y, new PlotInfo(this, seriesName)), true, false, true, false);
    }

    @Override public  XYErrorBarDataSeriesArray errorBarX(final Comparable seriesName, final short[] x, final short[] xLow, final short[] xHigh, final DBDateTime[] y) {
        return errorBarX(seriesName, new IndexableNumericDataArrayShort(x, new PlotInfo(this, seriesName)), new IndexableNumericDataArrayShort(xLow, new PlotInfo(this, seriesName)), new IndexableNumericDataArrayShort(xHigh, new PlotInfo(this, seriesName)), new IndexableNumericDataArrayDBDateTime(y, new PlotInfo(this, seriesName)), true, false, false, true);
    }

    @Override public  XYErrorBarDataSeriesArray errorBarX(final Comparable seriesName, final DBDateTime[] x, final DBDateTime[] xLow, final DBDateTime[] xHigh, final int[] y) {
        return errorBarX(seriesName, new IndexableNumericDataArrayDBDateTime(x, new PlotInfo(this, seriesName)), new IndexableNumericDataArrayDBDateTime(xLow, new PlotInfo(this, seriesName)), new IndexableNumericDataArrayDBDateTime(xHigh, new PlotInfo(this, seriesName)), new IndexableNumericDataArrayInt(y, new PlotInfo(this, seriesName)), true, false, true, false);
    }

    @Override public  XYErrorBarDataSeriesArray errorBarX(final Comparable seriesName, final int[] x, final int[] xLow, final int[] xHigh, final DBDateTime[] y) {
        return errorBarX(seriesName, new IndexableNumericDataArrayInt(x, new PlotInfo(this, seriesName)), new IndexableNumericDataArrayInt(xLow, new PlotInfo(this, seriesName)), new IndexableNumericDataArrayInt(xHigh, new PlotInfo(this, seriesName)), new IndexableNumericDataArrayDBDateTime(y, new PlotInfo(this, seriesName)), true, false, false, true);
    }

    @Override public  XYErrorBarDataSeriesArray errorBarX(final Comparable seriesName, final DBDateTime[] x, final DBDateTime[] xLow, final DBDateTime[] xHigh, final long[] y) {
        return errorBarX(seriesName, new IndexableNumericDataArrayDBDateTime(x, new PlotInfo(this, seriesName)), new IndexableNumericDataArrayDBDateTime(xLow, new PlotInfo(this, seriesName)), new IndexableNumericDataArrayDBDateTime(xHigh, new PlotInfo(this, seriesName)), new IndexableNumericDataArrayLong(y, new PlotInfo(this, seriesName)), true, false, true, false);
    }

    @Override public  XYErrorBarDataSeriesArray errorBarX(final Comparable seriesName, final long[] x, final long[] xLow, final long[] xHigh, final DBDateTime[] y) {
        return errorBarX(seriesName, new IndexableNumericDataArrayLong(x, new PlotInfo(this, seriesName)), new IndexableNumericDataArrayLong(xLow, new PlotInfo(this, seriesName)), new IndexableNumericDataArrayLong(xHigh, new PlotInfo(this, seriesName)), new IndexableNumericDataArrayDBDateTime(y, new PlotInfo(this, seriesName)), true, false, false, true);
    }

    @Override public  XYErrorBarDataSeriesArray errorBarX(final Comparable seriesName, final DBDateTime[] x, final DBDateTime[] xLow, final DBDateTime[] xHigh, final float[] y) {
        return errorBarX(seriesName, new IndexableNumericDataArrayDBDateTime(x, new PlotInfo(this, seriesName)), new IndexableNumericDataArrayDBDateTime(xLow, new PlotInfo(this, seriesName)), new IndexableNumericDataArrayDBDateTime(xHigh, new PlotInfo(this, seriesName)), new IndexableNumericDataArrayFloat(y, new PlotInfo(this, seriesName)), true, false, true, false);
    }

    @Override public  XYErrorBarDataSeriesArray errorBarX(final Comparable seriesName, final float[] x, final float[] xLow, final float[] xHigh, final DBDateTime[] y) {
        return errorBarX(seriesName, new IndexableNumericDataArrayFloat(x, new PlotInfo(this, seriesName)), new IndexableNumericDataArrayFloat(xLow, new PlotInfo(this, seriesName)), new IndexableNumericDataArrayFloat(xHigh, new PlotInfo(this, seriesName)), new IndexableNumericDataArrayDBDateTime(y, new PlotInfo(this, seriesName)), true, false, false, true);
    }

    @Override public  XYErrorBarDataSeriesArray errorBarX(final Comparable seriesName, final DBDateTime[] x, final DBDateTime[] xLow, final DBDateTime[] xHigh, final double[] y) {
        return errorBarX(seriesName, new IndexableNumericDataArrayDBDateTime(x, new PlotInfo(this, seriesName)), new IndexableNumericDataArrayDBDateTime(xLow, new PlotInfo(this, seriesName)), new IndexableNumericDataArrayDBDateTime(xHigh, new PlotInfo(this, seriesName)), new IndexableNumericDataArrayDouble(y, new PlotInfo(this, seriesName)), true, false, true, false);
    }

    @Override public  XYErrorBarDataSeriesArray errorBarX(final Comparable seriesName, final double[] x, final double[] xLow, final double[] xHigh, final DBDateTime[] y) {
        return errorBarX(seriesName, new IndexableNumericDataArrayDouble(x, new PlotInfo(this, seriesName)), new IndexableNumericDataArrayDouble(xLow, new PlotInfo(this, seriesName)), new IndexableNumericDataArrayDouble(xHigh, new PlotInfo(this, seriesName)), new IndexableNumericDataArrayDBDateTime(y, new PlotInfo(this, seriesName)), true, false, false, true);
    }

    @Override public <T3 extends Number> XYErrorBarDataSeriesArray errorBarX(final Comparable seriesName, final DBDateTime[] x, final DBDateTime[] xLow, final DBDateTime[] xHigh, final T3[] y) {
        return errorBarX(seriesName, new IndexableNumericDataArrayDBDateTime(x, new PlotInfo(this, seriesName)), new IndexableNumericDataArrayDBDateTime(xLow, new PlotInfo(this, seriesName)), new IndexableNumericDataArrayDBDateTime(xHigh, new PlotInfo(this, seriesName)), new IndexableNumericDataArrayNumber<>(y, new PlotInfo(this, seriesName)), true, false, true, false);
    }

    @Override public <T0 extends Number,T1 extends Number,T2 extends Number> XYErrorBarDataSeriesArray errorBarX(final Comparable seriesName, final T0[] x, final T1[] xLow, final T2[] xHigh, final DBDateTime[] y) {
        return errorBarX(seriesName, new IndexableNumericDataArrayNumber<>(x, new PlotInfo(this, seriesName)), new IndexableNumericDataArrayNumber<>(xLow, new PlotInfo(this, seriesName)), new IndexableNumericDataArrayNumber<>(xHigh, new PlotInfo(this, seriesName)), new IndexableNumericDataArrayDBDateTime(y, new PlotInfo(this, seriesName)), true, false, false, true);
    }

    @Override public <T3 extends Number> XYErrorBarDataSeriesArray errorBarX(final Comparable seriesName, final DBDateTime[] x, final DBDateTime[] xLow, final DBDateTime[] xHigh, final List<T3> y) {
        return errorBarX(seriesName, new IndexableNumericDataArrayDBDateTime(x, new PlotInfo(this, seriesName)), new IndexableNumericDataArrayDBDateTime(xLow, new PlotInfo(this, seriesName)), new IndexableNumericDataArrayDBDateTime(xHigh, new PlotInfo(this, seriesName)), new IndexableNumericDataListNumber<>(y, new PlotInfo(this, seriesName)), true, false, true, false);
    }

    @Override public <T0 extends Number,T1 extends Number,T2 extends Number> XYErrorBarDataSeriesArray errorBarX(final Comparable seriesName, final List<T0> x, final List<T1> xLow, final List<T2> xHigh, final DBDateTime[] y) {
        return errorBarX(seriesName, new IndexableNumericDataListNumber<>(x, new PlotInfo(this, seriesName)), new IndexableNumericDataListNumber<>(xLow, new PlotInfo(this, seriesName)), new IndexableNumericDataListNumber<>(xHigh, new PlotInfo(this, seriesName)), new IndexableNumericDataArrayDBDateTime(y, new PlotInfo(this, seriesName)), true, false, false, true);
    }
    ...
    @Override public  XYErrorBarDataSeriesArray errorBarY(final Comparable seriesName, final DBDateTime[] x, final DBDateTime[] y, final DBDateTime[] yLow, final DBDateTime[] yHigh) {
        return errorBarY(seriesName, new IndexableNumericDataArrayDBDateTime(x, new PlotInfo(this, seriesName)), new IndexableNumericDataArrayDBDateTime(y, new PlotInfo(this, seriesName)), new IndexableNumericDataArrayDBDateTime(yLow, new PlotInfo(this, seriesName)), new IndexableNumericDataArrayDBDateTime(yHigh, new PlotInfo(this, seriesName)), false, true, true, true);
    }
    ...
    @Override public  XYErrorBarDataSeriesArray errorBarY(final Comparable seriesName, final DBDateTime[] x, final short[] y, final short[] yLow, final short[] yHigh) {
        return errorBarY(seriesName, new IndexableNumericDataArrayDBDateTime(x, new PlotInfo(this, seriesName)), new IndexableNumericDataArrayShort(y, new PlotInfo(this, seriesName)), new IndexableNumericDataArrayShort(yLow, new PlotInfo(this, seriesName)), new IndexableNumericDataArrayShort(yHigh, new PlotInfo(this, seriesName)), false, true, true, false);
    }

    @Override public  XYErrorBarDataSeriesArray errorBarY(final Comparable seriesName, final short[] x, final DBDateTime[] y, final DBDateTime[] yLow, final DBDateTime[] yHigh) {
        return errorBarY(seriesName, new IndexableNumericDataArrayShort(x, new PlotInfo(this, seriesName)), new IndexableNumericDataArrayDBDateTime(y, new PlotInfo(this, seriesName)), new IndexableNumericDataArrayDBDateTime(yLow, new PlotInfo(this, seriesName)), new IndexableNumericDataArrayDBDateTime(yHigh, new PlotInfo(this, seriesName)), false, true, false, true);
    }

    @Override public  XYErrorBarDataSeriesArray errorBarY(final Comparable seriesName, final DBDateTime[] x, final int[] y, final int[] yLow, final int[] yHigh) {
        return errorBarY(seriesName, new IndexableNumericDataArrayDBDateTime(x, new PlotInfo(this, seriesName)), new IndexableNumericDataArrayInt(y, new PlotInfo(this, seriesName)), new IndexableNumericDataArrayInt(yLow, new PlotInfo(this, seriesName)), new IndexableNumericDataArrayInt(yHigh, new PlotInfo(this, seriesName)), false, true, true, false);
    }

    @Override public  XYErrorBarDataSeriesArray errorBarY(final Comparable seriesName, final int[] x, final DBDateTime[] y, final DBDateTime[] yLow, final DBDateTime[] yHigh) {
        return errorBarY(seriesName, new IndexableNumericDataArrayInt(x, new PlotInfo(this, seriesName)), new IndexableNumericDataArrayDBDateTime(y, new PlotInfo(this, seriesName)), new IndexableNumericDataArrayDBDateTime(yLow, new PlotInfo(this, seriesName)), new IndexableNumericDataArrayDBDateTime(yHigh, new PlotInfo(this, seriesName)), false, true, false, true);
    }

    @Override public  XYErrorBarDataSeriesArray errorBarY(final Comparable seriesName, final DBDateTime[] x, final long[] y, final long[] yLow, final long[] yHigh) {
        return errorBarY(seriesName, new IndexableNumericDataArrayDBDateTime(x, new PlotInfo(this, seriesName)), new IndexableNumericDataArrayLong(y, new PlotInfo(this, seriesName)), new IndexableNumericDataArrayLong(yLow, new PlotInfo(this, seriesName)), new IndexableNumericDataArrayLong(yHigh, new PlotInfo(this, seriesName)), false, true, true, false);
    }

    @Override public  XYErrorBarDataSeriesArray errorBarY(final Comparable seriesName, final long[] x, final DBDateTime[] y, final DBDateTime[] yLow, final DBDateTime[] yHigh) {
        return errorBarY(seriesName, new IndexableNumericDataArrayLong(x, new PlotInfo(this, seriesName)), new IndexableNumericDataArrayDBDateTime(y, new PlotInfo(this, seriesName)), new IndexableNumericDataArrayDBDateTime(yLow, new PlotInfo(this, seriesName)), new IndexableNumericDataArrayDBDateTime(yHigh, new PlotInfo(this, seriesName)), false, true, false, true);
    }

    @Override public  XYErrorBarDataSeriesArray errorBarY(final Comparable seriesName, final DBDateTime[] x, final float[] y, final float[] yLow, final float[] yHigh) {
        return errorBarY(seriesName, new IndexableNumericDataArrayDBDateTime(x, new PlotInfo(this, seriesName)), new IndexableNumericDataArrayFloat(y, new PlotInfo(this, seriesName)), new IndexableNumericDataArrayFloat(yLow, new PlotInfo(this, seriesName)), new IndexableNumericDataArrayFloat(yHigh, new PlotInfo(this, seriesName)), false, true, true, false);
    }

    @Override public  XYErrorBarDataSeriesArray errorBarY(final Comparable seriesName, final float[] x, final DBDateTime[] y, final DBDateTime[] yLow, final DBDateTime[] yHigh) {
        return errorBarY(seriesName, new IndexableNumericDataArrayFloat(x, new PlotInfo(this, seriesName)), new IndexableNumericDataArrayDBDateTime(y, new PlotInfo(this, seriesName)), new IndexableNumericDataArrayDBDateTime(yLow, new PlotInfo(this, seriesName)), new IndexableNumericDataArrayDBDateTime(yHigh, new PlotInfo(this, seriesName)), false, true, false, true);
    }

    @Override public  XYErrorBarDataSeriesArray errorBarY(final Comparable seriesName, final DBDateTime[] x, final double[] y, final double[] yLow, final double[] yHigh) {
        return errorBarY(seriesName, new IndexableNumericDataArrayDBDateTime(x, new PlotInfo(this, seriesName)), new IndexableNumericDataArrayDouble(y, new PlotInfo(this, seriesName)), new IndexableNumericDataArrayDouble(yLow, new PlotInfo(this, seriesName)), new IndexableNumericDataArrayDouble(yHigh, new PlotInfo(this, seriesName)), false, true, true, false);
    }

    @Override public  XYErrorBarDataSeriesArray errorBarY(final Comparable seriesName, final double[] x, final DBDateTime[] y, final DBDateTime[] yLow, final DBDateTime[] yHigh) {
        return errorBarY(seriesName, new IndexableNumericDataArrayDouble(x, new PlotInfo(this, seriesName)), new IndexableNumericDataArrayDBDateTime(y, new PlotInfo(this, seriesName)), new IndexableNumericDataArrayDBDateTime(yLow, new PlotInfo(this, seriesName)), new IndexableNumericDataArrayDBDateTime(yHigh, new PlotInfo(this, seriesName)), false, true, false, true);
    }

    @Override public <T1 extends Number,T2 extends Number,T3 extends Number> XYErrorBarDataSeriesArray errorBarY(final Comparable seriesName, final DBDateTime[] x, final T1[] y, final T2[] yLow, final T3[] yHigh) {
        return errorBarY(seriesName, new IndexableNumericDataArrayDBDateTime(x, new PlotInfo(this, seriesName)), new IndexableNumericDataArrayNumber<>(y, new PlotInfo(this, seriesName)), new IndexableNumericDataArrayNumber<>(yLow, new PlotInfo(this, seriesName)), new IndexableNumericDataArrayNumber<>(yHigh, new PlotInfo(this, seriesName)), false, true, true, false);
    }

    @Override public <T0 extends Number> XYErrorBarDataSeriesArray errorBarY(final Comparable seriesName, final T0[] x, final DBDateTime[] y, final DBDateTime[] yLow, final DBDateTime[] yHigh) {
        return errorBarY(seriesName, new IndexableNumericDataArrayNumber<>(x, new PlotInfo(this, seriesName)), new IndexableNumericDataArrayDBDateTime(y, new PlotInfo(this, seriesName)), new IndexableNumericDataArrayDBDateTime(yLow, new PlotInfo(this, seriesName)), new IndexableNumericDataArrayDBDateTime(yHigh, new PlotInfo(this, seriesName)), false, true, false, true);
    }

    @Override public <T1 extends Number,T2 extends Number,T3 extends Number> XYErrorBarDataSeriesArray errorBarY(final Comparable seriesName, final DBDateTime[] x, final List<T1> y, final List<T2> yLow, final List<T3> yHigh) {
        return errorBarY(seriesName, new IndexableNumericDataArrayDBDateTime(x, new PlotInfo(this, seriesName)), new IndexableNumericDataListNumber<>(y, new PlotInfo(this, seriesName)), new IndexableNumericDataListNumber<>(yLow, new PlotInfo(this, seriesName)), new IndexableNumericDataListNumber<>(yHigh, new PlotInfo(this, seriesName)), false, true, true, false);
    }

    @Override public <T0 extends Number> XYErrorBarDataSeriesArray errorBarY(final Comparable seriesName, final List<T0> x, final DBDateTime[] y, final DBDateTime[] yLow, final DBDateTime[] yHigh) {
        return errorBarY(seriesName, new IndexableNumericDataListNumber<>(x, new PlotInfo(this, seriesName)), new IndexableNumericDataArrayDBDateTime(y, new PlotInfo(this, seriesName)), new IndexableNumericDataArrayDBDateTime(yLow, new PlotInfo(this, seriesName)), new IndexableNumericDataArrayDBDateTime(yHigh, new PlotInfo(this, seriesName)), false, true, false, true);
    }
    ...
    @Override public <T0 extends Comparable> CategoryDataSeriesInternal catErrorBar(final Comparable seriesName, final T0[] categories, final DBDateTime[] values, final DBDateTime[] yLow, final DBDateTime[] yHigh) {
        return catPlot(new CategoryErrorBarDataSeriesMap(this, dataSeries.nextId(), seriesName, new IndexableDataArray<>(categories, new PlotInfo(this, seriesName)), new IndexableNumericDataArrayDBDateTime(values, new PlotInfo(this, seriesName)), new IndexableNumericDataArrayDBDateTime(yLow, new PlotInfo(this, seriesName)), new IndexableNumericDataArrayDBDateTime(yHigh, new PlotInfo(this, seriesName))), null, null, true);
    }
    ...
    @Override public <T0 extends Comparable> CategoryDataSeriesInternal catPlot(final Comparable seriesName, final T0[] categories, final DBDateTime[] values) {
        return catPlot(seriesName, new IndexableDataArray<>(categories, new PlotInfo(this, seriesName)), new IndexableNumericDataArrayDBDateTime(values, new PlotInfo(this, seriesName)), true);
    }
    ...
    @Override public <T0 extends Comparable> CategoryDataSeriesInternal catPlot(final Comparable seriesName, final List<T0> categories, final DBDateTime[] values) {
        return catPlot(seriesName, new IndexableDataArray<>(categories.toArray(new Comparable[categories.size()]), new PlotInfo(this, seriesName)), new IndexableNumericDataArrayDBDateTime(values, new PlotInfo(this, seriesName)), true);
    }
