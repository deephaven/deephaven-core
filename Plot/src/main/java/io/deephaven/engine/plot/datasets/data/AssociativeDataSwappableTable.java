...
/**
 * An {@link AssociativeData} dataset backed by a {@link SwappableTable}. Table columns hold the keys and associated
 * values.
 *
...
public class AssociativeDataSwappableTable<KEY, VALUE, VALUECOLUMN>
     ...
     *
     * @throws io.deephaven.base.verify.RequirementFailure {@code swappableTable}, {@code keyColumn}, and
     ...
     * @param valueColumn column in {@code swappableTable} which holds the values associated with the keys
     * @param keyColumnType data type of the keys
     * @param valueColumnType data type of the values
     * @param plotInfo plot information
     */
    public AssociativeDataSwappableTable(final SwappableTable swappableTable, final String keyColumn,
            final String valueColumn, final Class<KEY> keyColumnType, final Class<VALUECOLUMN> valueColumnType,
        ...
        ArgumentValidations.assertInstance(swappableTable.getTableDefinition(), keyColumn, keyColumnType,
                keyColumn + " is not of type " + keyColumnType, plotInfo);
        ArgumentValidations.assertInstance(swappableTable.getTableDefinition(), valueColumn, valueColumnType,
