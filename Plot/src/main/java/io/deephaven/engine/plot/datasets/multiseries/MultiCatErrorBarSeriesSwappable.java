...
public class MultiCatErrorBarSeriesSwappable extends AbstractSwappableMultiSeries<CategoryErrorBarDataSeriesInternal>{
    ...
    public MultiCatErrorBarSeriesSwappable(final AxesImpl axes,
        ...
        ArgumentValidations.assertIsNumericOrTimeOrCharOrComparableInstance(swappableTable.getTableDefinition(), categories, "Invalid data type in category column: column=" + categories, getPlotInfo());
        ArgumentValidations.assertIsNumericOrTime(swappableTable.getTableDefinition(), values, "Invalid data type in category column: column=" + values, getPlotInfo());
        ArgumentValidations.assertIsNumericOrTime(swappableTable.getTableDefinition(), yLow, "Invalid data type in category column: column=" + yLow, getPlotInfo());
        ArgumentValidations.assertIsNumericOrTime(swappableTable.getTableDefinition(), yHigh, "Invalid data type in category column: column=" + yHigh, getPlotInfo());
    ...
    @Override
    public CategoryErrorBarDataSeriesInternal createSeries(String seriesName, final BaseTable t, final DynamicSeriesNamer seriesNamer) {
        seriesName = makeSeriesName(seriesName, seriesNamer);
        final NonserializableCategoryDataSeriesTableMap series = new NonserializableCategoryDataSeriesTableMap(axes(), seriesName, t, categories, values, yLow, yHigh);
        series.addSwappableTable(getSwappableTable());
        return series;
    }

    private static class NonserializableCategoryDataSeriesTableMap extends AbstractTableBasedCategoryDataSeries implements CategoryErrorBarDataSeriesInternal, CategoryTableDataSeriesInternal {
        ...
        <T extends Comparable> NonserializableCategoryDataSeriesTableMap(final AxesImpl axes,
            ...
            ArgumentValidations.assertIsNumericOrTimeOrCharOrComparableInstance(table, categoryCol, "Invalid data type in category column: column=" + categoryCol, getPlotInfo());
            ArgumentValidations.assertIsNumericOrTime(table, values, "Invalid data type in data column: column=" + values, getPlotInfo());
            ArgumentValidations.assertIsNumericOrTime(table, yLow, "Invalid data type in data column: column=" + yLow, getPlotInfo());
            ArgumentValidations.assertIsNumericOrTime(table, yHigh, "Invalid data type in data column: column=" + yHigh, getPlotInfo());
    ...
    @Override public MultiCatErrorBarSeriesSwappable lineStyle(final io.deephaven.engine.plot.LineStyle style, final Object... keys) {
        if(keys == null || keys.length == 0) {
    ...
    @Override public MultiCatErrorBarSeriesSwappable pointColor(final io.deephaven.engine.plot.filters.SelectableDataSet sds, final java.lang.String keyColumn, final java.lang.String valueColumn, final Object... keys) {
        if(keys == null || keys.length == 0) {
    ...
    @Override public MultiCatErrorBarSeriesSwappable pointLabel(final io.deephaven.engine.plot.filters.SelectableDataSet sds, final java.lang.String keyColumn, final java.lang.String valueColumn, final Object... keys) {
        if(keys == null || keys.length == 0) {
    ...
    @Override public MultiCatErrorBarSeriesSwappable pointShape(final io.deephaven.engine.plot.filters.SelectableDataSet sds, final java.lang.String keyColumn, final java.lang.String valueColumn, final Object... keys) {
        if(keys == null || keys.length == 0) {
    ...
    @Override public MultiCatErrorBarSeriesSwappable pointSize(final io.deephaven.engine.plot.filters.SelectableDataSet sds, final java.lang.String keyColumn, final java.lang.String valueColumn, final Object... keys) {
        if(keys == null || keys.length == 0) {
