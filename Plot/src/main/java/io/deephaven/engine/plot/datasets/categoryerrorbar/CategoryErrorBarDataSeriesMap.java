...
import io.deephaven.engine.plot.datasets.category.AbstractMapBasedCategoryDataSeries;
...
import io.deephaven.engine.util.tuples.generated.ObjectIntTuple;

import java.util.Collection;
import java.util.LinkedHashMap;
import java.util.Map;

import static io.deephaven.engine.plot.util.NullCategory.INSTANCE;
...
public class CategoryErrorBarDataSeriesMap extends AbstractMapBasedCategoryDataSeries
    ...
    private void setValue(final Comparable category, final Number value, final Map<Comparable, Number> data) {
        if (value == null) {
            data.remove(category);
        } else {
