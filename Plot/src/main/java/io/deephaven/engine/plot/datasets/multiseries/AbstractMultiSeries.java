...
public abstract class AbstractMultiSeries<SERIES extends DataSeriesInternal> extends AbstractSeriesInternal implements MultiSeriesInternal<SERIES>, TableSnapshotSeries {
    ...
    @Override
    public AbstractMultiSeries<SERIES> seriesNamingFunction(final java.util.function.Function<Object, String> namingFunction) {
    ...
    private void applyNamingFunction(final java.util.function.Function<Object, String> namingFunction) {
        ...
        seriesNameColumnName = seriesNameColumnName == null ? ColumnNameConstants.SERIES_NAME + this.hashCode() : seriesNameColumnName;
        applyFunction(namingFunction, seriesNameColumnName, String.class);
    }

    /**
     * Applies the {@code function} to the given input of the underlying table to create a new column {@code columnName}.
     */
    protected void applyFunction(final java.util.function.Function function, final String columnName, final Class resultClass) {
    ...
    public void addSeries(SERIES series, Object key) {
        ...
        if (seriesNames.containsKey(series.name().toString())) {
            throw new PlotRuntimeException("MultiSeries: attempting to add a series with the same name as an existing series.   name=" + series.name() + "oldKey=" + seriesNames.containsKey(series.name()) + " newKey=" + key, this);
        }
    ...
    @Override public AbstractMultiSeries<SERIES> lineStyle(final io.deephaven.engine.plot.LineStyle style, final Object... keys) {
        throw new PlotUnsupportedOperationException("DataSeries " + this.getClass() + " does not support method lineStyle for arguments [class io.deephaven.engine.plot.LineStyle]. If you think this method should work, try placing your keys into an Object array", this);
    }
    ...
    @Override public AbstractMultiSeries<SERIES> pointColor(final io.deephaven.engine.plot.filters.SelectableDataSet sds, final java.lang.String keyColumn, final java.lang.String valueColumn, final Object... keys) {
        throw new PlotUnsupportedOperationException("DataSeries " + this.getClass() + " does not support method pointColor for arguments [interface io.deephaven.engine.plot.filters.SelectableDataSet, class java.lang.String, class java.lang.String]. If you think this method should work, try placing your keys into an Object array", this);
    }



    @Override public AbstractMultiSeries<SERIES> pointColor(final io.deephaven.engine.tables.Table t, final java.lang.String keyColumn, final java.lang.String valueColumn, final Object... keys) {
        throw new PlotUnsupportedOperationException("DataSeries " + this.getClass() + " does not support method pointColor for arguments [interface io.deephaven.engine.tables.Table, class java.lang.String, class java.lang.String]. If you think this method should work, try placing your keys into an Object array", this);
    }
    ...
    @Override public AbstractMultiSeries<SERIES> pointLabel(final io.deephaven.engine.plot.filters.SelectableDataSet sds, final java.lang.String keyColumn, final java.lang.String valueColumn, final Object... keys) {
        throw new PlotUnsupportedOperationException("DataSeries " + this.getClass() + " does not support method pointLabel for arguments [interface io.deephaven.engine.plot.filters.SelectableDataSet, class java.lang.String, class java.lang.String]. If you think this method should work, try placing your keys into an Object array", this);
    }



    @Override public AbstractMultiSeries<SERIES> pointLabel(final io.deephaven.engine.tables.Table t, final java.lang.String keyColumn, final java.lang.String valueColumn, final Object... keys) {
        throw new PlotUnsupportedOperationException("DataSeries " + this.getClass() + " does not support method pointLabel for arguments [interface io.deephaven.engine.tables.Table, class java.lang.String, class java.lang.String]. If you think this method should work, try placing your keys into an Object array", this);
    }
    ...
    @Override public AbstractMultiSeries<SERIES> pointShape(final io.deephaven.engine.plot.filters.SelectableDataSet sds, final java.lang.String keyColumn, final java.lang.String valueColumn, final Object... keys) {
        throw new PlotUnsupportedOperationException("DataSeries " + this.getClass() + " does not support method pointShape for arguments [interface io.deephaven.engine.plot.filters.SelectableDataSet, class java.lang.String, class java.lang.String]. If you think this method should work, try placing your keys into an Object array", this);
    }



    @Override public AbstractMultiSeries<SERIES> pointShape(final io.deephaven.engine.tables.Table t, final java.lang.String keyColumn, final java.lang.String valueColumn, final Object... keys) {
        throw new PlotUnsupportedOperationException("DataSeries " + this.getClass() + " does not support method pointShape for arguments [interface io.deephaven.engine.tables.Table, class java.lang.String, class java.lang.String]. If you think this method should work, try placing your keys into an Object array", this);
    }
    ...
    @Override public AbstractMultiSeries<SERIES> pointSize(final io.deephaven.engine.plot.filters.SelectableDataSet sds, final java.lang.String keyColumn, final java.lang.String valueColumn, final Object... keys) {
        throw new PlotUnsupportedOperationException("DataSeries " + this.getClass() + " does not support method pointSize for arguments [interface io.deephaven.engine.plot.filters.SelectableDataSet, class java.lang.String, class java.lang.String]. If you think this method should work, try placing your keys into an Object array", this);
    }



    @Override public AbstractMultiSeries<SERIES> pointSize(final io.deephaven.engine.tables.Table t, final java.lang.String keyColumn, final java.lang.String valueColumn, final Object... keys) {
        throw new PlotUnsupportedOperationException("DataSeries " + this.getClass() + " does not support method pointSize for arguments [interface io.deephaven.engine.tables.Table, class java.lang.String, class java.lang.String]. If you think this method should work, try placing your keys into an Object array", this);
    }
    ...
    @Override public <T extends io.deephaven.gui.color.Paint> AbstractMultiSeries<SERIES> pointColor(final io.deephaven.engine.plot.datasets.data.IndexableData<T> colors, final Object... keys) {
        throw new PlotUnsupportedOperationException("DataSeries " + this.getClass() + " does not support method pointColor for arguments [io.deephaven.engine.plot.datasets.data.IndexableData<T>]. If you think this method should work, try placing your keys into an Object array", this);
    }



    @Override public AbstractMultiSeries<SERIES> pointColor(final io.deephaven.engine.plot.filters.SelectableDataSet sds, final java.lang.String columnName, final Object... keys) {
        throw new PlotUnsupportedOperationException("DataSeries " + this.getClass() + " does not support method pointColor for arguments [interface io.deephaven.engine.plot.filters.SelectableDataSet, class java.lang.String]. If you think this method should work, try placing your keys into an Object array", this);
    }



    @Override public AbstractMultiSeries<SERIES> pointColor(final io.deephaven.engine.tables.Table t, final java.lang.String columnName, final Object... keys) {
        throw new PlotUnsupportedOperationException("DataSeries " + this.getClass() + " does not support method pointColor for arguments [interface io.deephaven.engine.tables.Table, class java.lang.String]. If you think this method should work, try placing your keys into an Object array", this);
    }



    @Override public AbstractMultiSeries<SERIES> pointColorInteger(final io.deephaven.engine.plot.datasets.data.IndexableData<java.lang.Integer> colors, final Object... keys) {
        throw new PlotUnsupportedOperationException("DataSeries " + this.getClass() + " does not support method pointColorInteger for arguments [io.deephaven.engine.plot.datasets.data.IndexableData<java.lang.Integer>]. If you think this method should work, try placing your keys into an Object array", this);
    }
    ...
    @Override public AbstractMultiSeries<SERIES> pointLabel(final io.deephaven.engine.plot.datasets.data.IndexableData<?> labels, final Object... keys) {
        throw new PlotUnsupportedOperationException("DataSeries " + this.getClass() + " does not support method pointLabel for arguments [io.deephaven.engine.plot.datasets.data.IndexableData<?>]. If you think this method should work, try placing your keys into an Object array", this);
    }



    @Override public AbstractMultiSeries<SERIES> pointLabel(final io.deephaven.engine.plot.filters.SelectableDataSet sds, final java.lang.String columnName, final Object... keys) {
        throw new PlotUnsupportedOperationException("DataSeries " + this.getClass() + " does not support method pointLabel for arguments [interface io.deephaven.engine.plot.filters.SelectableDataSet, class java.lang.String]. If you think this method should work, try placing your keys into an Object array", this);
    }



    @Override public AbstractMultiSeries<SERIES> pointLabel(final io.deephaven.engine.tables.Table t, final java.lang.String columnName, final Object... keys) {
        throw new PlotUnsupportedOperationException("DataSeries " + this.getClass() + " does not support method pointLabel for arguments [interface io.deephaven.engine.tables.Table, class java.lang.String]. If you think this method should work, try placing your keys into an Object array", this);
    }
    ...
    @Override public AbstractMultiSeries<SERIES> pointShape(final io.deephaven.engine.plot.datasets.data.IndexableData<java.lang.String> shapes, final Object... keys) {
        throw new PlotUnsupportedOperationException("DataSeries " + this.getClass() + " does not support method pointShape for arguments [io.deephaven.engine.plot.datasets.data.IndexableData<java.lang.String>]. If you think this method should work, try placing your keys into an Object array", this);
    }



    @Override public AbstractMultiSeries<SERIES> pointShape(final io.deephaven.engine.plot.filters.SelectableDataSet sds, final java.lang.String columnName, final Object... keys) {
        throw new PlotUnsupportedOperationException("DataSeries " + this.getClass() + " does not support method pointShape for arguments [interface io.deephaven.engine.plot.filters.SelectableDataSet, class java.lang.String]. If you think this method should work, try placing your keys into an Object array", this);
    }



    @Override public AbstractMultiSeries<SERIES> pointShape(final io.deephaven.engine.tables.Table t, final java.lang.String columnName, final Object... keys) {
        throw new PlotUnsupportedOperationException("DataSeries " + this.getClass() + " does not support method pointShape for arguments [interface io.deephaven.engine.tables.Table, class java.lang.String]. If you think this method should work, try placing your keys into an Object array", this);
    }
    ...
    @Override public AbstractMultiSeries<SERIES> pointSize(final io.deephaven.engine.plot.datasets.data.IndexableData<java.lang.Double> factors, final Object... keys) {
        throw new PlotUnsupportedOperationException("DataSeries " + this.getClass() + " does not support method pointSize for arguments [io.deephaven.engine.plot.datasets.data.IndexableData<java.lang.Double>]. If you think this method should work, try placing your keys into an Object array", this);
    }



    @Override public AbstractMultiSeries<SERIES> pointSize(final io.deephaven.engine.plot.filters.SelectableDataSet sds, final java.lang.String columnName, final Object... keys) {
        throw new PlotUnsupportedOperationException("DataSeries " + this.getClass() + " does not support method pointSize for arguments [interface io.deephaven.engine.plot.filters.SelectableDataSet, class java.lang.String]. If you think this method should work, try placing your keys into an Object array", this);
    }



    @Override public AbstractMultiSeries<SERIES> pointSize(final io.deephaven.engine.tables.Table t, final java.lang.String columnName, final Object... keys) {
        throw new PlotUnsupportedOperationException("DataSeries " + this.getClass() + " does not support method pointSize for arguments [interface io.deephaven.engine.tables.Table, class java.lang.String]. If you think this method should work, try placing your keys into an Object array", this);
    }
