...
public class MultiOHLCSeries extends AbstractTableMapHandleMultiSeries<OHLCDataSeriesInternal> {
     ...
     */
    public MultiOHLCSeries(final AxesImpl axes, final int id, final Comparable name, final TableBackedTableMapHandle tableMapHandle, final String timeCol, final String openCol, final String highCol, final String lowCol, final String closeCol, final String[] byColumns) {
    ...
    @Override public <T extends io.deephaven.gui.color.Paint> MultiOHLCSeries pointColorByY(final java.util.function.Function<java.lang.Double, T> colors, final Object... keys) {
        ...
        chart().figure().registerFigureFunction(new io.deephaven.engine.plot.util.functions.FigureImplFunction(f -> f.pointColor(getTableMapHandle().getTable(), newColumn, keys), this));
        return this;
    }
    ...
    @Override public MultiOHLCSeries lineStyle(final io.deephaven.engine.plot.LineStyle style, final Object... keys) {
        if(keys == null || keys.length == 0) {
    ...
    @Override public <T extends io.deephaven.gui.color.Paint> MultiOHLCSeries pointColor(final io.deephaven.engine.plot.datasets.data.IndexableData<T> colors, final Object... keys) {
        if(keys == null || keys.length == 0) {
    ...
    @Override public MultiOHLCSeries pointColor(final io.deephaven.engine.plot.filters.SelectableDataSet sds, final java.lang.String columnName, final Object... keys) {
        if(keys == null || keys.length == 0) {
    ...
    @Override public MultiOHLCSeries pointColorInteger(final io.deephaven.engine.plot.datasets.data.IndexableData<java.lang.Integer> colors, final Object... keys) {
        if(keys == null || keys.length == 0) {
    ...
    @Override public MultiOHLCSeries pointLabel(final io.deephaven.engine.plot.datasets.data.IndexableData<?> labels, final Object... keys) {
        if(keys == null || keys.length == 0) {
    ...
    @Override public MultiOHLCSeries pointLabel(final io.deephaven.engine.plot.filters.SelectableDataSet sds, final java.lang.String columnName, final Object... keys) {
        if(keys == null || keys.length == 0) {
    ...
    @Override public MultiOHLCSeries pointShape(final io.deephaven.engine.plot.datasets.data.IndexableData<java.lang.String> shapes, final Object... keys) {
        if(keys == null || keys.length == 0) {
    ...
    @Override public MultiOHLCSeries pointShape(final io.deephaven.engine.plot.filters.SelectableDataSet sds, final java.lang.String columnName, final Object... keys) {
        if(keys == null || keys.length == 0) {
    ...
    @Override public MultiOHLCSeries pointSize(final io.deephaven.engine.plot.datasets.data.IndexableData<java.lang.Double> factors, final Object... keys) {
        if(keys == null || keys.length == 0) {
    ...
    @Override public MultiOHLCSeries pointSize(final io.deephaven.engine.plot.filters.SelectableDataSet sds, final java.lang.String columnName, final Object... keys) {
        if(keys == null || keys.length == 0) {
