...
public class MultiOHLCSeries extends AbstractTableMapHandleMultiSeries<OHLCDataSeriesInternal> {
    ...
    @Override public MultiOHLCSeries pointColor(final io.deephaven.engine.table.Table t, final java.lang.String colors, final Object... keys) {
    ...
    @Override public MultiOHLCSeries pointColor(final io.deephaven.plot.filters.SelectableDataSet sds, final java.lang.String colors, final Object... keys) {
        if(keys == null || keys.length == 0) {
    ...
    @Override public MultiOHLCSeries pointLabel(final io.deephaven.engine.table.Table t, final java.lang.String label, final Object... keys) {
    ...
    @Override public MultiOHLCSeries pointLabel(final io.deephaven.plot.filters.SelectableDataSet sds, final java.lang.String label, final Object... keys) {
        if(keys == null || keys.length == 0) {
    ...
    @Override public MultiOHLCSeries pointShape(final io.deephaven.engine.table.Table t, final java.lang.String shape, final Object... keys) {
    ...
    @Override public MultiOHLCSeries pointShape(final io.deephaven.plot.filters.SelectableDataSet sds, final java.lang.String shape, final Object... keys) {
        if(keys == null || keys.length == 0) {
    ...
    @Override public MultiOHLCSeries pointSize(final io.deephaven.engine.table.Table t, final java.lang.String factor, final Object... keys) {
    ...
    @Override public MultiOHLCSeries pointSize(final io.deephaven.plot.filters.SelectableDataSet sds, final java.lang.String factor, final Object... keys) {
        if(keys == null || keys.length == 0) {
