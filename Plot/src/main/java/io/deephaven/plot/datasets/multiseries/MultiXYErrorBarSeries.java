...
public class MultiXYErrorBarSeries extends AbstractTableMapHandleMultiSeries<XYErrorBarDataSeriesInternal> {
    ...
    @Override public MultiXYErrorBarSeries pointColor(final io.deephaven.engine.table.Table t, final java.lang.String colors, final Object... keys) {
    ...
    @Override public MultiXYErrorBarSeries pointColor(final io.deephaven.plot.filters.SelectableDataSet sds, final java.lang.String colors, final Object... keys) {
        if(keys == null || keys.length == 0) {
    ...
    @Override public MultiXYErrorBarSeries pointLabel(final io.deephaven.engine.table.Table t, final java.lang.String label, final Object... keys) {
    ...
    @Override public MultiXYErrorBarSeries pointLabel(final io.deephaven.plot.filters.SelectableDataSet sds, final java.lang.String label, final Object... keys) {
        if(keys == null || keys.length == 0) {
    ...
    @Override public MultiXYErrorBarSeries pointShape(final io.deephaven.engine.table.Table t, final java.lang.String shape, final Object... keys) {
    ...
    @Override public MultiXYErrorBarSeries pointShape(final io.deephaven.plot.filters.SelectableDataSet sds, final java.lang.String shape, final Object... keys) {
        if(keys == null || keys.length == 0) {
    ...
    @Override public MultiXYErrorBarSeries pointSize(final io.deephaven.engine.table.Table t, final java.lang.String factor, final Object... keys) {
    ...
    @Override public MultiXYErrorBarSeries pointSize(final io.deephaven.plot.filters.SelectableDataSet sds, final java.lang.String factor, final Object... keys) {
        if(keys == null || keys.length == 0) {
