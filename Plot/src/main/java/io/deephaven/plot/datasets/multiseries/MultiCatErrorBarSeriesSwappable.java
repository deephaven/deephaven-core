...
public class MultiCatErrorBarSeriesSwappable extends AbstractSwappableMultiSeries<CategoryErrorBarDataSeriesInternal> {
    ...
    public CategoryErrorBarDataSeriesInternal createSeries(String seriesName, final BaseTable t,
        ...
        final NonserializableCategoryDataSeriesPartitionedTable series =
                new NonserializableCategoryDataSeriesPartitionedTable(axes(), seriesName, t, categories, values, yLow,
                        yHigh);
...
// @formatter:off
    ...
    @Override public <COLOR extends io.deephaven.gui.color.Paint> MultiCatErrorBarSeriesSwappable pointColor(final groovy.lang.Closure<COLOR> pointColor, final Object... multiSeriesKey) {
        return pointColor(new io.deephaven.plot.util.functions.ClosureFunction<>(pointColor), multiSeriesKey);
    }



    @Override public <COLOR extends io.deephaven.gui.color.Paint> MultiCatErrorBarSeriesSwappable pointColor(final java.util.function.Function<java.lang.Comparable, COLOR> pointColor, final Object... multiSeriesKey) {
        ...
        chart().figure().registerFigureFunction(new io.deephaven.plot.util.functions.FigureImplFunction(f -> f.pointColor(new SelectableDataSetSwappableTable(getSwappableTable()), getX(), newColumn, multiSeriesKey), this));
        return this;
    }



    @Override public <COLOR extends java.lang.Integer> MultiCatErrorBarSeriesSwappable pointColorInteger(final groovy.lang.Closure<COLOR> colors, final Object... multiSeriesKey) {
        return pointColorInteger(new io.deephaven.plot.util.functions.ClosureFunction<>(colors), multiSeriesKey);
    }



    @Override public <COLOR extends java.lang.Integer> MultiCatErrorBarSeriesSwappable pointColorInteger(final java.util.function.Function<java.lang.Comparable, COLOR> colors, final Object... multiSeriesKey) {
        final String newColumn = io.deephaven.plot.datasets.ColumnNameConstants.POINT_COLOR + this.hashCode();
    ...
    @Override public <LABEL> MultiCatErrorBarSeriesSwappable pointLabel(final groovy.lang.Closure<LABEL> pointLabels, final Object... multiSeriesKey) {
        return pointLabel(new io.deephaven.plot.util.functions.ClosureFunction<>(pointLabels), multiSeriesKey);
    }



    @Override public <LABEL> MultiCatErrorBarSeriesSwappable pointLabel(final java.util.function.Function<java.lang.Comparable, LABEL> pointLabels, final Object... multiSeriesKey) {
        ...
        chart().figure().registerFigureFunction(new io.deephaven.plot.util.functions.FigureImplFunction(f -> f.pointLabel(new SelectableDataSetSwappableTable(getSwappableTable()), getX(), newColumn, multiSeriesKey), this));
        return this;
    }



    @Override public MultiCatErrorBarSeriesSwappable pointShape(final groovy.lang.Closure<java.lang.String> pointShapes, final Object... multiSeriesKey) {
        return pointShape(new io.deephaven.plot.util.functions.ClosureFunction<>(pointShapes), multiSeriesKey);
    }



    @Override public MultiCatErrorBarSeriesSwappable pointShape(final java.util.function.Function<java.lang.Comparable, java.lang.String> pointShapes, final Object... multiSeriesKey) {
        ...
        chart().figure().registerFigureFunction(new io.deephaven.plot.util.functions.FigureImplFunction(f -> f.pointShape(new SelectableDataSetSwappableTable(getSwappableTable()), getX(), newColumn, multiSeriesKey), this));
        return this;
    }



    @Override public <NUMBER extends java.lang.Number> MultiCatErrorBarSeriesSwappable pointSize(final groovy.lang.Closure<NUMBER> pointSizes, final Object... multiSeriesKey) {
        return pointSize(new io.deephaven.plot.util.functions.ClosureFunction<>(pointSizes), multiSeriesKey);
    }



    @Override public <NUMBER extends java.lang.Number> MultiCatErrorBarSeriesSwappable pointSize(final java.util.function.Function<java.lang.Comparable, NUMBER> pointSizes, final Object... multiSeriesKey) {
        ...
        chart().figure().registerFigureFunction(new io.deephaven.plot.util.functions.FigureImplFunction(f -> f.pointSize(new SelectableDataSetSwappableTable(getSwappableTable()), getX(), newColumn, multiSeriesKey), this));
        return this;
    }
    ...
    @Override public MultiCatErrorBarSeriesSwappable errorBarColor(final java.lang.String errorBarColor, final Object... multiSeriesKey) {
    ...
    @Override public MultiCatErrorBarSeriesSwappable errorBarColor(final int errorBarColor, final Object... multiSeriesKey) {
        if(multiSeriesKey == null || multiSeriesKey.length == 0) {
    ...
    @Override public MultiCatErrorBarSeriesSwappable errorBarColor(final io.deephaven.gui.color.Paint errorBarColor, final Object... multiSeriesKey) {
        if(multiSeriesKey == null || multiSeriesKey.length == 0) {
    ...
    @Override public MultiCatErrorBarSeriesSwappable gradientVisible(final boolean gradientVisible, final Object... multiSeriesKey) {
        if(multiSeriesKey == null || multiSeriesKey.length == 0) {
    ...
    @Override public MultiCatErrorBarSeriesSwappable group(final int group, final Object... multiSeriesKey) {
        if(multiSeriesKey == null || multiSeriesKey.length == 0) {
    ...
    @Override public MultiCatErrorBarSeriesSwappable lineColor(final java.lang.String color, final Object... multiSeriesKey) {
        if(multiSeriesKey == null || multiSeriesKey.length == 0) {
    ...
    @Override public MultiCatErrorBarSeriesSwappable lineColor(final int color, final Object... multiSeriesKey) {
        if(multiSeriesKey == null || multiSeriesKey.length == 0) {
    ...
    @Override public MultiCatErrorBarSeriesSwappable lineColor(final io.deephaven.gui.color.Paint color, final Object... multiSeriesKey) {
        if(multiSeriesKey == null || multiSeriesKey.length == 0) {
    ...
    @Override public MultiCatErrorBarSeriesSwappable lineStyle(final io.deephaven.plot.LineStyle lineStyle, final Object... multiSeriesKey) {
        if(multiSeriesKey == null || multiSeriesKey.length == 0) {
    ...
    @Override public MultiCatErrorBarSeriesSwappable linesVisible(final java.lang.Boolean visible, final Object... multiSeriesKey) {
        if(multiSeriesKey == null || multiSeriesKey.length == 0) {
    ...
    @Override public MultiCatErrorBarSeriesSwappable piePercentLabelFormat(final java.lang.String pieLabelFormat, final Object... multiSeriesKey) {
        if(multiSeriesKey == null || multiSeriesKey.length == 0) {
    ...
    @Override public MultiCatErrorBarSeriesSwappable pointColor(final java.lang.String pointColor, final Object... multiSeriesKey) {
        if(multiSeriesKey == null || multiSeriesKey.length == 0) {
    ...
    @Override public MultiCatErrorBarSeriesSwappable pointColor(final int pointColor, final Object... multiSeriesKey) {
        if(multiSeriesKey == null || multiSeriesKey.length == 0) {
    ...
    @Override public MultiCatErrorBarSeriesSwappable pointColor(final io.deephaven.gui.color.Paint pointColor, final Object... multiSeriesKey) {
        if(multiSeriesKey == null || multiSeriesKey.length == 0) {
    ...
    @Override public <CATEGORY extends java.lang.Comparable, COLOR extends io.deephaven.gui.color.Paint> MultiCatErrorBarSeriesSwappable pointColor(final java.util.Map<CATEGORY, COLOR> pointColor, final Object... multiSeriesKey) {
        if(multiSeriesKey == null || multiSeriesKey.length == 0) {
    ...
    @Override public MultiCatErrorBarSeriesSwappable pointColor(final java.lang.Comparable category, final java.lang.String pointColor, final Object... multiSeriesKey) {
        if(multiSeriesKey == null || multiSeriesKey.length == 0) {
    ...
    @Override public MultiCatErrorBarSeriesSwappable pointColor(final java.lang.Comparable category, final int pointColor, final Object... multiSeriesKey) {
        if(multiSeriesKey == null || multiSeriesKey.length == 0) {
    ...
    @Override public MultiCatErrorBarSeriesSwappable pointColor(final java.lang.Comparable category, final io.deephaven.gui.color.Paint pointColor, final Object... multiSeriesKey) {
        if(multiSeriesKey == null || multiSeriesKey.length == 0) {
    ...
    @Override public MultiCatErrorBarSeriesSwappable pointColor(final io.deephaven.engine.table.Table t, final java.lang.String category, final java.lang.String pointColor, final Object... multiSeriesKey) {
    ...
    @Override public MultiCatErrorBarSeriesSwappable pointColor(final io.deephaven.plot.filters.SelectableDataSet sds, final java.lang.String category, final java.lang.String pointColor, final Object... multiSeriesKey) {
        if(multiSeriesKey == null || multiSeriesKey.length == 0) {
    ...
    @Override public <CATEGORY extends java.lang.Comparable, COLOR extends java.lang.Integer> MultiCatErrorBarSeriesSwappable pointColorInteger(final java.util.Map<CATEGORY, COLOR> colors, final Object... multiSeriesKey) {
        if(multiSeriesKey == null || multiSeriesKey.length == 0) {
    ...
    @Override public MultiCatErrorBarSeriesSwappable pointLabel(final java.lang.Object pointLabel, final Object... multiSeriesKey) {
        if(multiSeriesKey == null || multiSeriesKey.length == 0) {
    ...
    @Override public <CATEGORY extends java.lang.Comparable, LABEL> MultiCatErrorBarSeriesSwappable pointLabel(final java.util.Map<CATEGORY, LABEL> pointLabels, final Object... multiSeriesKey) {
        if(multiSeriesKey == null || multiSeriesKey.length == 0) {
    ...
    @Override public MultiCatErrorBarSeriesSwappable pointLabel(final java.lang.Comparable category, final java.lang.Object pointLabel, final Object... multiSeriesKey) {
        if(multiSeriesKey == null || multiSeriesKey.length == 0) {
    ...
    @Override public MultiCatErrorBarSeriesSwappable pointLabel(final io.deephaven.engine.table.Table t, final java.lang.String category, final java.lang.String pointLabel, final Object... multiSeriesKey) {
    ...
    @Override public MultiCatErrorBarSeriesSwappable pointLabel(final io.deephaven.plot.filters.SelectableDataSet sds, final java.lang.String category, final java.lang.String pointLabel, final Object... multiSeriesKey) {
        if(multiSeriesKey == null || multiSeriesKey.length == 0) {
    ...
    @Override public MultiCatErrorBarSeriesSwappable pointLabelFormat(final java.lang.String pointLabelFormat, final Object... multiSeriesKey) {
        if(multiSeriesKey == null || multiSeriesKey.length == 0) {
    ...
    @Override public MultiCatErrorBarSeriesSwappable pointShape(final java.lang.String pointShape, final Object... multiSeriesKey) {
        if(multiSeriesKey == null || multiSeriesKey.length == 0) {
    ...
    @Override public MultiCatErrorBarSeriesSwappable pointShape(final io.deephaven.gui.shape.Shape pointShape, final Object... multiSeriesKey) {
        if(multiSeriesKey == null || multiSeriesKey.length == 0) {
    ...
    @Override public <CATEGORY extends java.lang.Comparable> MultiCatErrorBarSeriesSwappable pointShape(final java.util.Map<CATEGORY, java.lang.String> pointShapes, final Object... multiSeriesKey) {
        if(multiSeriesKey == null || multiSeriesKey.length == 0) {
    ...
    @Override public MultiCatErrorBarSeriesSwappable pointShape(final java.lang.Comparable category, final java.lang.String pointShape, final Object... multiSeriesKey) {
        if(multiSeriesKey == null || multiSeriesKey.length == 0) {
    ...
    @Override public MultiCatErrorBarSeriesSwappable pointShape(final java.lang.Comparable category, final io.deephaven.gui.shape.Shape pointShape, final Object... multiSeriesKey) {
        if(multiSeriesKey == null || multiSeriesKey.length == 0) {
    ...
    @Override public MultiCatErrorBarSeriesSwappable pointShape(final io.deephaven.engine.table.Table t, final java.lang.String category, final java.lang.String pointShape, final Object... multiSeriesKey) {
    ...
    @Override public MultiCatErrorBarSeriesSwappable pointShape(final io.deephaven.plot.filters.SelectableDataSet sds, final java.lang.String category, final java.lang.String pointShape, final Object... multiSeriesKey) {
        if(multiSeriesKey == null || multiSeriesKey.length == 0) {
    ...
    @Override public MultiCatErrorBarSeriesSwappable pointSize(final java.lang.Number pointSize, final Object... multiSeriesKey) {
        if(multiSeriesKey == null || multiSeriesKey.length == 0) {
    ...
    @Override public <CATEGORY extends java.lang.Comparable, NUMBER extends java.lang.Number> MultiCatErrorBarSeriesSwappable pointSize(final java.util.Map<CATEGORY, NUMBER> pointSizes, final Object... multiSeriesKey) {
        if(multiSeriesKey == null || multiSeriesKey.length == 0) {
    ...
    @Override public <CATEGORY extends java.lang.Comparable, NUMBER extends java.lang.Number> MultiCatErrorBarSeriesSwappable pointSize(final CATEGORY[] categories, final NUMBER[] pointSizes, final Object... multiSeriesKey) {
        if(multiSeriesKey == null || multiSeriesKey.length == 0) {
    ...
    @Override public <CATEGORY extends java.lang.Comparable> MultiCatErrorBarSeriesSwappable pointSize(final CATEGORY[] categories, final double[] pointSizes, final Object... multiSeriesKey) {
        if(multiSeriesKey == null || multiSeriesKey.length == 0) {
    ...
    @Override public <CATEGORY extends java.lang.Comparable> MultiCatErrorBarSeriesSwappable pointSize(final CATEGORY[] categories, final int[] pointSizes, final Object... multiSeriesKey) {
        if(multiSeriesKey == null || multiSeriesKey.length == 0) {
    ...
    @Override public <CATEGORY extends java.lang.Comparable> MultiCatErrorBarSeriesSwappable pointSize(final CATEGORY[] categories, final long[] pointSizes, final Object... multiSeriesKey) {
        if(multiSeriesKey == null || multiSeriesKey.length == 0) {
    ...
    @Override public MultiCatErrorBarSeriesSwappable pointSize(final java.lang.Comparable category, final java.lang.Number pointSize, final Object... multiSeriesKey) {
        if(multiSeriesKey == null || multiSeriesKey.length == 0) {
    ...
    @Override public MultiCatErrorBarSeriesSwappable pointSize(final java.lang.Comparable category, final double pointSize, final Object... multiSeriesKey) {
        if(multiSeriesKey == null || multiSeriesKey.length == 0) {
    ...
    @Override public MultiCatErrorBarSeriesSwappable pointSize(final java.lang.Comparable category, final int pointSize, final Object... multiSeriesKey) {
        if(multiSeriesKey == null || multiSeriesKey.length == 0) {
    ...
    @Override public MultiCatErrorBarSeriesSwappable pointSize(final java.lang.Comparable category, final long pointSize, final Object... multiSeriesKey) {
        if(multiSeriesKey == null || multiSeriesKey.length == 0) {
    ...
    @Override public MultiCatErrorBarSeriesSwappable pointSize(final io.deephaven.engine.table.Table t, final java.lang.String category, final java.lang.String pointSize, final Object... multiSeriesKey) {
    ...
    @Override public MultiCatErrorBarSeriesSwappable pointSize(final io.deephaven.plot.filters.SelectableDataSet sds, final java.lang.String category, final java.lang.String pointSize, final Object... multiSeriesKey) {
        if(multiSeriesKey == null || multiSeriesKey.length == 0) {
    ...
    @Override public MultiCatErrorBarSeriesSwappable pointsVisible(final java.lang.Boolean visible, final Object... multiSeriesKey) {
        if(multiSeriesKey == null || multiSeriesKey.length == 0) {
    ...
    @Override public MultiCatErrorBarSeriesSwappable seriesColor(final java.lang.String color, final Object... multiSeriesKey) {
        if(multiSeriesKey == null || multiSeriesKey.length == 0) {
    ...
    @Override public MultiCatErrorBarSeriesSwappable seriesColor(final int color, final Object... multiSeriesKey) {
        if(multiSeriesKey == null || multiSeriesKey.length == 0) {
    ...
    @Override public MultiCatErrorBarSeriesSwappable seriesColor(final io.deephaven.gui.color.Paint color, final Object... multiSeriesKey) {
        if(multiSeriesKey == null || multiSeriesKey.length == 0) {
    ...
    @Override public MultiCatErrorBarSeriesSwappable toolTipPattern(final java.lang.String toolTipPattern, final Object... multiSeriesKey) {
        if(multiSeriesKey == null || multiSeriesKey.length == 0) {
    ...
    @Override public MultiCatErrorBarSeriesSwappable xToolTipPattern(final java.lang.String xToolTipPattern, final Object... multiSeriesKey) {
        if(multiSeriesKey == null || multiSeriesKey.length == 0) {
    ...
    @Override public MultiCatErrorBarSeriesSwappable yToolTipPattern(final java.lang.String yToolTipPattern, final Object... multiSeriesKey) {
        if(multiSeriesKey == null || multiSeriesKey.length == 0) {
