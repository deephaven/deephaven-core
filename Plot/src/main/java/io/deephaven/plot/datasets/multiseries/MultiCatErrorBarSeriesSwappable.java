...
public class MultiCatErrorBarSeriesSwappable extends AbstractSwappableMultiSeries<CategoryErrorBarDataSeriesInternal> {
    ...
    @Override public MultiCatErrorBarSeriesSwappable pointColor(final io.deephaven.engine.table.Table t, final java.lang.String key, final java.lang.String color, final Object... keys) {
    ...
    @Override public MultiCatErrorBarSeriesSwappable pointColor(final io.deephaven.plot.filters.SelectableDataSet sds, final java.lang.String key, final java.lang.String color, final Object... keys) {
        if(keys == null || keys.length == 0) {
    ...
    @Override public MultiCatErrorBarSeriesSwappable pointLabel(final io.deephaven.engine.table.Table t, final java.lang.String key, final java.lang.String label, final Object... keys) {
    ...
    @Override public MultiCatErrorBarSeriesSwappable pointLabel(final io.deephaven.plot.filters.SelectableDataSet sds, final java.lang.String key, final java.lang.String label, final Object... keys) {
        if(keys == null || keys.length == 0) {
    ...
    @Override public MultiCatErrorBarSeriesSwappable pointShape(final io.deephaven.engine.table.Table t, final java.lang.String key, final java.lang.String shape, final Object... keys) {
    ...
    @Override public MultiCatErrorBarSeriesSwappable pointShape(final io.deephaven.plot.filters.SelectableDataSet sds, final java.lang.String key, final java.lang.String shape, final Object... keys) {
        if(keys == null || keys.length == 0) {
    ...
    @Override public MultiCatErrorBarSeriesSwappable pointSize(final io.deephaven.engine.table.Table t, final java.lang.String key, final java.lang.String factor, final Object... keys) {
    ...
    @Override public MultiCatErrorBarSeriesSwappable pointSize(final io.deephaven.plot.filters.SelectableDataSet sds, final java.lang.String key, final java.lang.String factor, final Object... keys) {
        if(keys == null || keys.length == 0) {
