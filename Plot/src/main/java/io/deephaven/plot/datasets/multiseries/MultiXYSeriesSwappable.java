...
public class MultiXYSeriesSwappable extends AbstractSwappableMultiSeries<XYDataSeriesInternal> {
    ...
    @Override public MultiXYSeriesSwappable pointColor(final io.deephaven.engine.table.Table t, final java.lang.String columnName, final Object... keys) {
    ...
    @Override public MultiXYSeriesSwappable pointColor(final io.deephaven.plot.filters.SelectableDataSet sds, final java.lang.String columnName, final Object... keys) {
        if(keys == null || keys.length == 0) {
