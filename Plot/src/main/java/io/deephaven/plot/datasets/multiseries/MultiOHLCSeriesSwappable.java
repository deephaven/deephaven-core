...
public class MultiOHLCSeriesSwappable extends AbstractSwappableMultiSeries<OHLCDataSeriesInternal> {
    ...
    @Override public MultiOHLCSeriesSwappable pointColor(final io.deephaven.engine.table.Table t, final java.lang.String colors, final Object... keys) {
    ...
    @Override public MultiOHLCSeriesSwappable pointColor(final io.deephaven.plot.filters.SelectableDataSet sds, final java.lang.String colors, final Object... keys) {
        if(keys == null || keys.length == 0) {
