...
public class MultiCatSeries extends AbstractTableMapHandleMultiSeries<CategoryDataSeriesInternal> {
    ...
    public <COLOR extends io.deephaven.gui.color.Paint> MultiCatSeries pointColor(
        ...
        chart().figure().registerFigureFunction(new io.deephaven.plot.util.functions.FigureImplFunction(
    ...
    private io.deephaven.plot.util.PlotUtils.HashMapWithDefault<String, java.lang.String> errorBarColorSeriesNameToStringMap =
            new io.deephaven.plot.util.PlotUtils.HashMapWithDefault<>();
    ...
    private io.deephaven.plot.util.PlotUtils.HashMapWithDefault<String, java.lang.Integer> errorBarColorSeriesNameTointMap =
            new io.deephaven.plot.util.PlotUtils.HashMapWithDefault<>();
    ...
    private io.deephaven.plot.util.PlotUtils.HashMapWithDefault<String, io.deephaven.gui.color.Paint> errorBarColorSeriesNameToPaintMap =
            new io.deephaven.plot.util.PlotUtils.HashMapWithDefault<>();
    ...
    private io.deephaven.plot.util.PlotUtils.HashMapWithDefault<String, java.lang.Boolean> gradientVisibleSeriesNameTobooleanMap =
            new io.deephaven.plot.util.PlotUtils.HashMapWithDefault<>();
    ...
    private io.deephaven.plot.util.PlotUtils.HashMapWithDefault<String, java.lang.Integer> groupSeriesNameTointMap =
            new io.deephaven.plot.util.PlotUtils.HashMapWithDefault<>();
    ...
    private io.deephaven.plot.util.PlotUtils.HashMapWithDefault<String, java.lang.String> lineColorSeriesNameToStringMap =
            new io.deephaven.plot.util.PlotUtils.HashMapWithDefault<>();
    ...
    private io.deephaven.plot.util.PlotUtils.HashMapWithDefault<String, java.lang.Integer> lineColorSeriesNameTointMap =
            new io.deephaven.plot.util.PlotUtils.HashMapWithDefault<>();
    ...
    private io.deephaven.plot.util.PlotUtils.HashMapWithDefault<String, io.deephaven.gui.color.Paint> lineColorSeriesNameToPaintMap =
            new io.deephaven.plot.util.PlotUtils.HashMapWithDefault<>();
    ...
    private io.deephaven.plot.util.PlotUtils.HashMapWithDefault<String, io.deephaven.plot.LineStyle> lineStyleSeriesNameToLineStyleMap =
            new io.deephaven.plot.util.PlotUtils.HashMapWithDefault<>();
    ...
    @Override
    public MultiCatSeries lineStyle(final io.deephaven.plot.LineStyle style, final Object... keys) {
        if (keys == null || keys.length == 0) {
    ...
    private io.deephaven.plot.util.PlotUtils.HashMapWithDefault<String, java.lang.Boolean> linesVisibleSeriesNameToBooleanMap =
            new io.deephaven.plot.util.PlotUtils.HashMapWithDefault<>();
    ...
    private io.deephaven.plot.util.PlotUtils.HashMapWithDefault<String, java.lang.String> piePercentLabelFormatSeriesNameToStringMap =
            new io.deephaven.plot.util.PlotUtils.HashMapWithDefault<>();
    ...
    private io.deephaven.plot.util.PlotUtils.HashMapWithDefault<String, java.lang.String> pointColorSeriesNameToStringMap =
            new io.deephaven.plot.util.PlotUtils.HashMapWithDefault<>();
    ...
    private io.deephaven.plot.util.PlotUtils.HashMapWithDefault<String, java.lang.Integer> pointColorSeriesNameTointMap =
            new io.deephaven.plot.util.PlotUtils.HashMapWithDefault<>();
    ...
    private io.deephaven.plot.util.PlotUtils.HashMapWithDefault<String, io.deephaven.gui.color.Paint> pointColorSeriesNameToPaintMap =
            new io.deephaven.plot.util.PlotUtils.HashMapWithDefault<>();
    ...
    private io.deephaven.plot.util.PlotUtils.HashMapWithDefault<String, java.util.Map> pointColorSeriesNameToMapMap =
            new io.deephaven.plot.util.PlotUtils.HashMapWithDefault<>();
    ...
    private io.deephaven.plot.util.PlotUtils.HashMapWithDefault<String, java.lang.Object[]> pointColorSeriesNameToComparableStringMap =
            new io.deephaven.plot.util.PlotUtils.HashMapWithDefault<>();
    ...
    private io.deephaven.plot.util.PlotUtils.HashMapWithDefault<String, java.lang.Object[]> pointColorSeriesNameToComparableintMap =
            new io.deephaven.plot.util.PlotUtils.HashMapWithDefault<>();
    ...
    private io.deephaven.plot.util.PlotUtils.HashMapWithDefault<String, java.lang.Object[]> pointColorSeriesNameToComparablePaintMap =
            new io.deephaven.plot.util.PlotUtils.HashMapWithDefault<>();
    ...
    private io.deephaven.plot.util.PlotUtils.HashMapWithDefault<String, java.lang.Object[]> pointColorSeriesNameToSelectableDataSetStringStringMap =
            new io.deephaven.plot.util.PlotUtils.HashMapWithDefault<>();
    ...
    @Override
    public MultiCatSeries pointColor(final io.deephaven.plot.filters.SelectableDataSet sds,
    ...
    private io.deephaven.plot.util.PlotUtils.HashMapWithDefault<String, java.lang.Object[]> pointColorSeriesNameToTableStringStringMap =
            new io.deephaven.plot.util.PlotUtils.HashMapWithDefault<>();
    ...
    @Override
    public MultiCatSeries pointColor(final Table t, final java.lang.String keyColumn,
            final java.lang.String valueColumn, final Object... keys) {
        final io.deephaven.plot.util.tables.TableHandle tHandle =
                new io.deephaven.plot.util.tables.TableHandle(t, keyColumn, valueColumn);
    ...
    private io.deephaven.plot.util.PlotUtils.HashMapWithDefault<String, java.util.Map> pointColorByYSeriesNameToMapMap =
            new io.deephaven.plot.util.PlotUtils.HashMapWithDefault<>();
    ...
    private io.deephaven.plot.util.PlotUtils.HashMapWithDefault<String, java.util.Map> pointColorIntegerSeriesNameToMapMap =
            new io.deephaven.plot.util.PlotUtils.HashMapWithDefault<>();
    ...
    private io.deephaven.plot.util.PlotUtils.HashMapWithDefault<String, java.lang.Object> pointLabelSeriesNameToObjectMap =
            new io.deephaven.plot.util.PlotUtils.HashMapWithDefault<>();
    ...
    private io.deephaven.plot.util.PlotUtils.HashMapWithDefault<String, java.util.Map> pointLabelSeriesNameToMapMap =
            new io.deephaven.plot.util.PlotUtils.HashMapWithDefault<>();
    ...
    private io.deephaven.plot.util.PlotUtils.HashMapWithDefault<String, java.lang.Object[]> pointLabelSeriesNameToComparableObjectMap =
            new io.deephaven.plot.util.PlotUtils.HashMapWithDefault<>();
    ...
    private io.deephaven.plot.util.PlotUtils.HashMapWithDefault<String, java.lang.Object[]> pointLabelSeriesNameToSelectableDataSetStringStringMap =
            new io.deephaven.plot.util.PlotUtils.HashMapWithDefault<>();
    ...
    @Override
    public MultiCatSeries pointLabel(final io.deephaven.plot.filters.SelectableDataSet sds,
            final java.lang.String keyColumn, final java.lang.String valueColumn, final Object... keys) {
        if (keys == null || keys.length == 0) {
    ...
    private io.deephaven.plot.util.PlotUtils.HashMapWithDefault<String, java.lang.Object[]> pointLabelSeriesNameToTableStringStringMap =
            new io.deephaven.plot.util.PlotUtils.HashMapWithDefault<>();
    ...
    @Override
    public MultiCatSeries pointLabel(final Table t, final java.lang.String keyColumn,
            final java.lang.String valueColumn, final Object... keys) {
        final io.deephaven.plot.util.tables.TableHandle tHandle =
                new io.deephaven.plot.util.tables.TableHandle(t, keyColumn, valueColumn);
        addTableHandle(tHandle);
    ...
    private io.deephaven.plot.util.PlotUtils.HashMapWithDefault<String, java.lang.String> pointLabelFormatSeriesNameToStringMap =
            new io.deephaven.plot.util.PlotUtils.HashMapWithDefault<>();
    ...
    private io.deephaven.plot.util.PlotUtils.HashMapWithDefault<String, java.lang.String> pointShapeSeriesNameToStringMap =
            new io.deephaven.plot.util.PlotUtils.HashMapWithDefault<>();
    ...
    private io.deephaven.plot.util.PlotUtils.HashMapWithDefault<String, io.deephaven.gui.shape.Shape> pointShapeSeriesNameToShapeMap =
            new io.deephaven.plot.util.PlotUtils.HashMapWithDefault<>();
    ...
    private io.deephaven.plot.util.PlotUtils.HashMapWithDefault<String, java.util.Map> pointShapeSeriesNameToMapMap =
            new io.deephaven.plot.util.PlotUtils.HashMapWithDefault<>();
    ...
    private io.deephaven.plot.util.PlotUtils.HashMapWithDefault<String, java.lang.Object[]> pointShapeSeriesNameToComparableStringMap =
            new io.deephaven.plot.util.PlotUtils.HashMapWithDefault<>();
    ...
    private io.deephaven.plot.util.PlotUtils.HashMapWithDefault<String, java.lang.Object[]> pointShapeSeriesNameToComparableShapeMap =
            new io.deephaven.plot.util.PlotUtils.HashMapWithDefault<>();
    ...
    private io.deephaven.plot.util.PlotUtils.HashMapWithDefault<String, java.lang.Object[]> pointShapeSeriesNameToSelectableDataSetStringStringMap =
            new io.deephaven.plot.util.PlotUtils.HashMapWithDefault<>();
    ...
    @Override
    public MultiCatSeries pointShape(final io.deephaven.plot.filters.SelectableDataSet sds,
            final java.lang.String keyColumn, final java.lang.String valueColumn, final Object... keys) {
        if (keys == null || keys.length == 0) {
    ...
    private io.deephaven.plot.util.PlotUtils.HashMapWithDefault<String, java.lang.Object[]> pointShapeSeriesNameToTableStringStringMap =
            new io.deephaven.plot.util.PlotUtils.HashMapWithDefault<>();
    ...
    @Override
    public MultiCatSeries pointShape(final Table t, final java.lang.String keyColumn,
            final java.lang.String valueColumn, final Object... keys) {
        final io.deephaven.plot.util.tables.TableHandle tHandle =
                new io.deephaven.plot.util.tables.TableHandle(t, keyColumn, valueColumn);
        addTableHandle(tHandle);
    ...
    private io.deephaven.plot.util.PlotUtils.HashMapWithDefault<String, java.lang.Number> pointSizeSeriesNameToNumberMap =
            new io.deephaven.plot.util.PlotUtils.HashMapWithDefault<>();
    ...
    private io.deephaven.plot.util.PlotUtils.HashMapWithDefault<String, java.util.Map> pointSizeSeriesNameToMapMap =
            new io.deephaven.plot.util.PlotUtils.HashMapWithDefault<>();
    ...
    private io.deephaven.plot.util.PlotUtils.HashMapWithDefault<String, java.lang.Object[]> pointSizeSeriesNameToCATEGORYArrayNUMBERArrayMap =
            new io.deephaven.plot.util.PlotUtils.HashMapWithDefault<>();
    ...
    private io.deephaven.plot.util.PlotUtils.HashMapWithDefault<String, java.lang.Object[]> pointSizeSeriesNameToCATEGORYArraydoubleArrayMap =
            new io.deephaven.plot.util.PlotUtils.HashMapWithDefault<>();
    ...
    private io.deephaven.plot.util.PlotUtils.HashMapWithDefault<String, java.lang.Object[]> pointSizeSeriesNameToCATEGORYArrayintArrayMap =
            new io.deephaven.plot.util.PlotUtils.HashMapWithDefault<>();
    ...
    private io.deephaven.plot.util.PlotUtils.HashMapWithDefault<String, java.lang.Object[]> pointSizeSeriesNameToCATEGORYArraylongArrayMap =
            new io.deephaven.plot.util.PlotUtils.HashMapWithDefault<>();
    ...
    private io.deephaven.plot.util.PlotUtils.HashMapWithDefault<String, java.lang.Object[]> pointSizeSeriesNameToComparableNumberMap =
            new io.deephaven.plot.util.PlotUtils.HashMapWithDefault<>();
    ...
    private io.deephaven.plot.util.PlotUtils.HashMapWithDefault<String, java.lang.Object[]> pointSizeSeriesNameToComparabledoubleMap =
            new io.deephaven.plot.util.PlotUtils.HashMapWithDefault<>();
    ...
    private io.deephaven.plot.util.PlotUtils.HashMapWithDefault<String, java.lang.Object[]> pointSizeSeriesNameToComparableintMap =
            new io.deephaven.plot.util.PlotUtils.HashMapWithDefault<>();
    ...
    private io.deephaven.plot.util.PlotUtils.HashMapWithDefault<String, java.lang.Object[]> pointSizeSeriesNameToComparablelongMap =
            new io.deephaven.plot.util.PlotUtils.HashMapWithDefault<>();
    ...
    private io.deephaven.plot.util.PlotUtils.HashMapWithDefault<String, java.lang.Object[]> pointSizeSeriesNameToSelectableDataSetStringStringMap =
            new io.deephaven.plot.util.PlotUtils.HashMapWithDefault<>();
    ...
    @Override
    public MultiCatSeries pointSize(final io.deephaven.plot.filters.SelectableDataSet sds,
            final java.lang.String keyColumn, final java.lang.String valueColumn, final Object... keys) {
        if (keys == null || keys.length == 0) {
    ...
    private io.deephaven.plot.util.PlotUtils.HashMapWithDefault<String, java.lang.Object[]> pointSizeSeriesNameToTableStringStringMap =
            new io.deephaven.plot.util.PlotUtils.HashMapWithDefault<>();
    ...
    @Override
    public MultiCatSeries pointSize(final Table t, final java.lang.String keyColumn, final java.lang.String valueColumn,
            final Object... keys) {
        final io.deephaven.plot.util.tables.TableHandle tHandle =
                new io.deephaven.plot.util.tables.TableHandle(t, keyColumn, valueColumn);
        addTableHandle(tHandle);
    ...
    private io.deephaven.plot.util.PlotUtils.HashMapWithDefault<String, java.lang.Boolean> pointsVisibleSeriesNameToBooleanMap =
            new io.deephaven.plot.util.PlotUtils.HashMapWithDefault<>();
    ...
    private io.deephaven.plot.util.PlotUtils.HashMapWithDefault<String, java.lang.String> seriesColorSeriesNameToStringMap =
            new io.deephaven.plot.util.PlotUtils.HashMapWithDefault<>();
    ...
    private io.deephaven.plot.util.PlotUtils.HashMapWithDefault<String, java.lang.Integer> seriesColorSeriesNameTointMap =
            new io.deephaven.plot.util.PlotUtils.HashMapWithDefault<>();
    ...
    private io.deephaven.plot.util.PlotUtils.HashMapWithDefault<String, io.deephaven.gui.color.Paint> seriesColorSeriesNameToPaintMap =
            new io.deephaven.plot.util.PlotUtils.HashMapWithDefault<>();
    ...
    private io.deephaven.plot.util.PlotUtils.HashMapWithDefault<String, java.lang.String> toolTipPatternSeriesNameToStringMap =
            new io.deephaven.plot.util.PlotUtils.HashMapWithDefault<>();
    ...
    private io.deephaven.plot.util.PlotUtils.HashMapWithDefault<String, java.lang.String> xToolTipPatternSeriesNameToStringMap =
            new io.deephaven.plot.util.PlotUtils.HashMapWithDefault<>();
    ...
    private io.deephaven.plot.util.PlotUtils.HashMapWithDefault<String, java.lang.String> yToolTipPatternSeriesNameToStringMap =
            new io.deephaven.plot.util.PlotUtils.HashMapWithDefault<>();
    ...
    private <CATEGORY extends java.lang.Comparable, COLOR extends io.deephaven.gui.color.Paint, T extends io.deephaven.gui.color.Paint, LABEL, NUMBER extends java.lang.Number, COLOR0 extends java.lang.Integer> void $$initializeSeries$$(
        ...
        if (objectArray != null) {
            series.pointColor(((io.deephaven.plot.util.tables.TableHandle) objectArray[0]).getTable(),
        ...
        if (objectArray != null) {
            series.pointLabel(((io.deephaven.plot.util.tables.TableHandle) objectArray[0]).getTable(),
                    (java.lang.String) objectArray[1], (java.lang.String) objectArray[2]);
        }
        ...
        if (objectArray != null) {
            series.pointShape(((io.deephaven.plot.util.tables.TableHandle) objectArray[0]).getTable(),
                    (java.lang.String) objectArray[1], (java.lang.String) objectArray[2]);
        }
        ...
        if (objectArray != null) {
            series.pointLabel((io.deephaven.plot.filters.SelectableDataSet) objectArray[0],
                    (java.lang.String) objectArray[1], (java.lang.String) objectArray[2]);
        }
        ...
        if (objectArray != null) {
            series.pointColor((io.deephaven.plot.filters.SelectableDataSet) objectArray[0],
                    (java.lang.String) objectArray[1], (java.lang.String) objectArray[2]);
        }
        ...
        if (objectArray != null) {
            series.pointShape((io.deephaven.plot.filters.SelectableDataSet) objectArray[0],
                    (java.lang.String) objectArray[1], (java.lang.String) objectArray[2]);
        }
        ...
        if (objectArray != null) {
            series.pointSize(((io.deephaven.plot.util.tables.TableHandle) objectArray[0]).getTable(),
                    (java.lang.String) objectArray[1], (java.lang.String) objectArray[2]);
        }
        ...
        if (objectArray != null) {
            series.pointSize((io.deephaven.plot.filters.SelectableDataSet) objectArray[0],
                    (java.lang.String) objectArray[1], (java.lang.String) objectArray[2]);
        }
