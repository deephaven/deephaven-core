...
public class MultiXYErrorBarSeriesSwappable extends AbstractSwappableMultiSeries<XYErrorBarDataSeriesInternal> {
    ...
    @Override public MultiXYErrorBarSeriesSwappable errorBarColor(final java.lang.String errorBarColor, final Object... keys) {
    ...
    @Override public MultiXYErrorBarSeriesSwappable errorBarColor(final int errorBarColor, final Object... keys) {
        if(keys == null || keys.length == 0) {
    ...
    @Override public MultiXYErrorBarSeriesSwappable errorBarColor(final io.deephaven.gui.color.Paint errorBarColor, final Object... keys) {
        if(keys == null || keys.length == 0) {
    ...
    @Override public MultiXYErrorBarSeriesSwappable gradientVisible(final boolean gradientVisible, final Object... keys) {
        if(keys == null || keys.length == 0) {
    ...
    @Override public MultiXYErrorBarSeriesSwappable lineStyle(final io.deephaven.plot.LineStyle style, final Object... keys) {
        if(keys == null || keys.length == 0) {
    ...
    @Override public <T extends io.deephaven.gui.color.Paint> MultiXYErrorBarSeriesSwappable pointColor(final io.deephaven.plot.datasets.data.IndexableData<T> colors, final Object... keys) {
        if(keys == null || keys.length == 0) {
    ...
    @Override public MultiXYErrorBarSeriesSwappable pointColor(final io.deephaven.engine.table.Table t, final java.lang.String colors, final Object... keys) {
    final io.deephaven.plot.util.tables.TableHandle tHandle = new io.deephaven.plot.util.tables.TableHandle(t, colors);
    addTableHandle(tHandle);
        if(keys == null || keys.length == 0) {
            pointColorSeriesNameToTableStringMap.setDefault(new Object[]{tHandle, colors});
        } else {
    ...
    @Override public MultiXYErrorBarSeriesSwappable pointColor(final io.deephaven.plot.filters.SelectableDataSet sds, final java.lang.String colors, final Object... keys) {
        if(keys == null || keys.length == 0) {
            pointColorSeriesNameToSelectableDataSetStringMap.setDefault(new Object[]{sds, colors});
        } else {
    ...
    @Override public MultiXYErrorBarSeriesSwappable pointColorInteger(final io.deephaven.plot.datasets.data.IndexableData<java.lang.Integer> colors, final Object... keys) {
        if(keys == null || keys.length == 0) {
    ...
    @Override public MultiXYErrorBarSeriesSwappable pointLabel(final io.deephaven.plot.datasets.data.IndexableData<?> labels, final Object... keys) {
        if(keys == null || keys.length == 0) {
    ...
    @Override public MultiXYErrorBarSeriesSwappable pointLabel(final io.deephaven.engine.table.Table t, final java.lang.String label, final Object... keys) {
    ...
    @Override public MultiXYErrorBarSeriesSwappable pointLabel(final io.deephaven.plot.filters.SelectableDataSet sds, final java.lang.String label, final Object... keys) {
        if(keys == null || keys.length == 0) {
    ...
    @Override public MultiXYErrorBarSeriesSwappable pointShape(final io.deephaven.plot.datasets.data.IndexableData<java.lang.String> shapes, final Object... keys) {
        if(keys == null || keys.length == 0) {
    ...
    @Override public MultiXYErrorBarSeriesSwappable pointShape(final io.deephaven.engine.table.Table t, final java.lang.String shape, final Object... keys) {
    ...
    @Override public MultiXYErrorBarSeriesSwappable pointShape(final io.deephaven.plot.filters.SelectableDataSet sds, final java.lang.String shape, final Object... keys) {
        if(keys == null || keys.length == 0) {
    ...
    @Override public MultiXYErrorBarSeriesSwappable pointSize(final io.deephaven.plot.datasets.data.IndexableData<java.lang.Double> factors, final Object... keys) {
        if(keys == null || keys.length == 0) {
    ...
    @Override public MultiXYErrorBarSeriesSwappable pointSize(final io.deephaven.engine.table.Table t, final java.lang.String factor, final Object... keys) {
    ...
    @Override public MultiXYErrorBarSeriesSwappable pointSize(final io.deephaven.plot.filters.SelectableDataSet sds, final java.lang.String factor, final Object... keys) {
        if(keys == null || keys.length == 0) {
    ...
    @Override public MultiXYErrorBarSeriesSwappable toolTipPattern(final java.lang.String toolTipPattern, final Object... keys) {
        if(keys == null || keys.length == 0) {
    ...
    @Override public MultiXYErrorBarSeriesSwappable xToolTipPattern(final java.lang.String xToolTipPattern, final Object... keys) {
        if(keys == null || keys.length == 0) {
    ...
    @Override public MultiXYErrorBarSeriesSwappable yToolTipPattern(final java.lang.String yToolTipPattern, final Object... keys) {
        if(keys == null || keys.length == 0) {
