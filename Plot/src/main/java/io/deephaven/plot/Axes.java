...
public interface Axes extends Serializable {
    ...
    /**
     * Creates a new Axes instance which shares the same {@link Axis}
     * objects as this Axes.
     * The resultant Axes has the same range, ticks, etc. as this Axes
     * (as these are fields of the {@link Axis}) but may have,
    ...
    /**
     * Creates a new Axes instance which shares the same x-{@link Axis}
     * as this Axes.
     * <p>
     * The resultant Axes has the same x-axis range, ticks, etc. as this Axes
     * (as these are properties of the {@link Axis})
    ...
    /**
     * Creates a new Axes instance which shares the same y-{@link Axis}
     * as this Axes.
     * <p>
    ...
    /**
     * Gets the {@link Axis} at dimension {@code dim}.
    ...
    /**
     * Sets the {@link AxisTransform} of the x-{@link Axis}
     * as an {@link AxisTransformBusinessCalendar}.
     *
     ...
     * @return this Axes using the business calendar from row 0 of the filtered {@code sds} for the x-{@link Axis} business calendar.  If no value is found, no transform will be applied.
     */
     ...
     * @param sds selectable data set (e.g. OneClick filterable table) containing the business calendar.
     * @param valueColumn name of a column containing String values, where each value is the name of a {@link BusinessCalendar}.
     * @return this Axes using the business calendar from row 0 of the filtered {@code sds} for the y-{@link Axis} business calendar.  If no value is found, no transform will be applied.
     */
     ...
     */
    XYErrorBarDataSeries errorBarXY(final Comparable seriesName, final Table t, final String x, final String xLow, final String xHigh, final String y, final String yLow, final String yHigh);
     ...
     * @return dataset created for plot
     */
    XYErrorBarDataSeries errorBarXY(final Comparable seriesName, final SelectableDataSet sds, final String x, final String xLow, final String xHigh, final String y, final String yLow, final String yHigh);
     ...
     * @return dataset created for plot
     */
    MultiSeries errorBarXYBy(final Comparable seriesName, final Table t, final String x, final String xLow, final String xHigh, final String y, final String yLow, final String yHigh, final String... byColumns);
     ...
     * @return dataset created for plot
     */
    MultiSeries errorBarXYBy(final Comparable seriesName, final SelectableDataSet sds, final String x, final String xLow, final String xHigh, final String y, final String yLow, final String yHigh, final String... byColumns);
     ...
     * @return dataset created for plot
     */
    XYErrorBarDataSeries errorBarX( java.lang.Comparable seriesName, Table t, java.lang.String x, java.lang.String xLow, java.lang.String xHigh, java.lang.String y );
     ...
     * @return dataset created for plot
     */
    XYErrorBarDataSeries errorBarX( java.lang.Comparable seriesName, SelectableDataSet sds, java.lang.String x, java.lang.String xLow, java.lang.String xHigh, java.lang.String y );
     ...
     * @return dataset created for plot
     */
    MultiSeries errorBarXBy(final Comparable seriesName, final Table t, final String x, final String xLow, final String xHigh, final String y, final String... byColumns);
     ...
     * @return dataset created for plot
     */
    MultiSeries errorBarXBy(final Comparable seriesName, final SelectableDataSet sds, final String x, final String xLow, final String xHigh, final String y, final String... byColumns);
     ...
     * @return dataset created for plot
     */
    XYErrorBarDataSeries errorBarY( java.lang.Comparable seriesName, Table t, java.lang.String x, java.lang.String y, java.lang.String yLow, java.lang.String yHigh );
     ...
     * @return dataset created for plot
     */
    XYErrorBarDataSeries errorBarY( java.lang.Comparable seriesName, SelectableDataSet sds, java.lang.String x, java.lang.String y, java.lang.String yLow, java.lang.String yHigh );
     ...
     * @return dataset created for plot
     */
    MultiSeries errorBarYBy(final Comparable seriesName, final Table t, final String x, final String y, final String yLow, final String yHigh, final String... byColumns);
     ...
     * @return dataset created for plot
     */
    MultiSeries errorBarYBy(final Comparable seriesName, final SelectableDataSet sds, final String x, final String y, final String yLow, final String yHigh, final String... byColumns);
     ...
     * @return dataset created for plot
     */
    CategoryDataSeries catErrorBar(final Comparable seriesName, final Table t, final String categories, final String values, final String yLow, final String yHigh);
     ...
     * @return dataset created for plot
     */
    CategoryDataSeries catErrorBar(final Comparable seriesName, final SelectableDataSet sds, final String categories, final String values, final String yLow, final String yHigh);
     ...
     * @return dataset created for plot
     */
    MultiSeries catErrorBarBy(final Comparable seriesName, final Table t, final String categories, final String values, final String yLow, final String yHigh, final String... byColumns);
     ...
     * @return dataset created for plot
     */
    MultiSeries catErrorBarBy(final Comparable seriesName, final SelectableDataSet sds, final String categories, final String values, final String yLow, final String yHigh, final String... byColumns);
     ...
     * @return dataset created for plot
     */
    XYDataSeries plot(final Comparable seriesName, final IndexableNumericData x, final IndexableNumericData y, final boolean hasXTimeAxis, final boolean hasYTimeAxis);
     ...
     * @return dataset created for plot
     */
    MultiSeries plotBy(final Comparable seriesName, final Table t, final String x, final String y, final String... byColumns);
     ...
     * @return dataset created for plot
     */
    MultiSeries plotBy(final Comparable seriesName, final SelectableDataSet sds, final String x, final String y, final String... byColumns);
     ...
     * @return dataset created for plot
     */
    OHLCDataSeries ohlcPlot(final Comparable seriesName, final IndexableNumericData time, final IndexableNumericData open, final IndexableNumericData high, final IndexableNumericData low, final IndexableNumericData close);
     ...
     * @return dataset created for plot
     */
    OHLCDataSeries ohlcPlot(final Comparable seriesName, final Table t, final String timeCol, final String openCol, final String highCol, final String lowCol, final String closeCol);
     ...
     * @return dataset created for plot
     */
    OHLCDataSeries ohlcPlot(final Comparable seriesName, final SelectableDataSet sds, final String timeCol, final String openCol, final String highCol, final String lowCol, final String closeCol);
     ...
     * @return dataset created for plot
     */
    MultiSeries ohlcPlotBy(final Comparable seriesName, final Table t, final String timeCol, final String openCol, final String highCol, final String lowCol, final String closeCol, final String... byColumns);
     ...
     * @return dataset created for plot
     */
    MultiSeries ohlcPlotBy(final Comparable seriesName, final SelectableDataSet sds, final String timeCol, final String openCol, final String highCol, final String lowCol, final String closeCol, final String... byColumns);
     ...
     * @throws IllegalArgumentException {@code columnName} must be a numeric column in {@code t}
     */
    IntervalXYDataSeries histPlot(final Comparable seriesName, final Table t, final String columnName, final double rangeMin, final double rangeMax, final int nbins);
     ...
     */
    IntervalXYDataSeries histPlot(final Comparable seriesName, final SelectableDataSet sds, final String columnName, final int nbins);
     ...
     * @throws IllegalArgumentException {@code columnName} must be a numeric column in {@code sds}
     */
    IntervalXYDataSeries histPlot(final Comparable seriesName, final SelectableDataSet sds, final String columnName, final double rangeMin, final double rangeMax, final int nbins);
     ...
     * @return dataset created for plot
     */
    <T1 extends Comparable> CategoryDataSeries catPlot(final Comparable seriesName, final IndexableData<T1> categories, final IndexableNumericData values);
     ...
     * @return dataset created for plot
     */
    CategoryDataSeries catPlot(final Comparable seriesName, final Table t, final String categories, final String values);
     ...
     * @return dataset created for plot
     */
    CategoryDataSeries catPlot(final Comparable seriesName, final SelectableDataSet sds, final String categories, final String values);
     ...
     * @return dataset created for plot
     */
    MultiSeries catPlotBy(final Comparable seriesName, final Table t, final String categories, final String values, final String... byColumns);
     ...
     * @return dataset created for plot
     */
    MultiSeries catPlotBy(final Comparable seriesName, final SelectableDataSet sds, final String categories, final String values, final String... byColumns);
     ...
     * @return dataset created for plot
     */
    <T1 extends Comparable> CategoryDataSeries piePlot(final Comparable seriesName, final IndexableData<T1> categories, final IndexableNumericData values);
     ...
     * @return dataset created for plot
     */
    CategoryDataSeries piePlot(final Comparable seriesName, final Table t, final String categories, final String values);
     ...
     * @return dataset created for plot
     */
    CategoryDataSeries piePlot(final Comparable seriesName, final SelectableDataSet sds, final String categories, final String values);
