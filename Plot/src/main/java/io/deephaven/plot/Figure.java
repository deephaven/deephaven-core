...
public interface Figure extends java.io.Serializable, io.deephaven.plot.BaseFigure, io.deephaven.plot.Chart, io.deephaven.plot.Axes, io.deephaven.plot.Axis, io.deephaven.plot.datasets.DataSeries, io.deephaven.plot.datasets.category.CategoryDataSeries, io.deephaven.plot.datasets.interval.IntervalXYDataSeries, io.deephaven.plot.datasets.ohlc.OHLCDataSeries, io.deephaven.plot.datasets.xy.XYDataSeries, io.deephaven.plot.datasets.multiseries.MultiSeries, io.deephaven.plot.datasets.xy.XYDataSeriesFunction, io.deephaven.plot.datasets.xyerrorbar.XYErrorBarDataSeries, io.deephaven.plot.datasets.categoryerrorbar.CategoryErrorBarDataSeries {
    ...
    @Override  Figure businessTime( io.deephaven.engine.time.calendar.BusinessCalendar calendar );
    ...
    @Override <T0 extends java.lang.Comparable> Figure catErrorBar( java.lang.Comparable seriesName, T0[] categories, io.deephaven.engine.time.DateTime[] values, io.deephaven.engine.time.DateTime[] yLow, io.deephaven.engine.time.DateTime[] yHigh );
    ...
    @Override <T0 extends java.lang.Comparable> Figure catPlot( java.lang.Comparable seriesName, T0[] categories, io.deephaven.engine.time.DateTime[] values );
    ...
    @Override <T0 extends java.lang.Comparable> Figure catPlot( java.lang.Comparable seriesName, java.util.List<T0> categories, io.deephaven.engine.time.DateTime[] values );
    ...
    @Override <T0 extends java.lang.Number,T1 extends java.lang.Number,T2 extends java.lang.Number> Figure errorBarX( java.lang.Comparable seriesName, T0[] x, T1[] xLow, T2[] xHigh, io.deephaven.engine.time.DateTime[] y );
    ...
    @Override  Figure errorBarX( java.lang.Comparable seriesName, double[] x, double[] xLow, double[] xHigh, io.deephaven.engine.time.DateTime[] y );
    ...
    @Override  Figure errorBarX( java.lang.Comparable seriesName, float[] x, float[] xLow, float[] xHigh, io.deephaven.engine.time.DateTime[] y );
    ...
    @Override  Figure errorBarX( java.lang.Comparable seriesName, int[] x, int[] xLow, int[] xHigh, io.deephaven.engine.time.DateTime[] y );
    ...
    @Override  Figure errorBarX( java.lang.Comparable seriesName, long[] x, long[] xLow, long[] xHigh, io.deephaven.engine.time.DateTime[] y );

    @Override  Figure errorBarX( java.lang.Comparable seriesName, long[] x, long[] xLow, long[] xHigh, java.util.Date[] y );

    @Override <T3 extends java.lang.Number> Figure errorBarX( java.lang.Comparable seriesName, io.deephaven.engine.time.DateTime[] x, io.deephaven.engine.time.DateTime[] xLow, io.deephaven.engine.time.DateTime[] xHigh, T3[] y );

    @Override  Figure errorBarX( java.lang.Comparable seriesName, io.deephaven.engine.time.DateTime[] x, io.deephaven.engine.time.DateTime[] xLow, io.deephaven.engine.time.DateTime[] xHigh, double[] y );

    @Override  Figure errorBarX( java.lang.Comparable seriesName, io.deephaven.engine.time.DateTime[] x, io.deephaven.engine.time.DateTime[] xLow, io.deephaven.engine.time.DateTime[] xHigh, float[] y );

    @Override  Figure errorBarX( java.lang.Comparable seriesName, io.deephaven.engine.time.DateTime[] x, io.deephaven.engine.time.DateTime[] xLow, io.deephaven.engine.time.DateTime[] xHigh, int[] y );

    @Override  Figure errorBarX( java.lang.Comparable seriesName, io.deephaven.engine.time.DateTime[] x, io.deephaven.engine.time.DateTime[] xLow, io.deephaven.engine.time.DateTime[] xHigh, long[] y );

    @Override  Figure errorBarX( java.lang.Comparable seriesName, io.deephaven.engine.time.DateTime[] x, io.deephaven.engine.time.DateTime[] xLow, io.deephaven.engine.time.DateTime[] xHigh, io.deephaven.engine.time.DateTime[] y );

    @Override  Figure errorBarX( java.lang.Comparable seriesName, io.deephaven.engine.time.DateTime[] x, io.deephaven.engine.time.DateTime[] xLow, io.deephaven.engine.time.DateTime[] xHigh, short[] y );

    @Override <T3 extends java.lang.Number> Figure errorBarX( java.lang.Comparable seriesName, io.deephaven.engine.time.DateTime[] x, io.deephaven.engine.time.DateTime[] xLow, io.deephaven.engine.time.DateTime[] xHigh, java.util.List<T3> y );
    ...
    @Override  Figure errorBarX( java.lang.Comparable seriesName, short[] x, short[] xLow, short[] xHigh, io.deephaven.engine.time.DateTime[] y );
    ...
    @Override <T0 extends java.lang.Number,T1 extends java.lang.Number,T2 extends java.lang.Number> Figure errorBarX( java.lang.Comparable seriesName, java.util.List<T0> x, java.util.List<T1> xLow, java.util.List<T2> xHigh, io.deephaven.engine.time.DateTime[] y );
    ...
    @Override <T0 extends java.lang.Number,T1 extends java.lang.Number,T2 extends java.lang.Number> Figure errorBarXY( java.lang.Comparable seriesName, T0[] x, T1[] xLow, T2[] xHigh, io.deephaven.engine.time.DateTime[] y, io.deephaven.engine.time.DateTime[] yLow, io.deephaven.engine.time.DateTime[] yHigh );
    ...
    @Override  Figure errorBarXY( java.lang.Comparable seriesName, double[] x, double[] xLow, double[] xHigh, io.deephaven.engine.time.DateTime[] y, io.deephaven.engine.time.DateTime[] yLow, io.deephaven.engine.time.DateTime[] yHigh );
    ...
    @Override  Figure errorBarXY( java.lang.Comparable seriesName, float[] x, float[] xLow, float[] xHigh, io.deephaven.engine.time.DateTime[] y, io.deephaven.engine.time.DateTime[] yLow, io.deephaven.engine.time.DateTime[] yHigh );
    ...
    @Override  Figure errorBarXY( java.lang.Comparable seriesName, int[] x, int[] xLow, int[] xHigh, io.deephaven.engine.time.DateTime[] y, io.deephaven.engine.time.DateTime[] yLow, io.deephaven.engine.time.DateTime[] yHigh );
    ...
    @Override  Figure errorBarXY( java.lang.Comparable seriesName, long[] x, long[] xLow, long[] xHigh, io.deephaven.engine.time.DateTime[] y, io.deephaven.engine.time.DateTime[] yLow, io.deephaven.engine.time.DateTime[] yHigh );
    ...
    @Override <T3 extends java.lang.Number,T4 extends java.lang.Number,T5 extends java.lang.Number> Figure errorBarXY( java.lang.Comparable seriesName, io.deephaven.engine.time.DateTime[] x, io.deephaven.engine.time.DateTime[] xLow, io.deephaven.engine.time.DateTime[] xHigh, T3[] y, T4[] yLow, T5[] yHigh );

    @Override  Figure errorBarXY( java.lang.Comparable seriesName, io.deephaven.engine.time.DateTime[] x, io.deephaven.engine.time.DateTime[] xLow, io.deephaven.engine.time.DateTime[] xHigh, double[] y, double[] yLow, double[] yHigh );

    @Override  Figure errorBarXY( java.lang.Comparable seriesName, io.deephaven.engine.time.DateTime[] x, io.deephaven.engine.time.DateTime[] xLow, io.deephaven.engine.time.DateTime[] xHigh, float[] y, float[] yLow, float[] yHigh );

    @Override  Figure errorBarXY( java.lang.Comparable seriesName, io.deephaven.engine.time.DateTime[] x, io.deephaven.engine.time.DateTime[] xLow, io.deephaven.engine.time.DateTime[] xHigh, int[] y, int[] yLow, int[] yHigh );

    @Override  Figure errorBarXY( java.lang.Comparable seriesName, io.deephaven.engine.time.DateTime[] x, io.deephaven.engine.time.DateTime[] xLow, io.deephaven.engine.time.DateTime[] xHigh, long[] y, long[] yLow, long[] yHigh );

    @Override  Figure errorBarXY( java.lang.Comparable seriesName, io.deephaven.engine.time.DateTime[] x, io.deephaven.engine.time.DateTime[] xLow, io.deephaven.engine.time.DateTime[] xHigh, io.deephaven.engine.time.DateTime[] y, io.deephaven.engine.time.DateTime[] yLow, io.deephaven.engine.time.DateTime[] yHigh );

    @Override  Figure errorBarXY( java.lang.Comparable seriesName, io.deephaven.engine.time.DateTime[] x, io.deephaven.engine.time.DateTime[] xLow, io.deephaven.engine.time.DateTime[] xHigh, short[] y, short[] yLow, short[] yHigh );

    @Override <T3 extends java.lang.Number,T4 extends java.lang.Number,T5 extends java.lang.Number> Figure errorBarXY( java.lang.Comparable seriesName, io.deephaven.engine.time.DateTime[] x, io.deephaven.engine.time.DateTime[] xLow, io.deephaven.engine.time.DateTime[] xHigh, java.util.List<T3> y, java.util.List<T4> yLow, java.util.List<T5> yHigh );
    ...
    @Override  Figure errorBarXY( java.lang.Comparable seriesName, short[] x, short[] xLow, short[] xHigh, io.deephaven.engine.time.DateTime[] y, io.deephaven.engine.time.DateTime[] yLow, io.deephaven.engine.time.DateTime[] yHigh );
    ...
    @Override <T0 extends java.lang.Number,T1 extends java.lang.Number,T2 extends java.lang.Number> Figure errorBarXY( java.lang.Comparable seriesName, java.util.List<T0> x, java.util.List<T1> xLow, java.util.List<T2> xHigh, io.deephaven.engine.time.DateTime[] y, io.deephaven.engine.time.DateTime[] yLow, io.deephaven.engine.time.DateTime[] yHigh );
    ...
    @Override <T0 extends java.lang.Number> Figure errorBarY( java.lang.Comparable seriesName, T0[] x, io.deephaven.engine.time.DateTime[] y, io.deephaven.engine.time.DateTime[] yLow, io.deephaven.engine.time.DateTime[] yHigh );
    ...
    @Override  Figure errorBarY( java.lang.Comparable seriesName, double[] x, io.deephaven.engine.time.DateTime[] y, io.deephaven.engine.time.DateTime[] yLow, io.deephaven.engine.time.DateTime[] yHigh );
    ...
    @Override  Figure errorBarY( java.lang.Comparable seriesName, float[] x, io.deephaven.engine.time.DateTime[] y, io.deephaven.engine.time.DateTime[] yLow, io.deephaven.engine.time.DateTime[] yHigh );
    ...
    @Override  Figure errorBarY( java.lang.Comparable seriesName, int[] x, io.deephaven.engine.time.DateTime[] y, io.deephaven.engine.time.DateTime[] yLow, io.deephaven.engine.time.DateTime[] yHigh );
    ...
    @Override  Figure errorBarY( java.lang.Comparable seriesName, long[] x, io.deephaven.engine.time.DateTime[] y, io.deephaven.engine.time.DateTime[] yLow, io.deephaven.engine.time.DateTime[] yHigh );
    ...
    @Override <T1 extends java.lang.Number,T2 extends java.lang.Number,T3 extends java.lang.Number> Figure errorBarY( java.lang.Comparable seriesName, io.deephaven.engine.time.DateTime[] x, T1[] y, T2[] yLow, T3[] yHigh );

    @Override  Figure errorBarY( java.lang.Comparable seriesName, io.deephaven.engine.time.DateTime[] x, double[] y, double[] yLow, double[] yHigh );

    @Override  Figure errorBarY( java.lang.Comparable seriesName, io.deephaven.engine.time.DateTime[] x, float[] y, float[] yLow, float[] yHigh );

    @Override  Figure errorBarY( java.lang.Comparable seriesName, io.deephaven.engine.time.DateTime[] x, int[] y, int[] yLow, int[] yHigh );

    @Override  Figure errorBarY( java.lang.Comparable seriesName, io.deephaven.engine.time.DateTime[] x, long[] y, long[] yLow, long[] yHigh );

    @Override  Figure errorBarY( java.lang.Comparable seriesName, io.deephaven.engine.time.DateTime[] x, io.deephaven.engine.time.DateTime[] y, io.deephaven.engine.time.DateTime[] yLow, io.deephaven.engine.time.DateTime[] yHigh );

    @Override  Figure errorBarY( java.lang.Comparable seriesName, io.deephaven.engine.time.DateTime[] x, short[] y, short[] yLow, short[] yHigh );

    @Override <T1 extends java.lang.Number,T2 extends java.lang.Number,T3 extends java.lang.Number> Figure errorBarY( java.lang.Comparable seriesName, io.deephaven.engine.time.DateTime[] x, java.util.List<T1> y, java.util.List<T2> yLow, java.util.List<T3> yHigh );
    ...
    @Override  Figure errorBarY( java.lang.Comparable seriesName, short[] x, io.deephaven.engine.time.DateTime[] y, io.deephaven.engine.time.DateTime[] yLow, io.deephaven.engine.time.DateTime[] yHigh );
    ...
    @Override <T0 extends java.lang.Number> Figure errorBarY( java.lang.Comparable seriesName, java.util.List<T0> x, io.deephaven.engine.time.DateTime[] y, io.deephaven.engine.time.DateTime[] yLow, io.deephaven.engine.time.DateTime[] yHigh );
    ...
    @Override <T1 extends java.lang.Number,T2 extends java.lang.Number,T3 extends java.lang.Number,T4 extends java.lang.Number> Figure ohlcPlot( java.lang.Comparable seriesName, io.deephaven.engine.time.DateTime[] time, T1[] open, T2[] high, T3[] low, T4[] close );

    @Override  Figure ohlcPlot( java.lang.Comparable seriesName, io.deephaven.engine.time.DateTime[] time, double[] open, double[] high, double[] low, double[] close );

    @Override  Figure ohlcPlot( java.lang.Comparable seriesName, io.deephaven.engine.time.DateTime[] time, float[] open, float[] high, float[] low, float[] close );

    @Override  Figure ohlcPlot( java.lang.Comparable seriesName, io.deephaven.engine.time.DateTime[] time, int[] open, int[] high, int[] low, int[] close );

    @Override  Figure ohlcPlot( java.lang.Comparable seriesName, io.deephaven.engine.time.DateTime[] time, long[] open, long[] high, long[] low, long[] close );

    @Override  Figure ohlcPlot( java.lang.Comparable seriesName, io.deephaven.engine.time.DateTime[] time, short[] open, short[] high, short[] low, short[] close );

    @Override <T1 extends java.lang.Number,T2 extends java.lang.Number,T3 extends java.lang.Number,T4 extends java.lang.Number> Figure ohlcPlot( java.lang.Comparable seriesName, io.deephaven.engine.time.DateTime[] time, java.util.List<T1> open, java.util.List<T2> high, java.util.List<T3> low, java.util.List<T4> close );
    ...
    @Override <T0 extends java.lang.Number> Figure plot( java.lang.Comparable seriesName, T0[] x, io.deephaven.engine.time.DateTime[] y );
    ...
    @Override  Figure plot( java.lang.Comparable seriesName, double[] x, io.deephaven.engine.time.DateTime[] y );
    ...
    @Override  Figure plot( java.lang.Comparable seriesName, float[] x, io.deephaven.engine.time.DateTime[] y );
    ...
    @Override  Figure plot( java.lang.Comparable seriesName, int[] x, io.deephaven.engine.time.DateTime[] y );
    ...
    @Override  Figure plot( java.lang.Comparable seriesName, long[] x, io.deephaven.engine.time.DateTime[] y );
    ...
    @Override <T1 extends java.lang.Number> Figure plot( java.lang.Comparable seriesName, io.deephaven.engine.time.DateTime[] x, T1[] y );

    @Override  Figure plot( java.lang.Comparable seriesName, io.deephaven.engine.time.DateTime[] x, double[] y );

    @Override  Figure plot( java.lang.Comparable seriesName, io.deephaven.engine.time.DateTime[] x, float[] y );

    @Override  Figure plot( java.lang.Comparable seriesName, io.deephaven.engine.time.DateTime[] x, int[] y );

    @Override  Figure plot( java.lang.Comparable seriesName, io.deephaven.engine.time.DateTime[] x, long[] y );

    @Override  Figure plot( java.lang.Comparable seriesName, io.deephaven.engine.time.DateTime[] x, io.deephaven.engine.time.DateTime[] y );

    @Override  Figure plot( java.lang.Comparable seriesName, io.deephaven.engine.time.DateTime[] x, java.util.Date[] y );

    @Override  Figure plot( java.lang.Comparable seriesName, io.deephaven.engine.time.DateTime[] x, short[] y );

    @Override <T1 extends java.lang.Number> Figure plot( java.lang.Comparable seriesName, io.deephaven.engine.time.DateTime[] x, java.util.List<T1> y );
    ...
    @Override  Figure plot( java.lang.Comparable seriesName, java.util.Date[] x, io.deephaven.engine.time.DateTime[] y );
    ...
    @Override  Figure plot( java.lang.Comparable seriesName, short[] x, io.deephaven.engine.time.DateTime[] y );
    ...
    @Override <T0 extends java.lang.Number> Figure plot( java.lang.Comparable seriesName, java.util.List<T0> x, io.deephaven.engine.time.DateTime[] y );
    ...
    @Override  Figure xBusinessTime( io.deephaven.engine.time.calendar.BusinessCalendar calendar );
    ...
    @Override  Figure yBusinessTime( io.deephaven.engine.time.calendar.BusinessCalendar calendar );
