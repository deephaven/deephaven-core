...
public interface SelectableDataSet<KEY_TYPE, VALUE_TYPE> {
     ...
     *
     * @param chart chart
     * @param tableTransform tableTransform applied to the tables in partitionedTables. The purpose of this transform is to
     *        track the table definitions for tables inside partitionedTable
