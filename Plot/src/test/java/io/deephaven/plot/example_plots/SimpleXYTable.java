...
public class SimpleXYTable {
    ...
    public static void main(String[] args) {
        ...
        Table t = TableTools.emptyTable(10).updateView("Timestamp = DateTimeUtils.epochNanosToInstant(i * HOUR)", "Open = i",
                "High = i + 2", "Low = i - 2", "Close = i + 1", "By = i % 5");
        Table t2 = TableTools.emptyTable(5000).updateView("Timestamp = DateTimeUtils.epochNanosToInstant(0) + (i * HOUR)",
