...
public class SimplePlotBy {
    ...
    public static void main(String[] args) {
        ...
        final Table t =
                TableTools.newTable(TableTools.col("USym", cats), TableTools.intCol("TrackingWritableRowSet", x1),
        ...
        Figure axs = cht.newAxes().xTransform(AxisTransforms.LOG)
                .xLabel("X")
                .yLabel("Y")
                .plotBy("Test1", t, "TrackingWritableRowSet", "Value", "USym").lineColor("black").pointsVisible(true)
                .show();
