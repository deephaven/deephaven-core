...
public class TestSeriesLocation extends BaseArrayTestCase {
    ...
    public void testLocation() {
        final Table t =
            TableTools.emptyTable(100).update("A=i%2==0?`A`:`B`", "X=1.0*i", "Y=1.0*i*i");
        ...
        final XYDataSeriesArray s11 =
            a11.plot("S1", new double[] {1, 2, 3}, new double[] {4, 5, 6});
        final XYDataSeriesArray s12 =
        ...
        final XYDataSeriesArray s21 =
            a21.plot("S1", new double[] {1, 2, 3}, new double[] {4, 5, 6});
        final XYDataSeriesArray s22 =
