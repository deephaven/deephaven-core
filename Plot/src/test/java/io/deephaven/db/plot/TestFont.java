...
public class TestFont extends BaseArrayTestCase{
    ...
    public void testConstructors() {
        assertEquals(new Font("Ariel", Font.FontStyle.PLAIN, 10).javaFont(), new java.awt.Font("Ariel", java.awt.Font.PLAIN, 10));
        ...
        assertEquals(Font.font("Ariel", Font.FontStyle.PLAIN, 10).javaFont(), new java.awt.Font("Ariel", java.awt.Font.PLAIN, 10));
