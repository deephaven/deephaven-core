...
public class TestCompilerTools {
    ...
    public void testParallelCompile() throws Throwable {
        ...
        // Use a unique value added to the class name to guarantee unique classes, in case workspaces aren't cleared out correctly
        ...
        for (long i = 0; i < NUM_COMPILE_TESTS; i++) {
            ...
            System.out.println(printMillis(endTimeTest) + ": compile test of " + testClassName + " took " + compileTestMillis + " millis");
            if (i > 0) {
        ...
        System.out.println("Average compile time millis: " + averageCompileTime + ", delay will be " + waitStartMillis + " millis");
        ...
        for (int i = 0; i < NUM_THREADS; i++) {
            ...
            threads[i] = new Thread(() -> {
                try {
                    ...
                    System.out.println(printMillis(endTime) + ": thread " + fi + " completed with specified delay=" + delay
    ...
    private void compile(boolean printDetails, final String className) throws Exception {
        ...
        if (printDetails) {
            ...
            System.out.println(printMillis(endMillis) + ": Thread 0 ending compile: (" + (endMillis - startMillis) + ") millis elapsed");
        }
    }
    ...
    public void testSimpleCompile() throws Exception {
        ...
        final Class<?> clazz1 = CompilerTools.compile("Test", program1Text, "com.deephaven.test", codeLog, Collections.emptyMap());
