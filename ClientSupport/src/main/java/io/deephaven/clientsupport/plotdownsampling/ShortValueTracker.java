 ...
 */
public final class ShortValueTracker extends ValueTracker {
    private final ShortArraySource source = new ShortArraySource();
    ...
    private short minValue(int offset) {
        return source.getUnsafe(minValuePosition(offset));
    }
    private short maxValue(int offset) {
        return source.getUnsafe(maxValuePosition(offset));
    }

    private void setMinValue(int offset, short value) {
        source.set(minValuePosition(offset), value);
    }
    private void setMaxValue(int offset, short value) {
    ...
    public String toString(int offset) {
        return "ShortValueTracker("+offset+") { max=" + maxValue(offset) + ", min=" + minValue(offset) + " }";
    }
}
