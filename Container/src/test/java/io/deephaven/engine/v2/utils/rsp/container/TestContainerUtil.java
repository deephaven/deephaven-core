...
public class TestContainerUtil {
    ...
    public void testUtilUnsignedIntersection() {
        ...
        Assert.assertTrue(ContainerUtil.unsignedIntersects(data1, data1.length, data2, data2.length));
        short[] data3 = {-19, -17, -15, -13, -11, -9, -7};
        short[] data4 = {-18, -16, -14, -12, -10, -8, -6, -4, -2, 0};
        Assert.assertFalse(ContainerUtil.unsignedIntersects(data3, data3.length, data4, data4.length));
        short[] data5 = {};
        short[] data6 = {};
        Assert.assertFalse(ContainerUtil.unsignedIntersects(data5, data5.length, data6, data6.length));
    }
