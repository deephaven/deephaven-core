...
public interface RangeConsumer {
     ...
     * Methods receiving a RangeConsumer should call accept on it for for non-empty, disjoint ranges.
     * Calls should be made in increasing order of values contained in the ranges.
     *
