...
/**
 * A "no-op" table creation impl, based on the QST structure itself. Mainly useful for testing
 * the equivalence for the {@link io.deephaven.qst.TableOperations} of {@link Table}; but publicly
