...
public class AggregatingByteRingBufferTest extends TestCase {
    ...
    public void testRangesCollapse() {
        // overlapping
        assertTrue(AggregatingByteRingBuffer.rangesCollapse(0, 2, 1, 3));
        assertTrue(AggregatingByteRingBuffer.rangesCollapse(1, 3, 0, 2));

        assertTrue(AggregatingByteRingBuffer.rangesCollapse(0, 10, 1, 3));
        assertTrue(AggregatingByteRingBuffer.rangesCollapse(1, 3, 0, 10));

        // fully contained
        assertTrue(AggregatingByteRingBuffer.rangesCollapse(0, 3, 1, 2));
        assertTrue(AggregatingByteRingBuffer.rangesCollapse(1, 2, 0, 3));

        assertTrue(AggregatingByteRingBuffer.rangesCollapse(1, 2, 1, 1));
        assertTrue(AggregatingByteRingBuffer.rangesCollapse(1, 1, 1, 2));

        assertTrue(AggregatingByteRingBuffer.rangesCollapse(1, 2, 2, 2));
        assertTrue(AggregatingByteRingBuffer.rangesCollapse(2, 2, 1, 2));

        // consecutive
        assertTrue(AggregatingByteRingBuffer.rangesCollapse(0, 1, 2, 3));
        assertTrue(AggregatingByteRingBuffer.rangesCollapse(2, 3, 0, 1));

        // non-overlapping, non consecutive
        assertFalse(AggregatingByteRingBuffer.rangesCollapse(0, 1, 3, 4));
        assertFalse(AggregatingByteRingBuffer.rangesCollapse(3, 4, 0, 1));

        assertFalse(AggregatingByteRingBuffer.rangesCollapse(0, 1, 9, 10));
        assertFalse(AggregatingByteRingBuffer.rangesCollapse(9, 10, 0, 1));
    }
