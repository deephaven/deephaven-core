...
public class KeyValuePairLongToObjectTest extends TestCase {
    ...
    private static class Reader implements FastArray.ReadExternalFunction<KeyValuePairLongToObject<TrialClassA>> {
        ...
        @Override
        public void readExternal(ObjectInput in, KeyValuePairLongToObject<TrialClassA> item) throws IOException, ClassNotFoundException {
...
//                    System.out.println("write vlue:\n" + value);
    ...
    public void checkExternalization(KeyValuePairLongToObject<TrialClassA> kvpInput, KeyValuePairLongToObject<TrialClassA> kvpReceiver) throws Exception {
        if (kvpInput == null) {
