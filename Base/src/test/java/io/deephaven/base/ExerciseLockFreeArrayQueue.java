        ...
        public void put(T el, BenchRunner runner) {
            ...
            while ( !q.offer(el) ) {
                ...
                if ( spin == 1000000 ) {
                    ...
                    error("PBQ: aborting stuck producer after "+(ABORT_NANOS/1000000)+" millis and "+spin+" spins on element "+el);
                    break;
                }
            }
        ...
        public T get(BenchRunner runner) {
            ...
            while ( (v = q.poll()) == null ) {
                ...
                if ( spin == 1000000 ) {
                    ...
                    error("PBQ: aborting stuck consumer after "+(ABORT_NANOS/1000000)+" millis and "+spin+" spins");
                    break;
                }
            }
    ...
    public static void testManyThreads(final int trial, final BenchQueue<Int> q,
        ...
        for ( int i = 0; i < N; ++i ) {
            if ( dequeueCounts.get(i) != 1 ) {
                error("Trial "+trial+" testManyThreads: object "+i+" was dequeued "+dequeueCounts.get(i)+" times");
            }
        }
    }
