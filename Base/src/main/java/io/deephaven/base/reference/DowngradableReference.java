...
/**
 * SimpleReference implementation that allows a downgrade from strongly reachable to weakly
 * reachable.
 * 
...
public class DowngradableReference<T> extends WeakReference<T> implements SimpleReference<T> {
    ...
    /**
     * Eliminate this object's hard reference to the referent. Converts the reachability enforced by
     * this object from hard to weak.
     */
