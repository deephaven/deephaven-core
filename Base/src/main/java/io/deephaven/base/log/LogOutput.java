...
//--------------------------------------------------------------------
/**
 * Collects output for efficient textual logging. The append methods
 * are intended to behave like StringBuilder to the extent possible,
 * but the fast loggers make no pretense about handling Unicode or
 * producing anything but good old ASCII.
 * <P> Note that although the output will probably be single byte
 * ASCII, we behave like StringBuilder and by the standard overload
 * and promotion rules appending a byte actually appends an integer
...
public interface LogOutput {
    ...
    /** Appends the character equivalent of each byte remaining in the
     * given ByteBuffer ([65 66 67] == "ABC" not "656667"), but does
     * not modify the mark, position, or limit of the ByteBuffer. */
    ...
    default LogOutput append(Boolean b) { return b == null ? append("null") : append((boolean) b); }
    default LogOutput append(Character c) { return c == null ? append("null") : append((char) c); }
    default LogOutput append(Short s) { return s == null ? append("null") : append((short) s); }
    default LogOutput append(Integer i) { return i == null ? append("null") : append((int) i); };
    default LogOutput append(Long l) { return l == null ? append("null") : append((long) l); };
    default LogOutput appendDouble(Double f) { return f == null ? append("null") : appendDouble((double) f); }
     ...
     * Formats a String Collection
     */
    ObjFormatter<Collection<LogOutputAppendable>> APPENDABLE_COLLECTION_FORMATTER = new LogOutput.ObjFormatter<Collection<LogOutputAppendable>>() {
        @Override
     ...
     */
    LongFormatter MILLIS_FROM_EPOCH_FORMATTER = (logOutput, millis) -> logOutput.append(millisFormatter.getTimestamp(millis));
    ...
    class Null implements LogOutput {
        @Override public LogOutput start() { return this; }
        @Override public LogOutput append(boolean b) { return this; }
        @Override public LogOutput append(char c) { return this; }
        @Override public LogOutput append(short s) { return this; }
        @Override public LogOutput append(int i) { return this; }
        @Override public LogOutput append(long l) { return this; }

        @Override public LogOutput appendDouble(double f) { return this; }
        private LogOutput appendDouble(double f, int digits, boolean forceScientific, boolean trailingZeroes) { return this; }
        @Override public LogOutput append(LogOutputAppendable appendable) { return this; }
        @Override public <T> LogOutput append(ObjFormatter<T> objFormatter, T t) { return this; }
        @Override public <T> LogOutput append(ObjIntIntFormatter<T> objFormatter, T t, int nOffset, int nLength) { return this; }
        @Override public <T, U> LogOutput append(ObjObjFormatter<T, U> objObjFormatter, T t, U u) { return this; }
        @Override public LogOutput append(LongFormatter formatter, long n) { return this; }
        @Override public LogOutput append(CharSequence seq) { return this; }
        @Override public LogOutput append(CharSequence seq, int start, int length) { return this; }
        @Override public LogOutput append(final ByteBuffer bb) { return this; }
        @Override public LogOutput appendTimestamp(long utcMillis, TimestampBuffer tb) { return this; }
        @Override public LogOutput appendTimestampMicros(long utcMicros, TimestampBufferMicros tb) { return this; }
        @Override public LogOutput append(Throwable t) { return this; }
        @Override public LogOutput append(byte[] ba) { return this; }
        @Override public LogOutput append(byte[] ba, int pos, int length) { return this; }
        @Override public LogOutput append(byte[] ba, byte terminator) { return this; }

        @Override public LogOutput markEndOfHeader() { return this; }
        @Override public int getEndOfHeaderOffset() { return 0; }

        @Override public LogOutput nf() { return this; }
        @Override public LogOutput nl() { return this; }
        @Override public LogOutput close() { return this; }
        @Override public int relativeSize() { return 0; }
        @Override public int size() { return 0; }
        @Override public int getBufferCount() { return 0; }
        @Override public ByteBuffer getBuffer(int i) { return null; }
        @Override public LogOutput clear() { return this; }
    }
}
