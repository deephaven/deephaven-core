...
public class ConcurrentUnboundedStringCache<STRING_LIKE_TYPE extends CharSequence>
     ...
     */
    public ConcurrentUnboundedStringCache(@NotNull final StringCacheTypeAdapter<STRING_LIKE_TYPE> typeAdapter,
        ...
        stringCompatibleKeyValueFactory =
                debug ? new CheckedStringCompatibleKeyValueFactory() : new UncheckedStringCompatibleKeyValueFactory();
    ...
    private class CheckedStringCompatibleKeyValueFactory
        ...
        public STRING_LIKE_TYPE newValue(final CharSequence key) {
            ...
            Assert.assertion(CharSequenceUtils.contentEquals(key, value), "CharSequenceUtils.contentEquals(key, value)",
                    key, "key", value, "value");
