...
public interface StringCache<STRING_LIKE_TYPE extends CharSequence> {
     ...
     * @return -1 : This is an unbounded cache.
     *          0 : This "cache" doesn't actually perform any caching.
     *         >0 : Actual capacity bound.
     */
    int capacity();
     ...
     * @return A cached STRING_LIKE_TYPE that corresponds to the current value of the CharSequence expressed by protoString
     */
    @NotNull STRING_LIKE_TYPE getCachedString(@NotNull StringCompatible protoString);
     ...
     */
    @NotNull STRING_LIKE_TYPE getCachedString(@NotNull String string);
