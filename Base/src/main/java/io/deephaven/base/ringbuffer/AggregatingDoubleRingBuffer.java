...
public class AggregatingDoubleRingBuffer {
     ...
     */
    public AggregatingDoubleRingBuffer(int capacity, double identityVal, DoubleFunction aggFunction) {
     ...
     */
    private void evaluateAndStoreResults(int start, int end, double[] src, int dstOffset) {
