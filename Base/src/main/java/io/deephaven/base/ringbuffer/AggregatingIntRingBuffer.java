...
public class AggregatingIntRingBuffer {
    ...
    /**
     * Create a ring buffer for int values which aggregates its contents according to a user-defined aggregation
    ...
    public int removeUnsafe() {
        ...
        int val = internalBuffer.removeUnsafe();
     ...
     */
    private void computeAndStoreResults(int start, int end, int[] src, int dstOffset) {
