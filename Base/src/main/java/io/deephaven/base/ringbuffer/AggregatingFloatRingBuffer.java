...
public class AggregatingFloatRingBuffer {
    ...
    private final FloatFunction aggFunction;
     ...
     */
    public AggregatingFloatRingBuffer(int capacity, float identityVal, FloatFunction aggFunction) {
     ...
     */
    public AggregatingFloatRingBuffer(int capacity, float identityVal, FloatFunction aggFunction, boolean growable) {
     ...
     */
    private void evaluateAndStoreResults(int start, int end, float[] src, int dstOffset) {
        ...
        for (int left = start & 0xFFFFFFFE; left <= end; left += 2) {
            ...
            final float computeVal = aggFunction.apply(leftVal, rightVal);
