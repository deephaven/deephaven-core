...
public class AggregatingFloatRingBuffer {
    ...
    /**
     * Create a ring buffer for float values which aggregates its contents according to a user-defined aggregation
    ...
    public float removeUnsafe() {
        ...
        float val = internalBuffer.removeUnsafe();
     ...
     */
    private void computeAndStoreResults(int start, int end, float[] src, int dstOffset) {
