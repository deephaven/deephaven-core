...
public class AggregatingShortRingBuffer {
    ...
    private final ShortFunction aggFunction;
     ...
     */
    public AggregatingShortRingBuffer(int capacity, short identityVal, ShortFunction aggFunction) {
     ...
     */
    public AggregatingShortRingBuffer(int capacity, short identityVal, ShortFunction aggFunction, boolean growable) {
     ...
     */
    private void evaluateAndStoreResults(int start, int end, short[] src, int dstOffset) {
        ...
        for (int left = start & 0xFFFFFFFE; left <= end; left += 2) {
            ...
            final short computeVal = aggFunction.apply(leftVal, rightVal);
