...
public class AggregatingShortRingBuffer {
    ...
    /**
     * Create a ring buffer for short values which aggregates its contents according to a user-defined aggregation
    ...
    public short removeUnsafe() {
        ...
        short val = internalBuffer.removeUnsafe();
     ...
     */
    private void computeAndStoreResults(int start, int end, short[] src, int dstOffset) {
