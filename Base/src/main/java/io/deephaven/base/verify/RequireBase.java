...
/**
 * Non-reflective/threaded requirement methods for simple runtime program verification. Failed requirements throw
 * {@link RequirementFailure}.
 * <p>
 * Methods:
 * <ul>
 ...
 * </ul>
 *
 * @implNote Simpler version of {@link Require} - checks that don't need reflection/threads/etc may belong here, to
 *           allow them to be shared with the JS API implementation.
 */
public class RequireBase {
    ...
    // ----------------------------------------------------------------
    static void fail(String conditionText) {
    ...
    // ----------------------------------------------------------------
    static void fail(String conditionText, String detailMessage) {
        final RequirementFailure requirementFailure = new RequirementFailure(
