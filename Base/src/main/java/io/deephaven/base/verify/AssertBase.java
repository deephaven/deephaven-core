...
/**
 * Non-reflective/threaded assertion methods for simple runtime program verification. Failed assertions throw
 ...
 * </ul>
 *
 * @implNote Simpler version of {@link Assert} - checks that don't need reflection/threads/etc may belong here, to allow
 *           them to be shared with the JS API implementation.
 */
