...
//--------------------------------------------------------------------
/**
 * A statistic that represents the composite or rolled-up value
 * of a set of child statistics, as best as possible. This statistic
 * cannot be {@link #sample}d or {@link #increment}ed. Currently,
 * calls to {@link #update} are silently ignored, which also means
 * that Composites are not logged. Thus a Composite is currently only
 * useful for summaries in web/JMX displays.
 */
