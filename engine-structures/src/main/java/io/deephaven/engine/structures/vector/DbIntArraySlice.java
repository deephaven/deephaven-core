...
public class DbIntArraySlice extends DbIntArray.Indirect {
    ...
    public DbIntArraySlice(@NotNull final DbIntArray innerArray, final long offsetIndex, final long length, final long innerArrayValidFromInclusive, final long innerArrayValidToExclusive) {
    ...
    public DbIntArraySlice(@NotNull final DbIntArray innerArray, final long offsetIndex, final long length) {
    ...
    @Override
    public DbIntArray subArray(final long fromIndexInclusive, final long toIndexExclusive) {
            ...
            return new DbIntArraySlice(innerArray, newOffsetIndex, newLength,
    ...
    @Override
    public int[] toArray() {
        if (innerArray instanceof DbIntArrayDirect && offsetIndex >= innerArrayValidFromInclusive && offsetIndex + length <= innerArrayValidToExclusive) {
