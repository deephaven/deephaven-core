package io.deephaven.engine.structures.exceptions;
...
/**
 * <p>
 * Unchecked exception thrown when operations are invoked that cannot be completed correctly due to size constraints on
 * the underlying data structures.
 * <p>
 * For example, the current implementations of {@link RedirectionIndex} can only support an 32-bit integer number of
 * keys.
 */
