...
func (c *tableServiceClient) ComputeColumnStatistics(ctx context.Context, in *ColumnStatisticsRequest, opts ...grpc.CallOption) (*ExportedTableCreationResponse, error) {
	out := new(ExportedTableCreationResponse)
	err := c.cc.Invoke(ctx, "/io.deephaven.proto.backplane.grpc.TableService/ComputeColumnStatistics", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *tableServiceClient) Slice(ctx context.Context, in *SliceRequest, opts ...grpc.CallOption) (*ExportedTableCreationResponse, error) {
	out := new(ExportedTableCreationResponse)
	err := c.cc.Invoke(ctx, "/io.deephaven.proto.backplane.grpc.TableService/Slice", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedTableServiceServer) ComputeColumnStatistics(context.Context, *ColumnStatisticsRequest) (*ExportedTableCreationResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ComputeColumnStatistics not implemented")
}
func (UnimplementedTableServiceServer) Slice(context.Context, *SliceRequest) (*ExportedTableCreationResponse, error) {
...
func _TableService_ComputeColumnStatistics_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ColumnStatisticsRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(TableServiceServer).ComputeColumnStatistics(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/io.deephaven.proto.backplane.grpc.TableService/ComputeColumnStatistics",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TableServiceServer).ComputeColumnStatistics(ctx, req.(*ColumnStatisticsRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _TableService_Slice_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(SliceRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(TableServiceServer).Slice(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/io.deephaven.proto.backplane.grpc.TableService/Slice",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TableServiceServer).Slice(ctx, req.(*SliceRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var TableService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "ComputeColumnStatistics",
			Handler:    _TableService_ComputeColumnStatistics_Handler,
		},
		{
			MethodName: "Slice",
			Handler:    _TableService_Slice_Handler,
		},
	},
