...
func main() {
	args := []string{
		"--go_out=../..", "--go_opt=module=github.com/deephaven/deephaven-core/go",
		"--go-grpc_out=../..", "--go-grpc_opt=module=github.com/deephaven/deephaven-core/go",
	...
	for _, file := range files {
		...
		modPathPair := fileName + "=github.com/deephaven/deephaven-core/go/internal/proto/" + file
