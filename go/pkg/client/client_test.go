...
// TestLargeSnapshot exercises the multi-batch snapshot path: with a table larger than the server's
// MAX_SNAPSHOT_CELL_COUNT (1 << 24 cells), the snapshot is guaranteed to arrive as multiple Arrow
