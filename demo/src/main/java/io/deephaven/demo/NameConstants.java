 ...
 * NameConstants:
 * <p>
 * <p> Instead of random magic strings littering random method bodies,
 * <p> Let's instead litter this class with well-named constants ^-^
 */
public class NameConstants {
    ...
    public static final String BACKEND_ENVOY = "{\"ports\": { \"" + PORT_ENVOY_CLIENT_NAME + "\":\"dh-backend-envoy\" }}";
    ...
    public static final int PORT_ENVOY_CLIENT = Integer.parseInt(System.getProperty("dh-envoy-port", "10000"));
    ...
    public static final String DH_HELM_TARGET = System.getProperty(PROP_HELM_TARGET, DH_HELM_ROOT + "/generated");
    ...
    public static final String DH_INGRESS_NAME = System.getProperty("dh-ingress-name", "dh-ingress");
