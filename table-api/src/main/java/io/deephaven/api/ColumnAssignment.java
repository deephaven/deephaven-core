...
public abstract class ColumnAssignment implements JoinAddition, Selectable {
    ...
    public static ColumnAssignment parse(String x) {
        ...
        return of(ColumnName.parse(x.substring(0, ix)), ColumnName.parse(x.substring(ix + 1)));
    }
