...
public enum AggCountType {
    ...
    /**
     * Returns a functions that tests a boolean value stored as a byte.
     */
    public static BooleanCountFunction getBooleanCountFunction(final AggCountType countType) {
        switch (countType) {
            case ALL:
                return value -> true;
            case NON_NULL:
            ...
            default:
                throw new UnsupportedOperationException(
                        "Unsupported count type: " + countType + " for boolean data type");
        }
