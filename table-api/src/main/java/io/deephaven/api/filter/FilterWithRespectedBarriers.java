...
@Immutable
@SimpleStyle
public abstract class FilterWithRespectedBarriers extends FilterBase implements Filter {
     ...
     */
    public static FilterWithRespectedBarriers of(Filter filter, Object... barriers) {
        return ImmutableFilterWithRespectedBarriers.of(filter, barriers);
    }
    ...
    public Filter invert() {
        return FilterWithRespectedBarriers.of(filter().invert(), respectedBarriers());
    }
