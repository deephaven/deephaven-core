...
/**
 * Describes a TableMap by its handle and the keys present. At this time, a key can be a String, but
 * support for (boxed) int, long, and eventually Object[] (containing only string, int, long) will
 * be expected as well.
 */
