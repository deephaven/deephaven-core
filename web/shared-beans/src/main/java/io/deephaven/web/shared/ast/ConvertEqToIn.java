...
/**
 * IN-type expressions are more efficient at runtime than EQUALS, and also compile more quickly. However, they only work
 ...
 *
 * This is sort of the opposite of {@link ConvertInvalidInExpressions}, which converts EQs to INs when the types of the
