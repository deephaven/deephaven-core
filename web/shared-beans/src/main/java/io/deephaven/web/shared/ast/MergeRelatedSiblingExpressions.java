...
/**
 * If two or more IN-like expressions are in the same OR (or NOT-INs in the same AND), join them together into a single
...
public class MergeRelatedSiblingExpressions extends ReplacingVisitor {
    ...
    private FilterDescriptor mergedFilterDescriptor(FilterDescriptor.FilterOperation op, FilterDescriptor column,
            Set<FilterDescriptor> values) {
