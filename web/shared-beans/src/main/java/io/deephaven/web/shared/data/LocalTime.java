 ...
 * This should be better for serialization than java.time.LocalTime since we use bytes for
 * hour, minute and second, and is compatible with GWT (java.time is not available in GWT).
 */
