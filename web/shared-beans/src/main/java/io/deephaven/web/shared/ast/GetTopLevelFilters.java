 ...
 *
 * This can be run before the FilterPrinter to provide multiple strings to execute individually.
 * It should be run after other optimizations which might merge operations, and should be
 * run before nested Match operations are rewritten to invocations.
 */
