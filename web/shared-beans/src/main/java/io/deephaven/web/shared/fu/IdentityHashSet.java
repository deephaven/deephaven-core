 ...
 *
 * Should be very fast for pooled objects,
 * and completely wrong for different instances of Object which .equal() each other.
 *
 * Use only if you can guarantee type parameter T is a pooled object
 * (TableHandle, JsTable, ClientTableState, etc.)
 */
