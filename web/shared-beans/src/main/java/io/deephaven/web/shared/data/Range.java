...
/**
 * Describes a contiguous range of at least one item. Equals/hashcode compare both start and end, but
 * comparing Range instances will compare only by start - the overlap(Range) method should be used to
 * see if two ranges share at least one item.
 */
