...
public class NormalizeNotsTest extends AbstractReplacingVisitorTest {
    ...
    public void testNormalizeNots() {
        ...
        assertUnchanged("other non-flippble expression",
                or(
                        not(node(FilterDescriptor.FilterOperation.CONTAINS, reference("ColumnA"), literal("asdf"))),
        ...
        assertFilterEquals("flip various leaf expressions",
                not(or(
                        node(FilterDescriptor.FilterOperation.LT, reference("ColumnA"), reference("ColumnB")),
                        node(FilterDescriptor.FilterOperation.GT, reference("ColumnA"), reference("ColumnB")),
                        node(FilterDescriptor.FilterOperation.LTE, reference("ColumnA"), reference("ColumnB")),
                        node(FilterDescriptor.FilterOperation.GTE, reference("ColumnA"), reference("ColumnB")),
                        ...
                        node(FilterDescriptor.FilterOperation.NEQ, reference("ColumnA"), reference("ColumnB")),
                        node(FilterDescriptor.FilterOperation.NEQ_ICASE, reference("ColumnA"), reference("ColumnB")),
                        node(FilterDescriptor.FilterOperation.IN, reference("ColumnA"), reference("ColumnB")),
                        node(FilterDescriptor.FilterOperation.IN_ICASE, reference("ColumnA"), reference("ColumnB")),
                        node(FilterDescriptor.FilterOperation.NOT_IN, reference("ColumnA"), reference("ColumnB")),
                ...
                and(
                        ...
                        node(FilterDescriptor.FilterOperation.EQ_ICASE, reference("ColumnA"), reference("ColumnB")),
                        node(FilterDescriptor.FilterOperation.NOT_IN, reference("ColumnA"), reference("ColumnB")),
                        node(FilterDescriptor.FilterOperation.NOT_IN_ICASE, reference("ColumnA"), reference("ColumnB")),
                        node(FilterDescriptor.FilterOperation.IN, reference("ColumnA"), reference("ColumnB")),
                        node(FilterDescriptor.FilterOperation.IN_ICASE, reference("ColumnA"), reference("ColumnB"))));
    }
