...
@JsType(
        isNative = true,
        name = "dhinternal.io.deephaven_core.proto.table_pb.ExportedTableCreationResponse",
    ...
    public interface ToObjectReturnType {
        ...
        public interface ResultIdFieldType {
            ...
            public interface TicketFieldType {
                ...
                @JsOverlay
                static ExportedTableCreationResponse.ToObjectReturnType.ResultIdFieldType.TicketFieldType create() {
                    return Js.uncheckedCast(JsPropertyMap.of());
                }

                @JsProperty
                ExportedTableCreationResponse.ToObjectReturnType.ResultIdFieldType.TicketFieldType.GetTicketUnionType getTicket();
            ...
            @JsProperty
            ExportedTableCreationResponse.ToObjectReturnType.ResultIdFieldType.TicketFieldType getTicket();
    ...
    public interface ToObjectReturnType0 {
        ...
        public interface ResultIdFieldType {
            ...
            public interface TicketFieldType {
                ...
                @JsOverlay
                static ExportedTableCreationResponse.ToObjectReturnType0.ResultIdFieldType.TicketFieldType create() {
                    return Js.uncheckedCast(JsPropertyMap.of());
                }

                @JsProperty
                ExportedTableCreationResponse.ToObjectReturnType0.ResultIdFieldType.TicketFieldType.GetTicketUnionType getTicket();
            ...
            @JsProperty
            ExportedTableCreationResponse.ToObjectReturnType0.ResultIdFieldType.TicketFieldType getTicket();
