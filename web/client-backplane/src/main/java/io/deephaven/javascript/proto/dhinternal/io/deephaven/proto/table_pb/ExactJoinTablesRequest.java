  ...
  public interface ToObjectReturnType {
    ...
    public interface ResultIdFieldType {
      ...
      default void setTicket(String ticket) {
        setTicket(
            Js
                .<ExactJoinTablesRequest.ToObjectReturnType.ResultIdFieldType.GetTicketUnionType>
  ...
  public interface ToObjectReturnType0 {
    ...
    public interface ResultIdFieldType {
      ...
      default void setTicket(String ticket) {
        setTicket(
            Js
                .<ExactJoinTablesRequest.ToObjectReturnType0.ResultIdFieldType.GetTicketUnionType>
                    uncheckedCast(ticket));
      }
