...
@JsType(
    isNative = true,
    name =
        "dhinternal.io.deephaven.proto.console_pb.ChangeDocumentRequest.TextDocumentContentChangeEvent",
...
public class TextDocumentContentChangeEvent {
  ...
  public interface ToObjectReturnType {
    ...
    public interface RangeFieldType {
      ...
      public interface StartFieldType {
        @JsOverlay
        static TextDocumentContentChangeEvent.ToObjectReturnType.RangeFieldType.StartFieldType
            create() {
  ...
  public interface ToObjectReturnType0 {
    ...
    public interface RangeFieldType {
      ...
      public interface StartFieldType {
        @JsOverlay
        static TextDocumentContentChangeEvent.ToObjectReturnType0.RangeFieldType.StartFieldType
            create() {
          return Js.uncheckedCast(JsPropertyMap.of());
        }
