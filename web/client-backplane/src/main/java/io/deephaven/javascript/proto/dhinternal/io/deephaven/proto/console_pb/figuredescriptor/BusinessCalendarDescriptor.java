...
public class BusinessCalendarDescriptor {
  ...
  public interface ToObjectReturnType {
    ...
    public interface HolidaysListFieldType {
      ...
      public interface DateFieldType {
        @JsOverlay
        static BusinessCalendarDescriptor.ToObjectReturnType.HolidaysListFieldType.DateFieldType
            create() {
          return Js.uncheckedCast(JsPropertyMap.of());
        }
    ...
    @JsProperty
    JsArray<BusinessCalendarDescriptor.ToObjectReturnType.BusinessPeriodsListFieldType>
    ...
    default void setBusinessPeriodsList(
        BusinessCalendarDescriptor.ToObjectReturnType.BusinessPeriodsListFieldType[]
            businessPeriodsList) {
    ...
    default void setHolidaysList(
      ...
      setHolidaysList(
          Js
              .<JsArray<BusinessCalendarDescriptor.ToObjectReturnType.HolidaysListFieldType>>
  ...
  public interface ToObjectReturnType0 {
    ...
    public interface HolidaysListFieldType {
      ...
      public interface DateFieldType {
        @JsOverlay
        static BusinessCalendarDescriptor.ToObjectReturnType0.HolidaysListFieldType.DateFieldType
            create() {
          return Js.uncheckedCast(JsPropertyMap.of());
        }
    ...
    @JsProperty
    JsArray<BusinessCalendarDescriptor.ToObjectReturnType0.BusinessPeriodsListFieldType>
        getBusinessPeriodsList();
    ...
    @JsOverlay
    default void setBusinessPeriodsList(
        BusinessCalendarDescriptor.ToObjectReturnType0.BusinessPeriodsListFieldType[]
            businessPeriodsList) {
      setBusinessPeriodsList(
          Js
              .<JsArray<
    ...
    default void setHolidaysList(
      ...
      setHolidaysList(
          Js
              .<JsArray<BusinessCalendarDescriptor.ToObjectReturnType0.HolidaysListFieldType>>
                  uncheckedCast(holidaysList));
    }
