        ...
        public interface TextEditFieldType {
          ...
          public interface RangeFieldType {
            ...
            public interface StartFieldType {
              @JsOverlay
              static AutoCompleteResponse.ToObjectReturnType.CompletionItemsFieldType
                      .ItemsListFieldType.TextEditFieldType.RangeFieldType.StartFieldType
                  create() {
            ...
            @JsOverlay
            static AutoCompleteResponse.ToObjectReturnType.CompletionItemsFieldType
                    .ItemsListFieldType.TextEditFieldType.RangeFieldType
                create() {
              return Js.uncheckedCast(JsPropertyMap.of());
            }
          ...
          @JsOverlay
          static AutoCompleteResponse.ToObjectReturnType.CompletionItemsFieldType.ItemsListFieldType
                  .TextEditFieldType
              create() {
            return Js.uncheckedCast(JsPropertyMap.of());
          }
          ...
          @JsProperty
          AutoCompleteResponse.ToObjectReturnType.CompletionItemsFieldType.ItemsListFieldType
                  .TextEditFieldType.RangeFieldType
              getRange();
      ...
      public interface ItemsListFieldType {
        ...
        public interface TextEditFieldType {
          ...
          public interface RangeFieldType {
            ...
            public interface StartFieldType {
              @JsOverlay
              static AutoCompleteResponse.ToObjectReturnType0.CompletionItemsFieldType
                      .ItemsListFieldType.TextEditFieldType.RangeFieldType.StartFieldType
                  create() {
                return Js.uncheckedCast(JsPropertyMap.of());
              }
          ...
          @JsOverlay
          static AutoCompleteResponse.ToObjectReturnType0.CompletionItemsFieldType
                  .ItemsListFieldType.TextEditFieldType
              create() {
            return Js.uncheckedCast(JsPropertyMap.of());
          }
        ...
        @JsOverlay
        static AutoCompleteResponse.ToObjectReturnType0.CompletionItemsFieldType.ItemsListFieldType
            create() {
          return Js.uncheckedCast(JsPropertyMap.of());
        }
