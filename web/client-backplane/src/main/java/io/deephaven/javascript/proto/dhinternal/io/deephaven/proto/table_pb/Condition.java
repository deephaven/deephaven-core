    ...
    public interface CompareFieldType {
      ...
      public interface LhsFieldType {
        ...
        public interface LiteralFieldType {
          @JsOverlay
          static Condition.ToObjectReturnType.CompareFieldType.LhsFieldType.LiteralFieldType
              create() {
            return Js.uncheckedCast(JsPropertyMap.of());
          }
        ...
        public interface ReferenceFieldType {
          @JsOverlay
          static Condition.ToObjectReturnType.CompareFieldType.LhsFieldType.ReferenceFieldType
              create() {
            return Js.uncheckedCast(JsPropertyMap.of());
          }
        ...
        @JsProperty
        Condition.ToObjectReturnType.CompareFieldType.LhsFieldType.ReferenceFieldType
            getReference();
  ...
  public interface ToObjectReturnType0 {
    ...
    public interface CompareFieldType {
      ...
      public interface LhsFieldType {
        ...
        public interface LiteralFieldType {
          @JsOverlay
          static Condition.ToObjectReturnType0.CompareFieldType.LhsFieldType.LiteralFieldType
              create() {
            return Js.uncheckedCast(JsPropertyMap.of());
          }
        ...
        public interface ReferenceFieldType {
          @JsOverlay
          static Condition.ToObjectReturnType0.CompareFieldType.LhsFieldType.ReferenceFieldType
              create() {
            return Js.uncheckedCast(JsPropertyMap.of());
          }
        ...
        @JsProperty
        Condition.ToObjectReturnType0.CompareFieldType.LhsFieldType.ReferenceFieldType
            getReference();
