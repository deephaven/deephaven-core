...
public class AutoCompleteRequest {
  ...
  public interface ToObjectReturnType {
    ...
    public interface ChangeDocumentFieldType {
      ...
      public interface ContentChangesListFieldType {
        ...
        public interface RangeFieldType {
          ...
          public interface StartFieldType {
            @JsOverlay
            static AutoCompleteRequest.ToObjectReturnType.ChangeDocumentFieldType
                    .ContentChangesListFieldType.RangeFieldType.StartFieldType
                create() {
          ...
          @JsOverlay
          static AutoCompleteRequest.ToObjectReturnType.ChangeDocumentFieldType
                  .ContentChangesListFieldType.RangeFieldType
              create() {
            return Js.uncheckedCast(JsPropertyMap.of());
          }
          ...
          @JsProperty
          AutoCompleteRequest.ToObjectReturnType.ChangeDocumentFieldType.ContentChangesListFieldType
          ...
          @JsProperty
          void setStart(
              AutoCompleteRequest.ToObjectReturnType.ChangeDocumentFieldType
                      .ContentChangesListFieldType.RangeFieldType.StartFieldType
                  start);
        }
      ...
      public interface TextDocumentFieldType {
        @JsOverlay
        static AutoCompleteRequest.ToObjectReturnType.ChangeDocumentFieldType.TextDocumentFieldType
            create() {
          return Js.uncheckedCast(JsPropertyMap.of());
        }
      ...
      @JsProperty
      AutoCompleteRequest.ToObjectReturnType.ChangeDocumentFieldType.TextDocumentFieldType
          getTextDocument();
    ...
    public interface GetCompletionItemsFieldType {
      ...
      public interface ContextFieldType {
        @JsOverlay
        static AutoCompleteRequest.ToObjectReturnType.GetCompletionItemsFieldType.ContextFieldType
            create() {
          return Js.uncheckedCast(JsPropertyMap.of());
        }
      ...
      @JsProperty
      AutoCompleteRequest.ToObjectReturnType.GetCompletionItemsFieldType.ContextFieldType
          getContext();
    ...
    public interface OpenDocumentFieldType {
      ...
      public interface ConsoleIdFieldType {
        ...
        public interface GetTicketUnionType {
          @JsOverlay
          static AutoCompleteRequest.ToObjectReturnType.OpenDocumentFieldType.ConsoleIdFieldType
                  .GetTicketUnionType
              of(Object o) {
            return Js.cast(o);
          }
        ...
        @JsProperty
        AutoCompleteRequest.ToObjectReturnType.OpenDocumentFieldType.ConsoleIdFieldType
                .GetTicketUnionType
            getTicket();
      ...
      public interface TextDocumentFieldType {
        @JsOverlay
        static AutoCompleteRequest.ToObjectReturnType.OpenDocumentFieldType.TextDocumentFieldType
            create() {
          return Js.uncheckedCast(JsPropertyMap.of());
        }
      ...
      @JsProperty
      AutoCompleteRequest.ToObjectReturnType.OpenDocumentFieldType.TextDocumentFieldType
          getTextDocument();
  ...
  public interface ToObjectReturnType0 {
    ...
    public interface ChangeDocumentFieldType {
      ...
      public interface ContentChangesListFieldType {
        ...
        public interface RangeFieldType {
          ...
          public interface StartFieldType {
            @JsOverlay
            static AutoCompleteRequest.ToObjectReturnType0.ChangeDocumentFieldType
                    .ContentChangesListFieldType.RangeFieldType.StartFieldType
                create() {
              return Js.uncheckedCast(JsPropertyMap.of());
            }
          ...
          @JsProperty
          AutoCompleteRequest.ToObjectReturnType0.ChangeDocumentFieldType
                  .ContentChangesListFieldType.RangeFieldType.StartFieldType
              getStart();
        ...
        @JsProperty
        AutoCompleteRequest.ToObjectReturnType0.ChangeDocumentFieldType.ContentChangesListFieldType
                .RangeFieldType
            getRange();
      ...
      public interface TextDocumentFieldType {
        @JsOverlay
        static AutoCompleteRequest.ToObjectReturnType0.ChangeDocumentFieldType.TextDocumentFieldType
            create() {
          return Js.uncheckedCast(JsPropertyMap.of());
        }
      ...
      @JsProperty
      AutoCompleteRequest.ToObjectReturnType0.ChangeDocumentFieldType.TextDocumentFieldType
          getTextDocument();
    ...
    public interface GetCompletionItemsFieldType {
      ...
      public interface ContextFieldType {
        @JsOverlay
        static AutoCompleteRequest.ToObjectReturnType0.GetCompletionItemsFieldType.ContextFieldType
            create() {
          return Js.uncheckedCast(JsPropertyMap.of());
        }
      ...
      @JsProperty
      AutoCompleteRequest.ToObjectReturnType0.GetCompletionItemsFieldType.ContextFieldType
          getContext();
    ...
    public interface OpenDocumentFieldType {
      ...
      public interface ConsoleIdFieldType {
        ...
        public interface GetTicketUnionType {
          @JsOverlay
          static AutoCompleteRequest.ToObjectReturnType0.OpenDocumentFieldType.ConsoleIdFieldType
                  .GetTicketUnionType
              of(Object o) {
            return Js.cast(o);
          }
        ...
        @JsProperty
        AutoCompleteRequest.ToObjectReturnType0.OpenDocumentFieldType.ConsoleIdFieldType
                .GetTicketUnionType
            getTicket();
      ...
      public interface TextDocumentFieldType {
        @JsOverlay
        static AutoCompleteRequest.ToObjectReturnType0.OpenDocumentFieldType.TextDocumentFieldType
            create() {
          return Js.uncheckedCast(JsPropertyMap.of());
        }
      ...
      @JsProperty
      AutoCompleteRequest.ToObjectReturnType0.OpenDocumentFieldType.TextDocumentFieldType
          getTextDocument();
