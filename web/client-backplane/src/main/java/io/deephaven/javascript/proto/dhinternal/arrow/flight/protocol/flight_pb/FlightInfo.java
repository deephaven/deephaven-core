  ...
  public interface ToObjectReturnType {
    ...
    public interface EndpointListFieldType {
      ...
      public interface TicketFieldType {
        ...
        public interface GetTicketUnionType {
          @JsOverlay
          static FlightInfo.ToObjectReturnType.EndpointListFieldType.TicketFieldType
                  .GetTicketUnionType
              of(Object o) {
            return Js.cast(o);
          }
        ...
        @JsProperty
        FlightInfo.ToObjectReturnType.EndpointListFieldType.TicketFieldType.GetTicketUnionType
            getTicket();
        ...
        default void setTicket(String ticket) {
          setTicket(
              Js
                  .<FlightInfo.ToObjectReturnType.EndpointListFieldType.TicketFieldType
                          .GetTicketUnionType>
      ...
      @JsProperty
      JsArray<FlightInfo.ToObjectReturnType.EndpointListFieldType.LocationListFieldType>
          getLocationList();
      ...
      default void setLocationList(
          FlightInfo.ToObjectReturnType.EndpointListFieldType.LocationListFieldType[]
              locationList) {
        setLocationList(
            Js
                .<JsArray<
    ...
    public interface FlightDescriptorFieldType {
      ...
      default void setCmd(String cmd) {
        setCmd(
            Js
                .<FlightInfo.ToObjectReturnType.FlightDescriptorFieldType.GetCmdUnionType>
                    uncheckedCast(cmd));
      }
  ...
  public interface ToObjectReturnType0 {
    ...
    public interface EndpointListFieldType {
      ...
      public interface TicketFieldType {
        ...
        public interface GetTicketUnionType {
          @JsOverlay
          static FlightInfo.ToObjectReturnType0.EndpointListFieldType.TicketFieldType
                  .GetTicketUnionType
              of(Object o) {
            return Js.cast(o);
          }
        ...
        @JsProperty
        FlightInfo.ToObjectReturnType0.EndpointListFieldType.TicketFieldType.GetTicketUnionType
            getTicket();
        ...
        default void setTicket(String ticket) {
          setTicket(
              Js
                  .<FlightInfo.ToObjectReturnType0.EndpointListFieldType.TicketFieldType
                          .GetTicketUnionType>
                      uncheckedCast(ticket));
        }
      ...
      @JsProperty
      JsArray<FlightInfo.ToObjectReturnType0.EndpointListFieldType.LocationListFieldType>
          getLocationList();
      ...
      @JsOverlay
      default void setLocationList(
          FlightInfo.ToObjectReturnType0.EndpointListFieldType.LocationListFieldType[]
              locationList) {
        setLocationList(
            Js
                .<JsArray<
    ...
    public interface FlightDescriptorFieldType {
      ...
      default void setCmd(String cmd) {
        setCmd(
            Js
                .<FlightInfo.ToObjectReturnType0.FlightDescriptorFieldType.GetCmdUnionType>
                    uncheckedCast(cmd));
      }
