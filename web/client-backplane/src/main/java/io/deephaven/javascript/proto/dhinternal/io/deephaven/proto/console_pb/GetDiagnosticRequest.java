...
@JsType(
        isNative = true,
        name = "dhinternal.io.deephaven.proto.console_pb.GetDiagnosticRequest",
...
public class GetDiagnosticRequest {
    ...
    public static native Object toObject(boolean includeInstance, GetDiagnosticRequest msg);
