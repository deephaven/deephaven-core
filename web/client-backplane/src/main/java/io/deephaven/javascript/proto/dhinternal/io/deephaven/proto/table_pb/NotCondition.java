      ...
      public interface CompareFieldType {
        ...
        public interface LhsFieldType {
          ...
          public interface LiteralFieldType {
            @JsOverlay
            static NotCondition.ToObjectReturnType.FilterFieldType.CompareFieldType.LhsFieldType
                    .LiteralFieldType
                create() {
              return Js.uncheckedCast(JsPropertyMap.of());
            }
          ...
          @JsProperty
          NotCondition.ToObjectReturnType.FilterFieldType.CompareFieldType.LhsFieldType
                  .LiteralFieldType
              getLiteral();
    ...
    public interface FilterFieldType {
      ...
      public interface CompareFieldType {
        ...
        public interface LhsFieldType {
          ...
          public interface LiteralFieldType {
            @JsOverlay
            static NotCondition.ToObjectReturnType0.FilterFieldType.CompareFieldType.LhsFieldType
                    .LiteralFieldType
                create() {
              return Js.uncheckedCast(JsPropertyMap.of());
            }
          ...
          @JsProperty
          NotCondition.ToObjectReturnType0.FilterFieldType.CompareFieldType.LhsFieldType
                  .LiteralFieldType
              getLiteral();
