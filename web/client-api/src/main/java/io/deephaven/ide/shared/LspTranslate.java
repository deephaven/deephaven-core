 ...
 * LspTranslate:
 * <p><p>
 *     This class is responsible for transforming "off-the-wire" protobuf completion responses
 *     into js-friendly "js api" objects that we can hand off to clients.
 * <p><p>
 */
public class LspTranslate {

    public static CompletionItem toJs(io.deephaven.javascript.proto.dhinternal.io.deephaven.proto.console_pb.CompletionItem src) {
        ...
        final JsArray<io.deephaven.javascript.proto.dhinternal.io.deephaven.proto.console_pb.TextEdit> textEdits = src.getAdditionalTextEditsList();
    ...
    private static TextEdit toJs(final io.deephaven.javascript.proto.dhinternal.io.deephaven.proto.console_pb.TextEdit src) {
    ...
    private static DocumentRange toJs(final io.deephaven.javascript.proto.dhinternal.io.deephaven.proto.console_pb.DocumentRange range) {
    ...
    private static Position toJs(final io.deephaven.javascript.proto.dhinternal.io.deephaven.proto.console_pb.Position src) {
