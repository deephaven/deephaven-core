...
/**
 * A place to collect utility methods for managing data in/out of javascript / handling column type
 * information.
 */
public class JsData {
    /**
    ...
    public static String getRequiredStringProperty(JsPropertyMap<Object> source,
        String propertyName) {
    ...
    public static double getRequiredDoubleProperty(JsPropertyMap<Object> source,
        String propertyName) {
    ...
    public static Double getNullableDoubleProperty(JsPropertyMap<Object> source,
        String propertyName) {
    ...
    public static boolean getRequiredBooleanProperty(JsPropertyMap<Object> source,
        String propertyName) {
    ...
    public static Boolean getNullableBooleanProperty(JsPropertyMap<Object> source,
        String propertyName) {
