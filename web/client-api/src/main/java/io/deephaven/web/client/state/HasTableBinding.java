...
/**
 * In order to not-require a JsTable to be bound to a {@link ClientTableState},
 * we will use this interface, which exposes the parts of JsTable that we require
 * in managing handles and their lifecycles.
 *
 */
