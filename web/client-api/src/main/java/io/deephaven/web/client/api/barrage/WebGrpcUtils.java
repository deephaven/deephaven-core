...
/**
 * Holds some static details, must be initialized before any calls can be made. When our gRPC-web
 * client is redone to support interceptors/etc, this will likely no longer need to exist
 */
