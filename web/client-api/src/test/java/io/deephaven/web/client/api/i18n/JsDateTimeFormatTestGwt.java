...
public class JsDateTimeFormatTestGwt extends GWTTestCase {
    ...
    /**
     * Helper which takes a string, parses the string, and then formats the long again.
     * The input is checked to match the output of the final format call, and the
     * intermediate value is returned for any subsequent checks.
     */
