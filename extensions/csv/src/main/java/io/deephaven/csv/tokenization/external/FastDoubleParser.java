...
public class FastDoubleParser {
    ...
    /**
     * Parses the following rules (more rules are defined in {@link #parseDouble(CharSequence)}):
     * <dl>
     ...
     */
    private static double parseRestOfDecimalFloatLiteral(CharSequence str, int endIndex, int index, boolean isNegative,
