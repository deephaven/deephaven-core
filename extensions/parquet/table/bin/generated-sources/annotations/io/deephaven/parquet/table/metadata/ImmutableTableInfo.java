...
public final class ImmutableTableInfo extends TableInfo {
  ...
  private ImmutableTableInfo(
      ...
      ImmutableList<DataIndexInfo> dataIndexes,
      ImmutableList<ColumnTypeInfo> columnTypes,
      ImmutableList<SortColumnInfo> sortingColumns) {
  ...
  @Override
  public ImmutableList<DataIndexInfo> dataIndexes() {
    return dataIndexes;
  }
  ...
  @Override
  public ImmutableList<SortColumnInfo> sortingColumns() {
  ...
  public final ImmutableTableInfo withVersion(String value) {
    ...
    return validate(new ImmutableTableInfo(newValue, this.groupingColumns, this.dataIndexes, this.columnTypes, this.sortingColumns));
  }
  ...
  public final ImmutableTableInfo withGroupingColumns(GroupingColumnInfo... elements) {
    ...
    return validate(new ImmutableTableInfo(this.version, newValue, this.dataIndexes, this.columnTypes, this.sortingColumns));
  }
  ...
  /**
   * Copy the current immutable object with elements that replace the content of {@link TableInfo#dataIndexes() dataIndexes}.
   * @param elements The elements to set
   * @return A modified copy of {@code this} object
   */
  public final ImmutableTableInfo withDataIndexes(DataIndexInfo... elements) {
    ImmutableList<DataIndexInfo> newValue = ImmutableList.copyOf(elements);
    return validate(new ImmutableTableInfo(this.version, this.groupingColumns, newValue, this.columnTypes, this.sortingColumns));
  }

  /**
   * Copy the current immutable object with elements that replace the content of {@link TableInfo#dataIndexes() dataIndexes}.
   * A shallow reference equality check is used to prevent copying of the same value by returning {@code this}.
   * @param elements An iterable of dataIndexes elements to set
   * @return A modified copy of {@code this} object
   */
  public final ImmutableTableInfo withDataIndexes(Iterable<? extends DataIndexInfo> elements) {
    if (this.dataIndexes == elements) return this;
    ImmutableList<DataIndexInfo> newValue = ImmutableList.copyOf(elements);
    return validate(new ImmutableTableInfo(this.version, this.groupingColumns, newValue, this.columnTypes, this.sortingColumns));
  }
  ...
  public final ImmutableTableInfo withColumnTypes(ColumnTypeInfo... elements) {
    ...
    return validate(new ImmutableTableInfo(this.version, this.groupingColumns, this.dataIndexes, newValue, this.sortingColumns));
  }
  ...
  /**
   * Copy the current immutable object with elements that replace the content of {@link TableInfo#sortingColumns() sortingColumns}.
   * @param elements The elements to set
   * @return A modified copy of {@code this} object
   */
  public final ImmutableTableInfo withSortingColumns(SortColumnInfo... elements) {
    ImmutableList<SortColumnInfo> newValue = ImmutableList.copyOf(elements);
    return validate(new ImmutableTableInfo(this.version, this.groupingColumns, this.dataIndexes, this.columnTypes, newValue));
  }

  /**
   * Copy the current immutable object with elements that replace the content of {@link TableInfo#sortingColumns() sortingColumns}.
   * A shallow reference equality check is used to prevent copying of the same value by returning {@code this}.
   * @param elements An iterable of sortingColumns elements to set
   * @return A modified copy of {@code this} object
   */
  public final ImmutableTableInfo withSortingColumns(Iterable<? extends SortColumnInfo> elements) {
    if (this.sortingColumns == elements) return this;
    ImmutableList<SortColumnInfo> newValue = ImmutableList.copyOf(elements);
    return validate(new ImmutableTableInfo(this.version, this.groupingColumns, this.dataIndexes, this.columnTypes, newValue));
  }
  ...
  private boolean equalTo(int synthetic, ImmutableTableInfo another) {
    return version.equals(another.version)
        ...
        && dataIndexes.equals(another.dataIndexes)
        && columnTypes.equals(another.columnTypes)
        && sortingColumns.equals(another.sortingColumns);
  }

  /**
   * Computes a hash code from attributes: {@code version}, {@code groupingColumns}, {@code dataIndexes}, {@code columnTypes}, {@code sortingColumns}.
  ...
  public int hashCode() {
    ...
    h += (h << 5) + dataIndexes.hashCode();
    h += (h << 5) + columnTypes.hashCode();
    h += (h << 5) + sortingColumns.hashCode();
    return h;
  }
  ...
  public String toString() {
    return MoreObjects.toStringHelper("TableInfo")
        ...
        .add("dataIndexes", dataIndexes)
        .add("columnTypes", columnTypes)
        .add("sortingColumns", sortingColumns)
        .toString();
  }
  ...
  static final class Json extends TableInfo {
    ...
    @Nullable List<DataIndexInfo> dataIndexes = ImmutableList.of();
    @Nullable List<ColumnTypeInfo> columnTypes = ImmutableList.of();
    @Nullable List<SortColumnInfo> sortingColumns = ImmutableList.of();
    @JsonProperty("version")
    ...
    @Override
    public List<DataIndexInfo> dataIndexes() { throw new UnsupportedOperationException(); }
    @Override
    public List<ColumnTypeInfo> columnTypes() { throw new UnsupportedOperationException(); }
    @Override
    public List<SortColumnInfo> sortingColumns() { throw new UnsupportedOperationException(); }
  }
   ...
   *    .addDataIndexes|addAllDataIndexes(io.deephaven.parquet.table.metadata.DataIndexInfo) // {@link TableInfo#dataIndexes() dataIndexes} elements
   ...
   *    .addSortingColumns|addAllSortingColumns(io.deephaven.parquet.table.metadata.SortColumnInfo) // {@link TableInfo#sortingColumns() sortingColumns} elements
   *    .build();
   * </pre>
  ...
  public static final class Builder implements TableInfo.Builder {
    ...
    private ImmutableList.Builder<DataIndexInfo> dataIndexes = ImmutableList.builder();
    private ImmutableList.Builder<ColumnTypeInfo> columnTypes = ImmutableList.builder();
    private ImmutableList.Builder<SortColumnInfo> sortingColumns = ImmutableList.builder();
    ...
    public final Builder from(TableInfo instance) {
      ...
      addAllDataIndexes(instance.dataIndexes());
      addAllColumnTypes(instance.columnTypes());
      addAllSortingColumns(instance.sortingColumns());
      return this;
    }
    ...
    /**
     * Adds one element to {@link TableInfo#dataIndexes() dataIndexes} list.
     * @param element A dataIndexes element
     * @return {@code this} builder for use in a chained invocation
     */
    @CanIgnoreReturnValue 
    public final Builder addDataIndexes(DataIndexInfo element) {
      this.dataIndexes.add(element);
      return this;
    }

    /**
     * Adds elements to {@link TableInfo#dataIndexes() dataIndexes} list.
     * @param elements An array of dataIndexes elements
     * @return {@code this} builder for use in a chained invocation
     */
    @CanIgnoreReturnValue 
    public final Builder addDataIndexes(DataIndexInfo... elements) {
      this.dataIndexes.add(elements);
      return this;
    }


    /**
     * Sets or replaces all elements for {@link TableInfo#dataIndexes() dataIndexes} list.
     * @param elements An iterable of dataIndexes elements
     * @return {@code this} builder for use in a chained invocation
     */
    @CanIgnoreReturnValue 
    @JsonProperty("dataIndexes")
    public final Builder dataIndexes(Iterable<? extends DataIndexInfo> elements) {
      this.dataIndexes = ImmutableList.builder();
      return addAllDataIndexes(elements);
    }
    ...
    public final Builder addAllDataIndexes(Iterable<? extends DataIndexInfo> elements) {
      this.dataIndexes.addAll(elements);
      return this;
    }
    ...
    /**
     * Adds one element to {@link TableInfo#sortingColumns() sortingColumns} list.
     * @param element A sortingColumns element
     * @return {@code this} builder for use in a chained invocation
     */
    @CanIgnoreReturnValue 
    public final Builder addSortingColumns(SortColumnInfo element) {
      this.sortingColumns.add(element);
      return this;
    }

    /**
     * Adds elements to {@link TableInfo#sortingColumns() sortingColumns} list.
     * @param elements An array of sortingColumns elements
     * @return {@code this} builder for use in a chained invocation
     */
    @CanIgnoreReturnValue 
    public final Builder addSortingColumns(SortColumnInfo... elements) {
      this.sortingColumns.add(elements);
      return this;
    }


    /**
     * Sets or replaces all elements for {@link TableInfo#sortingColumns() sortingColumns} list.
     * @param elements An iterable of sortingColumns elements
     * @return {@code this} builder for use in a chained invocation
     */
    @CanIgnoreReturnValue 
    @JsonProperty("sortingColumns")
    public final Builder sortingColumns(Iterable<? extends SortColumnInfo> elements) {
      this.sortingColumns = ImmutableList.builder();
      return addAllSortingColumns(elements);
    }
    ...
    public final Builder addAllSortingColumns(Iterable<? extends SortColumnInfo> elements) {
      this.sortingColumns.addAll(elements);
      return this;
    }
