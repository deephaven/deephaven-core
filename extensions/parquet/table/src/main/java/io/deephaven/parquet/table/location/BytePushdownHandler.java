 ...
 * {@link #maybeOverlaps(ByteRangeFilter, Statistics)} serves range filters, which need no preparation.
 * <p>
 ...
 * <ul>
 * <li>A <b>stored sentinel</b> -- a value equal to {@code NULL_BYTE} -- is this class's business. To Parquet it is an
