        ...
        if (action.equals(SORTED_REGION_ACTION)) {
            ...
            if (ctx.isRangeFilter() && filter instanceof RangeFilter
                ...
                if (rangeFilter.getLower() == NULL_SHORT && rangeFilter.isLowerInclusive()) {
                    ...
                    try (final RowSet matches = ShortRegionBinarySearchKernel.binarySearchMax(
                            this,
                            selection.firstRowKey(),
                            selection.lastRowKey(),
                            firstSortedColumn,
                    ...
                    try (final RowSet matches = ShortRegionBinarySearchKernel.binarySearchMin(
                            this,
                            selection.firstRowKey(),
                            selection.lastRowKey(),
                            firstSortedColumn,
                ...
                try (final RowSet matches = ShortRegionBinarySearchKernel.binarySearchMinMax(
                        this,
                        selection.firstRowKey(),
                        selection.lastRowKey(),
                        firstSortedColumn,
