...
public class ColumnPageReaderImpl implements ColumnPageReader {
    ...
    private int readRowCountFromDataPage(ReadableByteChannel file) throws IOException {
        ...
        switch (pageHeader.type) {
            case DATA_PAGE:
                ...
                final BytesInput decompressedInput = compressor.decompress(bufferedInputStream, compressedPageSize, uncompressedPageSize);
    ...
    private IntBuffer readKeyFromDataPage(IntBuffer keyDest, int nullPlaceholder,
        ...
        switch (pageHeader.type) {
            case DATA_PAGE:
                BytesInput decompressedInput = compressor.decompress(Channels.newInputStream(file), compressedPageSize, uncompressedPageSize);
    ...
    private Object readDataPage(Object nullValue, SeekableByteChannel file) throws IOException {
        ...
        switch (pageHeader.type) {
            ...
            case DATA_PAGE_V2:
                ...
                BytesInput data = compressor.decompress(Channels.newInputStream(file), dataSize, pageHeader.getUncompressed_page_size()
                        - dataHeaderV2.getRepetition_levels_byte_length()
                        - dataHeaderV2.getDefinition_levels_byte_length());
