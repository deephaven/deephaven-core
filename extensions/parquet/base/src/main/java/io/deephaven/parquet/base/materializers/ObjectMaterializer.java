...
public class ObjectMaterializer<TYPE> extends ObjectMaterializerBase<TYPE> implements PageMaterializer {
    ...
    private ObjectMaterializer(PageValueReader dataReader, int numValues, final ObjectCodec<TYPE> codec,
            final Class<TYPE> nativeType) {
        this(dataReader, null, numValues, codec, nativeType);
    }

    private ObjectMaterializer(PageValueReader dataReader, TYPE nullValue, int numValues, final ObjectCodec<TYPE> codec,
            final Class<TYPE> nativeType) {
        // noinspection unchecked
