...
public class InstantFromInt96Materializer {

    public static final PageMaterializerFactory Factory = new PageMaterializerFactory() {
        @Override
        public PageMaterializer makeMaterializerWithNulls(ValuesReader dataReader, Object nullValue, int numValues) {
            return new InstantFromInt96PageMaterializer(dataReader, (long) nullValue, numValues);
        }

        @Override
        public PageMaterializer makeMaterializerNonNull(ValuesReader dataReader, int numValues) {
            return new InstantFromInt96PageMaterializer(dataReader, numValues);
        }
    };
    ...
    private static final class InstantFromInt96PageMaterializer extends LongPageMaterializerBase
        ...
        private InstantFromInt96PageMaterializer(ValuesReader dataReader, int numValues) {
            this(dataReader, 0, numValues);
        }

        private InstantFromInt96PageMaterializer(ValuesReader dataReader, long nullValue, int numValues) {
