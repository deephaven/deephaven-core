...
/**
 * Processes a JSON string as an {@link LocalTime}.
 */
@Immutable
@BuildableStyle
public abstract class LocalTimeValue extends ValueSingleValueBase<LocalTime> {
    public static Builder builder() {
        return ImmutableLocalTimeValue.builder();
    }

    public static LocalTimeValue standard() {
        return builder().build();
    }

    public static LocalTimeValue strict() {
        return builder()
                .allowMissing(false)
    ...
    public interface Builder extends ValueSingleValueBase.Builder<LocalTime, LocalTimeValue, Builder> {
