...
import static io.deephaven.jsoningester.JSONToStreamPublisherAdapter.SUBTABLE_RECORD_ID_COL;
...
public class JSONToStreamPublisherAdapterBuilder
    ...
    private final Map<String, JSONToStreamPublisherAdapterBuilder> nestedFieldBuilders = new HashMap<>();
    private final Map<String, JSONToStreamPublisherAdapterBuilder> parallelNestedFieldBuilders = new HashMap<>();
    ...
    public JSONToStreamPublisherAdapterBuilder() {}

    public JSONToStreamPublisherAdapterBuilder(JSONToStreamPublisherAdapterBuilder other) {
        ...
        for (Map.Entry<String, JSONToStreamPublisherAdapterBuilder> entry : other.fieldToSubtableBuilders.entrySet()) {
            final JSONToStreamPublisherAdapterBuilder subtableBuilderCopy =
                    new JSONToStreamPublisherAdapterBuilder(entry.getValue());
     ...
     */
    @ScriptApi
    public JSONToStreamPublisherAdapterBuilder addColumnFromField(final String column, final String field) {
     ...
     */
    @ScriptApi
    public JSONToStreamPublisherAdapterBuilder addNestedField(
            final String field,
            final JSONToStreamPublisherAdapterBuilder builder) {
        checkNestedBuilder(builder, field);
        addNestedColumns(builder);
    ...
    /**
     * Maps field in the input JSON to a new JSONToStreamPublisherAdapterBuilder, to produce a different table from the
     * JSON.
     * <p>
     *
     ...
     */
    @ScriptApi
    public JSONToStreamPublisherAdapterBuilder addFieldToSubTableMapping(
            final String field,
            final JSONToStreamPublisherAdapterBuilder subtableBuilder) {
    ...
    @ScriptApi
    public JSONToStreamPublisherAdapterBuilder addRoutedTableAdapter(
        ...
        routedTableIdsToBuilders.put(routedTableIdentifier,
                new JSONToStreamPublisherAdapter.RoutedAdapterInfo(subtableBuilder, routingPredicate));
        return this;
    }

    private void addNestedColumns(final JSONToStreamPublisherAdapterBuilder builder) {
    ...
    private void checkNestedBuilder(final JSONToStreamPublisherAdapterBuilder builder, final String field) {
    ...
    private void checkSubtableBuilder(final JSONToStreamPublisherAdapterBuilder builder, final String field) {
        if (!builder.getInternalColumns().isEmpty()) {
    ...
    public JSONToStreamPublisherAdapterBuilder addColumnFromPointer(final String column, final String jsonPointer) {
     ...
     */
    @ScriptApi
    public JSONToStreamPublisherAdapterBuilder allowUnmapped(final String column) {
        checkAlreadyDefined(column);
     ...
     */
    @ScriptApi
    public JSONToStreamPublisherAdapterBuilder processArrays(final boolean processArrays) {
     ...
     */
    @ScriptApi
    public JSONToStreamPublisherAdapterBuilder autoValueMapping(final boolean autoValueMapping) {
     ...
     */
    @ScriptApi
    public JSONToStreamPublisherAdapterBuilder allowMissingKeys(final boolean allowMissingKeys) {
     ...
     */
    @ScriptApi
    public JSONToStreamPublisherAdapterBuilder allowNullValues(final boolean allowNullValues) {
        this.allowNullValues = allowNullValues;
        return this;
    }

    @Override
    public JSONToStreamPublisherAdapterBuilder sendTimestampColumnName(final String sendTimestampColumnName) {
        return (JSONToStreamPublisherAdapterBuilder) super.sendTimestampColumnName(sendTimestampColumnName);
    }

    @Override
    public JSONToStreamPublisherAdapterBuilder receiveTimestampColumnName(final String receiveTimestampColumnName) {
        return (JSONToStreamPublisherAdapterBuilder) super.receiveTimestampColumnName(receiveTimestampColumnName);
    }

    @Override
    public JSONToStreamPublisherAdapterBuilder timestampColumnName(final String timestampColumnName) {
        return (JSONToStreamPublisherAdapterBuilder) super.timestampColumnName(timestampColumnName);
    }

    @Override
    public JSONToStreamPublisherAdapterBuilder messageIdColumnName(final String messageIdColumnName) {
        return (JSONToStreamPublisherAdapterBuilder) super.messageIdColumnName(messageIdColumnName);
    }

    public JSONToStreamPublisherAdapterBuilder nConsumerThreads(final int nConsumerThreads) {
        this.nConsumerThreads = nConsumerThreads;
        return this;
    }

    @NotNull
    public JSONToStreamPublisherAdapter makeAdapter(@NotNull final Logger log,
            final SimpleStreamPublisher streamPublisher) {
        return makeAdapter(log, streamPublisher, Collections.emptyMap());
    }

    @NotNull
    public JSONToStreamPublisherAdapter makeAdapter(@NotNull final Logger log,
            @NotNull final SimpleStreamPublisher streamPublisher,
            @NotNull final Map<String, SimpleStreamPublisher> subtableFieldToTableWriters) {
        ...
        return new JSONToStreamPublisherAdapter(streamPublisher, log, allowMissingKeys, allowNullValues, processArrays,
                nConsumerThreads,
                columnToJsonField,
                columnToJsonPointer,
                columnToIntFunction,
     ...
     */
    @NotNull
    JSONToStreamPublisherAdapter makeNestedAdapter(@NotNull final Logger log,
            @NotNull final SimpleStreamPublisher streamPublisher,
        ...
        // TODO: eliminate this var and use presence of parentAdapter instead?
        ...
        return new JSONToStreamPublisherAdapter(
                streamPublisher,
                log,
                allowMissingKeys,
                allowNullValues,
     ...
     *
     * @param log Logger to use
     * @param subtablePublisher Subtable's StreamPublisher
     * @param allUnmapped Columns that are not required to be mapped to JSON data
    ...
    JSONToStreamPublisherAdapter makeSubtableAdapter(@NotNull final Logger log,
        ...
        return new JSONToStreamPublisherAdapter(subtablePublisher,
                log, allowMissingKeys, allowNullValues, processArrays,
                0,
