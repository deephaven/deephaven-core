...
public interface MessageToIngesterAdapter<M> {
     ...
     * lull and there is time to do this.
     *
     ...
     *
     * @return null if there were no messages ever written to the location being used by this adapter; otherwise,
     *         returns the String last checkpoint ID.
     */
