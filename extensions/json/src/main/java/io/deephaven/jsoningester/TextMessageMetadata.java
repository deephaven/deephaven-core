...
/**
An internal storage for text message contents plus metadata in a standardized format for this plugin to further process.
 **/
public class TextMessageMetadata extends BaseMessageMetadata {
     ...
     */
    public TextMessageMetadata(final DateTime sentTime, final DateTime receiveTime, final DateTime ingestTime, final String messageId, final long messageNumber, final String text) {
