 ...
 */
public abstract class BaseStreamPublisherAdapterBuilder<A> {
     ...
     * @return this builder
     */
    public BaseStreamPublisherAdapterBuilder<A> sendTimestampColumnName(final String sendTimestampColumnName) {
     ...
     * @return this builder
     */
    public BaseStreamPublisherAdapterBuilder<A> receiveTimestampColumnName(final String receiveTimestampColumnName) {
     ...
     * @return this builder
     */
    public BaseStreamPublisherAdapterBuilder<A> timestampColumnName(final String timestampColumnName) {
     ...
     * @return this builder
     */
    public BaseStreamPublisherAdapterBuilder<A> messageIdColumnName(final String messageIdColumnName) {
    ...
    public abstract A makeAdapter(final Logger log, final SimpleStreamPublisher streamPublisher);
}
