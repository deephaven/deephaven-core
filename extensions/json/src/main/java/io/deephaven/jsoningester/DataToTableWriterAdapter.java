...
public interface DataToTableWriterAdapter {
     ...
     * processed messages are written. cleanup should be called after this function to ensure that.
     *
    ...
    /**
     * Do any 'cleanup' actions that should happen periodically but not at every message.
