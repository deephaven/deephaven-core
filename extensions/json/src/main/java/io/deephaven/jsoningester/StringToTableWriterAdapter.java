...
/**
 * String messages must be adapted to a TableWriter. The StringToTableWriterAdapter consumes
 * a String message and writes zero or more rows to a TableWriter.
 */
public interface StringToTableWriterAdapter extends DataToTableWriterAdapter {
     ...
     *
     * @param metadata  The metadata associated with the string to be consumed.  ID must be unique and increasing for any source
     *                  using this method to write data to a Deephaven database.
     * @param input The string text to be processed to a Table.
