...
/**
 * Immutable implementation of {@link BoolValue}.
 * <p>
 * Use the builder to create immutable instances:
 * {@code ImmutableBoolValue.builder()}.
 */
@Generated(from = "BoolValue", generator = "Immutables")
@SuppressWarnings({"all"})
@ParametersAreNonnullByDefault
@javax.annotation.processing.Generated("org.immutables.processor.ProxyProcessor")
@Immutable
public final class ImmutableBoolValue extends BoolValue {
  private final boolean allowMissing;
  private final @Nullable Boolean onNull;
  private final @Nullable Boolean onMissing;
  private final Set<JsonValueTypes> allowedTypes;

  private ImmutableBoolValue(ImmutableBoolValue.Builder builder) {
  ...
  private ImmutableBoolValue(
      boolean allowMissing,
      @Nullable Boolean onNull,
      @Nullable Boolean onMissing,
  ...
  private final class InitShim {
    ...
    boolean allowMissing() {
      ...
      if (allowMissingBuildStage == STAGE_UNINITIALIZED) {
        ...
        this.allowMissing = ImmutableBoolValue.super.allowMissing();
    ...
    Set<JsonValueTypes> allowedTypes() {
      ...
      if (allowedTypesBuildStage == STAGE_UNINITIALIZED) {
        ...
        this.allowedTypes = createUnmodifiableEnumSet(ImmutableBoolValue.super.allowedTypes());
    ...
    private String formatInitCycleMessage() {
      ...
      return "Cannot build BoolValue, attribute initializers form cycle " + attributes;
    }
  }
   ...
   */
  @Override
  public Optional<Boolean> onMissing() {
  ...
  /**
   * Copy the current immutable object by setting a value for the {@link BoolValue#allowMissing() allowMissing} attribute.
   * A value equality check is used to prevent copying of the same value by returning {@code this}.
   * @param value A new value for allowMissing
   * @return A modified copy of the {@code this} object
   */
  public final ImmutableBoolValue withAllowMissing(boolean value) {
    if (this.allowMissing == value) return this;
    return validate(new ImmutableBoolValue(value, this.onNull, this.onMissing, this.allowedTypes));
  }

  /**
   * Copy the current immutable object by setting a <i>present</i> value for the optional {@link BoolValue#onNull() onNull} attribute.
   * @param value The value for onNull
   * @return A modified copy of {@code this} object
   */
  public final ImmutableBoolValue withOnNull(boolean value) {
    @Nullable Boolean newValue = value;
    if (Objects.equals(this.onNull, newValue)) return this;
    return validate(new ImmutableBoolValue(this.allowMissing, newValue, this.onMissing, this.allowedTypes));
  }

  /**
   * Copy the current immutable object by setting an optional value for the {@link BoolValue#onNull() onNull} attribute.
   * An equality check is used on inner nullable value to prevent copying of the same value by returning {@code this}.
   * @param optional A value for onNull
   * @return A modified copy of {@code this} object
   */
  public final ImmutableBoolValue withOnNull(Optional<Boolean> optional) {
    @Nullable Boolean value = optional.orElse(null);
    if (Objects.equals(this.onNull, value)) return this;
    return validate(new ImmutableBoolValue(this.allowMissing, value, this.onMissing, this.allowedTypes));
  }

  /**
   * Copy the current immutable object by setting a <i>present</i> value for the optional {@link BoolValue#onMissing() onMissing} attribute.
   * @param value The value for onMissing
   * @return A modified copy of {@code this} object
   */
  public final ImmutableBoolValue withOnMissing(boolean value) {
    @Nullable Boolean newValue = value;
    if (Objects.equals(this.onMissing, newValue)) return this;
    return validate(new ImmutableBoolValue(this.allowMissing, this.onNull, newValue, this.allowedTypes));
  }

  /**
   * Copy the current immutable object by setting an optional value for the {@link BoolValue#onMissing() onMissing} attribute.
   * An equality check is used on inner nullable value to prevent copying of the same value by returning {@code this}.
   * @param optional A value for onMissing
   * @return A modified copy of {@code this} object
   */
  public final ImmutableBoolValue withOnMissing(Optional<Boolean> optional) {
    @Nullable Boolean value = optional.orElse(null);
    if (Objects.equals(this.onMissing, value)) return this;
    return validate(new ImmutableBoolValue(this.allowMissing, this.onNull, value, this.allowedTypes));
  }

  /**
   * Copy the current immutable object with elements that replace the content of {@link BoolValue#allowedTypes() allowedTypes}.
   * @param elements The elements to set
   * @return A modified copy of {@code this} object
   */
  public final ImmutableBoolValue withAllowedTypes(JsonValueTypes... elements) {
    Set<JsonValueTypes> newValue = createUnmodifiableEnumSet(Arrays.asList(elements));
    return validate(new ImmutableBoolValue(this.allowMissing, this.onNull, this.onMissing, newValue));
  }
   ...
   * @return A modified copy of {@code this} object
   */
  public final ImmutableBoolValue withAllowedTypes(Iterable<JsonValueTypes> elements) {
  ...
  /**
   * This instance is equal to all instances of {@code ImmutableBoolValue} that have equal attribute values.
   * @return {@code true} if {@code this} is equal to {@code another} instance
   */
  @Override
  public boolean equals(@Nullable Object another) {
    if (this == another) return true;
    return another instanceof ImmutableBoolValue
        && equalTo(0, (ImmutableBoolValue) another);
  }

  private boolean equalTo(int synthetic, ImmutableBoolValue another) {
  ...
  /**
   * Prints the immutable value {@code BoolValue} with attribute values.
   * @return A string representation of the value
   */
  @Override
  public String toString() {
    StringBuilder builder = new StringBuilder("BoolValue{");
  ...
  private static ImmutableBoolValue validate(ImmutableBoolValue instance) {
  ...
  /**
   * Creates an immutable copy of a {@link BoolValue} value.
   * Uses accessors to get values to initialize the new immutable instance.
   * If an instance is already immutable, it is returned as is.
   * @param instance The instance to copy
   * @return A copied immutable BoolValue instance
   */
  public static ImmutableBoolValue copyOf(BoolValue instance) {
    if (instance instanceof ImmutableBoolValue) {
      return (ImmutableBoolValue) instance;
    }
  ...
  /**
   * Creates a builder for {@link ImmutableBoolValue ImmutableBoolValue}.
   * <pre>
   * ImmutableBoolValue.builder()
   *    .allowMissing(boolean) // optional {@link BoolValue#allowMissing() allowMissing}
   *    .onNull(Boolean) // optional {@link BoolValue#onNull() onNull}
   *    .onMissing(Boolean) // optional {@link BoolValue#onMissing() onMissing}
   *    .addAllowedTypes|addAllAllowedTypes(io.deephaven.json.JsonValueTypes) // {@link BoolValue#allowedTypes() allowedTypes} elements
   *    .build();
   * </pre>
   * @return A new ImmutableBoolValue builder
   */
  public static ImmutableBoolValue.Builder builder() {
    return new ImmutableBoolValue.Builder();
  }

  /**
   * Builds instances of type {@link ImmutableBoolValue ImmutableBoolValue}.
  ...
  @Generated(from = "BoolValue", generator = "Immutables")
  @NotThreadSafe
  public static final class Builder implements BoolValue.Builder {
    private static final long OPT_BIT_ALLOW_MISSING = 0x1L;
    private static final long OPT_BIT_ALLOWED_TYPES = 0x2L;
    private long optBits;

    private boolean allowMissing;
    private @Nullable Boolean onNull;
    private @Nullable Boolean onMissing;
    ...
    /**
     * Fill a builder with attribute values from the provided {@code io.deephaven.json.BoolValue} instance.
     * @param instance The instance from which to copy values
     * @return {@code this} builder for use in a chained invocation
     */
    public final Builder from(BoolValue instance) {
    ...
    private void from(Object object) {
      ...
      if (object instanceof BoolValue) {
        BoolValue instance = (BoolValue) object;
        if ((bits & 0x1L) == 0) {
        ...
        Optional<Boolean> onMissingOptional = instance.onMissing();
        if (onMissingOptional.isPresent()) {
          onMissing(onMissingOptional);
        }
        Optional<Boolean> onNullOptional = instance.onNull();
    ...
    /**
     * Initializes the value for the {@link BoolValue#allowMissing() allowMissing} attribute.
     * <p><em>If not set, this attribute will have a default value as returned by the initializer of {@link BoolValue#allowMissing() allowMissing}.</em>
    ...
    /**
     * Initializes the optional value {@link BoolValue#onNull() onNull} to onNull.
     * @param onNull The value for onNull
     * @return {@code this} builder for chained invocation
     */
    public final Builder onNull(boolean onNull) {
      this.onNull = onNull;
      return this;
    }
     ...
     * @return {@code this} builder for use in a chained invocation
     */
    public final Builder onNull(Optional<Boolean> onNull) {
      this.onNull = onNull.orElse(null);
      return this;
    }

    /**
     * Initializes the optional value {@link BoolValue#onMissing() onMissing} to onMissing.
     * @param onMissing The value for onMissing
     * @return {@code this} builder for chained invocation
     */
    public final Builder onMissing(boolean onMissing) {
      this.onMissing = onMissing;
      return this;
    }
     ...
     * @return {@code this} builder for use in a chained invocation
     */
    public final Builder onMissing(Optional<Boolean> onMissing) {
      this.onMissing = onMissing.orElse(null);
      return this;
    }

    /**
     * Adds one element to {@link BoolValue#allowedTypes() allowedTypes} set.
    ...
    /**
     * Adds elements to {@link BoolValue#allowedTypes() allowedTypes} set.
    ...
    /**
     * Sets or replaces all elements for {@link BoolValue#allowedTypes() allowedTypes} set.
    ...
    /**
     * Builds a new {@link ImmutableBoolValue ImmutableBoolValue}.
     * @return An immutable instance of BoolValue
     * @throws java.lang.IllegalStateException if any required attributes are missing
     */
    public ImmutableBoolValue build() {
      return ImmutableBoolValue.validate(new ImmutableBoolValue(this));
    }
