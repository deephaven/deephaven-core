...
/**
 * Immutable implementation of {@link FloatValue}.
 * <p>
 * Use the builder to create immutable instances:
 * {@code ImmutableFloatValue.builder()}.
 */
@Generated(from = "FloatValue", generator = "Immutables")
@SuppressWarnings({"all"})
@ParametersAreNonnullByDefault
@javax.annotation.processing.Generated("org.immutables.processor.ProxyProcessor")
@Immutable
public final class ImmutableFloatValue extends FloatValue {
  private final boolean allowMissing;
  private final @Nullable Float onNull;
  private final @Nullable Float onMissing;
  private final Set<JsonValueTypes> allowedTypes;

  private ImmutableFloatValue(ImmutableFloatValue.Builder builder) {
  ...
  private ImmutableFloatValue(
      boolean allowMissing,
      @Nullable Float onNull,
      @Nullable Float onMissing,
  ...
  private final class InitShim {
    ...
    boolean allowMissing() {
      ...
      if (allowMissingBuildStage == STAGE_UNINITIALIZED) {
        ...
        this.allowMissing = ImmutableFloatValue.super.allowMissing();
    ...
    Set<JsonValueTypes> allowedTypes() {
      ...
      if (allowedTypesBuildStage == STAGE_UNINITIALIZED) {
        ...
        this.allowedTypes = createUnmodifiableEnumSet(ImmutableFloatValue.super.allowedTypes());
    ...
    private String formatInitCycleMessage() {
      ...
      return "Cannot build FloatValue, attribute initializers form cycle " + attributes;
    }
  }
   ...
   */
  @Override
  public Optional<Float> onMissing() {
  ...
  /**
   * Copy the current immutable object by setting a value for the {@link FloatValue#allowMissing() allowMissing} attribute.
   * A value equality check is used to prevent copying of the same value by returning {@code this}.
   * @param value A new value for allowMissing
   * @return A modified copy of the {@code this} object
   */
  public final ImmutableFloatValue withAllowMissing(boolean value) {
    if (this.allowMissing == value) return this;
    return validate(new ImmutableFloatValue(value, this.onNull, this.onMissing, this.allowedTypes));
  }

  /**
   * Copy the current immutable object by setting a <i>present</i> value for the optional {@link FloatValue#onNull() onNull} attribute.
   * @param value The value for onNull
   * @return A modified copy of {@code this} object
   */
  public final ImmutableFloatValue withOnNull(float value) {
    @Nullable Float newValue = value;
    if (Objects.equals(this.onNull, newValue)) return this;
    return validate(new ImmutableFloatValue(this.allowMissing, newValue, this.onMissing, this.allowedTypes));
  }

  /**
   * Copy the current immutable object by setting an optional value for the {@link FloatValue#onNull() onNull} attribute.
   * An equality check is used on inner nullable value to prevent copying of the same value by returning {@code this}.
   * @param optional A value for onNull
   * @return A modified copy of {@code this} object
   */
  public final ImmutableFloatValue withOnNull(Optional<Float> optional) {
    @Nullable Float value = optional.orElse(null);
    if (Objects.equals(this.onNull, value)) return this;
    return validate(new ImmutableFloatValue(this.allowMissing, value, this.onMissing, this.allowedTypes));
  }

  /**
   * Copy the current immutable object by setting a <i>present</i> value for the optional {@link FloatValue#onMissing() onMissing} attribute.
   * @param value The value for onMissing
   * @return A modified copy of {@code this} object
   */
  public final ImmutableFloatValue withOnMissing(float value) {
    @Nullable Float newValue = value;
    if (Objects.equals(this.onMissing, newValue)) return this;
    return validate(new ImmutableFloatValue(this.allowMissing, this.onNull, newValue, this.allowedTypes));
  }

  /**
   * Copy the current immutable object by setting an optional value for the {@link FloatValue#onMissing() onMissing} attribute.
   * An equality check is used on inner nullable value to prevent copying of the same value by returning {@code this}.
   * @param optional A value for onMissing
   * @return A modified copy of {@code this} object
   */
  public final ImmutableFloatValue withOnMissing(Optional<Float> optional) {
    @Nullable Float value = optional.orElse(null);
    if (Objects.equals(this.onMissing, value)) return this;
    return validate(new ImmutableFloatValue(this.allowMissing, this.onNull, value, this.allowedTypes));
  }

  /**
   * Copy the current immutable object with elements that replace the content of {@link FloatValue#allowedTypes() allowedTypes}.
   * @param elements The elements to set
   * @return A modified copy of {@code this} object
   */
  public final ImmutableFloatValue withAllowedTypes(JsonValueTypes... elements) {
    Set<JsonValueTypes> newValue = createUnmodifiableEnumSet(Arrays.asList(elements));
    return validate(new ImmutableFloatValue(this.allowMissing, this.onNull, this.onMissing, newValue));
  }
   ...
   * @return A modified copy of {@code this} object
   */
  public final ImmutableFloatValue withAllowedTypes(Iterable<JsonValueTypes> elements) {
  ...
  /**
   * This instance is equal to all instances of {@code ImmutableFloatValue} that have equal attribute values.
   * @return {@code true} if {@code this} is equal to {@code another} instance
   */
  @Override
  public boolean equals(@Nullable Object another) {
    if (this == another) return true;
    return another instanceof ImmutableFloatValue
        && equalTo(0, (ImmutableFloatValue) another);
  }

  private boolean equalTo(int synthetic, ImmutableFloatValue another) {
  ...
  /**
   * Prints the immutable value {@code FloatValue} with attribute values.
   * @return A string representation of the value
   */
  @Override
  public String toString() {
    StringBuilder builder = new StringBuilder("FloatValue{");
  ...
  private static ImmutableFloatValue validate(ImmutableFloatValue instance) {
  ...
  /**
   * Creates an immutable copy of a {@link FloatValue} value.
   * Uses accessors to get values to initialize the new immutable instance.
   * If an instance is already immutable, it is returned as is.
   * @param instance The instance to copy
   * @return A copied immutable FloatValue instance
   */
  public static ImmutableFloatValue copyOf(FloatValue instance) {
    if (instance instanceof ImmutableFloatValue) {
      return (ImmutableFloatValue) instance;
    }
  ...
  /**
   * Creates a builder for {@link ImmutableFloatValue ImmutableFloatValue}.
   * <pre>
   * ImmutableFloatValue.builder()
   *    .allowMissing(boolean) // optional {@link FloatValue#allowMissing() allowMissing}
   *    .onNull(Float) // optional {@link FloatValue#onNull() onNull}
   *    .onMissing(Float) // optional {@link FloatValue#onMissing() onMissing}
   *    .addAllowedTypes|addAllAllowedTypes(io.deephaven.json.JsonValueTypes) // {@link FloatValue#allowedTypes() allowedTypes} elements
   *    .build();
   * </pre>
   * @return A new ImmutableFloatValue builder
   */
  public static ImmutableFloatValue.Builder builder() {
    return new ImmutableFloatValue.Builder();
  }

  /**
   * Builds instances of type {@link ImmutableFloatValue ImmutableFloatValue}.
  ...
  @Generated(from = "FloatValue", generator = "Immutables")
  @NotThreadSafe
  public static final class Builder implements FloatValue.Builder {
    private static final long OPT_BIT_ALLOW_MISSING = 0x1L;
    private static final long OPT_BIT_ALLOWED_TYPES = 0x2L;
    private long optBits;

    private boolean allowMissing;
    private @Nullable Float onNull;
    private @Nullable Float onMissing;
    ...
    /**
     * Fill a builder with attribute values from the provided {@code io.deephaven.json.FloatValue} instance.
     * @param instance The instance from which to copy values
     * @return {@code this} builder for use in a chained invocation
     */
    public final Builder from(FloatValue instance) {
      Objects.requireNonNull(instance, "instance");
      from((Object) instance);
      return this;
    }
    ...
    private void from(Object object) {
      ...
      if (object instanceof FloatValue) {
        FloatValue instance = (FloatValue) object;
        if ((bits & 0x1L) == 0) {
          addAllAllowedTypes(instance.allowedTypes());
          bits |= 0x1L;
        }
        ...
        Optional<Float> onMissingOptional = instance.onMissing();
        if (onMissingOptional.isPresent()) {
          onMissing(onMissingOptional);
        }
        Optional<Float> onNullOptional = instance.onNull();
    ...
    /**
     * Initializes the value for the {@link FloatValue#allowMissing() allowMissing} attribute.
     * <p><em>If not set, this attribute will have a default value as returned by the initializer of {@link FloatValue#allowMissing() allowMissing}.</em>
    ...
    /**
     * Initializes the optional value {@link FloatValue#onNull() onNull} to onNull.
     * @param onNull The value for onNull
     * @return {@code this} builder for chained invocation
     */
    public final Builder onNull(float onNull) {
      this.onNull = onNull;
      return this;
    }
     ...
     * @return {@code this} builder for use in a chained invocation
     */
    public final Builder onNull(Optional<Float> onNull) {
      this.onNull = onNull.orElse(null);
      return this;
    }

    /**
     * Initializes the optional value {@link FloatValue#onMissing() onMissing} to onMissing.
     * @param onMissing The value for onMissing
     * @return {@code this} builder for chained invocation
     */
    public final Builder onMissing(float onMissing) {
      this.onMissing = onMissing;
      return this;
    }
     ...
     * @return {@code this} builder for use in a chained invocation
     */
    public final Builder onMissing(Optional<Float> onMissing) {
      this.onMissing = onMissing.orElse(null);
      return this;
    }

    /**
     * Adds one element to {@link FloatValue#allowedTypes() allowedTypes} set.
    ...
    /**
     * Adds elements to {@link FloatValue#allowedTypes() allowedTypes} set.
    ...
    /**
     * Sets or replaces all elements for {@link FloatValue#allowedTypes() allowedTypes} set.
    ...
    /**
     * Builds a new {@link ImmutableFloatValue ImmutableFloatValue}.
     * @return An immutable instance of FloatValue
     * @throws java.lang.IllegalStateException if any required attributes are missing
     */
    public ImmutableFloatValue build() {
      return ImmutableFloatValue.validate(new ImmutableFloatValue(this));
    }
