...
/**
 * Arrow Vector: {@link FixedSizeBinaryVector}
 * Deephaven Type: byte[]
 */
public class ArrowFixedSizeBinaryColumnSource extends AbstractArrowColumnSource<byte[]> implements ImmutableColumnSourceGetDefaults.ForObject<byte[]> {
    public ArrowFixedSizeBinaryColumnSource(final int highBit, final @NotNull Field field,
