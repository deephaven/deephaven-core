...
public class ArrowUint1VectorTest {
    private static final List<Long> expectedRows = Arrays.asList(0L, 1L, 2L, 4L, 8L, 9L);

    private static final short[] expectedValues = new short[] {1, 21, QueryConstants.NULL_SHORT, 32, 0, 96};
    ...
    private static QueryTable loadTable() {
        ...
        final File dataFile = new File(ArrowUint1VectorTest.class.getResource("/uint1_vector.arrow").getFile());
