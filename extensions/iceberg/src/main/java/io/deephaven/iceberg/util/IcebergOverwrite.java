...
public abstract class IcebergOverwrite {
     ...
     * <p>
     * Users must provide partition path for each table in {@link #dhTables()} in the same order if overwriting with a
     * partitioned table. For overwriting with non-partitioned tables, this should be an empty list.
     */
