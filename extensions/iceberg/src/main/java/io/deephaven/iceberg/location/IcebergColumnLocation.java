...
final class IcebergColumnLocation<ATTR extends Values> extends AbstractColumnLocation {
    ...
    private static final int CHUNK_SIZE = Configuration.getInstance()
            .getIntegerForClassWithDefault(IcebergColumnLocation.class, "chunkSize", 4096);
    private static final int INITIAL_PAGE_CACHE_SIZE = Configuration.getInstance()
            .getIntegerForClassWithDefault(IcebergColumnLocation.class, "initialPageCacheSize", 128);
    private static final int MAX_PAGE_CACHE_SIZE = Configuration.getInstance()
            .getIntegerForClassWithDefault(IcebergColumnLocation.class, "maxPageCacheSize", 8192);

    private static final Logger log = LoggerFactory.getLogger(IcebergColumnLocation.class);
    ...
    /**
     * Construct a new {@link IcebergColumnLocation} for the specified {@link IcebergTableLocation} and column name.
     *
    ...
    private IcebergTableLocation tl() {
        return (IcebergTableLocation) getTableLocation();
    }
