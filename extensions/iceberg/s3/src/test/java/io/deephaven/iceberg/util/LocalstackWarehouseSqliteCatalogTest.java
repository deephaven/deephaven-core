...
@Tag("testcontainers")
public final class LocalstackWarehouseSqliteCatalogTest extends S3WarehouseSqliteCatalogBase {
    @BeforeAll
    ...
    public S3Instructions s3Instructions() {
        return LocalStack.s3Instructions(S3Instructions.builder()).build();
    }
