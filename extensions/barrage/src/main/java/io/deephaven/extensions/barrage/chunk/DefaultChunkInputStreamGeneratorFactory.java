 ...
 *
 */
public class DefaultChunkInputStreamGeneratorFactory implements ChunkInputStreamGeneratorFactory {
            ...
            case Object:
                if (type.isArray()) {
                    if (componentType == byte.class) {
                        ...
                        return new VarListChunkInputStreamGenerator<>(type, chunk.asObjectChunk(), rowOffset, this);
                    }
                }
                if (Vector.class.isAssignableFrom(type)) {
                    // noinspection unchecked
                    return new VectorChunkInputStreamGenerator(
                            (Class<Vector<?>>) type, componentType, chunk.asObjectChunk(), rowOffset, this);
                }
