...
public class FloatChunkReader implements ChunkReader {
    ...
    public FloatChunkReader(StreamReaderOptions options) {
        this(options, FloatConversion.IDENTITY);
    }

    public FloatChunkReader(StreamReaderOptions options, FloatConversion conversion) {
