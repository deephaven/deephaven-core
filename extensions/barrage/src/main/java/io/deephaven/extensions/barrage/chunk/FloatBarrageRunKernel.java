...
public class FloatBarrageRunKernel {
    ...
    private static class Impl implements BarrageRunKernel {
        ...
        public void encodeRunEnds(
            ...
            final WritableFloatChunk<Values> typedRunValues = runValues.asWritableFloatChunk();
        ...
        public void decodeRunEnds(
                ...
                final int outOffset) {
            final FloatChunk<Values> typedRunValues = runValues.asFloatChunk();
            final WritableFloatChunk<Values> typedDst = dst.asWritableFloatChunk();
            int start = 0;
