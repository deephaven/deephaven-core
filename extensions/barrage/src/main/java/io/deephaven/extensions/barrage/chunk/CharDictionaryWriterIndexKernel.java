...
final class CharDictionaryWriterIndexKernel implements DictionaryWriterIndexKernel {
    static final CharDictionaryWriterIndexKernel INSTANCE = new CharDictionaryWriterIndexKernel();
