...
final class LongDictionaryWriterIndexKernel implements DictionaryWriterIndexKernel {
    static final LongDictionaryWriterIndexKernel INSTANCE = new LongDictionaryWriterIndexKernel();
