...
public class TestSuanShuIntegration extends BaseArrayTestCase {
    ...
    public void testConvertByteArrayToVector() throws Exception {
        ...
        testVecEquals(expected, ssVec((byte) 1, (byte) 2, (byte) 3, (byte) 4, (byte) 5, (byte) 6, (byte) 7, (byte) 8, (byte) 9, (byte) 10, (byte) 11, (byte) 12, (byte) 13, (byte) 14));
    }

    public void testConvertDbByteArrayToVector() throws Exception {
        final DbByteArrayDirect dbByteArrayDirect = new DbByteArrayDirect(new byte[]{1, 2, 3, 4, QueryConstants.NULL_BYTE, 6});
    ...
    public void testConvertDbShortArrayToVector() throws Exception {
        final DbShortArrayDirect dbShortArrayDirect = new DbShortArrayDirect(new short[]{1, 2, 3, 4, QueryConstants.NULL_SHORT, 6});
        final double[] doubles = new double[]{1, 2, 3, 4, Double.NaN, 6};
    ...
    public void testConvertDbFloatArrayToVector() throws Exception {
        final DbFloatArrayDirect dbFloatArrayDirect = new DbFloatArrayDirect(1.2f, -562, -23.069f, 4.56f, QueryConstants.NULL_FLOAT, 6f);
    ...
    public void testConvertDbLongArrayToVector() throws Exception {
        final DbLongArrayDirect dbLongArrayDirect = new DbLongArrayDirect(-126564L, 256746545L, 3545678945136L, 4544L, QueryConstants.NULL_LONG, 6654845L);
    ...
    public void testConvertDbDoubleArrayToVector() throws Exception {
        final DbDoubleArrayDirect dbDoubleArrayDirect = new DbDoubleArrayDirect(2.365d, 2125.5698d, -98231.2656897451d, QueryConstants.NULL_DOUBLE, 3457836.7283648723d);
    ...
    public void testConvertDbNumberArrayToVector() throws Exception {
        DbArray dbArray = new DbArrayDirect<>(BigDecimal.ZERO, BigDecimal.ONE, BigDecimal.ZERO, BigDecimal.ONE, null, BigDecimal.ONE);
        ...
        dbArray = new DbArrayDirect<>(2.365d, 2125.5698d, -98231.2656897451d, QueryConstants.NULL_DOUBLE, 3457836.7283648723d);
        ...
        dbArray = new DbArrayDirect<>(QueryConstants.NULL_BYTE, QueryConstants.NULL_SHORT, QueryConstants.NULL_INT, QueryConstants.NULL_FLOAT, QueryConstants.NULL_LONG, QueryConstants.NULL_DOUBLE);
    ...
    public void testConvertFloat2dArrayToMatrix() throws Exception {
        final double[][] doubles = new double[][]{{1f, 2f, 3f, 4f, 5f, 6f}
        ...
        final float[][] floats = new float[][]{{1f, 2f, 3f, 4f, 5f, 6f}
                , {11f, 12f, 13f, 14f, 15f, 16f}
                , {21f, 22f, 23f, 24f, 25f, 26f}
                , {31f, 32f, 33f, 34f, 35f, 36f}};
    ...
    public void testConvertDbFloatArrayToMatrix() throws Exception {
        final double[][] doubles = new double[][]{{1f, 2f, 3f, 4f, 5f, 6f}
                , {11f, 12f, 13f, 14f, 15f, Double.NaN}
                , {21f, 22f, 23f, 24f, 25f, 26f}
                , {31f, 32f, 33f, 34f, 35f, 36f}};
    ...
    public void testConvertLong2dArrayToMatrix() throws Exception {
        final double[][] doubles = new double[][]{{1L, 2L, 3L, 4L, 5L, 6L}
        ...
        final long[][] longs = new long[][]{{1L, 2L, 3L, 4L, 5L, 6L}
                , {11L, 12L, 13L, 14L, 15L, 16L}
                , {21L, 22L, 23L, 24L, 25L, 26L}
                , {31L, 32L, 33L, 34L, 35L, 36L}};
    ...
    public void testConvertDbLongArrayToMatrix() throws Exception {
        final double[][] doubles = new double[][]{{1l, 2l, 3l, 4l, 5l, 6l}
                , {11l, 12l, 13l, 14l, 15l, Double.NaN}
                , {21l, 22l, 23l, 24l, 25l, 26l}
                , {31l, 32l, 33l, 34l, 35l, 36l}};
    ...
    public void testConvertDbArrayBasesToMatrix() throws Exception {
        ...
        final DbArrayBase[] dbArrayBases = new DbArrayBase[]{new DbByteArrayDirect(new byte[]{1, 2, 3, 4, 5, 6})
                ...
                , new DbLongArrayDirect(21l, 22l, 23l, 24l, 25l, 26l)
                , new DbFloatArrayDirect(31f, 32f, 33f, 34f, 35f, 36f)
                , new DbArrayDirect<>(BigDecimal.ZERO, BigDecimal.ONE, BigDecimal.ZERO, BigDecimal.ONE, BigDecimal.ZERO, BigDecimal.ONE)};
        Matrix expected = new DenseMatrix(doubles);
        expected = new SimpleMatrixMathOperation().transpose(expected);
    ...
    public void testConvertDbArraysToMatrix() throws Exception {
        final double[][] doubles = new double[][]{{1, 2, 3, 4, Double.NaN, 6}
                , {1, 2, 3, 4, Double.NaN, 6}
                , {1, 2, 3, 4, Double.NaN, 6}
                , {11, 12, 13, 14, Double.NaN, 16}
                , {21, 22, 23, 24, Double.NaN, 26}
                , {31, 32, 33, 34, Double.NaN, 36}
                , {0, 1, 0, 1, Double.NaN, 1}};

        final DbArray dbArrays = new DbArrayDirect(new DbByteArrayDirect(new byte[]{1, 2, 3, 4, QueryConstants.NULL_BYTE, 6})
                ...
                , new DbArrayDirect<>(BigDecimal.ZERO, BigDecimal.ONE, BigDecimal.ZERO, BigDecimal.ONE, null, BigDecimal.ONE));
        Matrix expected = new DenseMatrix(doubles);
        expected = new SimpleMatrixMathOperation().transpose(expected);
