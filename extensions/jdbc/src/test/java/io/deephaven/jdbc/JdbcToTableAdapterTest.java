...
public class JdbcToTableAdapterTest {
    ...
    public void testLowerCamelCasingDeprecatedAPI() throws SQLException {
        final ResultSet rs = stmt.executeQuery("SELECT * from TestTable LIMIT 0");
    ...
    @Test
    @SuppressWarnings("removal")
    public void testLowercaseCasingDeprecatedAPI() throws SQLException {
        final ResultSet rs = stmt.executeQuery("SELECT * from TestTable LIMIT 0");
        final JdbcToTableAdapter.ReadJdbcOptions options = JdbcToTableAdapter.readJdbcOptions();
    ...
    @Test
    @SuppressWarnings("removal")
    public void testUpperCamelCasingDeprecatedAPI() throws SQLException {
        final ResultSet rs = stmt.executeQuery("SELECT * from TestTable LIMIT 0");
        final JdbcToTableAdapter.ReadJdbcOptions options = JdbcToTableAdapter.readJdbcOptions();
    ...
    @Test
    @SuppressWarnings("removal")
    public void testUppercaseCasingDeprecatedAPI() throws SQLException {
        final ResultSet rs = stmt.executeQuery("SELECT * from TestTable LIMIT 0");
        final JdbcToTableAdapter.ReadJdbcOptions options = JdbcToTableAdapter.readJdbcOptions();
    ...
    @Test
    @SuppressWarnings("removal")
    public void testAlternateReplacementDeprecatedAPI() throws SQLException {
        final ResultSet rs = stmt.executeQuery("SELECT * from TestTable LIMIT 0");
        final JdbcToTableAdapter.ReadJdbcOptions options = JdbcToTableAdapter.readJdbcOptions();
    ...
    @Test
    @SuppressWarnings("removal")
    public void testDefaultResultTypesDeprecatedAPI() throws SQLException {
    ...
    @Test
    @SuppressWarnings("removal")
    public void testDoubleArrayTypeDeprecatedAPI() throws SQLException {
    ...
    @Test
    @SuppressWarnings("removal")
    public void testLongArrayTypeDeprecatedAPI() throws SQLException {
        stmt.executeUpdate("DROP TABLE IF EXISTS SingleTestTable");
        stmt.executeUpdate("CREATE TABLE SingleTestTable (" +
                "   \"ArrayColumn\" VARCHAR(80)" +
                ");");
    ...
    private void testArrayParseStrictHelperDeprecatedAPI(
    ...
    @Test
    @SuppressWarnings("removal")
    public void testArrayParserNoBracesDeprecatedAPI() throws SQLException {
        testArrayParseStrictHelperDeprecatedAPI(() -> stmt.executeUpdate("INSERT INTO SingleTestTable VALUES (" +
                "'1.0, 2.0, 3.0'" +
    ...
    @Test
    @SuppressWarnings("removal")
    public void testArrayParserMismatchBracesDeprecatedAPI() throws SQLException {
        testArrayParseStrictHelperDeprecatedAPI(() -> stmt.executeUpdate("INSERT INTO SingleTestTable VALUES (" +
                "'{1.0, 2.0, 3.0)'" +
                ");"), new double[] {1.0, 2.0, 3.0});
    }
    ...
    @Test
    @SuppressWarnings("removal")
    public void testArrayParserMissingOpenDeprecatedAPI() throws SQLException {
        testArrayParseStrictHelperDeprecatedAPI(() -> stmt.executeUpdate("INSERT INTO SingleTestTable VALUES (" +
                "'1.0, 2.0, 3.0)'" +
                ");"), new double[] {1.0, 2.0, 3.0});
    }
    ...
    @Test
    @SuppressWarnings("removal")
    public void testArrayParserMissingCloseDeprecatedAPI() throws SQLException {
        testArrayParseStrictHelperDeprecatedAPI(() -> stmt.executeUpdate("INSERT INTO SingleTestTable VALUES (" +
                "'[1.0, 2.0, 3.0'" +
                ");"), new double[] {1.0, 2.0, 3.0});
    }
    ...
    @Test
    @SuppressWarnings("removal")
    public void testArrayParserShortDeprecatedAPI() throws SQLException {
        testArrayParseStrictHelperDeprecatedAPI(() -> stmt.executeUpdate("INSERT INTO SingleTestTable VALUES (" +
                "'1'" +
                ");"), new double[] {1.0});
    }
    ...
    @Test
    @SuppressWarnings("removal")
    public void testArrayDelimiterOptionDeprecatedAPI() throws SQLException {
        stmt.executeUpdate("DROP TABLE IF EXISTS SingleTestTable");
        stmt.executeUpdate("CREATE TABLE SingleTestTable (" +
                "   \"ArrayColumn\" VARCHAR(80)" +
                ");");
    ...
    @Test
    @SuppressWarnings("removal")
    public void testMaxRowsOptionDeprecatedAPI() throws SQLException {
        final ResultSet rs = stmt.executeQuery("SELECT * from TestTable");
        final JdbcToTableAdapter.ReadJdbcOptions options = JdbcToTableAdapter.readJdbcOptions();
        options.maxRows(32);
        final Table result = JdbcToTableAdapter.readJdbc(rs, options);
    ...
    @Test
    @SuppressWarnings("removal")
    public void testDecimalTypeMappingDeprecatedAPI() throws SQLException {
        stmt.executeUpdate("DROP TABLE IF EXISTS SingleTestTable");
        stmt.executeUpdate("CREATE TABLE SingleTestTable (" +
                "   \"FloatCol\" REAL" +
                ",  \"DoubleCol\" FLOAT" +
    ...
    @Test
    @SuppressWarnings("removal")
    public void testBoxedTypeMapsToPrimitiveDeprecatedAPI() throws SQLException {
        JdbcToTableAdapter.ReadJdbcOptions options = JdbcToTableAdapter.readJdbcOptions();
        options.columnNameFormat(JdbcToTableAdapter.CasingStyle.lowerCamel, "_");
    ...
    @Test
    @SuppressWarnings("removal")
    public void testCharTypeMappingDeprecatedAPI() throws SQLException {
        stmt.executeUpdate("DROP TABLE IF EXISTS SingleTestTable");
        stmt.executeUpdate("CREATE TABLE SingleTestTable (" +
                "   \"CharCol\" CHAR(1)" +
                ");");
    ...
    @Test
    @SuppressWarnings("removal")
    public void testDateTypeMappingDeprecatedAPI() throws SQLException {
        stmt.executeUpdate("DROP TABLE IF EXISTS SingleTestTable");
        stmt.executeUpdate("CREATE TABLE SingleTestTable (" +
                "   \"DateCol\" DATE" +
                ");");
    ...
    @Test
    @SuppressWarnings("removal")
    public void testLocalTimeTypeMappingDeprecatedAPI() throws SQLException {
        stmt.executeUpdate("DROP TABLE IF EXISTS SingleTestTable");
        stmt.executeUpdate("CREATE TABLE SingleTestTable (" +
                "   \"TimeCol\" TIME(2)" +
                ");");
    ...
    @Test
    @SuppressWarnings("removal")
    public void testThrowsMapperExceptionDeprecatedAPI() throws SQLException {
        JdbcToTableAdapter.ReadJdbcOptions options = JdbcToTableAdapter.readJdbcOptions();
        options.columnNameFormat(JdbcToTableAdapter.CasingStyle.lowerCamel, "_");
    ...
    public void testLowerCamelCasing() throws SQLException {
        ...
        final JdbcReadInstructions instructions = JdbcReadInstructions.builder()
                ...
                .build();
        final Table result = JdbcToTableAdapter.readJdbc(rs, instructions);
    ...
    public void testDoubleArrayType() throws SQLException {
        ...
        final JdbcReadInstructions instructions = JdbcReadInstructions.builder()
                ...
                .build();
        Table result = JdbcToTableAdapter.readJdbc(stmt.executeQuery("SELECT * FROM SingleTestTable"), instructions);
        ColumnSource<double[]> cs = result.getColumnSource("ArrayColumn");
    ...
    public void testLongArrayType() throws SQLException {
        ...
        final JdbcReadInstructions instructions = JdbcReadInstructions.builder()
                ...
                .build();
        final Table result = JdbcToTableAdapter.readJdbc(stmt.executeQuery("SELECT * FROM SingleTestTable"), instructions);
        final ColumnSource<long[]> cs = result.getColumnSource("ArrayColumn");
    ...
    private void testArrayParseStrictHelper(
        ...
        try {
            JdbcToTableAdapter.readJdbc(stmt.executeQuery("SELECT * FROM SingleTestTable"), strictInstructions);
            Assert.fail("Did not throw Input");
        } catch (InputMismatchException ignored) {
        }
        ...
        final JdbcReadInstructions lenientInstructions = JdbcReadInstructions.builder()
                ...
                .strict(false)
                .build();
        final Table result = JdbcToTableAdapter.readJdbc(stmt.executeQuery("SELECT * FROM SingleTestTable"), lenientInstructions);
        ColumnSource<double[]> cs = result.getColumnSource("ArrayColumn");
        Assert.assertEquals(1, result.size());
        Assert.assertArrayEquals(expectedRow, cs.get(0), 1e-8);
    }
    ...
    public void testDecimalTypeMapping() throws SQLException {
        ...
        JdbcReadInstructions instructions = JdbcReadInstructions.builder()
                ...
                .build();
        result = JdbcToTableAdapter.readJdbc(stmt.executeQuery("SELECT \"FloatCol\" FROM SingleTestTable"), instructions);
        bigdecimalCS = result.getColumnSource("FloatCol");
        Assert.assertEquals(1567.89, bigdecimalCS.get(0).doubleValue(), 1e-3);
        Assert.assertNull(bigdecimalCS.get(1));
        ...
        instructions = JdbcReadInstructions.builder()
                ...
                .build();
        result = JdbcToTableAdapter.readJdbc(stmt.executeQuery("SELECT \"DoubleCol\" FROM SingleTestTable"), instructions);
        bigdecimalCS = result.getColumnSource("DoubleCol");
        Assert.assertEquals(2567.89, bigdecimalCS.get(0).doubleValue(), 1e-3);
        Assert.assertNull(bigdecimalCS.get(1));
        TableTools.show(result);
        ...
        instructions = JdbcReadInstructions.builder()
                ...
                .build();
        result = JdbcToTableAdapter.readJdbc(stmt.executeQuery("SELECT \"DecimalCol\" FROM SingleTestTable"), instructions);
        floatCS = result.getColumnSource("DecimalCol");
        Assert.assertEquals(3567.89, floatCS.getFloat(0), 1e-3);
        Assert.assertEquals(QueryConstants.NULL_FLOAT, floatCS.getFloat(1), 1e-3);
    ...
    public void testBoxedTypeMapsToPrimitive() throws SQLException {
        ...
        Table result = JdbcToTableAdapter.readJdbc(stmt.executeQuery("SELECT * FROM TestTable"), instructions);
        Assert.assertEquals(short.class, result.getColumnSource("smallIntType").getType());
        Assert.assertEquals(int.class, result.getColumnSource("intType").getType());
        Assert.assertEquals(long.class, result.getColumnSource("bigIntType").getType());
        Assert.assertEquals(double.class, result.getColumnSource("decimalType").getType());
    ...
    public void testDateTypeMapping() throws SQLException {
        ...
        instructions = JdbcReadInstructions.builder()
                ...
                .build();
        result = JdbcToTableAdapter.readJdbc(stmt.executeQuery("SELECT * FROM SingleTestTable"), instructions);
        ColumnSource<Instant> dtcs = result.getColumnSource("DateCol");
    ...
    public void testThrowsMapperException() throws SQLException {
        ...
        // let's just make sure we get the expected mapping exception
        try {
            JdbcToTableAdapter.readJdbc(stmt.executeQuery("SELECT * FROM TestTable"), instructions);
            Assert.fail("Did not throw expected JdbcTypeMapperException");
        } catch (final JdbcTypeMapperException ignored) {
        }
    }
