...
require("deephaven/proto/notebook_pb");
require("Flight_pb")
...
var notebookService = require("deephaven/proto/notebook_pb_service");
...
var io = { deephaven: {
    proto: {
            ...
            notebook_pb: proto.io.deephaven.proto.backplane.grpc,
            notebook_pb_service: notebookService,
        },
        barrage: {
            "flatbuf": {
