...
/**
 * <p>3-Tuple (triple) key class composed of long, short, and long elements.
 * <p>Generated by io.deephaven.replicators.TupleCodeGenerator.
 */
public class LongShortLongTuple implements Comparable<LongShortLongTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<LongShortLongTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final LongShortLongTuple typedOther = (LongShortLongTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final LongShortLongTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public LongShortLongTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        return this;
    }
}
