...
/**
 * <p>3-Tuple (triple) key class composed of byte, char, and char elements.
 * <p>Generated by io.deephaven.replicators.TupleCodeGenerator.
 */
public class ByteCharCharTuple implements Comparable<ByteCharCharTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<ByteCharCharTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final ByteCharCharTuple typedOther = (ByteCharCharTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final ByteCharCharTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public ByteCharCharTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        return this;
    }
}
