...
/**
 * <p>3-Tuple (triple) key class composed of long, int, and Object elements.
 * <p>Generated by io.deephaven.replicators.TupleCodeGenerator.
 */
public class LongIntObjectTuple implements Comparable<LongIntObjectTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<LongIntObjectTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final LongIntObjectTuple typedOther = (LongIntObjectTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final LongIntObjectTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public LongIntObjectTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        final Object canonicalizedElement3 = canonicalizer.apply(element3);
        return canonicalizedElement3 == element3
                ? this : new LongIntObjectTuple(element1, element2, canonicalizedElement3);
    }
}
