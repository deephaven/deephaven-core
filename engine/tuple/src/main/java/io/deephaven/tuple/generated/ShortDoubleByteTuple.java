...
/**
 * <p>3-Tuple (triple) key class composed of short, double, and byte elements.
 * <p>Generated by io.deephaven.replicators.TupleCodeGenerator.
 */
public class ShortDoubleByteTuple implements Comparable<ShortDoubleByteTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<ShortDoubleByteTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final ShortDoubleByteTuple typedOther = (ShortDoubleByteTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final ShortDoubleByteTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public ShortDoubleByteTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        return this;
    }
}
