...
/**
 * <p>3-Tuple (triple) key class composed of byte, float, and Object elements.
 * <p>Generated by io.deephaven.replicators.TupleCodeGenerator.
 */
public class ByteFloatObjectTuple implements Comparable<ByteFloatObjectTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<ByteFloatObjectTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final ByteFloatObjectTuple typedOther = (ByteFloatObjectTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final ByteFloatObjectTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public ByteFloatObjectTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        final Object canonicalizedElement3 = canonicalizer.apply(element3);
        return canonicalizedElement3 == element3
                ? this : new ByteFloatObjectTuple(element1, element2, canonicalizedElement3);
    }
}
