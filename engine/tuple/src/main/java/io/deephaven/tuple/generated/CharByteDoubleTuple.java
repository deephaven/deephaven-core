...
/**
 * <p>3-Tuple (triple) key class composed of char, byte, and double elements.
 * <p>Generated by io.deephaven.replicators.TupleCodeGenerator.
 */
public class CharByteDoubleTuple implements Comparable<CharByteDoubleTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<CharByteDoubleTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final CharByteDoubleTuple typedOther = (CharByteDoubleTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final CharByteDoubleTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public CharByteDoubleTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        return this;
    }
}
