...
/**
 * <p>3-Tuple (triple) key class composed of float, long, and int elements.
 * <p>Generated by io.deephaven.replicators.TupleCodeGenerator.
 */
public class FloatLongIntTuple implements Comparable<FloatLongIntTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<FloatLongIntTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final FloatLongIntTuple typedOther = (FloatLongIntTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final FloatLongIntTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public FloatLongIntTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        return this;
    }
}
