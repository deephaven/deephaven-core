...
/**
 * <p>3-Tuple (triple) key class composed of float, double, and double elements.
 * <p>Generated by io.deephaven.replicators.TupleCodeGenerator.
 */
public class FloatDoubleDoubleTuple implements Comparable<FloatDoubleDoubleTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<FloatDoubleDoubleTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final FloatDoubleDoubleTuple typedOther = (FloatDoubleDoubleTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final FloatDoubleDoubleTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public FloatDoubleDoubleTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        return this;
    }
}
