...
/**
 * <p>3-Tuple (triple) key class composed of short, Object, and float elements.
...
public class ShortObjectFloatTuple implements Comparable<ShortObjectFloatTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<ShortObjectFloatTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final ShortObjectFloatTuple typedOther = (ShortObjectFloatTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final ShortObjectFloatTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public ShortObjectFloatTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        final Object canonicalizedElement2 = canonicalizer.apply(element2);
        return canonicalizedElement2 == element2
                ? this : new ShortObjectFloatTuple(element1, canonicalizedElement2, element3);
    }
}
