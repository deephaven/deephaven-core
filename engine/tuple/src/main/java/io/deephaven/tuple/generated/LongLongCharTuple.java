...
/**
 * <p>3-Tuple (triple) key class composed of long, long, and char elements.
 * <p>Generated by io.deephaven.replicators.TupleCodeGenerator.
 */
public class LongLongCharTuple implements Comparable<LongLongCharTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<LongLongCharTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final LongLongCharTuple typedOther = (LongLongCharTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final LongLongCharTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public LongLongCharTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        return this;
    }
}
