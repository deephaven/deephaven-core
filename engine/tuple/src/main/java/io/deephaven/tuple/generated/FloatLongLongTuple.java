...
/**
 * <p>3-Tuple (triple) key class composed of float, long, and long elements.
 * <p>Generated by io.deephaven.replicators.TupleCodeGenerator.
 */
public class FloatLongLongTuple implements Comparable<FloatLongLongTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<FloatLongLongTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final FloatLongLongTuple typedOther = (FloatLongLongTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final FloatLongLongTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public FloatLongLongTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        return this;
    }
}
