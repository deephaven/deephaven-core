...
/**
 * <p>3-Tuple (triple) key class composed of int, double, and char elements.
 * <p>Generated by io.deephaven.replicators.TupleCodeGenerator.
 */
public class IntDoubleCharTuple implements Comparable<IntDoubleCharTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<IntDoubleCharTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final IntDoubleCharTuple typedOther = (IntDoubleCharTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final IntDoubleCharTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public IntDoubleCharTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        return this;
    }
}
