...
/**
 * <p>3-Tuple (triple) key class composed of byte, short, and float elements.
 * <p>Generated by io.deephaven.replicators.TupleCodeGenerator.
 */
public class ByteShortFloatTuple implements Comparable<ByteShortFloatTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<ByteShortFloatTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final ByteShortFloatTuple typedOther = (ByteShortFloatTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final ByteShortFloatTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public ByteShortFloatTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        return this;
    }
}
