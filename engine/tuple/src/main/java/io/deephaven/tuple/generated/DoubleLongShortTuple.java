...
/**
 * <p>3-Tuple (triple) key class composed of double, long, and short elements.
 * <p>Generated by io.deephaven.replicators.TupleCodeGenerator.
 */
public class DoubleLongShortTuple implements Comparable<DoubleLongShortTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<DoubleLongShortTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final DoubleLongShortTuple typedOther = (DoubleLongShortTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final DoubleLongShortTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public DoubleLongShortTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        return this;
    }
}
