...
/**
 * <p>3-Tuple (triple) key class composed of int, double, and float elements.
 * <p>Generated by io.deephaven.replicators.TupleCodeGenerator.
 */
public class IntDoubleFloatTuple implements Comparable<IntDoubleFloatTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<IntDoubleFloatTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final IntDoubleFloatTuple typedOther = (IntDoubleFloatTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final IntDoubleFloatTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public IntDoubleFloatTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        return this;
    }
}
