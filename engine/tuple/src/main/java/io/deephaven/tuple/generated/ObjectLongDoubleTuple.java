...
/**
 * <p>3-Tuple (triple) key class composed of Object, long, and double elements.
 * <p>Generated by io.deephaven.replicators.TupleCodeGenerator.
 */
public class ObjectLongDoubleTuple implements Comparable<ObjectLongDoubleTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<ObjectLongDoubleTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final ObjectLongDoubleTuple typedOther = (ObjectLongDoubleTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final ObjectLongDoubleTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public ObjectLongDoubleTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        final Object canonicalizedElement1 = canonicalizer.apply(element1);
        return canonicalizedElement1 == element1
                ? this : new ObjectLongDoubleTuple(canonicalizedElement1, element2, element3);
    }
}
