...
/**
 * <p>3-Tuple (triple) key class composed of long, byte, and float elements.
 * <p>Generated by io.deephaven.replicators.TupleCodeGenerator.
 */
public class LongByteFloatTuple implements Comparable<LongByteFloatTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<LongByteFloatTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final LongByteFloatTuple typedOther = (LongByteFloatTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final LongByteFloatTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public LongByteFloatTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        return this;
    }
}
