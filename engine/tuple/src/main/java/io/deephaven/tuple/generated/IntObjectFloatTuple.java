...
/**
 * <p>3-Tuple (triple) key class composed of int, Object, and float elements.
 * <p>Generated by io.deephaven.replicators.TupleCodeGenerator.
 */
public class IntObjectFloatTuple implements Comparable<IntObjectFloatTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<IntObjectFloatTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final IntObjectFloatTuple typedOther = (IntObjectFloatTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final IntObjectFloatTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public IntObjectFloatTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        final Object canonicalizedElement2 = canonicalizer.apply(element2);
        return canonicalizedElement2 == element2
                ? this : new IntObjectFloatTuple(element1, canonicalizedElement2, element3);
    }
}
