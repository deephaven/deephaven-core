...
/**
 * <p>3-Tuple (triple) key class composed of char, float, and Object elements.
 * <p>Generated by io.deephaven.replicators.TupleCodeGenerator.
 */
public class CharFloatObjectTuple implements Comparable<CharFloatObjectTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<CharFloatObjectTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final CharFloatObjectTuple typedOther = (CharFloatObjectTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final CharFloatObjectTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public CharFloatObjectTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        final Object canonicalizedElement3 = canonicalizer.apply(element3);
        return canonicalizedElement3 == element3
                ? this : new CharFloatObjectTuple(element1, element2, canonicalizedElement3);
    }
}
