...
/**
 * <p>2-Tuple (double) key class composed of Object and double elements.
 * <p>Generated by io.deephaven.replicators.TupleCodeGenerator.
 */
public class ObjectDoubleTuple implements Comparable<ObjectDoubleTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<ObjectDoubleTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final ObjectDoubleTuple typedOther = (ObjectDoubleTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final ObjectDoubleTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    public String toString() {
        return "ObjectDoubleTuple{" +
                element1 + ", " +
                element2 + '}';
    }

    @Override
    public ObjectDoubleTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        final Object canonicalizedElement1 = canonicalizer.apply(element1);
        return canonicalizedElement1 == element1
                ? this : new ObjectDoubleTuple(canonicalizedElement1, element2);
    }
}
