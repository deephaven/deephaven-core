...
/**
 * <p>3-Tuple (triple) key class composed of Object, long, and int elements.
 * <p>Generated by io.deephaven.replicators.TupleCodeGenerator.
 */
public class ObjectLongIntTuple implements Comparable<ObjectLongIntTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<ObjectLongIntTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final ObjectLongIntTuple typedOther = (ObjectLongIntTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final ObjectLongIntTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public ObjectLongIntTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        final Object canonicalizedElement1 = canonicalizer.apply(element1);
        return canonicalizedElement1 == element1
                ? this : new ObjectLongIntTuple(canonicalizedElement1, element2, element3);
    }
}
