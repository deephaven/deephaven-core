...
/**
 * <p>3-Tuple (triple) key class composed of short, float, and Object elements.
 * <p>Generated by io.deephaven.replicators.TupleCodeGenerator.
 */
public class ShortFloatObjectTuple implements Comparable<ShortFloatObjectTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<ShortFloatObjectTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final ShortFloatObjectTuple typedOther = (ShortFloatObjectTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final ShortFloatObjectTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public ShortFloatObjectTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        final Object canonicalizedElement3 = canonicalizer.apply(element3);
        return canonicalizedElement3 == element3
                ? this : new ShortFloatObjectTuple(element1, element2, canonicalizedElement3);
    }
}
