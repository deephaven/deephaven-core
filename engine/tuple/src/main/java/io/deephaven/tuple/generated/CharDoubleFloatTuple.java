...
/**
 * <p>3-Tuple (triple) key class composed of char, double, and float elements.
 * <p>Generated by io.deephaven.replicators.TupleCodeGenerator.
 */
public class CharDoubleFloatTuple implements Comparable<CharDoubleFloatTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<CharDoubleFloatTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final CharDoubleFloatTuple typedOther = (CharDoubleFloatTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final CharDoubleFloatTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public CharDoubleFloatTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        return this;
    }
}
