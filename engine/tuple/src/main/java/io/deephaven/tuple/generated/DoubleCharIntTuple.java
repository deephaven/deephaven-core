...
/**
 * <p>3-Tuple (triple) key class composed of double, char, and int elements.
 * <p>Generated by io.deephaven.replicators.TupleCodeGenerator.
 */
public class DoubleCharIntTuple implements Comparable<DoubleCharIntTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<DoubleCharIntTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final DoubleCharIntTuple typedOther = (DoubleCharIntTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final DoubleCharIntTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public DoubleCharIntTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        return this;
    }
}
