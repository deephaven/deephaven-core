...
/**
 * <p>3-Tuple (triple) key class composed of byte, char, and Object elements.
 * <p>Generated by io.deephaven.replicators.TupleCodeGenerator.
 */
public class ByteCharObjectTuple implements Comparable<ByteCharObjectTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<ByteCharObjectTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final ByteCharObjectTuple typedOther = (ByteCharObjectTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final ByteCharObjectTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public ByteCharObjectTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        final Object canonicalizedElement3 = canonicalizer.apply(element3);
        return canonicalizedElement3 == element3
                ? this : new ByteCharObjectTuple(element1, element2, canonicalizedElement3);
    }
}
