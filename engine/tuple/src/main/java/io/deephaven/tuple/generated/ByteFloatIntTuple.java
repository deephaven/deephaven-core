...
/**
 * <p>3-Tuple (triple) key class composed of byte, float, and int elements.
 * <p>Generated by io.deephaven.replicators.TupleCodeGenerator.
 */
public class ByteFloatIntTuple implements Comparable<ByteFloatIntTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<ByteFloatIntTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final ByteFloatIntTuple typedOther = (ByteFloatIntTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final ByteFloatIntTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public ByteFloatIntTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        return this;
    }
}
