...
/**
 * <p>3-Tuple (triple) key class composed of Object, double, and char elements.
 * <p>Generated by io.deephaven.replicators.TupleCodeGenerator.
 */
public class ObjectDoubleCharTuple implements Comparable<ObjectDoubleCharTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<ObjectDoubleCharTuple> {
    ...
    private void initialize(
        ...
        cachedHashCode = ((31 +
                ...
                CharComparisons.hashCode(element3);
    }
    ...
    public final boolean equals(final Object other) {
        ...
        final ObjectDoubleCharTuple typedOther = (ObjectDoubleCharTuple) other;
        // @formatter:off
        return ObjectComparisons.eq(element1, typedOther.element1) &&
               DoubleComparisons.eq(element2, typedOther.element2) &&
               CharComparisons.eq(element3, typedOther.element3);
        // @formatter:on
    }

    @Override
    public final int compareTo(@NotNull final ObjectDoubleCharTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public ObjectDoubleCharTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        final Object canonicalizedElement1 = canonicalizer.apply(element1);
        return canonicalizedElement1 == element1
                ? this : new ObjectDoubleCharTuple(canonicalizedElement1, element2, element3);
    }
}
