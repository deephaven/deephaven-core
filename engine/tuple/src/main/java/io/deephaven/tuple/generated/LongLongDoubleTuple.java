...
/**
 * <p>3-Tuple (triple) key class composed of long, long, and double elements.
 * <p>Generated by io.deephaven.replicators.TupleCodeGenerator.
 */
public class LongLongDoubleTuple implements Comparable<LongLongDoubleTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<LongLongDoubleTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final LongLongDoubleTuple typedOther = (LongLongDoubleTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final LongLongDoubleTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public LongLongDoubleTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        return this;
    }
}
