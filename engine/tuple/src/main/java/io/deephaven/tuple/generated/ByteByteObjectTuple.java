...
/**
 * <p>3-Tuple (triple) key class composed of byte, byte, and Object elements.
 * <p>Generated by io.deephaven.replicators.TupleCodeGenerator.
 */
public class ByteByteObjectTuple implements Comparable<ByteByteObjectTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<ByteByteObjectTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final ByteByteObjectTuple typedOther = (ByteByteObjectTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final ByteByteObjectTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public ByteByteObjectTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        final Object canonicalizedElement3 = canonicalizer.apply(element3);
        return canonicalizedElement3 == element3
                ? this : new ByteByteObjectTuple(element1, element2, canonicalizedElement3);
    }
}
