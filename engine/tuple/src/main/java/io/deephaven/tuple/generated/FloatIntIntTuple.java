...
/**
 * <p>3-Tuple (triple) key class composed of float, int, and int elements.
 * <p>Generated by io.deephaven.replicators.TupleCodeGenerator.
 */
public class FloatIntIntTuple implements Comparable<FloatIntIntTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<FloatIntIntTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final FloatIntIntTuple typedOther = (FloatIntIntTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final FloatIntIntTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public FloatIntIntTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        return this;
    }
}
