...
/**
 * <p>3-Tuple (triple) key class composed of int, float, and byte elements.
 * <p>Generated by io.deephaven.replicators.TupleCodeGenerator.
 */
public class IntFloatByteTuple implements Comparable<IntFloatByteTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<IntFloatByteTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final IntFloatByteTuple typedOther = (IntFloatByteTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final IntFloatByteTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public IntFloatByteTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        return this;
    }
}
