...
/**
 * <p>3-Tuple (triple) key class composed of long, char, and byte elements.
 * <p>Generated by io.deephaven.replicators.TupleCodeGenerator.
 */
public class LongCharByteTuple implements Comparable<LongCharByteTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<LongCharByteTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final LongCharByteTuple typedOther = (LongCharByteTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final LongCharByteTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public LongCharByteTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        return this;
    }
}
