...
/**
 * <p>3-Tuple (triple) key class composed of double, int, and int elements.
 * <p>Generated by io.deephaven.replicators.TupleCodeGenerator.
 */
public class DoubleIntIntTuple implements Comparable<DoubleIntIntTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<DoubleIntIntTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final DoubleIntIntTuple typedOther = (DoubleIntIntTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final DoubleIntIntTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public DoubleIntIntTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        return this;
    }
}
