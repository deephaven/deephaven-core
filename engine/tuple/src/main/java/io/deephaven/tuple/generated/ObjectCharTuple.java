...
/**
 * <p>2-Tuple (double) key class composed of Object and char elements.
 * <p>Generated by io.deephaven.replicators.TupleCodeGenerator.
 */
public class ObjectCharTuple implements Comparable<ObjectCharTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<ObjectCharTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final ObjectCharTuple typedOther = (ObjectCharTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final ObjectCharTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    public String toString() {
        return "ObjectCharTuple{" +
                element1 + ", " +
                element2 + '}';
    }

    @Override
    public ObjectCharTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        final Object canonicalizedElement1 = canonicalizer.apply(element1);
        return canonicalizedElement1 == element1
                ? this : new ObjectCharTuple(canonicalizedElement1, element2);
    }
}
