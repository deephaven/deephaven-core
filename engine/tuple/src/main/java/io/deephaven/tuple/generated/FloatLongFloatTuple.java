...
/**
 * <p>3-Tuple (triple) key class composed of float, long, and float elements.
 * <p>Generated by io.deephaven.replicators.TupleCodeGenerator.
 */
public class FloatLongFloatTuple implements Comparable<FloatLongFloatTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<FloatLongFloatTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final FloatLongFloatTuple typedOther = (FloatLongFloatTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final FloatLongFloatTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public FloatLongFloatTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        return this;
    }
}
