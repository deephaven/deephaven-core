...
/**
 * <p>3-Tuple (triple) key class composed of float, int, and float elements.
 * <p>Generated by io.deephaven.replicators.TupleCodeGenerator.
 */
public class FloatIntFloatTuple implements Comparable<FloatIntFloatTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<FloatIntFloatTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final FloatIntFloatTuple typedOther = (FloatIntFloatTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final FloatIntFloatTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public FloatIntFloatTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        return this;
    }
}
