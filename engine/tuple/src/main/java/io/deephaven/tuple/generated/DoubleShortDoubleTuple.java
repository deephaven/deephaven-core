...
/**
 * <p>3-Tuple (triple) key class composed of double, short, and double elements.
 * <p>Generated by io.deephaven.replicators.TupleCodeGenerator.
 */
public class DoubleShortDoubleTuple implements Comparable<DoubleShortDoubleTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<DoubleShortDoubleTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final DoubleShortDoubleTuple typedOther = (DoubleShortDoubleTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final DoubleShortDoubleTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public DoubleShortDoubleTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        return this;
    }
}
