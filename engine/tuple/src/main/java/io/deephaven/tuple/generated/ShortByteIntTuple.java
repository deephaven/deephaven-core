...
/**
 * <p>3-Tuple (triple) key class composed of short, byte, and int elements.
 * <p>Generated by io.deephaven.replicators.TupleCodeGenerator.
 */
public class ShortByteIntTuple implements Comparable<ShortByteIntTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<ShortByteIntTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final ShortByteIntTuple typedOther = (ShortByteIntTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final ShortByteIntTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public ShortByteIntTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        return this;
    }
}
