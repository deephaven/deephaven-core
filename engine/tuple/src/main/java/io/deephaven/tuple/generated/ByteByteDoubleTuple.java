...
/**
 * <p>3-Tuple (triple) key class composed of byte, byte, and double elements.
 * <p>Generated by io.deephaven.replicators.TupleCodeGenerator.
 */
public class ByteByteDoubleTuple implements Comparable<ByteByteDoubleTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<ByteByteDoubleTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final ByteByteDoubleTuple typedOther = (ByteByteDoubleTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final ByteByteDoubleTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public ByteByteDoubleTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        return this;
    }
}
