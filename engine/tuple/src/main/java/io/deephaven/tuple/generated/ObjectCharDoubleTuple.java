...
/**
 * <p>3-Tuple (triple) key class composed of Object, char, and double elements.
 * <p>Generated by io.deephaven.replicators.TupleCodeGenerator.
 */
public class ObjectCharDoubleTuple implements Comparable<ObjectCharDoubleTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<ObjectCharDoubleTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final ObjectCharDoubleTuple typedOther = (ObjectCharDoubleTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final ObjectCharDoubleTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public ObjectCharDoubleTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        final Object canonicalizedElement1 = canonicalizer.apply(element1);
        return canonicalizedElement1 == element1
                ? this : new ObjectCharDoubleTuple(canonicalizedElement1, element2, element3);
    }
}
