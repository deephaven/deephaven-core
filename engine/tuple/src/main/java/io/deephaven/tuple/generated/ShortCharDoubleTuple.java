...
/**
 * <p>3-Tuple (triple) key class composed of short, char, and double elements.
 * <p>Generated by io.deephaven.replicators.TupleCodeGenerator.
 */
public class ShortCharDoubleTuple implements Comparable<ShortCharDoubleTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<ShortCharDoubleTuple> {
    ...
    @Override
    public final int compareTo(@NotNull final ShortCharDoubleTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public ShortCharDoubleTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        return this;
    }
}
