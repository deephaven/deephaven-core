...
/**
 * <p>2-Tuple (double) key class composed of long and byte elements.
 * <p>Generated by io.deephaven.replicators.TupleCodeGenerator.
 */
public class LongByteTuple implements Comparable<LongByteTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<LongByteTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final LongByteTuple typedOther = (LongByteTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final LongByteTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    public String toString() {
        return "LongByteTuple{" +
                element1 + ", " +
                element2 + '}';
    }

    @Override
    public LongByteTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        return this;
    }
}
