...
/**
 * <p>3-Tuple (triple) key class composed of short, byte, and long elements.
 * <p>Generated by io.deephaven.replicators.TupleCodeGenerator.
 */
public class ShortByteLongTuple implements Comparable<ShortByteLongTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<ShortByteLongTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final ShortByteLongTuple typedOther = (ShortByteLongTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final ShortByteLongTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public ShortByteLongTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        return this;
    }
}
