...
/**
 * <p>3-Tuple (triple) key class composed of byte, byte, and char elements.
 * <p>Generated by io.deephaven.replicators.TupleCodeGenerator.
 */
public class ByteByteCharTuple implements Comparable<ByteByteCharTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<ByteByteCharTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final ByteByteCharTuple typedOther = (ByteByteCharTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final ByteByteCharTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public ByteByteCharTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        return this;
    }
}
