...
/**
 * <p>3-Tuple (triple) key class composed of float, Object, and char elements.
 * <p>Generated by io.deephaven.replicators.TupleCodeGenerator.
 */
public class FloatObjectCharTuple implements Comparable<FloatObjectCharTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<FloatObjectCharTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final FloatObjectCharTuple typedOther = (FloatObjectCharTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final FloatObjectCharTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public FloatObjectCharTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        final Object canonicalizedElement2 = canonicalizer.apply(element2);
        return canonicalizedElement2 == element2
                ? this : new FloatObjectCharTuple(element1, canonicalizedElement2, element3);
    }
}
