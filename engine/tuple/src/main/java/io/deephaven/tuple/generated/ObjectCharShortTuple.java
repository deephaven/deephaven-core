...
/**
 * <p>3-Tuple (triple) key class composed of Object, char, and short elements.
 * <p>Generated by io.deephaven.replicators.TupleCodeGenerator.
 */
public class ObjectCharShortTuple implements Comparable<ObjectCharShortTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<ObjectCharShortTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final ObjectCharShortTuple typedOther = (ObjectCharShortTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final ObjectCharShortTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public ObjectCharShortTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        final Object canonicalizedElement1 = canonicalizer.apply(element1);
        return canonicalizedElement1 == element1
                ? this : new ObjectCharShortTuple(canonicalizedElement1, element2, element3);
    }
}
