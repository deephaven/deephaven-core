...
/**
 * <p>3-Tuple (triple) key class composed of byte, Object, and double elements.
 * <p>Generated by io.deephaven.replicators.TupleCodeGenerator.
 */
public class ByteObjectDoubleTuple implements Comparable<ByteObjectDoubleTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<ByteObjectDoubleTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final ByteObjectDoubleTuple typedOther = (ByteObjectDoubleTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final ByteObjectDoubleTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public ByteObjectDoubleTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        final Object canonicalizedElement2 = canonicalizer.apply(element2);
        return canonicalizedElement2 == element2
                ? this : new ByteObjectDoubleTuple(element1, canonicalizedElement2, element3);
    }
}
