...
/**
 * <p>3-Tuple (triple) key class composed of long, float, and long elements.
 * <p>Generated by io.deephaven.replicators.TupleCodeGenerator.
 */
public class LongFloatLongTuple implements Comparable<LongFloatLongTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<LongFloatLongTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final LongFloatLongTuple typedOther = (LongFloatLongTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final LongFloatLongTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public LongFloatLongTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        return this;
    }
}
