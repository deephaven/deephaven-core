...
/**
 * <p>3-Tuple (triple) key class composed of byte, Object, and short elements.
 * <p>Generated by io.deephaven.replicators.TupleCodeGenerator.
 */
public class ByteObjectShortTuple implements Comparable<ByteObjectShortTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<ByteObjectShortTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final ByteObjectShortTuple typedOther = (ByteObjectShortTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final ByteObjectShortTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public ByteObjectShortTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        final Object canonicalizedElement2 = canonicalizer.apply(element2);
        return canonicalizedElement2 == element2
                ? this : new ByteObjectShortTuple(element1, canonicalizedElement2, element3);
    }
}
