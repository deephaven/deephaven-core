...
/**
 * <p>3-Tuple (triple) key class composed of short, long, and short elements.
 * <p>Generated by io.deephaven.replicators.TupleCodeGenerator.
 */
public class ShortLongShortTuple implements Comparable<ShortLongShortTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<ShortLongShortTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final ShortLongShortTuple typedOther = (ShortLongShortTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final ShortLongShortTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public ShortLongShortTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        return this;
    }
}
