...
/**
 * <p>3-Tuple (triple) key class composed of Object, float, and float elements.
 * <p>Generated by io.deephaven.replicators.TupleCodeGenerator.
 */
public class ObjectFloatFloatTuple implements Comparable<ObjectFloatFloatTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<ObjectFloatFloatTuple> {
    ...
    @Override
    public final int compareTo(@NotNull final ObjectFloatFloatTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public ObjectFloatFloatTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        final Object canonicalizedElement1 = canonicalizer.apply(element1);
        return canonicalizedElement1 == element1
                ? this : new ObjectFloatFloatTuple(canonicalizedElement1, element2, element3);
    }
}
