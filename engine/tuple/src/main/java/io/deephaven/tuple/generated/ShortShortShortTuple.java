...
/**
 * <p>3-Tuple (triple) key class composed of short, short, and short elements.
 * <p>Generated by io.deephaven.replicators.TupleCodeGenerator.
 */
public class ShortShortShortTuple implements Comparable<ShortShortShortTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<ShortShortShortTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final ShortShortShortTuple typedOther = (ShortShortShortTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final ShortShortShortTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public ShortShortShortTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        return this;
    }
}
