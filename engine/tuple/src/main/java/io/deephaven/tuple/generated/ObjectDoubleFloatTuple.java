...
/**
 * <p>3-Tuple (triple) key class composed of Object, double, and float elements.
 * <p>Generated by io.deephaven.replicators.TupleCodeGenerator.
 */
public class ObjectDoubleFloatTuple implements Comparable<ObjectDoubleFloatTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<ObjectDoubleFloatTuple> {
    ...
    @Override
    public final int compareTo(@NotNull final ObjectDoubleFloatTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public ObjectDoubleFloatTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        final Object canonicalizedElement1 = canonicalizer.apply(element1);
        return canonicalizedElement1 == element1
                ? this : new ObjectDoubleFloatTuple(canonicalizedElement1, element2, element3);
    }
}
