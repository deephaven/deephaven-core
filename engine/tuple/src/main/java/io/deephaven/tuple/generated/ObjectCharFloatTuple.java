...
/**
 * <p>3-Tuple (triple) key class composed of Object, char, and float elements.
 * <p>Generated by io.deephaven.replicators.TupleCodeGenerator.
 */
public class ObjectCharFloatTuple implements Comparable<ObjectCharFloatTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<ObjectCharFloatTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final ObjectCharFloatTuple typedOther = (ObjectCharFloatTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final ObjectCharFloatTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public ObjectCharFloatTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        final Object canonicalizedElement1 = canonicalizer.apply(element1);
        return canonicalizedElement1 == element1
                ? this : new ObjectCharFloatTuple(canonicalizedElement1, element2, element3);
    }
}
