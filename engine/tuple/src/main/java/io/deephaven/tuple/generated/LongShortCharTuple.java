...
/**
 * <p>3-Tuple (triple) key class composed of long, short, and char elements.
 * <p>Generated by io.deephaven.replicators.TupleCodeGenerator.
 */
public class LongShortCharTuple implements Comparable<LongShortCharTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<LongShortCharTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final LongShortCharTuple typedOther = (LongShortCharTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final LongShortCharTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public LongShortCharTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        return this;
    }
}
