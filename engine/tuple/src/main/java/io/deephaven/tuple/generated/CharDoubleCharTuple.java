...
/**
 * <p>3-Tuple (triple) key class composed of char, double, and char elements.
 * <p>Generated by io.deephaven.replicators.TupleCodeGenerator.
 */
public class CharDoubleCharTuple implements Comparable<CharDoubleCharTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<CharDoubleCharTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final CharDoubleCharTuple typedOther = (CharDoubleCharTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final CharDoubleCharTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public CharDoubleCharTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        return this;
    }
}
