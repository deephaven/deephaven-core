...
/**
 * <p>3-Tuple (triple) key class composed of Object, long, and float elements.
 * <p>Generated by io.deephaven.replicators.TupleCodeGenerator.
 */
public class ObjectLongFloatTuple implements Comparable<ObjectLongFloatTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<ObjectLongFloatTuple> {
    ...
    @Override
    public ObjectLongFloatTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        final Object canonicalizedElement1 = canonicalizer.apply(element1);
        return canonicalizedElement1 == element1
                ? this : new ObjectLongFloatTuple(canonicalizedElement1, element2, element3);
    }
}
