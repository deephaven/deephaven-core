...
/**
 * <p>3-Tuple (triple) key class composed of float, int, and Object elements.
 * <p>Generated by io.deephaven.replicators.TupleCodeGenerator.
 */
public class FloatIntObjectTuple implements Comparable<FloatIntObjectTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<FloatIntObjectTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final FloatIntObjectTuple typedOther = (FloatIntObjectTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final FloatIntObjectTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public FloatIntObjectTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        final Object canonicalizedElement3 = canonicalizer.apply(element3);
        return canonicalizedElement3 == element3
                ? this : new FloatIntObjectTuple(element1, element2, canonicalizedElement3);
    }
}
