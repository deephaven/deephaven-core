...
/**
 * <p>3-Tuple (triple) key class composed of Object, int, and int elements.
 * <p>Generated by io.deephaven.replicators.TupleCodeGenerator.
 */
public class ObjectIntIntTuple implements Comparable<ObjectIntIntTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<ObjectIntIntTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final ObjectIntIntTuple typedOther = (ObjectIntIntTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final ObjectIntIntTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public ObjectIntIntTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        final Object canonicalizedElement1 = canonicalizer.apply(element1);
        return canonicalizedElement1 == element1
                ? this : new ObjectIntIntTuple(canonicalizedElement1, element2, element3);
    }
}
