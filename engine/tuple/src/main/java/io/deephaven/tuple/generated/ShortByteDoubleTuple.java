...
/**
 * <p>3-Tuple (triple) key class composed of short, byte, and double elements.
 * <p>Generated by io.deephaven.replicators.TupleCodeGenerator.
 */
public class ShortByteDoubleTuple implements Comparable<ShortByteDoubleTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<ShortByteDoubleTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final ShortByteDoubleTuple typedOther = (ShortByteDoubleTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final ShortByteDoubleTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public ShortByteDoubleTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        return this;
    }
}
