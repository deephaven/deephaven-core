...
/**
 * <p>3-Tuple (triple) key class composed of float, Object, and Object elements.
 * <p>Generated by io.deephaven.replicators.TupleCodeGenerator.
 */
public class FloatObjectObjectTuple implements Comparable<FloatObjectObjectTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<FloatObjectObjectTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final FloatObjectObjectTuple typedOther = (FloatObjectObjectTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final FloatObjectObjectTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public FloatObjectObjectTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        ...
        return canonicalizedElement2 == element2 && canonicalizedElement3 == element3
                ? this : new FloatObjectObjectTuple(element1, canonicalizedElement2, canonicalizedElement3);
    }
}
