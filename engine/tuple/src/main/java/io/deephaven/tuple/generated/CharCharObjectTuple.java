...
/**
 * <p>3-Tuple (triple) key class composed of char, char, and Object elements.
 * <p>Generated by io.deephaven.replicators.TupleCodeGenerator.
 */
public class CharCharObjectTuple implements Comparable<CharCharObjectTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<CharCharObjectTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final CharCharObjectTuple typedOther = (CharCharObjectTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final CharCharObjectTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public CharCharObjectTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        final Object canonicalizedElement3 = canonicalizer.apply(element3);
        return canonicalizedElement3 == element3
                ? this : new CharCharObjectTuple(element1, element2, canonicalizedElement3);
    }
}
