...
/**
 * <p>3-Tuple (triple) key class composed of float, float, and long elements.
 * <p>Generated by io.deephaven.replicators.TupleCodeGenerator.
 */
public class FloatFloatLongTuple implements Comparable<FloatFloatLongTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<FloatFloatLongTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final FloatFloatLongTuple typedOther = (FloatFloatLongTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final FloatFloatLongTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public FloatFloatLongTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        return this;
    }
}
