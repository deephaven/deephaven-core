...
/**
 * <p>3-Tuple (triple) key class composed of short, int, and int elements.
 * <p>Generated by io.deephaven.replicators.TupleCodeGenerator.
 */
public class ShortIntIntTuple implements Comparable<ShortIntIntTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<ShortIntIntTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final ShortIntIntTuple typedOther = (ShortIntIntTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final ShortIntIntTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public ShortIntIntTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        return this;
    }
}
