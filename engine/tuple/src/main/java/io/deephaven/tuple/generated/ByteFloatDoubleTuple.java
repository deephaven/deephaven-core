...
/**
 * <p>3-Tuple (triple) key class composed of byte, float, and double elements.
 * <p>Generated by io.deephaven.replicators.TupleCodeGenerator.
 */
public class ByteFloatDoubleTuple implements Comparable<ByteFloatDoubleTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<ByteFloatDoubleTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final ByteFloatDoubleTuple typedOther = (ByteFloatDoubleTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final ByteFloatDoubleTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public ByteFloatDoubleTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        return this;
    }
}
