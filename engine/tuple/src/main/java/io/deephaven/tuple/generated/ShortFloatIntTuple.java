...
/**
 * <p>3-Tuple (triple) key class composed of short, float, and int elements.
 * <p>Generated by io.deephaven.replicators.TupleCodeGenerator.
 */
public class ShortFloatIntTuple implements Comparable<ShortFloatIntTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<ShortFloatIntTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final ShortFloatIntTuple typedOther = (ShortFloatIntTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final ShortFloatIntTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public ShortFloatIntTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        return this;
    }
}
