...
/**
 * <p>3-Tuple (triple) key class composed of long, Object, and long elements.
 * <p>Generated by io.deephaven.replicators.TupleCodeGenerator.
 */
public class LongObjectLongTuple implements Comparable<LongObjectLongTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<LongObjectLongTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final LongObjectLongTuple typedOther = (LongObjectLongTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final LongObjectLongTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public LongObjectLongTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        final Object canonicalizedElement2 = canonicalizer.apply(element2);
        return canonicalizedElement2 == element2
                ? this : new LongObjectLongTuple(element1, canonicalizedElement2, element3);
    }
}
