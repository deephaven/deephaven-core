...
/**
 * <p>3-Tuple (triple) key class composed of double, int, and float elements.
 * <p>Generated by io.deephaven.replicators.TupleCodeGenerator.
 */
public class DoubleIntFloatTuple implements Comparable<DoubleIntFloatTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<DoubleIntFloatTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final DoubleIntFloatTuple typedOther = (DoubleIntFloatTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final DoubleIntFloatTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public DoubleIntFloatTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        return this;
    }
}
