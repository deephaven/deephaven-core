...
/**
 * <p>3-Tuple (triple) key class composed of char, char, and int elements.
 * <p>Generated by io.deephaven.replicators.TupleCodeGenerator.
 */
public class CharCharIntTuple implements Comparable<CharCharIntTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<CharCharIntTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final CharCharIntTuple typedOther = (CharCharIntTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final CharCharIntTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public CharCharIntTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        return this;
    }
}
