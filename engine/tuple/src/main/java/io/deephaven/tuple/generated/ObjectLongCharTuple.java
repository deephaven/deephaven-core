...
/**
 * <p>3-Tuple (triple) key class composed of Object, long, and char elements.
 * <p>Generated by io.deephaven.replicators.TupleCodeGenerator.
 */
public class ObjectLongCharTuple implements Comparable<ObjectLongCharTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<ObjectLongCharTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final ObjectLongCharTuple typedOther = (ObjectLongCharTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final ObjectLongCharTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public ObjectLongCharTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        final Object canonicalizedElement1 = canonicalizer.apply(element1);
        return canonicalizedElement1 == element1
                ? this : new ObjectLongCharTuple(canonicalizedElement1, element2, element3);
    }
}
