...
/**
 * <p>3-Tuple (triple) key class composed of char, short, and long elements.
 * <p>Generated by io.deephaven.replicators.TupleCodeGenerator.
 */
public class CharShortLongTuple implements Comparable<CharShortLongTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<CharShortLongTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final CharShortLongTuple typedOther = (CharShortLongTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final CharShortLongTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public CharShortLongTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        return this;
    }
}
