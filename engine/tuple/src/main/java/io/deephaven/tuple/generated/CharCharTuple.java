...
/**
 * <p>2-Tuple (double) key class composed of char and char elements.
 * <p>Generated by io.deephaven.replicators.TupleCodeGenerator.
 */
public class CharCharTuple implements Comparable<CharCharTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<CharCharTuple> {
    ...
    @Override
    public final int compareTo(@NotNull final CharCharTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    public String toString() {
        return "CharCharTuple{" +
                element1 + ", " +
                element2 + '}';
    }

    @Override
    public CharCharTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        return this;
    }
}
