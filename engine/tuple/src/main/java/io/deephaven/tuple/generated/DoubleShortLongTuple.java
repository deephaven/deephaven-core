...
/**
 * <p>3-Tuple (triple) key class composed of double, short, and long elements.
 * <p>Generated by io.deephaven.replicators.TupleCodeGenerator.
 */
public class DoubleShortLongTuple implements Comparable<DoubleShortLongTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<DoubleShortLongTuple> {
    ...
    @Override
    public final int compareTo(@NotNull final DoubleShortLongTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public DoubleShortLongTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        return this;
    }
}
