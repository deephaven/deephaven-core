...
/**
 * <p>3-Tuple (triple) key class composed of byte, float, and float elements.
 * <p>Generated by io.deephaven.replicators.TupleCodeGenerator.
 */
public class ByteFloatFloatTuple implements Comparable<ByteFloatFloatTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<ByteFloatFloatTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final ByteFloatFloatTuple typedOther = (ByteFloatFloatTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final ByteFloatFloatTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public ByteFloatFloatTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        return this;
    }
}
