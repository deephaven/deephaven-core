...
/**
 * <p>3-Tuple (triple) key class composed of char, int, and byte elements.
 * <p>Generated by io.deephaven.replicators.TupleCodeGenerator.
 */
public class CharIntByteTuple implements Comparable<CharIntByteTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<CharIntByteTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final CharIntByteTuple typedOther = (CharIntByteTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final CharIntByteTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public CharIntByteTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        return this;
    }
}
