...
/**
 * <p>3-Tuple (triple) key class composed of double, long, and Object elements.
 * <p>Generated by io.deephaven.replicators.TupleCodeGenerator.
 */
public class DoubleLongObjectTuple implements Comparable<DoubleLongObjectTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<DoubleLongObjectTuple> {
    ...
    @Override
    public final int compareTo(@NotNull final DoubleLongObjectTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public DoubleLongObjectTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        final Object canonicalizedElement3 = canonicalizer.apply(element3);
        return canonicalizedElement3 == element3
                ? this : new DoubleLongObjectTuple(element1, element2, canonicalizedElement3);
    }
}
