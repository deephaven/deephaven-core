...
/**
 * <p>3-Tuple (triple) key class composed of int, double, and Object elements.
 * <p>Generated by io.deephaven.replicators.TupleCodeGenerator.
 */
public class IntDoubleObjectTuple implements Comparable<IntDoubleObjectTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<IntDoubleObjectTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final IntDoubleObjectTuple typedOther = (IntDoubleObjectTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final IntDoubleObjectTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public IntDoubleObjectTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        final Object canonicalizedElement3 = canonicalizer.apply(element3);
        return canonicalizedElement3 == element3
                ? this : new IntDoubleObjectTuple(element1, element2, canonicalizedElement3);
    }
}
