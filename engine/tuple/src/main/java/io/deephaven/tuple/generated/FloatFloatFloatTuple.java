...
/**
 * <p>3-Tuple (triple) key class composed of float, float, and float elements.
 * <p>Generated by io.deephaven.replicators.TupleCodeGenerator.
 */
public class FloatFloatFloatTuple implements Comparable<FloatFloatFloatTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<FloatFloatFloatTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final FloatFloatFloatTuple typedOther = (FloatFloatFloatTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final FloatFloatFloatTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public FloatFloatFloatTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        return this;
    }
}
