...
/**
 * <p>3-Tuple (triple) key class composed of byte, short, and byte elements.
 * <p>Generated by io.deephaven.replicators.TupleCodeGenerator.
 */
public class ByteShortByteTuple implements Comparable<ByteShortByteTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<ByteShortByteTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final ByteShortByteTuple typedOther = (ByteShortByteTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final ByteShortByteTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public ByteShortByteTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        return this;
    }
}
