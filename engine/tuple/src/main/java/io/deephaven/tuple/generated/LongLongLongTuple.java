...
/**
 * <p>3-Tuple (triple) key class composed of long, long, and long elements.
 * <p>Generated by io.deephaven.replicators.TupleCodeGenerator.
 */
public class LongLongLongTuple implements Comparable<LongLongLongTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<LongLongLongTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final LongLongLongTuple typedOther = (LongLongLongTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final LongLongLongTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public LongLongLongTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        return this;
    }
}
