...
/**
 * <p>3-Tuple (triple) key class composed of double, byte, and Object elements.
 * <p>Generated by io.deephaven.replicators.TupleCodeGenerator.
 */
public class DoubleByteObjectTuple implements Comparable<DoubleByteObjectTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<DoubleByteObjectTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final DoubleByteObjectTuple typedOther = (DoubleByteObjectTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final DoubleByteObjectTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public DoubleByteObjectTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        final Object canonicalizedElement3 = canonicalizer.apply(element3);
        return canonicalizedElement3 == element3
                ? this : new DoubleByteObjectTuple(element1, element2, canonicalizedElement3);
    }
}
