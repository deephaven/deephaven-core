...
/**
 * <p>3-Tuple (triple) key class composed of Object, byte, and char elements.
 * <p>Generated by io.deephaven.replicators.TupleCodeGenerator.
 */
public class ObjectByteCharTuple implements Comparable<ObjectByteCharTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<ObjectByteCharTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final ObjectByteCharTuple typedOther = (ObjectByteCharTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final ObjectByteCharTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public ObjectByteCharTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        final Object canonicalizedElement1 = canonicalizer.apply(element1);
        return canonicalizedElement1 == element1
                ? this : new ObjectByteCharTuple(canonicalizedElement1, element2, element3);
    }
}
