...
/**
 * <p>3-Tuple (triple) key class composed of char, byte, and short elements.
 * <p>Generated by io.deephaven.replicators.TupleCodeGenerator.
 */
public class CharByteShortTuple implements Comparable<CharByteShortTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<CharByteShortTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final CharByteShortTuple typedOther = (CharByteShortTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final CharByteShortTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public CharByteShortTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        return this;
    }
}
