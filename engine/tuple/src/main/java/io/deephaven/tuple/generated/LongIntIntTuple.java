...
/**
 * <p>3-Tuple (triple) key class composed of long, int, and int elements.
 * <p>Generated by io.deephaven.replicators.TupleCodeGenerator.
 */
public class LongIntIntTuple implements Comparable<LongIntIntTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<LongIntIntTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final LongIntIntTuple typedOther = (LongIntIntTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final LongIntIntTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public LongIntIntTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        return this;
    }
}
