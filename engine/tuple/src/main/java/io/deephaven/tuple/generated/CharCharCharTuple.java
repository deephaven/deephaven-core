...
/**
 * <p>3-Tuple (triple) key class composed of char, char, and char elements.
 * <p>Generated by io.deephaven.replicators.TupleCodeGenerator.
 */
public class CharCharCharTuple implements Comparable<CharCharCharTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<CharCharCharTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final CharCharCharTuple typedOther = (CharCharCharTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final CharCharCharTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public CharCharCharTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        return this;
    }
}
