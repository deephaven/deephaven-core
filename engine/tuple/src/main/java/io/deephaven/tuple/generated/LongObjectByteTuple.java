...
/**
 * <p>3-Tuple (triple) key class composed of long, Object, and byte elements.
 * <p>Generated by io.deephaven.replicators.TupleCodeGenerator.
 */
public class LongObjectByteTuple implements Comparable<LongObjectByteTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<LongObjectByteTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final LongObjectByteTuple typedOther = (LongObjectByteTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final LongObjectByteTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public LongObjectByteTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        final Object canonicalizedElement2 = canonicalizer.apply(element2);
        return canonicalizedElement2 == element2
                ? this : new LongObjectByteTuple(element1, canonicalizedElement2, element3);
    }
}
