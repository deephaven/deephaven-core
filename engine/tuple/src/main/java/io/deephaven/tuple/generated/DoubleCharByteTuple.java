...
/**
 * <p>3-Tuple (triple) key class composed of double, char, and byte elements.
 * <p>Generated by io.deephaven.replicators.TupleCodeGenerator.
 */
public class DoubleCharByteTuple implements Comparable<DoubleCharByteTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<DoubleCharByteTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final DoubleCharByteTuple typedOther = (DoubleCharByteTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final DoubleCharByteTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public DoubleCharByteTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        return this;
    }
}
