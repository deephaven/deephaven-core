...
/**
 * <p>3-Tuple (triple) key class composed of int, Object, and char elements.
 * <p>Generated by io.deephaven.replicators.TupleCodeGenerator.
 */
public class IntObjectCharTuple implements Comparable<IntObjectCharTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<IntObjectCharTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final IntObjectCharTuple typedOther = (IntObjectCharTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final IntObjectCharTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public IntObjectCharTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        final Object canonicalizedElement2 = canonicalizer.apply(element2);
        return canonicalizedElement2 == element2
                ? this : new IntObjectCharTuple(element1, canonicalizedElement2, element3);
    }
}
