...
/**
 * <p>3-Tuple (triple) key class composed of byte, int, and double elements.
 * <p>Generated by io.deephaven.replicators.TupleCodeGenerator.
 */
public class ByteIntDoubleTuple implements Comparable<ByteIntDoubleTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<ByteIntDoubleTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final ByteIntDoubleTuple typedOther = (ByteIntDoubleTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final ByteIntDoubleTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public ByteIntDoubleTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        return this;
    }
}
