...
/**
 * <p>3-Tuple (triple) key class composed of short, byte, and float elements.
 * <p>Generated by io.deephaven.replicators.TupleCodeGenerator.
 */
public class ShortByteFloatTuple implements Comparable<ShortByteFloatTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<ShortByteFloatTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final ShortByteFloatTuple typedOther = (ShortByteFloatTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final ShortByteFloatTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public ShortByteFloatTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        return this;
    }
}
