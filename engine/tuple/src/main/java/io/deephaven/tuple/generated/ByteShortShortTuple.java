...
/**
 * <p>3-Tuple (triple) key class composed of byte, short, and short elements.
 * <p>Generated by io.deephaven.replicators.TupleCodeGenerator.
 */
public class ByteShortShortTuple implements Comparable<ByteShortShortTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<ByteShortShortTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final ByteShortShortTuple typedOther = (ByteShortShortTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final ByteShortShortTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public ByteShortShortTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        return this;
    }
}
