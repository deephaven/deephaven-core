...
/**
 * <p>3-Tuple (triple) key class composed of short, int, and float elements.
 * <p>Generated by io.deephaven.replicators.TupleCodeGenerator.
 */
public class ShortIntFloatTuple implements Comparable<ShortIntFloatTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<ShortIntFloatTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final ShortIntFloatTuple typedOther = (ShortIntFloatTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final ShortIntFloatTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public ShortIntFloatTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        return this;
    }
}
