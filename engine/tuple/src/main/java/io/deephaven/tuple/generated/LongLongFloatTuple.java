...
/**
 * <p>3-Tuple (triple) key class composed of long, long, and float elements.
 * <p>Generated by io.deephaven.replicators.TupleCodeGenerator.
 */
public class LongLongFloatTuple implements Comparable<LongLongFloatTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<LongLongFloatTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final LongLongFloatTuple typedOther = (LongLongFloatTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final LongLongFloatTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public LongLongFloatTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        return this;
    }
}
