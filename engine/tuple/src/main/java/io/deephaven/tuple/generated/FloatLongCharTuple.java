...
/**
 * <p>3-Tuple (triple) key class composed of float, long, and char elements.
 * <p>Generated by io.deephaven.replicators.TupleCodeGenerator.
 */
public class FloatLongCharTuple implements Comparable<FloatLongCharTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<FloatLongCharTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final FloatLongCharTuple typedOther = (FloatLongCharTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final FloatLongCharTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public FloatLongCharTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        return this;
    }
}
