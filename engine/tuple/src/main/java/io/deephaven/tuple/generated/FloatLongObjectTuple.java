...
/**
 * <p>3-Tuple (triple) key class composed of float, long, and Object elements.
 * <p>Generated by io.deephaven.replicators.TupleCodeGenerator.
 */
public class FloatLongObjectTuple implements Comparable<FloatLongObjectTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<FloatLongObjectTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final FloatLongObjectTuple typedOther = (FloatLongObjectTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final FloatLongObjectTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public FloatLongObjectTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        final Object canonicalizedElement3 = canonicalizer.apply(element3);
        return canonicalizedElement3 == element3
                ? this : new FloatLongObjectTuple(element1, element2, canonicalizedElement3);
    }
}
