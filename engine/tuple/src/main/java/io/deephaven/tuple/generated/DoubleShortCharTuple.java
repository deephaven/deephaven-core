...
/**
 * <p>3-Tuple (triple) key class composed of double, short, and char elements.
 * <p>Generated by io.deephaven.replicators.TupleCodeGenerator.
 */
public class DoubleShortCharTuple implements Comparable<DoubleShortCharTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<DoubleShortCharTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final DoubleShortCharTuple typedOther = (DoubleShortCharTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final DoubleShortCharTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public DoubleShortCharTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        return this;
    }
}
