...
/**
 * <p>3-Tuple (triple) key class composed of int, double, and double elements.
 * <p>Generated by io.deephaven.replicators.TupleCodeGenerator.
 */
public class IntDoubleDoubleTuple implements Comparable<IntDoubleDoubleTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<IntDoubleDoubleTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final IntDoubleDoubleTuple typedOther = (IntDoubleDoubleTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final IntDoubleDoubleTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public IntDoubleDoubleTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        return this;
    }
}
