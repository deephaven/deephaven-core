...
/**
 * <p>3-Tuple (triple) key class composed of char, byte, and float elements.
 * <p>Generated by io.deephaven.replicators.TupleCodeGenerator.
 */
public class CharByteFloatTuple implements Comparable<CharByteFloatTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<CharByteFloatTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final CharByteFloatTuple typedOther = (CharByteFloatTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final CharByteFloatTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public CharByteFloatTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        return this;
    }
}
