...
/**
 * <p>3-Tuple (triple) key class composed of float, long, and short elements.
 * <p>Generated by io.deephaven.replicators.TupleCodeGenerator.
 */
public class FloatLongShortTuple implements Comparable<FloatLongShortTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<FloatLongShortTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final FloatLongShortTuple typedOther = (FloatLongShortTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final FloatLongShortTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public FloatLongShortTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        return this;
    }
}
