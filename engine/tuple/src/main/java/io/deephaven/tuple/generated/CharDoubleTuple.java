...
/**
 * <p>2-Tuple (double) key class composed of char and double elements.
 * <p>Generated by io.deephaven.replicators.TupleCodeGenerator.
 */
public class CharDoubleTuple implements Comparable<CharDoubleTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<CharDoubleTuple> {
    ...
    @Override
    public final int compareTo(@NotNull final CharDoubleTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    public String toString() {
        return "CharDoubleTuple{" +
                element1 + ", " +
                element2 + '}';
    }

    @Override
    public CharDoubleTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        return this;
    }
}
