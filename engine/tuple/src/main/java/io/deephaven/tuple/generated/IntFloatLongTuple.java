...
/**
 * <p>3-Tuple (triple) key class composed of int, float, and long elements.
 * <p>Generated by io.deephaven.replicators.TupleCodeGenerator.
 */
public class IntFloatLongTuple implements Comparable<IntFloatLongTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<IntFloatLongTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final IntFloatLongTuple typedOther = (IntFloatLongTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final IntFloatLongTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public IntFloatLongTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        return this;
    }
}
