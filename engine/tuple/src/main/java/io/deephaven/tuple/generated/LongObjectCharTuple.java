...
/**
 * <p>3-Tuple (triple) key class composed of long, Object, and char elements.
 * <p>Generated by io.deephaven.replicators.TupleCodeGenerator.
 */
public class LongObjectCharTuple implements Comparable<LongObjectCharTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<LongObjectCharTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final LongObjectCharTuple typedOther = (LongObjectCharTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final LongObjectCharTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public LongObjectCharTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        final Object canonicalizedElement2 = canonicalizer.apply(element2);
        return canonicalizedElement2 == element2
                ? this : new LongObjectCharTuple(element1, canonicalizedElement2, element3);
    }
}
