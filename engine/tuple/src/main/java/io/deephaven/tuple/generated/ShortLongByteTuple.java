...
/**
 * <p>3-Tuple (triple) key class composed of short, long, and byte elements.
 * <p>Generated by io.deephaven.replicators.TupleCodeGenerator.
 */
public class ShortLongByteTuple implements Comparable<ShortLongByteTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<ShortLongByteTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final ShortLongByteTuple typedOther = (ShortLongByteTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final ShortLongByteTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public ShortLongByteTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        return this;
    }
}
