...
/**
 * <p>3-Tuple (triple) key class composed of byte, int, and int elements.
 * <p>Generated by io.deephaven.replicators.TupleCodeGenerator.
 */
public class ByteIntIntTuple implements Comparable<ByteIntIntTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<ByteIntIntTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final ByteIntIntTuple typedOther = (ByteIntIntTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final ByteIntIntTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public ByteIntIntTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        return this;
    }
}
