...
/**
 * <p>3-Tuple (triple) key class composed of Object, Object, and long elements.
 * <p>Generated by io.deephaven.replicators.TupleCodeGenerator.
 */
public class ObjectObjectLongTuple implements Comparable<ObjectObjectLongTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<ObjectObjectLongTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final ObjectObjectLongTuple typedOther = (ObjectObjectLongTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final ObjectObjectLongTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public ObjectObjectLongTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        ...
        return canonicalizedElement1 == element1 && canonicalizedElement2 == element2
                ? this : new ObjectObjectLongTuple(canonicalizedElement1, canonicalizedElement2, element3);
    }
}
