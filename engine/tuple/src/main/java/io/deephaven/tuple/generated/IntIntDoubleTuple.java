...
/**
 * <p>3-Tuple (triple) key class composed of int, int, and double elements.
 * <p>Generated by io.deephaven.replicators.TupleCodeGenerator.
 */
public class IntIntDoubleTuple implements Comparable<IntIntDoubleTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<IntIntDoubleTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final IntIntDoubleTuple typedOther = (IntIntDoubleTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final IntIntDoubleTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public IntIntDoubleTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        return this;
    }
}
