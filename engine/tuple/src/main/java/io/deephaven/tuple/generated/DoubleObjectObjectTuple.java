...
/**
 * <p>3-Tuple (triple) key class composed of double, Object, and Object elements.
 * <p>Generated by io.deephaven.replicators.TupleCodeGenerator.
 */
public class DoubleObjectObjectTuple implements Comparable<DoubleObjectObjectTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<DoubleObjectObjectTuple> {
    ...
    public DoubleObjectObjectTuple(
    ...
    public final boolean equals(final Object other) {
        ...
        final DoubleObjectObjectTuple typedOther = (DoubleObjectObjectTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final DoubleObjectObjectTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    public String toString() {
        return "DoubleObjectObjectTuple{" +
                element1 + ", " +
                element2 + ", " +
                element3 + '}';
    }
    ...
    @Override
    public DoubleObjectObjectTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        ...
        return canonicalizedElement2 == element2 && canonicalizedElement3 == element3
                ? this : new DoubleObjectObjectTuple(element1, canonicalizedElement2, canonicalizedElement3);
    }
}
