...
/**
 * <p>3-Tuple (triple) key class composed of long, char, and char elements.
 * <p>Generated by io.deephaven.replicators.TupleCodeGenerator.
 */
public class LongCharCharTuple implements Comparable<LongCharCharTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<LongCharCharTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final LongCharCharTuple typedOther = (LongCharCharTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final LongCharCharTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public LongCharCharTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        return this;
    }
}
