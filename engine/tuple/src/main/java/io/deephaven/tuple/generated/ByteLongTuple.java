...
/**
 * <p>2-Tuple (double) key class composed of byte and long elements.
 * <p>Generated by io.deephaven.replicators.TupleCodeGenerator.
 */
public class ByteLongTuple implements Comparable<ByteLongTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<ByteLongTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final ByteLongTuple typedOther = (ByteLongTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final ByteLongTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    public String toString() {
        return "ByteLongTuple{" +
                element1 + ", " +
                element2 + '}';
    }

    @Override
    public ByteLongTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        return this;
    }
}
