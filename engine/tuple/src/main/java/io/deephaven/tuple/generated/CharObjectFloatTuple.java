...
/**
 * <p>3-Tuple (triple) key class composed of char, Object, and float elements.
 * <p>Generated by io.deephaven.replicators.TupleCodeGenerator.
 */
public class CharObjectFloatTuple implements Comparable<CharObjectFloatTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<CharObjectFloatTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final CharObjectFloatTuple typedOther = (CharObjectFloatTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final CharObjectFloatTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public CharObjectFloatTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        final Object canonicalizedElement2 = canonicalizer.apply(element2);
        return canonicalizedElement2 == element2
                ? this : new CharObjectFloatTuple(element1, canonicalizedElement2, element3);
    }
}
