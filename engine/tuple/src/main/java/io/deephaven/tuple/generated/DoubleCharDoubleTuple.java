...
/**
 * <p>3-Tuple (triple) key class composed of double, char, and double elements.
 * <p>Generated by io.deephaven.replicators.TupleCodeGenerator.
 */
public class DoubleCharDoubleTuple implements Comparable<DoubleCharDoubleTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<DoubleCharDoubleTuple> {
    ...
    @Override
    public final int compareTo(@NotNull final DoubleCharDoubleTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public DoubleCharDoubleTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        return this;
    }
}
