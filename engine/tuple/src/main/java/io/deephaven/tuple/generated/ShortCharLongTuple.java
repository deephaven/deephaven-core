...
/**
 * <p>3-Tuple (triple) key class composed of short, char, and long elements.
 * <p>Generated by io.deephaven.replicators.TupleCodeGenerator.
 */
public class ShortCharLongTuple implements Comparable<ShortCharLongTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<ShortCharLongTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final ShortCharLongTuple typedOther = (ShortCharLongTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final ShortCharLongTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public ShortCharLongTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        return this;
    }
}
