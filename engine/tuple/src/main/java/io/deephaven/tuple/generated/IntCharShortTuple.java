...
/**
 * <p>3-Tuple (triple) key class composed of int, char, and short elements.
 * <p>Generated by io.deephaven.replicators.TupleCodeGenerator.
 */
public class IntCharShortTuple implements Comparable<IntCharShortTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<IntCharShortTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final IntCharShortTuple typedOther = (IntCharShortTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final IntCharShortTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public IntCharShortTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        return this;
    }
}
