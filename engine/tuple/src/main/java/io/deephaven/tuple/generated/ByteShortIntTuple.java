...
/**
 * <p>3-Tuple (triple) key class composed of byte, short, and int elements.
 * <p>Generated by io.deephaven.replicators.TupleCodeGenerator.
 */
public class ByteShortIntTuple implements Comparable<ByteShortIntTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<ByteShortIntTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final ByteShortIntTuple typedOther = (ByteShortIntTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final ByteShortIntTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public ByteShortIntTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        return this;
    }
}
