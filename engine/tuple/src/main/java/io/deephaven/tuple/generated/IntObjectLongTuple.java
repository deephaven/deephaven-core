...
/**
 * <p>3-Tuple (triple) key class composed of int, Object, and long elements.
 * <p>Generated by io.deephaven.replicators.TupleCodeGenerator.
 */
public class IntObjectLongTuple implements Comparable<IntObjectLongTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<IntObjectLongTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final IntObjectLongTuple typedOther = (IntObjectLongTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final IntObjectLongTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public IntObjectLongTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        final Object canonicalizedElement2 = canonicalizer.apply(element2);
        return canonicalizedElement2 == element2
                ? this : new IntObjectLongTuple(element1, canonicalizedElement2, element3);
    }
}
