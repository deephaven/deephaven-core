...
/**
 * <p>3-Tuple (triple) key class composed of float, Object, and byte elements.
 * <p>Generated by io.deephaven.replicators.TupleCodeGenerator.
 */
public class FloatObjectByteTuple implements Comparable<FloatObjectByteTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<FloatObjectByteTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final FloatObjectByteTuple typedOther = (FloatObjectByteTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final FloatObjectByteTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public FloatObjectByteTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        final Object canonicalizedElement2 = canonicalizer.apply(element2);
        return canonicalizedElement2 == element2
                ? this : new FloatObjectByteTuple(element1, canonicalizedElement2, element3);
    }
}
