...
/**
 * <p>3-Tuple (triple) key class composed of long, byte, and short elements.
 * <p>Generated by io.deephaven.replicators.TupleCodeGenerator.
 */
public class LongByteShortTuple implements Comparable<LongByteShortTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<LongByteShortTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final LongByteShortTuple typedOther = (LongByteShortTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final LongByteShortTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public LongByteShortTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        return this;
    }
}
