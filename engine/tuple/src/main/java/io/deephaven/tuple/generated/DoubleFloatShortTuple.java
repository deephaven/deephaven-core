...
/**
 * <p>3-Tuple (triple) key class composed of double, float, and short elements.
 * <p>Generated by io.deephaven.replicators.TupleCodeGenerator.
 */
public class DoubleFloatShortTuple implements Comparable<DoubleFloatShortTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<DoubleFloatShortTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final DoubleFloatShortTuple typedOther = (DoubleFloatShortTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final DoubleFloatShortTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public DoubleFloatShortTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        return this;
    }
}
