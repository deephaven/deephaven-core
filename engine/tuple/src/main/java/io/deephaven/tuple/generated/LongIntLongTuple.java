...
/**
 * <p>3-Tuple (triple) key class composed of long, int, and long elements.
 * <p>Generated by io.deephaven.replicators.TupleCodeGenerator.
 */
public class LongIntLongTuple implements Comparable<LongIntLongTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<LongIntLongTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final LongIntLongTuple typedOther = (LongIntLongTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final LongIntLongTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public LongIntLongTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        return this;
    }
}
