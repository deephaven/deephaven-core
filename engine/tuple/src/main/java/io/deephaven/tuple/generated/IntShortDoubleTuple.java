...
/**
 * <p>3-Tuple (triple) key class composed of int, short, and double elements.
 * <p>Generated by io.deephaven.replicators.TupleCodeGenerator.
 */
public class IntShortDoubleTuple implements Comparable<IntShortDoubleTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<IntShortDoubleTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final IntShortDoubleTuple typedOther = (IntShortDoubleTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final IntShortDoubleTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public IntShortDoubleTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        return this;
    }
}
