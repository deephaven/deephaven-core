...
/**
 * <p>3-Tuple (triple) key class composed of int, double, and byte elements.
 * <p>Generated by io.deephaven.replicators.TupleCodeGenerator.
 */
public class IntDoubleByteTuple implements Comparable<IntDoubleByteTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<IntDoubleByteTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final IntDoubleByteTuple typedOther = (IntDoubleByteTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final IntDoubleByteTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public IntDoubleByteTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        return this;
    }
}
