...
/**
 * <p>3-Tuple (triple) key class composed of Object, char, and long elements.
 * <p>Generated by io.deephaven.replicators.TupleCodeGenerator.
 */
public class ObjectCharLongTuple implements Comparable<ObjectCharLongTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<ObjectCharLongTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final ObjectCharLongTuple typedOther = (ObjectCharLongTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final ObjectCharLongTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public ObjectCharLongTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        final Object canonicalizedElement1 = canonicalizer.apply(element1);
        return canonicalizedElement1 == element1
                ? this : new ObjectCharLongTuple(canonicalizedElement1, element2, element3);
    }
}
