...
/**
 * <p>3-Tuple (triple) key class composed of char, long, and char elements.
 * <p>Generated by io.deephaven.replicators.TupleCodeGenerator.
 */
public class CharLongCharTuple implements Comparable<CharLongCharTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<CharLongCharTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final CharLongCharTuple typedOther = (CharLongCharTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final CharLongCharTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public CharLongCharTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        return this;
    }
}
