...
/**
 * <p>3-Tuple (triple) key class composed of double, float, and byte elements.
 * <p>Generated by io.deephaven.replicators.TupleCodeGenerator.
 */
public class DoubleFloatByteTuple implements Comparable<DoubleFloatByteTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<DoubleFloatByteTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final DoubleFloatByteTuple typedOther = (DoubleFloatByteTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final DoubleFloatByteTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public DoubleFloatByteTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        return this;
    }
}
