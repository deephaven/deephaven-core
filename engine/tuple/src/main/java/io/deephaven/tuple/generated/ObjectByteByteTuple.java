...
/**
 * <p>3-Tuple (triple) key class composed of Object, byte, and byte elements.
...
public class ObjectByteByteTuple implements Comparable<ObjectByteByteTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<ObjectByteByteTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final ObjectByteByteTuple typedOther = (ObjectByteByteTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final ObjectByteByteTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public ObjectByteByteTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        final Object canonicalizedElement1 = canonicalizer.apply(element1);
        return canonicalizedElement1 == element1
                ? this : new ObjectByteByteTuple(canonicalizedElement1, element2, element3);
    }
}
