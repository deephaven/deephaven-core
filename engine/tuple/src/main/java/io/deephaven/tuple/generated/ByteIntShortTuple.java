...
/**
 * <p>3-Tuple (triple) key class composed of byte, int, and short elements.
 * <p>Generated by io.deephaven.replicators.TupleCodeGenerator.
 */
public class ByteIntShortTuple implements Comparable<ByteIntShortTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<ByteIntShortTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final ByteIntShortTuple typedOther = (ByteIntShortTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final ByteIntShortTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public ByteIntShortTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        return this;
    }
}
