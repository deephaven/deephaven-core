...
/**
 * <p>3-Tuple (triple) key class composed of double, int, and Object elements.
 * <p>Generated by io.deephaven.replicators.TupleCodeGenerator.
 */
public class DoubleIntObjectTuple implements Comparable<DoubleIntObjectTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<DoubleIntObjectTuple> {
    ...
    @Override
    public final int compareTo(@NotNull final DoubleIntObjectTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public DoubleIntObjectTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        final Object canonicalizedElement3 = canonicalizer.apply(element3);
        return canonicalizedElement3 == element3
                ? this : new DoubleIntObjectTuple(element1, element2, canonicalizedElement3);
    }
}
