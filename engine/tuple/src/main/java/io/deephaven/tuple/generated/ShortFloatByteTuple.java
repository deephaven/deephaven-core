...
/**
 * <p>3-Tuple (triple) key class composed of short, float, and byte elements.
 * <p>Generated by io.deephaven.replicators.TupleCodeGenerator.
 */
public class ShortFloatByteTuple implements Comparable<ShortFloatByteTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<ShortFloatByteTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final ShortFloatByteTuple typedOther = (ShortFloatByteTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final ShortFloatByteTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public ShortFloatByteTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        return this;
    }
}
