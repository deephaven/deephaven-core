...
/**
 * <p>3-Tuple (triple) key class composed of char, byte, and int elements.
 * <p>Generated by io.deephaven.replicators.TupleCodeGenerator.
 */
public class CharByteIntTuple implements Comparable<CharByteIntTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<CharByteIntTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final CharByteIntTuple typedOther = (CharByteIntTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final CharByteIntTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public CharByteIntTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        return this;
    }
}
