...
/**
 * <p>3-Tuple (triple) key class composed of byte, short, and double elements.
 * <p>Generated by io.deephaven.replicators.TupleCodeGenerator.
 */
public class ByteShortDoubleTuple implements Comparable<ByteShortDoubleTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<ByteShortDoubleTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final ByteShortDoubleTuple typedOther = (ByteShortDoubleTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final ByteShortDoubleTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public ByteShortDoubleTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        return this;
    }
}
