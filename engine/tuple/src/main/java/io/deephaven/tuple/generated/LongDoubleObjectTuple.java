...
/**
 * <p>3-Tuple (triple) key class composed of long, double, and Object elements.
...
public class LongDoubleObjectTuple implements Comparable<LongDoubleObjectTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<LongDoubleObjectTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final LongDoubleObjectTuple typedOther = (LongDoubleObjectTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final LongDoubleObjectTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public LongDoubleObjectTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        final Object canonicalizedElement3 = canonicalizer.apply(element3);
        return canonicalizedElement3 == element3
                ? this : new LongDoubleObjectTuple(element1, element2, canonicalizedElement3);
    }
}
