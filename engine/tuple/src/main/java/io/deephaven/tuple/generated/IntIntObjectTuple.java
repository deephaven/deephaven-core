...
/**
 * <p>3-Tuple (triple) key class composed of int, int, and Object elements.
...
public class IntIntObjectTuple implements Comparable<IntIntObjectTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<IntIntObjectTuple> {
    ...
    @Override
    public final int compareTo(@NotNull final IntIntObjectTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public IntIntObjectTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        final Object canonicalizedElement3 = canonicalizer.apply(element3);
        return canonicalizedElement3 == element3
                ? this : new IntIntObjectTuple(element1, element2, canonicalizedElement3);
    }
}
