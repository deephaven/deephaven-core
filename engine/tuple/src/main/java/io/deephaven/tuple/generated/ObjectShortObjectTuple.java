...
/**
 * <p>3-Tuple (triple) key class composed of Object, short, and Object elements.
...
public class ObjectShortObjectTuple implements Comparable<ObjectShortObjectTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<ObjectShortObjectTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final ObjectShortObjectTuple typedOther = (ObjectShortObjectTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final ObjectShortObjectTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public ObjectShortObjectTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        ...
        return canonicalizedElement1 == element1 && canonicalizedElement3 == element3
                ? this : new ObjectShortObjectTuple(canonicalizedElement1, element2, canonicalizedElement3);
    }
}
