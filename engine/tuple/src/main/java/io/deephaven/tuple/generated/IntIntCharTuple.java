...
/**
 * <p>3-Tuple (triple) key class composed of int, int, and char elements.
 * <p>Generated by io.deephaven.replicators.TupleCodeGenerator.
 */
public class IntIntCharTuple implements Comparable<IntIntCharTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<IntIntCharTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final IntIntCharTuple typedOther = (IntIntCharTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final IntIntCharTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public IntIntCharTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        return this;
    }
}
