...
/**
 * <p>3-Tuple (triple) key class composed of double, int, and byte elements.
 * <p>Generated by io.deephaven.replicators.TupleCodeGenerator.
 */
public class DoubleIntByteTuple implements Comparable<DoubleIntByteTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<DoubleIntByteTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final DoubleIntByteTuple typedOther = (DoubleIntByteTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final DoubleIntByteTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public DoubleIntByteTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        return this;
    }
}
