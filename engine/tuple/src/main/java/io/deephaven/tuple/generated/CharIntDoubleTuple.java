...
/**
 * <p>3-Tuple (triple) key class composed of char, int, and double elements.
 * <p>Generated by io.deephaven.replicators.TupleCodeGenerator.
 */
public class CharIntDoubleTuple implements Comparable<CharIntDoubleTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<CharIntDoubleTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final CharIntDoubleTuple typedOther = (CharIntDoubleTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final CharIntDoubleTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public CharIntDoubleTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        return this;
    }
}
