...
/**
 * <p>3-Tuple (triple) key class composed of char, float, and short elements.
 * <p>Generated by io.deephaven.replicators.TupleCodeGenerator.
 */
public class CharFloatShortTuple implements Comparable<CharFloatShortTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<CharFloatShortTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final CharFloatShortTuple typedOther = (CharFloatShortTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final CharFloatShortTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public CharFloatShortTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        return this;
    }
}
