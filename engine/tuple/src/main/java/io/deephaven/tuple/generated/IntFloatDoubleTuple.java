...
/**
 * <p>3-Tuple (triple) key class composed of int, float, and double elements.
 * <p>Generated by io.deephaven.replicators.TupleCodeGenerator.
 */
public class IntFloatDoubleTuple implements Comparable<IntFloatDoubleTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<IntFloatDoubleTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final IntFloatDoubleTuple typedOther = (IntFloatDoubleTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final IntFloatDoubleTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public IntFloatDoubleTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        return this;
    }
}
