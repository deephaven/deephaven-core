...
/**
 * <p>3-Tuple (triple) key class composed of int, byte, and Object elements.
 * <p>Generated by io.deephaven.replicators.TupleCodeGenerator.
 */
public class IntByteObjectTuple implements Comparable<IntByteObjectTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<IntByteObjectTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final IntByteObjectTuple typedOther = (IntByteObjectTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final IntByteObjectTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public IntByteObjectTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        final Object canonicalizedElement3 = canonicalizer.apply(element3);
        return canonicalizedElement3 == element3
                ? this : new IntByteObjectTuple(element1, element2, canonicalizedElement3);
    }
}
