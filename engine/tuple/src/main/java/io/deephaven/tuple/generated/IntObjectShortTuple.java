...
/**
 * <p>3-Tuple (triple) key class composed of int, Object, and short elements.
 * <p>Generated by io.deephaven.replicators.TupleCodeGenerator.
 */
public class IntObjectShortTuple implements Comparable<IntObjectShortTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<IntObjectShortTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final IntObjectShortTuple typedOther = (IntObjectShortTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final IntObjectShortTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public IntObjectShortTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        final Object canonicalizedElement2 = canonicalizer.apply(element2);
        return canonicalizedElement2 == element2
                ? this : new IntObjectShortTuple(element1, canonicalizedElement2, element3);
    }
}
