...
/**
 * <p>3-Tuple (triple) key class composed of double, short, and int elements.
 * <p>Generated by io.deephaven.replicators.TupleCodeGenerator.
 */
public class DoubleShortIntTuple implements Comparable<DoubleShortIntTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<DoubleShortIntTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final DoubleShortIntTuple typedOther = (DoubleShortIntTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final DoubleShortIntTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public DoubleShortIntTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        return this;
    }
}
