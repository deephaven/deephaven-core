...
/**
 * <p>3-Tuple (triple) key class composed of short, char, and char elements.
 * <p>Generated by io.deephaven.replicators.TupleCodeGenerator.
 */
public class ShortCharCharTuple implements Comparable<ShortCharCharTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<ShortCharCharTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final ShortCharCharTuple typedOther = (ShortCharCharTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final ShortCharCharTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public ShortCharCharTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        return this;
    }
}
