...
/**
 * <p>2-Tuple (double) key class composed of short and int elements.
 * <p>Generated by io.deephaven.replicators.TupleCodeGenerator.
 */
public class ShortIntTuple implements Comparable<ShortIntTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<ShortIntTuple> {
    ...
    private void initialize(
        ...
        cachedHashCode = (31 +
                ...
                IntComparisons.hashCode(element2);
    }
    ...
    public final boolean equals(final Object other) {
        ...
        final ShortIntTuple typedOther = (ShortIntTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final ShortIntTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    public String toString() {
        return "ShortIntTuple{" +
                element1 + ", " +
                element2 + '}';
    }

    @Override
    public ShortIntTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        return this;
    }
}
