...
/**
 * <p>3-Tuple (triple) key class composed of long, char, and long elements.
 * <p>Generated by io.deephaven.replicators.TupleCodeGenerator.
 */
public class LongCharLongTuple implements Comparable<LongCharLongTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<LongCharLongTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final LongCharLongTuple typedOther = (LongCharLongTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final LongCharLongTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public LongCharLongTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        return this;
    }
}
