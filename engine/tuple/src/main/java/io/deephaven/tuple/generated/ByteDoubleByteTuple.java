...
/**
 * <p>3-Tuple (triple) key class composed of byte, double, and byte elements.
 * <p>Generated by io.deephaven.replicators.TupleCodeGenerator.
 */
public class ByteDoubleByteTuple implements Comparable<ByteDoubleByteTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<ByteDoubleByteTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final ByteDoubleByteTuple typedOther = (ByteDoubleByteTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final ByteDoubleByteTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public ByteDoubleByteTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        return this;
    }
}
