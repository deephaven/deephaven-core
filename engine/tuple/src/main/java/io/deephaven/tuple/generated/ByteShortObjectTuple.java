...
/**
 * <p>3-Tuple (triple) key class composed of byte, short, and Object elements.
 * <p>Generated by io.deephaven.replicators.TupleCodeGenerator.
 */
public class ByteShortObjectTuple implements Comparable<ByteShortObjectTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<ByteShortObjectTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final ByteShortObjectTuple typedOther = (ByteShortObjectTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final ByteShortObjectTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public ByteShortObjectTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        final Object canonicalizedElement3 = canonicalizer.apply(element3);
        return canonicalizedElement3 == element3
                ? this : new ByteShortObjectTuple(element1, element2, canonicalizedElement3);
    }
}
