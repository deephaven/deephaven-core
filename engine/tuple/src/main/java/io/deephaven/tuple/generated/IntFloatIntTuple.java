...
/**
 * <p>3-Tuple (triple) key class composed of int, float, and int elements.
 * <p>Generated by io.deephaven.replicators.TupleCodeGenerator.
 */
public class IntFloatIntTuple implements Comparable<IntFloatIntTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<IntFloatIntTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final IntFloatIntTuple typedOther = (IntFloatIntTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final IntFloatIntTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public IntFloatIntTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        return this;
    }
}
