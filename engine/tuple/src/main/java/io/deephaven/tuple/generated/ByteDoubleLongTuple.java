...
/**
 * <p>3-Tuple (triple) key class composed of byte, double, and long elements.
 * <p>Generated by io.deephaven.replicators.TupleCodeGenerator.
 */
public class ByteDoubleLongTuple implements Comparable<ByteDoubleLongTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<ByteDoubleLongTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final ByteDoubleLongTuple typedOther = (ByteDoubleLongTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final ByteDoubleLongTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public ByteDoubleLongTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        return this;
    }
}
