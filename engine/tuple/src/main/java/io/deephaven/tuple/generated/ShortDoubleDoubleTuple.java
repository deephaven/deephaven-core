...
/**
 * <p>3-Tuple (triple) key class composed of short, double, and double elements.
 * <p>Generated by io.deephaven.replicators.TupleCodeGenerator.
 */
public class ShortDoubleDoubleTuple implements Comparable<ShortDoubleDoubleTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<ShortDoubleDoubleTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final ShortDoubleDoubleTuple typedOther = (ShortDoubleDoubleTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final ShortDoubleDoubleTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public ShortDoubleDoubleTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        return this;
    }
}
