...
/**
 * <p>3-Tuple (triple) key class composed of Object, long, and Object elements.
 * <p>Generated by io.deephaven.replicators.TupleCodeGenerator.
 */
public class ObjectLongObjectTuple implements Comparable<ObjectLongObjectTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<ObjectLongObjectTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final ObjectLongObjectTuple typedOther = (ObjectLongObjectTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final ObjectLongObjectTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public ObjectLongObjectTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        ...
        return canonicalizedElement1 == element1 && canonicalizedElement3 == element3
                ? this : new ObjectLongObjectTuple(canonicalizedElement1, element2, canonicalizedElement3);
    }
}
