...
/**
 * <p>3-Tuple (triple) key class composed of long, float, and float elements.
 * <p>Generated by io.deephaven.replicators.TupleCodeGenerator.
 */
public class LongFloatFloatTuple implements Comparable<LongFloatFloatTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<LongFloatFloatTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final LongFloatFloatTuple typedOther = (LongFloatFloatTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final LongFloatFloatTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public LongFloatFloatTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        return this;
    }
}
