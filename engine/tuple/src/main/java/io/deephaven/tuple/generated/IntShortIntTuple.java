...
/**
 * <p>3-Tuple (triple) key class composed of int, short, and int elements.
 * <p>Generated by io.deephaven.replicators.TupleCodeGenerator.
 */
public class IntShortIntTuple implements Comparable<IntShortIntTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<IntShortIntTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final IntShortIntTuple typedOther = (IntShortIntTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final IntShortIntTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public IntShortIntTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        return this;
    }
}
