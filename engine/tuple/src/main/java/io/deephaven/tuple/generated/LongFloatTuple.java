...
/**
 * <p>2-Tuple (double) key class composed of long and float elements.
 * <p>Generated by io.deephaven.replicators.TupleCodeGenerator.
 */
public class LongFloatTuple implements Comparable<LongFloatTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<LongFloatTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final LongFloatTuple typedOther = (LongFloatTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final LongFloatTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    public String toString() {
        return "LongFloatTuple{" +
                element1 + ", " +
                element2 + '}';
    }

    @Override
    public LongFloatTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        return this;
    }
}
