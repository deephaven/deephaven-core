...
/**
 * <p>3-Tuple (triple) key class composed of double, Object, and byte elements.
 * <p>Generated by io.deephaven.replicators.TupleCodeGenerator.
 */
public class DoubleObjectByteTuple implements Comparable<DoubleObjectByteTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<DoubleObjectByteTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final DoubleObjectByteTuple typedOther = (DoubleObjectByteTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final DoubleObjectByteTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public DoubleObjectByteTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        final Object canonicalizedElement2 = canonicalizer.apply(element2);
        return canonicalizedElement2 == element2
                ? this : new DoubleObjectByteTuple(element1, canonicalizedElement2, element3);
    }
}
