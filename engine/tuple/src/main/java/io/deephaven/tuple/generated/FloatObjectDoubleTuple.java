...
/**
 * <p>3-Tuple (triple) key class composed of float, Object, and double elements.
 * <p>Generated by io.deephaven.replicators.TupleCodeGenerator.
 */
public class FloatObjectDoubleTuple implements Comparable<FloatObjectDoubleTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<FloatObjectDoubleTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final FloatObjectDoubleTuple typedOther = (FloatObjectDoubleTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final FloatObjectDoubleTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public FloatObjectDoubleTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        final Object canonicalizedElement2 = canonicalizer.apply(element2);
        return canonicalizedElement2 == element2
                ? this : new FloatObjectDoubleTuple(element1, canonicalizedElement2, element3);
    }
}
