...
/**
 * <p>3-Tuple (triple) key class composed of double, long, and double elements.
 * <p>Generated by io.deephaven.replicators.TupleCodeGenerator.
 */
public class DoubleLongDoubleTuple implements Comparable<DoubleLongDoubleTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<DoubleLongDoubleTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final DoubleLongDoubleTuple typedOther = (DoubleLongDoubleTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final DoubleLongDoubleTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public DoubleLongDoubleTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        return this;
    }
}
