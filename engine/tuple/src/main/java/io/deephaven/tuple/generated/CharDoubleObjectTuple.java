...
/**
 * <p>3-Tuple (triple) key class composed of char, double, and Object elements.
 * <p>Generated by io.deephaven.replicators.TupleCodeGenerator.
 */
public class CharDoubleObjectTuple implements Comparable<CharDoubleObjectTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<CharDoubleObjectTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final CharDoubleObjectTuple typedOther = (CharDoubleObjectTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final CharDoubleObjectTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public CharDoubleObjectTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        final Object canonicalizedElement3 = canonicalizer.apply(element3);
        return canonicalizedElement3 == element3
                ? this : new CharDoubleObjectTuple(element1, element2, canonicalizedElement3);
    }
}
