...
/**
 * <p>3-Tuple (triple) key class composed of long, double, and short elements.
 * <p>Generated by io.deephaven.replicators.TupleCodeGenerator.
 */
public class LongDoubleShortTuple implements Comparable<LongDoubleShortTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<LongDoubleShortTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final LongDoubleShortTuple typedOther = (LongDoubleShortTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final LongDoubleShortTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public LongDoubleShortTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        return this;
    }
}
