...
/**
 * <p>3-Tuple (triple) key class composed of int, long, and short elements.
 * <p>Generated by io.deephaven.replicators.TupleCodeGenerator.
 */
public class IntLongShortTuple implements Comparable<IntLongShortTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<IntLongShortTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final IntLongShortTuple typedOther = (IntLongShortTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final IntLongShortTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public IntLongShortTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        return this;
    }
}
