...
/**
 * <p>3-Tuple (triple) key class composed of double, float, and double elements.
 * <p>Generated by io.deephaven.replicators.TupleCodeGenerator.
 */
public class DoubleFloatDoubleTuple implements Comparable<DoubleFloatDoubleTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<DoubleFloatDoubleTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final DoubleFloatDoubleTuple typedOther = (DoubleFloatDoubleTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final DoubleFloatDoubleTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public DoubleFloatDoubleTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        return this;
    }
}
