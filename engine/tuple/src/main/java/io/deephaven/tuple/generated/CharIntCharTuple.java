...
/**
 * <p>3-Tuple (triple) key class composed of char, int, and char elements.
 * <p>Generated by io.deephaven.replicators.TupleCodeGenerator.
 */
public class CharIntCharTuple implements Comparable<CharIntCharTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<CharIntCharTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final CharIntCharTuple typedOther = (CharIntCharTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final CharIntCharTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public CharIntCharTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        return this;
    }
}
