...
/**
 * <p>3-Tuple (triple) key class composed of float, double, and Object elements.
 * <p>Generated by io.deephaven.replicators.TupleCodeGenerator.
 */
public class FloatDoubleObjectTuple implements Comparable<FloatDoubleObjectTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<FloatDoubleObjectTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final FloatDoubleObjectTuple typedOther = (FloatDoubleObjectTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final FloatDoubleObjectTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public FloatDoubleObjectTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        final Object canonicalizedElement3 = canonicalizer.apply(element3);
        return canonicalizedElement3 == element3
                ? this : new FloatDoubleObjectTuple(element1, element2, canonicalizedElement3);
    }
}
