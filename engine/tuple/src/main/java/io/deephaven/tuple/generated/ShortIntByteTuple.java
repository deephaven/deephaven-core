...
/**
 * <p>3-Tuple (triple) key class composed of short, int, and byte elements.
 * <p>Generated by io.deephaven.replicators.TupleCodeGenerator.
 */
public class ShortIntByteTuple implements Comparable<ShortIntByteTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<ShortIntByteTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final ShortIntByteTuple typedOther = (ShortIntByteTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final ShortIntByteTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public ShortIntByteTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        return this;
    }
}
