...
/**
 * <p>3-Tuple (triple) key class composed of int, float, and char elements.
 * <p>Generated by io.deephaven.replicators.TupleCodeGenerator.
 */
public class IntFloatCharTuple implements Comparable<IntFloatCharTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<IntFloatCharTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final IntFloatCharTuple typedOther = (IntFloatCharTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final IntFloatCharTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public IntFloatCharTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        return this;
    }
}
