...
/**
 * <p>3-Tuple (triple) key class composed of double, Object, and short elements.
 * <p>Generated by io.deephaven.replicators.TupleCodeGenerator.
 */
public class DoubleObjectShortTuple implements Comparable<DoubleObjectShortTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<DoubleObjectShortTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final DoubleObjectShortTuple typedOther = (DoubleObjectShortTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final DoubleObjectShortTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public DoubleObjectShortTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        final Object canonicalizedElement2 = canonicalizer.apply(element2);
        return canonicalizedElement2 == element2
                ? this : new DoubleObjectShortTuple(element1, canonicalizedElement2, element3);
    }
}
