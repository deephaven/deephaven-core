...
/**
 * <p>3-Tuple (triple) key class composed of char, char, and double elements.
 * <p>Generated by io.deephaven.replicators.TupleCodeGenerator.
 */
public class CharCharDoubleTuple implements Comparable<CharCharDoubleTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<CharCharDoubleTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final CharCharDoubleTuple typedOther = (CharCharDoubleTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final CharCharDoubleTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public CharCharDoubleTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        return this;
    }
}
