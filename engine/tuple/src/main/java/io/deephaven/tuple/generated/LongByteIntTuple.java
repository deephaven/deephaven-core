...
/**
 * <p>3-Tuple (triple) key class composed of long, byte, and int elements.
 * <p>Generated by io.deephaven.replicators.TupleCodeGenerator.
 */
public class LongByteIntTuple implements Comparable<LongByteIntTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<LongByteIntTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final LongByteIntTuple typedOther = (LongByteIntTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final LongByteIntTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public LongByteIntTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        return this;
    }
}
