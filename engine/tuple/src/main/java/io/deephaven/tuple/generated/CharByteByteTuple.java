...
/**
 * <p>3-Tuple (triple) key class composed of char, byte, and byte elements.
 * <p>Generated by io.deephaven.replicators.TupleCodeGenerator.
 */
public class CharByteByteTuple implements Comparable<CharByteByteTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<CharByteByteTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final CharByteByteTuple typedOther = (CharByteByteTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final CharByteByteTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public CharByteByteTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        return this;
    }
}
