...
/**
 * <p>3-Tuple (triple) key class composed of long, float, and Object elements.
 * <p>Generated by io.deephaven.replicators.TupleCodeGenerator.
 */
public class LongFloatObjectTuple implements Comparable<LongFloatObjectTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<LongFloatObjectTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final LongFloatObjectTuple typedOther = (LongFloatObjectTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final LongFloatObjectTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public LongFloatObjectTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        final Object canonicalizedElement3 = canonicalizer.apply(element3);
        return canonicalizedElement3 == element3
                ? this : new LongFloatObjectTuple(element1, element2, canonicalizedElement3);
    }
}
