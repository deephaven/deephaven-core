...
/**
 * <p>2-Tuple (double) key class composed of byte and float elements.
 * <p>Generated by io.deephaven.replicators.TupleCodeGenerator.
 */
public class ByteFloatTuple implements Comparable<ByteFloatTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<ByteFloatTuple> {
    ...
    @Override
    public final int compareTo(@NotNull final ByteFloatTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    public String toString() {
        return "ByteFloatTuple{" +
                element1 + ", " +
                element2 + '}';
    }

    @Override
    public ByteFloatTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        return this;
    }
}
