...
/**
 * <p>3-Tuple (triple) key class composed of short, Object, and Object elements.
 * <p>Generated by io.deephaven.replicators.TupleCodeGenerator.
 */
public class ShortObjectObjectTuple implements Comparable<ShortObjectObjectTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<ShortObjectObjectTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final ShortObjectObjectTuple typedOther = (ShortObjectObjectTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final ShortObjectObjectTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public ShortObjectObjectTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        ...
        return canonicalizedElement2 == element2 && canonicalizedElement3 == element3
                ? this : new ShortObjectObjectTuple(element1, canonicalizedElement2, canonicalizedElement3);
    }
}
