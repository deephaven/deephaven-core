...
/**
 * <p>3-Tuple (triple) key class composed of long, char, and short elements.
 * <p>Generated by io.deephaven.replicators.TupleCodeGenerator.
 */
public class LongCharShortTuple implements Comparable<LongCharShortTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<LongCharShortTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final LongCharShortTuple typedOther = (LongCharShortTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final LongCharShortTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public LongCharShortTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        return this;
    }
}
