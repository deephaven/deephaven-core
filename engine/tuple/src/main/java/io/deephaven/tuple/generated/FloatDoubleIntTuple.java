...
/**
 * <p>3-Tuple (triple) key class composed of float, double, and int elements.
...
public class FloatDoubleIntTuple implements Comparable<FloatDoubleIntTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<FloatDoubleIntTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final FloatDoubleIntTuple typedOther = (FloatDoubleIntTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final FloatDoubleIntTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public FloatDoubleIntTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        return this;
    }
}
