...
/**
 * <p>3-Tuple (triple) key class composed of Object, byte, and float elements.
 * <p>Generated by io.deephaven.replicators.TupleCodeGenerator.
 */
public class ObjectByteFloatTuple implements Comparable<ObjectByteFloatTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<ObjectByteFloatTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final ObjectByteFloatTuple typedOther = (ObjectByteFloatTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final ObjectByteFloatTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public ObjectByteFloatTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        final Object canonicalizedElement1 = canonicalizer.apply(element1);
        return canonicalizedElement1 == element1
                ? this : new ObjectByteFloatTuple(canonicalizedElement1, element2, element3);
    }
}
