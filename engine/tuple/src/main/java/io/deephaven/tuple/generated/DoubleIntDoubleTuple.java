...
/**
 * <p>3-Tuple (triple) key class composed of double, int, and double elements.
 * <p>Generated by io.deephaven.replicators.TupleCodeGenerator.
 */
public class DoubleIntDoubleTuple implements Comparable<DoubleIntDoubleTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<DoubleIntDoubleTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final DoubleIntDoubleTuple typedOther = (DoubleIntDoubleTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final DoubleIntDoubleTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public DoubleIntDoubleTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        return this;
    }
}
