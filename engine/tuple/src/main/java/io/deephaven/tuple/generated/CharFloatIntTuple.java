...
/**
 * <p>3-Tuple (triple) key class composed of char, float, and int elements.
 * <p>Generated by io.deephaven.replicators.TupleCodeGenerator.
 */
public class CharFloatIntTuple implements Comparable<CharFloatIntTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<CharFloatIntTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final CharFloatIntTuple typedOther = (CharFloatIntTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final CharFloatIntTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public CharFloatIntTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        return this;
    }
}
