...
/**
 * <p>3-Tuple (triple) key class composed of double, short, and float elements.
 * <p>Generated by io.deephaven.replicators.TupleCodeGenerator.
 */
public class DoubleShortFloatTuple implements Comparable<DoubleShortFloatTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<DoubleShortFloatTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final DoubleShortFloatTuple typedOther = (DoubleShortFloatTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final DoubleShortFloatTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public DoubleShortFloatTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        return this;
    }
}
