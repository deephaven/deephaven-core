...
/**
 * <p>3-Tuple (triple) key class composed of short, int, and double elements.
 * <p>Generated by io.deephaven.replicators.TupleCodeGenerator.
 */
public class ShortIntDoubleTuple implements Comparable<ShortIntDoubleTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<ShortIntDoubleTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final ShortIntDoubleTuple typedOther = (ShortIntDoubleTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final ShortIntDoubleTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public ShortIntDoubleTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        return this;
    }
}
