...
/**
 * <p>3-Tuple (triple) key class composed of int, double, and long elements.
 * <p>Generated by io.deephaven.replicators.TupleCodeGenerator.
 */
public class IntDoubleLongTuple implements Comparable<IntDoubleLongTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<IntDoubleLongTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final IntDoubleLongTuple typedOther = (IntDoubleLongTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final IntDoubleLongTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public IntDoubleLongTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        return this;
    }
}
