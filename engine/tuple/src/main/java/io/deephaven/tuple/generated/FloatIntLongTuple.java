...
/**
 * <p>3-Tuple (triple) key class composed of float, int, and long elements.
 * <p>Generated by io.deephaven.replicators.TupleCodeGenerator.
 */
public class FloatIntLongTuple implements Comparable<FloatIntLongTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<FloatIntLongTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final FloatIntLongTuple typedOther = (FloatIntLongTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final FloatIntLongTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public FloatIntLongTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        return this;
    }
}
