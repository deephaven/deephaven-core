...
/**
 * <p>3-Tuple (triple) key class composed of float, short, and Object elements.
 * <p>Generated by io.deephaven.replicators.TupleCodeGenerator.
 */
public class FloatShortObjectTuple implements Comparable<FloatShortObjectTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<FloatShortObjectTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final FloatShortObjectTuple typedOther = (FloatShortObjectTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final FloatShortObjectTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public FloatShortObjectTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        final Object canonicalizedElement3 = canonicalizer.apply(element3);
        return canonicalizedElement3 == element3
                ? this : new FloatShortObjectTuple(element1, element2, canonicalizedElement3);
    }
}
