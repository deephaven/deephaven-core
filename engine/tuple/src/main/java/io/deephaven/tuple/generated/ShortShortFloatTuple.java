...
/**
 * <p>3-Tuple (triple) key class composed of short, short, and float elements.
 * <p>Generated by io.deephaven.replicators.TupleCodeGenerator.
 */
public class ShortShortFloatTuple implements Comparable<ShortShortFloatTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<ShortShortFloatTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final ShortShortFloatTuple typedOther = (ShortShortFloatTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final ShortShortFloatTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public ShortShortFloatTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        return this;
    }
}
