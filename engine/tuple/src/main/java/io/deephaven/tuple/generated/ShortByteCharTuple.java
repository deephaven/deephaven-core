...
/**
 * <p>3-Tuple (triple) key class composed of short, byte, and char elements.
 * <p>Generated by io.deephaven.replicators.TupleCodeGenerator.
 */
public class ShortByteCharTuple implements Comparable<ShortByteCharTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<ShortByteCharTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final ShortByteCharTuple typedOther = (ShortByteCharTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final ShortByteCharTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public ShortByteCharTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        return this;
    }
}
