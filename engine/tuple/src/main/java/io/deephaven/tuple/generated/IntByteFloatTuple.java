...
/**
 * <p>3-Tuple (triple) key class composed of int, byte, and float elements.
...
public class IntByteFloatTuple implements Comparable<IntByteFloatTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<IntByteFloatTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final IntByteFloatTuple typedOther = (IntByteFloatTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final IntByteFloatTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public IntByteFloatTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        return this;
    }
}
