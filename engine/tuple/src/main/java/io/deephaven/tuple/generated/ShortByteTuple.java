...
/**
 * <p>2-Tuple (double) key class composed of short and byte elements.
 * <p>Generated by io.deephaven.replicators.TupleCodeGenerator.
 */
public class ShortByteTuple implements Comparable<ShortByteTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<ShortByteTuple> {
    ...
    private void initialize(
        ...
        cachedHashCode = (31 +
                ...
                ByteComparisons.hashCode(element2);
    }
    ...
    public final boolean equals(final Object other) {
        ...
        final ShortByteTuple typedOther = (ShortByteTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final ShortByteTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    public String toString() {
        return "ShortByteTuple{" +
                element1 + ", " +
                element2 + '}';
    }

    @Override
    public ShortByteTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        return this;
    }
}
