...
/**
 * <p>3-Tuple (triple) key class composed of byte, Object, and int elements.
 * <p>Generated by io.deephaven.replicators.TupleCodeGenerator.
 */
public class ByteObjectIntTuple implements Comparable<ByteObjectIntTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<ByteObjectIntTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final ByteObjectIntTuple typedOther = (ByteObjectIntTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final ByteObjectIntTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public ByteObjectIntTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        final Object canonicalizedElement2 = canonicalizer.apply(element2);
        return canonicalizedElement2 == element2
                ? this : new ByteObjectIntTuple(element1, canonicalizedElement2, element3);
    }
}
