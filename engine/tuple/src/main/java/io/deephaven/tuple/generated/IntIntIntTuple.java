...
/**
 * <p>3-Tuple (triple) key class composed of int, int, and int elements.
 * <p>Generated by io.deephaven.replicators.TupleCodeGenerator.
 */
public class IntIntIntTuple implements Comparable<IntIntIntTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<IntIntIntTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final IntIntIntTuple typedOther = (IntIntIntTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final IntIntIntTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public IntIntIntTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        return this;
    }
}
