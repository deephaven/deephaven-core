...
/**
 * <p>3-Tuple (triple) key class composed of Object, short, and float elements.
 * <p>Generated by io.deephaven.replicators.TupleCodeGenerator.
 */
public class ObjectShortFloatTuple implements Comparable<ObjectShortFloatTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<ObjectShortFloatTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final ObjectShortFloatTuple typedOther = (ObjectShortFloatTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final ObjectShortFloatTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public ObjectShortFloatTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        final Object canonicalizedElement1 = canonicalizer.apply(element1);
        return canonicalizedElement1 == element1
                ? this : new ObjectShortFloatTuple(canonicalizedElement1, element2, element3);
    }
}
