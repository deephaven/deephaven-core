...
/**
 * <p>3-Tuple (triple) key class composed of byte, byte, and int elements.
 * <p>Generated by io.deephaven.replicators.TupleCodeGenerator.
 */
public class ByteByteIntTuple implements Comparable<ByteByteIntTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<ByteByteIntTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final ByteByteIntTuple typedOther = (ByteByteIntTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final ByteByteIntTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public ByteByteIntTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        return this;
    }
}
