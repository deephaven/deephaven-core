...
/**
 * <p>3-Tuple (triple) key class composed of short, char, and byte elements.
 * <p>Generated by io.deephaven.replicators.TupleCodeGenerator.
 */
public class ShortCharByteTuple implements Comparable<ShortCharByteTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<ShortCharByteTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final ShortCharByteTuple typedOther = (ShortCharByteTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final ShortCharByteTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public ShortCharByteTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        return this;
    }
}
