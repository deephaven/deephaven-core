...
/**
 * <p>3-Tuple (triple) key class composed of short, long, and int elements.
 * <p>Generated by io.deephaven.replicators.TupleCodeGenerator.
 */
public class ShortLongIntTuple implements Comparable<ShortLongIntTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<ShortLongIntTuple> {
    ...
    @Override
    public final int compareTo(@NotNull final ShortLongIntTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public ShortLongIntTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        return this;
    }
}
