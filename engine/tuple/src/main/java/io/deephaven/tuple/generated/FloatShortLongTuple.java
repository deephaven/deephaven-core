...
/**
 * <p>3-Tuple (triple) key class composed of float, short, and long elements.
 * <p>Generated by io.deephaven.replicators.TupleCodeGenerator.
 */
public class FloatShortLongTuple implements Comparable<FloatShortLongTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<FloatShortLongTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final FloatShortLongTuple typedOther = (FloatShortLongTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final FloatShortLongTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public FloatShortLongTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        return this;
    }
}
