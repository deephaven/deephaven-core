...
/**
 * <p>3-Tuple (triple) key class composed of short, long, and float elements.
 * <p>Generated by io.deephaven.replicators.TupleCodeGenerator.
 */
public class ShortLongFloatTuple implements Comparable<ShortLongFloatTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<ShortLongFloatTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final ShortLongFloatTuple typedOther = (ShortLongFloatTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final ShortLongFloatTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public ShortLongFloatTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        return this;
    }
}
