...
/**
 * <p>3-Tuple (triple) key class composed of byte, char, and int elements.
 * <p>Generated by io.deephaven.replicators.TupleCodeGenerator.
 */
public class ByteCharIntTuple implements Comparable<ByteCharIntTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<ByteCharIntTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final ByteCharIntTuple typedOther = (ByteCharIntTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final ByteCharIntTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public ByteCharIntTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        return this;
    }
}
