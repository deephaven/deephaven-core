...
/**
 * <p>3-Tuple (triple) key class composed of char, byte, and long elements.
 * <p>Generated by io.deephaven.replicators.TupleCodeGenerator.
 */
public class CharByteLongTuple implements Comparable<CharByteLongTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<CharByteLongTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final CharByteLongTuple typedOther = (CharByteLongTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final CharByteLongTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public CharByteLongTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        return this;
    }
}
