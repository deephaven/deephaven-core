...
/**
 * <p>3-Tuple (triple) key class composed of int, char, and Object elements.
 * <p>Generated by io.deephaven.replicators.TupleCodeGenerator.
 */
public class IntCharObjectTuple implements Comparable<IntCharObjectTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<IntCharObjectTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final IntCharObjectTuple typedOther = (IntCharObjectTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final IntCharObjectTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public IntCharObjectTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        final Object canonicalizedElement3 = canonicalizer.apply(element3);
        return canonicalizedElement3 == element3
                ? this : new IntCharObjectTuple(element1, element2, canonicalizedElement3);
    }
}
