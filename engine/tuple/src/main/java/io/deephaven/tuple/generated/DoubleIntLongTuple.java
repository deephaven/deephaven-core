...
/**
 * <p>3-Tuple (triple) key class composed of double, int, and long elements.
 * <p>Generated by io.deephaven.replicators.TupleCodeGenerator.
 */
public class DoubleIntLongTuple implements Comparable<DoubleIntLongTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<DoubleIntLongTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final DoubleIntLongTuple typedOther = (DoubleIntLongTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final DoubleIntLongTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public DoubleIntLongTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        return this;
    }
}
