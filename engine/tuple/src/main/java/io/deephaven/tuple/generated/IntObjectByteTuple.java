...
/**
 * <p>3-Tuple (triple) key class composed of int, Object, and byte elements.
 * <p>Generated by io.deephaven.replicators.TupleCodeGenerator.
 */
public class IntObjectByteTuple implements Comparable<IntObjectByteTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<IntObjectByteTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final IntObjectByteTuple typedOther = (IntObjectByteTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final IntObjectByteTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public IntObjectByteTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        final Object canonicalizedElement2 = canonicalizer.apply(element2);
        return canonicalizedElement2 == element2
                ? this : new IntObjectByteTuple(element1, canonicalizedElement2, element3);
    }
}
