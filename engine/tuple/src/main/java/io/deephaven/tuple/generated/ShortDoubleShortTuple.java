...
/**
 * <p>3-Tuple (triple) key class composed of short, double, and short elements.
 * <p>Generated by io.deephaven.replicators.TupleCodeGenerator.
 */
public class ShortDoubleShortTuple implements Comparable<ShortDoubleShortTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<ShortDoubleShortTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final ShortDoubleShortTuple typedOther = (ShortDoubleShortTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final ShortDoubleShortTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public ShortDoubleShortTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        return this;
    }
}
