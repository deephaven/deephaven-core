...
/**
 * <p>3-Tuple (triple) key class composed of short, Object, and int elements.
 * <p>Generated by io.deephaven.replicators.TupleCodeGenerator.
 */
public class ShortObjectIntTuple implements Comparable<ShortObjectIntTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<ShortObjectIntTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final ShortObjectIntTuple typedOther = (ShortObjectIntTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final ShortObjectIntTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public ShortObjectIntTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        final Object canonicalizedElement2 = canonicalizer.apply(element2);
        return canonicalizedElement2 == element2
                ? this : new ShortObjectIntTuple(element1, canonicalizedElement2, element3);
    }
}
