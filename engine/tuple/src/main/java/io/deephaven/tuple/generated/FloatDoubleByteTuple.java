...
/**
 * <p>3-Tuple (triple) key class composed of float, double, and byte elements.
 * <p>Generated by io.deephaven.replicators.TupleCodeGenerator.
 */
public class FloatDoubleByteTuple implements Comparable<FloatDoubleByteTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<FloatDoubleByteTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final FloatDoubleByteTuple typedOther = (FloatDoubleByteTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final FloatDoubleByteTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public FloatDoubleByteTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        return this;
    }
}
