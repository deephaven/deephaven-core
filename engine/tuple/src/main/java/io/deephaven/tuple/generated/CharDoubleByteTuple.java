...
/**
 * <p>3-Tuple (triple) key class composed of char, double, and byte elements.
 * <p>Generated by io.deephaven.replicators.TupleCodeGenerator.
 */
public class CharDoubleByteTuple implements Comparable<CharDoubleByteTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<CharDoubleByteTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final CharDoubleByteTuple typedOther = (CharDoubleByteTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final CharDoubleByteTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public CharDoubleByteTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        return this;
    }
}
