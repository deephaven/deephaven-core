...
/**
 * <p>3-Tuple (triple) key class composed of byte, float, and char elements.
 * <p>Generated by io.deephaven.replicators.TupleCodeGenerator.
 */
public class ByteFloatCharTuple implements Comparable<ByteFloatCharTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<ByteFloatCharTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final ByteFloatCharTuple typedOther = (ByteFloatCharTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final ByteFloatCharTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public ByteFloatCharTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        return this;
    }
}
