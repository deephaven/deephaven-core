...
/**
 * <p>2-Tuple (double) key class composed of long and double elements.
 * <p>Generated by io.deephaven.replicators.TupleCodeGenerator.
 */
public class LongDoubleTuple implements Comparable<LongDoubleTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<LongDoubleTuple> {
    ...
    @Override
    public final int compareTo(@NotNull final LongDoubleTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    public String toString() {
        return "LongDoubleTuple{" +
                element1 + ", " +
                element2 + '}';
    }

    @Override
    public LongDoubleTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        return this;
    }
}
