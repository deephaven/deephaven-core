...
/**
 * <p>3-Tuple (triple) key class composed of short, short, and char elements.
 * <p>Generated by io.deephaven.replicators.TupleCodeGenerator.
 */
public class ShortShortCharTuple implements Comparable<ShortShortCharTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<ShortShortCharTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final ShortShortCharTuple typedOther = (ShortShortCharTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final ShortShortCharTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public ShortShortCharTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        return this;
    }
}
