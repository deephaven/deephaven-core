...
/**
 * <p>3-Tuple (triple) key class composed of float, int, and double elements.
 * <p>Generated by io.deephaven.replicators.TupleCodeGenerator.
 */
public class FloatIntDoubleTuple implements Comparable<FloatIntDoubleTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<FloatIntDoubleTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final FloatIntDoubleTuple typedOther = (FloatIntDoubleTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final FloatIntDoubleTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public FloatIntDoubleTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        return this;
    }
}
