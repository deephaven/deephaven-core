...
/**
 * <p>3-Tuple (triple) key class composed of double, long, and byte elements.
 * <p>Generated by io.deephaven.replicators.TupleCodeGenerator.
 */
public class DoubleLongByteTuple implements Comparable<DoubleLongByteTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<DoubleLongByteTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final DoubleLongByteTuple typedOther = (DoubleLongByteTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final DoubleLongByteTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public DoubleLongByteTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        return this;
    }
}
