...
/**
 * <p>3-Tuple (triple) key class composed of byte, char, and byte elements.
 * <p>Generated by io.deephaven.replicators.TupleCodeGenerator.
 */
public class ByteCharByteTuple implements Comparable<ByteCharByteTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<ByteCharByteTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final ByteCharByteTuple typedOther = (ByteCharByteTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final ByteCharByteTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public ByteCharByteTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        return this;
    }
}
