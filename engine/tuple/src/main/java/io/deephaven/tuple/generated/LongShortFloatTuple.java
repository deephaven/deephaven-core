...
/**
 * <p>3-Tuple (triple) key class composed of long, short, and float elements.
 * <p>Generated by io.deephaven.replicators.TupleCodeGenerator.
 */
public class LongShortFloatTuple implements Comparable<LongShortFloatTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<LongShortFloatTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final LongShortFloatTuple typedOther = (LongShortFloatTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final LongShortFloatTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public LongShortFloatTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        return this;
    }
}
