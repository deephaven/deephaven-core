...
/**
 * <p>3-Tuple (triple) key class composed of short, long, and long elements.
 * <p>Generated by io.deephaven.replicators.TupleCodeGenerator.
 */
public class ShortLongLongTuple implements Comparable<ShortLongLongTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<ShortLongLongTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final ShortLongLongTuple typedOther = (ShortLongLongTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final ShortLongLongTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public ShortLongLongTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        return this;
    }
}
