...
/**
 * <p>3-Tuple (triple) key class composed of float, double, and short elements.
 * <p>Generated by io.deephaven.replicators.TupleCodeGenerator.
 */
public class FloatDoubleShortTuple implements Comparable<FloatDoubleShortTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<FloatDoubleShortTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final FloatDoubleShortTuple typedOther = (FloatDoubleShortTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final FloatDoubleShortTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public FloatDoubleShortTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        return this;
    }
}
