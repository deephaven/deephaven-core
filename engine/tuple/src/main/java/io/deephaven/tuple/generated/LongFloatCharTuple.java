...
/**
 * <p>3-Tuple (triple) key class composed of long, float, and char elements.
 * <p>Generated by io.deephaven.replicators.TupleCodeGenerator.
 */
public class LongFloatCharTuple implements Comparable<LongFloatCharTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<LongFloatCharTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final LongFloatCharTuple typedOther = (LongFloatCharTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final LongFloatCharTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public LongFloatCharTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        return this;
    }
}
