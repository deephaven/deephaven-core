...
/**
 * <p>3-Tuple (triple) key class composed of float, Object, and short elements.
 * <p>Generated by io.deephaven.replicators.TupleCodeGenerator.
 */
public class FloatObjectShortTuple implements Comparable<FloatObjectShortTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<FloatObjectShortTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final FloatObjectShortTuple typedOther = (FloatObjectShortTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final FloatObjectShortTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public FloatObjectShortTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        final Object canonicalizedElement2 = canonicalizer.apply(element2);
        return canonicalizedElement2 == element2
                ? this : new FloatObjectShortTuple(element1, canonicalizedElement2, element3);
    }
}
