...
/**
 * <p>3-Tuple (triple) key class composed of double, long, and long elements.
 * <p>Generated by io.deephaven.replicators.TupleCodeGenerator.
 */
public class DoubleLongLongTuple implements Comparable<DoubleLongLongTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<DoubleLongLongTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final DoubleLongLongTuple typedOther = (DoubleLongLongTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final DoubleLongLongTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public DoubleLongLongTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        return this;
    }
}
