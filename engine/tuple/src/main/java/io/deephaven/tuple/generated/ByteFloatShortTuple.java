...
/**
 * <p>3-Tuple (triple) key class composed of byte, float, and short elements.
 * <p>Generated by io.deephaven.replicators.TupleCodeGenerator.
 */
public class ByteFloatShortTuple implements Comparable<ByteFloatShortTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<ByteFloatShortTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final ByteFloatShortTuple typedOther = (ByteFloatShortTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final ByteFloatShortTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public ByteFloatShortTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        return this;
    }
}
