...
/**
 * <p>3-Tuple (triple) key class composed of int, short, and char elements.
 * <p>Generated by io.deephaven.replicators.TupleCodeGenerator.
 */
public class IntShortCharTuple implements Comparable<IntShortCharTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<IntShortCharTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final IntShortCharTuple typedOther = (IntShortCharTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final IntShortCharTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public IntShortCharTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        return this;
    }
}
