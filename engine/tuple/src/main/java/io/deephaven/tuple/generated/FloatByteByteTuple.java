...
/**
 * <p>3-Tuple (triple) key class composed of float, byte, and byte elements.
 * <p>Generated by io.deephaven.replicators.TupleCodeGenerator.
 */
public class FloatByteByteTuple implements Comparable<FloatByteByteTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<FloatByteByteTuple> {
    ...
    @Override
    public final int compareTo(@NotNull final FloatByteByteTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public FloatByteByteTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        return this;
    }
}
