...
/**
 * <p>3-Tuple (triple) key class composed of double, short, and short elements.
 * <p>Generated by io.deephaven.replicators.TupleCodeGenerator.
 */
public class DoubleShortShortTuple implements Comparable<DoubleShortShortTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<DoubleShortShortTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final DoubleShortShortTuple typedOther = (DoubleShortShortTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final DoubleShortShortTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public DoubleShortShortTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        return this;
    }
}
