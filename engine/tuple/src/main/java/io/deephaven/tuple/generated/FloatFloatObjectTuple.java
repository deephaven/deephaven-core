...
/**
 * <p>3-Tuple (triple) key class composed of float, float, and Object elements.
 * <p>Generated by io.deephaven.replicators.TupleCodeGenerator.
 */
public class FloatFloatObjectTuple implements Comparable<FloatFloatObjectTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<FloatFloatObjectTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final FloatFloatObjectTuple typedOther = (FloatFloatObjectTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final FloatFloatObjectTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public FloatFloatObjectTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        final Object canonicalizedElement3 = canonicalizer.apply(element3);
        return canonicalizedElement3 == element3
                ? this : new FloatFloatObjectTuple(element1, element2, canonicalizedElement3);
    }
}
