...
/**
 * <p>3-Tuple (triple) key class composed of byte, Object, and float elements.
 * <p>Generated by io.deephaven.replicators.TupleCodeGenerator.
 */
public class ByteObjectFloatTuple implements Comparable<ByteObjectFloatTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<ByteObjectFloatTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final ByteObjectFloatTuple typedOther = (ByteObjectFloatTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final ByteObjectFloatTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public ByteObjectFloatTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        final Object canonicalizedElement2 = canonicalizer.apply(element2);
        return canonicalizedElement2 == element2
                ? this : new ByteObjectFloatTuple(element1, canonicalizedElement2, element3);
    }
}
