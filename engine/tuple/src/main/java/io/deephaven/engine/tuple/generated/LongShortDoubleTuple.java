...
/**
 * <p>3-Tuple (triple) key class composed of long, short, and double elements.
 * <p>Generated by {@link io.deephaven.engine.util.tuples.TupleCodeGenerator}.
 */
public class LongShortDoubleTuple implements Comparable<LongShortDoubleTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<LongShortDoubleTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final LongShortDoubleTuple typedOther = (LongShortDoubleTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final LongShortDoubleTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public LongShortDoubleTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        return this;
    }
}
