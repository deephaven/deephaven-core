...
/**
 * <p>3-Tuple (triple) key class composed of float, long, and byte elements.
 * <p>Generated by io.deephaven.replicators.TupleCodeGenerator.
 */
public class FloatLongByteTuple implements Comparable<FloatLongByteTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<FloatLongByteTuple> {
    ...
    @Override
    public final int compareTo(@NotNull final FloatLongByteTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public FloatLongByteTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        return this;
    }
}
