...
/**
 * <p>3-Tuple (triple) key class composed of char, int, and float elements.
 * <p>Generated by {@link io.deephaven.engine.util.tuples.TupleCodeGenerator}.
 */
public class CharIntFloatTuple implements Comparable<CharIntFloatTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<CharIntFloatTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final CharIntFloatTuple typedOther = (CharIntFloatTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final CharIntFloatTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public CharIntFloatTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        return this;
    }
}
