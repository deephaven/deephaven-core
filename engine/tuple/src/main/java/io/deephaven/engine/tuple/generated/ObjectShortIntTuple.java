...
/**
 * <p>3-Tuple (triple) key class composed of Object, short, and int elements.
 * <p>Generated by io.deephaven.replicators.TupleCodeGenerator.
 */
public class ObjectShortIntTuple implements Comparable<ObjectShortIntTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<ObjectShortIntTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final ObjectShortIntTuple typedOther = (ObjectShortIntTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final ObjectShortIntTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public ObjectShortIntTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        final Object canonicalizedElement1 = canonicalizer.apply(element1);
        return canonicalizedElement1 == element1
                ? this : new ObjectShortIntTuple(canonicalizedElement1, element2, element3);
    }
}
