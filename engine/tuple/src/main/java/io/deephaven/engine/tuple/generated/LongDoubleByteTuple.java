...
/**
 * <p>3-Tuple (triple) key class composed of long, double, and byte elements.
 * <p>Generated by {@link io.deephaven.engine.util.tuples.TupleCodeGenerator}.
 */
public class LongDoubleByteTuple implements Comparable<LongDoubleByteTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<LongDoubleByteTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final LongDoubleByteTuple typedOther = (LongDoubleByteTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final LongDoubleByteTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public LongDoubleByteTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        return this;
    }
}
