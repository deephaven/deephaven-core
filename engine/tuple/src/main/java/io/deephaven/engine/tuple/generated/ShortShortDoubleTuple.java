...
/**
 * <p>3-Tuple (triple) key class composed of short, short, and double elements.
 * <p>Generated by io.deephaven.replicators.TupleCodeGenerator.
 */
public class ShortShortDoubleTuple implements Comparable<ShortShortDoubleTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<ShortShortDoubleTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final ShortShortDoubleTuple typedOther = (ShortShortDoubleTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final ShortShortDoubleTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public ShortShortDoubleTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        return this;
    }
}
