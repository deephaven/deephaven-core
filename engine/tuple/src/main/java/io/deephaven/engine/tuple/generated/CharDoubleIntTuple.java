...
/**
 * <p>3-Tuple (triple) key class composed of char, double, and int elements.
 * <p>Generated by io.deephaven.replicators.TupleCodeGenerator.
 */
public class CharDoubleIntTuple implements Comparable<CharDoubleIntTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<CharDoubleIntTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final CharDoubleIntTuple typedOther = (CharDoubleIntTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final CharDoubleIntTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public CharDoubleIntTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        return this;
    }
}
