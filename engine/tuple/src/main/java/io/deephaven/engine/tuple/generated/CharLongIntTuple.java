...
/**
 * <p>3-Tuple (triple) key class composed of char, long, and int elements.
 * <p>Generated by io.deephaven.replicators.TupleCodeGenerator.
 */
public class CharLongIntTuple implements Comparable<CharLongIntTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<CharLongIntTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final CharLongIntTuple typedOther = (CharLongIntTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final CharLongIntTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public CharLongIntTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        return this;
    }
}
