...
/**
 * <p>3-Tuple (triple) key class composed of Object, int, and Object elements.
 * <p>Generated by io.deephaven.replicators.TupleCodeGenerator.
 */
public class ObjectIntObjectTuple implements Comparable<ObjectIntObjectTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<ObjectIntObjectTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final ObjectIntObjectTuple typedOther = (ObjectIntObjectTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final ObjectIntObjectTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public ObjectIntObjectTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        ...
        return canonicalizedElement1 == element1 && canonicalizedElement3 == element3
                ? this : new ObjectIntObjectTuple(canonicalizedElement1, element2, canonicalizedElement3);
    }
}
