...
/**
 * <p>3-Tuple (triple) key class composed of float, float, and byte elements.
 * <p>Generated by {@link io.deephaven.engine.util.tuples.TupleCodeGenerator}.
 */
public class FloatFloatByteTuple implements Comparable<FloatFloatByteTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<FloatFloatByteTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final FloatFloatByteTuple typedOther = (FloatFloatByteTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final FloatFloatByteTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public FloatFloatByteTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        return this;
    }
}
