...
/**
 * <p>3-Tuple (triple) key class composed of Object, Object, and byte elements.
 * <p>Generated by io.deephaven.replicators.TupleCodeGenerator.
 */
public class ObjectObjectByteTuple implements Comparable<ObjectObjectByteTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<ObjectObjectByteTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final ObjectObjectByteTuple typedOther = (ObjectObjectByteTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final ObjectObjectByteTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public ObjectObjectByteTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        ...
        return canonicalizedElement1 == element1 && canonicalizedElement2 == element2
                ? this : new ObjectObjectByteTuple(canonicalizedElement1, canonicalizedElement2, element3);
    }
}
