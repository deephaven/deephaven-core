...
/**
 * <p>3-Tuple (triple) key class composed of char, short, and byte elements.
 * <p>Generated by io.deephaven.replicators.TupleCodeGenerator.
 */
public class CharShortByteTuple implements Comparable<CharShortByteTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<CharShortByteTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final CharShortByteTuple typedOther = (CharShortByteTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final CharShortByteTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public CharShortByteTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        return this;
    }
}
