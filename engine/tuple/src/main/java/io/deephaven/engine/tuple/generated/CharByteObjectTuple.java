...
/**
 * <p>3-Tuple (triple) key class composed of char, byte, and Object elements.
 * <p>Generated by io.deephaven.replicators.TupleCodeGenerator.
 */
public class CharByteObjectTuple implements Comparable<CharByteObjectTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<CharByteObjectTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final CharByteObjectTuple typedOther = (CharByteObjectTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final CharByteObjectTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public CharByteObjectTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        final Object canonicalizedElement3 = canonicalizer.apply(element3);
        return canonicalizedElement3 == element3
                ? this : new CharByteObjectTuple(element1, element2, canonicalizedElement3);
    }
}
