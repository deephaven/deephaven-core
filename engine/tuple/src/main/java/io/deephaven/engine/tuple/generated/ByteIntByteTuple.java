...
/**
 * <p>3-Tuple (triple) key class composed of byte, int, and byte elements.
 * <p>Generated by {@link io.deephaven.engine.util.tuples.TupleCodeGenerator}.
 */
public class ByteIntByteTuple implements Comparable<ByteIntByteTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<ByteIntByteTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final ByteIntByteTuple typedOther = (ByteIntByteTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final ByteIntByteTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public ByteIntByteTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        return this;
    }
}
