...
/**
 * <p>2-Tuple (double) key class composed of byte and double elements.
 * <p>Generated by {@link io.deephaven.engine.util.tuples.TupleCodeGenerator}.
 */
public class ByteDoubleTuple implements Comparable<ByteDoubleTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<ByteDoubleTuple> {
    ...
    @Override
    public final int compareTo(@NotNull final ByteDoubleTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    public String toString() {
        return "ByteDoubleTuple{" +
                element1 + ", " +
                element2 + '}';
    }

    @Override
    public ByteDoubleTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        return this;
    }
}
