...
/**
 * <p>3-Tuple (triple) key class composed of double, float, and char elements.
 * <p>Generated by io.deephaven.replicators.TupleCodeGenerator.
 */
public class DoubleFloatCharTuple implements Comparable<DoubleFloatCharTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<DoubleFloatCharTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final DoubleFloatCharTuple typedOther = (DoubleFloatCharTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final DoubleFloatCharTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public DoubleFloatCharTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        return this;
    }
}
