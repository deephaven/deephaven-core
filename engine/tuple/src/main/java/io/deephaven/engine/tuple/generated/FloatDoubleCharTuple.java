...
/**
 * <p>3-Tuple (triple) key class composed of float, double, and char elements.
 * <p>Generated by io.deephaven.replicators.TupleCodeGenerator.
 */
public class FloatDoubleCharTuple implements Comparable<FloatDoubleCharTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<FloatDoubleCharTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final FloatDoubleCharTuple typedOther = (FloatDoubleCharTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final FloatDoubleCharTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public FloatDoubleCharTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        return this;
    }
}
