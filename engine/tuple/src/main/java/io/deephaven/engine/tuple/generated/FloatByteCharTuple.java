...
/**
 * <p>3-Tuple (triple) key class composed of float, byte, and char elements.
 * <p>Generated by io.deephaven.replicators.TupleCodeGenerator.
 */
public class FloatByteCharTuple implements Comparable<FloatByteCharTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<FloatByteCharTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final FloatByteCharTuple typedOther = (FloatByteCharTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final FloatByteCharTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public FloatByteCharTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        return this;
    }
}
