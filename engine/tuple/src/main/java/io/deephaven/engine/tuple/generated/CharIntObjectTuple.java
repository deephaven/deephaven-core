...
/**
 * <p>3-Tuple (triple) key class composed of char, int, and Object elements.
 * <p>Generated by io.deephaven.replicators.TupleCodeGenerator.
 */
public class CharIntObjectTuple implements Comparable<CharIntObjectTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<CharIntObjectTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final CharIntObjectTuple typedOther = (CharIntObjectTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final CharIntObjectTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public CharIntObjectTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        final Object canonicalizedElement3 = canonicalizer.apply(element3);
        return canonicalizedElement3 == element3
                ? this : new CharIntObjectTuple(element1, element2, canonicalizedElement3);
    }
}
