...
/**
 * <p>3-Tuple (triple) key class composed of short, double, and float elements.
 * <p>Generated by io.deephaven.replicators.TupleCodeGenerator.
 */
public class ShortDoubleFloatTuple implements Comparable<ShortDoubleFloatTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<ShortDoubleFloatTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final ShortDoubleFloatTuple typedOther = (ShortDoubleFloatTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final ShortDoubleFloatTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public ShortDoubleFloatTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        return this;
    }
}
