...
/**
 * <p>3-Tuple (triple) key class composed of long, short, and short elements.
 * <p>Generated by {@link io.deephaven.engine.util.tuples.TupleCodeGenerator}.
 */
public class LongShortShortTuple implements Comparable<LongShortShortTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<LongShortShortTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final LongShortShortTuple typedOther = (LongShortShortTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final LongShortShortTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public LongShortShortTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        return this;
    }
}
