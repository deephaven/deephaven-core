...
/**
 * <p>3-Tuple (triple) key class composed of char, float, and double elements.
 * <p>Generated by io.deephaven.replicators.TupleCodeGenerator.
 */
public class CharFloatDoubleTuple implements Comparable<CharFloatDoubleTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<CharFloatDoubleTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final CharFloatDoubleTuple typedOther = (CharFloatDoubleTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final CharFloatDoubleTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public CharFloatDoubleTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        return this;
    }
}
