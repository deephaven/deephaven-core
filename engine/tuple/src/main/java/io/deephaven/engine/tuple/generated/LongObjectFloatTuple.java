...
/**
 * <p>3-Tuple (triple) key class composed of long, Object, and float elements.
 * <p>Generated by io.deephaven.replicators.TupleCodeGenerator.
 */
public class LongObjectFloatTuple implements Comparable<LongObjectFloatTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<LongObjectFloatTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final LongObjectFloatTuple typedOther = (LongObjectFloatTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final LongObjectFloatTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public LongObjectFloatTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        final Object canonicalizedElement2 = canonicalizer.apply(element2);
        return canonicalizedElement2 == element2
                ? this : new LongObjectFloatTuple(element1, canonicalizedElement2, element3);
    }
}
