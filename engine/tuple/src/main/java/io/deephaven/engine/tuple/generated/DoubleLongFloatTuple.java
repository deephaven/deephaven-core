...
/**
 * <p>3-Tuple (triple) key class composed of double, long, and float elements.
 * <p>Generated by {@link io.deephaven.engine.util.tuples.TupleCodeGenerator}.
 */
public class DoubleLongFloatTuple implements Comparable<DoubleLongFloatTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<DoubleLongFloatTuple> {
    ...
    @Override
    public final int compareTo(@NotNull final DoubleLongFloatTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public DoubleLongFloatTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        return this;
    }
}
