...
/**
 * <p>3-Tuple (triple) key class composed of double, char, and short elements.
 * <p>Generated by {@link io.deephaven.engine.util.tuples.TupleCodeGenerator}.
 */
public class DoubleCharShortTuple implements Comparable<DoubleCharShortTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<DoubleCharShortTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final DoubleCharShortTuple typedOther = (DoubleCharShortTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final DoubleCharShortTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public DoubleCharShortTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        return this;
    }
}
