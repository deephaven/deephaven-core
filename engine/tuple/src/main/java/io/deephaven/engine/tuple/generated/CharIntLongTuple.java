...
/**
 * <p>3-Tuple (triple) key class composed of char, int, and long elements.
 * <p>Generated by io.deephaven.replicators.TupleCodeGenerator.
 */
public class CharIntLongTuple implements Comparable<CharIntLongTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<CharIntLongTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final CharIntLongTuple typedOther = (CharIntLongTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final CharIntLongTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public CharIntLongTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        return this;
    }
}
