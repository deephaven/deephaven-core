...
/**
 * <p>3-Tuple (triple) key class composed of float, Object, and float elements.
 * <p>Generated by {@link io.deephaven.engine.util.tuples.TupleCodeGenerator}.
 */
public class FloatObjectFloatTuple implements Comparable<FloatObjectFloatTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<FloatObjectFloatTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final FloatObjectFloatTuple typedOther = (FloatObjectFloatTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final FloatObjectFloatTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public FloatObjectFloatTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        final Object canonicalizedElement2 = canonicalizer.apply(element2);
        return canonicalizedElement2 == element2
                ? this : new FloatObjectFloatTuple(element1, canonicalizedElement2, element3);
    }
}
