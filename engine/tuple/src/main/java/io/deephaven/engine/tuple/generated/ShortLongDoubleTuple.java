...
/**
 * <p>3-Tuple (triple) key class composed of short, long, and double elements.
 * <p>Generated by {@link io.deephaven.engine.util.tuples.TupleCodeGenerator}.
 */
public class ShortLongDoubleTuple implements Comparable<ShortLongDoubleTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<ShortLongDoubleTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final ShortLongDoubleTuple typedOther = (ShortLongDoubleTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final ShortLongDoubleTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public ShortLongDoubleTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        return this;
    }
}
