...
/**
 * <p>3-Tuple (triple) key class composed of char, Object, and int elements.
 * <p>Generated by {@link io.deephaven.engine.util.tuples.TupleCodeGenerator}.
 */
public class CharObjectIntTuple implements Comparable<CharObjectIntTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<CharObjectIntTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final CharObjectIntTuple typedOther = (CharObjectIntTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final CharObjectIntTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public CharObjectIntTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        final Object canonicalizedElement2 = canonicalizer.apply(element2);
        return canonicalizedElement2 == element2
                ? this : new CharObjectIntTuple(element1, canonicalizedElement2, element3);
    }
}
