...
/**
 * <p>3-Tuple (triple) key class composed of short, long, and char elements.
 * <p>Generated by {@link io.deephaven.engine.util.tuples.TupleCodeGenerator}.
 */
public class ShortLongCharTuple implements Comparable<ShortLongCharTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<ShortLongCharTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final ShortLongCharTuple typedOther = (ShortLongCharTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final ShortLongCharTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public ShortLongCharTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        return this;
    }
}
