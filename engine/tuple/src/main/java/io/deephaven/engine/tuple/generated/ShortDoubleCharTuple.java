...
/**
 * <p>3-Tuple (triple) key class composed of short, double, and char elements.
 * <p>Generated by io.deephaven.replicators.TupleCodeGenerator.
 */
public class ShortDoubleCharTuple implements Comparable<ShortDoubleCharTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<ShortDoubleCharTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final ShortDoubleCharTuple typedOther = (ShortDoubleCharTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final ShortDoubleCharTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public ShortDoubleCharTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        return this;
    }
}
