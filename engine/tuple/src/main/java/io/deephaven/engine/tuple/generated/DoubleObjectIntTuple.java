...
/**
 * <p>3-Tuple (triple) key class composed of double, Object, and int elements.
 * <p>Generated by io.deephaven.replicators.TupleCodeGenerator.
 */
public class DoubleObjectIntTuple implements Comparable<DoubleObjectIntTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<DoubleObjectIntTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final DoubleObjectIntTuple typedOther = (DoubleObjectIntTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final DoubleObjectIntTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public DoubleObjectIntTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        final Object canonicalizedElement2 = canonicalizer.apply(element2);
        return canonicalizedElement2 == element2
                ? this : new DoubleObjectIntTuple(element1, canonicalizedElement2, element3);
    }
}
