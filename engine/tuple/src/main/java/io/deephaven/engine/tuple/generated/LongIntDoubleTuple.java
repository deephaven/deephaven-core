...
/**
 * <p>3-Tuple (triple) key class composed of long, int, and double elements.
 * <p>Generated by io.deephaven.replicators.TupleCodeGenerator.
 */
public class LongIntDoubleTuple implements Comparable<LongIntDoubleTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<LongIntDoubleTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final LongIntDoubleTuple typedOther = (LongIntDoubleTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final LongIntDoubleTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public LongIntDoubleTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        return this;
    }
}
