...
/**
 * <p>3-Tuple (triple) key class composed of short, short, and Object elements.
 * <p>Generated by {@link io.deephaven.engine.util.tuples.TupleCodeGenerator}.
 */
public class ShortShortObjectTuple implements Comparable<ShortShortObjectTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<ShortShortObjectTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final ShortShortObjectTuple typedOther = (ShortShortObjectTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final ShortShortObjectTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public ShortShortObjectTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        final Object canonicalizedElement3 = canonicalizer.apply(element3);
        return canonicalizedElement3 == element3
                ? this : new ShortShortObjectTuple(element1, element2, canonicalizedElement3);
    }
}
