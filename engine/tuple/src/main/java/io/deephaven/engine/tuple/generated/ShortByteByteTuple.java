...
/**
 * <p>3-Tuple (triple) key class composed of short, byte, and byte elements.
 * <p>Generated by io.deephaven.replicators.TupleCodeGenerator.
 */
public class ShortByteByteTuple implements Comparable<ShortByteByteTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<ShortByteByteTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final ShortByteByteTuple typedOther = (ShortByteByteTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final ShortByteByteTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public ShortByteByteTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        return this;
    }
}
