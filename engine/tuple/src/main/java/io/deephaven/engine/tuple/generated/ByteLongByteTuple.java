...
/**
 * <p>3-Tuple (triple) key class composed of byte, long, and byte elements.
 * <p>Generated by {@link io.deephaven.engine.util.tuples.TupleCodeGenerator}.
 */
public class ByteLongByteTuple implements Comparable<ByteLongByteTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<ByteLongByteTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final ByteLongByteTuple typedOther = (ByteLongByteTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final ByteLongByteTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public ByteLongByteTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        return this;
    }
}
