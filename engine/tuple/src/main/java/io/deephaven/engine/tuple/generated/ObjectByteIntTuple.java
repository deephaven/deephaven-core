...
/**
 * <p>3-Tuple (triple) key class composed of Object, byte, and int elements.
 * <p>Generated by {@link io.deephaven.engine.util.tuples.TupleCodeGenerator}.
 */
public class ObjectByteIntTuple implements Comparable<ObjectByteIntTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<ObjectByteIntTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final ObjectByteIntTuple typedOther = (ObjectByteIntTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final ObjectByteIntTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public ObjectByteIntTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        final Object canonicalizedElement1 = canonicalizer.apply(element1);
        return canonicalizedElement1 == element1
                ? this : new ObjectByteIntTuple(canonicalizedElement1, element2, element3);
    }
}
