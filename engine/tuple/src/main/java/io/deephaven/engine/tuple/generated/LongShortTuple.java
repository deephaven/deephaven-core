...
/**
 * <p>2-Tuple (double) key class composed of long and short elements.
 * <p>Generated by io.deephaven.replicators.TupleCodeGenerator.
 */
public class LongShortTuple implements Comparable<LongShortTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<LongShortTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final LongShortTuple typedOther = (LongShortTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final LongShortTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    public String toString() {
        return "LongShortTuple{" +
                element1 + ", " +
                element2 + '}';
    }

    @Override
    public LongShortTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        return this;
    }
}
