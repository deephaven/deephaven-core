...
/**
 * <p>3-Tuple (triple) key class composed of char, float, and byte elements.
 * <p>Generated by io.deephaven.replicators.TupleCodeGenerator.
 */
public class CharFloatByteTuple implements Comparable<CharFloatByteTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<CharFloatByteTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final CharFloatByteTuple typedOther = (CharFloatByteTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final CharFloatByteTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public CharFloatByteTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        return this;
    }
}
