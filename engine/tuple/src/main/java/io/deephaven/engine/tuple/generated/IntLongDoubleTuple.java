...
/**
 * <p>3-Tuple (triple) key class composed of int, long, and double elements.
 * <p>Generated by {@link io.deephaven.engine.util.tuples.TupleCodeGenerator}.
 */
public class IntLongDoubleTuple implements Comparable<IntLongDoubleTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<IntLongDoubleTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final IntLongDoubleTuple typedOther = (IntLongDoubleTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final IntLongDoubleTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public IntLongDoubleTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        return this;
    }
}
