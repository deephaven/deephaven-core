...
/**
 * <p>3-Tuple (triple) key class composed of Object, short, and byte elements.
 * <p>Generated by {@link io.deephaven.engine.util.tuples.TupleCodeGenerator}.
 */
public class ObjectShortByteTuple implements Comparable<ObjectShortByteTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<ObjectShortByteTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final ObjectShortByteTuple typedOther = (ObjectShortByteTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final ObjectShortByteTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public ObjectShortByteTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        final Object canonicalizedElement1 = canonicalizer.apply(element1);
        return canonicalizedElement1 == element1
                ? this : new ObjectShortByteTuple(canonicalizedElement1, element2, element3);
    }
}
