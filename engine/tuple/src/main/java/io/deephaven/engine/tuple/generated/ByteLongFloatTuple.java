...
/**
 * <p>3-Tuple (triple) key class composed of byte, long, and float elements.
 * <p>Generated by {@link io.deephaven.engine.util.tuples.TupleCodeGenerator}.
 */
public class ByteLongFloatTuple implements Comparable<ByteLongFloatTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<ByteLongFloatTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final ByteLongFloatTuple typedOther = (ByteLongFloatTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final ByteLongFloatTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public ByteLongFloatTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        return this;
    }
}
