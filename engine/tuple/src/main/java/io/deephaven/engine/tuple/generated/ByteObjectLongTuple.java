...
/**
 * <p>3-Tuple (triple) key class composed of byte, Object, and long elements.
 * <p>Generated by {@link io.deephaven.engine.util.tuples.TupleCodeGenerator}.
 */
public class ByteObjectLongTuple implements Comparable<ByteObjectLongTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<ByteObjectLongTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final ByteObjectLongTuple typedOther = (ByteObjectLongTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final ByteObjectLongTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public ByteObjectLongTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        final Object canonicalizedElement2 = canonicalizer.apply(element2);
        return canonicalizedElement2 == element2
                ? this : new ByteObjectLongTuple(element1, canonicalizedElement2, element3);
    }
}
