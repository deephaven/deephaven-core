...
/**
 * <p>3-Tuple (triple) key class composed of long, double, and double elements.
 * <p>Generated by {@link io.deephaven.engine.util.tuples.TupleCodeGenerator}.
 */
public class LongDoubleDoubleTuple implements Comparable<LongDoubleDoubleTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<LongDoubleDoubleTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final LongDoubleDoubleTuple typedOther = (LongDoubleDoubleTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final LongDoubleDoubleTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public LongDoubleDoubleTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        return this;
    }
}
