...
/**
 * <p>3-Tuple (triple) key class composed of float, short, and int elements.
 * <p>Generated by {@link io.deephaven.engine.util.tuples.TupleCodeGenerator}.
 */
public class FloatShortIntTuple implements Comparable<FloatShortIntTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<FloatShortIntTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final FloatShortIntTuple typedOther = (FloatShortIntTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final FloatShortIntTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public FloatShortIntTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        return this;
    }
}
