...
/**
 * <p>3-Tuple (triple) key class composed of float, double, and float elements.
 * <p>Generated by {@link io.deephaven.engine.util.tuples.TupleCodeGenerator}.
 */
public class FloatDoubleFloatTuple implements Comparable<FloatDoubleFloatTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<FloatDoubleFloatTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final FloatDoubleFloatTuple typedOther = (FloatDoubleFloatTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final FloatDoubleFloatTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public FloatDoubleFloatTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        return this;
    }
}
