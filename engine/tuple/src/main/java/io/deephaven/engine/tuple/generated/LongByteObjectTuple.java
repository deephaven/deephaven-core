...
/**
 * <p>3-Tuple (triple) key class composed of long, byte, and Object elements.
 * <p>Generated by io.deephaven.replicators.TupleCodeGenerator.
 */
public class LongByteObjectTuple implements Comparable<LongByteObjectTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<LongByteObjectTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final LongByteObjectTuple typedOther = (LongByteObjectTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final LongByteObjectTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public LongByteObjectTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        final Object canonicalizedElement3 = canonicalizer.apply(element3);
        return canonicalizedElement3 == element3
                ? this : new LongByteObjectTuple(element1, element2, canonicalizedElement3);
    }
}
