...
/**
 * <p>3-Tuple (triple) key class composed of Object, long, and byte elements.
 * <p>Generated by io.deephaven.replicators.TupleCodeGenerator.
 */
public class ObjectLongByteTuple implements Comparable<ObjectLongByteTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<ObjectLongByteTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final ObjectLongByteTuple typedOther = (ObjectLongByteTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final ObjectLongByteTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public ObjectLongByteTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        final Object canonicalizedElement1 = canonicalizer.apply(element1);
        return canonicalizedElement1 == element1
                ? this : new ObjectLongByteTuple(canonicalizedElement1, element2, element3);
    }
}
