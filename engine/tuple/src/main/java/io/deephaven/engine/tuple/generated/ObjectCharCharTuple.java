...
/**
 * <p>3-Tuple (triple) key class composed of Object, char, and char elements.
 * <p>Generated by {@link io.deephaven.engine.util.tuples.TupleCodeGenerator}.
 */
public class ObjectCharCharTuple implements Comparable<ObjectCharCharTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<ObjectCharCharTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final ObjectCharCharTuple typedOther = (ObjectCharCharTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final ObjectCharCharTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public ObjectCharCharTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        final Object canonicalizedElement1 = canonicalizer.apply(element1);
        return canonicalizedElement1 == element1
                ? this : new ObjectCharCharTuple(canonicalizedElement1, element2, element3);
    }
}
