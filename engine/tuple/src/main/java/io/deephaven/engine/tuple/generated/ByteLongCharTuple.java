...
/**
 * <p>3-Tuple (triple) key class composed of byte, long, and char elements.
 * <p>Generated by io.deephaven.replicators.TupleCodeGenerator.
 */
public class ByteLongCharTuple implements Comparable<ByteLongCharTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<ByteLongCharTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final ByteLongCharTuple typedOther = (ByteLongCharTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final ByteLongCharTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public ByteLongCharTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        return this;
    }
}
