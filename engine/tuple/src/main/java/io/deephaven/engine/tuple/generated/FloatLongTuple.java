...
/**
 * <p>2-Tuple (double) key class composed of float and long elements.
 * <p>Generated by io.deephaven.replicators.TupleCodeGenerator.
 */
public class FloatLongTuple implements Comparable<FloatLongTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<FloatLongTuple> {
    ...
    @Override
    public final int compareTo(@NotNull final FloatLongTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    public String toString() {
        return "FloatLongTuple{" +
                element1 + ", " +
                element2 + '}';
    }

    @Override
    public FloatLongTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        return this;
    }
}
