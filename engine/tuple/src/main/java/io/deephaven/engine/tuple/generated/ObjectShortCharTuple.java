...
/**
 * <p>3-Tuple (triple) key class composed of Object, short, and char elements.
 * <p>Generated by io.deephaven.replicators.TupleCodeGenerator.
 */
public class ObjectShortCharTuple implements Comparable<ObjectShortCharTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<ObjectShortCharTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final ObjectShortCharTuple typedOther = (ObjectShortCharTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final ObjectShortCharTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public ObjectShortCharTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        final Object canonicalizedElement1 = canonicalizer.apply(element1);
        return canonicalizedElement1 == element1
                ? this : new ObjectShortCharTuple(canonicalizedElement1, element2, element3);
    }
}
