...
/**
 * <p>3-Tuple (triple) key class composed of float, float, and double elements.
 * <p>Generated by io.deephaven.replicators.TupleCodeGenerator.
 */
public class FloatFloatDoubleTuple implements Comparable<FloatFloatDoubleTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<FloatFloatDoubleTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final FloatFloatDoubleTuple typedOther = (FloatFloatDoubleTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final FloatFloatDoubleTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public FloatFloatDoubleTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        return this;
    }
}
