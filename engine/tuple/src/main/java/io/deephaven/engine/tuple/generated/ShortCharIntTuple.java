...
/**
 * <p>3-Tuple (triple) key class composed of short, char, and int elements.
 * <p>Generated by {@link io.deephaven.engine.util.tuples.TupleCodeGenerator}.
 */
public class ShortCharIntTuple implements Comparable<ShortCharIntTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<ShortCharIntTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final ShortCharIntTuple typedOther = (ShortCharIntTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final ShortCharIntTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public ShortCharIntTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        return this;
    }
}
