...
/**
 * <p>3-Tuple (triple) key class composed of byte, char, and double elements.
 * <p>Generated by {@link io.deephaven.engine.util.tuples.TupleCodeGenerator}.
 */
public class ByteCharDoubleTuple implements Comparable<ByteCharDoubleTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<ByteCharDoubleTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final ByteCharDoubleTuple typedOther = (ByteCharDoubleTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final ByteCharDoubleTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public ByteCharDoubleTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        return this;
    }
}
