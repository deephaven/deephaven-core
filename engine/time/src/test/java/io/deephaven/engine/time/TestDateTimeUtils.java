...
public class TestDateTimeUtils extends BaseArrayTestCase {
    ...
    public void testConvertDateQuiet() throws Exception {
        ...
        TestCase.assertEquals(LocalDate.of(2024, 6, 25), DateTimeUtils.convertDateQuiet("6/25/24", DateTimeUtils.DateStyle.MDY));
        TestCase.assertEquals(LocalDate.of(2024, 6, 2), DateTimeUtils.convertDateQuiet("6/2/24", DateTimeUtils.DateStyle.MDY));
        TestCase.assertEquals(LocalDate.of(2024, 6, 2), DateTimeUtils.convertDateQuiet("6/2/2024", DateTimeUtils.DateStyle.MDY));
        ...
        TestCase.assertEquals(LocalDate.of(2024, 6, 25), DateTimeUtils.convertDateQuiet("25/6/24", DateTimeUtils.DateStyle.DMY));
        TestCase.assertEquals(LocalDate.of(2024, 6, 2), DateTimeUtils.convertDateQuiet("2/6/24", DateTimeUtils.DateStyle.DMY));
        TestCase.assertEquals(LocalDate.of(2024, 6, 2), DateTimeUtils.convertDateQuiet("2/6/2024", DateTimeUtils.DateStyle.DMY));
        ...
        TestCase.assertEquals(LocalDate.of(2024, 6, 25), DateTimeUtils.convertDateQuiet("24/6/25", DateTimeUtils.DateStyle.YMD));
        TestCase.assertEquals(LocalDate.of(2024, 6, 2), DateTimeUtils.convertDateQuiet("24/6/2", DateTimeUtils.DateStyle.YMD));
        TestCase.assertEquals(LocalDate.of(2024, 6, 2), DateTimeUtils.convertDateQuiet("2024/6/2", DateTimeUtils.DateStyle.YMD));
    }
    ...
    public void testConvertTimeQuiet() throws Exception {
        TestCase.assertEquals(new LocalTime("12:00").getMillisOfDay() * 1000000L, DateTimeUtils.convertTimeQuiet("12:00"));
        TestCase.assertEquals(new LocalTime("12:00:00").getMillisOfDay() * 1000000L, DateTimeUtils.convertTimeQuiet("12:00:00"));
        ...
        TestCase.assertEquals(new LocalTime("2:00:00").getMillisOfDay() * 1000000L, DateTimeUtils.convertTimeQuiet("2:00:00"));
    ...
    public void testConvertPeriodQuiet() throws Exception {
        ...
        TestCase.assertEquals(new org.joda.time.Period("P1wT1m"), DateTimeUtils.convertPeriodQuiet("1WT1M").getJodaPeriod());
    ...
    public void testTimeFormat() throws Exception {
        ...
        TestCase.assertEquals("12:00:00.123400000", DateTimeUtils.format(DateTimeUtils.convertTimeQuiet("12:00:00.1234")));
        TestCase.assertEquals("12:00:00.123456789", DateTimeUtils.format(DateTimeUtils.convertTimeQuiet("12:00:00.123456789")));
        ...
        TestCase.assertEquals("2:00:00.123456789", DateTimeUtils.format(DateTimeUtils.convertTimeQuiet("2:00:00.123456789")));
        ...
        TestCase.assertEquals("3T2:00:00.123000000", DateTimeUtils.format(DateTimeUtils.convertTimeQuiet("3T2:00:00.123")));
        TestCase.assertEquals("3T2:00:00.123400000", DateTimeUtils.format(DateTimeUtils.convertTimeQuiet("3T2:00:00.1234")));
    ...
    public void testLowerBin() {
        ...
        TestCase.assertEquals(DateTimeUtils.convertDateTime("2010-06-15T06:14:01 NY"), DateTimeUtils.lowerBin(time, second));
        TestCase.assertEquals(DateTimeUtils.convertDateTime("2010-06-15T06:10:00 NY"), DateTimeUtils.lowerBin(time, 5 * minute));
        TestCase.assertEquals(DateTimeUtils.convertDateTime("2010-06-15T06:00:00 NY"), DateTimeUtils.lowerBin(time, hour));
    ...
    public void testUpperBin() {
        ...
        TestCase.assertEquals(DateTimeUtils.convertDateTime("2010-06-15T06:14:02 NY"), DateTimeUtils.upperBin(time, second));
        TestCase.assertEquals(DateTimeUtils.convertDateTime("2010-06-15T06:15:00 NY"), DateTimeUtils.upperBin(time, 5 * minute));
        TestCase.assertEquals(DateTimeUtils.convertDateTime("2010-06-15T07:00:00 NY"), DateTimeUtils.upperBin(time, hour));
    ...
    public void testGetExcelDate() {
        ...
        TestCase.assertTrue(CompareUtils.doubleEquals(40344.625, DateTimeUtils.getExcelDateTime(time, TimeZones.TZ_CHICAGO)));
    ...
    public void testMicrosOfMilli() {
        ...
        TestCase.assertEquals(0, DateTimeUtils.microsOfMilliNy(DateTimeUtils.convertDateTime("2015-07-31T20:40:00.123 NY")));
        TestCase.assertEquals(400, DateTimeUtils.microsOfMilliNy(DateTimeUtils.convertDateTime("2015-07-31T20:40:00.1234 NY")));
    ...
    public void testZonedDateTime() {
        ...
        TestCase.assertEquals(dateTime2, DateTimeUtils.toDateTime(DateTimeUtils.getZonedDateTime(dateTime2, TimeZone.TZ_NY)));

        final DateTime dateTime3 = DateTimeUtils.convertDateTime("2050-07-31T20:40 NY");
        TestCase.assertEquals(dateTime3, DateTimeUtils.toDateTime(DateTimeUtils.getZonedDateTime(dateTime3, TimeZone.TZ_NY)));
    }
}
