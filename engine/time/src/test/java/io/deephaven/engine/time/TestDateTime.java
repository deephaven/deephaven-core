...
public class TestDateTime extends BaseArrayTestCase {
    ...
    public void testLastBusinessDateNy() {
        ...
        String fromCal =
                Calendars.calendar().previousBusinessDay(DateTimeUtil.millisToTime(System.currentTimeMillis()));
        TestCase.assertEquals(DateTimeUtil.lastBusinessDateNy(), fromCal);
        ...
        TestCase.assertEquals(expected, DateTimeUtil.lastBusinessDateNy(getMillisFromDateStr(format, today)));
        DateTimeUtil.endOfCurrentDateNyLastBusinessDay = 0;

        // Try the date time overrides
        String override = "2013-11-27";
        DateTimeUtil.lastBusinessDayNyOverride = override;
        TestCase.assertEquals(DateTimeUtil.lastBusinessDateNy(), override);
        DateTimeUtil.endOfCurrentDateNyLastBusinessDay = 0;

        // Now set the current date and see if the helper function workos
        DateTimeUtil.currentDateNyOverride = override;
        TestCase.assertEquals(DateTimeUtil.currentDateNy(), override);
        DateTimeUtil.endOfCurrentDateNyLastBusinessDay = 0;

        DateTimeUtil.overrideLastBusinessDateNyFromCurrentDateNy();
        TestCase.assertEquals(DateTimeUtil.lastBusinessDateNy(), "2013-11-26");
        DateTimeUtil.endOfCurrentDateNyLastBusinessDay = 0;
