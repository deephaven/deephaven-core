...
public class TestDateTime extends BaseArrayTestCase {
    ...
    public void testLastBusinessDateNy() {
        ...
        TestCase.assertEquals(DateTimeUtils.lastBusinessDateNy(), DateTimeUtils.lastBusinessDateNy(System.currentTimeMillis()));
        ...
        TestCase.assertEquals(dayBefore, DateTimeUtils.lastBusinessDateNy(getMillisFromDateStr(format, today) + 1)); // make sure
                                                                                                            // it
                                                                                                            // advances
                                                                                                            // just past
                                                                                                            // midnight
