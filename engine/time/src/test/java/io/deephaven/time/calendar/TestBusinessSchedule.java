...
public class TestBusinessSchedule extends BaseArrayTestCase {
    ...
    public void testBusinessSchedule() {
        ...
        final DateTime open2 = DateTimeUtils.toDateTime("2017-03-11T12:00:00.000000000 NY");
        final DateTime close2 = DateTimeUtils.toDateTime("2017-03-11T17:00:00.000000000 NY");
        ...
        assertTrue(single.isBusinessTime(DateTimeUtils.toDateTime("2017-03-11T10:00:00.000000000 NY")));
        assertTrue(single.isBusinessTime(DateTimeUtils.toDateTime("2017-03-11T10:15:00.000000000 NY")));
        assertTrue(single.isBusinessTime(DateTimeUtils.toDateTime("2017-03-11T11:00:00.000000000 NY")));
        assertFalse(single.isBusinessTime(DateTimeUtils.toDateTime("2017-03-11T11:10:00.000000000 NY")));
        assertEquals(0L, single.businessTimeElapsed(DateTimeUtils.toDateTime("2017-03-11T01:00:00.000000000 NY")));
        assertEquals(DateTimeUtils.MINUTE * 30,
                single.businessTimeElapsed(DateTimeUtils.toDateTime("2017-03-11T10:30:00.000000000 NY")));
        assertEquals(DateTimeUtils.HOUR,
                single.businessTimeElapsed(DateTimeUtils.toDateTime("2017-03-11T13:00:00.000000000 NY")));
        ...
        assertTrue(multi.isBusinessTime(DateTimeUtils.toDateTime("2017-03-11T10:00:00.000000000 NY")));
        assertTrue(multi.isBusinessTime(DateTimeUtils.toDateTime("2017-03-11T10:15:00.000000000 NY")));
        assertTrue(multi.isBusinessTime(DateTimeUtils.toDateTime("2017-03-11T11:00:00.000000000 NY")));
        assertFalse(multi.isBusinessTime(DateTimeUtils.toDateTime("2017-03-11T11:10:00.000000000 NY")));
        assertTrue(multi.isBusinessTime(DateTimeUtils.toDateTime("2017-03-11T12:10:00.000000000 NY")));
        assertEquals(0L, multi.businessTimeElapsed(DateTimeUtils.toDateTime("2017-03-11T01:00:00.000000000 NY")));
        assertEquals(DateTimeUtils.MINUTE * 30,
                multi.businessTimeElapsed(DateTimeUtils.toDateTime("2017-03-11T10:30:00.000000000 NY")));
        assertEquals(DateTimeUtils.HOUR * 2,
                multi.businessTimeElapsed(DateTimeUtils.toDateTime("2017-03-11T13:00:00.000000000 NY")));
        assertEquals(DateTimeUtils.HOUR * 2,
                multi.businessTimeElapsed(DateTimeUtils.toDateTime("2017-03-11T13:00:00.000000000 NY")));
        ...
        assertTrue(multi2.isBusinessTime(DateTimeUtils.toDateTime("2017-03-11T10:00:00.000000000 NY")));
        assertTrue(multi2.isBusinessTime(DateTimeUtils.toDateTime("2017-03-11T10:15:00.000000000 NY")));
        assertTrue(multi2.isBusinessTime(DateTimeUtils.toDateTime("2017-03-11T11:00:00.000000000 NY")));
        assertFalse(multi2.isBusinessTime(DateTimeUtils.toDateTime("2017-03-11T11:10:00.000000000 NY")));
        assertTrue(multi2.isBusinessTime(DateTimeUtils.toDateTime("2017-03-11T12:10:00.000000000 NY")));
        assertEquals(0L, multi2.businessTimeElapsed(DateTimeUtils.toDateTime("2017-03-11T01:00:00.000000000 NY")));
        assertEquals(DateTimeUtils.MINUTE * 30,
                multi2.businessTimeElapsed(DateTimeUtils.toDateTime("2017-03-11T10:30:00.000000000 NY")));
        assertEquals(DateTimeUtils.HOUR * 2,
                multi2.businessTimeElapsed(DateTimeUtils.toDateTime("2017-03-11T13:00:00.000000000 NY")));
        assertEquals(DateTimeUtils.HOUR * 2,
                multi2.businessTimeElapsed(DateTimeUtils.toDateTime("2017-03-11T13:00:00.000000000 NY")));
