...
public class TestYearMonthSummaryCache extends BaseArrayTestCase {
    ...
    public void testIteratorInclusive() {
        ...
        String[] target = {};
        String[] actual = iteratorToStream(cache.iterator(start, end, startInclusive, endInclusive)).toArray(String[]::new);
        ...
        target = new String[]{"month201811", "month201812", "year2019", "year2020", "year2021", "month202201", "month202202"};
        actual = iteratorToStream(cache.iterator(start, end, startInclusive, endInclusive)).toArray(String[]::new);
        assertEquals(target, actual);
    }
