...
public class ShortVectorColumnWrapper extends ShortVector.Indirect {
    ...
    public DeephavenValueIteratorOfShort iterator(final long fromIndexInclusive, final long toIndexExclusive) {
        ...
        final DeephavenValueIteratorOfShort rowsIterator = includedRows > CHUNKED_COLUMN_ITERATOR_SIZE_THRESHOLD
        ...
        if (includedInitialNulls == 0 && includedRemainingNulls == 0) {
            return rowsIterator == null ? DeephavenValueIteratorOfShort.empty() : rowsIterator;
        }
