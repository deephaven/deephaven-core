...
public interface UpdateByClause {
    /**
     * Conjoin an {@link UpdateBySpec} with columns for it to be applied to so the engine can construct
    ...
    // region Specs
    /**
     * Simply wrap the input specs as a collection suitable for {@link Table#updateBy(UpdateByControl, Collection, MatchPair...)}.  This is
     * functionally equivalent to {@link Arrays#asList(Object[])}.
     *
     ...
     * @return a new {@link UpdateByClause} for performing a forward fill with {@link Table#updateBy(UpdateByControl, Collection, MatchPair...)}
     */
     ...
     * @return a new {@link UpdateByClause} for performing a cumulative min with {@link Table#updateBy(UpdateByControl, Collection, MatchPair...)}
     */
     ...
     * @param columns the columns to find the min
     * @return a new {@link UpdateByClause} for performing a cumulative max with {@link Table#updateBy(UpdateByControl, Collection, MatchPair...)}
     */
     ...
     * @param columns the columns to find the min
     * @return a new {@link UpdateByClause} for performing a cumulative produce with {@link Table#updateBy(UpdateByControl, Collection, MatchPair...)}
     */
     ...
     * @param control a {@link EmaControl.Builder control} object that defines how special cases should behave.
     *                See {@link EmaControl} for further details.
     * @param columns the columns to apply the EMA to.
     * @return a new {@link  UpdateByClause} for performing an EMA with {@link Table#updateBy(UpdateByControl, Collection, MatchPair...)}
     */
    static UpdateByClause ema(final long timeScaleTicks, @NotNull final EmaControl.Builder control, final String... columns) {
     ...
     *
     * @param timeScaleTicks the decay rate (tau) in ticks
     * @param control a {@link EmaControl control} object that defines how special cases should behave.
     *                See {@link EmaControl} for further details.
     * @param columns the columns to apply the EMA to.
     * @return a new {@link  UpdateByClause} for performing an EMA with {@link Table#updateBy(UpdateByControl, Collection, MatchPair...)}
     */
    ...
    /**
     * <p>Create an Exponential Moving Average of the specified columns, using time as the decay unit.</p>
     * <p>The formula used is</p>
     * <pre>
     ...
     * @return a new {@link  UpdateByClause} for performing an EMA with {@link Table#updateBy(UpdateByControl, Collection, MatchPair...)}
     */
    static UpdateByClause ema(@NotNull final String timestampColumn, final long timeScaleNanos, @NotNull final EmaControl.Builder control, final String... columns) {
     ...
     * @return a new {@link  UpdateByClause} for performing an EMA with {@link Table#updateBy(UpdateByControl, Collection, MatchPair...)}
     */
    static UpdateByClause ema(@NotNull final String timestampColumn, final long timeScaleNanos, @NotNull final EmaControl control, final String... columns) {
