 ...
 */
public class UnboxedDateTimeTestSource extends UnboxedLongBackedColumnSource<DateTime> implements ColumnSource<Long> {
    ...
    public UnboxedDateTimeTestSource(ColumnSource<DateTime> alternateColumnSource,
            TestColumnSource<Long> treeMapSource) {
        super(alternateColumnSource);
        this.longTestSource = treeMapSource;
    }
