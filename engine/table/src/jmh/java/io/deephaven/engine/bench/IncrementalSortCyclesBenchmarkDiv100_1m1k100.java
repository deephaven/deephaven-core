...
public class IncrementalSortCyclesBenchmarkDiv100_1m1k100 extends IncrementalSortCyclesBenchmarkBase {
    ...
    public void setup(Blackhole blackhole) throws Exception {
        init(TABLE_SIZE, CYCLE_SIZE, NUM_CYCLES, "io.deephaven.engine.bench.Functions.div_100", false, blackhole);
    }
