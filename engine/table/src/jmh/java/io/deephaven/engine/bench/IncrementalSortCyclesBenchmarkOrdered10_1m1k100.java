...
public class IncrementalSortCyclesBenchmarkOrdered10_1m1k100 extends IncrementalSortCyclesBenchmarkBase {
    ...
    public void setup(Blackhole blackhole) throws Exception {
        init(TABLE_SIZE, CYCLE_SIZE, NUM_CYCLES, "io.deephaven.engine.bench.Functions.ordered_10", false, blackhole);
    }
