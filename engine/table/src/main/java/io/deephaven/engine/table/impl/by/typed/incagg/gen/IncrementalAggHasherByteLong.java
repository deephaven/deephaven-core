...
final class IncrementalAggHasherByteLong extends IncrementalChunkedOperatorAggregationStateManagerTypedBase {
    ...
    public IncrementalAggHasherByteLong(ColumnSource[] tableKeySources,
    ...
    private static int hash(byte k0, long k1) {
    ...
    private boolean findOverflow(HashHandler handler, byte k0, long k1, int chunkPosition,
