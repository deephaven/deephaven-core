...
/**
 * This implements a timsort kernel that sorts a multi-column key (Int, Float), comparing each
 ...
 */
public final class IntFloatMultiColumnTimsortKernel {
    private IntFloatMultiColumnTimsortKernel() {
        throw new UnsupportedOperationException();
    }

    public static <SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> IntFloatMultiColumnSortKernelContext<SORT_VALUES_ATTR, PERMUTE_VALUES_ATTR> createContext(
            final int size) {
        return new IntFloatMultiColumnSortKernelContext<>(size);
    }
    ...
    static <SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> void sort(
            IntFloatMultiColumnSortKernelContext<SORT_VALUES_ATTR, PERMUTE_VALUES_ATTR> context,
    ...
    private static int upperBound(IntChunk<?> valuesToSort0, FloatChunk<?> valuesToSort1, int lo,
            int hi, int searchValue0, float searchValue1) {
    ...
    private static int lowerBound(IntChunk<?> valuesToSort0, FloatChunk<?> valuesToSort1, int lo,
            int hi, int searchValue0, float searchValue1) {
    ...
    private static int bound(IntChunk<?> valuesToSort0, FloatChunk<?> valuesToSort1, int lo, int hi,
            int searchValue0, float searchValue1, final boolean lower) {
    ...
    private static void insertionSort(WritableLongChunk<?> valuesToPermute,
            WritableIntChunk<?> valuesToSort0, WritableFloatChunk<?> valuesToSort1, int offset,
            int length) {
    ...
    private static void swap(WritableLongChunk<?> valuesToPermute,
            WritableIntChunk<?> valuesToSort0, WritableFloatChunk<?> valuesToSort1, int a, int b) {
    ...
    public static class IntFloatMultiColumnSortKernelContext<SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> implements MultiColumnSortKernel<PERMUTE_VALUES_ATTR> {
        int minGallop;
        ...
        private IntFloatMultiColumnSortKernelContext(int size) {
        ...
        public void sort(WritableLongChunk<PERMUTE_VALUES_ATTR> valuesToPermute,
            ...
            IntFloatMultiColumnTimsortKernel.sort(this, valuesToPermute,
