...
final class StaticAggHasherFloatLong extends StaticChunkedOperatorAggregationStateManagerTypedBase {
    ...
    public StaticAggHasherFloatLong(ColumnSource[] tableKeySources,
    ...
    private boolean findOverflow(HashHandler handler, float k0, long k1, int chunkPosition,
