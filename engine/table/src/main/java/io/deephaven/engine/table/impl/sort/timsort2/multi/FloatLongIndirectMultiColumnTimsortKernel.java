...
/**
 * This implements a timsort kernel for a multi-column key (Float, Long) that never moves the column values:
 ...
 */
public final class FloatLongIndirectMultiColumnTimsortKernel {
    private FloatLongIndirectMultiColumnTimsortKernel() {
        throw new UnsupportedOperationException();
    }

    public static <PERMUTE_VALUES_ATTR extends Any> FloatLongIndirectMultiColumnSortKernelContext<PERMUTE_VALUES_ATTR> createContext(
            final int size) {
        return new FloatLongIndirectMultiColumnSortKernelContext<>(size);
    }
     ...
     */
    public static void sort(FloatLongIndirectMultiColumnSortKernelContext<?> context,
    ...
    private static void timSort(FloatLongIndirectMultiColumnSortKernelContext<?> context,
            WritableIntChunk<ChunkPositions> positions, FloatChunk<?> valuesToSort0,
     ...
     */
    private static int compareColumns(FloatChunk<?> valuesToSort0, LongChunk<?> valuesToSort1,
    ...
    private static void ensureMergeInvariants(
            FloatLongIndirectMultiColumnSortKernelContext<?> context,
            WritableIntChunk<ChunkPositions> positions, FloatChunk<?> valuesToSort0,
            LongChunk<?> valuesToSort1) {
        while (context.runCount > 1) {
    ...
    private static void merge(FloatLongIndirectMultiColumnSortKernelContext<?> context,
            WritableIntChunk<ChunkPositions> positions, FloatChunk<?> valuesToSort0,
     ...
     */
    private static void frontMerge(FloatLongIndirectMultiColumnSortKernelContext<?> context,
            WritableIntChunk<ChunkPositions> positions, FloatChunk<?> valuesToSort0,
     ...
     * We eventually need to do galloping here, but are skipping that for now
     */
    private static void backMerge(FloatLongIndirectMultiColumnSortKernelContext<?> context,
            WritableIntChunk<ChunkPositions> positions, FloatChunk<?> valuesToSort0,
    ...
    private static void copyToTemporary(FloatLongIndirectMultiColumnSortKernelContext<?> context,
    ...
    private static void insertionSort(WritableIntChunk<ChunkPositions> positions,
            FloatChunk<?> valuesToSort0, LongChunk<?> valuesToSort1, int offset, int length) {
    ...
    public static class FloatLongIndirectMultiColumnSortKernelContext<PERMUTE_VALUES_ATTR extends Any> implements MultiColumnSortKernel<PERMUTE_VALUES_ATTR> {
        int minGallop;
        ...
        private FloatLongIndirectMultiColumnSortKernelContext(int size) {
        ...
        public void sort(WritableLongChunk<PERMUTE_VALUES_ATTR> valuesToPermute,
            ...
            FloatLongIndirectMultiColumnTimsortKernel.sort(this, positions, valuesToSort[0].asFloatChunk(), valuesToSort[1].asLongChunk());
