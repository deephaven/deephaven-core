...
final class IncrementalAggHasherCharInt extends IncrementalChunkedOperatorAggregationStateManagerTypedBase {
    ...
    public IncrementalAggHasherCharInt(ColumnSource[] tableKeySources,
