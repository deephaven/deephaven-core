...
final class IncrementalAggOpenHasherWithTombstoneIntChar extends IncrementalChunkedOperatorAggregationStateManagerOpenAddressedBaseWithTombstones {
    ...
    public IncrementalAggOpenHasherWithTombstoneIntChar(ColumnSource[] tableKeySources,
