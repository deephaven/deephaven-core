...
/**
 * This implements a timsort kernel that sorts a multi-column key (Int, Short), comparing each
 ...
 */
public final class IntShortMultiColumnTimsortKernel {
    private IntShortMultiColumnTimsortKernel() {
        throw new UnsupportedOperationException();
    }

    public static <SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> IntShortMultiColumnSortKernelContext<SORT_VALUES_ATTR, PERMUTE_VALUES_ATTR> createContext(
            final int size) {
        return new IntShortMultiColumnSortKernelContext<>(size);
    }
    ...
    static <SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> void sort(
            IntShortMultiColumnSortKernelContext<SORT_VALUES_ATTR, PERMUTE_VALUES_ATTR> context,
    ...
    private static int upperBound(IntChunk<?> valuesToSort0, ShortChunk<?> valuesToSort1, int lo,
            int hi, int searchValue0, short searchValue1) {
    ...
    private static int lowerBound(IntChunk<?> valuesToSort0, ShortChunk<?> valuesToSort1, int lo,
            int hi, int searchValue0, short searchValue1) {
    ...
    private static int bound(IntChunk<?> valuesToSort0, ShortChunk<?> valuesToSort1, int lo, int hi,
            int searchValue0, short searchValue1, final boolean lower) {
    ...
    private static void insertionSort(WritableLongChunk<?> valuesToPermute,
            WritableIntChunk<?> valuesToSort0, WritableShortChunk<?> valuesToSort1, int offset,
            int length) {
    ...
    private static void swap(WritableLongChunk<?> valuesToPermute,
            WritableIntChunk<?> valuesToSort0, WritableShortChunk<?> valuesToSort1, int a, int b) {
    ...
    public static class IntShortMultiColumnSortKernelContext<SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> implements MultiColumnSortKernel<PERMUTE_VALUES_ATTR> {
        int minGallop;
        ...
        private IntShortMultiColumnSortKernelContext(int size) {
        ...
        public void sort(WritableLongChunk<PERMUTE_VALUES_ATTR> valuesToPermute,
            ...
            IntShortMultiColumnTimsortKernel.sort(this, valuesToPermute,
