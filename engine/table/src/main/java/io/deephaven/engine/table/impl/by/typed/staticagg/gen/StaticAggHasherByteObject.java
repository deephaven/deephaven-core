...
final class StaticAggHasherByteObject extends StaticChunkedOperatorAggregationStateManagerTypedBase {
    ...
    public StaticAggHasherByteObject(ColumnSource[] tableKeySources,
