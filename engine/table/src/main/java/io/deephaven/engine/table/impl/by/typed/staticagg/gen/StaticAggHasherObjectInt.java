...
final class StaticAggHasherObjectInt extends StaticChunkedOperatorAggregationStateManagerTypedBase {
    ...
    public StaticAggHasherObjectInt(ColumnSource[] tableKeySources,
