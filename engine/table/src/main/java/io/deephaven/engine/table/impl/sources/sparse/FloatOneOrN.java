...
public final class FloatOneOrN {
    ...
    private static final int ELEMENT_SIZE = Float.BYTES;
    ...
    static public final class Block0 {
        ...
        /**
         * Called by the {@link io.deephaven.engine.table.impl.sources.FloatSparseArraySource} at the end of a cycle
         ...
         */
        private void clearOneLowestLevelBlock(final long block2Idx, final SoftRecycler<float[]> recycler) {
         ...
         * @param recycler recycler for lowest level blocks
         */
        private void clearOneBlock_2(final long block1Idx, final SoftRecycler<float[][]> recycler) {
    ...
    static public final class Block1 {
         ...
         */
        private void clearByIndex(final int idx, final SoftRecycler<float[][]> recycler2) {
            Assert.neq(idx, "idx", HAVE_MORE_THAN_ONE, "HAVE_MORE_THAN_ONE");
            if (oneIndex == idx) {
    ...
    static public final class Block2 {
        ...
        long estimateSize() {
            ...
            if (oneIndex != HAVE_MORE_THAN_ONE) {
                return (long)oneValue.length * Float.BYTES;
            }
