...
/**
 * This implements a timsort kernel for a multi-column key (Object, NullAwareChar) that never moves the column values:
 ...
 */
public final class ObjectNullAwareCharIndirectMultiColumnTimsortKernel {
    private ObjectNullAwareCharIndirectMultiColumnTimsortKernel() {
        throw new UnsupportedOperationException();
    }

    public static <PERMUTE_VALUES_ATTR extends Any> ObjectNullAwareCharIndirectMultiColumnSortKernelContext<PERMUTE_VALUES_ATTR> createContext(
            final int size) {
        return new ObjectNullAwareCharIndirectMultiColumnSortKernelContext<>(size);
    }
     ...
     */
    public static void sort(ObjectNullAwareCharIndirectMultiColumnSortKernelContext<?> context,
    ...
    private static void timSort(ObjectNullAwareCharIndirectMultiColumnSortKernelContext<?> context,
            WritableIntChunk<ChunkPositions> positions, ObjectChunk<Object, ?> valuesToSort0,
    ...
    private static int compareColumns(ObjectChunk<Object, ?> valuesToSort0,
            CharChunk<?> valuesToSort1, int lhsPos, int rhsPos) {
    ...
    private static void ensureMergeInvariants(
            ObjectNullAwareCharIndirectMultiColumnSortKernelContext<?> context,
            WritableIntChunk<ChunkPositions> positions, ObjectChunk<Object, ?> valuesToSort0,
            CharChunk<?> valuesToSort1) {
        while (context.runCount > 1) {
    ...
    private static void merge(ObjectNullAwareCharIndirectMultiColumnSortKernelContext<?> context,
            WritableIntChunk<ChunkPositions> positions, ObjectChunk<Object, ?> valuesToSort0,
    ...
    private static int upperBound(IntChunk<ChunkPositions> positions,
            ObjectChunk<Object, ?> valuesToSort0, CharChunk<?> valuesToSort1, int lo, int hi,
            int searchPos) {
    ...
    private static void insertionSort(WritableIntChunk<ChunkPositions> positions,
            ObjectChunk<Object, ?> valuesToSort0, CharChunk<?> valuesToSort1, int offset,
            int length) {
    ...
    public static class ObjectNullAwareCharIndirectMultiColumnSortKernelContext<PERMUTE_VALUES_ATTR extends Any> implements MultiColumnSortKernel<PERMUTE_VALUES_ATTR> {
        int minGallop;
        ...
        private ObjectNullAwareCharIndirectMultiColumnSortKernelContext(int size) {
        ...
        public void sort(WritableLongChunk<PERMUTE_VALUES_ATTR> valuesToPermute,
            ...
            ObjectNullAwareCharIndirectMultiColumnTimsortKernel.sort(this, positions, valuesToSort[0].<Object>asObjectChunk(), valuesToSort[1].asCharChunk());
