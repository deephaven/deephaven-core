...
final class TypedHasherByteDouble extends IncrementalChunkedOperatorAggregationStateManagerTypedBase {
  ...
  public TypedHasherByteDouble(ColumnSource[] tableKeySources, int tableSize,
  ...
  private int hash(byte v0, double v1) {
  ...
  private boolean findOverflow(HashHandler handler, byte v0, double v1, int chunkPosition,
