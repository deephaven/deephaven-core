...
final class StaticAggHasherFloatObject extends StaticChunkedOperatorAggregationStateManagerTypedBase {
    ...
    public StaticAggHasherFloatObject(ColumnSource[] tableKeySources,
    ...
    private boolean findOverflow(HashHandler handler, float k0, Object k1, int chunkPosition,
