...
/**
 * This implements a timsort kernel for a multi-column key (Byte, Double) that never moves the column values:
 ...
 */
public final class ByteDoubleIndirectMultiColumnTimsortKernel {
    private ByteDoubleIndirectMultiColumnTimsortKernel() {
        throw new UnsupportedOperationException();
    }

    public static <PERMUTE_VALUES_ATTR extends Any> ByteDoubleIndirectMultiColumnSortKernelContext<PERMUTE_VALUES_ATTR> createContext(
            final int size) {
        return new ByteDoubleIndirectMultiColumnSortKernelContext<>(size);
    }
     ...
     */
    public static void sort(ByteDoubleIndirectMultiColumnSortKernelContext<?> context,
            WritableIntChunk<ChunkPositions> positions, ByteChunk<?> valuesToSort0,
            DoubleChunk<?> valuesToSort1) {
        timSort(context, positions, valuesToSort0, valuesToSort1, 0, positions.size());
    }

    private static void timSort(ByteDoubleIndirectMultiColumnSortKernelContext<?> context,
            WritableIntChunk<ChunkPositions> positions, ByteChunk<?> valuesToSort0,
     ...
     */
    private static int compareColumns(ByteChunk<?> valuesToSort0, DoubleChunk<?> valuesToSort1,
    ...
    private static void ensureMergeInvariants(
            ByteDoubleIndirectMultiColumnSortKernelContext<?> context,
            WritableIntChunk<ChunkPositions> positions, ByteChunk<?> valuesToSort0,
            DoubleChunk<?> valuesToSort1) {
        while (context.runCount > 1) {
    ...
    private static void merge(ByteDoubleIndirectMultiColumnSortKernelContext<?> context,
            WritableIntChunk<ChunkPositions> positions, ByteChunk<?> valuesToSort0,
     ...
     */
    private static void frontMerge(ByteDoubleIndirectMultiColumnSortKernelContext<?> context,
            WritableIntChunk<ChunkPositions> positions, ByteChunk<?> valuesToSort0,
     ...
     * We eventually need to do galloping here, but are skipping that for now
     */
    private static void backMerge(ByteDoubleIndirectMultiColumnSortKernelContext<?> context,
            WritableIntChunk<ChunkPositions> positions, ByteChunk<?> valuesToSort0,
    ...
    private static void copyToTemporary(ByteDoubleIndirectMultiColumnSortKernelContext<?> context,
    ...
    private static int upperBound(IntChunk<ChunkPositions> positions, ByteChunk<?> valuesToSort0,
    ...
    private static int lowerBound(IntChunk<ChunkPositions> positions, ByteChunk<?> valuesToSort0,
            DoubleChunk<?> valuesToSort1, int lo, int hi, int searchPos) {
    ...
    private static int bound(IntChunk<ChunkPositions> positions, ByteChunk<?> valuesToSort0,
    ...
    private static void insertionSort(WritableIntChunk<ChunkPositions> positions,
            ByteChunk<?> valuesToSort0, DoubleChunk<?> valuesToSort1, int offset, int length) {
    ...
    public static class ByteDoubleIndirectMultiColumnSortKernelContext<PERMUTE_VALUES_ATTR extends Any> implements MultiColumnSortKernel<PERMUTE_VALUES_ATTR> {
        int minGallop;
        ...
        private ByteDoubleIndirectMultiColumnSortKernelContext(int size) {
        ...
        public void sort(WritableLongChunk<PERMUTE_VALUES_ATTR> valuesToPermute,
            ...
            ByteDoubleIndirectMultiColumnTimsortKernel.sort(this, positions, valuesToSort[0].asByteChunk(), valuesToSort[1].asDoubleChunk());
