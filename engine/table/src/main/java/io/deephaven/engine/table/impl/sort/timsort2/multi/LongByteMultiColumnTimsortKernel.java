...
/**
 * This implements a timsort kernel that sorts a multi-column key (Long, Byte), comparing each
 ...
 */
public final class LongByteMultiColumnTimsortKernel {
    private LongByteMultiColumnTimsortKernel() {
        throw new UnsupportedOperationException();
    }

    public static <SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> LongByteMultiColumnSortKernelContext<SORT_VALUES_ATTR, PERMUTE_VALUES_ATTR> createContext(
            final int size) {
        return new LongByteMultiColumnSortKernelContext<>(size);
    }
    ...
    static <SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> void sort(
            LongByteMultiColumnSortKernelContext<SORT_VALUES_ATTR, PERMUTE_VALUES_ATTR> context,
    ...
    private static int upperBound(LongChunk<?> valuesToSort0, ByteChunk<?> valuesToSort1, int lo,
            int hi, long searchValue0, byte searchValue1) {
    ...
    private static int lowerBound(LongChunk<?> valuesToSort0, ByteChunk<?> valuesToSort1, int lo,
            int hi, long searchValue0, byte searchValue1) {
    ...
    private static int bound(LongChunk<?> valuesToSort0, ByteChunk<?> valuesToSort1, int lo, int hi,
            long searchValue0, byte searchValue1, final boolean lower) {
    ...
    private static void insertionSort(WritableLongChunk<?> valuesToPermute,
            WritableLongChunk<?> valuesToSort0, WritableByteChunk<?> valuesToSort1, int offset,
            int length) {
    ...
    private static void swap(WritableLongChunk<?> valuesToPermute,
            WritableLongChunk<?> valuesToSort0, WritableByteChunk<?> valuesToSort1, int a, int b) {
    ...
    public static class LongByteMultiColumnSortKernelContext<SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> implements MultiColumnSortKernel<PERMUTE_VALUES_ATTR> {
        int minGallop;
        ...
        private LongByteMultiColumnSortKernelContext(int size) {
        ...
        public void sort(WritableLongChunk<PERMUTE_VALUES_ATTR> valuesToPermute,
            ...
            LongByteMultiColumnTimsortKernel.sort(this, valuesToPermute,
