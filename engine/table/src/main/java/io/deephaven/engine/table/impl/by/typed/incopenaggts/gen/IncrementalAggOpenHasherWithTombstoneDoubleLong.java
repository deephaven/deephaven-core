...
final class IncrementalAggOpenHasherWithTombstoneDoubleLong extends IncrementalChunkedOperatorAggregationStateManagerOpenAddressedBaseWithTombstones {
    ...
    public IncrementalAggOpenHasherWithTombstoneDoubleLong(ColumnSource[] tableKeySources,
