...
final class IncrementalAggHasherLongFloat extends IncrementalChunkedOperatorAggregationStateManagerTypedBase {
    ...
    public IncrementalAggHasherLongFloat(ColumnSource[] tableKeySources,
    ...
    private boolean findOverflow(HashHandler handler, long k0, float k1, int chunkPosition,
