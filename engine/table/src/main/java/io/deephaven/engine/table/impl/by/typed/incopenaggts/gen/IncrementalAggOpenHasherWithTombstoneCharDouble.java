...
final class IncrementalAggOpenHasherWithTombstoneCharDouble extends IncrementalChunkedOperatorAggregationStateManagerOpenAddressedBaseWithTombstones {
    ...
    public IncrementalAggOpenHasherWithTombstoneCharDouble(ColumnSource[] tableKeySources,
