...
final class TypedHasherFloatShort extends IncrementalChunkedOperatorAggregationStateManagerTypedBase {
  ...
  public TypedHasherFloatShort(ColumnSource[] tableKeySources, int tableSize,
    ...
    this.keySource1 = (ShortArraySource) super.mainKeySources[1];
  ...
  private int hash(float v0, short v1) {
  ...
  private boolean findOverflow(HashHandler handler, float v0, short v1, int chunkPosition,
