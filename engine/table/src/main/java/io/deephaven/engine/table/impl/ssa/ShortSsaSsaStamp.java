...
public class ShortSsaSsaStamp implements SsaSsaStamp {
    ...
    public void processEntry(SegmentedSortedArray leftSsa, SegmentedSortedArray rightSsa,
        ...
        processEntry((ShortSegmentedSortedArray) leftSsa, (ShortSegmentedSortedArray) rightSsa, rowRedirection,
                disallowExactMatch);
    }

    private static void processEntry(ShortSegmentedSortedArray leftSsa, ShortSegmentedSortedArray rightSsa,
            WritableRowRedirection rowRedirection, boolean disallowExactMatch) {
    ...
    private static void fillWithValue(WritableRowRedirection rowRedirection, ShortSegmentedSortedArray.Iterator leftIt,
            long rightKey) {
        while (leftIt.hasNext()) {
            leftIt.next();
    ...
    public void processRemovals(SegmentedSortedArray leftSsa, Chunk<? extends Values> rightStampChunk,
        ...
        processRemovals((ShortSegmentedSortedArray) leftSsa, rightStampChunk.asShortChunk(), rightKeys, priorRedirections,
                rowRedirection, modifiedBuilder, disallowExactMatch);
    }

    static private void processRemovals(ShortSegmentedSortedArray leftSsa, ShortChunk<? extends Values> rightStampChunk,
    ...
    public void processInsertion(SegmentedSortedArray leftSsa, Chunk<? extends Values> rightStampChunk,
        ...
        processInsertion((ShortSegmentedSortedArray) leftSsa, rightStampChunk.asShortChunk(), rightKeys,
                nextRightValue.asShortChunk(), rowRedirection, modifiedBuilder, endsWithLastValue, disallowExactMatch);
    }

    static private void processInsertion(ShortSegmentedSortedArray leftSsa, ShortChunk<? extends Values> rightStampChunk,
    ...
    public void findModified(SegmentedSortedArray leftSsa, RowRedirection rowRedirection,
        ...
        findModified((ShortSegmentedSortedArray) leftSsa, rowRedirection, rightStampChunk.asShortChunk(),
                rightStampIndices, modifiedBuilder, disallowExactMatch);
    }

    private static void findModified(ShortSegmentedSortedArray leftSsa, RowRedirection rowRedirection,
    ...
    public void applyShift(SegmentedSortedArray leftSsa, Chunk<? extends Values> rightStampChunk,
        ...
        applyShift((ShortSegmentedSortedArray) leftSsa, rightStampChunk.asShortChunk(), rightStampKeys, shiftDelta,
                rowRedirection, disallowExactMatch);
    }

    private void applyShift(ShortSegmentedSortedArray leftSsa, ShortChunk<? extends Values> rightStampChunk,
            LongChunk<RowKeys> rightStampKeys, long shiftDelta, WritableRowRedirection rowRedirection,
            boolean disallowExactMatch) {
        final ShortSegmentedSortedArray.Iterator leftIt = leftSsa.iterator(disallowExactMatch, false);
