...
public class CharNoExactStampKernel implements StampKernel {
    static final CharNoExactStampKernel INSTANCE = new CharNoExactStampKernel();
    private CharNoExactStampKernel() {} // static use only
