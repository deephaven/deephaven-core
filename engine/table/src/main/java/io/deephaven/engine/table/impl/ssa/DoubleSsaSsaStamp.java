...
public class DoubleSsaSsaStamp implements SsaSsaStamp {
    ...
    public void processEntry(SegmentedSortedArray leftSsa, SegmentedSortedArray rightSsa,
        ...
        processEntry((DoubleSegmentedSortedArray) leftSsa, (DoubleSegmentedSortedArray) rightSsa, rowRedirection,
                disallowExactMatch);
    }

    private static void processEntry(DoubleSegmentedSortedArray leftSsa, DoubleSegmentedSortedArray rightSsa,
            WritableRowRedirection rowRedirection, boolean disallowExactMatch) {
    ...
    private static void fillWithValue(WritableRowRedirection rowRedirection, DoubleSegmentedSortedArray.Iterator leftIt,
            long rightKey) {
        while (leftIt.hasNext()) {
            leftIt.next();
    ...
    public void processRemovals(SegmentedSortedArray leftSsa, Chunk<? extends Values> rightStampChunk,
        ...
        processRemovals((DoubleSegmentedSortedArray) leftSsa, rightStampChunk.asDoubleChunk(), rightKeys, priorRedirections,
                rowRedirection, modifiedBuilder, disallowExactMatch);
    }

    static private void processRemovals(DoubleSegmentedSortedArray leftSsa, DoubleChunk<? extends Values> rightStampChunk,
    ...
    public void findModified(SegmentedSortedArray leftSsa, RowRedirection rowRedirection,
        ...
        findModified((DoubleSegmentedSortedArray) leftSsa, rowRedirection, rightStampChunk.asDoubleChunk(),
                rightStampIndices, modifiedBuilder, disallowExactMatch);
    }

    private static void findModified(DoubleSegmentedSortedArray leftSsa, RowRedirection rowRedirection,
    ...
    public void applyShift(SegmentedSortedArray leftSsa, Chunk<? extends Values> rightStampChunk,
        ...
        applyShift((DoubleSegmentedSortedArray) leftSsa, rightStampChunk.asDoubleChunk(), rightStampKeys, shiftDelta,
                rowRedirection, disallowExactMatch);
    }

    private void applyShift(DoubleSegmentedSortedArray leftSsa, DoubleChunk<? extends Values> rightStampChunk,
            LongChunk<RowKeys> rightStampKeys, long shiftDelta, WritableRowRedirection rowRedirection,
            boolean disallowExactMatch) {
        final DoubleSegmentedSortedArray.Iterator leftIt = leftSsa.iterator(disallowExactMatch, false);
