...
/**
 * This implements a timsort kernel for a multi-column key (Long, Short) that never moves the column values:
 ...
 */
public final class LongShortIndirectMultiColumnTimsortKernel {
    private LongShortIndirectMultiColumnTimsortKernel() {
        throw new UnsupportedOperationException();
    }

    public static <PERMUTE_VALUES_ATTR extends Any> LongShortIndirectMultiColumnSortKernelContext<PERMUTE_VALUES_ATTR> createContext(
            final int size) {
        return new LongShortIndirectMultiColumnSortKernelContext<>(size);
    }
     ...
     */
    public static void sort(LongShortIndirectMultiColumnSortKernelContext<?> context,
    ...
    private static void timSort(LongShortIndirectMultiColumnSortKernelContext<?> context,
            WritableIntChunk<ChunkPositions> positions, LongChunk<?> valuesToSort0,
     ...
     */
    private static int compareColumns(LongChunk<?> valuesToSort0, ShortChunk<?> valuesToSort1,
    ...
    private static void ensureMergeInvariants(
            LongShortIndirectMultiColumnSortKernelContext<?> context,
            WritableIntChunk<ChunkPositions> positions, LongChunk<?> valuesToSort0,
            ShortChunk<?> valuesToSort1) {
        while (context.runCount > 1) {
    ...
    private static void merge(LongShortIndirectMultiColumnSortKernelContext<?> context,
            WritableIntChunk<ChunkPositions> positions, LongChunk<?> valuesToSort0,
     ...
     */
    private static void frontMerge(LongShortIndirectMultiColumnSortKernelContext<?> context,
            WritableIntChunk<ChunkPositions> positions, LongChunk<?> valuesToSort0,
     ...
     * We eventually need to do galloping here, but are skipping that for now
     */
    private static void backMerge(LongShortIndirectMultiColumnSortKernelContext<?> context,
            WritableIntChunk<ChunkPositions> positions, LongChunk<?> valuesToSort0,
    ...
    private static void copyToTemporary(LongShortIndirectMultiColumnSortKernelContext<?> context,
    ...
    private static void insertionSort(WritableIntChunk<ChunkPositions> positions,
            LongChunk<?> valuesToSort0, ShortChunk<?> valuesToSort1, int offset, int length) {
    ...
    public static class LongShortIndirectMultiColumnSortKernelContext<PERMUTE_VALUES_ATTR extends Any> implements MultiColumnSortKernel<PERMUTE_VALUES_ATTR> {
        int minGallop;
        ...
        private LongShortIndirectMultiColumnSortKernelContext(int size) {
        ...
        public void sort(WritableLongChunk<PERMUTE_VALUES_ATTR> valuesToPermute,
            ...
            LongShortIndirectMultiColumnTimsortKernel.sort(this, positions, valuesToSort[0].asLongChunk(), valuesToSort[1].asShortChunk());
