 ...
 */
public final class ShortTimsortDescendingKernel {
    private ShortTimsortDescendingKernel() {
        throw new UnsupportedOperationException();
    }

    public static <ATTR extends Any> ShortSortKernelContext<ATTR> createContext(final int size) {
     ...
     */
    public static <ATTR extends Any> void sort(ShortSortKernelContext<ATTR> context,
            final WritableShortChunk<ATTR> valuesToSort) {
        timSort(context, valuesToSort, 0, valuesToSort.size());
    }

    private static <ATTR extends Any> void timSort(ShortSortKernelContext<ATTR> context,
            WritableShortChunk<ATTR> valuesToSort, int offset, int length) {
        if (length <= 1) {
            return;
        }
    ...
    private static <ATTR extends Any> void ensureMergeInvariants(
            ShortSortKernelContext<ATTR> context, WritableShortChunk<ATTR> valuesToSort) {
        while (context.runCount > 1) {
    ...
    private static <ATTR extends Any> void merge(ShortSortKernelContext<ATTR> context,
            WritableShortChunk<ATTR> valuesToSort, int start1, int length1, int length2) {
     ...
     */
    private static <ATTR extends Any> void frontMerge(ShortSortKernelContext<ATTR> context,
            WritableShortChunk<ATTR> valuesToSort, final int mergeStartPosition, final int start2,
            final int length2) {
        int tempCursor = 0;
     ...
     * We eventually need to do galloping here, but are skipping that for now
     */
    private static <ATTR extends Any> void backMerge(ShortSortKernelContext<ATTR> context,
            WritableShortChunk<ATTR> valuesToSort, final int mergeStartPosition,
            final int length1) {
    ...
    private static <ATTR extends Any> void copyToTemporary(ShortSortKernelContext<ATTR> context,
            WritableShortChunk<ATTR> valuesToSort, int mergeStartPosition, int remaining1) {
    ...
    private static <ATTR extends Any> void copyToChunk(ShortChunk<ATTR> valuesSource,
            WritableShortChunk<ATTR> valuesDest, int sourceStart, int destStart, int length) {
    ...
    private static void insertionSort(WritableShortChunk<?> valuesToSort, int offset, int length) {
    ...
    private static void swap(WritableShortChunk<?> valuesToSort, int a, int b) {
