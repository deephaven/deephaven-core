...
final class StaticAggHasherCharChar extends StaticChunkedOperatorAggregationStateManagerTypedBase {
    ...
    public StaticAggHasherCharChar(ColumnSource[] tableKeySources,
