...
public final class TypedHasherShortInt extends IncrementalChunkedOperatorAggregationStateManagerTypedBase {
  ...
  private boolean findOverflow(HashHandler handler, short v0, int v1, int chunkPosition,
