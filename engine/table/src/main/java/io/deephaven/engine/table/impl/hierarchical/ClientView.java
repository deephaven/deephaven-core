...
public final class ClientView<IFACE_TYPE extends HierarchicalTable<IFACE_TYPE>, IMPL_TYPE extends HierarchicalTableImpl<IFACE_TYPE, IMPL_TYPE>>
    ...
    /**
     * The "base" HierarchicalTableImpl for this instance, which may be {@code HierarchicalTableImpl.this}. Client
     * operations should be applied to the base in order to create new results.
     */
    ...
    /**
     * Name for an optional column of booleans that specify whether descendants of an expanded node should be expanded
     * by default instead of the typical contracted by default.
     */
