...
public final class LongOneOrN {
    ...
    private LongOneOrN() {
        throw new IllegalStateException("LongOneOrN class should never be constructed.");
    }
    ...
    static public final class Block0 {
        ...
        /**
         * Called by the {@link io.deephaven.engine.table.impl.sources.LongSparseArraySource} at the end of a cycle
         ...
         */
         public void clearBlocks2(final RowSet blocks2ToClear,
                                           final SoftRecycler<long[][]> recycler2) {
         ...
         */
        private void clearOneLowestLevelBlock(final long block2Idx, final SoftRecycler<long[]> recycler) {
         ...
         * @param recycler recycler for lowest level blocks
         */
        private void clearOneBlock_2(final long block1Idx, final SoftRecycler<long[][]> recycler) {
        ...
        public void enumerate(long nullValue, LongConsumer consumer) {
            if (oneIndex == ONE_UNINITIALIZED) {
                return;
            }
    ...
    static public final class Block1 {
        ...
        void enumerate(long nullValue, LongConsumer consumer, long offset) {
            if (oneIndex == ONE_UNINITIALIZED) {
                return;
            }
            if (oneIndex != HAVE_MORE_THAN_ONE) {
         ...
         */
        private void clearByIndex(final int idx, final SoftRecycler<long[][]> recycler2) {
            Assert.neq(idx, "idx", HAVE_MORE_THAN_ONE, "HAVE_MORE_THAN_ONE");
            if (oneIndex == idx) {
    ...
    static public final class Block2 {
        ...
        private static void enumerateInner(long nullValue, long[] inner, LongConsumer consumer, long offset) {
        ...
        long estimateSize() {
            ...
            if (oneIndex != HAVE_MORE_THAN_ONE) {
                return (long)oneValue.length * Long.BYTES;
            }
