...
public class TypedStaticChunkedOperatorAggregationStateManager {
    ...
    public static StaticChunkedOperatorAggregationStateManagerTypedBase make(ColumnSource<?>[] tableKeySources
        ...
        try {
            final Constructor<? extends StaticChunkedOperatorAggregationStateManagerTypedBase> constructor1 = castedClass.getDeclaredConstructor(ColumnSource[].class, int.class, double.class, double.class);
    ...
    private static MethodSpec createFindOverflow(ChunkType[] chunkTypes) {
        final MethodSpec.Builder builder = MethodSpec.methodBuilder("findOverflow").addParameter(StaticChunkedOperatorAggregationStateManagerTypedBase.StaticAggHashHandler.class, "handler");
        for (int ii = 0; ii < chunkTypes.length; ++ii) {
        ...
        MethodSpec findOverflow = builder.build();
        return findOverflow;
    }
    ...
    private static MethodSpec createMaybeMoveMainBucket(ChunkType[] chunkTypes) {
        MethodSpec.Builder builder = MethodSpec.methodBuilder("maybeMoveMainBucket").addParameter(StaticChunkedOperatorAggregationStateManagerTypedBase.StaticAggHashHandler.class, "handler").addParameter(int.class, "bucket").addParameter(int.class, "destBucket").addParameter(int.class, "bucketsToAdd").returns(int.class).addModifiers(Modifier.PRIVATE);
    ...
    private static MethodSpec createRehashBucketMethod(ChunkType[] chunkTypes) {
        ...
        return MethodSpec.methodBuilder("rehashBucket").addParameter(StaticChunkedOperatorAggregationStateManagerTypedBase.StaticAggHashHandler.class, "handler").addParameter(int.class, "bucket").addParameter(int.class, "destBucket").addParameter(int.class, "bucketsToAdd").returns(void.class).addModifiers(Modifier.PROTECTED)
    ...
    private static MethodSpec createBuildMethod(ChunkType[] chunkTypes) {
        ...
        final MethodSpec build = MethodSpec.methodBuilder("build")
                .addParameter(StaticChunkedOperatorAggregationStateManagerTypedBase.StaticAggHashHandler.class, "handler")
