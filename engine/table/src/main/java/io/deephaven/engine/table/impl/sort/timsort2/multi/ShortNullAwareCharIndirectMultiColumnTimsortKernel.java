...
/**
 * This implements a timsort kernel for a multi-column key (Short, NullAwareChar) that never moves the column values:
 ...
 */
public final class ShortNullAwareCharIndirectMultiColumnTimsortKernel {
    private ShortNullAwareCharIndirectMultiColumnTimsortKernel() {
        throw new UnsupportedOperationException();
    }

    public static <PERMUTE_VALUES_ATTR extends Any> ShortNullAwareCharIndirectMultiColumnSortKernelContext<PERMUTE_VALUES_ATTR> createContext(
            final int size) {
        return new ShortNullAwareCharIndirectMultiColumnSortKernelContext<>(size);
    }
     ...
     */
    public static void sort(ShortNullAwareCharIndirectMultiColumnSortKernelContext<?> context,
    ...
    private static void timSort(ShortNullAwareCharIndirectMultiColumnSortKernelContext<?> context,
            WritableIntChunk<ChunkPositions> positions, ShortChunk<?> valuesToSort0,
     ...
     */
    private static int compareColumns(ShortChunk<?> valuesToSort0, CharChunk<?> valuesToSort1,
    ...
    private static void ensureMergeInvariants(
            ShortNullAwareCharIndirectMultiColumnSortKernelContext<?> context,
            WritableIntChunk<ChunkPositions> positions, ShortChunk<?> valuesToSort0,
            CharChunk<?> valuesToSort1) {
        while (context.runCount > 1) {
    ...
    private static void merge(ShortNullAwareCharIndirectMultiColumnSortKernelContext<?> context,
            WritableIntChunk<ChunkPositions> positions, ShortChunk<?> valuesToSort0,
     ...
     * We eventually need to do galloping here, but are skipping that for now
     */
    private static void backMerge(ShortNullAwareCharIndirectMultiColumnSortKernelContext<?> context,
            WritableIntChunk<ChunkPositions> positions, ShortChunk<?> valuesToSort0,
    ...
    private static void insertionSort(WritableIntChunk<ChunkPositions> positions,
            ShortChunk<?> valuesToSort0, CharChunk<?> valuesToSort1, int offset, int length) {
    ...
    public static class ShortNullAwareCharIndirectMultiColumnSortKernelContext<PERMUTE_VALUES_ATTR extends Any> implements MultiColumnSortKernel<PERMUTE_VALUES_ATTR> {
        int minGallop;
        ...
        private ShortNullAwareCharIndirectMultiColumnSortKernelContext(int size) {
        ...
        public void sort(WritableLongChunk<PERMUTE_VALUES_ATTR> valuesToPermute,
            ...
            ShortNullAwareCharIndirectMultiColumnTimsortKernel.sort(this, positions, valuesToSort[0].asShortChunk(), valuesToSort[1].asCharChunk());
