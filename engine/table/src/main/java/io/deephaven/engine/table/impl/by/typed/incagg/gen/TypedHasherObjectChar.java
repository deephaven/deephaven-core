...
public final class TypedHasherObjectChar extends IncrementalChunkedOperatorAggregationStateManagerTypedBase {
  ...
  public TypedHasherObjectChar(ColumnSource[] tableKeySources, int tableSize,
  ...
  private int hash(Object v0, char v1) {
  ...
  private boolean findOverflow(HashHandler handler, Object v0, char v1, int chunkPosition,
