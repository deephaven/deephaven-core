...
final class IncrementalAggHasherDoubleByte extends IncrementalChunkedOperatorAggregationStateManagerTypedBase {
    ...
    public IncrementalAggHasherDoubleByte(ColumnSource[] tableKeySources,
    ...
    private boolean findOverflow(HashHandler handler, double k0, byte k1, int chunkPosition,
