...
final class StaticAggOpenHasherDoubleShort extends StaticChunkedOperatorAggregationStateManagerOpenAddressedBase {
    private final ImmutableDoubleArraySource mainKeySource0;

    private final ImmutableShortArraySource mainKeySource1;

    public StaticAggOpenHasherDoubleShort(ColumnSource[] tableKeySources,
