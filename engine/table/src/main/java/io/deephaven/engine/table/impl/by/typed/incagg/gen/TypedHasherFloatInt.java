...
public final class TypedHasherFloatInt extends IncrementalChunkedOperatorAggregationStateManagerTypedBase {
  ...
  public TypedHasherFloatInt(ColumnSource[] tableKeySources, int tableSize,
  ...
  private int hash(float v0, int v1) {
  ...
  private boolean findOverflow(HashHandler handler, float v0, int v1, int chunkPosition,
