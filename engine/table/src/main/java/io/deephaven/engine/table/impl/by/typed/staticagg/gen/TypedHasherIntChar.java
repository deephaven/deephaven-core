...
final class TypedHasherIntChar extends StaticChunkedOperatorAggregationStateManagerTypedBase {
  ...
  public TypedHasherIntChar(ColumnSource[] tableKeySources, int tableSize, double maximumLoadFactor,
  ...
  private int hash(int v0, char v1) {
  ...
  private boolean findOverflow(HashHandler handler, int v0, char v1, int chunkPosition,
