...
public class IntReverseChunkSsaStamp implements ChunkSsaStamp {
    ...
    private static void processEntry(IntChunk<Values> leftStampValues, Chunk<RowKeys> leftStampKeys, IntReverseSegmentedSortedArray ssa, WritableLongChunk<RowKeys> rightKeysForLeft, boolean disallowExactMatch) {
