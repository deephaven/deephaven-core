...
/**
 * This implements a timsort kernel for a multi-column key (Object, Byte) that never moves the column values:
 ...
 */
public final class ObjectByteIndirectMultiColumnTimsortKernel {
    private ObjectByteIndirectMultiColumnTimsortKernel() {
        throw new UnsupportedOperationException();
    }

    public static <PERMUTE_VALUES_ATTR extends Any> ObjectByteIndirectMultiColumnSortKernelContext<PERMUTE_VALUES_ATTR> createContext(
            final int size) {
        return new ObjectByteIndirectMultiColumnSortKernelContext<>(size);
    }
     ...
     */
    public static void sort(ObjectByteIndirectMultiColumnSortKernelContext<?> context,
    ...
    private static void timSort(ObjectByteIndirectMultiColumnSortKernelContext<?> context,
            WritableIntChunk<ChunkPositions> positions, ObjectChunk<Object, ?> valuesToSort0,
     ...
     */
    private static int compareColumns(ObjectChunk<Object, ?> valuesToSort0,
            ByteChunk<?> valuesToSort1, int lhsPos, int rhsPos) {
    ...
    private static void ensureMergeInvariants(
            ObjectByteIndirectMultiColumnSortKernelContext<?> context,
            WritableIntChunk<ChunkPositions> positions, ObjectChunk<Object, ?> valuesToSort0,
            ByteChunk<?> valuesToSort1) {
        while (context.runCount > 1) {
    ...
    private static void merge(ObjectByteIndirectMultiColumnSortKernelContext<?> context,
            WritableIntChunk<ChunkPositions> positions, ObjectChunk<Object, ?> valuesToSort0,
     ...
     */
    private static void frontMerge(ObjectByteIndirectMultiColumnSortKernelContext<?> context,
            WritableIntChunk<ChunkPositions> positions, ObjectChunk<Object, ?> valuesToSort0,
     ...
     * We eventually need to do galloping here, but are skipping that for now
     */
    private static void backMerge(ObjectByteIndirectMultiColumnSortKernelContext<?> context,
            WritableIntChunk<ChunkPositions> positions, ObjectChunk<Object, ?> valuesToSort0,
    ...
    private static void copyToTemporary(ObjectByteIndirectMultiColumnSortKernelContext<?> context,
    ...
    private static int upperBound(IntChunk<ChunkPositions> positions,
            ObjectChunk<Object, ?> valuesToSort0, ByteChunk<?> valuesToSort1, int lo, int hi,
            int searchPos) {
    ...
    private static int bound(IntChunk<ChunkPositions> positions,
            ObjectChunk<Object, ?> valuesToSort0, ByteChunk<?> valuesToSort1, int lo, int hi,
            int searchPos, final boolean lower) {
    ...
    private static void insertionSort(WritableIntChunk<ChunkPositions> positions,
            ObjectChunk<Object, ?> valuesToSort0, ByteChunk<?> valuesToSort1, int offset,
            int length) {
    ...
    public static class ObjectByteIndirectMultiColumnSortKernelContext<PERMUTE_VALUES_ATTR extends Any> implements MultiColumnSortKernel<PERMUTE_VALUES_ATTR> {
        int minGallop;
        ...
        private ObjectByteIndirectMultiColumnSortKernelContext(int size) {
        ...
        public void sort(WritableLongChunk<PERMUTE_VALUES_ATTR> valuesToPermute,
            ...
            ObjectByteIndirectMultiColumnTimsortKernel.sort(this, positions, valuesToSort[0].<Object>asObjectChunk(), valuesToSort[1].asByteChunk());
