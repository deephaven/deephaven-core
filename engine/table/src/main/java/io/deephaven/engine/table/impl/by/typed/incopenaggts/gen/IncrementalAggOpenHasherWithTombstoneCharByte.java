...
final class IncrementalAggOpenHasherWithTombstoneCharByte extends IncrementalChunkedOperatorAggregationStateManagerOpenAddressedBaseWithTombstones {
    ...
    public IncrementalAggOpenHasherWithTombstoneCharByte(ColumnSource[] tableKeySources,
