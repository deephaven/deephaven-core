...
public class ShortCompactKernel implements CompactKernel {
    ...
    public void compactAndCount(
            ...
            boolean countNull,
            boolean countNaN) {
        compactAndCount(valueChunk.asWritableShortChunk(), counts, countNull, countNaN);
    }
    ...
    public void compactAndCount(
            ...
            boolean countNull,
            boolean countNaN) {
        compactAndCount(valueChunk.asWritableShortChunk(), counts, startPositions, lengths, countNull, countNaN);
    }

    public static void compactAndCount(
            WritableShortChunk<? extends Values> valueChunk,
            WritableIntChunk<ChunkLengths> counts) {
    ...
    public static int compactAndCount(
        ...
        for (int rpos = start; rpos < end; ++rpos) {
            ...
            if (!countNull && nextValue == NULL_SHORT) {
                continue;
            }
