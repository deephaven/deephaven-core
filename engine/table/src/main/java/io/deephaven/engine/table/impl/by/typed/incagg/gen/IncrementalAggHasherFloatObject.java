...
final class IncrementalAggHasherFloatObject extends IncrementalChunkedOperatorAggregationStateManagerTypedBase {
    ...
    public IncrementalAggHasherFloatObject(ColumnSource[] tableKeySources,
