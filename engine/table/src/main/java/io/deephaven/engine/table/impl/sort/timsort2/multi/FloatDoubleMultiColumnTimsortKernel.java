...
/**
 * This implements a timsort kernel that sorts a multi-column key (Float, Double), comparing each
 ...
 */
public final class FloatDoubleMultiColumnTimsortKernel {
    private FloatDoubleMultiColumnTimsortKernel() {
        throw new UnsupportedOperationException();
    }

    public static <SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> FloatDoubleMultiColumnSortKernelContext<SORT_VALUES_ATTR, PERMUTE_VALUES_ATTR> createContext(
            final int size) {
        return new FloatDoubleMultiColumnSortKernelContext<>(size);
    }
    ...
    static <SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> void sort(
            FloatDoubleMultiColumnSortKernelContext<SORT_VALUES_ATTR, PERMUTE_VALUES_ATTR> context,
    ...
    private static int upperBound(FloatChunk<?> valuesToSort0, DoubleChunk<?> valuesToSort1, int lo,
            int hi, float searchValue0, double searchValue1) {
    ...
    private static int lowerBound(FloatChunk<?> valuesToSort0, DoubleChunk<?> valuesToSort1, int lo,
            int hi, float searchValue0, double searchValue1) {
    ...
    private static int bound(FloatChunk<?> valuesToSort0, DoubleChunk<?> valuesToSort1, int lo,
            int hi, float searchValue0, double searchValue1, final boolean lower) {
    ...
    private static void insertionSort(WritableLongChunk<?> valuesToPermute,
            WritableFloatChunk<?> valuesToSort0, WritableDoubleChunk<?> valuesToSort1, int offset,
            int length) {
    ...
    private static void swap(WritableLongChunk<?> valuesToPermute,
            WritableFloatChunk<?> valuesToSort0, WritableDoubleChunk<?> valuesToSort1, int a,
            int b) {
    ...
    public static class FloatDoubleMultiColumnSortKernelContext<SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> implements MultiColumnSortKernel<PERMUTE_VALUES_ATTR> {
        int minGallop;
        ...
        private FloatDoubleMultiColumnSortKernelContext(int size) {
        ...
        public void sort(WritableLongChunk<PERMUTE_VALUES_ATTR> valuesToPermute,
            ...
            FloatDoubleMultiColumnTimsortKernel.sort(this, valuesToPermute,
