...
final class TypedHasherCharLong extends IncrementalChunkedOperatorAggregationStateManagerTypedBase {
  ...
  public TypedHasherCharLong(ColumnSource[] tableKeySources, int tableSize,
  ...
  private int hash(char v0, long v1) {
  ...
  private boolean findOverflow(HashHandler handler, char v0, long v1, int chunkPosition,
