...
final class TypedHasherIntShort extends IncrementalChunkedOperatorAggregationStateManagerTypedBase {
  ...
  public TypedHasherIntShort(ColumnSource[] tableKeySources, int tableSize,
  ...
  private int hash(int v0, short v1) {
  ...
  private boolean findOverflow(HashHandler handler, int v0, short v1, int chunkPosition,
