...
public class PercentileBySpecImpl implements Serializable, AggregationSpec {
    private final double percentile;
    private final boolean averageMedian;

    public PercentileBySpecImpl(double percentile) {
        this(percentile, false);
    }

    public PercentileBySpecImpl(double percentile, boolean averageMedian) {
