...
public final class ShortOneOrN {
    ...
    private static final int ELEMENT_SIZE = Short.BYTES;
    ...
    static public final class Block0 {
        ...
        /**
         * Called by the {@link io.deephaven.engine.table.impl.sources.ShortSparseArraySource} at the end of a cycle
         ...
         */
         public void clearLowestLevelBlocks(final RowSet blocksToClear,
                                           final SoftRecycler<short[]> recycler) {
         ...
         */
         public void clearBlocks2(final RowSet blocks2ToClear,
                                           final SoftRecycler<short[][]> recycler2) {
         ...
         */
        private void clearOneLowestLevelBlock(final long block2Idx, final SoftRecycler<short[]> recycler) {
         ...
         * @param recycler recycler for lowest level blocks
         */
        private void clearOneBlock_2(final long block1Idx, final SoftRecycler<short[][]> recycler) {
    ...
    static public final class Block1 {
         ...
         */
        private void clearByIndex(final int idx, final SoftRecycler<short[][]> recycler2) {
            Assert.neq(idx, "idx", HAVE_MORE_THAN_ONE, "HAVE_MORE_THAN_ONE");
            if (oneIndex == idx) {
    ...
    static public final class Block2 {
        ...
        long estimateSize() {
            ...
            if (oneIndex != HAVE_MORE_THAN_ONE) {
                return (long)oneValue.length * Short.BYTES;
            }
