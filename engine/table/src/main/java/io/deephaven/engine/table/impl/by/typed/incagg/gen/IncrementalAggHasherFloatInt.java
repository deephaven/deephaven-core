...
final class IncrementalAggHasherFloatInt extends IncrementalChunkedOperatorAggregationStateManagerTypedBase {
    ...
    public IncrementalAggHasherFloatInt(ColumnSource[] tableKeySources,
    ...
    private boolean findOverflow(HashHandler handler, float k0, int k1, int chunkPosition,
