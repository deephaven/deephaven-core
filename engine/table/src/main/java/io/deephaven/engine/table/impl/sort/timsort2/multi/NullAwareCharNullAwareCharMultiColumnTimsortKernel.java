...
/**
 * This implements a timsort kernel that sorts a multi-column key (NullAwareChar, NullAwareChar), comparing each
 ...
 */
public final class NullAwareCharNullAwareCharMultiColumnTimsortKernel {
    private NullAwareCharNullAwareCharMultiColumnTimsortKernel() {
        throw new UnsupportedOperationException();
    }

    public static <SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> NullAwareCharNullAwareCharMultiColumnSortKernelContext<SORT_VALUES_ATTR, PERMUTE_VALUES_ATTR> createContext(
            final int size) {
        return new NullAwareCharNullAwareCharMultiColumnSortKernelContext<>(size);
    }
    ...
    static <SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> void sort(
            NullAwareCharNullAwareCharMultiColumnSortKernelContext<SORT_VALUES_ATTR, PERMUTE_VALUES_ATTR> context,
            WritableLongChunk<PERMUTE_VALUES_ATTR> valuesToPermute,
            WritableCharChunk<SORT_VALUES_ATTR> valuesToSort0,
            WritableCharChunk<SORT_VALUES_ATTR> valuesToSort1,
    ...
    private static <SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> void timSort(
            ...
            WritableLongChunk<PERMUTE_VALUES_ATTR> valuesToPermute,
            WritableCharChunk<SORT_VALUES_ATTR> valuesToSort0,
            WritableCharChunk<SORT_VALUES_ATTR> valuesToSort1, int offset, int length) {
        if (length <= 1) {
            return;
        }
        ...
        while (startRun < offset + length) {
            char current0 = valuesToSort0.get(startRun);
            ...
            if (startRun + 1 == offset + length) {
                ...
                char next0 = valuesToSort0.get(startRun + 1);
                endRun = startRun + 2;
    ...
    private static int doComparison1(char lhs, char rhs) {
        return CharComparisons.compare(lhs, rhs);
    }
    ...
    private static <SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> void merge(
            ...
            WritableLongChunk<PERMUTE_VALUES_ATTR> valuesToPermute,
            WritableCharChunk<SORT_VALUES_ATTR> valuesToSort0,
            WritableCharChunk<SORT_VALUES_ATTR> valuesToSort1, int start1, int length1,
            int length2) {
        ...
        final char run2lo0 = valuesToSort0.get(start2);
        final char run2lo1 = valuesToSort1.get(start2);
        ...
        final char run1hi0 = valuesToSort0.get(start1 + length1 - 1);
        final char run1hi1 = valuesToSort1.get(start1 + length1 - 1);
    ...
    private static <SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> void frontMerge(
            ...
            WritableLongChunk<PERMUTE_VALUES_ATTR> valuesToPermute,
            WritableCharChunk<SORT_VALUES_ATTR> valuesToSort0,
            WritableCharChunk<SORT_VALUES_ATTR> valuesToSort1, final int mergeStartPosition,
        ...
        char val1_0 = context.temporaryValues0.get(tempCursor);
        char val2_0 = valuesToSort0.get(run2Cursor);
    ...
    private static <SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> void backMerge(
        ...
        char val1_0 = valuesToSort0.get(run1Cursor);
        char val2_0 = context.temporaryValues0.get(tempCursor);
    ...
    private static <SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> void copyToTemporary(
            ...
            WritableLongChunk<PERMUTE_VALUES_ATTR> valuesToPermute,
            WritableCharChunk<SORT_VALUES_ATTR> valuesToSort0,
            WritableCharChunk<SORT_VALUES_ATTR> valuesToSort1, int mergeStartPosition,
            int remaining1) {
    ...
    private static <SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> void copyToChunk(
            LongChunk<PERMUTE_VALUES_ATTR> rowSetSource, CharChunk<SORT_VALUES_ATTR> valuesSource0,
            CharChunk<SORT_VALUES_ATTR> valuesSource1,
            WritableLongChunk<PERMUTE_VALUES_ATTR> permuteValuesDest,
            WritableCharChunk<SORT_VALUES_ATTR> sortValuesDest0,
            WritableCharChunk<SORT_VALUES_ATTR> sortValuesDest1, int sourceStart, int destStart,
            int length) {
    ...
    private static int upperBound(CharChunk<?> valuesToSort0, CharChunk<?> valuesToSort1, int lo,
            int hi, char searchValue0, char searchValue1) {
    ...
    private static int lowerBound(CharChunk<?> valuesToSort0, CharChunk<?> valuesToSort1, int lo,
            int hi, char searchValue0, char searchValue1) {
    ...
    private static int bound(CharChunk<?> valuesToSort0, CharChunk<?> valuesToSort1, int lo, int hi,
            char searchValue0, char searchValue1, final boolean lower) {
    ...
    private static void insertionSort(WritableLongChunk<?> valuesToPermute,
            WritableCharChunk<?> valuesToSort0, WritableCharChunk<?> valuesToSort1, int offset,
            int length) {
    ...
    private static void swap(WritableLongChunk<?> valuesToPermute,
            WritableCharChunk<?> valuesToSort0, WritableCharChunk<?> valuesToSort1, int a, int b) {
        final long tempPermuteValue = valuesToPermute.get(a);
        final char temp0 = valuesToSort0.get(a);
        final char temp1 = valuesToSort1.get(a);
    ...
    public static class NullAwareCharNullAwareCharMultiColumnSortKernelContext<SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> implements MultiColumnSortKernel<PERMUTE_VALUES_ATTR> {
        int minGallop;
        ...
        private final WritableCharChunk<SORT_VALUES_ATTR> temporaryValues0;

        private final WritableCharChunk<SORT_VALUES_ATTR> temporaryValues1;

        private NullAwareCharNullAwareCharMultiColumnSortKernelContext(int size) {
            temporaryKeys = WritableLongChunk.makeWritableChunk((size + 2) / 2);
            temporaryValues0 = WritableCharChunk.makeWritableChunk((size + 2) / 2);
            temporaryValues1 = WritableCharChunk.makeWritableChunk((size + 2) / 2);
        ...
        public void sort(WritableLongChunk<PERMUTE_VALUES_ATTR> valuesToPermute,
            ...
            NullAwareCharNullAwareCharMultiColumnTimsortKernel.sort(this, valuesToPermute,
                            (WritableCharChunk<SORT_VALUES_ATTR>) valuesToSort[0].asWritableCharChunk(),
                            (WritableCharChunk<SORT_VALUES_ATTR>) valuesToSort[1].asWritableCharChunk());
        }
