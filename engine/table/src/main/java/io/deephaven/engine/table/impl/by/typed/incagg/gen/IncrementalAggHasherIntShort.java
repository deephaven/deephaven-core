...
final class IncrementalAggHasherIntShort extends IncrementalChunkedOperatorAggregationStateManagerTypedBase {
    ...
    public IncrementalAggHasherIntShort(ColumnSource[] tableKeySources,
