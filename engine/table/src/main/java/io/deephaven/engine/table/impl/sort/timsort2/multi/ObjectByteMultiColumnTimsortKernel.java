...
/**
 * This implements a timsort kernel that sorts a multi-column key (Object, Byte), comparing each
 ...
 */
public final class ObjectByteMultiColumnTimsortKernel {
    private ObjectByteMultiColumnTimsortKernel() {
        throw new UnsupportedOperationException();
    }

    public static <SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> ObjectByteMultiColumnSortKernelContext<SORT_VALUES_ATTR, PERMUTE_VALUES_ATTR> createContext(
            final int size) {
        return new ObjectByteMultiColumnSortKernelContext<>(size);
    }
    ...
    static <SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> void sort(
            ObjectByteMultiColumnSortKernelContext<SORT_VALUES_ATTR, PERMUTE_VALUES_ATTR> context,
    ...
    private static int upperBound(ObjectChunk<Object, ?> valuesToSort0, ByteChunk<?> valuesToSort1,
            int lo, int hi, Object searchValue0, byte searchValue1) {
    ...
    private static int lowerBound(ObjectChunk<Object, ?> valuesToSort0, ByteChunk<?> valuesToSort1,
            int lo, int hi, Object searchValue0, byte searchValue1) {
    ...
    private static int bound(ObjectChunk<Object, ?> valuesToSort0, ByteChunk<?> valuesToSort1,
            int lo, int hi, Object searchValue0, byte searchValue1, final boolean lower) {
    ...
    private static void insertionSort(WritableLongChunk<?> valuesToPermute,
            WritableObjectChunk<Object, ?> valuesToSort0, WritableByteChunk<?> valuesToSort1,
    ...
    private static void swap(WritableLongChunk<?> valuesToPermute,
            WritableObjectChunk<Object, ?> valuesToSort0, WritableByteChunk<?> valuesToSort1, int a,
            int b) {
    ...
    public static class ObjectByteMultiColumnSortKernelContext<SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> implements MultiColumnSortKernel<PERMUTE_VALUES_ATTR> {
        int minGallop;
        ...
        private ObjectByteMultiColumnSortKernelContext(int size) {
        ...
        public void sort(WritableLongChunk<PERMUTE_VALUES_ATTR> valuesToPermute,
            ...
            ObjectByteMultiColumnTimsortKernel.sort(this, valuesToPermute,
