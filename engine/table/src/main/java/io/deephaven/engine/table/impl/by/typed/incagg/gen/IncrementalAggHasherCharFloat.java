...
final class IncrementalAggHasherCharFloat extends IncrementalChunkedOperatorAggregationStateManagerTypedBase {
    ...
    public IncrementalAggHasherCharFloat(ColumnSource[] tableKeySources,
