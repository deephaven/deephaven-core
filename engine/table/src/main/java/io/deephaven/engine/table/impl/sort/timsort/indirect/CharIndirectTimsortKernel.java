...
/**
 * This implements a timsort kernel for a sort key (Char) that never moves the column values:
 ...
 */
public final class CharIndirectTimsortKernel {
    private CharIndirectTimsortKernel() {
        throw new UnsupportedOperationException();
    }

    public static <PERMUTE_VALUES_ATTR extends Any> CharIndirectSortKernelContext<PERMUTE_VALUES_ATTR> createContext(
            final int size) {
        return new CharIndirectSortKernelContext<>(size);
    }
     ...
     */
    public static void sort(CharIndirectSortKernelContext<?> context,
    ...
    private static void timSort(CharIndirectSortKernelContext<?> context,
    ...
    private static void ensureMergeInvariants(CharIndirectSortKernelContext<?> context,
            WritableIntChunk<ChunkPositions> positions, CharChunk<?> valuesToSort0) {
        while (context.runCount > 1) {
    ...
    private static void merge(CharIndirectSortKernelContext<?> context,
     ...
     */
    private static void frontMerge(CharIndirectSortKernelContext<?> context,
            WritableIntChunk<ChunkPositions> positions, CharChunk<?> valuesToSort0,
     ...
     * We eventually need to do galloping here, but are skipping that for now
     */
    private static void backMerge(CharIndirectSortKernelContext<?> context,
            WritableIntChunk<ChunkPositions> positions, CharChunk<?> valuesToSort0,
    ...
    private static void copyToTemporary(CharIndirectSortKernelContext<?> context,
    ...
    public static class CharIndirectSortKernelContext<PERMUTE_VALUES_ATTR extends Any> implements MultiColumnSortKernel<PERMUTE_VALUES_ATTR> {
        int minGallop;
        ...
        private CharIndirectSortKernelContext(int size) {
            this.size = size;
        ...
        public void sort(WritableLongChunk<PERMUTE_VALUES_ATTR> valuesToPermute,
            ...
            CharIndirectTimsortKernel.sort(this, positions, valuesToSort[0].asCharChunk());
        ...
        public void sortPositions(WritableIntChunk<ChunkPositions> positions,
            ...
            CharIndirectTimsortKernel.timSort(this, positions, valuesToSort[0].asCharChunk(), offset, length);
        }
        ...
        public void mergePositions(WritableIntChunk<ChunkPositions> positions,
            ...
            CharIndirectTimsortKernel.merge(this, positions, valuesToSort[0].asCharChunk(), start1, length1, length2);
        }
