...
/**
 * This implements a timsort kernel that sorts a multi-column key (Double, NullAwareChar), comparing each
 ...
 */
public final class DoubleNullAwareCharMultiColumnTimsortKernel {
    private DoubleNullAwareCharMultiColumnTimsortKernel() {
        throw new UnsupportedOperationException();
    }

    public static <SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> DoubleNullAwareCharMultiColumnSortKernelContext<SORT_VALUES_ATTR, PERMUTE_VALUES_ATTR> createContext(
            final int size) {
        return new DoubleNullAwareCharMultiColumnSortKernelContext<>(size);
    }
    ...
    static <SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> void sort(
            DoubleNullAwareCharMultiColumnSortKernelContext<SORT_VALUES_ATTR, PERMUTE_VALUES_ATTR> context,
            WritableLongChunk<PERMUTE_VALUES_ATTR> valuesToPermute,
            WritableDoubleChunk<SORT_VALUES_ATTR> valuesToSort0,
    ...
    private static <SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> void timSort(
        ...
        while (startRun < offset + length) {
            double current0 = valuesToSort0.get(startRun);
            ...
            if (startRun + 1 == offset + length) {
                ...
                double next0 = valuesToSort0.get(startRun + 1);
                endRun = startRun + 2;
    ...
    private static int doComparison0(double lhs, double rhs) {
    ...
    private static <SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> void merge(
        ...
        final double run2lo0 = valuesToSort0.get(start2);
        ...
        final double run1hi0 = valuesToSort0.get(start1 + length1 - 1);
    ...
    private static <SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> void frontMerge(
        ...
        double val1_0 = context.temporaryValues0.get(tempCursor);
        double val2_0 = valuesToSort0.get(run2Cursor);
    ...
    private static <SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> void backMerge(
        ...
        double val1_0 = valuesToSort0.get(run1Cursor);
        double val2_0 = context.temporaryValues0.get(tempCursor);
    ...
    private static <SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> void copyToChunk(
            ...
            DoubleChunk<SORT_VALUES_ATTR> valuesSource0, CharChunk<SORT_VALUES_ATTR> valuesSource1,
            WritableLongChunk<PERMUTE_VALUES_ATTR> permuteValuesDest,
            WritableDoubleChunk<SORT_VALUES_ATTR> sortValuesDest0,
    ...
    private static int upperBound(DoubleChunk<?> valuesToSort0, CharChunk<?> valuesToSort1, int lo,
            int hi, double searchValue0, char searchValue1) {
    ...
    private static int lowerBound(DoubleChunk<?> valuesToSort0, CharChunk<?> valuesToSort1, int lo,
            int hi, double searchValue0, char searchValue1) {
    ...
    private static int bound(DoubleChunk<?> valuesToSort0, CharChunk<?> valuesToSort1, int lo,
            int hi, double searchValue0, char searchValue1, final boolean lower) {
    ...
    private static void insertionSort(WritableLongChunk<?> valuesToPermute,
            WritableDoubleChunk<?> valuesToSort0, WritableCharChunk<?> valuesToSort1, int offset,
            int length) {
    ...
    private static void swap(WritableLongChunk<?> valuesToPermute,
            WritableDoubleChunk<?> valuesToSort0, WritableCharChunk<?> valuesToSort1, int a,
            int b) {
        final long tempPermuteValue = valuesToPermute.get(a);
        final double temp0 = valuesToSort0.get(a);
    ...
    public static class DoubleNullAwareCharMultiColumnSortKernelContext<SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> implements MultiColumnSortKernel<PERMUTE_VALUES_ATTR> {
        int minGallop;
        ...
        private final WritableDoubleChunk<SORT_VALUES_ATTR> temporaryValues0;

        private final WritableCharChunk<SORT_VALUES_ATTR> temporaryValues1;

        private DoubleNullAwareCharMultiColumnSortKernelContext(int size) {
            temporaryKeys = WritableLongChunk.makeWritableChunk((size + 2) / 2);
            temporaryValues0 = WritableDoubleChunk.makeWritableChunk((size + 2) / 2);
        ...
        public void sort(WritableLongChunk<PERMUTE_VALUES_ATTR> valuesToPermute,
            ...
            DoubleNullAwareCharMultiColumnTimsortKernel.sort(this, valuesToPermute,
                            (WritableDoubleChunk<SORT_VALUES_ATTR>) valuesToSort[0].asWritableDoubleChunk(),
