...
public class IntChunkSsaStamp implements ChunkSsaStamp {
    ...
    public void processEntry(Chunk<Values> leftStampValues, Chunk<RowKeys> leftStampKeys, SegmentedSortedArray ssa,
        ...
        processEntry(leftStampValues.asIntChunk(), leftStampKeys, (IntSegmentedSortedArray) ssa, rightKeysForLeft,
                disallowExactMatch);
    }

    private static void processEntry(IntChunk<Values> leftStampValues, Chunk<RowKeys> leftStampKeys,
            IntSegmentedSortedArray ssa, WritableLongChunk<RowKeys> rightKeysForLeft, boolean disallowExactMatch) {
