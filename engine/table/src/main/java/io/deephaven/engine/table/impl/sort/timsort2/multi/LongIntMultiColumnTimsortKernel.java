...
/**
 * This implements a timsort kernel that sorts a multi-column key (Long, Int), comparing each
 ...
 */
public final class LongIntMultiColumnTimsortKernel {
    private LongIntMultiColumnTimsortKernel() {
        throw new UnsupportedOperationException();
    }

    public static <SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> LongIntMultiColumnSortKernelContext<SORT_VALUES_ATTR, PERMUTE_VALUES_ATTR> createContext(
            final int size) {
        return new LongIntMultiColumnSortKernelContext<>(size);
    }
    ...
    static <SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> void sort(
            LongIntMultiColumnSortKernelContext<SORT_VALUES_ATTR, PERMUTE_VALUES_ATTR> context,
    ...
    private static int upperBound(LongChunk<?> valuesToSort0, IntChunk<?> valuesToSort1, int lo,
            int hi, long searchValue0, int searchValue1) {
    ...
    private static int lowerBound(LongChunk<?> valuesToSort0, IntChunk<?> valuesToSort1, int lo,
            int hi, long searchValue0, int searchValue1) {
    ...
    private static int bound(LongChunk<?> valuesToSort0, IntChunk<?> valuesToSort1, int lo, int hi,
            long searchValue0, int searchValue1, final boolean lower) {
    ...
    private static void insertionSort(WritableLongChunk<?> valuesToPermute,
            WritableLongChunk<?> valuesToSort0, WritableIntChunk<?> valuesToSort1, int offset,
            int length) {
    ...
    private static void swap(WritableLongChunk<?> valuesToPermute,
            WritableLongChunk<?> valuesToSort0, WritableIntChunk<?> valuesToSort1, int a, int b) {
    ...
    public static class LongIntMultiColumnSortKernelContext<SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> implements MultiColumnSortKernel<PERMUTE_VALUES_ATTR> {
        int minGallop;
        ...
        private LongIntMultiColumnSortKernelContext(int size) {
        ...
        public void sort(WritableLongChunk<PERMUTE_VALUES_ATTR> valuesToPermute,
            ...
            LongIntMultiColumnTimsortKernel.sort(this, valuesToPermute,
