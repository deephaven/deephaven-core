...
/**
 * This implements a timsort kernel that sorts a multi-column key (Double, Byte), comparing each
 ...
 */
public final class DoubleByteMultiColumnTimsortKernel {
    private DoubleByteMultiColumnTimsortKernel() {
        throw new UnsupportedOperationException();
    }

    public static <SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> DoubleByteMultiColumnSortKernelContext<SORT_VALUES_ATTR, PERMUTE_VALUES_ATTR> createContext(
            final int size) {
        return new DoubleByteMultiColumnSortKernelContext<>(size);
    }
    ...
    static <SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> void sort(
            DoubleByteMultiColumnSortKernelContext<SORT_VALUES_ATTR, PERMUTE_VALUES_ATTR> context,
    ...
    private static <SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> void copyToChunk(
            ...
            DoubleChunk<SORT_VALUES_ATTR> valuesSource0, ByteChunk<SORT_VALUES_ATTR> valuesSource1,
    ...
    private static int upperBound(DoubleChunk<?> valuesToSort0, ByteChunk<?> valuesToSort1, int lo,
            int hi, double searchValue0, byte searchValue1) {
    ...
    private static int lowerBound(DoubleChunk<?> valuesToSort0, ByteChunk<?> valuesToSort1, int lo,
            int hi, double searchValue0, byte searchValue1) {
    ...
    private static int bound(DoubleChunk<?> valuesToSort0, ByteChunk<?> valuesToSort1, int lo,
            int hi, double searchValue0, byte searchValue1, final boolean lower) {
    ...
    private static void insertionSort(WritableLongChunk<?> valuesToPermute,
            WritableDoubleChunk<?> valuesToSort0, WritableByteChunk<?> valuesToSort1, int offset,
            int length) {
    ...
    private static void swap(WritableLongChunk<?> valuesToPermute,
            WritableDoubleChunk<?> valuesToSort0, WritableByteChunk<?> valuesToSort1, int a,
            int b) {
    ...
    public static class DoubleByteMultiColumnSortKernelContext<SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> implements MultiColumnSortKernel<PERMUTE_VALUES_ATTR> {
        int minGallop;
        ...
        private DoubleByteMultiColumnSortKernelContext(int size) {
        ...
        public void sort(WritableLongChunk<PERMUTE_VALUES_ATTR> valuesToPermute,
            ...
            DoubleByteMultiColumnTimsortKernel.sort(this, valuesToPermute,
