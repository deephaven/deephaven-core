...
public class SlicedRowSetShortVectorColumnWrapper extends ShortVector.Indirect {
    ...
    public SlicedRowSetShortVectorColumnWrapper(@NotNull final ColumnSource<Short> columnSource, @NotNull final RowSet rowSet) {
    ...
    public ShortVector subVector(long fromIndex, long toIndex) {
        ...
        return new SlicedRowSetShortVectorColumnWrapper(columnSource, rowSet.subSetByPositionRange(realFrom, realTo), newStartPadding, newEndPadding);
    }
    ...
    public ShortVector subVectorByPositions(long [] positions) {
        ...
        return new SlicedRowSetShortVectorColumnWrapper(columnSource, builder.build(), 0, 0);
    }
