...
final class IncrementalAggHasherIntLong extends IncrementalChunkedOperatorAggregationStateManagerTypedBase {
    ...
    public IncrementalAggHasherIntLong(ColumnSource[] tableKeySources,
