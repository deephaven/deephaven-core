...
final class IncrementalAggHasherCharByte extends IncrementalChunkedOperatorAggregationStateManagerTypedBase {
    ...
    public IncrementalAggHasherCharByte(ColumnSource[] tableKeySources,
