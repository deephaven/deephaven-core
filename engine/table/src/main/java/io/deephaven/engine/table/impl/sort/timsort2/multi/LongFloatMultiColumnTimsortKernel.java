...
/**
 * This implements a timsort kernel that sorts a multi-column key (Long, Float), comparing each
 ...
 */
public final class LongFloatMultiColumnTimsortKernel {
    private LongFloatMultiColumnTimsortKernel() {
        throw new UnsupportedOperationException();
    }

    public static <SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> LongFloatMultiColumnSortKernelContext<SORT_VALUES_ATTR, PERMUTE_VALUES_ATTR> createContext(
            final int size) {
        return new LongFloatMultiColumnSortKernelContext<>(size);
    }
    ...
    static <SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> void sort(
            LongFloatMultiColumnSortKernelContext<SORT_VALUES_ATTR, PERMUTE_VALUES_ATTR> context,
    ...
    private static int upperBound(LongChunk<?> valuesToSort0, FloatChunk<?> valuesToSort1, int lo,
            int hi, long searchValue0, float searchValue1) {
    ...
    private static int lowerBound(LongChunk<?> valuesToSort0, FloatChunk<?> valuesToSort1, int lo,
            int hi, long searchValue0, float searchValue1) {
    ...
    private static int bound(LongChunk<?> valuesToSort0, FloatChunk<?> valuesToSort1, int lo,
            int hi, long searchValue0, float searchValue1, final boolean lower) {
    ...
    private static void insertionSort(WritableLongChunk<?> valuesToPermute,
            WritableLongChunk<?> valuesToSort0, WritableFloatChunk<?> valuesToSort1, int offset,
            int length) {
    ...
    private static void swap(WritableLongChunk<?> valuesToPermute,
            WritableLongChunk<?> valuesToSort0, WritableFloatChunk<?> valuesToSort1, int a, int b) {
    ...
    public static class LongFloatMultiColumnSortKernelContext<SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> implements MultiColumnSortKernel<PERMUTE_VALUES_ATTR> {
        int minGallop;
        ...
        private LongFloatMultiColumnSortKernelContext(int size) {
        ...
        public void sort(WritableLongChunk<PERMUTE_VALUES_ATTR> valuesToPermute,
            ...
            LongFloatMultiColumnTimsortKernel.sort(this, valuesToPermute,
