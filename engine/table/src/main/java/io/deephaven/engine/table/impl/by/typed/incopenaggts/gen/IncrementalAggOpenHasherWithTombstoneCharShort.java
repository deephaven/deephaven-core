...
final class IncrementalAggOpenHasherWithTombstoneCharShort extends IncrementalChunkedOperatorAggregationStateManagerOpenAddressedBaseWithTombstones {
    ...
    public IncrementalAggOpenHasherWithTombstoneCharShort(ColumnSource[] tableKeySources,
