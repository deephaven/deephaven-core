...
final class IncrementalAggOpenHasherWithTombstoneCharLong extends IncrementalChunkedOperatorAggregationStateManagerOpenAddressedBaseWithTombstones {
    ...
    public IncrementalAggOpenHasherWithTombstoneCharLong(ColumnSource[] tableKeySources,
