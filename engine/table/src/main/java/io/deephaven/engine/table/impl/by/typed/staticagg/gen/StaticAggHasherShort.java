...
final class StaticAggHasherShort extends StaticChunkedOperatorAggregationStateManagerTypedBase {
    private final ShortArraySource mainKeySource0;

    private final ShortArraySource overflowKeySource0;

    public StaticAggHasherShort(ColumnSource[] tableKeySources,
    ...
    private boolean findOverflow(HashHandler handler, short k0, int chunkPosition,
