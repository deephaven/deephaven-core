...
final class StaticAggHasherDouble extends StaticChunkedOperatorAggregationStateManagerTypedBase {
    private final DoubleArraySource mainKeySource0;

    private final DoubleArraySource overflowKeySource0;

    public StaticAggHasherDouble(ColumnSource[] tableKeySources,
