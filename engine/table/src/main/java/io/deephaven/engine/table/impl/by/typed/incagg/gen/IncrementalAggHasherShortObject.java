...
final class IncrementalAggHasherShortObject extends IncrementalChunkedOperatorAggregationStateManagerTypedBase {
    private final ShortArraySource mainKeySource0;

    private final ShortArraySource overflowKeySource0;

    private final ObjectArraySource mainKeySource1;

    private final ObjectArraySource overflowKeySource1;

    public IncrementalAggHasherShortObject(ColumnSource[] tableKeySources,
        ...
        this.mainKeySource1 = (ObjectArraySource) super.mainKeySources[1];
    ...
    private int maybeMoveMainBucket(HashHandler handler, int sourceBucket, int destBucket,
        ...
        if (location == sourceBucket) {
            ...
            mainKeySource1.set(sourceBucket, null);
            handler.doMoveMain(sourceBucket, destBucket);
        }
        return mainInsertLocation;
    }

    private boolean findOverflow(HashHandler handler, short k0, Object k1, int chunkPosition,
