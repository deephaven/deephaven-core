...
/**
 * This implements a timsort kernel for a multi-column key (Double, Short) that never moves the column values:
 ...
 */
public final class DoubleShortIndirectMultiColumnTimsortKernel {
    private DoubleShortIndirectMultiColumnTimsortKernel() {
        throw new UnsupportedOperationException();
    }

    public static <PERMUTE_VALUES_ATTR extends Any> DoubleShortIndirectMultiColumnSortKernelContext<PERMUTE_VALUES_ATTR> createContext(
            final int size) {
        return new DoubleShortIndirectMultiColumnSortKernelContext<>(size);
    }
     ...
     */
    public static void sort(DoubleShortIndirectMultiColumnSortKernelContext<?> context,
            WritableIntChunk<ChunkPositions> positions, DoubleChunk<?> valuesToSort0,
            ShortChunk<?> valuesToSort1) {
        timSort(context, positions, valuesToSort0, valuesToSort1, 0, positions.size());
    }

    private static void timSort(DoubleShortIndirectMultiColumnSortKernelContext<?> context,
            WritableIntChunk<ChunkPositions> positions, DoubleChunk<?> valuesToSort0,
            ShortChunk<?> valuesToSort1, int offset, int length) {
        if (length <= 1) {
            return;
        }
     ...
     */
    private static int compareColumns(DoubleChunk<?> valuesToSort0, ShortChunk<?> valuesToSort1,
    ...
    private static void ensureMergeInvariants(
            DoubleShortIndirectMultiColumnSortKernelContext<?> context,
            WritableIntChunk<ChunkPositions> positions, DoubleChunk<?> valuesToSort0,
            ShortChunk<?> valuesToSort1) {
        while (context.runCount > 1) {
    ...
    private static void merge(DoubleShortIndirectMultiColumnSortKernelContext<?> context,
            WritableIntChunk<ChunkPositions> positions, DoubleChunk<?> valuesToSort0,
            ShortChunk<?> valuesToSort1, int start1, int length1, int length2) {
     ...
     */
    private static void frontMerge(DoubleShortIndirectMultiColumnSortKernelContext<?> context,
            WritableIntChunk<ChunkPositions> positions, DoubleChunk<?> valuesToSort0,
            ShortChunk<?> valuesToSort1, final int mergeStartPosition, final int start2,
            final int length2) {
        int tempCursor = 0;
     ...
     * We eventually need to do galloping here, but are skipping that for now
     */
    private static void backMerge(DoubleShortIndirectMultiColumnSortKernelContext<?> context,
            WritableIntChunk<ChunkPositions> positions, DoubleChunk<?> valuesToSort0,
            ShortChunk<?> valuesToSort1, final int mergeStartPosition, final int length1) {
    ...
    private static void copyToTemporary(DoubleShortIndirectMultiColumnSortKernelContext<?> context,
    ...
    private static int upperBound(IntChunk<ChunkPositions> positions, DoubleChunk<?> valuesToSort0,
            ShortChunk<?> valuesToSort1, int lo, int hi, int searchPos) {
    ...
    private static int bound(IntChunk<ChunkPositions> positions, DoubleChunk<?> valuesToSort0,
            ShortChunk<?> valuesToSort1, int lo, int hi, int searchPos, final boolean lower) {
    ...
    private static void insertionSort(WritableIntChunk<ChunkPositions> positions,
            DoubleChunk<?> valuesToSort0, ShortChunk<?> valuesToSort1, int offset, int length) {
    ...
    public static class DoubleShortIndirectMultiColumnSortKernelContext<PERMUTE_VALUES_ATTR extends Any> implements MultiColumnSortKernel<PERMUTE_VALUES_ATTR> {
        int minGallop;
        ...
        private DoubleShortIndirectMultiColumnSortKernelContext(int size) {
        ...
        public void sort(WritableLongChunk<PERMUTE_VALUES_ATTR> valuesToPermute,
            ...
            DoubleShortIndirectMultiColumnTimsortKernel.sort(this, positions, valuesToSort[0].asDoubleChunk(), valuesToSort[1].asShortChunk());
