...
public final class TypedHasherLongByte extends StaticChunkedOperatorAggregationStateManagerTypedBase {
  ...
  public TypedHasherLongByte(ColumnSource[] tableKeySources, int tableSize,
  ...
  private int hash(long v0, byte v1) {
  ...
  private boolean findOverflow(StaticChunkedOperatorAggregationStateManagerTypedBase.StaticAggHashHandler handler,
      long v0, byte v1, int chunkPosition, int overflowLocation) {
    while (overflowLocation != QueryConstants.NULL_INT) {
