...
/**
 * This implements a timsort kernel that sorts a multi-column key (Short, Int), comparing each
 ...
 */
public final class ShortIntMultiColumnTimsortKernel {
    private ShortIntMultiColumnTimsortKernel() {
        throw new UnsupportedOperationException();
    }

    public static <SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> ShortIntMultiColumnSortKernelContext<SORT_VALUES_ATTR, PERMUTE_VALUES_ATTR> createContext(
            final int size) {
        return new ShortIntMultiColumnSortKernelContext<>(size);
    }
    ...
    static <SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> void sort(
            ShortIntMultiColumnSortKernelContext<SORT_VALUES_ATTR, PERMUTE_VALUES_ATTR> context,
    ...
    private static int upperBound(ShortChunk<?> valuesToSort0, IntChunk<?> valuesToSort1, int lo,
            int hi, short searchValue0, int searchValue1) {
    ...
    private static int lowerBound(ShortChunk<?> valuesToSort0, IntChunk<?> valuesToSort1, int lo,
            int hi, short searchValue0, int searchValue1) {
    ...
    private static int bound(ShortChunk<?> valuesToSort0, IntChunk<?> valuesToSort1, int lo, int hi,
            short searchValue0, int searchValue1, final boolean lower) {
    ...
    private static void insertionSort(WritableLongChunk<?> valuesToPermute,
            WritableShortChunk<?> valuesToSort0, WritableIntChunk<?> valuesToSort1, int offset,
            int length) {
    ...
    private static void swap(WritableLongChunk<?> valuesToPermute,
            WritableShortChunk<?> valuesToSort0, WritableIntChunk<?> valuesToSort1, int a, int b) {
    ...
    public static class ShortIntMultiColumnSortKernelContext<SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> implements MultiColumnSortKernel<PERMUTE_VALUES_ATTR> {
        int minGallop;
        ...
        private ShortIntMultiColumnSortKernelContext(int size) {
        ...
        public void sort(WritableLongChunk<PERMUTE_VALUES_ATTR> valuesToPermute,
            ...
            ShortIntMultiColumnTimsortKernel.sort(this, valuesToPermute,
