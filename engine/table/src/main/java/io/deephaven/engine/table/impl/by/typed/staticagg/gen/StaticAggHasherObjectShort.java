...
final class StaticAggHasherObjectShort extends StaticChunkedOperatorAggregationStateManagerTypedBase {
    ...
    public StaticAggHasherObjectShort(ColumnSource[] tableKeySources,
