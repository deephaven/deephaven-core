...
final class IncrementalAggHasherByteInt extends IncrementalChunkedOperatorAggregationStateManagerTypedBase {
    ...
    public IncrementalAggHasherByteInt(ColumnSource[] tableKeySources,
    ...
    private boolean findOverflow(HashHandler handler, byte k0, int k1, int chunkPosition,
