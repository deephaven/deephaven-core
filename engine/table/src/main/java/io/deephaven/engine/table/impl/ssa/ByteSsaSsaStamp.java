...
public class ByteSsaSsaStamp implements SsaSsaStamp {
    ...
    private static void fillWithNull(WritableRowRedirection rowRedirection, ByteSegmentedSortedArray.Iterator leftIt) {
        while (leftIt.hasNext()) {
            leftIt.next();
            rowRedirection.removeVoid(leftIt.getKey());
        }
    ...
    static private void processInsertion(ByteSegmentedSortedArray leftSsa, ByteChunk<? extends Values> rightStampChunk, LongChunk<Attributes.RowKeys> rightKeys, ByteChunk<Values> nextRightValue, WritableRowRedirection rowRedirection, RowSetBuilderRandom modifiedBuilder, boolean endsWithLastValue, boolean disallowExactMatch) {
    ...
    private static void findModified(ByteSegmentedSortedArray leftSsa, RowRedirection rowRedirection, ByteChunk<? extends Values> rightStampChunk, LongChunk<Attributes.RowKeys> rightStampIndices, RowSetBuilderRandom modifiedBuilder, boolean disallowExactMatch) {
        final ByteSegmentedSortedArray.Iterator leftIt = leftSsa.iterator(disallowExactMatch, false);
    ...
    private void applyShift(ByteSegmentedSortedArray leftSsa, ByteChunk<? extends Values> rightStampChunk, LongChunk<Attributes.RowKeys> rightStampKeys, long shiftDelta, WritableRowRedirection rowRedirection, boolean disallowExactMatch) {
        final ByteSegmentedSortedArray.Iterator leftIt = leftSsa.iterator(disallowExactMatch, false);
