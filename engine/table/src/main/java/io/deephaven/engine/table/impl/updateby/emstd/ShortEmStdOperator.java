...
/***
 * Compute an exponential moving standard deviation for a short column source. The output is expressed as a double value
...
public class ShortEmStdOperator extends BasePrimitiveEmStdOperator {
    ...
    protected class Context extends BasePrimitiveEmStdOperator.Context {
        ...
        public void setValueChunks(@NotNull final Chunk<? extends Values>[] valuesChunks) {
            shortValueChunk = valuesChunks[0].asShortChunk();
        }
    ...
    /**
     * An operator that computes an exponential moving standard deviation from a short column using an exponential decay
     * function.
     *
