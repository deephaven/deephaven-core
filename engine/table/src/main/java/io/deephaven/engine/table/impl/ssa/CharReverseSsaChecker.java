...
import io.deephaven.engine.chunk.util.hashing.CharChunkEquals;
...
public class CharReverseSsaChecker implements SsaChecker {
    ...
    static void checkSsa(CharReverseSegmentedSortedArray ssa, CharChunk<? extends Values> valueChunk, LongChunk<? extends Attributes.RowKeys> tableIndexChunk) {
