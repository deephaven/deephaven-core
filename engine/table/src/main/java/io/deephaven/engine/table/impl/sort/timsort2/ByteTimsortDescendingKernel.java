 ...
 */
public final class ByteTimsortDescendingKernel {
    private ByteTimsortDescendingKernel() {
        throw new UnsupportedOperationException();
    }

    public static <ATTR extends Any> ByteSortKernelContext<ATTR> createContext(final int size) {
     ...
     */
    public static <ATTR extends Any> void sort(ByteSortKernelContext<ATTR> context,
            final WritableByteChunk<ATTR> valuesToSort) {
        timSort(context, valuesToSort, 0, valuesToSort.size());
    }

    private static <ATTR extends Any> void timSort(ByteSortKernelContext<ATTR> context,
            WritableByteChunk<ATTR> valuesToSort, int offset, int length) {
        if (length <= 1) {
            return;
        }
    ...
    private static <ATTR extends Any> void ensureMergeInvariants(
            ByteSortKernelContext<ATTR> context, WritableByteChunk<ATTR> valuesToSort) {
        while (context.runCount > 1) {
    ...
    private static <ATTR extends Any> void merge(ByteSortKernelContext<ATTR> context,
            WritableByteChunk<ATTR> valuesToSort, int start1, int length1, int length2) {
     ...
     */
    private static <ATTR extends Any> void frontMerge(ByteSortKernelContext<ATTR> context,
            WritableByteChunk<ATTR> valuesToSort, final int mergeStartPosition, final int start2,
            final int length2) {
        int tempCursor = 0;
     ...
     * We eventually need to do galloping here, but are skipping that for now
     */
    private static <ATTR extends Any> void backMerge(ByteSortKernelContext<ATTR> context,
            WritableByteChunk<ATTR> valuesToSort, final int mergeStartPosition, final int length1) {
    ...
    private static <ATTR extends Any> void copyToTemporary(ByteSortKernelContext<ATTR> context,
            WritableByteChunk<ATTR> valuesToSort, int mergeStartPosition, int remaining1) {
    ...
    private static <ATTR extends Any> void copyToChunk(ByteChunk<ATTR> valuesSource,
            WritableByteChunk<ATTR> valuesDest, int sourceStart, int destStart, int length) {
    ...
    private static void insertionSort(WritableByteChunk<?> valuesToSort, int offset, int length) {
    ...
    private static void swap(WritableByteChunk<?> valuesToSort, int a, int b) {
