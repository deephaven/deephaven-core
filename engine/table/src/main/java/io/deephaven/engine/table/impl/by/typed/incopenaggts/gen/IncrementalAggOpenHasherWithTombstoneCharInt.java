...
final class IncrementalAggOpenHasherWithTombstoneCharInt extends IncrementalChunkedOperatorAggregationStateManagerOpenAddressedBaseWithTombstones {
    ...
    public IncrementalAggOpenHasherWithTombstoneCharInt(ColumnSource[] tableKeySources,
