...
/**
 * This implements a timsort kernel for a sort key (Long) that never moves the column values:
 ...
 */
public final class LongIndirectTimsortKernel {
    private LongIndirectTimsortKernel() {
        throw new UnsupportedOperationException();
    }

    public static <PERMUTE_VALUES_ATTR extends Any> LongIndirectSortKernelContext<PERMUTE_VALUES_ATTR> createContext(
            final int size) {
        return new LongIndirectSortKernelContext<>(size);
    }
     ...
     */
    public static void sort(LongIndirectSortKernelContext<?> context,
    ...
    private static void timSort(LongIndirectSortKernelContext<?> context,
    ...
    private static void ensureMergeInvariants(LongIndirectSortKernelContext<?> context,
            WritableIntChunk<ChunkPositions> positions, LongChunk<?> valuesToSort0) {
        while (context.runCount > 1) {
    ...
    private static void merge(LongIndirectSortKernelContext<?> context,
     ...
     */
    private static void frontMerge(LongIndirectSortKernelContext<?> context,
            WritableIntChunk<ChunkPositions> positions, LongChunk<?> valuesToSort0,
     ...
     * We eventually need to do galloping here, but are skipping that for now
     */
    private static void backMerge(LongIndirectSortKernelContext<?> context,
            WritableIntChunk<ChunkPositions> positions, LongChunk<?> valuesToSort0,
    ...
    private static void copyToTemporary(LongIndirectSortKernelContext<?> context,
    ...
    public static class LongIndirectSortKernelContext<PERMUTE_VALUES_ATTR extends Any> implements MultiColumnSortKernel<PERMUTE_VALUES_ATTR> {
        int minGallop;
        ...
        private LongIndirectSortKernelContext(int size) {
            this.size = size;
        ...
        public void sort(WritableLongChunk<PERMUTE_VALUES_ATTR> valuesToPermute,
            ...
            LongIndirectTimsortKernel.sort(this, positions, valuesToSort[0].asLongChunk());
        ...
        public void sortPositions(WritableIntChunk<ChunkPositions> positions,
            ...
            LongIndirectTimsortKernel.timSort(this, positions, valuesToSort[0].asLongChunk(), offset, length);
        }
        ...
        public void mergePositions(WritableIntChunk<ChunkPositions> positions,
            ...
            LongIndirectTimsortKernel.merge(this, positions, valuesToSort[0].asLongChunk(), start1, length1, length2);
        }
