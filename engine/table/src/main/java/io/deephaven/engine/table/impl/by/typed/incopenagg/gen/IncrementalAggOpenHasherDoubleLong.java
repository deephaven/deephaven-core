...
final class IncrementalAggOpenHasherDoubleLong extends IncrementalChunkedOperatorAggregationStateManagerOpenAddressedBase {
    ...
    public IncrementalAggOpenHasherDoubleLong(ColumnSource[] tableKeySources,
