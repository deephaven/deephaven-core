...
public class IntCompactKernel implements CompactKernel {
    ...
    public static int compactAndCount(WritableIntChunk<? extends Values> valueChunk, WritableIntChunk<ChunkLengths> counts, final int start, final int length, boolean countNull) {
        int wpos = -1;
