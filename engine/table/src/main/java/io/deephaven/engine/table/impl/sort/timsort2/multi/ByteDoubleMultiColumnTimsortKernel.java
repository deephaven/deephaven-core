...
/**
 * This implements a timsort kernel that sorts a multi-column key (Byte, Double), comparing each
 ...
 */
public final class ByteDoubleMultiColumnTimsortKernel {
    private ByteDoubleMultiColumnTimsortKernel() {
        throw new UnsupportedOperationException();
    }

    public static <SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> ByteDoubleMultiColumnSortKernelContext<SORT_VALUES_ATTR, PERMUTE_VALUES_ATTR> createContext(
            final int size) {
        return new ByteDoubleMultiColumnSortKernelContext<>(size);
    }
    ...
    static <SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> void sort(
            ByteDoubleMultiColumnSortKernelContext<SORT_VALUES_ATTR, PERMUTE_VALUES_ATTR> context,
    ...
    private static int upperBound(ByteChunk<?> valuesToSort0, DoubleChunk<?> valuesToSort1, int lo,
            int hi, byte searchValue0, double searchValue1) {
    ...
    private static int lowerBound(ByteChunk<?> valuesToSort0, DoubleChunk<?> valuesToSort1, int lo,
            int hi, byte searchValue0, double searchValue1) {
    ...
    private static int bound(ByteChunk<?> valuesToSort0, DoubleChunk<?> valuesToSort1, int lo,
            int hi, byte searchValue0, double searchValue1, final boolean lower) {
    ...
    private static void insertionSort(WritableLongChunk<?> valuesToPermute,
            WritableByteChunk<?> valuesToSort0, WritableDoubleChunk<?> valuesToSort1, int offset,
            int length) {
    ...
    private static void swap(WritableLongChunk<?> valuesToPermute,
            WritableByteChunk<?> valuesToSort0, WritableDoubleChunk<?> valuesToSort1, int a,
            int b) {
    ...
    public static class ByteDoubleMultiColumnSortKernelContext<SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> implements MultiColumnSortKernel<PERMUTE_VALUES_ATTR> {
        int minGallop;
        ...
        private ByteDoubleMultiColumnSortKernelContext(int size) {
        ...
        public void sort(WritableLongChunk<PERMUTE_VALUES_ATTR> valuesToPermute,
            ...
            ByteDoubleMultiColumnTimsortKernel.sort(this, valuesToPermute,
