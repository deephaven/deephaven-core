...
/***
 * Compute an exponential moving standard deviation for a int column source. The output is expressed as a double value
 ...
 */
public class IntEmStdOperator extends BasePrimitiveEmStdOperator {
    // region extra-fields
    ...
    protected class Context extends BasePrimitiveEmStdOperator.Context {
        ...
        public void setValueChunks(@NotNull final Chunk<? extends Values>[] valuesChunks) {
            intValueChunk = valuesChunks[0].asIntChunk();
        }
    ...
    /**
     * An operator that computes an exponential moving standard deviation from a int column using an exponential decay
     * function.
     *
