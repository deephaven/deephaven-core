...
final class IncrementalAggOpenHasherCharShort extends IncrementalChunkedOperatorAggregationStateManagerOpenAddressedBase {
    ...
    public IncrementalAggOpenHasherCharShort(ColumnSource[] tableKeySources,
