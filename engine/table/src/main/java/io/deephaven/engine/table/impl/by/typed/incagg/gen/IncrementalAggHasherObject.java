...
final class IncrementalAggHasherObject extends IncrementalChunkedOperatorAggregationStateManagerTypedBase {
    private final ObjectArraySource mainKeySource0;

    private final ObjectArraySource overflowKeySource0;

    public IncrementalAggHasherObject(ColumnSource[] tableKeySources,
