...
final class IncrementalAggHasherFloatChar extends IncrementalChunkedOperatorAggregationStateManagerTypedBase {
    ...
    public IncrementalAggHasherFloatChar(ColumnSource[] tableKeySources,
    ...
    private boolean findOverflow(HashHandler handler, float k0, char k1, int chunkPosition,
