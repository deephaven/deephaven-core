...
/**
 * This implements a timsort kernel that sorts a multi-column key (Short, Byte), comparing each
 ...
 */
public final class ShortByteMultiColumnTimsortKernel {
    private ShortByteMultiColumnTimsortKernel() {
        throw new UnsupportedOperationException();
    }

    public static <SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> ShortByteMultiColumnSortKernelContext<SORT_VALUES_ATTR, PERMUTE_VALUES_ATTR> createContext(
            final int size) {
        return new ShortByteMultiColumnSortKernelContext<>(size);
    }
    ...
    static <SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> void sort(
            ShortByteMultiColumnSortKernelContext<SORT_VALUES_ATTR, PERMUTE_VALUES_ATTR> context,
    ...
    private static int upperBound(ShortChunk<?> valuesToSort0, ByteChunk<?> valuesToSort1, int lo,
            int hi, short searchValue0, byte searchValue1) {
    ...
    private static int lowerBound(ShortChunk<?> valuesToSort0, ByteChunk<?> valuesToSort1, int lo,
            int hi, short searchValue0, byte searchValue1) {
    ...
    private static int bound(ShortChunk<?> valuesToSort0, ByteChunk<?> valuesToSort1, int lo,
            int hi, short searchValue0, byte searchValue1, final boolean lower) {
    ...
    private static void insertionSort(WritableLongChunk<?> valuesToPermute,
            WritableShortChunk<?> valuesToSort0, WritableByteChunk<?> valuesToSort1, int offset,
            int length) {
    ...
    private static void swap(WritableLongChunk<?> valuesToPermute,
            WritableShortChunk<?> valuesToSort0, WritableByteChunk<?> valuesToSort1, int a, int b) {
    ...
    public static class ShortByteMultiColumnSortKernelContext<SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> implements MultiColumnSortKernel<PERMUTE_VALUES_ATTR> {
        int minGallop;
        ...
        private ShortByteMultiColumnSortKernelContext(int size) {
        ...
        public void sort(WritableLongChunk<PERMUTE_VALUES_ATTR> valuesToPermute,
            ...
            ShortByteMultiColumnTimsortKernel.sort(this, valuesToPermute,
