...
final class RightIncrementalAsOfJoinHasherInt extends RightIncrementalAsOfJoinStateManagerTypedBase {
    private ImmutableIntArraySource mainKeySource0;

    private ImmutableIntArraySource alternateKeySource0;

    public RightIncrementalAsOfJoinHasherInt(ColumnSource[] tableKeySources,
