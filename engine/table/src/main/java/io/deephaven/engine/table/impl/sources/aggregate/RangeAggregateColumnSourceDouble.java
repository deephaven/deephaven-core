 ...
 */
public final class RangeAggregateColumnSourceDouble
        extends RangeAggregateColumnSource<DoubleVector, Double> {

    public RangeAggregateColumnSourceDouble(
            @NotNull final ColumnSource<Double> aggregated,
        ...
        super(DoubleVector.class, aggregated, rowSets, startPositionsInclusive, endPositionsExclusive);
    }

    @NotNull
    private DoubleVector makeVector(
            @NotNull final RowSet rowSet,
            final int startPositionInclusive,
            final int length) {
        return new DoubleVectorSlice(
                new DoubleVectorColumnWrapper(aggregated, rowSet),
                startPositionInclusive,
                length);
    }

    @NotNull
    private DoubleVector makePrevVector(
            @NotNull final RowSet rowSet,
            final int startPositionInclusive,
            final int length) {
        return new DoubleVectorSlice(
                new DoubleVectorColumnWrapper(aggregatedPrev, rowSet),
                startPositionInclusive,
                length);
    }
