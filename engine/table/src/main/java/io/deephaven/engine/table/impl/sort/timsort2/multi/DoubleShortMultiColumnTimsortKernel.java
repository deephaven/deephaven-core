...
/**
 * This implements a timsort kernel that sorts a multi-column key (Double, Short), comparing each
 ...
 */
public final class DoubleShortMultiColumnTimsortKernel {
    private DoubleShortMultiColumnTimsortKernel() {
        throw new UnsupportedOperationException();
    }

    public static <SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> DoubleShortMultiColumnSortKernelContext<SORT_VALUES_ATTR, PERMUTE_VALUES_ATTR> createContext(
            final int size) {
        return new DoubleShortMultiColumnSortKernelContext<>(size);
    }
    ...
    static <SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> void sort(
            DoubleShortMultiColumnSortKernelContext<SORT_VALUES_ATTR, PERMUTE_VALUES_ATTR> context,
    ...
    private static <SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> void copyToChunk(
            ...
            DoubleChunk<SORT_VALUES_ATTR> valuesSource0, ShortChunk<SORT_VALUES_ATTR> valuesSource1,
    ...
    private static int upperBound(DoubleChunk<?> valuesToSort0, ShortChunk<?> valuesToSort1, int lo,
            int hi, double searchValue0, short searchValue1) {
    ...
    private static int lowerBound(DoubleChunk<?> valuesToSort0, ShortChunk<?> valuesToSort1, int lo,
            int hi, double searchValue0, short searchValue1) {
    ...
    private static int bound(DoubleChunk<?> valuesToSort0, ShortChunk<?> valuesToSort1, int lo,
            int hi, double searchValue0, short searchValue1, final boolean lower) {
    ...
    private static void insertionSort(WritableLongChunk<?> valuesToPermute,
            WritableDoubleChunk<?> valuesToSort0, WritableShortChunk<?> valuesToSort1, int offset,
            int length) {
    ...
    private static void swap(WritableLongChunk<?> valuesToPermute,
            WritableDoubleChunk<?> valuesToSort0, WritableShortChunk<?> valuesToSort1, int a,
            int b) {
    ...
    public static class DoubleShortMultiColumnSortKernelContext<SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> implements MultiColumnSortKernel<PERMUTE_VALUES_ATTR> {
        int minGallop;
        ...
        private DoubleShortMultiColumnSortKernelContext(int size) {
        ...
        public void sort(WritableLongChunk<PERMUTE_VALUES_ATTR> valuesToPermute,
            ...
            DoubleShortMultiColumnTimsortKernel.sort(this, valuesToPermute,
