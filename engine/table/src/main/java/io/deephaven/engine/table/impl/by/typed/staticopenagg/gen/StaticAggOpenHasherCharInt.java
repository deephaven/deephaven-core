...
final class StaticAggOpenHasherCharInt extends StaticChunkedOperatorAggregationStateManagerOpenAddressedBase {
    private final ImmutableCharArraySource mainKeySource0;

    private final ImmutableIntArraySource mainKeySource1;

    public StaticAggOpenHasherCharInt(ColumnSource[] tableKeySources,
