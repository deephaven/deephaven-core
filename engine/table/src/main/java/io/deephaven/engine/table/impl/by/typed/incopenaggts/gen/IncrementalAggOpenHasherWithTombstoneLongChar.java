...
final class IncrementalAggOpenHasherWithTombstoneLongChar extends IncrementalChunkedOperatorAggregationStateManagerOpenAddressedBaseWithTombstones {
    ...
    public IncrementalAggOpenHasherWithTombstoneLongChar(ColumnSource[] tableKeySources,
