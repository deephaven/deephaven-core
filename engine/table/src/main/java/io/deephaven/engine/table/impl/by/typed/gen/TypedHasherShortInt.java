...
public final class TypedHasherShortInt extends StaticChunkedOperatorAggregationStateManagerTypedBase {
  ...
  public TypedHasherShortInt(ColumnSource[] tableKeySources, int tableSize,
  ...
  private int hash(short v0, int v1) {
  ...
  private boolean findOverflow(StaticChunkedOperatorAggregationStateManagerTypedBase.StaticAggHashHandler handler,
      short v0, int v1, int chunkPosition, int overflowLocation) {
    while (overflowLocation != QueryConstants.NULL_INT) {
