...
/**
 * This implements a timsort kernel for a multi-column key (Object, Long) that never moves the column values:
 ...
 */
public final class ObjectLongIndirectMultiColumnTimsortKernel {
    private ObjectLongIndirectMultiColumnTimsortKernel() {
        throw new UnsupportedOperationException();
    }

    public static <PERMUTE_VALUES_ATTR extends Any> ObjectLongIndirectMultiColumnSortKernelContext<PERMUTE_VALUES_ATTR> createContext(
            final int size) {
        return new ObjectLongIndirectMultiColumnSortKernelContext<>(size);
    }
     ...
     */
    public static void sort(ObjectLongIndirectMultiColumnSortKernelContext<?> context,
    ...
    private static void timSort(ObjectLongIndirectMultiColumnSortKernelContext<?> context,
            WritableIntChunk<ChunkPositions> positions, ObjectChunk<Object, ?> valuesToSort0,
    ...
    private static int compareColumns(ObjectChunk<Object, ?> valuesToSort0,
            LongChunk<?> valuesToSort1, int lhsPos, int rhsPos) {
    ...
    private static void ensureMergeInvariants(
            ObjectLongIndirectMultiColumnSortKernelContext<?> context,
            WritableIntChunk<ChunkPositions> positions, ObjectChunk<Object, ?> valuesToSort0,
            LongChunk<?> valuesToSort1) {
        while (context.runCount > 1) {
    ...
    private static void merge(ObjectLongIndirectMultiColumnSortKernelContext<?> context,
            WritableIntChunk<ChunkPositions> positions, ObjectChunk<Object, ?> valuesToSort0,
     ...
     */
    private static void frontMerge(ObjectLongIndirectMultiColumnSortKernelContext<?> context,
            WritableIntChunk<ChunkPositions> positions, ObjectChunk<Object, ?> valuesToSort0,
     ...
     * We eventually need to do galloping here, but are skipping that for now
     */
    private static void backMerge(ObjectLongIndirectMultiColumnSortKernelContext<?> context,
            WritableIntChunk<ChunkPositions> positions, ObjectChunk<Object, ?> valuesToSort0,
    ...
    private static void copyToTemporary(ObjectLongIndirectMultiColumnSortKernelContext<?> context,
    ...
    private static int upperBound(IntChunk<ChunkPositions> positions,
            ObjectChunk<Object, ?> valuesToSort0, LongChunk<?> valuesToSort1, int lo, int hi,
            int searchPos) {
    ...
    private static void insertionSort(WritableIntChunk<ChunkPositions> positions,
            ObjectChunk<Object, ?> valuesToSort0, LongChunk<?> valuesToSort1, int offset,
            int length) {
    ...
    public static class ObjectLongIndirectMultiColumnSortKernelContext<PERMUTE_VALUES_ATTR extends Any> implements MultiColumnSortKernel<PERMUTE_VALUES_ATTR> {
        int minGallop;
        ...
        private ObjectLongIndirectMultiColumnSortKernelContext(int size) {
        ...
        public void sort(WritableLongChunk<PERMUTE_VALUES_ATTR> valuesToPermute,
            ...
            ObjectLongIndirectMultiColumnTimsortKernel.sort(this, positions, valuesToSort[0].<Object>asObjectChunk(), valuesToSort[1].asLongChunk());
