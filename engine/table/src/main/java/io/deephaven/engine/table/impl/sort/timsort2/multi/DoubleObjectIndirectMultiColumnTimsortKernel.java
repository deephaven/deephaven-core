...
/**
 * This implements a timsort kernel for a multi-column key (Double, Object) that never moves the column values:
 ...
 */
public final class DoubleObjectIndirectMultiColumnTimsortKernel {
    private DoubleObjectIndirectMultiColumnTimsortKernel() {
        throw new UnsupportedOperationException();
    }

    public static <PERMUTE_VALUES_ATTR extends Any> DoubleObjectIndirectMultiColumnSortKernelContext<PERMUTE_VALUES_ATTR> createContext(
            final int size) {
        return new DoubleObjectIndirectMultiColumnSortKernelContext<>(size);
    }
     ...
     */
    public static void sort(DoubleObjectIndirectMultiColumnSortKernelContext<?> context,
    ...
    private static void timSort(DoubleObjectIndirectMultiColumnSortKernelContext<?> context,
            WritableIntChunk<ChunkPositions> positions, DoubleChunk<?> valuesToSort0,
     ...
     */
    private static int compareColumns(DoubleChunk<?> valuesToSort0,
    ...
    private static void ensureMergeInvariants(
            DoubleObjectIndirectMultiColumnSortKernelContext<?> context,
            WritableIntChunk<ChunkPositions> positions, DoubleChunk<?> valuesToSort0,
            ObjectChunk<Object, ?> valuesToSort1) {
        while (context.runCount > 1) {
    ...
    private static void merge(DoubleObjectIndirectMultiColumnSortKernelContext<?> context,
            WritableIntChunk<ChunkPositions> positions, DoubleChunk<?> valuesToSort0,
     ...
     */
    private static void frontMerge(DoubleObjectIndirectMultiColumnSortKernelContext<?> context,
            WritableIntChunk<ChunkPositions> positions, DoubleChunk<?> valuesToSort0,
     ...
     * We eventually need to do galloping here, but are skipping that for now
     */
    private static void backMerge(DoubleObjectIndirectMultiColumnSortKernelContext<?> context,
            WritableIntChunk<ChunkPositions> positions, DoubleChunk<?> valuesToSort0,
    ...
    private static void copyToTemporary(DoubleObjectIndirectMultiColumnSortKernelContext<?> context,
    ...
    private static void insertionSort(WritableIntChunk<ChunkPositions> positions,
            DoubleChunk<?> valuesToSort0, ObjectChunk<Object, ?> valuesToSort1, int offset,
            int length) {
    ...
    public static class DoubleObjectIndirectMultiColumnSortKernelContext<PERMUTE_VALUES_ATTR extends Any> implements MultiColumnSortKernel<PERMUTE_VALUES_ATTR> {
        int minGallop;
        ...
        private DoubleObjectIndirectMultiColumnSortKernelContext(int size) {
        ...
        public void sort(WritableLongChunk<PERMUTE_VALUES_ATTR> valuesToPermute,
            ...
            DoubleObjectIndirectMultiColumnTimsortKernel.sort(this, positions, valuesToSort[0].asDoubleChunk(), valuesToSort[1].<Object>asObjectChunk());
