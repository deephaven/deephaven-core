...
final class StaticAggHasherIntObject extends StaticChunkedOperatorAggregationStateManagerTypedBase {
    ...
    public StaticAggHasherIntObject(ColumnSource[] tableKeySources,
