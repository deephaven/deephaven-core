...
final class IncrementalAggOpenHasherByteInt extends IncrementalChunkedOperatorAggregationStateManagerOpenAddressedBase {
    ...
    public IncrementalAggOpenHasherByteInt(ColumnSource[] tableKeySources,
