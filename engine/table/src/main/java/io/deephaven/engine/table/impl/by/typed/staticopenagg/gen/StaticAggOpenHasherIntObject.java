...
final class StaticAggOpenHasherIntObject extends StaticChunkedOperatorAggregationStateManagerOpenAddressedBase {
    private final ImmutableIntArraySource mainKeySource0;

    private final ImmutableObjectArraySource mainKeySource1;

    public StaticAggOpenHasherIntObject(ColumnSource[] tableKeySources,
