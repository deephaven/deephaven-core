...
public final class BooleanOneOrN {
    ...
    private BooleanOneOrN() {
        throw new IllegalStateException("BooleanOneOrN class should never be constructed.");
    }
    ...
    static public final class Block0 {
         ...
         */
         public void clearLowestLevelBlocks(final RowSet blocksToClear,
                                           final SoftRecycler<boolean[]> recycler) {
         ...
         */
        private void clearOneLowestLevelBlock(final long block2Idx, final SoftRecycler<boolean[]> recycler) {
         ...
         * @param recycler recycler for lowest level blocks
         */
        private void clearOneBlock_2(final long block1Idx, final SoftRecycler<boolean[][]> recycler) {
        ...
        public void enumerate(boolean nullValue, LongConsumer consumer) {
            if (oneIndex == ONE_UNINITIALIZED) {
                return;
            }
    ...
    static public final class Block1 {
        ...
        void enumerate(boolean nullValue, LongConsumer consumer, long offset) {
            if (oneIndex == ONE_UNINITIALIZED) {
                return;
            }
            if (oneIndex != HAVE_MORE_THAN_ONE) {
         ...
         */
        private void clearByIndex(final int idx, final SoftRecycler<boolean[][]> recycler2) {
            Assert.neq(idx, "idx", HAVE_MORE_THAN_ONE, "HAVE_MORE_THAN_ONE");
            if (oneIndex == idx) {
    ...
    static public final class Block2 {
        ...
        public void ensureIndex(int idx, SoftRecycler<boolean [][]> recycler) {
            if (oneIndex == idx || oneIndex == HAVE_MORE_THAN_ONE) {
                return;
            }
            if (oneIndex == ONE_UNINITIALIZED) {
        ...
        public void maybeRecycle(SoftRecycler<boolean [][]> recycler) {
            if (array != null) {
                recycler.returnItem(array);
            }
        }
        ...
        private static void enumerateInner(boolean nullValue, boolean[] inner, LongConsumer consumer, long offset) {
