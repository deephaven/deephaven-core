...
final class IncrementalAggHasherFloat extends IncrementalChunkedOperatorAggregationStateManagerTypedBase {
    private final FloatArraySource mainKeySource0;

    private final FloatArraySource overflowKeySource0;

    public IncrementalAggHasherFloat(ColumnSource[] tableKeySources,
