...
/**
 * This implements a timsort kernel that sorts a multi-column key (Short, Double), comparing each
 ...
 */
public final class ShortDoubleMultiColumnTimsortKernel {
    private ShortDoubleMultiColumnTimsortKernel() {
        throw new UnsupportedOperationException();
    }

    public static <SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> ShortDoubleMultiColumnSortKernelContext<SORT_VALUES_ATTR, PERMUTE_VALUES_ATTR> createContext(
            final int size) {
        return new ShortDoubleMultiColumnSortKernelContext<>(size);
    }
    ...
    static <SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> void sort(
            ShortDoubleMultiColumnSortKernelContext<SORT_VALUES_ATTR, PERMUTE_VALUES_ATTR> context,
            WritableLongChunk<PERMUTE_VALUES_ATTR> valuesToPermute,
            WritableShortChunk<SORT_VALUES_ATTR> valuesToSort0,
            WritableDoubleChunk<SORT_VALUES_ATTR> valuesToSort1,
    ...
    private static <SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> void timSort(
            ...
            WritableLongChunk<PERMUTE_VALUES_ATTR> valuesToPermute,
            WritableShortChunk<SORT_VALUES_ATTR> valuesToSort0,
            WritableDoubleChunk<SORT_VALUES_ATTR> valuesToSort1, int offset, int length) {
        if (length <= 1) {
            return;
        }
        ...
        while (startRun < offset + length) {
            short current0 = valuesToSort0.get(startRun);
            ...
            if (startRun + 1 == offset + length) {
                ...
                short next0 = valuesToSort0.get(startRun + 1);
                endRun = startRun + 2;
    ...
    private static int doComparison1(double lhs, double rhs) {
    ...
    private static <SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> void merge(
            ...
            WritableLongChunk<PERMUTE_VALUES_ATTR> valuesToPermute,
            WritableShortChunk<SORT_VALUES_ATTR> valuesToSort0,
            WritableDoubleChunk<SORT_VALUES_ATTR> valuesToSort1, int start1, int length1,
            int length2) {
        ...
        final short run2lo0 = valuesToSort0.get(start2);
        final double run2lo1 = valuesToSort1.get(start2);
        ...
        final short run1hi0 = valuesToSort0.get(start1 + length1 - 1);
        final double run1hi1 = valuesToSort1.get(start1 + length1 - 1);
    ...
    private static <SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> void frontMerge(
            ...
            WritableLongChunk<PERMUTE_VALUES_ATTR> valuesToPermute,
            WritableShortChunk<SORT_VALUES_ATTR> valuesToSort0,
            WritableDoubleChunk<SORT_VALUES_ATTR> valuesToSort1, final int mergeStartPosition,
        ...
        short val1_0 = context.temporaryValues0.get(tempCursor);
        short val2_0 = valuesToSort0.get(run2Cursor);
    ...
    private static <SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> void backMerge(
        ...
        short val1_0 = valuesToSort0.get(run1Cursor);
        short val2_0 = context.temporaryValues0.get(tempCursor);
    ...
    private static <SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> void copyToTemporary(
            ...
            WritableLongChunk<PERMUTE_VALUES_ATTR> valuesToPermute,
            WritableShortChunk<SORT_VALUES_ATTR> valuesToSort0,
            WritableDoubleChunk<SORT_VALUES_ATTR> valuesToSort1, int mergeStartPosition,
            int remaining1) {
    ...
    private static <SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> void copyToChunk(
            LongChunk<PERMUTE_VALUES_ATTR> rowSetSource, ShortChunk<SORT_VALUES_ATTR> valuesSource0,
            DoubleChunk<SORT_VALUES_ATTR> valuesSource1,
            WritableLongChunk<PERMUTE_VALUES_ATTR> permuteValuesDest,
            WritableShortChunk<SORT_VALUES_ATTR> sortValuesDest0,
            WritableDoubleChunk<SORT_VALUES_ATTR> sortValuesDest1, int sourceStart, int destStart,
            int length) {
    ...
    private static int upperBound(ShortChunk<?> valuesToSort0, DoubleChunk<?> valuesToSort1, int lo,
            int hi, short searchValue0, double searchValue1) {
    ...
    private static int lowerBound(ShortChunk<?> valuesToSort0, DoubleChunk<?> valuesToSort1, int lo,
            int hi, short searchValue0, double searchValue1) {
    ...
    private static int bound(ShortChunk<?> valuesToSort0, DoubleChunk<?> valuesToSort1, int lo,
            int hi, short searchValue0, double searchValue1, final boolean lower) {
    ...
    private static void insertionSort(WritableLongChunk<?> valuesToPermute,
            WritableShortChunk<?> valuesToSort0, WritableDoubleChunk<?> valuesToSort1, int offset,
            int length) {
    ...
    private static void swap(WritableLongChunk<?> valuesToPermute,
            WritableShortChunk<?> valuesToSort0, WritableDoubleChunk<?> valuesToSort1, int a,
            int b) {
        final long tempPermuteValue = valuesToPermute.get(a);
        final short temp0 = valuesToSort0.get(a);
        final double temp1 = valuesToSort1.get(a);
    ...
    public static class ShortDoubleMultiColumnSortKernelContext<SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> implements MultiColumnSortKernel<PERMUTE_VALUES_ATTR> {
        int minGallop;
        ...
        private final WritableShortChunk<SORT_VALUES_ATTR> temporaryValues0;

        private final WritableDoubleChunk<SORT_VALUES_ATTR> temporaryValues1;

        private ShortDoubleMultiColumnSortKernelContext(int size) {
            temporaryKeys = WritableLongChunk.makeWritableChunk((size + 2) / 2);
            temporaryValues0 = WritableShortChunk.makeWritableChunk((size + 2) / 2);
            temporaryValues1 = WritableDoubleChunk.makeWritableChunk((size + 2) / 2);
        ...
        public void sort(WritableLongChunk<PERMUTE_VALUES_ATTR> valuesToPermute,
            ...
            ShortDoubleMultiColumnTimsortKernel.sort(this, valuesToPermute,
                            (WritableShortChunk<SORT_VALUES_ATTR>) valuesToSort[0].asWritableShortChunk(),
                            (WritableDoubleChunk<SORT_VALUES_ATTR>) valuesToSort[1].asWritableDoubleChunk());
        }
