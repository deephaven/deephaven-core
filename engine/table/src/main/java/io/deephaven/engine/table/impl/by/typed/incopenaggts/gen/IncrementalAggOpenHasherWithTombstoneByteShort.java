...
final class IncrementalAggOpenHasherWithTombstoneByteShort extends IncrementalChunkedOperatorAggregationStateManagerOpenAddressedBaseWithTombstones {
    ...
    public IncrementalAggOpenHasherWithTombstoneByteShort(ColumnSource[] tableKeySources,
