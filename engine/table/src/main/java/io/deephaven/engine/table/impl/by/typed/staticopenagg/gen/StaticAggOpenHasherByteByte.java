...
final class StaticAggOpenHasherByteByte extends StaticChunkedOperatorAggregationStateManagerOpenAddressedBase {
    private final ImmutableByteArraySource mainKeySource0;

    private final ImmutableByteArraySource mainKeySource1;

    public StaticAggOpenHasherByteByte(ColumnSource[] tableKeySources,
