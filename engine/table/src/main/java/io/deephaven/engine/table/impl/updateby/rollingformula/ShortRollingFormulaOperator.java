...
public class ShortRollingFormulaOperator extends BaseRollingFormulaOperator {
    ...
    protected class Context extends BaseRollingFormulaOperator.Context {
        ...
        protected Context(final int affectedChunkSize, final int influencerChunkSize) {
            ...
            final SingleValueColumnSource<ShortVector> formulaInputSource = (SingleValueColumnSource<ShortVector>) SingleValueColumnSource.getSingleValueColumnSource(vectorType);
