...
/**
 * This implements a timsort kernel that sorts a multi-column key (Object, Short), comparing each
 ...
 */
public final class ObjectShortMultiColumnTimsortKernel {
    private ObjectShortMultiColumnTimsortKernel() {
        throw new UnsupportedOperationException();
    }

    public static <SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> ObjectShortMultiColumnSortKernelContext<SORT_VALUES_ATTR, PERMUTE_VALUES_ATTR> createContext(
            final int size) {
        return new ObjectShortMultiColumnSortKernelContext<>(size);
    }
    ...
    static <SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> void sort(
            ObjectShortMultiColumnSortKernelContext<SORT_VALUES_ATTR, PERMUTE_VALUES_ATTR> context,
    ...
    private static int upperBound(ObjectChunk<Object, ?> valuesToSort0, ShortChunk<?> valuesToSort1,
            int lo, int hi, Object searchValue0, short searchValue1) {
    ...
    private static int lowerBound(ObjectChunk<Object, ?> valuesToSort0, ShortChunk<?> valuesToSort1,
            int lo, int hi, Object searchValue0, short searchValue1) {
    ...
    private static int bound(ObjectChunk<Object, ?> valuesToSort0, ShortChunk<?> valuesToSort1,
            int lo, int hi, Object searchValue0, short searchValue1, final boolean lower) {
    ...
    private static void insertionSort(WritableLongChunk<?> valuesToPermute,
            WritableObjectChunk<Object, ?> valuesToSort0, WritableShortChunk<?> valuesToSort1,
    ...
    public static class ObjectShortMultiColumnSortKernelContext<SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> implements MultiColumnSortKernel<PERMUTE_VALUES_ATTR> {
        int minGallop;
        ...
        private ObjectShortMultiColumnSortKernelContext(int size) {
        ...
        public void sort(WritableLongChunk<PERMUTE_VALUES_ATTR> valuesToPermute,
            ...
            ObjectShortMultiColumnTimsortKernel.sort(this, valuesToPermute,
