...
public class LongSsaSsaStamp implements SsaSsaStamp {
    ...
    public void processEntry(SegmentedSortedArray leftSsa, SegmentedSortedArray rightSsa,
        ...
        processEntry((LongSegmentedSortedArray) leftSsa, (LongSegmentedSortedArray) rightSsa, rowRedirection,
                disallowExactMatch);
    }

    private static void processEntry(LongSegmentedSortedArray leftSsa, LongSegmentedSortedArray rightSsa,
            WritableRowRedirection rowRedirection, boolean disallowExactMatch) {
    ...
    private static void fillWithValue(WritableRowRedirection rowRedirection, LongSegmentedSortedArray.Iterator leftIt,
            long rightKey) {
        while (leftIt.hasNext()) {
            leftIt.next();
    ...
    public void applyShift(SegmentedSortedArray leftSsa, Chunk<? extends Values> rightStampChunk,
        ...
        applyShift((LongSegmentedSortedArray) leftSsa, rightStampChunk.asLongChunk(), rightStampKeys, shiftDelta,
                rowRedirection, disallowExactMatch);
    }

    private void applyShift(LongSegmentedSortedArray leftSsa, LongChunk<? extends Values> rightStampChunk,
            LongChunk<RowKeys> rightStampKeys, long shiftDelta, WritableRowRedirection rowRedirection,
            boolean disallowExactMatch) {
        final LongSegmentedSortedArray.Iterator leftIt = leftSsa.iterator(disallowExactMatch, false);
