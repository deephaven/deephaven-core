...
final class IncrementalAggOpenHasherWithTombstoneLongByte extends IncrementalChunkedOperatorAggregationStateManagerOpenAddressedBaseWithTombstones {
    ...
    public IncrementalAggOpenHasherWithTombstoneLongByte(ColumnSource[] tableKeySources,
