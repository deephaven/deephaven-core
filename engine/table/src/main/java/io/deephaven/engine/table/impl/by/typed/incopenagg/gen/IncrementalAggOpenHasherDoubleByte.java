...
final class IncrementalAggOpenHasherDoubleByte extends IncrementalChunkedOperatorAggregationStateManagerOpenAddressedBase {
    ...
    public IncrementalAggOpenHasherDoubleByte(ColumnSource[] tableKeySources,
