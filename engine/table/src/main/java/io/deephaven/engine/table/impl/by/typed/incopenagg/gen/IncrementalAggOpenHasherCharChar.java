...
final class IncrementalAggOpenHasherCharChar extends IncrementalChunkedOperatorAggregationStateManagerOpenAddressedBase {
    ...
    public IncrementalAggOpenHasherCharChar(ColumnSource[] tableKeySources,
