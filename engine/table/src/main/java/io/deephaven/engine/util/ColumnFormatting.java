...
public interface ColumnFormatting {
    ...
    AxisOptions axisOption = AxisOptions.Proportional;
    ...
    ValuePlacementOptions valuePlacementOption = ValuePlacementOptions.Beside;
    ...
    DirectionOptions directionOption = DirectionOptions.LTR;
}
