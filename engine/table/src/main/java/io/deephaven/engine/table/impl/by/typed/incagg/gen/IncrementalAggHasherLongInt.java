...
final class IncrementalAggHasherLongInt extends IncrementalChunkedOperatorAggregationStateManagerTypedBase {
    ...
    public IncrementalAggHasherLongInt(ColumnSource[] tableKeySources,
    ...
    private boolean findOverflow(HashHandler handler, long k0, int k1, int chunkPosition,
