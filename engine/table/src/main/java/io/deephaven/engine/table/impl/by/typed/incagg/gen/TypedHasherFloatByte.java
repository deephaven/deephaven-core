...
final class TypedHasherFloatByte extends IncrementalChunkedOperatorAggregationStateManagerTypedBase {
  ...
  public TypedHasherFloatByte(ColumnSource[] tableKeySources, int tableSize,
      double maximumLoadFactor, double targetLoadFactor) {
    super(tableKeySources, tableSize, maximumLoadFactor, targetLoadFactor);
    this.keySource0 = (FloatArraySource) super.mainKeySources[0];
    this.overflowKeySource0 = (FloatArraySource) super.overflowKeySources[0];
    this.keySource1 = (ByteArraySource) super.mainKeySources[1];
  ...
  private int hash(float v0, byte v1) {
  ...
  private boolean findOverflow(HashHandler handler, float v0, byte v1, int chunkPosition,
