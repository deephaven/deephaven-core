...
final class StaticAggOpenHasherObjectInt extends StaticChunkedOperatorAggregationStateManagerOpenAddressedBase {
    private final ImmutableObjectArraySource mainKeySource0;

    private final ImmutableIntArraySource mainKeySource1;

    public StaticAggOpenHasherObjectInt(ColumnSource[] tableKeySources,
