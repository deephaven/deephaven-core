...
final class StaticAggHasherByteShort extends StaticChunkedOperatorAggregationStateManagerTypedBase {
    ...
    public StaticAggHasherByteShort(ColumnSource[] tableKeySources,
    ...
    private boolean findOverflow(HashHandler handler, byte k0, short k1, int chunkPosition,
