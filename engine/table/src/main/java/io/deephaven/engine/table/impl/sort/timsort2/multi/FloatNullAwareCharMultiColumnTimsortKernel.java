...
/**
 * This implements a timsort kernel that sorts a multi-column key (Float, NullAwareChar), comparing each
 ...
 */
public final class FloatNullAwareCharMultiColumnTimsortKernel {
    private FloatNullAwareCharMultiColumnTimsortKernel() {
        throw new UnsupportedOperationException();
    }

    public static <SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> FloatNullAwareCharMultiColumnSortKernelContext<SORT_VALUES_ATTR, PERMUTE_VALUES_ATTR> createContext(
            final int size) {
        return new FloatNullAwareCharMultiColumnSortKernelContext<>(size);
    }
    ...
    static <SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> void sort(
            FloatNullAwareCharMultiColumnSortKernelContext<SORT_VALUES_ATTR, PERMUTE_VALUES_ATTR> context,
    ...
    private static int upperBound(FloatChunk<?> valuesToSort0, CharChunk<?> valuesToSort1, int lo,
            int hi, float searchValue0, char searchValue1) {
    ...
    private static int lowerBound(FloatChunk<?> valuesToSort0, CharChunk<?> valuesToSort1, int lo,
            int hi, float searchValue0, char searchValue1) {
    ...
    private static int bound(FloatChunk<?> valuesToSort0, CharChunk<?> valuesToSort1, int lo,
            int hi, float searchValue0, char searchValue1, final boolean lower) {
    ...
    private static void insertionSort(WritableLongChunk<?> valuesToPermute,
            WritableFloatChunk<?> valuesToSort0, WritableCharChunk<?> valuesToSort1, int offset,
            int length) {
    ...
    private static void swap(WritableLongChunk<?> valuesToPermute,
            WritableFloatChunk<?> valuesToSort0, WritableCharChunk<?> valuesToSort1, int a, int b) {
    ...
    public static class FloatNullAwareCharMultiColumnSortKernelContext<SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> implements MultiColumnSortKernel<PERMUTE_VALUES_ATTR> {
        int minGallop;
        ...
        private FloatNullAwareCharMultiColumnSortKernelContext(int size) {
        ...
        public void sort(WritableLongChunk<PERMUTE_VALUES_ATTR> valuesToPermute,
            ...
            FloatNullAwareCharMultiColumnTimsortKernel.sort(this, valuesToPermute,
