...
/**
 * This implements a timsort kernel for a multi-column key (Object, Object) that never moves the column values:
 ...
 */
public final class ObjectObjectIndirectMultiColumnTimsortKernel {
    private ObjectObjectIndirectMultiColumnTimsortKernel() {
        throw new UnsupportedOperationException();
    }

    public static <PERMUTE_VALUES_ATTR extends Any> ObjectObjectIndirectMultiColumnSortKernelContext<PERMUTE_VALUES_ATTR> createContext(
            final int size) {
        return new ObjectObjectIndirectMultiColumnSortKernelContext<>(size);
    }
     ...
     */
    public static void sort(ObjectObjectIndirectMultiColumnSortKernelContext<?> context,
    ...
    private static void timSort(ObjectObjectIndirectMultiColumnSortKernelContext<?> context,
            WritableIntChunk<ChunkPositions> positions, ObjectChunk<Object, ?> valuesToSort0,
    ...
    private static void ensureMergeInvariants(
            ObjectObjectIndirectMultiColumnSortKernelContext<?> context,
            WritableIntChunk<ChunkPositions> positions, ObjectChunk<Object, ?> valuesToSort0,
            ObjectChunk<Object, ?> valuesToSort1) {
        while (context.runCount > 1) {
    ...
    private static void merge(ObjectObjectIndirectMultiColumnSortKernelContext<?> context,
            WritableIntChunk<ChunkPositions> positions, ObjectChunk<Object, ?> valuesToSort0,
     ...
     */
    private static void frontMerge(ObjectObjectIndirectMultiColumnSortKernelContext<?> context,
            WritableIntChunk<ChunkPositions> positions, ObjectChunk<Object, ?> valuesToSort0,
     ...
     * We eventually need to do galloping here, but are skipping that for now
     */
    private static void backMerge(ObjectObjectIndirectMultiColumnSortKernelContext<?> context,
            WritableIntChunk<ChunkPositions> positions, ObjectChunk<Object, ?> valuesToSort0,
    ...
    private static void copyToTemporary(ObjectObjectIndirectMultiColumnSortKernelContext<?> context,
    ...
    private static int upperBound(IntChunk<ChunkPositions> positions,
            ObjectChunk<Object, ?> valuesToSort0, ObjectChunk<Object, ?> valuesToSort1, int lo,
    ...
    private static void insertionSort(WritableIntChunk<ChunkPositions> positions,
            ObjectChunk<Object, ?> valuesToSort0, ObjectChunk<Object, ?> valuesToSort1, int offset,
            int length) {
    ...
    public static class ObjectObjectIndirectMultiColumnSortKernelContext<PERMUTE_VALUES_ATTR extends Any> implements MultiColumnSortKernel<PERMUTE_VALUES_ATTR> {
        int minGallop;
        ...
        private ObjectObjectIndirectMultiColumnSortKernelContext(int size) {
        ...
        public void sort(WritableLongChunk<PERMUTE_VALUES_ATTR> valuesToPermute,
            ...
            ObjectObjectIndirectMultiColumnTimsortKernel.sort(this, positions, valuesToSort[0].<Object>asObjectChunk(), valuesToSort[1].<Object>asObjectChunk());
