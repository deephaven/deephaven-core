...
final class StaticAggOpenHasherDoubleChar extends StaticChunkedOperatorAggregationStateManagerOpenAddressedBase {
    private final ImmutableDoubleArraySource mainKeySource0;

    private final ImmutableCharArraySource mainKeySource1;

    public StaticAggOpenHasherDoubleChar(ColumnSource[] tableKeySources,
