...
final class StaticAggHasherDoubleInt extends StaticChunkedOperatorAggregationStateManagerTypedBase {
    ...
    public StaticAggHasherDoubleInt(ColumnSource[] tableKeySources,
    ...
    private boolean findOverflow(HashHandler handler, double k0, int k1, int chunkPosition,
