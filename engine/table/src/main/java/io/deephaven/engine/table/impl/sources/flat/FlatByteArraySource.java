 ...
 */
public class FlatByteArraySource extends AbstractColumnSource<Byte> implements ImmutableColumnSourceGetDefaults.ForByte, WritableColumnSource<Byte>, FillUnordered, InMemoryColumnSource, ChunkedBackingStoreExposedWritableSource {
    private final byte[] data;

    // region constructor
    public FlatByteArraySource(long size) {
        super(byte.class);
        this.data = new byte[Math.toIntExact(size)];
    }
