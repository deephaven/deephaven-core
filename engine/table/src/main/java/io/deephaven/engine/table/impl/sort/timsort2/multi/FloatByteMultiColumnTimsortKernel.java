...
/**
 * This implements a timsort kernel that sorts a multi-column key (Float, Byte), comparing each
 ...
 */
public final class FloatByteMultiColumnTimsortKernel {
    private FloatByteMultiColumnTimsortKernel() {
        throw new UnsupportedOperationException();
    }

    public static <SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> FloatByteMultiColumnSortKernelContext<SORT_VALUES_ATTR, PERMUTE_VALUES_ATTR> createContext(
            final int size) {
        return new FloatByteMultiColumnSortKernelContext<>(size);
    }
    ...
    static <SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> void sort(
            FloatByteMultiColumnSortKernelContext<SORT_VALUES_ATTR, PERMUTE_VALUES_ATTR> context,
    ...
    private static int upperBound(FloatChunk<?> valuesToSort0, ByteChunk<?> valuesToSort1, int lo,
            int hi, float searchValue0, byte searchValue1) {
    ...
    private static int lowerBound(FloatChunk<?> valuesToSort0, ByteChunk<?> valuesToSort1, int lo,
            int hi, float searchValue0, byte searchValue1) {
    ...
    private static int bound(FloatChunk<?> valuesToSort0, ByteChunk<?> valuesToSort1, int lo,
            int hi, float searchValue0, byte searchValue1, final boolean lower) {
    ...
    private static void insertionSort(WritableLongChunk<?> valuesToPermute,
            WritableFloatChunk<?> valuesToSort0, WritableByteChunk<?> valuesToSort1, int offset,
            int length) {
    ...
    private static void swap(WritableLongChunk<?> valuesToPermute,
            WritableFloatChunk<?> valuesToSort0, WritableByteChunk<?> valuesToSort1, int a, int b) {
    ...
    public static class FloatByteMultiColumnSortKernelContext<SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> implements MultiColumnSortKernel<PERMUTE_VALUES_ATTR> {
        int minGallop;
        ...
        private FloatByteMultiColumnSortKernelContext(int size) {
        ...
        public void sort(WritableLongChunk<PERMUTE_VALUES_ATTR> valuesToPermute,
            ...
            FloatByteMultiColumnTimsortKernel.sort(this, valuesToPermute,
