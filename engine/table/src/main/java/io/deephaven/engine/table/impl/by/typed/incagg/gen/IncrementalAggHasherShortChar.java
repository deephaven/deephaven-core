...
final class IncrementalAggHasherShortChar extends IncrementalChunkedOperatorAggregationStateManagerTypedBase {
    ...
    public IncrementalAggHasherShortChar(ColumnSource[] tableKeySources,
    ...
    private boolean findOverflow(HashHandler handler, short k0, char k1, int chunkPosition,
