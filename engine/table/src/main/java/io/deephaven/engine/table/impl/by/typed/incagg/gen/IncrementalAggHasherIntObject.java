...
final class IncrementalAggHasherIntObject extends IncrementalChunkedOperatorAggregationStateManagerTypedBase {
    ...
    private static int hash(int k0, Object k1) {
    ...
    private boolean findOverflow(HashHandler handler, int k0, Object k1, int chunkPosition,
