...
/**
 * This implements a timsort kernel that sorts a multi-column key (Byte, Object), comparing each
 ...
 */
public final class ByteObjectMultiColumnTimsortKernel {
    private ByteObjectMultiColumnTimsortKernel() {
        throw new UnsupportedOperationException();
    }

    public static <SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> ByteObjectMultiColumnSortKernelContext<SORT_VALUES_ATTR, PERMUTE_VALUES_ATTR> createContext(
            final int size) {
        return new ByteObjectMultiColumnSortKernelContext<>(size);
    }
    ...
    static <SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> void sort(
            ByteObjectMultiColumnSortKernelContext<SORT_VALUES_ATTR, PERMUTE_VALUES_ATTR> context,
            WritableLongChunk<PERMUTE_VALUES_ATTR> valuesToPermute,
            WritableByteChunk<SORT_VALUES_ATTR> valuesToSort0,
            WritableObjectChunk<Object, SORT_VALUES_ATTR> valuesToSort1,
    ...
    private static <SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> void timSort(
            ...
            WritableLongChunk<PERMUTE_VALUES_ATTR> valuesToPermute,
            WritableByteChunk<SORT_VALUES_ATTR> valuesToSort0,
            WritableObjectChunk<Object, SORT_VALUES_ATTR> valuesToSort1, int offset, int length) {
        if (length <= 1) {
            return;
        }
    ...
    private static <SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> void merge(
            ...
            WritableLongChunk<PERMUTE_VALUES_ATTR> valuesToPermute,
            WritableByteChunk<SORT_VALUES_ATTR> valuesToSort0,
            WritableObjectChunk<Object, SORT_VALUES_ATTR> valuesToSort1, int start1, int length1,
            int length2) {
        ...
        final Object run2lo1 = valuesToSort1.get(start2);
        ...
        final Object run1hi1 = valuesToSort1.get(start1 + length1 - 1);
    ...
    private static <SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> void copyToTemporary(
            ...
            WritableLongChunk<PERMUTE_VALUES_ATTR> valuesToPermute,
            WritableByteChunk<SORT_VALUES_ATTR> valuesToSort0,
            WritableObjectChunk<Object, SORT_VALUES_ATTR> valuesToSort1, int mergeStartPosition,
            int remaining1) {
    ...
    private static <SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> void copyToChunk(
            ...
            ObjectChunk<Object, SORT_VALUES_ATTR> valuesSource1,
            WritableLongChunk<PERMUTE_VALUES_ATTR> permuteValuesDest,
            WritableByteChunk<SORT_VALUES_ATTR> sortValuesDest0,
            WritableObjectChunk<Object, SORT_VALUES_ATTR> sortValuesDest1, int sourceStart,
    ...
    private static int upperBound(ByteChunk<?> valuesToSort0, ObjectChunk<Object, ?> valuesToSort1,
            int lo, int hi, byte searchValue0, Object searchValue1) {
    ...
    private static int lowerBound(ByteChunk<?> valuesToSort0, ObjectChunk<Object, ?> valuesToSort1,
            int lo, int hi, byte searchValue0, Object searchValue1) {
    ...
    private static int bound(ByteChunk<?> valuesToSort0, ObjectChunk<Object, ?> valuesToSort1,
            int lo, int hi, byte searchValue0, Object searchValue1, final boolean lower) {
    ...
    private static void insertionSort(WritableLongChunk<?> valuesToPermute,
            WritableByteChunk<?> valuesToSort0, WritableObjectChunk<Object, ?> valuesToSort1,
    ...
    private static void swap(WritableLongChunk<?> valuesToPermute,
            WritableByteChunk<?> valuesToSort0, WritableObjectChunk<Object, ?> valuesToSort1, int a,
            int b) {
        final long tempPermuteValue = valuesToPermute.get(a);
        final byte temp0 = valuesToSort0.get(a);
        final Object temp1 = valuesToSort1.get(a);
    ...
    public static class ByteObjectMultiColumnSortKernelContext<SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> implements MultiColumnSortKernel<PERMUTE_VALUES_ATTR> {
        int minGallop;
        ...
        private final WritableObjectChunk<Object, SORT_VALUES_ATTR> temporaryValues1;

        private ByteObjectMultiColumnSortKernelContext(int size) {
            temporaryKeys = WritableLongChunk.makeWritableChunk((size + 2) / 2);
            temporaryValues0 = WritableByteChunk.makeWritableChunk((size + 2) / 2);
            temporaryValues1 = WritableObjectChunk.makeWritableChunk((size + 2) / 2);
        ...
        public void sort(WritableLongChunk<PERMUTE_VALUES_ATTR> valuesToPermute,
            ...
            ByteObjectMultiColumnTimsortKernel.sort(this, valuesToPermute,
                            (WritableByteChunk<SORT_VALUES_ATTR>) valuesToSort[0].asWritableByteChunk(),
                            (WritableObjectChunk<Object, SORT_VALUES_ATTR>) valuesToSort[1].asWritableObjectChunk());
        }
