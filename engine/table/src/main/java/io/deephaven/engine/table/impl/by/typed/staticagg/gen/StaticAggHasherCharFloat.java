...
final class StaticAggHasherCharFloat extends StaticChunkedOperatorAggregationStateManagerTypedBase {
    ...
    public StaticAggHasherCharFloat(ColumnSource[] tableKeySources,
    ...
    private boolean findOverflow(HashHandler handler, char k0, float k1, int chunkPosition,
