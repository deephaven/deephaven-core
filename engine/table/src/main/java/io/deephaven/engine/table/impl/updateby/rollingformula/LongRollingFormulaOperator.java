...
public class LongRollingFormulaOperator extends BaseRollingFormulaOperator {
    ...
    protected class Context extends BaseRollingFormulaOperator.Context {
        ...
        protected Context(final int affectedChunkSize, final int influencerChunkSize) {
            ...
            final SingleValueColumnSource<LongVector> formulaInputSource = (SingleValueColumnSource<LongVector>) SingleValueColumnSource.getSingleValueColumnSource(vectorType);
    ...
    protected LongRollingFormulaOperator(
            @NotNull final MatchPair pair,
            @NotNull final String[] affectingColumns,
            @Nullable final String timestampColumnName,
            final long reverseWindowScaleUnits,
    ...
    public UpdateByOperator copy() {
        return new LongRollingFormulaOperator(pair,
                affectingColumns,
                timestampColumnName,
