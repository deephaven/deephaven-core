...
final class IncrementalAggOpenHasherWithTombstoneDoubleByte extends IncrementalChunkedOperatorAggregationStateManagerOpenAddressedBaseWithTombstones {
    ...
    public IncrementalAggOpenHasherWithTombstoneDoubleByte(ColumnSource[] tableKeySources,
