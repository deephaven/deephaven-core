...
/**
 * This implements a timsort kernel for a multi-column key (NullAwareChar, Int) that never moves the column values:
 ...
 */
public final class NullAwareCharIntIndirectMultiColumnTimsortKernel {
    private NullAwareCharIntIndirectMultiColumnTimsortKernel() {
        throw new UnsupportedOperationException();
    }

    public static <PERMUTE_VALUES_ATTR extends Any> NullAwareCharIntIndirectMultiColumnSortKernelContext<PERMUTE_VALUES_ATTR> createContext(
            final int size) {
        return new NullAwareCharIntIndirectMultiColumnSortKernelContext<>(size);
    }
     ...
     */
    public static void sort(NullAwareCharIntIndirectMultiColumnSortKernelContext<?> context,
            WritableIntChunk<ChunkPositions> positions, CharChunk<?> valuesToSort0,
            IntChunk<?> valuesToSort1) {
        timSort(context, positions, valuesToSort0, valuesToSort1, 0, positions.size());
    }

    private static void timSort(NullAwareCharIntIndirectMultiColumnSortKernelContext<?> context,
            WritableIntChunk<ChunkPositions> positions, CharChunk<?> valuesToSort0,
            IntChunk<?> valuesToSort1, int offset, int length) {
        if (length <= 1) {
            return;
        }
     ...
     */
    private static int compareColumns(CharChunk<?> valuesToSort0, IntChunk<?> valuesToSort1,
    ...
    private static void ensureMergeInvariants(
            NullAwareCharIntIndirectMultiColumnSortKernelContext<?> context,
            WritableIntChunk<ChunkPositions> positions, CharChunk<?> valuesToSort0,
            IntChunk<?> valuesToSort1) {
        while (context.runCount > 1) {
    ...
    private static void merge(NullAwareCharIntIndirectMultiColumnSortKernelContext<?> context,
            WritableIntChunk<ChunkPositions> positions, CharChunk<?> valuesToSort0,
            IntChunk<?> valuesToSort1, int start1, int length1, int length2) {
     ...
     */
    private static void frontMerge(NullAwareCharIntIndirectMultiColumnSortKernelContext<?> context,
            WritableIntChunk<ChunkPositions> positions, CharChunk<?> valuesToSort0,
            IntChunk<?> valuesToSort1, final int mergeStartPosition, final int start2,
            final int length2) {
        int tempCursor = 0;
     ...
     * We eventually need to do galloping here, but are skipping that for now
     */
    private static void backMerge(NullAwareCharIntIndirectMultiColumnSortKernelContext<?> context,
            WritableIntChunk<ChunkPositions> positions, CharChunk<?> valuesToSort0,
            IntChunk<?> valuesToSort1, final int mergeStartPosition, final int length1) {
    ...
    private static int upperBound(IntChunk<ChunkPositions> positions, CharChunk<?> valuesToSort0,
            IntChunk<?> valuesToSort1, int lo, int hi, int searchPos) {
    ...
    private static int bound(IntChunk<ChunkPositions> positions, CharChunk<?> valuesToSort0,
            IntChunk<?> valuesToSort1, int lo, int hi, int searchPos, final boolean lower) {
    ...
    private static void insertionSort(WritableIntChunk<ChunkPositions> positions,
            CharChunk<?> valuesToSort0, IntChunk<?> valuesToSort1, int offset, int length) {
    ...
    public static class NullAwareCharIntIndirectMultiColumnSortKernelContext<PERMUTE_VALUES_ATTR extends Any> implements MultiColumnSortKernel<PERMUTE_VALUES_ATTR> {
        int minGallop;
        ...
        private NullAwareCharIntIndirectMultiColumnSortKernelContext(int size) {
        ...
        public void sort(WritableLongChunk<PERMUTE_VALUES_ATTR> valuesToPermute,
            ...
            NullAwareCharIntIndirectMultiColumnTimsortKernel.sort(this, positions, valuesToSort[0].asCharChunk(), valuesToSort[1].asIntChunk());
