...
final class IncrementalAggOpenHasherWithTombstoneDoubleChar extends IncrementalChunkedOperatorAggregationStateManagerOpenAddressedBaseWithTombstones {
    ...
    public IncrementalAggOpenHasherWithTombstoneDoubleChar(ColumnSource[] tableKeySources,
