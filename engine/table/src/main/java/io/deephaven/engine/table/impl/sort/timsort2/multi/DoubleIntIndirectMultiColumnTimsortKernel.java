...
/**
 * This implements a timsort kernel for a multi-column key (Double, Int) that never moves the column values:
 ...
 */
public final class DoubleIntIndirectMultiColumnTimsortKernel {
    private DoubleIntIndirectMultiColumnTimsortKernel() {
        throw new UnsupportedOperationException();
    }

    public static <PERMUTE_VALUES_ATTR extends Any> DoubleIntIndirectMultiColumnSortKernelContext<PERMUTE_VALUES_ATTR> createContext(
            final int size) {
        return new DoubleIntIndirectMultiColumnSortKernelContext<>(size);
    }
     ...
     */
    public static void sort(DoubleIntIndirectMultiColumnSortKernelContext<?> context,
    ...
    private static void timSort(DoubleIntIndirectMultiColumnSortKernelContext<?> context,
            WritableIntChunk<ChunkPositions> positions, DoubleChunk<?> valuesToSort0,
     ...
     */
    private static int compareColumns(DoubleChunk<?> valuesToSort0, IntChunk<?> valuesToSort1,
    ...
    private static void ensureMergeInvariants(
            DoubleIntIndirectMultiColumnSortKernelContext<?> context,
            WritableIntChunk<ChunkPositions> positions, DoubleChunk<?> valuesToSort0,
            IntChunk<?> valuesToSort1) {
        while (context.runCount > 1) {
    ...
    private static void merge(DoubleIntIndirectMultiColumnSortKernelContext<?> context,
            WritableIntChunk<ChunkPositions> positions, DoubleChunk<?> valuesToSort0,
     ...
     */
    private static void frontMerge(DoubleIntIndirectMultiColumnSortKernelContext<?> context,
            WritableIntChunk<ChunkPositions> positions, DoubleChunk<?> valuesToSort0,
     ...
     * We eventually need to do galloping here, but are skipping that for now
     */
    private static void backMerge(DoubleIntIndirectMultiColumnSortKernelContext<?> context,
            WritableIntChunk<ChunkPositions> positions, DoubleChunk<?> valuesToSort0,
    ...
    private static void copyToTemporary(DoubleIntIndirectMultiColumnSortKernelContext<?> context,
    ...
    private static void insertionSort(WritableIntChunk<ChunkPositions> positions,
            DoubleChunk<?> valuesToSort0, IntChunk<?> valuesToSort1, int offset, int length) {
    ...
    public static class DoubleIntIndirectMultiColumnSortKernelContext<PERMUTE_VALUES_ATTR extends Any> implements MultiColumnSortKernel<PERMUTE_VALUES_ATTR> {
        int minGallop;
        ...
        private DoubleIntIndirectMultiColumnSortKernelContext(int size) {
        ...
        public void sort(WritableLongChunk<PERMUTE_VALUES_ATTR> valuesToPermute,
            ...
            DoubleIntIndirectMultiColumnTimsortKernel.sort(this, positions, valuesToSort[0].asDoubleChunk(), valuesToSort[1].asIntChunk());
