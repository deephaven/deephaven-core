...
final class StaticAggHasherLongDouble extends StaticChunkedOperatorAggregationStateManagerTypedBase {
    ...
    public StaticAggHasherLongDouble(ColumnSource[] tableKeySources,
