...
final class IncrementalAggOpenHasherIntChar extends IncrementalChunkedOperatorAggregationStateManagerOpenAddressedBase {
    ...
    public IncrementalAggOpenHasherIntChar(ColumnSource[] tableKeySources,
