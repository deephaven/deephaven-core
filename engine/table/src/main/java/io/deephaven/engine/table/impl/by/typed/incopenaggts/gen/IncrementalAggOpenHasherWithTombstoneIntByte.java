...
final class IncrementalAggOpenHasherWithTombstoneIntByte extends IncrementalChunkedOperatorAggregationStateManagerOpenAddressedBaseWithTombstones {
    ...
    public IncrementalAggOpenHasherWithTombstoneIntByte(ColumnSource[] tableKeySources,
