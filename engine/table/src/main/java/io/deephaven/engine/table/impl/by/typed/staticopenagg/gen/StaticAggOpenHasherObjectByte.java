...
final class StaticAggOpenHasherObjectByte extends StaticChunkedOperatorAggregationStateManagerOpenAddressedBase {
    private final ImmutableObjectArraySource mainKeySource0;

    private final ImmutableByteArraySource mainKeySource1;

    public StaticAggOpenHasherObjectByte(ColumnSource[] tableKeySources,
