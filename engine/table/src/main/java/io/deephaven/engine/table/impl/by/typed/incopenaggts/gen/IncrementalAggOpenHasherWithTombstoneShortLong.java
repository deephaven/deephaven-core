...
final class IncrementalAggOpenHasherWithTombstoneShortLong extends IncrementalChunkedOperatorAggregationStateManagerOpenAddressedBaseWithTombstones {
    ...
    public IncrementalAggOpenHasherWithTombstoneShortLong(ColumnSource[] tableKeySources,
