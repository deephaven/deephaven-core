...
/**
 * {@link RangeSearchKernel} for values of type short.
 */
enum RangeSearchKernelShort implements RangeSearchKernel {
    ...
    static RangeSearchKernelShort forRules(
    ...
    private static boolean isValidPairDisallowEqual(final short start, final short end) {
    ...
    private static void processRangeStartsLessThan(
        ...
        short leftValue = leftValues.get(leftIndex);
        do {
    ...
    // region isNaN
    private static boolean isNaN(@SuppressWarnings("unused") final short v) {
        return false;
    }
    // endregion isNaN

    // region isNull
    private static boolean isNull(final short v) {
    ...
    // region eq
    private static boolean eq(final short a, final short b) {
    ...
    // region lt
    private static boolean lt(final short a, final short b) {
        // We need not deal with null or NaN values here
        return a < b;
    }
    // endregion lt
    ...
    // region leq
    private static boolean leq(final short a, final short b) {
        // We need not deal with null or NaN values here
        return a <= b;
    }
    // endregion leq
