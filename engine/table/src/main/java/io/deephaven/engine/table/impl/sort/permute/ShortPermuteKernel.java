...
public class ShortPermuteKernel {
    public static <T extends Any> void permute(ShortChunk<? extends T> inputValues,
            IntChunk<ChunkPositions> outputPositions, WritableShortChunk<? super T> outputValues) {
        for (int ii = 0; ii < outputPositions.size(); ++ii) {
            outputValues.set(outputPositions.get(ii), inputValues.get(ii));
        }
    }

    public static <T extends Any> void permuteInput(ShortChunk<? extends T> inputValues,
            IntChunk<ChunkPositions> inputPositions, WritableShortChunk<? super T> outputValues) {
    ...
    public static <T extends Any> void permute(IntChunk<ChunkPositions> inputPositions,
            ShortChunk<? extends T> inputValues, IntChunk<ChunkPositions> outputPositions,
            WritableShortChunk<? super T> outputValues) {
        for (int ii = 0; ii < outputPositions.size(); ++ii) {
    ...
    private static class ShortPermuteKernelContext implements PermuteKernel {
        ...
        public <T extends Any> void permute(IntChunk<ChunkPositions> inputPositions, Chunk<? extends T> inputValues,
            ...
            ShortPermuteKernel.permute(inputPositions, inputValues.asShortChunk(), outputPositions,
                    outputValues.asWritableShortChunk());
        }
        ...
        public <T extends Any> void permuteInput(Chunk<? extends T> inputValues,
            ...
            ShortPermuteKernel.permuteInput(inputValues.asShortChunk(), inputPositions,
                    outputValues.asWritableShortChunk());
        }
    }
