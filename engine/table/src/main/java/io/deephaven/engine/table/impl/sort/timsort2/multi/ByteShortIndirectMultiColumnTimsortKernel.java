...
/**
 * This implements a timsort kernel for a multi-column key (Byte, Short) that never moves the column values:
 ...
 */
public final class ByteShortIndirectMultiColumnTimsortKernel {
    private ByteShortIndirectMultiColumnTimsortKernel() {
        throw new UnsupportedOperationException();
    }

    public static <PERMUTE_VALUES_ATTR extends Any> ByteShortIndirectMultiColumnSortKernelContext<PERMUTE_VALUES_ATTR> createContext(
            final int size) {
        return new ByteShortIndirectMultiColumnSortKernelContext<>(size);
    }
     ...
     */
    public static void sort(ByteShortIndirectMultiColumnSortKernelContext<?> context,
    ...
    private static void timSort(ByteShortIndirectMultiColumnSortKernelContext<?> context,
            WritableIntChunk<ChunkPositions> positions, ByteChunk<?> valuesToSort0,
     ...
     */
    private static int compareColumns(ByteChunk<?> valuesToSort0, ShortChunk<?> valuesToSort1,
    ...
    private static void ensureMergeInvariants(
            ByteShortIndirectMultiColumnSortKernelContext<?> context,
            WritableIntChunk<ChunkPositions> positions, ByteChunk<?> valuesToSort0,
            ShortChunk<?> valuesToSort1) {
        while (context.runCount > 1) {
    ...
    private static void merge(ByteShortIndirectMultiColumnSortKernelContext<?> context,
            WritableIntChunk<ChunkPositions> positions, ByteChunk<?> valuesToSort0,
     ...
     */
    private static void frontMerge(ByteShortIndirectMultiColumnSortKernelContext<?> context,
            WritableIntChunk<ChunkPositions> positions, ByteChunk<?> valuesToSort0,
     ...
     * We eventually need to do galloping here, but are skipping that for now
     */
    private static void backMerge(ByteShortIndirectMultiColumnSortKernelContext<?> context,
            WritableIntChunk<ChunkPositions> positions, ByteChunk<?> valuesToSort0,
    ...
    private static void copyToTemporary(ByteShortIndirectMultiColumnSortKernelContext<?> context,
    ...
    private static void insertionSort(WritableIntChunk<ChunkPositions> positions,
            ByteChunk<?> valuesToSort0, ShortChunk<?> valuesToSort1, int offset, int length) {
    ...
    public static class ByteShortIndirectMultiColumnSortKernelContext<PERMUTE_VALUES_ATTR extends Any> implements MultiColumnSortKernel<PERMUTE_VALUES_ATTR> {
        int minGallop;
        ...
        private ByteShortIndirectMultiColumnSortKernelContext(int size) {
        ...
        public void sort(WritableLongChunk<PERMUTE_VALUES_ATTR> valuesToPermute,
            ...
            ByteShortIndirectMultiColumnTimsortKernel.sort(this, positions, valuesToSort[0].asByteChunk(), valuesToSort[1].asShortChunk());
