...
final class TypedHasherFloatObject extends StaticChunkedOperatorAggregationStateManagerTypedBase {
  ...
  public TypedHasherFloatObject(ColumnSource[] tableKeySources, int tableSize,
  ...
  private int hash(float v0, Object v1) {
  ...
  private boolean findOverflow(HashHandler handler, float v0, Object v1, int chunkPosition,
