...
final class IncrementalAggHasherByteObject extends IncrementalChunkedOperatorAggregationStateManagerTypedBase {
    ...
    public IncrementalAggHasherByteObject(ColumnSource[] tableKeySources,
    ...
    private boolean findOverflow(HashHandler handler, byte k0, Object k1, int chunkPosition,
