...
final class StaticAggOpenHasherCharShort extends StaticChunkedOperatorAggregationStateManagerOpenAddressedBase {
    private final ImmutableCharArraySource mainKeySource0;

    private final ImmutableShortArraySource mainKeySource1;

    public StaticAggOpenHasherCharShort(ColumnSource[] tableKeySources,
