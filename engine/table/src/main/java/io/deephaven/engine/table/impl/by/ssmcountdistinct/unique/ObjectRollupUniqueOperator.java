...
public class ObjectRollupUniqueOperator implements IterativeChunkedAggregationOperator {
     ...
     * {@link ObjectCompactModifications} instead and calls {@link #applyAdds} directly.
     */
     ...
     * with {@link ObjectCompactModifications} instead and calls {@link #applyRemoves} directly.
     */
    ...
    private boolean finalizeState(long destination, long priorState, Object priorValue, long count,
        ...
        if (!ObjectComparisons.eq(newValue, priorValue)) {
    ...
    private void clearSingletonValue(long destination) {
        ...
        singletonValue.set(destination, null);
    ...
    public BucketedContext makeBucketedContext(int size) {
        return new SsmUniqueRollupContext(ChunkType.Object, size);
    }
