...
public abstract class BaseWindowedLongUpdateByOperator extends UpdateByWindowedOperator {
    ...
    protected class Context extends UpdateWindowedContext {
        ...
        public void loadWindowChunks(final long startKey) {
            ...
            if (candidateValuesChunk == null) {
                candidateValuesChunk = WritableLongChunk.makeWritableChunk(WINDOW_CHUNK_SIZE);
            }
        ...
        public void fillWindowTicks(UpdateContext context, long currentPos) {
            ...
            while (candidatePositionsChunk.size() > 0 && candidatePositionsChunk.get(candidateWindowIndex) <= head) {
                ...
                final long val = candidateValuesChunk.get(candidateWindowIndex);
    ...
    public abstract void push(UpdateContext context, long key, long val);
