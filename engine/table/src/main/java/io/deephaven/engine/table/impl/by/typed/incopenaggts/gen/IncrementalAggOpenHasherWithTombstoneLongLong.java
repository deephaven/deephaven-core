...
final class IncrementalAggOpenHasherWithTombstoneLongLong extends IncrementalChunkedOperatorAggregationStateManagerOpenAddressedBaseWithTombstones {
    ...
    public IncrementalAggOpenHasherWithTombstoneLongLong(ColumnSource[] tableKeySources,
