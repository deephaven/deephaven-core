...
final class TypedHasherDoubleLong extends StaticChunkedOperatorAggregationStateManagerTypedBase {
    ...
    public TypedHasherDoubleLong(ColumnSource[] tableKeySources, int tableSize,
