 ...
 */
public final class FloatByteTimsortKernel {
    private FloatByteTimsortKernel() {
    }
    ...
    public static <SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> FloatByteSortKernelContext<SORT_VALUES_ATTR, PERMUTE_VALUES_ATTR> createContext(
            final int size) {
        return new FloatByteTimsortKernel().createContextInstance(size);
    }
    ...
    public class FloatByteSortKernelContext<SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> implements ByteSortKernel<SORT_VALUES_ATTR, PERMUTE_VALUES_ATTR> {
        ...
        public void sort(WritableByteChunk<PERMUTE_VALUES_ATTR> valuesToPermute,
            ...
            FloatByteTimsortKernel.this.sort(this, valuesToPermute, valuesToSort.asWritableFloatChunk());
        }
        ...
        public void sort(WritableByteChunk<PERMUTE_VALUES_ATTR> valuesToPermute,
                ...
                IntChunk<? extends ChunkPositions> offsetsIn,
                IntChunk<? extends ChunkLengths> lengthsIn) {
            FloatByteTimsortKernel.this.sort(this, valuesToPermute, valuesToSort.asWritableFloatChunk(), offsetsIn, lengthsIn);
        }

        @Override
        public void sort(WritableByteChunk<PERMUTE_VALUES_ATTR> valuesToPermute,
                WritableChunk<SORT_VALUES_ATTR> valuesToSort, int offset, int length) {
            FloatByteTimsortKernel.this.timSort(this, valuesToPermute, valuesToSort.asWritableFloatChunk(), offset, length);
        }
        ...
        public void merge(WritableByteChunk<PERMUTE_VALUES_ATTR> valuesToPermute,
                ...
                int length2) {
            FloatByteTimsortKernel.this.merge(this, valuesToPermute, valuesToSort.asWritableFloatChunk(), start1, length1, length2);
        }
        ...
        private FloatByteTimsortKernel kernel() {
            return FloatByteTimsortKernel.this;
        }
    }
}
