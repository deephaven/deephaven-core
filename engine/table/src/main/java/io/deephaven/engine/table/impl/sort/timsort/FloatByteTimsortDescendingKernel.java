...
// ****** Edit FloatByteTimsortDescendingKernel and run "./gradlew replicateSortKernel" to regenerate
//
// @formatter:off
...
public final class FloatByteTimsortDescendingKernel {
    ...
    // region Context
    public class FloatByteSortKernelContext<SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any>
    ...
    public <SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> FloatByteSortKernelContext<SORT_VALUES_ATTR, PERMUTE_VALUES_ATTR> createContextInstance(int size) {
    ...
    public static <SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> FloatByteSortKernelContext<SORT_VALUES_ATTR, PERMUTE_VALUES_ATTR> createContext(final int size) {
    ...
    private static <SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> void copyToChunk(
            ...
            FloatChunk<SORT_VALUES_ATTR> valuesSource,
            WritableByteChunk<PERMUTE_VALUES_ATTR> permuteValuesDest,
            WritableFloatChunk<SORT_VALUES_ATTR> sortValuesDest,
            int sourceStart,
            int destStart,
            int length) {
    ...
    static private void swap(WritableByteChunk<?> valuesToPermute, WritableFloatChunk<?> valuesToSort, int a, int b) {
    ...
    // private static void doCheck(Chunk.ByteChunk valuesToPermute, Chunk.FloatChunk valuesToSort, int startCheck, int
    // mergeEnd) {
    // float lastCheck;
    ...
    // private static void dumpValues(Chunk.FloatChunk valuesToSort, int start1, int length1, int start2, int length2,
    // String msg) {
