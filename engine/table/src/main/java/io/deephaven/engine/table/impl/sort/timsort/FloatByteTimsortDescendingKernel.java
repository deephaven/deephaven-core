 ...
 */
public final class FloatByteTimsortDescendingKernel {
    private FloatByteTimsortDescendingKernel() {
    }

    public <SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> FloatByteSortKernelContext<SORT_VALUES_ATTR, PERMUTE_VALUES_ATTR> createContextInstance(
            int size) {
        return new FloatByteSortKernelContext<>(size);
    }

    public static <SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> FloatByteSortKernelContext<SORT_VALUES_ATTR, PERMUTE_VALUES_ATTR> createContext(
            final int size) {
        return new FloatByteTimsortDescendingKernel().createContextInstance(size);
    }
    ...
    static <SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> void sort(
            FloatByteSortKernelContext<SORT_VALUES_ATTR, PERMUTE_VALUES_ATTR> context,
    ...
    private <SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> void timSort(
            FloatByteSortKernelContext<SORT_VALUES_ATTR, PERMUTE_VALUES_ATTR> context,
            WritableByteChunk<PERMUTE_VALUES_ATTR> valuesToPermute,
            WritableFloatChunk<SORT_VALUES_ATTR> valuesToSort, int offset, int length) {
        if (length <= 1) {
            return;
        }
    ...
    private <SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> void merge(
            FloatByteSortKernelContext<SORT_VALUES_ATTR, PERMUTE_VALUES_ATTR> context,
            WritableByteChunk<PERMUTE_VALUES_ATTR> valuesToPermute,
            WritableFloatChunk<SORT_VALUES_ATTR> valuesToSort, int start1, int length1,
            int length2) {
    ...
    private <SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> void frontMerge(
            FloatByteSortKernelContext<SORT_VALUES_ATTR, PERMUTE_VALUES_ATTR> context,
            WritableByteChunk<PERMUTE_VALUES_ATTR> valuesToPermute,
            WritableFloatChunk<SORT_VALUES_ATTR> valuesToSort, final int mergeStartPosition,
    ...
    private static <SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> void copyToTemporary(
            FloatByteSortKernelContext<SORT_VALUES_ATTR, PERMUTE_VALUES_ATTR> context,
            WritableByteChunk<PERMUTE_VALUES_ATTR> valuesToPermute,
            WritableFloatChunk<SORT_VALUES_ATTR> valuesToSort, int mergeStartPosition,
            int remaining1) {
    ...
    private static <SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> void copyToChunk(
            ByteChunk<PERMUTE_VALUES_ATTR> rowSetSource, FloatChunk<SORT_VALUES_ATTR> valuesSource,
            WritableByteChunk<PERMUTE_VALUES_ATTR> permuteValuesDest,
            WritableFloatChunk<SORT_VALUES_ATTR> sortValuesDest, int sourceStart, int destStart,
            int length) {
    ...
    private int bound(FloatChunk<?> valuesToSort, int lo, int hi, float searchValue,
            final boolean lower) {
        // lt or leq
    ...
    private void insertionSort(WritableByteChunk<?> valuesToPermute,
            WritableFloatChunk<?> valuesToSort, int offset, int length) {
    ...
    private static void swap(WritableByteChunk<?> valuesToPermute,
            WritableFloatChunk<?> valuesToSort, int a, int b) {
    ...
    public class FloatByteSortKernelContext<SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> implements ByteSortKernel<SORT_VALUES_ATTR, PERMUTE_VALUES_ATTR> {
        int minGallop;
        ...
        private final WritableFloatChunk<SORT_VALUES_ATTR> temporaryValues;
        ...
        public void sort(WritableByteChunk<PERMUTE_VALUES_ATTR> valuesToPermute,
            ...
            FloatByteTimsortDescendingKernel.this.sort(this, valuesToPermute, valuesToSort.asWritableFloatChunk());
        }
        ...
        public void sort(WritableByteChunk<PERMUTE_VALUES_ATTR> valuesToPermute,
                ...
                IntChunk<? extends ChunkPositions> offsetsIn,
                IntChunk<? extends ChunkLengths> lengthsIn) {
            FloatByteTimsortDescendingKernel.this.sort(this, valuesToPermute, valuesToSort.asWritableFloatChunk(), offsetsIn, lengthsIn);
        }

        @Override
        public void sort(WritableByteChunk<PERMUTE_VALUES_ATTR> valuesToPermute,
                WritableChunk<SORT_VALUES_ATTR> valuesToSort, int offset, int length) {
            FloatByteTimsortDescendingKernel.this.timSort(this, valuesToPermute, valuesToSort.asWritableFloatChunk(), offset, length);
        }
        ...
        public void merge(WritableByteChunk<PERMUTE_VALUES_ATTR> valuesToPermute,
                ...
                int length2) {
            FloatByteTimsortDescendingKernel.this.merge(this, valuesToPermute, valuesToSort.asWritableFloatChunk(), start1, length1, length2);
        }
        ...
        private FloatByteTimsortDescendingKernel kernel() {
            return FloatByteTimsortDescendingKernel.this;
        }
    }
}
