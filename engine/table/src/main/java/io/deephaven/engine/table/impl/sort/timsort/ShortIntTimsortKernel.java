 ...
 */
public final class ShortIntTimsortKernel {
    ...
    public static <SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> ShortIntSortKernelContext<SORT_VALUES_ATTR, PERMUTE_VALUES_ATTR> createContext(
            final int size) {
        return new ShortIntTimsortKernel().createContextInstance(size);
    }
    ...
    public class ShortIntSortKernelContext<SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> implements IntSortKernel<SORT_VALUES_ATTR, PERMUTE_VALUES_ATTR> {
        ...
        public void sort(WritableIntChunk<PERMUTE_VALUES_ATTR> valuesToPermute,
            ...
            ShortIntTimsortKernel.this.sort(this, valuesToPermute, valuesToSort.asWritableShortChunk());
        }
        ...
        public void sort(WritableIntChunk<PERMUTE_VALUES_ATTR> valuesToPermute,
                ...
                IntChunk<? extends ChunkPositions> offsetsIn,
                IntChunk<? extends ChunkLengths> lengthsIn) {
            ShortIntTimsortKernel.this.sort(this, valuesToPermute, valuesToSort.asWritableShortChunk(), offsetsIn, lengthsIn);
        }

        @Override
        public void sort(WritableIntChunk<PERMUTE_VALUES_ATTR> valuesToPermute,
                WritableChunk<SORT_VALUES_ATTR> valuesToSort, int offset, int length) {
            ShortIntTimsortKernel.this.timSort(this, valuesToPermute, valuesToSort.asWritableShortChunk(), offset, length);
        }
        ...
        public void merge(WritableIntChunk<PERMUTE_VALUES_ATTR> valuesToPermute,
                ...
                int length2) {
            ShortIntTimsortKernel.this.merge(this, valuesToPermute, valuesToSort.asWritableShortChunk(), start1, length1, length2);
        }
        ...
        private ShortIntTimsortKernel kernel() {
            return ShortIntTimsortKernel.this;
        }
    }
}
