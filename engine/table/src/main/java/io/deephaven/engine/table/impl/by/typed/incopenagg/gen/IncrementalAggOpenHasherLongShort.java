...
final class IncrementalAggOpenHasherLongShort extends IncrementalChunkedOperatorAggregationStateManagerOpenAddressedBase {
    ...
    public IncrementalAggOpenHasherLongShort(ColumnSource[] tableKeySources,
