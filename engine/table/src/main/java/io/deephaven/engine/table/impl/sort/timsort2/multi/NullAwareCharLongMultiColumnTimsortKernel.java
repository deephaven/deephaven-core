...
/**
 * This implements a timsort kernel that sorts a multi-column key (NullAwareChar, Long), comparing each
 ...
 */
public final class NullAwareCharLongMultiColumnTimsortKernel {
    private NullAwareCharLongMultiColumnTimsortKernel() {
        throw new UnsupportedOperationException();
    }

    public static <SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> NullAwareCharLongMultiColumnSortKernelContext<SORT_VALUES_ATTR, PERMUTE_VALUES_ATTR> createContext(
            final int size) {
        return new NullAwareCharLongMultiColumnSortKernelContext<>(size);
    }
    ...
    static <SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> void sort(
            NullAwareCharLongMultiColumnSortKernelContext<SORT_VALUES_ATTR, PERMUTE_VALUES_ATTR> context,
    ...
    private static int upperBound(CharChunk<?> valuesToSort0, LongChunk<?> valuesToSort1, int lo,
            int hi, char searchValue0, long searchValue1) {
    ...
    private static int lowerBound(CharChunk<?> valuesToSort0, LongChunk<?> valuesToSort1, int lo,
            int hi, char searchValue0, long searchValue1) {
    ...
    private static int bound(CharChunk<?> valuesToSort0, LongChunk<?> valuesToSort1, int lo, int hi,
            char searchValue0, long searchValue1, final boolean lower) {
    ...
    private static void insertionSort(WritableLongChunk<?> valuesToPermute,
            WritableCharChunk<?> valuesToSort0, WritableLongChunk<?> valuesToSort1, int offset,
            int length) {
    ...
    private static void swap(WritableLongChunk<?> valuesToPermute,
            WritableCharChunk<?> valuesToSort0, WritableLongChunk<?> valuesToSort1, int a, int b) {
    ...
    public static class NullAwareCharLongMultiColumnSortKernelContext<SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> implements MultiColumnSortKernel<PERMUTE_VALUES_ATTR> {
        int minGallop;
        ...
        private NullAwareCharLongMultiColumnSortKernelContext(int size) {
        ...
        public void sort(WritableLongChunk<PERMUTE_VALUES_ATTR> valuesToPermute,
            ...
            NullAwareCharLongMultiColumnTimsortKernel.sort(this, valuesToPermute,
