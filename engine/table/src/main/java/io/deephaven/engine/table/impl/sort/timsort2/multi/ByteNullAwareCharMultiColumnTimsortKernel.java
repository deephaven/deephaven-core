...
/**
 * This implements a timsort kernel that sorts a multi-column key (Byte, NullAwareChar), comparing each
 ...
 */
public final class ByteNullAwareCharMultiColumnTimsortKernel {
    private ByteNullAwareCharMultiColumnTimsortKernel() {
        throw new UnsupportedOperationException();
    }

    public static <SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> ByteNullAwareCharMultiColumnSortKernelContext<SORT_VALUES_ATTR, PERMUTE_VALUES_ATTR> createContext(
            final int size) {
        return new ByteNullAwareCharMultiColumnSortKernelContext<>(size);
    }
    ...
    static <SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> void sort(
            ByteNullAwareCharMultiColumnSortKernelContext<SORT_VALUES_ATTR, PERMUTE_VALUES_ATTR> context,
            WritableLongChunk<PERMUTE_VALUES_ATTR> valuesToPermute,
            WritableByteChunk<SORT_VALUES_ATTR> valuesToSort0,
    ...
    private static <SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> void timSort(
        ...
        while (startRun < offset + length) {
            byte current0 = valuesToSort0.get(startRun);
            ...
            if (startRun + 1 == offset + length) {
                ...
                byte next0 = valuesToSort0.get(startRun + 1);
                endRun = startRun + 2;
    ...
    private static int doComparison0(byte lhs, byte rhs) {
    ...
    private static <SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> void merge(
        ...
        final byte run2lo0 = valuesToSort0.get(start2);
        ...
        final byte run1hi0 = valuesToSort0.get(start1 + length1 - 1);
    ...
    private static <SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> void frontMerge(
        ...
        byte val1_0 = context.temporaryValues0.get(tempCursor);
        byte val2_0 = valuesToSort0.get(run2Cursor);
    ...
    private static <SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> void backMerge(
        ...
        byte val1_0 = valuesToSort0.get(run1Cursor);
        byte val2_0 = context.temporaryValues0.get(tempCursor);
    ...
    private static <SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> void copyToChunk(
            LongChunk<PERMUTE_VALUES_ATTR> rowSetSource, ByteChunk<SORT_VALUES_ATTR> valuesSource0,
            CharChunk<SORT_VALUES_ATTR> valuesSource1,
            WritableLongChunk<PERMUTE_VALUES_ATTR> permuteValuesDest,
            WritableByteChunk<SORT_VALUES_ATTR> sortValuesDest0,
    ...
    private static int upperBound(ByteChunk<?> valuesToSort0, CharChunk<?> valuesToSort1, int lo,
            int hi, byte searchValue0, char searchValue1) {
    ...
    private static int lowerBound(ByteChunk<?> valuesToSort0, CharChunk<?> valuesToSort1, int lo,
            int hi, byte searchValue0, char searchValue1) {
    ...
    private static int bound(ByteChunk<?> valuesToSort0, CharChunk<?> valuesToSort1, int lo, int hi,
            byte searchValue0, char searchValue1, final boolean lower) {
    ...
    private static void insertionSort(WritableLongChunk<?> valuesToPermute,
            WritableByteChunk<?> valuesToSort0, WritableCharChunk<?> valuesToSort1, int offset,
            int length) {
    ...
    private static void swap(WritableLongChunk<?> valuesToPermute,
            WritableByteChunk<?> valuesToSort0, WritableCharChunk<?> valuesToSort1, int a, int b) {
        final long tempPermuteValue = valuesToPermute.get(a);
        final byte temp0 = valuesToSort0.get(a);
    ...
    public static class ByteNullAwareCharMultiColumnSortKernelContext<SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> implements MultiColumnSortKernel<PERMUTE_VALUES_ATTR> {
        int minGallop;
        ...
        private final WritableByteChunk<SORT_VALUES_ATTR> temporaryValues0;

        private final WritableCharChunk<SORT_VALUES_ATTR> temporaryValues1;

        private ByteNullAwareCharMultiColumnSortKernelContext(int size) {
            temporaryKeys = WritableLongChunk.makeWritableChunk((size + 2) / 2);
            temporaryValues0 = WritableByteChunk.makeWritableChunk((size + 2) / 2);
        ...
        public void sort(WritableLongChunk<PERMUTE_VALUES_ATTR> valuesToPermute,
            ...
            ByteNullAwareCharMultiColumnTimsortKernel.sort(this, valuesToPermute,
                            (WritableByteChunk<SORT_VALUES_ATTR>) valuesToSort[0].asWritableByteChunk(),
