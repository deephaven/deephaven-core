...
/**
 * This implements a timsort kernel that sorts a multi-column key (Byte, Short), comparing each
 ...
 */
public final class ByteShortMultiColumnTimsortKernel {
    private ByteShortMultiColumnTimsortKernel() {
        throw new UnsupportedOperationException();
    }

    public static <SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> ByteShortMultiColumnSortKernelContext<SORT_VALUES_ATTR, PERMUTE_VALUES_ATTR> createContext(
            final int size) {
        return new ByteShortMultiColumnSortKernelContext<>(size);
    }
    ...
    static <SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> void sort(
            ByteShortMultiColumnSortKernelContext<SORT_VALUES_ATTR, PERMUTE_VALUES_ATTR> context,
    ...
    private static int upperBound(ByteChunk<?> valuesToSort0, ShortChunk<?> valuesToSort1, int lo,
            int hi, byte searchValue0, short searchValue1) {
    ...
    private static int lowerBound(ByteChunk<?> valuesToSort0, ShortChunk<?> valuesToSort1, int lo,
            int hi, byte searchValue0, short searchValue1) {
    ...
    private static int bound(ByteChunk<?> valuesToSort0, ShortChunk<?> valuesToSort1, int lo,
            int hi, byte searchValue0, short searchValue1, final boolean lower) {
    ...
    private static void insertionSort(WritableLongChunk<?> valuesToPermute,
            WritableByteChunk<?> valuesToSort0, WritableShortChunk<?> valuesToSort1, int offset,
            int length) {
    ...
    private static void swap(WritableLongChunk<?> valuesToPermute,
            WritableByteChunk<?> valuesToSort0, WritableShortChunk<?> valuesToSort1, int a, int b) {
    ...
    public static class ByteShortMultiColumnSortKernelContext<SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> implements MultiColumnSortKernel<PERMUTE_VALUES_ATTR> {
        int minGallop;
        ...
        private ByteShortMultiColumnSortKernelContext(int size) {
        ...
        public void sort(WritableLongChunk<PERMUTE_VALUES_ATTR> valuesToPermute,
            ...
            ByteShortMultiColumnTimsortKernel.sort(this, valuesToPermute,
