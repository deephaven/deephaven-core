...
final class IncrementalAggOpenHasherCharDouble extends IncrementalChunkedOperatorAggregationStateManagerOpenAddressedBase {
    ...
    public IncrementalAggOpenHasherCharDouble(ColumnSource[] tableKeySources,
