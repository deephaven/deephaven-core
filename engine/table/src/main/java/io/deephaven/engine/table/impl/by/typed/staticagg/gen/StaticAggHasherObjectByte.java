...
final class StaticAggHasherObjectByte extends StaticChunkedOperatorAggregationStateManagerTypedBase {
    ...
    public StaticAggHasherObjectByte(ColumnSource[] tableKeySources,
