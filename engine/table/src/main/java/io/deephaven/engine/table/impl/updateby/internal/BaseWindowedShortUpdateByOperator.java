...
public abstract class BaseWindowedShortUpdateByOperator extends UpdateByWindowedOperator {
    protected final ColumnSource<Short> valueSource;
    ...
    protected class Context extends UpdateWindowedContext {
        ...
        public WritableShortChunk<Values> candidateValuesChunk;
        ...
        public void loadWindowChunks(final long startKey) {
            ...
            if (candidateValuesChunk == null) {
                candidateValuesChunk = WritableShortChunk.makeWritableChunk(WINDOW_CHUNK_SIZE);
            }
        ...
        public void fillWindowTicks(UpdateContext context, long currentPos) {
            ...
            while (candidatePositionsChunk.size() > 0 && candidatePositionsChunk.get(candidateWindowIndex) <= head) {
                ...
                final short val = candidateValuesChunk.get(candidateWindowIndex);
    ...
    public BaseWindowedShortUpdateByOperator(@NotNull final MatchPair pair,
    ...
    public abstract void push(UpdateContext context, long key, short val);
