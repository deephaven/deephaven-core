...
public class PrevFloatVectorColumnWrapper extends FloatVector.Indirect {
    ...
    public PrevFloatVectorColumnWrapper(@NotNull final ColumnSource<Float> columnSource,
                                       @NotNull final RowSet rowSet) {
        this(columnSource, rowSet, 0, 0);
    }

    private PrevFloatVectorColumnWrapper(@NotNull final ColumnSource<Float> columnSource,
    ...
    public float get(long index) {
        ...
        return columnSource.getPrevFloat(rowSet.get(index));
    }
    ...
    public FloatVector subVector(long fromIndexInclusive, long toIndexExclusive) {
        ...
        return new PrevFloatVectorColumnWrapper(columnSource, rowSet.subSetByPositionRange(realFrom, realTo),
    ...
    public FloatVector subVectorByPositions(long[] positions) {
        ...
        return new PrevFloatVectorColumnWrapper(columnSource, builder.build(), 0, 0);
    }
