...
final class IncrementalAggOpenHasherWithTombstoneFloatFloat extends IncrementalChunkedOperatorAggregationStateManagerOpenAddressedBaseWithTombstones {
    ...
    public IncrementalAggOpenHasherWithTombstoneFloatFloat(ColumnSource[] tableKeySources,
