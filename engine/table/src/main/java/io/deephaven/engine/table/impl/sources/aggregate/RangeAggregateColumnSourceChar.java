 ...
 */
public final class RangeAggregateColumnSourceChar extends RangeAggregateColumnSource<CharVector, Character> {
    ...
    public CharVector get(final long rowKey) {
        ...
        return new CharVectorSlice(new CharVectorColumnWrapper(aggregated, rowSet), startPositionInclusive, length);
    }
    ...
    public void fillChunk(
        ...
        for (int di = 0; di < size; ++di) {
            ...
            typedDestination.set(di, new CharVectorSlice(
                    new CharVectorColumnWrapper(aggregated, rowSet), startPositionInclusive, length));
        }
