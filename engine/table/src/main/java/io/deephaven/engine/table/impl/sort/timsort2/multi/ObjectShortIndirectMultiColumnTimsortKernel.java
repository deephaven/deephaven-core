...
/**
 * This implements a timsort kernel for a multi-column key (Object, Short) that never moves the column values:
 ...
 */
public final class ObjectShortIndirectMultiColumnTimsortKernel {
    private ObjectShortIndirectMultiColumnTimsortKernel() {
        throw new UnsupportedOperationException();
    }

    public static <PERMUTE_VALUES_ATTR extends Any> ObjectShortIndirectMultiColumnSortKernelContext<PERMUTE_VALUES_ATTR> createContext(
            final int size) {
        return new ObjectShortIndirectMultiColumnSortKernelContext<>(size);
    }
     ...
     */
    public static void sort(ObjectShortIndirectMultiColumnSortKernelContext<?> context,
    ...
    private static void timSort(ObjectShortIndirectMultiColumnSortKernelContext<?> context,
            WritableIntChunk<ChunkPositions> positions, ObjectChunk<Object, ?> valuesToSort0,
    ...
    private static int compareColumns(ObjectChunk<Object, ?> valuesToSort0,
            ShortChunk<?> valuesToSort1, int lhsPos, int rhsPos) {
    ...
    private static void ensureMergeInvariants(
            ObjectShortIndirectMultiColumnSortKernelContext<?> context,
            WritableIntChunk<ChunkPositions> positions, ObjectChunk<Object, ?> valuesToSort0,
            ShortChunk<?> valuesToSort1) {
        while (context.runCount > 1) {
    ...
    private static void merge(ObjectShortIndirectMultiColumnSortKernelContext<?> context,
            WritableIntChunk<ChunkPositions> positions, ObjectChunk<Object, ?> valuesToSort0,
     ...
     */
    private static void frontMerge(ObjectShortIndirectMultiColumnSortKernelContext<?> context,
            WritableIntChunk<ChunkPositions> positions, ObjectChunk<Object, ?> valuesToSort0,
     ...
     * We eventually need to do galloping here, but are skipping that for now
     */
    private static void backMerge(ObjectShortIndirectMultiColumnSortKernelContext<?> context,
            WritableIntChunk<ChunkPositions> positions, ObjectChunk<Object, ?> valuesToSort0,
    ...
    private static void copyToTemporary(ObjectShortIndirectMultiColumnSortKernelContext<?> context,
    ...
    private static int upperBound(IntChunk<ChunkPositions> positions,
            ObjectChunk<Object, ?> valuesToSort0, ShortChunk<?> valuesToSort1, int lo, int hi,
            int searchPos) {
    ...
    private static void insertionSort(WritableIntChunk<ChunkPositions> positions,
            ObjectChunk<Object, ?> valuesToSort0, ShortChunk<?> valuesToSort1, int offset,
            int length) {
    ...
    public static class ObjectShortIndirectMultiColumnSortKernelContext<PERMUTE_VALUES_ATTR extends Any> implements MultiColumnSortKernel<PERMUTE_VALUES_ATTR> {
        int minGallop;
        ...
        private ObjectShortIndirectMultiColumnSortKernelContext(int size) {
        ...
        public void sort(WritableLongChunk<PERMUTE_VALUES_ATTR> valuesToPermute,
            ...
            ObjectShortIndirectMultiColumnTimsortKernel.sort(this, positions, valuesToSort[0].<Object>asObjectChunk(), valuesToSort[1].asShortChunk());
