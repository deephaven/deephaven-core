...
public class LongByteTimsortKernel {
    ...
    public static class LongByteSortKernelContext<SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any>
        ...
        public void sort(
            ...
            LongByteTimsortKernel.sort(this, valuesToPermute, valuesToSort.asWritableLongChunk());
        }
        ...
        public void sort(
            ...
            LongByteTimsortKernel.sort(this, valuesToPermute, valuesToSort.asWritableLongChunk(), offsetsIn, lengthsIn);
        }
