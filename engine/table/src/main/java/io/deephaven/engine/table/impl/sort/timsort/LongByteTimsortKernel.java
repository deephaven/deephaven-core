 ...
 * the algorithm.
 */
public class LongByteTimsortKernel {
    ...
    public static class LongByteSortKernelContext<ATTR extends Any, KEY_INDICES extends Indices> implements ByteSortKernel<ATTR, KEY_INDICES> {
        ...
        public void sort(WritableByteChunk<KEY_INDICES> indexKeys, WritableChunk<ATTR> valuesToSort) {
            LongByteTimsortKernel.sort(this, indexKeys, valuesToSort.asWritableLongChunk());
        }
        ...
        public void sort(WritableByteChunk<KEY_INDICES> indexKeys, WritableChunk<ATTR> valuesToSort, IntChunk<? extends ChunkPositions> offsetsIn, IntChunk<? extends ChunkLengths> lengthsIn) {
            LongByteTimsortKernel.sort(this, indexKeys, valuesToSort.asWritableLongChunk(), offsetsIn, lengthsIn);
        }
