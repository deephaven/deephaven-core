...
final class StaticAggHasherObjectDouble extends StaticChunkedOperatorAggregationStateManagerTypedBase {
    ...
    public StaticAggHasherObjectDouble(ColumnSource[] tableKeySources,
