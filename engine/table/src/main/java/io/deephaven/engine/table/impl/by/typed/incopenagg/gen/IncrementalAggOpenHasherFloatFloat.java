...
final class IncrementalAggOpenHasherFloatFloat extends IncrementalChunkedOperatorAggregationStateManagerOpenAddressedBase {
    ...
    public IncrementalAggOpenHasherFloatFloat(ColumnSource[] tableKeySources,
