...
final class RightIncrementalAsOfJoinHasherObject extends RightIncrementalAsOfJoinStateManagerTypedBase {
    private ImmutableObjectArraySource mainKeySource0;

    private ImmutableObjectArraySource alternateKeySource0;

    public RightIncrementalAsOfJoinHasherObject(ColumnSource[] tableKeySources,
