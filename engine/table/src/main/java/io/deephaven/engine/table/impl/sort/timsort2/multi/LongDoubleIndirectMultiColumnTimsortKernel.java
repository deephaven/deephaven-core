...
/**
 * This implements a timsort kernel for a multi-column key (Long, Double) that never moves the column values:
 ...
 */
public final class LongDoubleIndirectMultiColumnTimsortKernel {
    private LongDoubleIndirectMultiColumnTimsortKernel() {
        throw new UnsupportedOperationException();
    }

    public static <PERMUTE_VALUES_ATTR extends Any> LongDoubleIndirectMultiColumnSortKernelContext<PERMUTE_VALUES_ATTR> createContext(
            final int size) {
        return new LongDoubleIndirectMultiColumnSortKernelContext<>(size);
    }
     ...
     */
    public static void sort(LongDoubleIndirectMultiColumnSortKernelContext<?> context,
    ...
    private static void timSort(LongDoubleIndirectMultiColumnSortKernelContext<?> context,
            WritableIntChunk<ChunkPositions> positions, LongChunk<?> valuesToSort0,
     ...
     */
    private static int compareColumns(LongChunk<?> valuesToSort0, DoubleChunk<?> valuesToSort1,
    ...
    private static void ensureMergeInvariants(
            LongDoubleIndirectMultiColumnSortKernelContext<?> context,
            WritableIntChunk<ChunkPositions> positions, LongChunk<?> valuesToSort0,
            DoubleChunk<?> valuesToSort1) {
        while (context.runCount > 1) {
    ...
    private static void merge(LongDoubleIndirectMultiColumnSortKernelContext<?> context,
            WritableIntChunk<ChunkPositions> positions, LongChunk<?> valuesToSort0,
     ...
     */
    private static void frontMerge(LongDoubleIndirectMultiColumnSortKernelContext<?> context,
            WritableIntChunk<ChunkPositions> positions, LongChunk<?> valuesToSort0,
     ...
     * We eventually need to do galloping here, but are skipping that for now
     */
    private static void backMerge(LongDoubleIndirectMultiColumnSortKernelContext<?> context,
            WritableIntChunk<ChunkPositions> positions, LongChunk<?> valuesToSort0,
    ...
    private static void copyToTemporary(LongDoubleIndirectMultiColumnSortKernelContext<?> context,
    ...
    private static void insertionSort(WritableIntChunk<ChunkPositions> positions,
            LongChunk<?> valuesToSort0, DoubleChunk<?> valuesToSort1, int offset, int length) {
    ...
    public static class LongDoubleIndirectMultiColumnSortKernelContext<PERMUTE_VALUES_ATTR extends Any> implements MultiColumnSortKernel<PERMUTE_VALUES_ATTR> {
        int minGallop;
        ...
        private LongDoubleIndirectMultiColumnSortKernelContext(int size) {
        ...
        public void sort(WritableLongChunk<PERMUTE_VALUES_ATTR> valuesToPermute,
            ...
            LongDoubleIndirectMultiColumnTimsortKernel.sort(this, positions, valuesToSort[0].asLongChunk(), valuesToSort[1].asDoubleChunk());
