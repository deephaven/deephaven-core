...
final class IncrementalAggHasherFloatDouble extends IncrementalChunkedOperatorAggregationStateManagerTypedBase {
    ...
    public IncrementalAggHasherFloatDouble(ColumnSource[] tableKeySources,
