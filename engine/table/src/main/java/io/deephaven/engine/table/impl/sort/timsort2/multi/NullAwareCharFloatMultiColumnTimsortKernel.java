...
/**
 * This implements a timsort kernel that sorts a multi-column key (NullAwareChar, Float), comparing each
 ...
 */
public final class NullAwareCharFloatMultiColumnTimsortKernel {
    private NullAwareCharFloatMultiColumnTimsortKernel() {
        throw new UnsupportedOperationException();
    }

    public static <SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> NullAwareCharFloatMultiColumnSortKernelContext<SORT_VALUES_ATTR, PERMUTE_VALUES_ATTR> createContext(
            final int size) {
        return new NullAwareCharFloatMultiColumnSortKernelContext<>(size);
    }
    ...
    static <SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> void sort(
            NullAwareCharFloatMultiColumnSortKernelContext<SORT_VALUES_ATTR, PERMUTE_VALUES_ATTR> context,
            WritableLongChunk<PERMUTE_VALUES_ATTR> valuesToPermute,
            WritableCharChunk<SORT_VALUES_ATTR> valuesToSort0,
            WritableFloatChunk<SORT_VALUES_ATTR> valuesToSort1,
    ...
    private static <SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> void timSort(
            ...
            WritableLongChunk<PERMUTE_VALUES_ATTR> valuesToPermute,
            WritableCharChunk<SORT_VALUES_ATTR> valuesToSort0,
            WritableFloatChunk<SORT_VALUES_ATTR> valuesToSort1, int offset, int length) {
        if (length <= 1) {
            return;
        }
    ...
    private static int doComparison1(float lhs, float rhs) {
    ...
    private static <SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> void merge(
            ...
            WritableLongChunk<PERMUTE_VALUES_ATTR> valuesToPermute,
            WritableCharChunk<SORT_VALUES_ATTR> valuesToSort0,
            WritableFloatChunk<SORT_VALUES_ATTR> valuesToSort1, int start1, int length1,
            int length2) {
        ...
        final float run2lo1 = valuesToSort1.get(start2);
        ...
        final float run1hi1 = valuesToSort1.get(start1 + length1 - 1);
    ...
    private static <SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> void frontMerge(
            ...
            WritableLongChunk<PERMUTE_VALUES_ATTR> valuesToPermute,
            WritableCharChunk<SORT_VALUES_ATTR> valuesToSort0,
            WritableFloatChunk<SORT_VALUES_ATTR> valuesToSort1, final int mergeStartPosition,
    ...
    private static <SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> void copyToTemporary(
            ...
            WritableLongChunk<PERMUTE_VALUES_ATTR> valuesToPermute,
            WritableCharChunk<SORT_VALUES_ATTR> valuesToSort0,
            WritableFloatChunk<SORT_VALUES_ATTR> valuesToSort1, int mergeStartPosition,
            int remaining1) {
    ...
    private static <SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> void copyToChunk(
            ...
            FloatChunk<SORT_VALUES_ATTR> valuesSource1,
            WritableLongChunk<PERMUTE_VALUES_ATTR> permuteValuesDest,
            WritableCharChunk<SORT_VALUES_ATTR> sortValuesDest0,
            WritableFloatChunk<SORT_VALUES_ATTR> sortValuesDest1, int sourceStart, int destStart,
            int length) {
    ...
    private static int upperBound(CharChunk<?> valuesToSort0, FloatChunk<?> valuesToSort1, int lo,
            int hi, char searchValue0, float searchValue1) {
    ...
    private static int lowerBound(CharChunk<?> valuesToSort0, FloatChunk<?> valuesToSort1, int lo,
            int hi, char searchValue0, float searchValue1) {
    ...
    private static int bound(CharChunk<?> valuesToSort0, FloatChunk<?> valuesToSort1, int lo,
            int hi, char searchValue0, float searchValue1, final boolean lower) {
    ...
    private static void insertionSort(WritableLongChunk<?> valuesToPermute,
            WritableCharChunk<?> valuesToSort0, WritableFloatChunk<?> valuesToSort1, int offset,
            int length) {
    ...
    private static void swap(WritableLongChunk<?> valuesToPermute,
            WritableCharChunk<?> valuesToSort0, WritableFloatChunk<?> valuesToSort1, int a, int b) {
        final long tempPermuteValue = valuesToPermute.get(a);
        final char temp0 = valuesToSort0.get(a);
        final float temp1 = valuesToSort1.get(a);
    ...
    public static class NullAwareCharFloatMultiColumnSortKernelContext<SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> implements MultiColumnSortKernel<PERMUTE_VALUES_ATTR> {
        int minGallop;
        ...
        private final WritableFloatChunk<SORT_VALUES_ATTR> temporaryValues1;

        private NullAwareCharFloatMultiColumnSortKernelContext(int size) {
            temporaryKeys = WritableLongChunk.makeWritableChunk((size + 2) / 2);
            temporaryValues0 = WritableCharChunk.makeWritableChunk((size + 2) / 2);
            temporaryValues1 = WritableFloatChunk.makeWritableChunk((size + 2) / 2);
        ...
        public void sort(WritableLongChunk<PERMUTE_VALUES_ATTR> valuesToPermute,
            ...
            NullAwareCharFloatMultiColumnTimsortKernel.sort(this, valuesToPermute,
                            (WritableCharChunk<SORT_VALUES_ATTR>) valuesToSort[0].asWritableCharChunk(),
                            (WritableFloatChunk<SORT_VALUES_ATTR>) valuesToSort[1].asWritableFloatChunk());
        }
