...
final class StaticAggHasherIntFloat extends StaticChunkedOperatorAggregationStateManagerTypedBase {
    ...
    public StaticAggHasherIntFloat(ColumnSource[] tableKeySources,
