...
public final class DoubleReverseSegmentedSortedArray implements SegmentedSortedArray {
     ...
     */
    private <T extends Any> int findNext(DoubleChunk<T> stampValues, LongChunk<? extends Attributes.RowKeys> stampRowKeys, WritableDoubleChunk<T> nextValues) {
    ...
    private static <T extends Any> int findNextOneLeaf(int offset, DoubleChunk<T> stampValues, LongChunk<? extends Attributes.RowKeys> stampRowKeys, WritableDoubleChunk<T> nextValues, int leafSize, double [] leafValues, long [] leafKeys) {
        int lo = 0;
     ...
     */
    void insert(DoubleChunk<? extends Any> valuesToInsert, LongChunk<? extends Attributes.RowKeys> rowKeysToInsert) {
    ...
    private void copyToLeaf(int leafOffset, double[] leafValues, DoubleChunk<? extends Any> insertValues, long[] leafRowKeys, LongChunk<? extends RowKeys> insertRowKeys) {
        copyToLeaf(leafOffset, leafValues, insertValues, leafRowKeys, insertRowKeys, 0, insertRowKeys.size());
    }

    private void copyToLeaf(int leafOffset, double[] leafValues, DoubleChunk<? extends Any> insertValues, long[] leafRowKeys, LongChunk<? extends Attributes.RowKeys> insertRowKeys, int srcOffset, int length) {
    ...
    private void distributeValues(int targetSize, int startingLeaf, int distributionSlots, DoubleChunk<? extends Any> valuesToInsert, LongChunk<? extends Attributes.RowKeys> rowKeys) {
    ...
    private void insertIntoLeaf(int leafSize, double [] leafValues, DoubleChunk<? extends Any> insertValues, long [] leafRowKeys, LongChunk<? extends Attributes.RowKeys> insertRowKeys) {
    ...
    private boolean isAfterLeaf(int leafSize, double[] leafValues, DoubleChunk<? extends Any> insertValues, long[] leafRowKeys, LongChunk<? extends RowKeys> insertRowKeys) {
    ...
    private void removeFromLeaf(int leafSize, double [] leafValues, DoubleChunk<? extends Any> removeValues, long [] leafRowKeys, LongChunk<? extends Attributes.RowKeys> removeRowKeys, @Nullable WritableLongChunk<? extends Attributes.RowKeys> priorRedirections, long firstPriorRedirection) {
    ...
    private static int lowerBound(DoubleChunk<? extends Any> valuesToSearch, LongChunk<? extends RowKeys> rowKeysToSearch, int lo, int hi, double searchValue, long searchKey) {
        while (lo < hi) {
    ...
    private static int upperBound(DoubleChunk<? extends Any> valuesToSearch, LongChunk<? extends Attributes.RowKeys> rowKeysToSearch, int lo, int hi, double searchValue, long searchKey) {
        while (lo < hi) {
            final int mid = (lo + hi) >>> 1;
            final double testValue = valuesToSearch.get(mid);
            final int comparison = doComparison(testValue, searchValue);
    ...
    private static int lowerBound(double [] valuesToSearch, long [] rowKeysToSearch, int lo, int hi, double searchValue, long searchKey) {
        while (lo < hi) {
            final int mid = (lo + hi) >>> 1;
     ...
     */
    private static int bound(double [] valuesToSearch, long [] rowKeysToSearch, final double searchValue, long searchRowKey, int lo, int hi) {
        while (lo < hi) {
            final int mid = (lo + hi) >>> 1;
            final double testValue = valuesToSearch[mid];
            final int comparison = doComparison(testValue, searchValue);
    ...
    private void remove(DoubleChunk<? extends Any> valuesToRemove, LongChunk<? extends Attributes.RowKeys> rowKeysToRemove) {
     ...
     */
    private void removeAndGetNextInternal(DoubleChunk<? extends Any> valuesToRemove, LongChunk<? extends RowKeys> rowKeysToRemove, @Nullable WritableLongChunk<? extends Attributes.RowKeys> priorRedirections) {
        validate();
    ...
    private void shiftLeaf(int leafSize, double [] leafValues, DoubleChunk<? extends Any> shiftValues, long [] leafRowKeys, LongChunk<? extends Attributes.RowKeys> shiftRowKeys, long shiftDelta) {
        Assert.leq(leafSize, "leafSize", this.leafSize, "this.leafSize");
    ...
    private void shiftLeafReverse(int leafSize, double [] leafValues, DoubleChunk<? extends Any> shiftValues, long [] leafRowKeys, LongChunk<? extends Attributes.RowKeys> shiftRowKeys, long shiftDelta) {
        Assert.leq(leafSize, "leafSize", this.leafSize, "this.leafSize");
        final int shiftSize = shiftValues.size();
