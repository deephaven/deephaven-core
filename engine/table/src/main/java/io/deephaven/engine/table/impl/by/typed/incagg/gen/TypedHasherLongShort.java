...
final class TypedHasherLongShort extends IncrementalChunkedOperatorAggregationStateManagerTypedBase {
  ...
  public TypedHasherLongShort(ColumnSource[] tableKeySources, int tableSize,
  ...
  private int hash(long v0, short v1) {
  ...
  private boolean findOverflow(HashHandler handler, long v0, short v1, int chunkPosition,
