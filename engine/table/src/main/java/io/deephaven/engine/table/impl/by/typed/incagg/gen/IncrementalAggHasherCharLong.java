...
final class IncrementalAggHasherCharLong extends IncrementalChunkedOperatorAggregationStateManagerTypedBase {
    ...
    public IncrementalAggHasherCharLong(ColumnSource[] tableKeySources,
    ...
    private boolean findOverflow(HashHandler handler, char k0, long k1, int chunkPosition,
