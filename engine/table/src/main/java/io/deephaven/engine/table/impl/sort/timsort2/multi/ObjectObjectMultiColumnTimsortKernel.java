...
/**
 * This implements a timsort kernel that sorts a multi-column key (Object, Object), comparing each
 ...
 */
public final class ObjectObjectMultiColumnTimsortKernel {
    private ObjectObjectMultiColumnTimsortKernel() {
        throw new UnsupportedOperationException();
    }

    public static <SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> ObjectObjectMultiColumnSortKernelContext<SORT_VALUES_ATTR, PERMUTE_VALUES_ATTR> createContext(
            final int size) {
        return new ObjectObjectMultiColumnSortKernelContext<>(size);
    }
    ...
    static <SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> void sort(
            ObjectObjectMultiColumnSortKernelContext<SORT_VALUES_ATTR, PERMUTE_VALUES_ATTR> context,
    ...
    private static int upperBound(ObjectChunk<Object, ?> valuesToSort0,
            ObjectChunk<Object, ?> valuesToSort1, int lo, int hi, Object searchValue0,
            Object searchValue1) {
    ...
    private static int bound(ObjectChunk<Object, ?> valuesToSort0,
            ObjectChunk<Object, ?> valuesToSort1, int lo, int hi, Object searchValue0,
            Object searchValue1, final boolean lower) {
    ...
    private static void insertionSort(WritableLongChunk<?> valuesToPermute,
            WritableObjectChunk<Object, ?> valuesToSort0,
            WritableObjectChunk<Object, ?> valuesToSort1, int offset, int length) {
    ...
    private static void swap(WritableLongChunk<?> valuesToPermute,
            WritableObjectChunk<Object, ?> valuesToSort0,
            WritableObjectChunk<Object, ?> valuesToSort1, int a, int b) {
    ...
    public static class ObjectObjectMultiColumnSortKernelContext<SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> implements MultiColumnSortKernel<PERMUTE_VALUES_ATTR> {
        int minGallop;
        ...
        private ObjectObjectMultiColumnSortKernelContext(int size) {
        ...
        public void sort(WritableLongChunk<PERMUTE_VALUES_ATTR> valuesToPermute,
            ...
            ObjectObjectMultiColumnTimsortKernel.sort(this, valuesToPermute,
