...
/**
 * This implements a timsort kernel that sorts a multi-column key (Short, NullAwareChar), comparing each
 ...
 */
public final class ShortNullAwareCharMultiColumnTimsortKernel {
    private ShortNullAwareCharMultiColumnTimsortKernel() {
        throw new UnsupportedOperationException();
    }

    public static <SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> ShortNullAwareCharMultiColumnSortKernelContext<SORT_VALUES_ATTR, PERMUTE_VALUES_ATTR> createContext(
            final int size) {
        return new ShortNullAwareCharMultiColumnSortKernelContext<>(size);
    }
    ...
    static <SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> void sort(
            ShortNullAwareCharMultiColumnSortKernelContext<SORT_VALUES_ATTR, PERMUTE_VALUES_ATTR> context,
    ...
    private static int upperBound(ShortChunk<?> valuesToSort0, CharChunk<?> valuesToSort1, int lo,
            int hi, short searchValue0, char searchValue1) {
    ...
    private static int lowerBound(ShortChunk<?> valuesToSort0, CharChunk<?> valuesToSort1, int lo,
            int hi, short searchValue0, char searchValue1) {
    ...
    private static int bound(ShortChunk<?> valuesToSort0, CharChunk<?> valuesToSort1, int lo,
            int hi, short searchValue0, char searchValue1, final boolean lower) {
    ...
    private static void insertionSort(WritableLongChunk<?> valuesToPermute,
            WritableShortChunk<?> valuesToSort0, WritableCharChunk<?> valuesToSort1, int offset,
            int length) {
    ...
    private static void swap(WritableLongChunk<?> valuesToPermute,
            WritableShortChunk<?> valuesToSort0, WritableCharChunk<?> valuesToSort1, int a, int b) {
    ...
    public static class ShortNullAwareCharMultiColumnSortKernelContext<SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> implements MultiColumnSortKernel<PERMUTE_VALUES_ATTR> {
        int minGallop;
        ...
        private ShortNullAwareCharMultiColumnSortKernelContext(int size) {
        ...
        public void sort(WritableLongChunk<PERMUTE_VALUES_ATTR> valuesToPermute,
            ...
            ShortNullAwareCharMultiColumnTimsortKernel.sort(this, valuesToPermute,
