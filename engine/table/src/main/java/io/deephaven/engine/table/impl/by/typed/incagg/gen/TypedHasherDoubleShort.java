...
public final class TypedHasherDoubleShort extends IncrementalChunkedOperatorAggregationStateManagerTypedBase {
  ...
  public TypedHasherDoubleShort(ColumnSource[] tableKeySources, int tableSize,
  ...
  private int hash(double v0, short v1) {
  ...
  private boolean findOverflow(HashHandler handler, double v0, short v1, int chunkPosition,
