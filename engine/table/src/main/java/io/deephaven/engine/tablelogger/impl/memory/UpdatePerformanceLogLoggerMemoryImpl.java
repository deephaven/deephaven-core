...
class UpdatePerformanceLogLoggerMemoryImpl extends MemoryTableLogger<UpdatePerformanceLogLoggerMemoryImpl.ISetter>
        implements UpdatePerformanceLogLogger {
    ...
    class DirectSetter extends BaseSetter implements ISetter {
        ...
        public void log(final Row.Flags flags, final IntervalLevelDetails intervalLevelDetails,
            ...
            this.IntervalStartTime.set(
                    DateTimeUtils.epochMillisToInstant(intervalLevelDetails.getIntervalStartTimeMillis()));
            this.IntervalEndTime.set(
                    DateTimeUtils.epochMillisToInstant(intervalLevelDetails.getIntervalEndTimeMillis()));
