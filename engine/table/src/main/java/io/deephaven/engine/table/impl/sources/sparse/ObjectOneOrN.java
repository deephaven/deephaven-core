...
public final class ObjectOneOrN {
    ...
    static public final class Block0<T> {
         ...
         * @param recycler2 recycler for Object[][] from Block2<T>
         * @param recycler1 recycler for block2 structures from Block1<T>
         * @param recycler0 recycler for Block1<T> structures from Block0
         */
        public void clearBlock(final long block2Idx,
                               ...
                               final SoftRecycler<Block1<T>[]> recycler0) {
         ...
         * @param recycler0 the recycler for our array of Block1<T> structures if we are empty
         * @return true if there are no more elements in this block
         */
        @SuppressWarnings("UnusedReturnValue")
        private boolean clearByIndex(final int idx, final SoftRecycler<Block1<T>[]> recycler0) {
    ...
    static public final class Block1<T> {
         ...
         * @return true if there are no more elements in this block
         */
        private boolean clearByIndex(final int idx, final SoftRecycler<Block2<T>[]> recycler1) {
            Assert.neq(idx, "idx", HAVE_MORE_THAN_ONE, "HAVE_MORE_THAN_ONE");
            if (oneIndex == idx) {
                oneValue = null;
                oneIndex = ONE_UNINITIALIZED;
