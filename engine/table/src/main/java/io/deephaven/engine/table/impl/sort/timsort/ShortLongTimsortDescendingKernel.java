...
// ****** Edit ShortLongTimsortDescendingKernel and run "./gradlew replicateSortKernel" to regenerate
//
// @formatter:off
...
public final class ShortLongTimsortDescendingKernel {
    ...
    // region Context
    public class ShortLongSortKernelContext<SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any>
    ...
    public <SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> ShortLongSortKernelContext<SORT_VALUES_ATTR, PERMUTE_VALUES_ATTR> createContextInstance(int size) {
    ...
    public static <SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> ShortLongSortKernelContext<SORT_VALUES_ATTR, PERMUTE_VALUES_ATTR> createContext(final int size) {
    ...
    private static <SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> void copyToChunk(
            ...
            ShortChunk<SORT_VALUES_ATTR> valuesSource,
            WritableLongChunk<PERMUTE_VALUES_ATTR> permuteValuesDest,
            WritableShortChunk<SORT_VALUES_ATTR> sortValuesDest,
            int sourceStart,
            int destStart,
            int length) {
    ...
    private int bound(ShortChunk<?> valuesToSort, int lo, int hi, short searchValue, final boolean lower) {
    ...
    private void insertionSort(
            ...
            WritableShortChunk<?> valuesToSort,
            int offset,
            int length) {
    ...
    static private void swap(WritableLongChunk<?> valuesToPermute, WritableShortChunk<?> valuesToSort, int a, int b) {
    ...
    // private static void doCheck(Chunk.LongChunk valuesToPermute, Chunk.ShortChunk valuesToSort, int startCheck, int
    // mergeEnd) {
    // short lastCheck;
    ...
    // private static void dumpValues(Chunk.ShortChunk valuesToSort, int start1, int length1, int start2, int length2,
    // String msg) {
