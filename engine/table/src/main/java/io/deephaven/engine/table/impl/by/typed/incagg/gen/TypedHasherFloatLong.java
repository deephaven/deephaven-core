...
final class TypedHasherFloatLong extends IncrementalChunkedOperatorAggregationStateManagerTypedBase {
  ...
  public TypedHasherFloatLong(ColumnSource[] tableKeySources, int tableSize,
  ...
  private int hash(float v0, long v1) {
  ...
  private boolean findOverflow(HashHandler handler, float v0, long v1, int chunkPosition,
