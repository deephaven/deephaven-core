...
final class IncrementalAggOpenHasherWithTombstoneIntFloat extends IncrementalChunkedOperatorAggregationStateManagerOpenAddressedBaseWithTombstones {
    ...
    public IncrementalAggOpenHasherWithTombstoneIntFloat(ColumnSource[] tableKeySources,
