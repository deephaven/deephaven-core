...
final class IncrementalAggHasherShort extends IncrementalChunkedOperatorAggregationStateManagerTypedBase {
    private final ShortArraySource mainKeySource0;

    private final ShortArraySource overflowKeySource0;

    public IncrementalAggHasherShort(ColumnSource[] tableKeySources,
