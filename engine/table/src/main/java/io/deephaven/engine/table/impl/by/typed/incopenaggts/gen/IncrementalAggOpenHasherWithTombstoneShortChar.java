...
final class IncrementalAggOpenHasherWithTombstoneShortChar extends IncrementalChunkedOperatorAggregationStateManagerOpenAddressedBaseWithTombstones {
    ...
    public IncrementalAggOpenHasherWithTombstoneShortChar(ColumnSource[] tableKeySources,
