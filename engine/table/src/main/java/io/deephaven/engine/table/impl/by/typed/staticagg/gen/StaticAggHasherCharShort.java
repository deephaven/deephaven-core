...
final class StaticAggHasherCharShort extends StaticChunkedOperatorAggregationStateManagerTypedBase {
    ...
    public StaticAggHasherCharShort(ColumnSource[] tableKeySources,
