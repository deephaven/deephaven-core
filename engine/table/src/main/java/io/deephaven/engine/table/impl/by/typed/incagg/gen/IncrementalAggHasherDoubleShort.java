...
final class IncrementalAggHasherDoubleShort extends IncrementalChunkedOperatorAggregationStateManagerTypedBase {
    ...
    public IncrementalAggHasherDoubleShort(ColumnSource[] tableKeySources,
    ...
    private static int hash(double k0, short k1) {
    ...
    private boolean findOverflow(HashHandler handler, double k0, short k1, int chunkPosition,
