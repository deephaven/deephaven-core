...
/**
 * This implements a timsort kernel that sorts a multi-column key (Float, Float), comparing each
 ...
 */
public final class FloatFloatMultiColumnTimsortKernel {
    private FloatFloatMultiColumnTimsortKernel() {
        throw new UnsupportedOperationException();
    }

    public static <SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> FloatFloatMultiColumnSortKernelContext<SORT_VALUES_ATTR, PERMUTE_VALUES_ATTR> createContext(
            final int size) {
        return new FloatFloatMultiColumnSortKernelContext<>(size);
    }
    ...
    static <SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> void sort(
            FloatFloatMultiColumnSortKernelContext<SORT_VALUES_ATTR, PERMUTE_VALUES_ATTR> context,
    ...
    private static int upperBound(FloatChunk<?> valuesToSort0, FloatChunk<?> valuesToSort1, int lo,
            int hi, float searchValue0, float searchValue1) {
    ...
    private static int lowerBound(FloatChunk<?> valuesToSort0, FloatChunk<?> valuesToSort1, int lo,
            int hi, float searchValue0, float searchValue1) {
    ...
    private static int bound(FloatChunk<?> valuesToSort0, FloatChunk<?> valuesToSort1, int lo,
            int hi, float searchValue0, float searchValue1, final boolean lower) {
    ...
    private static void insertionSort(WritableLongChunk<?> valuesToPermute,
            WritableFloatChunk<?> valuesToSort0, WritableFloatChunk<?> valuesToSort1, int offset,
            int length) {
    ...
    private static void swap(WritableLongChunk<?> valuesToPermute,
            WritableFloatChunk<?> valuesToSort0, WritableFloatChunk<?> valuesToSort1, int a,
            int b) {
    ...
    public static class FloatFloatMultiColumnSortKernelContext<SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> implements MultiColumnSortKernel<PERMUTE_VALUES_ATTR> {
        int minGallop;
        ...
        private FloatFloatMultiColumnSortKernelContext(int size) {
        ...
        public void sort(WritableLongChunk<PERMUTE_VALUES_ATTR> valuesToPermute,
            ...
            FloatFloatMultiColumnTimsortKernel.sort(this, valuesToPermute,
