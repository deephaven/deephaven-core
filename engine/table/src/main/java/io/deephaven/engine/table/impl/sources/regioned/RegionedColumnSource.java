 ...
 * {@link TrackingWritableRowSet TrackingWritableRowSet} for such a {@link Table table}, we statically partition the
 * available element address space from [0, {@value Long#MAX_VALUE} <i>(2^63-1)</i>].
 *
 * <p>
