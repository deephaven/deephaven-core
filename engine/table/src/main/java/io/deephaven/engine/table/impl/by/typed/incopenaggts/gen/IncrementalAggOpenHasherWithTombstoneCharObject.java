...
final class IncrementalAggOpenHasherWithTombstoneCharObject extends IncrementalChunkedOperatorAggregationStateManagerOpenAddressedBaseWithTombstones {
    ...
    public IncrementalAggOpenHasherWithTombstoneCharObject(ColumnSource[] tableKeySources,
