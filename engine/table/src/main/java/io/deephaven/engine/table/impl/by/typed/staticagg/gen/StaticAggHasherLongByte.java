...
final class StaticAggHasherLongByte extends StaticChunkedOperatorAggregationStateManagerTypedBase {
    ...
    public StaticAggHasherLongByte(ColumnSource[] tableKeySources,
