...
/*
 * ---------------------------------------------------------------------------------------------------------------------
 * AUTO-GENERATED CLASS - DO NOT EDIT MANUALLY - for any changes edit DoubleLongTimsortKernel and regenerate
 * ---------------------------------------------------------------------------------------------------------------------
 */
...
public class DoubleIntTimsortKernel {
    ...
    // region Context
    public static class DoubleIntSortKernelContext<ATTR extends Any, KEY_INDICES extends Indices> implements IntSortKernel<ATTR, KEY_INDICES> {
        int minGallop;
        int runCount = 0;
        ...
        public void sort(WritableIntChunk<KEY_INDICES> indexKeys, WritableChunk<ATTR> valuesToSort) {
            DoubleIntTimsortKernel.sort(this, indexKeys, valuesToSort.asWritableDoubleChunk());
        }
        ...
        public void sort(WritableIntChunk<KEY_INDICES> indexKeys, WritableChunk<ATTR> valuesToSort, IntChunk<? extends ChunkPositions> offsetsIn, IntChunk<? extends ChunkLengths> lengthsIn) {
            DoubleIntTimsortKernel.sort(this, indexKeys, valuesToSort.asWritableDoubleChunk(), offsetsIn, lengthsIn);
        }
    ...
    public static <ATTR extends Any, KEY_INDICES extends Indices> DoubleIntSortKernelContext<ATTR, KEY_INDICES> createContext(int size) {
     ...
     */
    static <ATTR extends Any, KEY_INDICES extends Indices> void sort(DoubleIntSortKernelContext<ATTR, KEY_INDICES> context, WritableIntChunk<KEY_INDICES> indexKeys, WritableDoubleChunk<ATTR> valuesToSort, IntChunk<? extends ChunkPositions> offsetsIn, IntChunk<? extends ChunkLengths> lengthsIn) {
     ...
     * runs sorted on each pass.
     */
    public static <ATTR extends Any, KEY_INDICES extends Indices> void sort(DoubleIntSortKernelContext<ATTR, KEY_INDICES> context, WritableIntChunk<KEY_INDICES> indexKeys, WritableDoubleChunk<ATTR> valuesToSort) {
        timSort(context, indexKeys, valuesToSort, 0, indexKeys.size());
    }

    static private <ATTR extends Any, KEY_INDICES extends Indices> void timSort(DoubleIntSortKernelContext<ATTR, KEY_INDICES> context, WritableIntChunk<KEY_INDICES> indexKeys, WritableDoubleChunk<ATTR> valuesToSort, int offset, int length) {
        if (length <= 1) {
            return;
        }
     ...
     */
    private static <ATTR extends Any, KEY_INDICES extends Indices> void ensureMergeInvariants(DoubleIntSortKernelContext<ATTR, KEY_INDICES> context, WritableIntChunk<KEY_INDICES> indexKeys, WritableDoubleChunk<ATTR> valuesToSort) {
        while (context.runCount > 1) {
    ...
    private static <ATTR extends Any, KEY_INDICES extends Indices> void merge(DoubleIntSortKernelContext<ATTR, KEY_INDICES> context, WritableIntChunk<KEY_INDICES> indexKeys, WritableDoubleChunk<ATTR> valuesToSort, int start1, int length1, int length2) {
     ...
     */
    private static <ATTR extends Any, KEY_INDICES extends Indices> void frontMerge(DoubleIntSortKernelContext<ATTR, KEY_INDICES> context, WritableIntChunk<KEY_INDICES> indexKeys, WritableDoubleChunk<ATTR> valuesToSort, final int mergeStartPosition, final int start2, final int length2) {
        int tempCursor = 0;
     ...
     * We eventually need to do galloping here, but are skipping that for now
     */
    private static <ATTR extends Any, KEY_INDICES extends Indices> void backMerge(DoubleIntSortKernelContext<ATTR, KEY_INDICES> context, WritableIntChunk<KEY_INDICES> indexKeys, WritableDoubleChunk<ATTR> valuesToSort, final int mergeStartPosition, final int length1) {
    ...
    private static <ATTR extends Any, KEY_INDICES extends Indices> void copyToTemporary(DoubleIntSortKernelContext<ATTR, KEY_INDICES> context, WritableIntChunk<KEY_INDICES> indexKeys, WritableDoubleChunk<ATTR> valuesToSort, int mergeStartPosition, int remaining1) {
    ...
    private static <ATTR extends Any, KEY_INDICES extends Indices> void copyToChunk(IntChunk<KEY_INDICES> rowSetSource, DoubleChunk<ATTR> valuesSource, WritableIntChunk<KEY_INDICES> indexDest, WritableDoubleChunk<ATTR> valuesDest, int sourceStart, int destStart, int length) {
    ...
    private static void insertionSort(WritableIntChunk<? extends Indices> indexKeys, WritableDoubleChunk<?> valuesToSort, int offset, int length) {
    ...
    static private void swap(WritableIntChunk<? extends Indices> indexKeys, WritableDoubleChunk<?> valuesToSort, int a, int b) {
