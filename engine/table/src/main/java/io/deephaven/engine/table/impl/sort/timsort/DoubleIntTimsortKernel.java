...
public final class DoubleIntTimsortKernel {
    ...
    // region Context
    public class DoubleIntSortKernelContext<SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any>
    ...
    public <SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> DoubleIntSortKernelContext<SORT_VALUES_ATTR, PERMUTE_VALUES_ATTR> createContextInstance(int size) {
    ...
    public static <SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> DoubleIntSortKernelContext<SORT_VALUES_ATTR, PERMUTE_VALUES_ATTR> createContext(final int size) {
    ...
    static private void swap(WritableIntChunk<?> valuesToPermute, WritableDoubleChunk<?> valuesToSort, int a, int b) {
    ...
    // private static void doCheck(Chunk.IntChunk valuesToPermute, Chunk.DoubleChunk valuesToSort, int startCheck, int
    // mergeEnd) {
    // double lastCheck;
    ...
    // private static void dumpValues(Chunk.DoubleChunk valuesToSort, int start1, int length1, int start2, int length2,
    // String msg) {
