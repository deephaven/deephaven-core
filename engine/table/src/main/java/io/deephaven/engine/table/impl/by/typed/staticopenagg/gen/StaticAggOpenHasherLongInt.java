...
final class StaticAggOpenHasherLongInt extends StaticChunkedOperatorAggregationStateManagerOpenAddressedBase {
    private final ImmutableLongArraySource mainKeySource0;

    private final ImmutableIntArraySource mainKeySource1;

    public StaticAggOpenHasherLongInt(ColumnSource[] tableKeySources,
    ...
    private static int hash(long k0, int k1) {
