...
final class StaticAggHasherObject extends StaticChunkedOperatorAggregationStateManagerTypedBase {
    private final ObjectArraySource mainKeySource0;

    private final ObjectArraySource overflowKeySource0;

    public StaticAggHasherObject(ColumnSource[] tableKeySources,
