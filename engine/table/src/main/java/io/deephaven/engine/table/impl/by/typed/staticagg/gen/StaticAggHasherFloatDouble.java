...
final class StaticAggHasherFloatDouble extends StaticChunkedOperatorAggregationStateManagerTypedBase {
    ...
    public StaticAggHasherFloatDouble(ColumnSource[] tableKeySources,
