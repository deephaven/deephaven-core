 ...
 * the algorithm.
 */
public class ShortLongTimsortKernel {
    private ShortLongTimsortKernel() {
    ...
    public static class ShortLongSortKernelContext<ATTR extends Any, KEY_INDICES extends Indices> implements LongSortKernel<ATTR, KEY_INDICES> {
        ...
        public void sort(WritableLongChunk<KEY_INDICES> indexKeys, WritableChunk<ATTR> valuesToSort) {
            ShortLongTimsortKernel.sort(this, indexKeys, valuesToSort.asWritableShortChunk());
        }
        ...
        public void sort(WritableLongChunk<KEY_INDICES> indexKeys, WritableChunk<ATTR> valuesToSort, IntChunk<? extends ChunkPositions> offsetsIn, IntChunk<? extends ChunkLengths> lengthsIn) {
            ShortLongTimsortKernel.sort(this, indexKeys, valuesToSort.asWritableShortChunk(), offsetsIn, lengthsIn);
        }
