...
public class ShortLongTimsortKernel {
    ...
    ShortLongSortKernelContext<SORT_VALUES_ATTR, PERMUTE_VALUES_ATTR> createContext(int size) {
...
//    private static void doCheck(Chunk.LongChunk valuesToPermute, Chunk.ShortChunk valuesToSort, int startCheck, int mergeEnd) {
//        short lastCheck;
