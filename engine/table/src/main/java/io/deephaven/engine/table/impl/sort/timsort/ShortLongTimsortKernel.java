 ...
 */
public final class ShortLongTimsortKernel {
    ...
    public static <SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> ShortLongSortKernelContext<SORT_VALUES_ATTR, PERMUTE_VALUES_ATTR> createContext(
            final int size) {
        return new ShortLongTimsortKernel().createContextInstance(size);
    }
    ...
    public class ShortLongSortKernelContext<SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> implements LongSortKernel<SORT_VALUES_ATTR, PERMUTE_VALUES_ATTR> {
        ...
        public void sort(WritableLongChunk<PERMUTE_VALUES_ATTR> valuesToPermute,
            ...
            ShortLongTimsortKernel.this.sort(this, valuesToPermute, valuesToSort.asWritableShortChunk());
        }
        ...
        public void sort(WritableLongChunk<PERMUTE_VALUES_ATTR> valuesToPermute,
                ...
                IntChunk<? extends ChunkPositions> offsetsIn,
                IntChunk<? extends ChunkLengths> lengthsIn) {
            ShortLongTimsortKernel.this.sort(this, valuesToPermute, valuesToSort.asWritableShortChunk(), offsetsIn, lengthsIn);
        }

        @Override
        public void sort(WritableLongChunk<PERMUTE_VALUES_ATTR> valuesToPermute,
                WritableChunk<SORT_VALUES_ATTR> valuesToSort, int offset, int length) {
            ShortLongTimsortKernel.this.timSort(this, valuesToPermute, valuesToSort.asWritableShortChunk(), offset, length);
        }
        ...
        public void merge(WritableLongChunk<PERMUTE_VALUES_ATTR> valuesToPermute,
                ...
                int length2) {
            ShortLongTimsortKernel.this.merge(this, valuesToPermute, valuesToSort.asWritableShortChunk(), start1, length1, length2);
        }
        ...
        private ShortLongTimsortKernel kernel() {
            return ShortLongTimsortKernel.this;
        }
    }
}
