...
public class ShortLongTimsortKernel {
    ...
    public static class ShortLongSortKernelContext<SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any>
        ...
        public void sort(
            ...
            ShortLongTimsortKernel.sort(this, valuesToPermute, valuesToSort.asWritableShortChunk());
        }
        ...
        public void sort(
            ...
            ShortLongTimsortKernel.sort(this, valuesToPermute, valuesToSort.asWritableShortChunk(), offsetsIn, lengthsIn);
        }
