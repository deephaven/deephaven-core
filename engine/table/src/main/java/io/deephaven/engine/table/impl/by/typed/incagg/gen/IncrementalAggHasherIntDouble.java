...
final class IncrementalAggHasherIntDouble extends IncrementalChunkedOperatorAggregationStateManagerTypedBase {
    ...
    public IncrementalAggHasherIntDouble(ColumnSource[] tableKeySources,
