...
/**
 * This implements a timsort kernel that sorts a multi-column key (Float, Long), comparing each
 ...
 */
public final class FloatLongMultiColumnTimsortKernel {
    private FloatLongMultiColumnTimsortKernel() {
        throw new UnsupportedOperationException();
    }

    public static <SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> FloatLongMultiColumnSortKernelContext<SORT_VALUES_ATTR, PERMUTE_VALUES_ATTR> createContext(
            final int size) {
        return new FloatLongMultiColumnSortKernelContext<>(size);
    }
    ...
    static <SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> void sort(
            FloatLongMultiColumnSortKernelContext<SORT_VALUES_ATTR, PERMUTE_VALUES_ATTR> context,
    ...
    private static int upperBound(FloatChunk<?> valuesToSort0, LongChunk<?> valuesToSort1, int lo,
            int hi, float searchValue0, long searchValue1) {
    ...
    private static int lowerBound(FloatChunk<?> valuesToSort0, LongChunk<?> valuesToSort1, int lo,
            int hi, float searchValue0, long searchValue1) {
    ...
    private static int bound(FloatChunk<?> valuesToSort0, LongChunk<?> valuesToSort1, int lo,
            int hi, float searchValue0, long searchValue1, final boolean lower) {
    ...
    private static void insertionSort(WritableLongChunk<?> valuesToPermute,
            WritableFloatChunk<?> valuesToSort0, WritableLongChunk<?> valuesToSort1, int offset,
            int length) {
    ...
    private static void swap(WritableLongChunk<?> valuesToPermute,
            WritableFloatChunk<?> valuesToSort0, WritableLongChunk<?> valuesToSort1, int a, int b) {
    ...
    public static class FloatLongMultiColumnSortKernelContext<SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> implements MultiColumnSortKernel<PERMUTE_VALUES_ATTR> {
        int minGallop;
        ...
        private FloatLongMultiColumnSortKernelContext(int size) {
        ...
        public void sort(WritableLongChunk<PERMUTE_VALUES_ATTR> valuesToPermute,
            ...
            FloatLongMultiColumnTimsortKernel.sort(this, valuesToPermute,
