...
/**
 * This implements a timsort kernel that sorts a multi-column key (Short, Float), comparing each
 ...
 */
public final class ShortFloatMultiColumnTimsortKernel {
    private ShortFloatMultiColumnTimsortKernel() {
        throw new UnsupportedOperationException();
    }

    public static <SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> ShortFloatMultiColumnSortKernelContext<SORT_VALUES_ATTR, PERMUTE_VALUES_ATTR> createContext(
            final int size) {
        return new ShortFloatMultiColumnSortKernelContext<>(size);
    }
    ...
    static <SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> void sort(
            ShortFloatMultiColumnSortKernelContext<SORT_VALUES_ATTR, PERMUTE_VALUES_ATTR> context,
    ...
    private static int upperBound(ShortChunk<?> valuesToSort0, FloatChunk<?> valuesToSort1, int lo,
            int hi, short searchValue0, float searchValue1) {
    ...
    private static int lowerBound(ShortChunk<?> valuesToSort0, FloatChunk<?> valuesToSort1, int lo,
            int hi, short searchValue0, float searchValue1) {
    ...
    private static int bound(ShortChunk<?> valuesToSort0, FloatChunk<?> valuesToSort1, int lo,
            int hi, short searchValue0, float searchValue1, final boolean lower) {
    ...
    private static void insertionSort(WritableLongChunk<?> valuesToPermute,
            WritableShortChunk<?> valuesToSort0, WritableFloatChunk<?> valuesToSort1, int offset,
            int length) {
    ...
    private static void swap(WritableLongChunk<?> valuesToPermute,
            WritableShortChunk<?> valuesToSort0, WritableFloatChunk<?> valuesToSort1, int a,
            int b) {
    ...
    public static class ShortFloatMultiColumnSortKernelContext<SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> implements MultiColumnSortKernel<PERMUTE_VALUES_ATTR> {
        int minGallop;
        ...
        private ShortFloatMultiColumnSortKernelContext(int size) {
        ...
        public void sort(WritableLongChunk<PERMUTE_VALUES_ATTR> valuesToPermute,
            ...
            ShortFloatMultiColumnTimsortKernel.sort(this, valuesToPermute,
