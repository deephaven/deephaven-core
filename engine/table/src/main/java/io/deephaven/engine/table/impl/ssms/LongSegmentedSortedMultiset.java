...
public final class LongSegmentedSortedMultiset implements SegmentedSortedMultiSet<Long>, LongVector {
    ...
    private void insert(WritableLongChunk<? extends Values> valuesToInsert, WritableIntChunk<ChunkLengths> counts) {
        ...
        if (isSingleton()) {
            if (valuesToInsert.size() == 1 && LongComparisons.eq(valuesToInsert.get(0), singletonValue)) {
    ...
    private void remove(RemoveContext removeContext, LongChunk<? extends Values> valuesToRemove,
        ...
        if (isSingleton()) {
            ...
            Assert.assertion(LongComparisons.eq(valuesToRemove.get(0), singletonValue),
                    "LongComparisons.eq(valuesToRemove.get(0), singletonValue)");
            singletonCount -= counts.get(0);
