...
/**
 * This implements a timsort kernel that sorts a multi-column key (Object, Double), comparing each
 ...
 */
public final class ObjectDoubleMultiColumnTimsortKernel {
    private ObjectDoubleMultiColumnTimsortKernel() {
        throw new UnsupportedOperationException();
    }

    public static <SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> ObjectDoubleMultiColumnSortKernelContext<SORT_VALUES_ATTR, PERMUTE_VALUES_ATTR> createContext(
            final int size) {
        return new ObjectDoubleMultiColumnSortKernelContext<>(size);
    }
    ...
    static <SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> void sort(
            ObjectDoubleMultiColumnSortKernelContext<SORT_VALUES_ATTR, PERMUTE_VALUES_ATTR> context,
    ...
    private static int upperBound(ObjectChunk<Object, ?> valuesToSort0,
            DoubleChunk<?> valuesToSort1, int lo, int hi, Object searchValue0,
            double searchValue1) {
    ...
    private static int lowerBound(ObjectChunk<Object, ?> valuesToSort0,
            DoubleChunk<?> valuesToSort1, int lo, int hi, Object searchValue0,
            double searchValue1) {
    ...
    private static int bound(ObjectChunk<Object, ?> valuesToSort0, DoubleChunk<?> valuesToSort1,
            int lo, int hi, Object searchValue0, double searchValue1, final boolean lower) {
    ...
    private static void insertionSort(WritableLongChunk<?> valuesToPermute,
            WritableObjectChunk<Object, ?> valuesToSort0, WritableDoubleChunk<?> valuesToSort1,
    ...
    public static class ObjectDoubleMultiColumnSortKernelContext<SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> implements MultiColumnSortKernel<PERMUTE_VALUES_ATTR> {
        int minGallop;
        ...
        private ObjectDoubleMultiColumnSortKernelContext(int size) {
        ...
        public void sort(WritableLongChunk<PERMUTE_VALUES_ATTR> valuesToPermute,
            ...
            ObjectDoubleMultiColumnTimsortKernel.sort(this, valuesToPermute,
