...
/**
 * This implements a timsort kernel that sorts a multi-column key (Double, Double), comparing each
 ...
 */
public final class DoubleDoubleMultiColumnTimsortKernel {
    private DoubleDoubleMultiColumnTimsortKernel() {
        throw new UnsupportedOperationException();
    }

    public static <SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> DoubleDoubleMultiColumnSortKernelContext<SORT_VALUES_ATTR, PERMUTE_VALUES_ATTR> createContext(
            final int size) {
        return new DoubleDoubleMultiColumnSortKernelContext<>(size);
    }
    ...
    static <SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> void sort(
            DoubleDoubleMultiColumnSortKernelContext<SORT_VALUES_ATTR, PERMUTE_VALUES_ATTR> context,
    ...
    private static int upperBound(DoubleChunk<?> valuesToSort0, DoubleChunk<?> valuesToSort1,
            int lo, int hi, double searchValue0, double searchValue1) {
    ...
    private static int lowerBound(DoubleChunk<?> valuesToSort0, DoubleChunk<?> valuesToSort1,
            int lo, int hi, double searchValue0, double searchValue1) {
    ...
    private static int bound(DoubleChunk<?> valuesToSort0, DoubleChunk<?> valuesToSort1, int lo,
            int hi, double searchValue0, double searchValue1, final boolean lower) {
    ...
    private static void insertionSort(WritableLongChunk<?> valuesToPermute,
            WritableDoubleChunk<?> valuesToSort0, WritableDoubleChunk<?> valuesToSort1, int offset,
            int length) {
    ...
    private static void swap(WritableLongChunk<?> valuesToPermute,
            WritableDoubleChunk<?> valuesToSort0, WritableDoubleChunk<?> valuesToSort1, int a,
            int b) {
    ...
    public static class DoubleDoubleMultiColumnSortKernelContext<SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> implements MultiColumnSortKernel<PERMUTE_VALUES_ATTR> {
        int minGallop;
        ...
        private DoubleDoubleMultiColumnSortKernelContext(int size) {
        ...
        public void sort(WritableLongChunk<PERMUTE_VALUES_ATTR> valuesToPermute,
            ...
            DoubleDoubleMultiColumnTimsortKernel.sort(this, valuesToPermute,
