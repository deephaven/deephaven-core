...
final class IncrementalAggHasherObjectFloat extends IncrementalChunkedOperatorAggregationStateManagerTypedBase {
    ...
    public IncrementalAggHasherObjectFloat(ColumnSource[] tableKeySources,
    ...
    private static int hash(Object k0, float k1) {
    ...
    private boolean findOverflow(HashHandler handler, Object k0, float k1, int chunkPosition,
