...
// ****** Edit ShortByteTimsortDescendingKernel and run "./gradlew replicateSortKernel" to regenerate
//
// @formatter:off
 ...
 */
public class ShortByteTimsortDescendingKernel {
    ...
    public static class ShortByteSortKernelContext<SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any>
        ...
        public void sort(
            ...
            ShortByteTimsortDescendingKernel.sort(this, valuesToPermute, valuesToSort.asWritableShortChunk());
        }
        ...
        public void sort(
            ...
            ShortByteTimsortDescendingKernel.sort(this, valuesToPermute, valuesToSort.asWritableShortChunk(), offsetsIn, lengthsIn);
        }
