...
public final class DoubleDescIndirectTimsortKernel {
    ...
    public static class DoubleDescIndirectSortKernelContext<PERMUTE_VALUES_ATTR extends Any> implements MultiColumnSortKernel<PERMUTE_VALUES_ATTR> {
        ...
        public void sortPositions(WritableIntChunk<ChunkPositions> positions,
            ...
            DoubleDescIndirectTimsortKernel.timSort(this, positions, valuesToSort[0].asDoubleChunk(), offset, length);
        }
        ...
        public void mergePositions(WritableIntChunk<ChunkPositions> positions,
            ...
            DoubleDescIndirectTimsortKernel.merge(this, positions, valuesToSort[0].asDoubleChunk(), start1, length1, length2);
        }
