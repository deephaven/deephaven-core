...
final class IncrementalAggOpenHasherWithTombstoneIntDouble extends IncrementalChunkedOperatorAggregationStateManagerOpenAddressedBaseWithTombstones {
    ...
    public IncrementalAggOpenHasherWithTombstoneIntDouble(ColumnSource[] tableKeySources,
