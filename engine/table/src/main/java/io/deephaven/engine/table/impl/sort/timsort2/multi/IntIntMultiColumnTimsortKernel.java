...
/**
 * This implements a timsort kernel that sorts a multi-column key (Int, Int), comparing each
 ...
 */
public final class IntIntMultiColumnTimsortKernel {
    private IntIntMultiColumnTimsortKernel() {
        throw new UnsupportedOperationException();
    }

    public static <SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> IntIntMultiColumnSortKernelContext<SORT_VALUES_ATTR, PERMUTE_VALUES_ATTR> createContext(
            final int size) {
        return new IntIntMultiColumnSortKernelContext<>(size);
    }
    ...
    static <SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> void sort(
            IntIntMultiColumnSortKernelContext<SORT_VALUES_ATTR, PERMUTE_VALUES_ATTR> context,
    ...
    private static int upperBound(IntChunk<?> valuesToSort0, IntChunk<?> valuesToSort1, int lo,
            int hi, int searchValue0, int searchValue1) {
    ...
    private static int lowerBound(IntChunk<?> valuesToSort0, IntChunk<?> valuesToSort1, int lo,
            int hi, int searchValue0, int searchValue1) {
    ...
    private static int bound(IntChunk<?> valuesToSort0, IntChunk<?> valuesToSort1, int lo, int hi,
            int searchValue0, int searchValue1, final boolean lower) {
    ...
    private static void insertionSort(WritableLongChunk<?> valuesToPermute,
            WritableIntChunk<?> valuesToSort0, WritableIntChunk<?> valuesToSort1, int offset,
            int length) {
    ...
    private static void swap(WritableLongChunk<?> valuesToPermute,
            WritableIntChunk<?> valuesToSort0, WritableIntChunk<?> valuesToSort1, int a, int b) {
    ...
    public static class IntIntMultiColumnSortKernelContext<SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> implements MultiColumnSortKernel<PERMUTE_VALUES_ATTR> {
        int minGallop;
        ...
        private IntIntMultiColumnSortKernelContext(int size) {
        ...
        public void sort(WritableLongChunk<PERMUTE_VALUES_ATTR> valuesToPermute,
            ...
            IntIntMultiColumnTimsortKernel.sort(this, valuesToPermute,
