...
final class IncrementalAggOpenHasherWithTombstoneIntInt extends IncrementalChunkedOperatorAggregationStateManagerOpenAddressedBaseWithTombstones {
    ...
    public IncrementalAggOpenHasherWithTombstoneIntInt(ColumnSource[] tableKeySources,
