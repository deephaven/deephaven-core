...
/**
 * This implements a timsort kernel for a multi-column key (Float, Int) that never moves the column values:
 ...
 */
public final class FloatIntIndirectMultiColumnTimsortKernel {
    private FloatIntIndirectMultiColumnTimsortKernel() {
        throw new UnsupportedOperationException();
    }

    public static <PERMUTE_VALUES_ATTR extends Any> FloatIntIndirectMultiColumnSortKernelContext<PERMUTE_VALUES_ATTR> createContext(
            final int size) {
        return new FloatIntIndirectMultiColumnSortKernelContext<>(size);
    }
     ...
     */
    public static void sort(FloatIntIndirectMultiColumnSortKernelContext<?> context,
    ...
    private static void timSort(FloatIntIndirectMultiColumnSortKernelContext<?> context,
            WritableIntChunk<ChunkPositions> positions, FloatChunk<?> valuesToSort0,
     ...
     */
    private static int compareColumns(FloatChunk<?> valuesToSort0, IntChunk<?> valuesToSort1,
    ...
    private static void ensureMergeInvariants(
            FloatIntIndirectMultiColumnSortKernelContext<?> context,
            WritableIntChunk<ChunkPositions> positions, FloatChunk<?> valuesToSort0,
            IntChunk<?> valuesToSort1) {
        while (context.runCount > 1) {
    ...
    private static void merge(FloatIntIndirectMultiColumnSortKernelContext<?> context,
            WritableIntChunk<ChunkPositions> positions, FloatChunk<?> valuesToSort0,
     ...
     */
    private static void frontMerge(FloatIntIndirectMultiColumnSortKernelContext<?> context,
            WritableIntChunk<ChunkPositions> positions, FloatChunk<?> valuesToSort0,
     ...
     * We eventually need to do galloping here, but are skipping that for now
     */
    private static void backMerge(FloatIntIndirectMultiColumnSortKernelContext<?> context,
            WritableIntChunk<ChunkPositions> positions, FloatChunk<?> valuesToSort0,
    ...
    private static void copyToTemporary(FloatIntIndirectMultiColumnSortKernelContext<?> context,
    ...
    private static void insertionSort(WritableIntChunk<ChunkPositions> positions,
            FloatChunk<?> valuesToSort0, IntChunk<?> valuesToSort1, int offset, int length) {
    ...
    public static class FloatIntIndirectMultiColumnSortKernelContext<PERMUTE_VALUES_ATTR extends Any> implements MultiColumnSortKernel<PERMUTE_VALUES_ATTR> {
        int minGallop;
        ...
        private FloatIntIndirectMultiColumnSortKernelContext(int size) {
        ...
        public void sort(WritableLongChunk<PERMUTE_VALUES_ATTR> valuesToPermute,
            ...
            FloatIntIndirectMultiColumnTimsortKernel.sort(this, positions, valuesToSort[0].asFloatChunk(), valuesToSort[1].asIntChunk());
