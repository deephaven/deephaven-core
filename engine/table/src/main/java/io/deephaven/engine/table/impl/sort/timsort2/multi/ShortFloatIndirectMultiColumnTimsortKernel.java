...
/**
 * This implements a timsort kernel for a multi-column key (Short, Float) that never moves the column values:
 ...
 */
public final class ShortFloatIndirectMultiColumnTimsortKernel {
    private ShortFloatIndirectMultiColumnTimsortKernel() {
        throw new UnsupportedOperationException();
    }

    public static <PERMUTE_VALUES_ATTR extends Any> ShortFloatIndirectMultiColumnSortKernelContext<PERMUTE_VALUES_ATTR> createContext(
            final int size) {
        return new ShortFloatIndirectMultiColumnSortKernelContext<>(size);
    }
     ...
     */
    public static void sort(ShortFloatIndirectMultiColumnSortKernelContext<?> context,
    ...
    private static void timSort(ShortFloatIndirectMultiColumnSortKernelContext<?> context,
            WritableIntChunk<ChunkPositions> positions, ShortChunk<?> valuesToSort0,
     ...
     */
    private static int compareColumns(ShortChunk<?> valuesToSort0, FloatChunk<?> valuesToSort1,
    ...
    private static void ensureMergeInvariants(
            ShortFloatIndirectMultiColumnSortKernelContext<?> context,
            WritableIntChunk<ChunkPositions> positions, ShortChunk<?> valuesToSort0,
            FloatChunk<?> valuesToSort1) {
        while (context.runCount > 1) {
    ...
    private static void merge(ShortFloatIndirectMultiColumnSortKernelContext<?> context,
            WritableIntChunk<ChunkPositions> positions, ShortChunk<?> valuesToSort0,
     ...
     */
    private static void frontMerge(ShortFloatIndirectMultiColumnSortKernelContext<?> context,
            WritableIntChunk<ChunkPositions> positions, ShortChunk<?> valuesToSort0,
     ...
     * We eventually need to do galloping here, but are skipping that for now
     */
    private static void backMerge(ShortFloatIndirectMultiColumnSortKernelContext<?> context,
            WritableIntChunk<ChunkPositions> positions, ShortChunk<?> valuesToSort0,
    ...
    private static void copyToTemporary(ShortFloatIndirectMultiColumnSortKernelContext<?> context,
    ...
    private static void insertionSort(WritableIntChunk<ChunkPositions> positions,
            ShortChunk<?> valuesToSort0, FloatChunk<?> valuesToSort1, int offset, int length) {
    ...
    public static class ShortFloatIndirectMultiColumnSortKernelContext<PERMUTE_VALUES_ATTR extends Any> implements MultiColumnSortKernel<PERMUTE_VALUES_ATTR> {
        int minGallop;
        ...
        private ShortFloatIndirectMultiColumnSortKernelContext(int size) {
        ...
        public void sort(WritableLongChunk<PERMUTE_VALUES_ATTR> valuesToPermute,
            ...
            ShortFloatIndirectMultiColumnTimsortKernel.sort(this, positions, valuesToSort[0].asShortChunk(), valuesToSort[1].asFloatChunk());
