...
public class ShortReverseChunkSsaStamp implements ChunkSsaStamp {
    ...
    public void processEntry(Chunk<Values> leftStampValues, Chunk<RowKeys> leftStampKeys, SegmentedSortedArray ssa,
        ...
        processEntry(leftStampValues.asShortChunk(), leftStampKeys, (ShortReverseSegmentedSortedArray) ssa, rightKeysForLeft,
                disallowExactMatch);
    }

    private static void processEntry(ShortChunk<Values> leftStampValues, Chunk<RowKeys> leftStampKeys,
            ShortReverseSegmentedSortedArray ssa, WritableLongChunk<RowKeys> rightKeysForLeft, boolean disallowExactMatch) {
    ...
    public void processRemovals(Chunk<Values> leftStampValues, LongChunk<RowKeys> leftStampKeys,
        ...
        processRemovals(leftStampValues.asShortChunk(), leftStampKeys, rightStampChunk.asShortChunk(), rightKeys,
                priorRedirections, rowRedirection, modifiedBuilder, disallowExactMatch);
    }

    private static void processRemovals(ShortChunk<Values> leftStampValues, LongChunk<RowKeys> leftStampKeys,
            ShortChunk<? extends Values> rightStampChunk, LongChunk<RowKeys> rightKeys,
    ...
    public void processInsertion(Chunk<Values> leftStampValues, LongChunk<RowKeys> leftStampKeys,
        ...
        processInsertion(leftStampValues.asShortChunk(), leftStampKeys, rightStampChunk.asShortChunk(), rightKeys,
                nextRightValue.asShortChunk(), rowRedirection, modifiedBuilder, endsWithLastValue, disallowExactMatch);
    }

    private static void processInsertion(ShortChunk<Values> leftStampValues, LongChunk<RowKeys> leftStampKeys,
            ShortChunk<? extends Values> rightStampChunk, LongChunk<RowKeys> rightKeys, ShortChunk<Values> nextRightValue,
            WritableRowRedirection rowRedirection, RowSetBuilderRandom modifiedBuilder, boolean endsWithLastValue,
            boolean disallowExactMatch) {
    ...
    public int findModified(int first, Chunk<Values> leftStampValues, LongChunk<RowKeys> leftStampKeys,
        ...
        return findModified(first, leftStampValues.asShortChunk(), leftStampKeys, rowRedirection,
                rightStampChunk.asShortChunk(), rightStampIndices, modifiedBuilder, disallowExactMatch);
    }

    private static int findModified(int leftLowIdx, ShortChunk<Values> leftStampValues, LongChunk<RowKeys> leftStampKeys,
            RowRedirection rowRedirection, ShortChunk<? extends Values> rightStampChunk,
            LongChunk<RowKeys> rightStampIndices, RowSetBuilderRandom modifiedBuilder, boolean disallowExactMatch) {
        for (int ii = 0; ii < rightStampChunk.size(); ++ii) {
            final short rightStampValue = rightStampChunk.get(ii);
    ...
    public void applyShift(Chunk<Values> leftStampValues, LongChunk<RowKeys> leftStampKeys,
        ...
        applyShift(leftStampValues.asShortChunk(), leftStampKeys, rightStampChunk.asShortChunk(), rightStampKeys,
                shiftDelta, rowRedirection, disallowExactMatch);
    }

    private void applyShift(ShortChunk<Values> leftStampValues, LongChunk<RowKeys> leftStampKeys,
            ShortChunk<? extends Values> rightStampChunk, LongChunk<RowKeys> rightStampKeys, long shiftDelta,
            WritableRowRedirection rowRedirection, boolean disallowExactMatch) {
        int leftLowIdx = 0;
        for (int ii = 0; ii < rightStampChunk.size(); ++ii) {
            final short rightStampValue = rightStampChunk.get(ii);
    ...
    private static int findFirstResponsiveLeft(int leftLowIdx, ShortChunk<Values> leftStampValues,
            boolean disallowExactMatch, short rightStampValue) {
