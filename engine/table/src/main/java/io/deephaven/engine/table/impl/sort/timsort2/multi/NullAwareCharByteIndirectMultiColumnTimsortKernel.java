...
/**
 * This implements a timsort kernel for a multi-column key (NullAwareChar, Byte) that never moves the column values:
 ...
 */
public final class NullAwareCharByteIndirectMultiColumnTimsortKernel {
    private NullAwareCharByteIndirectMultiColumnTimsortKernel() {
        throw new UnsupportedOperationException();
    }

    public static <PERMUTE_VALUES_ATTR extends Any> NullAwareCharByteIndirectMultiColumnSortKernelContext<PERMUTE_VALUES_ATTR> createContext(
            final int size) {
        return new NullAwareCharByteIndirectMultiColumnSortKernelContext<>(size);
    }
     ...
     */
    public static void sort(NullAwareCharByteIndirectMultiColumnSortKernelContext<?> context,
    ...
    private static void timSort(NullAwareCharByteIndirectMultiColumnSortKernelContext<?> context,
            WritableIntChunk<ChunkPositions> positions, CharChunk<?> valuesToSort0,
     ...
     */
    private static int compareColumns(CharChunk<?> valuesToSort0, ByteChunk<?> valuesToSort1,
    ...
    private static void ensureMergeInvariants(
            NullAwareCharByteIndirectMultiColumnSortKernelContext<?> context,
            WritableIntChunk<ChunkPositions> positions, CharChunk<?> valuesToSort0,
            ByteChunk<?> valuesToSort1) {
        while (context.runCount > 1) {
    ...
    private static void merge(NullAwareCharByteIndirectMultiColumnSortKernelContext<?> context,
            WritableIntChunk<ChunkPositions> positions, CharChunk<?> valuesToSort0,
     ...
     */
    private static void frontMerge(NullAwareCharByteIndirectMultiColumnSortKernelContext<?> context,
            WritableIntChunk<ChunkPositions> positions, CharChunk<?> valuesToSort0,
     ...
     * We eventually need to do galloping here, but are skipping that for now
     */
    private static void backMerge(NullAwareCharByteIndirectMultiColumnSortKernelContext<?> context,
            WritableIntChunk<ChunkPositions> positions, CharChunk<?> valuesToSort0,
    ...
    private static void insertionSort(WritableIntChunk<ChunkPositions> positions,
            CharChunk<?> valuesToSort0, ByteChunk<?> valuesToSort1, int offset, int length) {
    ...
    public static class NullAwareCharByteIndirectMultiColumnSortKernelContext<PERMUTE_VALUES_ATTR extends Any> implements MultiColumnSortKernel<PERMUTE_VALUES_ATTR> {
        int minGallop;
        ...
        private NullAwareCharByteIndirectMultiColumnSortKernelContext(int size) {
        ...
        public void sort(WritableLongChunk<PERMUTE_VALUES_ATTR> valuesToPermute,
            ...
            NullAwareCharByteIndirectMultiColumnTimsortKernel.sort(this, positions, valuesToSort[0].asCharChunk(), valuesToSort[1].asByteChunk());
