 ...
 */
public class FloatSingleValueSource extends SingleValueColumnSource<Float>
    ...
    public Chunk<Values> getValueChunk() {
        return SingleValuePushdownHelper.makeChunk(getFloat(0));
    }

    @Override
    public Chunk<Values> getPrevValueChunk() {
        // avoid duplicating the current vs prev logic in getPrevFloat
        return SingleValuePushdownHelper.makeChunk(getPrevFloat(0));
    }
}
