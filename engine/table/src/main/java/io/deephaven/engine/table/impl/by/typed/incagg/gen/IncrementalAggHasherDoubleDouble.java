...
final class IncrementalAggHasherDoubleDouble extends IncrementalChunkedOperatorAggregationStateManagerTypedBase {
    ...
    public IncrementalAggHasherDoubleDouble(ColumnSource[] tableKeySources,
    ...
    private boolean findOverflow(HashHandler handler, double k0, double k1, int chunkPosition,
