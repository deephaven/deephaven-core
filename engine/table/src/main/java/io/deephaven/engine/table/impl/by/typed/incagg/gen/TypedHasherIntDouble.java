...
final class TypedHasherIntDouble extends IncrementalChunkedOperatorAggregationStateManagerTypedBase {
  ...
  private boolean findOverflow(HashHandler handler, int v0, double v1, int chunkPosition,
