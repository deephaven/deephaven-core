 ...
 */
public class KeyOnlyFirstOrLastBySpec extends IterativeIndexSpec {
    ...
    public KeyOnlyFirstOrLastBySpec(String resultColumn, AggType type) {
        super(false, false, 0);
        ...
        if (type != AggType.First && type != AggType.Last) {
            throw new IllegalArgumentException(
                    "KeyOnlyFirstOrLastBySpec only support AggType.First and AggType.Last");
        }
    }
    ...
    @Override
    KeyOnlyFirstOrLastBySpec forRollup() {
