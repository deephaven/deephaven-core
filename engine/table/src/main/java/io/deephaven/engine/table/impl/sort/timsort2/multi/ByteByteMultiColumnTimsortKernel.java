...
/**
 * This implements a timsort kernel that sorts a multi-column key (Byte, Byte), comparing each
 ...
 */
public final class ByteByteMultiColumnTimsortKernel {
    private ByteByteMultiColumnTimsortKernel() {
        throw new UnsupportedOperationException();
    }

    public static <SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> ByteByteMultiColumnSortKernelContext<SORT_VALUES_ATTR, PERMUTE_VALUES_ATTR> createContext(
            final int size) {
        return new ByteByteMultiColumnSortKernelContext<>(size);
    }
    ...
    static <SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> void sort(
            ByteByteMultiColumnSortKernelContext<SORT_VALUES_ATTR, PERMUTE_VALUES_ATTR> context,
    ...
    private static int upperBound(ByteChunk<?> valuesToSort0, ByteChunk<?> valuesToSort1, int lo,
            int hi, byte searchValue0, byte searchValue1) {
    ...
    private static int lowerBound(ByteChunk<?> valuesToSort0, ByteChunk<?> valuesToSort1, int lo,
            int hi, byte searchValue0, byte searchValue1) {
    ...
    private static int bound(ByteChunk<?> valuesToSort0, ByteChunk<?> valuesToSort1, int lo, int hi,
            byte searchValue0, byte searchValue1, final boolean lower) {
    ...
    private static void insertionSort(WritableLongChunk<?> valuesToPermute,
            WritableByteChunk<?> valuesToSort0, WritableByteChunk<?> valuesToSort1, int offset,
            int length) {
    ...
    private static void swap(WritableLongChunk<?> valuesToPermute,
            WritableByteChunk<?> valuesToSort0, WritableByteChunk<?> valuesToSort1, int a, int b) {
    ...
    public static class ByteByteMultiColumnSortKernelContext<SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> implements MultiColumnSortKernel<PERMUTE_VALUES_ATTR> {
        int minGallop;
        ...
        private ByteByteMultiColumnSortKernelContext(int size) {
        ...
        public void sort(WritableLongChunk<PERMUTE_VALUES_ATTR> valuesToPermute,
            ...
            ByteByteMultiColumnTimsortKernel.sort(this, valuesToPermute,
