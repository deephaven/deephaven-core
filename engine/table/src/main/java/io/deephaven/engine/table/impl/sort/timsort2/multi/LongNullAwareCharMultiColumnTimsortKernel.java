...
/**
 * This implements a timsort kernel that sorts a multi-column key (Long, NullAwareChar), comparing each
 ...
 */
public final class LongNullAwareCharMultiColumnTimsortKernel {
    private LongNullAwareCharMultiColumnTimsortKernel() {
        throw new UnsupportedOperationException();
    }

    public static <SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> LongNullAwareCharMultiColumnSortKernelContext<SORT_VALUES_ATTR, PERMUTE_VALUES_ATTR> createContext(
            final int size) {
        return new LongNullAwareCharMultiColumnSortKernelContext<>(size);
    }
    ...
    static <SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> void sort(
            LongNullAwareCharMultiColumnSortKernelContext<SORT_VALUES_ATTR, PERMUTE_VALUES_ATTR> context,
            WritableLongChunk<PERMUTE_VALUES_ATTR> valuesToPermute,
            WritableLongChunk<SORT_VALUES_ATTR> valuesToSort0,
    ...
    private static <SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> void timSort(
        ...
        while (startRun < offset + length) {
            long current0 = valuesToSort0.get(startRun);
            ...
            if (startRun + 1 == offset + length) {
                ...
                long next0 = valuesToSort0.get(startRun + 1);
                endRun = startRun + 2;
    ...
    private static <SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> void merge(
        ...
        final long run2lo0 = valuesToSort0.get(start2);
        ...
        final long run1hi0 = valuesToSort0.get(start1 + length1 - 1);
    ...
    private static <SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> void frontMerge(
        ...
        long val1_0 = context.temporaryValues0.get(tempCursor);
        long val2_0 = valuesToSort0.get(run2Cursor);
    ...
    private static <SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> void backMerge(
        ...
        long val1_0 = valuesToSort0.get(run1Cursor);
        long val2_0 = context.temporaryValues0.get(tempCursor);
    ...
    private static <SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> void copyToChunk(
            LongChunk<PERMUTE_VALUES_ATTR> rowSetSource, LongChunk<SORT_VALUES_ATTR> valuesSource0,
            CharChunk<SORT_VALUES_ATTR> valuesSource1,
            WritableLongChunk<PERMUTE_VALUES_ATTR> permuteValuesDest,
            WritableLongChunk<SORT_VALUES_ATTR> sortValuesDest0,
    ...
    private static int upperBound(LongChunk<?> valuesToSort0, CharChunk<?> valuesToSort1, int lo,
            int hi, long searchValue0, char searchValue1) {
    ...
    private static int lowerBound(LongChunk<?> valuesToSort0, CharChunk<?> valuesToSort1, int lo,
            int hi, long searchValue0, char searchValue1) {
    ...
    private static int bound(LongChunk<?> valuesToSort0, CharChunk<?> valuesToSort1, int lo, int hi,
            long searchValue0, char searchValue1, final boolean lower) {
    ...
    private static void insertionSort(WritableLongChunk<?> valuesToPermute,
            WritableLongChunk<?> valuesToSort0, WritableCharChunk<?> valuesToSort1, int offset,
            int length) {
    ...
    private static void swap(WritableLongChunk<?> valuesToPermute,
            WritableLongChunk<?> valuesToSort0, WritableCharChunk<?> valuesToSort1, int a, int b) {
        final long tempPermuteValue = valuesToPermute.get(a);
        final long temp0 = valuesToSort0.get(a);
    ...
    public static class LongNullAwareCharMultiColumnSortKernelContext<SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> implements MultiColumnSortKernel<PERMUTE_VALUES_ATTR> {
        int minGallop;
        ...
        private final WritableLongChunk<SORT_VALUES_ATTR> temporaryValues0;

        private final WritableCharChunk<SORT_VALUES_ATTR> temporaryValues1;

        private LongNullAwareCharMultiColumnSortKernelContext(int size) {
            temporaryKeys = WritableLongChunk.makeWritableChunk((size + 2) / 2);
            temporaryValues0 = WritableLongChunk.makeWritableChunk((size + 2) / 2);
        ...
        public void sort(WritableLongChunk<PERMUTE_VALUES_ATTR> valuesToPermute,
            ...
            LongNullAwareCharMultiColumnTimsortKernel.sort(this, valuesToPermute,
                            (WritableLongChunk<SORT_VALUES_ATTR>) valuesToSort[0].asWritableLongChunk(),
