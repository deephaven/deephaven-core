...
final class StaticAggHasherCharDouble extends StaticChunkedOperatorAggregationStateManagerTypedBase {
    ...
    public StaticAggHasherCharDouble(ColumnSource[] tableKeySources,
