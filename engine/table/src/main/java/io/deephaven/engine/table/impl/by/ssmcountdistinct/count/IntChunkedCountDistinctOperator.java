...
public class IntChunkedCountDistinctOperator implements IterativeChunkedAggregationOperator {
    ...
    private static void flushPrevious(IntChunkedCountDistinctOperator op) {
    ...
    public void startTrackingPrevValues() {
        ...
        if(exposeInternal) {
            ...
            prevFlusher = new UpdateCommitter<>(this, ExecutionContext.getContext().getUpdateGraph(), IntChunkedCountDistinctOperator::flushPrevious);
