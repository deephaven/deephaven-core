...
final class StaticAggHasherByteDouble extends StaticChunkedOperatorAggregationStateManagerTypedBase {
    ...
    public StaticAggHasherByteDouble(ColumnSource[] tableKeySources,
