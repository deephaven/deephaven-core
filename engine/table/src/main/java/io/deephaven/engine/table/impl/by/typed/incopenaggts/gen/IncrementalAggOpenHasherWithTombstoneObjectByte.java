...
final class IncrementalAggOpenHasherWithTombstoneObjectByte extends IncrementalChunkedOperatorAggregationStateManagerOpenAddressedBaseWithTombstones {
    ...
    public IncrementalAggOpenHasherWithTombstoneObjectByte(ColumnSource[] tableKeySources,
