 ...
 *
 * You can use {@link AddOnlyMinMaxBySpecImpl} if you want to force add-only behavior.
 *
 */
public class MinMaxBySpecImpl extends ReaggregatableStatefactory {
     ...
     */
    public MinMaxBySpecImpl(boolean minimum) {
        this(minimum, false);
    }
     ...
     */
    MinMaxBySpecImpl(boolean minimum, boolean addOnly) {
