...
/**
 * This implements a timsort kernel for a multi-column key (Float, Float) that never moves the column values:
 ...
 */
public final class FloatFloatIndirectMultiColumnTimsortKernel {
    private FloatFloatIndirectMultiColumnTimsortKernel() {
        throw new UnsupportedOperationException();
    }

    public static <PERMUTE_VALUES_ATTR extends Any> FloatFloatIndirectMultiColumnSortKernelContext<PERMUTE_VALUES_ATTR> createContext(
            final int size) {
        return new FloatFloatIndirectMultiColumnSortKernelContext<>(size);
    }
     ...
     */
    public static void sort(FloatFloatIndirectMultiColumnSortKernelContext<?> context,
            WritableIntChunk<ChunkPositions> positions, FloatChunk<?> valuesToSort0,
            FloatChunk<?> valuesToSort1) {
        timSort(context, positions, valuesToSort0, valuesToSort1, 0, positions.size());
    }

    private static void timSort(FloatFloatIndirectMultiColumnSortKernelContext<?> context,
            WritableIntChunk<ChunkPositions> positions, FloatChunk<?> valuesToSort0,
     ...
     */
    private static int compareColumns(FloatChunk<?> valuesToSort0, FloatChunk<?> valuesToSort1,
    ...
    private static void ensureMergeInvariants(
            FloatFloatIndirectMultiColumnSortKernelContext<?> context,
            WritableIntChunk<ChunkPositions> positions, FloatChunk<?> valuesToSort0,
            FloatChunk<?> valuesToSort1) {
        while (context.runCount > 1) {
    ...
    private static void merge(FloatFloatIndirectMultiColumnSortKernelContext<?> context,
            WritableIntChunk<ChunkPositions> positions, FloatChunk<?> valuesToSort0,
     ...
     */
    private static void frontMerge(FloatFloatIndirectMultiColumnSortKernelContext<?> context,
            WritableIntChunk<ChunkPositions> positions, FloatChunk<?> valuesToSort0,
     ...
     * We eventually need to do galloping here, but are skipping that for now
     */
    private static void backMerge(FloatFloatIndirectMultiColumnSortKernelContext<?> context,
            WritableIntChunk<ChunkPositions> positions, FloatChunk<?> valuesToSort0,
    ...
    private static void copyToTemporary(FloatFloatIndirectMultiColumnSortKernelContext<?> context,
    ...
    private static int upperBound(IntChunk<ChunkPositions> positions, FloatChunk<?> valuesToSort0,
    ...
    private static int lowerBound(IntChunk<ChunkPositions> positions, FloatChunk<?> valuesToSort0,
            FloatChunk<?> valuesToSort1, int lo, int hi, int searchPos) {
    ...
    private static int bound(IntChunk<ChunkPositions> positions, FloatChunk<?> valuesToSort0,
    ...
    private static void insertionSort(WritableIntChunk<ChunkPositions> positions,
            FloatChunk<?> valuesToSort0, FloatChunk<?> valuesToSort1, int offset, int length) {
    ...
    public static class FloatFloatIndirectMultiColumnSortKernelContext<PERMUTE_VALUES_ATTR extends Any> implements MultiColumnSortKernel<PERMUTE_VALUES_ATTR> {
        int minGallop;
        ...
        private FloatFloatIndirectMultiColumnSortKernelContext(int size) {
        ...
        public void sort(WritableLongChunk<PERMUTE_VALUES_ATTR> valuesToPermute,
            ...
            FloatFloatIndirectMultiColumnTimsortKernel.sort(this, positions, valuesToSort[0].asFloatChunk(), valuesToSort[1].asFloatChunk());
