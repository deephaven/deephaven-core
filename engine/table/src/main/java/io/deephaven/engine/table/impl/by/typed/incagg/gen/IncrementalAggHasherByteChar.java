...
final class IncrementalAggHasherByteChar extends IncrementalChunkedOperatorAggregationStateManagerTypedBase {
    ...
    public IncrementalAggHasherByteChar(ColumnSource[] tableKeySources,
