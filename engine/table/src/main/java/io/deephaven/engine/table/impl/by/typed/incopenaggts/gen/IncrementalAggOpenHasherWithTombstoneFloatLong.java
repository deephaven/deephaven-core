...
final class IncrementalAggOpenHasherWithTombstoneFloatLong extends IncrementalChunkedOperatorAggregationStateManagerOpenAddressedBaseWithTombstones {
    ...
    public IncrementalAggOpenHasherWithTombstoneFloatLong(ColumnSource[] tableKeySources,
