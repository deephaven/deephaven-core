...
final class IncrementalAggOpenHasherWithTombstoneByteObject extends IncrementalChunkedOperatorAggregationStateManagerOpenAddressedBaseWithTombstones {
    ...
    public IncrementalAggOpenHasherWithTombstoneByteObject(ColumnSource[] tableKeySources,
