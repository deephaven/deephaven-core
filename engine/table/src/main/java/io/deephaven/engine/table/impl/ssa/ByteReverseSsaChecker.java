...
// ****** Edit ByteSsaChecker and run "./gradlew replicateReverseSegmentedSortedArray" to regenerate
//
// @formatter:off
...
public class ByteReverseSsaChecker implements SsaChecker {
    ...
    static void checkSsa(ByteReverseSegmentedSortedArray ssa, ByteChunk<? extends Values> valueChunk,
            LongChunk<? extends RowKeys> tableIndexChunk) {
