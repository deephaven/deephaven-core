...
/**
 * This implements a timsort kernel for a sort key (Byte descending) that never moves the column values:
 ...
 */
public final class ByteDescIndirectTimsortKernel {
    private ByteDescIndirectTimsortKernel() {
        throw new UnsupportedOperationException();
    }

    public static <PERMUTE_VALUES_ATTR extends Any> ByteDescIndirectSortKernelContext<PERMUTE_VALUES_ATTR> createContext(
            final int size) {
        return new ByteDescIndirectSortKernelContext<>(size);
    }
     ...
     */
    public static void sort(ByteDescIndirectSortKernelContext<?> context,
    ...
    private static void timSort(ByteDescIndirectSortKernelContext<?> context,
    ...
    private static void ensureMergeInvariants(ByteDescIndirectSortKernelContext<?> context,
            WritableIntChunk<ChunkPositions> positions, ByteChunk<?> valuesToSort0) {
        while (context.runCount > 1) {
    ...
    private static void merge(ByteDescIndirectSortKernelContext<?> context,
     ...
     */
    private static void frontMerge(ByteDescIndirectSortKernelContext<?> context,
            WritableIntChunk<ChunkPositions> positions, ByteChunk<?> valuesToSort0,
     ...
     * We eventually need to do galloping here, but are skipping that for now
     */
    private static void backMerge(ByteDescIndirectSortKernelContext<?> context,
            WritableIntChunk<ChunkPositions> positions, ByteChunk<?> valuesToSort0,
    ...
    private static void copyToTemporary(ByteDescIndirectSortKernelContext<?> context,
    ...
    public static class ByteDescIndirectSortKernelContext<PERMUTE_VALUES_ATTR extends Any> implements MultiColumnSortKernel<PERMUTE_VALUES_ATTR> {
        int minGallop;
        ...
        private ByteDescIndirectSortKernelContext(int size) {
        ...
        public void sort(WritableLongChunk<PERMUTE_VALUES_ATTR> valuesToPermute,
            ...
            ByteDescIndirectTimsortKernel.sort(this, positions, valuesToSort[0].asByteChunk());
