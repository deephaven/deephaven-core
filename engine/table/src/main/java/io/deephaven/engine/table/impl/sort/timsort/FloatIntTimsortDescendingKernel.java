...
public class FloatIntTimsortDescendingKernel {
    ...
    // region Context
    public static class FloatIntSortKernelContext<SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any>
        ...
        public void sort(
            ...
            FloatIntTimsortDescendingKernel.sort(this, valuesToPermute, valuesToSort.asWritableFloatChunk());
        }
        ...
        public void sort(
            ...
            FloatIntTimsortDescendingKernel.sort(this, valuesToPermute, valuesToSort.asWritableFloatChunk(), offsetsIn, lengthsIn);
        }
    ...
    FloatIntSortKernelContext<SORT_VALUES_ATTR, PERMUTE_VALUES_ATTR> createContext(int size) {
...
//    private static void doCheck(Chunk.IntChunk valuesToPermute, Chunk.FloatChunk valuesToSort, int startCheck, int mergeEnd) {
//        float lastCheck;
