...
public final class TypedHasherCharChar extends IncrementalChunkedOperatorAggregationStateManagerTypedBase {
  ...
  private int hash(char v0, char v1) {
  ...
  private boolean findOverflow(HashHandler handler, char v0, char v1, int chunkPosition,
