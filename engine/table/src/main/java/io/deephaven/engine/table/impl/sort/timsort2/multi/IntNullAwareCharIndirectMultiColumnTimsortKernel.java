...
/**
 * This implements a timsort kernel for a multi-column key (Int, NullAwareChar) that never moves the column values:
 ...
 */
public final class IntNullAwareCharIndirectMultiColumnTimsortKernel {
    private IntNullAwareCharIndirectMultiColumnTimsortKernel() {
        throw new UnsupportedOperationException();
    }

    public static <PERMUTE_VALUES_ATTR extends Any> IntNullAwareCharIndirectMultiColumnSortKernelContext<PERMUTE_VALUES_ATTR> createContext(
            final int size) {
        return new IntNullAwareCharIndirectMultiColumnSortKernelContext<>(size);
    }
     ...
     */
    public static void sort(IntNullAwareCharIndirectMultiColumnSortKernelContext<?> context,
    ...
    private static void timSort(IntNullAwareCharIndirectMultiColumnSortKernelContext<?> context,
            WritableIntChunk<ChunkPositions> positions, IntChunk<?> valuesToSort0,
     ...
     */
    private static int compareColumns(IntChunk<?> valuesToSort0, CharChunk<?> valuesToSort1,
    ...
    private static void ensureMergeInvariants(
            IntNullAwareCharIndirectMultiColumnSortKernelContext<?> context,
            WritableIntChunk<ChunkPositions> positions, IntChunk<?> valuesToSort0,
            CharChunk<?> valuesToSort1) {
        while (context.runCount > 1) {
    ...
    private static void merge(IntNullAwareCharIndirectMultiColumnSortKernelContext<?> context,
            WritableIntChunk<ChunkPositions> positions, IntChunk<?> valuesToSort0,
     ...
     */
    private static void frontMerge(IntNullAwareCharIndirectMultiColumnSortKernelContext<?> context,
            WritableIntChunk<ChunkPositions> positions, IntChunk<?> valuesToSort0,
     ...
     * We eventually need to do galloping here, but are skipping that for now
     */
    private static void backMerge(IntNullAwareCharIndirectMultiColumnSortKernelContext<?> context,
            WritableIntChunk<ChunkPositions> positions, IntChunk<?> valuesToSort0,
    ...
    private static int bound(IntChunk<ChunkPositions> positions, IntChunk<?> valuesToSort0,
    ...
    private static void insertionSort(WritableIntChunk<ChunkPositions> positions,
            IntChunk<?> valuesToSort0, CharChunk<?> valuesToSort1, int offset, int length) {
    ...
    public static class IntNullAwareCharIndirectMultiColumnSortKernelContext<PERMUTE_VALUES_ATTR extends Any> implements MultiColumnSortKernel<PERMUTE_VALUES_ATTR> {
        int minGallop;
        ...
        private IntNullAwareCharIndirectMultiColumnSortKernelContext(int size) {
        ...
        public void sort(WritableLongChunk<PERMUTE_VALUES_ATTR> valuesToPermute,
            ...
            IntNullAwareCharIndirectMultiColumnTimsortKernel.sort(this, positions, valuesToSort[0].asIntChunk(), valuesToSort[1].asCharChunk());
