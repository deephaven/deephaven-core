 ...
 */
public final class ObjectByteTimsortKernel {
    ...
    public static <SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> ObjectByteSortKernelContext<SORT_VALUES_ATTR, PERMUTE_VALUES_ATTR> createContext(
            final int size) {
        return new ObjectByteTimsortKernel().createContextInstance(size);
    }
    ...
    public class ObjectByteSortKernelContext<SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> implements ByteSortKernel<SORT_VALUES_ATTR, PERMUTE_VALUES_ATTR> {
        ...
        public void sort(WritableByteChunk<PERMUTE_VALUES_ATTR> valuesToPermute,
            ...
            ObjectByteTimsortKernel.this.sort(this, valuesToPermute, valuesToSort.asWritableObjectChunk());
        }
        ...
        public void sort(WritableByteChunk<PERMUTE_VALUES_ATTR> valuesToPermute,
                ...
                IntChunk<? extends ChunkPositions> offsetsIn,
                IntChunk<? extends ChunkLengths> lengthsIn) {
            ObjectByteTimsortKernel.this.sort(this, valuesToPermute, valuesToSort.asWritableObjectChunk(), offsetsIn, lengthsIn);
        }

        @Override
        public void sort(WritableByteChunk<PERMUTE_VALUES_ATTR> valuesToPermute,
                WritableChunk<SORT_VALUES_ATTR> valuesToSort, int offset, int length) {
            ObjectByteTimsortKernel.this.timSort(this, valuesToPermute, valuesToSort.asWritableObjectChunk(), offset, length);
        }
        ...
        public void merge(WritableByteChunk<PERMUTE_VALUES_ATTR> valuesToPermute,
                ...
                int length2) {
            ObjectByteTimsortKernel.this.merge(this, valuesToPermute, valuesToSort.asWritableObjectChunk(), start1, length1, length2);
        }
        ...
        private ObjectByteTimsortKernel kernel() {
            return ObjectByteTimsortKernel.this;
        }
    }
}
