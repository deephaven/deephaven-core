...
public final class TypedHasherCharShort extends StaticChunkedOperatorAggregationStateManagerTypedBase {
  ...
  public TypedHasherCharShort(ColumnSource[] tableKeySources, int tableSize,
  ...
  private int hash(char v0, short v1) {
  ...
  private boolean findOverflow(StaticChunkedOperatorAggregationStateManagerTypedBase.StaticAggHashHandler handler,
      char v0, short v1, int chunkPosition, int overflowLocation) {
    while (overflowLocation != QueryConstants.NULL_INT) {
