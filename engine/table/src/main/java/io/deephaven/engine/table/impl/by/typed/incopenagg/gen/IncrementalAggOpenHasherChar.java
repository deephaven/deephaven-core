...
final class IncrementalAggOpenHasherChar extends IncrementalChunkedOperatorAggregationStateManagerOpenAddressedBase {
    private ImmutableCharArraySource mainKeySource0;

    private ImmutableCharArraySource alternateKeySource0;

    public IncrementalAggOpenHasherChar(ColumnSource[] tableKeySources,
