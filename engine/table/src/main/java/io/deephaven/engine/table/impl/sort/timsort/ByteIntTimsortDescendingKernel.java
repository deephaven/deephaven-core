...
// ****** Edit ByteIntTimsortDescendingKernel and run "./gradlew replicateSortKernel" to regenerate
//
// @formatter:off
 ...
 */
public final class ByteIntTimsortDescendingKernel {
    // region constructor
    private ByteIntTimsortDescendingKernel() {
    }
    ...
    public class ByteIntSortKernelContext<SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any>
        ...
        private ByteIntSortKernelContext(int size) {
        ...
        public void sort(
            ...
            ByteIntTimsortDescendingKernel.this.sort(this, valuesToPermute, valuesToSort.asWritableByteChunk());
        }
        ...
        public void sort(
            ...
            ByteIntTimsortDescendingKernel.this.sort(this, valuesToPermute, valuesToSort.asWritableByteChunk(), offsetsIn, lengthsIn);
        }
        ...
        private ByteIntTimsortDescendingKernel kernel() {
            return ByteIntTimsortDescendingKernel.this;
        }
    }
    // endregion Context

    // region createContextInstance
    public <SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> ByteIntSortKernelContext<SORT_VALUES_ATTR, PERMUTE_VALUES_ATTR> createContextInstance(int size) {
    ...
    public static <SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> ByteIntSortKernelContext<SORT_VALUES_ATTR, PERMUTE_VALUES_ATTR> createContext(final int size) {
        return new ByteIntTimsortDescendingKernel().createContextInstance(size);
    }
    ...
    static private void swap(WritableIntChunk<?> valuesToPermute, WritableByteChunk<?> valuesToSort, int a, int b) {
    ...
    // private static void doCheck(Chunk.IntChunk valuesToPermute, Chunk.ByteChunk valuesToSort, int startCheck, int
    // mergeEnd) {
    // byte lastCheck;
