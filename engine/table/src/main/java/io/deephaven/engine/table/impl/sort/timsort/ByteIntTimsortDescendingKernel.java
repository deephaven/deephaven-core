...
public final class ByteIntTimsortDescendingKernel {
    ...
    private static <SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> void copyToChunk(
            IntChunk<PERMUTE_VALUES_ATTR> rowSetSource, ByteChunk<SORT_VALUES_ATTR> valuesSource,
    ...
    private static void swap(WritableIntChunk<?> valuesToPermute, WritableByteChunk<?> valuesToSort,
            int a, int b) {
    ...
    public class ByteIntSortKernelContext<SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> implements IntSortKernel<SORT_VALUES_ATTR, PERMUTE_VALUES_ATTR> {
        int minGallop;
        ...
        public void sort(WritableIntChunk<PERMUTE_VALUES_ATTR> valuesToPermute,
            ...
            ByteIntTimsortDescendingKernel.this.timSort(this, valuesToPermute, valuesToSort.asWritableByteChunk(), offset, length);
        }
        ...
        public void merge(WritableIntChunk<PERMUTE_VALUES_ATTR> valuesToPermute,
                ...
                int length2) {
            ByteIntTimsortDescendingKernel.this.merge(this, valuesToPermute, valuesToSort.asWritableByteChunk(), start1, length1, length2);
        }
