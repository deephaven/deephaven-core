...
/**
 * This implements a timsort kernel for a multi-column key (Short, Int) that never moves the column values:
 ...
 */
public final class ShortIntIndirectMultiColumnTimsortKernel {
    private ShortIntIndirectMultiColumnTimsortKernel() {
        throw new UnsupportedOperationException();
    }

    public static <PERMUTE_VALUES_ATTR extends Any> ShortIntIndirectMultiColumnSortKernelContext<PERMUTE_VALUES_ATTR> createContext(
            final int size) {
        return new ShortIntIndirectMultiColumnSortKernelContext<>(size);
    }
     ...
     */
    public static void sort(ShortIntIndirectMultiColumnSortKernelContext<?> context,
    ...
    private static void timSort(ShortIntIndirectMultiColumnSortKernelContext<?> context,
            WritableIntChunk<ChunkPositions> positions, ShortChunk<?> valuesToSort0,
     ...
     */
    private static int compareColumns(ShortChunk<?> valuesToSort0, IntChunk<?> valuesToSort1,
    ...
    private static void ensureMergeInvariants(
            ShortIntIndirectMultiColumnSortKernelContext<?> context,
            WritableIntChunk<ChunkPositions> positions, ShortChunk<?> valuesToSort0,
            IntChunk<?> valuesToSort1) {
        while (context.runCount > 1) {
    ...
    private static void merge(ShortIntIndirectMultiColumnSortKernelContext<?> context,
            WritableIntChunk<ChunkPositions> positions, ShortChunk<?> valuesToSort0,
     ...
     */
    private static void frontMerge(ShortIntIndirectMultiColumnSortKernelContext<?> context,
            WritableIntChunk<ChunkPositions> positions, ShortChunk<?> valuesToSort0,
     ...
     * We eventually need to do galloping here, but are skipping that for now
     */
    private static void backMerge(ShortIntIndirectMultiColumnSortKernelContext<?> context,
            WritableIntChunk<ChunkPositions> positions, ShortChunk<?> valuesToSort0,
    ...
    private static void copyToTemporary(ShortIntIndirectMultiColumnSortKernelContext<?> context,
    ...
    private static void insertionSort(WritableIntChunk<ChunkPositions> positions,
            ShortChunk<?> valuesToSort0, IntChunk<?> valuesToSort1, int offset, int length) {
    ...
    public static class ShortIntIndirectMultiColumnSortKernelContext<PERMUTE_VALUES_ATTR extends Any> implements MultiColumnSortKernel<PERMUTE_VALUES_ATTR> {
        int minGallop;
        ...
        private ShortIntIndirectMultiColumnSortKernelContext(int size) {
        ...
        public void sort(WritableLongChunk<PERMUTE_VALUES_ATTR> valuesToPermute,
            ...
            ShortIntIndirectMultiColumnTimsortKernel.sort(this, positions, valuesToSort[0].asShortChunk(), valuesToSort[1].asIntChunk());
