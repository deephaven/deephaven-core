...
public class CharReverseChunkSsaStamp implements ChunkSsaStamp {
    ...
    private static void processEntry(CharChunk<Values> leftStampValues, Chunk<RowKeys> leftStampKeys, CharReverseSegmentedSortedArray ssa, WritableLongChunk<RowKeys> rightKeysForLeft, boolean disallowExactMatch) {
