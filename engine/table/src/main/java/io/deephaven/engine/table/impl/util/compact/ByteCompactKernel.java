...
public class ByteCompactKernel implements CompactKernel {
    ...
    public void compactAndCount(
            ...
            boolean countNull,
            boolean countNaN) {
        compactAndCount(valueChunk.asWritableByteChunk(), counts, countNull, countNaN);
    }
    ...
    public void compactAndCount(
            ...
            boolean countNull,
            boolean countNaN) {
        compactAndCount(valueChunk.asWritableByteChunk(), counts, startPositions, lengths, countNull, countNaN);
    }

    public static void compactAndCount(
            WritableByteChunk<? extends Values> valueChunk,
            WritableIntChunk<ChunkLengths> counts) {
    ...
    public static int compactAndCount(
        ...
        for (int rpos = start; rpos < end; ++rpos) {
            ...
            if (!countNull && nextValue == NULL_BYTE) {
                continue;
            }
