...
final class TypedHasherFloatFloat extends IncrementalChunkedOperatorAggregationStateManagerTypedBase {
    ...
    public TypedHasherFloatFloat(ColumnSource[] tableKeySources, int tableSize,
