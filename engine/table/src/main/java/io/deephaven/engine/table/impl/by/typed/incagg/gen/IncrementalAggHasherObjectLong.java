...
final class IncrementalAggHasherObjectLong extends IncrementalChunkedOperatorAggregationStateManagerTypedBase {
    ...
    public IncrementalAggHasherObjectLong(ColumnSource[] tableKeySources,
