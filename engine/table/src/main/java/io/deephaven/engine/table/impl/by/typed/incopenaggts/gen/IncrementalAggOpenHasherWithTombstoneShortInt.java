...
final class IncrementalAggOpenHasherWithTombstoneShortInt extends IncrementalChunkedOperatorAggregationStateManagerOpenAddressedBaseWithTombstones {
    ...
    public IncrementalAggOpenHasherWithTombstoneShortInt(ColumnSource[] tableKeySources,
