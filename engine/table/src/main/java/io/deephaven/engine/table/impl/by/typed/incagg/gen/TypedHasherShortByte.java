...
public final class TypedHasherShortByte extends IncrementalChunkedOperatorAggregationStateManagerTypedBase {
  ...
  private boolean findOverflow(HashHandler handler, short v0, byte v1, int chunkPosition,
