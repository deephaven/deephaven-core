...
final class StaticAggHasherCharByte extends StaticChunkedOperatorAggregationStateManagerTypedBase {
    ...
    public StaticAggHasherCharByte(ColumnSource[] tableKeySources,
