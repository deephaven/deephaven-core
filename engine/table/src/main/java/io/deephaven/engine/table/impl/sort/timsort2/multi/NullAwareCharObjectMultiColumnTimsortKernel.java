...
/**
 * This implements a timsort kernel that sorts a multi-column key (NullAwareChar, Object), comparing each
 ...
 */
public final class NullAwareCharObjectMultiColumnTimsortKernel {
    private NullAwareCharObjectMultiColumnTimsortKernel() {
        throw new UnsupportedOperationException();
    }

    public static <SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> NullAwareCharObjectMultiColumnSortKernelContext<SORT_VALUES_ATTR, PERMUTE_VALUES_ATTR> createContext(
            final int size) {
        return new NullAwareCharObjectMultiColumnSortKernelContext<>(size);
    }
    ...
    static <SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> void sort(
            NullAwareCharObjectMultiColumnSortKernelContext<SORT_VALUES_ATTR, PERMUTE_VALUES_ATTR> context,
    ...
    private static int upperBound(CharChunk<?> valuesToSort0, ObjectChunk<Object, ?> valuesToSort1,
            int lo, int hi, char searchValue0, Object searchValue1) {
    ...
    private static int lowerBound(CharChunk<?> valuesToSort0, ObjectChunk<Object, ?> valuesToSort1,
            int lo, int hi, char searchValue0, Object searchValue1) {
    ...
    private static int bound(CharChunk<?> valuesToSort0, ObjectChunk<Object, ?> valuesToSort1,
            int lo, int hi, char searchValue0, Object searchValue1, final boolean lower) {
    ...
    private static void insertionSort(WritableLongChunk<?> valuesToPermute,
            WritableCharChunk<?> valuesToSort0, WritableObjectChunk<Object, ?> valuesToSort1,
    ...
    private static void swap(WritableLongChunk<?> valuesToPermute,
            WritableCharChunk<?> valuesToSort0, WritableObjectChunk<Object, ?> valuesToSort1, int a,
            int b) {
    ...
    public static class NullAwareCharObjectMultiColumnSortKernelContext<SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> implements MultiColumnSortKernel<PERMUTE_VALUES_ATTR> {
        int minGallop;
        ...
        private NullAwareCharObjectMultiColumnSortKernelContext(int size) {
        ...
        public void sort(WritableLongChunk<PERMUTE_VALUES_ATTR> valuesToPermute,
            ...
            NullAwareCharObjectMultiColumnTimsortKernel.sort(this, valuesToPermute,
