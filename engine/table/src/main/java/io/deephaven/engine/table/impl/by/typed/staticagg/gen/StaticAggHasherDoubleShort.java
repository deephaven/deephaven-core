...
final class StaticAggHasherDoubleShort extends StaticChunkedOperatorAggregationStateManagerTypedBase {
    ...
    public StaticAggHasherDoubleShort(ColumnSource[] tableKeySources,
