...
public final class TypedHasherObjectFloat extends StaticChunkedOperatorAggregationStateManagerTypedBase {
  ...
  private boolean findOverflow(StaticChunkedOperatorAggregationStateManagerTypedBase.StaticAggHashHandler handler,
      Object v0, float v1, int chunkPosition, int overflowLocation) {
    while (overflowLocation != QueryConstants.NULL_INT) {
