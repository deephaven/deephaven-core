...
final class StaticAggHasherObjectLong extends StaticChunkedOperatorAggregationStateManagerTypedBase {
    ...
    public StaticAggHasherObjectLong(ColumnSource[] tableKeySources,
