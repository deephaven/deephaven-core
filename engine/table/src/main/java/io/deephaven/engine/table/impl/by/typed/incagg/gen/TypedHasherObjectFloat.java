...
final class TypedHasherObjectFloat extends IncrementalChunkedOperatorAggregationStateManagerTypedBase {
  ...
  public TypedHasherObjectFloat(ColumnSource[] tableKeySources, int tableSize,
  ...
  private int hash(Object v0, float v1) {
  ...
  private int maybeMoveMainBucket(HashHandler handler, int bucket, int destBucket,
      int bucketsToAdd) {
    final Object v0 = mainKeySource0.getUnsafe(bucket);
    ...
    if (location == bucket) {
      ...
      mainKeySource0.set(bucket, null);
  ...
  private boolean findOverflow(HashHandler handler, Object v0, float v1, int chunkPosition,
