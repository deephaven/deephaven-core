...
public class IntRollingFormulaOperator extends BaseRollingFormulaOperator {
    ...
    protected class Context extends BaseRollingFormulaOperator.Context {
        ...
        protected Context(final int affectedChunkSize, final int influencerChunkSize) {
            ...
            final SingleValueColumnSource<IntVector> formulaInputSource = (SingleValueColumnSource<IntVector>) SingleValueColumnSource.getSingleValueColumnSource(vectorType);
