...
/**
 * This implements a timsort kernel that sorts a multi-column key (NullAwareChar, Int), comparing each
 ...
 */
public final class NullAwareCharIntMultiColumnTimsortKernel {
    private NullAwareCharIntMultiColumnTimsortKernel() {
        throw new UnsupportedOperationException();
    }

    public static <SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> NullAwareCharIntMultiColumnSortKernelContext<SORT_VALUES_ATTR, PERMUTE_VALUES_ATTR> createContext(
            final int size) {
        return new NullAwareCharIntMultiColumnSortKernelContext<>(size);
    }
    ...
    static <SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> void sort(
            NullAwareCharIntMultiColumnSortKernelContext<SORT_VALUES_ATTR, PERMUTE_VALUES_ATTR> context,
    ...
    private static int upperBound(CharChunk<?> valuesToSort0, IntChunk<?> valuesToSort1, int lo,
            int hi, char searchValue0, int searchValue1) {
    ...
    private static int lowerBound(CharChunk<?> valuesToSort0, IntChunk<?> valuesToSort1, int lo,
            int hi, char searchValue0, int searchValue1) {
    ...
    private static int bound(CharChunk<?> valuesToSort0, IntChunk<?> valuesToSort1, int lo, int hi,
            char searchValue0, int searchValue1, final boolean lower) {
    ...
    private static void insertionSort(WritableLongChunk<?> valuesToPermute,
            WritableCharChunk<?> valuesToSort0, WritableIntChunk<?> valuesToSort1, int offset,
            int length) {
    ...
    private static void swap(WritableLongChunk<?> valuesToPermute,
            WritableCharChunk<?> valuesToSort0, WritableIntChunk<?> valuesToSort1, int a, int b) {
    ...
    public static class NullAwareCharIntMultiColumnSortKernelContext<SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> implements MultiColumnSortKernel<PERMUTE_VALUES_ATTR> {
        int minGallop;
        ...
        private NullAwareCharIntMultiColumnSortKernelContext(int size) {
        ...
        public void sort(WritableLongChunk<PERMUTE_VALUES_ATTR> valuesToPermute,
            ...
            NullAwareCharIntMultiColumnTimsortKernel.sort(this, valuesToPermute,
