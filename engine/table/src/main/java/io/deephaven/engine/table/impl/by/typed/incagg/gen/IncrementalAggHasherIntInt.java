...
final class IncrementalAggHasherIntInt extends IncrementalChunkedOperatorAggregationStateManagerTypedBase {
    ...
    public IncrementalAggHasherIntInt(ColumnSource[] tableKeySources,
