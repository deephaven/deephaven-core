...
final class IncrementalAggOpenHasherWithTombstoneObjectLong extends IncrementalChunkedOperatorAggregationStateManagerOpenAddressedBaseWithTombstones {
    ...
    public IncrementalAggOpenHasherWithTombstoneObjectLong(ColumnSource[] tableKeySources,
