 ...
 */
public final class CharIntTimsortDescendingKernel {
    private CharIntTimsortDescendingKernel() {
    }
    ...
    public static <SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> CharIntSortKernelContext<SORT_VALUES_ATTR, PERMUTE_VALUES_ATTR> createContext(
            final int size) {
        return new CharIntTimsortDescendingKernel().createContextInstance(size);
    }
    ...
    public class CharIntSortKernelContext<SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> implements IntSortKernel<SORT_VALUES_ATTR, PERMUTE_VALUES_ATTR> {
        ...
        public void sort(WritableIntChunk<PERMUTE_VALUES_ATTR> valuesToPermute,
            ...
            CharIntTimsortDescendingKernel.this.sort(this, valuesToPermute, valuesToSort.asWritableCharChunk());
        }
        ...
        public void sort(WritableIntChunk<PERMUTE_VALUES_ATTR> valuesToPermute,
                ...
                IntChunk<? extends ChunkPositions> offsetsIn,
                IntChunk<? extends ChunkLengths> lengthsIn) {
            CharIntTimsortDescendingKernel.this.sort(this, valuesToPermute, valuesToSort.asWritableCharChunk(), offsetsIn, lengthsIn);
        }

        @Override
        public void sort(WritableIntChunk<PERMUTE_VALUES_ATTR> valuesToPermute,
                WritableChunk<SORT_VALUES_ATTR> valuesToSort, int offset, int length) {
            CharIntTimsortDescendingKernel.this.timSort(this, valuesToPermute, valuesToSort.asWritableCharChunk(), offset, length);
        }
        ...
        public void merge(WritableIntChunk<PERMUTE_VALUES_ATTR> valuesToPermute,
                ...
                int length2) {
            CharIntTimsortDescendingKernel.this.merge(this, valuesToPermute, valuesToSort.asWritableCharChunk(), start1, length1, length2);
        }
        ...
        private CharIntTimsortDescendingKernel kernel() {
            return CharIntTimsortDescendingKernel.this;
        }
    }
}
