...
public class FloatReverseSsaSsaStamp implements SsaSsaStamp {
    ...
    static private void processRemovals(FloatReverseSegmentedSortedArray leftSsa, FloatChunk<? extends Values> rightStampChunk, LongChunk<RowKeys> rightKeys, WritableLongChunk<RowKeys> nextRedirections, WritableRowRedirection rowRedirection, RowSetBuilderRandom modifiedBuilder, boolean disallowExactMatch) {
    ...
    private static void findModified(FloatReverseSegmentedSortedArray leftSsa, RowRedirection rowRedirection, FloatChunk<? extends Values> rightStampChunk, LongChunk<RowKeys> rightStampIndices, RowSetBuilderRandom modifiedBuilder, boolean disallowExactMatch) {
        final FloatReverseSegmentedSortedArray.Iterator leftIt = leftSsa.iterator(disallowExactMatch, false);
    ...
    private void applyShift(FloatReverseSegmentedSortedArray leftSsa, FloatChunk<? extends Values> rightStampChunk, LongChunk<RowKeys> rightStampKeys, long shiftDelta, WritableRowRedirection rowRedirection, boolean disallowExactMatch) {
        final FloatReverseSegmentedSortedArray.Iterator leftIt = leftSsa.iterator(disallowExactMatch, false);
