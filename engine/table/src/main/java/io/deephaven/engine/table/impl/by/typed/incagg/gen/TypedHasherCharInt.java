...
final class TypedHasherCharInt extends IncrementalChunkedOperatorAggregationStateManagerTypedBase {
  ...
  public TypedHasherCharInt(ColumnSource[] tableKeySources, int tableSize, double maximumLoadFactor,
    ...
    this.keySource1 = (IntegerArraySource) super.keySources[1];
  ...
  private int hash(char v0, int v1) {
  ...
  private boolean findOverflow(HashHandler handler, char v0, int v1, int chunkPosition,
