...
final class IncrementalAggHasherByte extends IncrementalChunkedOperatorAggregationStateManagerTypedBase {
    private final ByteArraySource mainKeySource0;

    private final ByteArraySource overflowKeySource0;

    public IncrementalAggHasherByte(ColumnSource[] tableKeySources,
    ...
    private boolean findOverflow(HashHandler handler, byte k0, int chunkPosition,
