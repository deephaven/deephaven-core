...
/**
 * This implements a timsort kernel for a multi-column key (Byte, Long) that never moves the column values:
 ...
 */
public final class ByteLongIndirectMultiColumnTimsortKernel {
    private ByteLongIndirectMultiColumnTimsortKernel() {
        throw new UnsupportedOperationException();
    }

    public static <PERMUTE_VALUES_ATTR extends Any> ByteLongIndirectMultiColumnSortKernelContext<PERMUTE_VALUES_ATTR> createContext(
            final int size) {
        return new ByteLongIndirectMultiColumnSortKernelContext<>(size);
    }
     ...
     */
    public static void sort(ByteLongIndirectMultiColumnSortKernelContext<?> context,
    ...
    private static void timSort(ByteLongIndirectMultiColumnSortKernelContext<?> context,
            WritableIntChunk<ChunkPositions> positions, ByteChunk<?> valuesToSort0,
     ...
     */
    private static int compareColumns(ByteChunk<?> valuesToSort0, LongChunk<?> valuesToSort1,
    ...
    private static void ensureMergeInvariants(
            ByteLongIndirectMultiColumnSortKernelContext<?> context,
            WritableIntChunk<ChunkPositions> positions, ByteChunk<?> valuesToSort0,
            LongChunk<?> valuesToSort1) {
        while (context.runCount > 1) {
    ...
    private static void merge(ByteLongIndirectMultiColumnSortKernelContext<?> context,
            WritableIntChunk<ChunkPositions> positions, ByteChunk<?> valuesToSort0,
     ...
     */
    private static void frontMerge(ByteLongIndirectMultiColumnSortKernelContext<?> context,
            WritableIntChunk<ChunkPositions> positions, ByteChunk<?> valuesToSort0,
     ...
     * We eventually need to do galloping here, but are skipping that for now
     */
    private static void backMerge(ByteLongIndirectMultiColumnSortKernelContext<?> context,
            WritableIntChunk<ChunkPositions> positions, ByteChunk<?> valuesToSort0,
    ...
    private static void copyToTemporary(ByteLongIndirectMultiColumnSortKernelContext<?> context,
    ...
    private static void insertionSort(WritableIntChunk<ChunkPositions> positions,
            ByteChunk<?> valuesToSort0, LongChunk<?> valuesToSort1, int offset, int length) {
    ...
    public static class ByteLongIndirectMultiColumnSortKernelContext<PERMUTE_VALUES_ATTR extends Any> implements MultiColumnSortKernel<PERMUTE_VALUES_ATTR> {
        int minGallop;
        ...
        private ByteLongIndirectMultiColumnSortKernelContext(int size) {
        ...
        public void sort(WritableLongChunk<PERMUTE_VALUES_ATTR> valuesToPermute,
            ...
            ByteLongIndirectMultiColumnTimsortKernel.sort(this, positions, valuesToSort[0].asByteChunk(), valuesToSort[1].asLongChunk());
