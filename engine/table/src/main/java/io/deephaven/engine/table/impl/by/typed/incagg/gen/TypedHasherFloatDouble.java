...
final class TypedHasherFloatDouble extends IncrementalChunkedOperatorAggregationStateManagerTypedBase {
  ...
  public TypedHasherFloatDouble(ColumnSource[] tableKeySources, int tableSize,
    ...
    this.keySource1 = (DoubleArraySource) super.mainKeySources[1];
  ...
  private int hash(float v0, double v1) {
  ...
  private boolean findOverflow(HashHandler handler, float v0, double v1, int chunkPosition,
