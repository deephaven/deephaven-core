 ...
 */
public final class CharLongTimsortKernel {
    ...
    public static <SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> CharLongSortKernelContext<SORT_VALUES_ATTR, PERMUTE_VALUES_ATTR> createContext(
            final int size) {
        return new CharLongTimsortKernel().createContextInstance(size);
    }
    ...
    public class CharLongSortKernelContext<SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> implements LongSortKernel<SORT_VALUES_ATTR, PERMUTE_VALUES_ATTR> {
        ...
        public void sort(WritableLongChunk<PERMUTE_VALUES_ATTR> valuesToPermute,
            ...
            CharLongTimsortKernel.this.sort(this, valuesToPermute, valuesToSort.asWritableCharChunk());
        }
        ...
        public void sort(WritableLongChunk<PERMUTE_VALUES_ATTR> valuesToPermute,
                ...
                IntChunk<? extends ChunkPositions> offsetsIn,
                IntChunk<? extends ChunkLengths> lengthsIn) {
            CharLongTimsortKernel.this.sort(this, valuesToPermute, valuesToSort.asWritableCharChunk(), offsetsIn, lengthsIn);
        }

        @Override
        public void sort(WritableLongChunk<PERMUTE_VALUES_ATTR> valuesToPermute,
                WritableChunk<SORT_VALUES_ATTR> valuesToSort, int offset, int length) {
            CharLongTimsortKernel.this.timSort(this, valuesToPermute, valuesToSort.asWritableCharChunk(), offset, length);
        }
        ...
        public void merge(WritableLongChunk<PERMUTE_VALUES_ATTR> valuesToPermute,
                ...
                int length2) {
            CharLongTimsortKernel.this.merge(this, valuesToPermute, valuesToSort.asWritableCharChunk(), start1, length1, length2);
        }
        ...
        private CharLongTimsortKernel kernel() {
            return CharLongTimsortKernel.this;
        }
    }
}
