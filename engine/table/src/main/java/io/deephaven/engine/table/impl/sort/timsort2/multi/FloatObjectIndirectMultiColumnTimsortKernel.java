...
/**
 * This implements a timsort kernel for a multi-column key (Float, Object) that never moves the column values:
 ...
 */
public final class FloatObjectIndirectMultiColumnTimsortKernel {
    private FloatObjectIndirectMultiColumnTimsortKernel() {
        throw new UnsupportedOperationException();
    }

    public static <PERMUTE_VALUES_ATTR extends Any> FloatObjectIndirectMultiColumnSortKernelContext<PERMUTE_VALUES_ATTR> createContext(
            final int size) {
        return new FloatObjectIndirectMultiColumnSortKernelContext<>(size);
    }
     ...
     */
    public static void sort(FloatObjectIndirectMultiColumnSortKernelContext<?> context,
    ...
    private static void timSort(FloatObjectIndirectMultiColumnSortKernelContext<?> context,
            WritableIntChunk<ChunkPositions> positions, FloatChunk<?> valuesToSort0,
     ...
     */
    private static int compareColumns(FloatChunk<?> valuesToSort0,
    ...
    private static void ensureMergeInvariants(
            FloatObjectIndirectMultiColumnSortKernelContext<?> context,
            WritableIntChunk<ChunkPositions> positions, FloatChunk<?> valuesToSort0,
            ObjectChunk<Object, ?> valuesToSort1) {
        while (context.runCount > 1) {
    ...
    private static void merge(FloatObjectIndirectMultiColumnSortKernelContext<?> context,
            WritableIntChunk<ChunkPositions> positions, FloatChunk<?> valuesToSort0,
     ...
     */
    private static void frontMerge(FloatObjectIndirectMultiColumnSortKernelContext<?> context,
            WritableIntChunk<ChunkPositions> positions, FloatChunk<?> valuesToSort0,
     ...
     * We eventually need to do galloping here, but are skipping that for now
     */
    private static void backMerge(FloatObjectIndirectMultiColumnSortKernelContext<?> context,
            WritableIntChunk<ChunkPositions> positions, FloatChunk<?> valuesToSort0,
    ...
    private static void copyToTemporary(FloatObjectIndirectMultiColumnSortKernelContext<?> context,
    ...
    private static void insertionSort(WritableIntChunk<ChunkPositions> positions,
            FloatChunk<?> valuesToSort0, ObjectChunk<Object, ?> valuesToSort1, int offset,
            int length) {
    ...
    public static class FloatObjectIndirectMultiColumnSortKernelContext<PERMUTE_VALUES_ATTR extends Any> implements MultiColumnSortKernel<PERMUTE_VALUES_ATTR> {
        int minGallop;
        ...
        private FloatObjectIndirectMultiColumnSortKernelContext(int size) {
        ...
        public void sort(WritableLongChunk<PERMUTE_VALUES_ATTR> valuesToPermute,
            ...
            FloatObjectIndirectMultiColumnTimsortKernel.sort(this, positions, valuesToSort[0].asFloatChunk(), valuesToSort[1].<Object>asObjectChunk());
