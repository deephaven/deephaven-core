...
final class IncrementalAggHasherIntFloat extends IncrementalChunkedOperatorAggregationStateManagerTypedBase {
    ...
    public IncrementalAggHasherIntFloat(ColumnSource[] tableKeySources,
    ...
    private boolean findOverflow(HashHandler handler, int k0, float k1, int chunkPosition,
