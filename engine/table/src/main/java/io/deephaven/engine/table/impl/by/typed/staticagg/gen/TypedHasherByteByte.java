...
final class TypedHasherByteByte extends StaticChunkedOperatorAggregationStateManagerTypedBase {
  ...
  public TypedHasherByteByte(ColumnSource[] tableKeySources, int tableSize,
      double maximumLoadFactor, double targetLoadFactor) {
    super(tableKeySources, tableSize, maximumLoadFactor, targetLoadFactor);
    this.keySource0 = (ByteArraySource) super.mainKeySources[0];
  ...
  private int hash(byte v0, byte v1) {
  ...
  private boolean findOverflow(HashHandler handler, byte v0, byte v1, int chunkPosition,
