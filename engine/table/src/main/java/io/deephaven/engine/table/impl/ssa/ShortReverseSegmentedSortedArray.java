...
public final class ShortReverseSegmentedSortedArray implements SegmentedSortedArray {
    ...
    private static <T extends Any> int findNextOneLeaf(int offset, ShortChunk<T> stampValues, LongChunk<? extends Attributes.RowKeys> stampIndices, WritableShortChunk<T> nextValues, int leafSize, short [] leafValues, long [] leafKeys) {
        int lo = 0;
     ...
     */
    void insert(ShortChunk<? extends Any> valuesToInsert, LongChunk<? extends Attributes.RowKeys> indicesToInsert) {
    ...
    private void copyToLeaf(int leafOffset, short[] leafValues, ShortChunk<? extends Any> insertValues, long[] leafIndices, LongChunk<? extends Attributes.RowKeys> insertIndices, int srcOffset, int length) {
    ...
    private void distributeValues(int targetSize, int startingLeaf, int distributionSlots, ShortChunk<? extends Any> valuesToInsert, LongChunk<? extends Attributes.RowKeys> indices) {
    ...
    private void insertIntoLeaf(int leafSize, short [] leafValues, ShortChunk<? extends Any> insertValues, long [] leafIndices, LongChunk<? extends Attributes.RowKeys> insertIndices) {
    ...
    private void removeFromLeaf(int leafSize, short [] leafValues, ShortChunk<? extends Any> removeValues, long [] leafIndices, LongChunk<? extends Attributes.RowKeys> removeIndices, @Nullable WritableLongChunk<? extends Attributes.RowKeys> priorRedirections, long firstPriorRedirection) {
    ...
    private void remove(ShortChunk<? extends Any> valuesToRemove, LongChunk<? extends Attributes.RowKeys> indicesToRemove) {
     ...
     */
    private void removeAndGetNextInternal(ShortChunk<? extends Any> valuesToRemove, LongChunk<? extends RowKeys> indicesToRemove, @Nullable WritableLongChunk<? extends Attributes.RowKeys> priorRedirections) {
        validate();
