...
public final class ShortReverseSegmentedSortedArray implements SegmentedSortedArray {
     ...
     */
    private <T extends Any> int findNext(ShortChunk<T> stampValues, LongChunk<? extends Attributes.RowKeys> stampRowKeys, WritableShortChunk<T> nextValues) {
    ...
    private static <T extends Any> int findNextOneLeaf(int offset, ShortChunk<T> stampValues, LongChunk<? extends Attributes.RowKeys> stampRowKeys, WritableShortChunk<T> nextValues, int leafSize, short [] leafValues, long [] leafKeys) {
        int lo = 0;
     ...
     */
    void insert(ShortChunk<? extends Any> valuesToInsert, LongChunk<? extends Attributes.RowKeys> rowKeysToInsert) {
    ...
    private void copyToLeaf(int leafOffset, short[] leafValues, ShortChunk<? extends Any> insertValues, long[] leafRowKeys, LongChunk<? extends RowKeys> insertRowKeys) {
        copyToLeaf(leafOffset, leafValues, insertValues, leafRowKeys, insertRowKeys, 0, insertRowKeys.size());
    }

    private void copyToLeaf(int leafOffset, short[] leafValues, ShortChunk<? extends Any> insertValues, long[] leafRowKeys, LongChunk<? extends Attributes.RowKeys> insertRowKeys, int srcOffset, int length) {
    ...
    private void distributeValues(int targetSize, int startingLeaf, int distributionSlots, ShortChunk<? extends Any> valuesToInsert, LongChunk<? extends Attributes.RowKeys> rowKeys) {
    ...
    private void insertIntoLeaf(int leafSize, short [] leafValues, ShortChunk<? extends Any> insertValues, long [] leafRowKeys, LongChunk<? extends Attributes.RowKeys> insertRowKeys) {
    ...
    private boolean isAfterLeaf(int leafSize, short[] leafValues, ShortChunk<? extends Any> insertValues, long[] leafRowKeys, LongChunk<? extends RowKeys> insertRowKeys) {
    ...
    private void removeFromLeaf(int leafSize, short [] leafValues, ShortChunk<? extends Any> removeValues, long [] leafRowKeys, LongChunk<? extends Attributes.RowKeys> removeRowKeys, @Nullable WritableLongChunk<? extends Attributes.RowKeys> priorRedirections, long firstPriorRedirection) {
    ...
    private static int lowerBound(ShortChunk<? extends Any> valuesToSearch, LongChunk<? extends RowKeys> rowKeysToSearch, int lo, int hi, short searchValue, long searchKey) {
        while (lo < hi) {
    ...
    private static int upperBound(ShortChunk<? extends Any> valuesToSearch, LongChunk<? extends Attributes.RowKeys> rowKeysToSearch, int lo, int hi, short searchValue, long searchKey) {
        while (lo < hi) {
            final int mid = (lo + hi) >>> 1;
            final short testValue = valuesToSearch.get(mid);
            final int comparison = doComparison(testValue, searchValue);
    ...
    private static int lowerBound(short [] valuesToSearch, long [] rowKeysToSearch, int lo, int hi, short searchValue, long searchKey) {
        while (lo < hi) {
            final int mid = (lo + hi) >>> 1;
     ...
     */
    private static int bound(short [] valuesToSearch, long [] rowKeysToSearch, final short searchValue, long searchRowKey, int lo, int hi) {
        while (lo < hi) {
            final int mid = (lo + hi) >>> 1;
            final short testValue = valuesToSearch[mid];
            final int comparison = doComparison(testValue, searchValue);
    ...
    private void remove(ShortChunk<? extends Any> valuesToRemove, LongChunk<? extends Attributes.RowKeys> rowKeysToRemove) {
     ...
     */
    private void removeAndGetNextInternal(ShortChunk<? extends Any> valuesToRemove, LongChunk<? extends RowKeys> rowKeysToRemove, @Nullable WritableLongChunk<? extends Attributes.RowKeys> priorRedirections) {
        validate();
    ...
    private void applyShift(ShortChunk<? extends Any> stampChunk, LongChunk<? extends Attributes.RowKeys> keyChunk, long shiftDelta) {
        validate();
    ...
    private void shiftLeaf(int leafSize, short [] leafValues, ShortChunk<? extends Any> shiftValues, long [] leafRowKeys, LongChunk<? extends Attributes.RowKeys> shiftRowKeys, long shiftDelta) {
        Assert.leq(leafSize, "leafSize", this.leafSize, "this.leafSize");
    ...
    private void shiftLeafReverse(int leafSize, short [] leafValues, ShortChunk<? extends Any> shiftValues, long [] leafRowKeys, LongChunk<? extends Attributes.RowKeys> shiftRowKeys, long shiftDelta) {
        Assert.leq(leafSize, "leafSize", this.leafSize, "this.leafSize");
        final int shiftSize = shiftValues.size();
