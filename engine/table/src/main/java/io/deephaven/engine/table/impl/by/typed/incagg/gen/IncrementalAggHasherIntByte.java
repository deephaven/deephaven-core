...
final class IncrementalAggHasherIntByte extends IncrementalChunkedOperatorAggregationStateManagerTypedBase {
    ...
    public IncrementalAggHasherIntByte(ColumnSource[] tableKeySources,
