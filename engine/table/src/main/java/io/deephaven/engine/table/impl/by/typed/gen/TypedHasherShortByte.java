...
public final class TypedHasherShortByte extends StaticChunkedOperatorAggregationStateManagerTypedBase {
  ...
  public TypedHasherShortByte(ColumnSource[] tableKeySources, int tableSize,
  ...
  private int hash(short v0, byte v1) {
  ...
  private boolean findOverflow(StaticChunkedOperatorAggregationStateManagerTypedBase.StaticAggHashHandler handler,
      short v0, byte v1, int chunkPosition, int overflowLocation) {
    while (overflowLocation != QueryConstants.NULL_INT) {
