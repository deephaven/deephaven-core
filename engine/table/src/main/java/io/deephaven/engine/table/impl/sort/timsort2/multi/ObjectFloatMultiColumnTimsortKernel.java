...
/**
 * This implements a timsort kernel that sorts a multi-column key (Object, Float), comparing each
 ...
 */
public final class ObjectFloatMultiColumnTimsortKernel {
    private ObjectFloatMultiColumnTimsortKernel() {
        throw new UnsupportedOperationException();
    }

    public static <SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> ObjectFloatMultiColumnSortKernelContext<SORT_VALUES_ATTR, PERMUTE_VALUES_ATTR> createContext(
            final int size) {
        return new ObjectFloatMultiColumnSortKernelContext<>(size);
    }
    ...
    static <SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> void sort(
            ObjectFloatMultiColumnSortKernelContext<SORT_VALUES_ATTR, PERMUTE_VALUES_ATTR> context,
    ...
    private static int upperBound(ObjectChunk<Object, ?> valuesToSort0, FloatChunk<?> valuesToSort1,
            int lo, int hi, Object searchValue0, float searchValue1) {
    ...
    private static int lowerBound(ObjectChunk<Object, ?> valuesToSort0, FloatChunk<?> valuesToSort1,
            int lo, int hi, Object searchValue0, float searchValue1) {
    ...
    private static int bound(ObjectChunk<Object, ?> valuesToSort0, FloatChunk<?> valuesToSort1,
            int lo, int hi, Object searchValue0, float searchValue1, final boolean lower) {
    ...
    private static void insertionSort(WritableLongChunk<?> valuesToPermute,
            WritableObjectChunk<Object, ?> valuesToSort0, WritableFloatChunk<?> valuesToSort1,
    ...
    public static class ObjectFloatMultiColumnSortKernelContext<SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> implements MultiColumnSortKernel<PERMUTE_VALUES_ATTR> {
        int minGallop;
        ...
        private ObjectFloatMultiColumnSortKernelContext(int size) {
        ...
        public void sort(WritableLongChunk<PERMUTE_VALUES_ATTR> valuesToPermute,
            ...
            ObjectFloatMultiColumnTimsortKernel.sort(this, valuesToPermute,
