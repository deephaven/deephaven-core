...
final class TypedHasherIntByte extends IncrementalChunkedOperatorAggregationStateManagerTypedBase {
  ...
  public TypedHasherIntByte(ColumnSource[] tableKeySources, int tableSize, double maximumLoadFactor,
  ...
  private int hash(int v0, byte v1) {
  ...
  private boolean findOverflow(HashHandler handler, int v0, byte v1, int chunkPosition,
