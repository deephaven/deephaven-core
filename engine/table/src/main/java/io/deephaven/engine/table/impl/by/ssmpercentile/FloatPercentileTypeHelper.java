...
public class FloatPercentileTypeHelper implements SsmChunkedPercentileOperator.PercentileTypeHelper {
    ...
    FloatPercentileTypeHelper(double percentile, WritableColumnSource resultColumn) {
    ...
    public int pivot(SegmentedSortedMultiSet segmentedSortedMultiSet, Chunk<? extends Values> valueCopy,
        ...
        if (result > startPosition && FloatComparisons.eq(asFloatChunk.get(result - 1), hiValue)
