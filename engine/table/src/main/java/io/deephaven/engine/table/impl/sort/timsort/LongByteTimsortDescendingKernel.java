...
public class LongByteTimsortDescendingKernel {
    ...
    // region Context
    public static class LongByteSortKernelContext<SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any>
        ...
        public void sort(
            ...
            LongByteTimsortDescendingKernel.sort(this, valuesToPermute, valuesToSort.asWritableLongChunk());
        }
        ...
        public void sort(
            ...
            LongByteTimsortDescendingKernel.sort(this, valuesToPermute, valuesToSort.asWritableLongChunk(), offsetsIn, lengthsIn);
        }
    ...
    LongByteSortKernelContext<SORT_VALUES_ATTR, PERMUTE_VALUES_ATTR> createContext(int size) {
...
//    private static void doCheck(Chunk.ByteChunk valuesToPermute, Chunk.LongChunk valuesToSort, int startCheck, int mergeEnd) {
//        long lastCheck;
