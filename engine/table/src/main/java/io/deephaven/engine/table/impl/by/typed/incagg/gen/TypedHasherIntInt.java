...
public final class TypedHasherIntInt extends IncrementalChunkedOperatorAggregationStateManagerTypedBase {
  ...
  public TypedHasherIntInt(ColumnSource[] tableKeySources, int tableSize, double maximumLoadFactor,
  ...
  private int hash(int v0, int v1) {
  ...
  private boolean findOverflow(HashHandler handler, int v0, int v1, int chunkPosition,
