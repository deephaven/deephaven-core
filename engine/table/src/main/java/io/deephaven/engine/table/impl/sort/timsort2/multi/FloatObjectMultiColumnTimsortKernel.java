...
/**
 * This implements a timsort kernel that sorts a multi-column key (Float, Object), comparing each
 ...
 */
public final class FloatObjectMultiColumnTimsortKernel {
    private FloatObjectMultiColumnTimsortKernel() {
        throw new UnsupportedOperationException();
    }

    public static <SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> FloatObjectMultiColumnSortKernelContext<SORT_VALUES_ATTR, PERMUTE_VALUES_ATTR> createContext(
            final int size) {
        return new FloatObjectMultiColumnSortKernelContext<>(size);
    }
    ...
    static <SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> void sort(
            FloatObjectMultiColumnSortKernelContext<SORT_VALUES_ATTR, PERMUTE_VALUES_ATTR> context,
    ...
    private static int upperBound(FloatChunk<?> valuesToSort0, ObjectChunk<Object, ?> valuesToSort1,
            int lo, int hi, float searchValue0, Object searchValue1) {
    ...
    private static int lowerBound(FloatChunk<?> valuesToSort0, ObjectChunk<Object, ?> valuesToSort1,
            int lo, int hi, float searchValue0, Object searchValue1) {
    ...
    private static int bound(FloatChunk<?> valuesToSort0, ObjectChunk<Object, ?> valuesToSort1,
            int lo, int hi, float searchValue0, Object searchValue1, final boolean lower) {
    ...
    private static void insertionSort(WritableLongChunk<?> valuesToPermute,
            WritableFloatChunk<?> valuesToSort0, WritableObjectChunk<Object, ?> valuesToSort1,
    ...
    public static class FloatObjectMultiColumnSortKernelContext<SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> implements MultiColumnSortKernel<PERMUTE_VALUES_ATTR> {
        int minGallop;
        ...
        private FloatObjectMultiColumnSortKernelContext(int size) {
        ...
        public void sort(WritableLongChunk<PERMUTE_VALUES_ATTR> valuesToPermute,
            ...
            FloatObjectMultiColumnTimsortKernel.sort(this, valuesToPermute,
