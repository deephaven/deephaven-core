...
/**
 * This implements a timsort kernel that sorts a multi-column key (Int, Double), comparing each
 ...
 */
public final class IntDoubleMultiColumnTimsortKernel {
    private IntDoubleMultiColumnTimsortKernel() {
        throw new UnsupportedOperationException();
    }

    public static <SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> IntDoubleMultiColumnSortKernelContext<SORT_VALUES_ATTR, PERMUTE_VALUES_ATTR> createContext(
            final int size) {
        return new IntDoubleMultiColumnSortKernelContext<>(size);
    }
    ...
    static <SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> void sort(
            IntDoubleMultiColumnSortKernelContext<SORT_VALUES_ATTR, PERMUTE_VALUES_ATTR> context,
    ...
    private static int upperBound(IntChunk<?> valuesToSort0, DoubleChunk<?> valuesToSort1, int lo,
            int hi, int searchValue0, double searchValue1) {
    ...
    private static int lowerBound(IntChunk<?> valuesToSort0, DoubleChunk<?> valuesToSort1, int lo,
            int hi, int searchValue0, double searchValue1) {
    ...
    private static int bound(IntChunk<?> valuesToSort0, DoubleChunk<?> valuesToSort1, int lo,
            int hi, int searchValue0, double searchValue1, final boolean lower) {
    ...
    private static void insertionSort(WritableLongChunk<?> valuesToPermute,
            WritableIntChunk<?> valuesToSort0, WritableDoubleChunk<?> valuesToSort1, int offset,
            int length) {
    ...
    private static void swap(WritableLongChunk<?> valuesToPermute,
            WritableIntChunk<?> valuesToSort0, WritableDoubleChunk<?> valuesToSort1, int a, int b) {
    ...
    public static class IntDoubleMultiColumnSortKernelContext<SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> implements MultiColumnSortKernel<PERMUTE_VALUES_ATTR> {
        int minGallop;
        ...
        private IntDoubleMultiColumnSortKernelContext(int size) {
        ...
        public void sort(WritableLongChunk<PERMUTE_VALUES_ATTR> valuesToPermute,
            ...
            IntDoubleMultiColumnTimsortKernel.sort(this, valuesToPermute,
