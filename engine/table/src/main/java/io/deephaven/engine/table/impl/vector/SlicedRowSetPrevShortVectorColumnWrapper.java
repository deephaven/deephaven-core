...
public class SlicedRowSetPrevShortVectorColumnWrapper extends ShortVector.Indirect {
    ...
    public SlicedRowSetPrevShortVectorColumnWrapper(@NotNull final ColumnSource<Short> columnSource,
                                                    @NotNull final RowSet rowSet) {
        this(columnSource, rowSet, 0, 0);
    }

    private SlicedRowSetPrevShortVectorColumnWrapper(@NotNull final ColumnSource<Short> columnSource,
    ...
    public ShortVector subVector(long fromIndex, long toIndex) {
        ...
        return new SlicedRowSetPrevShortVectorColumnWrapper(columnSource, rowSet.subSetByPositionRange(realFrom, realTo),
    ...
    public ShortVector subVectorByPositions(long[] positions) {
        ...
        return new SlicedRowSetPrevShortVectorColumnWrapper(columnSource, builder.build(), 0, 0);
    }
