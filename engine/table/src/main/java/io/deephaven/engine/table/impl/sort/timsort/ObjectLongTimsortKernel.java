 ...
 */
public final class ObjectLongTimsortKernel {
    ...
    public static <SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> ObjectLongSortKernelContext<SORT_VALUES_ATTR, PERMUTE_VALUES_ATTR> createContext(
            final int size) {
        return new ObjectLongTimsortKernel().createContextInstance(size);
    }
    ...
    public class ObjectLongSortKernelContext<SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> implements LongSortKernel<SORT_VALUES_ATTR, PERMUTE_VALUES_ATTR> {
        ...
        public void sort(WritableLongChunk<PERMUTE_VALUES_ATTR> valuesToPermute,
            ...
            ObjectLongTimsortKernel.this.sort(this, valuesToPermute, valuesToSort.asWritableObjectChunk());
        }
        ...
        public void sort(WritableLongChunk<PERMUTE_VALUES_ATTR> valuesToPermute,
                ...
                IntChunk<? extends ChunkPositions> offsetsIn,
                IntChunk<? extends ChunkLengths> lengthsIn) {
            ObjectLongTimsortKernel.this.sort(this, valuesToPermute, valuesToSort.asWritableObjectChunk(), offsetsIn, lengthsIn);
        }

        @Override
        public void sort(WritableLongChunk<PERMUTE_VALUES_ATTR> valuesToPermute,
                WritableChunk<SORT_VALUES_ATTR> valuesToSort, int offset, int length) {
            ObjectLongTimsortKernel.this.timSort(this, valuesToPermute, valuesToSort.asWritableObjectChunk(), offset, length);
        }
        ...
        public void merge(WritableLongChunk<PERMUTE_VALUES_ATTR> valuesToPermute,
                ...
                int length2) {
            ObjectLongTimsortKernel.this.merge(this, valuesToPermute, valuesToSort.asWritableObjectChunk(), start1, length1, length2);
        }
        ...
        private ObjectLongTimsortKernel kernel() {
            return ObjectLongTimsortKernel.this;
        }
    }
}
