...
// ****** Edit ByteByteTimsortDescendingKernel and run "./gradlew replicateSortKernel" to regenerate
//
// @formatter:off
 ...
 */
public final class ByteByteTimsortDescendingKernel {
    // region constructor
    ...
    // region Context
    public class ByteByteSortKernelContext<SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any>
        ...
        private final WritableByteChunk<SORT_VALUES_ATTR> temporaryValues;
        ...
        public void sort(
            ...
            ByteByteTimsortDescendingKernel.this.sort(this, valuesToPermute, valuesToSort.asWritableByteChunk());
        }
        ...
        public void sort(
            ...
            ByteByteTimsortDescendingKernel.this.sort(this, valuesToPermute, valuesToSort.asWritableByteChunk(), offsetsIn, lengthsIn);
        }
        ...
        private ByteByteTimsortDescendingKernel kernel() {
            return ByteByteTimsortDescendingKernel.this;
        }
    }
    // endregion Context

    // region createContextInstance
    public <SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> ByteByteSortKernelContext<SORT_VALUES_ATTR, PERMUTE_VALUES_ATTR> createContextInstance(int size) {
    ...
    public static <SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> ByteByteSortKernelContext<SORT_VALUES_ATTR, PERMUTE_VALUES_ATTR> createContext(final int size) {
        return new ByteByteTimsortDescendingKernel().createContextInstance(size);
    }
    ...
    static <SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> void sort(
            ByteByteSortKernelContext<SORT_VALUES_ATTR, PERMUTE_VALUES_ATTR> context,
            WritableByteChunk<PERMUTE_VALUES_ATTR> valuesToPermute,
    ...
    private static <SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> void copyToChunk(
            ...
            ByteChunk<SORT_VALUES_ATTR> valuesSource,
            WritableByteChunk<PERMUTE_VALUES_ATTR> permuteValuesDest,
            WritableByteChunk<SORT_VALUES_ATTR> sortValuesDest,
            int sourceStart,
            int destStart,
            int length) {
    ...
    static private void swap(WritableByteChunk<?> valuesToPermute, WritableByteChunk<?> valuesToSort, int a, int b) {
    ...
    // private static void doCheck(Chunk.ByteChunk valuesToPermute, Chunk.ByteChunk valuesToSort, int startCheck, int
    // mergeEnd) {
    // byte lastCheck;
    ...
    // private static void dumpValues(Chunk.ByteChunk valuesToSort, int start1, int length1, int start2, int length2,
    // String msg) {
