...
public final class ByteByteTimsortDescendingKernel {
    ...
    private <SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> void timSort(
            ByteByteSortKernelContext<SORT_VALUES_ATTR, PERMUTE_VALUES_ATTR> context,
            WritableByteChunk<PERMUTE_VALUES_ATTR> valuesToPermute,
            WritableByteChunk<SORT_VALUES_ATTR> valuesToSort, int offset, int length) {
        if (length <= 1) {
            return;
        }
    ...
    private <SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> void merge(
            ByteByteSortKernelContext<SORT_VALUES_ATTR, PERMUTE_VALUES_ATTR> context,
            WritableByteChunk<PERMUTE_VALUES_ATTR> valuesToPermute,
            WritableByteChunk<SORT_VALUES_ATTR> valuesToSort, int start1, int length1,
            int length2) {
    ...
    private <SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> void frontMerge(
            ByteByteSortKernelContext<SORT_VALUES_ATTR, PERMUTE_VALUES_ATTR> context,
            WritableByteChunk<PERMUTE_VALUES_ATTR> valuesToPermute,
            WritableByteChunk<SORT_VALUES_ATTR> valuesToSort, final int mergeStartPosition,
    ...
    private static <SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> void copyToTemporary(
            ByteByteSortKernelContext<SORT_VALUES_ATTR, PERMUTE_VALUES_ATTR> context,
            WritableByteChunk<PERMUTE_VALUES_ATTR> valuesToPermute,
            WritableByteChunk<SORT_VALUES_ATTR> valuesToSort, int mergeStartPosition,
            int remaining1) {
    ...
    private static <SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> void copyToChunk(
            ByteChunk<PERMUTE_VALUES_ATTR> rowSetSource, ByteChunk<SORT_VALUES_ATTR> valuesSource,
            WritableByteChunk<PERMUTE_VALUES_ATTR> permuteValuesDest,
            WritableByteChunk<SORT_VALUES_ATTR> sortValuesDest, int sourceStart, int destStart,
            int length) {
    ...
    private void insertionSort(WritableByteChunk<?> valuesToPermute,
            WritableByteChunk<?> valuesToSort, int offset, int length) {
    ...
    private static void swap(WritableByteChunk<?> valuesToPermute,
            WritableByteChunk<?> valuesToSort, int a, int b) {
    ...
    public class ByteByteSortKernelContext<SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> implements ByteSortKernel<SORT_VALUES_ATTR, PERMUTE_VALUES_ATTR> {
        int minGallop;
        ...
        public void sort(WritableByteChunk<PERMUTE_VALUES_ATTR> valuesToPermute,
            ...
            ByteByteTimsortDescendingKernel.this.timSort(this, valuesToPermute, valuesToSort.asWritableByteChunk(), offset, length);
        }
        ...
        public void merge(WritableByteChunk<PERMUTE_VALUES_ATTR> valuesToPermute,
                ...
                int length2) {
            ByteByteTimsortDescendingKernel.this.merge(this, valuesToPermute, valuesToSort.asWritableByteChunk(), start1, length1, length2);
        }
