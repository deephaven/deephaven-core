...
public class ByteByteTimsortDescendingKernel {
    ...
    // region Context
    public static class ByteByteSortKernelContext<SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any>
        ...
        public void sort(
            ...
            ByteByteTimsortDescendingKernel.sort(this, valuesToPermute, valuesToSort.asWritableByteChunk());
        }
        ...
        public void sort(
            ...
            ByteByteTimsortDescendingKernel.sort(this, valuesToPermute, valuesToSort.asWritableByteChunk(), offsetsIn, lengthsIn);
        }
    ...
    ByteByteSortKernelContext<SORT_VALUES_ATTR, PERMUTE_VALUES_ATTR> createContext(int size) {
...
//    private static void doCheck(Chunk.ByteChunk valuesToPermute, Chunk.ByteChunk valuesToSort, int startCheck, int mergeEnd) {
//        byte lastCheck;
