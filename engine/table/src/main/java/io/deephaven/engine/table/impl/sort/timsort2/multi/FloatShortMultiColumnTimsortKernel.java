...
/**
 * This implements a timsort kernel that sorts a multi-column key (Float, Short), comparing each
 ...
 */
public final class FloatShortMultiColumnTimsortKernel {
    private FloatShortMultiColumnTimsortKernel() {
        throw new UnsupportedOperationException();
    }

    public static <SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> FloatShortMultiColumnSortKernelContext<SORT_VALUES_ATTR, PERMUTE_VALUES_ATTR> createContext(
            final int size) {
        return new FloatShortMultiColumnSortKernelContext<>(size);
    }
    ...
    static <SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> void sort(
            FloatShortMultiColumnSortKernelContext<SORT_VALUES_ATTR, PERMUTE_VALUES_ATTR> context,
    ...
    private static int upperBound(FloatChunk<?> valuesToSort0, ShortChunk<?> valuesToSort1, int lo,
            int hi, float searchValue0, short searchValue1) {
    ...
    private static int lowerBound(FloatChunk<?> valuesToSort0, ShortChunk<?> valuesToSort1, int lo,
            int hi, float searchValue0, short searchValue1) {
    ...
    private static int bound(FloatChunk<?> valuesToSort0, ShortChunk<?> valuesToSort1, int lo,
            int hi, float searchValue0, short searchValue1, final boolean lower) {
    ...
    private static void insertionSort(WritableLongChunk<?> valuesToPermute,
            WritableFloatChunk<?> valuesToSort0, WritableShortChunk<?> valuesToSort1, int offset,
            int length) {
    ...
    private static void swap(WritableLongChunk<?> valuesToPermute,
            WritableFloatChunk<?> valuesToSort0, WritableShortChunk<?> valuesToSort1, int a,
            int b) {
    ...
    public static class FloatShortMultiColumnSortKernelContext<SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> implements MultiColumnSortKernel<PERMUTE_VALUES_ATTR> {
        int minGallop;
        ...
        private FloatShortMultiColumnSortKernelContext(int size) {
        ...
        public void sort(WritableLongChunk<PERMUTE_VALUES_ATTR> valuesToPermute,
            ...
            FloatShortMultiColumnTimsortKernel.sort(this, valuesToPermute,
