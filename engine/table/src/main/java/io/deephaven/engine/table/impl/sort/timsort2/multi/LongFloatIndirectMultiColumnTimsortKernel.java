...
/**
 * This implements a timsort kernel for a multi-column key (Long, Float) that never moves the column values:
 ...
 */
public final class LongFloatIndirectMultiColumnTimsortKernel {
    private LongFloatIndirectMultiColumnTimsortKernel() {
        throw new UnsupportedOperationException();
    }

    public static <PERMUTE_VALUES_ATTR extends Any> LongFloatIndirectMultiColumnSortKernelContext<PERMUTE_VALUES_ATTR> createContext(
            final int size) {
        return new LongFloatIndirectMultiColumnSortKernelContext<>(size);
    }
     ...
     */
    public static void sort(LongFloatIndirectMultiColumnSortKernelContext<?> context,
    ...
    private static void timSort(LongFloatIndirectMultiColumnSortKernelContext<?> context,
            WritableIntChunk<ChunkPositions> positions, LongChunk<?> valuesToSort0,
     ...
     */
    private static int compareColumns(LongChunk<?> valuesToSort0, FloatChunk<?> valuesToSort1,
    ...
    private static void ensureMergeInvariants(
            LongFloatIndirectMultiColumnSortKernelContext<?> context,
            WritableIntChunk<ChunkPositions> positions, LongChunk<?> valuesToSort0,
            FloatChunk<?> valuesToSort1) {
        while (context.runCount > 1) {
    ...
    private static void merge(LongFloatIndirectMultiColumnSortKernelContext<?> context,
            WritableIntChunk<ChunkPositions> positions, LongChunk<?> valuesToSort0,
     ...
     */
    private static void frontMerge(LongFloatIndirectMultiColumnSortKernelContext<?> context,
            WritableIntChunk<ChunkPositions> positions, LongChunk<?> valuesToSort0,
     ...
     * We eventually need to do galloping here, but are skipping that for now
     */
    private static void backMerge(LongFloatIndirectMultiColumnSortKernelContext<?> context,
            WritableIntChunk<ChunkPositions> positions, LongChunk<?> valuesToSort0,
    ...
    private static void copyToTemporary(LongFloatIndirectMultiColumnSortKernelContext<?> context,
    ...
    private static void insertionSort(WritableIntChunk<ChunkPositions> positions,
            LongChunk<?> valuesToSort0, FloatChunk<?> valuesToSort1, int offset, int length) {
    ...
    public static class LongFloatIndirectMultiColumnSortKernelContext<PERMUTE_VALUES_ATTR extends Any> implements MultiColumnSortKernel<PERMUTE_VALUES_ATTR> {
        int minGallop;
        ...
        private LongFloatIndirectMultiColumnSortKernelContext(int size) {
        ...
        public void sort(WritableLongChunk<PERMUTE_VALUES_ATTR> valuesToPermute,
            ...
            LongFloatIndirectMultiColumnTimsortKernel.sort(this, positions, valuesToSort[0].asLongChunk(), valuesToSort[1].asFloatChunk());
