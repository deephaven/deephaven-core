...
final class IncrementalAggOpenHasherWithTombstoneFloatChar extends IncrementalChunkedOperatorAggregationStateManagerOpenAddressedBaseWithTombstones {
    ...
    public IncrementalAggOpenHasherWithTombstoneFloatChar(ColumnSource[] tableKeySources,
