...
final class StaticAggHasherDoubleLong extends StaticChunkedOperatorAggregationStateManagerTypedBase {
    ...
    public StaticAggHasherDoubleLong(ColumnSource[] tableKeySources,
