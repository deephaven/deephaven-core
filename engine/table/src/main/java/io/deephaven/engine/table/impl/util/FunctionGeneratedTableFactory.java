...
public class FunctionGeneratedTableFactory {
    private final Supplier<io.deephaven.engine.table.Table> tableGenerator;
     ...
     */
    public static Table create(Supplier<io.deephaven.engine.table.Table> tableGenerator, int refreshIntervalMs) {
     ...
     * @return a ticking table (assuming sourceTables have been specified) generated by tableGenerator
     */
    public static Table create(Supplier<io.deephaven.engine.table.Table> tableGenerator, Table... sourceTables) {
    ...
    private FunctionGeneratedTableFactory(final Supplier<io.deephaven.engine.table.Table> tableGenerator,
