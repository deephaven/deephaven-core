...
final class TypedHasherInt extends IncrementalChunkedOperatorAggregationStateManagerTypedBase {
  private final IntegerArraySource mainKeySource0;

  private final IntegerArraySource overflowKeySource0;

  public TypedHasherInt(ColumnSource[] tableKeySources, int tableSize, double maximumLoadFactor,
  ...
  private boolean findOverflow(HashHandler handler, int v0, int chunkPosition,
