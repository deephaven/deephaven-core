...
final class StaticAggHasherIntByte extends StaticChunkedOperatorAggregationStateManagerTypedBase {
    ...
    public StaticAggHasherIntByte(ColumnSource[] tableKeySources,
