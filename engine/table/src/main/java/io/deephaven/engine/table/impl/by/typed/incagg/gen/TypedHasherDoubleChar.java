...
final class TypedHasherDoubleChar extends IncrementalChunkedOperatorAggregationStateManagerTypedBase {
  ...
  public TypedHasherDoubleChar(ColumnSource[] tableKeySources, int tableSize,
  ...
  private boolean findOverflow(HashHandler handler, double v0, char v1, int chunkPosition,
