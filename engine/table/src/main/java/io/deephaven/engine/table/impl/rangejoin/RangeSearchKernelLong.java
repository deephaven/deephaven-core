...
/**
 * {@link RangeSearchKernel} for values of type long.
 */
enum RangeSearchKernelLong implements RangeSearchKernel {

    LT_GT {
        @Override
        void populateAllRangeForEmptyRight(@NotNull final LongChunk<? extends Values> lsv,
                @NotNull final LongChunk<? extends Values> lev, @NotNull final WritableIntChunk<? extends Values> o) {
            populateAllRangesForEmptyRightDisallowEqual(lsv, lev, o);
        }

        @Override
        void populateInvalidRanges(@NotNull final LongChunk<? extends Values> lsv,
                @NotNull final LongChunk<? extends Values> lev, @NotNull final WritableBooleanChunk<? super Values> v,
                @NotNull final WritableIntChunk<? extends Values> o) {
            populateInvalidRangesDisallowEqual(lsv, lev, v, o);
        }

        @Override
        void findStarts(@NotNull final LongChunk<? extends Values> lv, @NotNull final IntChunk<ChunkPositions> lp,
                @NotNull final LongChunk<? extends Values> rv, @NotNull final IntChunk<ChunkPositions> rso,
        ...
        @Override
        void findEnds(@NotNull final LongChunk<? extends Values> lv, @NotNull final IntChunk<ChunkPositions> lp,
                @NotNull final LongChunk<? extends Values> rv, @NotNull final IntChunk<ChunkPositions> rso,
                @NotNull final IntChunk<ChunkLengths> rl, @NotNull final WritableIntChunk<? extends Values> o) {
    ...
    static RangeSearchKernelLong forRules(
    ...
    public final void populateAllRangeForEmptyRight(
        ...
        populateAllRangeForEmptyRight(leftStartValues.asLongChunk(), leftEndValues.asLongChunk(), output);
    }

    abstract void populateAllRangeForEmptyRight(
            @NotNull final LongChunk<? extends Values> leftStartValues,
            @NotNull final LongChunk<? extends Values> leftEndValues,
            @NotNull final WritableIntChunk<? extends Values> output);
    ...
    public final void populateInvalidRanges(
            ...
            @NotNull final WritableIntChunk<? extends Values> output) {
        populateInvalidRanges(leftStartValues.asLongChunk(), leftEndValues.asLongChunk(), validity, output);
    }
    ...
    public final void findStarts(
            ...
            @NotNull final WritableIntChunk<? extends Values> output) {
        findStarts(leftValues.asLongChunk(), leftPositions,
                rightValues.asLongChunk(), rightStartOffsets, rightLengths,
                output);
    }

    abstract void findStarts(
            @NotNull final LongChunk<? extends Values> leftValues,
            @NotNull final IntChunk<ChunkPositions> leftPositions,
            @NotNull final LongChunk<? extends Values> rightValues,
            @NotNull final IntChunk<ChunkPositions> rightStartOffsets,
            @NotNull final IntChunk<ChunkLengths> rightLengths,
            @NotNull final WritableIntChunk<? extends Values> output);
    ...
    public final void findEnds(
            ...
            @NotNull final IntChunk<ChunkLengths> rightLengths,
            @NotNull final WritableIntChunk<? extends Values> output) {
        findEnds(leftValues.asLongChunk(), leftPositions,
                rightValues.asLongChunk(), rightStartOffsets, rightLengths,
                output);
    }
    ...
    private static void populateInvalidRangesAllowEqual(
            @NotNull LongChunk<? extends Values> leftStartValues,
            @NotNull LongChunk<? extends Values> leftEndValues,
    ...
    private static boolean isValidPairAllowEqual(final long start, final long end) {
        return !isNaN(start) && !isNaN(end) && (isNull(start) || isNull(end) || leq(start, end));
    }

    private static boolean isValidPairDisallowEqual(final long start, final long end) {
    ...
    private static void findStartsLessThan(
        ...
        long leftValue = leftValues.get(leftIndex);
        do {
            ...
            final long rightValue = rightValues.get(rightIndex);
    ...
    // region isNaN
    private static boolean isNaN(@SuppressWarnings("unused") final long v) {
        return false;
    }
    // endregion isNaN

    // region isNull
    private static boolean isNull(final long v) {
    ...
    // region lt
    private static boolean lt(final long a, final long b) {
    ...
    // region leq
    private static boolean leq(final long a, final long b) {
        // We need not deal with null or NaN values here
        return a <= b;
    }
    // endregion leq
