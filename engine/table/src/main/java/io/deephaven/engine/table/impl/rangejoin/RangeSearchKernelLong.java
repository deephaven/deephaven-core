...
enum RangeSearchKernelLong implements RangeSearchKernel {
    ...
    LT_GT {
        ...
        void processAllRangesForEmptyRight(
                @NotNull final LongChunk<? extends Values> lsv,
                @NotNull final LongChunk<? extends Values> lev,
        ...
        void processRangeStarts(
                @NotNull final LongChunk<? extends Values> lv,
                @NotNull final IntChunk<ChunkPositions> lp,
                @NotNull final LongChunk<? extends Values> rv,
    ...
    public final void processAllRangesForEmptyRight(
        ...
        processAllRangesForEmptyRight(
                leftStartValues.asLongChunk(),
                leftEndValues.asLongChunk(),
    ...
    public final void processRangeStarts(
            ...
            @NotNull final WritableIntChunk<? extends Values> outputStartPositionsInclusive) {
        processRangeStarts(
                leftValues.asLongChunk(),
                leftPositions,
                rightValues.asLongChunk(),
                rightStartOffsets,
                rightSizeExpanded,
                outputStartPositionsInclusive);
    }
    ...
    abstract void processRangeStarts(
            @NotNull LongChunk<? extends Values> leftValues,
            @NotNull IntChunk<ChunkPositions> leftPositions,
            @NotNull LongChunk<? extends Values> rightValues,
    ...
    // region eq
    private static boolean eq(final long a, final long b) {
