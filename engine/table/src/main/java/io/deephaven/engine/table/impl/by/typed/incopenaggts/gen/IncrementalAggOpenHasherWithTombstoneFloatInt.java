...
final class IncrementalAggOpenHasherWithTombstoneFloatInt extends IncrementalChunkedOperatorAggregationStateManagerOpenAddressedBaseWithTombstones {
    ...
    public IncrementalAggOpenHasherWithTombstoneFloatInt(ColumnSource[] tableKeySources,
