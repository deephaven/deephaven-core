...
/**
 * This implements a timsort kernel for a multi-column key (NullAwareChar, Float) that never moves the column values:
 ...
 */
public final class NullAwareCharFloatIndirectMultiColumnTimsortKernel {
    private NullAwareCharFloatIndirectMultiColumnTimsortKernel() {
        throw new UnsupportedOperationException();
    }

    public static <PERMUTE_VALUES_ATTR extends Any> NullAwareCharFloatIndirectMultiColumnSortKernelContext<PERMUTE_VALUES_ATTR> createContext(
            final int size) {
        return new NullAwareCharFloatIndirectMultiColumnSortKernelContext<>(size);
    }
     ...
     */
    public static void sort(NullAwareCharFloatIndirectMultiColumnSortKernelContext<?> context,
    ...
    private static void timSort(NullAwareCharFloatIndirectMultiColumnSortKernelContext<?> context,
            WritableIntChunk<ChunkPositions> positions, CharChunk<?> valuesToSort0,
     ...
     */
    private static int compareColumns(CharChunk<?> valuesToSort0, FloatChunk<?> valuesToSort1,
    ...
    private static void ensureMergeInvariants(
            NullAwareCharFloatIndirectMultiColumnSortKernelContext<?> context,
            WritableIntChunk<ChunkPositions> positions, CharChunk<?> valuesToSort0,
            FloatChunk<?> valuesToSort1) {
        while (context.runCount > 1) {
    ...
    private static void merge(NullAwareCharFloatIndirectMultiColumnSortKernelContext<?> context,
            WritableIntChunk<ChunkPositions> positions, CharChunk<?> valuesToSort0,
     ...
     * We eventually need to do galloping here, but are skipping that for now
     */
    private static void backMerge(NullAwareCharFloatIndirectMultiColumnSortKernelContext<?> context,
            WritableIntChunk<ChunkPositions> positions, CharChunk<?> valuesToSort0,
    ...
    private static void insertionSort(WritableIntChunk<ChunkPositions> positions,
            CharChunk<?> valuesToSort0, FloatChunk<?> valuesToSort1, int offset, int length) {
    ...
    public static class NullAwareCharFloatIndirectMultiColumnSortKernelContext<PERMUTE_VALUES_ATTR extends Any> implements MultiColumnSortKernel<PERMUTE_VALUES_ATTR> {
        int minGallop;
        ...
        private NullAwareCharFloatIndirectMultiColumnSortKernelContext(int size) {
        ...
        public void sort(WritableLongChunk<PERMUTE_VALUES_ATTR> valuesToPermute,
            ...
            NullAwareCharFloatIndirectMultiColumnTimsortKernel.sort(this, positions, valuesToSort[0].asCharChunk(), valuesToSort[1].asFloatChunk());
