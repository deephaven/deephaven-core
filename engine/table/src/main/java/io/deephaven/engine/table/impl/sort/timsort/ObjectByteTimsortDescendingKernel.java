...
/*
 * ---------------------------------------------------------------------------------------------------------------------
 * AUTO-GENERATED CLASS - DO NOT EDIT MANUALLY - for any changes edit ObjectLongTimsortDescendingKernel and regenerate
 * ---------------------------------------------------------------------------------------------------------------------
 */
 ...
 * the algorithm.
 */
public class ObjectByteTimsortDescendingKernel {
    private ObjectByteTimsortDescendingKernel() {
        throw new UnsupportedOperationException();
    }

    // region Context
    public static class ObjectByteSortKernelContext<ATTR extends Any, KEY_INDICES extends Indices> implements ByteSortKernel<ATTR, KEY_INDICES> {
        int minGallop;
        int runCount = 0;
        ...
        public void sort(WritableByteChunk<KEY_INDICES> indexKeys, WritableChunk<ATTR> valuesToSort) {
            ObjectByteTimsortDescendingKernel.sort(this, indexKeys, valuesToSort.asWritableObjectChunk());
        }
        ...
        public void sort(WritableByteChunk<KEY_INDICES> indexKeys, WritableChunk<ATTR> valuesToSort, IntChunk<? extends ChunkPositions> offsetsIn, IntChunk<? extends ChunkLengths> lengthsIn) {
            ObjectByteTimsortDescendingKernel.sort(this, indexKeys, valuesToSort.asWritableObjectChunk(), offsetsIn, lengthsIn);
        }
    ...
    public static <ATTR extends Any, KEY_INDICES extends Indices> ObjectByteSortKernelContext<ATTR, KEY_INDICES> createContext(int size) {
     ...
     */
    static <ATTR extends Any, KEY_INDICES extends Indices> void sort(ObjectByteSortKernelContext<ATTR, KEY_INDICES> context, WritableByteChunk<KEY_INDICES> indexKeys, WritableObjectChunk<Object, ATTR> valuesToSort, IntChunk<? extends ChunkPositions> offsetsIn, IntChunk<? extends ChunkLengths> lengthsIn) {
     ...
     * runs sorted on each pass.
     */
    public static <ATTR extends Any, KEY_INDICES extends Indices> void sort(ObjectByteSortKernelContext<ATTR, KEY_INDICES> context, WritableByteChunk<KEY_INDICES> indexKeys, WritableObjectChunk<Object, ATTR> valuesToSort) {
        timSort(context, indexKeys, valuesToSort, 0, indexKeys.size());
    }

    static private <ATTR extends Any, KEY_INDICES extends Indices> void timSort(ObjectByteSortKernelContext<ATTR, KEY_INDICES> context, WritableByteChunk<KEY_INDICES> indexKeys, WritableObjectChunk<Object, ATTR> valuesToSort, int offset, int length) {
        if (length <= 1) {
            return;
        }
     ...
     */
    private static <ATTR extends Any, KEY_INDICES extends Indices> void ensureMergeInvariants(ObjectByteSortKernelContext<ATTR, KEY_INDICES> context, WritableByteChunk<KEY_INDICES> indexKeys, WritableObjectChunk<Object, ATTR> valuesToSort) {
        while (context.runCount > 1) {
    ...
    private static <ATTR extends Any, KEY_INDICES extends Indices> void merge(ObjectByteSortKernelContext<ATTR, KEY_INDICES> context, WritableByteChunk<KEY_INDICES> indexKeys, WritableObjectChunk<Object, ATTR> valuesToSort, int start1, int length1, int length2) {
     ...
     */
    private static <ATTR extends Any, KEY_INDICES extends Indices> void frontMerge(ObjectByteSortKernelContext<ATTR, KEY_INDICES> context, WritableByteChunk<KEY_INDICES> indexKeys, WritableObjectChunk<Object, ATTR> valuesToSort, final int mergeStartPosition, final int start2, final int length2) {
        int tempCursor = 0;
     ...
     * We eventually need to do galloping here, but are skipping that for now
     */
    private static <ATTR extends Any, KEY_INDICES extends Indices> void backMerge(ObjectByteSortKernelContext<ATTR, KEY_INDICES> context, WritableByteChunk<KEY_INDICES> indexKeys, WritableObjectChunk<Object, ATTR> valuesToSort, final int mergeStartPosition, final int length1) {
    ...
    private static <ATTR extends Any, KEY_INDICES extends Indices> void copyToTemporary(ObjectByteSortKernelContext<ATTR, KEY_INDICES> context, WritableByteChunk<KEY_INDICES> indexKeys, WritableObjectChunk<Object, ATTR> valuesToSort, int mergeStartPosition, int remaining1) {
    ...
    private static <ATTR extends Any, KEY_INDICES extends Indices> void copyToChunk(ByteChunk<KEY_INDICES> rowSetSource, ObjectChunk<Object, ATTR> valuesSource, WritableByteChunk<KEY_INDICES> indexDest, WritableObjectChunk<Object, ATTR> valuesDest, int sourceStart, int destStart, int length) {
    ...
    private static void insertionSort(WritableByteChunk<? extends Indices> indexKeys, WritableObjectChunk<Object, ?> valuesToSort, int offset, int length) {
    ...
    static private void swap(WritableByteChunk<? extends Indices> indexKeys, WritableObjectChunk<Object, ?> valuesToSort, int a, int b) {
...
//    private static void doCheck(Chunk.ByteChunk indexKeys, Chunk.ObjectChunk valuesToSort, int startCheck, int mergeEnd) {
//        Object lastCheck;
