...
// ****** Edit LongSegmentedSortedArray and run "./gradlew replicateSegmentedSortedArray" to regenerate
//
// @formatter:off
 ...
 *
 * We must be totally ordered, which is accomplished by sorting on the long values, and then on the corresponding row
 * key.
 */
public final class LongReverseSegmentedSortedArray implements SegmentedSortedArray {
    ...
    public void insert(Chunk<? extends Any> valuesToInsert, LongChunk<? extends RowKeys> rowKeysToInsert) {
        insert(valuesToInsert.asLongChunk(), rowKeysToInsert);
    }
    ...
    public <T extends Any> int insertAndGetNextValue(Chunk<T> valuesToInsert,
        ...
        return findNext(valuesToInsert.asLongChunk(), rowKeysToInsert, nextValue.asWritableLongChunk());
    }
     ...
     */
    private <T extends Any> int findNext(LongChunk<T> stampValues, LongChunk<? extends RowKeys> stampRowKeys,
            WritableLongChunk<T> nextValues) {
    ...
    private static <T extends Any> int findNextOneLeaf(int offset, LongChunk<T> stampValues,
            LongChunk<? extends RowKeys> stampRowKeys, WritableLongChunk<T> nextValues, int leafSize, long[] leafValues,
            long[] leafKeys) {
        int lo = 0;
     ...
     */
    void insert(LongChunk<? extends Any> valuesToInsert, LongChunk<? extends RowKeys> rowKeysToInsert) {
    ...
    private void copyToLeaf(int leafOffset, long[] leafValues, LongChunk<? extends Any> insertValues,
    ...
    private void moveLeafValues(long[] leafValues, long[] leafRowKeys, int srcPos, int destPos, int length) {
        System.arraycopy(leafValues, srcPos, leafValues, destPos, length);
        System.arraycopy(leafRowKeys, srcPos, leafRowKeys, destPos, length);
    }
     ...
     */
    private static void clearValues(long[] values, int from, int to) {
        // region clearValues
    ...
    private void distributeValues(int targetSize, int startingLeaf, int distributionSlots,
            LongChunk<? extends Any> valuesToInsert, LongChunk<? extends RowKeys> rowKeys) {
    ...
    private void makeSingletonLeaf(LongChunk<? extends Any> values, LongChunk<? extends RowKeys> rowKeys) {
    ...
    private void makeLeavesInitial(LongChunk<? extends Any> values, LongChunk<? extends RowKeys> rowKeys) {
    ...
    private void insertIntoLeaf(int leafSize, long[] leafValues, LongChunk<? extends Any> insertValues,
            long[] leafRowKeys, LongChunk<? extends RowKeys> insertRowKeys) {
    ...
    private boolean isAfterLeaf(int leafSize, long[] leafValues, LongChunk<? extends Any> insertValues,
            long[] leafRowKeys, LongChunk<? extends RowKeys> insertRowKeys) {
    ...
    private void removeFromLeaf(int leafSize, long[] leafValues, LongChunk<? extends Any> removeValues,
    ...
    private static int lowerBound(LongChunk<? extends Any> valuesToSearch, LongChunk<? extends RowKeys> rowKeysToSearch,
            int lo, int hi, long searchValue, long searchKey) {
        while (lo < hi) {
    ...
    private static int upperBound(LongChunk<? extends Any> valuesToSearch, LongChunk<? extends RowKeys> rowKeysToSearch,
            int lo, int hi, long searchValue, long searchKey) {
        while (lo < hi) {
            final int mid = (lo + hi) >>> 1;
            final long testValue = valuesToSearch.get(mid);
    ...
    private static int lowerBound(long[] valuesToSearch, long[] rowKeysToSearch, int lo, int hi, long searchValue,
            long searchKey) {
        while (lo < hi) {
            final int mid = (lo + hi) >>> 1;
     ...
     */
    private static int bound(long[] valuesToSearch, long[] rowKeysToSearch, final long searchValue, long searchRowKey,
            int lo, int hi) {
        while (lo < hi) {
            final int mid = (lo + hi) >>> 1;
            final long testValue = valuesToSearch[mid];
    ...
    public void remove(Chunk<? extends Any> valuesToRemove, LongChunk<? extends RowKeys> rowKeysToRemove) {
        remove(valuesToRemove.asLongChunk(), rowKeysToRemove);
    }
    ...
    public void removeAndGetPrior(Chunk<? extends Any> stampChunk, LongChunk<? extends RowKeys> rowKeysToRemove,
        ...
        removeAndGetNextInternal(stampChunk.asLongChunk(), rowKeysToRemove, priorRedirections);
    }

    private void remove(LongChunk<? extends Any> valuesToRemove, LongChunk<? extends RowKeys> rowKeysToRemove) {
     ...
     */
    private void removeAndGetNextInternal(LongChunk<? extends Any> valuesToRemove,
    ...
    private void applyShift(LongChunk<? extends Any> stampChunk, LongChunk<? extends RowKeys> keyChunk,
            long shiftDelta) {
        validate();
    ...
    private void shiftLeaf(int leafSize, long[] leafValues, LongChunk<? extends Any> shiftValues, long[] leafRowKeys,
    ...
    private void applyShiftReverse(LongChunk<? extends Any> stampChunk, LongChunk<? extends RowKeys> keyChunk,
            long shiftDelta) {
        validate();
        final int shiftSize = stampChunk.size();
        if (shiftSize == 0) {
    ...
    private void shiftLeafReverse(int leafSize, long[] leafValues, LongChunk<? extends Any> shiftValues,
    ...
    private static void validateLeaf(long[] values, long[] rowKeys, int size) {
        if (!SEGMENTED_SORTED_ARRAY_VALIDATION) {
            return;
        }
     ...
     */
    WritableLongChunk<? extends Any> asLongChunk() {
    ...
    public final class Iterator {
         ...
         */
        public void advanceToLast(long value) {
