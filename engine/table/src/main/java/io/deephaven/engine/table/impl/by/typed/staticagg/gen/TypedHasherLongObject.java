...
final class TypedHasherLongObject extends StaticChunkedOperatorAggregationStateManagerTypedBase {
  ...
  public TypedHasherLongObject(ColumnSource[] tableKeySources, int tableSize,
  ...
  private int hash(long v0, Object v1) {
  ...
  private int maybeMoveMainBucket(HashHandler handler, int bucket, int destBucket,
    ...
    final Object v1 = mainKeySource1.getUnsafe(bucket);
    final int hash = hash(v0, v1);
    ...
    if (location == bucket) {
      ...
      mainKeySource1.set(bucket, null);
      handler.doMoveMain(bucket, destBucket);
    }
    return mainInsertLocation;
  }

  private boolean findOverflow(HashHandler handler, long v0, Object v1, int chunkPosition,
