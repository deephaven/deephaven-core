...
final class TypedHasherShortChar extends StaticChunkedOperatorAggregationStateManagerTypedBase {
  ...
  public TypedHasherShortChar(ColumnSource[] tableKeySources, int tableSize,
  ...
  private int hash(short v0, char v1) {
  ...
  private boolean findOverflow(HashHandler handler, short v0, char v1, int chunkPosition,
