...
final class IncrementalAggOpenHasherWithTombstoneCharChar extends IncrementalChunkedOperatorAggregationStateManagerOpenAddressedBaseWithTombstones {
    ...
    public IncrementalAggOpenHasherWithTombstoneCharChar(ColumnSource[] tableKeySources,
