...
public final class ByteSegmentedSortedMultiset implements SegmentedSortedMultiSet<Byte>, ByteVector {
    ...
    private void insert(WritableByteChunk<? extends Values> valuesToInsert, WritableIntChunk<ChunkLengths> counts) {
        ...
        if (isSingleton()) {
            if (valuesToInsert.size() == 1 && ByteComparisons.eq(valuesToInsert.get(0), singletonValue)) {
    ...
    private void remove(RemoveContext removeContext, ByteChunk<? extends Values> valuesToRemove,
        ...
        if (isSingleton()) {
            ...
            Assert.assertion(ByteComparisons.eq(valuesToRemove.get(0), singletonValue),
                    "ByteComparisons.eq(valuesToRemove.get(0), singletonValue)");
            singletonCount -= counts.get(0);
