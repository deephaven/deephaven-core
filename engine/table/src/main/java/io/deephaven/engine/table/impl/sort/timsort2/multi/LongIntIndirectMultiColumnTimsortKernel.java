...
/**
 * This implements a timsort kernel for a multi-column key (Long, Int) that never moves the column values:
 ...
 */
public final class LongIntIndirectMultiColumnTimsortKernel {
    private LongIntIndirectMultiColumnTimsortKernel() {
        throw new UnsupportedOperationException();
    }

    public static <PERMUTE_VALUES_ATTR extends Any> LongIntIndirectMultiColumnSortKernelContext<PERMUTE_VALUES_ATTR> createContext(
            final int size) {
        return new LongIntIndirectMultiColumnSortKernelContext<>(size);
    }
     ...
     */
    public static void sort(LongIntIndirectMultiColumnSortKernelContext<?> context,
    ...
    private static void timSort(LongIntIndirectMultiColumnSortKernelContext<?> context,
            WritableIntChunk<ChunkPositions> positions, LongChunk<?> valuesToSort0,
     ...
     */
    private static int compareColumns(LongChunk<?> valuesToSort0, IntChunk<?> valuesToSort1,
    ...
    private static void ensureMergeInvariants(
            LongIntIndirectMultiColumnSortKernelContext<?> context,
            WritableIntChunk<ChunkPositions> positions, LongChunk<?> valuesToSort0,
            IntChunk<?> valuesToSort1) {
        while (context.runCount > 1) {
    ...
    private static void merge(LongIntIndirectMultiColumnSortKernelContext<?> context,
            WritableIntChunk<ChunkPositions> positions, LongChunk<?> valuesToSort0,
     ...
     */
    private static void frontMerge(LongIntIndirectMultiColumnSortKernelContext<?> context,
            WritableIntChunk<ChunkPositions> positions, LongChunk<?> valuesToSort0,
     ...
     * We eventually need to do galloping here, but are skipping that for now
     */
    private static void backMerge(LongIntIndirectMultiColumnSortKernelContext<?> context,
            WritableIntChunk<ChunkPositions> positions, LongChunk<?> valuesToSort0,
    ...
    private static void copyToTemporary(LongIntIndirectMultiColumnSortKernelContext<?> context,
    ...
    private static void insertionSort(WritableIntChunk<ChunkPositions> positions,
            LongChunk<?> valuesToSort0, IntChunk<?> valuesToSort1, int offset, int length) {
    ...
    public static class LongIntIndirectMultiColumnSortKernelContext<PERMUTE_VALUES_ATTR extends Any> implements MultiColumnSortKernel<PERMUTE_VALUES_ATTR> {
        int minGallop;
        ...
        private LongIntIndirectMultiColumnSortKernelContext(int size) {
        ...
        public void sort(WritableLongChunk<PERMUTE_VALUES_ATTR> valuesToPermute,
            ...
            LongIntIndirectMultiColumnTimsortKernel.sort(this, positions, valuesToSort[0].asLongChunk(), valuesToSort[1].asIntChunk());
