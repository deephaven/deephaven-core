...
public final class ObjectDescIndirectTimsortKernel {
    ...
    public static class ObjectDescIndirectSortKernelContext<PERMUTE_VALUES_ATTR extends Any> implements MultiColumnSortKernel<PERMUTE_VALUES_ATTR> {
        ...
        public void sortPositions(WritableIntChunk<ChunkPositions> positions,
            ...
            ObjectDescIndirectTimsortKernel.timSort(this, positions, valuesToSort[0].<Object>asObjectChunk(), offset, length);
        }
        ...
        public void mergePositions(WritableIntChunk<ChunkPositions> positions,
            ...
            ObjectDescIndirectTimsortKernel.merge(this, positions, valuesToSort[0].<Object>asObjectChunk(), start1, length1, length2);
        }
