...
public class NullAwareCharIntTimsortDescendingKernel {
    ...
    // region Context
    public static class CharIntSortKernelContext<SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any>
        ...
        public void sort(
            ...
            NullAwareCharIntTimsortDescendingKernel.sort(this, valuesToPermute, valuesToSort.asWritableCharChunk());
        }
        ...
        public void sort(
            ...
            NullAwareCharIntTimsortDescendingKernel.sort(this, valuesToPermute, valuesToSort.asWritableCharChunk(), offsetsIn, lengthsIn);
        }
