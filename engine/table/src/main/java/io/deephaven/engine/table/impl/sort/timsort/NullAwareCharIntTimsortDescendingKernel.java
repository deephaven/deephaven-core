...
public class NullAwareCharIntTimsortDescendingKernel {
    ...
    public static class CharIntSortKernelContext<ATTR extends Any, KEY_INDICES extends Indices> implements IntSortKernel<ATTR, KEY_INDICES> {
        ...
        public void sort(WritableIntChunk<KEY_INDICES> indexKeys, WritableChunk<ATTR> valuesToSort) {
            NullAwareCharIntTimsortDescendingKernel.sort(this, indexKeys, valuesToSort.asWritableCharChunk());
        }
        ...
        public void sort(WritableIntChunk<KEY_INDICES> indexKeys, WritableChunk<ATTR> valuesToSort, IntChunk<? extends ChunkPositions> offsetsIn, IntChunk<? extends ChunkLengths> lengthsIn) {
            NullAwareCharIntTimsortDescendingKernel.sort(this, indexKeys, valuesToSort.asWritableCharChunk(), offsetsIn, lengthsIn);
        }
