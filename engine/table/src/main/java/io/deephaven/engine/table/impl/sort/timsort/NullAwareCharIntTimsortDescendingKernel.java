...
// ****** Edit NullAwareCharIntTimsortDescendingKernel and run "./gradlew replicateSortKernel" to regenerate
//
// @formatter:off
...
//
// ****** AUTO-GENERATED CLASS - DO NOT EDIT MANUALLY
// ****** Edit CharLongTimsortDescendingKernel and run "./gradlew replicateSortKernel" to regenerate
//
// @formatter:off
 ...
 */
public final class NullAwareCharIntTimsortDescendingKernel {
    // region constructor
    ...
    // region Context
    public class CharIntSortKernelContext<SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any>
        ...
        public void sort(
            ...
            NullAwareCharIntTimsortDescendingKernel.this.sort(this, valuesToPermute, valuesToSort.asWritableCharChunk());
        }
        ...
        public void sort(
            ...
            NullAwareCharIntTimsortDescendingKernel.this.sort(this, valuesToPermute, valuesToSort.asWritableCharChunk(), offsetsIn, lengthsIn);
        }
        ...
        private NullAwareCharIntTimsortDescendingKernel kernel() {
            return NullAwareCharIntTimsortDescendingKernel.this;
        }
    }
    // endregion Context

    // region createContextInstance
    public <SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> CharIntSortKernelContext<SORT_VALUES_ATTR, PERMUTE_VALUES_ATTR> createContextInstance(int size) {
    ...
    public static <SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> CharIntSortKernelContext<SORT_VALUES_ATTR, PERMUTE_VALUES_ATTR> createContext(final int size) {
        return new NullAwareCharIntTimsortDescendingKernel().createContextInstance(size);
    }
    ...
    static <SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> void sort(
            CharIntSortKernelContext<SORT_VALUES_ATTR, PERMUTE_VALUES_ATTR> context,
            WritableIntChunk<PERMUTE_VALUES_ATTR> valuesToPermute,
    ...
    private static <SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> void copyToChunk(
            IntChunk<PERMUTE_VALUES_ATTR> rowSetSource,
            CharChunk<SORT_VALUES_ATTR> valuesSource,
            WritableIntChunk<PERMUTE_VALUES_ATTR> permuteValuesDest,
            WritableCharChunk<SORT_VALUES_ATTR> sortValuesDest,
            int sourceStart,
            int destStart,
            int length) {
    ...
    private int upperBound(CharChunk<?> valuesToSort, int lo, int hi, char searchValue) {
    ...
    private int lowerBound(CharChunk<?> valuesToSort, int lo, int hi, char searchValue) {
        return bound(valuesToSort, lo, hi, searchValue, true);
    }

    private int bound(CharChunk<?> valuesToSort, int lo, int hi, char searchValue, final boolean lower) {
    ...
    private void insertionSort(
            ...
            WritableCharChunk<?> valuesToSort,
            int offset,
            int length) {
    ...
    static private void swap(WritableIntChunk<?> valuesToPermute, WritableCharChunk<?> valuesToSort, int a, int b) {
    ...
    // private static void doCheck(Chunk.IntChunk valuesToPermute, Chunk.CharChunk valuesToSort, int startCheck, int
    // mergeEnd) {
    // char lastCheck;
    ...
    // private static void dumpValues(Chunk.CharChunk valuesToSort, int start1, int length1, int start2, int length2,
    // String msg) {
