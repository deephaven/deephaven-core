 ...
 */
public final class IntLongTimsortDescendingKernel {
    private IntLongTimsortDescendingKernel() {
    }

    public <SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> IntLongSortKernelContext<SORT_VALUES_ATTR, PERMUTE_VALUES_ATTR> createContextInstance(
            int size) {
    ...
    public static <SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> IntLongSortKernelContext<SORT_VALUES_ATTR, PERMUTE_VALUES_ATTR> createContext(
            final int size) {
        return new IntLongTimsortDescendingKernel().createContextInstance(size);
    }
    ...
    private <SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> void timSort(
            IntLongSortKernelContext<SORT_VALUES_ATTR, PERMUTE_VALUES_ATTR> context,
            WritableLongChunk<PERMUTE_VALUES_ATTR> valuesToPermute,
            WritableIntChunk<SORT_VALUES_ATTR> valuesToSort, int offset, int length) {
        if (length <= 1) {
            return;
        }
    ...
    private <SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> void merge(
            IntLongSortKernelContext<SORT_VALUES_ATTR, PERMUTE_VALUES_ATTR> context,
            WritableLongChunk<PERMUTE_VALUES_ATTR> valuesToPermute,
            WritableIntChunk<SORT_VALUES_ATTR> valuesToSort, int start1, int length1, int length2) {
    ...
    private <SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> void frontMerge(
            IntLongSortKernelContext<SORT_VALUES_ATTR, PERMUTE_VALUES_ATTR> context,
            WritableLongChunk<PERMUTE_VALUES_ATTR> valuesToPermute,
            WritableIntChunk<SORT_VALUES_ATTR> valuesToSort, final int mergeStartPosition,
    ...
    private static <SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> void copyToTemporary(
            IntLongSortKernelContext<SORT_VALUES_ATTR, PERMUTE_VALUES_ATTR> context,
            WritableLongChunk<PERMUTE_VALUES_ATTR> valuesToPermute,
            WritableIntChunk<SORT_VALUES_ATTR> valuesToSort, int mergeStartPosition,
            int remaining1) {
    ...
    private static <SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> void copyToChunk(
            LongChunk<PERMUTE_VALUES_ATTR> rowSetSource, IntChunk<SORT_VALUES_ATTR> valuesSource,
            WritableLongChunk<PERMUTE_VALUES_ATTR> permuteValuesDest,
            WritableIntChunk<SORT_VALUES_ATTR> sortValuesDest, int sourceStart, int destStart,
            int length) {
    ...
    private int bound(IntChunk<?> valuesToSort, int lo, int hi, int searchValue,
            final boolean lower) {
        // lt or leq
    ...
    private void insertionSort(WritableLongChunk<?> valuesToPermute,
            WritableIntChunk<?> valuesToSort, int offset, int length) {
    ...
    private static void swap(WritableLongChunk<?> valuesToPermute, WritableIntChunk<?> valuesToSort,
            int a, int b) {
    ...
    public class IntLongSortKernelContext<SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> implements LongSortKernel<SORT_VALUES_ATTR, PERMUTE_VALUES_ATTR> {
        int minGallop;
        ...
        public void sort(WritableLongChunk<PERMUTE_VALUES_ATTR> valuesToPermute,
            ...
            IntLongTimsortDescendingKernel.this.sort(this, valuesToPermute, valuesToSort.asWritableIntChunk());
        }
        ...
        public void sort(WritableLongChunk<PERMUTE_VALUES_ATTR> valuesToPermute,
                ...
                IntChunk<? extends ChunkPositions> offsetsIn,
                IntChunk<? extends ChunkLengths> lengthsIn) {
            IntLongTimsortDescendingKernel.this.sort(this, valuesToPermute, valuesToSort.asWritableIntChunk(), offsetsIn, lengthsIn);
        }

        @Override
        public void sort(WritableLongChunk<PERMUTE_VALUES_ATTR> valuesToPermute,
                WritableChunk<SORT_VALUES_ATTR> valuesToSort, int offset, int length) {
            IntLongTimsortDescendingKernel.this.timSort(this, valuesToPermute, valuesToSort.asWritableIntChunk(), offset, length);
        }
        ...
        public void merge(WritableLongChunk<PERMUTE_VALUES_ATTR> valuesToPermute,
                ...
                int length2) {
            IntLongTimsortDescendingKernel.this.merge(this, valuesToPermute, valuesToSort.asWritableIntChunk(), start1, length1, length2);
        }
        ...
        private IntLongTimsortDescendingKernel kernel() {
            return IntLongTimsortDescendingKernel.this;
        }
    }
}
