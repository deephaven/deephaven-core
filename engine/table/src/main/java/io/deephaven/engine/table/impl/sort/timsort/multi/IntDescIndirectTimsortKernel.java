...
public final class IntDescIndirectTimsortKernel {
    ...
    public static class IntDescIndirectSortKernelContext<PERMUTE_VALUES_ATTR extends Any> implements MultiColumnSortKernel<PERMUTE_VALUES_ATTR> {
        ...
        public void sortPositions(WritableIntChunk<ChunkPositions> positions,
            ...
            IntDescIndirectTimsortKernel.timSort(this, positions, valuesToSort[0].asIntChunk(), offset, length);
        }
        ...
        public void mergePositions(WritableIntChunk<ChunkPositions> positions,
            ...
            IntDescIndirectTimsortKernel.merge(this, positions, valuesToSort[0].asIntChunk(), start1, length1, length2);
        }
