...
final class StaticAggHasherIntDouble extends StaticChunkedOperatorAggregationStateManagerTypedBase {
    ...
    public StaticAggHasherIntDouble(ColumnSource[] tableKeySources,
    ...
    private boolean findOverflow(HashHandler handler, int k0, double k1, int chunkPosition,
