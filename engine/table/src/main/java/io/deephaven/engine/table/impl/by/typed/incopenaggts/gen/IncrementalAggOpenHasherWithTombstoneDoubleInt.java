...
final class IncrementalAggOpenHasherWithTombstoneDoubleInt extends IncrementalChunkedOperatorAggregationStateManagerOpenAddressedBaseWithTombstones {
    ...
    public IncrementalAggOpenHasherWithTombstoneDoubleInt(ColumnSource[] tableKeySources,
