...
final class IncrementalAggOpenHasherWithTombstoneLongInt extends IncrementalChunkedOperatorAggregationStateManagerOpenAddressedBaseWithTombstones {
    ...
    public IncrementalAggOpenHasherWithTombstoneLongInt(ColumnSource[] tableKeySources,
