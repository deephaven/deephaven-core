...
public class LongCopyKernel implements CopyKernel {
    public static final LongCopyKernel INSTANCE = new LongCopyKernel();

    private LongCopyKernel() {} // use through the instance
    ...
    public static <T extends Any> void conditionalCopy(
            WritableLongChunk<T> output, long[] baseInput, long[] overInput, long[] useOverInput,
    ...
    public <T extends Any> void conditionalCopy(
            ...
            int srcOffset, int dstOffset, int length)
    {
        long[] typedBaseInput = (long[]) baseInput;
        long[] typedOverInput = (long[]) overInput;
        conditionalCopy(output.asWritableLongChunk(), typedBaseInput, typedOverInput, useOverInput, srcOffset, dstOffset, length);
    }
}
