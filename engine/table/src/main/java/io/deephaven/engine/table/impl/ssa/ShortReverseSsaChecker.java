...
// ****** Edit ShortSsaChecker and run "./gradlew replicateReverseSegmentedSortedArray" to regenerate
//
// @formatter:off
...
public class ShortReverseSsaChecker implements SsaChecker {
    ...
    static void checkSsa(ShortReverseSegmentedSortedArray ssa, ShortChunk<? extends Values> valueChunk,
            LongChunk<? extends RowKeys> tableIndexChunk) {
