 ...
 */
public final class RangeAggregateColumnSourceLong
        extends RangeAggregateColumnSource<LongVector, Long> {

    public RangeAggregateColumnSourceLong(
            @NotNull final ColumnSource<Long> aggregated,
        ...
        super(LongVector.class, aggregated, rowSets, startPositionsInclusive, endPositionsExclusive);
    }

    @NotNull
    private LongVector makeVector(
            @NotNull final RowSet rowSet,
            final int startPositionInclusive,
            final int length) {
        return new LongVectorSlice(
                new LongVectorColumnWrapper(aggregated, rowSet),
                startPositionInclusive,
                length);
    }

    @NotNull
    private LongVector makePrevVector(
            @NotNull final RowSet rowSet,
            final int startPositionInclusive,
            final int length) {
        return new LongVectorSlice(
                new LongVectorColumnWrapper(aggregatedPrev, rowSet),
                startPositionInclusive,
                length);
    }
