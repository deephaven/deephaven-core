...
public final class TypedHasherByteInt extends IncrementalChunkedOperatorAggregationStateManagerTypedBase {
  ...
  public TypedHasherByteInt(ColumnSource[] tableKeySources, int tableSize, double maximumLoadFactor,
  ...
  private int hash(byte v0, int v1) {
  ...
  private boolean findOverflow(HashHandler handler, byte v0, int v1, int chunkPosition,
