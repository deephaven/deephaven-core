...
/**
 * This implements a timsort kernel that sorts a multi-column key (Double, Float), comparing each
 ...
 */
public final class DoubleFloatMultiColumnTimsortKernel {
    private DoubleFloatMultiColumnTimsortKernel() {
        throw new UnsupportedOperationException();
    }

    public static <SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> DoubleFloatMultiColumnSortKernelContext<SORT_VALUES_ATTR, PERMUTE_VALUES_ATTR> createContext(
            final int size) {
        return new DoubleFloatMultiColumnSortKernelContext<>(size);
    }
    ...
    static <SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> void sort(
            DoubleFloatMultiColumnSortKernelContext<SORT_VALUES_ATTR, PERMUTE_VALUES_ATTR> context,
    ...
    private static <SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> void copyToChunk(
            ...
            DoubleChunk<SORT_VALUES_ATTR> valuesSource0, FloatChunk<SORT_VALUES_ATTR> valuesSource1,
    ...
    private static int upperBound(DoubleChunk<?> valuesToSort0, FloatChunk<?> valuesToSort1, int lo,
            int hi, double searchValue0, float searchValue1) {
    ...
    private static int lowerBound(DoubleChunk<?> valuesToSort0, FloatChunk<?> valuesToSort1, int lo,
            int hi, double searchValue0, float searchValue1) {
    ...
    private static int bound(DoubleChunk<?> valuesToSort0, FloatChunk<?> valuesToSort1, int lo,
            int hi, double searchValue0, float searchValue1, final boolean lower) {
    ...
    private static void insertionSort(WritableLongChunk<?> valuesToPermute,
            WritableDoubleChunk<?> valuesToSort0, WritableFloatChunk<?> valuesToSort1, int offset,
            int length) {
    ...
    private static void swap(WritableLongChunk<?> valuesToPermute,
            WritableDoubleChunk<?> valuesToSort0, WritableFloatChunk<?> valuesToSort1, int a,
            int b) {
    ...
    public static class DoubleFloatMultiColumnSortKernelContext<SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> implements MultiColumnSortKernel<PERMUTE_VALUES_ATTR> {
        int minGallop;
        ...
        private DoubleFloatMultiColumnSortKernelContext(int size) {
        ...
        public void sort(WritableLongChunk<PERMUTE_VALUES_ATTR> valuesToPermute,
            ...
            DoubleFloatMultiColumnTimsortKernel.sort(this, valuesToPermute,
