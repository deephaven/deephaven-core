 ...
 */
public final class CharTimsortKernel {
    private CharTimsortKernel() {
        throw new UnsupportedOperationException();
    }

    public static <ATTR extends Any> CharSortKernelContext<ATTR> createContext(final int size) {
     ...
     */
    public static <ATTR extends Any> void sort(CharSortKernelContext<ATTR> context,
            final WritableCharChunk<ATTR> valuesToSort) {
        timSort(context, valuesToSort, 0, valuesToSort.size());
    }

    private static <ATTR extends Any> void timSort(CharSortKernelContext<ATTR> context,
    ...
    private static <ATTR extends Any> void ensureMergeInvariants(
            CharSortKernelContext<ATTR> context, WritableCharChunk<ATTR> valuesToSort) {
        while (context.runCount > 1) {
    ...
    private static <ATTR extends Any> void merge(CharSortKernelContext<ATTR> context,
     ...
     */
    private static <ATTR extends Any> void frontMerge(CharSortKernelContext<ATTR> context,
     ...
     * We eventually need to do galloping here, but are skipping that for now
     */
    private static <ATTR extends Any> void backMerge(CharSortKernelContext<ATTR> context,
    ...
    private static <ATTR extends Any> void copyToTemporary(CharSortKernelContext<ATTR> context,
            WritableCharChunk<ATTR> valuesToSort, int mergeStartPosition, int remaining1) {
