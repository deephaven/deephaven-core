...
/*
 * ---------------------------------------------------------------------------------------------------------------------
 * AUTO-GENERATED CLASS - DO NOT EDIT MANUALLY - for any changes edit DoubleLongTimsortDescendingKernel and regenerate
 * ---------------------------------------------------------------------------------------------------------------------
 */
...
public class DoubleByteTimsortDescendingKernel {
    ...
    // region Context
    public static class DoubleByteSortKernelContext<ATTR extends Any, KEY_INDICES extends Indices> implements ByteSortKernel<ATTR, KEY_INDICES> {
        int minGallop;
        int runCount = 0;
        ...
        private DoubleByteSortKernelContext(int size) {
        ...
        public void sort(WritableByteChunk<KEY_INDICES> indexKeys, WritableChunk<ATTR> valuesToSort) {
            DoubleByteTimsortDescendingKernel.sort(this, indexKeys, valuesToSort.asWritableDoubleChunk());
        }
        ...
        public void sort(WritableByteChunk<KEY_INDICES> indexKeys, WritableChunk<ATTR> valuesToSort, IntChunk<? extends ChunkPositions> offsetsIn, IntChunk<? extends ChunkLengths> lengthsIn) {
            DoubleByteTimsortDescendingKernel.sort(this, indexKeys, valuesToSort.asWritableDoubleChunk(), offsetsIn, lengthsIn);
        }
    ...
    public static <ATTR extends Any, KEY_INDICES extends Indices> DoubleByteSortKernelContext<ATTR, KEY_INDICES> createContext(int size) {
     ...
     */
    static <ATTR extends Any, KEY_INDICES extends Indices> void sort(DoubleByteSortKernelContext<ATTR, KEY_INDICES> context, WritableByteChunk<KEY_INDICES> indexKeys, WritableDoubleChunk<ATTR> valuesToSort, IntChunk<? extends ChunkPositions> offsetsIn, IntChunk<? extends ChunkLengths> lengthsIn) {
     ...
     * runs sorted on each pass.
     */
    public static <ATTR extends Any, KEY_INDICES extends Indices> void sort(DoubleByteSortKernelContext<ATTR, KEY_INDICES> context, WritableByteChunk<KEY_INDICES> indexKeys, WritableDoubleChunk<ATTR> valuesToSort) {
        timSort(context, indexKeys, valuesToSort, 0, indexKeys.size());
    }

    static private <ATTR extends Any, KEY_INDICES extends Indices> void timSort(DoubleByteSortKernelContext<ATTR, KEY_INDICES> context, WritableByteChunk<KEY_INDICES> indexKeys, WritableDoubleChunk<ATTR> valuesToSort, int offset, int length) {
        if (length <= 1) {
            return;
        }
     ...
     */
    private static <ATTR extends Any, KEY_INDICES extends Indices> void ensureMergeInvariants(DoubleByteSortKernelContext<ATTR, KEY_INDICES> context, WritableByteChunk<KEY_INDICES> indexKeys, WritableDoubleChunk<ATTR> valuesToSort) {
        while (context.runCount > 1) {
    ...
    private static <ATTR extends Any, KEY_INDICES extends Indices> void merge(DoubleByteSortKernelContext<ATTR, KEY_INDICES> context, WritableByteChunk<KEY_INDICES> indexKeys, WritableDoubleChunk<ATTR> valuesToSort, int start1, int length1, int length2) {
     ...
     */
    private static <ATTR extends Any, KEY_INDICES extends Indices> void frontMerge(DoubleByteSortKernelContext<ATTR, KEY_INDICES> context, WritableByteChunk<KEY_INDICES> indexKeys, WritableDoubleChunk<ATTR> valuesToSort, final int mergeStartPosition, final int start2, final int length2) {
        int tempCursor = 0;
     ...
     * We eventually need to do galloping here, but are skipping that for now
     */
    private static <ATTR extends Any, KEY_INDICES extends Indices> void backMerge(DoubleByteSortKernelContext<ATTR, KEY_INDICES> context, WritableByteChunk<KEY_INDICES> indexKeys, WritableDoubleChunk<ATTR> valuesToSort, final int mergeStartPosition, final int length1) {
    ...
    private static <ATTR extends Any, KEY_INDICES extends Indices> void copyToTemporary(DoubleByteSortKernelContext<ATTR, KEY_INDICES> context, WritableByteChunk<KEY_INDICES> indexKeys, WritableDoubleChunk<ATTR> valuesToSort, int mergeStartPosition, int remaining1) {
    ...
    private static <ATTR extends Any, KEY_INDICES extends Indices> void copyToChunk(ByteChunk<KEY_INDICES> rowSetSource, DoubleChunk<ATTR> valuesSource, WritableByteChunk<KEY_INDICES> indexDest, WritableDoubleChunk<ATTR> valuesDest, int sourceStart, int destStart, int length) {
    ...
    private static void insertionSort(WritableByteChunk<? extends Indices> indexKeys, WritableDoubleChunk<?> valuesToSort, int offset, int length) {
    ...
    static private void swap(WritableByteChunk<? extends Indices> indexKeys, WritableDoubleChunk<?> valuesToSort, int a, int b) {
...
//    private static void doCheck(Chunk.ByteChunk indexKeys, Chunk.DoubleChunk valuesToSort, int startCheck, int mergeEnd) {
//        double lastCheck;
