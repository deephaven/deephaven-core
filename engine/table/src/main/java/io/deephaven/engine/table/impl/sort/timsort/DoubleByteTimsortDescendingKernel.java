...
public final class DoubleByteTimsortDescendingKernel {
    ...
    private static <SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> void copyToChunk(
            ByteChunk<PERMUTE_VALUES_ATTR> rowSetSource, DoubleChunk<SORT_VALUES_ATTR> valuesSource,
    ...
    public class DoubleByteSortKernelContext<SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> implements ByteSortKernel<SORT_VALUES_ATTR, PERMUTE_VALUES_ATTR> {
        int minGallop;
        ...
        public void sort(WritableByteChunk<PERMUTE_VALUES_ATTR> valuesToPermute,
                ...
                IntChunk<? extends ChunkPositions> offsetsIn,
                IntChunk<? extends ChunkLengths> lengthsIn) {
            DoubleByteTimsortDescendingKernel.this.sort(this, valuesToPermute, valuesToSort.asWritableDoubleChunk(), offsetsIn, lengthsIn);
        }

        @Override
        public void sort(WritableByteChunk<PERMUTE_VALUES_ATTR> valuesToPermute,
                WritableChunk<SORT_VALUES_ATTR> valuesToSort, int offset, int length) {
            DoubleByteTimsortDescendingKernel.this.timSort(this, valuesToPermute, valuesToSort.asWritableDoubleChunk(), offset, length);
        }
        ...
        public void merge(WritableByteChunk<PERMUTE_VALUES_ATTR> valuesToPermute,
                ...
                int length2) {
            DoubleByteTimsortDescendingKernel.this.merge(this, valuesToPermute, valuesToSort.asWritableDoubleChunk(), start1, length1, length2);
        }
