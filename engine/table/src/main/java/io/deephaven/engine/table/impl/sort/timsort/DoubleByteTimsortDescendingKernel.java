...
public class DoubleByteTimsortDescendingKernel {
    ...
    DoubleByteSortKernelContext<SORT_VALUES_ATTR, PERMUTE_VALUES_ATTR> createContext(int size) {
...
//    private static void doCheck(Chunk.ByteChunk valuesToPermute, Chunk.DoubleChunk valuesToSort, int startCheck, int mergeEnd) {
//        double lastCheck;
