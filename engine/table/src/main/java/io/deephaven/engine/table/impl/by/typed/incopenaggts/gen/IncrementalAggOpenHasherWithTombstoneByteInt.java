...
final class IncrementalAggOpenHasherWithTombstoneByteInt extends IncrementalChunkedOperatorAggregationStateManagerOpenAddressedBaseWithTombstones {
    ...
    public IncrementalAggOpenHasherWithTombstoneByteInt(ColumnSource[] tableKeySources,
