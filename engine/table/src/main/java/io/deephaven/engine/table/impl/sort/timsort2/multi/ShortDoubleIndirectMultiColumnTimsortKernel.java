...
/**
 * This implements a timsort kernel for a multi-column key (Short, Double) that never moves the column values:
 ...
 */
public final class ShortDoubleIndirectMultiColumnTimsortKernel {
    private ShortDoubleIndirectMultiColumnTimsortKernel() {
        throw new UnsupportedOperationException();
    }

    public static <PERMUTE_VALUES_ATTR extends Any> ShortDoubleIndirectMultiColumnSortKernelContext<PERMUTE_VALUES_ATTR> createContext(
            final int size) {
        return new ShortDoubleIndirectMultiColumnSortKernelContext<>(size);
    }
     ...
     */
    public static void sort(ShortDoubleIndirectMultiColumnSortKernelContext<?> context,
    ...
    private static void timSort(ShortDoubleIndirectMultiColumnSortKernelContext<?> context,
            WritableIntChunk<ChunkPositions> positions, ShortChunk<?> valuesToSort0,
     ...
     */
    private static int compareColumns(ShortChunk<?> valuesToSort0, DoubleChunk<?> valuesToSort1,
    ...
    private static void ensureMergeInvariants(
            ShortDoubleIndirectMultiColumnSortKernelContext<?> context,
            WritableIntChunk<ChunkPositions> positions, ShortChunk<?> valuesToSort0,
            DoubleChunk<?> valuesToSort1) {
        while (context.runCount > 1) {
    ...
    private static void merge(ShortDoubleIndirectMultiColumnSortKernelContext<?> context,
            WritableIntChunk<ChunkPositions> positions, ShortChunk<?> valuesToSort0,
     ...
     */
    private static void frontMerge(ShortDoubleIndirectMultiColumnSortKernelContext<?> context,
            WritableIntChunk<ChunkPositions> positions, ShortChunk<?> valuesToSort0,
     ...
     * We eventually need to do galloping here, but are skipping that for now
     */
    private static void backMerge(ShortDoubleIndirectMultiColumnSortKernelContext<?> context,
            WritableIntChunk<ChunkPositions> positions, ShortChunk<?> valuesToSort0,
    ...
    private static void copyToTemporary(ShortDoubleIndirectMultiColumnSortKernelContext<?> context,
    ...
    private static void insertionSort(WritableIntChunk<ChunkPositions> positions,
            ShortChunk<?> valuesToSort0, DoubleChunk<?> valuesToSort1, int offset, int length) {
    ...
    public static class ShortDoubleIndirectMultiColumnSortKernelContext<PERMUTE_VALUES_ATTR extends Any> implements MultiColumnSortKernel<PERMUTE_VALUES_ATTR> {
        int minGallop;
        ...
        private ShortDoubleIndirectMultiColumnSortKernelContext(int size) {
        ...
        public void sort(WritableLongChunk<PERMUTE_VALUES_ATTR> valuesToPermute,
            ...
            ShortDoubleIndirectMultiColumnTimsortKernel.sort(this, positions, valuesToSort[0].asShortChunk(), valuesToSort[1].asDoubleChunk());
