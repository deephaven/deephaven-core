...
public final class TypedHasherCharFloat extends StaticChunkedOperatorAggregationStateManagerTypedBase {
  ...
  public TypedHasherCharFloat(ColumnSource[] tableKeySources, int tableSize,
  ...
  private int hash(char v0, float v1) {
  ...
  private boolean findOverflow(StaticChunkedOperatorAggregationStateManagerTypedBase.StaticAggHashHandler handler,
      char v0, float v1, int chunkPosition, int overflowLocation) {
    while (overflowLocation != QueryConstants.NULL_INT) {
