...
public final class IntByteTimsortKernel {
    ...
    // region Context
    public class IntByteSortKernelContext<SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any>
    ...
    static private void swap(WritableByteChunk<?> valuesToPermute, WritableIntChunk<?> valuesToSort, int a, int b) {
    ...
    // private static void doCheck(Chunk.ByteChunk valuesToPermute, Chunk.IntChunk valuesToSort, int startCheck, int
    // mergeEnd) {
    // int lastCheck;
