...
public class IntByteTimsortKernel {
    ...
    public static class IntByteSortKernelContext<SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any>
        ...
        public void sort(
            ...
            IntByteTimsortKernel.sort(this, valuesToPermute, valuesToSort.asWritableIntChunk());
        }
        ...
        public void sort(
            ...
            IntByteTimsortKernel.sort(this, valuesToPermute, valuesToSort.asWritableIntChunk(), offsetsIn, lengthsIn);
        }
