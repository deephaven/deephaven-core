...
public final class TypedHasherShortObject extends IncrementalChunkedOperatorAggregationStateManagerTypedBase {
  ...
  public TypedHasherShortObject(ColumnSource[] tableKeySources, int tableSize,
  ...
  private int hash(short v0, Object v1) {
  ...
  private boolean findOverflow(HashHandler handler, short v0, Object v1, int chunkPosition,
