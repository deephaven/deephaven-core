...
final class IncrementalAggHasherCharObject extends IncrementalChunkedOperatorAggregationStateManagerTypedBase {
    ...
    public IncrementalAggHasherCharObject(ColumnSource[] tableKeySources,
    ...
    private static int hash(char k0, Object k1) {
    ...
    private boolean findOverflow(HashHandler handler, char k0, Object k1, int chunkPosition,
