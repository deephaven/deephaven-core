...
public class TypedHashDispatcher {
    ...
    private static RightIncrementalNaturalJoinStateManagerTypedBase dispatchSingle(ChunkType chunkType,
        ...
        switch (chunkType) {
            ...
            case Char:
                return new RightIncrementalNaturalJoinHasherChar(tableKeySources, tableSize, maximumLoadFactor,
                        targetLoadFactor);
            case Byte:
                return new RightIncrementalNaturalJoinHasherByte(tableKeySources, tableSize, maximumLoadFactor,
                        targetLoadFactor);
            case Short:
                return new RightIncrementalNaturalJoinHasherShort(tableKeySources, tableSize, maximumLoadFactor,
                        targetLoadFactor);
            case Int:
                return new RightIncrementalNaturalJoinHasherInt(tableKeySources, tableSize, maximumLoadFactor,
                        targetLoadFactor);
            case Long:
                return new RightIncrementalNaturalJoinHasherLong(tableKeySources, tableSize, maximumLoadFactor,
                        targetLoadFactor);
            case Float:
                return new RightIncrementalNaturalJoinHasherFloat(tableKeySources, tableSize, maximumLoadFactor,
                        targetLoadFactor);
            case Double:
                return new RightIncrementalNaturalJoinHasherDouble(tableKeySources, tableSize, maximumLoadFactor,
                        targetLoadFactor);
            case Object:
                return new RightIncrementalNaturalJoinHasherObject(tableKeySources, tableSize, maximumLoadFactor,
                        targetLoadFactor);
        }
    }
}
