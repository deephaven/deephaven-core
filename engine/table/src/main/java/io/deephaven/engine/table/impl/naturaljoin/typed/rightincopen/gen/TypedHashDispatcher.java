...
public class TypedHashDispatcher {
    ...
    private static RightIncrementalNaturalJoinStateManagerTypedBase dispatchSingle(ChunkType chunkType,
        ...
        switch (chunkType) {
            ...
            case Char:
                return new RightIncrementalNaturalJoinHasherChar(tableKeySources, originalTableKeySources, tableSize,
                        maximumLoadFactor, targetLoadFactor);
            case Byte:
                return new RightIncrementalNaturalJoinHasherByte(tableKeySources, originalTableKeySources, tableSize,
                        maximumLoadFactor, targetLoadFactor);
            case Short:
                return new RightIncrementalNaturalJoinHasherShort(tableKeySources, originalTableKeySources, tableSize,
                        maximumLoadFactor, targetLoadFactor);
            case Int:
                return new RightIncrementalNaturalJoinHasherInt(tableKeySources, originalTableKeySources, tableSize,
                        maximumLoadFactor, targetLoadFactor);
            case Long:
                return new RightIncrementalNaturalJoinHasherLong(tableKeySources, originalTableKeySources, tableSize,
                        maximumLoadFactor, targetLoadFactor);
            case Float:
                return new RightIncrementalNaturalJoinHasherFloat(tableKeySources, originalTableKeySources, tableSize,
                        maximumLoadFactor, targetLoadFactor);
            case Double:
                return new RightIncrementalNaturalJoinHasherDouble(tableKeySources, originalTableKeySources, tableSize,
                        maximumLoadFactor, targetLoadFactor);
            case Object:
                return new RightIncrementalNaturalJoinHasherObject(tableKeySources, originalTableKeySources, tableSize,
                        maximumLoadFactor, targetLoadFactor);
        }
    }
}
