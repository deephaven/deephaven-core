...
public final class LongIntTimsortKernel {
    ...
    private <SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> void timSort(
            LongIntSortKernelContext<SORT_VALUES_ATTR, PERMUTE_VALUES_ATTR> context,
            WritableIntChunk<PERMUTE_VALUES_ATTR> valuesToPermute,
            WritableLongChunk<SORT_VALUES_ATTR> valuesToSort, int offset, int length) {
        if (length <= 1) {
            return;
        }
    ...
    private <SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> void merge(
            LongIntSortKernelContext<SORT_VALUES_ATTR, PERMUTE_VALUES_ATTR> context,
            WritableIntChunk<PERMUTE_VALUES_ATTR> valuesToPermute,
            WritableLongChunk<SORT_VALUES_ATTR> valuesToSort, int start1, int length1,
            int length2) {
    ...
    private <SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> void frontMerge(
            LongIntSortKernelContext<SORT_VALUES_ATTR, PERMUTE_VALUES_ATTR> context,
            WritableIntChunk<PERMUTE_VALUES_ATTR> valuesToPermute,
            WritableLongChunk<SORT_VALUES_ATTR> valuesToSort, final int mergeStartPosition,
    ...
    private static <SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> void copyToTemporary(
            LongIntSortKernelContext<SORT_VALUES_ATTR, PERMUTE_VALUES_ATTR> context,
            WritableIntChunk<PERMUTE_VALUES_ATTR> valuesToPermute,
            WritableLongChunk<SORT_VALUES_ATTR> valuesToSort, int mergeStartPosition,
            int remaining1) {
    ...
    private static <SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> void copyToChunk(
            IntChunk<PERMUTE_VALUES_ATTR> rowSetSource, LongChunk<SORT_VALUES_ATTR> valuesSource,
            WritableIntChunk<PERMUTE_VALUES_ATTR> permuteValuesDest,
            WritableLongChunk<SORT_VALUES_ATTR> sortValuesDest, int sourceStart, int destStart,
            int length) {
    ...
    private int bound(LongChunk<?> valuesToSort, int lo, int hi, long searchValue,
            final boolean lower) {
        // lt or leq
    ...
    private void insertionSort(WritableIntChunk<?> valuesToPermute,
            WritableLongChunk<?> valuesToSort, int offset, int length) {
    ...
    private static void swap(WritableIntChunk<?> valuesToPermute, WritableLongChunk<?> valuesToSort,
            int a, int b) {
    ...
    public class LongIntSortKernelContext<SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> implements IntSortKernel<SORT_VALUES_ATTR, PERMUTE_VALUES_ATTR> {
        int minGallop;
        ...
        public void sort(WritableIntChunk<PERMUTE_VALUES_ATTR> valuesToPermute,
            ...
            LongIntTimsortKernel.this.timSort(this, valuesToPermute, valuesToSort.asWritableLongChunk(), offset, length);
        }
        ...
        public void merge(WritableIntChunk<PERMUTE_VALUES_ATTR> valuesToPermute,
                ...
                int length2) {
            LongIntTimsortKernel.this.merge(this, valuesToPermute, valuesToSort.asWritableLongChunk(), start1, length1, length2);
        }
