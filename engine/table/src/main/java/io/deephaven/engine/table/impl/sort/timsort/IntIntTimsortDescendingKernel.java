...
public class IntIntTimsortDescendingKernel {
    ...
    public static class IntIntSortKernelContext<ATTR extends Any, KEY_INDICES extends Indices> implements IntSortKernel<ATTR, KEY_INDICES> {
        ...
        public void sort(WritableIntChunk<KEY_INDICES> indexKeys, WritableChunk<ATTR> valuesToSort) {
            IntIntTimsortDescendingKernel.sort(this, indexKeys, valuesToSort.asWritableIntChunk());
        }
        ...
        public void sort(WritableIntChunk<KEY_INDICES> indexKeys, WritableChunk<ATTR> valuesToSort, IntChunk<? extends ChunkPositions> offsetsIn, IntChunk<? extends ChunkLengths> lengthsIn) {
            IntIntTimsortDescendingKernel.sort(this, indexKeys, valuesToSort.asWritableIntChunk(), offsetsIn, lengthsIn);
        }
