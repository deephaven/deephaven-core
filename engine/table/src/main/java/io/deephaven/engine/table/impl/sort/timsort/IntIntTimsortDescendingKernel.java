...
public final class IntIntTimsortDescendingKernel {
    ...
    public class IntIntSortKernelContext<SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> implements IntSortKernel<SORT_VALUES_ATTR, PERMUTE_VALUES_ATTR> {
        ...
        public void sort(WritableIntChunk<PERMUTE_VALUES_ATTR> valuesToPermute,
                ...
                IntChunk<? extends ChunkPositions> offsetsIn,
                IntChunk<? extends ChunkLengths> lengthsIn) {
            IntIntTimsortDescendingKernel.this.sort(this, valuesToPermute, valuesToSort.asWritableIntChunk(), offsetsIn, lengthsIn);
        }

        @Override
        public void sort(WritableIntChunk<PERMUTE_VALUES_ATTR> valuesToPermute,
                WritableChunk<SORT_VALUES_ATTR> valuesToSort, int offset, int length) {
            IntIntTimsortDescendingKernel.this.timSort(this, valuesToPermute, valuesToSort.asWritableIntChunk(), offset, length);
        }
        ...
        public void merge(WritableIntChunk<PERMUTE_VALUES_ATTR> valuesToPermute,
                ...
                int length2) {
            IntIntTimsortDescendingKernel.this.merge(this, valuesToPermute, valuesToSort.asWritableIntChunk(), start1, length1, length2);
        }
