...
final class IncrementalAggOpenHasherLongObject extends IncrementalChunkedOperatorAggregationStateManagerOpenAddressedBase {
    ...
    public IncrementalAggOpenHasherLongObject(ColumnSource[] tableKeySources,
