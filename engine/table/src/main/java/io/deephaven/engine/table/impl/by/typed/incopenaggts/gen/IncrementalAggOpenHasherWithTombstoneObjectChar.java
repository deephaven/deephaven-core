...
final class IncrementalAggOpenHasherWithTombstoneObjectChar extends IncrementalChunkedOperatorAggregationStateManagerOpenAddressedBaseWithTombstones {
    ...
    public IncrementalAggOpenHasherWithTombstoneObjectChar(ColumnSource[] tableKeySources,
