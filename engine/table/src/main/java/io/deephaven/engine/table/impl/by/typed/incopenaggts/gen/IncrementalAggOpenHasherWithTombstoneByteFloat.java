...
final class IncrementalAggOpenHasherWithTombstoneByteFloat extends IncrementalChunkedOperatorAggregationStateManagerOpenAddressedBaseWithTombstones {
    ...
    public IncrementalAggOpenHasherWithTombstoneByteFloat(ColumnSource[] tableKeySources,
