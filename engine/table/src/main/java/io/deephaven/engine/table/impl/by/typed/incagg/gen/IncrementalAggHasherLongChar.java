...
final class IncrementalAggHasherLongChar extends IncrementalChunkedOperatorAggregationStateManagerTypedBase {
    ...
    public IncrementalAggHasherLongChar(ColumnSource[] tableKeySources,
    ...
    private boolean findOverflow(HashHandler handler, long k0, char k1, int chunkPosition,
