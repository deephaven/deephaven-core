...
final class TypedHasherCharObject extends IncrementalChunkedOperatorAggregationStateManagerTypedBase {
  ...
  public TypedHasherCharObject(ColumnSource[] tableKeySources, int tableSize,
  ...
  private int hash(char v0, Object v1) {
  ...
  private boolean findOverflow(HashHandler handler, char v0, Object v1, int chunkPosition,
