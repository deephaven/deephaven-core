 ...
 */
public final class SlicedLongAggregateColumnSource extends BaseAggregateSlicedColumnSource<LongVector, Long> {
    public SlicedLongAggregateColumnSource(
            @NotNull final ColumnSource<Long> aggregatedSource,
            @NotNull final ColumnSource<? extends RowSet> groupRowSetSource,
            @NotNull final ColumnSource<Long> startSource,
            @NotNull final ColumnSource<Long> endSource) {
        super(LongVector.class, aggregatedSource, groupRowSetSource, startSource, endSource);
    }
    ...
    public SlicedLongAggregateColumnSource(
            ...
            final long revTicks,
            final long fwdTicks) {
        super(LongVector.class, aggregatedSource, groupRowSetSource, revTicks, fwdTicks);
    }
    ...
    public LongVector get(final long rowKey) {
        ...
        return rowSetSlice.isEmpty() ? null : new LongVectorColumnWrapper(aggregatedSource, rowSetSlice);
    }
    ...
    public LongVector getPrev(final long rowKey) {
        ...
        // Determine the slice of the groupRowSetSource from start to end.
        final RowSet rowSetSlice = bucketRowSet.subSetByPositionRange(start, end);
        return rowSetSlice.isEmpty() ? null : new PrevLongVectorColumnWrapper(aggregatedSource, rowSetSlice);
    }
    ...
    public void fillChunk(@NotNull final FillContext context, @NotNull final WritableChunk<? super Values> destination,
        ...
        for (int di = 0; di < size; ++di) {
            ...
            if (startPos == NULL_LONG || endPos == NULL_LONG) {
                ...
                // Determine the slice of the groupRowSetSource from start to end.
                final RowSet rowSetSlice = bucketRowSet.subSetByPositionRange(start, end);
                typedDestination.set(di, rowSetSlice.isEmpty() ? null : new LongVectorColumnWrapper(aggregatedSource, rowSetSlice));
            }
        }
    ...
    public void fillPrevChunk(@NotNull final FillContext context,
        ...
        for (int di = 0; di < size; ++di) {
            ...
            if (startPos == NULL_LONG || endPos == NULL_LONG) {
                ...
                typedDestination.set(di, rowSetSlice.isEmpty() ? null : new PrevLongVectorColumnWrapper(aggregatedSource, rowSetSlice));
            }
        }
        typedDestination.setSize(size);
    }
