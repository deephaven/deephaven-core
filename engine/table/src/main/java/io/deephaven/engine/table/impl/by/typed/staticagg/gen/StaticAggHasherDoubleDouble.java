...
final class StaticAggHasherDoubleDouble extends StaticChunkedOperatorAggregationStateManagerTypedBase {
    ...
    public StaticAggHasherDoubleDouble(ColumnSource[] tableKeySources,
