...
final class IncrementalAggHasherInt extends IncrementalChunkedOperatorAggregationStateManagerTypedBase {
    private final IntegerArraySource mainKeySource0;

    private final IntegerArraySource overflowKeySource0;

    public IncrementalAggHasherInt(ColumnSource[] tableKeySources,
    ...
    private boolean findOverflow(HashHandler handler, int k0, int chunkPosition,
