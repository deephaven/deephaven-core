...
enum RangeSearchKernelFloat implements RangeSearchKernel {
    ...
    LT_GT {
        @Override
        void populateAllRangeForEmptyRight(@NotNull final FloatChunk<? extends Values> lsv,
                @NotNull final FloatChunk<? extends Values> lev, @NotNull final WritableIntChunk<? extends Values> o) {
            populateAllRangesForEmptyRightDisallowEqual(lsv, lev, o);
        }

        @Override
        void populateInvalidRanges(@NotNull final FloatChunk<? extends Values> lsv,
                @NotNull final FloatChunk<? extends Values> lev, @NotNull final WritableBooleanChunk<? super Values> v,
                @NotNull final WritableIntChunk<? extends Values> o) {
            populateInvalidRangesDisallowEqual(lsv, lev, v, o);
        }

        @Override
        void findStarts(@NotNull final FloatChunk<? extends Values> lv, @NotNull final IntChunk<ChunkPositions> lp,
                @NotNull final FloatChunk<? extends Values> rv, @NotNull final IntChunk<ChunkPositions> rso,
        ...
        @Override
        void findEnds(@NotNull final FloatChunk<? extends Values> lv, @NotNull final IntChunk<ChunkPositions> lp,
                @NotNull final FloatChunk<? extends Values> rv, @NotNull final IntChunk<ChunkPositions> rso,
                @NotNull final IntChunk<ChunkLengths> rl, @NotNull final WritableIntChunk<? extends Values> o) {
    ...
    public final void populateAllRangeForEmptyRight(
        ...
        populateAllRangeForEmptyRight(leftStartValues.asFloatChunk(), leftEndValues.asFloatChunk(), output);
    }
    ...
    public final void populateInvalidRanges(
            ...
            @NotNull final WritableIntChunk<? extends Values> output) {
        populateInvalidRanges(leftStartValues.asFloatChunk(), leftEndValues.asFloatChunk(), validity, output);
    }
    ...
    public final void findStarts(
            ...
            @NotNull final WritableIntChunk<? extends Values> output) {
        findStarts(leftValues.asFloatChunk(), leftPositions,
                rightValues.asFloatChunk(), rightStartOffsets, rightLengths,
                output);
    }
    ...
    public final void findEnds(
            ...
            @NotNull final IntChunk<ChunkLengths> rightLengths,
            @NotNull final WritableIntChunk<? extends Values> output) {
        findEnds(leftValues.asFloatChunk(), leftPositions,
                rightValues.asFloatChunk(), rightStartOffsets, rightLengths,
                output);
    }
