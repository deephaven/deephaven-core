 ...
 */
public class DoubleChunkedCountDistinctOperator implements IterativeChunkedAggregationOperator {
    ...
    private UpdateCommitter<DoubleChunkedCountDistinctOperator> prevFlusher = null;

    private final DoubleSsmBackedSource ssms;
    private final LongArraySource resultColumn;

    public DoubleChunkedCountDistinctOperator(// region Constructor
    ...
    public void startTrackingPrevValues() {
        ...
        if(exposeInternal) {
            ...
            prevFlusher = new UpdateCommitter<>(this, ExecutionContext.getContext().getUpdateGraph(), DoubleChunkedCountDistinctOperator::flushPrevious);
