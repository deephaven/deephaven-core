...
final class TypedHasherDoubleObject extends IncrementalChunkedOperatorAggregationStateManagerTypedBase {
  ...
  public TypedHasherDoubleObject(ColumnSource[] tableKeySources, int tableSize,
  ...
  private int hash(double v0, Object v1) {
  ...
  private boolean findOverflow(HashHandler handler, double v0, Object v1, int chunkPosition,
