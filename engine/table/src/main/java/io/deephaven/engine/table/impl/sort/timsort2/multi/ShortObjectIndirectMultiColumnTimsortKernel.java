...
/**
 * This implements a timsort kernel for a multi-column key (Short, Object) that never moves the column values:
 ...
 */
public final class ShortObjectIndirectMultiColumnTimsortKernel {
    private ShortObjectIndirectMultiColumnTimsortKernel() {
        throw new UnsupportedOperationException();
    }

    public static <PERMUTE_VALUES_ATTR extends Any> ShortObjectIndirectMultiColumnSortKernelContext<PERMUTE_VALUES_ATTR> createContext(
            final int size) {
        return new ShortObjectIndirectMultiColumnSortKernelContext<>(size);
    }
     ...
     */
    public static void sort(ShortObjectIndirectMultiColumnSortKernelContext<?> context,
    ...
    private static void timSort(ShortObjectIndirectMultiColumnSortKernelContext<?> context,
            WritableIntChunk<ChunkPositions> positions, ShortChunk<?> valuesToSort0,
     ...
     */
    private static int compareColumns(ShortChunk<?> valuesToSort0,
    ...
    private static void ensureMergeInvariants(
            ShortObjectIndirectMultiColumnSortKernelContext<?> context,
            WritableIntChunk<ChunkPositions> positions, ShortChunk<?> valuesToSort0,
            ObjectChunk<Object, ?> valuesToSort1) {
        while (context.runCount > 1) {
    ...
    private static void merge(ShortObjectIndirectMultiColumnSortKernelContext<?> context,
            WritableIntChunk<ChunkPositions> positions, ShortChunk<?> valuesToSort0,
     ...
     */
    private static void frontMerge(ShortObjectIndirectMultiColumnSortKernelContext<?> context,
            WritableIntChunk<ChunkPositions> positions, ShortChunk<?> valuesToSort0,
     ...
     * We eventually need to do galloping here, but are skipping that for now
     */
    private static void backMerge(ShortObjectIndirectMultiColumnSortKernelContext<?> context,
            WritableIntChunk<ChunkPositions> positions, ShortChunk<?> valuesToSort0,
    ...
    private static void copyToTemporary(ShortObjectIndirectMultiColumnSortKernelContext<?> context,
    ...
    private static void insertionSort(WritableIntChunk<ChunkPositions> positions,
            ShortChunk<?> valuesToSort0, ObjectChunk<Object, ?> valuesToSort1, int offset,
            int length) {
    ...
    public static class ShortObjectIndirectMultiColumnSortKernelContext<PERMUTE_VALUES_ATTR extends Any> implements MultiColumnSortKernel<PERMUTE_VALUES_ATTR> {
        int minGallop;
        ...
        private ShortObjectIndirectMultiColumnSortKernelContext(int size) {
        ...
        public void sort(WritableLongChunk<PERMUTE_VALUES_ATTR> valuesToPermute,
            ...
            ShortObjectIndirectMultiColumnTimsortKernel.sort(this, positions, valuesToSort[0].asShortChunk(), valuesToSort[1].<Object>asObjectChunk());
