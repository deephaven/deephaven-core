...
final class IncrementalAggHasherByteDouble extends IncrementalChunkedOperatorAggregationStateManagerTypedBase {
    ...
    public IncrementalAggHasherByteDouble(ColumnSource[] tableKeySources,
