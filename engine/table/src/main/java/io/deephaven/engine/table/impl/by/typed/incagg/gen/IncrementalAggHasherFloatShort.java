...
final class IncrementalAggHasherFloatShort extends IncrementalChunkedOperatorAggregationStateManagerTypedBase {
    ...
    public IncrementalAggHasherFloatShort(ColumnSource[] tableKeySources,
    ...
    private boolean findOverflow(HashHandler handler, float k0, short k1, int chunkPosition,
