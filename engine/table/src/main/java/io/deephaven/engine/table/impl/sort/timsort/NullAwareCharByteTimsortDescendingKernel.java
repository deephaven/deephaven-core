...
// ****** Edit NullAwareCharByteTimsortDescendingKernel and run "./gradlew replicateSortKernel" to regenerate
//
// @formatter:off
 ...
 */
public final class NullAwareCharByteTimsortDescendingKernel {
    // region constructor
    ...
    // region Context
    public class CharByteSortKernelContext<SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any>
        ...
        public void sort(
            ...
            NullAwareCharByteTimsortDescendingKernel.this.sort(this, valuesToPermute, valuesToSort.asWritableCharChunk());
        }
        ...
        public void sort(
            ...
            NullAwareCharByteTimsortDescendingKernel.this.sort(this, valuesToPermute, valuesToSort.asWritableCharChunk(), offsetsIn, lengthsIn);
        }
        ...
        private NullAwareCharByteTimsortDescendingKernel kernel() {
            return NullAwareCharByteTimsortDescendingKernel.this;
        }
    }
    // endregion Context

    // region createContextInstance
    public <SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> CharByteSortKernelContext<SORT_VALUES_ATTR, PERMUTE_VALUES_ATTR> createContextInstance(int size) {
    ...
    public static <SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> CharByteSortKernelContext<SORT_VALUES_ATTR, PERMUTE_VALUES_ATTR> createContext(final int size) {
        return new NullAwareCharByteTimsortDescendingKernel().createContextInstance(size);
    }
    ...
    static private void swap(WritableByteChunk<?> valuesToPermute, WritableCharChunk<?> valuesToSort, int a, int b) {
    ...
    // private static void doCheck(Chunk.ByteChunk valuesToPermute, Chunk.CharChunk valuesToSort, int startCheck, int
    // mergeEnd) {
    // char lastCheck;
