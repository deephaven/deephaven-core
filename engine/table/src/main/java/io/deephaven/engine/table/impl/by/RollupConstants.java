...
public final class RollupConstants {
    ...
    /**
     * Middle column name component (between source column name and {@link #ROLLUP_COLUMN_SUFFIX suffix}) for SSM
    ...
    /**
     * Middle column name component (between source column name and {@link #ROLLUP_COLUMN_SUFFIX suffix}) for non-null
     * count columns used in rollup aggregations.
     */
    static final String ROLLUP_NONNULL_COUNT_COLUMN_ID = "_NNC_";

    /**
     * Middle column name component (between source column name and {@link #ROLLUP_COLUMN_SUFFIX suffix}) for NaN count
     * columns used in rollup aggregations.
     */
    static final String ROLLUP_NAN_COUNT_COLUMN_ID = "_NaNC_";

    /**
     * Middle column name component (between source column name and {@link #ROLLUP_COLUMN_SUFFIX suffix}) for positive
     * infinity count columns used in rollup aggregations.
     */
    static final String ROLLUP_PI_COUNT_COLUMN_ID = "_PIC_";

    /**
     * Middle column name component (between source column name and {@link #ROLLUP_COLUMN_SUFFIX suffix}) for negative
     * infinity count columns used in rollup aggregations.
     */
