...
/**
 * This implements a timsort kernel for a multi-column key (NullAwareChar, Object) that never moves the column values:
 ...
 */
public final class NullAwareCharObjectIndirectMultiColumnTimsortKernel {
    private NullAwareCharObjectIndirectMultiColumnTimsortKernel() {
        throw new UnsupportedOperationException();
    }

    public static <PERMUTE_VALUES_ATTR extends Any> NullAwareCharObjectIndirectMultiColumnSortKernelContext<PERMUTE_VALUES_ATTR> createContext(
            final int size) {
        return new NullAwareCharObjectIndirectMultiColumnSortKernelContext<>(size);
    }
     ...
     */
    public static void sort(NullAwareCharObjectIndirectMultiColumnSortKernelContext<?> context,
    ...
    private static void timSort(NullAwareCharObjectIndirectMultiColumnSortKernelContext<?> context,
            WritableIntChunk<ChunkPositions> positions, CharChunk<?> valuesToSort0,
     ...
     */
    private static int compareColumns(CharChunk<?> valuesToSort0,
    ...
    private static void ensureMergeInvariants(
            NullAwareCharObjectIndirectMultiColumnSortKernelContext<?> context,
            WritableIntChunk<ChunkPositions> positions, CharChunk<?> valuesToSort0,
            ObjectChunk<Object, ?> valuesToSort1) {
        while (context.runCount > 1) {
    ...
    private static void merge(NullAwareCharObjectIndirectMultiColumnSortKernelContext<?> context,
            WritableIntChunk<ChunkPositions> positions, CharChunk<?> valuesToSort0,
    ...
    private static void insertionSort(WritableIntChunk<ChunkPositions> positions,
            CharChunk<?> valuesToSort0, ObjectChunk<Object, ?> valuesToSort1, int offset,
            int length) {
    ...
    public static class NullAwareCharObjectIndirectMultiColumnSortKernelContext<PERMUTE_VALUES_ATTR extends Any> implements MultiColumnSortKernel<PERMUTE_VALUES_ATTR> {
        int minGallop;
        ...
        private NullAwareCharObjectIndirectMultiColumnSortKernelContext(int size) {
        ...
        public void sort(WritableLongChunk<PERMUTE_VALUES_ATTR> valuesToPermute,
            ...
            NullAwareCharObjectIndirectMultiColumnTimsortKernel.sort(this, positions, valuesToSort[0].asCharChunk(), valuesToSort[1].<Object>asObjectChunk());
