...
final class TypedHasherDoubleDouble extends IncrementalChunkedOperatorAggregationStateManagerTypedBase {
  ...
  public TypedHasherDoubleDouble(ColumnSource[] tableKeySources, int tableSize,
  ...
  private int hash(double v0, double v1) {
  ...
  private boolean findOverflow(HashHandler handler, double v0, double v1, int chunkPosition,
