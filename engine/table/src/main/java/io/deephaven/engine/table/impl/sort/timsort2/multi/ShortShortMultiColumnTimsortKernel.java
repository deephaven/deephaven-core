...
/**
 * This implements a timsort kernel that sorts a multi-column key (Short, Short), comparing each
 ...
 */
public final class ShortShortMultiColumnTimsortKernel {
    private ShortShortMultiColumnTimsortKernel() {
        throw new UnsupportedOperationException();
    }

    public static <SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> ShortShortMultiColumnSortKernelContext<SORT_VALUES_ATTR, PERMUTE_VALUES_ATTR> createContext(
            final int size) {
        return new ShortShortMultiColumnSortKernelContext<>(size);
    }
    ...
    static <SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> void sort(
            ShortShortMultiColumnSortKernelContext<SORT_VALUES_ATTR, PERMUTE_VALUES_ATTR> context,
    ...
    private static int upperBound(ShortChunk<?> valuesToSort0, ShortChunk<?> valuesToSort1, int lo,
            int hi, short searchValue0, short searchValue1) {
    ...
    private static int lowerBound(ShortChunk<?> valuesToSort0, ShortChunk<?> valuesToSort1, int lo,
            int hi, short searchValue0, short searchValue1) {
    ...
    private static int bound(ShortChunk<?> valuesToSort0, ShortChunk<?> valuesToSort1, int lo,
            int hi, short searchValue0, short searchValue1, final boolean lower) {
    ...
    private static void insertionSort(WritableLongChunk<?> valuesToPermute,
            WritableShortChunk<?> valuesToSort0, WritableShortChunk<?> valuesToSort1, int offset,
            int length) {
    ...
    private static void swap(WritableLongChunk<?> valuesToPermute,
            WritableShortChunk<?> valuesToSort0, WritableShortChunk<?> valuesToSort1, int a,
            int b) {
    ...
    public static class ShortShortMultiColumnSortKernelContext<SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> implements MultiColumnSortKernel<PERMUTE_VALUES_ATTR> {
        int minGallop;
        ...
        private ShortShortMultiColumnSortKernelContext(int size) {
        ...
        public void sort(WritableLongChunk<PERMUTE_VALUES_ATTR> valuesToPermute,
            ...
            ShortShortMultiColumnTimsortKernel.sort(this, valuesToPermute,
