...
final class StaticAggHasherShortInt extends StaticChunkedOperatorAggregationStateManagerTypedBase {
    ...
    public StaticAggHasherShortInt(ColumnSource[] tableKeySources,
