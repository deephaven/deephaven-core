...
final class StaticAggHasherCharObject extends StaticChunkedOperatorAggregationStateManagerTypedBase {
    ...
    public StaticAggHasherCharObject(ColumnSource[] tableKeySources,
