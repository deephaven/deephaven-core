...
/**
 * {@link RangeSearchKernel} for values of type double.
 */
enum RangeSearchKernelDouble implements RangeSearchKernel {

    LT_GT {
        @Override
        void populateAllRangeForEmptyRight(@NotNull final DoubleChunk<? extends Values> lsv,
                @NotNull final DoubleChunk<? extends Values> lev, @NotNull final WritableIntChunk<? extends Values> o) {
            populateAllRangesForEmptyRightDisallowEqual(lsv, lev, o);
        }

        @Override
        void populateInvalidRanges(@NotNull final DoubleChunk<? extends Values> lsv,
                @NotNull final DoubleChunk<? extends Values> lev, @NotNull final WritableBooleanChunk<? super Values> v,
                @NotNull final WritableIntChunk<? extends Values> o) {
            populateInvalidRangesDisallowEqual(lsv, lev, v, o);
        }

        @Override
        void findStarts(@NotNull final DoubleChunk<? extends Values> lv, @NotNull final IntChunk<ChunkPositions> lp,
                @NotNull final DoubleChunk<? extends Values> rv, @NotNull final IntChunk<ChunkPositions> rso,
        ...
        @Override
        void findEnds(@NotNull final DoubleChunk<? extends Values> lv, @NotNull final IntChunk<ChunkPositions> lp,
                @NotNull final DoubleChunk<? extends Values> rv, @NotNull final IntChunk<ChunkPositions> rso,
                @NotNull final IntChunk<ChunkLengths> rl, @NotNull final WritableIntChunk<? extends Values> o) {
    ...
    static RangeSearchKernelDouble forRules(
    ...
    public final void populateAllRangeForEmptyRight(
        ...
        populateAllRangeForEmptyRight(leftStartValues.asDoubleChunk(), leftEndValues.asDoubleChunk(), output);
    }

    abstract void populateAllRangeForEmptyRight(
            @NotNull final DoubleChunk<? extends Values> leftStartValues,
            @NotNull final DoubleChunk<? extends Values> leftEndValues,
            @NotNull final WritableIntChunk<? extends Values> output);
    ...
    public final void populateInvalidRanges(
            ...
            @NotNull final WritableIntChunk<? extends Values> output) {
        populateInvalidRanges(leftStartValues.asDoubleChunk(), leftEndValues.asDoubleChunk(), validity, output);
    }
    ...
    public final void findStarts(
            ...
            @NotNull final WritableIntChunk<? extends Values> output) {
        findStarts(leftValues.asDoubleChunk(), leftPositions,
                rightValues.asDoubleChunk(), rightStartOffsets, rightLengths,
                output);
    }

    abstract void findStarts(
            @NotNull final DoubleChunk<? extends Values> leftValues,
            @NotNull final IntChunk<ChunkPositions> leftPositions,
            @NotNull final DoubleChunk<? extends Values> rightValues,
            @NotNull final IntChunk<ChunkPositions> rightStartOffsets,
            @NotNull final IntChunk<ChunkLengths> rightLengths,
            @NotNull final WritableIntChunk<? extends Values> output);
    ...
    public final void findEnds(
            ...
            @NotNull final IntChunk<ChunkLengths> rightLengths,
            @NotNull final WritableIntChunk<? extends Values> output) {
        findEnds(leftValues.asDoubleChunk(), leftPositions,
                rightValues.asDoubleChunk(), rightStartOffsets, rightLengths,
                output);
    }
    ...
    private static void populateInvalidRangesAllowEqual(
            @NotNull DoubleChunk<? extends Values> leftStartValues,
            @NotNull DoubleChunk<? extends Values> leftEndValues,
    ...
    private static boolean isValidPairAllowEqual(final double start, final double end) {
        return !isNaN(start) && !isNaN(end) && (isNull(start) || isNull(end) || leq(start, end));
    }

    private static boolean isValidPairDisallowEqual(final double start, final double end) {
    ...
    private static void findStartsLessThan(
        ...
        double leftValue = leftValues.get(leftIndex);
        do {
            ...
            final double rightValue = rightValues.get(rightIndex);
    ...
    // region lt
    private static boolean lt(final double a, final double b) {
    ...
    // region leq
    private static boolean leq(final double a, final double b) {
        // We need not deal with null or NaN values here
        return a <= b;
    }
    // endregion leq
