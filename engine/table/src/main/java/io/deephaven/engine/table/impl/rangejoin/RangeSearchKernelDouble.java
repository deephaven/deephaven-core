...
enum RangeSearchKernelDouble implements RangeSearchKernel {
    ...
    LT_GT {
        ...
        void processAllRangesForEmptyRight(
                @NotNull final DoubleChunk<? extends Values> lsv,
                @NotNull final DoubleChunk<? extends Values> lev,
        ...
        void processRangeStarts(
                @NotNull final DoubleChunk<? extends Values> lv,
                @NotNull final IntChunk<ChunkPositions> lp,
                @NotNull final DoubleChunk<? extends Values> rv,
    ...
    public final void processAllRangesForEmptyRight(
        ...
        processAllRangesForEmptyRight(
                leftStartValues.asDoubleChunk(),
                leftEndValues.asDoubleChunk(),
    ...
    public final void processRangeStarts(
            ...
            @NotNull final WritableIntChunk<? extends Values> outputStartPositionsInclusive) {
        processRangeStarts(
                leftValues.asDoubleChunk(),
                leftPositions,
                rightValues.asDoubleChunk(),
                rightStartOffsets,
                rightSizeExpanded,
                outputStartPositionsInclusive);
    }
    ...
    abstract void processRangeStarts(
            @NotNull DoubleChunk<? extends Values> leftValues,
            @NotNull IntChunk<ChunkPositions> leftPositions,
            @NotNull DoubleChunk<? extends Values> rightValues,
