...
final class StaticAggHasherObjectFloat extends StaticChunkedOperatorAggregationStateManagerTypedBase {
    ...
    public StaticAggHasherObjectFloat(ColumnSource[] tableKeySources,
