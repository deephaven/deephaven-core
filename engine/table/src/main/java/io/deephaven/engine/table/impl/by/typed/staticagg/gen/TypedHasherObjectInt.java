...
final class TypedHasherObjectInt extends StaticChunkedOperatorAggregationStateManagerTypedBase {
  ...
  public TypedHasherObjectInt(ColumnSource[] tableKeySources, int tableSize,
  ...
  private int hash(Object v0, int v1) {
  ...
  private boolean findOverflow(HashHandler handler, Object v0, int v1, int chunkPosition,
