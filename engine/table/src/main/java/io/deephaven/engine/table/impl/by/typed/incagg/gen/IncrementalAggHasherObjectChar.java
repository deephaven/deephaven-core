...
final class IncrementalAggHasherObjectChar extends IncrementalChunkedOperatorAggregationStateManagerTypedBase {
    ...
    public IncrementalAggHasherObjectChar(ColumnSource[] tableKeySources,
    ...
    private boolean findOverflow(HashHandler handler, Object k0, char k1, int chunkPosition,
