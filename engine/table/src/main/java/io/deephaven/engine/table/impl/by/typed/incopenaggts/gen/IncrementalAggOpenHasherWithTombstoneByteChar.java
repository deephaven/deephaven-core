...
final class IncrementalAggOpenHasherWithTombstoneByteChar extends IncrementalChunkedOperatorAggregationStateManagerOpenAddressedBaseWithTombstones {
    ...
    public IncrementalAggOpenHasherWithTombstoneByteChar(ColumnSource[] tableKeySources,
