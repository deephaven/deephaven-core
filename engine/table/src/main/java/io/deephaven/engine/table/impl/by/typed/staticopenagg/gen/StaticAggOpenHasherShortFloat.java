...
final class StaticAggOpenHasherShortFloat extends StaticChunkedOperatorAggregationStateManagerOpenAddressedBase {
    private final ImmutableShortArraySource mainKeySource0;

    private final ImmutableFloatArraySource mainKeySource1;

    public StaticAggOpenHasherShortFloat(ColumnSource[] tableKeySources,
