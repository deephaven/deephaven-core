...
// ****** Edit CharByteTimsortKernel and run "./gradlew replicateSortKernel" to regenerate
//
// @formatter:off
 ...
 */
public final class NullAwareCharByteTimsortKernel {
    // region constructor
    ...
    public class CharByteSortKernelContext<SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any>
        ...
        public void sort(
            ...
            NullAwareCharByteTimsortKernel.this.sort(this, valuesToPermute, valuesToSort.asWritableCharChunk());
        }
        ...
        public void sort(
            ...
            NullAwareCharByteTimsortKernel.this.sort(this, valuesToPermute, valuesToSort.asWritableCharChunk(), offsetsIn, lengthsIn);
        }
        ...
        private NullAwareCharByteTimsortKernel kernel() {
            return NullAwareCharByteTimsortKernel.this;
        }
    }
    // endregion Context
    ...
    public static <SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> CharByteSortKernelContext<SORT_VALUES_ATTR, PERMUTE_VALUES_ATTR> createContext(final int size) {
        return new NullAwareCharByteTimsortKernel().createContextInstance(size);
    }
