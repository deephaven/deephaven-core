...
/*
 * ---------------------------------------------------------------------------------------------------------------------
 * AUTO-GENERATED CLASS - DO NOT EDIT MANUALLY - for any changes edit IntLongTimsortKernel and regenerate
 * ---------------------------------------------------------------------------------------------------------------------
 */
 ...
 * the algorithm.
 */
public class IntIntTimsortKernel {
    private IntIntTimsortKernel() {
        throw new UnsupportedOperationException();
    }

    // region Context
    public static class IntIntSortKernelContext<ATTR extends Any, KEY_INDICES extends Indices> implements IntSortKernel<ATTR, KEY_INDICES> {
        int minGallop;
        int runCount = 0;
        ...
        private IntIntSortKernelContext(int size) {
        ...
        public void sort(WritableIntChunk<KEY_INDICES> indexKeys, WritableChunk<ATTR> valuesToSort) {
            IntIntTimsortKernel.sort(this, indexKeys, valuesToSort.asWritableIntChunk());
        }
        ...
        public void sort(WritableIntChunk<KEY_INDICES> indexKeys, WritableChunk<ATTR> valuesToSort, IntChunk<? extends ChunkPositions> offsetsIn, IntChunk<? extends ChunkLengths> lengthsIn) {
            IntIntTimsortKernel.sort(this, indexKeys, valuesToSort.asWritableIntChunk(), offsetsIn, lengthsIn);
        }
    ...
    public static <ATTR extends Any, KEY_INDICES extends Indices> IntIntSortKernelContext<ATTR, KEY_INDICES> createContext(int size) {
     ...
     */
    static <ATTR extends Any, KEY_INDICES extends Indices> void sort(IntIntSortKernelContext<ATTR, KEY_INDICES> context, WritableIntChunk<KEY_INDICES> indexKeys, WritableIntChunk<ATTR> valuesToSort, IntChunk<? extends ChunkPositions> offsetsIn, IntChunk<? extends ChunkLengths> lengthsIn) {
     ...
     * runs sorted on each pass.
     */
    public static <ATTR extends Any, KEY_INDICES extends Indices> void sort(IntIntSortKernelContext<ATTR, KEY_INDICES> context, WritableIntChunk<KEY_INDICES> indexKeys, WritableIntChunk<ATTR> valuesToSort) {
        timSort(context, indexKeys, valuesToSort, 0, indexKeys.size());
    }

    static private <ATTR extends Any, KEY_INDICES extends Indices> void timSort(IntIntSortKernelContext<ATTR, KEY_INDICES> context, WritableIntChunk<KEY_INDICES> indexKeys, WritableIntChunk<ATTR> valuesToSort, int offset, int length) {
        if (length <= 1) {
            return;
        }
     ...
     */
    private static <ATTR extends Any, KEY_INDICES extends Indices> void ensureMergeInvariants(IntIntSortKernelContext<ATTR, KEY_INDICES> context, WritableIntChunk<KEY_INDICES> indexKeys, WritableIntChunk<ATTR> valuesToSort) {
        while (context.runCount > 1) {
    ...
    private static <ATTR extends Any, KEY_INDICES extends Indices> void merge(IntIntSortKernelContext<ATTR, KEY_INDICES> context, WritableIntChunk<KEY_INDICES> indexKeys, WritableIntChunk<ATTR> valuesToSort, int start1, int length1, int length2) {
     ...
     */
    private static <ATTR extends Any, KEY_INDICES extends Indices> void frontMerge(IntIntSortKernelContext<ATTR, KEY_INDICES> context, WritableIntChunk<KEY_INDICES> indexKeys, WritableIntChunk<ATTR> valuesToSort, final int mergeStartPosition, final int start2, final int length2) {
        int tempCursor = 0;
     ...
     * We eventually need to do galloping here, but are skipping that for now
     */
    private static <ATTR extends Any, KEY_INDICES extends Indices> void backMerge(IntIntSortKernelContext<ATTR, KEY_INDICES> context, WritableIntChunk<KEY_INDICES> indexKeys, WritableIntChunk<ATTR> valuesToSort, final int mergeStartPosition, final int length1) {
    ...
    private static <ATTR extends Any, KEY_INDICES extends Indices> void copyToTemporary(IntIntSortKernelContext<ATTR, KEY_INDICES> context, WritableIntChunk<KEY_INDICES> indexKeys, WritableIntChunk<ATTR> valuesToSort, int mergeStartPosition, int remaining1) {
    ...
    private static <ATTR extends Any, KEY_INDICES extends Indices> void copyToChunk(IntChunk<KEY_INDICES> rowSetSource, IntChunk<ATTR> valuesSource, WritableIntChunk<KEY_INDICES> indexDest, WritableIntChunk<ATTR> valuesDest, int sourceStart, int destStart, int length) {
    ...
    private static void insertionSort(WritableIntChunk<? extends Indices> indexKeys, WritableIntChunk<?> valuesToSort, int offset, int length) {
    ...
    static private void swap(WritableIntChunk<? extends Indices> indexKeys, WritableIntChunk<?> valuesToSort, int a, int b) {
...
//    private static void doCheck(Chunk.IntChunk indexKeys, Chunk.IntChunk valuesToSort, int startCheck, int mergeEnd) {
//        int lastCheck;
