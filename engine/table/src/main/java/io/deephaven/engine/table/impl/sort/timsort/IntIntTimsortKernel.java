 ...
 */
public final class IntIntTimsortKernel {
    ...
    public static <SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> IntIntSortKernelContext<SORT_VALUES_ATTR, PERMUTE_VALUES_ATTR> createContext(
            final int size) {
        return new IntIntTimsortKernel().createContextInstance(size);
    }
    ...
    private static <SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> void copyToChunk(
            IntChunk<PERMUTE_VALUES_ATTR> rowSetSource, IntChunk<SORT_VALUES_ATTR> valuesSource,
    ...
    private static void swap(WritableIntChunk<?> valuesToPermute, WritableIntChunk<?> valuesToSort,
            int a, int b) {
    ...
    public class IntIntSortKernelContext<SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> implements IntSortKernel<SORT_VALUES_ATTR, PERMUTE_VALUES_ATTR> {
        int minGallop;
        ...
        public void sort(WritableIntChunk<PERMUTE_VALUES_ATTR> valuesToPermute,
            ...
            IntIntTimsortKernel.this.sort(this, valuesToPermute, valuesToSort.asWritableIntChunk());
        }
        ...
        public void sort(WritableIntChunk<PERMUTE_VALUES_ATTR> valuesToPermute,
                ...
                IntChunk<? extends ChunkPositions> offsetsIn,
                IntChunk<? extends ChunkLengths> lengthsIn) {
            IntIntTimsortKernel.this.sort(this, valuesToPermute, valuesToSort.asWritableIntChunk(), offsetsIn, lengthsIn);
        }

        @Override
        public void sort(WritableIntChunk<PERMUTE_VALUES_ATTR> valuesToPermute,
                WritableChunk<SORT_VALUES_ATTR> valuesToSort, int offset, int length) {
            IntIntTimsortKernel.this.timSort(this, valuesToPermute, valuesToSort.asWritableIntChunk(), offset, length);
        }
        ...
        public void merge(WritableIntChunk<PERMUTE_VALUES_ATTR> valuesToPermute,
                ...
                int length2) {
            IntIntTimsortKernel.this.merge(this, valuesToPermute, valuesToSort.asWritableIntChunk(), start1, length1, length2);
        }
        ...
        private IntIntTimsortKernel kernel() {
            return IntIntTimsortKernel.this;
        }
    }
}
