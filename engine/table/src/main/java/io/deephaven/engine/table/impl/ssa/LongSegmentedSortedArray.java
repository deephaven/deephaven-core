...
public final class LongSegmentedSortedArray implements SegmentedSortedArray {
     ...
     */
    private <T extends Any> int findNext(LongChunk<T> stampValues, LongChunk<? extends RowKeys> stampRowKeys, WritableLongChunk<T> nextValues) {
    ...
    private static <T extends Any> int findNextOneLeaf(int offset, LongChunk<T> stampValues, LongChunk<? extends RowKeys> stampRowKeys, WritableLongChunk<T> nextValues, int leafSize, long [] leafValues, long [] leafKeys) {
        int lo = 0;
    ...
    private void copyToLeaf(int leafOffset, long[] leafValues, LongChunk<? extends Any> insertValues, long[] leafRowKeys, LongChunk<? extends RowKeys> insertRowKeys, int srcOffset, int length) {
    ...
    private void distributeValues(int targetSize, int startingLeaf, int distributionSlots, LongChunk<? extends Any> valuesToInsert, LongChunk<? extends RowKeys> rowKeys) {
    ...
    private void insertIntoLeaf(int leafSize, long [] leafValues, LongChunk<? extends Any> insertValues, long [] leafRowKeys, LongChunk<? extends RowKeys> insertRowKeys) {
    ...
    private void removeFromLeaf(int leafSize, long [] leafValues, LongChunk<? extends Any> removeValues, long [] leafRowKeys, LongChunk<? extends RowKeys> removeRowKeys, @Nullable WritableLongChunk<? extends RowKeys> priorRedirections, long firstPriorRedirection) {
    ...
    private static int upperBound(LongChunk<? extends Any> valuesToSearch, LongChunk<? extends RowKeys> rowKeysToSearch, int lo, int hi, long searchValue, long searchKey) {
        while (lo < hi) {
            final int mid = (lo + hi) >>> 1;
            final long testValue = valuesToSearch.get(mid);
            final int comparison = doComparison(testValue, searchValue);
     ...
     */
    private void removeAndGetNextInternal(LongChunk<? extends Any> valuesToRemove, LongChunk<? extends RowKeys> rowKeysToRemove, @Nullable WritableLongChunk<? extends RowKeys> priorRedirections) {
        validate();
    ...
    private void shiftLeaf(int leafSize, long [] leafValues, LongChunk<? extends Any> shiftValues, long [] leafRowKeys, LongChunk<? extends RowKeys> shiftRowKeys, long shiftDelta) {
        Assert.leq(leafSize, "leafSize", this.leafSize, "this.leafSize");
    ...
    private void shiftLeafReverse(int leafSize, long [] leafValues, LongChunk<? extends Any> shiftValues, long [] leafRowKeys, LongChunk<? extends RowKeys> shiftRowKeys, long shiftDelta) {
        Assert.leq(leafSize, "leafSize", this.leafSize, "this.leafSize");
        final int shiftSize = shiftValues.size();
