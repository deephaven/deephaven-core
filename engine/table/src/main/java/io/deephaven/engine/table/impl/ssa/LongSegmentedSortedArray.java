...
public final class LongSegmentedSortedArray implements SegmentedSortedArray {
     ...
     */
    private <T extends Any> int findNext(LongChunk<T> stampValues, LongChunk<? extends Attributes.RowKeys> stampRowKeys, WritableLongChunk<T> nextValues) {
    ...
    private static <T extends Any> int findNextOneLeaf(int offset, LongChunk<T> stampValues, LongChunk<? extends Attributes.RowKeys> stampRowKeys, WritableLongChunk<T> nextValues, int leafSize, long [] leafValues, long [] leafKeys) {
        int lo = 0;
     ...
     */
    void insert(LongChunk<? extends Any> valuesToInsert, LongChunk<? extends Attributes.RowKeys> rowKeysToInsert) {
    ...
    private void copyToLeaf(int leafOffset, long[] leafValues, LongChunk<? extends Any> insertValues, long[] leafRowKeys, LongChunk<? extends RowKeys> insertRowKeys) {
        copyToLeaf(leafOffset, leafValues, insertValues, leafRowKeys, insertRowKeys, 0, insertRowKeys.size());
    }

    private void copyToLeaf(int leafOffset, long[] leafValues, LongChunk<? extends Any> insertValues, long[] leafRowKeys, LongChunk<? extends Attributes.RowKeys> insertRowKeys, int srcOffset, int length) {
    ...
    private void distributeValues(int targetSize, int startingLeaf, int distributionSlots, LongChunk<? extends Any> valuesToInsert, LongChunk<? extends Attributes.RowKeys> rowKeys) {
    ...
    private void insertIntoLeaf(int leafSize, long [] leafValues, LongChunk<? extends Any> insertValues, long [] leafRowKeys, LongChunk<? extends Attributes.RowKeys> insertRowKeys) {
    ...
    private boolean isAfterLeaf(int leafSize, long[] leafValues, LongChunk<? extends Any> insertValues, long[] leafRowKeys, LongChunk<? extends RowKeys> insertRowKeys) {
    ...
    private void removeFromLeaf(int leafSize, long [] leafValues, LongChunk<? extends Any> removeValues, long [] leafRowKeys, LongChunk<? extends Attributes.RowKeys> removeRowKeys, @Nullable WritableLongChunk<? extends Attributes.RowKeys> priorRedirections, long firstPriorRedirection) {
    ...
    private static int lowerBound(LongChunk<? extends Any> valuesToSearch, LongChunk<? extends RowKeys> rowKeysToSearch, int lo, int hi, long searchValue, long searchKey) {
        while (lo < hi) {
    ...
    private static int upperBound(LongChunk<? extends Any> valuesToSearch, LongChunk<? extends Attributes.RowKeys> rowKeysToSearch, int lo, int hi, long searchValue, long searchKey) {
        while (lo < hi) {
            final int mid = (lo + hi) >>> 1;
            final long testValue = valuesToSearch.get(mid);
            final int comparison = doComparison(testValue, searchValue);
    ...
    private static int lowerBound(long [] valuesToSearch, long [] rowKeysToSearch, int lo, int hi, long searchValue, long searchKey) {
        while (lo < hi) {
            final int mid = (lo + hi) >>> 1;
     ...
     */
    private static int bound(long [] valuesToSearch, long [] rowKeysToSearch, final long searchValue, long searchRowKey, int lo, int hi) {
        while (lo < hi) {
            final int mid = (lo + hi) >>> 1;
            final long testValue = valuesToSearch[mid];
            final int comparison = doComparison(testValue, searchValue);
    ...
    private void remove(LongChunk<? extends Any> valuesToRemove, LongChunk<? extends Attributes.RowKeys> rowKeysToRemove) {
     ...
     */
    private void removeAndGetNextInternal(LongChunk<? extends Any> valuesToRemove, LongChunk<? extends RowKeys> rowKeysToRemove, @Nullable WritableLongChunk<? extends Attributes.RowKeys> priorRedirections) {
        validate();
    ...
    private void shiftLeaf(int leafSize, long [] leafValues, LongChunk<? extends Any> shiftValues, long [] leafRowKeys, LongChunk<? extends Attributes.RowKeys> shiftRowKeys, long shiftDelta) {
        Assert.leq(leafSize, "leafSize", this.leafSize, "this.leafSize");
    ...
    private void shiftLeafReverse(int leafSize, long [] leafValues, LongChunk<? extends Any> shiftValues, long [] leafRowKeys, LongChunk<? extends Attributes.RowKeys> shiftRowKeys, long shiftDelta) {
        Assert.leq(leafSize, "leafSize", this.leafSize, "this.leafSize");
        final int shiftSize = shiftValues.size();
