...
public final class TypedHasherShortDouble extends StaticChunkedOperatorAggregationStateManagerTypedBase {
  ...
  public TypedHasherShortDouble(ColumnSource[] tableKeySources, int tableSize,
  ...
  private boolean findOverflow(StaticChunkedOperatorAggregationStateManagerTypedBase.StaticAggHashHandler handler,
      short v0, double v1, int chunkPosition, int overflowLocation) {
    while (overflowLocation != QueryConstants.NULL_INT) {
