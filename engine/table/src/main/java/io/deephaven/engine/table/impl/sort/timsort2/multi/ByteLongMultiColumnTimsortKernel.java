...
/**
 * This implements a timsort kernel that sorts a multi-column key (Byte, Long), comparing each
 ...
 */
public final class ByteLongMultiColumnTimsortKernel {
    private ByteLongMultiColumnTimsortKernel() {
        throw new UnsupportedOperationException();
    }

    public static <SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> ByteLongMultiColumnSortKernelContext<SORT_VALUES_ATTR, PERMUTE_VALUES_ATTR> createContext(
            final int size) {
        return new ByteLongMultiColumnSortKernelContext<>(size);
    }
    ...
    static <SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> void sort(
            ByteLongMultiColumnSortKernelContext<SORT_VALUES_ATTR, PERMUTE_VALUES_ATTR> context,
    ...
    private static int upperBound(ByteChunk<?> valuesToSort0, LongChunk<?> valuesToSort1, int lo,
            int hi, byte searchValue0, long searchValue1) {
    ...
    private static int lowerBound(ByteChunk<?> valuesToSort0, LongChunk<?> valuesToSort1, int lo,
            int hi, byte searchValue0, long searchValue1) {
    ...
    private static int bound(ByteChunk<?> valuesToSort0, LongChunk<?> valuesToSort1, int lo, int hi,
            byte searchValue0, long searchValue1, final boolean lower) {
    ...
    private static void insertionSort(WritableLongChunk<?> valuesToPermute,
            WritableByteChunk<?> valuesToSort0, WritableLongChunk<?> valuesToSort1, int offset,
            int length) {
    ...
    private static void swap(WritableLongChunk<?> valuesToPermute,
            WritableByteChunk<?> valuesToSort0, WritableLongChunk<?> valuesToSort1, int a, int b) {
    ...
    public static class ByteLongMultiColumnSortKernelContext<SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> implements MultiColumnSortKernel<PERMUTE_VALUES_ATTR> {
        int minGallop;
        ...
        private ByteLongMultiColumnSortKernelContext(int size) {
        ...
        public void sort(WritableLongChunk<PERMUTE_VALUES_ATTR> valuesToPermute,
            ...
            ByteLongMultiColumnTimsortKernel.sort(this, valuesToPermute,
