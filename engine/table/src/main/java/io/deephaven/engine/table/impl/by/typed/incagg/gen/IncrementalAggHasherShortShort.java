...
final class IncrementalAggHasherShortShort extends IncrementalChunkedOperatorAggregationStateManagerTypedBase {
    ...
    public IncrementalAggHasherShortShort(ColumnSource[] tableKeySources,
    ...
    private static int hash(short k0, short k1) {
    ...
    private boolean findOverflow(HashHandler handler, short k0, short k1, int chunkPosition,
