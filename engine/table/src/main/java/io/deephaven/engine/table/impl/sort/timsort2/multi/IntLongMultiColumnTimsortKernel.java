...
/**
 * This implements a timsort kernel that sorts a multi-column key (Int, Long), comparing each
 ...
 */
public final class IntLongMultiColumnTimsortKernel {
    private IntLongMultiColumnTimsortKernel() {
        throw new UnsupportedOperationException();
    }

    public static <SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> IntLongMultiColumnSortKernelContext<SORT_VALUES_ATTR, PERMUTE_VALUES_ATTR> createContext(
            final int size) {
        return new IntLongMultiColumnSortKernelContext<>(size);
    }
    ...
    static <SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> void sort(
            IntLongMultiColumnSortKernelContext<SORT_VALUES_ATTR, PERMUTE_VALUES_ATTR> context,
    ...
    private static int upperBound(IntChunk<?> valuesToSort0, LongChunk<?> valuesToSort1, int lo,
            int hi, int searchValue0, long searchValue1) {
    ...
    private static int lowerBound(IntChunk<?> valuesToSort0, LongChunk<?> valuesToSort1, int lo,
            int hi, int searchValue0, long searchValue1) {
    ...
    private static int bound(IntChunk<?> valuesToSort0, LongChunk<?> valuesToSort1, int lo, int hi,
            int searchValue0, long searchValue1, final boolean lower) {
    ...
    private static void insertionSort(WritableLongChunk<?> valuesToPermute,
            WritableIntChunk<?> valuesToSort0, WritableLongChunk<?> valuesToSort1, int offset,
            int length) {
    ...
    private static void swap(WritableLongChunk<?> valuesToPermute,
            WritableIntChunk<?> valuesToSort0, WritableLongChunk<?> valuesToSort1, int a, int b) {
    ...
    public static class IntLongMultiColumnSortKernelContext<SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> implements MultiColumnSortKernel<PERMUTE_VALUES_ATTR> {
        int minGallop;
        ...
        private IntLongMultiColumnSortKernelContext(int size) {
        ...
        public void sort(WritableLongChunk<PERMUTE_VALUES_ATTR> valuesToPermute,
            ...
            IntLongMultiColumnTimsortKernel.sort(this, valuesToPermute,
