...
/**
 * This implements a timsort kernel for a multi-column key (Int, Double) that never moves the column values:
 ...
 */
public final class IntDoubleIndirectMultiColumnTimsortKernel {
    private IntDoubleIndirectMultiColumnTimsortKernel() {
        throw new UnsupportedOperationException();
    }

    public static <PERMUTE_VALUES_ATTR extends Any> IntDoubleIndirectMultiColumnSortKernelContext<PERMUTE_VALUES_ATTR> createContext(
            final int size) {
        return new IntDoubleIndirectMultiColumnSortKernelContext<>(size);
    }
     ...
     */
    public static void sort(IntDoubleIndirectMultiColumnSortKernelContext<?> context,
    ...
    private static void timSort(IntDoubleIndirectMultiColumnSortKernelContext<?> context,
            WritableIntChunk<ChunkPositions> positions, IntChunk<?> valuesToSort0,
     ...
     */
    private static int compareColumns(IntChunk<?> valuesToSort0, DoubleChunk<?> valuesToSort1,
    ...
    private static void ensureMergeInvariants(
            IntDoubleIndirectMultiColumnSortKernelContext<?> context,
            WritableIntChunk<ChunkPositions> positions, IntChunk<?> valuesToSort0,
            DoubleChunk<?> valuesToSort1) {
        while (context.runCount > 1) {
    ...
    private static void merge(IntDoubleIndirectMultiColumnSortKernelContext<?> context,
            WritableIntChunk<ChunkPositions> positions, IntChunk<?> valuesToSort0,
     ...
     */
    private static void frontMerge(IntDoubleIndirectMultiColumnSortKernelContext<?> context,
            WritableIntChunk<ChunkPositions> positions, IntChunk<?> valuesToSort0,
     ...
     * We eventually need to do galloping here, but are skipping that for now
     */
    private static void backMerge(IntDoubleIndirectMultiColumnSortKernelContext<?> context,
            WritableIntChunk<ChunkPositions> positions, IntChunk<?> valuesToSort0,
    ...
    private static void copyToTemporary(IntDoubleIndirectMultiColumnSortKernelContext<?> context,
    ...
    private static void insertionSort(WritableIntChunk<ChunkPositions> positions,
            IntChunk<?> valuesToSort0, DoubleChunk<?> valuesToSort1, int offset, int length) {
    ...
    public static class IntDoubleIndirectMultiColumnSortKernelContext<PERMUTE_VALUES_ATTR extends Any> implements MultiColumnSortKernel<PERMUTE_VALUES_ATTR> {
        int minGallop;
        ...
        private IntDoubleIndirectMultiColumnSortKernelContext(int size) {
        ...
        public void sort(WritableLongChunk<PERMUTE_VALUES_ATTR> valuesToPermute,
            ...
            IntDoubleIndirectMultiColumnTimsortKernel.sort(this, positions, valuesToSort[0].asIntChunk(), valuesToSort[1].asDoubleChunk());
