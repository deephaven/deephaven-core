 ...
 */
public final class DoubleLongTimsortKernel {
    ...
    public static <SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> DoubleLongSortKernelContext<SORT_VALUES_ATTR, PERMUTE_VALUES_ATTR> createContext(
            final int size) {
        return new DoubleLongTimsortKernel().createContextInstance(size);
    }
    ...
    private static <SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> void copyToChunk(
            LongChunk<PERMUTE_VALUES_ATTR> rowSetSource, DoubleChunk<SORT_VALUES_ATTR> valuesSource,
    ...
    public class DoubleLongSortKernelContext<SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> implements LongSortKernel<SORT_VALUES_ATTR, PERMUTE_VALUES_ATTR> {
        int minGallop;
        ...
        public void sort(WritableLongChunk<PERMUTE_VALUES_ATTR> valuesToPermute,
            ...
            DoubleLongTimsortKernel.this.sort(this, valuesToPermute, valuesToSort.asWritableDoubleChunk());
        }
        ...
        public void sort(WritableLongChunk<PERMUTE_VALUES_ATTR> valuesToPermute,
                ...
                IntChunk<? extends ChunkPositions> offsetsIn,
                IntChunk<? extends ChunkLengths> lengthsIn) {
            DoubleLongTimsortKernel.this.sort(this, valuesToPermute, valuesToSort.asWritableDoubleChunk(), offsetsIn, lengthsIn);
        }

        @Override
        public void sort(WritableLongChunk<PERMUTE_VALUES_ATTR> valuesToPermute,
                WritableChunk<SORT_VALUES_ATTR> valuesToSort, int offset, int length) {
            DoubleLongTimsortKernel.this.timSort(this, valuesToPermute, valuesToSort.asWritableDoubleChunk(), offset, length);
        }
        ...
        public void merge(WritableLongChunk<PERMUTE_VALUES_ATTR> valuesToPermute,
                ...
                int length2) {
            DoubleLongTimsortKernel.this.merge(this, valuesToPermute, valuesToSort.asWritableDoubleChunk(), start1, length1, length2);
        }
        ...
        private DoubleLongTimsortKernel kernel() {
            return DoubleLongTimsortKernel.this;
        }
    }
}
