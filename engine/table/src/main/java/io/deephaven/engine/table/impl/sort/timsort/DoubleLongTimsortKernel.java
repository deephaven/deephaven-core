...
public final class DoubleLongTimsortKernel {
    ...
    // region Context
    public class DoubleLongSortKernelContext<SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any>
    ...
    // private static void doCheck(Chunk.LongChunk valuesToPermute, Chunk.DoubleChunk valuesToSort, int startCheck, int
    // mergeEnd) {
    // double lastCheck;
