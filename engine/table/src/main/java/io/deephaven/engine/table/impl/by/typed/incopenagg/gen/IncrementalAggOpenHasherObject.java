...
final class IncrementalAggOpenHasherObject extends IncrementalChunkedOperatorAggregationStateManagerOpenAddressedBase {
    ...
    public IncrementalAggOpenHasherObject(ColumnSource[] tableKeySources, int tableSize,
    ...
    protected void migrateOneLocation(int locationToMigrate) {
        ...
        final Object k0 = mainKeySource0.getUnsafe(locationToMigrate);
        final int hash = hash(k0);
        ...
        mainKeySource0.set(locationToMigrate, null);
