...
final class IncrementalAggOpenHasherObject extends IncrementalChunkedOperatorAggregationStateManagerOpenAddressedBase {
    private ImmutableObjectArraySource mainKeySource0;

    private ImmutableObjectArraySource alternateKeySource0;

    public IncrementalAggOpenHasherObject(ColumnSource[] tableKeySources,
