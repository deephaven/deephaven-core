 ...
 * possible.
 */
public class ShortChunkColumnSource extends AbstractColumnSource<Short>
        implements ImmutableColumnSourceGetDefaults.ForShort, ChunkColumnSource<Short> {
    private final ArrayList<ShortChunk<? extends Values>> data = new ArrayList<>();
    ...
    protected ShortChunkColumnSource(final LongArrayList firstOffsetForData) {
        super(Short.class);
     ...
     */
    public void addChunk(@NotNull final ShortChunk<? extends Values> chunk) {
