...
final class IncrementalAggHasherFloatByte extends IncrementalChunkedOperatorAggregationStateManagerTypedBase {
    ...
    public IncrementalAggHasherFloatByte(ColumnSource[] tableKeySources,
