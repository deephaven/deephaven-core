...
/**
 * This implements a timsort kernel for a sort key (Int) that never moves the column values:
...
public final class IntIndirectTimsortKernel {
    ...
    public static class IntIndirectSortKernelContext<PERMUTE_VALUES_ATTR extends Any> implements MultiColumnSortKernel<PERMUTE_VALUES_ATTR> {
        ...
        public void sortPositions(WritableIntChunk<ChunkPositions> positions,
            ...
            IntIndirectTimsortKernel.timSort(this, positions, valuesToSort[0].asIntChunk(), offset, length);
        }
        ...
        public void mergePositions(WritableIntChunk<ChunkPositions> positions,
            ...
            IntIndirectTimsortKernel.merge(this, positions, valuesToSort[0].asIntChunk(), start1, length1, length2);
        }
