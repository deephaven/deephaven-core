...
final class StaticAggHasherByteInt extends StaticChunkedOperatorAggregationStateManagerTypedBase {
    ...
    public StaticAggHasherByteInt(ColumnSource[] tableKeySources,
