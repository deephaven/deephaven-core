...
/**
 * This implements a timsort kernel for a sort key (Double) that never moves the column values:
 ...
 */
public final class DoubleIndirectTimsortKernel {
    private DoubleIndirectTimsortKernel() {
        throw new UnsupportedOperationException();
    }

    public static <PERMUTE_VALUES_ATTR extends Any> DoubleIndirectSortKernelContext<PERMUTE_VALUES_ATTR> createContext(
            final int size) {
        return new DoubleIndirectSortKernelContext<>(size);
    }
     ...
     */
    public static void sort(DoubleIndirectSortKernelContext<?> context,
    ...
    private static void timSort(DoubleIndirectSortKernelContext<?> context,
    ...
    private static void ensureMergeInvariants(DoubleIndirectSortKernelContext<?> context,
            WritableIntChunk<ChunkPositions> positions, DoubleChunk<?> valuesToSort0) {
        while (context.runCount > 1) {
    ...
    private static void merge(DoubleIndirectSortKernelContext<?> context,
     ...
     */
    private static void frontMerge(DoubleIndirectSortKernelContext<?> context,
            WritableIntChunk<ChunkPositions> positions, DoubleChunk<?> valuesToSort0,
     ...
     * We eventually need to do galloping here, but are skipping that for now
     */
    private static void backMerge(DoubleIndirectSortKernelContext<?> context,
            WritableIntChunk<ChunkPositions> positions, DoubleChunk<?> valuesToSort0,
    ...
    private static void copyToTemporary(DoubleIndirectSortKernelContext<?> context,
    ...
    public static class DoubleIndirectSortKernelContext<PERMUTE_VALUES_ATTR extends Any> implements MultiColumnSortKernel<PERMUTE_VALUES_ATTR> {
        int minGallop;
        ...
        private DoubleIndirectSortKernelContext(int size) {
            this.size = size;
        ...
        public void sort(WritableLongChunk<PERMUTE_VALUES_ATTR> valuesToPermute,
            ...
            DoubleIndirectTimsortKernel.sort(this, positions, valuesToSort[0].asDoubleChunk());
        ...
        public void sortPositions(WritableIntChunk<ChunkPositions> positions,
            ...
            DoubleIndirectTimsortKernel.timSort(this, positions, valuesToSort[0].asDoubleChunk(), offset, length);
        }
        ...
        public void mergePositions(WritableIntChunk<ChunkPositions> positions,
            ...
            DoubleIndirectTimsortKernel.merge(this, positions, valuesToSort[0].asDoubleChunk(), start1, length1, length2);
        }
