...
public class LongPermuteKernel {
    public static <T extends Any> void permute(LongChunk<? extends T> inputValues,
            IntChunk<ChunkPositions> outputPositions, WritableLongChunk<? super T> outputValues) {
        for (int ii = 0; ii < outputPositions.size(); ++ii) {
            outputValues.set(outputPositions.get(ii), inputValues.get(ii));
        }
    }

    public static <T extends Any> void permuteInput(LongChunk<? extends T> inputValues,
            IntChunk<ChunkPositions> inputPositions, WritableLongChunk<? super T> outputValues) {
    ...
    public static <T extends Any> void permute(IntChunk<ChunkPositions> inputPositions,
            LongChunk<? extends T> inputValues, IntChunk<ChunkPositions> outputPositions,
            WritableLongChunk<? super T> outputValues) {
        for (int ii = 0; ii < outputPositions.size(); ++ii) {
    ...
    private static class LongPermuteKernelContext implements PermuteKernel {
        ...
        public <T extends Any> void permute(IntChunk<ChunkPositions> inputPositions, Chunk<? extends T> inputValues,
            ...
            LongPermuteKernel.permute(inputPositions, inputValues.asLongChunk(), outputPositions,
                    outputValues.asWritableLongChunk());
        }
        ...
        public <T extends Any> void permuteInput(Chunk<? extends T> inputValues,
            ...
            LongPermuteKernel.permuteInput(inputValues.asLongChunk(), inputPositions,
                    outputValues.asWritableLongChunk());
        }
    }
