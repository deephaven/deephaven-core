...
final class IncrementalAggOpenHasherWithTombstoneCharFloat extends IncrementalChunkedOperatorAggregationStateManagerOpenAddressedBaseWithTombstones {
    ...
    public IncrementalAggOpenHasherWithTombstoneCharFloat(ColumnSource[] tableKeySources,
