...
/**
 * This implements a timsort kernel for a multi-column key (Double, Byte) that never moves the column values:
 ...
 */
public final class DoubleByteIndirectMultiColumnTimsortKernel {
    private DoubleByteIndirectMultiColumnTimsortKernel() {
        throw new UnsupportedOperationException();
    }

    public static <PERMUTE_VALUES_ATTR extends Any> DoubleByteIndirectMultiColumnSortKernelContext<PERMUTE_VALUES_ATTR> createContext(
            final int size) {
        return new DoubleByteIndirectMultiColumnSortKernelContext<>(size);
    }
     ...
     */
    public static void sort(DoubleByteIndirectMultiColumnSortKernelContext<?> context,
    ...
    private static void timSort(DoubleByteIndirectMultiColumnSortKernelContext<?> context,
            WritableIntChunk<ChunkPositions> positions, DoubleChunk<?> valuesToSort0,
     ...
     */
    private static int compareColumns(DoubleChunk<?> valuesToSort0, ByteChunk<?> valuesToSort1,
    ...
    private static void ensureMergeInvariants(
            DoubleByteIndirectMultiColumnSortKernelContext<?> context,
            WritableIntChunk<ChunkPositions> positions, DoubleChunk<?> valuesToSort0,
            ByteChunk<?> valuesToSort1) {
        while (context.runCount > 1) {
    ...
    private static void merge(DoubleByteIndirectMultiColumnSortKernelContext<?> context,
            WritableIntChunk<ChunkPositions> positions, DoubleChunk<?> valuesToSort0,
     ...
     */
    private static void frontMerge(DoubleByteIndirectMultiColumnSortKernelContext<?> context,
            WritableIntChunk<ChunkPositions> positions, DoubleChunk<?> valuesToSort0,
     ...
     * We eventually need to do galloping here, but are skipping that for now
     */
    private static void backMerge(DoubleByteIndirectMultiColumnSortKernelContext<?> context,
            WritableIntChunk<ChunkPositions> positions, DoubleChunk<?> valuesToSort0,
    ...
    private static void copyToTemporary(DoubleByteIndirectMultiColumnSortKernelContext<?> context,
    ...
    private static void insertionSort(WritableIntChunk<ChunkPositions> positions,
            DoubleChunk<?> valuesToSort0, ByteChunk<?> valuesToSort1, int offset, int length) {
    ...
    public static class DoubleByteIndirectMultiColumnSortKernelContext<PERMUTE_VALUES_ATTR extends Any> implements MultiColumnSortKernel<PERMUTE_VALUES_ATTR> {
        int minGallop;
        ...
        private DoubleByteIndirectMultiColumnSortKernelContext(int size) {
        ...
        public void sort(WritableLongChunk<PERMUTE_VALUES_ATTR> valuesToPermute,
            ...
            DoubleByteIndirectMultiColumnTimsortKernel.sort(this, positions, valuesToSort[0].asDoubleChunk(), valuesToSort[1].asByteChunk());
