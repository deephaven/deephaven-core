...
/**
 * This implements a timsort kernel that sorts a multi-column key (Byte, Int), comparing each
 ...
 */
public final class ByteIntMultiColumnTimsortKernel {
    private ByteIntMultiColumnTimsortKernel() {
        throw new UnsupportedOperationException();
    }

    public static <SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> ByteIntMultiColumnSortKernelContext<SORT_VALUES_ATTR, PERMUTE_VALUES_ATTR> createContext(
            final int size) {
        return new ByteIntMultiColumnSortKernelContext<>(size);
    }
    ...
    static <SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> void sort(
            ByteIntMultiColumnSortKernelContext<SORT_VALUES_ATTR, PERMUTE_VALUES_ATTR> context,
    ...
    private static int upperBound(ByteChunk<?> valuesToSort0, IntChunk<?> valuesToSort1, int lo,
            int hi, byte searchValue0, int searchValue1) {
    ...
    private static int lowerBound(ByteChunk<?> valuesToSort0, IntChunk<?> valuesToSort1, int lo,
            int hi, byte searchValue0, int searchValue1) {
    ...
    private static int bound(ByteChunk<?> valuesToSort0, IntChunk<?> valuesToSort1, int lo, int hi,
            byte searchValue0, int searchValue1, final boolean lower) {
    ...
    private static void insertionSort(WritableLongChunk<?> valuesToPermute,
            WritableByteChunk<?> valuesToSort0, WritableIntChunk<?> valuesToSort1, int offset,
            int length) {
    ...
    private static void swap(WritableLongChunk<?> valuesToPermute,
            WritableByteChunk<?> valuesToSort0, WritableIntChunk<?> valuesToSort1, int a, int b) {
    ...
    public static class ByteIntMultiColumnSortKernelContext<SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> implements MultiColumnSortKernel<PERMUTE_VALUES_ATTR> {
        int minGallop;
        ...
        private ByteIntMultiColumnSortKernelContext(int size) {
        ...
        public void sort(WritableLongChunk<PERMUTE_VALUES_ATTR> valuesToPermute,
            ...
            ByteIntMultiColumnTimsortKernel.sort(this, valuesToPermute,
