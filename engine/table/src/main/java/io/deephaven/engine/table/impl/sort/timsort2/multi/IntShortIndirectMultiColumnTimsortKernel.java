...
/**
 * This implements a timsort kernel for a multi-column key (Int, Short) that never moves the column values:
 ...
 */
public final class IntShortIndirectMultiColumnTimsortKernel {
    private IntShortIndirectMultiColumnTimsortKernel() {
        throw new UnsupportedOperationException();
    }

    public static <PERMUTE_VALUES_ATTR extends Any> IntShortIndirectMultiColumnSortKernelContext<PERMUTE_VALUES_ATTR> createContext(
            final int size) {
        return new IntShortIndirectMultiColumnSortKernelContext<>(size);
    }
     ...
     */
    public static void sort(IntShortIndirectMultiColumnSortKernelContext<?> context,
    ...
    private static void timSort(IntShortIndirectMultiColumnSortKernelContext<?> context,
            WritableIntChunk<ChunkPositions> positions, IntChunk<?> valuesToSort0,
     ...
     */
    private static int compareColumns(IntChunk<?> valuesToSort0, ShortChunk<?> valuesToSort1,
    ...
    private static void ensureMergeInvariants(
            IntShortIndirectMultiColumnSortKernelContext<?> context,
            WritableIntChunk<ChunkPositions> positions, IntChunk<?> valuesToSort0,
            ShortChunk<?> valuesToSort1) {
        while (context.runCount > 1) {
    ...
    private static void merge(IntShortIndirectMultiColumnSortKernelContext<?> context,
            WritableIntChunk<ChunkPositions> positions, IntChunk<?> valuesToSort0,
     ...
     */
    private static void frontMerge(IntShortIndirectMultiColumnSortKernelContext<?> context,
            WritableIntChunk<ChunkPositions> positions, IntChunk<?> valuesToSort0,
     ...
     * We eventually need to do galloping here, but are skipping that for now
     */
    private static void backMerge(IntShortIndirectMultiColumnSortKernelContext<?> context,
            WritableIntChunk<ChunkPositions> positions, IntChunk<?> valuesToSort0,
    ...
    private static void copyToTemporary(IntShortIndirectMultiColumnSortKernelContext<?> context,
    ...
    private static void insertionSort(WritableIntChunk<ChunkPositions> positions,
            IntChunk<?> valuesToSort0, ShortChunk<?> valuesToSort1, int offset, int length) {
    ...
    public static class IntShortIndirectMultiColumnSortKernelContext<PERMUTE_VALUES_ATTR extends Any> implements MultiColumnSortKernel<PERMUTE_VALUES_ATTR> {
        int minGallop;
        ...
        private IntShortIndirectMultiColumnSortKernelContext(int size) {
        ...
        public void sort(WritableLongChunk<PERMUTE_VALUES_ATTR> valuesToPermute,
            ...
            IntShortIndirectMultiColumnTimsortKernel.sort(this, positions, valuesToSort[0].asIntChunk(), valuesToSort[1].asShortChunk());
