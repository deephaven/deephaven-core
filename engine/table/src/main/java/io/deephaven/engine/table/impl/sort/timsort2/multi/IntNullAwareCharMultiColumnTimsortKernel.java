...
/**
 * This implements a timsort kernel that sorts a multi-column key (Int, NullAwareChar), comparing each
 ...
 */
public final class IntNullAwareCharMultiColumnTimsortKernel {
    private IntNullAwareCharMultiColumnTimsortKernel() {
        throw new UnsupportedOperationException();
    }

    public static <SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> IntNullAwareCharMultiColumnSortKernelContext<SORT_VALUES_ATTR, PERMUTE_VALUES_ATTR> createContext(
            final int size) {
        return new IntNullAwareCharMultiColumnSortKernelContext<>(size);
    }
    ...
    static <SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> void sort(
            IntNullAwareCharMultiColumnSortKernelContext<SORT_VALUES_ATTR, PERMUTE_VALUES_ATTR> context,
            WritableLongChunk<PERMUTE_VALUES_ATTR> valuesToPermute,
            WritableIntChunk<SORT_VALUES_ATTR> valuesToSort0,
    ...
    private static <SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> void timSort(
        ...
        while (startRun < offset + length) {
            int current0 = valuesToSort0.get(startRun);
            ...
            if (startRun + 1 == offset + length) {
                ...
                int next0 = valuesToSort0.get(startRun + 1);
                endRun = startRun + 2;
    ...
    private static <SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> void merge(
        ...
        final int run2lo0 = valuesToSort0.get(start2);
        ...
        final int run1hi0 = valuesToSort0.get(start1 + length1 - 1);
    ...
    private static <SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> void frontMerge(
        ...
        int val1_0 = context.temporaryValues0.get(tempCursor);
        int val2_0 = valuesToSort0.get(run2Cursor);
    ...
    private static <SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> void backMerge(
        ...
        int val1_0 = valuesToSort0.get(run1Cursor);
        int val2_0 = context.temporaryValues0.get(tempCursor);
    ...
    private static <SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> void copyToChunk(
            LongChunk<PERMUTE_VALUES_ATTR> rowSetSource, IntChunk<SORT_VALUES_ATTR> valuesSource0,
            CharChunk<SORT_VALUES_ATTR> valuesSource1,
            WritableLongChunk<PERMUTE_VALUES_ATTR> permuteValuesDest,
            WritableIntChunk<SORT_VALUES_ATTR> sortValuesDest0,
    ...
    private static int upperBound(IntChunk<?> valuesToSort0, CharChunk<?> valuesToSort1, int lo,
            int hi, int searchValue0, char searchValue1) {
    ...
    private static int lowerBound(IntChunk<?> valuesToSort0, CharChunk<?> valuesToSort1, int lo,
            int hi, int searchValue0, char searchValue1) {
    ...
    private static int bound(IntChunk<?> valuesToSort0, CharChunk<?> valuesToSort1, int lo, int hi,
            int searchValue0, char searchValue1, final boolean lower) {
    ...
    private static void insertionSort(WritableLongChunk<?> valuesToPermute,
            WritableIntChunk<?> valuesToSort0, WritableCharChunk<?> valuesToSort1, int offset,
            int length) {
    ...
    private static void swap(WritableLongChunk<?> valuesToPermute,
            WritableIntChunk<?> valuesToSort0, WritableCharChunk<?> valuesToSort1, int a, int b) {
        final long tempPermuteValue = valuesToPermute.get(a);
        final int temp0 = valuesToSort0.get(a);
    ...
    public static class IntNullAwareCharMultiColumnSortKernelContext<SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> implements MultiColumnSortKernel<PERMUTE_VALUES_ATTR> {
        int minGallop;
        ...
        private final WritableIntChunk<SORT_VALUES_ATTR> temporaryValues0;

        private final WritableCharChunk<SORT_VALUES_ATTR> temporaryValues1;

        private IntNullAwareCharMultiColumnSortKernelContext(int size) {
            temporaryKeys = WritableLongChunk.makeWritableChunk((size + 2) / 2);
            temporaryValues0 = WritableIntChunk.makeWritableChunk((size + 2) / 2);
        ...
        public void sort(WritableLongChunk<PERMUTE_VALUES_ATTR> valuesToPermute,
            ...
            IntNullAwareCharMultiColumnTimsortKernel.sort(this, valuesToPermute,
                            (WritableIntChunk<SORT_VALUES_ATTR>) valuesToSort[0].asWritableIntChunk(),
