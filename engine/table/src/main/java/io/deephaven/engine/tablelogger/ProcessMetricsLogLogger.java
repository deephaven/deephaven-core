...
public interface ProcessMetricsLogLogger extends EngineTableLoggerProvider.EngineTableLogger {
    default void log(final long timestamp, final String processId, final String name, final String interval, final String type, final long n, final long sum, final long last, final long min, final long max, final long avg, final long sum2, final long stdev) throws IOException {
