...
public class FloatLongTimsortKernel {
    ...
    public static class FloatLongSortKernelContext<SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any>
        ...
        public void sort(
            ...
            FloatLongTimsortKernel.sort(this, valuesToPermute, valuesToSort.asWritableFloatChunk());
        }
        ...
        public void sort(
            ...
            FloatLongTimsortKernel.sort(this, valuesToPermute, valuesToSort.asWritableFloatChunk(), offsetsIn, lengthsIn);
        }
    ...
    FloatLongSortKernelContext<SORT_VALUES_ATTR, PERMUTE_VALUES_ATTR> createContext(int size) {
    ...
    static private void swap(WritableLongChunk<?> valuesToPermute, WritableFloatChunk<?> valuesToSort, int a, int b) {
...
//    private static void doCheck(Chunk.LongChunk valuesToPermute, Chunk.FloatChunk valuesToSort, int startCheck, int mergeEnd) {
//        float lastCheck;
