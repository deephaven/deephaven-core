...
public final class FloatLongTimsortKernel {
    ...
    private static <SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> void copyToChunk(
            LongChunk<PERMUTE_VALUES_ATTR> rowSetSource, FloatChunk<SORT_VALUES_ATTR> valuesSource,
    ...
    public class FloatLongSortKernelContext<SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> implements LongSortKernel<SORT_VALUES_ATTR, PERMUTE_VALUES_ATTR> {
        int minGallop;
        ...
        public void sort(WritableLongChunk<PERMUTE_VALUES_ATTR> valuesToPermute,
            ...
            FloatLongTimsortKernel.this.sort(this, valuesToPermute, valuesToSort.asWritableFloatChunk());
        }
        ...
        public void sort(WritableLongChunk<PERMUTE_VALUES_ATTR> valuesToPermute,
            ...
            FloatLongTimsortKernel.this.timSort(this, valuesToPermute, valuesToSort.asWritableFloatChunk(), offset, length);
        }
        ...
        public void merge(WritableLongChunk<PERMUTE_VALUES_ATTR> valuesToPermute,
                ...
                int length2) {
            FloatLongTimsortKernel.this.merge(this, valuesToPermute, valuesToSort.asWritableFloatChunk(), start1, length1, length2);
        }
        ...
        private FloatLongTimsortKernel kernel() {
            return FloatLongTimsortKernel.this;
        }
    }
}
