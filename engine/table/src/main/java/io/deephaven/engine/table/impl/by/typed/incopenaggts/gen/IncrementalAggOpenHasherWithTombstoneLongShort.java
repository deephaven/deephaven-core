...
final class IncrementalAggOpenHasherWithTombstoneLongShort extends IncrementalChunkedOperatorAggregationStateManagerOpenAddressedBaseWithTombstones {
    ...
    public IncrementalAggOpenHasherWithTombstoneLongShort(ColumnSource[] tableKeySources,
