...
final class IncrementalAggOpenHasherLongChar extends IncrementalChunkedOperatorAggregationStateManagerOpenAddressedBase {
    ...
    public IncrementalAggOpenHasherLongChar(ColumnSource[] tableKeySources,
