...
final class IncrementalAggOpenHasherWithTombstoneFloatByte extends IncrementalChunkedOperatorAggregationStateManagerOpenAddressedBaseWithTombstones {
    ...
    public IncrementalAggOpenHasherWithTombstoneFloatByte(ColumnSource[] tableKeySources,
