...
final class RightIncrementalAsOfJoinHasherChar extends RightIncrementalAsOfJoinStateManagerTypedBase {
    private ImmutableCharArraySource mainKeySource0;

    private ImmutableCharArraySource alternateKeySource0;

    public RightIncrementalAsOfJoinHasherChar(ColumnSource[] tableKeySources,
