...
final class IncrementalAggHasherShortLong extends IncrementalChunkedOperatorAggregationStateManagerTypedBase {
    ...
    public IncrementalAggHasherShortLong(ColumnSource[] tableKeySources,
    ...
    private boolean findOverflow(HashHandler handler, short k0, long k1, int chunkPosition,
