...
public final class TypedHasherShortDouble extends IncrementalChunkedOperatorAggregationStateManagerTypedBase {
  ...
  private boolean findOverflow(HashHandler handler, short v0, double v1, int chunkPosition,
