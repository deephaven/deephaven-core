...
final class StaticAggHasherDoubleByte extends StaticChunkedOperatorAggregationStateManagerTypedBase {
    ...
    public StaticAggHasherDoubleByte(ColumnSource[] tableKeySources,
