...
final class IncrementalAggOpenHasherCharFloat extends IncrementalChunkedOperatorAggregationStateManagerOpenAddressedBase {
    ...
    public IncrementalAggOpenHasherCharFloat(ColumnSource[] tableKeySources,
