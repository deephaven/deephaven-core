...
final class TypedHasherShortShort extends StaticChunkedOperatorAggregationStateManagerTypedBase {
  ...
  public TypedHasherShortShort(ColumnSource[] tableKeySources, int tableSize,
  ...
  private int hash(short v0, short v1) {
  ...
  private boolean findOverflow(HashHandler handler, short v0, short v1, int chunkPosition,
