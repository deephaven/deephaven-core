...
final class StaticAggHasherIntLong extends StaticChunkedOperatorAggregationStateManagerTypedBase {
    ...
    public StaticAggHasherIntLong(ColumnSource[] tableKeySources,
    ...
    private boolean findOverflow(HashHandler handler, int k0, long k1, int chunkPosition,
