...
final class StaticAggHasherLongLong extends StaticChunkedOperatorAggregationStateManagerTypedBase {
    ...
    public StaticAggHasherLongLong(ColumnSource[] tableKeySources,
