...
// ****** Edit ByteLongTimsortDescendingKernel and run "./gradlew replicateSortKernel" to regenerate
//
// @formatter:off
...
public class ByteLongTimsortDescendingKernel {
    ...
    public static class ByteLongSortKernelContext<SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any>
        ...
        public void sort(
            ...
            ByteLongTimsortDescendingKernel.sort(this, valuesToPermute, valuesToSort.asWritableByteChunk());
        }
        ...
        public void sort(
            ...
            ByteLongTimsortDescendingKernel.sort(this, valuesToPermute, valuesToSort.asWritableByteChunk(), offsetsIn, lengthsIn);
        }
