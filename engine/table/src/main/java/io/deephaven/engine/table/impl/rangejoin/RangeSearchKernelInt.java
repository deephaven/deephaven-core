...
enum RangeSearchKernelInt implements RangeSearchKernel {
    ...
    LT_GT {
        ...
        void processAllRangesForEmptyRight(
                @NotNull final IntChunk<? extends Values> lsv,
                @NotNull final IntChunk<? extends Values> lev,
        ...
        void processRangeStarts(
                @NotNull final IntChunk<? extends Values> lv,
    ...
    public final void processAllRangesForEmptyRight(
        ...
        processAllRangesForEmptyRight(
                leftStartValues.asIntChunk(),
                leftEndValues.asIntChunk(),
    ...
    abstract void processRangeStarts(
            @NotNull IntChunk<? extends Values> leftValues,
    ...
    // region eq
    private static boolean eq(final int a, final int b) {
