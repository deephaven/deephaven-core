 ...
 */
enum RangeSearchKernelInt implements RangeSearchKernel {

    LT_GT {
        @Override
        void populateAllRangeForEmptyRight(@NotNull final IntChunk<? extends Values> lsv,
                @NotNull final IntChunk<? extends Values> lev, @NotNull final WritableIntChunk<? extends Values> o) {
            populateAllRangesForEmptyRightDisallowEqual(lsv, lev, o);
        }

        @Override
        void populateInvalidRanges(@NotNull final IntChunk<? extends Values> lsv,
                @NotNull final IntChunk<? extends Values> lev, @NotNull final WritableBooleanChunk<? super Values> v,
                @NotNull final WritableIntChunk<? extends Values> o) {
            populateInvalidRangesDisallowEqual(lsv, lev, v, o);
        }

        @Override
        void findStarts(@NotNull final IntChunk<? extends Values> lv, @NotNull final IntChunk<ChunkPositions> lp,
                @NotNull final IntChunk<? extends Values> rv, @NotNull final IntChunk<ChunkPositions> rso,
        ...
        @Override
        void findEnds(@NotNull final IntChunk<? extends Values> lv, @NotNull final IntChunk<ChunkPositions> lp,
                @NotNull final IntChunk<? extends Values> rv, @NotNull final IntChunk<ChunkPositions> rso,
                @NotNull final IntChunk<ChunkLengths> rl, @NotNull final WritableIntChunk<? extends Values> o) {
    ...
    static RangeSearchKernelInt forRules(
    ...
    public final void populateAllRangeForEmptyRight(
        ...
        populateAllRangeForEmptyRight(leftStartValues.asIntChunk(), leftEndValues.asIntChunk(), output);
    }

    abstract void populateAllRangeForEmptyRight(
            @NotNull final IntChunk<? extends Values> leftStartValues,
            @NotNull final IntChunk<? extends Values> leftEndValues,
            @NotNull final WritableIntChunk<? extends Values> output);
    ...
    public final void populateInvalidRanges(
            ...
            @NotNull final WritableIntChunk<? extends Values> output) {
        populateInvalidRanges(leftStartValues.asIntChunk(), leftEndValues.asIntChunk(), validity, output);
    }
    ...
    public final void findStarts(
            ...
            @NotNull final WritableIntChunk<? extends Values> output) {
        findStarts(leftValues.asIntChunk(), leftPositions,
                rightValues.asIntChunk(), rightStartOffsets, rightLengths,
                output);
    }
    ...
    public final void findEnds(
            ...
            @NotNull final IntChunk<ChunkLengths> rightLengths,
            @NotNull final WritableIntChunk<? extends Values> output) {
        findEnds(leftValues.asIntChunk(), leftPositions,
                rightValues.asIntChunk(), rightStartOffsets, rightLengths,
                output);
    }
    ...
    private static void populateInvalidRangesAllowEqual(
            @NotNull IntChunk<? extends Values> leftStartValues,
            @NotNull IntChunk<? extends Values> leftEndValues,
    ...
    private static boolean isValidPairAllowEqual(final int start, final int end) {
        return !isNaN(start) && !isNaN(end) && (isNull(start) || isNull(end) || leq(start, end));
    }

    private static boolean isValidPairDisallowEqual(final int start, final int end) {
    ...
    private static void findStartsLessThan(
        ...
        int leftValue = leftValues.get(leftIndex);
        do {
    ...
    // region isNaN
    private static boolean isNaN(@SuppressWarnings("unused") final int v) {
        return false;
    }
    // endregion isNaN

    // region isNull
    private static boolean isNull(final int v) {
    ...
    // region leq
    private static boolean leq(final int a, final int b) {
        // We need not deal with null or NaN values here
        return a <= b;
    }
    // endregion leq
