...
final class StaticAggHasherLongChar extends StaticChunkedOperatorAggregationStateManagerTypedBase {
    ...
    public StaticAggHasherLongChar(ColumnSource[] tableKeySources,
