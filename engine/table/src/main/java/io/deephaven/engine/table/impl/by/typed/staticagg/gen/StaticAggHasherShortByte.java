...
final class StaticAggHasherShortByte extends StaticChunkedOperatorAggregationStateManagerTypedBase {
    ...
    public StaticAggHasherShortByte(ColumnSource[] tableKeySources,
