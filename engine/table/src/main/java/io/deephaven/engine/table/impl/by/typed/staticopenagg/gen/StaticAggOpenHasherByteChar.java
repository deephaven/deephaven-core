...
final class StaticAggOpenHasherByteChar extends StaticChunkedOperatorAggregationStateManagerOpenAddressedBase {
    private final ImmutableByteArraySource mainKeySource0;

    private final ImmutableCharArraySource mainKeySource1;

    public StaticAggOpenHasherByteChar(ColumnSource[] tableKeySources,
