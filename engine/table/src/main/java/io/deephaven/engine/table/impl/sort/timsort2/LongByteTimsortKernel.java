 ...
 */
public final class LongByteTimsortKernel {
    private LongByteTimsortKernel() {
    }
    ...
    public static <SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> LongByteSortKernelContext<SORT_VALUES_ATTR, PERMUTE_VALUES_ATTR> createContext(
            final int size) {
        return new LongByteTimsortKernel().createContextInstance(size);
    }
    ...
    public class LongByteSortKernelContext<SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> implements ByteSortKernel<SORT_VALUES_ATTR, PERMUTE_VALUES_ATTR> {
        ...
        public void sort(WritableByteChunk<PERMUTE_VALUES_ATTR> valuesToPermute,
            ...
            LongByteTimsortKernel.this.sort(this, valuesToPermute, valuesToSort.asWritableLongChunk());
        }
        ...
        public void sort(WritableByteChunk<PERMUTE_VALUES_ATTR> valuesToPermute,
                ...
                IntChunk<? extends ChunkPositions> offsetsIn,
                IntChunk<? extends ChunkLengths> lengthsIn) {
            LongByteTimsortKernel.this.sort(this, valuesToPermute, valuesToSort.asWritableLongChunk(), offsetsIn, lengthsIn);
        }
        ...
        private LongByteTimsortKernel kernel() {
            return LongByteTimsortKernel.this;
        }
    }
}
