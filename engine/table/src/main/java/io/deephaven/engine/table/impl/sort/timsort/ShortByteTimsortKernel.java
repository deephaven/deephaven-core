...
public final class ShortByteTimsortKernel {
    ...
    // region Context
    public class ShortByteSortKernelContext<SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any>
    ...
    public <SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> ShortByteSortKernelContext<SORT_VALUES_ATTR, PERMUTE_VALUES_ATTR> createContextInstance(int size) {
    ...
    public static <SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> ShortByteSortKernelContext<SORT_VALUES_ATTR, PERMUTE_VALUES_ATTR> createContext(final int size) {
    ...
    static private void swap(WritableByteChunk<?> valuesToPermute, WritableShortChunk<?> valuesToSort, int a, int b) {
    ...
    // private static void doCheck(Chunk.ByteChunk valuesToPermute, Chunk.ShortChunk valuesToSort, int startCheck, int
    // mergeEnd) {
    // short lastCheck;
