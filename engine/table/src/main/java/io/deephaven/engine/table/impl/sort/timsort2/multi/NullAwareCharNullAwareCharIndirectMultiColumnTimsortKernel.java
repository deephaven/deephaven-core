...
/**
 * This implements a timsort kernel for a multi-column key (NullAwareChar, NullAwareChar) that never moves the column values:
 ...
 */
public final class NullAwareCharNullAwareCharIndirectMultiColumnTimsortKernel {
    private NullAwareCharNullAwareCharIndirectMultiColumnTimsortKernel() {
        throw new UnsupportedOperationException();
    }

    public static <PERMUTE_VALUES_ATTR extends Any> NullAwareCharNullAwareCharIndirectMultiColumnSortKernelContext<PERMUTE_VALUES_ATTR> createContext(
            final int size) {
        return new NullAwareCharNullAwareCharIndirectMultiColumnSortKernelContext<>(size);
    }
    ...
    public static void sort(
            NullAwareCharNullAwareCharIndirectMultiColumnSortKernelContext<?> context,
     ...
     */
    private static int compareColumns(CharChunk<?> valuesToSort0, CharChunk<?> valuesToSort1,
    ...
    private static void insertionSort(WritableIntChunk<ChunkPositions> positions,
            CharChunk<?> valuesToSort0, CharChunk<?> valuesToSort1, int offset, int length) {
    ...
    public static class NullAwareCharNullAwareCharIndirectMultiColumnSortKernelContext<PERMUTE_VALUES_ATTR extends Any> implements MultiColumnSortKernel<PERMUTE_VALUES_ATTR> {
        int minGallop;
        ...
        private NullAwareCharNullAwareCharIndirectMultiColumnSortKernelContext(int size) {
        ...
        public void sort(WritableLongChunk<PERMUTE_VALUES_ATTR> valuesToPermute,
            ...
            NullAwareCharNullAwareCharIndirectMultiColumnTimsortKernel.sort(this, positions, valuesToSort[0].asCharChunk(), valuesToSort[1].asCharChunk());
