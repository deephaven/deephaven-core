...
public class CharCopyKernel implements CopyKernel {
    ...
    private CharCopyKernel() {} // use through the instance
    ...
    public static <T extends Any> void conditionalCopy(
            WritableCharChunk<T> output, char[] baseInput, char[] overInput, long[] useOverInput,
    ...
    public <T extends Any> void conditionalCopy(
            ...
            int srcOffset, int dstOffset, int length) {
        char[] typedBaseInput = (char[]) baseInput;
        char[] typedOverInput = (char[]) overInput;
        conditionalCopy(output.asWritableCharChunk(), typedBaseInput, typedOverInput, useOverInput, srcOffset,
                dstOffset, length);
    }
}
