...
public final class TypedHasherByteObject extends StaticChunkedOperatorAggregationStateManagerTypedBase {
  ...
  public TypedHasherByteObject(ColumnSource[] tableKeySources, int tableSize,
  ...
  private int hash(byte v0, Object v1) {
  ...
  private boolean findOverflow(StaticChunkedOperatorAggregationStateManagerTypedBase.StaticAggHashHandler handler,
      byte v0, Object v1, int chunkPosition, int overflowLocation) {
    while (overflowLocation != QueryConstants.NULL_INT) {
