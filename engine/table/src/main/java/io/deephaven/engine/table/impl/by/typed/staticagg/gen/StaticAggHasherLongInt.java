...
final class StaticAggHasherLongInt extends StaticChunkedOperatorAggregationStateManagerTypedBase {
    ...
    public StaticAggHasherLongInt(ColumnSource[] tableKeySources,
