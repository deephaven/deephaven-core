...
public final class ByteSegmentedSortedArray implements SegmentedSortedArray {
     ...
     */
    private <T extends Any> int findNext(ByteChunk<T> stampValues, LongChunk<? extends Attributes.RowKeys> stampRowKeys, WritableByteChunk<T> nextValues) {
    ...
    private static <T extends Any> int findNextOneLeaf(int offset, ByteChunk<T> stampValues, LongChunk<? extends Attributes.RowKeys> stampRowKeys, WritableByteChunk<T> nextValues, int leafSize, byte [] leafValues, long [] leafKeys) {
        int lo = 0;
     ...
     */
    void insert(ByteChunk<? extends Any> valuesToInsert, LongChunk<? extends Attributes.RowKeys> rowKeysToInsert) {
    ...
    private void copyToLeaf(int leafOffset, byte[] leafValues, ByteChunk<? extends Any> insertValues, long[] leafRowKeys, LongChunk<? extends RowKeys> insertRowKeys) {
        copyToLeaf(leafOffset, leafValues, insertValues, leafRowKeys, insertRowKeys, 0, insertRowKeys.size());
    }

    private void copyToLeaf(int leafOffset, byte[] leafValues, ByteChunk<? extends Any> insertValues, long[] leafRowKeys, LongChunk<? extends Attributes.RowKeys> insertRowKeys, int srcOffset, int length) {
    ...
    private void distributeValues(int targetSize, int startingLeaf, int distributionSlots, ByteChunk<? extends Any> valuesToInsert, LongChunk<? extends Attributes.RowKeys> rowKeys) {
    ...
    private void insertIntoLeaf(int leafSize, byte [] leafValues, ByteChunk<? extends Any> insertValues, long [] leafRowKeys, LongChunk<? extends Attributes.RowKeys> insertRowKeys) {
    ...
    private boolean isAfterLeaf(int leafSize, byte[] leafValues, ByteChunk<? extends Any> insertValues, long[] leafRowKeys, LongChunk<? extends RowKeys> insertRowKeys) {
    ...
    private void removeFromLeaf(int leafSize, byte [] leafValues, ByteChunk<? extends Any> removeValues, long [] leafRowKeys, LongChunk<? extends Attributes.RowKeys> removeRowKeys, @Nullable WritableLongChunk<? extends Attributes.RowKeys> priorRedirections, long firstPriorRedirection) {
    ...
    private static int lowerBound(ByteChunk<? extends Any> valuesToSearch, LongChunk<? extends RowKeys> rowKeysToSearch, int lo, int hi, byte searchValue, long searchKey) {
        while (lo < hi) {
    ...
    private static int upperBound(ByteChunk<? extends Any> valuesToSearch, LongChunk<? extends Attributes.RowKeys> rowKeysToSearch, int lo, int hi, byte searchValue, long searchKey) {
        while (lo < hi) {
            final int mid = (lo + hi) >>> 1;
            final byte testValue = valuesToSearch.get(mid);
            final int comparison = doComparison(testValue, searchValue);
    ...
    private static int lowerBound(byte [] valuesToSearch, long [] rowKeysToSearch, int lo, int hi, byte searchValue, long searchKey) {
        while (lo < hi) {
            final int mid = (lo + hi) >>> 1;
     ...
     */
    private static int bound(byte [] valuesToSearch, long [] rowKeysToSearch, final byte searchValue, long searchRowKey, int lo, int hi) {
        while (lo < hi) {
            final int mid = (lo + hi) >>> 1;
            final byte testValue = valuesToSearch[mid];
            final int comparison = doComparison(testValue, searchValue);
    ...
    private void remove(ByteChunk<? extends Any> valuesToRemove, LongChunk<? extends Attributes.RowKeys> rowKeysToRemove) {
     ...
     */
    private void removeAndGetNextInternal(ByteChunk<? extends Any> valuesToRemove, LongChunk<? extends RowKeys> rowKeysToRemove, @Nullable WritableLongChunk<? extends Attributes.RowKeys> priorRedirections) {
        validate();
    ...
    private void shiftLeaf(int leafSize, byte [] leafValues, ByteChunk<? extends Any> shiftValues, long [] leafRowKeys, LongChunk<? extends Attributes.RowKeys> shiftRowKeys, long shiftDelta) {
        Assert.leq(leafSize, "leafSize", this.leafSize, "this.leafSize");
    ...
    private void shiftLeafReverse(int leafSize, byte [] leafValues, ByteChunk<? extends Any> shiftValues, long [] leafRowKeys, LongChunk<? extends Attributes.RowKeys> shiftRowKeys, long shiftDelta) {
        Assert.leq(leafSize, "leafSize", this.leafSize, "this.leafSize");
        final int shiftSize = shiftValues.size();
