...
public final class ByteSegmentedSortedArray implements SegmentedSortedArray {
     ...
     */
    private <T extends Any> int findNext(ByteChunk<T> stampValues, LongChunk<? extends RowKeys> stampRowKeys, WritableByteChunk<T> nextValues) {
    ...
    private static <T extends Any> int findNextOneLeaf(int offset, ByteChunk<T> stampValues, LongChunk<? extends RowKeys> stampRowKeys, WritableByteChunk<T> nextValues, int leafSize, byte [] leafValues, long [] leafKeys) {
        int lo = 0;
    ...
    private void copyToLeaf(int leafOffset, byte[] leafValues, ByteChunk<? extends Any> insertValues, long[] leafRowKeys, LongChunk<? extends RowKeys> insertRowKeys, int srcOffset, int length) {
    ...
    private void distributeValues(int targetSize, int startingLeaf, int distributionSlots, ByteChunk<? extends Any> valuesToInsert, LongChunk<? extends RowKeys> rowKeys) {
    ...
    private void insertIntoLeaf(int leafSize, byte [] leafValues, ByteChunk<? extends Any> insertValues, long [] leafRowKeys, LongChunk<? extends RowKeys> insertRowKeys) {
    ...
    private void removeFromLeaf(int leafSize, byte [] leafValues, ByteChunk<? extends Any> removeValues, long [] leafRowKeys, LongChunk<? extends RowKeys> removeRowKeys, @Nullable WritableLongChunk<? extends RowKeys> priorRedirections, long firstPriorRedirection) {
    ...
    private static int upperBound(ByteChunk<? extends Any> valuesToSearch, LongChunk<? extends RowKeys> rowKeysToSearch, int lo, int hi, byte searchValue, long searchKey) {
        while (lo < hi) {
            final int mid = (lo + hi) >>> 1;
            final byte testValue = valuesToSearch.get(mid);
            final int comparison = doComparison(testValue, searchValue);
     ...
     */
    private void removeAndGetNextInternal(ByteChunk<? extends Any> valuesToRemove, LongChunk<? extends RowKeys> rowKeysToRemove, @Nullable WritableLongChunk<? extends RowKeys> priorRedirections) {
        validate();
    ...
    private void applyShift(ByteChunk<? extends Any> stampChunk, LongChunk<? extends RowKeys> keyChunk, long shiftDelta) {
        validate();
    ...
    private void shiftLeaf(int leafSize, byte [] leafValues, ByteChunk<? extends Any> shiftValues, long [] leafRowKeys, LongChunk<? extends RowKeys> shiftRowKeys, long shiftDelta) {
        Assert.leq(leafSize, "leafSize", this.leafSize, "this.leafSize");
    ...
    private void applyShiftReverse(ByteChunk<? extends Any> stampChunk, LongChunk<? extends RowKeys> keyChunk, long shiftDelta) {
        validate();
        final int shiftSize = stampChunk.size();
        if (shiftSize == 0) {
            return;
    ...
    private void shiftLeafReverse(int leafSize, byte [] leafValues, ByteChunk<? extends Any> shiftValues, long [] leafRowKeys, LongChunk<? extends RowKeys> shiftRowKeys, long shiftDelta) {
        Assert.leq(leafSize, "leafSize", this.leafSize, "this.leafSize");
        final int shiftSize = shiftValues.size();
