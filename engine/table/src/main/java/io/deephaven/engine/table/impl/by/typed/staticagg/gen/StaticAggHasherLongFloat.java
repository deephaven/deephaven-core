...
final class StaticAggHasherLongFloat extends StaticChunkedOperatorAggregationStateManagerTypedBase {
    ...
    public StaticAggHasherLongFloat(ColumnSource[] tableKeySources,
