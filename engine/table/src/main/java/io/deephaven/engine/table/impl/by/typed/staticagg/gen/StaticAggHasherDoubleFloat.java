...
final class StaticAggHasherDoubleFloat extends StaticChunkedOperatorAggregationStateManagerTypedBase {
    ...
    public StaticAggHasherDoubleFloat(ColumnSource[] tableKeySources,
    ...
    private static int hash(double k0, float k1) {
    ...
    private boolean findOverflow(HashHandler handler, double k0, float k1, int chunkPosition,
