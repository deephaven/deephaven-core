...
final class IncrementalAggOpenHasherWithTombstoneShortDouble extends IncrementalChunkedOperatorAggregationStateManagerOpenAddressedBaseWithTombstones {
    ...
    public IncrementalAggOpenHasherWithTombstoneShortDouble(ColumnSource[] tableKeySources,
    ...
    private static int hash(short k0, double k1) {
