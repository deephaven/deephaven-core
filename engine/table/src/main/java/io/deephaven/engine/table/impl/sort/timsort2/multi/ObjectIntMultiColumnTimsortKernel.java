...
/**
 * This implements a timsort kernel that sorts a multi-column key (Object, Int), comparing each
 ...
 */
public final class ObjectIntMultiColumnTimsortKernel {
    private ObjectIntMultiColumnTimsortKernel() {
        throw new UnsupportedOperationException();
    }

    public static <SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> ObjectIntMultiColumnSortKernelContext<SORT_VALUES_ATTR, PERMUTE_VALUES_ATTR> createContext(
            final int size) {
        return new ObjectIntMultiColumnSortKernelContext<>(size);
    }
    ...
    static <SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> void sort(
            ObjectIntMultiColumnSortKernelContext<SORT_VALUES_ATTR, PERMUTE_VALUES_ATTR> context,
    ...
    private static int upperBound(ObjectChunk<Object, ?> valuesToSort0, IntChunk<?> valuesToSort1,
            int lo, int hi, Object searchValue0, int searchValue1) {
    ...
    private static int lowerBound(ObjectChunk<Object, ?> valuesToSort0, IntChunk<?> valuesToSort1,
            int lo, int hi, Object searchValue0, int searchValue1) {
    ...
    private static int bound(ObjectChunk<Object, ?> valuesToSort0, IntChunk<?> valuesToSort1,
            int lo, int hi, Object searchValue0, int searchValue1, final boolean lower) {
    ...
    private static void insertionSort(WritableLongChunk<?> valuesToPermute,
            WritableObjectChunk<Object, ?> valuesToSort0, WritableIntChunk<?> valuesToSort1,
    ...
    private static void swap(WritableLongChunk<?> valuesToPermute,
            WritableObjectChunk<Object, ?> valuesToSort0, WritableIntChunk<?> valuesToSort1, int a,
            int b) {
    ...
    public static class ObjectIntMultiColumnSortKernelContext<SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> implements MultiColumnSortKernel<PERMUTE_VALUES_ATTR> {
        int minGallop;
        ...
        private ObjectIntMultiColumnSortKernelContext(int size) {
        ...
        public void sort(WritableLongChunk<PERMUTE_VALUES_ATTR> valuesToPermute,
            ...
            ObjectIntMultiColumnTimsortKernel.sort(this, valuesToPermute,
