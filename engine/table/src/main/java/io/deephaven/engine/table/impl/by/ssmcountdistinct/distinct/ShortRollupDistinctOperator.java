 ...
 */
public class ShortRollupDistinctOperator implements IterativeChunkedAggregationOperator {
    ...
    private UpdateCommitter<ShortRollupDistinctOperator> prevFlusher = null;
    private WritableRowSet touchedStates;

    public ShortRollupDistinctOperator(
            // region Constructor
    ...
    public void startTrackingPrevValues() {
        ...
        prevFlusher = new UpdateCommitter<>(this, ExecutionContext.getContext().getUpdateGraph(),
                ShortRollupDistinctOperator::flushPrevious);
        touchedStates = RowSetFactory.empty();
        internalResult.startTrackingPrevValues();
    }

    private static void flushPrevious(ShortRollupDistinctOperator op) {
