...
final class IncrementalAggHasherShortInt extends IncrementalChunkedOperatorAggregationStateManagerTypedBase {
    ...
    public IncrementalAggHasherShortInt(ColumnSource[] tableKeySources,
    ...
    private boolean findOverflow(HashHandler handler, short k0, int k1, int chunkPosition,
