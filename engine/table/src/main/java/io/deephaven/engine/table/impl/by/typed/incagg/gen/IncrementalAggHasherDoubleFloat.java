...
final class IncrementalAggHasherDoubleFloat extends IncrementalChunkedOperatorAggregationStateManagerTypedBase {
    ...
    public IncrementalAggHasherDoubleFloat(ColumnSource[] tableKeySources,
