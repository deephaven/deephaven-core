...
final class IncrementalAggOpenHasherWithTombstoneLongObject extends IncrementalChunkedOperatorAggregationStateManagerOpenAddressedBaseWithTombstones {
    ...
    public IncrementalAggOpenHasherWithTombstoneLongObject(ColumnSource[] tableKeySources,
