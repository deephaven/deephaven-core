...
final class IncrementalAggOpenHasherWithTombstoneFloatShort extends IncrementalChunkedOperatorAggregationStateManagerOpenAddressedBaseWithTombstones {
    ...
    public IncrementalAggOpenHasherWithTombstoneFloatShort(ColumnSource[] tableKeySources,
