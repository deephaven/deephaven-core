...
final class IncrementalAggHasherChar extends IncrementalChunkedOperatorAggregationStateManagerTypedBase {
    private final CharacterArraySource mainKeySource0;

    private final CharacterArraySource overflowKeySource0;

    public IncrementalAggHasherChar(ColumnSource[] tableKeySources,
