...
final class StaticAggHasherDoubleObject extends StaticChunkedOperatorAggregationStateManagerTypedBase {
    ...
    public StaticAggHasherDoubleObject(ColumnSource[] tableKeySources,
