...
public final class ByteOneOrN {
    ...
    private static final int ELEMENT_SIZE = Byte.BYTES;
    ...
    static public final class Block0 {
        ...
        /**
         * Called by the {@link io.deephaven.engine.table.impl.sources.ByteSparseArraySource} at the end of a cycle
         ...
         */
         public void clearLowestLevelBlocks(final RowSet blocksToClear,
                                           final SoftRecycler<byte[]> recycler) {
         ...
         */
         public void clearBlocks2(final RowSet blocks2ToClear,
                                           final SoftRecycler<byte[][]> recycler2) {
         ...
         */
        private void clearOneLowestLevelBlock(final long block2Idx, final SoftRecycler<byte[]> recycler) {
         ...
         * @param recycler recycler for lowest level blocks
         */
        private void clearOneBlock_2(final long block1Idx, final SoftRecycler<byte[][]> recycler) {
    ...
    static public final class Block1 {
         ...
         */
        private void clearByIndex(final int idx, final SoftRecycler<byte[][]> recycler2) {
            Assert.neq(idx, "idx", HAVE_MORE_THAN_ONE, "HAVE_MORE_THAN_ONE");
            if (oneIndex == idx) {
    ...
    static public final class Block2 {
        ...
        long estimateSize() {
            ...
            if (oneIndex != HAVE_MORE_THAN_ONE) {
                return (long)oneValue.length * Byte.BYTES;
            }
