...
final class StaticAggHasherCharInt extends StaticChunkedOperatorAggregationStateManagerTypedBase {
    ...
    public StaticAggHasherCharInt(ColumnSource[] tableKeySources,
