 ...
 * key.
 */
public final class CharReverseSegmentedSortedArray implements SegmentedSortedArray {
    ...
    /**
     * Create a CharReverseSegmentedSortedArray with the given leafSize.
     *
     * @param leafSize the maximumSize for any leaf
     */
    public CharReverseSegmentedSortedArray(int leafSize) {
