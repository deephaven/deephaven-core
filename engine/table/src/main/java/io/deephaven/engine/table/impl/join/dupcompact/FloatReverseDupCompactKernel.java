...
// ****** Edit FloatReverseDupCompactKernel and run "./gradlew replicateDupCompactKernel" to regenerate
//
// @formatter:off
...
public class FloatReverseDupCompactKernel implements DupCompactKernel {
    ...
    public int compactDuplicates(
        ...
        return compactDuplicates(chunkToCompact.asWritableFloatChunk(), rowKeys);
    }
    ...
    public int compactDuplicatesPreferFirst(
        ...
        return compactDuplicatesPreferFirst(chunkToCompact.asWritableFloatChunk(), chunkPositions);
    }
