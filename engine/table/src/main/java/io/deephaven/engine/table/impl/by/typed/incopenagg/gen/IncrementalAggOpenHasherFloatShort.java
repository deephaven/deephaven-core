...
final class IncrementalAggOpenHasherFloatShort extends IncrementalChunkedOperatorAggregationStateManagerOpenAddressedBase {
    ...
    public IncrementalAggOpenHasherFloatShort(ColumnSource[] tableKeySources,
