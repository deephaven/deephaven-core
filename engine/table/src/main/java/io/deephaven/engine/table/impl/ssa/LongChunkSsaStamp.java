...
public class LongChunkSsaStamp implements ChunkSsaStamp {
    ...
    private static void processEntry(LongChunk<Values> leftStampValues, Chunk<RowKeys> leftStampKeys, LongSegmentedSortedArray ssa, WritableLongChunk<RowKeys> rightKeysForLeft, boolean disallowExactMatch) {
