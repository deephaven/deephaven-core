 ...
 */
public class IntRollupDistinctOperator implements IterativeChunkedAggregationOperator {
    ...
    private UpdateCommitter<IntRollupDistinctOperator> prevFlusher = null;
    private WritableRowSet touchedStates;

    public IntRollupDistinctOperator(
            // region Constructor
    ...
    public void startTrackingPrevValues() {
        ...
        prevFlusher = new UpdateCommitter<>(this, ExecutionContext.getContext().getUpdateGraph(),
                IntRollupDistinctOperator::flushPrevious);
        touchedStates = RowSetFactory.empty();
        internalResult.startTrackingPrevValues();
    }

    private static void flushPrevious(IntRollupDistinctOperator op) {
