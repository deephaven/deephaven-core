...
final class StaticAggHasherFloatShort extends StaticChunkedOperatorAggregationStateManagerTypedBase {
    ...
    public StaticAggHasherFloatShort(ColumnSource[] tableKeySources,
