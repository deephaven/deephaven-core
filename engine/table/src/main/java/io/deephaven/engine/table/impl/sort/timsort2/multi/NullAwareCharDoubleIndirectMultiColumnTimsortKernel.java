 ...
 */
public final class NullAwareCharDoubleIndirectMultiColumnTimsortKernel {
    private NullAwareCharDoubleIndirectMultiColumnTimsortKernel() {
        throw new UnsupportedOperationException();
    }

    public static <PERMUTE_VALUES_ATTR extends Any> NullAwareCharDoubleIndirectMultiColumnSortKernelContext<PERMUTE_VALUES_ATTR> createContext(
            final int size) {
        return new NullAwareCharDoubleIndirectMultiColumnSortKernelContext<>(size);
    }
    ...
    private static void timSort(NullAwareCharDoubleIndirectMultiColumnSortKernelContext<?> context,
            WritableIntChunk<ChunkPositions> positions, CharChunk<?> valuesToSort0,
     ...
     */
    private static int compareColumns(CharChunk<?> valuesToSort0, DoubleChunk<?> valuesToSort1,
    ...
    private static void ensureMergeInvariants(
            NullAwareCharDoubleIndirectMultiColumnSortKernelContext<?> context,
            WritableIntChunk<ChunkPositions> positions, CharChunk<?> valuesToSort0,
            DoubleChunk<?> valuesToSort1) {
        while (context.runCount > 1) {
    ...
    private static void merge(NullAwareCharDoubleIndirectMultiColumnSortKernelContext<?> context,
            WritableIntChunk<ChunkPositions> positions, CharChunk<?> valuesToSort0,
    ...
    private static void insertionSort(WritableIntChunk<ChunkPositions> positions,
            CharChunk<?> valuesToSort0, DoubleChunk<?> valuesToSort1, int offset, int length) {
    ...
    public static class NullAwareCharDoubleIndirectMultiColumnSortKernelContext<PERMUTE_VALUES_ATTR extends Any> implements MultiColumnSortKernel<PERMUTE_VALUES_ATTR> {
        int minGallop;
        ...
        private NullAwareCharDoubleIndirectMultiColumnSortKernelContext(int size) {
        ...
        public void sort(WritableLongChunk<PERMUTE_VALUES_ATTR> valuesToPermute,
            ...
            NullAwareCharDoubleIndirectMultiColumnTimsortKernel.sort(this, positions, valuesToSort[0].asCharChunk(), valuesToSort[1].asDoubleChunk());
