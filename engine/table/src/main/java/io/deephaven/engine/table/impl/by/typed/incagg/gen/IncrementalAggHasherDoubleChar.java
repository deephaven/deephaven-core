...
final class IncrementalAggHasherDoubleChar extends IncrementalChunkedOperatorAggregationStateManagerTypedBase {
    ...
    public IncrementalAggHasherDoubleChar(ColumnSource[] tableKeySources,
    ...
    private static int hash(double k0, char k1) {
    ...
    private boolean findOverflow(HashHandler handler, double k0, char k1, int chunkPosition,
