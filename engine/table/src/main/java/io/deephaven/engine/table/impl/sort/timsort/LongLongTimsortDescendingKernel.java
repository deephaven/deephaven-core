 ...
 */
public final class LongLongTimsortDescendingKernel {
    private LongLongTimsortDescendingKernel() {
    }

    public <SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> LongLongSortKernelContext<SORT_VALUES_ATTR, PERMUTE_VALUES_ATTR> createContextInstance(
            int size) {
        return new LongLongSortKernelContext<>(size);
    }

    public static <SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> LongLongSortKernelContext<SORT_VALUES_ATTR, PERMUTE_VALUES_ATTR> createContext(
            final int size) {
        return new LongLongTimsortDescendingKernel().createContextInstance(size);
    }
    ...
    static <SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> void sort(
            LongLongSortKernelContext<SORT_VALUES_ATTR, PERMUTE_VALUES_ATTR> context,
    ...
    private static <SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> void copyToChunk(
            LongChunk<PERMUTE_VALUES_ATTR> rowSetSource, LongChunk<SORT_VALUES_ATTR> valuesSource,
    ...
    public class LongLongSortKernelContext<SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> implements LongSortKernel<SORT_VALUES_ATTR, PERMUTE_VALUES_ATTR> {
        int minGallop;
        ...
        public void sort(WritableLongChunk<PERMUTE_VALUES_ATTR> valuesToPermute,
            ...
            LongLongTimsortDescendingKernel.this.sort(this, valuesToPermute, valuesToSort.asWritableLongChunk());
        }
        ...
        public void sort(WritableLongChunk<PERMUTE_VALUES_ATTR> valuesToPermute,
                ...
                IntChunk<? extends ChunkPositions> offsetsIn,
                IntChunk<? extends ChunkLengths> lengthsIn) {
            LongLongTimsortDescendingKernel.this.sort(this, valuesToPermute, valuesToSort.asWritableLongChunk(), offsetsIn, lengthsIn);
        }

        @Override
        public void sort(WritableLongChunk<PERMUTE_VALUES_ATTR> valuesToPermute,
                WritableChunk<SORT_VALUES_ATTR> valuesToSort, int offset, int length) {
            LongLongTimsortDescendingKernel.this.timSort(this, valuesToPermute, valuesToSort.asWritableLongChunk(), offset, length);
        }
        ...
        public void merge(WritableLongChunk<PERMUTE_VALUES_ATTR> valuesToPermute,
                ...
                int length2) {
            LongLongTimsortDescendingKernel.this.merge(this, valuesToPermute, valuesToSort.asWritableLongChunk(), start1, length1, length2);
        }
        ...
        private LongLongTimsortDescendingKernel kernel() {
            return LongLongTimsortDescendingKernel.this;
        }
    }
}
