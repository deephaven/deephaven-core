...
public class LongLongTimsortDescendingKernel {
    ...
    LongLongSortKernelContext<SORT_VALUES_ATTR, PERMUTE_VALUES_ATTR> createContext(int size) {
...
//    private static void doCheck(Chunk.LongChunk valuesToPermute, Chunk.LongChunk valuesToSort, int startCheck, int mergeEnd) {
//        long lastCheck;
