...
// ****** Edit LongLongTimsortDescendingKernel and run "./gradlew replicateSortKernel" to regenerate
//
// @formatter:off
...
public final class LongLongTimsortDescendingKernel {
    ...
    // region Context
    public class LongLongSortKernelContext<SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any>
    ...
    public <SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> LongLongSortKernelContext<SORT_VALUES_ATTR, PERMUTE_VALUES_ATTR> createContextInstance(int size) {
    ...
    public static <SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> LongLongSortKernelContext<SORT_VALUES_ATTR, PERMUTE_VALUES_ATTR> createContext(final int size) {
    ...
    static private void swap(WritableLongChunk<?> valuesToPermute, WritableLongChunk<?> valuesToSort, int a, int b) {
    ...
    // private static void doCheck(Chunk.LongChunk valuesToPermute, Chunk.LongChunk valuesToSort, int startCheck, int
    // mergeEnd) {
    // long lastCheck;
