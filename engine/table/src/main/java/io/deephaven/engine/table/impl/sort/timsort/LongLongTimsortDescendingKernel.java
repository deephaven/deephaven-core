...
public class LongLongTimsortDescendingKernel {
    ...
    // region Context
    public static class LongLongSortKernelContext<SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any>
        ...
        public void sort(
            ...
            LongLongTimsortDescendingKernel.sort(this, valuesToPermute, valuesToSort.asWritableLongChunk());
        }
        ...
        public void sort(
            ...
            LongLongTimsortDescendingKernel.sort(this, valuesToPermute, valuesToSort.asWritableLongChunk(), offsetsIn, lengthsIn);
        }
