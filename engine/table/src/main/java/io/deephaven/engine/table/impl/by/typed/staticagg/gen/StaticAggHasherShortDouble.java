...
final class StaticAggHasherShortDouble extends StaticChunkedOperatorAggregationStateManagerTypedBase {
    ...
    public StaticAggHasherShortDouble(ColumnSource[] tableKeySources,
