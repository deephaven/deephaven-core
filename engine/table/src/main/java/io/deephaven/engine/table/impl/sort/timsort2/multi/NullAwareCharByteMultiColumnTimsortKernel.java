...
/**
 * This implements a timsort kernel that sorts a multi-column key (NullAwareChar, Byte), comparing each
 ...
 */
public final class NullAwareCharByteMultiColumnTimsortKernel {
    private NullAwareCharByteMultiColumnTimsortKernel() {
        throw new UnsupportedOperationException();
    }

    public static <SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> NullAwareCharByteMultiColumnSortKernelContext<SORT_VALUES_ATTR, PERMUTE_VALUES_ATTR> createContext(
            final int size) {
        return new NullAwareCharByteMultiColumnSortKernelContext<>(size);
    }
    ...
    static <SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> void sort(
            NullAwareCharByteMultiColumnSortKernelContext<SORT_VALUES_ATTR, PERMUTE_VALUES_ATTR> context,
            WritableLongChunk<PERMUTE_VALUES_ATTR> valuesToPermute,
            WritableCharChunk<SORT_VALUES_ATTR> valuesToSort0,
            WritableByteChunk<SORT_VALUES_ATTR> valuesToSort1,
    ...
    private static <SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> void timSort(
            ...
            WritableLongChunk<PERMUTE_VALUES_ATTR> valuesToPermute,
            WritableCharChunk<SORT_VALUES_ATTR> valuesToSort0,
            WritableByteChunk<SORT_VALUES_ATTR> valuesToSort1, int offset, int length) {
        if (length <= 1) {
            return;
        }
    ...
    private static int doComparison1(byte lhs, byte rhs) {
    ...
    private static <SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> void merge(
            ...
            WritableLongChunk<PERMUTE_VALUES_ATTR> valuesToPermute,
            WritableCharChunk<SORT_VALUES_ATTR> valuesToSort0,
            WritableByteChunk<SORT_VALUES_ATTR> valuesToSort1, int start1, int length1,
            int length2) {
        ...
        final byte run2lo1 = valuesToSort1.get(start2);
        ...
        final byte run1hi1 = valuesToSort1.get(start1 + length1 - 1);
    ...
    private static <SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> void frontMerge(
            ...
            WritableLongChunk<PERMUTE_VALUES_ATTR> valuesToPermute,
            WritableCharChunk<SORT_VALUES_ATTR> valuesToSort0,
            WritableByteChunk<SORT_VALUES_ATTR> valuesToSort1, final int mergeStartPosition,
    ...
    private static <SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> void copyToTemporary(
            ...
            WritableLongChunk<PERMUTE_VALUES_ATTR> valuesToPermute,
            WritableCharChunk<SORT_VALUES_ATTR> valuesToSort0,
            WritableByteChunk<SORT_VALUES_ATTR> valuesToSort1, int mergeStartPosition,
            int remaining1) {
    ...
    private static <SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> void copyToChunk(
            ...
            ByteChunk<SORT_VALUES_ATTR> valuesSource1,
            WritableLongChunk<PERMUTE_VALUES_ATTR> permuteValuesDest,
            WritableCharChunk<SORT_VALUES_ATTR> sortValuesDest0,
            WritableByteChunk<SORT_VALUES_ATTR> sortValuesDest1, int sourceStart, int destStart,
            int length) {
    ...
    private static int upperBound(CharChunk<?> valuesToSort0, ByteChunk<?> valuesToSort1, int lo,
            int hi, char searchValue0, byte searchValue1) {
    ...
    private static int lowerBound(CharChunk<?> valuesToSort0, ByteChunk<?> valuesToSort1, int lo,
            int hi, char searchValue0, byte searchValue1) {
    ...
    private static int bound(CharChunk<?> valuesToSort0, ByteChunk<?> valuesToSort1, int lo, int hi,
            char searchValue0, byte searchValue1, final boolean lower) {
    ...
    private static void insertionSort(WritableLongChunk<?> valuesToPermute,
            WritableCharChunk<?> valuesToSort0, WritableByteChunk<?> valuesToSort1, int offset,
            int length) {
    ...
    private static void swap(WritableLongChunk<?> valuesToPermute,
            WritableCharChunk<?> valuesToSort0, WritableByteChunk<?> valuesToSort1, int a, int b) {
        final long tempPermuteValue = valuesToPermute.get(a);
        final char temp0 = valuesToSort0.get(a);
        final byte temp1 = valuesToSort1.get(a);
    ...
    public static class NullAwareCharByteMultiColumnSortKernelContext<SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> implements MultiColumnSortKernel<PERMUTE_VALUES_ATTR> {
        int minGallop;
        ...
        private final WritableByteChunk<SORT_VALUES_ATTR> temporaryValues1;

        private NullAwareCharByteMultiColumnSortKernelContext(int size) {
            temporaryKeys = WritableLongChunk.makeWritableChunk((size + 2) / 2);
            temporaryValues0 = WritableCharChunk.makeWritableChunk((size + 2) / 2);
            temporaryValues1 = WritableByteChunk.makeWritableChunk((size + 2) / 2);
        ...
        public void sort(WritableLongChunk<PERMUTE_VALUES_ATTR> valuesToPermute,
            ...
            NullAwareCharByteMultiColumnTimsortKernel.sort(this, valuesToPermute,
                            (WritableCharChunk<SORT_VALUES_ATTR>) valuesToSort[0].asWritableCharChunk(),
                            (WritableByteChunk<SORT_VALUES_ATTR>) valuesToSort[1].asWritableByteChunk());
        }
