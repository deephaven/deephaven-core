...
/**
 * This implements a timsort kernel that sorts a multi-column key (Object, NullAwareChar), comparing each
 ...
 */
public final class ObjectNullAwareCharMultiColumnTimsortKernel {
    private ObjectNullAwareCharMultiColumnTimsortKernel() {
        throw new UnsupportedOperationException();
    }

    public static <SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> ObjectNullAwareCharMultiColumnSortKernelContext<SORT_VALUES_ATTR, PERMUTE_VALUES_ATTR> createContext(
            final int size) {
        return new ObjectNullAwareCharMultiColumnSortKernelContext<>(size);
    }
    ...
    static <SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> void sort(
            ObjectNullAwareCharMultiColumnSortKernelContext<SORT_VALUES_ATTR, PERMUTE_VALUES_ATTR> context,
            WritableLongChunk<PERMUTE_VALUES_ATTR> valuesToPermute,
            WritableObjectChunk<Object, SORT_VALUES_ATTR> valuesToSort0,
    ...
    private static <SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> void timSort(
        ...
        while (startRun < offset + length) {
            Object current0 = valuesToSort0.get(startRun);
            ...
            if (startRun + 1 == offset + length) {
                ...
                Object next0 = valuesToSort0.get(startRun + 1);
                endRun = startRun + 2;
    ...
    private static <SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> void merge(
        ...
        final Object run2lo0 = valuesToSort0.get(start2);
        ...
        final Object run1hi0 = valuesToSort0.get(start1 + length1 - 1);
    ...
    private static <SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> void frontMerge(
        ...
        Object val1_0 = context.temporaryValues0.get(tempCursor);
        Object val2_0 = valuesToSort0.get(run2Cursor);
    ...
    private static <SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> void backMerge(
        ...
        Object val1_0 = valuesToSort0.get(run1Cursor);
        Object val2_0 = context.temporaryValues0.get(tempCursor);
    ...
    private static <SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> void copyToChunk(
            ...
            ObjectChunk<Object, SORT_VALUES_ATTR> valuesSource0,
            CharChunk<SORT_VALUES_ATTR> valuesSource1,
            WritableLongChunk<PERMUTE_VALUES_ATTR> permuteValuesDest,
            WritableObjectChunk<Object, SORT_VALUES_ATTR> sortValuesDest0,
    ...
    private static int upperBound(ObjectChunk<Object, ?> valuesToSort0, CharChunk<?> valuesToSort1,
            int lo, int hi, Object searchValue0, char searchValue1) {
    ...
    private static int lowerBound(ObjectChunk<Object, ?> valuesToSort0, CharChunk<?> valuesToSort1,
            int lo, int hi, Object searchValue0, char searchValue1) {
    ...
    private static int bound(ObjectChunk<Object, ?> valuesToSort0, CharChunk<?> valuesToSort1,
            int lo, int hi, Object searchValue0, char searchValue1, final boolean lower) {
    ...
    private static void insertionSort(WritableLongChunk<?> valuesToPermute,
            WritableObjectChunk<Object, ?> valuesToSort0, WritableCharChunk<?> valuesToSort1,
    ...
    private static void swap(WritableLongChunk<?> valuesToPermute,
            WritableObjectChunk<Object, ?> valuesToSort0, WritableCharChunk<?> valuesToSort1, int a,
            int b) {
        final long tempPermuteValue = valuesToPermute.get(a);
        final Object temp0 = valuesToSort0.get(a);
    ...
    public static class ObjectNullAwareCharMultiColumnSortKernelContext<SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> implements MultiColumnSortKernel<PERMUTE_VALUES_ATTR> {
        int minGallop;
        ...
        private final WritableObjectChunk<Object, SORT_VALUES_ATTR> temporaryValues0;

        private final WritableCharChunk<SORT_VALUES_ATTR> temporaryValues1;

        private ObjectNullAwareCharMultiColumnSortKernelContext(int size) {
            temporaryKeys = WritableLongChunk.makeWritableChunk((size + 2) / 2);
            temporaryValues0 = WritableObjectChunk.makeWritableChunk((size + 2) / 2);
        ...
        public void sort(WritableLongChunk<PERMUTE_VALUES_ATTR> valuesToPermute,
            ...
            ObjectNullAwareCharMultiColumnTimsortKernel.sort(this, valuesToPermute,
                            (WritableObjectChunk<Object, SORT_VALUES_ATTR>) valuesToSort[0].asWritableObjectChunk(),
