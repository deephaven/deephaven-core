...
final class IncrementalAggHasherShortByte extends IncrementalChunkedOperatorAggregationStateManagerTypedBase {
    ...
    public IncrementalAggHasherShortByte(ColumnSource[] tableKeySources,
    ...
    private boolean findOverflow(HashHandler handler, short k0, byte k1, int chunkPosition,
