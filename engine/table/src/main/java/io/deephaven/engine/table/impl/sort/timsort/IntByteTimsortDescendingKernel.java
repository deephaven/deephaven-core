...
public class IntByteTimsortDescendingKernel {
    ...
    // region Context
    public static class IntByteSortKernelContext<SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any>
        ...
        public void sort(
            ...
            IntByteTimsortDescendingKernel.sort(this, valuesToPermute, valuesToSort.asWritableIntChunk());
        }
        ...
        public void sort(
            ...
            IntByteTimsortDescendingKernel.sort(this, valuesToPermute, valuesToSort.asWritableIntChunk(), offsetsIn, lengthsIn);
        }
    ...
    IntByteSortKernelContext<SORT_VALUES_ATTR, PERMUTE_VALUES_ATTR> createContext(int size) {
...
//    private static void doCheck(Chunk.ByteChunk valuesToPermute, Chunk.IntChunk valuesToSort, int startCheck, int mergeEnd) {
//        int lastCheck;
