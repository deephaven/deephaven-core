...
public final class IntByteTimsortDescendingKernel {
    ...
    public class IntByteSortKernelContext<SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> implements ByteSortKernel<SORT_VALUES_ATTR, PERMUTE_VALUES_ATTR> {
        ...
        public void sort(WritableByteChunk<PERMUTE_VALUES_ATTR> valuesToPermute,
            ...
            IntByteTimsortDescendingKernel.this.sort(this, valuesToPermute, valuesToSort.asWritableIntChunk());
        }
        ...
        public void sort(WritableByteChunk<PERMUTE_VALUES_ATTR> valuesToPermute,
            ...
            IntByteTimsortDescendingKernel.this.timSort(this, valuesToPermute, valuesToSort.asWritableIntChunk(), offset, length);
        }
        ...
        public void merge(WritableByteChunk<PERMUTE_VALUES_ATTR> valuesToPermute,
                ...
                int length2) {
            IntByteTimsortDescendingKernel.this.merge(this, valuesToPermute, valuesToSort.asWritableIntChunk(), start1, length1, length2);
        }
        ...
        private IntByteTimsortDescendingKernel kernel() {
            return IntByteTimsortDescendingKernel.this;
        }
    }
}
