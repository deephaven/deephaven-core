...
final class IncrementalAggOpenHasherWithTombstoneByteDouble extends IncrementalChunkedOperatorAggregationStateManagerOpenAddressedBaseWithTombstones {
    ...
    public IncrementalAggOpenHasherWithTombstoneByteDouble(ColumnSource[] tableKeySources,
