...
/**
 * This implements a timsort kernel that sorts a multi-column key (Long, Long), comparing each
 ...
 */
public final class LongLongMultiColumnTimsortKernel {
    private LongLongMultiColumnTimsortKernel() {
        throw new UnsupportedOperationException();
    }

    public static <SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> LongLongMultiColumnSortKernelContext<SORT_VALUES_ATTR, PERMUTE_VALUES_ATTR> createContext(
            final int size) {
        return new LongLongMultiColumnSortKernelContext<>(size);
    }
    ...
    static <SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> void sort(
            LongLongMultiColumnSortKernelContext<SORT_VALUES_ATTR, PERMUTE_VALUES_ATTR> context,
    ...
    private static int upperBound(LongChunk<?> valuesToSort0, LongChunk<?> valuesToSort1, int lo,
            int hi, long searchValue0, long searchValue1) {
    ...
    private static int lowerBound(LongChunk<?> valuesToSort0, LongChunk<?> valuesToSort1, int lo,
            int hi, long searchValue0, long searchValue1) {
    ...
    private static int bound(LongChunk<?> valuesToSort0, LongChunk<?> valuesToSort1, int lo, int hi,
            long searchValue0, long searchValue1, final boolean lower) {
    ...
    private static void insertionSort(WritableLongChunk<?> valuesToPermute,
            WritableLongChunk<?> valuesToSort0, WritableLongChunk<?> valuesToSort1, int offset,
            int length) {
    ...
    private static void swap(WritableLongChunk<?> valuesToPermute,
            WritableLongChunk<?> valuesToSort0, WritableLongChunk<?> valuesToSort1, int a, int b) {
    ...
    public static class LongLongMultiColumnSortKernelContext<SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> implements MultiColumnSortKernel<PERMUTE_VALUES_ATTR> {
        int minGallop;
        ...
        private LongLongMultiColumnSortKernelContext(int size) {
        ...
        public void sort(WritableLongChunk<PERMUTE_VALUES_ATTR> valuesToPermute,
            ...
            LongLongMultiColumnTimsortKernel.sort(this, valuesToPermute,
