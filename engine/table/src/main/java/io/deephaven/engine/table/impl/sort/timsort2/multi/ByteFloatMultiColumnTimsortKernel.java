...
/**
 * This implements a timsort kernel that sorts a multi-column key (Byte, Float), comparing each
 ...
 */
public final class ByteFloatMultiColumnTimsortKernel {
    private ByteFloatMultiColumnTimsortKernel() {
        throw new UnsupportedOperationException();
    }

    public static <SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> ByteFloatMultiColumnSortKernelContext<SORT_VALUES_ATTR, PERMUTE_VALUES_ATTR> createContext(
            final int size) {
        return new ByteFloatMultiColumnSortKernelContext<>(size);
    }
    ...
    static <SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> void sort(
            ByteFloatMultiColumnSortKernelContext<SORT_VALUES_ATTR, PERMUTE_VALUES_ATTR> context,
    ...
    private static int upperBound(ByteChunk<?> valuesToSort0, FloatChunk<?> valuesToSort1, int lo,
            int hi, byte searchValue0, float searchValue1) {
    ...
    private static int lowerBound(ByteChunk<?> valuesToSort0, FloatChunk<?> valuesToSort1, int lo,
            int hi, byte searchValue0, float searchValue1) {
    ...
    private static int bound(ByteChunk<?> valuesToSort0, FloatChunk<?> valuesToSort1, int lo,
            int hi, byte searchValue0, float searchValue1, final boolean lower) {
    ...
    private static void insertionSort(WritableLongChunk<?> valuesToPermute,
            WritableByteChunk<?> valuesToSort0, WritableFloatChunk<?> valuesToSort1, int offset,
            int length) {
    ...
    private static void swap(WritableLongChunk<?> valuesToPermute,
            WritableByteChunk<?> valuesToSort0, WritableFloatChunk<?> valuesToSort1, int a, int b) {
    ...
    public static class ByteFloatMultiColumnSortKernelContext<SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> implements MultiColumnSortKernel<PERMUTE_VALUES_ATTR> {
        int minGallop;
        ...
        private ByteFloatMultiColumnSortKernelContext(int size) {
        ...
        public void sort(WritableLongChunk<PERMUTE_VALUES_ATTR> valuesToPermute,
            ...
            ByteFloatMultiColumnTimsortKernel.sort(this, valuesToPermute,
