...
final class IncrementalAggHasherObjectByte extends IncrementalChunkedOperatorAggregationStateManagerTypedBase {
    ...
    public IncrementalAggHasherObjectByte(ColumnSource[] tableKeySources,
    ...
    private static int hash(Object k0, byte k1) {
    ...
    private boolean findOverflow(HashHandler handler, Object k0, byte k1, int chunkPosition,
