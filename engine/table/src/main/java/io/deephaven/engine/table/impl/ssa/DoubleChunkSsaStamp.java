...
public class DoubleChunkSsaStamp implements ChunkSsaStamp {
    ...
    private static void processEntry(DoubleChunk<Values> leftStampValues, Chunk<RowKeys> leftStampKeys, DoubleSegmentedSortedArray ssa, WritableLongChunk<RowKeys> rightKeysForLeft, boolean disallowExactMatch) {
