...
final class IncrementalAggHasherByteFloat extends IncrementalChunkedOperatorAggregationStateManagerTypedBase {
    ...
    public IncrementalAggHasherByteFloat(ColumnSource[] tableKeySources,
    ...
    private boolean findOverflow(HashHandler handler, byte k0, float k1, int chunkPosition,
