...
final class IncrementalAggOpenHasherShortByte extends IncrementalChunkedOperatorAggregationStateManagerOpenAddressedBase {
    ...
    public IncrementalAggOpenHasherShortByte(ColumnSource[] tableKeySources,
