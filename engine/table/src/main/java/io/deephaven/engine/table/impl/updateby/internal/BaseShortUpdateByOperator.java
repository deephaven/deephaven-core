...
public abstract class BaseShortUpdateByOperator implements UpdateByOperator {
    ...
    protected ShortArraySource bucketLastVal;

    /** These are only used in grouped operations */
    protected short singletonVal;
    ...
    protected class Context implements UpdateContext {
        ...
        public short curVal = QueryConstants.NULL_SHORT;
    ...
    public BaseShortUpdateByOperator(@NotNull final MatchPair pair,
        ...
        this.singletonVal = QueryConstants.NULL_SHORT;
    }
    ...
    public void initializeForUpdate(@NotNull final UpdateContext context,
        ...
        if(!initialized) {
            ...
            if(usingBuckets) {
                ...
                this.bucketLastVal = new ShortArraySource();
    ...
    public void onBucketsRemoved(@NotNull final RowSet removedBuckets) {
        if(bucketLastVal != null) {
            ...
            singletonVal = QueryConstants.NULL_SHORT;
        }
    }
    ...
    public void resetForReprocess(@NotNull final UpdateContext context,
        ...
        final Context ctx = (Context) context;
        if(!ctx.canProcessDirectly) {
            singletonVal = firstUnmodifiedKey == NULL_ROW_KEY ? QueryConstants.NULL_SHORT : outputSource.getShort(firstUnmodifiedKey);
        }
    }
