...
/**
 * This implements a timsort kernel that sorts a multi-column key (NullAwareChar, Double), comparing each
 ...
 */
public final class NullAwareCharDoubleMultiColumnTimsortKernel {
    private NullAwareCharDoubleMultiColumnTimsortKernel() {
        throw new UnsupportedOperationException();
    }

    public static <SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> NullAwareCharDoubleMultiColumnSortKernelContext<SORT_VALUES_ATTR, PERMUTE_VALUES_ATTR> createContext(
            final int size) {
        return new NullAwareCharDoubleMultiColumnSortKernelContext<>(size);
    }
    ...
    static <SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> void sort(
            NullAwareCharDoubleMultiColumnSortKernelContext<SORT_VALUES_ATTR, PERMUTE_VALUES_ATTR> context,
    ...
    private static int upperBound(CharChunk<?> valuesToSort0, DoubleChunk<?> valuesToSort1, int lo,
            int hi, char searchValue0, double searchValue1) {
    ...
    private static int lowerBound(CharChunk<?> valuesToSort0, DoubleChunk<?> valuesToSort1, int lo,
            int hi, char searchValue0, double searchValue1) {
    ...
    private static int bound(CharChunk<?> valuesToSort0, DoubleChunk<?> valuesToSort1, int lo,
            int hi, char searchValue0, double searchValue1, final boolean lower) {
    ...
    private static void insertionSort(WritableLongChunk<?> valuesToPermute,
            WritableCharChunk<?> valuesToSort0, WritableDoubleChunk<?> valuesToSort1, int offset,
            int length) {
    ...
    private static void swap(WritableLongChunk<?> valuesToPermute,
            WritableCharChunk<?> valuesToSort0, WritableDoubleChunk<?> valuesToSort1, int a,
            int b) {
    ...
    public static class NullAwareCharDoubleMultiColumnSortKernelContext<SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> implements MultiColumnSortKernel<PERMUTE_VALUES_ATTR> {
        int minGallop;
        ...
        private NullAwareCharDoubleMultiColumnSortKernelContext(int size) {
        ...
        public void sort(WritableLongChunk<PERMUTE_VALUES_ATTR> valuesToPermute,
            ...
            NullAwareCharDoubleMultiColumnTimsortKernel.sort(this, valuesToPermute,
