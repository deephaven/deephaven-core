...
final class StaticAggHasherByteFloat extends StaticChunkedOperatorAggregationStateManagerTypedBase {
    ...
    public StaticAggHasherByteFloat(ColumnSource[] tableKeySources,
