...
public class DoubleLongMegaMergeKernel {
    ...
    // region Context
    public static class DoubleLongMegaMergeKernelContext<ATTR extends Any, KEY_INDICES extends Indices>
        ...
        public void merge(LongArraySource indexDestinationSource, ArrayBackedColumnSource<?> valuesDestinationSource,
            ...
            DoubleLongMegaMergeKernel.merge(indexDestinationSource, (DoubleArraySource) valuesDestinationSource,
