...
public final class DoubleOneOrN {
    private static final int REFERENCE_SIZE = 8;
    private static final int ELEMENT_SIZE = Double.BYTES;

    private static final int ONE_UNINITIALIZED = -1;
    private static final int HAVE_MORE_THAN_ONE = -2;

    private DoubleOneOrN() {
        throw new IllegalStateException("DoubleOneOrN class should never be constructed.");
    }
    ...
    static public final class Block0 {
        ...
        /**
         * Called by the {@link io.deephaven.engine.table.impl.sources.DoubleSparseArraySource} at the end of a cycle
         ...
         */
         public void clearLowestLevelBlocks(final RowSet blocksToClear,
                                           final SoftRecycler<double[]> recycler) {
         ...
         */
         public void clearBlocks2(final RowSet blocks2ToClear,
                                           final SoftRecycler<double[][]> recycler2) {
         ...
         */
        private void clearOneLowestLevelBlock(final long block2Idx, final SoftRecycler<double[]> recycler) {
         ...
         * @param recycler recycler for lowest level blocks
         */
        private void clearOneBlock_2(final long block1Idx, final SoftRecycler<double[][]> recycler) {
        ...
        public double [] getInnermostBlockByKeyOrNull(long key) {
        ...
        public void enumerate(double nullValue, LongConsumer consumer) {
            if (oneIndex == ONE_UNINITIALIZED) {
                return;
            }
    ...
    static public final class Block1 {
        ...
        void enumerate(double nullValue, LongConsumer consumer, long offset) {
            if (oneIndex == ONE_UNINITIALIZED) {
                return;
            }
            if (oneIndex != HAVE_MORE_THAN_ONE) {
         ...
         */
        private void clearByIndex(final int idx, final SoftRecycler<double[][]> recycler2) {
            Assert.neq(idx, "idx", HAVE_MORE_THAN_ONE, "HAVE_MORE_THAN_ONE");
            if (oneIndex == idx) {
    ...
    static public final class Block2 {
        ...
        public void ensureIndex(int idx, SoftRecycler<double [][]> recycler) {
            if (oneIndex == idx || oneIndex == HAVE_MORE_THAN_ONE) {
                return;
            }
            if (oneIndex == ONE_UNINITIALIZED) {
        ...
        public void maybeRecycle(SoftRecycler<double [][]> recycler) {
            if (array != null) {
                recycler.returnItem(array);
            }
        }
        ...
        private static void enumerateInner(double nullValue, double[] inner, LongConsumer consumer, long offset) {
        ...
        long estimateSize() {
            ...
            if (oneIndex != HAVE_MORE_THAN_ONE) {
                return (long)oneValue.length * Double.BYTES;
            }
