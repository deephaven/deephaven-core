...
/**
 * This implements a timsort kernel that sorts a multi-column key (Long, Short), comparing each
 ...
 */
public final class LongShortMultiColumnTimsortKernel {
    private LongShortMultiColumnTimsortKernel() {
        throw new UnsupportedOperationException();
    }

    public static <SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> LongShortMultiColumnSortKernelContext<SORT_VALUES_ATTR, PERMUTE_VALUES_ATTR> createContext(
            final int size) {
        return new LongShortMultiColumnSortKernelContext<>(size);
    }
    ...
    static <SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> void sort(
            LongShortMultiColumnSortKernelContext<SORT_VALUES_ATTR, PERMUTE_VALUES_ATTR> context,
    ...
    private static int upperBound(LongChunk<?> valuesToSort0, ShortChunk<?> valuesToSort1, int lo,
            int hi, long searchValue0, short searchValue1) {
    ...
    private static int lowerBound(LongChunk<?> valuesToSort0, ShortChunk<?> valuesToSort1, int lo,
            int hi, long searchValue0, short searchValue1) {
    ...
    private static int bound(LongChunk<?> valuesToSort0, ShortChunk<?> valuesToSort1, int lo,
            int hi, long searchValue0, short searchValue1, final boolean lower) {
    ...
    private static void insertionSort(WritableLongChunk<?> valuesToPermute,
            WritableLongChunk<?> valuesToSort0, WritableShortChunk<?> valuesToSort1, int offset,
            int length) {
    ...
    private static void swap(WritableLongChunk<?> valuesToPermute,
            WritableLongChunk<?> valuesToSort0, WritableShortChunk<?> valuesToSort1, int a, int b) {
    ...
    public static class LongShortMultiColumnSortKernelContext<SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> implements MultiColumnSortKernel<PERMUTE_VALUES_ATTR> {
        int minGallop;
        ...
        private LongShortMultiColumnSortKernelContext(int size) {
        ...
        public void sort(WritableLongChunk<PERMUTE_VALUES_ATTR> valuesToPermute,
            ...
            LongShortMultiColumnTimsortKernel.sort(this, valuesToPermute,
