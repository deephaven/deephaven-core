...
final class StaticAggHasherLongShort extends StaticChunkedOperatorAggregationStateManagerTypedBase {
    ...
    public StaticAggHasherLongShort(ColumnSource[] tableKeySources,
