...
final class StaticAggHasherCharLong extends StaticChunkedOperatorAggregationStateManagerTypedBase {
    ...
    public StaticAggHasherCharLong(ColumnSource[] tableKeySources,
