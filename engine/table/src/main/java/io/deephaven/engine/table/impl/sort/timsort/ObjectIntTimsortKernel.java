 ...
 */
public final class ObjectIntTimsortKernel {
    private ObjectIntTimsortKernel() {
    }

    public <SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> ObjectIntSortKernelContext<SORT_VALUES_ATTR, PERMUTE_VALUES_ATTR> createContextInstance(
            int size) {
        return new ObjectIntSortKernelContext<>(size);
    }

    public static <SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> ObjectIntSortKernelContext<SORT_VALUES_ATTR, PERMUTE_VALUES_ATTR> createContext(
            final int size) {
        return new ObjectIntTimsortKernel().createContextInstance(size);
    }
    ...
    static <SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> void sort(
            ObjectIntSortKernelContext<SORT_VALUES_ATTR, PERMUTE_VALUES_ATTR> context,
    ...
    private <SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> void timSort(
            ObjectIntSortKernelContext<SORT_VALUES_ATTR, PERMUTE_VALUES_ATTR> context,
            WritableIntChunk<PERMUTE_VALUES_ATTR> valuesToPermute,
            WritableObjectChunk<Object, SORT_VALUES_ATTR> valuesToSort, int offset, int length) {
        if (length <= 1) {
            return;
        }
    ...
    private <SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> void merge(
            ObjectIntSortKernelContext<SORT_VALUES_ATTR, PERMUTE_VALUES_ATTR> context,
            WritableIntChunk<PERMUTE_VALUES_ATTR> valuesToPermute,
            WritableObjectChunk<Object, SORT_VALUES_ATTR> valuesToSort, int start1, int length1,
            int length2) {
    ...
    private static <SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> void copyToTemporary(
            ObjectIntSortKernelContext<SORT_VALUES_ATTR, PERMUTE_VALUES_ATTR> context,
            WritableIntChunk<PERMUTE_VALUES_ATTR> valuesToPermute,
            WritableObjectChunk<Object, SORT_VALUES_ATTR> valuesToSort, int mergeStartPosition,
            int remaining1) {
    ...
    private static <SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> void copyToChunk(
            ...
            WritableObjectChunk<Object, SORT_VALUES_ATTR> sortValuesDest, int sourceStart,
    ...
    private int upperBound(ObjectChunk<Object, ?> valuesToSort, int lo, int hi,
            Object searchValue) {
    ...
    private int lowerBound(ObjectChunk<Object, ?> valuesToSort, int lo, int hi,
            Object searchValue) {
    ...
    private int bound(ObjectChunk<Object, ?> valuesToSort, int lo, int hi, Object searchValue,
            final boolean lower) {
        // lt or leq
    ...
    private void insertionSort(WritableIntChunk<?> valuesToPermute,
            WritableObjectChunk<Object, ?> valuesToSort, int offset, int length) {
    ...
    private static void swap(WritableIntChunk<?> valuesToPermute,
            WritableObjectChunk<Object, ?> valuesToSort, int a, int b) {
    ...
    public class ObjectIntSortKernelContext<SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> implements IntSortKernel<SORT_VALUES_ATTR, PERMUTE_VALUES_ATTR> {
        int minGallop;
        ...
        public void sort(WritableIntChunk<PERMUTE_VALUES_ATTR> valuesToPermute,
            ...
            ObjectIntTimsortKernel.this.sort(this, valuesToPermute, valuesToSort.asWritableObjectChunk());
        }
        ...
        public void sort(WritableIntChunk<PERMUTE_VALUES_ATTR> valuesToPermute,
                ...
                IntChunk<? extends ChunkPositions> offsetsIn,
                IntChunk<? extends ChunkLengths> lengthsIn) {
            ObjectIntTimsortKernel.this.sort(this, valuesToPermute, valuesToSort.asWritableObjectChunk(), offsetsIn, lengthsIn);
        }

        @Override
        public void sort(WritableIntChunk<PERMUTE_VALUES_ATTR> valuesToPermute,
                WritableChunk<SORT_VALUES_ATTR> valuesToSort, int offset, int length) {
            ObjectIntTimsortKernel.this.timSort(this, valuesToPermute, valuesToSort.asWritableObjectChunk(), offset, length);
        }
        ...
        public void merge(WritableIntChunk<PERMUTE_VALUES_ATTR> valuesToPermute,
                ...
                int length2) {
            ObjectIntTimsortKernel.this.merge(this, valuesToPermute, valuesToSort.asWritableObjectChunk(), start1, length1, length2);
        }
        ...
        private ObjectIntTimsortKernel kernel() {
            return ObjectIntTimsortKernel.this;
        }
    }
}
