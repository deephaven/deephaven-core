...
public class ObjectIntTimsortKernel {
    ...
    ObjectIntSortKernelContext<SORT_VALUES_ATTR, PERMUTE_VALUES_ATTR> createContext(int size) {
...
//    private static void doCheck(Chunk.IntChunk valuesToPermute, Chunk.ObjectChunk valuesToSort, int startCheck, int mergeEnd) {
//        Object lastCheck;
