...
public final class ObjectIntTimsortKernel {
    ...
    // region Context
    public class ObjectIntSortKernelContext<SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any>
    ...
    public <SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> ObjectIntSortKernelContext<SORT_VALUES_ATTR, PERMUTE_VALUES_ATTR> createContextInstance(int size) {
    ...
    public static <SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> ObjectIntSortKernelContext<SORT_VALUES_ATTR, PERMUTE_VALUES_ATTR> createContext(final int size) {
    ...
    static private void swap(WritableIntChunk<?> valuesToPermute, WritableObjectChunk<Object, ?> valuesToSort, int a, int b) {
    ...
    // private static void doCheck(Chunk.IntChunk valuesToPermute, Chunk.ObjectChunk valuesToSort, int startCheck, int
    // mergeEnd) {
    // Object lastCheck;
    ...
    // private static void dumpValues(Chunk.ObjectChunk valuesToSort, int start1, int length1, int start2, int length2,
    // String msg) {
