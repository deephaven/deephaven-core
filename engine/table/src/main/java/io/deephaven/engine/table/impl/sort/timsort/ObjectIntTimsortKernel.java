...
public class ObjectIntTimsortKernel {
    ...
    // region Context
    public static class ObjectIntSortKernelContext<SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any>
        ...
        public void sort(
            ...
            ObjectIntTimsortKernel.sort(this, valuesToPermute, valuesToSort.asWritableObjectChunk());
        }
        ...
        public void sort(
            ...
            ObjectIntTimsortKernel.sort(this, valuesToPermute, valuesToSort.asWritableObjectChunk(), offsetsIn, lengthsIn);
        }
