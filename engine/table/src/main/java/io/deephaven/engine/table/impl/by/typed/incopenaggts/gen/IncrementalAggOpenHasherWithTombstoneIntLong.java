...
final class IncrementalAggOpenHasherWithTombstoneIntLong extends IncrementalChunkedOperatorAggregationStateManagerOpenAddressedBaseWithTombstones {
    ...
    public IncrementalAggOpenHasherWithTombstoneIntLong(ColumnSource[] tableKeySources,
