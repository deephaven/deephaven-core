...
/**
 * This implements a timsort kernel that sorts a multi-column key (Object, Long), comparing each
 ...
 */
public final class ObjectLongMultiColumnTimsortKernel {
    private ObjectLongMultiColumnTimsortKernel() {
        throw new UnsupportedOperationException();
    }

    public static <SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> ObjectLongMultiColumnSortKernelContext<SORT_VALUES_ATTR, PERMUTE_VALUES_ATTR> createContext(
            final int size) {
        return new ObjectLongMultiColumnSortKernelContext<>(size);
    }
    ...
    static <SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> void sort(
            ObjectLongMultiColumnSortKernelContext<SORT_VALUES_ATTR, PERMUTE_VALUES_ATTR> context,
            WritableLongChunk<PERMUTE_VALUES_ATTR> valuesToPermute,
            WritableObjectChunk<Object, SORT_VALUES_ATTR> valuesToSort0,
            WritableLongChunk<SORT_VALUES_ATTR> valuesToSort1,
    ...
    private static <SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> void timSort(
            ...
            WritableLongChunk<PERMUTE_VALUES_ATTR> valuesToPermute,
            WritableObjectChunk<Object, SORT_VALUES_ATTR> valuesToSort0,
            WritableLongChunk<SORT_VALUES_ATTR> valuesToSort1, int offset, int length) {
        if (length <= 1) {
            return;
        }
    ...
    private static int doComparison1(long lhs, long rhs) {
    ...
    private static <SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> void merge(
            ...
            WritableLongChunk<PERMUTE_VALUES_ATTR> valuesToPermute,
            WritableObjectChunk<Object, SORT_VALUES_ATTR> valuesToSort0,
            WritableLongChunk<SORT_VALUES_ATTR> valuesToSort1, int start1, int length1,
            int length2) {
        ...
        final long run2lo1 = valuesToSort1.get(start2);
        ...
        final long run1hi1 = valuesToSort1.get(start1 + length1 - 1);
    ...
    private static <SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> void frontMerge(
            ...
            WritableLongChunk<PERMUTE_VALUES_ATTR> valuesToPermute,
            WritableObjectChunk<Object, SORT_VALUES_ATTR> valuesToSort0,
            WritableLongChunk<SORT_VALUES_ATTR> valuesToSort1, final int mergeStartPosition,
    ...
    private static <SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> void copyToTemporary(
            ...
            WritableLongChunk<PERMUTE_VALUES_ATTR> valuesToPermute,
            WritableObjectChunk<Object, SORT_VALUES_ATTR> valuesToSort0,
            WritableLongChunk<SORT_VALUES_ATTR> valuesToSort1, int mergeStartPosition,
            int remaining1) {
    ...
    private static <SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> void copyToChunk(
            ...
            LongChunk<SORT_VALUES_ATTR> valuesSource1,
            WritableLongChunk<PERMUTE_VALUES_ATTR> permuteValuesDest,
            WritableObjectChunk<Object, SORT_VALUES_ATTR> sortValuesDest0,
            WritableLongChunk<SORT_VALUES_ATTR> sortValuesDest1, int sourceStart, int destStart,
            int length) {
    ...
    private static int upperBound(ObjectChunk<Object, ?> valuesToSort0, LongChunk<?> valuesToSort1,
            int lo, int hi, Object searchValue0, long searchValue1) {
    ...
    private static int lowerBound(ObjectChunk<Object, ?> valuesToSort0, LongChunk<?> valuesToSort1,
            int lo, int hi, Object searchValue0, long searchValue1) {
    ...
    private static int bound(ObjectChunk<Object, ?> valuesToSort0, LongChunk<?> valuesToSort1,
            int lo, int hi, Object searchValue0, long searchValue1, final boolean lower) {
    ...
    private static void insertionSort(WritableLongChunk<?> valuesToPermute,
            WritableObjectChunk<Object, ?> valuesToSort0, WritableLongChunk<?> valuesToSort1,
    ...
    private static void swap(WritableLongChunk<?> valuesToPermute,
            WritableObjectChunk<Object, ?> valuesToSort0, WritableLongChunk<?> valuesToSort1, int a,
            int b) {
        final long tempPermuteValue = valuesToPermute.get(a);
        final Object temp0 = valuesToSort0.get(a);
        final long temp1 = valuesToSort1.get(a);
    ...
    public static class ObjectLongMultiColumnSortKernelContext<SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> implements MultiColumnSortKernel<PERMUTE_VALUES_ATTR> {
        int minGallop;
        ...
        private final WritableLongChunk<SORT_VALUES_ATTR> temporaryValues1;

        private ObjectLongMultiColumnSortKernelContext(int size) {
            ...
            temporaryValues1 = WritableLongChunk.makeWritableChunk((size + 2) / 2);
        ...
        public void sort(WritableLongChunk<PERMUTE_VALUES_ATTR> valuesToPermute,
            ...
            ObjectLongMultiColumnTimsortKernel.sort(this, valuesToPermute,
                            (WritableObjectChunk<Object, SORT_VALUES_ATTR>) valuesToSort[0].asWritableObjectChunk(),
                            (WritableLongChunk<SORT_VALUES_ATTR>) valuesToSort[1].asWritableLongChunk());
        }
