...
final class StaticAggHasherFloatInt extends StaticChunkedOperatorAggregationStateManagerTypedBase {
    ...
    public StaticAggHasherFloatInt(ColumnSource[] tableKeySources,
