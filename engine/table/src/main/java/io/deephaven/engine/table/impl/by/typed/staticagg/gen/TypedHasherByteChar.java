...
public final class TypedHasherByteChar extends StaticChunkedOperatorAggregationStateManagerTypedBase {
  ...
  public TypedHasherByteChar(ColumnSource[] tableKeySources, int tableSize,
  ...
  private int hash(byte v0, char v1) {
  ...
  private boolean findOverflow(HashHandler handler, byte v0, char v1, int chunkPosition,
