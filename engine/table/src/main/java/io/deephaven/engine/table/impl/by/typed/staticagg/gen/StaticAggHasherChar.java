...
final class StaticAggHasherChar extends StaticChunkedOperatorAggregationStateManagerTypedBase {
    private final CharacterArraySource mainKeySource0;

    private final CharacterArraySource overflowKeySource0;

    public StaticAggHasherChar(ColumnSource[] tableKeySources,
    ...
    private boolean findOverflow(HashHandler handler, char k0, int chunkPosition,
