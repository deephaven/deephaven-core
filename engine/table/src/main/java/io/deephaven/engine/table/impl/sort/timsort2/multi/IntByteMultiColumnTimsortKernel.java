...
/**
 * This implements a timsort kernel that sorts a multi-column key (Int, Byte), comparing each
 ...
 */
public final class IntByteMultiColumnTimsortKernel {
    private IntByteMultiColumnTimsortKernel() {
        throw new UnsupportedOperationException();
    }

    public static <SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> IntByteMultiColumnSortKernelContext<SORT_VALUES_ATTR, PERMUTE_VALUES_ATTR> createContext(
            final int size) {
        return new IntByteMultiColumnSortKernelContext<>(size);
    }
    ...
    static <SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> void sort(
            IntByteMultiColumnSortKernelContext<SORT_VALUES_ATTR, PERMUTE_VALUES_ATTR> context,
    ...
    private static int upperBound(IntChunk<?> valuesToSort0, ByteChunk<?> valuesToSort1, int lo,
            int hi, int searchValue0, byte searchValue1) {
    ...
    private static int lowerBound(IntChunk<?> valuesToSort0, ByteChunk<?> valuesToSort1, int lo,
            int hi, int searchValue0, byte searchValue1) {
    ...
    private static int bound(IntChunk<?> valuesToSort0, ByteChunk<?> valuesToSort1, int lo, int hi,
            int searchValue0, byte searchValue1, final boolean lower) {
    ...
    private static void insertionSort(WritableLongChunk<?> valuesToPermute,
            WritableIntChunk<?> valuesToSort0, WritableByteChunk<?> valuesToSort1, int offset,
            int length) {
    ...
    private static void swap(WritableLongChunk<?> valuesToPermute,
            WritableIntChunk<?> valuesToSort0, WritableByteChunk<?> valuesToSort1, int a, int b) {
    ...
    public static class IntByteMultiColumnSortKernelContext<SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> implements MultiColumnSortKernel<PERMUTE_VALUES_ATTR> {
        int minGallop;
        ...
        private IntByteMultiColumnSortKernelContext(int size) {
        ...
        public void sort(WritableLongChunk<PERMUTE_VALUES_ATTR> valuesToPermute,
            ...
            IntByteMultiColumnTimsortKernel.sort(this, valuesToPermute,
