...
final class StaticAggOpenHasherShortLong extends StaticChunkedOperatorAggregationStateManagerOpenAddressedBase {
    private final ImmutableShortArraySource mainKeySource0;

    private final ImmutableLongArraySource mainKeySource1;

    public StaticAggOpenHasherShortLong(ColumnSource[] tableKeySources,
