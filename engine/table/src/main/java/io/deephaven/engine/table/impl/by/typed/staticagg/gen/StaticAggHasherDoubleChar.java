...
final class StaticAggHasherDoubleChar extends StaticChunkedOperatorAggregationStateManagerTypedBase {
    ...
    public StaticAggHasherDoubleChar(ColumnSource[] tableKeySources,
