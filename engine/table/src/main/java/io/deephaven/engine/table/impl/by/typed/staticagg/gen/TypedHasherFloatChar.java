...
public final class TypedHasherFloatChar extends StaticChunkedOperatorAggregationStateManagerTypedBase {
  ...
  public TypedHasherFloatChar(ColumnSource[] tableKeySources, int tableSize,
  ...
  private int hash(float v0, char v1) {
  ...
  private boolean findOverflow(HashHandler handler, float v0, char v1, int chunkPosition,
