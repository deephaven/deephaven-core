...
public final class TypedHasherObjectByte extends IncrementalChunkedOperatorAggregationStateManagerTypedBase {
  ...
  public TypedHasherObjectByte(ColumnSource[] tableKeySources, int tableSize,
  ...
  private int hash(Object v0, byte v1) {
  ...
  private boolean findOverflow(HashHandler handler, Object v0, byte v1, int chunkPosition,
