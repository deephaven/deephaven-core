...
// ****** Edit ObjectLongTimsortDescendingKernel and run "./gradlew replicateSortKernel" to regenerate
//
// @formatter:off
...
public final class ObjectLongTimsortDescendingKernel {
    ...
    public static <SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> ObjectLongSortKernelContext<SORT_VALUES_ATTR, PERMUTE_VALUES_ATTR> createContext(final int size) {
    ...
    static private void swap(WritableLongChunk<?> valuesToPermute, WritableObjectChunk<Object, ?> valuesToSort, int a, int b) {
    ...
    // private static void doCheck(Chunk.LongChunk valuesToPermute, Chunk.ObjectChunk valuesToSort, int startCheck, int
    // mergeEnd) {
    // Object lastCheck;
