...
public class ByteLongTimsortKernel {
    ...
    // region Context
    public static class ByteLongSortKernelContext<SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any>
        ...
        public void sort(
            ...
            ByteLongTimsortKernel.sort(this, valuesToPermute, valuesToSort.asWritableByteChunk());
        }
        ...
        public void sort(
            ...
            ByteLongTimsortKernel.sort(this, valuesToPermute, valuesToSort.asWritableByteChunk(), offsetsIn, lengthsIn);
        }
    ...
    ByteLongSortKernelContext<SORT_VALUES_ATTR, PERMUTE_VALUES_ATTR> createContext(int size) {
...
//    private static void doCheck(Chunk.LongChunk valuesToPermute, Chunk.ByteChunk valuesToSort, int startCheck, int mergeEnd) {
//        byte lastCheck;
