 ...
 */
public final class ByteLongTimsortKernel {
    // region constructor
    ...
    // region Context
    public class ByteLongSortKernelContext<SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any>
        ...
        public void sort(
            ...
            ByteLongTimsortKernel.this.sort(this, valuesToPermute, valuesToSort.asWritableByteChunk());
        }
        ...
        public void sort(
            ...
            ByteLongTimsortKernel.this.sort(this, valuesToPermute, valuesToSort.asWritableByteChunk(), offsetsIn, lengthsIn);
        }
        ...
        private ByteLongTimsortKernel kernel() {
            return ByteLongTimsortKernel.this;
        }
    }
    // endregion Context

    // region createContextInstance
    public <SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> ByteLongSortKernelContext<SORT_VALUES_ATTR, PERMUTE_VALUES_ATTR> createContextInstance(int size) {
    ...
    public static <SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> ByteLongSortKernelContext<SORT_VALUES_ATTR, PERMUTE_VALUES_ATTR> createContext(final int size) {
        return new ByteLongTimsortKernel().createContextInstance(size);
    }
    ...
    static <SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> void sort(
            ByteLongSortKernelContext<SORT_VALUES_ATTR, PERMUTE_VALUES_ATTR> context,
            WritableLongChunk<PERMUTE_VALUES_ATTR> valuesToPermute,
    ...
    static private void swap(WritableLongChunk<?> valuesToPermute, WritableByteChunk<?> valuesToSort, int a, int b) {
    ...
    // private static void doCheck(Chunk.LongChunk valuesToPermute, Chunk.ByteChunk valuesToSort, int startCheck, int
    // mergeEnd) {
    // byte lastCheck;
