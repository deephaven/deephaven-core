...
final class IncrementalAggHasherDoubleLong extends IncrementalChunkedOperatorAggregationStateManagerTypedBase {
    ...
    public IncrementalAggHasherDoubleLong(ColumnSource[] tableKeySources,
        ...
        this.mainKeySource1 = (LongArraySource) super.mainKeySources[1];
    ...
    private static int hash(double k0, long k1) {
    ...
    private int maybeMoveMainBucket(HashHandler handler, int sourceBucket, int destBucket,
        ...
        final long k1 = mainKeySource1.getUnsafe(sourceBucket);
        final int hash = hash(k0, k1);
        ...
        if (location == sourceBucket) {
            ...
            mainKeySource1.set(sourceBucket, QueryConstants.NULL_LONG);
            handler.doMoveMain(sourceBucket, destBucket);
        }
        return mainInsertLocation;
    }

    private boolean findOverflow(HashHandler handler, double k0, long k1, int chunkPosition,
