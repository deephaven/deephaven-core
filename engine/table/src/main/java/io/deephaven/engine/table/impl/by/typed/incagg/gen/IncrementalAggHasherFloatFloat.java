...
final class IncrementalAggHasherFloatFloat extends IncrementalChunkedOperatorAggregationStateManagerTypedBase {
    ...
    private boolean findOverflow(HashHandler handler, float k0, float k1, int chunkPosition,
