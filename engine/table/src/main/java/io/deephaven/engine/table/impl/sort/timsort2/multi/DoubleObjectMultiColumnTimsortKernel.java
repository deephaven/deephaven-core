...
/**
 * This implements a timsort kernel that sorts a multi-column key (Double, Object), comparing each
 ...
 */
public final class DoubleObjectMultiColumnTimsortKernel {
    private DoubleObjectMultiColumnTimsortKernel() {
        throw new UnsupportedOperationException();
    }

    public static <SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> DoubleObjectMultiColumnSortKernelContext<SORT_VALUES_ATTR, PERMUTE_VALUES_ATTR> createContext(
            final int size) {
        return new DoubleObjectMultiColumnSortKernelContext<>(size);
    }
    ...
    static <SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> void sort(
            DoubleObjectMultiColumnSortKernelContext<SORT_VALUES_ATTR, PERMUTE_VALUES_ATTR> context,
    ...
    private static <SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> void copyToChunk(
            ...
            DoubleChunk<SORT_VALUES_ATTR> valuesSource0,
    ...
    private static int upperBound(DoubleChunk<?> valuesToSort0,
            ObjectChunk<Object, ?> valuesToSort1, int lo, int hi, double searchValue0,
            Object searchValue1) {
    ...
    private static int lowerBound(DoubleChunk<?> valuesToSort0,
            ObjectChunk<Object, ?> valuesToSort1, int lo, int hi, double searchValue0,
            Object searchValue1) {
    ...
    private static int bound(DoubleChunk<?> valuesToSort0, ObjectChunk<Object, ?> valuesToSort1,
            int lo, int hi, double searchValue0, Object searchValue1, final boolean lower) {
    ...
    private static void insertionSort(WritableLongChunk<?> valuesToPermute,
            WritableDoubleChunk<?> valuesToSort0, WritableObjectChunk<Object, ?> valuesToSort1,
    ...
    public static class DoubleObjectMultiColumnSortKernelContext<SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> implements MultiColumnSortKernel<PERMUTE_VALUES_ATTR> {
        int minGallop;
        ...
        private DoubleObjectMultiColumnSortKernelContext(int size) {
        ...
        public void sort(WritableLongChunk<PERMUTE_VALUES_ATTR> valuesToPermute,
            ...
            DoubleObjectMultiColumnTimsortKernel.sort(this, valuesToPermute,
