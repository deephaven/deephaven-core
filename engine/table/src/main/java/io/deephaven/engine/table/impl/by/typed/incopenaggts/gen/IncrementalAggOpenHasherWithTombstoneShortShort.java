...
final class IncrementalAggOpenHasherWithTombstoneShortShort extends IncrementalChunkedOperatorAggregationStateManagerOpenAddressedBaseWithTombstones {
    ...
    public IncrementalAggOpenHasherWithTombstoneShortShort(ColumnSource[] tableKeySources,
