 ...
 */
public final class RangeAggregateColumnSourceFloat
        extends RangeAggregateColumnSource<FloatVector, Float> {

    public RangeAggregateColumnSourceFloat(
            @NotNull final ColumnSource<Float> aggregated,
        ...
        super(FloatVector.class, aggregated, rowSets, startPositionsInclusive, endPositionsExclusive);
    }

    @NotNull
    private FloatVector makeVector(
            @NotNull final RowSet rowSet,
            final int startPositionInclusive,
            final int length) {
        return new FloatVectorSlice(
                new FloatVectorColumnWrapper(aggregated, rowSet),
                startPositionInclusive,
                length);
    }

    @NotNull
    private FloatVector makePrevVector(
            @NotNull final RowSet rowSet,
            final int startPositionInclusive,
            final int length) {
        return new FloatVectorSlice(
                new FloatVectorColumnWrapper(aggregatedPrev, rowSet),
                startPositionInclusive,
                length);
    }
