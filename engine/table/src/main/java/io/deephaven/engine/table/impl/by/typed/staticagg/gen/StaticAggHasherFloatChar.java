...
final class StaticAggHasherFloatChar extends StaticChunkedOperatorAggregationStateManagerTypedBase {
    ...
    public StaticAggHasherFloatChar(ColumnSource[] tableKeySources,
