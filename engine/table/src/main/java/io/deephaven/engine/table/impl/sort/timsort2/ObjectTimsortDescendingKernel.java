 ...
 */
public final class ObjectTimsortDescendingKernel {
    private ObjectTimsortDescendingKernel() {
        throw new UnsupportedOperationException();
    }

    public static <ATTR extends Any> ObjectSortKernelContext<ATTR> createContext(final int size) {
     ...
     */
    public static <ATTR extends Any> void sort(ObjectSortKernelContext<ATTR> context,
            final WritableObjectChunk<Object, ATTR> valuesToSort) {
        timSort(context, valuesToSort, 0, valuesToSort.size());
    }

    private static <ATTR extends Any> void timSort(ObjectSortKernelContext<ATTR> context,
            WritableObjectChunk<Object, ATTR> valuesToSort, int offset, int length) {
        if (length <= 1) {
            return;
        }
    ...
    private static <ATTR extends Any> void ensureMergeInvariants(
            ObjectSortKernelContext<ATTR> context, WritableObjectChunk<Object, ATTR> valuesToSort) {
        while (context.runCount > 1) {
    ...
    private static <ATTR extends Any> void merge(ObjectSortKernelContext<ATTR> context,
            WritableObjectChunk<Object, ATTR> valuesToSort, int start1, int length1, int length2) {
     ...
     */
    private static <ATTR extends Any> void frontMerge(ObjectSortKernelContext<ATTR> context,
            WritableObjectChunk<Object, ATTR> valuesToSort, final int mergeStartPosition,
     ...
     * We eventually need to do galloping here, but are skipping that for now
     */
    private static <ATTR extends Any> void backMerge(ObjectSortKernelContext<ATTR> context,
            WritableObjectChunk<Object, ATTR> valuesToSort, final int mergeStartPosition,
            final int length1) {
    ...
    private static <ATTR extends Any> void copyToTemporary(ObjectSortKernelContext<ATTR> context,
            WritableObjectChunk<Object, ATTR> valuesToSort, int mergeStartPosition,
            int remaining1) {
    ...
    private static <ATTR extends Any> void copyToChunk(ObjectChunk<Object, ATTR> valuesSource,
            WritableObjectChunk<Object, ATTR> valuesDest, int sourceStart, int destStart,
            int length) {
        valuesDest.copyFromChunk(valuesSource, sourceStart, destStart, length);
    }

    private static int upperBound(ObjectChunk<Object, ?> valuesToSort, int lo, int hi,
            Object searchValue) {
    ...
    private static int lowerBound(ObjectChunk<Object, ?> valuesToSort, int lo, int hi,
            Object searchValue) {
    ...
    private static int bound(ObjectChunk<Object, ?> valuesToSort, int lo, int hi,
            Object searchValue, final boolean lower) {
    ...
    private static void insertionSort(WritableObjectChunk<Object, ?> valuesToSort, int offset,
            int length) {
    ...
    private static void swap(WritableObjectChunk<Object, ?> valuesToSort, int a, int b) {
