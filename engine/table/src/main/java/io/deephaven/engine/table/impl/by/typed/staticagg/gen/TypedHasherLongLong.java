...
final class TypedHasherLongLong extends StaticChunkedOperatorAggregationStateManagerTypedBase {
  ...
  public TypedHasherLongLong(ColumnSource[] tableKeySources, int tableSize,
  ...
  private int hash(long v0, long v1) {
  ...
  private boolean findOverflow(HashHandler handler, long v0, long v1, int chunkPosition,
