...
final class TypedHasherLongInt extends StaticChunkedOperatorAggregationStateManagerTypedBase {
    ...
    public TypedHasherLongInt(ColumnSource[] tableKeySources, int tableSize,
