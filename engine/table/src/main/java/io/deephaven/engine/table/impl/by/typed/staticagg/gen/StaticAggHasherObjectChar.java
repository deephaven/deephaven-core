...
final class StaticAggHasherObjectChar extends StaticChunkedOperatorAggregationStateManagerTypedBase {
    ...
    public StaticAggHasherObjectChar(ColumnSource[] tableKeySources,
