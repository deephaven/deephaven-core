...
public class ShortEMSOperator extends BasePrimitiveEMSOperator {
    ...
    /**
     * An operator that computes an EM Sum from a short column using an exponential decay function.
     *
     ...
     */
    public ShortEMSOperator(@NotNull final MatchPair pair,
