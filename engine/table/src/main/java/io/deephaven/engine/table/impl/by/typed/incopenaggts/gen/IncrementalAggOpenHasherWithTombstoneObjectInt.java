...
final class IncrementalAggOpenHasherWithTombstoneObjectInt extends IncrementalChunkedOperatorAggregationStateManagerOpenAddressedBaseWithTombstones {
    ...
    public IncrementalAggOpenHasherWithTombstoneObjectInt(ColumnSource[] tableKeySources,
