...
final class TypedHasherObjectLong extends StaticChunkedOperatorAggregationStateManagerTypedBase {
  ...
  public TypedHasherObjectLong(ColumnSource[] tableKeySources, int tableSize,
  ...
  private int hash(Object v0, long v1) {
  ...
  private boolean findOverflow(HashHandler handler, Object v0, long v1, int chunkPosition,
