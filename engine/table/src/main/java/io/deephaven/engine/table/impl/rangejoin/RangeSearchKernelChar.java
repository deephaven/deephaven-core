...
enum RangeSearchKernelChar implements RangeSearchKernel {
    ...
    LT_GT {
        ...
        void processAllRangesForEmptyRight(
                @NotNull final CharChunk<? extends Values> lsv,
                @NotNull final CharChunk<? extends Values> lev,
        ...
        void processRangeStarts(
                @NotNull final CharChunk<? extends Values> lv,
                @NotNull final IntChunk<ChunkPositions> lp,
                @NotNull final CharChunk<? extends Values> rv,
    ...
    public final void processAllRangesForEmptyRight(
        ...
        processAllRangesForEmptyRight(
                leftStartValues.asCharChunk(),
                leftEndValues.asCharChunk(),
    ...
    public final void processRangeStarts(
            ...
            @NotNull final WritableIntChunk<? extends Values> outputStartPositionsInclusive) {
        processRangeStarts(
                leftValues.asCharChunk(),
                leftPositions,
                rightValues.asCharChunk(),
                rightStartOffsets,
                rightSizeExpanded,
                outputStartPositionsInclusive);
    }
    ...
    abstract void processRangeStarts(
            @NotNull CharChunk<? extends Values> leftValues,
            @NotNull IntChunk<ChunkPositions> leftPositions,
            @NotNull CharChunk<? extends Values> rightValues,
    ...
    // region isNaN
    private static boolean isNaN(@SuppressWarnings("unused") final char v) {
        return false;
    }
    // endregion isNaN

    // region isNull
    private static boolean isNull(final char v) {
    ...
    // region eq
    private static boolean eq(final char a, final char b) {
