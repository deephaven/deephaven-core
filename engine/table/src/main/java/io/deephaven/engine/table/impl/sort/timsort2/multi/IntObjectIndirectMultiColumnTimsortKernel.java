...
/**
 * This implements a timsort kernel for a multi-column key (Int, Object) that never moves the column values:
 ...
 */
public final class IntObjectIndirectMultiColumnTimsortKernel {
    private IntObjectIndirectMultiColumnTimsortKernel() {
        throw new UnsupportedOperationException();
    }

    public static <PERMUTE_VALUES_ATTR extends Any> IntObjectIndirectMultiColumnSortKernelContext<PERMUTE_VALUES_ATTR> createContext(
            final int size) {
        return new IntObjectIndirectMultiColumnSortKernelContext<>(size);
    }
     ...
     */
    public static void sort(IntObjectIndirectMultiColumnSortKernelContext<?> context,
    ...
    private static void timSort(IntObjectIndirectMultiColumnSortKernelContext<?> context,
            WritableIntChunk<ChunkPositions> positions, IntChunk<?> valuesToSort0,
     ...
     */
    private static int compareColumns(IntChunk<?> valuesToSort0,
    ...
    private static void ensureMergeInvariants(
            IntObjectIndirectMultiColumnSortKernelContext<?> context,
            WritableIntChunk<ChunkPositions> positions, IntChunk<?> valuesToSort0,
            ObjectChunk<Object, ?> valuesToSort1) {
        while (context.runCount > 1) {
    ...
    private static void merge(IntObjectIndirectMultiColumnSortKernelContext<?> context,
            WritableIntChunk<ChunkPositions> positions, IntChunk<?> valuesToSort0,
     ...
     */
    private static void frontMerge(IntObjectIndirectMultiColumnSortKernelContext<?> context,
            WritableIntChunk<ChunkPositions> positions, IntChunk<?> valuesToSort0,
     ...
     * We eventually need to do galloping here, but are skipping that for now
     */
    private static void backMerge(IntObjectIndirectMultiColumnSortKernelContext<?> context,
            WritableIntChunk<ChunkPositions> positions, IntChunk<?> valuesToSort0,
    ...
    private static void copyToTemporary(IntObjectIndirectMultiColumnSortKernelContext<?> context,
    ...
    private static void insertionSort(WritableIntChunk<ChunkPositions> positions,
            IntChunk<?> valuesToSort0, ObjectChunk<Object, ?> valuesToSort1, int offset,
            int length) {
    ...
    public static class IntObjectIndirectMultiColumnSortKernelContext<PERMUTE_VALUES_ATTR extends Any> implements MultiColumnSortKernel<PERMUTE_VALUES_ATTR> {
        int minGallop;
        ...
        private IntObjectIndirectMultiColumnSortKernelContext(int size) {
        ...
        public void sort(WritableLongChunk<PERMUTE_VALUES_ATTR> valuesToPermute,
            ...
            IntObjectIndirectMultiColumnTimsortKernel.sort(this, positions, valuesToSort[0].asIntChunk(), valuesToSort[1].<Object>asObjectChunk());
