...
/**
 * This implements a timsort kernel that sorts a multi-column key (Short, Object), comparing each
 ...
 */
public final class ShortObjectMultiColumnTimsortKernel {
    private ShortObjectMultiColumnTimsortKernel() {
        throw new UnsupportedOperationException();
    }

    public static <SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> ShortObjectMultiColumnSortKernelContext<SORT_VALUES_ATTR, PERMUTE_VALUES_ATTR> createContext(
            final int size) {
        return new ShortObjectMultiColumnSortKernelContext<>(size);
    }
    ...
    static <SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> void sort(
            ShortObjectMultiColumnSortKernelContext<SORT_VALUES_ATTR, PERMUTE_VALUES_ATTR> context,
    ...
    private static int upperBound(ShortChunk<?> valuesToSort0, ObjectChunk<Object, ?> valuesToSort1,
            int lo, int hi, short searchValue0, Object searchValue1) {
    ...
    private static int lowerBound(ShortChunk<?> valuesToSort0, ObjectChunk<Object, ?> valuesToSort1,
            int lo, int hi, short searchValue0, Object searchValue1) {
    ...
    private static int bound(ShortChunk<?> valuesToSort0, ObjectChunk<Object, ?> valuesToSort1,
            int lo, int hi, short searchValue0, Object searchValue1, final boolean lower) {
    ...
    private static void insertionSort(WritableLongChunk<?> valuesToPermute,
            WritableShortChunk<?> valuesToSort0, WritableObjectChunk<Object, ?> valuesToSort1,
    ...
    public static class ShortObjectMultiColumnSortKernelContext<SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> implements MultiColumnSortKernel<PERMUTE_VALUES_ATTR> {
        int minGallop;
        ...
        private ShortObjectMultiColumnSortKernelContext(int size) {
        ...
        public void sort(WritableLongChunk<PERMUTE_VALUES_ATTR> valuesToPermute,
            ...
            ShortObjectMultiColumnTimsortKernel.sort(this, valuesToPermute,
