...
public final class ComparatorLongTimsortKernel {
    ...
    public <SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> ComparatorLongSortKernelContext<SORT_VALUES_ATTR, PERMUTE_VALUES_ATTR> createContextInstance(
            int size) {
        return new ComparatorLongSortKernelContext<>(size);
    }

    public static <SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> ComparatorLongSortKernelContext<SORT_VALUES_ATTR, PERMUTE_VALUES_ATTR> createContext(
    ...
    @VisibleForTesting
    boolean lt(Object lhs, Object rhs) {
        return doComparison(lhs, rhs) < 0;
    }

    @VisibleForTesting
    boolean geq(Object lhs, Object rhs) {
        return doComparison(lhs, rhs) >= 0;
    }
    ...
    public class ComparatorLongSortKernelContext<SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> implements LongSortKernel<SORT_VALUES_ATTR, PERMUTE_VALUES_ATTR> {
        int minGallop;
        ...
        public void sort(WritableLongChunk<PERMUTE_VALUES_ATTR> valuesToPermute,
            ...
            ComparatorLongTimsortKernel.this.sort(this, valuesToPermute, valuesToSort.asWritableObjectChunk());
        }
