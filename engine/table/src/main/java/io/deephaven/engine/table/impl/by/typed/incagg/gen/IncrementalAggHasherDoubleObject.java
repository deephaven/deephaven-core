...
final class IncrementalAggHasherDoubleObject extends IncrementalChunkedOperatorAggregationStateManagerTypedBase {
    ...
    public IncrementalAggHasherDoubleObject(ColumnSource[] tableKeySources,
    ...
    private boolean findOverflow(HashHandler handler, double k0, Object k1, int chunkPosition,
