 ...
 */
public class DoubleByteTimsortKernel {
    ...
    public static class DoubleByteSortKernelContext<SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any>
        ...
        public void sort(
            ...
            DoubleByteTimsortKernel.sort(this, valuesToPermute, valuesToSort.asWritableDoubleChunk());
        }
        ...
        public void sort(
            ...
            DoubleByteTimsortKernel.sort(this, valuesToPermute, valuesToSort.asWritableDoubleChunk(), offsetsIn, lengthsIn);
        }
