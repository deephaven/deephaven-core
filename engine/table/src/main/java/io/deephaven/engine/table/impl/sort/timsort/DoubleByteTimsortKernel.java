 ...
 */
public final class DoubleByteTimsortKernel {
    private DoubleByteTimsortKernel() {
    }
    ...
    public static <SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> DoubleByteSortKernelContext<SORT_VALUES_ATTR, PERMUTE_VALUES_ATTR> createContext(
            final int size) {
        return new DoubleByteTimsortKernel().createContextInstance(size);
    }
    ...
    public class DoubleByteSortKernelContext<SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> implements ByteSortKernel<SORT_VALUES_ATTR, PERMUTE_VALUES_ATTR> {
        ...
        public void sort(WritableByteChunk<PERMUTE_VALUES_ATTR> valuesToPermute,
            ...
            DoubleByteTimsortKernel.this.sort(this, valuesToPermute, valuesToSort.asWritableDoubleChunk());
        }
        ...
        public void sort(WritableByteChunk<PERMUTE_VALUES_ATTR> valuesToPermute,
                ...
                IntChunk<? extends ChunkPositions> offsetsIn,
                IntChunk<? extends ChunkLengths> lengthsIn) {
            DoubleByteTimsortKernel.this.sort(this, valuesToPermute, valuesToSort.asWritableDoubleChunk(), offsetsIn, lengthsIn);
        }

        @Override
        public void sort(WritableByteChunk<PERMUTE_VALUES_ATTR> valuesToPermute,
                WritableChunk<SORT_VALUES_ATTR> valuesToSort, int offset, int length) {
            DoubleByteTimsortKernel.this.timSort(this, valuesToPermute, valuesToSort.asWritableDoubleChunk(), offset, length);
        }
        ...
        public void merge(WritableByteChunk<PERMUTE_VALUES_ATTR> valuesToPermute,
                ...
                int length2) {
            DoubleByteTimsortKernel.this.merge(this, valuesToPermute, valuesToSort.asWritableDoubleChunk(), start1, length1, length2);
        }
        ...
        private DoubleByteTimsortKernel kernel() {
            return DoubleByteTimsortKernel.this;
        }
    }
}
