...
public class DoubleByteTimsortKernel {
    ...
    public static class DoubleByteSortKernelContext<ATTR extends Any, KEY_INDICES extends Indices> implements ByteSortKernel<ATTR, KEY_INDICES> {
        ...
        public void sort(WritableByteChunk<KEY_INDICES> indexKeys, WritableChunk<ATTR> valuesToSort) {
            DoubleByteTimsortKernel.sort(this, indexKeys, valuesToSort.asWritableDoubleChunk());
        }
        ...
        public void sort(WritableByteChunk<KEY_INDICES> indexKeys, WritableChunk<ATTR> valuesToSort, IntChunk<? extends ChunkPositions> offsetsIn, IntChunk<? extends ChunkLengths> lengthsIn) {
            DoubleByteTimsortKernel.sort(this, indexKeys, valuesToSort.asWritableDoubleChunk(), offsetsIn, lengthsIn);
        }
