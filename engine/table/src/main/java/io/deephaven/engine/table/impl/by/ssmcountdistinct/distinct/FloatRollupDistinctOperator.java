...
// ****** Edit CharRollupDistinctOperator and run "./gradlew replicateSegmentedSortedMultiset" to regenerate
//
// @formatter:off
 ...
 */
public class FloatRollupDistinctOperator implements IterativeChunkedAggregationOperator {
    ...
    public FloatRollupDistinctOperator(
            // region Constructor
    ...
    public void startTrackingPrevValues() {
        ...
        prevFlusher = new UpdateCommitter<>(this, ExecutionContext.getContext().getUpdateGraph(),
                FloatRollupDistinctOperator::flushPrevious);
