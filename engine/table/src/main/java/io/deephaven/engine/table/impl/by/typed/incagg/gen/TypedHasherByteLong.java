...
final class TypedHasherByteLong extends IncrementalChunkedOperatorAggregationStateManagerTypedBase {
    ...
    public TypedHasherByteLong(ColumnSource[] tableKeySources, int tableSize,
