...
final class IncrementalAggOpenHasherByteByte extends IncrementalChunkedOperatorAggregationStateManagerOpenAddressedBase {
    ...
    public IncrementalAggOpenHasherByteByte(ColumnSource[] tableKeySources,
