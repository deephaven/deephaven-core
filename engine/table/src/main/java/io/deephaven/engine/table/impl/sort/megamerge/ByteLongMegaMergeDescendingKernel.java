...
// ****** Edit ByteLongMegaMergeDescendingKernel and run "./gradlew replicateSortKernel" to regenerate
//
// @formatter:off
...
public class ByteLongMegaMergeDescendingKernel {
    ...
    // region Context
    public static class ByteLongMegaMergeDescendingKernelContext<ATTR extends Any, KEY_INDICES extends Indices>
        ...
        public void merge(LongArraySource indexDestinationSource, WritableColumnSource<?> valuesDestinationSource,
            ...
            ByteLongMegaMergeDescendingKernel.merge(indexDestinationSource, (ByteArraySource) valuesDestinationSource,
                    destinationOffset, destinationSize, indexKeys, valuesToMerge.asByteChunk());
        }
    }
    // endregion Context
    ...
    private static <ATTR extends Any, KEY_INDICES extends Indices> void copyChunkToDest(
            LongChunk<KEY_INDICES> keysChunk, ByteChunk<ATTR> valuesChunk, LongArraySource destinationKeys,
            ByteArraySource destinationValues, int sourceStart, long destStart, int length) {
    ...
    private static void moveInDest(LongArraySource destinationKeys, ByteArraySource destinationValues,
    ...
    private static int lowerBound(ByteChunk<?> valuesToSort, @SuppressWarnings("SameParameterValue") int lo, int hi,
            byte searchValue) {
