...
public class CharPermuteKernel {
    public static <T extends Any> void permute(CharChunk<? extends T> inputValues,
            IntChunk<ChunkPositions> outputPositions, WritableCharChunk<? super T> outputValues) {
        for (int ii = 0; ii < outputPositions.size(); ++ii) {
            outputValues.set(outputPositions.get(ii), inputValues.get(ii));
        }
    }

    public static <T extends Any> void permuteInput(CharChunk<? extends T> inputValues,
            IntChunk<ChunkPositions> inputPositions, WritableCharChunk<? super T> outputValues) {
    ...
    public static <T extends Any> void permute(IntChunk<ChunkPositions> inputPositions,
            CharChunk<? extends T> inputValues, IntChunk<ChunkPositions> outputPositions,
            WritableCharChunk<? super T> outputValues) {
        for (int ii = 0; ii < outputPositions.size(); ++ii) {
    ...
    private static class CharPermuteKernelContext implements PermuteKernel {
        ...
        public <T extends Any> void permute(IntChunk<ChunkPositions> inputPositions, Chunk<? extends T> inputValues,
            ...
            CharPermuteKernel.permute(inputPositions, inputValues.asCharChunk(), outputPositions,
                    outputValues.asWritableCharChunk());
        }
        ...
        public <T extends Any> void permuteInput(Chunk<? extends T> inputValues,
            ...
            CharPermuteKernel.permuteInput(inputValues.asCharChunk(), inputPositions,
                    outputValues.asWritableCharChunk());
        }
    }
