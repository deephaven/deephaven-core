...
/**
 * This implements a timsort kernel for a multi-column key (Long, NullAwareChar) that never moves the column values:
 ...
 */
public final class LongNullAwareCharIndirectMultiColumnTimsortKernel {
    private LongNullAwareCharIndirectMultiColumnTimsortKernel() {
        throw new UnsupportedOperationException();
    }

    public static <PERMUTE_VALUES_ATTR extends Any> LongNullAwareCharIndirectMultiColumnSortKernelContext<PERMUTE_VALUES_ATTR> createContext(
            final int size) {
        return new LongNullAwareCharIndirectMultiColumnSortKernelContext<>(size);
    }
     ...
     */
    public static void sort(LongNullAwareCharIndirectMultiColumnSortKernelContext<?> context,
    ...
    private static void timSort(LongNullAwareCharIndirectMultiColumnSortKernelContext<?> context,
            WritableIntChunk<ChunkPositions> positions, LongChunk<?> valuesToSort0,
     ...
     */
    private static int compareColumns(LongChunk<?> valuesToSort0, CharChunk<?> valuesToSort1,
    ...
    private static void ensureMergeInvariants(
            LongNullAwareCharIndirectMultiColumnSortKernelContext<?> context,
            WritableIntChunk<ChunkPositions> positions, LongChunk<?> valuesToSort0,
            CharChunk<?> valuesToSort1) {
        while (context.runCount > 1) {
    ...
    private static void merge(LongNullAwareCharIndirectMultiColumnSortKernelContext<?> context,
            WritableIntChunk<ChunkPositions> positions, LongChunk<?> valuesToSort0,
     ...
     */
    private static void frontMerge(LongNullAwareCharIndirectMultiColumnSortKernelContext<?> context,
            WritableIntChunk<ChunkPositions> positions, LongChunk<?> valuesToSort0,
     ...
     * We eventually need to do galloping here, but are skipping that for now
     */
    private static void backMerge(LongNullAwareCharIndirectMultiColumnSortKernelContext<?> context,
            WritableIntChunk<ChunkPositions> positions, LongChunk<?> valuesToSort0,
    ...
    private static void insertionSort(WritableIntChunk<ChunkPositions> positions,
            LongChunk<?> valuesToSort0, CharChunk<?> valuesToSort1, int offset, int length) {
    ...
    public static class LongNullAwareCharIndirectMultiColumnSortKernelContext<PERMUTE_VALUES_ATTR extends Any> implements MultiColumnSortKernel<PERMUTE_VALUES_ATTR> {
        int minGallop;
        ...
        private LongNullAwareCharIndirectMultiColumnSortKernelContext(int size) {
        ...
        public void sort(WritableLongChunk<PERMUTE_VALUES_ATTR> valuesToPermute,
            ...
            LongNullAwareCharIndirectMultiColumnTimsortKernel.sort(this, positions, valuesToSort[0].asLongChunk(), valuesToSort[1].asCharChunk());
