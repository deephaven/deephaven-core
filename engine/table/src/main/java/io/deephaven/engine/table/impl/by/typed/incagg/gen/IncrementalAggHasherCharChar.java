...
final class IncrementalAggHasherCharChar extends IncrementalChunkedOperatorAggregationStateManagerTypedBase {
    ...
    public IncrementalAggHasherCharChar(ColumnSource[] tableKeySources,
    ...
    private boolean findOverflow(HashHandler handler, char k0, char k1, int chunkPosition,
