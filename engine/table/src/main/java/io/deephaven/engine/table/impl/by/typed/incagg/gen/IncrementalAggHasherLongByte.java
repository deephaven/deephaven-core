...
final class IncrementalAggHasherLongByte extends IncrementalChunkedOperatorAggregationStateManagerTypedBase {
    ...
    public IncrementalAggHasherLongByte(ColumnSource[] tableKeySources,
    ...
    private boolean findOverflow(HashHandler handler, long k0, byte k1, int chunkPosition,
