...
final class IncrementalAggOpenHasherCharObject extends IncrementalChunkedOperatorAggregationStateManagerOpenAddressedBase {
    ...
    public IncrementalAggOpenHasherCharObject(ColumnSource[] tableKeySources,
