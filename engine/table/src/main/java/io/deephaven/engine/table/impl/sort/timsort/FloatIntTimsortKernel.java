 ...
 */
public final class FloatIntTimsortKernel {
    // region constructor
    ...
    // region Context
    public class FloatIntSortKernelContext<SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any>
        ...
        public void sort(
            ...
            FloatIntTimsortKernel.this.sort(this, valuesToPermute, valuesToSort.asWritableFloatChunk());
        }
        ...
        public void sort(
            ...
            FloatIntTimsortKernel.this.sort(this, valuesToPermute, valuesToSort.asWritableFloatChunk(), offsetsIn, lengthsIn);
        }
        ...
        private FloatIntTimsortKernel kernel() {
            return FloatIntTimsortKernel.this;
        }
    }
    // endregion Context

    // region createContextInstance
    public <SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> FloatIntSortKernelContext<SORT_VALUES_ATTR, PERMUTE_VALUES_ATTR> createContextInstance(int size) {
    ...
    public static <SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> FloatIntSortKernelContext<SORT_VALUES_ATTR, PERMUTE_VALUES_ATTR> createContext(final int size) {
        return new FloatIntTimsortKernel().createContextInstance(size);
    }
    ...
    static private void swap(WritableIntChunk<?> valuesToPermute, WritableFloatChunk<?> valuesToSort, int a, int b) {
    ...
    // private static void doCheck(Chunk.IntChunk valuesToPermute, Chunk.FloatChunk valuesToSort, int startCheck, int
    // mergeEnd) {
    // float lastCheck;
