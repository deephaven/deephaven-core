...
public class FloatIntTimsortKernel {
    ...
    public static class FloatIntSortKernelContext<SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any>
        ...
        public void sort(
            ...
            FloatIntTimsortKernel.sort(this, valuesToPermute, valuesToSort.asWritableFloatChunk());
        }
        ...
        public void sort(
            ...
            FloatIntTimsortKernel.sort(this, valuesToPermute, valuesToSort.asWritableFloatChunk(), offsetsIn, lengthsIn);
        }
