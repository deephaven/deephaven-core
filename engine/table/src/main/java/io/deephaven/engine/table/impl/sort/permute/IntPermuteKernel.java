...
public class IntPermuteKernel {
    public static <T extends Any> void permute(IntChunk<? extends T> inputValues,
            IntChunk<ChunkPositions> outputPositions, WritableIntChunk<? super T> outputValues) {
        for (int ii = 0; ii < outputPositions.size(); ++ii) {
            outputValues.set(outputPositions.get(ii), inputValues.get(ii));
        }
    }

    public static <T extends Any> void permuteInput(IntChunk<? extends T> inputValues,
            IntChunk<ChunkPositions> inputPositions, WritableIntChunk<? super T> outputValues) {
    ...
    public static <T extends Any> void permute(IntChunk<ChunkPositions> inputPositions,
            IntChunk<? extends T> inputValues, IntChunk<ChunkPositions> outputPositions,
            WritableIntChunk<? super T> outputValues) {
        for (int ii = 0; ii < outputPositions.size(); ++ii) {
    ...
    private static class IntPermuteKernelContext implements PermuteKernel {
        ...
        public <T extends Any> void permute(IntChunk<ChunkPositions> inputPositions, Chunk<? extends T> inputValues,
            ...
            IntPermuteKernel.permute(inputPositions, inputValues.asIntChunk(), outputPositions,
                    outputValues.asWritableIntChunk());
        }
        ...
        public <T extends Any> void permuteInput(Chunk<? extends T> inputValues,
            ...
            IntPermuteKernel.permuteInput(inputValues.asIntChunk(), inputPositions,
                    outputValues.asWritableIntChunk());
        }
    }
