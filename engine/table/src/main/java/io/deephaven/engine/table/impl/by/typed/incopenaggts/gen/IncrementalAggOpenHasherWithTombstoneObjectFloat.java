...
final class IncrementalAggOpenHasherWithTombstoneObjectFloat extends IncrementalChunkedOperatorAggregationStateManagerOpenAddressedBaseWithTombstones {
    ...
    public IncrementalAggOpenHasherWithTombstoneObjectFloat(ColumnSource[] tableKeySources,
    ...
    private boolean migrateOneLocation(int locationToMigrate, boolean trueOnDeletedEntry) {
        ...
        final float k1 = alternateKeySource1.getUnsafe(locationToMigrate);
        final int hash = hash(k0, k1);
    ...
    protected void adviseNewAlternate() {
        ...
        this.mainKeySource1 = (ImmutableFloatArraySource)super.mainKeySources[1];
        this.alternateKeySource1 = (ImmutableFloatArraySource)super.alternateKeySources[1];
    }
