 ...
 */
public final class ShortIntTimsortDescendingKernel {
    private ShortIntTimsortDescendingKernel() {
    }

    public <SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> ShortIntSortKernelContext<SORT_VALUES_ATTR, PERMUTE_VALUES_ATTR> createContextInstance(
            int size) {
        return new ShortIntSortKernelContext<>(size);
    }

    public static <SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> ShortIntSortKernelContext<SORT_VALUES_ATTR, PERMUTE_VALUES_ATTR> createContext(
            final int size) {
        return new ShortIntTimsortDescendingKernel().createContextInstance(size);
    }
    ...
    private static <SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> void copyToChunk(
            IntChunk<PERMUTE_VALUES_ATTR> rowSetSource, ShortChunk<SORT_VALUES_ATTR> valuesSource,
    ...
    public class ShortIntSortKernelContext<SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> implements IntSortKernel<SORT_VALUES_ATTR, PERMUTE_VALUES_ATTR> {
        int minGallop;
        ...
        public void sort(WritableIntChunk<PERMUTE_VALUES_ATTR> valuesToPermute,
            ...
            ShortIntTimsortDescendingKernel.this.sort(this, valuesToPermute, valuesToSort.asWritableShortChunk());
        }
        ...
        public void sort(WritableIntChunk<PERMUTE_VALUES_ATTR> valuesToPermute,
                ...
                IntChunk<? extends ChunkPositions> offsetsIn,
                IntChunk<? extends ChunkLengths> lengthsIn) {
            ShortIntTimsortDescendingKernel.this.sort(this, valuesToPermute, valuesToSort.asWritableShortChunk(), offsetsIn, lengthsIn);
        }

        @Override
        public void sort(WritableIntChunk<PERMUTE_VALUES_ATTR> valuesToPermute,
                WritableChunk<SORT_VALUES_ATTR> valuesToSort, int offset, int length) {
            ShortIntTimsortDescendingKernel.this.timSort(this, valuesToPermute, valuesToSort.asWritableShortChunk(), offset, length);
        }
        ...
        public void merge(WritableIntChunk<PERMUTE_VALUES_ATTR> valuesToPermute,
                ...
                int length2) {
            ShortIntTimsortDescendingKernel.this.merge(this, valuesToPermute, valuesToSort.asWritableShortChunk(), start1, length1, length2);
        }
        ...
        private ShortIntTimsortDescendingKernel kernel() {
            return ShortIntTimsortDescendingKernel.this;
        }
    }
}
