 ...
 */
public final class DoubleIntTimsortDescendingKernel {
    private DoubleIntTimsortDescendingKernel() {
    }

    public <SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> DoubleIntSortKernelContext<SORT_VALUES_ATTR, PERMUTE_VALUES_ATTR> createContextInstance(
            int size) {
        return new DoubleIntSortKernelContext<>(size);
    }

    public static <SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> DoubleIntSortKernelContext<SORT_VALUES_ATTR, PERMUTE_VALUES_ATTR> createContext(
            final int size) {
        return new DoubleIntTimsortDescendingKernel().createContextInstance(size);
    }
    ...
    static <SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> void sort(
            DoubleIntSortKernelContext<SORT_VALUES_ATTR, PERMUTE_VALUES_ATTR> context,
    ...
    private <SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> void timSort(
            DoubleIntSortKernelContext<SORT_VALUES_ATTR, PERMUTE_VALUES_ATTR> context,
            WritableIntChunk<PERMUTE_VALUES_ATTR> valuesToPermute,
            WritableDoubleChunk<SORT_VALUES_ATTR> valuesToSort, int offset, int length) {
        if (length <= 1) {
            return;
        }
    ...
    private <SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> void merge(
            DoubleIntSortKernelContext<SORT_VALUES_ATTR, PERMUTE_VALUES_ATTR> context,
            WritableIntChunk<PERMUTE_VALUES_ATTR> valuesToPermute,
            WritableDoubleChunk<SORT_VALUES_ATTR> valuesToSort, int start1, int length1,
            int length2) {
    ...
    private <SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> void frontMerge(
            DoubleIntSortKernelContext<SORT_VALUES_ATTR, PERMUTE_VALUES_ATTR> context,
            WritableIntChunk<PERMUTE_VALUES_ATTR> valuesToPermute,
            WritableDoubleChunk<SORT_VALUES_ATTR> valuesToSort, final int mergeStartPosition,
    ...
    private static <SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> void copyToTemporary(
            DoubleIntSortKernelContext<SORT_VALUES_ATTR, PERMUTE_VALUES_ATTR> context,
            WritableIntChunk<PERMUTE_VALUES_ATTR> valuesToPermute,
            WritableDoubleChunk<SORT_VALUES_ATTR> valuesToSort, int mergeStartPosition,
            int remaining1) {
    ...
    private static <SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> void copyToChunk(
            IntChunk<PERMUTE_VALUES_ATTR> rowSetSource, DoubleChunk<SORT_VALUES_ATTR> valuesSource,
            WritableIntChunk<PERMUTE_VALUES_ATTR> permuteValuesDest,
            WritableDoubleChunk<SORT_VALUES_ATTR> sortValuesDest, int sourceStart, int destStart,
            int length) {
    ...
    private int bound(DoubleChunk<?> valuesToSort, int lo, int hi, double searchValue,
            final boolean lower) {
    ...
    private void insertionSort(WritableIntChunk<?> valuesToPermute,
            WritableDoubleChunk<?> valuesToSort, int offset, int length) {
    ...
    private static void swap(WritableIntChunk<?> valuesToPermute,
            WritableDoubleChunk<?> valuesToSort, int a, int b) {
    ...
    public class DoubleIntSortKernelContext<SORT_VALUES_ATTR extends Any, PERMUTE_VALUES_ATTR extends Any> implements IntSortKernel<SORT_VALUES_ATTR, PERMUTE_VALUES_ATTR> {
        int minGallop;
        ...
        public void sort(WritableIntChunk<PERMUTE_VALUES_ATTR> valuesToPermute,
            ...
            DoubleIntTimsortDescendingKernel.this.sort(this, valuesToPermute, valuesToSort.asWritableDoubleChunk());
        }
        ...
        public void sort(WritableIntChunk<PERMUTE_VALUES_ATTR> valuesToPermute,
                ...
                IntChunk<? extends ChunkPositions> offsetsIn,
                IntChunk<? extends ChunkLengths> lengthsIn) {
            DoubleIntTimsortDescendingKernel.this.sort(this, valuesToPermute, valuesToSort.asWritableDoubleChunk(), offsetsIn, lengthsIn);
        }
        ...
        private DoubleIntTimsortDescendingKernel kernel() {
            return DoubleIntTimsortDescendingKernel.this;
        }
    }
}
