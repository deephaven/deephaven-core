...
/**
 * This implements a timsort kernel for a multi-column key (Int, Long) that never moves the column values:
 ...
 */
public final class IntLongIndirectMultiColumnTimsortKernel {
    private IntLongIndirectMultiColumnTimsortKernel() {
        throw new UnsupportedOperationException();
    }

    public static <PERMUTE_VALUES_ATTR extends Any> IntLongIndirectMultiColumnSortKernelContext<PERMUTE_VALUES_ATTR> createContext(
            final int size) {
        return new IntLongIndirectMultiColumnSortKernelContext<>(size);
    }
     ...
     */
    public static void sort(IntLongIndirectMultiColumnSortKernelContext<?> context,
    ...
    private static void timSort(IntLongIndirectMultiColumnSortKernelContext<?> context,
            WritableIntChunk<ChunkPositions> positions, IntChunk<?> valuesToSort0,
     ...
     */
    private static int compareColumns(IntChunk<?> valuesToSort0, LongChunk<?> valuesToSort1,
    ...
    private static void ensureMergeInvariants(
            IntLongIndirectMultiColumnSortKernelContext<?> context,
            WritableIntChunk<ChunkPositions> positions, IntChunk<?> valuesToSort0,
            LongChunk<?> valuesToSort1) {
        while (context.runCount > 1) {
    ...
    private static void merge(IntLongIndirectMultiColumnSortKernelContext<?> context,
            WritableIntChunk<ChunkPositions> positions, IntChunk<?> valuesToSort0,
     ...
     */
    private static void frontMerge(IntLongIndirectMultiColumnSortKernelContext<?> context,
            WritableIntChunk<ChunkPositions> positions, IntChunk<?> valuesToSort0,
     ...
     * We eventually need to do galloping here, but are skipping that for now
     */
    private static void backMerge(IntLongIndirectMultiColumnSortKernelContext<?> context,
            WritableIntChunk<ChunkPositions> positions, IntChunk<?> valuesToSort0,
    ...
    private static void copyToTemporary(IntLongIndirectMultiColumnSortKernelContext<?> context,
    ...
    private static void insertionSort(WritableIntChunk<ChunkPositions> positions,
            IntChunk<?> valuesToSort0, LongChunk<?> valuesToSort1, int offset, int length) {
    ...
    public static class IntLongIndirectMultiColumnSortKernelContext<PERMUTE_VALUES_ATTR extends Any> implements MultiColumnSortKernel<PERMUTE_VALUES_ATTR> {
        int minGallop;
        ...
        private IntLongIndirectMultiColumnSortKernelContext(int size) {
        ...
        public void sort(WritableLongChunk<PERMUTE_VALUES_ATTR> valuesToPermute,
            ...
            IntLongIndirectMultiColumnTimsortKernel.sort(this, positions, valuesToSort[0].asIntChunk(), valuesToSort[1].asLongChunk());
