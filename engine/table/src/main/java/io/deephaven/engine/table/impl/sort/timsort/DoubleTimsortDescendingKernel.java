 ...
 */
public final class DoubleTimsortDescendingKernel {
    private DoubleTimsortDescendingKernel() {
        throw new UnsupportedOperationException();
    }

    public static <ATTR extends Any> DoubleSortKernelContext<ATTR> createContext(final int size) {
     ...
     */
    public static <ATTR extends Any> void sort(DoubleSortKernelContext<ATTR> context,
            final WritableDoubleChunk<ATTR> valuesToSort) {
        timSort(context, valuesToSort, 0, valuesToSort.size());
    }

    private static <ATTR extends Any> void timSort(DoubleSortKernelContext<ATTR> context,
            WritableDoubleChunk<ATTR> valuesToSort, int offset, int length) {
        if (length <= 1) {
            return;
        }
    ...
    private static <ATTR extends Any> void ensureMergeInvariants(
            DoubleSortKernelContext<ATTR> context, WritableDoubleChunk<ATTR> valuesToSort) {
        while (context.runCount > 1) {
    ...
    private static <ATTR extends Any> void merge(DoubleSortKernelContext<ATTR> context,
            WritableDoubleChunk<ATTR> valuesToSort, int start1, int length1, int length2) {
     ...
     */
    private static <ATTR extends Any> void frontMerge(DoubleSortKernelContext<ATTR> context,
            WritableDoubleChunk<ATTR> valuesToSort, final int mergeStartPosition, final int start2,
            final int length2) {
        int tempCursor = 0;
     ...
     * We eventually need to do galloping here, but are skipping that for now
     */
    private static <ATTR extends Any> void backMerge(DoubleSortKernelContext<ATTR> context,
            WritableDoubleChunk<ATTR> valuesToSort, final int mergeStartPosition,
            final int length1) {
    ...
    private static <ATTR extends Any> void copyToTemporary(DoubleSortKernelContext<ATTR> context,
            WritableDoubleChunk<ATTR> valuesToSort, int mergeStartPosition, int remaining1) {
    ...
    private static <ATTR extends Any> void copyToChunk(DoubleChunk<ATTR> valuesSource,
            WritableDoubleChunk<ATTR> valuesDest, int sourceStart, int destStart, int length) {
    ...
    private static void insertionSort(WritableDoubleChunk<?> valuesToSort, int offset, int length) {
    ...
    private static void swap(WritableDoubleChunk<?> valuesToSort, int a, int b) {
