...
public final class ByteDescIndirectTimsortKernel {
    ...
    public static class ByteDescIndirectSortKernelContext<PERMUTE_VALUES_ATTR extends Any> implements MultiColumnSortKernel<PERMUTE_VALUES_ATTR> {
        ...
        public void sortPositions(WritableIntChunk<ChunkPositions> positions,
            ...
            ByteDescIndirectTimsortKernel.timSort(this, positions, valuesToSort[0].asByteChunk(), offset, length);
        }
        ...
        public void mergePositions(WritableIntChunk<ChunkPositions> positions,
            ...
            ByteDescIndirectTimsortKernel.merge(this, positions, valuesToSort[0].asByteChunk(), start1, length1, length2);
        }
