...
public class QueryTableTest extends QueryTableTestBase {
    ...
    public void testView() {
        ...
        assertEquals(Arrays.asList(0, 2, 4), Arrays.asList(TableImpl.getColumn(table0, "x").get(0, table0.size())));
        assertEquals(Arrays.asList("0", "2", "4"), Arrays.asList(TableImpl.getColumn(table0, "y").get(0, table0.size())));

        final QueryTable table = (QueryTable) table0.updateView("z = x + 1", "x = z + 1", "t = x - 3");
        assertEquals(Arrays.asList(1, 3, 5), Arrays.asList(TableImpl.getColumn(table, "z").get(0, table.size())));
        assertEquals(Arrays.asList(2, 4, 6), Arrays.asList(TableImpl.getColumn(table, "x").get(0, table.size())));
        assertEquals(Arrays.asList(-1, 1, 3), Arrays.asList(TableImpl.getColumn(table, "t").get(0, table.size())));
    ...
    public void testView1() {
        ...
        assertNull(TableImpl.getColumn(t.updateView("nullD = NULL_DOUBLE + 0"), "nullD").get(0));

        assertEquals(
                Arrays.asList(TableImpl.getColumn(emptyTable(4).updateView("b1 = (i%2 = 0)?null:true").updateView("x = b1 == null?1:2")
                        .select("x"), "x").get(0, 4)),
        ...
        assertEquals(Arrays.asList(0, 2, 4), Arrays.asList(TableImpl.getColumn(table, "x").get(0, 3)));
        assertEquals(Arrays.asList("0", "2", "4"), Arrays.asList(TableImpl.getColumn(table, "y").get(0, 3)));

        table = table.updateView("z = x + 1", "x = z + 1", "t = x - 3");
        assertEquals(Arrays.asList(1, 3, 5), Arrays.asList(TableImpl.getColumn(table, "z").get(0, 3)));
        assertEquals(Arrays.asList(2, 4, 6), Arrays.asList(TableImpl.getColumn(table, "x").get(0, 3)));
        assertEquals(Arrays.asList(-1, 1, 3), Arrays.asList(TableImpl.getColumn(table, "t").get(0, 3)));
    }
    ...
    public void testReinterpret() {
        ...
        assertEquals((long[]) TableImpl.getColumn(result, 0).getDirect(), LongStream.range(0, 5).toArray());
    ...
    public void testDropColumns() {
        ...
        try {
            TableImpl.getColumn(table.dropColumns("String", "Int"), "Int");
            fail("Expected exception");
        } catch (RuntimeException ignored) {
        }
    ...
    public void testRenameColumns() {
        ...
        assertArrayEquals((int[]) TableImpl.getColumn(table, 1).getDirect(),
                (int[]) TableImpl.getColumn(table.renameColumns("NewInt=Int"), 1).getDirect());
        ...
        assertArrayEquals((int[]) TableImpl.getColumn(table, "Int").getDirect(),
                (int[]) TableImpl.getColumn(table.renameColumns("NewInt=Int"), "NewInt").getDirect());
        assertEquals(table.getColumnSource("Double"), table.renameColumns("NewInt=Int").getColumnSource("Double"));
        try {
            TableImpl.getColumn(table.renameColumns("NewInt=Int"), "Int");
            fail("Expected exception");
        } catch (RuntimeException ignored) {
        }

        assertEquals(3, table.renameColumns("NewInt=Int", "NewString=String").numColumns());
        assertArrayEquals((String[]) TableImpl.getColumn(table, 0).getDirect(),
                (String[]) TableImpl.getColumn(table.renameColumns("NewInt=Int", "NewString=String"), 0).getDirect());
        assertArrayEquals((int[]) TableImpl.getColumn(table, 1).getDirect(),
                (int[]) TableImpl.getColumn(table.renameColumns("NewInt=Int"), 1).getDirect());
        assertEquals(table.getColumnSources().toArray()[2],
                table.renameColumns("NewInt=Int", "NewString=String").getColumnSources().toArray()[2]);
        assertArrayEquals((String[]) TableImpl.getColumn(table, "String").getDirect(),
                (String[]) TableImpl.getColumn(table.renameColumns("NewInt=Int", "NewString=String"), "NewString").getDirect());
        assertArrayEquals((int[]) TableImpl.getColumn(table, "Int").getDirect(),
                (int[]) TableImpl.getColumn(table.renameColumns("NewInt=Int"), "NewInt").getDirect());
        assertEquals(table.getColumnSource("Double"),
                table.renameColumns("NewInt=Int", "NewString=String").getColumnSource("Double"));
        try {
            TableImpl.getColumn(table.renameColumns("NewInt=Int", "NewString=String"), "Int");
            fail("Expected exception");
        } catch (RuntimeException ignored) {
        }
        try {
            TableImpl.getColumn(table.renameColumns("NewInt=Int", "NewString=String"), "String");
            fail("Expected exception");
        } catch (RuntimeException ignored) {
        }
        ...
        try {
            TableImpl.getColumn(table.renameColumns("NewInt=Int").renameColumns("NewString=String"), "Int");
            fail("Expected exception");
        } catch (RuntimeException ignored) {
        }
        try {
            TableImpl.getColumn(table.renameColumns("NewInt=Int").renameColumns("NewString=String"), "String");
            fail("Expected exception");
        } catch (RuntimeException ignored) {
        }
    }
    ...
    public void testReverse() {
        ...
        final DataColumn<Long> licsr = TableImpl.getColumn(bigReversed, "LICS");
    ...
    private void checkReverse(QueryTable table, Table reversed, String timestamp) {
        ...
        for (long ii = 0; ii < table.size(); ++ii) {
            ...
            assertEquals(TableImpl.getColumn(table, timestamp).get(ii), TableImpl.getColumn(reversed, timestamp).get(jj));
        }
    }
    ...
    public void testSnapshotDependencies() {
        ...
        TestCase.assertEquals(2, TableImpl.getColumn(snappedOfSnap, "B").get(0));
    }
    ...
    public void testSnapshotIncrementalDependencies() {
        ...
        TestCase.assertEquals(TableImpl.getColumn(snappedOfSnap, "B").get(0), 1);
        ...
        TestCase.assertEquals(TableImpl.getColumn(snappedOfSnap, "B").get(0), 2);
    }
            ...
            for (int step = 0; step < 200; step++) {
                ...
                if (modStamp) {
                    ...
                    if (coalescingListener.getCount() > 0) {
                        ...
                        final DataColumn<Integer> lastStamps = TableImpl.getColumn(lastSnapshot, "Stamp");
    ...
    public void testUngroupingAgnostic() {
        ...
        assertEquals(Arrays.asList(1, 1, 1, 3, 3), Arrays.asList(TableImpl.getColumn(t1, "X").get(0, 5)));
        assertEquals(Arrays.asList("a", "b", "c", "d", "e"), Arrays.asList(TableImpl.getColumn(t1, "Y").get(0, 5)));
        assertEquals(Arrays.asList(4, 5, 6, 7, 8), Arrays.asList(TableImpl.getColumn(t1, "Z").get(0, 5)));
        ...
        assertEquals(5, t1.size());
        assertEquals(Arrays.asList("X", "Y", "Z"), t1.getDefinition().getColumnNames());
        assertEquals(Arrays.asList(1, 1, 1, 2, 2), Arrays.asList(TableImpl.getColumn(t1, "X").get(0, 5)));
        assertEquals(Arrays.asList("a", "b", "c", "d", "e"), Arrays.asList(TableImpl.getColumn(t1, "Y").get(0, 5)));
        show(t1);
        show(t1.ungroup("Z"));
        t1 = t1.ungroup("Z");
        ...
        assertEquals(Arrays.asList("X", "Y", "Z"), t1.getDefinition().getColumnNames());
        assertEquals(Arrays.asList(1, 1, 1, 1, 1, 1, 1, 1, 1), Arrays.asList(TableImpl.getColumn(t1, "X").get(0, 9)));
        assertEquals(Arrays.asList("a", "a", "a", "b", "b", "b", "c", "c", "c"),
                Arrays.asList(TableImpl.getColumn(t1, "Y").get(0, 9)));
        assertEquals(Arrays.asList(4, 5, 6, 4, 5, 6, 4, 5, 6), Arrays.asList(TableImpl.getColumn(t1, "Z").get(0, 9)));
        ...
        assertEquals(Arrays.asList("X", "Y", "Z"), t1.getDefinition().getColumnNames());
        assertEquals(Arrays.asList(1, 1, 1, 1, 1, 1, 1, 1, 1), Arrays.asList(TableImpl.getColumn(t1, "X").get(0, 9)));
        assertEquals(Arrays.asList(4, 4, 4, 5, 5, 5, 6, 6, 6), Arrays.asList(TableImpl.getColumn(t1, "Z").get(0, 9)));
    ...
    public void testUngroupableColumnSources() {
        ...
        final int[] intDirect = (int[]) TableImpl.getColumn(t2, "Int").getDirect();
    ...
    public void testUngroupWithRebase() {
        ...
        try {
            ...
            assertEquals(5, t1.size());
            assertEquals(Arrays.asList("X", "Y"), t1.getDefinition().getColumnNames());
            assertEquals(Arrays.asList(1, 1, 1, 2, 2), Ints.asList((int[]) TableImpl.getColumn(t1, "X").getDirect()));
            assertEquals(Arrays.asList("a", "b", "c", "d", "e"),
                    Arrays.asList((String[]) TableImpl.getColumn(t1, "Y").getDirect()));
            validateUpdates(t1);
            ...
            assertEquals(Arrays.asList(1, 1, 1, 2, 2, 3, 3, 3, 3, 3, 3),
                    Ints.asList((int[]) (TableImpl.getColumn(t1, "X").getDirect())));
