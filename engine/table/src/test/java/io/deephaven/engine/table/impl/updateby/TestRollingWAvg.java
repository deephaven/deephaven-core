...
//    }
    ...
    private void doTestStaticZeroKey(final int prevTicks, final int postTicks) {
        ...
        final Table actual = t.updateBy(UpdateByOperation.RollingWAvg(prevTicks, postTicks, "doubleCol", primitiveColumns));
...
//        doTestStaticZeroKeyBigNumbers(t, prevTicks, postTicks);
    ...
    private void doTestStaticZeroKeyTimed(final Duration prevTime, final Duration postTime) {
        ...
        final Table actual = t.updateBy(UpdateByOperation.RollingWAvg("ts", prevTime, postTime, "doubleCol", primitiveColumns));
