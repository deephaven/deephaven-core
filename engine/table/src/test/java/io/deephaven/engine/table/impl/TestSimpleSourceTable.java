    ...
    public void setUp() throws Exception {
        ...
        columnSources = TABLE_DEFINITION.getColumnStream().map(cd -> {
            ...
            final ChunkSource.FillContext mockedFillContext =
                    jmock.mock(ChunkSource.FillContext.class, "_FC_" + cd.getName());
            final ChunkSource.GetContext mockedGetContext =
                    jmock.mock(ChunkSource.GetContext.class, "_GC_" + cd.getName());
            jmock.checking(new Expectations() {
                {
        ...
        keySupplier = jmock.mock(LiveSupplier.class);
        locationProvider = jmock.mock(TableLocationProvider.class);
        tableLocation = jmock.mock(TableLocation.class);
        jmock.checking(new Expectations() {
            {
