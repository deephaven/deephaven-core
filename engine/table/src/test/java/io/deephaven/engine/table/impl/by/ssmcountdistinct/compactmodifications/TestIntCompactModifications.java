...
public class TestIntCompactModifications {
    @Test
    public void testPureRemovals() {
        // every value drops out entirely (nothing added survives)
        check(new int[] {(int) ('a' + 0), (int) ('a' + 0), (int) ('a' + 1)},
                new int[] {(int) ('a' + 2), (int) ('a' + 2), (int) ('a' + 2)},
                0, 3, true, true,
                new int[] {(int) ('a' + 0), (int) ('a' + 1)}, new int[] {2, 1},
                new int[] {(int) ('a' + 2)}, new int[] {3});
    }
    ...
    public void testFullyCancelled() {
        ...
        check(new int[] {(int) ('a' + 0), (int) ('a' + 0), (int) ('a' + 1)},
                new int[] {(int) ('a' + 0), (int) ('a' + 0), (int) ('a' + 1)},
                0, 3, true, true,
                new int[] {}, new int[] {},
                new int[] {}, new int[] {});
    }
    ...
    public void testPartialDeltaMoreRemoved() {
        ...
        check(new int[] {(int) ('a' + 0), (int) ('a' + 0), (int) ('a' + 0)},
                new int[] {(int) ('a' + 0), (int) ('a' + 1), (int) ('a' + 2)},
                0, 3, true, true,
                new int[] {(int) ('a' + 0)}, new int[] {2},
                new int[] {(int) ('a' + 1), (int) ('a' + 2)}, new int[] {1, 1});
    }

    @Test
    public void testPartialDeltaMoreAdded() {
        // mirror image: 'a' goes from 1 to 3 (net add 2); 'b' and 'c' are wholly removed
        check(new int[] {(int) ('a' + 0), (int) ('a' + 1), (int) ('a' + 2)},
                new int[] {(int) ('a' + 0), (int) ('a' + 0), (int) ('a' + 0)},
                0, 3, true, true,
                new int[] {(int) ('a' + 1), (int) ('a' + 2)}, new int[] {1, 1},
                new int[] {(int) ('a' + 0)}, new int[] {2});
    }
    ...
    public void testNonZeroStart() {
        ...
        final int[] removed = new int[] {(int) ('a' + 3), (int) ('a' + 3),
                (int) ('a' + 0), (int) ('a' + 0), (int) ('a' + 1)};
        final int[] added = new int[] {(int) ('a' + 3), (int) ('a' + 3),
        ...
        IntCompactModifications.compactAndCountModifications(
                WritableIntChunk.writableChunkWrap(removed), WritableIntChunk.writableChunkWrap(removedCounts),
                WritableIntChunk.writableChunkWrap(added), WritableIntChunk.writableChunkWrap(addedCounts),
                2, 3, 2, 3, true, true, removedSize, addedSize);

        assertEquals(2, removedSize.get());
        assertEquals(1, addedSize.get());
        // the prefix is untouched
        assertEquals((int) ('a' + 3), removed[0]/*EXTRA*/);
        assertEquals((int) ('a' + 3), removed[1]/*EXTRA*/);
        assertEquals((int) ('a' + 3), added[0]/*EXTRA*/);
        assertEquals((int) ('a' + 3), added[1]/*EXTRA*/);
        assertArrayEquals(new int[] {(int) ('a' + 0), (int) ('a' + 1)},
        ...
        assertArrayEquals(new int[] {(int) ('a' + 2)},
    ...
    public void testNullIgnored() {
        ...
        check(new int[] {(int) ('a' + 0), NULL_INT, NULL_INT},
                new int[] {(int) ('a' + 0), (int) ('a' + 0), NULL_INT},
                0, 3, false, true,
                new int[] {}, new int[] {},
                new int[] {(int) ('a' + 0)}, new int[] {1});
    }

    @Test
    public void testNullCounted() {
        // with countNull == true the null run participates: net remove one null, net add one 'a'
        check(new int[] {NULL_INT, NULL_INT, (int) ('a' + 0)},
                new int[] {NULL_INT, (int) ('a' + 0), (int) ('a' + 0)},
                0, 3, true, true,
                new int[] {NULL_INT}, new int[] {1},
                new int[] {(int) ('a' + 0)}, new int[] {1});
    }

    @Test
    public void testEmpty() {
        check(new int[] {}, new int[] {}, 0, 0, true, true,
                new int[] {}, new int[] {},
                new int[] {}, new int[] {});
    }
    ...
    public void testDistinctRemovedAddedRanges() {
        ...
        final int[] removed = new int[] {(int) ('a' + 3), (int) ('a' + 1), (int) ('a' + 0)};
        final int[] added = new int[] {(int) ('a' + 3), (int) ('a' + 3), (int) ('a' + 3),
                (int) ('a' + 0), (int) ('a' + 0), (int) ('a' + 2)};
        final int[] removedCounts = new int[removed.length];
        final int[] addedCounts = new int[added.length];
        ...
        assertEquals((int) ('a' + 3), removed[0]/*EXTRA*/);
        assertArrayEquals(new int[] {(int) ('a' + 1)}, Arrays.copyOfRange(removed, 1, 1 + removedSize.get())/*EXTRA*/);
        assertArrayEquals(new int[] {1}, Arrays.copyOfRange(removedCounts, 1, 1 + removedSize.get()));
        // added survivors begin at addedStart == 3
        assertArrayEquals(new int[] {(int) ('a' + 0), (int) ('a' + 2)},
    ...
    private static void check(int[] removed, int[] added, int start, int length, boolean countNull,
            boolean countNaN, int[] expectedRemoved, int[] expectedRemovedCounts, int[] expectedAdded,
