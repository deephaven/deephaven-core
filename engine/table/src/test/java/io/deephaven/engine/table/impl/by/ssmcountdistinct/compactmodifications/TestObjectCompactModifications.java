...
public class TestObjectCompactModifications {
    @Test
    public void testPureRemovals() {
        // every value drops out entirely (nothing added survives)
        check(new Object[] {(Object) ('a' + 0), (Object) ('a' + 0), (Object) ('a' + 1)},
                new Object[] {(Object) ('a' + 2), (Object) ('a' + 2), (Object) ('a' + 2)},
                0, 3, true, true,
                new Object[] {(Object) ('a' + 0), (Object) ('a' + 1)}, new int[] {2, 1},
                new Object[] {(Object) ('a' + 2)}, new int[] {3});
    }
    ...
    public void testFullyCancelled() {
        ...
        check(new Object[] {(Object) ('a' + 0), (Object) ('a' + 0), (Object) ('a' + 1)},
                new Object[] {(Object) ('a' + 0), (Object) ('a' + 0), (Object) ('a' + 1)},
                0, 3, true, true,
                new Object[] {}, new int[] {},
                new Object[] {}, new int[] {});
    }
    ...
    public void testPartialDeltaMoreRemoved() {
        ...
        check(new Object[] {(Object) ('a' + 0), (Object) ('a' + 0), (Object) ('a' + 0)},
                new Object[] {(Object) ('a' + 0), (Object) ('a' + 1), (Object) ('a' + 2)},
                0, 3, true, true,
                new Object[] {(Object) ('a' + 0)}, new int[] {2},
                new Object[] {(Object) ('a' + 1), (Object) ('a' + 2)}, new int[] {1, 1});
    }

    @Test
    public void testPartialDeltaMoreAdded() {
        // mirror image: 'a' goes from 1 to 3 (net add 2); 'b' and 'c' are wholly removed
        check(new Object[] {(Object) ('a' + 0), (Object) ('a' + 1), (Object) ('a' + 2)},
                new Object[] {(Object) ('a' + 0), (Object) ('a' + 0), (Object) ('a' + 0)},
                0, 3, true, true,
                new Object[] {(Object) ('a' + 1), (Object) ('a' + 2)}, new int[] {1, 1},
                new Object[] {(Object) ('a' + 0)}, new int[] {2});
    }
    ...
    public void testNonZeroStart() {
        ...
        final Object[] removed = new Object[] {(Object) ('a' + 3), (Object) ('a' + 3),
                (Object) ('a' + 0), (Object) ('a' + 0), (Object) ('a' + 1)};
        final Object[] added = new Object[] {(Object) ('a' + 3), (Object) ('a' + 3),
                (Object) ('a' + 2), (Object) ('a' + 2), (Object) ('a' + 2)};
        ...
        ObjectCompactModifications.compactAndCountModifications(
                WritableObjectChunk.writableChunkWrap(removed), WritableIntChunk.writableChunkWrap(removedCounts),
                WritableObjectChunk.writableChunkWrap(added), WritableIntChunk.writableChunkWrap(addedCounts),
                2, 3, 2, 3, true, true, removedSize, addedSize);

        assertEquals(2, removedSize.get());
        assertEquals(1, addedSize.get());
        // the prefix is untouched
        assertEquals((Object) ('a' + 3), removed[0]/*EXTRA*/);
        assertEquals((Object) ('a' + 3), removed[1]/*EXTRA*/);
        assertEquals((Object) ('a' + 3), added[0]/*EXTRA*/);
        assertEquals((Object) ('a' + 3), added[1]/*EXTRA*/);
        assertArrayEquals(new Object[] {(Object) ('a' + 0), (Object) ('a' + 1)},
        ...
        assertArrayEquals(new Object[] {(Object) ('a' + 2)},
    ...
    public void testNullIgnored() {
        ...
        check(new Object[] {(Object) ('a' + 0), null, null},
                new Object[] {(Object) ('a' + 0), (Object) ('a' + 0), null},
                0, 3, false, true,
                new Object[] {}, new int[] {},
                new Object[] {(Object) ('a' + 0)}, new int[] {1});
    }

    @Test
    public void testNullCounted() {
        // with countNull == true the null run participates: net remove one null, net add one 'a'
        check(new Object[] {null, null, (Object) ('a' + 0)},
                new Object[] {null, (Object) ('a' + 0), (Object) ('a' + 0)},
                0, 3, true, true,
    ...
    public void testEmpty() {
        check(new Object[] {}, new Object[] {}, 0, 0, true, true,
                new Object[] {}, new int[] {},
                new Object[] {}, new int[] {});
    }
    ...
    public void testDistinctRemovedAddedRanges() {
        ...
        final Object[] removed = new Object[] {(Object) ('a' + 3), (Object) ('a' + 1), (Object) ('a' + 0)};
        final Object[] added = new Object[] {(Object) ('a' + 3), (Object) ('a' + 3), (Object) ('a' + 3),
                (Object) ('a' + 0), (Object) ('a' + 0), (Object) ('a' + 2)};
        final int[] removedCounts = new int[removed.length];
        final int[] addedCounts = new int[added.length];
        ...
        assertEquals((Object) ('a' + 3), removed[0]/*EXTRA*/);
        assertArrayEquals(new Object[] {(Object) ('a' + 1)}, Arrays.copyOfRange(removed, 1, 1 + removedSize.get())/*EXTRA*/);
        assertArrayEquals(new int[] {1}, Arrays.copyOfRange(removedCounts, 1, 1 + removedSize.get()));
        // added survivors begin at addedStart == 3
        assertArrayEquals(new Object[] {(Object) ('a' + 0), (Object) ('a' + 2)},
    ...
    private static void check(Object[] removed, Object[] added, int start, int length, boolean countNull,
            boolean countNaN, Object[] expectedRemoved, int[] expectedRemovedCounts, Object[] expectedAdded,
