...
public abstract class BaseTestCharTimSortKernel extends TestTimSortKernel {
    ...
    static class CharMultiSortKernelStuff extends SortMultiKernelStuff<CharLongLongTuple> {
        ...
        CharMultiSortKernelStuff(List<CharLongLongTuple> javaTuples) {
            ...
            secondarySortContext = io.deephaven.engine.table.impl.sort.timsort2.LongLongTimsortKernel.createContext(size);
            ...
            secondaryColumnSource = new AbstractColumnSource.DefaultedImmutable<>(long.class) {
                ...
                public long getLong(long rowKey) {
                    final CharLongLongTuple charLongLongTuple = javaTuples.get((int) (rowKey / 10));
