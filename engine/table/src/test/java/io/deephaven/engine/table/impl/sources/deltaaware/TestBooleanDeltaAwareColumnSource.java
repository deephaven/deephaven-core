...
public class TestBooleanDeltaAwareColumnSource {
    ...
    public void simple2() {
        ...
        final long key0 = 5;
        final long key1 = 6;
        final byte[] values = ArrayGenerator.randomBooleans(rng, 3);
    ...
    public void overlapping() {
        ...
        final byte[] valuesPhase1 = ArrayGenerator.randomBooleans(rng, length);
    ...
    private static void checkUsingChunk(DeltaAwareColumnSource<Boolean> dacs, Map<Long, Byte> expectedCurrent,
    ...
    private static void checkChunk(ObjectChunk<Boolean, ? extends Values> values, Map<Long, Byte> expected, RowSet keys) {
        int sliceOffset = 0;
