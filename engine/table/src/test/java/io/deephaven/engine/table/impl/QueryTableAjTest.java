...
public class QueryTableAjTest {
    ...
    public void testAjStaticIndexed(boolean leftIndexed, boolean rightIndexed) {
        ...
        if (leftIndexed) {
            DataIndexer.of(left.getRowSet()).getOrCreateDataIndex(left, "BucketA", "BucketB");
        }
        if (rightIndexed) {
            DataIndexer.of(right.getRowSet()).getOrCreateDataIndex(right, "BucketA", "BucketB");
        }
    ...
    private void testAjRandomIncrementalWithInitial(int seed, int leftNodeSize, int rightNodeSize, int leftSize,
        ...
        final QueryTable leftTable = getTable(leftRefreshing, leftSize, random,
                leftColumnInfo = initColumnInfos(new String[] {"Truthiness", "Bucket", "LeftStamp", "LeftSentinel"},
                        ...
                        new IntGenerator(10_000_000, 10_010_000)));
        if (leftIndexing) {
            DataIndexer.of(leftTable.getRowSet()).getOrCreateDataIndex(leftTable, "Bucket");
        }
        ...
        if (rightIndexing) {
            ...
            DataIndexer.of(rightSorted.getRowSet()).getOrCreateDataIndex(rightSorted, "Bucket");
        }
        ...
        if (rightIndexing) {
            ...
            DataIndexer.of(rightReversed.getRowSet()).getOrCreateDataIndex(rightReversed, "Bucket");
        }
