...
public class TestCharCompactModifications {
    @Test
    public void testPureRemovals() {
        // every value drops out entirely (nothing added survives)
        check(new char[] {(char) ('a' + 0), (char) ('a' + 0), (char) ('a' + 1)},
                new char[] {(char) ('a' + 2), (char) ('a' + 2), (char) ('a' + 2)},
                0, 3, true, true,
                new char[] {(char) ('a' + 0), (char) ('a' + 1)}, new int[] {2, 1},
                new char[] {(char) ('a' + 2)}, new int[] {3});
    }
    ...
    public void testFullyCancelled() {
        ...
        check(new char[] {(char) ('a' + 0), (char) ('a' + 0), (char) ('a' + 1)},
                new char[] {(char) ('a' + 0), (char) ('a' + 0), (char) ('a' + 1)},
                0, 3, true, true,
                new char[] {}, new int[] {},
                new char[] {}, new int[] {});
    }
    ...
    public void testPartialDeltaMoreRemoved() {
        ...
        check(new char[] {(char) ('a' + 0), (char) ('a' + 0), (char) ('a' + 0)},
                new char[] {(char) ('a' + 0), (char) ('a' + 1), (char) ('a' + 2)},
                0, 3, true, true,
                new char[] {(char) ('a' + 0)}, new int[] {2},
                new char[] {(char) ('a' + 1), (char) ('a' + 2)}, new int[] {1, 1});
    }

    @Test
    public void testPartialDeltaMoreAdded() {
        // mirror image: 'a' goes from 1 to 3 (net add 2); 'b' and 'c' are wholly removed
        check(new char[] {(char) ('a' + 0), (char) ('a' + 1), (char) ('a' + 2)},
                new char[] {(char) ('a' + 0), (char) ('a' + 0), (char) ('a' + 0)},
                0, 3, true, true,
                new char[] {(char) ('a' + 1), (char) ('a' + 2)}, new int[] {1, 1},
                new char[] {(char) ('a' + 0)}, new int[] {2});
    }
    ...
    public void testNonZeroStart() {
        ...
        final char[] removed = new char[] {(char) ('a' + 3), (char) ('a' + 3),
                (char) ('a' + 0), (char) ('a' + 0), (char) ('a' + 1)};
        final char[] added = new char[] {(char) ('a' + 3), (char) ('a' + 3),
                (char) ('a' + 2), (char) ('a' + 2), (char) ('a' + 2)};
        ...
        CharCompactModifications.compactAndCountModifications(
                WritableCharChunk.writableChunkWrap(removed), WritableIntChunk.writableChunkWrap(removedCounts),
                WritableCharChunk.writableChunkWrap(added), WritableIntChunk.writableChunkWrap(addedCounts),
                2, 3, 2, 3, true, true, removedSize, addedSize);

        assertEquals(2, removedSize.get());
        assertEquals(1, addedSize.get());
        // the prefix is untouched
        assertEquals((char) ('a' + 3), removed[0]/*EXTRA*/);
        assertEquals((char) ('a' + 3), removed[1]/*EXTRA*/);
        assertEquals((char) ('a' + 3), added[0]/*EXTRA*/);
        assertEquals((char) ('a' + 3), added[1]/*EXTRA*/);
        assertArrayEquals(new char[] {(char) ('a' + 0), (char) ('a' + 1)},
        ...
        assertArrayEquals(new char[] {(char) ('a' + 2)},
    ...
    public void testNullIgnored() {
        ...
        check(new char[] {(char) ('a' + 0), NULL_CHAR, NULL_CHAR},
                new char[] {(char) ('a' + 0), (char) ('a' + 0), NULL_CHAR},
                0, 3, false, true,
                new char[] {}, new int[] {},
                new char[] {(char) ('a' + 0)}, new int[] {1});
    }

    @Test
    public void testNullCounted() {
        // with countNull == true the null run participates: net remove one null, net add one 'a'
        check(new char[] {NULL_CHAR, NULL_CHAR, (char) ('a' + 0)},
                new char[] {NULL_CHAR, (char) ('a' + 0), (char) ('a' + 0)},
                0, 3, true, true,
                new char[] {NULL_CHAR}, new int[] {1},
                new char[] {(char) ('a' + 0)}, new int[] {1});
    }

    @Test
    public void testEmpty() {
        check(new char[] {}, new char[] {}, 0, 0, true, true,
                new char[] {}, new int[] {},
                new char[] {}, new int[] {});
    }
    ...
    public void testDistinctRemovedAddedRanges() {
        ...
        final char[] removed = new char[] {(char) ('a' + 3), (char) ('a' + 1), (char) ('a' + 0)};
        final char[] added = new char[] {(char) ('a' + 3), (char) ('a' + 3), (char) ('a' + 3),
                (char) ('a' + 0), (char) ('a' + 0), (char) ('a' + 2)};
        final int[] removedCounts = new int[removed.length];
        final int[] addedCounts = new int[added.length];
        ...
        assertEquals((char) ('a' + 3), removed[0]/*EXTRA*/);
        assertArrayEquals(new char[] {(char) ('a' + 1)}, Arrays.copyOfRange(removed, 1, 1 + removedSize.get())/*EXTRA*/);
        assertArrayEquals(new int[] {1}, Arrays.copyOfRange(removedCounts, 1, 1 + removedSize.get()));
        // added survivors begin at addedStart == 3
        assertArrayEquals(new char[] {(char) ('a' + 0), (char) ('a' + 2)},
    ...
    private static void check(char[] removed, char[] added, int start, int length, boolean countNull,
            boolean countNaN, char[] expectedRemoved, int[] expectedRemovedCounts, char[] expectedAdded,
