...
public class TestEma extends BaseUpdateByTest {
    ...
    public void testStaticZeroKey() {
        ...
        computeEma((TableBase) t.dropColumns("ts"), null, 100, skipControl);
        computeEma((TableBase) t.dropColumns("ts"), null, 100, resetControl);
    ...
    private void doTestStaticBucketed(boolean grouped) {
        final TableBase t = createTestTable(100000, true, grouped, false, 0x31313131,
                new String[] {"ts"}, new TstUtils.Generator[] {new TstUtils.SortedDateTimeGenerator(
                        convertDateTime("2022-03-09T09:00:00.000 NY"),
                        convertDateTime("2022-03-09T16:30:00.000 NY"))}).t;
        ...
        final OperationControl resetControl = OperationControl.builder()
                .onNullValue(BadDataBehavior.RESET)
                .onNanValue(BadDataBehavior.RESET).build();
        computeEma((TableBase) t.dropColumns("ts"), null, 100, skipControl, "Sym");
        computeEma((TableBase) t.dropColumns("ts"), null, 100, resetControl, "Sym");
    ...
    public void testThrowBehaviors() {
        ...
        final TableBase bytes = testTable(RowSetFactory.flat(4).toTracking(),
        ...
        TableBase doubles = testTable(RowSetFactory.flat(4).toTracking(),
        ...
        TableBase bi = testTable(RowSetFactory.flat(4).toTracking(),
        ...
        TableBase bd = testTable(RowSetFactory.flat(4).toTracking(),
    ...
    private void testThrowsInternal(TableBase table) {
        assertThrows(TableDataException.class,
    ...
    public void testResetBehavior() {
        ...
        TableBase input = testTable(RowSetFactory.flat(3).toTracking(), doubleCol("col", 0, Double.NaN, 1));
    ...
    private void testResetBehaviorInternal(Table expected, final ColumnHolder ts, final ColumnHolder col) {
        ...
        TableBase input = testTable(RowSetFactory.flat(6).toTracking(), ts, col);
    ...
    public void testPoison() {
        ...
        TableBase input = testTable(RowSetFactory.flat(5).toTracking(),
