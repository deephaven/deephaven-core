    ...
    public void testBoundsAscending() {
        ...
        try {
            ...
            assertEquals(-6, CharColumnBinarySearchKernel.upperBoundAscending(
                    source, selection, 0, lastPos, (char) 4, false, false)); // inserting 4 at pos 5 preserves sort
                                                                             // order
            assertEquals(-6, CharColumnBinarySearchKernel.upperBoundAscending(
                    source, selection, 0, lastPos, (char) 4, true, false)); // inserting 4 at pos 5 preserves sort order
            ...
            assertEquals(-1, CharColumnBinarySearchKernel.upperBoundAscending(
                    source, selection, 0, lastPos, (char) 1, false, false)); // inserting 1 at pos 0 preserves sort
                                                                             // order
            ...
            assertEquals(7, CharColumnBinarySearchKernel.upperBoundAscending(
                    source, selection, 0, lastPos, (char) 5, true, false)); // inserting 5 at pos 7 preserves sort order
        } finally {
            selection.close();
            source.clear(true);
        }
