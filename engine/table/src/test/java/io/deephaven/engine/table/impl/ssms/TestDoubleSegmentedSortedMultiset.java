...
public class TestDoubleSegmentedSortedMultiset extends RefreshingTableTestCase {
    ...
    public void testMoveSingletonMerge() {
        final int nodeSize = 4;
        final SsaTestHelpers.TestDescriptor desc = new SsaTestHelpers.TestDescriptor();
        final double v = (double) ('a' + 5);
        final double w = (double) ('a' + 6);

        // moveFrontToBack: a singleton whose value equals the destination's (singleton) maximum merges via addMaxCount
        {
            final DoubleSegmentedSortedMultiset source = makeSsm(nodeSize, new double[] {v}, new int[] {2});
            final DoubleSegmentedSortedMultiset dest = makeSsm(nodeSize, new double[] {v}, new int[] {3});
            source.moveFrontToBack(dest, source.totalSize());
            verifySsm(source, new double[0], desc);
            verifySsm(dest, new double[] {v, v, v, v, v}, desc);
        }
        ...
        {
            final DoubleSegmentedSortedMultiset source = makeSsm(nodeSize, new double[] {v, w}, new int[] {3, 1});
            final DoubleSegmentedSortedMultiset dest = makeSsm(nodeSize, new double[] {v}, new int[] {1});
            source.moveFrontToBack(dest, 1);
            verifySsm(source, new double[] {v, v, w}, desc);
            verifySsm(dest, new double[] {v, v}, desc);
        }

        // moveBackToFront: the symmetric case, reducing the source maximum in place (addMaxCount(-count))
        {
            final DoubleSegmentedSortedMultiset source = makeSsm(nodeSize, new double[] {v, w}, new int[] {1, 3});
            final DoubleSegmentedSortedMultiset dest = makeSsm(nodeSize, new double[] {w}, new int[] {1});
            source.moveBackToFront(dest, 1);
            verifySsm(source, new double[] {v, w, w}, desc);
            verifySsm(dest, new double[] {w, w}, desc);
        }
    }
    ...
    public void testInsertIntoMiddleLeafSplit() {
        ...
        for (int ii = 0; ii < 12; ++ii) {
            initial[ii] = (double) ('a' + 2 * ii);
        }
        final DoubleSegmentedSortedMultiset ssm = makeSsm(nodeSize, initial);

        try (final WritableDoubleChunk<Values> values = WritableDoubleChunk.makeWritableChunk(3);
                final WritableIntChunk<ChunkLengths> counts = WritableIntChunk.makeWritableChunk(3)) {
            values.set(0, (double) ('a' + 1));
            values.set(1, (double) ('a' + 3));
            values.set(2, (double) ('a' + 5));
            counts.set(0, 1);
            counts.set(1, 1);
            counts.set(2, 1);
        ...
        final double[] expected = new double[] {
                (double) ('a' + 0), (double) ('a' + 1), (double) ('a' + 2), (double) ('a' + 3), (double) ('a' + 4),
                (double) ('a' + 5), (double) ('a' + 6), (double) ('a' + 8), (double) ('a' + 10), (double) ('a' + 12),
                (double) ('a' + 14), (double) ('a' + 16), (double) ('a' + 18), (double) ('a' + 20), (double) ('a' + 22)};
    ...
    public void testRemoveMaxMultiLeaf() {
        ...
        final DoubleSegmentedSortedMultiset source = makeSsm(nodeSize, new double[] {
                (double) ('a' + 0), (double) ('a' + 1), (double) ('a' + 2), (double) ('a' + 3), (double) ('a' + 4)});
        final DoubleSegmentedSortedMultiset dest =
                makeSsm(nodeSize, new double[] {(double) ('a' + 4), (double) ('a' + 5)});
        source.moveBackToFront(dest, 1);
        verifySsm(source, new double[] {(double) ('a' + 0), (double) ('a' + 1), (double) ('a' + 2), (double) ('a' + 3)}, desc);
    ...
    public void testRemoveMaxSizeOne() {
        ...
        final DoubleSegmentedSortedMultiset source =
                makeSsm(nodeSize, new double[] {(double) ('a' + 3), (double) ('a' + 4)});
        final DoubleSegmentedSortedMultiset dest1 =
                makeSsm(nodeSize, new double[] {(double) ('a' + 4), (double) ('a' + 5)});
        source.moveBackToFront(dest1, 1);
        verifySsm(source, new double[] {(double) ('a' + 3)}, desc);
        verifySsm(dest1, new double[] {(double) ('a' + 4), (double) ('a' + 4), (double) ('a' + 5)}, desc);

        // removing the maximum of that size-1 directory clears the set (removeMax's size == 1 branch)
        final DoubleSegmentedSortedMultiset dest2 =
                makeSsm(nodeSize, new double[] {(double) ('a' + 3), (double) ('a' + 6)});
    ...
    public void testMoveFrontToBackPartialAppend() {
        ...
        {
            final DoubleSegmentedSortedMultiset source =
                    makeSsm(nodeSize, new double[] {(double) ('a' + 2), (double) ('a' + 3)}, new int[] {2, 2});
            final DoubleSegmentedSortedMultiset dest =
                    makeSsm(nodeSize, new double[] {(double) ('a' + 0), (double) ('a' + 1)});
            source.moveFrontToBack(dest, 1);
            verifySsm(source, new double[] {(double) ('a' + 2), (double) ('a' + 3), (double) ('a' + 3)}, desc);
            verifySsm(dest, new double[] {(double) ('a' + 0), (double) ('a' + 1), (double) ('a' + 2)}, desc);
        }
        ...
        {
            final DoubleSegmentedSortedMultiset source =
                    makeSsm(nodeSize, new double[] {(double) ('a' + 5), (double) ('a' + 6)}, new int[] {2, 2});
            final DoubleSegmentedSortedMultiset dest = makeSsm(nodeSize, new double[] {
                    (double) ('a' + 0), (double) ('a' + 1), (double) ('a' + 2), (double) ('a' + 3), (double) ('a' + 4)});
            source.moveFrontToBack(dest, 1);
            verifySsm(source, new double[] {(double) ('a' + 5), (double) ('a' + 6), (double) ('a' + 6)}, desc);
            verifySsm(dest, new double[] {(double) ('a' + 0), (double) ('a' + 1), (double) ('a' + 2), (double) ('a' + 3),
                    (double) ('a' + 4), (double) ('a' + 5)}, desc);
        }
    }
    ...
    public void testMoveBackToFrontCompleteLeaves() {
        ...
        final DoubleSegmentedSortedMultiset source = makeSsm(nodeSize, new double[] {
                (double) ('a' + 0), (double) ('a' + 1), (double) ('a' + 2), (double) ('a' + 3), (double) ('a' + 4),
                (double) ('a' + 5), (double) ('a' + 6), (double) ('a' + 7), (double) ('a' + 8)},
                new int[] {1, 1, 1, 2, 1, 1, 1, 1, 1});
        final DoubleSegmentedSortedMultiset dest =
                makeSsm(nodeSize, new double[] {(double) ('a' + 9), (double) ('a' + 10)});
        source.moveBackToFront(dest, 6);
        verifySsm(source,
                new double[] {(double) ('a' + 0), (double) ('a' + 1), (double) ('a' + 2), (double) ('a' + 3)}, desc);
        verifySsm(dest, new double[] {(double) ('a' + 3), (double) ('a' + 4), (double) ('a' + 5), (double) ('a' + 6),
    ...
    public void testScalarInsertRemove() {
        ...
        for (int seed = 0; seed < 20; ++seed) {
            ...
            for (int ii = 0; ii < 60; ++ii) {
                ...
                final boolean added = ssm.insert((double) ('a' + offset), count);
            ...
            while (true) {
                ...
                final boolean removed = ssm.remove((double) ('a' + offset), count);
                refCounts[offset] -= count;
    ...
    private void verifyScalar(DoubleSegmentedSortedMultiset ssm, long[] refCounts, SsaTestHelpers.TestDescriptor desc) {
        int total = 0;
        int distinct = 0;
        ...
        final double[] expanded = new double[total];
        int position = 0;
        for (int offset = 0; offset < refCounts.length; ++offset) {
            for (long kk = 0; kk < refCounts[offset]; ++kk) {
                expanded[position++] = (double) ('a' + offset);
            }
        }
    ...
    public void testInsertRemoveWithOffset() {
        ...
        final DoubleSegmentedSortedMultiset subject = new DoubleSegmentedSortedMultiset(nodeSize);
        final DoubleSegmentedSortedMultiset reference = new DoubleSegmentedSortedMultiset(nodeSize);
    ...
    private void checkPartialCopy(final int nodeSize, final int valueCount) {
        ...
        assertEquals(prefix, NULL_DOUBLE, ssm.get(-1), .000001f);
        assertEquals(prefix, NULL_DOUBLE, ssm.get(valueCount), .000001f);
        assertEquals(prefix, NULL_DOUBLE, ssm.get(valueCount + 1), .000001f);
        assertEquals(prefix, NULL_DOUBLE, ssm.get(Long.MAX_VALUE), .000001f);
        ...
        for (int from = -3; from <= valueCount + 3; ++from) {
            for (int to = from; to <= valueCount + 3; ++to) {
                ...
                for (int ii = 0; ii < to - from; ++ii) {
                    assertEquals(message, expected.get(ii), actual.get(ii), .000001f);
                }
            }
        }
        ...
        try {
            ...
            try (final WritableDoubleChunk<?> keys = ssm.keyChunk();
                ...
                checkMap.forEach((key, count) -> {
                    assertEquals((double) key, keys.get(offset.get()), .000001f);
    ...
    private DoubleSegmentedSortedMultiset makeSsm(int nodeSize, double[] values) {
        final int[] counts = new int[values.length];
        Arrays.fill(counts, 1);
        return makeSsm(nodeSize, values, counts);
    }

    private DoubleSegmentedSortedMultiset makeSsm(int nodeSize, double[] values, int[] counts) {
        final DoubleSegmentedSortedMultiset ssm = new DoubleSegmentedSortedMultiset(nodeSize);
        if (values.length > 0) {
            try (final WritableDoubleChunk<Values> valuesChunk = WritableDoubleChunk.makeWritableChunk(values.length);
    ...
    private void applyInsert(DoubleSegmentedSortedMultiset subject, DoubleSegmentedSortedMultiset reference, int prefix,
            int[] valueOffsets, int[] counts) {
        final double[] values = new double[valueOffsets.length];
        for (int ii = 0; ii < values.length; ++ii) {
            values[ii] = (double) ('a' + valueOffsets[ii]);
        }
        ...
        final double junk = (double) ('a' - 1);
        try (final WritableDoubleChunk<Values> valuesChunk = WritableDoubleChunk.makeWritableChunk(prefix + values.length);
            ...
            for (int ii = 0; ii < prefix; ++ii) {
                assertEquals(junk, valuesChunk.get(ii), .000001f);
            }
        }
    ...
    private void applyRemove(DoubleSegmentedSortedMultiset subject, DoubleSegmentedSortedMultiset reference, int prefix,
            int[] valueOffsets, int[] counts) {
        final double[] values = new double[valueOffsets.length];
        for (int ii = 0; ii < values.length; ++ii) {
            values[ii] = (double) ('a' + valueOffsets[ii]);
    ...
    private void assertSameContents(DoubleSegmentedSortedMultiset subject, DoubleSegmentedSortedMultiset reference) {
        subject.validate();
        reference.validate();
        assertEquals(reference.size(), subject.size());
        assertEquals(reference.totalSize(), subject.totalSize());
        try (final WritableDoubleChunk<?> subjectKeys = subject.keyChunk();
             final WritableLongChunk<?> subjectCounts = subject.countChunk();
             final WritableDoubleChunk<?> referenceKeys = reference.keyChunk();
            ...
            for (int ii = 0; ii < referenceKeys.size(); ++ii) {
                assertEquals(referenceKeys.get(ii), subjectKeys.get(ii), .000001f);
    ...
    private void checkEqualsArray(int valueCount) {
        ...
        if (valueCount > 0) {
            final double different = (double) ('a' + 20);
    ...
    private void checkIterator(final int nodeSize, final int valueCount) {
        ...
        try (final ValueIteratorOfDouble it = ssm.iterator()) {
            ...
            for (int ii = 0; ii < valueCount; ++ii) {
                ...
                assertEquals(prefix, values[ii], it.nextDouble(), .000001f);
            }
            ...
            for (int to = from; to <= valueCount + 3; ++to) {
                ...
                try (final ValueIteratorOfDouble it = ssm.iterator(from, to)) {
                    ...
                    for (int ii = from; ii < to; ++ii) {
                        ...
                        assertEquals(message, reference.get(ii), it.nextDouble(), .000001f);
                ...
                try (final ValueIteratorOfDouble it = ssm.iterator(from, to);
                    ...
                    while (sliceIt.hasNext()) {
                        assertTrue(message, it.hasNext());
                        assertEquals(message, sliceIt.nextDouble(), it.nextDouble(), .000001f);
                    }
                    assertFalse(message, it.hasNext());
                }
            }
    ...
    public void testEqualsArrayNull() {
        ...
        checkEqualsArrayNull(4, new double[] {NULL_DOUBLE, (double) ('a' + 1), (double) ('a' + 2)});
        // multiple leaves containing the null sentinel
        checkEqualsArrayNull(4, new double[] {NULL_DOUBLE,
                (double) ('a' + 1), (double) ('a' + 2), (double) ('a' + 3), (double) ('a' + 4), (double) ('a' + 5)});
    }

    private void checkEqualsArrayNull(int nodeSize, double[] sortedValues) {
    ...
    private void verifySsm(DoubleSegmentedSortedMultiset ssm, double[] expanded, SsaTestHelpers.TestDescriptor desc) {
        try (final WritableDoubleChunk<Values> valueChunk =
                WritableDoubleChunk.makeWritableChunk(Math.max(expanded.length, 1))) {
    ...
    private void checkAppendMaximum(int nodeSize, int destCount, SsaTestHelpers.TestDescriptor desc) {
        final double[] destValues = new double[destCount];
        for (int ii = 0; ii < destCount; ++ii) {
            destValues[ii] = (double) ('a' + 1 + ii);
        }
        // strictly greater than everything in the destination, so it becomes the new maximum (exercises appendMaximum)
        final double value = (double) ('a' + 20);

        final DoubleSegmentedSortedMultiset source = makeSsm(nodeSize, new double[] {value});
        final DoubleSegmentedSortedMultiset dest = makeSsm(nodeSize, destValues);

        source.moveFrontToBack(dest, source.totalSize());

        verifySsm(source, new double[0], desc);
        final double[] expected = Arrays.copyOf(destValues, destCount + 1);
    ...
    private void checkPrependMinimum(int nodeSize, int destCount, SsaTestHelpers.TestDescriptor desc) {
        ...
        // values (int arithmetic boxes to Integer; a bare double literal would box to Double and break comparisons).
        final double value = (double) ('a' + 0);
        ...
        verifySsm(source, new double[0], desc);
        final double[] expected = new double[destCount + 1];
        expected[0] = value;
