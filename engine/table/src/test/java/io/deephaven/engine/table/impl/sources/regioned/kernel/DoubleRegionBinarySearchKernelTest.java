...
// ****** Edit FloatRegionBinarySearchKernelTest and run "./gradlew replicateRegionAndRegionedSourceTests" to
// regenerate
//
// @formatter:off
...
public class DoubleRegionBinarySearchKernelTest {
    ...
    private void randomizedTestRunner(
        ...
        for (int ii = 0; ii < size; ++ii) {
            ...
            try (final RowSet matchRs = DoubleRegionBinarySearchKernel.binarySearchMatch(
                    region, startRow, endRow, sortColumn, new Double[] {value});
                 final RowSet minMaxRs = DoubleRegionBinarySearchKernel.binarySearchMinMax(
        ...
        for (Double missingValue : missingValues) {
            ...
            try (final RowSet valuesFound = DoubleRegionBinarySearchKernel.binarySearchMatch(
                    region, startRow, endRow, sortColumn, new Double[] {missingValue})) {
                assertTrue(valuesFound.isEmpty());
            }
            try (final RowSet valuesFound = DoubleRegionBinarySearchKernel.binarySearchMinMax(
    ...
    public void testSerial() {
        ...
        randomizedTestRunner(10, 0, i -> 0, i -> 10);
        invertedRandomizedTestRunner(10, 0, i -> 0, i -> 10);
    }
        ...
        for (double f : specialValues) {
            try (final RowSet matches = DoubleRegionBinarySearchKernel.binarySearchMatch(
                ...
                matches.forAllRowKeys(rowKey -> {
                    ...
                    assertTrue(DoubleComparisons.eq(value, f));
                });
            }
        }
    ...
    private void binSearchWithGapsHelper(boolean inverted) {
        // From 0 to 9
        binSearchWithGaps(inverted, (double) 0, true, (double) 9, true, 8, 0, 7);
        binSearchWithGaps(inverted, (double) 0, true, (double) 9, false, 7, 0, 6);
        binSearchWithGaps(inverted, (double) 0, false, (double) 9, true, 7, 1, 7);
        binSearchWithGaps(inverted, (double) 0, false, (double) 9, false, 6, 1, 6);
        // From first to 3
        binSearchWithGaps(inverted, (double) 0, true, (double) 3, true, 3, 0, 2);
        binSearchWithGaps(inverted, (double) 0, true, (double) 3, false, 3, 0, 2);
        binSearchWithGaps(inverted, (double) 0, false, (double) 3, true, 2, 1, 2);
        binSearchWithGaps(inverted, (double) 0, false, (double) 3, false, 2, 1, 2);
        // From first to 7
        binSearchWithGaps(inverted, (double) 0, true, (double) 7, true, 6, 0, 5);
        binSearchWithGaps(inverted, (double) 0, true, (double) 7, false, 6, 0, 5);
        binSearchWithGaps(inverted, (double) 0, false, (double) 7, true, 5, 1, 5);
        binSearchWithGaps(inverted, (double) 0, false, (double) 7, false, 5, 1, 5);
        // From 3 to last
        binSearchWithGaps(inverted, (double) 3, true, (double) 9, true, 5, 3, 7);
        binSearchWithGaps(inverted, (double) 3, true, (double) 9, false, 4, 3, 6);
        binSearchWithGaps(inverted, (double) 3, false, (double) 9, true, 5, 3, 7);
        binSearchWithGaps(inverted, (double) 3, false, (double) 9, false, 4, 3, 6);
        // From 7 to last
        binSearchWithGaps(inverted, (double) 7, true, (double) 9, true, 2, 6, 7);
        binSearchWithGaps(inverted, (double) 7, true, (double) 9, false, 1, 6, 6);
        binSearchWithGaps(inverted, (double) 7, false, (double) 9, true, 2, 6, 7);
        binSearchWithGaps(inverted, (double) 7, false, (double) 9, false, 1, 6, 6);
        // From 3 to 7
        binSearchWithGaps(inverted, (double) 3, true, (double) 7, true, 3, 3, 5);
        binSearchWithGaps(inverted, (double) 3, true, (double) 7, false, 3, 3, 5);
        binSearchWithGaps(inverted, (double) 3, false, (double) 7, true, 3, 3, 5);
        binSearchWithGaps(inverted, (double) 3, false, (double) 7, false, 3, 3, 5);
        // From 2 to 8
        binSearchWithGaps(inverted, (double) 2, true, (double) 8, true, 5, 2, 6);
        binSearchWithGaps(inverted, (double) 2, true, (double) 8, false, 4, 2, 5);
        binSearchWithGaps(inverted, (double) 2, false, (double) 8, true, 4, 3, 6);
        binSearchWithGaps(inverted, (double) 2, false, (double) 8, false, 3, 3, 5);
    }
    ...
    private static final List<Double> DISPATCH_DATA =
            List.of(NULL_DOUBLE, (double) 1.0, (double) 2.0, (double) 5.0, (double) 5.0, Double.POSITIVE_INFINITY, Double.NaN);
     ...
     * NaN above {@link Double#POSITIVE_INFINITY}: only an inclusive NaN bound is genuinely unbounded, so an inclusive
        ...
        for (final boolean descending : new boolean[] {false, true}) {
            ...
            for (final boolean lowerInc : new boolean[] {false, true}) {
                for (final boolean upperInc : new boolean[] {false, true}) {
                    try (final RowSet viaFilter = DoubleRegionBinarySearchKernel.binsearchRangeFilter(region, 0, lastKey,
                            sortColumn, new DoubleRangeFilter("test", (double) 2.0, (double) 5.0, lowerInc, upperInc));
                            final RowSet viaSearch = DoubleRegionBinarySearchKernel.binarySearchMinMax(region, 0,
                                    lastKey, sortColumn, (double) 2.0, (double) 5.0, lowerInc, upperInc)) {
            ...
            try (final RowSet viaFilter = DoubleRegionBinarySearchKernel.binsearchRangeFilter(region, 0, lastKey,
                    sortColumn, new DoubleRangeFilter("test", (double) 2.0, Double.POSITIVE_INFINITY, true, true));
                    final RowSet viaSearch = DoubleRegionBinarySearchKernel.binarySearchMinMax(region, 0, lastKey,
                            sortColumn, (double) 2.0, Double.POSITIVE_INFINITY, true, true)) {
            ...
            try (final RowSet viaFilter = DoubleRegionBinarySearchKernel.binsearchRangeFilter(region, 0, lastKey,
                    sortColumn, new DoubleRangeFilter("test", NULL_DOUBLE, (double) 5.0, true, true));
                    final RowSet viaSearch = DoubleRegionBinarySearchKernel.binarySearchMax(region, 0, lastKey,
                            sortColumn, (double) 5.0, true)) {
                assertEquals("descending=" + descending, viaSearch, viaFilter);
            }

            // An inclusive NaN upper bound is the unbounded one, so only the lower bound is searched.
            try (final RowSet viaFilter = DoubleRegionBinarySearchKernel.binsearchRangeFilter(region, 0, lastKey,
                    sortColumn, new DoubleRangeFilter("test", (double) 2.0, Double.NaN, true, true));
                    final RowSet viaSearch = DoubleRegionBinarySearchKernel.binarySearchMin(region, 0, lastKey,
                            sortColumn, (double) 2.0, true)) {
                assertEquals("descending=" + descending, viaSearch, viaFilter);
            }
        }
    }
    ...
    public void testMatchFilterEntryPointDispatch() {
        final ColumnRegionDouble<Values> region = makeColumnRegionDouble(DISPATCH_DATA);
        final long lastKey = DISPATCH_DATA.size() - 1;
        final SortColumn sortColumn = SortColumn.asc(ColumnName.of("test"));
        final TableDefinition tableDefinition = TableDefinition.of(ColumnDefinition.ofDouble("test"));

        final MatchFilter matchFilter = new MatchFilter(MatchOptions.REGULAR, "test", (double) 5.0, NULL_DOUBLE);
        matchFilter.init(tableDefinition);
        try (final RowSet viaFilter = DoubleRegionBinarySearchKernel.binsearchMatchFilter(region, 0, lastKey,
                sortColumn, matchFilter);
                final RowSet viaSearch = DoubleRegionBinarySearchKernel.binarySearchMatch(region, 0, lastKey,
                        sortColumn, new Object[] {(double) 5.0, NULL_DOUBLE})) {
