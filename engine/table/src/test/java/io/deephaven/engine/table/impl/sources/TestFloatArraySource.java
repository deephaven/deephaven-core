...
public class TestFloatArraySource {
        ...
        try (final RowSequence.Iterator rsIterator = rowSet.getRowSequenceIterator();
            ...
            while (it.hasNext()) {
                ...
                if (ranges.size() > 2 || ranges.get(0)
                        / FloatArraySource.BLOCK_SIZE != (ranges.get(1) / FloatArraySource.BLOCK_SIZE)) {
    ...
    public void testGetChunk() {
        ...
        testGetChunkGeneric(ArrayGenerator.randomFloats(random, 16), ArrayGenerator.randomFloats(random, 16), 1,
        ...
        testGetChunkGeneric(ArrayGenerator.randomFloats(random, 16), ArrayGenerator.randomFloats(random, 16), 3,
                RowSetFactory.fromKeys(5, 6, 7));
        testGetChunkGeneric(ArrayGenerator.randomFloats(random, 16), ArrayGenerator.randomFloats(random, 16), 4,
                RowSetFactory.fromKeys(4, 5, 6, 7));
        testGetChunkGeneric(ArrayGenerator.randomFloats(random, 16), ArrayGenerator.randomFloats(random, 16), 5,
                RowSetFactory.fromKeys(4, 5, 6, 7, 8));
        testGetChunkGeneric(ArrayGenerator.randomFloats(random, 512), ArrayGenerator.randomFloats(random, 512), 4,
                RowSetFactory.fromKeys(254, 255, 256, 257));
        testGetChunkGeneric(ArrayGenerator.randomFloats(random, 512), ArrayGenerator.randomFloats(random, 512), 5,
    ...
    public void testGetChunkLazy() {
        ...
        testGetChunkGenericLazy(ArrayGenerator.randomFloats(random, 512), 5,
                RowSetFactory.fromKeys(254, 255, 256, 257, 258));
    ...
    private void testIndexSizeVariations(Random random, int sourceSize, float[] values, float[] newvalues,
            int indexSize) {
    ...
    private void testParameterChunkAndIndex(Random random, int sourceSize, float[] values, float[] newvalues,
            int indexSize) {
        final RowSet rowSet =
                RowSetFactory.fromKeys(indexDataGenerator(random, indexSize, .1, sourceSize / indexSize, sourceSize));
    ...
    public void testFillChunk() {
        ...
        testFillChunkGeneric(ArrayGenerator.randomFloats(random, 16), ArrayGenerator.randomFloats(random, 16), 1,
                RowSetFactory.fromKeys(0));
        testFillChunkGeneric(ArrayGenerator.randomFloats(random, 16), ArrayGenerator.randomFloats(random, 16), 1,
                RowSetFactory.fromKeys(0, 1));
        testFillChunkGeneric(ArrayGenerator.randomFloats(random, 16), ArrayGenerator.randomFloats(random, 16), 1,
        ...
        testFillChunkGeneric(ArrayGenerator.randomFloats(random, 16), ArrayGenerator.randomFloats(random, 16), 1,
                RowSetFactory.fromKeys(4, 5, 6, 7, 8));
        testFillChunkGeneric(ArrayGenerator.randomFloats(random, 16), ArrayGenerator.randomFloats(random, 16), 3,
                RowSetFactory.fromKeys(5, 6, 7));
        testFillChunkGeneric(ArrayGenerator.randomFloats(random, 16), ArrayGenerator.randomFloats(random, 16), 4,
                RowSetFactory.fromKeys(4, 5, 6, 7));
        testFillChunkGeneric(ArrayGenerator.randomFloats(random, 16), ArrayGenerator.randomFloats(random, 16), 5,
                RowSetFactory.fromKeys(4, 5, 6, 7, 8));
        testFillChunkGeneric(ArrayGenerator.randomFloats(random, 512), ArrayGenerator.randomFloats(random, 512), 4,
                RowSetFactory.fromKeys(254, 255, 256, 257));
        testFillChunkGeneric(ArrayGenerator.randomFloats(random, 512), ArrayGenerator.randomFloats(random, 512), 5,
                RowSetFactory.fromKeys(254, 255, 256, 257, 258));

        // Test the fill with null behavior when requesting keys outside of source.
        testFillChunkGeneric(ArrayGenerator.randomFloats(random, 512), ArrayGenerator.randomFloats(random, 4096), 4096,
    ...
    private void testFillChunkIndexSizeVariations(Random random, int sourceSize, float[] values, float[] newValues,
            int indexSize) {
    ...
    private void testParameterFillChunkAndIndex(Random random, int sourceSize, float[] values, float[] newValues,
            int indexSize) {
        final RowSet rowSet =
                RowSetFactory.fromKeys(indexDataGenerator(random, indexSize, .1, sourceSize / indexSize, sourceSize));
        for (int chunkSize = 2; chunkSize < sourceSize; chunkSize *= 2) {
    ...
    public void testFillChunkLazy() {
        ...
        testFillChunkLazyGeneric(ArrayGenerator.randomFloats(random, 512), 4,
                RowSetFactory.fromKeys(254, 255, 256, 257));
        testFillChunkLazyGeneric(ArrayGenerator.randomFloats(random, 512), 5,
                RowSetFactory.fromKeys(254, 255, 256, 257, 258));
