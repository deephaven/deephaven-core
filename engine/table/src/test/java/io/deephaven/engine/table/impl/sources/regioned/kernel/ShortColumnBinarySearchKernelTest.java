    ...
    public void testBoundsAscending() {
        ...
        try {
            ...
            assertEquals(-6, ShortColumnBinarySearchKernel.upperBoundAscending(
                    source, selection, 0, lastPos, (short) 4, false, false)); // inserting 4 at pos 5 preserves sort
                                                                             // order
            assertEquals(-6, ShortColumnBinarySearchKernel.upperBoundAscending(
                    source, selection, 0, lastPos, (short) 4, true, false)); // inserting 4 at pos 5 preserves sort order
            ...
            assertEquals(-1, ShortColumnBinarySearchKernel.upperBoundAscending(
                    source, selection, 0, lastPos, (short) 1, false, false)); // inserting 1 at pos 0 preserves sort
                                                                             // order
            ...
            assertEquals(7, ShortColumnBinarySearchKernel.upperBoundAscending(
                    source, selection, 0, lastPos, (short) 5, true, false)); // inserting 5 at pos 7 preserves sort order
        } finally {
            selection.close();
            source.clear(true);
        }
