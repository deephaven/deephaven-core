...
public class ShortColumnBinarySearchKernelTest {
    ...
    public void testBoundsAscending() {
        ...
        final List<Short> data = List.of(
                (short) 1, (short) 2, (short) 3, (short) 3, (short) 3,
                (short) 5, (short) 5, (short) 5);
        final ShortChunkColumnSource source = makeChunkColumnSource(data);
        ...
        try {
            ...
            assertEquals(-6, ShortColumnBinarySearchKernel.lowerBoundAscending(
                    source, selection, 0, lastPos, (short) 4, false, false));
            assertEquals(-6, ShortColumnBinarySearchKernel.lowerBoundAscending(
                    source, selection, 0, lastPos, (short) 4, true, false));
            // lowerBound: 5 is present but exclusive (value > 5) finds nothing; past-end insertion point 8 -> -(8+1)=-9
            assertEquals(-9, ShortColumnBinarySearchKernel.lowerBoundAscending(
                    source, selection, 0, lastPos, (short) 5, false, false));
            // lowerBound: 5 is present; inclusive search returns first occurrence at position 5
            assertEquals(5, ShortColumnBinarySearchKernel.lowerBoundAscending(
                    source, selection, 0, lastPos, (short) 5, true, false));
            ...
            assertEquals(-6, ShortColumnBinarySearchKernel.upperBoundAscending(
                    source, selection, 0, lastPos, (short) 4, false, false));
            // inserting 4 at pos 5 preserves sort order
            assertEquals(-6, ShortColumnBinarySearchKernel.upperBoundAscending(
                    source, selection, 0, lastPos, (short) 4, true, false));
            ...
            assertEquals(-1, ShortColumnBinarySearchKernel.upperBoundAscending(
                    source, selection, 0, lastPos, (short) 1, false, false));
            // upperBound: 5 is present; inclusive search returns last occurrence at position 7
            // inserting 5 at pos 7 preserves sort order
            assertEquals(7, ShortColumnBinarySearchKernel.upperBoundAscending(
                    source, selection, 0, lastPos, (short) 5, true, false));
        } finally {
            selection.close();
            source.clear(true);
    ...
    public void testBoundsDescending() {
        ...
        final List<Short> data = List.of(
                (short) 5, (short) 5, (short) 5, (short) 3, (short) 3, (short) 3,
                (short) 2, (short) 1);
        final ShortChunkColumnSource source = makeChunkColumnSource(data);
        final RowSet selection = RowSetFactory.fromRange(0, data.size() - 1);
        final long lastPos = data.size() - 1;
    ...
    public void testMatchMultipleValuesIncludingNull() {
        ...
        assertMatchPositions(ascending, new Short[] {(short) 5, NULL_SHORT}, List.of(0L, 3L, 4L));
        assertMatchPositions(ascending, new Short[] {NULL_SHORT, (short) 5}, List.of(0L, 3L, 4L));

        // Several ordinary values plus the sentinel, listed out of order.
        assertMatchPositions(ascending, new Short[] {(short) 9, (short) 1, NULL_SHORT}, List.of(0L, 1L, 5L));

        // The sentinel on its own, and ordinary values without it.
        assertMatchPositions(ascending, new Short[] {NULL_SHORT}, List.of(0L));
        assertMatchPositions(ascending, new Short[] {(short) 1, (short) 9}, List.of(1L, 5L));

        // A value absent from the data, between two that are present.
        assertMatchPositions(ascending, new Short[] {(short) 1, (short) 3, (short) 9}, List.of(1L, 5L));

        // Nothing present at all.
        assertMatchPositions(ascending, new Short[] {(short) 3, (short) 7}, List.of());
    }
    ...
    private static void assertMatchPositions(
            final List<Short> ascendingData,
            final Short[] searchValues,
        ...
        for (final boolean descending : new boolean[] {false, true}) {
            ...
            try (final RowSet selection = RowSetFactory.fromRange(0, data.size() - 1);
                    final RowSet matched = ShortColumnBinarySearchKernel.binarySearchMatch(
