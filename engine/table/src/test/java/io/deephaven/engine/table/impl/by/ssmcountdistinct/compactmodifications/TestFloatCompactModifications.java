...
public class TestFloatCompactModifications {
    @Test
    public void testPureRemovals() {
        // every value drops out entirely (nothing added survives)
        check(new float[] {(float) ('a' + 0), (float) ('a' + 0), (float) ('a' + 1)},
                new float[] {(float) ('a' + 2), (float) ('a' + 2), (float) ('a' + 2)},
                0, 3, true, true,
                new float[] {(float) ('a' + 0), (float) ('a' + 1)}, new int[] {2, 1},
                new float[] {(float) ('a' + 2)}, new int[] {3});
    }
    ...
    public void testFullyCancelled() {
        ...
        check(new float[] {(float) ('a' + 0), (float) ('a' + 0), (float) ('a' + 1)},
                new float[] {(float) ('a' + 0), (float) ('a' + 0), (float) ('a' + 1)},
                0, 3, true, true,
                new float[] {}, new int[] {},
                new float[] {}, new int[] {});
    }
    ...
    public void testPartialDeltaMoreRemoved() {
        ...
        check(new float[] {(float) ('a' + 0), (float) ('a' + 0), (float) ('a' + 0)},
                new float[] {(float) ('a' + 0), (float) ('a' + 1), (float) ('a' + 2)},
                0, 3, true, true,
                new float[] {(float) ('a' + 0)}, new int[] {2},
                new float[] {(float) ('a' + 1), (float) ('a' + 2)}, new int[] {1, 1});
    }

    @Test
    public void testPartialDeltaMoreAdded() {
        // mirror image: 'a' goes from 1 to 3 (net add 2); 'b' and 'c' are wholly removed
        check(new float[] {(float) ('a' + 0), (float) ('a' + 1), (float) ('a' + 2)},
                new float[] {(float) ('a' + 0), (float) ('a' + 0), (float) ('a' + 0)},
                0, 3, true, true,
                new float[] {(float) ('a' + 1), (float) ('a' + 2)}, new int[] {1, 1},
                new float[] {(float) ('a' + 0)}, new int[] {2});
    }
    ...
    public void testNonZeroStart() {
        ...
        final float[] removed = new float[] {(float) ('a' + 3), (float) ('a' + 3),
                (float) ('a' + 0), (float) ('a' + 0), (float) ('a' + 1)};
        final float[] added = new float[] {(float) ('a' + 3), (float) ('a' + 3),
                (float) ('a' + 2), (float) ('a' + 2), (float) ('a' + 2)};
        ...
        FloatCompactModifications.compactAndCountModifications(
                WritableFloatChunk.writableChunkWrap(removed), WritableIntChunk.writableChunkWrap(removedCounts),
                WritableFloatChunk.writableChunkWrap(added), WritableIntChunk.writableChunkWrap(addedCounts),
                2, 3, 2, 3, true, true, removedSize, addedSize);

        assertEquals(2, removedSize.get());
        assertEquals(1, addedSize.get());
        // the prefix is untouched
        assertEquals((float) ('a' + 3), removed[0], .000001f);
        assertEquals((float) ('a' + 3), removed[1], .000001f);
        assertEquals((float) ('a' + 3), added[0], .000001f);
        assertEquals((float) ('a' + 3), added[1], .000001f);
        assertArrayEquals(new float[] {(float) ('a' + 0), (float) ('a' + 1)},
        ...
        assertArrayEquals(new float[] {(float) ('a' + 2)},
    ...
    public void testNullIgnored() {
        ...
        check(new float[] {(float) ('a' + 0), NULL_FLOAT, NULL_FLOAT},
                new float[] {(float) ('a' + 0), (float) ('a' + 0), NULL_FLOAT},
                0, 3, false, true,
                new float[] {}, new int[] {},
                new float[] {(float) ('a' + 0)}, new int[] {1});
    }

    @Test
    public void testNullCounted() {
        // with countNull == true the null run participates: net remove one null, net add one 'a'
        check(new float[] {NULL_FLOAT, NULL_FLOAT, (float) ('a' + 0)},
                new float[] {NULL_FLOAT, (float) ('a' + 0), (float) ('a' + 0)},
                0, 3, true, true,
                new float[] {NULL_FLOAT}, new int[] {1},
                new float[] {(float) ('a' + 0)}, new int[] {1});
    }

    @Test
    public void testEmpty() {
        check(new float[] {}, new float[] {}, 0, 0, true, true,
                new float[] {}, new int[] {},
                new float[] {}, new int[] {});
    }
    ...
    public void testDistinctRemovedAddedRanges() {
        ...
        final float[] removed = new float[] {(float) ('a' + 3), (float) ('a' + 1), (float) ('a' + 0)};
        final float[] added = new float[] {(float) ('a' + 3), (float) ('a' + 3), (float) ('a' + 3),
                (float) ('a' + 0), (float) ('a' + 0), (float) ('a' + 2)};
        final int[] removedCounts = new int[removed.length];
        final int[] addedCounts = new int[added.length];
        ...
        assertEquals((float) ('a' + 3), removed[0], .000001f);
        assertArrayEquals(new float[] {(float) ('a' + 1)}, Arrays.copyOfRange(removed, 1, 1 + removedSize.get()), .000001f);
        assertArrayEquals(new int[] {1}, Arrays.copyOfRange(removedCounts, 1, 1 + removedSize.get()));
        // added survivors begin at addedStart == 3
        assertArrayEquals(new float[] {(float) ('a' + 0), (float) ('a' + 2)},
    ...
    private static void check(float[] removed, float[] added, int start, int length, boolean countNull,
            boolean countNaN, float[] expectedRemoved, int[] expectedRemovedCounts, float[] expectedAdded,
