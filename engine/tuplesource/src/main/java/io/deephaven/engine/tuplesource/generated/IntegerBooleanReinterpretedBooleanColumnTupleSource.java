...
/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types Int, Boolean, and Byte.
...
public class IntegerBooleanReinterpretedBooleanColumnTupleSource extends AbstractTupleSource<IntByteByteTuple> {
    ...
    public static final ThreeColumnTupleSourceFactory<IntByteByteTuple, Int, Boolean, Byte> FACTORY = new Factory();
    ...
    private static final class Factory implements ThreeColumnTupleSourceFactory<IntByteByteTuple, Int, Boolean, Byte> {
