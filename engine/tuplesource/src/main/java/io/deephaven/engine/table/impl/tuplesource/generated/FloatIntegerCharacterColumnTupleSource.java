...
import io.deephaven.engine.tuple.generated.FloatIntCharTuple;
import io.deephaven.util.type.TypeUtils;
import org.jetbrains.annotations.NotNull;


/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types Float, Int, and Char.
...
public class FloatIntegerCharacterColumnTupleSource extends AbstractTupleSource<FloatIntCharTuple> {
    ...
    public static final ThreeColumnTupleSourceFactory<FloatIntCharTuple, Float, Int, Char> FACTORY = new Factory();
    ...
    @Override
    public final <ELEMENT_TYPE> void exportElement(@NotNull final FloatIntCharTuple tuple, final int elementIndex, @NotNull final WritableColumnSource<ELEMENT_TYPE> writableSource, final long destinationIndexKey) {
        if (elementIndex == 0) {
    ...
    private static final class Factory implements ThreeColumnTupleSourceFactory<FloatIntCharTuple, Float, Int, Char> {
