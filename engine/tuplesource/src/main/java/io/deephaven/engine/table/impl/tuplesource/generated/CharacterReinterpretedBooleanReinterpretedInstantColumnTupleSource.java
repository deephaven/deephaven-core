...
public class CharacterReinterpretedBooleanReinterpretedInstantColumnTupleSource extends AbstractTupleSource<CharByteLongTuple> {
    ...
    public CharacterReinterpretedBooleanReinterpretedInstantColumnTupleSource(
    ...
    private static final class Factory implements ThreeColumnTupleSourceFactory<CharByteLongTuple, Character, Byte, Long> {
        ...
        public TupleSource<CharByteLongTuple> create(
            ...
            return new CharacterReinterpretedBooleanReinterpretedInstantColumnTupleSource(
                    columnSource1,
                    columnSource2,
                    columnSource3
            );
