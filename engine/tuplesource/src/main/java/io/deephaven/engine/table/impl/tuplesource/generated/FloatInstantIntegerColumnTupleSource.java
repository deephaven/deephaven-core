...
/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types Float, Instant, and Integer.
 */
@SuppressWarnings({"unused", "WeakerAccess"})
public class FloatInstantIntegerColumnTupleSource extends AbstractTupleSource<FloatLongIntTuple> {

    /** {@link ThreeColumnTupleSourceFactory} instance to create instances of {@link FloatInstantIntegerColumnTupleSource}. **/
    ...
    public FloatInstantIntegerColumnTupleSource(
    ...
    /** {@link ThreeColumnTupleSourceFactory} for instances of {@link FloatInstantIntegerColumnTupleSource}. **/
    private static final class Factory implements ThreeColumnTupleSourceFactory<FloatLongIntTuple, Float, Instant, Integer> {
        ...
        public TupleSource<FloatLongIntTuple> create(
            ...
            return new FloatInstantIntegerColumnTupleSource(
                    columnSource1,
                    columnSource2,
                    columnSource3
            );
