...
public class IntegerByteDoubleColumnTupleSource extends AbstractTupleSource<IntByteDoubleTuple> {

    /** {@link ThreeColumnTupleSourceFactory} instance to create instances of {@link IntegerByteDoubleColumnTupleSource}. **/
    ...
    public IntegerByteDoubleColumnTupleSource(
    ...
    @Override
    public final <ELEMENT_TYPE> void exportElement(@NotNull final IntByteDoubleTuple tuple, final int elementIndex, @NotNull final WritableColumnSource<ELEMENT_TYPE> writableSource, final long destinationIndexKey) {
        if (elementIndex == 0) {
    ...
    /** {@link ThreeColumnTupleSourceFactory} for instances of {@link IntegerByteDoubleColumnTupleSource}. **/
    private static final class Factory implements ThreeColumnTupleSourceFactory<IntByteDoubleTuple, Int, Byte, Double> {
        ...
        public TupleSource<IntByteDoubleTuple> create(
            ...
            return new IntegerByteDoubleColumnTupleSource(
                    columnSource1,
                    columnSource2,
                    columnSource3
            );
