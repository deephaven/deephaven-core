...
import io.deephaven.engine.tuple.generated.DoubleFloatShortTuple;
...
public class DoubleFloatShortColumnTupleSource extends AbstractTupleSource<DoubleFloatShortTuple> {
    ...
    @Override
    public final <ELEMENT_TYPE> void exportElement(@NotNull final DoubleFloatShortTuple tuple, final int elementIndex, @NotNull final WritableColumnSource<ELEMENT_TYPE> writableSource, final long destinationIndexKey) {
        if (elementIndex == 0) {
