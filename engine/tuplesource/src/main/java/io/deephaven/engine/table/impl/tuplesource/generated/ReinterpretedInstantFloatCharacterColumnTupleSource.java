...
public class ReinterpretedInstantFloatCharacterColumnTupleSource extends AbstractTupleSource<LongFloatCharTuple> {
    ...
    public ReinterpretedInstantFloatCharacterColumnTupleSource(
    ...
    @Override
    public final void exportAllTo(final Object @NotNull [] dest, @NotNull final LongFloatCharTuple tuple) {
    ...
    @Override
    public final void exportAllTo(final Object @NotNull [] dest, @NotNull final LongFloatCharTuple tuple, final int @NotNull [] map) {
    ...
    @Override
    public final void exportAllReinterpretedTo(final Object @NotNull [] dest, @NotNull final LongFloatCharTuple tuple) {
    ...
    @Override
    public final void exportAllReinterpretedTo(final Object @NotNull [] dest, @NotNull final LongFloatCharTuple tuple, final int @NotNull [] map) {
