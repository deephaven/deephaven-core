...
/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types Boolean, Long, and Int.
...
public class BooleanReinterpretedDateTimeIntegerColumnTupleSource extends AbstractTupleSource<ByteLongIntTuple> {
    ...
    public static final ThreeColumnTupleSourceFactory<ByteLongIntTuple, Boolean, Long, Int> FACTORY = new Factory();
    ...
    private static final class Factory implements ThreeColumnTupleSourceFactory<ByteLongIntTuple, Boolean, Long, Int> {
