...
/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types Boolean, Char, and Int.
...
public class BooleanCharacterIntegerColumnTupleSource extends AbstractTupleSource<ByteCharIntTuple> {
    ...
    public static final ThreeColumnTupleSourceFactory<ByteCharIntTuple, Boolean, Char, Int> FACTORY = new Factory();
    ...
    private static final class Factory implements ThreeColumnTupleSourceFactory<ByteCharIntTuple, Boolean, Char, Int> {
