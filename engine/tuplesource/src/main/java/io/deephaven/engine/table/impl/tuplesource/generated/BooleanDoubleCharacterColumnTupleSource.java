...
/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types Boolean, Double, and Char.
...
public class BooleanDoubleCharacterColumnTupleSource extends AbstractTupleSource<ByteDoubleCharTuple> {
    ...
    public static final ThreeColumnTupleSourceFactory<ByteDoubleCharTuple, Boolean, Double, Char> FACTORY = new Factory();
    ...
    private static final class Factory implements ThreeColumnTupleSourceFactory<ByteDoubleCharTuple, Boolean, Double, Char> {
