...
/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types Boolean, Character, and Character.
 */
...
public class BooleanCharacterCharacterColumnTupleSource extends AbstractTupleSource<ByteCharCharTuple> {
    ...
    private static final class Factory implements ThreeColumnTupleSourceFactory<ByteCharCharTuple, Boolean, Character, Character> {
