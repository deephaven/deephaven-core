...
/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types Int, Byte, and Boolean.
...
public class IntegerReinterpretedBooleanBooleanColumnTupleSource extends AbstractTupleSource<IntByteByteTuple> {
    ...
    public static final ThreeColumnTupleSourceFactory<IntByteByteTuple, Int, Byte, Boolean> FACTORY = new Factory();
    ...
    private static final class Factory implements ThreeColumnTupleSourceFactory<IntByteByteTuple, Int, Byte, Boolean> {
