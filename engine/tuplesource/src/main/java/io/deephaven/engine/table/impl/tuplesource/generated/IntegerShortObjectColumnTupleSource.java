...
import io.deephaven.engine.tuple.generated.IntShortObjectTuple;
import io.deephaven.util.type.TypeUtils;
import org.jetbrains.annotations.NotNull;


/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types Int, Short, and Object.
...
public class IntegerShortObjectColumnTupleSource extends AbstractTupleSource<IntShortObjectTuple> {
    ...
    public static final ThreeColumnTupleSourceFactory<IntShortObjectTuple, Int, Short, Object> FACTORY = new Factory();
    ...
    @Override
    public final IntShortObjectTuple createTuple(final long indexKey) {
    ...
    @Override
    public final IntShortObjectTuple createPreviousTuple(final long indexKey) {
        return new IntShortObjectTuple(
    ...
    @Override
    public final <ELEMENT_TYPE> void exportElement(@NotNull final IntShortObjectTuple tuple, final int elementIndex, @NotNull final WritableColumnSource<ELEMENT_TYPE> writableSource, final long destinationIndexKey) {
        if (elementIndex == 0) {
    ...
    @Override
    public final Object exportToExternalKey(@NotNull final IntShortObjectTuple tuple) {
        return new SmartKey(
    ...
    protected void convertChunks(@NotNull WritableChunk<? super Attributes.Values> destination, int chunkSize, Chunk<Attributes.Values> [] chunks) {
        WritableObjectChunk<IntShortObjectTuple, ? super Attributes.Values> destinationObjectChunk = destination.asWritableObjectChunk();
    ...
    private static final class Factory implements ThreeColumnTupleSourceFactory<IntShortObjectTuple, Int, Short, Object> {
