...
public class BooleanDateTimeBooleanColumnTupleSource extends AbstractTupleSource<ByteLongByteTuple> {
    ...
    protected void convertChunks(@NotNull WritableChunk<? super Values> destination, int chunkSize, Chunk<Values> [] chunks) {
        ...
        for (int ii = 0; ii < chunkSize; ++ii) {
            destinationObjectChunk.set(ii, new ByteLongByteTuple(BooleanUtils.booleanAsByte(chunk1.get(ii)), DateTimeUtil.nanos(chunk2.get(ii)), BooleanUtils.booleanAsByte(chunk3.get(ii))));
        }
