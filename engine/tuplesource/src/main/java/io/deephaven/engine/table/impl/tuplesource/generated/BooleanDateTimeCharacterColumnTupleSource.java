...
/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types Boolean, DateTime, and Character.
...
public class BooleanDateTimeCharacterColumnTupleSource extends AbstractTupleSource<ByteLongCharTuple> {
    ...
    public static final ThreeColumnTupleSourceFactory<ByteLongCharTuple, Boolean, DateTime, Character> FACTORY = new Factory();
    ...
    private static final class Factory implements ThreeColumnTupleSourceFactory<ByteLongCharTuple, Boolean, DateTime, Character> {
