...
public class ReinterpretedBooleanObjectIntegerColumnTupleSource extends AbstractTupleSource<ByteObjectIntTuple> {
    ...
    @Override
    public final void exportAllTo(final Object @NotNull [] dest, @NotNull final ByteObjectIntTuple tuple) {
    ...
    @Override
    public final void exportAllTo(final Object @NotNull [] dest, @NotNull final ByteObjectIntTuple tuple, final int @NotNull [] map) {
    ...
    @Override
    public final void exportAllReinterpretedTo(final Object @NotNull [] dest, @NotNull final ByteObjectIntTuple tuple) {
    ...
    @Override
    public final void exportAllReinterpretedTo(final Object @NotNull [] dest, @NotNull final ByteObjectIntTuple tuple, final int @NotNull [] map) {
