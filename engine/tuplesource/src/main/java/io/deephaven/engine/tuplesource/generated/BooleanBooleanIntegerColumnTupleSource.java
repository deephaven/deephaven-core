...
/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types Boolean, Boolean, and Int.
...
public class BooleanBooleanIntegerColumnTupleSource extends AbstractTupleSource<ByteByteIntTuple> {
    ...
    public static final ThreeColumnTupleSourceFactory<ByteByteIntTuple, Boolean, Boolean, Int> FACTORY = new Factory();
    ...
    private static final class Factory implements ThreeColumnTupleSourceFactory<ByteByteIntTuple, Boolean, Boolean, Int> {
