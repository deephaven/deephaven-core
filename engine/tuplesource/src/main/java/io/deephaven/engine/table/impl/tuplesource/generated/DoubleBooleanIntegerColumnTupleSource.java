...
import io.deephaven.engine.tuple.generated.DoubleByteIntTuple;
...
/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types Double, Boolean, and Int.
...
public class DoubleBooleanIntegerColumnTupleSource extends AbstractTupleSource<DoubleByteIntTuple> {
    ...
    public static final ThreeColumnTupleSourceFactory<DoubleByteIntTuple, Double, Boolean, Int> FACTORY = new Factory();
    ...
    @Override
    public final <ELEMENT_TYPE> void exportElement(@NotNull final DoubleByteIntTuple tuple, final int elementIndex, @NotNull final WritableColumnSource<ELEMENT_TYPE> writableSource, final long destinationIndexKey) {
        if (elementIndex == 0) {
    ...
    private static final class Factory implements ThreeColumnTupleSourceFactory<DoubleByteIntTuple, Double, Boolean, Int> {
