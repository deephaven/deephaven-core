...
/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types Boolean, Int, and Int.
...
public class BooleanIntegerIntegerColumnTupleSource extends AbstractTupleSource<ByteIntIntTuple> {
    ...
    public static final ThreeColumnTupleSourceFactory<ByteIntIntTuple, Boolean, Int, Int> FACTORY = new Factory();
    ...
    private static final class Factory implements ThreeColumnTupleSourceFactory<ByteIntIntTuple, Boolean, Int, Int> {
