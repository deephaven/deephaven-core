...
import io.deephaven.engine.tuple.generated.ShortFloatObjectTuple;
...
public class ShortFloatObjectColumnTupleSource extends AbstractTupleSource<ShortFloatObjectTuple> {
    ...
    @Override
    public final <ELEMENT_TYPE> void exportElement(@NotNull final ShortFloatObjectTuple tuple, final int elementIndex, @NotNull final WritableColumnSource<ELEMENT_TYPE> writableSource, final long destinationIndexKey) {
        if (elementIndex == 0) {
