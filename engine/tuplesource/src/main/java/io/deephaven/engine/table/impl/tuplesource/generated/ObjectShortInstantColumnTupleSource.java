...
/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types Object, Short, and Instant.
 */
@SuppressWarnings({"unused", "WeakerAccess"})
public class ObjectShortInstantColumnTupleSource extends AbstractTupleSource<ObjectShortLongTuple> {

    /** {@link ThreeColumnTupleSourceFactory} instance to create instances of {@link ObjectShortInstantColumnTupleSource}. **/
    public static final ThreeColumnTupleSourceFactory<ObjectShortLongTuple, Object, Short, Instant> FACTORY = new Factory();

    private final ColumnSource<Object> columnSource1;
    private final ColumnSource<Short> columnSource2;
    private final ColumnSource<Instant> columnSource3;

    public ObjectShortInstantColumnTupleSource(
    ...
    protected void convertChunks(@NotNull WritableChunk<? super Values> destination, int chunkSize, Chunk<? extends Values> [] chunks) {
        ...
        for (int ii = 0; ii < chunkSize; ++ii) {
            destinationObjectChunk.set(ii, new ObjectShortLongTuple(chunk1.get(ii), chunk2.get(ii), DateTimeUtils.epochNanos(chunk3.get(ii))));
        }
        destinationObjectChunk.setSize(chunkSize);
    }

    /** {@link ThreeColumnTupleSourceFactory} for instances of {@link ObjectShortInstantColumnTupleSource}. **/
    private static final class Factory implements ThreeColumnTupleSourceFactory<ObjectShortLongTuple, Object, Short, Instant> {
        ...
        public TupleSource<ObjectShortLongTuple> create(
            ...
            return new ObjectShortInstantColumnTupleSource(
                    columnSource1,
                    columnSource2,
                    columnSource3
            );
