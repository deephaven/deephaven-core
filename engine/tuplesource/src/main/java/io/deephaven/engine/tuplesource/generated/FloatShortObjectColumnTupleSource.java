...
import io.deephaven.engine.tuple.generated.FloatShortObjectTuple;
...
public class FloatShortObjectColumnTupleSource extends AbstractTupleSource<FloatShortObjectTuple> {
    ...
    @Override
    public final <ELEMENT_TYPE> void exportElement(@NotNull final FloatShortObjectTuple tuple, final int elementIndex, @NotNull final WritableColumnSource<ELEMENT_TYPE> writableSource, final long destinationIndexKey) {
        if (elementIndex == 0) {
