...
/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types Object, Int, and Int.
...
public class ObjectIntegerIntegerColumnTupleSource extends AbstractTupleSource<ObjectIntIntTuple> {
    ...
    public static final ThreeColumnTupleSourceFactory<ObjectIntIntTuple, Object, Int, Int> FACTORY = new Factory();
    ...
    @Override
    public final ObjectIntIntTuple createTuple(final long indexKey) {
    ...
    @Override
    public final ObjectIntIntTuple createPreviousTuple(final long indexKey) {
        return new ObjectIntIntTuple(
    ...
    @Override
    public final <ELEMENT_TYPE> void exportElement(@NotNull final ObjectIntIntTuple tuple, final int elementIndex, @NotNull final WritableColumnSource<ELEMENT_TYPE> writableSource, final long destinationIndexKey) {
        if (elementIndex == 0) {
    ...
    protected void convertChunks(@NotNull WritableChunk<? super Attributes.Values> destination, int chunkSize, Chunk<Attributes.Values> [] chunks) {
        WritableObjectChunk<ObjectIntIntTuple, ? super Attributes.Values> destinationObjectChunk = destination.asWritableObjectChunk();
    ...
    private static final class Factory implements ThreeColumnTupleSourceFactory<ObjectIntIntTuple, Object, Int, Int> {
