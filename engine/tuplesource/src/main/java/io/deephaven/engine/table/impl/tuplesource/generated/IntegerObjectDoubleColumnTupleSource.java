...
/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types Int, Object, and Double.
...
public class IntegerObjectDoubleColumnTupleSource extends AbstractTupleSource<IntObjectDoubleTuple> {
    ...
    public static final ThreeColumnTupleSourceFactory<IntObjectDoubleTuple, Int, Object, Double> FACTORY = new Factory();
    ...
    @Override
    public final <ELEMENT_TYPE> void exportElement(@NotNull final IntObjectDoubleTuple tuple, final int elementIndex, @NotNull final WritableColumnSource<ELEMENT_TYPE> writableSource, final long destinationIndexKey) {
        if (elementIndex == 0) {
    ...
    private static final class Factory implements ThreeColumnTupleSourceFactory<IntObjectDoubleTuple, Int, Object, Double> {
