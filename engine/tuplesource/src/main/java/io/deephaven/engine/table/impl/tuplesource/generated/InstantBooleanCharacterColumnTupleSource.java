...
/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types Instant, Boolean, and Character.
 */
@SuppressWarnings({"unused", "WeakerAccess"})
public class InstantBooleanCharacterColumnTupleSource extends AbstractTupleSource<LongByteCharTuple> {

    /** {@link ThreeColumnTupleSourceFactory} instance to create instances of {@link InstantBooleanCharacterColumnTupleSource}. **/
    public static final ThreeColumnTupleSourceFactory<LongByteCharTuple, Instant, Boolean, Character> FACTORY = new Factory();

    private final ColumnSource<Instant> columnSource1;
    private final ColumnSource<Boolean> columnSource2;
    private final ColumnSource<Character> columnSource3;

    public InstantBooleanCharacterColumnTupleSource(
    ...
    protected void convertChunks(@NotNull WritableChunk<? super Values> destination, int chunkSize, Chunk<? extends Values> [] chunks) {
        ...
        for (int ii = 0; ii < chunkSize; ++ii) {
            destinationObjectChunk.set(ii, new LongByteCharTuple(DateTimeUtils.epochNanos(chunk1.get(ii)), BooleanUtils.booleanAsByte(chunk2.get(ii)), chunk3.get(ii)));
        }
        destinationObjectChunk.setSize(chunkSize);
    }

    /** {@link ThreeColumnTupleSourceFactory} for instances of {@link InstantBooleanCharacterColumnTupleSource}. **/
    private static final class Factory implements ThreeColumnTupleSourceFactory<LongByteCharTuple, Instant, Boolean, Character> {
        ...
        public TupleSource<LongByteCharTuple> create(
            ...
            return new InstantBooleanCharacterColumnTupleSource(
                    columnSource1,
                    columnSource2,
                    columnSource3
            );
