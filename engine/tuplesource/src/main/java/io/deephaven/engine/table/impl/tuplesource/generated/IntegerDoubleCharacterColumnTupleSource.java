...
/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types Int, Double, and Char.
...
public class IntegerDoubleCharacterColumnTupleSource extends AbstractTupleSource<IntDoubleCharTuple> {
    ...
    public static final ThreeColumnTupleSourceFactory<IntDoubleCharTuple, Int, Double, Char> FACTORY = new Factory();
    ...
    @Override
    public final <ELEMENT_TYPE> void exportElement(@NotNull final IntDoubleCharTuple tuple, final int elementIndex, @NotNull final WritableColumnSource<ELEMENT_TYPE> writableSource, final long destinationIndexKey) {
        if (elementIndex == 0) {
    ...
    private static final class Factory implements ThreeColumnTupleSourceFactory<IntDoubleCharTuple, Int, Double, Char> {
