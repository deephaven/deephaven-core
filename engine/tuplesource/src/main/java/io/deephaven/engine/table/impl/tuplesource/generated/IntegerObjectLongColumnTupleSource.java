...
/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types Int, Object, and Long.
...
public class IntegerObjectLongColumnTupleSource extends AbstractTupleSource<IntObjectLongTuple> {
    ...
    public static final ThreeColumnTupleSourceFactory<IntObjectLongTuple, Int, Object, Long> FACTORY = new Factory();
    ...
    @Override
    public final <ELEMENT_TYPE> void exportElement(@NotNull final IntObjectLongTuple tuple, final int elementIndex, @NotNull final WritableColumnSource<ELEMENT_TYPE> writableSource, final long destinationIndexKey) {
        if (elementIndex == 0) {
    ...
    private static final class Factory implements ThreeColumnTupleSourceFactory<IntObjectLongTuple, Int, Object, Long> {
