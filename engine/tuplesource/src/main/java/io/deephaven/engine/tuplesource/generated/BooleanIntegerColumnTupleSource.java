...
/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types Boolean and Int.
...
public class BooleanIntegerColumnTupleSource extends AbstractTupleSource<ByteIntTuple> {
    ...
    public static final TwoColumnTupleSourceFactory<ByteIntTuple, Boolean, Int> FACTORY = new Factory();
    ...
    private static final class Factory implements TwoColumnTupleSourceFactory<ByteIntTuple, Boolean, Int> {
