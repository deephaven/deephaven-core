...
/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types Instant, Float, and Instant.
 */
@SuppressWarnings({"unused", "WeakerAccess"})
public class InstantFloatInstantColumnTupleSource extends AbstractTupleSource<LongFloatLongTuple> {

    /** {@link ThreeColumnTupleSourceFactory} instance to create instances of {@link InstantFloatInstantColumnTupleSource}. **/
    public static final ThreeColumnTupleSourceFactory<LongFloatLongTuple, Instant, Float, Instant> FACTORY = new Factory();

    private final ColumnSource<Instant> columnSource1;
    private final ColumnSource<Float> columnSource2;
    private final ColumnSource<Instant> columnSource3;

    public InstantFloatInstantColumnTupleSource(
    ...
    /** {@link ThreeColumnTupleSourceFactory} for instances of {@link InstantFloatInstantColumnTupleSource}. **/
    private static final class Factory implements ThreeColumnTupleSourceFactory<LongFloatLongTuple, Instant, Float, Instant> {
        ...
        public TupleSource<LongFloatLongTuple> create(
            ...
            return new InstantFloatInstantColumnTupleSource(
                    columnSource1,
                    columnSource2,
                    columnSource3
            );
