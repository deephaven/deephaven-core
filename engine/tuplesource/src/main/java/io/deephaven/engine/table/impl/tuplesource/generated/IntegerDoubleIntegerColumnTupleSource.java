...
/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types Int, Double, and Int.
...
public class IntegerDoubleIntegerColumnTupleSource extends AbstractTupleSource<IntDoubleIntTuple> {
    ...
    public static final ThreeColumnTupleSourceFactory<IntDoubleIntTuple, Int, Double, Int> FACTORY = new Factory();
    ...
    @Override
    public final <ELEMENT_TYPE> void exportElement(@NotNull final IntDoubleIntTuple tuple, final int elementIndex, @NotNull final WritableColumnSource<ELEMENT_TYPE> writableSource, final long destinationIndexKey) {
        if (elementIndex == 0) {
    ...
    private static final class Factory implements ThreeColumnTupleSourceFactory<IntDoubleIntTuple, Int, Double, Int> {
