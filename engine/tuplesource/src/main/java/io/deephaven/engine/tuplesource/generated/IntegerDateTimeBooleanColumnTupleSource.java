...
/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types Int, DateTime, and Boolean.
...
public class IntegerDateTimeBooleanColumnTupleSource extends AbstractTupleSource<IntLongByteTuple> {
    ...
    public static final ThreeColumnTupleSourceFactory<IntLongByteTuple, Int, DateTime, Boolean> FACTORY = new Factory();
    ...
    private static final class Factory implements ThreeColumnTupleSourceFactory<IntLongByteTuple, Int, DateTime, Boolean> {
