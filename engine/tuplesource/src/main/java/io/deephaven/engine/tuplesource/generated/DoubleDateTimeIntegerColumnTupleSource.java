...
/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types Double, DateTime, and Int.
...
public class DoubleDateTimeIntegerColumnTupleSource extends AbstractTupleSource<DoubleLongIntTuple> {
    ...
    public static final ThreeColumnTupleSourceFactory<DoubleLongIntTuple, Double, DateTime, Int> FACTORY = new Factory();
    ...
    private static final class Factory implements ThreeColumnTupleSourceFactory<DoubleLongIntTuple, Double, DateTime, Int> {
