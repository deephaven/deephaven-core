...
/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types Char, Int, and Boolean.
...
public class CharacterIntegerBooleanColumnTupleSource extends AbstractTupleSource<CharIntByteTuple> {
    ...
    public static final ThreeColumnTupleSourceFactory<CharIntByteTuple, Char, Int, Boolean> FACTORY = new Factory();
    ...
    private static final class Factory implements ThreeColumnTupleSourceFactory<CharIntByteTuple, Char, Int, Boolean> {
