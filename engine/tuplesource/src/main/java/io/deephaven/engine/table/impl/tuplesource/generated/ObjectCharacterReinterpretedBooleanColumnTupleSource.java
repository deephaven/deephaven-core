...
import io.deephaven.engine.tuple.generated.ObjectCharByteTuple;
...
/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types Object, Char, and Byte.
...
public class ObjectCharacterReinterpretedBooleanColumnTupleSource extends AbstractTupleSource<ObjectCharByteTuple> {
    ...
    public static final ThreeColumnTupleSourceFactory<ObjectCharByteTuple, Object, Char, Byte> FACTORY = new Factory();
    ...
    @Override
    public final <ELEMENT_TYPE> void exportElement(@NotNull final ObjectCharByteTuple tuple, final int elementIndex, @NotNull final WritableColumnSource<ELEMENT_TYPE> writableSource, final long destinationIndexKey) {
        if (elementIndex == 0) {
    ...
    private static final class Factory implements ThreeColumnTupleSourceFactory<ObjectCharByteTuple, Object, Char, Byte> {
