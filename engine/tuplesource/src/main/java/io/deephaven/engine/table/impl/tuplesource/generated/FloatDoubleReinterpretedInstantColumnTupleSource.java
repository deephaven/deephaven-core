...
public class FloatDoubleReinterpretedInstantColumnTupleSource extends AbstractTupleSource<FloatDoubleLongTuple> {
    ...
    private static final class Factory implements ThreeColumnTupleSourceFactory<FloatDoubleLongTuple, Float, Double, Long> {
        ...
        public TupleSource<FloatDoubleLongTuple> create(
            ...
            return new FloatDoubleReinterpretedInstantColumnTupleSource(
                    columnSource1,
                    columnSource2,
                    columnSource3
            );
