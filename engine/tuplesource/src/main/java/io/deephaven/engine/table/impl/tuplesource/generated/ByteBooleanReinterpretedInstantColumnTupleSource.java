...
public class ByteBooleanReinterpretedInstantColumnTupleSource extends AbstractTupleSource<ByteByteLongTuple> {
    ...
    public ByteBooleanReinterpretedInstantColumnTupleSource(
    ...
    private static final class Factory implements ThreeColumnTupleSourceFactory<ByteByteLongTuple, Byte, Boolean, Long> {
        ...
        public TupleSource<ByteByteLongTuple> create(
            ...
            return new ByteBooleanReinterpretedInstantColumnTupleSource(
                    columnSource1,
                    columnSource2,
                    columnSource3
            );
