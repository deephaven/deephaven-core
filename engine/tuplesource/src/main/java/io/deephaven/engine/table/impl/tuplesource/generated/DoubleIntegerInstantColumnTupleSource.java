...
/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types Double, Integer, and Instant.
 */
@SuppressWarnings({"unused", "WeakerAccess"})
public class DoubleIntegerInstantColumnTupleSource extends AbstractTupleSource<DoubleIntLongTuple> {

    /** {@link ThreeColumnTupleSourceFactory} instance to create instances of {@link DoubleIntegerInstantColumnTupleSource}. **/
    public static final ThreeColumnTupleSourceFactory<DoubleIntLongTuple, Double, Integer, Instant> FACTORY = new Factory();

    private final ColumnSource<Double> columnSource1;
    private final ColumnSource<Integer> columnSource2;
    private final ColumnSource<Instant> columnSource3;

    public DoubleIntegerInstantColumnTupleSource(
    ...
    protected void convertChunks(@NotNull WritableChunk<? super Values> destination, int chunkSize, Chunk<? extends Values> [] chunks) {
        ...
        for (int ii = 0; ii < chunkSize; ++ii) {
            destinationObjectChunk.set(ii, new DoubleIntLongTuple(chunk1.get(ii), chunk2.get(ii), DateTimeUtils.epochNanos(chunk3.get(ii))));
        }
        destinationObjectChunk.setSize(chunkSize);
    }

    /** {@link ThreeColumnTupleSourceFactory} for instances of {@link DoubleIntegerInstantColumnTupleSource}. **/
    private static final class Factory implements ThreeColumnTupleSourceFactory<DoubleIntLongTuple, Double, Integer, Instant> {
        ...
        public TupleSource<DoubleIntLongTuple> create(
            ...
            return new DoubleIntegerInstantColumnTupleSource(
                    columnSource1,
                    columnSource2,
                    columnSource3
            );
