...
public class FloatReinterpretedInstantShortColumnTupleSource extends AbstractTupleSource<FloatLongShortTuple> {

    /** {@link ThreeColumnTupleSourceFactory} instance to create instances of {@link FloatReinterpretedInstantShortColumnTupleSource}. **/
    ...
    public FloatReinterpretedInstantShortColumnTupleSource(
    ...
    @Override
    public final void exportAllTo(final Object @NotNull [] dest, @NotNull final FloatLongShortTuple tuple) {
    ...
    @Override
    public final void exportAllTo(final Object @NotNull [] dest, @NotNull final FloatLongShortTuple tuple, final int @NotNull [] map) {
    ...
    @Override
    public final void exportAllReinterpretedTo(final Object @NotNull [] dest, @NotNull final FloatLongShortTuple tuple) {
        dest[0] = TypeUtils.box(tuple.getFirstElement());
    ...
    @Override
    public final void exportAllReinterpretedTo(final Object @NotNull [] dest, @NotNull final FloatLongShortTuple tuple, final int @NotNull [] map) {
        dest[map[0]] = TypeUtils.box(tuple.getFirstElement());
    ...
    /** {@link ThreeColumnTupleSourceFactory} for instances of {@link FloatReinterpretedInstantShortColumnTupleSource}. **/
    private static final class Factory implements ThreeColumnTupleSourceFactory<FloatLongShortTuple, Float, Long, Short> {
        ...
        public TupleSource<FloatLongShortTuple> create(
            ...
            return new FloatReinterpretedInstantShortColumnTupleSource(
                    columnSource1,
                    columnSource2,
                    columnSource3
            );
