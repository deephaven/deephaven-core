...
import io.deephaven.engine.tuple.generated.ObjectIntFloatTuple;
...
/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types Object, Int, and Float.
...
public class ObjectIntegerFloatColumnTupleSource extends AbstractTupleSource<ObjectIntFloatTuple> {
    ...
    public static final ThreeColumnTupleSourceFactory<ObjectIntFloatTuple, Object, Int, Float> FACTORY = new Factory();
    ...
    @Override
    public final <ELEMENT_TYPE> void exportElement(@NotNull final ObjectIntFloatTuple tuple, final int elementIndex, @NotNull final WritableColumnSource<ELEMENT_TYPE> writableSource, final long destinationIndexKey) {
        if (elementIndex == 0) {
    ...
    private static final class Factory implements ThreeColumnTupleSourceFactory<ObjectIntFloatTuple, Object, Int, Float> {
