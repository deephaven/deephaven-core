...
import io.deephaven.engine.tuple.generated.ObjectCharShortTuple;
...
/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types Object, Char, and Short.
...
public class ObjectCharacterShortColumnTupleSource extends AbstractTupleSource<ObjectCharShortTuple> {
    ...
    public static final ThreeColumnTupleSourceFactory<ObjectCharShortTuple, Object, Char, Short> FACTORY = new Factory();
    ...
    @Override
    public final ObjectCharShortTuple createTuple(final long indexKey) {
    ...
    @Override
    public final ObjectCharShortTuple createPreviousTuple(final long indexKey) {
        return new ObjectCharShortTuple(
    ...
    @Override
    public final <ELEMENT_TYPE> void exportElement(@NotNull final ObjectCharShortTuple tuple, final int elementIndex, @NotNull final WritableColumnSource<ELEMENT_TYPE> writableSource, final long destinationIndexKey) {
        if (elementIndex == 0) {
    ...
    @Override
    public final Object exportToExternalKey(@NotNull final ObjectCharShortTuple tuple) {
        return new SmartKey(
    ...
    protected void convertChunks(@NotNull WritableChunk<? super Attributes.Values> destination, int chunkSize, Chunk<Attributes.Values> [] chunks) {
        WritableObjectChunk<ObjectCharShortTuple, ? super Attributes.Values> destinationObjectChunk = destination.asWritableObjectChunk();
    ...
    private static final class Factory implements ThreeColumnTupleSourceFactory<ObjectCharShortTuple, Object, Char, Short> {
