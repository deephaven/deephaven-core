...
/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types Short, Boolean, and Instant.
 */
@SuppressWarnings({"unused", "WeakerAccess"})
public class ShortBooleanInstantColumnTupleSource extends AbstractTupleSource<ShortByteLongTuple> {

    /** {@link ThreeColumnTupleSourceFactory} instance to create instances of {@link ShortBooleanInstantColumnTupleSource}. **/
    public static final ThreeColumnTupleSourceFactory<ShortByteLongTuple, Short, Boolean, Instant> FACTORY = new Factory();
    ...
    /** {@link ThreeColumnTupleSourceFactory} for instances of {@link ShortBooleanInstantColumnTupleSource}. **/
    private static final class Factory implements ThreeColumnTupleSourceFactory<ShortByteLongTuple, Short, Boolean, Instant> {
        ...
        public TupleSource<ShortByteLongTuple> create(
            ...
            return new ShortBooleanInstantColumnTupleSource(
                    columnSource1,
                    columnSource2,
                    columnSource3
            );
