...
public class ReinterpretedInstantByteReinterpretedInstantColumnTupleSource extends AbstractTupleSource<LongByteLongTuple> {
    ...
    private static final class Factory implements ThreeColumnTupleSourceFactory<LongByteLongTuple, Long, Byte, Long> {
        ...
        public TupleSource<LongByteLongTuple> create(
            ...
            return new ReinterpretedInstantByteReinterpretedInstantColumnTupleSource(
                    columnSource1,
                    columnSource2,
                    columnSource3
            );
