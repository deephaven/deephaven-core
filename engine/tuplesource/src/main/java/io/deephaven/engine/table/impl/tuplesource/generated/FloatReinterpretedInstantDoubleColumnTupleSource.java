...
public class FloatReinterpretedInstantDoubleColumnTupleSource extends AbstractTupleSource<FloatLongDoubleTuple> {
    ...
    public FloatReinterpretedInstantDoubleColumnTupleSource(
    ...
    private static final class Factory implements ThreeColumnTupleSourceFactory<FloatLongDoubleTuple, Float, Long, Double> {
        ...
        public TupleSource<FloatLongDoubleTuple> create(
            ...
            return new FloatReinterpretedInstantDoubleColumnTupleSource(
                    columnSource1,
                    columnSource2,
                    columnSource3
            );
