...
/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types Boolean, Int, and DateTime.
...
public class BooleanIntegerDateTimeColumnTupleSource extends AbstractTupleSource<ByteIntLongTuple> {
    ...
    public static final ThreeColumnTupleSourceFactory<ByteIntLongTuple, Boolean, Int, DateTime> FACTORY = new Factory();
    ...
    private static final class Factory implements ThreeColumnTupleSourceFactory<ByteIntLongTuple, Boolean, Int, DateTime> {
