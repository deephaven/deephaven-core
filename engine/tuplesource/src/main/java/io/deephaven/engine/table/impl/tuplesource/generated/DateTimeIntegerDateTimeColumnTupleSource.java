...
/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types DateTime, Int, and DateTime.
...
public class DateTimeIntegerDateTimeColumnTupleSource extends AbstractTupleSource<LongIntLongTuple> {
    ...
    public static final ThreeColumnTupleSourceFactory<LongIntLongTuple, DateTime, Int, DateTime> FACTORY = new Factory();
    ...
    private static final class Factory implements ThreeColumnTupleSourceFactory<LongIntLongTuple, DateTime, Int, DateTime> {
