...
import io.deephaven.engine.tuple.generated.ObjectIntLongTuple;
...
/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types Object, Int, and Long.
 * <p>Generated by io.deephaven.replicators.TupleSourceCodeGenerator.
 */
@SuppressWarnings({"unused", "WeakerAccess"})
public class ObjectIntegerReinterpretedDateTimeColumnTupleSource extends AbstractTupleSource<ObjectIntLongTuple> {

    /** {@link ThreeColumnTupleSourceFactory} instance to create instances of {@link ObjectIntegerReinterpretedDateTimeColumnTupleSource}. **/
    public static final ThreeColumnTupleSourceFactory<ObjectIntLongTuple, Object, Int, Long> FACTORY = new Factory();

    private final ColumnSource<Object> columnSource1;
    private final ColumnSource<Int> columnSource2;
    private final ColumnSource<Long> columnSource3;

    public ObjectIntegerReinterpretedDateTimeColumnTupleSource(
    ...
    @Override
    public final <ELEMENT_TYPE> void exportElement(@NotNull final ObjectIntLongTuple tuple, final int elementIndex, @NotNull final WritableColumnSource<ELEMENT_TYPE> writableSource, final long destinationIndexKey) {
        if (elementIndex == 0) {
    ...
    /** {@link ThreeColumnTupleSourceFactory} for instances of {@link ObjectIntegerReinterpretedDateTimeColumnTupleSource}. **/
    private static final class Factory implements ThreeColumnTupleSourceFactory<ObjectIntLongTuple, Object, Int, Long> {
        ...
        public TupleSource<ObjectIntLongTuple> create(
            ...
            return new ObjectIntegerReinterpretedDateTimeColumnTupleSource(
                    columnSource1,
                    columnSource2,
                    columnSource3
            );
