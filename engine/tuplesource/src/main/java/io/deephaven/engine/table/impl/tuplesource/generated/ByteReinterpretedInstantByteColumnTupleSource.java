...
public class ByteReinterpretedInstantByteColumnTupleSource extends AbstractTupleSource<ByteLongByteTuple> {
    ...
    public ByteReinterpretedInstantByteColumnTupleSource(
    ...
    private static final class Factory implements ThreeColumnTupleSourceFactory<ByteLongByteTuple, Byte, Long, Byte> {
        ...
        public TupleSource<ByteLongByteTuple> create(
            ...
            return new ByteReinterpretedInstantByteColumnTupleSource(
                    columnSource1,
                    columnSource2,
                    columnSource3
            );
