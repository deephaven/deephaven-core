...
/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types Float and Boolean.
 */
@SuppressWarnings({"unused", "WeakerAccess"})
public class FloatBooleanColumnTupleSource extends AbstractTupleSource<FloatByteTuple> {

    /** {@link TwoColumnTupleSourceFactory} instance to create instances of {@link FloatBooleanColumnTupleSource}. **/
    public static final TwoColumnTupleSourceFactory<FloatByteTuple, Float, Boolean> FACTORY = new Factory();

    private final ColumnSource<Float> columnSource1;
    private final ColumnSource<Boolean> columnSource2;

    public FloatBooleanColumnTupleSource(
    ...
    protected void convertChunks(@NotNull WritableChunk<? super Values> destination, int chunkSize, Chunk<? extends Values> [] chunks) {
        ...
        for (int ii = 0; ii < chunkSize; ++ii) {
            destinationObjectChunk.set(ii, new FloatByteTuple(chunk1.get(ii), BooleanUtils.booleanAsByte(chunk2.get(ii))));
        }
    ...
    /** {@link TwoColumnTupleSourceFactory} for instances of {@link FloatBooleanColumnTupleSource}. **/
    private static final class Factory implements TwoColumnTupleSourceFactory<FloatByteTuple, Float, Boolean> {
        ...
        public TupleSource<FloatByteTuple> create(
            ...
            return new FloatBooleanColumnTupleSource(
                    columnSource1,
                    columnSource2
            );
        }
