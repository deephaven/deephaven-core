...
public class IntegerReinterpretedInstantFloatColumnTupleSource extends AbstractTupleSource<IntLongFloatTuple> {
    ...
    public IntegerReinterpretedInstantFloatColumnTupleSource(
    ...
    private static final class Factory implements ThreeColumnTupleSourceFactory<IntLongFloatTuple, Integer, Long, Float> {
        ...
        public TupleSource<IntLongFloatTuple> create(
            ...
            return new IntegerReinterpretedInstantFloatColumnTupleSource(
                    columnSource1,
                    columnSource2,
                    columnSource3
            );
