...
public class ReinterpretedInstantFloatLongColumnTupleSource extends AbstractTupleSource<LongFloatLongTuple> {

    /** {@link ThreeColumnTupleSourceFactory} instance to create instances of {@link ReinterpretedInstantFloatLongColumnTupleSource}. **/
    ...
    public ReinterpretedInstantFloatLongColumnTupleSource(
    ...
    @Override
    public final void exportAllTo(final Object @NotNull [] dest, @NotNull final LongFloatLongTuple tuple) {
    ...
    @Override
    public final void exportAllTo(final Object @NotNull [] dest, @NotNull final LongFloatLongTuple tuple, final int @NotNull [] map) {
    ...
    @Override
    public final void exportAllReinterpretedTo(final Object @NotNull [] dest, @NotNull final LongFloatLongTuple tuple) {
    ...
    @Override
    public final void exportAllReinterpretedTo(final Object @NotNull [] dest, @NotNull final LongFloatLongTuple tuple, final int @NotNull [] map) {
    ...
    /** {@link ThreeColumnTupleSourceFactory} for instances of {@link ReinterpretedInstantFloatLongColumnTupleSource}. **/
    private static final class Factory implements ThreeColumnTupleSourceFactory<LongFloatLongTuple, Long, Float, Long> {
        ...
        public TupleSource<LongFloatLongTuple> create(
            ...
            return new ReinterpretedInstantFloatLongColumnTupleSource(
                    columnSource1,
                    columnSource2,
                    columnSource3
            );
