...
/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types Int, Int, and Byte.
...
public class IntegerIntegerByteColumnTupleSource extends AbstractTupleSource<IntIntByteTuple> {
    ...
    public static final ThreeColumnTupleSourceFactory<IntIntByteTuple, Int, Int, Byte> FACTORY = new Factory();
    ...
    private static final class Factory implements ThreeColumnTupleSourceFactory<IntIntByteTuple, Int, Int, Byte> {
