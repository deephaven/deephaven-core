...
import io.deephaven.engine.tuple.generated.IntIntDoubleTuple;
...
/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types Int, Int, and Double.
...
public class IntegerIntegerDoubleColumnTupleSource extends AbstractTupleSource<IntIntDoubleTuple> {
    ...
    public static final ThreeColumnTupleSourceFactory<IntIntDoubleTuple, Int, Int, Double> FACTORY = new Factory();
    ...
    @Override
    public final <ELEMENT_TYPE> void exportElement(@NotNull final IntIntDoubleTuple tuple, final int elementIndex, @NotNull final WritableColumnSource<ELEMENT_TYPE> writableSource, final long destinationIndexKey) {
        if (elementIndex == 0) {
    ...
    private static final class Factory implements ThreeColumnTupleSourceFactory<IntIntDoubleTuple, Int, Int, Double> {
