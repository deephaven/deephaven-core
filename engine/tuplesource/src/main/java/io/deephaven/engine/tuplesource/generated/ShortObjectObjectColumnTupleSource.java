...
import io.deephaven.engine.tuple.generated.ShortObjectObjectTuple;
...
public class ShortObjectObjectColumnTupleSource extends AbstractTupleSource<ShortObjectObjectTuple> {
    ...
    @Override
    public final <ELEMENT_TYPE> void exportElement(@NotNull final ShortObjectObjectTuple tuple, final int elementIndex, @NotNull final WritableColumnSource<ELEMENT_TYPE> writableSource, final long destinationIndexKey) {
        if (elementIndex == 0) {
