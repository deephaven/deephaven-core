...
public class ReinterpretedInstantByteLongColumnTupleSource extends AbstractTupleSource<LongByteLongTuple> {
    ...
    public ReinterpretedInstantByteLongColumnTupleSource(
    ...
    private static final class Factory implements ThreeColumnTupleSourceFactory<LongByteLongTuple, Long, Byte, Long> {
        ...
        public TupleSource<LongByteLongTuple> create(
            ...
            return new ReinterpretedInstantByteLongColumnTupleSource(
                    columnSource1,
                    columnSource2,
                    columnSource3
            );
