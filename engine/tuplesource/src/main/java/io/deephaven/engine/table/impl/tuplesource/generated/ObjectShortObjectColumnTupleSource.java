...
import io.deephaven.engine.tuple.generated.ObjectShortObjectTuple;
...
public class ObjectShortObjectColumnTupleSource extends AbstractTupleSource<ObjectShortObjectTuple> {
    ...
    @Override
    public final ObjectShortObjectTuple createTuple(final long indexKey) {
    ...
    @Override
    public final ObjectShortObjectTuple createPreviousTuple(final long indexKey) {
        return new ObjectShortObjectTuple(
    ...
    @Override
    public final <ELEMENT_TYPE> void exportElement(@NotNull final ObjectShortObjectTuple tuple, final int elementIndex, @NotNull final WritableColumnSource<ELEMENT_TYPE> writableSource, final long destinationIndexKey) {
        if (elementIndex == 0) {
    ...
    @Override
    public final Object exportToExternalKey(@NotNull final ObjectShortObjectTuple tuple) {
        return new SmartKey(
    ...
    protected void convertChunks(@NotNull WritableChunk<? super Attributes.Values> destination, int chunkSize, Chunk<Attributes.Values> [] chunks) {
        WritableObjectChunk<ObjectShortObjectTuple, ? super Attributes.Values> destinationObjectChunk = destination.asWritableObjectChunk();
