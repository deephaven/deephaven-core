...
import io.deephaven.engine.tuple.generated.ObjectFloatFloatTuple;
...
public class ObjectFloatFloatColumnTupleSource extends AbstractTupleSource<ObjectFloatFloatTuple> {
    ...
    @Override
    public final <ELEMENT_TYPE> void exportElement(@NotNull final ObjectFloatFloatTuple tuple, final int elementIndex, @NotNull final WritableColumnSource<ELEMENT_TYPE> writableSource, final long destinationIndexKey) {
        if (elementIndex == 0) {
