...
import io.deephaven.engine.tuple.generated.FloatShortFloatTuple;
...
public class FloatShortFloatColumnTupleSource extends AbstractTupleSource<FloatShortFloatTuple> {
    ...
    @Override
    public final <ELEMENT_TYPE> void exportElement(@NotNull final FloatShortFloatTuple tuple, final int elementIndex, @NotNull final WritableColumnSource<ELEMENT_TYPE> writableSource, final long destinationIndexKey) {
        if (elementIndex == 0) {
