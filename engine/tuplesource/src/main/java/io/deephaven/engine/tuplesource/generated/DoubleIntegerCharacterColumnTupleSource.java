...
import io.deephaven.engine.tuple.generated.DoubleIntCharTuple;
...
/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types Double, Int, and Char.
...
public class DoubleIntegerCharacterColumnTupleSource extends AbstractTupleSource<DoubleIntCharTuple> {
    ...
    public static final ThreeColumnTupleSourceFactory<DoubleIntCharTuple, Double, Int, Char> FACTORY = new Factory();
    ...
    @Override
    public final <ELEMENT_TYPE> void exportElement(@NotNull final DoubleIntCharTuple tuple, final int elementIndex, @NotNull final WritableColumnSource<ELEMENT_TYPE> writableSource, final long destinationIndexKey) {
        if (elementIndex == 0) {
    ...
    private static final class Factory implements ThreeColumnTupleSourceFactory<DoubleIntCharTuple, Double, Int, Char> {
