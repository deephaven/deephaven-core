...
/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types Boolean, Int, and Float.
...
public class BooleanIntegerFloatColumnTupleSource extends AbstractTupleSource<ByteIntFloatTuple> {
    ...
    public static final ThreeColumnTupleSourceFactory<ByteIntFloatTuple, Boolean, Int, Float> FACTORY = new Factory();
    ...
    private static final class Factory implements ThreeColumnTupleSourceFactory<ByteIntFloatTuple, Boolean, Int, Float> {
