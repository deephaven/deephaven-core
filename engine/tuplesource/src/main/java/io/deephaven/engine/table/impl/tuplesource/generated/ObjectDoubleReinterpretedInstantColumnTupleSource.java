...
public class ObjectDoubleReinterpretedInstantColumnTupleSource extends AbstractTupleSource<ObjectDoubleLongTuple> {
    ...
    public ObjectDoubleReinterpretedInstantColumnTupleSource(
    ...
    private static final class Factory implements ThreeColumnTupleSourceFactory<ObjectDoubleLongTuple, Object, Double, Long> {
        ...
        public TupleSource<ObjectDoubleLongTuple> create(
            ...
            return new ObjectDoubleReinterpretedInstantColumnTupleSource(
                    columnSource1,
                    columnSource2,
                    columnSource3
            );
