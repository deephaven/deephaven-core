...
import io.deephaven.engine.tuple.generated.IntFloatDoubleTuple;
import io.deephaven.util.type.TypeUtils;
import org.jetbrains.annotations.NotNull;


/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types Int, Float, and Double.
...
public class IntegerFloatDoubleColumnTupleSource extends AbstractTupleSource<IntFloatDoubleTuple> {
    ...
    public static final ThreeColumnTupleSourceFactory<IntFloatDoubleTuple, Int, Float, Double> FACTORY = new Factory();
    ...
    @Override
    public final IntFloatDoubleTuple createTuple(final long indexKey) {
    ...
    @Override
    public final IntFloatDoubleTuple createPreviousTuple(final long indexKey) {
        return new IntFloatDoubleTuple(
    ...
    @Override
    public final <ELEMENT_TYPE> void exportElement(@NotNull final IntFloatDoubleTuple tuple, final int elementIndex, @NotNull final WritableColumnSource<ELEMENT_TYPE> writableSource, final long destinationIndexKey) {
        if (elementIndex == 0) {
    ...
    @Override
    public final Object exportToExternalKey(@NotNull final IntFloatDoubleTuple tuple) {
        return new SmartKey(
    ...
    protected void convertChunks(@NotNull WritableChunk<? super Attributes.Values> destination, int chunkSize, Chunk<Attributes.Values> [] chunks) {
        WritableObjectChunk<IntFloatDoubleTuple, ? super Attributes.Values> destinationObjectChunk = destination.asWritableObjectChunk();
    ...
    private static final class Factory implements ThreeColumnTupleSourceFactory<IntFloatDoubleTuple, Int, Float, Double> {
