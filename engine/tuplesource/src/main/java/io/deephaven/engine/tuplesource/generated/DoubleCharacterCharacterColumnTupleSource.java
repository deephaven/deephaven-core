...
/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types Double, Char, and Char.
...
public class DoubleCharacterCharacterColumnTupleSource extends AbstractTupleSource<DoubleCharCharTuple> {
    ...
    public static final ThreeColumnTupleSourceFactory<DoubleCharCharTuple, Double, Char, Char> FACTORY = new Factory();
    ...
    private static final class Factory implements ThreeColumnTupleSourceFactory<DoubleCharCharTuple, Double, Char, Char> {
