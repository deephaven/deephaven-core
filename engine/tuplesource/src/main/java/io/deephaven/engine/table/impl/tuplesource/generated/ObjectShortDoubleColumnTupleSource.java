...
import io.deephaven.engine.tuple.generated.ObjectShortDoubleTuple;
...
public class ObjectShortDoubleColumnTupleSource extends AbstractTupleSource<ObjectShortDoubleTuple> {
    ...
    @Override
    public final <ELEMENT_TYPE> void exportElement(@NotNull final ObjectShortDoubleTuple tuple, final int elementIndex, @NotNull final WritableColumnSource<ELEMENT_TYPE> writableSource, final long destinationIndexKey) {
        if (elementIndex == 0) {
