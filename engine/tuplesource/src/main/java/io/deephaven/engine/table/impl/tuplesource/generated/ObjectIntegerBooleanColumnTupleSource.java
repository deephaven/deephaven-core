...
/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types Object, Int, and Boolean.
...
public class ObjectIntegerBooleanColumnTupleSource extends AbstractTupleSource<ObjectIntByteTuple> {
    ...
    public static final ThreeColumnTupleSourceFactory<ObjectIntByteTuple, Object, Int, Boolean> FACTORY = new Factory();
    ...
    @Override
    public final <ELEMENT_TYPE> void exportElement(@NotNull final ObjectIntByteTuple tuple, final int elementIndex, @NotNull final WritableColumnSource<ELEMENT_TYPE> writableSource, final long destinationIndexKey) {
        if (elementIndex == 0) {
    ...
    private static final class Factory implements ThreeColumnTupleSourceFactory<ObjectIntByteTuple, Object, Int, Boolean> {
