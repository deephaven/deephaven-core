...
/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types Long, Boolean, and Int.
...
public class LongBooleanIntegerColumnTupleSource extends AbstractTupleSource<LongByteIntTuple> {
    ...
    public static final ThreeColumnTupleSourceFactory<LongByteIntTuple, Long, Boolean, Int> FACTORY = new Factory();
    ...
    private static final class Factory implements ThreeColumnTupleSourceFactory<LongByteIntTuple, Long, Boolean, Int> {
