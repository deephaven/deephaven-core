...
/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types Boolean, Float, and Char.
...
public class BooleanFloatCharacterColumnTupleSource extends AbstractTupleSource<ByteFloatCharTuple> {
    ...
    public static final ThreeColumnTupleSourceFactory<ByteFloatCharTuple, Boolean, Float, Char> FACTORY = new Factory();
    ...
    private static final class Factory implements ThreeColumnTupleSourceFactory<ByteFloatCharTuple, Boolean, Float, Char> {
