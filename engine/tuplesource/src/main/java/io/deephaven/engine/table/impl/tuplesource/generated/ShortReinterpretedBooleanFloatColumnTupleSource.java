...
public class ShortReinterpretedBooleanFloatColumnTupleSource extends AbstractTupleSource<ShortByteFloatTuple> {
    ...
    @Override
    public final void exportAllTo(final Object @NotNull [] dest, @NotNull final ShortByteFloatTuple tuple) {
    ...
    @Override
    public final void exportAllTo(final Object @NotNull [] dest, @NotNull final ShortByteFloatTuple tuple, final int @NotNull [] map) {
    ...
    @Override
    public final void exportAllReinterpretedTo(final Object @NotNull [] dest, @NotNull final ShortByteFloatTuple tuple) {
        dest[0] = TypeUtils.box(tuple.getFirstElement());
    ...
    @Override
    public final void exportAllReinterpretedTo(final Object @NotNull [] dest, @NotNull final ShortByteFloatTuple tuple, final int @NotNull [] map) {
        dest[map[0]] = TypeUtils.box(tuple.getFirstElement());
