...
/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types Double, Boolean, and Char.
...
public class DoubleBooleanCharacterColumnTupleSource extends AbstractTupleSource<DoubleByteCharTuple> {
    ...
    public static final ThreeColumnTupleSourceFactory<DoubleByteCharTuple, Double, Boolean, Char> FACTORY = new Factory();
    ...
    private static final class Factory implements ThreeColumnTupleSourceFactory<DoubleByteCharTuple, Double, Boolean, Char> {
