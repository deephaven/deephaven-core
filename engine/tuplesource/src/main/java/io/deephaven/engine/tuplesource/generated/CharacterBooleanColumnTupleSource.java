...
/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types Char and Boolean.
...
public class CharacterBooleanColumnTupleSource extends AbstractTupleSource<CharByteTuple> {
    ...
    public static final TwoColumnTupleSourceFactory<CharByteTuple, Char, Boolean> FACTORY = new Factory();
    ...
    private static final class Factory implements TwoColumnTupleSourceFactory<CharByteTuple, Char, Boolean> {
