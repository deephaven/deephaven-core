...
public class BooleanReinterpretedInstantCharacterColumnTupleSource extends AbstractTupleSource<ByteLongCharTuple> {

    /** {@link ThreeColumnTupleSourceFactory} instance to create instances of {@link BooleanReinterpretedInstantCharacterColumnTupleSource}. **/
    ...
    public BooleanReinterpretedInstantCharacterColumnTupleSource(
    ...
    /** {@link ThreeColumnTupleSourceFactory} for instances of {@link BooleanReinterpretedInstantCharacterColumnTupleSource}. **/
    private static final class Factory implements ThreeColumnTupleSourceFactory<ByteLongCharTuple, Boolean, Long, Character> {
        ...
        public TupleSource<ByteLongCharTuple> create(
            ...
            return new BooleanReinterpretedInstantCharacterColumnTupleSource(
                    columnSource1,
                    columnSource2,
                    columnSource3
            );
