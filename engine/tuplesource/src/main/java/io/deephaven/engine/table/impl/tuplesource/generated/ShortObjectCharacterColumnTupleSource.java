...
import io.deephaven.engine.tuple.generated.ShortObjectCharTuple;
import io.deephaven.util.type.TypeUtils;
import org.jetbrains.annotations.NotNull;


/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types Short, Object, and Char.
...
public class ShortObjectCharacterColumnTupleSource extends AbstractTupleSource<ShortObjectCharTuple> {
    ...
    public static final ThreeColumnTupleSourceFactory<ShortObjectCharTuple, Short, Object, Char> FACTORY = new Factory();
    ...
    @Override
    public final ShortObjectCharTuple createTuple(final long indexKey) {
    ...
    @Override
    public final ShortObjectCharTuple createPreviousTuple(final long indexKey) {
        return new ShortObjectCharTuple(
    ...
    @Override
    public final <ELEMENT_TYPE> void exportElement(@NotNull final ShortObjectCharTuple tuple, final int elementIndex, @NotNull final WritableColumnSource<ELEMENT_TYPE> writableSource, final long destinationIndexKey) {
        if (elementIndex == 0) {
    ...
    protected void convertChunks(@NotNull WritableChunk<? super Attributes.Values> destination, int chunkSize, Chunk<Attributes.Values> [] chunks) {
        WritableObjectChunk<ShortObjectCharTuple, ? super Attributes.Values> destinationObjectChunk = destination.asWritableObjectChunk();
    ...
    private static final class Factory implements ThreeColumnTupleSourceFactory<ShortObjectCharTuple, Short, Object, Char> {
