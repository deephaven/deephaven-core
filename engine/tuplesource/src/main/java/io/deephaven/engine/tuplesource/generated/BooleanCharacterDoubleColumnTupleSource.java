...
/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types Boolean, Char, and Double.
...
public class BooleanCharacterDoubleColumnTupleSource extends AbstractTupleSource<ByteCharDoubleTuple> {
    ...
    public static final ThreeColumnTupleSourceFactory<ByteCharDoubleTuple, Boolean, Char, Double> FACTORY = new Factory();
    ...
    private static final class Factory implements ThreeColumnTupleSourceFactory<ByteCharDoubleTuple, Boolean, Char, Double> {
