...
import io.deephaven.engine.tuple.generated.IntByteShortTuple;
import io.deephaven.util.type.TypeUtils;
import org.jetbrains.annotations.NotNull;


/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types Int, Byte, and Short.
...
public class IntegerByteShortColumnTupleSource extends AbstractTupleSource<IntByteShortTuple> {
    ...
    public static final ThreeColumnTupleSourceFactory<IntByteShortTuple, Int, Byte, Short> FACTORY = new Factory();
    ...
    @Override
    public final <ELEMENT_TYPE> void exportElement(@NotNull final IntByteShortTuple tuple, final int elementIndex, @NotNull final WritableColumnSource<ELEMENT_TYPE> writableSource, final long destinationIndexKey) {
        if (elementIndex == 0) {
    ...
    private static final class Factory implements ThreeColumnTupleSourceFactory<IntByteShortTuple, Int, Byte, Short> {
