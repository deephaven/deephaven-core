...
import io.deephaven.engine.tuple.generated.CharObjectTuple;
...
/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types Char and Object.
...
public class CharacterObjectColumnTupleSource extends AbstractTupleSource<CharObjectTuple> {
    ...
    public static final TwoColumnTupleSourceFactory<CharObjectTuple, Char, Object> FACTORY = new Factory();
    ...
    @Override
    public final <ELEMENT_TYPE> void exportElement(@NotNull final CharObjectTuple tuple, final int elementIndex, @NotNull final WritableColumnSource<ELEMENT_TYPE> writableSource, final long destinationIndexKey) {
        if (elementIndex == 0) {
    ...
    private static final class Factory implements TwoColumnTupleSourceFactory<CharObjectTuple, Char, Object> {
