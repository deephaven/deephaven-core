...
public class ReinterpretedBooleanFloatReinterpretedInstantColumnTupleSource extends AbstractTupleSource<ByteFloatLongTuple> {
    ...
    public ReinterpretedBooleanFloatReinterpretedInstantColumnTupleSource(
