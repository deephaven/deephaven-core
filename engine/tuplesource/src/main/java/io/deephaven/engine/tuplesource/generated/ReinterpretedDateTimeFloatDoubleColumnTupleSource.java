...
public class ReinterpretedDateTimeFloatDoubleColumnTupleSource extends AbstractTupleSource<LongFloatDoubleTuple> {

    /** {@link ThreeColumnTupleSourceFactory} instance to create instances of {@link ReinterpretedDateTimeFloatDoubleColumnTupleSource}. **/
    ...
    public ReinterpretedDateTimeFloatDoubleColumnTupleSource(
    ...
    @Override
    public final <ELEMENT_TYPE> void exportElement(@NotNull final LongFloatDoubleTuple tuple, final int elementIndex, @NotNull final WritableColumnSource<ELEMENT_TYPE> writableSource, final long destinationIndexKey) {
        if (elementIndex == 0) {
    ...
    /** {@link ThreeColumnTupleSourceFactory} for instances of {@link ReinterpretedDateTimeFloatDoubleColumnTupleSource}. **/
    private static final class Factory implements ThreeColumnTupleSourceFactory<LongFloatDoubleTuple, Long, Float, Double> {
        ...
        public TupleSource<LongFloatDoubleTuple> create(
            ...
            return new ReinterpretedDateTimeFloatDoubleColumnTupleSource(
                    columnSource1,
                    columnSource2,
                    columnSource3
            );
