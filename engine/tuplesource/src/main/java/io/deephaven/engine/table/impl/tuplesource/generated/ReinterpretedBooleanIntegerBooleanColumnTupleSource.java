...
/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types Byte, Integer, and Boolean.
 */
...
public class ReinterpretedBooleanIntegerBooleanColumnTupleSource extends AbstractTupleSource<ByteIntByteTuple> {
    ...
    public static final ThreeColumnTupleSourceFactory<ByteIntByteTuple, Byte, Integer, Boolean> FACTORY = new Factory();
    ...
    private static final class Factory implements ThreeColumnTupleSourceFactory<ByteIntByteTuple, Byte, Integer, Boolean> {
