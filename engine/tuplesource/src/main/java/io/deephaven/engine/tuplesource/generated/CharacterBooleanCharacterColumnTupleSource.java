...
/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types Char, Boolean, and Char.
...
public class CharacterBooleanCharacterColumnTupleSource extends AbstractTupleSource<CharByteCharTuple> {
    ...
    public static final ThreeColumnTupleSourceFactory<CharByteCharTuple, Char, Boolean, Char> FACTORY = new Factory();
    ...
    private static final class Factory implements ThreeColumnTupleSourceFactory<CharByteCharTuple, Char, Boolean, Char> {
