...
public class LongReinterpretedInstantFloatColumnTupleSource extends AbstractTupleSource<LongLongFloatTuple> {
    ...
    private static final class Factory implements ThreeColumnTupleSourceFactory<LongLongFloatTuple, Long, Long, Float> {
        ...
        public TupleSource<LongLongFloatTuple> create(
            ...
            return new LongReinterpretedInstantFloatColumnTupleSource(
                    columnSource1,
                    columnSource2,
                    columnSource3
            );
