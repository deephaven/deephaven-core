...
public class BooleanReinterpretedInstantColumnTupleSource extends AbstractTupleSource<ByteLongTuple> {

    /** {@link TwoColumnTupleSourceFactory} instance to create instances of {@link BooleanReinterpretedInstantColumnTupleSource}. **/
    public static final TwoColumnTupleSourceFactory<ByteLongTuple, Boolean, Long> FACTORY = new Factory();

    private final ColumnSource<Boolean> columnSource1;
    private final ColumnSource<Long> columnSource2;

    public BooleanReinterpretedInstantColumnTupleSource(
    ...
    private static final class Factory implements TwoColumnTupleSourceFactory<ByteLongTuple, Boolean, Long> {
        ...
        public TupleSource<ByteLongTuple> create(
            ...
            return new BooleanReinterpretedInstantColumnTupleSource(
                    columnSource1,
                    columnSource2
            );
        }
