...
/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types Float, Long, and Int.
...
public class FloatReinterpretedDateTimeIntegerColumnTupleSource extends AbstractTupleSource<FloatLongIntTuple> {
    ...
    public static final ThreeColumnTupleSourceFactory<FloatLongIntTuple, Float, Long, Int> FACTORY = new Factory();
    ...
    private static final class Factory implements ThreeColumnTupleSourceFactory<FloatLongIntTuple, Float, Long, Int> {
