...
import io.deephaven.engine.tuple.generated.ByteFloatTuple;
...
public class ByteFloatColumnTupleSource extends AbstractTupleSource<ByteFloatTuple> {
    ...
    @Override
    public final <ELEMENT_TYPE> void exportElement(@NotNull final ByteFloatTuple tuple, final int elementIndex, @NotNull final WritableColumnSource<ELEMENT_TYPE> writableSource, final long destinationIndexKey) {
        if (elementIndex == 0) {
