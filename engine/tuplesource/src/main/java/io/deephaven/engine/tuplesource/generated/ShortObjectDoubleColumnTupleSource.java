...
import io.deephaven.engine.tuple.generated.ShortObjectDoubleTuple;
...
public class ShortObjectDoubleColumnTupleSource extends AbstractTupleSource<ShortObjectDoubleTuple> {
    ...
    @Override
    public final <ELEMENT_TYPE> void exportElement(@NotNull final ShortObjectDoubleTuple tuple, final int elementIndex, @NotNull final WritableColumnSource<ELEMENT_TYPE> writableSource, final long destinationIndexKey) {
        if (elementIndex == 0) {
