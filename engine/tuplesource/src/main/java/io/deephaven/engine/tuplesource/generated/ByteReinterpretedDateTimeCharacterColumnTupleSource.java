...
/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types Byte, Long, and Char.
...
public class ByteReinterpretedDateTimeCharacterColumnTupleSource extends AbstractTupleSource<ByteLongCharTuple> {
    ...
    public static final ThreeColumnTupleSourceFactory<ByteLongCharTuple, Byte, Long, Char> FACTORY = new Factory();
    ...
    private static final class Factory implements ThreeColumnTupleSourceFactory<ByteLongCharTuple, Byte, Long, Char> {
