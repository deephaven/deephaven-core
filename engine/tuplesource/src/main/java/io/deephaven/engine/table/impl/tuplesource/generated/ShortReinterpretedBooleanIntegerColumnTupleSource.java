...
/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types Short, Byte, and Int.
...
public class ShortReinterpretedBooleanIntegerColumnTupleSource extends AbstractTupleSource<ShortByteIntTuple> {
    ...
    public static final ThreeColumnTupleSourceFactory<ShortByteIntTuple, Short, Byte, Int> FACTORY = new Factory();
    ...
    private static final class Factory implements ThreeColumnTupleSourceFactory<ShortByteIntTuple, Short, Byte, Int> {
