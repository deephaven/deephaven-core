...
import io.deephaven.engine.tuple.generated.ShortDoubleDoubleTuple;
...
public class ShortDoubleDoubleColumnTupleSource extends AbstractTupleSource<ShortDoubleDoubleTuple> {
    ...
    @Override
    public final <ELEMENT_TYPE> void exportElement(@NotNull final ShortDoubleDoubleTuple tuple, final int elementIndex, @NotNull final WritableColumnSource<ELEMENT_TYPE> writableSource, final long destinationIndexKey) {
        if (elementIndex == 0) {
