...
public class LongReinterpretedInstantReinterpretedBooleanColumnTupleSource extends AbstractTupleSource<LongLongByteTuple> {
    ...
    public LongReinterpretedInstantReinterpretedBooleanColumnTupleSource(
    ...
    private static final class Factory implements ThreeColumnTupleSourceFactory<LongLongByteTuple, Long, Long, Byte> {
        ...
        public TupleSource<LongLongByteTuple> create(
            ...
            return new LongReinterpretedInstantReinterpretedBooleanColumnTupleSource(
                    columnSource1,
                    columnSource2,
                    columnSource3
            );
