...
import io.deephaven.engine.tuple.generated.DoubleFloatTuple;
...
public class DoubleFloatColumnTupleSource extends AbstractTupleSource<DoubleFloatTuple> {
    ...
    @Override
    public final <ELEMENT_TYPE> void exportElement(@NotNull final DoubleFloatTuple tuple, final int elementIndex, @NotNull final WritableColumnSource<ELEMENT_TYPE> writableSource, final long destinationIndexKey) {
        if (elementIndex == 0) {
