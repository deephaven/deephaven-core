...
public class ShortReinterpretedInstantCharacterColumnTupleSource extends AbstractTupleSource<ShortLongCharTuple> {
    ...
    public ShortReinterpretedInstantCharacterColumnTupleSource(
    ...
    @Override
    public final void exportAllTo(final Object @NotNull [] dest, @NotNull final ShortLongCharTuple tuple) {
    ...
    @Override
    public final void exportAllTo(final Object @NotNull [] dest, @NotNull final ShortLongCharTuple tuple, final int @NotNull [] map) {
    ...
    @Override
    public final void exportAllReinterpretedTo(final Object @NotNull [] dest, @NotNull final ShortLongCharTuple tuple) {
        dest[0] = TypeUtils.box(tuple.getFirstElement());
    ...
    @Override
    public final void exportAllReinterpretedTo(final Object @NotNull [] dest, @NotNull final ShortLongCharTuple tuple, final int @NotNull [] map) {
        dest[map[0]] = TypeUtils.box(tuple.getFirstElement());
    ...
    private static final class Factory implements ThreeColumnTupleSourceFactory<ShortLongCharTuple, Short, Long, Character> {
        ...
        public TupleSource<ShortLongCharTuple> create(
            ...
            return new ShortReinterpretedInstantCharacterColumnTupleSource(
                    columnSource1,
                    columnSource2,
                    columnSource3
            );
