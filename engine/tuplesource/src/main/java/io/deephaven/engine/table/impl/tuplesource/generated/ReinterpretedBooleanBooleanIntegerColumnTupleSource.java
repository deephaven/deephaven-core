...
/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types Byte, Boolean, and Int.
...
public class ReinterpretedBooleanBooleanIntegerColumnTupleSource extends AbstractTupleSource<ByteByteIntTuple> {
    ...
    public static final ThreeColumnTupleSourceFactory<ByteByteIntTuple, Byte, Boolean, Int> FACTORY = new Factory();
    ...
    private static final class Factory implements ThreeColumnTupleSourceFactory<ByteByteIntTuple, Byte, Boolean, Int> {
