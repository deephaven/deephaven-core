...
public class CharacterReinterpretedInstantReinterpretedInstantColumnTupleSource extends AbstractTupleSource<CharLongLongTuple> {
    ...
    public CharacterReinterpretedInstantReinterpretedInstantColumnTupleSource(
    ...
    private static final class Factory implements ThreeColumnTupleSourceFactory<CharLongLongTuple, Character, Long, Long> {
        ...
        public TupleSource<CharLongLongTuple> create(
            ...
            return new CharacterReinterpretedInstantReinterpretedInstantColumnTupleSource(
                    columnSource1,
                    columnSource2,
                    columnSource3
            );
