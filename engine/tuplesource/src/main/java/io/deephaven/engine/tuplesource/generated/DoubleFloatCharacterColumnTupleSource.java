...
import io.deephaven.engine.tuple.generated.DoubleFloatCharTuple;
...
/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types Double, Float, and Char.
...
public class DoubleFloatCharacterColumnTupleSource extends AbstractTupleSource<DoubleFloatCharTuple> {
    ...
    public static final ThreeColumnTupleSourceFactory<DoubleFloatCharTuple, Double, Float, Char> FACTORY = new Factory();
    ...
    @Override
    public final DoubleFloatCharTuple createTuple(final long indexKey) {
    ...
    @Override
    public final DoubleFloatCharTuple createPreviousTuple(final long indexKey) {
        return new DoubleFloatCharTuple(
    ...
    @Override
    public final <ELEMENT_TYPE> void exportElement(@NotNull final DoubleFloatCharTuple tuple, final int elementIndex, @NotNull final WritableColumnSource<ELEMENT_TYPE> writableSource, final long destinationIndexKey) {
        if (elementIndex == 0) {
    ...
    @Override
    public final Object exportToExternalKey(@NotNull final DoubleFloatCharTuple tuple) {
        return new SmartKey(
    ...
    protected void convertChunks(@NotNull WritableChunk<? super Attributes.Values> destination, int chunkSize, Chunk<Attributes.Values> [] chunks) {
        WritableObjectChunk<DoubleFloatCharTuple, ? super Attributes.Values> destinationObjectChunk = destination.asWritableObjectChunk();
    ...
    private static final class Factory implements ThreeColumnTupleSourceFactory<DoubleFloatCharTuple, Double, Float, Char> {
