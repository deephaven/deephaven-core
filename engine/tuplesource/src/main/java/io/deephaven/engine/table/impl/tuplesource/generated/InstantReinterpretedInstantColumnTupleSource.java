...
/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types Instant and Long.
 */
@SuppressWarnings({"unused", "WeakerAccess"})
public class InstantReinterpretedInstantColumnTupleSource extends AbstractTupleSource<LongLongTuple> {

    /** {@link TwoColumnTupleSourceFactory} instance to create instances of {@link InstantReinterpretedInstantColumnTupleSource}. **/
    public static final TwoColumnTupleSourceFactory<LongLongTuple, Instant, Long> FACTORY = new Factory();

    private final ColumnSource<Instant> columnSource1;
    private final ColumnSource<Long> columnSource2;

    public InstantReinterpretedInstantColumnTupleSource(
    ...
    protected void convertChunks(@NotNull WritableChunk<? super Values> destination, int chunkSize, Chunk<? extends Values> [] chunks) {
        ...
        for (int ii = 0; ii < chunkSize; ++ii) {
            destinationObjectChunk.set(ii, new LongLongTuple(DateTimeUtils.epochNanos(chunk1.get(ii)), chunk2.get(ii)));
        }
    ...
    /** {@link TwoColumnTupleSourceFactory} for instances of {@link InstantReinterpretedInstantColumnTupleSource}. **/
    private static final class Factory implements TwoColumnTupleSourceFactory<LongLongTuple, Instant, Long> {
        ...
        public TupleSource<LongLongTuple> create(
            ...
            return new InstantReinterpretedInstantColumnTupleSource(
                    columnSource1,
                    columnSource2
            );
        }
