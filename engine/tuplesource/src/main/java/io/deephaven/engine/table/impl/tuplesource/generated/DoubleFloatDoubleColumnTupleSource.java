...
import io.deephaven.engine.tuple.generated.DoubleFloatDoubleTuple;
...
public class DoubleFloatDoubleColumnTupleSource extends AbstractTupleSource<DoubleFloatDoubleTuple> {
    ...
    @Override
    public final <ELEMENT_TYPE> void exportElement(@NotNull final DoubleFloatDoubleTuple tuple, final int elementIndex, @NotNull final WritableColumnSource<ELEMENT_TYPE> writableSource, final long destinationIndexKey) {
        if (elementIndex == 0) {
