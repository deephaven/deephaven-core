...
import io.deephaven.engine.tuple.generated.IntFloatObjectTuple;
import io.deephaven.util.type.TypeUtils;
import org.jetbrains.annotations.NotNull;


/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types Int, Float, and Object.
...
public class IntegerFloatObjectColumnTupleSource extends AbstractTupleSource<IntFloatObjectTuple> {
    ...
    public static final ThreeColumnTupleSourceFactory<IntFloatObjectTuple, Int, Float, Object> FACTORY = new Factory();
    ...
    @Override
    public final <ELEMENT_TYPE> void exportElement(@NotNull final IntFloatObjectTuple tuple, final int elementIndex, @NotNull final WritableColumnSource<ELEMENT_TYPE> writableSource, final long destinationIndexKey) {
        if (elementIndex == 0) {
    ...
    private static final class Factory implements ThreeColumnTupleSourceFactory<IntFloatObjectTuple, Int, Float, Object> {
