...
public class ByteReinterpretedInstantLongColumnTupleSource extends AbstractTupleSource<ByteLongLongTuple> {
    ...
    public ByteReinterpretedInstantLongColumnTupleSource(
    ...
    private static final class Factory implements ThreeColumnTupleSourceFactory<ByteLongLongTuple, Byte, Long, Long> {
        ...
        public TupleSource<ByteLongLongTuple> create(
            ...
            return new ByteReinterpretedInstantLongColumnTupleSource(
                    columnSource1,
                    columnSource2,
                    columnSource3
            );
