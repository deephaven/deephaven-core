...
import io.deephaven.engine.tuple.generated.IntShortFloatTuple;
import io.deephaven.util.type.TypeUtils;
import org.jetbrains.annotations.NotNull;


/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types Int, Short, and Float.
...
public class IntegerShortFloatColumnTupleSource extends AbstractTupleSource<IntShortFloatTuple> {
    ...
    public static final ThreeColumnTupleSourceFactory<IntShortFloatTuple, Int, Short, Float> FACTORY = new Factory();
    ...
    @Override
    public final IntShortFloatTuple createTuple(final long indexKey) {
    ...
    @Override
    public final IntShortFloatTuple createPreviousTuple(final long indexKey) {
        return new IntShortFloatTuple(
    ...
    @Override
    public final <ELEMENT_TYPE> void exportElement(@NotNull final IntShortFloatTuple tuple, final int elementIndex, @NotNull final WritableColumnSource<ELEMENT_TYPE> writableSource, final long destinationIndexKey) {
        if (elementIndex == 0) {
    ...
    @Override
    public final Object exportToExternalKey(@NotNull final IntShortFloatTuple tuple) {
        return new SmartKey(
    ...
    private static final class Factory implements ThreeColumnTupleSourceFactory<IntShortFloatTuple, Int, Short, Float> {
