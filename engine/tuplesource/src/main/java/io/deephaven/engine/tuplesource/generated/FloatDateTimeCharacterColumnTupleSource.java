...
/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types Float, DateTime, and Char.
...
public class FloatDateTimeCharacterColumnTupleSource extends AbstractTupleSource<FloatLongCharTuple> {
    ...
    public static final ThreeColumnTupleSourceFactory<FloatLongCharTuple, Float, DateTime, Char> FACTORY = new Factory();
    ...
    private static final class Factory implements ThreeColumnTupleSourceFactory<FloatLongCharTuple, Float, DateTime, Char> {
