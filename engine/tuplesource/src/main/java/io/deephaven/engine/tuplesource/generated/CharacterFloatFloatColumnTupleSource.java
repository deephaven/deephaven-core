...
import io.deephaven.engine.tuple.generated.CharFloatFloatTuple;
...
/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types Char, Float, and Float.
...
public class CharacterFloatFloatColumnTupleSource extends AbstractTupleSource<CharFloatFloatTuple> {
    ...
    public static final ThreeColumnTupleSourceFactory<CharFloatFloatTuple, Char, Float, Float> FACTORY = new Factory();
    ...
    @Override
    public final CharFloatFloatTuple createTuple(final long indexKey) {
    ...
    @Override
    public final CharFloatFloatTuple createPreviousTuple(final long indexKey) {
        return new CharFloatFloatTuple(
    ...
    @Override
    public final <ELEMENT_TYPE> void exportElement(@NotNull final CharFloatFloatTuple tuple, final int elementIndex, @NotNull final WritableColumnSource<ELEMENT_TYPE> writableSource, final long destinationIndexKey) {
        if (elementIndex == 0) {
    ...
    @Override
    public final Object exportToExternalKey(@NotNull final CharFloatFloatTuple tuple) {
        return new SmartKey(
    ...
    protected void convertChunks(@NotNull WritableChunk<? super Attributes.Values> destination, int chunkSize, Chunk<Attributes.Values> [] chunks) {
        WritableObjectChunk<CharFloatFloatTuple, ? super Attributes.Values> destinationObjectChunk = destination.asWritableObjectChunk();
    ...
    private static final class Factory implements ThreeColumnTupleSourceFactory<CharFloatFloatTuple, Char, Float, Float> {
