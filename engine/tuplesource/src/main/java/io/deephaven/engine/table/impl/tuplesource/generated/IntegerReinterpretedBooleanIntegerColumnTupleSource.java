...
/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types Int, Byte, and Int.
...
public class IntegerReinterpretedBooleanIntegerColumnTupleSource extends AbstractTupleSource<IntByteIntTuple> {
    ...
    public static final ThreeColumnTupleSourceFactory<IntByteIntTuple, Int, Byte, Int> FACTORY = new Factory();
    ...
    private static final class Factory implements ThreeColumnTupleSourceFactory<IntByteIntTuple, Int, Byte, Int> {
