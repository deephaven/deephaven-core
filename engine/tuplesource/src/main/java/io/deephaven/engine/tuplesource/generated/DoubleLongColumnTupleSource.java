...
public class DoubleLongColumnTupleSource extends AbstractTupleSource<DoubleLongTuple> {
    ...
    @Override
    public final <ELEMENT_TYPE> void exportElement(@NotNull final DoubleLongTuple tuple, final int elementIndex, @NotNull final WritableColumnSource<ELEMENT_TYPE> writableSource, final long destinationIndexKey) {
        if (elementIndex == 0) {
