...
import io.deephaven.engine.tuple.generated.ShortFloatCharTuple;
import io.deephaven.util.type.TypeUtils;
import org.jetbrains.annotations.NotNull;


/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types Short, Float, and Char.
...
public class ShortFloatCharacterColumnTupleSource extends AbstractTupleSource<ShortFloatCharTuple> {
    ...
    public static final ThreeColumnTupleSourceFactory<ShortFloatCharTuple, Short, Float, Char> FACTORY = new Factory();
    ...
    @Override
    public final ShortFloatCharTuple createTuple(final long indexKey) {
    ...
    @Override
    public final ShortFloatCharTuple createPreviousTuple(final long indexKey) {
        return new ShortFloatCharTuple(
    ...
    @Override
    public final <ELEMENT_TYPE> void exportElement(@NotNull final ShortFloatCharTuple tuple, final int elementIndex, @NotNull final WritableColumnSource<ELEMENT_TYPE> writableSource, final long destinationIndexKey) {
        if (elementIndex == 0) {
    ...
    protected void convertChunks(@NotNull WritableChunk<? super Attributes.Values> destination, int chunkSize, Chunk<Attributes.Values> [] chunks) {
        WritableObjectChunk<ShortFloatCharTuple, ? super Attributes.Values> destinationObjectChunk = destination.asWritableObjectChunk();
    ...
    private static final class Factory implements ThreeColumnTupleSourceFactory<ShortFloatCharTuple, Short, Float, Char> {
