...
import io.deephaven.engine.tuple.generated.ObjectDoubleObjectTuple;
...
public class ObjectDoubleObjectColumnTupleSource extends AbstractTupleSource<ObjectDoubleObjectTuple> {
    ...
    @Override
    public final <ELEMENT_TYPE> void exportElement(@NotNull final ObjectDoubleObjectTuple tuple, final int elementIndex, @NotNull final WritableColumnSource<ELEMENT_TYPE> writableSource, final long destinationIndexKey) {
        if (elementIndex == 0) {
