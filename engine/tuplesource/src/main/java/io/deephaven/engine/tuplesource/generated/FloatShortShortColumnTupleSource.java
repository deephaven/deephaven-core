...
import io.deephaven.engine.tuple.generated.FloatShortShortTuple;
...
public class FloatShortShortColumnTupleSource extends AbstractTupleSource<FloatShortShortTuple> {
    ...
    @Override
    public final <ELEMENT_TYPE> void exportElement(@NotNull final FloatShortShortTuple tuple, final int elementIndex, @NotNull final WritableColumnSource<ELEMENT_TYPE> writableSource, final long destinationIndexKey) {
        if (elementIndex == 0) {
