...
/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types Float, Object, and Int.
...
public class FloatObjectIntegerColumnTupleSource extends AbstractTupleSource<FloatObjectIntTuple> {
    ...
    public static final ThreeColumnTupleSourceFactory<FloatObjectIntTuple, Float, Object, Int> FACTORY = new Factory();
    ...
    @Override
    public final <ELEMENT_TYPE> void exportElement(@NotNull final FloatObjectIntTuple tuple, final int elementIndex, @NotNull final WritableColumnSource<ELEMENT_TYPE> writableSource, final long destinationIndexKey) {
        if (elementIndex == 0) {
    ...
    private static final class Factory implements ThreeColumnTupleSourceFactory<FloatObjectIntTuple, Float, Object, Int> {
