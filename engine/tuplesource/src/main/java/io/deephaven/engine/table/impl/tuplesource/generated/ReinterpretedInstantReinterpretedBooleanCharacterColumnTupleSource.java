...
public class ReinterpretedInstantReinterpretedBooleanCharacterColumnTupleSource extends AbstractTupleSource<LongByteCharTuple> {
    ...
    private static final class Factory implements ThreeColumnTupleSourceFactory<LongByteCharTuple, Long, Byte, Character> {
        ...
        public TupleSource<LongByteCharTuple> create(
            ...
            return new ReinterpretedInstantReinterpretedBooleanCharacterColumnTupleSource(
                    columnSource1,
                    columnSource2,
                    columnSource3
            );
