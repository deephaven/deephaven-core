...
/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types Int, Int, and Boolean.
...
public class IntegerIntegerBooleanColumnTupleSource extends AbstractTupleSource<IntIntByteTuple> {
    ...
    public static final ThreeColumnTupleSourceFactory<IntIntByteTuple, Int, Int, Boolean> FACTORY = new Factory();
    ...
    private static final class Factory implements ThreeColumnTupleSourceFactory<IntIntByteTuple, Int, Int, Boolean> {
