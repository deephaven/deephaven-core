...
/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types Char, Int, and Byte.
...
public class CharacterIntegerByteColumnTupleSource extends AbstractTupleSource<CharIntByteTuple> {
    ...
    public static final ThreeColumnTupleSourceFactory<CharIntByteTuple, Char, Int, Byte> FACTORY = new Factory();
    ...
    private static final class Factory implements ThreeColumnTupleSourceFactory<CharIntByteTuple, Char, Int, Byte> {
