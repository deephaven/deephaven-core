...
/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types Character, Instant, and Boolean.
 */
@SuppressWarnings({"unused", "WeakerAccess"})
public class CharacterInstantBooleanColumnTupleSource extends AbstractTupleSource<CharLongByteTuple> {

    /** {@link ThreeColumnTupleSourceFactory} instance to create instances of {@link CharacterInstantBooleanColumnTupleSource}. **/
    public static final ThreeColumnTupleSourceFactory<CharLongByteTuple, Character, Instant, Boolean> FACTORY = new Factory();
    ...
    /** {@link ThreeColumnTupleSourceFactory} for instances of {@link CharacterInstantBooleanColumnTupleSource}. **/
    private static final class Factory implements ThreeColumnTupleSourceFactory<CharLongByteTuple, Character, Instant, Boolean> {
