...
import io.deephaven.engine.tuple.generated.DoubleFloatByteTuple;
...
public class DoubleFloatByteColumnTupleSource extends AbstractTupleSource<DoubleFloatByteTuple> {
    ...
    @Override
    public final <ELEMENT_TYPE> void exportElement(@NotNull final DoubleFloatByteTuple tuple, final int elementIndex, @NotNull final WritableColumnSource<ELEMENT_TYPE> writableSource, final long destinationIndexKey) {
        if (elementIndex == 0) {
