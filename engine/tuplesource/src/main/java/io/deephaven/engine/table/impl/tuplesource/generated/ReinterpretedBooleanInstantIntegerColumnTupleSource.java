...
/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types Byte, Instant, and Integer.
 */
@SuppressWarnings({"unused", "WeakerAccess"})
public class ReinterpretedBooleanInstantIntegerColumnTupleSource extends AbstractTupleSource<ByteLongIntTuple> {

    /** {@link ThreeColumnTupleSourceFactory} instance to create instances of {@link ReinterpretedBooleanInstantIntegerColumnTupleSource}. **/
    public static final ThreeColumnTupleSourceFactory<ByteLongIntTuple, Byte, Instant, Integer> FACTORY = new Factory();

    private final ColumnSource<Byte> columnSource1;
    private final ColumnSource<Instant> columnSource2;
    private final ColumnSource<Integer> columnSource3;

    public ReinterpretedBooleanInstantIntegerColumnTupleSource(
    ...
    /** {@link ThreeColumnTupleSourceFactory} for instances of {@link ReinterpretedBooleanInstantIntegerColumnTupleSource}. **/
    private static final class Factory implements ThreeColumnTupleSourceFactory<ByteLongIntTuple, Byte, Instant, Integer> {
        ...
        public TupleSource<ByteLongIntTuple> create(
            ...
            return new ReinterpretedBooleanInstantIntegerColumnTupleSource(
                    columnSource1,
                    columnSource2,
                    columnSource3
            );
