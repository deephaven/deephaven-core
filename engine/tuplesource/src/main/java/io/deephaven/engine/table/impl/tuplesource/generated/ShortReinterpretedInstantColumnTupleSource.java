...
public class ShortReinterpretedInstantColumnTupleSource extends AbstractTupleSource<ShortLongTuple> {
    ...
    public ShortReinterpretedInstantColumnTupleSource(
    ...
    private static final class Factory implements TwoColumnTupleSourceFactory<ShortLongTuple, Short, Long> {
        ...
        public TupleSource<ShortLongTuple> create(
            ...
            return new ShortReinterpretedInstantColumnTupleSource(
                    columnSource1,
                    columnSource2
            );
        }
