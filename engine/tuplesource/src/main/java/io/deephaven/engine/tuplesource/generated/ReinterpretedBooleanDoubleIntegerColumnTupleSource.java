...
/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types Byte, Double, and Int.
...
public class ReinterpretedBooleanDoubleIntegerColumnTupleSource extends AbstractTupleSource<ByteDoubleIntTuple> {
    ...
    public static final ThreeColumnTupleSourceFactory<ByteDoubleIntTuple, Byte, Double, Int> FACTORY = new Factory();
    ...
    private static final class Factory implements ThreeColumnTupleSourceFactory<ByteDoubleIntTuple, Byte, Double, Int> {
