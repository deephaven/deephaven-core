...
import io.deephaven.engine.tuple.generated.DoubleDoubleShortTuple;
...
public class DoubleDoubleShortColumnTupleSource extends AbstractTupleSource<DoubleDoubleShortTuple> {
    ...
    @Override
    public final <ELEMENT_TYPE> void exportElement(@NotNull final DoubleDoubleShortTuple tuple, final int elementIndex, @NotNull final WritableColumnSource<ELEMENT_TYPE> writableSource, final long destinationIndexKey) {
        if (elementIndex == 0) {
