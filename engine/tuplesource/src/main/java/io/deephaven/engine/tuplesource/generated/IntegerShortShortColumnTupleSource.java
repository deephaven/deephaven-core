...
import io.deephaven.engine.tuple.generated.IntShortShortTuple;
...
/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types Int, Short, and Short.
...
public class IntegerShortShortColumnTupleSource extends AbstractTupleSource<IntShortShortTuple> {
    ...
    public static final ThreeColumnTupleSourceFactory<IntShortShortTuple, Int, Short, Short> FACTORY = new Factory();
    ...
    @Override
    public final <ELEMENT_TYPE> void exportElement(@NotNull final IntShortShortTuple tuple, final int elementIndex, @NotNull final WritableColumnSource<ELEMENT_TYPE> writableSource, final long destinationIndexKey) {
        if (elementIndex == 0) {
    ...
    private static final class Factory implements ThreeColumnTupleSourceFactory<IntShortShortTuple, Int, Short, Short> {
