...
/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types Short, Boolean, and Character.
 */
...
public class ShortBooleanCharacterColumnTupleSource extends AbstractTupleSource<ShortByteCharTuple> {
    ...
    public static final ThreeColumnTupleSourceFactory<ShortByteCharTuple, Short, Boolean, Character> FACTORY = new Factory();
    ...
    private static final class Factory implements ThreeColumnTupleSourceFactory<ShortByteCharTuple, Short, Boolean, Character> {
