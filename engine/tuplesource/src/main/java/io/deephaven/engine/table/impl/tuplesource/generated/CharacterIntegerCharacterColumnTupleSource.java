...
/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types Char, Int, and Char.
...
public class CharacterIntegerCharacterColumnTupleSource extends AbstractTupleSource<CharIntCharTuple> {
    ...
    public static final ThreeColumnTupleSourceFactory<CharIntCharTuple, Char, Int, Char> FACTORY = new Factory();
    ...
    @Override
    public final <ELEMENT_TYPE> void exportElement(@NotNull final CharIntCharTuple tuple, final int elementIndex, @NotNull final WritableColumnSource<ELEMENT_TYPE> writableSource, final long destinationIndexKey) {
        if (elementIndex == 0) {
    ...
    private static final class Factory implements ThreeColumnTupleSourceFactory<CharIntCharTuple, Char, Int, Char> {
