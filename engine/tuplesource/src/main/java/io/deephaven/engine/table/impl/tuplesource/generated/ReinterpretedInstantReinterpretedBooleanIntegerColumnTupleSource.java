...
public class ReinterpretedInstantReinterpretedBooleanIntegerColumnTupleSource extends AbstractTupleSource<LongByteIntTuple> {
    ...
    private static final class Factory implements ThreeColumnTupleSourceFactory<LongByteIntTuple, Long, Byte, Integer> {
        ...
        public TupleSource<LongByteIntTuple> create(
            ...
            return new ReinterpretedInstantReinterpretedBooleanIntegerColumnTupleSource(
                    columnSource1,
                    columnSource2,
                    columnSource3
            );
