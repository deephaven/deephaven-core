...
import io.deephaven.tuple.generated.ByteCharShortTuple;
...
public class ReinterpretedBooleanCharacterShortColumnTupleSource extends AbstractTupleSource<ByteCharShortTuple> {

    /** {@link ThreeColumnTupleSourceFactory} instance to create instances of {@link ReinterpretedBooleanCharacterShortColumnTupleSource}. **/
    ...
    public ReinterpretedBooleanCharacterShortColumnTupleSource(
    ...
    @Override
    public final <ELEMENT_TYPE> void exportElement(@NotNull final ByteCharShortTuple tuple, final int elementIndex, @NotNull final WritableColumnSource<ELEMENT_TYPE> writableSource, final long destinationRowKey) {
        if (elementIndex == 0) {
    ...
    @Override
    public final void exportAllTo(final Object @NotNull [] dest, @NotNull final ByteCharShortTuple tuple) {
    ...
    @Override
    public final void exportAllTo(final Object @NotNull [] dest, @NotNull final ByteCharShortTuple tuple, final int @NotNull [] map) {
    ...
    @Override
    public final void exportAllReinterpretedTo(final Object @NotNull [] dest, @NotNull final ByteCharShortTuple tuple) {
    ...
    @Override
    public final void exportAllReinterpretedTo(final Object @NotNull [] dest, @NotNull final ByteCharShortTuple tuple, final int @NotNull [] map) {
    ...
    /** {@link ThreeColumnTupleSourceFactory} for instances of {@link ReinterpretedBooleanCharacterShortColumnTupleSource}. **/
    private static final class Factory implements ThreeColumnTupleSourceFactory<ByteCharShortTuple, Byte, Character, Short> {
        ...
        public TupleSource<ByteCharShortTuple> create(
            ...
            return new ReinterpretedBooleanCharacterShortColumnTupleSource(
                    columnSource1,
                    columnSource2,
                    columnSource3
            );
