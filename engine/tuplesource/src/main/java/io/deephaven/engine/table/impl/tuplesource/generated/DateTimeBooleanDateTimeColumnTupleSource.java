...
/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types DateTime, Boolean, and DateTime.
...
public class DateTimeBooleanDateTimeColumnTupleSource extends AbstractTupleSource<LongByteLongTuple> {
    ...
    public static final ThreeColumnTupleSourceFactory<LongByteLongTuple, DateTime, Boolean, DateTime> FACTORY = new Factory();
    ...
    private static final class Factory implements ThreeColumnTupleSourceFactory<LongByteLongTuple, DateTime, Boolean, DateTime> {
