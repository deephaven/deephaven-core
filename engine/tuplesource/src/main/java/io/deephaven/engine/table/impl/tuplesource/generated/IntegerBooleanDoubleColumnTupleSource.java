...
/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types Int, Boolean, and Double.
...
public class IntegerBooleanDoubleColumnTupleSource extends AbstractTupleSource<IntByteDoubleTuple> {
    ...
    public static final ThreeColumnTupleSourceFactory<IntByteDoubleTuple, Int, Boolean, Double> FACTORY = new Factory();
    ...
    private static final class Factory implements ThreeColumnTupleSourceFactory<IntByteDoubleTuple, Int, Boolean, Double> {
