...
import io.deephaven.engine.tuple.generated.DoubleByteFloatTuple;
...
public class DoubleByteFloatColumnTupleSource extends AbstractTupleSource<DoubleByteFloatTuple> {
    ...
    @Override
    public final <ELEMENT_TYPE> void exportElement(@NotNull final DoubleByteFloatTuple tuple, final int elementIndex, @NotNull final WritableColumnSource<ELEMENT_TYPE> writableSource, final long destinationIndexKey) {
        if (elementIndex == 0) {
