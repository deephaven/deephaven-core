...
import io.deephaven.engine.tuple.generated.ObjectCharFloatTuple;
...
/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types Object, Char, and Float.
...
public class ObjectCharacterFloatColumnTupleSource extends AbstractTupleSource<ObjectCharFloatTuple> {
    ...
    public static final ThreeColumnTupleSourceFactory<ObjectCharFloatTuple, Object, Char, Float> FACTORY = new Factory();
    ...
    @Override
    public final <ELEMENT_TYPE> void exportElement(@NotNull final ObjectCharFloatTuple tuple, final int elementIndex, @NotNull final WritableColumnSource<ELEMENT_TYPE> writableSource, final long destinationIndexKey) {
        if (elementIndex == 0) {
    ...
    private static final class Factory implements ThreeColumnTupleSourceFactory<ObjectCharFloatTuple, Object, Char, Float> {
