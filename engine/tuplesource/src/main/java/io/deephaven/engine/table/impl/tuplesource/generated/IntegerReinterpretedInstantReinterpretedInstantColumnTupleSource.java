...
public class IntegerReinterpretedInstantReinterpretedInstantColumnTupleSource extends AbstractTupleSource<IntLongLongTuple> {
    ...
    public IntegerReinterpretedInstantReinterpretedInstantColumnTupleSource(
    ...
    private static final class Factory implements ThreeColumnTupleSourceFactory<IntLongLongTuple, Integer, Long, Long> {
        ...
        public TupleSource<IntLongLongTuple> create(
            ...
            return new IntegerReinterpretedInstantReinterpretedInstantColumnTupleSource(
                    columnSource1,
                    columnSource2,
                    columnSource3
            );
