...
import io.deephaven.engine.tuple.generated.IntIntObjectTuple;
import io.deephaven.util.type.TypeUtils;
import org.jetbrains.annotations.NotNull;


/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types Int, Int, and Object.
...
public class IntegerIntegerObjectColumnTupleSource extends AbstractTupleSource<IntIntObjectTuple> {
    ...
    public static final ThreeColumnTupleSourceFactory<IntIntObjectTuple, Int, Int, Object> FACTORY = new Factory();
    ...
    @Override
    public final IntIntObjectTuple createTuple(final long indexKey) {
    ...
    @Override
    public final IntIntObjectTuple createPreviousTuple(final long indexKey) {
        return new IntIntObjectTuple(
    ...
    @Override
    public final <ELEMENT_TYPE> void exportElement(@NotNull final IntIntObjectTuple tuple, final int elementIndex, @NotNull final WritableColumnSource<ELEMENT_TYPE> writableSource, final long destinationIndexKey) {
        if (elementIndex == 0) {
    ...
    @Override
    public final Object exportToExternalKey(@NotNull final IntIntObjectTuple tuple) {
        return new SmartKey(
    ...
    protected void convertChunks(@NotNull WritableChunk<? super Attributes.Values> destination, int chunkSize, Chunk<Attributes.Values> [] chunks) {
        WritableObjectChunk<IntIntObjectTuple, ? super Attributes.Values> destinationObjectChunk = destination.asWritableObjectChunk();
    ...
    private static final class Factory implements ThreeColumnTupleSourceFactory<IntIntObjectTuple, Int, Int, Object> {
