...
/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types Instant, Boolean, and Integer.
 */
@SuppressWarnings({"unused", "WeakerAccess"})
public class InstantBooleanIntegerColumnTupleSource extends AbstractTupleSource<LongByteIntTuple> {

    /** {@link ThreeColumnTupleSourceFactory} instance to create instances of {@link InstantBooleanIntegerColumnTupleSource}. **/
    public static final ThreeColumnTupleSourceFactory<LongByteIntTuple, Instant, Boolean, Integer> FACTORY = new Factory();

    private final ColumnSource<Instant> columnSource1;
    private final ColumnSource<Boolean> columnSource2;
    private final ColumnSource<Integer> columnSource3;

    public InstantBooleanIntegerColumnTupleSource(
    ...
    /** {@link ThreeColumnTupleSourceFactory} for instances of {@link InstantBooleanIntegerColumnTupleSource}. **/
    private static final class Factory implements ThreeColumnTupleSourceFactory<LongByteIntTuple, Instant, Boolean, Integer> {
        ...
        public TupleSource<LongByteIntTuple> create(
            ...
            return new InstantBooleanIntegerColumnTupleSource(
                    columnSource1,
                    columnSource2,
                    columnSource3
            );
