...
public class ReinterpretedBooleanInstantColumnTupleSource extends AbstractTupleSource<ByteLongTuple> {

    /** {@link TwoColumnTupleSourceFactory} instance to create instances of {@link ReinterpretedBooleanInstantColumnTupleSource}. **/
    ...
    public ReinterpretedBooleanInstantColumnTupleSource(
    ...
    private static final class Factory implements TwoColumnTupleSourceFactory<ByteLongTuple, Byte, Instant> {
        ...
        public TupleSource<ByteLongTuple> create(
            ...
            return new ReinterpretedBooleanInstantColumnTupleSource(
                    columnSource1,
                    columnSource2
            );
        }
