...
/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types Short, Integer, and Instant.
 */
@SuppressWarnings({"unused", "WeakerAccess"})
public class ShortIntegerInstantColumnTupleSource extends AbstractTupleSource<ShortIntLongTuple> {

    /** {@link ThreeColumnTupleSourceFactory} instance to create instances of {@link ShortIntegerInstantColumnTupleSource}. **/
    public static final ThreeColumnTupleSourceFactory<ShortIntLongTuple, Short, Integer, Instant> FACTORY = new Factory();

    private final ColumnSource<Short> columnSource1;
    private final ColumnSource<Integer> columnSource2;
    private final ColumnSource<Instant> columnSource3;

    public ShortIntegerInstantColumnTupleSource(
    ...
    /** {@link ThreeColumnTupleSourceFactory} for instances of {@link ShortIntegerInstantColumnTupleSource}. **/
    private static final class Factory implements ThreeColumnTupleSourceFactory<ShortIntLongTuple, Short, Integer, Instant> {
        ...
        public TupleSource<ShortIntLongTuple> create(
            ...
            return new ShortIntegerInstantColumnTupleSource(
                    columnSource1,
                    columnSource2,
                    columnSource3
            );
