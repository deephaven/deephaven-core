...
/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types Object, Instant, and Instant.
 */
@SuppressWarnings({"unused", "WeakerAccess"})
public class ObjectInstantInstantColumnTupleSource extends AbstractTupleSource<ObjectLongLongTuple> {

    /** {@link ThreeColumnTupleSourceFactory} instance to create instances of {@link ObjectInstantInstantColumnTupleSource}. **/
    public static final ThreeColumnTupleSourceFactory<ObjectLongLongTuple, Object, Instant, Instant> FACTORY = new Factory();

    private final ColumnSource<Object> columnSource1;
    private final ColumnSource<Instant> columnSource2;
    private final ColumnSource<Instant> columnSource3;

    public ObjectInstantInstantColumnTupleSource(
    ...
    protected void convertChunks(@NotNull WritableChunk<? super Values> destination, int chunkSize, Chunk<? extends Values> [] chunks) {
        ...
        for (int ii = 0; ii < chunkSize; ++ii) {
            destinationObjectChunk.set(ii, new ObjectLongLongTuple(chunk1.get(ii), DateTimeUtils.epochNanos(chunk2.get(ii)), DateTimeUtils.epochNanos(chunk3.get(ii))));
        }
        destinationObjectChunk.setSize(chunkSize);
    }

    /** {@link ThreeColumnTupleSourceFactory} for instances of {@link ObjectInstantInstantColumnTupleSource}. **/
    private static final class Factory implements ThreeColumnTupleSourceFactory<ObjectLongLongTuple, Object, Instant, Instant> {
        ...
        public TupleSource<ObjectLongLongTuple> create(
            ...
            return new ObjectInstantInstantColumnTupleSource(
                    columnSource1,
                    columnSource2,
                    columnSource3
            );
