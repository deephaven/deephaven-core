...
/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types Double, Byte, and Int.
...
public class DoubleReinterpretedBooleanIntegerColumnTupleSource extends AbstractTupleSource<DoubleByteIntTuple> {
    ...
    public static final ThreeColumnTupleSourceFactory<DoubleByteIntTuple, Double, Byte, Int> FACTORY = new Factory();
    ...
    private static final class Factory implements ThreeColumnTupleSourceFactory<DoubleByteIntTuple, Double, Byte, Int> {
