...
import io.deephaven.engine.tuple.generated.CharShortByteTuple;
...
/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types Char, Short, and Boolean.
...
public class CharacterShortBooleanColumnTupleSource extends AbstractTupleSource<CharShortByteTuple> {
    ...
    public static final ThreeColumnTupleSourceFactory<CharShortByteTuple, Char, Short, Boolean> FACTORY = new Factory();
    ...
    @Override
    public final <ELEMENT_TYPE> void exportElement(@NotNull final CharShortByteTuple tuple, final int elementIndex, @NotNull final WritableColumnSource<ELEMENT_TYPE> writableSource, final long destinationIndexKey) {
        if (elementIndex == 0) {
    ...
    private static final class Factory implements ThreeColumnTupleSourceFactory<CharShortByteTuple, Char, Short, Boolean> {
