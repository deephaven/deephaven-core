...
public class LongShortObjectColumnTupleSource extends AbstractTupleSource<LongShortObjectTuple> {

    /** {@link ThreeColumnTupleSourceFactory} instance to create instances of {@link LongShortObjectColumnTupleSource}. **/
    ...
    public LongShortObjectColumnTupleSource(
    ...
    @Override
    public final void exportAllTo(final Object @NotNull [] dest, @NotNull final LongShortObjectTuple tuple) {
    ...
    @Override
    public final void exportAllTo(final Object @NotNull [] dest, @NotNull final LongShortObjectTuple tuple, final int @NotNull [] map) {
    ...
    @Override
    public final void exportAllReinterpretedTo(final Object @NotNull [] dest, @NotNull final LongShortObjectTuple tuple) {
        dest[0] = TypeUtils.box(tuple.getFirstElement());
        dest[1] = TypeUtils.box(tuple.getSecondElement());
        dest[2] = tuple.getThirdElement();
    }
    ...
    @Override
    public final void exportAllReinterpretedTo(final Object @NotNull [] dest, @NotNull final LongShortObjectTuple tuple, final int @NotNull [] map) {
        dest[map[0]] = TypeUtils.box(tuple.getFirstElement());
        dest[map[1]] = TypeUtils.box(tuple.getSecondElement());
        dest[map[2]] = tuple.getThirdElement();
    }
    ...
    /** {@link ThreeColumnTupleSourceFactory} for instances of {@link LongShortObjectColumnTupleSource}. **/
    private static final class Factory implements ThreeColumnTupleSourceFactory<LongShortObjectTuple, Long, Short, Object> {
        ...
        public TupleSource<LongShortObjectTuple> create(
            ...
            return new LongShortObjectColumnTupleSource(
                    columnSource1,
                    columnSource2,
                    columnSource3
            );
