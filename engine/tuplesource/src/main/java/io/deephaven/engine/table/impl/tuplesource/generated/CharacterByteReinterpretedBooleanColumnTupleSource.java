...
import io.deephaven.engine.tuple.generated.CharByteByteTuple;
...
/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types Char, Byte, and Byte.
...
public class CharacterByteReinterpretedBooleanColumnTupleSource extends AbstractTupleSource<CharByteByteTuple> {
    ...
    public static final ThreeColumnTupleSourceFactory<CharByteByteTuple, Char, Byte, Byte> FACTORY = new Factory();
    ...
    @Override
    public final <ELEMENT_TYPE> void exportElement(@NotNull final CharByteByteTuple tuple, final int elementIndex, @NotNull final WritableColumnSource<ELEMENT_TYPE> writableSource, final long destinationIndexKey) {
        if (elementIndex == 0) {
    ...
    private static final class Factory implements ThreeColumnTupleSourceFactory<CharByteByteTuple, Char, Byte, Byte> {
