...
/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types Double, Char, and Double.
...
public class DoubleCharacterDoubleColumnTupleSource extends AbstractTupleSource<DoubleCharDoubleTuple> {
    ...
    public static final ThreeColumnTupleSourceFactory<DoubleCharDoubleTuple, Double, Char, Double> FACTORY = new Factory();
    ...
    @Override
    public final <ELEMENT_TYPE> void exportElement(@NotNull final DoubleCharDoubleTuple tuple, final int elementIndex, @NotNull final WritableColumnSource<ELEMENT_TYPE> writableSource, final long destinationIndexKey) {
        if (elementIndex == 0) {
    ...
    private static final class Factory implements ThreeColumnTupleSourceFactory<DoubleCharDoubleTuple, Double, Char, Double> {
