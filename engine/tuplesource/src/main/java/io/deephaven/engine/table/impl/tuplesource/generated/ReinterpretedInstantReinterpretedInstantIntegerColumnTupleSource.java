...
public class ReinterpretedInstantReinterpretedInstantIntegerColumnTupleSource extends AbstractTupleSource<LongLongIntTuple> {
    ...
    public ReinterpretedInstantReinterpretedInstantIntegerColumnTupleSource(
