...
import io.deephaven.engine.tuple.generated.DoubleLongFloatTuple;
...
public class DoubleReinterpretedDateTimeFloatColumnTupleSource extends AbstractTupleSource<DoubleLongFloatTuple> {
    ...
    @Override
    public final <ELEMENT_TYPE> void exportElement(@NotNull final DoubleLongFloatTuple tuple, final int elementIndex, @NotNull final WritableColumnSource<ELEMENT_TYPE> writableSource, final long destinationIndexKey) {
        if (elementIndex == 0) {
