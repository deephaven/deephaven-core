...
public class ReinterpretedInstantFloatReinterpretedBooleanColumnTupleSource extends AbstractTupleSource<LongFloatByteTuple> {
    ...
    public ReinterpretedInstantFloatReinterpretedBooleanColumnTupleSource(
    ...
    private static final class Factory implements ThreeColumnTupleSourceFactory<LongFloatByteTuple, Long, Float, Byte> {
        ...
        public TupleSource<LongFloatByteTuple> create(
            ...
            return new ReinterpretedInstantFloatReinterpretedBooleanColumnTupleSource(
                    columnSource1,
                    columnSource2,
                    columnSource3
            );
