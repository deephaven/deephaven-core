...
/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types Object, Boolean, and Int.
...
public class ObjectBooleanIntegerColumnTupleSource extends AbstractTupleSource<ObjectByteIntTuple> {
    ...
    public static final ThreeColumnTupleSourceFactory<ObjectByteIntTuple, Object, Boolean, Int> FACTORY = new Factory();
    ...
    @Override
    public final <ELEMENT_TYPE> void exportElement(@NotNull final ObjectByteIntTuple tuple, final int elementIndex, @NotNull final WritableColumnSource<ELEMENT_TYPE> writableSource, final long destinationIndexKey) {
        if (elementIndex == 0) {
    ...
    private static final class Factory implements ThreeColumnTupleSourceFactory<ObjectByteIntTuple, Object, Boolean, Int> {
