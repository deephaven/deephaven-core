...
public class ShortObjectReinterpretedBooleanColumnTupleSource extends AbstractTupleSource<ShortObjectByteTuple> {
    ...
    @Override
    public final ShortObjectByteTuple createTuple(final long indexKey) {
    ...
    @Override
    public final ShortObjectByteTuple createPreviousTuple(final long indexKey) {
        return new ShortObjectByteTuple(
    ...
    @Override
    public final <ELEMENT_TYPE> void exportElement(@NotNull final ShortObjectByteTuple tuple, final int elementIndex, @NotNull final WritableSource<ELEMENT_TYPE> writableSource, final long destinationIndexKey) {
        if (elementIndex == 0) {
    ...
    protected void convertChunks(@NotNull WritableChunk<? super Attributes.Values> destination, int chunkSize, Chunk<Attributes.Values> [] chunks) {
        WritableObjectChunk<ShortObjectByteTuple, ? super Attributes.Values> destinationObjectChunk = destination.asWritableObjectChunk();
