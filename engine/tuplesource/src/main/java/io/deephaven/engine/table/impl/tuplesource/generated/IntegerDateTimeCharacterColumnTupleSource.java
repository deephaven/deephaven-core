...
/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types Int, DateTime, and Char.
...
public class IntegerDateTimeCharacterColumnTupleSource extends AbstractTupleSource<IntLongCharTuple> {
    ...
    public static final ThreeColumnTupleSourceFactory<IntLongCharTuple, Int, DateTime, Char> FACTORY = new Factory();
    ...
    private static final class Factory implements ThreeColumnTupleSourceFactory<IntLongCharTuple, Int, DateTime, Char> {
