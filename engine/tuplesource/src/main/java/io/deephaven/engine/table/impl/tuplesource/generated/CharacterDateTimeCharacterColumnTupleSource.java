...
/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types Character, DateTime, and Character.
...
public class CharacterDateTimeCharacterColumnTupleSource extends AbstractTupleSource<CharLongCharTuple> {
    ...
    public static final ThreeColumnTupleSourceFactory<CharLongCharTuple, Character, DateTime, Character> FACTORY = new Factory();
    ...
    private static final class Factory implements ThreeColumnTupleSourceFactory<CharLongCharTuple, Character, DateTime, Character> {
