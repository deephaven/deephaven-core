...
/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types Char, Boolean, and DateTime.
...
public class CharacterBooleanDateTimeColumnTupleSource extends AbstractTupleSource<CharByteLongTuple> {
    ...
    public static final ThreeColumnTupleSourceFactory<CharByteLongTuple, Char, Boolean, DateTime> FACTORY = new Factory();
    ...
    private static final class Factory implements ThreeColumnTupleSourceFactory<CharByteLongTuple, Char, Boolean, DateTime> {
