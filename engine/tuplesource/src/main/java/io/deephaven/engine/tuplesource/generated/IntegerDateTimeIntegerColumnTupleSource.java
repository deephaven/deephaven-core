...
import io.deephaven.engine.tuple.generated.IntLongIntTuple;
...
/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types Int, DateTime, and Int.
...
public class IntegerDateTimeIntegerColumnTupleSource extends AbstractTupleSource<IntLongIntTuple> {
    ...
    public static final ThreeColumnTupleSourceFactory<IntLongIntTuple, Int, DateTime, Int> FACTORY = new Factory();
    ...
    @Override
    public final <ELEMENT_TYPE> void exportElement(@NotNull final IntLongIntTuple tuple, final int elementIndex, @NotNull final WritableColumnSource<ELEMENT_TYPE> writableSource, final long destinationIndexKey) {
        if (elementIndex == 0) {
    ...
    private static final class Factory implements ThreeColumnTupleSourceFactory<IntLongIntTuple, Int, DateTime, Int> {
