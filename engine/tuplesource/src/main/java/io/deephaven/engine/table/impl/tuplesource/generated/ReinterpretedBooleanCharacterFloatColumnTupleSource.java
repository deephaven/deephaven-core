...
import io.deephaven.tuple.generated.ByteCharFloatTuple;
...
public class ReinterpretedBooleanCharacterFloatColumnTupleSource extends AbstractTupleSource<ByteCharFloatTuple> {
    ...
    @Override
    public final ByteCharFloatTuple createTuple(final long rowKey) {
    ...
    @Override
    public final ByteCharFloatTuple createPreviousTuple(final long rowKey) {
        return new ByteCharFloatTuple(
    ...
    @Override
    public final <ELEMENT_TYPE> void exportElement(@NotNull final ByteCharFloatTuple tuple, final int elementIndex, @NotNull final WritableColumnSource<ELEMENT_TYPE> writableSource, final long destinationRowKey) {
        if (elementIndex == 0) {
    ...
    @Override
    public final void exportAllTo(final Object @NotNull [] dest, @NotNull final ByteCharFloatTuple tuple) {
    ...
    @Override
    public final void exportAllTo(final Object @NotNull [] dest, @NotNull final ByteCharFloatTuple tuple, final int @NotNull [] map) {
    ...
    @Override
    public final void exportAllReinterpretedTo(final Object @NotNull [] dest, @NotNull final ByteCharFloatTuple tuple) {
    ...
    @Override
    public final void exportAllReinterpretedTo(final Object @NotNull [] dest, @NotNull final ByteCharFloatTuple tuple, final int @NotNull [] map) {
    ...
    protected void convertChunks(@NotNull WritableChunk<? super Values> destination, int chunkSize, Chunk<? extends Values> [] chunks) {
        WritableObjectChunk<ByteCharFloatTuple, ? super Values> destinationObjectChunk = destination.asWritableObjectChunk();
