...
/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types Boolean, Short, and Int.
...
public class BooleanShortIntegerColumnTupleSource extends AbstractTupleSource<ByteShortIntTuple> {
    ...
    public static final ThreeColumnTupleSourceFactory<ByteShortIntTuple, Boolean, Short, Int> FACTORY = new Factory();
    ...
    @Override
    public final <ELEMENT_TYPE> void exportElement(@NotNull final ByteShortIntTuple tuple, final int elementIndex, @NotNull final WritableColumnSource<ELEMENT_TYPE> writableSource, final long destinationIndexKey) {
        if (elementIndex == 0) {
    ...
    private static final class Factory implements ThreeColumnTupleSourceFactory<ByteShortIntTuple, Boolean, Short, Int> {
