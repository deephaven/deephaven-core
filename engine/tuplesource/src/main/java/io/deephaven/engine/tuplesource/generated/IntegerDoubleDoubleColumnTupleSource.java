...
/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types Int, Double, and Double.
...
public class IntegerDoubleDoubleColumnTupleSource extends AbstractTupleSource<IntDoubleDoubleTuple> {
    ...
    public static final ThreeColumnTupleSourceFactory<IntDoubleDoubleTuple, Int, Double, Double> FACTORY = new Factory();
    ...
    private static final class Factory implements ThreeColumnTupleSourceFactory<IntDoubleDoubleTuple, Int, Double, Double> {
