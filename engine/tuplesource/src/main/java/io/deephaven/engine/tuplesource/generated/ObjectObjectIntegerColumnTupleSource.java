...
import io.deephaven.engine.tuple.generated.ObjectObjectIntTuple;
...
/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types Object, Object, and Int.
...
public class ObjectObjectIntegerColumnTupleSource extends AbstractTupleSource<ObjectObjectIntTuple> {
    ...
    public static final ThreeColumnTupleSourceFactory<ObjectObjectIntTuple, Object, Object, Int> FACTORY = new Factory();
    ...
    @Override
    public final ObjectObjectIntTuple createTuple(final long indexKey) {
    ...
    @Override
    public final ObjectObjectIntTuple createPreviousTuple(final long indexKey) {
        return new ObjectObjectIntTuple(
    ...
    @Override
    public final <ELEMENT_TYPE> void exportElement(@NotNull final ObjectObjectIntTuple tuple, final int elementIndex, @NotNull final WritableColumnSource<ELEMENT_TYPE> writableSource, final long destinationIndexKey) {
        if (elementIndex == 0) {
    ...
    @Override
    public final Object exportToExternalKey(@NotNull final ObjectObjectIntTuple tuple) {
        return new SmartKey(
    ...
    protected void convertChunks(@NotNull WritableChunk<? super Attributes.Values> destination, int chunkSize, Chunk<Attributes.Values> [] chunks) {
        WritableObjectChunk<ObjectObjectIntTuple, ? super Attributes.Values> destinationObjectChunk = destination.asWritableObjectChunk();
    ...
    private static final class Factory implements ThreeColumnTupleSourceFactory<ObjectObjectIntTuple, Object, Object, Int> {
