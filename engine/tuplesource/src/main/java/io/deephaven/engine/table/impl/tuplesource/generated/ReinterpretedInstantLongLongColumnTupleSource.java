...
public class ReinterpretedInstantLongLongColumnTupleSource extends AbstractTupleSource<LongLongLongTuple> {
    ...
    public ReinterpretedInstantLongLongColumnTupleSource(
    ...
    private static final class Factory implements ThreeColumnTupleSourceFactory<LongLongLongTuple, Long, Long, Long> {
        ...
        public TupleSource<LongLongLongTuple> create(
            ...
            return new ReinterpretedInstantLongLongColumnTupleSource(
                    columnSource1,
                    columnSource2,
                    columnSource3
            );
