...
public class ReinterpretedInstantFloatFloatColumnTupleSource extends AbstractTupleSource<LongFloatFloatTuple> {

    /** {@link ThreeColumnTupleSourceFactory} instance to create instances of {@link ReinterpretedInstantFloatFloatColumnTupleSource}. **/
    ...
    public ReinterpretedInstantFloatFloatColumnTupleSource(
    ...
    @Override
    public final void exportAllTo(final Object @NotNull [] dest, @NotNull final LongFloatFloatTuple tuple) {
    ...
    @Override
    public final void exportAllTo(final Object @NotNull [] dest, @NotNull final LongFloatFloatTuple tuple, final int @NotNull [] map) {
    ...
    @Override
    public final void exportAllReinterpretedTo(final Object @NotNull [] dest, @NotNull final LongFloatFloatTuple tuple) {
    ...
    @Override
    public final void exportAllReinterpretedTo(final Object @NotNull [] dest, @NotNull final LongFloatFloatTuple tuple, final int @NotNull [] map) {
    ...
    /** {@link ThreeColumnTupleSourceFactory} for instances of {@link ReinterpretedInstantFloatFloatColumnTupleSource}. **/
    private static final class Factory implements ThreeColumnTupleSourceFactory<LongFloatFloatTuple, Long, Float, Float> {
        ...
        public TupleSource<LongFloatFloatTuple> create(
            ...
            return new ReinterpretedInstantFloatFloatColumnTupleSource(
                    columnSource1,
                    columnSource2,
                    columnSource3
            );
