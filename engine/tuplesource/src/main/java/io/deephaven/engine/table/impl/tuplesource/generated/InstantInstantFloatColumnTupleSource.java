...
/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types Instant, Instant, and Float.
 */
@SuppressWarnings({"unused", "WeakerAccess"})
public class InstantInstantFloatColumnTupleSource extends AbstractTupleSource<LongLongFloatTuple> {

    /** {@link ThreeColumnTupleSourceFactory} instance to create instances of {@link InstantInstantFloatColumnTupleSource}. **/
    public static final ThreeColumnTupleSourceFactory<LongLongFloatTuple, Instant, Instant, Float> FACTORY = new Factory();

    private final ColumnSource<Instant> columnSource1;
    private final ColumnSource<Instant> columnSource2;
    private final ColumnSource<Float> columnSource3;

    public InstantInstantFloatColumnTupleSource(
    ...
    protected void convertChunks(@NotNull WritableChunk<? super Values> destination, int chunkSize, Chunk<? extends Values> [] chunks) {
        ...
        for (int ii = 0; ii < chunkSize; ++ii) {
            destinationObjectChunk.set(ii, new LongLongFloatTuple(DateTimeUtils.epochNanos(chunk1.get(ii)), DateTimeUtils.epochNanos(chunk2.get(ii)), chunk3.get(ii)));
        }
        destinationObjectChunk.setSize(chunkSize);
    }

    /** {@link ThreeColumnTupleSourceFactory} for instances of {@link InstantInstantFloatColumnTupleSource}. **/
    private static final class Factory implements ThreeColumnTupleSourceFactory<LongLongFloatTuple, Instant, Instant, Float> {
        ...
        public TupleSource<LongLongFloatTuple> create(
            ...
            return new InstantInstantFloatColumnTupleSource(
                    columnSource1,
                    columnSource2,
                    columnSource3
            );
