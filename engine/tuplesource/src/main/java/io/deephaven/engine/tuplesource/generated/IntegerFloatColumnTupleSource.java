...
/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types Int and Float.
...
public class IntegerFloatColumnTupleSource extends AbstractTupleSource<IntFloatTuple> {
    ...
    public static final TwoColumnTupleSourceFactory<IntFloatTuple, Int, Float> FACTORY = new Factory();
    ...
    private static final class Factory implements TwoColumnTupleSourceFactory<IntFloatTuple, Int, Float> {
