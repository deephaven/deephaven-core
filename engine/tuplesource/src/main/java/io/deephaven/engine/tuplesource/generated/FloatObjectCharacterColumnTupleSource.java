...
/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types Float, Object, and Char.
...
public class FloatObjectCharacterColumnTupleSource extends AbstractTupleSource<FloatObjectCharTuple> {
    ...
    public static final ThreeColumnTupleSourceFactory<FloatObjectCharTuple, Float, Object, Char> FACTORY = new Factory();
    ...
    @Override
    public final <ELEMENT_TYPE> void exportElement(@NotNull final FloatObjectCharTuple tuple, final int elementIndex, @NotNull final WritableColumnSource<ELEMENT_TYPE> writableSource, final long destinationIndexKey) {
        if (elementIndex == 0) {
    ...
    private static final class Factory implements ThreeColumnTupleSourceFactory<FloatObjectCharTuple, Float, Object, Char> {
