...
/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types Char, Char, and Int.
...
public class CharacterCharacterIntegerColumnTupleSource extends AbstractTupleSource<CharCharIntTuple> {
    ...
    public static final ThreeColumnTupleSourceFactory<CharCharIntTuple, Char, Char, Int> FACTORY = new Factory();
    ...
    @Override
    public final <ELEMENT_TYPE> void exportElement(@NotNull final CharCharIntTuple tuple, final int elementIndex, @NotNull final WritableColumnSource<ELEMENT_TYPE> writableSource, final long destinationIndexKey) {
        if (elementIndex == 0) {
    ...
    private static final class Factory implements ThreeColumnTupleSourceFactory<CharCharIntTuple, Char, Char, Int> {
