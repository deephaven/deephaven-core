...
import io.deephaven.engine.tuple.generated.ObjectCharObjectTuple;
...
/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types Object, Char, and Object.
...
public class ObjectCharacterObjectColumnTupleSource extends AbstractTupleSource<ObjectCharObjectTuple> {
    ...
    public static final ThreeColumnTupleSourceFactory<ObjectCharObjectTuple, Object, Char, Object> FACTORY = new Factory();
    ...
    @Override
    public final ObjectCharObjectTuple createTuple(final long indexKey) {
    ...
    @Override
    public final ObjectCharObjectTuple createPreviousTuple(final long indexKey) {
        return new ObjectCharObjectTuple(
    ...
    @Override
    public final <ELEMENT_TYPE> void exportElement(@NotNull final ObjectCharObjectTuple tuple, final int elementIndex, @NotNull final WritableColumnSource<ELEMENT_TYPE> writableSource, final long destinationIndexKey) {
        if (elementIndex == 0) {
    ...
    @Override
    public final Object exportToExternalKey(@NotNull final ObjectCharObjectTuple tuple) {
        return new SmartKey(
    ...
    protected void convertChunks(@NotNull WritableChunk<? super Attributes.Values> destination, int chunkSize, Chunk<Attributes.Values> [] chunks) {
        WritableObjectChunk<ObjectCharObjectTuple, ? super Attributes.Values> destinationObjectChunk = destination.asWritableObjectChunk();
    ...
    private static final class Factory implements ThreeColumnTupleSourceFactory<ObjectCharObjectTuple, Object, Char, Object> {
