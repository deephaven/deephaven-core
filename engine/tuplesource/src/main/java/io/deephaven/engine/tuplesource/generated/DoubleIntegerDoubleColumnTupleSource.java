...
import io.deephaven.engine.tuple.generated.DoubleIntDoubleTuple;
...
/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types Double, Int, and Double.
...
public class DoubleIntegerDoubleColumnTupleSource extends AbstractTupleSource<DoubleIntDoubleTuple> {
    ...
    public static final ThreeColumnTupleSourceFactory<DoubleIntDoubleTuple, Double, Int, Double> FACTORY = new Factory();
    ...
    @Override
    public final <ELEMENT_TYPE> void exportElement(@NotNull final DoubleIntDoubleTuple tuple, final int elementIndex, @NotNull final WritableColumnSource<ELEMENT_TYPE> writableSource, final long destinationIndexKey) {
        if (elementIndex == 0) {
    ...
    private static final class Factory implements ThreeColumnTupleSourceFactory<DoubleIntDoubleTuple, Double, Int, Double> {
