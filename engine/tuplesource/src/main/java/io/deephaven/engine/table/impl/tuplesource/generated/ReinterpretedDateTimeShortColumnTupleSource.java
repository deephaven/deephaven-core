...
import io.deephaven.engine.tuple.generated.LongShortTuple;
...
public class ReinterpretedDateTimeShortColumnTupleSource extends AbstractTupleSource<LongShortTuple> {

    /** {@link TwoColumnTupleSourceFactory} instance to create instances of {@link ReinterpretedDateTimeShortColumnTupleSource}. **/
    public static final TwoColumnTupleSourceFactory<LongShortTuple, Long, Short> FACTORY = new Factory();

    private final ColumnSource<Long> columnSource1;
    private final ColumnSource<Short> columnSource2;

    public ReinterpretedDateTimeShortColumnTupleSource(
    ...
    @Override
    public final <ELEMENT_TYPE> void exportElement(@NotNull final LongShortTuple tuple, final int elementIndex, @NotNull final WritableColumnSource<ELEMENT_TYPE> writableSource, final long destinationIndexKey) {
        if (elementIndex == 0) {
    ...
    /** {@link TwoColumnTupleSourceFactory} for instances of {@link ReinterpretedDateTimeShortColumnTupleSource}. **/
    private static final class Factory implements TwoColumnTupleSourceFactory<LongShortTuple, Long, Short> {
        ...
        public TupleSource<LongShortTuple> create(
            ...
            return new ReinterpretedDateTimeShortColumnTupleSource(
                    columnSource1,
                    columnSource2
            );
        }
