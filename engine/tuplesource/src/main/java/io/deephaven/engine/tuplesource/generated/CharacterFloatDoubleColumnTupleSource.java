...
/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types Char, Float, and Double.
...
public class CharacterFloatDoubleColumnTupleSource extends AbstractTupleSource<CharFloatDoubleTuple> {
    ...
    public static final ThreeColumnTupleSourceFactory<CharFloatDoubleTuple, Char, Float, Double> FACTORY = new Factory();
    ...
    @Override
    public final CharFloatDoubleTuple createTuple(final long indexKey) {
    ...
    @Override
    public final CharFloatDoubleTuple createPreviousTuple(final long indexKey) {
        return new CharFloatDoubleTuple(
    ...
    @Override
    public final <ELEMENT_TYPE> void exportElement(@NotNull final CharFloatDoubleTuple tuple, final int elementIndex, @NotNull final WritableSource<ELEMENT_TYPE> writableSource, final long destinationIndexKey) {
        if (elementIndex == 0) {
    ...
    protected void convertChunks(@NotNull WritableChunk<? super Attributes.Values> destination, int chunkSize, Chunk<Attributes.Values> [] chunks) {
        WritableObjectChunk<CharFloatDoubleTuple, ? super Attributes.Values> destinationObjectChunk = destination.asWritableObjectChunk();
    ...
    private static final class Factory implements ThreeColumnTupleSourceFactory<CharFloatDoubleTuple, Char, Float, Double> {
