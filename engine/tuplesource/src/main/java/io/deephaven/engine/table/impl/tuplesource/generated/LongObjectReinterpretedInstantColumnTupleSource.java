...
public class LongObjectReinterpretedInstantColumnTupleSource extends AbstractTupleSource<LongObjectLongTuple> {
    ...
    private static final class Factory implements ThreeColumnTupleSourceFactory<LongObjectLongTuple, Long, Object, Long> {
        ...
        public TupleSource<LongObjectLongTuple> create(
            ...
            return new LongObjectReinterpretedInstantColumnTupleSource(
                    columnSource1,
                    columnSource2,
                    columnSource3
            );
