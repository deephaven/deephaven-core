...
/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types Byte, Instant, and Float.
 */
@SuppressWarnings({"unused", "WeakerAccess"})
public class ReinterpretedBooleanInstantFloatColumnTupleSource extends AbstractTupleSource<ByteLongFloatTuple> {

    /** {@link ThreeColumnTupleSourceFactory} instance to create instances of {@link ReinterpretedBooleanInstantFloatColumnTupleSource}. **/
    public static final ThreeColumnTupleSourceFactory<ByteLongFloatTuple, Byte, Instant, Float> FACTORY = new Factory();

    private final ColumnSource<Byte> columnSource1;
    private final ColumnSource<Instant> columnSource2;
    private final ColumnSource<Float> columnSource3;

    public ReinterpretedBooleanInstantFloatColumnTupleSource(
    ...
    protected void convertChunks(@NotNull WritableChunk<? super Values> destination, int chunkSize, Chunk<? extends Values> [] chunks) {
        ...
        for (int ii = 0; ii < chunkSize; ++ii) {
            destinationObjectChunk.set(ii, new ByteLongFloatTuple(chunk1.get(ii), DateTimeUtils.epochNanos(chunk2.get(ii)), chunk3.get(ii)));
        }
        destinationObjectChunk.setSize(chunkSize);
    }

    /** {@link ThreeColumnTupleSourceFactory} for instances of {@link ReinterpretedBooleanInstantFloatColumnTupleSource}. **/
    private static final class Factory implements ThreeColumnTupleSourceFactory<ByteLongFloatTuple, Byte, Instant, Float> {
        ...
        public TupleSource<ByteLongFloatTuple> create(
            ...
            return new ReinterpretedBooleanInstantFloatColumnTupleSource(
                    columnSource1,
                    columnSource2,
                    columnSource3
            );
