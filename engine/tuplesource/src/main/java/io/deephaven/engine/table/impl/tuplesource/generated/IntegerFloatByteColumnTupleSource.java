...
/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types Int, Float, and Byte.
...
public class IntegerFloatByteColumnTupleSource extends AbstractTupleSource<IntFloatByteTuple> {
    ...
    public static final ThreeColumnTupleSourceFactory<IntFloatByteTuple, Int, Float, Byte> FACTORY = new Factory();
    ...
    private static final class Factory implements ThreeColumnTupleSourceFactory<IntFloatByteTuple, Int, Float, Byte> {
