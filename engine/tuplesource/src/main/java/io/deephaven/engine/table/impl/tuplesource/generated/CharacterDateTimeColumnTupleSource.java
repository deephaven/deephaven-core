...
/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types Char and DateTime.
...
public class CharacterDateTimeColumnTupleSource extends AbstractTupleSource<CharLongTuple> {
    ...
    public static final TwoColumnTupleSourceFactory<CharLongTuple, Char, DateTime> FACTORY = new Factory();
    ...
    private static final class Factory implements TwoColumnTupleSourceFactory<CharLongTuple, Char, DateTime> {
