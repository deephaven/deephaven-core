...
import io.deephaven.engine.tuple.generated.FloatDoubleCharTuple;
...
/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types Float, Double, and Char.
...
public class FloatDoubleCharacterColumnTupleSource extends AbstractTupleSource<FloatDoubleCharTuple> {
    ...
    public static final ThreeColumnTupleSourceFactory<FloatDoubleCharTuple, Float, Double, Char> FACTORY = new Factory();
    ...
    @Override
    public final FloatDoubleCharTuple createTuple(final long indexKey) {
    ...
    @Override
    public final FloatDoubleCharTuple createPreviousTuple(final long indexKey) {
        return new FloatDoubleCharTuple(
    ...
    @Override
    public final <ELEMENT_TYPE> void exportElement(@NotNull final FloatDoubleCharTuple tuple, final int elementIndex, @NotNull final WritableColumnSource<ELEMENT_TYPE> writableSource, final long destinationIndexKey) {
        if (elementIndex == 0) {
    ...
    @Override
    public final Object exportToExternalKey(@NotNull final FloatDoubleCharTuple tuple) {
        return new SmartKey(
    ...
    protected void convertChunks(@NotNull WritableChunk<? super Attributes.Values> destination, int chunkSize, Chunk<Attributes.Values> [] chunks) {
        WritableObjectChunk<FloatDoubleCharTuple, ? super Attributes.Values> destinationObjectChunk = destination.asWritableObjectChunk();
    ...
    private static final class Factory implements ThreeColumnTupleSourceFactory<FloatDoubleCharTuple, Float, Double, Char> {
