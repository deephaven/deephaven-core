...
/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types Int, DateTime, and DateTime.
...
public class IntegerDateTimeDateTimeColumnTupleSource extends AbstractTupleSource<IntLongLongTuple> {
    ...
    public static final ThreeColumnTupleSourceFactory<IntLongLongTuple, Int, DateTime, DateTime> FACTORY = new Factory();
    ...
    private static final class Factory implements ThreeColumnTupleSourceFactory<IntLongLongTuple, Int, DateTime, DateTime> {
