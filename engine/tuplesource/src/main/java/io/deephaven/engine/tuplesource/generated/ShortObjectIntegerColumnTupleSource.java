...
/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types Short, Object, and Int.
...
public class ShortObjectIntegerColumnTupleSource extends AbstractTupleSource<ShortObjectIntTuple> {
    ...
    public static final ThreeColumnTupleSourceFactory<ShortObjectIntTuple, Short, Object, Int> FACTORY = new Factory();
    ...
    @Override
    public final ShortObjectIntTuple createTuple(final long indexKey) {
    ...
    @Override
    public final ShortObjectIntTuple createPreviousTuple(final long indexKey) {
        return new ShortObjectIntTuple(
    ...
    @Override
    public final <ELEMENT_TYPE> void exportElement(@NotNull final ShortObjectIntTuple tuple, final int elementIndex, @NotNull final WritableColumnSource<ELEMENT_TYPE> writableSource, final long destinationIndexKey) {
        if (elementIndex == 0) {
    ...
    protected void convertChunks(@NotNull WritableChunk<? super Attributes.Values> destination, int chunkSize, Chunk<Attributes.Values> [] chunks) {
        WritableObjectChunk<ShortObjectIntTuple, ? super Attributes.Values> destinationObjectChunk = destination.asWritableObjectChunk();
    ...
    private static final class Factory implements ThreeColumnTupleSourceFactory<ShortObjectIntTuple, Short, Object, Int> {
