...
/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types Byte, Float, and Int.
...
public class ByteFloatIntegerColumnTupleSource extends AbstractTupleSource<ByteFloatIntTuple> {
    ...
    public static final ThreeColumnTupleSourceFactory<ByteFloatIntTuple, Byte, Float, Int> FACTORY = new Factory();
    ...
    private static final class Factory implements ThreeColumnTupleSourceFactory<ByteFloatIntTuple, Byte, Float, Int> {
