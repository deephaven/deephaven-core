...
/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types DateTime, Float, and Char.
...
public class DateTimeFloatCharacterColumnTupleSource extends AbstractTupleSource<LongFloatCharTuple> {
    ...
    public static final ThreeColumnTupleSourceFactory<LongFloatCharTuple, DateTime, Float, Char> FACTORY = new Factory();
    ...
    private static final class Factory implements ThreeColumnTupleSourceFactory<LongFloatCharTuple, DateTime, Float, Char> {
