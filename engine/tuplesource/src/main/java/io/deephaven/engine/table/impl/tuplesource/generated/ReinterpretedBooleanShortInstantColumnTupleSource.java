...
/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types Byte, Short, and Instant.
 */
@SuppressWarnings({"unused", "WeakerAccess"})
public class ReinterpretedBooleanShortInstantColumnTupleSource extends AbstractTupleSource<ByteShortLongTuple> {

    /** {@link ThreeColumnTupleSourceFactory} instance to create instances of {@link ReinterpretedBooleanShortInstantColumnTupleSource}. **/
    public static final ThreeColumnTupleSourceFactory<ByteShortLongTuple, Byte, Short, Instant> FACTORY = new Factory();

    private final ColumnSource<Byte> columnSource1;
    private final ColumnSource<Short> columnSource2;
    private final ColumnSource<Instant> columnSource3;

    public ReinterpretedBooleanShortInstantColumnTupleSource(
    ...
    /** {@link ThreeColumnTupleSourceFactory} for instances of {@link ReinterpretedBooleanShortInstantColumnTupleSource}. **/
    private static final class Factory implements ThreeColumnTupleSourceFactory<ByteShortLongTuple, Byte, Short, Instant> {
        ...
        public TupleSource<ByteShortLongTuple> create(
            ...
            return new ReinterpretedBooleanShortInstantColumnTupleSource(
                    columnSource1,
                    columnSource2,
                    columnSource3
            );
