...
/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types Short, Instant, and Character.
 */
@SuppressWarnings({"unused", "WeakerAccess"})
public class ShortInstantCharacterColumnTupleSource extends AbstractTupleSource<ShortLongCharTuple> {

    /** {@link ThreeColumnTupleSourceFactory} instance to create instances of {@link ShortInstantCharacterColumnTupleSource}. **/
    public static final ThreeColumnTupleSourceFactory<ShortLongCharTuple, Short, Instant, Character> FACTORY = new Factory();

    private final ColumnSource<Short> columnSource1;
    private final ColumnSource<Instant> columnSource2;
    private final ColumnSource<Character> columnSource3;

    public ShortInstantCharacterColumnTupleSource(
    ...
    /** {@link ThreeColumnTupleSourceFactory} for instances of {@link ShortInstantCharacterColumnTupleSource}. **/
    private static final class Factory implements ThreeColumnTupleSourceFactory<ShortLongCharTuple, Short, Instant, Character> {
        ...
        public TupleSource<ShortLongCharTuple> create(
            ...
            return new ShortInstantCharacterColumnTupleSource(
                    columnSource1,
                    columnSource2,
                    columnSource3
            );
