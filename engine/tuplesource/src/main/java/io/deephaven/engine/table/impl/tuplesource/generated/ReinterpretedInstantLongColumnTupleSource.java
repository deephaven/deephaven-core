...
public class ReinterpretedInstantLongColumnTupleSource extends AbstractTupleSource<LongLongTuple> {
    ...
    public ReinterpretedInstantLongColumnTupleSource(
    ...
    private static final class Factory implements TwoColumnTupleSourceFactory<LongLongTuple, Long, Long> {
        ...
        public TupleSource<LongLongTuple> create(
            ...
            return new ReinterpretedInstantLongColumnTupleSource(
                    columnSource1,
                    columnSource2
            );
        }
