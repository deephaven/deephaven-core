...
/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types Int, Float, and DateTime.
...
public class IntegerFloatDateTimeColumnTupleSource extends AbstractTupleSource<IntFloatLongTuple> {
    ...
    public static final ThreeColumnTupleSourceFactory<IntFloatLongTuple, Int, Float, DateTime> FACTORY = new Factory();
    ...
    private static final class Factory implements ThreeColumnTupleSourceFactory<IntFloatLongTuple, Int, Float, DateTime> {
