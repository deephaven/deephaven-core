...
import io.deephaven.engine.tuple.generated.IntCharObjectTuple;
...
/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types Int, Char, and Object.
...
public class IntegerCharacterObjectColumnTupleSource extends AbstractTupleSource<IntCharObjectTuple> {
    ...
    public static final ThreeColumnTupleSourceFactory<IntCharObjectTuple, Int, Char, Object> FACTORY = new Factory();
    ...
    @Override
    public final <ELEMENT_TYPE> void exportElement(@NotNull final IntCharObjectTuple tuple, final int elementIndex, @NotNull final WritableColumnSource<ELEMENT_TYPE> writableSource, final long destinationIndexKey) {
        if (elementIndex == 0) {
    ...
    private static final class Factory implements ThreeColumnTupleSourceFactory<IntCharObjectTuple, Int, Char, Object> {
