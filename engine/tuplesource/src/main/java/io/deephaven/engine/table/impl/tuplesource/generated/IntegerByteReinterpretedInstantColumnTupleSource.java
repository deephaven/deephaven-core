...
public class IntegerByteReinterpretedInstantColumnTupleSource extends AbstractTupleSource<IntByteLongTuple> {
    ...
    public IntegerByteReinterpretedInstantColumnTupleSource(
    ...
    private static final class Factory implements ThreeColumnTupleSourceFactory<IntByteLongTuple, Integer, Byte, Long> {
        ...
        public TupleSource<IntByteLongTuple> create(
            ...
            return new IntegerByteReinterpretedInstantColumnTupleSource(
                    columnSource1,
                    columnSource2,
                    columnSource3
            );
