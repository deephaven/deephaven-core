...
/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types Byte, Short, and Char.
...
public class ByteShortCharacterColumnTupleSource extends AbstractTupleSource<ByteShortCharTuple> {
    ...
    public static final ThreeColumnTupleSourceFactory<ByteShortCharTuple, Byte, Short, Char> FACTORY = new Factory();
    ...
    @Override
    public final <ELEMENT_TYPE> void exportElement(@NotNull final ByteShortCharTuple tuple, final int elementIndex, @NotNull final WritableColumnSource<ELEMENT_TYPE> writableSource, final long destinationIndexKey) {
        if (elementIndex == 0) {
    ...
    private static final class Factory implements ThreeColumnTupleSourceFactory<ByteShortCharTuple, Byte, Short, Char> {
