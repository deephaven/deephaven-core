...
import io.deephaven.engine.tuple.generated.IntObjectFloatTuple;
...
/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types Int, Object, and Float.
...
public class IntegerObjectFloatColumnTupleSource extends AbstractTupleSource<IntObjectFloatTuple> {
    ...
    public static final ThreeColumnTupleSourceFactory<IntObjectFloatTuple, Int, Object, Float> FACTORY = new Factory();
    ...
    @Override
    public final <ELEMENT_TYPE> void exportElement(@NotNull final IntObjectFloatTuple tuple, final int elementIndex, @NotNull final WritableColumnSource<ELEMENT_TYPE> writableSource, final long destinationIndexKey) {
        if (elementIndex == 0) {
    ...
    private static final class Factory implements ThreeColumnTupleSourceFactory<IntObjectFloatTuple, Int, Object, Float> {
