...
import io.deephaven.engine.tuple.generated.IntShortDoubleTuple;
import io.deephaven.util.type.TypeUtils;
import org.jetbrains.annotations.NotNull;


/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types Int, Short, and Double.
...
public class IntegerShortDoubleColumnTupleSource extends AbstractTupleSource<IntShortDoubleTuple> {
    ...
    public static final ThreeColumnTupleSourceFactory<IntShortDoubleTuple, Int, Short, Double> FACTORY = new Factory();
    ...
    @Override
    public final IntShortDoubleTuple createTuple(final long indexKey) {
    ...
    @Override
    public final IntShortDoubleTuple createPreviousTuple(final long indexKey) {
        return new IntShortDoubleTuple(
    ...
    @Override
    public final <ELEMENT_TYPE> void exportElement(@NotNull final IntShortDoubleTuple tuple, final int elementIndex, @NotNull final WritableColumnSource<ELEMENT_TYPE> writableSource, final long destinationIndexKey) {
        if (elementIndex == 0) {
    ...
    protected void convertChunks(@NotNull WritableChunk<? super Attributes.Values> destination, int chunkSize, Chunk<Attributes.Values> [] chunks) {
        WritableObjectChunk<IntShortDoubleTuple, ? super Attributes.Values> destinationObjectChunk = destination.asWritableObjectChunk();
    ...
    private static final class Factory implements ThreeColumnTupleSourceFactory<IntShortDoubleTuple, Int, Short, Double> {
