...
/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types Instant and Character.
 */
@SuppressWarnings({"unused", "WeakerAccess"})
public class InstantCharacterColumnTupleSource extends AbstractTupleSource<LongCharTuple> {

    /** {@link TwoColumnTupleSourceFactory} instance to create instances of {@link InstantCharacterColumnTupleSource}. **/
    public static final TwoColumnTupleSourceFactory<LongCharTuple, Instant, Character> FACTORY = new Factory();

    private final ColumnSource<Instant> columnSource1;
    private final ColumnSource<Character> columnSource2;

    public InstantCharacterColumnTupleSource(
    ...
    protected void convertChunks(@NotNull WritableChunk<? super Values> destination, int chunkSize, Chunk<? extends Values> [] chunks) {
        ...
        for (int ii = 0; ii < chunkSize; ++ii) {
            destinationObjectChunk.set(ii, new LongCharTuple(DateTimeUtils.epochNanos(chunk1.get(ii)), chunk2.get(ii)));
        }
    ...
    /** {@link TwoColumnTupleSourceFactory} for instances of {@link InstantCharacterColumnTupleSource}. **/
    private static final class Factory implements TwoColumnTupleSourceFactory<LongCharTuple, Instant, Character> {
        ...
        public TupleSource<LongCharTuple> create(
            ...
            return new InstantCharacterColumnTupleSource(
                    columnSource1,
                    columnSource2
            );
        }
