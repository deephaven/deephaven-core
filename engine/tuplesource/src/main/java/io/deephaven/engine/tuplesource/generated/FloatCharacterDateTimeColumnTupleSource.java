...
/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types Float, Char, and DateTime.
...
public class FloatCharacterDateTimeColumnTupleSource extends AbstractTupleSource<FloatCharLongTuple> {
    ...
    public static final ThreeColumnTupleSourceFactory<FloatCharLongTuple, Float, Char, DateTime> FACTORY = new Factory();
    ...
    private static final class Factory implements ThreeColumnTupleSourceFactory<FloatCharLongTuple, Float, Char, DateTime> {
