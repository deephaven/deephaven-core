...
/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types DateTime, Char, and Boolean.
...
public class DateTimeCharacterBooleanColumnTupleSource extends AbstractTupleSource<LongCharByteTuple> {
    ...
    public static final ThreeColumnTupleSourceFactory<LongCharByteTuple, DateTime, Char, Boolean> FACTORY = new Factory();
    ...
    private static final class Factory implements ThreeColumnTupleSourceFactory<LongCharByteTuple, DateTime, Char, Boolean> {
