...
/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types Instant, Short, and Boolean.
 */
@SuppressWarnings({"unused", "WeakerAccess"})
public class InstantShortBooleanColumnTupleSource extends AbstractTupleSource<LongShortByteTuple> {

    /** {@link ThreeColumnTupleSourceFactory} instance to create instances of {@link InstantShortBooleanColumnTupleSource}. **/
    public static final ThreeColumnTupleSourceFactory<LongShortByteTuple, Instant, Short, Boolean> FACTORY = new Factory();

    private final ColumnSource<Instant> columnSource1;
    private final ColumnSource<Short> columnSource2;
    private final ColumnSource<Boolean> columnSource3;

    public InstantShortBooleanColumnTupleSource(
    ...
    /** {@link ThreeColumnTupleSourceFactory} for instances of {@link InstantShortBooleanColumnTupleSource}. **/
    private static final class Factory implements ThreeColumnTupleSourceFactory<LongShortByteTuple, Instant, Short, Boolean> {
        ...
        public TupleSource<LongShortByteTuple> create(
            ...
            return new InstantShortBooleanColumnTupleSource(
                    columnSource1,
                    columnSource2,
                    columnSource3
            );
