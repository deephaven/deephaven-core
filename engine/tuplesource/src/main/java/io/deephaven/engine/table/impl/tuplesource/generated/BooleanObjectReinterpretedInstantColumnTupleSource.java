...
public class BooleanObjectReinterpretedInstantColumnTupleSource extends AbstractTupleSource<ByteObjectLongTuple> {
    ...
    public BooleanObjectReinterpretedInstantColumnTupleSource(
    ...
    private static final class Factory implements ThreeColumnTupleSourceFactory<ByteObjectLongTuple, Boolean, Object, Long> {
        ...
        public TupleSource<ByteObjectLongTuple> create(
            ...
            return new BooleanObjectReinterpretedInstantColumnTupleSource(
                    columnSource1,
                    columnSource2,
                    columnSource3
            );
