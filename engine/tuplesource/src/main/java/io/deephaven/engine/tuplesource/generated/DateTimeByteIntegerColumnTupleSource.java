...
/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types DateTime, Byte, and Int.
...
public class DateTimeByteIntegerColumnTupleSource extends AbstractTupleSource<LongByteIntTuple> {
    ...
    public static final ThreeColumnTupleSourceFactory<LongByteIntTuple, DateTime, Byte, Int> FACTORY = new Factory();
    ...
    private static final class Factory implements ThreeColumnTupleSourceFactory<LongByteIntTuple, DateTime, Byte, Int> {
