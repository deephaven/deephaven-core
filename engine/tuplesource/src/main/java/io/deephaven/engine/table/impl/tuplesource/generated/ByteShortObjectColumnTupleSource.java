...
import io.deephaven.engine.tuple.generated.ByteShortObjectTuple;
...
public class ByteShortObjectColumnTupleSource extends AbstractTupleSource<ByteShortObjectTuple> {
    ...
    @Override
    public final <ELEMENT_TYPE> void exportElement(@NotNull final ByteShortObjectTuple tuple, final int elementIndex, @NotNull final WritableColumnSource<ELEMENT_TYPE> writableSource, final long destinationIndexKey) {
        if (elementIndex == 0) {
