...
/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types Boolean, Object, and Boolean.
 */
@SuppressWarnings({"unused", "WeakerAccess"})
public class BooleanObjectBooleanColumnTupleSource extends AbstractTupleSource<ByteObjectByteTuple> {

    /** {@link ThreeColumnTupleSourceFactory} instance to create instances of {@link BooleanObjectBooleanColumnTupleSource}. **/
    public static final ThreeColumnTupleSourceFactory<ByteObjectByteTuple, Boolean, Object, Boolean> FACTORY = new Factory();

    private final ColumnSource<Boolean> columnSource1;
    private final ColumnSource<Object> columnSource2;
    private final ColumnSource<Boolean> columnSource3;

    public BooleanObjectBooleanColumnTupleSource(
    ...
    protected void convertChunks(@NotNull WritableChunk<? super Values> destination, int chunkSize, Chunk<? extends Values> [] chunks) {
        ...
        for (int ii = 0; ii < chunkSize; ++ii) {
            destinationObjectChunk.set(ii, new ByteObjectByteTuple(BooleanUtils.booleanAsByte(chunk1.get(ii)), chunk2.get(ii), BooleanUtils.booleanAsByte(chunk3.get(ii))));
        }
        destinationObjectChunk.setSize(chunkSize);
    }

    /** {@link ThreeColumnTupleSourceFactory} for instances of {@link BooleanObjectBooleanColumnTupleSource}. **/
    private static final class Factory implements ThreeColumnTupleSourceFactory<ByteObjectByteTuple, Boolean, Object, Boolean> {
        ...
        public TupleSource<ByteObjectByteTuple> create(
            ...
            return new BooleanObjectBooleanColumnTupleSource(
                    columnSource1,
                    columnSource2,
                    columnSource3
            );
