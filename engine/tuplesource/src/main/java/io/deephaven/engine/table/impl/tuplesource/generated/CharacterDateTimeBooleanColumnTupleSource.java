...
/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types Character, DateTime, and Boolean.
...
public class CharacterDateTimeBooleanColumnTupleSource extends AbstractTupleSource<CharLongByteTuple> {
    ...
    public static final ThreeColumnTupleSourceFactory<CharLongByteTuple, Character, DateTime, Boolean> FACTORY = new Factory();
    ...
    protected void convertChunks(@NotNull WritableChunk<? super Values> destination, int chunkSize, Chunk<? extends Values> [] chunks) {
        ...
        for (int ii = 0; ii < chunkSize; ++ii) {
            destinationObjectChunk.set(ii, new CharLongByteTuple(chunk1.get(ii), DateTimeUtils.epochNanos(chunk2.get(ii)), BooleanUtils.booleanAsByte(chunk3.get(ii))));
        }
        destinationObjectChunk.setSize(chunkSize);
    }

    /** {@link ThreeColumnTupleSourceFactory} for instances of {@link CharacterDateTimeBooleanColumnTupleSource}. **/
    private static final class Factory implements ThreeColumnTupleSourceFactory<CharLongByteTuple, Character, DateTime, Boolean> {
