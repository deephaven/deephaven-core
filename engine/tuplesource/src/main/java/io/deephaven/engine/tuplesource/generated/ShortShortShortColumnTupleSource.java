...
import io.deephaven.engine.tuple.generated.ShortShortShortTuple;
...
public class ShortShortShortColumnTupleSource extends AbstractTupleSource<ShortShortShortTuple> {
    ...
    @Override
    public final <ELEMENT_TYPE> void exportElement(@NotNull final ShortShortShortTuple tuple, final int elementIndex, @NotNull final WritableColumnSource<ELEMENT_TYPE> writableSource, final long destinationIndexKey) {
        if (elementIndex == 0) {
