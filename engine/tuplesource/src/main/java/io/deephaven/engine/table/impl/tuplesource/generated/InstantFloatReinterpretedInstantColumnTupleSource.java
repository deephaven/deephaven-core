...
/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types Instant, Float, and Long.
 */
@SuppressWarnings({"unused", "WeakerAccess"})
public class InstantFloatReinterpretedInstantColumnTupleSource extends AbstractTupleSource<LongFloatLongTuple> {

    /** {@link ThreeColumnTupleSourceFactory} instance to create instances of {@link InstantFloatReinterpretedInstantColumnTupleSource}. **/
    public static final ThreeColumnTupleSourceFactory<LongFloatLongTuple, Instant, Float, Long> FACTORY = new Factory();

    private final ColumnSource<Instant> columnSource1;
    private final ColumnSource<Float> columnSource2;
    private final ColumnSource<Long> columnSource3;

    public InstantFloatReinterpretedInstantColumnTupleSource(
    ...
    /** {@link ThreeColumnTupleSourceFactory} for instances of {@link InstantFloatReinterpretedInstantColumnTupleSource}. **/
    private static final class Factory implements ThreeColumnTupleSourceFactory<LongFloatLongTuple, Instant, Float, Long> {
        ...
        public TupleSource<LongFloatLongTuple> create(
            ...
            return new InstantFloatReinterpretedInstantColumnTupleSource(
                    columnSource1,
                    columnSource2,
                    columnSource3
            );
