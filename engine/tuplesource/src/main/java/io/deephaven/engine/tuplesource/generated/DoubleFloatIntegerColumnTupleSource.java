...
/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types Double, Float, and Int.
...
public class DoubleFloatIntegerColumnTupleSource extends AbstractTupleSource<DoubleFloatIntTuple> {
    ...
    public static final ThreeColumnTupleSourceFactory<DoubleFloatIntTuple, Double, Float, Int> FACTORY = new Factory();
    ...
    private static final class Factory implements ThreeColumnTupleSourceFactory<DoubleFloatIntTuple, Double, Float, Int> {
