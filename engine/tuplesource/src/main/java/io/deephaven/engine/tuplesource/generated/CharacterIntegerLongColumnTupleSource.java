...
/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types Char, Int, and Long.
...
public class CharacterIntegerLongColumnTupleSource extends AbstractTupleSource<CharIntLongTuple> {
    ...
    public static final ThreeColumnTupleSourceFactory<CharIntLongTuple, Char, Int, Long> FACTORY = new Factory();
    ...
    @Override
    public final <ELEMENT_TYPE> void exportElement(@NotNull final CharIntLongTuple tuple, final int elementIndex, @NotNull final WritableColumnSource<ELEMENT_TYPE> writableSource, final long destinationIndexKey) {
        if (elementIndex == 0) {
    ...
    private static final class Factory implements ThreeColumnTupleSourceFactory<CharIntLongTuple, Char, Int, Long> {
