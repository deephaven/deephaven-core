...
import io.deephaven.engine.tuple.generated.ByteIntObjectTuple;
...
/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types Byte, Int, and Object.
...
public class ReinterpretedBooleanIntegerObjectColumnTupleSource extends AbstractTupleSource<ByteIntObjectTuple> {
    ...
    public static final ThreeColumnTupleSourceFactory<ByteIntObjectTuple, Byte, Int, Object> FACTORY = new Factory();
    ...
    @Override
    public final <ELEMENT_TYPE> void exportElement(@NotNull final ByteIntObjectTuple tuple, final int elementIndex, @NotNull final WritableColumnSource<ELEMENT_TYPE> writableSource, final long destinationIndexKey) {
        if (elementIndex == 0) {
    ...
    private static final class Factory implements ThreeColumnTupleSourceFactory<ByteIntObjectTuple, Byte, Int, Object> {
