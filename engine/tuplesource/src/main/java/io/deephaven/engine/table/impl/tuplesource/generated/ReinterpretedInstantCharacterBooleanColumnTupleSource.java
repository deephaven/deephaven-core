...
public class ReinterpretedInstantCharacterBooleanColumnTupleSource extends AbstractTupleSource<LongCharByteTuple> {
    ...
    public ReinterpretedInstantCharacterBooleanColumnTupleSource(
    ...
    private static final class Factory implements ThreeColumnTupleSourceFactory<LongCharByteTuple, Long, Character, Boolean> {
        ...
        public TupleSource<LongCharByteTuple> create(
            ...
            return new ReinterpretedInstantCharacterBooleanColumnTupleSource(
                    columnSource1,
                    columnSource2,
                    columnSource3
            );
