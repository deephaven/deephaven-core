...
/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types Integer, Long, and Instant.
 */
@SuppressWarnings({"unused", "WeakerAccess"})
public class IntegerReinterpretedInstantInstantColumnTupleSource extends AbstractTupleSource<IntLongLongTuple> {

    /** {@link ThreeColumnTupleSourceFactory} instance to create instances of {@link IntegerReinterpretedInstantInstantColumnTupleSource}. **/
    public static final ThreeColumnTupleSourceFactory<IntLongLongTuple, Integer, Long, Instant> FACTORY = new Factory();

    private final ColumnSource<Integer> columnSource1;
    private final ColumnSource<Long> columnSource2;
    private final ColumnSource<Instant> columnSource3;

    public IntegerReinterpretedInstantInstantColumnTupleSource(
    ...
    /** {@link ThreeColumnTupleSourceFactory} for instances of {@link IntegerReinterpretedInstantInstantColumnTupleSource}. **/
    private static final class Factory implements ThreeColumnTupleSourceFactory<IntLongLongTuple, Integer, Long, Instant> {
        ...
        public TupleSource<IntLongLongTuple> create(
            ...
            return new IntegerReinterpretedInstantInstantColumnTupleSource(
                    columnSource1,
                    columnSource2,
                    columnSource3
            );
