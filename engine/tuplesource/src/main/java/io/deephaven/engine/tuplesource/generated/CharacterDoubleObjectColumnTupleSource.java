...
import io.deephaven.engine.tuple.generated.CharDoubleObjectTuple;
...
/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types Char, Double, and Object.
...
public class CharacterDoubleObjectColumnTupleSource extends AbstractTupleSource<CharDoubleObjectTuple> {
    ...
    public static final ThreeColumnTupleSourceFactory<CharDoubleObjectTuple, Char, Double, Object> FACTORY = new Factory();
    ...
    @Override
    public final <ELEMENT_TYPE> void exportElement(@NotNull final CharDoubleObjectTuple tuple, final int elementIndex, @NotNull final WritableColumnSource<ELEMENT_TYPE> writableSource, final long destinationIndexKey) {
        if (elementIndex == 0) {
    ...
    private static final class Factory implements ThreeColumnTupleSourceFactory<CharDoubleObjectTuple, Char, Double, Object> {
