...
import io.deephaven.engine.tuple.generated.CharObjectDoubleTuple;
import io.deephaven.util.type.TypeUtils;
import org.jetbrains.annotations.NotNull;


/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types Char, Object, and Double.
...
public class CharacterObjectDoubleColumnTupleSource extends AbstractTupleSource<CharObjectDoubleTuple> {
    ...
    public static final ThreeColumnTupleSourceFactory<CharObjectDoubleTuple, Char, Object, Double> FACTORY = new Factory();
    ...
    @Override
    public final <ELEMENT_TYPE> void exportElement(@NotNull final CharObjectDoubleTuple tuple, final int elementIndex, @NotNull final WritableColumnSource<ELEMENT_TYPE> writableSource, final long destinationIndexKey) {
        if (elementIndex == 0) {
    ...
    private static final class Factory implements ThreeColumnTupleSourceFactory<CharObjectDoubleTuple, Char, Object, Double> {
