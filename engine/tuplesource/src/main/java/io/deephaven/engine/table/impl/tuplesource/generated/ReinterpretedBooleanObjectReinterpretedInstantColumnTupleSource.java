...
public class ReinterpretedBooleanObjectReinterpretedInstantColumnTupleSource extends AbstractTupleSource<ByteObjectLongTuple> {
    ...
    public ReinterpretedBooleanObjectReinterpretedInstantColumnTupleSource(
