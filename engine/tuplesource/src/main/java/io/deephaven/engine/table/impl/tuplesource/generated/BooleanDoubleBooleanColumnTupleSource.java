...
/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types Boolean, Double, and Boolean.
 */
@SuppressWarnings({"unused", "WeakerAccess"})
public class BooleanDoubleBooleanColumnTupleSource extends AbstractTupleSource<ByteDoubleByteTuple> {

    /** {@link ThreeColumnTupleSourceFactory} instance to create instances of {@link BooleanDoubleBooleanColumnTupleSource}. **/
    public static final ThreeColumnTupleSourceFactory<ByteDoubleByteTuple, Boolean, Double, Boolean> FACTORY = new Factory();

    private final ColumnSource<Boolean> columnSource1;
    private final ColumnSource<Double> columnSource2;
    private final ColumnSource<Boolean> columnSource3;

    public BooleanDoubleBooleanColumnTupleSource(
    ...
    protected void convertChunks(@NotNull WritableChunk<? super Values> destination, int chunkSize, Chunk<? extends Values> [] chunks) {
        ...
        for (int ii = 0; ii < chunkSize; ++ii) {
            destinationObjectChunk.set(ii, new ByteDoubleByteTuple(BooleanUtils.booleanAsByte(chunk1.get(ii)), chunk2.get(ii), BooleanUtils.booleanAsByte(chunk3.get(ii))));
        }
        destinationObjectChunk.setSize(chunkSize);
    }

    /** {@link ThreeColumnTupleSourceFactory} for instances of {@link BooleanDoubleBooleanColumnTupleSource}. **/
    private static final class Factory implements ThreeColumnTupleSourceFactory<ByteDoubleByteTuple, Boolean, Double, Boolean> {
        ...
        public TupleSource<ByteDoubleByteTuple> create(
            ...
            return new BooleanDoubleBooleanColumnTupleSource(
                    columnSource1,
                    columnSource2,
                    columnSource3
            );
