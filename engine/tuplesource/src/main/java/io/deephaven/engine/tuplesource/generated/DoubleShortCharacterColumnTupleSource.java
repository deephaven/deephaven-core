...
import io.deephaven.engine.tuple.generated.DoubleShortCharTuple;
...
/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types Double, Short, and Char.
...
public class DoubleShortCharacterColumnTupleSource extends AbstractTupleSource<DoubleShortCharTuple> {
    ...
    public static final ThreeColumnTupleSourceFactory<DoubleShortCharTuple, Double, Short, Char> FACTORY = new Factory();
    ...
    @Override
    public final <ELEMENT_TYPE> void exportElement(@NotNull final DoubleShortCharTuple tuple, final int elementIndex, @NotNull final WritableColumnSource<ELEMENT_TYPE> writableSource, final long destinationIndexKey) {
        if (elementIndex == 0) {
    ...
    private static final class Factory implements ThreeColumnTupleSourceFactory<DoubleShortCharTuple, Double, Short, Char> {
