...
/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types Long, Int, and Int.
...
public class ReinterpretedDateTimeIntegerIntegerColumnTupleSource extends AbstractTupleSource<LongIntIntTuple> {
    ...
    public static final ThreeColumnTupleSourceFactory<LongIntIntTuple, Long, Int, Int> FACTORY = new Factory();
    ...
    private static final class Factory implements ThreeColumnTupleSourceFactory<LongIntIntTuple, Long, Int, Int> {
