...
import io.deephaven.engine.tuple.generated.CharDoubleTuple;
import io.deephaven.util.type.TypeUtils;
import org.jetbrains.annotations.NotNull;


/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types Char and Double.
...
public class CharacterDoubleColumnTupleSource extends AbstractTupleSource<CharDoubleTuple> {
    ...
    public static final TwoColumnTupleSourceFactory<CharDoubleTuple, Char, Double> FACTORY = new Factory();
    ...
    @Override
    public final <ELEMENT_TYPE> void exportElement(@NotNull final CharDoubleTuple tuple, final int elementIndex, @NotNull final WritableColumnSource<ELEMENT_TYPE> writableSource, final long destinationIndexKey) {
        if (elementIndex == 0) {
    ...
    private static final class Factory implements TwoColumnTupleSourceFactory<CharDoubleTuple, Char, Double> {
