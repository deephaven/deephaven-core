...
import io.deephaven.engine.tuple.generated.CharFloatObjectTuple;
...
/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types Char, Float, and Object.
...
public class CharacterFloatObjectColumnTupleSource extends AbstractTupleSource<CharFloatObjectTuple> {
    ...
    public static final ThreeColumnTupleSourceFactory<CharFloatObjectTuple, Char, Float, Object> FACTORY = new Factory();
    ...
    @Override
    public final <ELEMENT_TYPE> void exportElement(@NotNull final CharFloatObjectTuple tuple, final int elementIndex, @NotNull final WritableColumnSource<ELEMENT_TYPE> writableSource, final long destinationIndexKey) {
        if (elementIndex == 0) {
    ...
    private static final class Factory implements ThreeColumnTupleSourceFactory<CharFloatObjectTuple, Char, Float, Object> {
