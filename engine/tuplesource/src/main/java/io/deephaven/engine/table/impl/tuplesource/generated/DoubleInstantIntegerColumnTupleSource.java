...
/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types Double, Instant, and Integer.
 */
@SuppressWarnings({"unused", "WeakerAccess"})
public class DoubleInstantIntegerColumnTupleSource extends AbstractTupleSource<DoubleLongIntTuple> {

    /** {@link ThreeColumnTupleSourceFactory} instance to create instances of {@link DoubleInstantIntegerColumnTupleSource}. **/
    public static final ThreeColumnTupleSourceFactory<DoubleLongIntTuple, Double, Instant, Integer> FACTORY = new Factory();
    ...
    protected void convertChunks(@NotNull WritableChunk<? super Values> destination, int chunkSize, Chunk<? extends Values> [] chunks) {
        ...
        for (int ii = 0; ii < chunkSize; ++ii) {
            destinationObjectChunk.set(ii, new DoubleLongIntTuple(chunk1.get(ii), DateTimeUtils.epochNanos(chunk2.get(ii)), chunk3.get(ii)));
        }
        destinationObjectChunk.setSize(chunkSize);
    }

    /** {@link ThreeColumnTupleSourceFactory} for instances of {@link DoubleInstantIntegerColumnTupleSource}. **/
    private static final class Factory implements ThreeColumnTupleSourceFactory<DoubleLongIntTuple, Double, Instant, Integer> {
        ...
        public TupleSource<DoubleLongIntTuple> create(
            ...
            return new DoubleInstantIntegerColumnTupleSource(
                    columnSource1,
                    columnSource2,
                    columnSource3
            );
