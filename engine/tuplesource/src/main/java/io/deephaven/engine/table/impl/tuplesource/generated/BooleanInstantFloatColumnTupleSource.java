...
/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types Boolean, Instant, and Float.
 */
@SuppressWarnings({"unused", "WeakerAccess"})
public class BooleanInstantFloatColumnTupleSource extends AbstractTupleSource<ByteLongFloatTuple> {

    /** {@link ThreeColumnTupleSourceFactory} instance to create instances of {@link BooleanInstantFloatColumnTupleSource}. **/
    ...
    public BooleanInstantFloatColumnTupleSource(
    ...
    protected void convertChunks(@NotNull WritableChunk<? super Values> destination, int chunkSize, Chunk<? extends Values> [] chunks) {
        ...
        for (int ii = 0; ii < chunkSize; ++ii) {
            destinationObjectChunk.set(ii, new ByteLongFloatTuple(BooleanUtils.booleanAsByte(chunk1.get(ii)), DateTimeUtils.epochNanos(chunk2.get(ii)), chunk3.get(ii)));
        }
        destinationObjectChunk.setSize(chunkSize);
    }

    /** {@link ThreeColumnTupleSourceFactory} for instances of {@link BooleanInstantFloatColumnTupleSource}. **/
    private static final class Factory implements ThreeColumnTupleSourceFactory<ByteLongFloatTuple, Boolean, Instant, Float> {
        ...
        public TupleSource<ByteLongFloatTuple> create(
            ...
            return new BooleanInstantFloatColumnTupleSource(
                    columnSource1,
                    columnSource2,
                    columnSource3
            );
