...
import io.deephaven.engine.tuple.generated.DoubleShortDoubleTuple;
...
public class DoubleShortDoubleColumnTupleSource extends AbstractTupleSource<DoubleShortDoubleTuple> {
    ...
    @Override
    public final <ELEMENT_TYPE> void exportElement(@NotNull final DoubleShortDoubleTuple tuple, final int elementIndex, @NotNull final WritableColumnSource<ELEMENT_TYPE> writableSource, final long destinationIndexKey) {
        if (elementIndex == 0) {
