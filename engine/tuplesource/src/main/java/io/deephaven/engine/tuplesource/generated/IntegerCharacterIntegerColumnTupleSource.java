...
public class IntegerCharacterIntegerColumnTupleSource extends AbstractTupleSource<IntCharIntTuple> {
    ...
    @Override
    public final <ELEMENT_TYPE> void exportElement(@NotNull final IntCharIntTuple tuple, final int elementIndex, @NotNull final WritableSource<ELEMENT_TYPE> writableSource, final long destinationIndexKey) {
        if (elementIndex == 0) {
