...
/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types Int, Char, and Int.
...
public class IntegerCharacterIntegerColumnTupleSource extends AbstractTupleSource<IntCharIntTuple> {
    ...
    public static final ThreeColumnTupleSourceFactory<IntCharIntTuple, Int, Char, Int> FACTORY = new Factory();
    ...
    @Override
    public final IntCharIntTuple createTuple(final long indexKey) {
    ...
    @Override
    public final IntCharIntTuple createPreviousTuple(final long indexKey) {
        return new IntCharIntTuple(
    ...
    @Override
    public final <ELEMENT_TYPE> void exportElement(@NotNull final IntCharIntTuple tuple, final int elementIndex, @NotNull final WritableColumnSource<ELEMENT_TYPE> writableSource, final long destinationIndexKey) {
        if (elementIndex == 0) {
    ...
    protected void convertChunks(@NotNull WritableChunk<? super Attributes.Values> destination, int chunkSize, Chunk<Attributes.Values> [] chunks) {
        WritableObjectChunk<IntCharIntTuple, ? super Attributes.Values> destinationObjectChunk = destination.asWritableObjectChunk();
    ...
    private static final class Factory implements ThreeColumnTupleSourceFactory<IntCharIntTuple, Int, Char, Int> {
