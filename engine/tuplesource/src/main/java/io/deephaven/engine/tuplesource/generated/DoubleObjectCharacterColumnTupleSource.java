...
import io.deephaven.engine.tuple.generated.DoubleObjectCharTuple;
...
/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types Double, Object, and Char.
...
public class DoubleObjectCharacterColumnTupleSource extends AbstractTupleSource<DoubleObjectCharTuple> {
    ...
    public static final ThreeColumnTupleSourceFactory<DoubleObjectCharTuple, Double, Object, Char> FACTORY = new Factory();
    ...
    @Override
    public final <ELEMENT_TYPE> void exportElement(@NotNull final DoubleObjectCharTuple tuple, final int elementIndex, @NotNull final WritableColumnSource<ELEMENT_TYPE> writableSource, final long destinationIndexKey) {
        if (elementIndex == 0) {
    ...
    private static final class Factory implements ThreeColumnTupleSourceFactory<DoubleObjectCharTuple, Double, Object, Char> {
