...
/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types Boolean, Double, and Integer.
 */
...
public class BooleanDoubleIntegerColumnTupleSource extends AbstractTupleSource<ByteDoubleIntTuple> {
    ...
    public static final ThreeColumnTupleSourceFactory<ByteDoubleIntTuple, Boolean, Double, Integer> FACTORY = new Factory();
    ...
    private static final class Factory implements ThreeColumnTupleSourceFactory<ByteDoubleIntTuple, Boolean, Double, Integer> {
