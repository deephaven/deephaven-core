...
/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types DateTime, Char, and DateTime.
...
public class DateTimeCharacterDateTimeColumnTupleSource extends AbstractTupleSource<LongCharLongTuple> {
    ...
    public static final ThreeColumnTupleSourceFactory<LongCharLongTuple, DateTime, Char, DateTime> FACTORY = new Factory();
    ...
    private static final class Factory implements ThreeColumnTupleSourceFactory<LongCharLongTuple, DateTime, Char, DateTime> {
