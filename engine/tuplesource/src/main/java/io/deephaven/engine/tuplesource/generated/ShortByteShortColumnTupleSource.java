...
import io.deephaven.engine.tuple.generated.ShortByteShortTuple;
...
public class ShortByteShortColumnTupleSource extends AbstractTupleSource<ShortByteShortTuple> {
    ...
    @Override
    public final <ELEMENT_TYPE> void exportElement(@NotNull final ShortByteShortTuple tuple, final int elementIndex, @NotNull final WritableColumnSource<ELEMENT_TYPE> writableSource, final long destinationIndexKey) {
        if (elementIndex == 0) {
    ...
    protected void convertChunks(@NotNull WritableChunk<? super Attributes.Values> destination, int chunkSize, Chunk<Attributes.Values> [] chunks) {
        WritableObjectChunk<ShortByteShortTuple, ? super Attributes.Values> destinationObjectChunk = destination.asWritableObjectChunk();
