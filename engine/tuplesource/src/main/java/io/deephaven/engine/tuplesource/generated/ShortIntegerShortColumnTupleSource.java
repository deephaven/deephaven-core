...
/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types Short, Int, and Short.
...
public class ShortIntegerShortColumnTupleSource extends AbstractTupleSource<ShortIntShortTuple> {
    ...
    public static final ThreeColumnTupleSourceFactory<ShortIntShortTuple, Short, Int, Short> FACTORY = new Factory();
    ...
    @Override
    public final <ELEMENT_TYPE> void exportElement(@NotNull final ShortIntShortTuple tuple, final int elementIndex, @NotNull final WritableColumnSource<ELEMENT_TYPE> writableSource, final long destinationIndexKey) {
        if (elementIndex == 0) {
    ...
    private static final class Factory implements ThreeColumnTupleSourceFactory<ShortIntShortTuple, Short, Int, Short> {
