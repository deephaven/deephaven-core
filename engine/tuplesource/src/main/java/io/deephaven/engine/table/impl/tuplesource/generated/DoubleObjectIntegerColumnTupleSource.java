...
import io.deephaven.engine.tuple.generated.DoubleObjectIntTuple;
import io.deephaven.util.type.TypeUtils;
import org.jetbrains.annotations.NotNull;


/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types Double, Object, and Int.
...
public class DoubleObjectIntegerColumnTupleSource extends AbstractTupleSource<DoubleObjectIntTuple> {
    ...
    public static final ThreeColumnTupleSourceFactory<DoubleObjectIntTuple, Double, Object, Int> FACTORY = new Factory();
    ...
    @Override
    public final DoubleObjectIntTuple createTuple(final long indexKey) {
    ...
    @Override
    public final DoubleObjectIntTuple createPreviousTuple(final long indexKey) {
        return new DoubleObjectIntTuple(
    ...
    @Override
    public final <ELEMENT_TYPE> void exportElement(@NotNull final DoubleObjectIntTuple tuple, final int elementIndex, @NotNull final WritableColumnSource<ELEMENT_TYPE> writableSource, final long destinationIndexKey) {
        if (elementIndex == 0) {
    ...
    @Override
    public final Object exportToExternalKey(@NotNull final DoubleObjectIntTuple tuple) {
        return new SmartKey(
    ...
    protected void convertChunks(@NotNull WritableChunk<? super Attributes.Values> destination, int chunkSize, Chunk<Attributes.Values> [] chunks) {
        WritableObjectChunk<DoubleObjectIntTuple, ? super Attributes.Values> destinationObjectChunk = destination.asWritableObjectChunk();
    ...
    private static final class Factory implements ThreeColumnTupleSourceFactory<DoubleObjectIntTuple, Double, Object, Int> {
