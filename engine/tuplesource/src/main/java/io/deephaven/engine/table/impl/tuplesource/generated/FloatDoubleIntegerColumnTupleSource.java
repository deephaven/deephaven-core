...
import io.deephaven.engine.tuple.generated.FloatDoubleIntTuple;
import io.deephaven.util.type.TypeUtils;
import org.jetbrains.annotations.NotNull;


/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types Float, Double, and Int.
...
public class FloatDoubleIntegerColumnTupleSource extends AbstractTupleSource<FloatDoubleIntTuple> {
    ...
    public static final ThreeColumnTupleSourceFactory<FloatDoubleIntTuple, Float, Double, Int> FACTORY = new Factory();
    ...
    @Override
    public final FloatDoubleIntTuple createTuple(final long indexKey) {
    ...
    @Override
    public final FloatDoubleIntTuple createPreviousTuple(final long indexKey) {
        return new FloatDoubleIntTuple(
    ...
    @Override
    public final <ELEMENT_TYPE> void exportElement(@NotNull final FloatDoubleIntTuple tuple, final int elementIndex, @NotNull final WritableColumnSource<ELEMENT_TYPE> writableSource, final long destinationIndexKey) {
        if (elementIndex == 0) {
    ...
    @Override
    public final Object exportToExternalKey(@NotNull final FloatDoubleIntTuple tuple) {
        return new SmartKey(
    ...
    protected void convertChunks(@NotNull WritableChunk<? super Attributes.Values> destination, int chunkSize, Chunk<Attributes.Values> [] chunks) {
        WritableObjectChunk<FloatDoubleIntTuple, ? super Attributes.Values> destinationObjectChunk = destination.asWritableObjectChunk();
    ...
    private static final class Factory implements ThreeColumnTupleSourceFactory<FloatDoubleIntTuple, Float, Double, Int> {
