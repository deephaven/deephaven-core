...
/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types Long, Double, and Float.
 */
@SuppressWarnings({"unused", "WeakerAccess"})
public class ReinterpretedInstantDoubleFloatColumnTupleSource extends AbstractTupleSource<LongDoubleFloatTuple> {

    /** {@link ThreeColumnTupleSourceFactory} instance to create instances of {@link ReinterpretedInstantDoubleFloatColumnTupleSource}. **/
    public static final ThreeColumnTupleSourceFactory<LongDoubleFloatTuple, Long, Double, Float> FACTORY = new Factory();

    private final ColumnSource<Long> columnSource1;
    private final ColumnSource<Double> columnSource2;
    private final ColumnSource<Float> columnSource3;

    public ReinterpretedInstantDoubleFloatColumnTupleSource(
    ...
    protected void convertChunks(@NotNull WritableChunk<? super Values> destination, int chunkSize, Chunk<? extends Values> [] chunks) {
        ...
        for (int ii = 0; ii < chunkSize; ++ii) {
            destinationObjectChunk.set(ii, new LongDoubleFloatTuple(chunk1.get(ii), chunk2.get(ii), chunk3.get(ii)));
        }
        destinationObjectChunk.setSize(chunkSize);
    }

    /** {@link ThreeColumnTupleSourceFactory} for instances of {@link ReinterpretedInstantDoubleFloatColumnTupleSource}. **/
    private static final class Factory implements ThreeColumnTupleSourceFactory<LongDoubleFloatTuple, Long, Double, Float> {
        ...
        public TupleSource<LongDoubleFloatTuple> create(
            ...
            return new ReinterpretedInstantDoubleFloatColumnTupleSource(
                    columnSource1,
                    columnSource2,
                    columnSource3
            );
