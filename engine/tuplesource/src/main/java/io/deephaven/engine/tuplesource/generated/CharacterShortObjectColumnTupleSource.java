...
/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types Char, Short, and Object.
...
public class CharacterShortObjectColumnTupleSource extends AbstractTupleSource<CharShortObjectTuple> {
    ...
    public static final ThreeColumnTupleSourceFactory<CharShortObjectTuple, Char, Short, Object> FACTORY = new Factory();
    ...
    @Override
    public final <ELEMENT_TYPE> void exportElement(@NotNull final CharShortObjectTuple tuple, final int elementIndex, @NotNull final WritableColumnSource<ELEMENT_TYPE> writableSource, final long destinationIndexKey) {
        if (elementIndex == 0) {
    ...
    private static final class Factory implements ThreeColumnTupleSourceFactory<CharShortObjectTuple, Char, Short, Object> {
