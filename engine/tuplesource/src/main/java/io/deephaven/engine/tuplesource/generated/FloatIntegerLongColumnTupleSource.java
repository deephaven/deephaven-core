...
/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types Float, Int, and Long.
...
public class FloatIntegerLongColumnTupleSource extends AbstractTupleSource<FloatIntLongTuple> {
    ...
    public static final ThreeColumnTupleSourceFactory<FloatIntLongTuple, Float, Int, Long> FACTORY = new Factory();
    ...
    private static final class Factory implements ThreeColumnTupleSourceFactory<FloatIntLongTuple, Float, Int, Long> {
