...
/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types DateTime, DateTime, and Character.
...
public class DateTimeDateTimeCharacterColumnTupleSource extends AbstractTupleSource<LongLongCharTuple> {
    ...
    public static final ThreeColumnTupleSourceFactory<LongLongCharTuple, DateTime, DateTime, Character> FACTORY = new Factory();
    ...
    protected void convertChunks(@NotNull WritableChunk<? super Values> destination, int chunkSize, Chunk<Values> [] chunks) {
        ...
        for (int ii = 0; ii < chunkSize; ++ii) {
            destinationObjectChunk.set(ii, new LongLongCharTuple(DateTimeUtil.nanos(chunk1.get(ii)), DateTimeUtil.nanos(chunk2.get(ii)), chunk3.get(ii)));
        }
        destinationObjectChunk.setSize(chunkSize);
    }

    /** {@link ThreeColumnTupleSourceFactory} for instances of {@link DateTimeDateTimeCharacterColumnTupleSource}. **/
    private static final class Factory implements ThreeColumnTupleSourceFactory<LongLongCharTuple, DateTime, DateTime, Character> {
