...
public class ReinterpretedBooleanReinterpretedInstantBooleanColumnTupleSource extends AbstractTupleSource<ByteLongByteTuple> {
    ...
    public ReinterpretedBooleanReinterpretedInstantBooleanColumnTupleSource(
    ...
    private static final class Factory implements ThreeColumnTupleSourceFactory<ByteLongByteTuple, Byte, Long, Boolean> {
        ...
        public TupleSource<ByteLongByteTuple> create(
            ...
            return new ReinterpretedBooleanReinterpretedInstantBooleanColumnTupleSource(
                    columnSource1,
                    columnSource2,
                    columnSource3
            );
