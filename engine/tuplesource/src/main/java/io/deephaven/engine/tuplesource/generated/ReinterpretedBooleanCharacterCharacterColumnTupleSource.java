...
/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types Byte, Char, and Char.
...
public class ReinterpretedBooleanCharacterCharacterColumnTupleSource extends AbstractTupleSource<ByteCharCharTuple> {
    ...
    public static final ThreeColumnTupleSourceFactory<ByteCharCharTuple, Byte, Char, Char> FACTORY = new Factory();
    ...
    @Override
    public final <ELEMENT_TYPE> void exportElement(@NotNull final ByteCharCharTuple tuple, final int elementIndex, @NotNull final WritableColumnSource<ELEMENT_TYPE> writableSource, final long destinationIndexKey) {
        if (elementIndex == 0) {
    ...
    private static final class Factory implements ThreeColumnTupleSourceFactory<ByteCharCharTuple, Byte, Char, Char> {
