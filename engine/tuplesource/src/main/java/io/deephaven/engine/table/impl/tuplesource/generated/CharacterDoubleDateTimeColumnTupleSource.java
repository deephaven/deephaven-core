...
/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types Char, Double, and DateTime.
...
public class CharacterDoubleDateTimeColumnTupleSource extends AbstractTupleSource<CharDoubleLongTuple> {
    ...
    public static final ThreeColumnTupleSourceFactory<CharDoubleLongTuple, Char, Double, DateTime> FACTORY = new Factory();
    ...
    private static final class Factory implements ThreeColumnTupleSourceFactory<CharDoubleLongTuple, Char, Double, DateTime> {
