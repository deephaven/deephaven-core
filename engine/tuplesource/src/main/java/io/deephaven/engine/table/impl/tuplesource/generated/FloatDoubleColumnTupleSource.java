...
import io.deephaven.engine.tuple.generated.FloatDoubleTuple;
...
public class FloatDoubleColumnTupleSource extends AbstractTupleSource<FloatDoubleTuple> {
    ...
    @Override
    public final <ELEMENT_TYPE> void exportElement(@NotNull final FloatDoubleTuple tuple, final int elementIndex, @NotNull final WritableColumnSource<ELEMENT_TYPE> writableSource, final long destinationIndexKey) {
        if (elementIndex == 0) {
