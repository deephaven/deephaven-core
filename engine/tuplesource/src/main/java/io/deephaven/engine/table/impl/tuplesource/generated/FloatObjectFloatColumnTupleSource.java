...
import io.deephaven.engine.tuple.generated.FloatObjectFloatTuple;
...
public class FloatObjectFloatColumnTupleSource extends AbstractTupleSource<FloatObjectFloatTuple> {
    ...
    @Override
    public final <ELEMENT_TYPE> void exportElement(@NotNull final FloatObjectFloatTuple tuple, final int elementIndex, @NotNull final WritableColumnSource<ELEMENT_TYPE> writableSource, final long destinationIndexKey) {
        if (elementIndex == 0) {
