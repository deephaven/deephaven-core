...
public class ReinterpretedBooleanReinterpretedInstantShortColumnTupleSource extends AbstractTupleSource<ByteLongShortTuple> {
    ...
    public ReinterpretedBooleanReinterpretedInstantShortColumnTupleSource(
    ...
    private static final class Factory implements ThreeColumnTupleSourceFactory<ByteLongShortTuple, Byte, Long, Short> {
        ...
        public TupleSource<ByteLongShortTuple> create(
            ...
            return new ReinterpretedBooleanReinterpretedInstantShortColumnTupleSource(
                    columnSource1,
                    columnSource2,
                    columnSource3
            );
