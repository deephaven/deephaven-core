...
/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types Instant, Short, and Double.
 */
@SuppressWarnings({"unused", "WeakerAccess"})
public class InstantShortDoubleColumnTupleSource extends AbstractTupleSource<LongShortDoubleTuple> {

    /** {@link ThreeColumnTupleSourceFactory} instance to create instances of {@link InstantShortDoubleColumnTupleSource}. **/
    public static final ThreeColumnTupleSourceFactory<LongShortDoubleTuple, Instant, Short, Double> FACTORY = new Factory();

    private final ColumnSource<Instant> columnSource1;
    private final ColumnSource<Short> columnSource2;
    private final ColumnSource<Double> columnSource3;

    public InstantShortDoubleColumnTupleSource(
    ...
    protected void convertChunks(@NotNull WritableChunk<? super Values> destination, int chunkSize, Chunk<? extends Values> [] chunks) {
        ...
        for (int ii = 0; ii < chunkSize; ++ii) {
            destinationObjectChunk.set(ii, new LongShortDoubleTuple(DateTimeUtils.epochNanos(chunk1.get(ii)), chunk2.get(ii), chunk3.get(ii)));
        }
        destinationObjectChunk.setSize(chunkSize);
    }

    /** {@link ThreeColumnTupleSourceFactory} for instances of {@link InstantShortDoubleColumnTupleSource}. **/
    private static final class Factory implements ThreeColumnTupleSourceFactory<LongShortDoubleTuple, Instant, Short, Double> {
        ...
        public TupleSource<LongShortDoubleTuple> create(
            ...
            return new InstantShortDoubleColumnTupleSource(
                    columnSource1,
                    columnSource2,
                    columnSource3
            );
