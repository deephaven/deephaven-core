...
/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types DateTime, Char, and Float.
...
public class DateTimeCharacterFloatColumnTupleSource extends AbstractTupleSource<LongCharFloatTuple> {
    ...
    public static final ThreeColumnTupleSourceFactory<LongCharFloatTuple, DateTime, Char, Float> FACTORY = new Factory();
    ...
    private static final class Factory implements ThreeColumnTupleSourceFactory<LongCharFloatTuple, DateTime, Char, Float> {
