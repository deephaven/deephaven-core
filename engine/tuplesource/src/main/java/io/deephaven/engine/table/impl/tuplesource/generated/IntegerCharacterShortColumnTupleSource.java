...
import io.deephaven.engine.tuple.generated.IntCharShortTuple;
import io.deephaven.util.type.TypeUtils;
import org.jetbrains.annotations.NotNull;


/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types Int, Char, and Short.
...
public class IntegerCharacterShortColumnTupleSource extends AbstractTupleSource<IntCharShortTuple> {
    ...
    public static final ThreeColumnTupleSourceFactory<IntCharShortTuple, Int, Char, Short> FACTORY = new Factory();
    ...
    @Override
    public final IntCharShortTuple createTuple(final long indexKey) {
    ...
    @Override
    public final IntCharShortTuple createPreviousTuple(final long indexKey) {
        return new IntCharShortTuple(
    ...
    @Override
    public final <ELEMENT_TYPE> void exportElement(@NotNull final IntCharShortTuple tuple, final int elementIndex, @NotNull final WritableColumnSource<ELEMENT_TYPE> writableSource, final long destinationIndexKey) {
        if (elementIndex == 0) {
    ...
    @Override
    public final Object exportToExternalKey(@NotNull final IntCharShortTuple tuple) {
        return new SmartKey(
    ...
    protected void convertChunks(@NotNull WritableChunk<? super Attributes.Values> destination, int chunkSize, Chunk<Attributes.Values> [] chunks) {
        WritableObjectChunk<IntCharShortTuple, ? super Attributes.Values> destinationObjectChunk = destination.asWritableObjectChunk();
    ...
    private static final class Factory implements ThreeColumnTupleSourceFactory<IntCharShortTuple, Int, Char, Short> {
