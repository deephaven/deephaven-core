...
/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types Short, Instant, and Instant.
 */
@SuppressWarnings({"unused", "WeakerAccess"})
public class ShortInstantInstantColumnTupleSource extends AbstractTupleSource<ShortLongLongTuple> {

    /** {@link ThreeColumnTupleSourceFactory} instance to create instances of {@link ShortInstantInstantColumnTupleSource}. **/
    public static final ThreeColumnTupleSourceFactory<ShortLongLongTuple, Short, Instant, Instant> FACTORY = new Factory();

    private final ColumnSource<Short> columnSource1;
    private final ColumnSource<Instant> columnSource2;
    private final ColumnSource<Instant> columnSource3;

    public ShortInstantInstantColumnTupleSource(
    ...
    protected void convertChunks(@NotNull WritableChunk<? super Values> destination, int chunkSize, Chunk<? extends Values> [] chunks) {
        ...
        for (int ii = 0; ii < chunkSize; ++ii) {
            destinationObjectChunk.set(ii, new ShortLongLongTuple(chunk1.get(ii), DateTimeUtils.epochNanos(chunk2.get(ii)), DateTimeUtils.epochNanos(chunk3.get(ii))));
        }
        destinationObjectChunk.setSize(chunkSize);
    }

    /** {@link ThreeColumnTupleSourceFactory} for instances of {@link ShortInstantInstantColumnTupleSource}. **/
    private static final class Factory implements ThreeColumnTupleSourceFactory<ShortLongLongTuple, Short, Instant, Instant> {
        ...
        public TupleSource<ShortLongLongTuple> create(
            ...
            return new ShortInstantInstantColumnTupleSource(
                    columnSource1,
                    columnSource2,
                    columnSource3
            );
