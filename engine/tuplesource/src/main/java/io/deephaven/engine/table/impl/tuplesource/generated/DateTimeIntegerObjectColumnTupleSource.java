...
/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types DateTime, Int, and Object.
...
public class DateTimeIntegerObjectColumnTupleSource extends AbstractTupleSource<LongIntObjectTuple> {
    ...
    public static final ThreeColumnTupleSourceFactory<LongIntObjectTuple, DateTime, Int, Object> FACTORY = new Factory();
    ...
    @Override
    public final <ELEMENT_TYPE> void exportElement(@NotNull final LongIntObjectTuple tuple, final int elementIndex, @NotNull final WritableColumnSource<ELEMENT_TYPE> writableSource, final long destinationIndexKey) {
        if (elementIndex == 0) {
    ...
    private static final class Factory implements ThreeColumnTupleSourceFactory<LongIntObjectTuple, DateTime, Int, Object> {
