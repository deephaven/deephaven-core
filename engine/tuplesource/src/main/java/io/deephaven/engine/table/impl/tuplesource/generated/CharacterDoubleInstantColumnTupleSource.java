...
/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types Character, Double, and Instant.
 */
@SuppressWarnings({"unused", "WeakerAccess"})
public class CharacterDoubleInstantColumnTupleSource extends AbstractTupleSource<CharDoubleLongTuple> {

    /** {@link ThreeColumnTupleSourceFactory} instance to create instances of {@link CharacterDoubleInstantColumnTupleSource}. **/
    public static final ThreeColumnTupleSourceFactory<CharDoubleLongTuple, Character, Double, Instant> FACTORY = new Factory();

    private final ColumnSource<Character> columnSource1;
    private final ColumnSource<Double> columnSource2;
    private final ColumnSource<Instant> columnSource3;

    public CharacterDoubleInstantColumnTupleSource(
    ...
    /** {@link ThreeColumnTupleSourceFactory} for instances of {@link CharacterDoubleInstantColumnTupleSource}. **/
    private static final class Factory implements ThreeColumnTupleSourceFactory<CharDoubleLongTuple, Character, Double, Instant> {
        ...
        public TupleSource<CharDoubleLongTuple> create(
            ...
            return new CharacterDoubleInstantColumnTupleSource(
                    columnSource1,
                    columnSource2,
                    columnSource3
            );
