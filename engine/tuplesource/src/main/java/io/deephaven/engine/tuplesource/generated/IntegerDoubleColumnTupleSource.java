...
import io.deephaven.engine.tuple.generated.IntDoubleTuple;
...
/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types Int and Double.
...
public class IntegerDoubleColumnTupleSource extends AbstractTupleSource<IntDoubleTuple> {
    ...
    public static final TwoColumnTupleSourceFactory<IntDoubleTuple, Int, Double> FACTORY = new Factory();
    ...
    @Override
    public final <ELEMENT_TYPE> void exportElement(@NotNull final IntDoubleTuple tuple, final int elementIndex, @NotNull final WritableColumnSource<ELEMENT_TYPE> writableSource, final long destinationIndexKey) {
        if (elementIndex == 0) {
    ...
    private static final class Factory implements TwoColumnTupleSourceFactory<IntDoubleTuple, Int, Double> {
