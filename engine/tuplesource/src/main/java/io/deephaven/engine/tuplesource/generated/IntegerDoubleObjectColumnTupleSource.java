...
import io.deephaven.engine.tuple.generated.IntDoubleObjectTuple;
...
/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types Int, Double, and Object.
...
public class IntegerDoubleObjectColumnTupleSource extends AbstractTupleSource<IntDoubleObjectTuple> {
    ...
    public static final ThreeColumnTupleSourceFactory<IntDoubleObjectTuple, Int, Double, Object> FACTORY = new Factory();
    ...
    @Override
    public final IntDoubleObjectTuple createTuple(final long indexKey) {
    ...
    @Override
    public final IntDoubleObjectTuple createPreviousTuple(final long indexKey) {
        return new IntDoubleObjectTuple(
    ...
    @Override
    public final <ELEMENT_TYPE> void exportElement(@NotNull final IntDoubleObjectTuple tuple, final int elementIndex, @NotNull final WritableColumnSource<ELEMENT_TYPE> writableSource, final long destinationIndexKey) {
        if (elementIndex == 0) {
    ...
    @Override
    public final Object exportToExternalKey(@NotNull final IntDoubleObjectTuple tuple) {
        return new SmartKey(
    ...
    protected void convertChunks(@NotNull WritableChunk<? super Attributes.Values> destination, int chunkSize, Chunk<Attributes.Values> [] chunks) {
        WritableObjectChunk<IntDoubleObjectTuple, ? super Attributes.Values> destinationObjectChunk = destination.asWritableObjectChunk();
    ...
    private static final class Factory implements ThreeColumnTupleSourceFactory<IntDoubleObjectTuple, Int, Double, Object> {
