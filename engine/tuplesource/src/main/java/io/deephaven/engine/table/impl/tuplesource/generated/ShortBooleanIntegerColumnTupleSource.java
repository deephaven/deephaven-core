...
import io.deephaven.engine.tuple.generated.ShortByteIntTuple;
...
/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types Short, Boolean, and Int.
...
public class ShortBooleanIntegerColumnTupleSource extends AbstractTupleSource<ShortByteIntTuple> {
    ...
    public static final ThreeColumnTupleSourceFactory<ShortByteIntTuple, Short, Boolean, Int> FACTORY = new Factory();
    ...
    @Override
    public final <ELEMENT_TYPE> void exportElement(@NotNull final ShortByteIntTuple tuple, final int elementIndex, @NotNull final WritableColumnSource<ELEMENT_TYPE> writableSource, final long destinationIndexKey) {
        if (elementIndex == 0) {
    ...
    private static final class Factory implements ThreeColumnTupleSourceFactory<ShortByteIntTuple, Short, Boolean, Int> {
