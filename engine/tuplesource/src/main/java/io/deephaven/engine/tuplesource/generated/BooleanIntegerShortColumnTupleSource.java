...
/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types Boolean, Int, and Short.
...
public class BooleanIntegerShortColumnTupleSource extends AbstractTupleSource<ByteIntShortTuple> {
    ...
    public static final ThreeColumnTupleSourceFactory<ByteIntShortTuple, Boolean, Int, Short> FACTORY = new Factory();
    ...
    private static final class Factory implements ThreeColumnTupleSourceFactory<ByteIntShortTuple, Boolean, Int, Short> {
