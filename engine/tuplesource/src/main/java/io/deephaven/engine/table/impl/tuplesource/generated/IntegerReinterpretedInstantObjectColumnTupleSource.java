...
import io.deephaven.tuple.generated.IntLongObjectTuple;
...
public class IntegerReinterpretedInstantObjectColumnTupleSource extends AbstractTupleSource<IntLongObjectTuple> {
    ...
    public IntegerReinterpretedInstantObjectColumnTupleSource(
    ...
    @Override
    public final void exportAllTo(final Object @NotNull [] dest, @NotNull final IntLongObjectTuple tuple) {
    ...
    @Override
    public final void exportAllTo(final Object @NotNull [] dest, @NotNull final IntLongObjectTuple tuple, final int @NotNull [] map) {
    ...
    @Override
    public final void exportAllReinterpretedTo(final Object @NotNull [] dest, @NotNull final IntLongObjectTuple tuple) {
        dest[0] = TypeUtils.box(tuple.getFirstElement());
    ...
    @Override
    public final void exportAllReinterpretedTo(final Object @NotNull [] dest, @NotNull final IntLongObjectTuple tuple, final int @NotNull [] map) {
        dest[map[0]] = TypeUtils.box(tuple.getFirstElement());
    ...
    private static final class Factory implements ThreeColumnTupleSourceFactory<IntLongObjectTuple, Integer, Long, Object> {
        ...
        public TupleSource<IntLongObjectTuple> create(
            ...
            return new IntegerReinterpretedInstantObjectColumnTupleSource(
                    columnSource1,
                    columnSource2,
                    columnSource3
            );
