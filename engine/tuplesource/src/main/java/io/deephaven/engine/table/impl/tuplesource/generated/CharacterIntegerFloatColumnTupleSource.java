...
/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types Char, Int, and Float.
...
public class CharacterIntegerFloatColumnTupleSource extends AbstractTupleSource<CharIntFloatTuple> {
    ...
    public static final ThreeColumnTupleSourceFactory<CharIntFloatTuple, Char, Int, Float> FACTORY = new Factory();
    ...
    @Override
    public final <ELEMENT_TYPE> void exportElement(@NotNull final CharIntFloatTuple tuple, final int elementIndex, @NotNull final WritableColumnSource<ELEMENT_TYPE> writableSource, final long destinationIndexKey) {
        if (elementIndex == 0) {
    ...
    private static final class Factory implements ThreeColumnTupleSourceFactory<CharIntFloatTuple, Char, Int, Float> {
