...
/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types Char, Char, and DateTime.
...
public class CharacterCharacterDateTimeColumnTupleSource extends AbstractTupleSource<CharCharLongTuple> {
    ...
    public static final ThreeColumnTupleSourceFactory<CharCharLongTuple, Char, Char, DateTime> FACTORY = new Factory();
    ...
    private static final class Factory implements ThreeColumnTupleSourceFactory<CharCharLongTuple, Char, Char, DateTime> {
