...
/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types Int, Double, and Long.
...
public class IntegerDoubleReinterpretedDateTimeColumnTupleSource extends AbstractTupleSource<IntDoubleLongTuple> {
    ...
    public static final ThreeColumnTupleSourceFactory<IntDoubleLongTuple, Int, Double, Long> FACTORY = new Factory();
    ...
    private static final class Factory implements ThreeColumnTupleSourceFactory<IntDoubleLongTuple, Int, Double, Long> {
