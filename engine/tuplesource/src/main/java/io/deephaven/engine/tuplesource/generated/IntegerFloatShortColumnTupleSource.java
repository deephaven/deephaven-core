...
import io.deephaven.engine.tuple.generated.IntFloatShortTuple;
...
/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types Int, Float, and Short.
...
public class IntegerFloatShortColumnTupleSource extends AbstractTupleSource<IntFloatShortTuple> {
    ...
    public static final ThreeColumnTupleSourceFactory<IntFloatShortTuple, Int, Float, Short> FACTORY = new Factory();
    ...
    @Override
    public final <ELEMENT_TYPE> void exportElement(@NotNull final IntFloatShortTuple tuple, final int elementIndex, @NotNull final WritableColumnSource<ELEMENT_TYPE> writableSource, final long destinationIndexKey) {
        if (elementIndex == 0) {
    ...
    private static final class Factory implements ThreeColumnTupleSourceFactory<IntFloatShortTuple, Int, Float, Short> {
