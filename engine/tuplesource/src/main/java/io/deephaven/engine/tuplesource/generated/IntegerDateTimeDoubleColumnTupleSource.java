...
/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types Int, DateTime, and Double.
...
public class IntegerDateTimeDoubleColumnTupleSource extends AbstractTupleSource<IntLongDoubleTuple> {
    ...
    public static final ThreeColumnTupleSourceFactory<IntLongDoubleTuple, Int, DateTime, Double> FACTORY = new Factory();
    ...
    private static final class Factory implements ThreeColumnTupleSourceFactory<IntLongDoubleTuple, Int, DateTime, Double> {
