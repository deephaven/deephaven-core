...
/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types Int and DateTime.
...
public class IntegerDateTimeColumnTupleSource extends AbstractTupleSource<IntLongTuple> {
    ...
    public static final TwoColumnTupleSourceFactory<IntLongTuple, Int, DateTime> FACTORY = new Factory();
    ...
    private static final class Factory implements TwoColumnTupleSourceFactory<IntLongTuple, Int, DateTime> {
