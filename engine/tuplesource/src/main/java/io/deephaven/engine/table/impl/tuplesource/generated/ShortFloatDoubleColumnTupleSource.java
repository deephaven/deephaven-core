...
import io.deephaven.engine.tuple.generated.ShortFloatDoubleTuple;
...
public class ShortFloatDoubleColumnTupleSource extends AbstractTupleSource<ShortFloatDoubleTuple> {
    ...
    @Override
    public final <ELEMENT_TYPE> void exportElement(@NotNull final ShortFloatDoubleTuple tuple, final int elementIndex, @NotNull final WritableColumnSource<ELEMENT_TYPE> writableSource, final long destinationIndexKey) {
        if (elementIndex == 0) {
