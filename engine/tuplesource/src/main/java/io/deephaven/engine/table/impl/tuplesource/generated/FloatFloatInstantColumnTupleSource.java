...
/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types Float, Float, and Instant.
 */
@SuppressWarnings({"unused", "WeakerAccess"})
public class FloatFloatInstantColumnTupleSource extends AbstractTupleSource<FloatFloatLongTuple> {

    /** {@link ThreeColumnTupleSourceFactory} instance to create instances of {@link FloatFloatInstantColumnTupleSource}. **/
    public static final ThreeColumnTupleSourceFactory<FloatFloatLongTuple, Float, Float, Instant> FACTORY = new Factory();

    private final ColumnSource<Float> columnSource1;
    private final ColumnSource<Float> columnSource2;
    private final ColumnSource<Instant> columnSource3;

    public FloatFloatInstantColumnTupleSource(
    ...
    protected void convertChunks(@NotNull WritableChunk<? super Values> destination, int chunkSize, Chunk<? extends Values> [] chunks) {
        ...
        for (int ii = 0; ii < chunkSize; ++ii) {
            destinationObjectChunk.set(ii, new FloatFloatLongTuple(chunk1.get(ii), chunk2.get(ii), DateTimeUtils.epochNanos(chunk3.get(ii))));
        }
        destinationObjectChunk.setSize(chunkSize);
    }

    /** {@link ThreeColumnTupleSourceFactory} for instances of {@link FloatFloatInstantColumnTupleSource}. **/
    private static final class Factory implements ThreeColumnTupleSourceFactory<FloatFloatLongTuple, Float, Float, Instant> {
        ...
        public TupleSource<FloatFloatLongTuple> create(
            ...
            return new FloatFloatInstantColumnTupleSource(
                    columnSource1,
                    columnSource2,
                    columnSource3
            );
