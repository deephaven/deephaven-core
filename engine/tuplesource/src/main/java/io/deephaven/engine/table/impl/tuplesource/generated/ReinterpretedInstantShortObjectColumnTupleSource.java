...
public class ReinterpretedInstantShortObjectColumnTupleSource extends AbstractTupleSource<LongShortObjectTuple> {
    ...
    public ReinterpretedInstantShortObjectColumnTupleSource(
    ...
    private static final class Factory implements ThreeColumnTupleSourceFactory<LongShortObjectTuple, Long, Short, Object> {
        ...
        public TupleSource<LongShortObjectTuple> create(
            ...
            return new ReinterpretedInstantShortObjectColumnTupleSource(
                    columnSource1,
                    columnSource2,
                    columnSource3
            );
