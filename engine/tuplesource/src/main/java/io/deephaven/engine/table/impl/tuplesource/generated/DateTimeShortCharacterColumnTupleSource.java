...
public class DateTimeShortCharacterColumnTupleSource extends AbstractTupleSource<LongShortCharTuple> {
    ...
    @Override
    public final <ELEMENT_TYPE> void exportElement(@NotNull final LongShortCharTuple tuple, final int elementIndex, @NotNull final WritableColumnSource<ELEMENT_TYPE> writableSource, final long destinationIndexKey) {
        if (elementIndex == 0) {
