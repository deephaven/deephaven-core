...
import io.deephaven.engine.tuple.generated.FloatFloatFloatTuple;
...
public class FloatFloatFloatColumnTupleSource extends AbstractTupleSource<FloatFloatFloatTuple> {
    ...
    @Override
    public final <ELEMENT_TYPE> void exportElement(@NotNull final FloatFloatFloatTuple tuple, final int elementIndex, @NotNull final WritableColumnSource<ELEMENT_TYPE> writableSource, final long destinationIndexKey) {
        if (elementIndex == 0) {
