...
import io.deephaven.engine.tuple.generated.DoubleCharIntTuple;
import io.deephaven.util.type.TypeUtils;
import org.jetbrains.annotations.NotNull;


/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types Double, Char, and Int.
...
public class DoubleCharacterIntegerColumnTupleSource extends AbstractTupleSource<DoubleCharIntTuple> {
    ...
    public static final ThreeColumnTupleSourceFactory<DoubleCharIntTuple, Double, Char, Int> FACTORY = new Factory();
    ...
    @Override
    public final <ELEMENT_TYPE> void exportElement(@NotNull final DoubleCharIntTuple tuple, final int elementIndex, @NotNull final WritableColumnSource<ELEMENT_TYPE> writableSource, final long destinationIndexKey) {
        if (elementIndex == 0) {
    ...
    private static final class Factory implements ThreeColumnTupleSourceFactory<DoubleCharIntTuple, Double, Char, Int> {
