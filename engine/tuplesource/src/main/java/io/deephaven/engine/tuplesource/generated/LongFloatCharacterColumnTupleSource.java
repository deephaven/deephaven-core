...
/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types Long, Float, and Char.
...
public class LongFloatCharacterColumnTupleSource extends AbstractTupleSource<LongFloatCharTuple> {
    ...
    public static final ThreeColumnTupleSourceFactory<LongFloatCharTuple, Long, Float, Char> FACTORY = new Factory();
    ...
    private static final class Factory implements ThreeColumnTupleSourceFactory<LongFloatCharTuple, Long, Float, Char> {
