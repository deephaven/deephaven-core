...
public class ReinterpretedInstantReinterpretedBooleanLongColumnTupleSource extends AbstractTupleSource<LongByteLongTuple> {
    ...
    public ReinterpretedInstantReinterpretedBooleanLongColumnTupleSource(
    ...
    private static final class Factory implements ThreeColumnTupleSourceFactory<LongByteLongTuple, Long, Byte, Long> {
        ...
        public TupleSource<LongByteLongTuple> create(
            ...
            return new ReinterpretedInstantReinterpretedBooleanLongColumnTupleSource(
                    columnSource1,
                    columnSource2,
                    columnSource3
            );
