...
import io.deephaven.engine.tuple.generated.ObjectIntShortTuple;
import io.deephaven.util.type.TypeUtils;
import org.jetbrains.annotations.NotNull;


/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types Object, Int, and Short.
...
public class ObjectIntegerShortColumnTupleSource extends AbstractTupleSource<ObjectIntShortTuple> {
    ...
    public static final ThreeColumnTupleSourceFactory<ObjectIntShortTuple, Object, Int, Short> FACTORY = new Factory();
    ...
    @Override
    public final <ELEMENT_TYPE> void exportElement(@NotNull final ObjectIntShortTuple tuple, final int elementIndex, @NotNull final WritableColumnSource<ELEMENT_TYPE> writableSource, final long destinationIndexKey) {
        if (elementIndex == 0) {
    ...
    private static final class Factory implements ThreeColumnTupleSourceFactory<ObjectIntShortTuple, Object, Int, Short> {
