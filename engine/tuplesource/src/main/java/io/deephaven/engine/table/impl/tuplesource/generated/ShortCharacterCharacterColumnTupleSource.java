...
import io.deephaven.engine.tuple.generated.ShortCharCharTuple;
import io.deephaven.util.type.TypeUtils;
import org.jetbrains.annotations.NotNull;


/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types Short, Char, and Char.
...
public class ShortCharacterCharacterColumnTupleSource extends AbstractTupleSource<ShortCharCharTuple> {
    ...
    public static final ThreeColumnTupleSourceFactory<ShortCharCharTuple, Short, Char, Char> FACTORY = new Factory();
    ...
    @Override
    public final <ELEMENT_TYPE> void exportElement(@NotNull final ShortCharCharTuple tuple, final int elementIndex, @NotNull final WritableColumnSource<ELEMENT_TYPE> writableSource, final long destinationIndexKey) {
        if (elementIndex == 0) {
    ...
    private static final class Factory implements ThreeColumnTupleSourceFactory<ShortCharCharTuple, Short, Char, Char> {
