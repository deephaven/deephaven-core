...
/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types Character, Instant, and Integer.
 */
@SuppressWarnings({"unused", "WeakerAccess"})
public class CharacterInstantIntegerColumnTupleSource extends AbstractTupleSource<CharLongIntTuple> {

    /** {@link ThreeColumnTupleSourceFactory} instance to create instances of {@link CharacterInstantIntegerColumnTupleSource}. **/
    public static final ThreeColumnTupleSourceFactory<CharLongIntTuple, Character, Instant, Integer> FACTORY = new Factory();

    private final ColumnSource<Character> columnSource1;
    private final ColumnSource<Instant> columnSource2;
    private final ColumnSource<Integer> columnSource3;

    public CharacterInstantIntegerColumnTupleSource(
    ...
    /** {@link ThreeColumnTupleSourceFactory} for instances of {@link CharacterInstantIntegerColumnTupleSource}. **/
    private static final class Factory implements ThreeColumnTupleSourceFactory<CharLongIntTuple, Character, Instant, Integer> {
        ...
        public TupleSource<CharLongIntTuple> create(
            ...
            return new CharacterInstantIntegerColumnTupleSource(
                    columnSource1,
                    columnSource2,
                    columnSource3
            );
