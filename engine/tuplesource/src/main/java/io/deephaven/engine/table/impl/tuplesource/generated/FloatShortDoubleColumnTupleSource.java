...
import io.deephaven.engine.tuple.generated.FloatShortDoubleTuple;
...
public class FloatShortDoubleColumnTupleSource extends AbstractTupleSource<FloatShortDoubleTuple> {
    ...
    @Override
    public final <ELEMENT_TYPE> void exportElement(@NotNull final FloatShortDoubleTuple tuple, final int elementIndex, @NotNull final WritableColumnSource<ELEMENT_TYPE> writableSource, final long destinationIndexKey) {
        if (elementIndex == 0) {
