...
/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types Byte, DateTime, and Int.
...
public class ByteDateTimeIntegerColumnTupleSource extends AbstractTupleSource<ByteLongIntTuple> {
    ...
    public static final ThreeColumnTupleSourceFactory<ByteLongIntTuple, Byte, DateTime, Int> FACTORY = new Factory();
    ...
    private static final class Factory implements ThreeColumnTupleSourceFactory<ByteLongIntTuple, Byte, DateTime, Int> {
