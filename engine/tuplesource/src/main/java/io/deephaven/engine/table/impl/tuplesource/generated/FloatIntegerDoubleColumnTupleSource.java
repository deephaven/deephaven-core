...
import io.deephaven.engine.tuple.generated.FloatIntDoubleTuple;
import io.deephaven.util.type.TypeUtils;
import org.jetbrains.annotations.NotNull;


/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types Float, Int, and Double.
...
public class FloatIntegerDoubleColumnTupleSource extends AbstractTupleSource<FloatIntDoubleTuple> {
    ...
    public static final ThreeColumnTupleSourceFactory<FloatIntDoubleTuple, Float, Int, Double> FACTORY = new Factory();
    ...
    @Override
    public final FloatIntDoubleTuple createTuple(final long indexKey) {
    ...
    @Override
    public final FloatIntDoubleTuple createPreviousTuple(final long indexKey) {
        return new FloatIntDoubleTuple(
    ...
    @Override
    public final <ELEMENT_TYPE> void exportElement(@NotNull final FloatIntDoubleTuple tuple, final int elementIndex, @NotNull final WritableColumnSource<ELEMENT_TYPE> writableSource, final long destinationIndexKey) {
        if (elementIndex == 0) {
    ...
    @Override
    public final Object exportToExternalKey(@NotNull final FloatIntDoubleTuple tuple) {
        return new SmartKey(
    ...
    protected void convertChunks(@NotNull WritableChunk<? super Attributes.Values> destination, int chunkSize, Chunk<Attributes.Values> [] chunks) {
        WritableObjectChunk<FloatIntDoubleTuple, ? super Attributes.Values> destinationObjectChunk = destination.asWritableObjectChunk();
    ...
    private static final class Factory implements ThreeColumnTupleSourceFactory<FloatIntDoubleTuple, Float, Int, Double> {
