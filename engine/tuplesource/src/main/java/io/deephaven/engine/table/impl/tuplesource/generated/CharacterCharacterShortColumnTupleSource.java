...
import io.deephaven.engine.tuple.generated.CharCharShortTuple;
import io.deephaven.util.type.TypeUtils;
import org.jetbrains.annotations.NotNull;


/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types Char, Char, and Short.
...
public class CharacterCharacterShortColumnTupleSource extends AbstractTupleSource<CharCharShortTuple> {
    ...
    public static final ThreeColumnTupleSourceFactory<CharCharShortTuple, Char, Char, Short> FACTORY = new Factory();
    ...
    @Override
    public final <ELEMENT_TYPE> void exportElement(@NotNull final CharCharShortTuple tuple, final int elementIndex, @NotNull final WritableColumnSource<ELEMENT_TYPE> writableSource, final long destinationIndexKey) {
        if (elementIndex == 0) {
    ...
    private static final class Factory implements ThreeColumnTupleSourceFactory<CharCharShortTuple, Char, Char, Short> {
