...
import io.deephaven.engine.tuple.generated.DoubleDoubleObjectTuple;
...
public class DoubleDoubleObjectColumnTupleSource extends AbstractTupleSource<DoubleDoubleObjectTuple> {
    ...
    @Override
    public final <ELEMENT_TYPE> void exportElement(@NotNull final DoubleDoubleObjectTuple tuple, final int elementIndex, @NotNull final WritableColumnSource<ELEMENT_TYPE> writableSource, final long destinationIndexKey) {
        if (elementIndex == 0) {
