...
import io.deephaven.engine.tuple.generated.ObjectCharTuple;
import io.deephaven.util.type.TypeUtils;
import org.jetbrains.annotations.NotNull;


/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types Object and Char.
...
public class ObjectCharacterColumnTupleSource extends AbstractTupleSource<ObjectCharTuple> {
    ...
    public static final TwoColumnTupleSourceFactory<ObjectCharTuple, Object, Char> FACTORY = new Factory();
    ...
    @Override
    public final <ELEMENT_TYPE> void exportElement(@NotNull final ObjectCharTuple tuple, final int elementIndex, @NotNull final WritableColumnSource<ELEMENT_TYPE> writableSource, final long destinationIndexKey) {
        if (elementIndex == 0) {
    ...
    private static final class Factory implements TwoColumnTupleSourceFactory<ObjectCharTuple, Object, Char> {
