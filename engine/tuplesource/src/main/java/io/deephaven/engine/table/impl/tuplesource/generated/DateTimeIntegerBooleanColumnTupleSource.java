...
/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types DateTime, Int, and Boolean.
...
public class DateTimeIntegerBooleanColumnTupleSource extends AbstractTupleSource<LongIntByteTuple> {
    ...
    public static final ThreeColumnTupleSourceFactory<LongIntByteTuple, DateTime, Int, Boolean> FACTORY = new Factory();
    ...
    private static final class Factory implements ThreeColumnTupleSourceFactory<LongIntByteTuple, DateTime, Int, Boolean> {
