...
import io.deephaven.engine.tuple.generated.ObjectDoubleTuple;
...
public class ObjectDoubleColumnTupleSource extends AbstractTupleSource<ObjectDoubleTuple> {
    ...
    @Override
    public final <ELEMENT_TYPE> void exportElement(@NotNull final ObjectDoubleTuple tuple, final int elementIndex, @NotNull final WritableColumnSource<ELEMENT_TYPE> writableSource, final long destinationIndexKey) {
        if (elementIndex == 0) {
