...
/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types Instant, Double, and Instant.
 */
@SuppressWarnings({"unused", "WeakerAccess"})
public class InstantDoubleInstantColumnTupleSource extends AbstractTupleSource<LongDoubleLongTuple> {

    /** {@link ThreeColumnTupleSourceFactory} instance to create instances of {@link InstantDoubleInstantColumnTupleSource}. **/
    public static final ThreeColumnTupleSourceFactory<LongDoubleLongTuple, Instant, Double, Instant> FACTORY = new Factory();

    private final ColumnSource<Instant> columnSource1;
    private final ColumnSource<Double> columnSource2;
    private final ColumnSource<Instant> columnSource3;

    public InstantDoubleInstantColumnTupleSource(
    ...
    protected void convertChunks(@NotNull WritableChunk<? super Values> destination, int chunkSize, Chunk<? extends Values> [] chunks) {
        ...
        for (int ii = 0; ii < chunkSize; ++ii) {
            destinationObjectChunk.set(ii, new LongDoubleLongTuple(DateTimeUtils.epochNanos(chunk1.get(ii)), chunk2.get(ii), DateTimeUtils.epochNanos(chunk3.get(ii))));
        }
        destinationObjectChunk.setSize(chunkSize);
    }

    /** {@link ThreeColumnTupleSourceFactory} for instances of {@link InstantDoubleInstantColumnTupleSource}. **/
    private static final class Factory implements ThreeColumnTupleSourceFactory<LongDoubleLongTuple, Instant, Double, Instant> {
        ...
        public TupleSource<LongDoubleLongTuple> create(
            ...
            return new InstantDoubleInstantColumnTupleSource(
                    columnSource1,
                    columnSource2,
                    columnSource3
            );
