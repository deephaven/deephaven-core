...
/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types Boolean, Instant, and Boolean.
 */
@SuppressWarnings({"unused", "WeakerAccess"})
public class BooleanInstantBooleanColumnTupleSource extends AbstractTupleSource<ByteLongByteTuple> {

    /** {@link ThreeColumnTupleSourceFactory} instance to create instances of {@link BooleanInstantBooleanColumnTupleSource}. **/
    public static final ThreeColumnTupleSourceFactory<ByteLongByteTuple, Boolean, Instant, Boolean> FACTORY = new Factory();

    private final ColumnSource<Boolean> columnSource1;
    private final ColumnSource<Instant> columnSource2;
    private final ColumnSource<Boolean> columnSource3;

    public BooleanInstantBooleanColumnTupleSource(
    ...
    /** {@link ThreeColumnTupleSourceFactory} for instances of {@link BooleanInstantBooleanColumnTupleSource}. **/
    private static final class Factory implements ThreeColumnTupleSourceFactory<ByteLongByteTuple, Boolean, Instant, Boolean> {
        ...
        public TupleSource<ByteLongByteTuple> create(
            ...
            return new BooleanInstantBooleanColumnTupleSource(
                    columnSource1,
                    columnSource2,
                    columnSource3
            );
