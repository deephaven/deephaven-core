...
import io.deephaven.engine.tuple.generated.CharCharObjectTuple;
...
/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types Char, Char, and Object.
...
public class CharacterCharacterObjectColumnTupleSource extends AbstractTupleSource<CharCharObjectTuple> {
    ...
    public static final ThreeColumnTupleSourceFactory<CharCharObjectTuple, Char, Char, Object> FACTORY = new Factory();
    ...
    @Override
    public final CharCharObjectTuple createTuple(final long indexKey) {
    ...
    @Override
    public final CharCharObjectTuple createPreviousTuple(final long indexKey) {
        return new CharCharObjectTuple(
    ...
    @Override
    public final <ELEMENT_TYPE> void exportElement(@NotNull final CharCharObjectTuple tuple, final int elementIndex, @NotNull final WritableColumnSource<ELEMENT_TYPE> writableSource, final long destinationIndexKey) {
        if (elementIndex == 0) {
    ...
    protected void convertChunks(@NotNull WritableChunk<? super Attributes.Values> destination, int chunkSize, Chunk<Attributes.Values> [] chunks) {
        WritableObjectChunk<CharCharObjectTuple, ? super Attributes.Values> destinationObjectChunk = destination.asWritableObjectChunk();
    ...
    private static final class Factory implements ThreeColumnTupleSourceFactory<CharCharObjectTuple, Char, Char, Object> {
