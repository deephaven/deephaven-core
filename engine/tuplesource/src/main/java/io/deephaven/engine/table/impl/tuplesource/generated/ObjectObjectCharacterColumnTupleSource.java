...
/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types Object, Object, and Char.
...
public class ObjectObjectCharacterColumnTupleSource extends AbstractTupleSource<ObjectObjectCharTuple> {
    ...
    public static final ThreeColumnTupleSourceFactory<ObjectObjectCharTuple, Object, Object, Char> FACTORY = new Factory();
    ...
    @Override
    public final <ELEMENT_TYPE> void exportElement(@NotNull final ObjectObjectCharTuple tuple, final int elementIndex, @NotNull final WritableColumnSource<ELEMENT_TYPE> writableSource, final long destinationIndexKey) {
        if (elementIndex == 0) {
    ...
    private static final class Factory implements ThreeColumnTupleSourceFactory<ObjectObjectCharTuple, Object, Object, Char> {
