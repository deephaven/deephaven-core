...
import io.deephaven.engine.tuple.generated.ShortFloatFloatTuple;
...
public class ShortFloatFloatColumnTupleSource extends AbstractTupleSource<ShortFloatFloatTuple> {
    ...
    @Override
    public final <ELEMENT_TYPE> void exportElement(@NotNull final ShortFloatFloatTuple tuple, final int elementIndex, @NotNull final WritableColumnSource<ELEMENT_TYPE> writableSource, final long destinationIndexKey) {
        if (elementIndex == 0) {
