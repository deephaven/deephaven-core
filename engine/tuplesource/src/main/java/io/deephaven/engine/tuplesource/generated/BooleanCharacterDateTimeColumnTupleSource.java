...
/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types Boolean, Char, and DateTime.
...
public class BooleanCharacterDateTimeColumnTupleSource extends AbstractTupleSource<ByteCharLongTuple> {
    ...
    public static final ThreeColumnTupleSourceFactory<ByteCharLongTuple, Boolean, Char, DateTime> FACTORY = new Factory();
    ...
    private static final class Factory implements ThreeColumnTupleSourceFactory<ByteCharLongTuple, Boolean, Char, DateTime> {
