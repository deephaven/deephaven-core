...
/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types Long, Instant, and Boolean.
 */
@SuppressWarnings({"unused", "WeakerAccess"})
public class ReinterpretedInstantInstantBooleanColumnTupleSource extends AbstractTupleSource<LongLongByteTuple> {

    /** {@link ThreeColumnTupleSourceFactory} instance to create instances of {@link ReinterpretedInstantInstantBooleanColumnTupleSource}. **/
    public static final ThreeColumnTupleSourceFactory<LongLongByteTuple, Long, Instant, Boolean> FACTORY = new Factory();

    private final ColumnSource<Long> columnSource1;
    private final ColumnSource<Instant> columnSource2;
    private final ColumnSource<Boolean> columnSource3;

    public ReinterpretedInstantInstantBooleanColumnTupleSource(
    ...
    /** {@link ThreeColumnTupleSourceFactory} for instances of {@link ReinterpretedInstantInstantBooleanColumnTupleSource}. **/
    private static final class Factory implements ThreeColumnTupleSourceFactory<LongLongByteTuple, Long, Instant, Boolean> {
        ...
        public TupleSource<LongLongByteTuple> create(
            ...
            return new ReinterpretedInstantInstantBooleanColumnTupleSource(
                    columnSource1,
                    columnSource2,
                    columnSource3
            );
