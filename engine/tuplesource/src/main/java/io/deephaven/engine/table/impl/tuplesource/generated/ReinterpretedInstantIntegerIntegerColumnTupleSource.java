...
public class ReinterpretedInstantIntegerIntegerColumnTupleSource extends AbstractTupleSource<LongIntIntTuple> {

    /** {@link ThreeColumnTupleSourceFactory} instance to create instances of {@link ReinterpretedInstantIntegerIntegerColumnTupleSource}. **/
    ...
    public ReinterpretedInstantIntegerIntegerColumnTupleSource(
    ...
    @Override
    public final void exportAllTo(final Object @NotNull [] dest, @NotNull final LongIntIntTuple tuple) {
    ...
    @Override
    public final void exportAllTo(final Object @NotNull [] dest, @NotNull final LongIntIntTuple tuple, final int @NotNull [] map) {
    ...
    @Override
    public final void exportAllReinterpretedTo(final Object @NotNull [] dest, @NotNull final LongIntIntTuple tuple) {
    ...
    @Override
    public final void exportAllReinterpretedTo(final Object @NotNull [] dest, @NotNull final LongIntIntTuple tuple, final int @NotNull [] map) {
    ...
    /** {@link ThreeColumnTupleSourceFactory} for instances of {@link ReinterpretedInstantIntegerIntegerColumnTupleSource}. **/
    private static final class Factory implements ThreeColumnTupleSourceFactory<LongIntIntTuple, Long, Integer, Integer> {
        ...
        public TupleSource<LongIntIntTuple> create(
            ...
            return new ReinterpretedInstantIntegerIntegerColumnTupleSource(
                    columnSource1,
                    columnSource2,
                    columnSource3
            );
