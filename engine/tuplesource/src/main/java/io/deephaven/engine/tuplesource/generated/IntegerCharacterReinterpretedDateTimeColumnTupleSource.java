...
/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types Int, Char, and Long.
...
public class IntegerCharacterReinterpretedDateTimeColumnTupleSource extends AbstractTupleSource<IntCharLongTuple> {
    ...
    public static final ThreeColumnTupleSourceFactory<IntCharLongTuple, Int, Char, Long> FACTORY = new Factory();
    ...
    private static final class Factory implements ThreeColumnTupleSourceFactory<IntCharLongTuple, Int, Char, Long> {
