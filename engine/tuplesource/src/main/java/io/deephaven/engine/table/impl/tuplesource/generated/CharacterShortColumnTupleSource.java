...
import io.deephaven.engine.tuple.generated.CharShortTuple;
import io.deephaven.util.type.TypeUtils;
import org.jetbrains.annotations.NotNull;


/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types Char and Short.
...
public class CharacterShortColumnTupleSource extends AbstractTupleSource<CharShortTuple> {
    ...
    public static final TwoColumnTupleSourceFactory<CharShortTuple, Char, Short> FACTORY = new Factory();
    ...
    @Override
    public final <ELEMENT_TYPE> void exportElement(@NotNull final CharShortTuple tuple, final int elementIndex, @NotNull final WritableColumnSource<ELEMENT_TYPE> writableSource, final long destinationIndexKey) {
        if (elementIndex == 0) {
    ...
    private static final class Factory implements TwoColumnTupleSourceFactory<CharShortTuple, Char, Short> {
