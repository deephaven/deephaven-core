...
/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types Instant and Byte.
 */
@SuppressWarnings({"unused", "WeakerAccess"})
public class InstantReinterpretedBooleanColumnTupleSource extends AbstractTupleSource<LongByteTuple> {

    /** {@link TwoColumnTupleSourceFactory} instance to create instances of {@link InstantReinterpretedBooleanColumnTupleSource}. **/
    public static final TwoColumnTupleSourceFactory<LongByteTuple, Instant, Byte> FACTORY = new Factory();

    private final ColumnSource<Instant> columnSource1;
    private final ColumnSource<Byte> columnSource2;

    public InstantReinterpretedBooleanColumnTupleSource(
    ...
    protected void convertChunks(@NotNull WritableChunk<? super Values> destination, int chunkSize, Chunk<? extends Values> [] chunks) {
        ...
        for (int ii = 0; ii < chunkSize; ++ii) {
            destinationObjectChunk.set(ii, new LongByteTuple(DateTimeUtils.epochNanos(chunk1.get(ii)), chunk2.get(ii)));
        }
    ...
    private static final class Factory implements TwoColumnTupleSourceFactory<LongByteTuple, Instant, Byte> {
        ...
        public TupleSource<LongByteTuple> create(
            ...
            return new InstantReinterpretedBooleanColumnTupleSource(
                    columnSource1,
                    columnSource2
            );
        }
