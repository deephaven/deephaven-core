...
import io.deephaven.engine.tuple.generated.ShortIntLongTuple;
...
/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types Short, Int, and Long.
 * <p>Generated by io.deephaven.replicators.TupleSourceCodeGenerator.
 */
@SuppressWarnings({"unused", "WeakerAccess"})
public class ShortIntegerReinterpretedDateTimeColumnTupleSource extends AbstractTupleSource<ShortIntLongTuple> {

    /** {@link ThreeColumnTupleSourceFactory} instance to create instances of {@link ShortIntegerReinterpretedDateTimeColumnTupleSource}. **/
    public static final ThreeColumnTupleSourceFactory<ShortIntLongTuple, Short, Int, Long> FACTORY = new Factory();

    private final ColumnSource<Short> columnSource1;
    private final ColumnSource<Int> columnSource2;
    private final ColumnSource<Long> columnSource3;

    public ShortIntegerReinterpretedDateTimeColumnTupleSource(
    ...
    @Override
    public final <ELEMENT_TYPE> void exportElement(@NotNull final ShortIntLongTuple tuple, final int elementIndex, @NotNull final WritableColumnSource<ELEMENT_TYPE> writableSource, final long destinationIndexKey) {
        if (elementIndex == 0) {
    ...
    /** {@link ThreeColumnTupleSourceFactory} for instances of {@link ShortIntegerReinterpretedDateTimeColumnTupleSource}. **/
    private static final class Factory implements ThreeColumnTupleSourceFactory<ShortIntLongTuple, Short, Int, Long> {
        ...
        public TupleSource<ShortIntLongTuple> create(
            ...
            return new ShortIntegerReinterpretedDateTimeColumnTupleSource(
                    columnSource1,
                    columnSource2,
                    columnSource3
            );
