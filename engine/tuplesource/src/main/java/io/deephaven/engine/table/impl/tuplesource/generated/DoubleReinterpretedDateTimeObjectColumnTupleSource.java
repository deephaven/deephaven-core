...
import io.deephaven.engine.tuple.generated.DoubleLongObjectTuple;
...
public class DoubleReinterpretedDateTimeObjectColumnTupleSource extends AbstractTupleSource<DoubleLongObjectTuple> {
    ...
    @Override
    public final <ELEMENT_TYPE> void exportElement(@NotNull final DoubleLongObjectTuple tuple, final int elementIndex, @NotNull final WritableColumnSource<ELEMENT_TYPE> writableSource, final long destinationIndexKey) {
        if (elementIndex == 0) {
