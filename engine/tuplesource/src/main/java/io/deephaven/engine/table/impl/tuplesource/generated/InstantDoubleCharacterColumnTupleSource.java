...
/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types Instant, Double, and Character.
 */
@SuppressWarnings({"unused", "WeakerAccess"})
public class InstantDoubleCharacterColumnTupleSource extends AbstractTupleSource<LongDoubleCharTuple> {

    /** {@link ThreeColumnTupleSourceFactory} instance to create instances of {@link InstantDoubleCharacterColumnTupleSource}. **/
    public static final ThreeColumnTupleSourceFactory<LongDoubleCharTuple, Instant, Double, Character> FACTORY = new Factory();

    private final ColumnSource<Instant> columnSource1;
    private final ColumnSource<Double> columnSource2;
    private final ColumnSource<Character> columnSource3;

    public InstantDoubleCharacterColumnTupleSource(
    ...
    /** {@link ThreeColumnTupleSourceFactory} for instances of {@link InstantDoubleCharacterColumnTupleSource}. **/
    private static final class Factory implements ThreeColumnTupleSourceFactory<LongDoubleCharTuple, Instant, Double, Character> {
        ...
        public TupleSource<LongDoubleCharTuple> create(
            ...
            return new InstantDoubleCharacterColumnTupleSource(
                    columnSource1,
                    columnSource2,
                    columnSource3
            );
