...
/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types Char, Boolean, and Boolean.
...
public class CharacterBooleanBooleanColumnTupleSource extends AbstractTupleSource<CharByteByteTuple> {
    ...
    public static final ThreeColumnTupleSourceFactory<CharByteByteTuple, Char, Boolean, Boolean> FACTORY = new Factory();
    ...
    private static final class Factory implements ThreeColumnTupleSourceFactory<CharByteByteTuple, Char, Boolean, Boolean> {
