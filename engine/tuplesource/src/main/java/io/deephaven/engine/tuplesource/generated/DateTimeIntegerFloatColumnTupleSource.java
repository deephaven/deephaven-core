...
/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types DateTime, Int, and Float.
...
public class DateTimeIntegerFloatColumnTupleSource extends AbstractTupleSource<LongIntFloatTuple> {
    ...
    public static final ThreeColumnTupleSourceFactory<LongIntFloatTuple, DateTime, Int, Float> FACTORY = new Factory();
    ...
    private static final class Factory implements ThreeColumnTupleSourceFactory<LongIntFloatTuple, DateTime, Int, Float> {
