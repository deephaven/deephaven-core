...
import io.deephaven.engine.tuple.generated.ObjectByteTuple;
...
public class ObjectBooleanColumnTupleSource extends AbstractTupleSource<ObjectByteTuple> {
    ...
    @Override
    public final <ELEMENT_TYPE> void exportElement(@NotNull final ObjectByteTuple tuple, final int elementIndex, @NotNull final WritableColumnSource<ELEMENT_TYPE> writableSource, final long destinationIndexKey) {
        if (elementIndex == 0) {
