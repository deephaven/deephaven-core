...
/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types Byte, DateTime, and Byte.
...
public class ReinterpretedBooleanDateTimeReinterpretedBooleanColumnTupleSource extends AbstractTupleSource<ByteLongByteTuple> {
    ...
    public static final ThreeColumnTupleSourceFactory<ByteLongByteTuple, Byte, DateTime, Byte> FACTORY = new Factory();
    ...
    protected void convertChunks(@NotNull WritableChunk<? super Attributes.Values> destination, int chunkSize, Chunk<Attributes.Values> [] chunks) {
        ...
        for (int ii = 0; ii < chunkSize; ++ii) {
            destinationObjectChunk.set(ii, new ByteLongByteTuple(chunk1.get(ii), DateTimeUtils.nanos(chunk2.get(ii)), chunk3.get(ii)));
        }
    ...
    private static final class Factory implements ThreeColumnTupleSourceFactory<ByteLongByteTuple, Byte, DateTime, Byte> {
