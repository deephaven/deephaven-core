...
/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types Int, Long, and Double.
...
public class IntegerLongDoubleColumnTupleSource extends AbstractTupleSource<IntLongDoubleTuple> {
    ...
    public static final ThreeColumnTupleSourceFactory<IntLongDoubleTuple, Int, Long, Double> FACTORY = new Factory();
    ...
    private static final class Factory implements ThreeColumnTupleSourceFactory<IntLongDoubleTuple, Int, Long, Double> {
