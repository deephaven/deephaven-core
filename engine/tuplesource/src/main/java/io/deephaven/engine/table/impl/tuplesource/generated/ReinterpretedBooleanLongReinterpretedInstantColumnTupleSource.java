...
public class ReinterpretedBooleanLongReinterpretedInstantColumnTupleSource extends AbstractTupleSource<ByteLongLongTuple> {
    ...
    private static final class Factory implements ThreeColumnTupleSourceFactory<ByteLongLongTuple, Byte, Long, Long> {
        ...
        public TupleSource<ByteLongLongTuple> create(
            ...
            return new ReinterpretedBooleanLongReinterpretedInstantColumnTupleSource(
                    columnSource1,
                    columnSource2,
                    columnSource3
            );
