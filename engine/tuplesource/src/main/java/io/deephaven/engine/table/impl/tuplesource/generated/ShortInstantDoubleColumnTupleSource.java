...
/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types Short, Instant, and Double.
 */
@SuppressWarnings({"unused", "WeakerAccess"})
public class ShortInstantDoubleColumnTupleSource extends AbstractTupleSource<ShortLongDoubleTuple> {

    /** {@link ThreeColumnTupleSourceFactory} instance to create instances of {@link ShortInstantDoubleColumnTupleSource}. **/
    public static final ThreeColumnTupleSourceFactory<ShortLongDoubleTuple, Short, Instant, Double> FACTORY = new Factory();
    ...
    protected void convertChunks(@NotNull WritableChunk<? super Values> destination, int chunkSize, Chunk<? extends Values> [] chunks) {
        ...
        for (int ii = 0; ii < chunkSize; ++ii) {
            destinationObjectChunk.set(ii, new ShortLongDoubleTuple(chunk1.get(ii), DateTimeUtils.epochNanos(chunk2.get(ii)), chunk3.get(ii)));
        }
        destinationObjectChunk.setSize(chunkSize);
    }

    /** {@link ThreeColumnTupleSourceFactory} for instances of {@link ShortInstantDoubleColumnTupleSource}. **/
    private static final class Factory implements ThreeColumnTupleSourceFactory<ShortLongDoubleTuple, Short, Instant, Double> {
        ...
        public TupleSource<ShortLongDoubleTuple> create(
            ...
            return new ShortInstantDoubleColumnTupleSource(
                    columnSource1,
                    columnSource2,
                    columnSource3
            );
