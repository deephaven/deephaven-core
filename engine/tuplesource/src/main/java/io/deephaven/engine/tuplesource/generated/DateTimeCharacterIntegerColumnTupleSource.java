...
/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types DateTime, Char, and Int.
...
public class DateTimeCharacterIntegerColumnTupleSource extends AbstractTupleSource<LongCharIntTuple> {
    ...
    public static final ThreeColumnTupleSourceFactory<LongCharIntTuple, DateTime, Char, Int> FACTORY = new Factory();
    ...
    private static final class Factory implements ThreeColumnTupleSourceFactory<LongCharIntTuple, DateTime, Char, Int> {
