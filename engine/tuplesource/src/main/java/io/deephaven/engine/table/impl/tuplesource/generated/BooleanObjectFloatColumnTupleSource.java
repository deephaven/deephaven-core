...
import io.deephaven.engine.tuple.generated.ByteObjectFloatTuple;
...
public class BooleanObjectFloatColumnTupleSource extends AbstractTupleSource<ByteObjectFloatTuple> {
    ...
    @Override
    public final <ELEMENT_TYPE> void exportElement(@NotNull final ByteObjectFloatTuple tuple, final int elementIndex, @NotNull final WritableColumnSource<ELEMENT_TYPE> writableSource, final long destinationIndexKey) {
        if (elementIndex == 0) {
