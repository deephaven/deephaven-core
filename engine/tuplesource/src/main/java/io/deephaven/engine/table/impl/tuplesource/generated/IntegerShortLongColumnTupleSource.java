...
/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types Int, Short, and Long.
...
public class IntegerShortLongColumnTupleSource extends AbstractTupleSource<IntShortLongTuple> {
    ...
    public static final ThreeColumnTupleSourceFactory<IntShortLongTuple, Int, Short, Long> FACTORY = new Factory();
    ...
    @Override
    public final <ELEMENT_TYPE> void exportElement(@NotNull final IntShortLongTuple tuple, final int elementIndex, @NotNull final WritableColumnSource<ELEMENT_TYPE> writableSource, final long destinationIndexKey) {
        if (elementIndex == 0) {
    ...
    private static final class Factory implements ThreeColumnTupleSourceFactory<IntShortLongTuple, Int, Short, Long> {
