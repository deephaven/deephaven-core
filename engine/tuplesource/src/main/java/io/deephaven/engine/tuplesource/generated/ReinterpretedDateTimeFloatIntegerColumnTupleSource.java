...
/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types Long, Float, and Int.
...
public class ReinterpretedDateTimeFloatIntegerColumnTupleSource extends AbstractTupleSource<LongFloatIntTuple> {
    ...
    public static final ThreeColumnTupleSourceFactory<LongFloatIntTuple, Long, Float, Int> FACTORY = new Factory();
    ...
    private static final class Factory implements ThreeColumnTupleSourceFactory<LongFloatIntTuple, Long, Float, Int> {
