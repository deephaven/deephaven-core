...
import io.deephaven.engine.tuple.generated.CharObjectIntTuple;
import io.deephaven.util.type.TypeUtils;
import org.jetbrains.annotations.NotNull;


/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types Char, Object, and Int.
...
public class CharacterObjectIntegerColumnTupleSource extends AbstractTupleSource<CharObjectIntTuple> {
    ...
    public static final ThreeColumnTupleSourceFactory<CharObjectIntTuple, Char, Object, Int> FACTORY = new Factory();
    ...
    @Override
    public final <ELEMENT_TYPE> void exportElement(@NotNull final CharObjectIntTuple tuple, final int elementIndex, @NotNull final WritableColumnSource<ELEMENT_TYPE> writableSource, final long destinationIndexKey) {
        if (elementIndex == 0) {
    ...
    private static final class Factory implements ThreeColumnTupleSourceFactory<CharObjectIntTuple, Char, Object, Int> {
