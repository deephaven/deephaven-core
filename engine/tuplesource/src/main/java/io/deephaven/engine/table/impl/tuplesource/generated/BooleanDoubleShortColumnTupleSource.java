...
import io.deephaven.engine.tuple.generated.ByteDoubleShortTuple;
...
public class BooleanDoubleShortColumnTupleSource extends AbstractTupleSource<ByteDoubleShortTuple> {
    ...
    @Override
    public final <ELEMENT_TYPE> void exportElement(@NotNull final ByteDoubleShortTuple tuple, final int elementIndex, @NotNull final WritableColumnSource<ELEMENT_TYPE> writableSource, final long destinationIndexKey) {
        if (elementIndex == 0) {
