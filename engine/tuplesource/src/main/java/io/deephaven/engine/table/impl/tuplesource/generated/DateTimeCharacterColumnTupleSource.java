...
/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types DateTime and Char.
...
public class DateTimeCharacterColumnTupleSource extends AbstractTupleSource<LongCharTuple> {
    ...
    public static final TwoColumnTupleSourceFactory<LongCharTuple, DateTime, Char> FACTORY = new Factory();
    ...
    private static final class Factory implements TwoColumnTupleSourceFactory<LongCharTuple, DateTime, Char> {
