...
/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types Byte and Instant.
 */
@SuppressWarnings({"unused", "WeakerAccess"})
public class ByteInstantColumnTupleSource extends AbstractTupleSource<ByteLongTuple> {

    /** {@link TwoColumnTupleSourceFactory} instance to create instances of {@link ByteInstantColumnTupleSource}. **/
    public static final TwoColumnTupleSourceFactory<ByteLongTuple, Byte, Instant> FACTORY = new Factory();

    private final ColumnSource<Byte> columnSource1;
    private final ColumnSource<Instant> columnSource2;

    public ByteInstantColumnTupleSource(
    ...
    protected void convertChunks(@NotNull WritableChunk<? super Values> destination, int chunkSize, Chunk<? extends Values> [] chunks) {
        ...
        for (int ii = 0; ii < chunkSize; ++ii) {
            destinationObjectChunk.set(ii, new ByteLongTuple(chunk1.get(ii), DateTimeUtils.epochNanos(chunk2.get(ii))));
        }
    ...
    /** {@link TwoColumnTupleSourceFactory} for instances of {@link ByteInstantColumnTupleSource}. **/
    private static final class Factory implements TwoColumnTupleSourceFactory<ByteLongTuple, Byte, Instant> {
        ...
        public TupleSource<ByteLongTuple> create(
            ...
            return new ByteInstantColumnTupleSource(
                    columnSource1,
                    columnSource2
            );
        }
