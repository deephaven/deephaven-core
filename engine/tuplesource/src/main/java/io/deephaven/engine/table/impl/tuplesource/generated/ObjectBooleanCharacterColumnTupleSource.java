...
import io.deephaven.engine.tuple.generated.ObjectByteCharTuple;
...
/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types Object, Boolean, and Char.
...
public class ObjectBooleanCharacterColumnTupleSource extends AbstractTupleSource<ObjectByteCharTuple> {
    ...
    public static final ThreeColumnTupleSourceFactory<ObjectByteCharTuple, Object, Boolean, Char> FACTORY = new Factory();
    ...
    @Override
    public final <ELEMENT_TYPE> void exportElement(@NotNull final ObjectByteCharTuple tuple, final int elementIndex, @NotNull final WritableColumnSource<ELEMENT_TYPE> writableSource, final long destinationIndexKey) {
        if (elementIndex == 0) {
    ...
    private static final class Factory implements ThreeColumnTupleSourceFactory<ObjectByteCharTuple, Object, Boolean, Char> {
