...
/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types Char and Byte.
...
public class CharacterByteColumnTupleSource extends AbstractTupleSource<CharByteTuple> {
    ...
    public static final TwoColumnTupleSourceFactory<CharByteTuple, Char, Byte> FACTORY = new Factory();
    ...
    private static final class Factory implements TwoColumnTupleSourceFactory<CharByteTuple, Char, Byte> {
