...
/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types Char, DateTime, and Char.
...
public class CharacterDateTimeCharacterColumnTupleSource extends AbstractTupleSource<CharLongCharTuple> {
    ...
    public static final ThreeColumnTupleSourceFactory<CharLongCharTuple, Char, DateTime, Char> FACTORY = new Factory();
    ...
    private static final class Factory implements ThreeColumnTupleSourceFactory<CharLongCharTuple, Char, DateTime, Char> {
