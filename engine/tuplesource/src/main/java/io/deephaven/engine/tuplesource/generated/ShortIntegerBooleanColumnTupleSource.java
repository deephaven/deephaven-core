...
import io.deephaven.engine.tuple.generated.ShortIntByteTuple;
...
/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types Short, Int, and Boolean.
...
public class ShortIntegerBooleanColumnTupleSource extends AbstractTupleSource<ShortIntByteTuple> {
    ...
    public static final ThreeColumnTupleSourceFactory<ShortIntByteTuple, Short, Int, Boolean> FACTORY = new Factory();
    ...
    @Override
    public final <ELEMENT_TYPE> void exportElement(@NotNull final ShortIntByteTuple tuple, final int elementIndex, @NotNull final WritableColumnSource<ELEMENT_TYPE> writableSource, final long destinationIndexKey) {
        if (elementIndex == 0) {
    ...
    private static final class Factory implements ThreeColumnTupleSourceFactory<ShortIntByteTuple, Short, Int, Boolean> {
