...
import io.deephaven.engine.tuple.generated.ObjectDoubleIntTuple;
import io.deephaven.util.type.TypeUtils;
import org.jetbrains.annotations.NotNull;


/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types Object, Double, and Int.
...
public class ObjectDoubleIntegerColumnTupleSource extends AbstractTupleSource<ObjectDoubleIntTuple> {
    ...
    public static final ThreeColumnTupleSourceFactory<ObjectDoubleIntTuple, Object, Double, Int> FACTORY = new Factory();
    ...
    @Override
    public final <ELEMENT_TYPE> void exportElement(@NotNull final ObjectDoubleIntTuple tuple, final int elementIndex, @NotNull final WritableColumnSource<ELEMENT_TYPE> writableSource, final long destinationIndexKey) {
        if (elementIndex == 0) {
    ...
    private static final class Factory implements ThreeColumnTupleSourceFactory<ObjectDoubleIntTuple, Object, Double, Int> {
