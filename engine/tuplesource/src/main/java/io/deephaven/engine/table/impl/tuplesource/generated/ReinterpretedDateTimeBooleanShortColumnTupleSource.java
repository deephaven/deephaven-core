...
import io.deephaven.engine.tuple.generated.LongByteShortTuple;
...
public class ReinterpretedDateTimeBooleanShortColumnTupleSource extends AbstractTupleSource<LongByteShortTuple> {

    /** {@link ThreeColumnTupleSourceFactory} instance to create instances of {@link ReinterpretedDateTimeBooleanShortColumnTupleSource}. **/
    ...
    public ReinterpretedDateTimeBooleanShortColumnTupleSource(
    ...
    @Override
    public final <ELEMENT_TYPE> void exportElement(@NotNull final LongByteShortTuple tuple, final int elementIndex, @NotNull final WritableColumnSource<ELEMENT_TYPE> writableSource, final long destinationIndexKey) {
        if (elementIndex == 0) {
    ...
    /** {@link ThreeColumnTupleSourceFactory} for instances of {@link ReinterpretedDateTimeBooleanShortColumnTupleSource}. **/
    private static final class Factory implements ThreeColumnTupleSourceFactory<LongByteShortTuple, Long, Boolean, Short> {
        ...
        public TupleSource<LongByteShortTuple> create(
            ...
            return new ReinterpretedDateTimeBooleanShortColumnTupleSource(
                    columnSource1,
                    columnSource2,
                    columnSource3
            );
