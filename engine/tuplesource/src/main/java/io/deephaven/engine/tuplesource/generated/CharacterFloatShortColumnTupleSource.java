...
import io.deephaven.engine.tuple.generated.CharFloatShortTuple;
...
/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types Char, Float, and Short.
...
public class CharacterFloatShortColumnTupleSource extends AbstractTupleSource<CharFloatShortTuple> {
    ...
    public static final ThreeColumnTupleSourceFactory<CharFloatShortTuple, Char, Float, Short> FACTORY = new Factory();
    ...
    @Override
    public final <ELEMENT_TYPE> void exportElement(@NotNull final CharFloatShortTuple tuple, final int elementIndex, @NotNull final WritableColumnSource<ELEMENT_TYPE> writableSource, final long destinationIndexKey) {
        if (elementIndex == 0) {
    ...
    private static final class Factory implements ThreeColumnTupleSourceFactory<CharFloatShortTuple, Char, Float, Short> {
