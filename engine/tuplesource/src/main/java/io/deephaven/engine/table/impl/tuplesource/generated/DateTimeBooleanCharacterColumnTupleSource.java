...
/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types DateTime, Boolean, and Char.
...
public class DateTimeBooleanCharacterColumnTupleSource extends AbstractTupleSource<LongByteCharTuple> {
    ...
    public static final ThreeColumnTupleSourceFactory<LongByteCharTuple, DateTime, Boolean, Char> FACTORY = new Factory();
    ...
    private static final class Factory implements ThreeColumnTupleSourceFactory<LongByteCharTuple, DateTime, Boolean, Char> {
