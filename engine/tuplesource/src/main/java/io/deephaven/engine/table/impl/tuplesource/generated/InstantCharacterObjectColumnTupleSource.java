...
/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types Instant, Character, and Object.
 */
@SuppressWarnings({"unused", "WeakerAccess"})
public class InstantCharacterObjectColumnTupleSource extends AbstractTupleSource<LongCharObjectTuple> {

    /** {@link ThreeColumnTupleSourceFactory} instance to create instances of {@link InstantCharacterObjectColumnTupleSource}. **/
    public static final ThreeColumnTupleSourceFactory<LongCharObjectTuple, Instant, Character, Object> FACTORY = new Factory();

    private final ColumnSource<Instant> columnSource1;
    private final ColumnSource<Character> columnSource2;
    private final ColumnSource<Object> columnSource3;

    public InstantCharacterObjectColumnTupleSource(
    ...
    protected void convertChunks(@NotNull WritableChunk<? super Values> destination, int chunkSize, Chunk<? extends Values> [] chunks) {
        ...
        for (int ii = 0; ii < chunkSize; ++ii) {
            destinationObjectChunk.set(ii, new LongCharObjectTuple(DateTimeUtils.epochNanos(chunk1.get(ii)), chunk2.get(ii), chunk3.get(ii)));
        }
        destinationObjectChunk.setSize(chunkSize);
    }

    /** {@link ThreeColumnTupleSourceFactory} for instances of {@link InstantCharacterObjectColumnTupleSource}. **/
    private static final class Factory implements ThreeColumnTupleSourceFactory<LongCharObjectTuple, Instant, Character, Object> {
        ...
        public TupleSource<LongCharObjectTuple> create(
            ...
            return new InstantCharacterObjectColumnTupleSource(
                    columnSource1,
                    columnSource2,
                    columnSource3
            );
