...
public class ObjectDoubleByteColumnTupleSource extends AbstractTupleSource<ObjectDoubleByteTuple> {
    ...
    @Override
    public final <ELEMENT_TYPE> void exportElement(@NotNull final ObjectDoubleByteTuple tuple, final int elementIndex, @NotNull final WritableColumnSource<ELEMENT_TYPE> writableSource, final long destinationIndexKey) {
        if (elementIndex == 0) {
