...
/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types Short, Char, and Byte.
...
public class ShortCharacterByteColumnTupleSource extends AbstractTupleSource<ShortCharByteTuple> {
    ...
    public static final ThreeColumnTupleSourceFactory<ShortCharByteTuple, Short, Char, Byte> FACTORY = new Factory();
    ...
    @Override
    public final <ELEMENT_TYPE> void exportElement(@NotNull final ShortCharByteTuple tuple, final int elementIndex, @NotNull final WritableColumnSource<ELEMENT_TYPE> writableSource, final long destinationIndexKey) {
        if (elementIndex == 0) {
    ...
    private static final class Factory implements ThreeColumnTupleSourceFactory<ShortCharByteTuple, Short, Char, Byte> {
