...
/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types Int, Boolean, and Float.
...
public class IntegerBooleanFloatColumnTupleSource extends AbstractTupleSource<IntByteFloatTuple> {
    ...
    public static final ThreeColumnTupleSourceFactory<IntByteFloatTuple, Int, Boolean, Float> FACTORY = new Factory();
    ...
    private static final class Factory implements ThreeColumnTupleSourceFactory<IntByteFloatTuple, Int, Boolean, Float> {
