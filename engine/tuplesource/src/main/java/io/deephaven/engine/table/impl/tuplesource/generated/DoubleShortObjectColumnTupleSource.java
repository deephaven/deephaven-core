...
import io.deephaven.engine.tuple.generated.DoubleShortObjectTuple;
...
public class DoubleShortObjectColumnTupleSource extends AbstractTupleSource<DoubleShortObjectTuple> {
    ...
    @Override
    public final <ELEMENT_TYPE> void exportElement(@NotNull final DoubleShortObjectTuple tuple, final int elementIndex, @NotNull final WritableColumnSource<ELEMENT_TYPE> writableSource, final long destinationIndexKey) {
        if (elementIndex == 0) {
