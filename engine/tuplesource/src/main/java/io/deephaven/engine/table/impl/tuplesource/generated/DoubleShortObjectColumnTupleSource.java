...
import io.deephaven.tuple.generated.DoubleShortObjectTuple;
...
public class DoubleShortObjectColumnTupleSource extends AbstractTupleSource<DoubleShortObjectTuple> {
    ...
    @Override
    public final DoubleShortObjectTuple createTuple(final long rowKey) {
    ...
    @Override
    public final DoubleShortObjectTuple createPreviousTuple(final long rowKey) {
        return new DoubleShortObjectTuple(
    ...
    @Override
    public final <ELEMENT_TYPE> void exportElement(@NotNull final DoubleShortObjectTuple tuple, final int elementIndex, @NotNull final WritableColumnSource<ELEMENT_TYPE> writableSource, final long destinationRowKey) {
        if (elementIndex == 0) {
    ...
    @Override
    public final void exportAllTo(final Object @NotNull [] dest, @NotNull final DoubleShortObjectTuple tuple) {
    ...
    @Override
    public final void exportAllTo(final Object @NotNull [] dest, @NotNull final DoubleShortObjectTuple tuple, final int @NotNull [] map) {
    ...
    @Override
    public final void exportAllReinterpretedTo(final Object @NotNull [] dest, @NotNull final DoubleShortObjectTuple tuple) {
        dest[0] = TypeUtils.box(tuple.getFirstElement());
        dest[1] = TypeUtils.box(tuple.getSecondElement());
        dest[2] = tuple.getThirdElement();
    }
    ...
    @Override
    public final void exportAllReinterpretedTo(final Object @NotNull [] dest, @NotNull final DoubleShortObjectTuple tuple, final int @NotNull [] map) {
        dest[map[0]] = TypeUtils.box(tuple.getFirstElement());
        dest[map[1]] = TypeUtils.box(tuple.getSecondElement());
        dest[map[2]] = tuple.getThirdElement();
    }
    ...
    protected void convertChunks(@NotNull WritableChunk<? super Values> destination, int chunkSize, Chunk<? extends Values> [] chunks) {
        WritableObjectChunk<DoubleShortObjectTuple, ? super Values> destinationObjectChunk = destination.asWritableObjectChunk();
