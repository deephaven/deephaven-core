...
/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types Boolean, Int, and Double.
...
public class BooleanIntegerDoubleColumnTupleSource extends AbstractTupleSource<ByteIntDoubleTuple> {
    ...
    public static final ThreeColumnTupleSourceFactory<ByteIntDoubleTuple, Boolean, Int, Double> FACTORY = new Factory();
    ...
    private static final class Factory implements ThreeColumnTupleSourceFactory<ByteIntDoubleTuple, Boolean, Int, Double> {
