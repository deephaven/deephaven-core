...
/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types Object, DateTime, and Object.
...
public class ObjectDateTimeObjectColumnTupleSource extends AbstractTupleSource<ObjectLongObjectTuple> {
    ...
    public static final ThreeColumnTupleSourceFactory<ObjectLongObjectTuple, Object, DateTime, Object> FACTORY = new Factory();
    ...
    protected void convertChunks(@NotNull WritableChunk<? super Attributes.Values> destination, int chunkSize, Chunk<Attributes.Values> [] chunks) {
        ...
        for (int ii = 0; ii < chunkSize; ++ii) {
            destinationObjectChunk.set(ii, new ObjectLongObjectTuple(chunk1.get(ii), DateTimeUtils.nanos(chunk2.get(ii)), chunk3.get(ii)));
        }
        destinationObjectChunk.setSize(chunkSize);
    }

    /** {@link ThreeColumnTupleSourceFactory} for instances of {@link ObjectDateTimeObjectColumnTupleSource}. **/
    private static final class Factory implements ThreeColumnTupleSourceFactory<ObjectLongObjectTuple, Object, DateTime, Object> {
