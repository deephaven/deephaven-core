...
/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types Character, Integer, and Instant.
 */
@SuppressWarnings({"unused", "WeakerAccess"})
public class CharacterIntegerInstantColumnTupleSource extends AbstractTupleSource<CharIntLongTuple> {

    /** {@link ThreeColumnTupleSourceFactory} instance to create instances of {@link CharacterIntegerInstantColumnTupleSource}. **/
    public static final ThreeColumnTupleSourceFactory<CharIntLongTuple, Character, Integer, Instant> FACTORY = new Factory();

    private final ColumnSource<Character> columnSource1;
    private final ColumnSource<Integer> columnSource2;
    private final ColumnSource<Instant> columnSource3;

    public CharacterIntegerInstantColumnTupleSource(
    ...
    protected void convertChunks(@NotNull WritableChunk<? super Values> destination, int chunkSize, Chunk<? extends Values> [] chunks) {
        ...
        for (int ii = 0; ii < chunkSize; ++ii) {
            destinationObjectChunk.set(ii, new CharIntLongTuple(chunk1.get(ii), chunk2.get(ii), DateTimeUtils.epochNanos(chunk3.get(ii))));
        }
        destinationObjectChunk.setSize(chunkSize);
    }

    /** {@link ThreeColumnTupleSourceFactory} for instances of {@link CharacterIntegerInstantColumnTupleSource}. **/
    private static final class Factory implements ThreeColumnTupleSourceFactory<CharIntLongTuple, Character, Integer, Instant> {
        ...
        public TupleSource<CharIntLongTuple> create(
            ...
            return new CharacterIntegerInstantColumnTupleSource(
                    columnSource1,
                    columnSource2,
                    columnSource3
            );
