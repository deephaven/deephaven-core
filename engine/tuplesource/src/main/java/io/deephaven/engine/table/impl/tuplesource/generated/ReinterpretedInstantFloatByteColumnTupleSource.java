...
public class ReinterpretedInstantFloatByteColumnTupleSource extends AbstractTupleSource<LongFloatByteTuple> {
    ...
    public ReinterpretedInstantFloatByteColumnTupleSource(
    ...
    private static final class Factory implements ThreeColumnTupleSourceFactory<LongFloatByteTuple, Long, Float, Byte> {
        ...
        public TupleSource<LongFloatByteTuple> create(
            ...
            return new ReinterpretedInstantFloatByteColumnTupleSource(
                    columnSource1,
                    columnSource2,
                    columnSource3
            );
