...
import io.deephaven.tuple.generated.ByteCharObjectTuple;
import io.deephaven.util.type.TypeUtils;
import org.jetbrains.annotations.NotNull;


/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types Byte, Character, and Object.
 */
...
public class ByteCharacterObjectColumnTupleSource extends AbstractTupleSource<ByteCharObjectTuple> {
    ...
    public static final ThreeColumnTupleSourceFactory<ByteCharObjectTuple, Byte, Character, Object> FACTORY = new Factory();
    ...
    @Override
    public final ByteCharObjectTuple createTuple(final long rowKey) {
    ...
    @Override
    public final ByteCharObjectTuple createPreviousTuple(final long rowKey) {
        return new ByteCharObjectTuple(
    ...
    @Override
    public final <ELEMENT_TYPE> void exportElement(@NotNull final ByteCharObjectTuple tuple, final int elementIndex, @NotNull final WritableColumnSource<ELEMENT_TYPE> writableSource, final long destinationRowKey) {
        if (elementIndex == 0) {
    ...
    @Override
    public final void exportAllTo(final Object @NotNull [] dest, @NotNull final ByteCharObjectTuple tuple) {
    ...
    @Override
    public final void exportAllTo(final Object @NotNull [] dest, @NotNull final ByteCharObjectTuple tuple, final int @NotNull [] map) {
    ...
    @Override
    public final void exportAllReinterpretedTo(final Object @NotNull [] dest, @NotNull final ByteCharObjectTuple tuple) {
        dest[0] = TypeUtils.box(tuple.getFirstElement());
        dest[1] = TypeUtils.box(tuple.getSecondElement());
        dest[2] = tuple.getThirdElement();
    }
    ...
    @Override
    public final void exportAllReinterpretedTo(final Object @NotNull [] dest, @NotNull final ByteCharObjectTuple tuple, final int @NotNull [] map) {
        dest[map[0]] = TypeUtils.box(tuple.getFirstElement());
        dest[map[1]] = TypeUtils.box(tuple.getSecondElement());
        dest[map[2]] = tuple.getThirdElement();
    }
    ...
    private static final class Factory implements ThreeColumnTupleSourceFactory<ByteCharObjectTuple, Byte, Character, Object> {
