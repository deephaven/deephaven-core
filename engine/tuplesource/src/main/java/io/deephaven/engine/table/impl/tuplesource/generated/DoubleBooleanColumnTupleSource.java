...
import io.deephaven.engine.tuple.generated.DoubleByteTuple;
...
public class DoubleBooleanColumnTupleSource extends AbstractTupleSource<DoubleByteTuple> {
    ...
    @Override
    public final <ELEMENT_TYPE> void exportElement(@NotNull final DoubleByteTuple tuple, final int elementIndex, @NotNull final WritableColumnSource<ELEMENT_TYPE> writableSource, final long destinationIndexKey) {
        if (elementIndex == 0) {
