...
import io.deephaven.engine.tuple.generated.FloatIntFloatTuple;
import io.deephaven.util.type.TypeUtils;
import org.jetbrains.annotations.NotNull;


/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types Float, Int, and Float.
...
public class FloatIntegerFloatColumnTupleSource extends AbstractTupleSource<FloatIntFloatTuple> {
    ...
    public static final ThreeColumnTupleSourceFactory<FloatIntFloatTuple, Float, Int, Float> FACTORY = new Factory();
    ...
    @Override
    public final <ELEMENT_TYPE> void exportElement(@NotNull final FloatIntFloatTuple tuple, final int elementIndex, @NotNull final WritableColumnSource<ELEMENT_TYPE> writableSource, final long destinationIndexKey) {
        if (elementIndex == 0) {
    ...
    private static final class Factory implements ThreeColumnTupleSourceFactory<FloatIntFloatTuple, Float, Int, Float> {
