...
/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types Long and Int.
...
public class LongIntegerColumnTupleSource extends AbstractTupleSource<LongIntTuple> {
    ...
    public static final TwoColumnTupleSourceFactory<LongIntTuple, Long, Int> FACTORY = new Factory();
    ...
    private static final class Factory implements TwoColumnTupleSourceFactory<LongIntTuple, Long, Int> {
