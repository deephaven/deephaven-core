...
public class FloatReinterpretedInstantIntegerColumnTupleSource extends AbstractTupleSource<FloatLongIntTuple> {
    ...
    public FloatReinterpretedInstantIntegerColumnTupleSource(
    ...
    private static final class Factory implements ThreeColumnTupleSourceFactory<FloatLongIntTuple, Float, Long, Integer> {
        ...
        public TupleSource<FloatLongIntTuple> create(
            ...
            return new FloatReinterpretedInstantIntegerColumnTupleSource(
                    columnSource1,
                    columnSource2,
                    columnSource3
            );
