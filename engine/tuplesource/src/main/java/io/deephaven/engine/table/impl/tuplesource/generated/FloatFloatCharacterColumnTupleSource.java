...
import io.deephaven.engine.tuple.generated.FloatFloatCharTuple;
import io.deephaven.util.type.TypeUtils;
import org.jetbrains.annotations.NotNull;


/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types Float, Float, and Char.
...
public class FloatFloatCharacterColumnTupleSource extends AbstractTupleSource<FloatFloatCharTuple> {
    ...
    public static final ThreeColumnTupleSourceFactory<FloatFloatCharTuple, Float, Float, Char> FACTORY = new Factory();
    ...
    @Override
    public final <ELEMENT_TYPE> void exportElement(@NotNull final FloatFloatCharTuple tuple, final int elementIndex, @NotNull final WritableColumnSource<ELEMENT_TYPE> writableSource, final long destinationIndexKey) {
        if (elementIndex == 0) {
    ...
    private static final class Factory implements ThreeColumnTupleSourceFactory<FloatFloatCharTuple, Float, Float, Char> {
