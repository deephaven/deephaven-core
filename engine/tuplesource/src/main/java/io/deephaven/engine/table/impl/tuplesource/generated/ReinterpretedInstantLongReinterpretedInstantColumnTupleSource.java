...
public class ReinterpretedInstantLongReinterpretedInstantColumnTupleSource extends AbstractTupleSource<LongLongLongTuple> {
    ...
    public ReinterpretedInstantLongReinterpretedInstantColumnTupleSource(
    ...
    private static final class Factory implements ThreeColumnTupleSourceFactory<LongLongLongTuple, Long, Long, Long> {
        ...
        public TupleSource<LongLongLongTuple> create(
            ...
            return new ReinterpretedInstantLongReinterpretedInstantColumnTupleSource(
                    columnSource1,
                    columnSource2,
                    columnSource3
            );
