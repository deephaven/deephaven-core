...
public class ReinterpretedInstantCharacterShortColumnTupleSource extends AbstractTupleSource<LongCharShortTuple> {
    ...
    public ReinterpretedInstantCharacterShortColumnTupleSource(
    ...
    private static final class Factory implements ThreeColumnTupleSourceFactory<LongCharShortTuple, Long, Character, Short> {
        ...
        public TupleSource<LongCharShortTuple> create(
            ...
            return new ReinterpretedInstantCharacterShortColumnTupleSource(
                    columnSource1,
                    columnSource2,
                    columnSource3
            );
