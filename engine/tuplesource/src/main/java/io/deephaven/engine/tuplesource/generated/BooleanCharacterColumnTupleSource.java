...
/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types Boolean and Char.
...
public class BooleanCharacterColumnTupleSource extends AbstractTupleSource<ByteCharTuple> {
    ...
    public static final TwoColumnTupleSourceFactory<ByteCharTuple, Boolean, Char> FACTORY = new Factory();
    ...
    private static final class Factory implements TwoColumnTupleSourceFactory<ByteCharTuple, Boolean, Char> {
