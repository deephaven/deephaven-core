...
public class ReinterpretedBooleanIntegerIntegerColumnTupleSource extends AbstractTupleSource<ByteIntIntTuple> {
    ...
    @Override
    public final <ELEMENT_TYPE> void exportElement(@NotNull final ByteIntIntTuple tuple, final int elementIndex, @NotNull final WritableColumnSource<ELEMENT_TYPE> writableSource, final long destinationIndexKey) {
        if (elementIndex == 0) {
