...
public class ReinterpretedInstantShortBooleanColumnTupleSource extends AbstractTupleSource<LongShortByteTuple> {
    ...
    public ReinterpretedInstantShortBooleanColumnTupleSource(
