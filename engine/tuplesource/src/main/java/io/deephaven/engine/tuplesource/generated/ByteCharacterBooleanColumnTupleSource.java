...
/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types Byte, Char, and Boolean.
...
public class ByteCharacterBooleanColumnTupleSource extends AbstractTupleSource<ByteCharByteTuple> {
    ...
    public static final ThreeColumnTupleSourceFactory<ByteCharByteTuple, Byte, Char, Boolean> FACTORY = new Factory();
    ...
    private static final class Factory implements ThreeColumnTupleSourceFactory<ByteCharByteTuple, Byte, Char, Boolean> {
