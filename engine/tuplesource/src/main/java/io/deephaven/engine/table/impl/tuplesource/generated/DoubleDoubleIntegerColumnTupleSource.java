...
import io.deephaven.engine.tuple.generated.DoubleDoubleIntTuple;
import io.deephaven.util.type.TypeUtils;
import org.jetbrains.annotations.NotNull;


/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types Double, Double, and Int.
...
public class DoubleDoubleIntegerColumnTupleSource extends AbstractTupleSource<DoubleDoubleIntTuple> {
    ...
    public static final ThreeColumnTupleSourceFactory<DoubleDoubleIntTuple, Double, Double, Int> FACTORY = new Factory();
    ...
    @Override
    public final <ELEMENT_TYPE> void exportElement(@NotNull final DoubleDoubleIntTuple tuple, final int elementIndex, @NotNull final WritableColumnSource<ELEMENT_TYPE> writableSource, final long destinationIndexKey) {
        if (elementIndex == 0) {
    ...
    private static final class Factory implements ThreeColumnTupleSourceFactory<DoubleDoubleIntTuple, Double, Double, Int> {
