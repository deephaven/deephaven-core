...
public class BooleanReinterpretedBooleanReinterpretedInstantColumnTupleSource extends AbstractTupleSource<ByteByteLongTuple> {
    ...
    public BooleanReinterpretedBooleanReinterpretedInstantColumnTupleSource(
    ...
    private static final class Factory implements ThreeColumnTupleSourceFactory<ByteByteLongTuple, Boolean, Byte, Long> {
        ...
        public TupleSource<ByteByteLongTuple> create(
            ...
            return new BooleanReinterpretedBooleanReinterpretedInstantColumnTupleSource(
                    columnSource1,
                    columnSource2,
                    columnSource3
            );
