...
import io.deephaven.engine.tuple.generated.ShortObjectTuple;
...
public class ShortObjectColumnTupleSource extends AbstractTupleSource<ShortObjectTuple> {
    ...
    @Override
    public final <ELEMENT_TYPE> void exportElement(@NotNull final ShortObjectTuple tuple, final int elementIndex, @NotNull final WritableColumnSource<ELEMENT_TYPE> writableSource, final long destinationIndexKey) {
        if (elementIndex == 0) {
