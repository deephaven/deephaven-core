...
import io.deephaven.engine.tuple.generated.ByteFloatFloatTuple;
...
public class BooleanFloatFloatColumnTupleSource extends AbstractTupleSource<ByteFloatFloatTuple> {
    ...
    @Override
    public final <ELEMENT_TYPE> void exportElement(@NotNull final ByteFloatFloatTuple tuple, final int elementIndex, @NotNull final WritableColumnSource<ELEMENT_TYPE> writableSource, final long destinationIndexKey) {
        if (elementIndex == 0) {
