...
/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types DateTime, Int, and Int.
...
public class DateTimeIntegerIntegerColumnTupleSource extends AbstractTupleSource<LongIntIntTuple> {
    ...
    public static final ThreeColumnTupleSourceFactory<LongIntIntTuple, DateTime, Int, Int> FACTORY = new Factory();
    ...
    private static final class Factory implements ThreeColumnTupleSourceFactory<LongIntIntTuple, DateTime, Int, Int> {
