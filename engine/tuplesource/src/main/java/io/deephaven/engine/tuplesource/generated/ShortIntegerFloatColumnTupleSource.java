...
import io.deephaven.engine.tuple.generated.ShortIntFloatTuple;
...
/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types Short, Int, and Float.
...
public class ShortIntegerFloatColumnTupleSource extends AbstractTupleSource<ShortIntFloatTuple> {
    ...
    public static final ThreeColumnTupleSourceFactory<ShortIntFloatTuple, Short, Int, Float> FACTORY = new Factory();
    ...
    @Override
    public final <ELEMENT_TYPE> void exportElement(@NotNull final ShortIntFloatTuple tuple, final int elementIndex, @NotNull final WritableColumnSource<ELEMENT_TYPE> writableSource, final long destinationIndexKey) {
        if (elementIndex == 0) {
    ...
    private static final class Factory implements ThreeColumnTupleSourceFactory<ShortIntFloatTuple, Short, Int, Float> {
