...
/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types Boolean, Int, and Byte.
...
public class BooleanIntegerByteColumnTupleSource extends AbstractTupleSource<ByteIntByteTuple> {
    ...
    public static final ThreeColumnTupleSourceFactory<ByteIntByteTuple, Boolean, Int, Byte> FACTORY = new Factory();
    ...
    private static final class Factory implements ThreeColumnTupleSourceFactory<ByteIntByteTuple, Boolean, Int, Byte> {
