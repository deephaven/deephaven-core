...
/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types DateTime, DateTime, and Int.
...
public class DateTimeDateTimeIntegerColumnTupleSource extends AbstractTupleSource<LongLongIntTuple> {
    ...
    public static final ThreeColumnTupleSourceFactory<LongLongIntTuple, DateTime, DateTime, Int> FACTORY = new Factory();
    ...
    private static final class Factory implements ThreeColumnTupleSourceFactory<LongLongIntTuple, DateTime, DateTime, Int> {
