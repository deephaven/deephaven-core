...
/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types Float, Int, and Byte.
...
public class FloatIntegerByteColumnTupleSource extends AbstractTupleSource<FloatIntByteTuple> {
    ...
    public static final ThreeColumnTupleSourceFactory<FloatIntByteTuple, Float, Int, Byte> FACTORY = new Factory();
    ...
    private static final class Factory implements ThreeColumnTupleSourceFactory<FloatIntByteTuple, Float, Int, Byte> {
