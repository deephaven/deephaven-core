...
public class ReinterpretedInstantLongCharacterColumnTupleSource extends AbstractTupleSource<LongLongCharTuple> {
    ...
    public ReinterpretedInstantLongCharacterColumnTupleSource(
