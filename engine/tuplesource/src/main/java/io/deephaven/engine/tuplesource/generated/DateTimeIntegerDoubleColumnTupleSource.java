...
/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types DateTime, Int, and Double.
...
public class DateTimeIntegerDoubleColumnTupleSource extends AbstractTupleSource<LongIntDoubleTuple> {
    ...
    public static final ThreeColumnTupleSourceFactory<LongIntDoubleTuple, DateTime, Int, Double> FACTORY = new Factory();
    ...
    private static final class Factory implements ThreeColumnTupleSourceFactory<LongIntDoubleTuple, DateTime, Int, Double> {
