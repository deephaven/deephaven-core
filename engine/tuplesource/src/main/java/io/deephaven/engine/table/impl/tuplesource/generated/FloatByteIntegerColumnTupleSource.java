...
public class FloatByteIntegerColumnTupleSource extends AbstractTupleSource<FloatByteIntTuple> {

    /** {@link ThreeColumnTupleSourceFactory} instance to create instances of {@link FloatByteIntegerColumnTupleSource}. **/
    ...
    public FloatByteIntegerColumnTupleSource(
    ...
    @Override
    public final void exportAllTo(final Object @NotNull [] dest, @NotNull final FloatByteIntTuple tuple) {
    ...
    @Override
    public final void exportAllTo(final Object @NotNull [] dest, @NotNull final FloatByteIntTuple tuple, final int @NotNull [] map) {
    ...
    @Override
    public final void exportAllReinterpretedTo(final Object @NotNull [] dest, @NotNull final FloatByteIntTuple tuple) {
        dest[0] = TypeUtils.box(tuple.getFirstElement());
        dest[1] = TypeUtils.box(tuple.getSecondElement());
        dest[2] = TypeUtils.box(tuple.getThirdElement());
    }
    ...
    @Override
    public final void exportAllReinterpretedTo(final Object @NotNull [] dest, @NotNull final FloatByteIntTuple tuple, final int @NotNull [] map) {
        dest[map[0]] = TypeUtils.box(tuple.getFirstElement());
        dest[map[1]] = TypeUtils.box(tuple.getSecondElement());
        dest[map[2]] = TypeUtils.box(tuple.getThirdElement());
    }
    ...
    /** {@link ThreeColumnTupleSourceFactory} for instances of {@link FloatByteIntegerColumnTupleSource}. **/
    private static final class Factory implements ThreeColumnTupleSourceFactory<FloatByteIntTuple, Float, Byte, Integer> {
        ...
        public TupleSource<FloatByteIntTuple> create(
            ...
            return new FloatByteIntegerColumnTupleSource(
                    columnSource1,
                    columnSource2,
                    columnSource3
            );
