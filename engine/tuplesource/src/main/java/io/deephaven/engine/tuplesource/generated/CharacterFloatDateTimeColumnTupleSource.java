...
/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types Char, Float, and DateTime.
...
public class CharacterFloatDateTimeColumnTupleSource extends AbstractTupleSource<CharFloatLongTuple> {
    ...
    public static final ThreeColumnTupleSourceFactory<CharFloatLongTuple, Char, Float, DateTime> FACTORY = new Factory();
    ...
    private static final class Factory implements ThreeColumnTupleSourceFactory<CharFloatLongTuple, Char, Float, DateTime> {
