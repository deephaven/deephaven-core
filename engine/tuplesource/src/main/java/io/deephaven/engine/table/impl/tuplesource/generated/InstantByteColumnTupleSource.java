...
public class InstantByteColumnTupleSource extends AbstractTupleSource<LongByteTuple> {

    /** {@link TwoColumnTupleSourceFactory} instance to create instances of {@link InstantByteColumnTupleSource}. **/
    ...
    public InstantByteColumnTupleSource(
    ...
    private static final class Factory implements TwoColumnTupleSourceFactory<LongByteTuple, Instant, Byte> {
        ...
        public TupleSource<LongByteTuple> create(
            ...
            return new InstantByteColumnTupleSource(
                    columnSource1,
                    columnSource2
            );
        }
