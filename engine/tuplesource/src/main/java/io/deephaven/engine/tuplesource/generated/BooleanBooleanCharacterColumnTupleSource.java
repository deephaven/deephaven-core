...
/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types Boolean, Boolean, and Char.
...
public class BooleanBooleanCharacterColumnTupleSource extends AbstractTupleSource<ByteByteCharTuple> {
    ...
    public static final ThreeColumnTupleSourceFactory<ByteByteCharTuple, Boolean, Boolean, Char> FACTORY = new Factory();
    ...
    private static final class Factory implements ThreeColumnTupleSourceFactory<ByteByteCharTuple, Boolean, Boolean, Char> {
