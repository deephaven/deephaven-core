...
import io.deephaven.engine.tuple.generated.ShortIntCharTuple;
...
/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types Short, Int, and Char.
...
public class ShortIntegerCharacterColumnTupleSource extends AbstractTupleSource<ShortIntCharTuple> {
    ...
    public static final ThreeColumnTupleSourceFactory<ShortIntCharTuple, Short, Int, Char> FACTORY = new Factory();
    ...
    @Override
    public final ShortIntCharTuple createTuple(final long indexKey) {
    ...
    @Override
    public final ShortIntCharTuple createPreviousTuple(final long indexKey) {
        return new ShortIntCharTuple(
    ...
    @Override
    public final <ELEMENT_TYPE> void exportElement(@NotNull final ShortIntCharTuple tuple, final int elementIndex, @NotNull final WritableColumnSource<ELEMENT_TYPE> writableSource, final long destinationIndexKey) {
        if (elementIndex == 0) {
    ...
    @Override
    public final Object exportToExternalKey(@NotNull final ShortIntCharTuple tuple) {
        return new SmartKey(
    ...
    protected void convertChunks(@NotNull WritableChunk<? super Attributes.Values> destination, int chunkSize, Chunk<Attributes.Values> [] chunks) {
        WritableObjectChunk<ShortIntCharTuple, ? super Attributes.Values> destinationObjectChunk = destination.asWritableObjectChunk();
    ...
    private static final class Factory implements ThreeColumnTupleSourceFactory<ShortIntCharTuple, Short, Int, Char> {
