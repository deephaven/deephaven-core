...
/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types Float, Char, and Byte.
...
public class FloatCharacterByteColumnTupleSource extends AbstractTupleSource<FloatCharByteTuple> {
    ...
    public static final ThreeColumnTupleSourceFactory<FloatCharByteTuple, Float, Char, Byte> FACTORY = new Factory();
    ...
    private static final class Factory implements ThreeColumnTupleSourceFactory<FloatCharByteTuple, Float, Char, Byte> {
