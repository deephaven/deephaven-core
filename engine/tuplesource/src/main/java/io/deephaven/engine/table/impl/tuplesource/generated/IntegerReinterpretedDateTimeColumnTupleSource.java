...
/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types Int and Long.
...
public class IntegerReinterpretedDateTimeColumnTupleSource extends AbstractTupleSource<IntLongTuple> {
    ...
    public static final TwoColumnTupleSourceFactory<IntLongTuple, Int, Long> FACTORY = new Factory();
    ...
    @Override
    public final <ELEMENT_TYPE> void exportElement(@NotNull final IntLongTuple tuple, final int elementIndex, @NotNull final WritableColumnSource<ELEMENT_TYPE> writableSource, final long destinationIndexKey) {
        if (elementIndex == 0) {
    ...
    private static final class Factory implements TwoColumnTupleSourceFactory<IntLongTuple, Int, Long> {
