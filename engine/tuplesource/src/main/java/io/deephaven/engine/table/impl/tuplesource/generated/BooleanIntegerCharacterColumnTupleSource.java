...
/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types Boolean, Int, and Char.
...
public class BooleanIntegerCharacterColumnTupleSource extends AbstractTupleSource<ByteIntCharTuple> {
    ...
    public static final ThreeColumnTupleSourceFactory<ByteIntCharTuple, Boolean, Int, Char> FACTORY = new Factory();
    ...
    private static final class Factory implements ThreeColumnTupleSourceFactory<ByteIntCharTuple, Boolean, Int, Char> {
