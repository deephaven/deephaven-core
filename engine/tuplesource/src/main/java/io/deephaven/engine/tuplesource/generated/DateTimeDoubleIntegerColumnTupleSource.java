...
/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types DateTime, Double, and Int.
...
public class DateTimeDoubleIntegerColumnTupleSource extends AbstractTupleSource<LongDoubleIntTuple> {
    ...
    public static final ThreeColumnTupleSourceFactory<LongDoubleIntTuple, DateTime, Double, Int> FACTORY = new Factory();
    ...
    private static final class Factory implements ThreeColumnTupleSourceFactory<LongDoubleIntTuple, DateTime, Double, Int> {
