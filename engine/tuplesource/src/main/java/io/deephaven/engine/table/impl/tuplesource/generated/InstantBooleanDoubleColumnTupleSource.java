...
/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types Instant, Boolean, and Double.
 */
@SuppressWarnings({"unused", "WeakerAccess"})
public class InstantBooleanDoubleColumnTupleSource extends AbstractTupleSource<LongByteDoubleTuple> {

    /** {@link ThreeColumnTupleSourceFactory} instance to create instances of {@link InstantBooleanDoubleColumnTupleSource}. **/
    public static final ThreeColumnTupleSourceFactory<LongByteDoubleTuple, Instant, Boolean, Double> FACTORY = new Factory();

    private final ColumnSource<Instant> columnSource1;
    private final ColumnSource<Boolean> columnSource2;
    private final ColumnSource<Double> columnSource3;

    public InstantBooleanDoubleColumnTupleSource(
    ...
    /** {@link ThreeColumnTupleSourceFactory} for instances of {@link InstantBooleanDoubleColumnTupleSource}. **/
    private static final class Factory implements ThreeColumnTupleSourceFactory<LongByteDoubleTuple, Instant, Boolean, Double> {
        ...
        public TupleSource<LongByteDoubleTuple> create(
            ...
            return new InstantBooleanDoubleColumnTupleSource(
                    columnSource1,
                    columnSource2,
                    columnSource3
            );
