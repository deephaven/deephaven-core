...
public class ReinterpretedInstantFloatObjectColumnTupleSource extends AbstractTupleSource<LongFloatObjectTuple> {
    ...
    public ReinterpretedInstantFloatObjectColumnTupleSource(
    ...
    private static final class Factory implements ThreeColumnTupleSourceFactory<LongFloatObjectTuple, Long, Float, Object> {
        ...
        public TupleSource<LongFloatObjectTuple> create(
            ...
            return new ReinterpretedInstantFloatObjectColumnTupleSource(
                    columnSource1,
                    columnSource2,
                    columnSource3
            );
