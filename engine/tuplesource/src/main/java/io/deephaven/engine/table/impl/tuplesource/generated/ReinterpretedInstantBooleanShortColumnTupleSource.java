...
public class ReinterpretedInstantBooleanShortColumnTupleSource extends AbstractTupleSource<LongByteShortTuple> {
    ...
    public ReinterpretedInstantBooleanShortColumnTupleSource(
