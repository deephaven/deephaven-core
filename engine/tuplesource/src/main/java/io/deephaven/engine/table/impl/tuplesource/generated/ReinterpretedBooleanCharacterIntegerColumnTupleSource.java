...
public class ReinterpretedBooleanCharacterIntegerColumnTupleSource extends AbstractTupleSource<ByteCharIntTuple> {
    ...
    @Override
    public final void exportAllTo(final Object @NotNull [] dest, @NotNull final ByteCharIntTuple tuple) {
    ...
    @Override
    public final void exportAllTo(final Object @NotNull [] dest, @NotNull final ByteCharIntTuple tuple, final int @NotNull [] map) {
    ...
    @Override
    public final void exportAllReinterpretedTo(final Object @NotNull [] dest, @NotNull final ByteCharIntTuple tuple) {
    ...
    @Override
    public final void exportAllReinterpretedTo(final Object @NotNull [] dest, @NotNull final ByteCharIntTuple tuple, final int @NotNull [] map) {
