...
import io.deephaven.engine.tuple.generated.CharFloatTuple;
...
/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types Char and Float.
...
public class CharacterFloatColumnTupleSource extends AbstractTupleSource<CharFloatTuple> {
    ...
    public static final TwoColumnTupleSourceFactory<CharFloatTuple, Char, Float> FACTORY = new Factory();
    ...
    @Override
    public final <ELEMENT_TYPE> void exportElement(@NotNull final CharFloatTuple tuple, final int elementIndex, @NotNull final WritableColumnSource<ELEMENT_TYPE> writableSource, final long destinationIndexKey) {
        if (elementIndex == 0) {
    ...
    private static final class Factory implements TwoColumnTupleSourceFactory<CharFloatTuple, Char, Float> {
