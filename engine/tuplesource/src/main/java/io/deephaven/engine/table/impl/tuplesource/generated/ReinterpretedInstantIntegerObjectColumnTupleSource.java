...
public class ReinterpretedInstantIntegerObjectColumnTupleSource extends AbstractTupleSource<LongIntObjectTuple> {
    ...
    public ReinterpretedInstantIntegerObjectColumnTupleSource(
    ...
    private static final class Factory implements ThreeColumnTupleSourceFactory<LongIntObjectTuple, Long, Integer, Object> {
        ...
        public TupleSource<LongIntObjectTuple> create(
            ...
            return new ReinterpretedInstantIntegerObjectColumnTupleSource(
                    columnSource1,
                    columnSource2,
                    columnSource3
            );
