...
import io.deephaven.engine.tuple.generated.CharCharDoubleTuple;
import io.deephaven.util.type.TypeUtils;
import org.jetbrains.annotations.NotNull;


/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types Char, Char, and Double.
...
public class CharacterCharacterDoubleColumnTupleSource extends AbstractTupleSource<CharCharDoubleTuple> {
    ...
    public static final ThreeColumnTupleSourceFactory<CharCharDoubleTuple, Char, Char, Double> FACTORY = new Factory();
    ...
    @Override
    public final <ELEMENT_TYPE> void exportElement(@NotNull final CharCharDoubleTuple tuple, final int elementIndex, @NotNull final WritableColumnSource<ELEMENT_TYPE> writableSource, final long destinationIndexKey) {
        if (elementIndex == 0) {
    ...
    private static final class Factory implements ThreeColumnTupleSourceFactory<CharCharDoubleTuple, Char, Char, Double> {
