...
public class ReinterpretedInstantReinterpretedBooleanReinterpretedBooleanColumnTupleSource extends AbstractTupleSource<LongByteByteTuple> {
    ...
    public ReinterpretedInstantReinterpretedBooleanReinterpretedBooleanColumnTupleSource(
    ...
    private static final class Factory implements ThreeColumnTupleSourceFactory<LongByteByteTuple, Long, Byte, Byte> {
        ...
        public TupleSource<LongByteByteTuple> create(
            ...
            return new ReinterpretedInstantReinterpretedBooleanReinterpretedBooleanColumnTupleSource(
                    columnSource1,
                    columnSource2,
                    columnSource3
            );
