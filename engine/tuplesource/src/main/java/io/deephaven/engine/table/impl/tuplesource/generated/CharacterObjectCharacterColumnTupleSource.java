...
import io.deephaven.tuple.generated.CharObjectCharTuple;
...
public class CharacterObjectCharacterColumnTupleSource extends AbstractTupleSource<CharObjectCharTuple> {
    ...
    @Override
    public final CharObjectCharTuple createTuple(final long rowKey) {
    ...
    @Override
    public final CharObjectCharTuple createPreviousTuple(final long rowKey) {
        return new CharObjectCharTuple(
    ...
    @Override
    public final <ELEMENT_TYPE> void exportElement(@NotNull final CharObjectCharTuple tuple, final int elementIndex, @NotNull final WritableColumnSource<ELEMENT_TYPE> writableSource, final long destinationRowKey) {
        if (elementIndex == 0) {
    ...
    @Override
    public final void exportAllTo(final Object @NotNull [] dest, @NotNull final CharObjectCharTuple tuple) {
    ...
    @Override
    public final void exportAllTo(final Object @NotNull [] dest, @NotNull final CharObjectCharTuple tuple, final int @NotNull [] map) {
    ...
    @Override
    public final void exportAllReinterpretedTo(final Object @NotNull [] dest, @NotNull final CharObjectCharTuple tuple) {
        dest[0] = TypeUtils.box(tuple.getFirstElement());
        dest[1] = tuple.getSecondElement();
        dest[2] = TypeUtils.box(tuple.getThirdElement());
    }
    ...
    @Override
    public final void exportAllReinterpretedTo(final Object @NotNull [] dest, @NotNull final CharObjectCharTuple tuple, final int @NotNull [] map) {
        dest[map[0]] = TypeUtils.box(tuple.getFirstElement());
        dest[map[1]] = tuple.getSecondElement();
        dest[map[2]] = TypeUtils.box(tuple.getThirdElement());
    }
    ...
    protected void convertChunks(@NotNull WritableChunk<? super Values> destination, int chunkSize, Chunk<? extends Values> [] chunks) {
        WritableObjectChunk<CharObjectCharTuple, ? super Values> destinationObjectChunk = destination.asWritableObjectChunk();
