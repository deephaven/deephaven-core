...
import io.deephaven.engine.tuple.generated.CharObjectCharTuple;
import io.deephaven.util.type.TypeUtils;
import org.jetbrains.annotations.NotNull;


/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types Char, Object, and Char.
...
public class CharacterObjectCharacterColumnTupleSource extends AbstractTupleSource<CharObjectCharTuple> {
    ...
    public static final ThreeColumnTupleSourceFactory<CharObjectCharTuple, Char, Object, Char> FACTORY = new Factory();
    ...
    @Override
    public final <ELEMENT_TYPE> void exportElement(@NotNull final CharObjectCharTuple tuple, final int elementIndex, @NotNull final WritableColumnSource<ELEMENT_TYPE> writableSource, final long destinationIndexKey) {
        if (elementIndex == 0) {
    ...
    private static final class Factory implements ThreeColumnTupleSourceFactory<CharObjectCharTuple, Char, Object, Char> {
