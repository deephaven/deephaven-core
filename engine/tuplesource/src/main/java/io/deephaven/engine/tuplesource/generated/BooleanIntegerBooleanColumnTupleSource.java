...
/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types Boolean, Int, and Boolean.
...
public class BooleanIntegerBooleanColumnTupleSource extends AbstractTupleSource<ByteIntByteTuple> {
    ...
    public static final ThreeColumnTupleSourceFactory<ByteIntByteTuple, Boolean, Int, Boolean> FACTORY = new Factory();
    ...
    private static final class Factory implements ThreeColumnTupleSourceFactory<ByteIntByteTuple, Boolean, Int, Boolean> {
