...
/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types Char, DateTime, and Double.
...
public class CharacterDateTimeDoubleColumnTupleSource extends AbstractTupleSource<CharLongDoubleTuple> {
    ...
    public static final ThreeColumnTupleSourceFactory<CharLongDoubleTuple, Char, DateTime, Double> FACTORY = new Factory();
    ...
    private static final class Factory implements ThreeColumnTupleSourceFactory<CharLongDoubleTuple, Char, DateTime, Double> {
