...
/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types DateTime, DateTime, and Char.
...
public class DateTimeDateTimeCharacterColumnTupleSource extends AbstractTupleSource<LongLongCharTuple> {
    ...
    public static final ThreeColumnTupleSourceFactory<LongLongCharTuple, DateTime, DateTime, Char> FACTORY = new Factory();
    ...
    protected void convertChunks(@NotNull WritableChunk<? super Attributes.Values> destination, int chunkSize, Chunk<Attributes.Values> [] chunks) {
        ...
        for (int ii = 0; ii < chunkSize; ++ii) {
            destinationObjectChunk.set(ii, new LongLongCharTuple(DateTimeUtils.nanos(chunk1.get(ii)), DateTimeUtils.nanos(chunk2.get(ii)), chunk3.get(ii)));
        }
        destinationObjectChunk.setSize(chunkSize);
    }

    /** {@link ThreeColumnTupleSourceFactory} for instances of {@link DateTimeDateTimeCharacterColumnTupleSource}. **/
    private static final class Factory implements ThreeColumnTupleSourceFactory<LongLongCharTuple, DateTime, DateTime, Char> {
