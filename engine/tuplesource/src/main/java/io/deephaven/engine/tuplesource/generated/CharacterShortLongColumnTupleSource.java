...
/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types Char, Short, and Long.
...
public class CharacterShortLongColumnTupleSource extends AbstractTupleSource<CharShortLongTuple> {
    ...
    public static final ThreeColumnTupleSourceFactory<CharShortLongTuple, Char, Short, Long> FACTORY = new Factory();
    ...
    @Override
    public final <ELEMENT_TYPE> void exportElement(@NotNull final CharShortLongTuple tuple, final int elementIndex, @NotNull final WritableSource<ELEMENT_TYPE> writableSource, final long destinationIndexKey) {
        if (elementIndex == 0) {
    ...
    private static final class Factory implements ThreeColumnTupleSourceFactory<CharShortLongTuple, Char, Short, Long> {
