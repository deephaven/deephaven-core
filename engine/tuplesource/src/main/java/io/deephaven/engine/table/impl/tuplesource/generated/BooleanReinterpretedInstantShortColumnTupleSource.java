...
public class BooleanReinterpretedInstantShortColumnTupleSource extends AbstractTupleSource<ByteLongShortTuple> {
    ...
    public BooleanReinterpretedInstantShortColumnTupleSource(
    ...
    private static final class Factory implements ThreeColumnTupleSourceFactory<ByteLongShortTuple, Boolean, Long, Short> {
        ...
        public TupleSource<ByteLongShortTuple> create(
            ...
            return new BooleanReinterpretedInstantShortColumnTupleSource(
                    columnSource1,
                    columnSource2,
                    columnSource3
            );
