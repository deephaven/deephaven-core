...
import io.deephaven.engine.tuple.generated.ShortLongCharTuple;
import io.deephaven.util.type.TypeUtils;
import org.jetbrains.annotations.NotNull;


/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types Short, DateTime, and Char.
...
public class ShortDateTimeCharacterColumnTupleSource extends AbstractTupleSource<ShortLongCharTuple> {
    ...
    public static final ThreeColumnTupleSourceFactory<ShortLongCharTuple, Short, DateTime, Char> FACTORY = new Factory();
    ...
    @Override
    public final <ELEMENT_TYPE> void exportElement(@NotNull final ShortLongCharTuple tuple, final int elementIndex, @NotNull final WritableColumnSource<ELEMENT_TYPE> writableSource, final long destinationIndexKey) {
        if (elementIndex == 0) {
    ...
    private static final class Factory implements ThreeColumnTupleSourceFactory<ShortLongCharTuple, Short, DateTime, Char> {
