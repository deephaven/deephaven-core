...
public class ReinterpretedInstantReinterpretedInstantShortColumnTupleSource extends AbstractTupleSource<LongLongShortTuple> {
    ...
    public ReinterpretedInstantReinterpretedInstantShortColumnTupleSource(
    ...
    private static final class Factory implements ThreeColumnTupleSourceFactory<LongLongShortTuple, Long, Long, Short> {
        ...
        public TupleSource<LongLongShortTuple> create(
            ...
            return new ReinterpretedInstantReinterpretedInstantShortColumnTupleSource(
                    columnSource1,
                    columnSource2,
                    columnSource3
            );
