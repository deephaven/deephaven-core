...
import io.deephaven.engine.tuple.generated.CharShortDoubleTuple;
import io.deephaven.util.type.TypeUtils;
import org.jetbrains.annotations.NotNull;


/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types Char, Short, and Double.
...
public class CharacterShortDoubleColumnTupleSource extends AbstractTupleSource<CharShortDoubleTuple> {
    ...
    public static final ThreeColumnTupleSourceFactory<CharShortDoubleTuple, Char, Short, Double> FACTORY = new Factory();
    ...
    @Override
    public final CharShortDoubleTuple createTuple(final long indexKey) {
    ...
    @Override
    public final CharShortDoubleTuple createPreviousTuple(final long indexKey) {
        return new CharShortDoubleTuple(
    ...
    @Override
    public final <ELEMENT_TYPE> void exportElement(@NotNull final CharShortDoubleTuple tuple, final int elementIndex, @NotNull final WritableColumnSource<ELEMENT_TYPE> writableSource, final long destinationIndexKey) {
        if (elementIndex == 0) {
    ...
    protected void convertChunks(@NotNull WritableChunk<? super Attributes.Values> destination, int chunkSize, Chunk<Attributes.Values> [] chunks) {
        WritableObjectChunk<CharShortDoubleTuple, ? super Attributes.Values> destinationObjectChunk = destination.asWritableObjectChunk();
    ...
    private static final class Factory implements ThreeColumnTupleSourceFactory<CharShortDoubleTuple, Char, Short, Double> {
