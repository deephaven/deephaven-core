...
import io.deephaven.engine.tuple.generated.IntIntCharTuple;
import io.deephaven.util.type.TypeUtils;
import org.jetbrains.annotations.NotNull;


/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types Int, Int, and Char.
...
public class IntegerIntegerCharacterColumnTupleSource extends AbstractTupleSource<IntIntCharTuple> {
    ...
    public static final ThreeColumnTupleSourceFactory<IntIntCharTuple, Int, Int, Char> FACTORY = new Factory();
    ...
    @Override
    public final <ELEMENT_TYPE> void exportElement(@NotNull final IntIntCharTuple tuple, final int elementIndex, @NotNull final WritableColumnSource<ELEMENT_TYPE> writableSource, final long destinationIndexKey) {
        if (elementIndex == 0) {
    ...
    private static final class Factory implements ThreeColumnTupleSourceFactory<IntIntCharTuple, Int, Int, Char> {
