...
import io.deephaven.engine.tuple.generated.DoubleCharObjectTuple;
...
/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types Double, Char, and Object.
...
public class DoubleCharacterObjectColumnTupleSource extends AbstractTupleSource<DoubleCharObjectTuple> {
    ...
    public static final ThreeColumnTupleSourceFactory<DoubleCharObjectTuple, Double, Char, Object> FACTORY = new Factory();
    ...
    @Override
    public final <ELEMENT_TYPE> void exportElement(@NotNull final DoubleCharObjectTuple tuple, final int elementIndex, @NotNull final WritableColumnSource<ELEMENT_TYPE> writableSource, final long destinationIndexKey) {
        if (elementIndex == 0) {
    ...
    private static final class Factory implements ThreeColumnTupleSourceFactory<DoubleCharObjectTuple, Double, Char, Object> {
