...
import io.deephaven.engine.tuple.generated.DoubleObjectFloatTuple;
...
public class DoubleObjectFloatColumnTupleSource extends AbstractTupleSource<DoubleObjectFloatTuple> {
    ...
    @Override
    public final <ELEMENT_TYPE> void exportElement(@NotNull final DoubleObjectFloatTuple tuple, final int elementIndex, @NotNull final WritableColumnSource<ELEMENT_TYPE> writableSource, final long destinationIndexKey) {
        if (elementIndex == 0) {
