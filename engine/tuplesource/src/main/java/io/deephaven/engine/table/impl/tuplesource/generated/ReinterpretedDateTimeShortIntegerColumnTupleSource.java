...
/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types Long, Short, and Int.
 * <p>Generated by io.deephaven.replicators.TupleSourceCodeGenerator.
 */
@SuppressWarnings({"unused", "WeakerAccess"})
public class ReinterpretedDateTimeShortIntegerColumnTupleSource extends AbstractTupleSource<LongShortIntTuple> {

    /** {@link ThreeColumnTupleSourceFactory} instance to create instances of {@link ReinterpretedDateTimeShortIntegerColumnTupleSource}. **/
    public static final ThreeColumnTupleSourceFactory<LongShortIntTuple, Long, Short, Int> FACTORY = new Factory();

    private final ColumnSource<Long> columnSource1;
    private final ColumnSource<Short> columnSource2;
    private final ColumnSource<Int> columnSource3;

    public ReinterpretedDateTimeShortIntegerColumnTupleSource(
    ...
    protected void convertChunks(@NotNull WritableChunk<? super Attributes.Values> destination, int chunkSize, Chunk<Attributes.Values> [] chunks) {
        WritableObjectChunk<LongShortIntTuple, ? super Attributes.Values> destinationObjectChunk = destination.asWritableObjectChunk();
    ...
    /** {@link ThreeColumnTupleSourceFactory} for instances of {@link ReinterpretedDateTimeShortIntegerColumnTupleSource}. **/
    private static final class Factory implements ThreeColumnTupleSourceFactory<LongShortIntTuple, Long, Short, Int> {
        ...
        public TupleSource<LongShortIntTuple> create(
            ...
            return new ReinterpretedDateTimeShortIntegerColumnTupleSource(
                    columnSource1,
                    columnSource2,
                    columnSource3
            );
