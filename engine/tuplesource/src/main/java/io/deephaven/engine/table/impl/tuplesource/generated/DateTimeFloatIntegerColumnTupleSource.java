...
/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types DateTime, Float, and Int.
...
public class DateTimeFloatIntegerColumnTupleSource extends AbstractTupleSource<LongFloatIntTuple> {
    ...
    public static final ThreeColumnTupleSourceFactory<LongFloatIntTuple, DateTime, Float, Int> FACTORY = new Factory();
    ...
    private static final class Factory implements ThreeColumnTupleSourceFactory<LongFloatIntTuple, DateTime, Float, Int> {
