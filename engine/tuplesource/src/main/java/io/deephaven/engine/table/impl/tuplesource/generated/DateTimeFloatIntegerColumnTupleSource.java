...
import io.deephaven.engine.tuple.generated.LongFloatIntTuple;
...
public class DateTimeFloatIntegerColumnTupleSource extends AbstractTupleSource<LongFloatIntTuple> {
    ...
    @Override
    public final <ELEMENT_TYPE> void exportElement(@NotNull final LongFloatIntTuple tuple, final int elementIndex, @NotNull final WritableColumnSource<ELEMENT_TYPE> writableSource, final long destinationIndexKey) {
        if (elementIndex == 0) {
