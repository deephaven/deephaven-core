...
/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types Float, DateTime, and Int.
...
public class FloatDateTimeIntegerColumnTupleSource extends AbstractTupleSource<FloatLongIntTuple> {
    ...
    public static final ThreeColumnTupleSourceFactory<FloatLongIntTuple, Float, DateTime, Int> FACTORY = new Factory();
    ...
    private static final class Factory implements ThreeColumnTupleSourceFactory<FloatLongIntTuple, Float, DateTime, Int> {
