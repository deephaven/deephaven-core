...
/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types Double, DateTime, and Char.
...
public class DoubleDateTimeCharacterColumnTupleSource extends AbstractTupleSource<DoubleLongCharTuple> {
    ...
    public static final ThreeColumnTupleSourceFactory<DoubleLongCharTuple, Double, DateTime, Char> FACTORY = new Factory();
    ...
    private static final class Factory implements ThreeColumnTupleSourceFactory<DoubleLongCharTuple, Double, DateTime, Char> {
