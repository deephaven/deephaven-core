...
import io.deephaven.engine.tuple.generated.ShortCharTuple;
import io.deephaven.util.type.TypeUtils;
import org.jetbrains.annotations.NotNull;


/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types Short and Char.
...
public class ShortCharacterColumnTupleSource extends AbstractTupleSource<ShortCharTuple> {
    ...
    public static final TwoColumnTupleSourceFactory<ShortCharTuple, Short, Char> FACTORY = new Factory();
    ...
    @Override
    public final <ELEMENT_TYPE> void exportElement(@NotNull final ShortCharTuple tuple, final int elementIndex, @NotNull final WritableColumnSource<ELEMENT_TYPE> writableSource, final long destinationIndexKey) {
        if (elementIndex == 0) {
    ...
    private static final class Factory implements TwoColumnTupleSourceFactory<ShortCharTuple, Short, Char> {
