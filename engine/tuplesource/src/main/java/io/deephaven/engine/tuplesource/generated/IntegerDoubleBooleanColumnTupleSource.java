...
/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types Int, Double, and Boolean.
...
public class IntegerDoubleBooleanColumnTupleSource extends AbstractTupleSource<IntDoubleByteTuple> {
    ...
    public static final ThreeColumnTupleSourceFactory<IntDoubleByteTuple, Int, Double, Boolean> FACTORY = new Factory();
    ...
    private static final class Factory implements ThreeColumnTupleSourceFactory<IntDoubleByteTuple, Int, Double, Boolean> {
