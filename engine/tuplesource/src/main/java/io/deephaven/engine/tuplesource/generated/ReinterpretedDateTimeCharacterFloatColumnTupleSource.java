...
/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types Long, Char, and Float.
...
public class ReinterpretedDateTimeCharacterFloatColumnTupleSource extends AbstractTupleSource<LongCharFloatTuple> {
    ...
    public static final ThreeColumnTupleSourceFactory<LongCharFloatTuple, Long, Char, Float> FACTORY = new Factory();
    ...
    private static final class Factory implements ThreeColumnTupleSourceFactory<LongCharFloatTuple, Long, Char, Float> {
