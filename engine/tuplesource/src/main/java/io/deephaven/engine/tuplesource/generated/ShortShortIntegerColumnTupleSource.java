...
import io.deephaven.engine.tuple.generated.ShortShortIntTuple;
...
/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types Short, Short, and Int.
...
public class ShortShortIntegerColumnTupleSource extends AbstractTupleSource<ShortShortIntTuple> {
    ...
    public static final ThreeColumnTupleSourceFactory<ShortShortIntTuple, Short, Short, Int> FACTORY = new Factory();
    ...
    @Override
    public final <ELEMENT_TYPE> void exportElement(@NotNull final ShortShortIntTuple tuple, final int elementIndex, @NotNull final WritableColumnSource<ELEMENT_TYPE> writableSource, final long destinationIndexKey) {
        if (elementIndex == 0) {
    ...
    private static final class Factory implements ThreeColumnTupleSourceFactory<ShortShortIntTuple, Short, Short, Int> {
