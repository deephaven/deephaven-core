...
/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types Character, Float, and Boolean.
 */
@SuppressWarnings({"unused", "WeakerAccess"})
public class CharacterFloatBooleanColumnTupleSource extends AbstractTupleSource<CharFloatByteTuple> {

    /** {@link ThreeColumnTupleSourceFactory} instance to create instances of {@link CharacterFloatBooleanColumnTupleSource}. **/
    public static final ThreeColumnTupleSourceFactory<CharFloatByteTuple, Character, Float, Boolean> FACTORY = new Factory();

    private final ColumnSource<Character> columnSource1;
    private final ColumnSource<Float> columnSource2;
    private final ColumnSource<Boolean> columnSource3;

    public CharacterFloatBooleanColumnTupleSource(
    ...
    protected void convertChunks(@NotNull WritableChunk<? super Values> destination, int chunkSize, Chunk<? extends Values> [] chunks) {
        ...
        for (int ii = 0; ii < chunkSize; ++ii) {
            destinationObjectChunk.set(ii, new CharFloatByteTuple(chunk1.get(ii), chunk2.get(ii), BooleanUtils.booleanAsByte(chunk3.get(ii))));
        }
        destinationObjectChunk.setSize(chunkSize);
    }

    /** {@link ThreeColumnTupleSourceFactory} for instances of {@link CharacterFloatBooleanColumnTupleSource}. **/
    private static final class Factory implements ThreeColumnTupleSourceFactory<CharFloatByteTuple, Character, Float, Boolean> {
        ...
        public TupleSource<CharFloatByteTuple> create(
            ...
            return new CharacterFloatBooleanColumnTupleSource(
                    columnSource1,
                    columnSource2,
                    columnSource3
            );
