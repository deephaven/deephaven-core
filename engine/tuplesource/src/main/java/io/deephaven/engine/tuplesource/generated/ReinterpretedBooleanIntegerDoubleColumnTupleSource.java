...
/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types Byte, Int, and Double.
...
public class ReinterpretedBooleanIntegerDoubleColumnTupleSource extends AbstractTupleSource<ByteIntDoubleTuple> {
    ...
    public static final ThreeColumnTupleSourceFactory<ByteIntDoubleTuple, Byte, Int, Double> FACTORY = new Factory();
    ...
    private static final class Factory implements ThreeColumnTupleSourceFactory<ByteIntDoubleTuple, Byte, Int, Double> {
