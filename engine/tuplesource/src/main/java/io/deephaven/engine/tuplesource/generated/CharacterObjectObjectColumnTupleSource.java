...
/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types Char, Object, and Object.
...
public class CharacterObjectObjectColumnTupleSource extends AbstractTupleSource<CharObjectObjectTuple> {
    ...
    public static final ThreeColumnTupleSourceFactory<CharObjectObjectTuple, Char, Object, Object> FACTORY = new Factory();
    ...
    @Override
    public final <ELEMENT_TYPE> void exportElement(@NotNull final CharObjectObjectTuple tuple, final int elementIndex, @NotNull final WritableColumnSource<ELEMENT_TYPE> writableSource, final long destinationIndexKey) {
        if (elementIndex == 0) {
    ...
    private static final class Factory implements ThreeColumnTupleSourceFactory<CharObjectObjectTuple, Char, Object, Object> {
