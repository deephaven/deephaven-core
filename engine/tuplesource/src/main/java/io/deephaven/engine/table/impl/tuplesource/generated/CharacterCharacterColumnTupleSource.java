...
import io.deephaven.engine.tuple.generated.CharCharTuple;
import io.deephaven.util.type.TypeUtils;
import org.jetbrains.annotations.NotNull;


/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types Char and Char.
...
public class CharacterCharacterColumnTupleSource extends AbstractTupleSource<CharCharTuple> {
    ...
    public static final TwoColumnTupleSourceFactory<CharCharTuple, Char, Char> FACTORY = new Factory();
    ...
    @Override
    public final <ELEMENT_TYPE> void exportElement(@NotNull final CharCharTuple tuple, final int elementIndex, @NotNull final WritableColumnSource<ELEMENT_TYPE> writableSource, final long destinationIndexKey) {
        if (elementIndex == 0) {
    ...
    private static final class Factory implements TwoColumnTupleSourceFactory<CharCharTuple, Char, Char> {
