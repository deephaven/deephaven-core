...
import io.deephaven.engine.tuple.generated.DoubleCharShortTuple;
import io.deephaven.util.type.TypeUtils;
import org.jetbrains.annotations.NotNull;


/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types Double, Char, and Short.
...
public class DoubleCharacterShortColumnTupleSource extends AbstractTupleSource<DoubleCharShortTuple> {
    ...
    public static final ThreeColumnTupleSourceFactory<DoubleCharShortTuple, Double, Char, Short> FACTORY = new Factory();
    ...
    @Override
    public final DoubleCharShortTuple createTuple(final long indexKey) {
    ...
    @Override
    public final DoubleCharShortTuple createPreviousTuple(final long indexKey) {
        return new DoubleCharShortTuple(
    ...
    @Override
    public final <ELEMENT_TYPE> void exportElement(@NotNull final DoubleCharShortTuple tuple, final int elementIndex, @NotNull final WritableColumnSource<ELEMENT_TYPE> writableSource, final long destinationIndexKey) {
        if (elementIndex == 0) {
    ...
    @Override
    public final Object exportToExternalKey(@NotNull final DoubleCharShortTuple tuple) {
        return new SmartKey(
    ...
    protected void convertChunks(@NotNull WritableChunk<? super Attributes.Values> destination, int chunkSize, Chunk<Attributes.Values> [] chunks) {
        WritableObjectChunk<DoubleCharShortTuple, ? super Attributes.Values> destinationObjectChunk = destination.asWritableObjectChunk();
    ...
    private static final class Factory implements ThreeColumnTupleSourceFactory<DoubleCharShortTuple, Double, Char, Short> {
