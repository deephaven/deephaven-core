...
import io.deephaven.engine.tuple.generated.ByteFloatCharTuple;
...
/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types Byte, Float, and Char.
...
public class ReinterpretedBooleanFloatCharacterColumnTupleSource extends AbstractTupleSource<ByteFloatCharTuple> {
    ...
    public static final ThreeColumnTupleSourceFactory<ByteFloatCharTuple, Byte, Float, Char> FACTORY = new Factory();
    ...
    @Override
    public final <ELEMENT_TYPE> void exportElement(@NotNull final ByteFloatCharTuple tuple, final int elementIndex, @NotNull final WritableColumnSource<ELEMENT_TYPE> writableSource, final long destinationIndexKey) {
        if (elementIndex == 0) {
    ...
    private static final class Factory implements ThreeColumnTupleSourceFactory<ByteFloatCharTuple, Byte, Float, Char> {
