...
import io.deephaven.engine.tuple.generated.ObjectFloatObjectTuple;
...
public class ObjectFloatObjectColumnTupleSource extends AbstractTupleSource<ObjectFloatObjectTuple> {
    ...
    @Override
    public final <ELEMENT_TYPE> void exportElement(@NotNull final ObjectFloatObjectTuple tuple, final int elementIndex, @NotNull final WritableColumnSource<ELEMENT_TYPE> writableSource, final long destinationIndexKey) {
        if (elementIndex == 0) {
