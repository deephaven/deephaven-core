...
public class RowSetFactoryUnionTest {
    ...
    public void empty() {
        try (
                final WritableRowSet actual = RowSetFactory.union(List.of())) {
    ...
    public void union() {
        ...
        try (
                ...
                final WritableRowSet actual = RowSetFactory.union(List.of(r1, r2, r3))) {
            assertThat(actual).isEqualTo(expected);
        }
    }

    @Test
    public void overlappingUnion() {
        try (
                final WritableRowSet r1 = RowSetFactory.fromRange(0, 9);
    ...
    public void outOfOrder() {
        try (
                ...
                final WritableRowSet e1 = r1.union(r2);
                final WritableRowSet expected = e1.union(r3);
                final WritableRowSet actual = RowSetFactory.union(List.of(r3, r2, r1))) {
            assertThat(actual).isEqualTo(expected);
        }
    }
}
