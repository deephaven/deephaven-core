...
public class TrackingWritableRowSetImplPrevTest {
    ...
    public void testPrevWithEmptyConstruction() {
        ...
        assertTrue(ix.prevCopy().isEmpty());
    }
    ...
    public void testPrevWithSingleRangeIxOnly() {
        ...
        assertEquals(1L, ix.prevCopy().size());
        assertEquals(1L, ix.prevCopy().firstRowKey());
        ix.insert(2L);
        assertEquals(1L, ix.prevCopy().size());
        assertEquals(1L, ix.prevCopy().firstRowKey());
        LogicalClock.DEFAULT.startUpdateCycle();
        assertEquals(2L, ix.prevCopy().size());
        assertEquals(2L, ix.prevCopy().lastRowKey());
        ix.insert(3L);
        ...
        LogicalClock.DEFAULT.startUpdateCycle();
        assertEquals(5L, ix.size());
        assertEquals(5L, ix.prevCopy().size());
        assertEquals(5L, ix.prevCopy().lastRowKey());
    }
    ...
    public void testPrevWithRspOnly() {
        ...
        assertEquals(2L, ix.prevCopy().size());
        assertEquals(1L, ix.prevCopy().firstRowKey());
        assertEquals(3L, ix.prevCopy().lastRowKey());
        ix.insert(5L);
        assertEquals(3L, ix.size());
        assertEquals(1L, ix.firstRowKey());
        ...
        assertEquals(3L, ix.prevCopy().lastRowKey());
        LogicalClock.DEFAULT.startUpdateCycle();
        assertEquals(3L, ix.prevCopy().size());
        assertEquals(1L, ix.prevCopy().firstRowKey());
        assertEquals(5L, ix.prevCopy().lastRowKey());
        ix.insert(7L);
        assertEquals(4L, ix.size());
        ...
        LogicalClock.DEFAULT.startUpdateCycle();
        assertEquals(6L, ix.size());
        assertEquals(6L, ix.prevCopy().size());
        assertEquals(11L, ix.prevCopy().lastRowKey());
    }
    ...
    public void testPrevWithSingleThenRspThenEmptyThenSingle() {
        ...
        LogicalClock.DEFAULT.completeUpdateCycle();
        assertEquals(1L, ix.prevCopy().size());
        assertEquals(1L, ix.prevCopy().lastRowKey());
        LogicalClock.DEFAULT.startUpdateCycle();
        assertEquals(2L, ix.prevCopy().size());
        assertEquals(3L, ix.prevCopy().lastRowKey());
        LogicalClock.DEFAULT.completeUpdateCycle();
