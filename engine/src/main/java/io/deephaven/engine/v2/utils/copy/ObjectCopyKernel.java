...
public class ObjectCopyKernel implements CopyKernel {
    ...
    public static <T extends Any> void conditionalCopy(
            WritableObjectChunk<Object, T> output, Object[] baseInput, Object[] overInput,
            long[] useOverInput, int srcOffset, int dstOffset, int length)
    {
        int bitsSet = 0;
    ...
    public <T extends Any> void conditionalCopy(
            WritableChunk<T> output, Object baseInput, Object overInput,
            long[] useOverInput, int srcOffset, int dstOffset, int length)
    {
        Object[] typedBaseInput = (Object[]) baseInput;
        Object[] typedOverInput = (Object[]) overInput;
