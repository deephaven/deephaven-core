 ...
 * ------------------------------------------------------------------------------------------------------------------ */
package io.deephaven.engine.v2.sources.sparse;
...
public final class ByteOneOrN {
    private static final int ONE_UNINITIALIZED = -1;
    private static final int HAVE_MORE_THAN_ONE = -2;

    private ByteOneOrN() {
        throw new IllegalStateException("ByteOneOrN class should never be constructed.");
    }
    ...
    static public final class Block0 {
        ...
        public void enumerate(byte nullValue, LongConsumer consumer) {
            if (oneIndex == ONE_UNINITIALIZED) {
                return;
            }
    ...
    static public final class Block1 {
        ...
        void enumerate(byte nullValue, LongConsumer consumer, long offset) {
            if (oneIndex == ONE_UNINITIALIZED) {
                return;
            }
            if (oneIndex != HAVE_MORE_THAN_ONE) {
    ...
    static public final class Block2 {
        ...
        private static void enumerateInner(byte nullValue, byte[] inner, LongConsumer consumer, long offset) {
