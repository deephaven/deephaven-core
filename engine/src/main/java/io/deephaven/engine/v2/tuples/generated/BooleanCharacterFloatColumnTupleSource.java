...
import io.deephaven.engine.util.tuples.generated.ByteCharFloatTuple;
...
/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types Boolean, Character, and Float.
...
public class BooleanCharacterFloatColumnTupleSource extends AbstractTupleSource<ByteCharFloatTuple> {
    ...
    public static final ThreeColumnTupleSourceFactory<ByteCharFloatTuple, Boolean, Character, Float> FACTORY = new Factory();
    ...
    private static final class Factory implements ThreeColumnTupleSourceFactory<ByteCharFloatTuple, Boolean, Character, Float> {
