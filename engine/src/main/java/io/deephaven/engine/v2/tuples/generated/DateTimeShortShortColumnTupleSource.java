...
import io.deephaven.engine.util.tuples.generated.LongShortShortTuple;
...
/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types DBDateTime, Short, and Short.
...
public class DateTimeShortShortColumnTupleSource extends AbstractTupleSource<LongShortShortTuple> {
    ...
    public static final ThreeColumnTupleSourceFactory<LongShortShortTuple, DBDateTime, Short, Short> FACTORY = new Factory();
    ...
    protected void convertChunks(@NotNull WritableChunk<? super Attributes.Values> destination, int chunkSize, Chunk<Attributes.Values> [] chunks) {
        ...
        for (int ii = 0; ii < chunkSize; ++ii) {
            destinationObjectChunk.set(ii, new LongShortShortTuple(DBTimeUtils.nanos(chunk1.get(ii)), chunk2.get(ii), chunk3.get(ii)));
        }
        destinationObjectChunk.setSize(chunkSize);
    }

    /** {@link ThreeColumnTupleSourceFactory} for instances of {@link DateTimeShortShortColumnTupleSource}. **/
    private static final class Factory implements ThreeColumnTupleSourceFactory<LongShortShortTuple, DBDateTime, Short, Short> {
