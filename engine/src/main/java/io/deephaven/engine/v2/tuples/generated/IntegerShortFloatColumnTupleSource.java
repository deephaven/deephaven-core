...
import io.deephaven.engine.util.tuples.generated.IntShortFloatTuple;
...
public class IntegerShortFloatColumnTupleSource extends AbstractTupleSource<IntShortFloatTuple> {
    ...
    @Override
    public final <ELEMENT_TYPE> void exportElement(@NotNull final IntShortFloatTuple tuple, final int elementIndex, @NotNull final WritableSource<ELEMENT_TYPE> writableSource, final long destinationIndexKey) {
        if (elementIndex == 0) {
