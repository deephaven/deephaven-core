...
import io.deephaven.engine.util.tuples.generated.IntFloatLongTuple;
...
public class IntegerFloatReinterpretedDateTimeColumnTupleSource extends AbstractTupleSource<IntFloatLongTuple> {
    ...
    @Override
    public final <ELEMENT_TYPE> void exportElement(@NotNull final IntFloatLongTuple tuple, final int elementIndex, @NotNull final WritableSource<ELEMENT_TYPE> writableSource, final long destinationIndexKey) {
        if (elementIndex == 0) {
