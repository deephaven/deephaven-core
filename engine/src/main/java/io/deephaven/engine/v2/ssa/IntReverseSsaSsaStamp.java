...
public class IntReverseSsaSsaStamp implements SsaSsaStamp {
    ...
    static private void processRemovals(IntReverseSegmentedSortedArray leftSsa, IntChunk<? extends Values> rightStampChunk, LongChunk<KeyIndices> rightKeys, WritableLongChunk<KeyIndices> nextRedirections, RedirectionIndex redirectionIndex, Index.RandomBuilder modifiedBuilder, boolean disallowExactMatch) {
    ...
    static private void processInsertion(IntReverseSegmentedSortedArray leftSsa, IntChunk<? extends Values> rightStampChunk, LongChunk<KeyIndices> rightKeys, IntChunk<Values> nextRightValue, RedirectionIndex redirectionIndex, Index.RandomBuilder modifiedBuilder, boolean endsWithLastValue, boolean disallowExactMatch) {
    ...
    private static void findModified(IntReverseSegmentedSortedArray leftSsa, RedirectionIndex redirectionIndex, IntChunk<? extends Values> rightStampChunk, LongChunk<KeyIndices> rightStampIndices, Index.RandomBuilder modifiedBuilder, boolean disallowExactMatch) {
        final IntReverseSegmentedSortedArray.Iterator leftIt = leftSsa.iterator(disallowExactMatch, false);
    ...
    private void applyShift(IntReverseSegmentedSortedArray leftSsa, IntChunk<? extends Values> rightStampChunk, LongChunk<KeyIndices> rightStampKeys, long shiftDelta, RedirectionIndex redirectionIndex, boolean disallowExactMatch) {
        final IntReverseSegmentedSortedArray.Iterator leftIt = leftSsa.iterator(disallowExactMatch, false);
