...
/**
 * <p>3-Tuple (triple) key class composed of Object, Object, and float elements.
 * <p>Generated by {@link io.deephaven.engine.util.tuples.TupleCodeGenerator}.
 */
public class ObjectObjectFloatTuple implements Comparable<ObjectObjectFloatTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<ObjectObjectFloatTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final ObjectObjectFloatTuple typedOther = (ObjectObjectFloatTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final ObjectObjectFloatTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public ObjectObjectFloatTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        ...
        return canonicalizedElement1 == element1 && canonicalizedElement2 == element2
                ? this : new ObjectObjectFloatTuple(canonicalizedElement1, canonicalizedElement2, element3);
    }
}
