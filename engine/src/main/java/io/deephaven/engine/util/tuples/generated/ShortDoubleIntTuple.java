...
/**
 * <p>3-Tuple (triple) key class composed of short, double, and int elements.
 * <p>Generated by {@link io.deephaven.engine.util.tuples.TupleCodeGenerator}.
 */
public class ShortDoubleIntTuple implements Comparable<ShortDoubleIntTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<ShortDoubleIntTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final ShortDoubleIntTuple typedOther = (ShortDoubleIntTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final ShortDoubleIntTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public ShortDoubleIntTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        return this;
    }
}
