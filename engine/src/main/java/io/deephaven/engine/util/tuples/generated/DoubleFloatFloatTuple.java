...
/**
 * <p>3-Tuple (triple) key class composed of double, float, and float elements.
 * <p>Generated by {@link io.deephaven.engine.util.tuples.TupleCodeGenerator}.
 */
public class DoubleFloatFloatTuple implements Comparable<DoubleFloatFloatTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<DoubleFloatFloatTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final DoubleFloatFloatTuple typedOther = (DoubleFloatFloatTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final DoubleFloatFloatTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public DoubleFloatFloatTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        return this;
    }
}
