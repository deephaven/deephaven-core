...
/**
 * <p>3-Tuple (triple) key class composed of Object, float, and short elements.
 * <p>Generated by {@link io.deephaven.engine.util.tuples.TupleCodeGenerator}.
 */
public class ObjectFloatShortTuple implements Comparable<ObjectFloatShortTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<ObjectFloatShortTuple> {
    ...
    @Override
    public final int compareTo(@NotNull final ObjectFloatShortTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public ObjectFloatShortTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        final Object canonicalizedElement1 = canonicalizer.apply(element1);
        return canonicalizedElement1 == element1
                ? this : new ObjectFloatShortTuple(canonicalizedElement1, element2, element3);
    }
}
