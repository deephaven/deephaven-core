...
/**
 * <p>2-Tuple (double) key class composed of Object and Object elements.
 * <p>Generated by {@link io.deephaven.engine.util.tuples.TupleCodeGenerator}.
 */
public class ObjectObjectTuple implements Comparable<ObjectObjectTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<ObjectObjectTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final ObjectObjectTuple typedOther = (ObjectObjectTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final ObjectObjectTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
        ...
        return 0 != (comparison = DBLanguageFunctionUtil.compareTo((Comparable)element1, (Comparable)other.element1)) ? comparison :
               DBLanguageFunctionUtil.compareTo((Comparable)element2, (Comparable)other.element2);
        // @formatter:on
    }
    ...
    public String toString() {
        return "ObjectObjectTuple{" +
                element1 + ", " +
                element2 + '}';
    }

    @Override
    public ObjectObjectTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        ...
        return canonicalizedElement1 == element1 && canonicalizedElement2 == element2
                ? this : new ObjectObjectTuple(canonicalizedElement1, canonicalizedElement2);
    }
}
