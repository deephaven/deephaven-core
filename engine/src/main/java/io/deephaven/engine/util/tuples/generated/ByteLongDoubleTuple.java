...
/**
 * <p>3-Tuple (triple) key class composed of byte, long, and double elements.
 * <p>Generated by {@link io.deephaven.engine.util.tuples.TupleCodeGenerator}.
 */
public class ByteLongDoubleTuple implements Comparable<ByteLongDoubleTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<ByteLongDoubleTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final ByteLongDoubleTuple typedOther = (ByteLongDoubleTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final ByteLongDoubleTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public ByteLongDoubleTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        return this;
    }
}
