...
/**
 * <p>3-Tuple (triple) key class composed of double, Object, and float elements.
 * <p>Generated by {@link io.deephaven.engine.util.tuples.TupleCodeGenerator}.
 */
public class DoubleObjectFloatTuple implements Comparable<DoubleObjectFloatTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<DoubleObjectFloatTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final DoubleObjectFloatTuple typedOther = (DoubleObjectFloatTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final DoubleObjectFloatTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public DoubleObjectFloatTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        final Object canonicalizedElement2 = canonicalizer.apply(element2);
        return canonicalizedElement2 == element2
                ? this : new DoubleObjectFloatTuple(element1, canonicalizedElement2, element3);
    }
}
