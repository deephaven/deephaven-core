...
/**
 * <p>3-Tuple (triple) key class composed of char, long, and float elements.
 * <p>Generated by {@link io.deephaven.engine.util.tuples.TupleCodeGenerator}.
 */
public class CharLongFloatTuple implements Comparable<CharLongFloatTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<CharLongFloatTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final CharLongFloatTuple typedOther = (CharLongFloatTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final CharLongFloatTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public CharLongFloatTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        return this;
    }
}
