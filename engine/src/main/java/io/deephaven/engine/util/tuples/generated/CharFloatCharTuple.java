...
/**
 * <p>3-Tuple (triple) key class composed of char, float, and char elements.
 * <p>Generated by {@link io.deephaven.engine.util.tuples.TupleCodeGenerator}.
 */
public class CharFloatCharTuple implements Comparable<CharFloatCharTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<CharFloatCharTuple> {
    ...
    @Override
    public final int compareTo(@NotNull final CharFloatCharTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public CharFloatCharTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        return this;
    }
}
