...
/**
 * <p>3-Tuple (triple) key class composed of char, short, and int elements.
 * <p>Generated by {@link io.deephaven.engine.util.tuples.TupleCodeGenerator}.
 */
public class CharShortIntTuple implements Comparable<CharShortIntTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<CharShortIntTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final CharShortIntTuple typedOther = (CharShortIntTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final CharShortIntTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public CharShortIntTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        return this;
    }
}
