...
/**
 * <p>3-Tuple (triple) key class composed of long, int, and byte elements.
 * <p>Generated by {@link io.deephaven.engine.util.tuples.TupleCodeGenerator}.
 */
public class LongIntByteTuple implements Comparable<LongIntByteTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<LongIntByteTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final LongIntByteTuple typedOther = (LongIntByteTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final LongIntByteTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public LongIntByteTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        return this;
    }
}
