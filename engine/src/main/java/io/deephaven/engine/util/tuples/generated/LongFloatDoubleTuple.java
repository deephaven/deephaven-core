...
/**
 * <p>3-Tuple (triple) key class composed of long, float, and double elements.
 * <p>Generated by {@link io.deephaven.engine.util.tuples.TupleCodeGenerator}.
 */
public class LongFloatDoubleTuple implements Comparable<LongFloatDoubleTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<LongFloatDoubleTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final LongFloatDoubleTuple typedOther = (LongFloatDoubleTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final LongFloatDoubleTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public LongFloatDoubleTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        return this;
    }
}
