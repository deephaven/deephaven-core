...
/**
 * <p>3-Tuple (triple) key class composed of float, double, and long elements.
 * <p>Generated by {@link io.deephaven.engine.util.tuples.TupleCodeGenerator}.
 */
public class FloatDoubleLongTuple implements Comparable<FloatDoubleLongTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<FloatDoubleLongTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final FloatDoubleLongTuple typedOther = (FloatDoubleLongTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final FloatDoubleLongTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public FloatDoubleLongTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        return this;
    }
}
