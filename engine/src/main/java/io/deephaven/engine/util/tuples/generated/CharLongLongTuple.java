...
/**
 * <p>3-Tuple (triple) key class composed of char, long, and long elements.
 * <p>Generated by {@link io.deephaven.engine.util.tuples.TupleCodeGenerator}.
 */
public class CharLongLongTuple implements Comparable<CharLongLongTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<CharLongLongTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final CharLongLongTuple typedOther = (CharLongLongTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final CharLongLongTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public CharLongLongTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        return this;
    }
}
