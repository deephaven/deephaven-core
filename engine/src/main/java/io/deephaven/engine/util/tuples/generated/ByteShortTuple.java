...
/**
 * <p>2-Tuple (double) key class composed of byte and short elements.
 * <p>Generated by {@link io.deephaven.engine.util.tuples.TupleCodeGenerator}.
 */
public class ByteShortTuple implements Comparable<ByteShortTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<ByteShortTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final ByteShortTuple typedOther = (ByteShortTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final ByteShortTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    public String toString() {
        return "ByteShortTuple{" +
                element1 + ", " +
                element2 + '}';
    }

    @Override
    public ByteShortTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        return this;
    }
}
