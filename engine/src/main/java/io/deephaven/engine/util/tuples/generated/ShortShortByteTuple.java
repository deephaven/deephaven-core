...
/**
 * <p>3-Tuple (triple) key class composed of short, short, and byte elements.
 * <p>Generated by {@link io.deephaven.engine.util.tuples.TupleCodeGenerator}.
 */
public class ShortShortByteTuple implements Comparable<ShortShortByteTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<ShortShortByteTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final ShortShortByteTuple typedOther = (ShortShortByteTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final ShortShortByteTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public ShortShortByteTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        return this;
    }
}
