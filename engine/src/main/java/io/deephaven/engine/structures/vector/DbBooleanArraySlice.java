...
package io.deephaven.engine.structures.vector;
...
import static io.deephaven.engine.structures.vector.DbArrayBase.clampIndex;
...
public class DbBooleanArraySlice extends DbBooleanArray.Indirect {
    ...
    private DbBooleanArraySlice(@NotNull final DbBooleanArray innerArray, final long offsetIndex, final long length, final long innerArrayValidFromInclusive, final long innerArrayValidToExclusive) {
    ...
    public DbBooleanArraySlice(@NotNull final DbBooleanArray innerArray, final long offsetIndex, final long length) {
    ...
    @Override
    public DbBooleanArray subArray(final long fromIndexInclusive, final long toIndexExclusive) {
        ...
        return new DbBooleanArraySlice(innerArray, newOffsetIndex, newLength,
    ...
    public Boolean[] toArray() {
        if (innerArray instanceof DbBooleanArrayDirect && offsetIndex >= innerArrayValidFromInclusive && offsetIndex + length <= innerArrayValidToExclusive) {
