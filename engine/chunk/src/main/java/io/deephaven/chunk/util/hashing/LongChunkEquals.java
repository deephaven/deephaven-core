...
public class LongChunkEquals implements ChunkEquals {
    ...
    private static void equal(LongChunk<? extends Any> lhs, LongChunk<? extends Any> rhs,
    ...
    public static void notEqual(LongChunk<? extends Any> lhs, LongChunk<? extends Any> rhs,
            WritableBooleanChunk destination) {
        for (int ii = 0; ii < lhs.size(); ++ii) {
    ...
    private static void andEqual(LongChunk<? extends Any> lhs, LongChunk<? extends Any> rhs,
            WritableBooleanChunk destination) {
        for (int ii = 0; ii < lhs.size(); ++ii) {
    ...
    private static void andNotEqual(LongChunk<? extends Any> lhs, LongChunk<? extends Any> rhs,
            WritableBooleanChunk destination) {
        for (int ii = 0; ii < lhs.size(); ++ii) {
    ...
    private static void equalPairs(IntChunk<ChunkPositions> chunkPositionsToCheckForEquality,
            LongChunk<? extends Any> valuesChunk, WritableBooleanChunk destinations) {
    ...
    private static void equalPermuted(IntChunk<ChunkPositions> lhsPositions, IntChunk<ChunkPositions> rhsPositions,
            LongChunk<? extends Any> lhs, LongChunk<? extends Any> rhs, WritableBooleanChunk destinations) {
    ...
    private static void equalLhsPermuted(IntChunk<ChunkPositions> lhsPositions, LongChunk<? extends Any> lhs,
            LongChunk<? extends Any> rhs, WritableBooleanChunk destinations) {
        for (int ii = 0; ii < lhsPositions.size(); ++ii) {
            final int lhsPosition = lhsPositions.get(ii);
    ...
    private static void andEqualLhsPermuted(IntChunk<ChunkPositions> lhsPositions, LongChunk<? extends Any> lhs,
            LongChunk<? extends Any> rhs, WritableBooleanChunk destinations) {
        for (int ii = 0; ii < lhsPositions.size(); ++ii) {
            if (destinations.get(ii)) {
                final int lhsPosition = lhsPositions.get(ii);
