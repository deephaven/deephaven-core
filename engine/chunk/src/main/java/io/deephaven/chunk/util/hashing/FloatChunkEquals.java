...
public class FloatChunkEquals implements ChunkEquals {
    ...
    private static void equal(FloatChunk<? extends Any> lhs, FloatChunk<? extends Any> rhs,
    ...
    public static void notEqual(FloatChunk<? extends Any> lhs, FloatChunk<? extends Any> rhs,
            WritableBooleanChunk destination) {
        for (int ii = 0; ii < lhs.size(); ++ii) {
    ...
    private static void andEqual(FloatChunk<? extends Any> lhs, FloatChunk<? extends Any> rhs,
            WritableBooleanChunk destination) {
        for (int ii = 0; ii < lhs.size(); ++ii) {
    ...
    private static void andNotEqual(FloatChunk<? extends Any> lhs, FloatChunk<? extends Any> rhs,
            WritableBooleanChunk destination) {
        for (int ii = 0; ii < lhs.size(); ++ii) {
    ...
    private static void equalPairs(IntChunk<ChunkPositions> chunkPositionsToCheckForEquality,
            FloatChunk<? extends Any> valuesChunk, WritableBooleanChunk destinations) {
    ...
    private static void equalPermuted(IntChunk<ChunkPositions> lhsPositions, IntChunk<ChunkPositions> rhsPositions,
            FloatChunk<? extends Any> lhs, FloatChunk<? extends Any> rhs, WritableBooleanChunk destinations) {
    ...
    private static void equalLhsPermuted(IntChunk<ChunkPositions> lhsPositions, FloatChunk<? extends Any> lhs,
            FloatChunk<? extends Any> rhs, WritableBooleanChunk destinations) {
        for (int ii = 0; ii < lhsPositions.size(); ++ii) {
            final int lhsPosition = lhsPositions.get(ii);
    ...
    private static void andEqualLhsPermuted(IntChunk<ChunkPositions> lhsPositions, FloatChunk<? extends Any> lhs,
            FloatChunk<? extends Any> rhs, WritableBooleanChunk destinations) {
        for (int ii = 0; ii < lhsPositions.size(); ++ii) {
            if (destinations.get(ii)) {
                final int lhsPosition = lhsPositions.get(ii);
