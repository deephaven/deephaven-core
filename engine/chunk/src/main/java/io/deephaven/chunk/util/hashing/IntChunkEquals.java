...
public class IntChunkEquals implements ChunkEquals {
    ...
    private static void equal(IntChunk<? extends Any> lhs, IntChunk<? extends Any> rhs,
    ...
    public static void notEqual(IntChunk<? extends Any> lhs, IntChunk<? extends Any> rhs,
            WritableBooleanChunk destination) {
        for (int ii = 0; ii < lhs.size(); ++ii) {
    ...
    private static void andEqual(IntChunk<? extends Any> lhs, IntChunk<? extends Any> rhs,
            WritableBooleanChunk destination) {
        for (int ii = 0; ii < lhs.size(); ++ii) {
    ...
    private static void andNotEqual(IntChunk<? extends Any> lhs, IntChunk<? extends Any> rhs,
            WritableBooleanChunk destination) {
        for (int ii = 0; ii < lhs.size(); ++ii) {
    ...
    private static void equalPairs(IntChunk<ChunkPositions> chunkPositionsToCheckForEquality,
            IntChunk<? extends Any> valuesChunk, WritableBooleanChunk destinations) {
    ...
    private static void equalPermuted(IntChunk<ChunkPositions> lhsPositions, IntChunk<ChunkPositions> rhsPositions,
            IntChunk<? extends Any> lhs, IntChunk<? extends Any> rhs, WritableBooleanChunk destinations) {
    ...
    private static void equalLhsPermuted(IntChunk<ChunkPositions> lhsPositions, IntChunk<? extends Any> lhs,
            IntChunk<? extends Any> rhs, WritableBooleanChunk destinations) {
        for (int ii = 0; ii < lhsPositions.size(); ++ii) {
            final int lhsPosition = lhsPositions.get(ii);
    ...
    private static void andEqualLhsPermuted(IntChunk<ChunkPositions> lhsPositions, IntChunk<? extends Any> lhs,
            IntChunk<? extends Any> rhs, WritableBooleanChunk destinations) {
        for (int ii = 0; ii < lhsPositions.size(); ++ii) {
            if (destinations.get(ii)) {
                final int lhsPosition = lhsPositions.get(ii);
