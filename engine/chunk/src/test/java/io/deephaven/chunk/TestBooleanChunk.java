...
public class TestBooleanChunk {
    ...
    public void chunkWrapBounds() {
        ...
        expectException(IllegalArgumentException.class,
                () -> WritableBooleanChunk.writableChunkWrap(data0, 0, data0.length + 1));
        expectException(IllegalArgumentException.class,
                () -> WritableBooleanChunk.writableChunkWrap(data0, data0.length - 1, 2));
        expectException(IllegalArgumentException.class,
                () -> WritableBooleanChunk.writableChunkWrap(data0, data0.length, 1));
        ...
        expectException(IllegalArgumentException.class,
                () -> WritableBooleanChunkChunk.writableChunkWrap(wccData, 0, ccData.length + 1));
        expectException(IllegalArgumentException.class,
                () -> WritableBooleanChunkChunk.writableChunkWrap(wccData, ccData.length - 1, 2));
        expectException(IllegalArgumentException.class,
                () -> WritableBooleanChunkChunk.writableChunkWrap(wccData, ccData.length, 1));
    ...
    public void copyFromChunk() {
        ...
        final WritableBooleanChunk<Values> destChunk =
                WritableBooleanChunk.writableChunkWrap(destData, destChunkOffset, destChunkCapacity);
    ...
    public void testWritableChunkChunk() {
        ...
        WritableBooleanChunk<Values> replacementChunk =
                WritableBooleanChunk.writableChunkWrap(replacementData, MIDCHOFF, MIDCHOFF);
    ...
    private static <ATTR extends Values> void verifyChunkEqualsArray(BooleanChunk<ATTR> chunk, boolean[] data, int offset,
            int size) {
        for (int ii = 0; ii < size; ++ii) {
