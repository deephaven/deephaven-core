...
public interface ValueIteratorOfByte extends CloseablePrimitiveIteratorOfByte, ValueIterator<Byte> {
    ...
    // region streamAsInt
    /**
     * Create an unboxed {@link IntStream} over the remaining elements of this ValueIteratorOfByte by casting
    ...
    // region stream
    /**
     * Create a boxed {@link Stream} over the remaining elements of this ValueIteratorOfByte. The result
    ...
    /**
     * Create a ValueIteratorOfByte over an array of {@code byte}. The result does not need to be
     * {@link #close() closed}.
     *
