...
@Command(name = "example-3", mixinStandardHelpOptions = true,
    ...
    version = "0.1.0")
class Example3 extends FlightCannedExampleBase {

    @Override
    protected TableSpec table() {
        return TableSpec.empty(100).view("I=i").where(Collections.singletonList(FilterOr.of(
            FilterCondition.lt(ColumnName.of("I"), Value.of(42L)),
            FilterCondition.eq(ColumnName.of("I"), Value.of(93L)), RawString.of("I % 2 == 0"))));
    }
