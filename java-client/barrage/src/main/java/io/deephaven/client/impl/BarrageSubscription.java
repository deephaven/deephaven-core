...
public interface BarrageSubscription extends LivenessReferent, AutoCloseable {
    ...
    /**
     * Request a full snapshot of the data and populate a {@link BarrageTable} with the incrementally updating data
     * that is received. This call will block until all rows for the subscribed table are available.
     *
     * @return the {@code BarrageTable}
     */
     ...
     * @return the {@code BarrageTable}
     */
    BarrageTable snapshotPartialTable(RowSet viewport, BitSet columns, boolean reverseViewport) throws InterruptedException;

    /**
     * Request a snapshot of the data limited by viewport or column set and populate a {@link BarrageTable}
     * with the data that is received. Allows the viewport to be reversed.
     *
     * @param viewport the position-space viewport to use for the subscription
     * @param columns the columns to include in the subscription
     ...
     * @return the {@code BarrageTable}
     */
    BarrageTable snapshotPartialTable(RowSet viewport, BitSet columns, boolean reverseViewport, boolean blockUntilComplete)
            throws InterruptedException;
