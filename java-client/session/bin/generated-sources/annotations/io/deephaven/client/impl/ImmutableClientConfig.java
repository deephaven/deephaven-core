...
public final class ImmutableClientConfig extends ClientConfig {
  ...
  public final ImmutableClientConfig withTarget(DeephavenTarget value) {
    ...
    return new ImmutableClientConfig(newValue, this.ssl, this.userAgent, this.extraHeaders, this.maxInboundMessageSize);
  }
  ...
  public final ImmutableClientConfig withSsl(SSLConfig value) {
    ...
    return new ImmutableClientConfig(this.target, newValue, this.userAgent, this.extraHeaders, this.maxInboundMessageSize);
  }
  ...
  public final ImmutableClientConfig withSsl(Optional<? extends SSLConfig> optional) {
    ...
    return new ImmutableClientConfig(this.target, value, this.userAgent, this.extraHeaders, this.maxInboundMessageSize);
  }
  ...
  public final ImmutableClientConfig withUserAgent(String value) {
    ...
    return new ImmutableClientConfig(this.target, this.ssl, newValue, this.extraHeaders, this.maxInboundMessageSize);
  }
  ...
  public final ImmutableClientConfig withUserAgent(Optional<String> optional) {
    ...
    return new ImmutableClientConfig(this.target, this.ssl, value, this.extraHeaders, this.maxInboundMessageSize);
  }
  ...
  public final ImmutableClientConfig withExtraHeaders(Map<String, ? extends String> entries) {
    ...
    return new ImmutableClientConfig(this.target, this.ssl, this.userAgent, newValue, this.maxInboundMessageSize);
  }
  ...
  public final ImmutableClientConfig withMaxInboundMessageSize(int value) {
    ...
    return new ImmutableClientConfig(this.target, this.ssl, this.userAgent, this.extraHeaders, value);
  }
  ...
  /**
   * Computes a hash code from attributes: {@code target}, {@code ssl}, {@code userAgent}, {@code extraHeaders}, {@code maxInboundMessageSize}.
