...
public class StatsDriver extends TimedJob {
    public interface StatusAdapter {
        ...
        class Null implements StatusAdapter {
            ...
            public boolean cmsAlertEnabled() { return true; }
        }
    ...
    public final static String header="Stat,IntervalName,NowSec,NowString,AppNowSec,AppNowString,TypeTag,Name,N,Sum,Last,Min,Max,Avg,Sum2,Stdev";
                ...
                case 'N': {
                    ...
                    if (entriesHisto != null) {
                        ...
                        if ( e.size() > BUFFER_SIZE - GUESS_ENTRY_SIZE ) {
                            e.end();
                            e = entriesHisto[intervalIndex] = entryPoolHisto.take().start(sinkHisto, LogLevel.INFO, now * 1000);
                        }
                        e.append("HISTOGRAM")
