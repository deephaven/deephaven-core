...
class TestJpy(unittest.TestCase):
    ...
    def test_ping_pong_stack(self):
        ...
        self.assertEquals(
            "test_jpy(java,5)(python,4)(java,3)(python,2)(java,1)",
            PingPongStack.pingPongPython("test_jpy", 5),
        )
        self.assertEquals(
            "test_jpy(java,4)(python,3)(java,2)(python,1)",
            PingPongStack.pingPongPython("test_jpy", 4),
        )
    ...
    def test_pass_function_to_java(self):
        ...
        PassPyObjectToJava = jpy.get_type(
            "io/deephaven/jpy/integration/PassPyObjectToJava"
        )
    ...
    def test_pass_the_context_to_java(self):
        ...
        self.assertEquals(
            104, PassPyObjectToJava.invoke_the_context_plus(context_99, 5)
        )
    ...
    def test_pyproxy_unwrap(self):
        ...
        # Note: a temporary PyObject is created, and that holds onto a ref until Java GCs.
        # While the following counts are racy, it is probably very rare to fail here.
        obj_proxy = jpy.get_type(
            "io.deephaven.jpy.integration.SomeJavaInterface"
        ).proxy(obj)
