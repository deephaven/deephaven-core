...
class UpdateByTestCase(BaseTestCase):
    ...
    def test_ema_proxy(self):
        ...
        ops = [
            ...
            ema_time_decay(ts_col="Timestamp", time_scale=10, cols="ema_a = a"),
            ema_time_decay(
                ts_col="Timestamp", time_scale=100, cols="ema_c = c", op_control=op_ctrl
            ),
        ]
        pt_proxies = [
    ...
    rolling_ops = [
        ...
        rolling_sum_time(
            ts_col="Timestamp", cols=["rsum_b = b", "rsum_e = e"], rev_time="00:00:10"
        ),
        rolling_sum_time(
            ts_col="Timestamp",
        ...
        rolling_avg_time(
            ts_col="Timestamp", cols=["ravg_b = b", "ravg_e = e"], rev_time="00:00:10"
        ),
        rolling_avg_time(
            ts_col="Timestamp",
        ...
        rolling_min_time(
            ts_col="Timestamp", cols=["rmin_b = b", "rmin_e = e"], rev_time="00:00:10"
        ),
        rolling_min_time(
            ts_col="Timestamp",
        ...
        rolling_max_time(
            ts_col="Timestamp", cols=["rmax_b = b", "rmax_e = e"], rev_time="00:00:10"
        ),
        rolling_max_time(
            ts_col="Timestamp",
        ...
        rolling_prod_time(
            ts_col="Timestamp", cols=["rprod_b = b", "rprod_e = e"], rev_time="00:00:10"
        ),
        rolling_prod_time(
            ts_col="Timestamp",
