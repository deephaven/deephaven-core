...
class UpdateByTestCase(BaseTestCase):
    ...
    def setUpClass(cls) -> None:
        ...
        cls.em_ops = [
            ...
            ems_time(ts_col="Timestamp", time_scale="00:00:00.001", cols="ems_c = c",
                           op_control=cls.em_op_ctrl),
            ...
            emmin_time(ts_col="Timestamp", time_scale="00:00:00.001", cols="emmin_c = c",
                             op_control=cls.em_op_ctrl),
            ...
            emstd_time(ts_col="Timestamp", time_scale="00:00:00.001", cols="emtd_c = c",
                       op_control=cls.em_op_ctrl),
        ]
