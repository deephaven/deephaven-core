...
class UpdateByTestCase(BaseTestCase):
    ...
    em_op_ctrl = OperationControl(on_null=BadDataBehavior.THROW,
    ...
    em_ops = [
        ...
        ema_tick_decay(time_scale_ticks=100, cols="ema_a = a", op_control=em_op_ctrl),
        ...
        ema_time_decay(ts_col="Timestamp", time_scale="00:00:00.001", cols="ema_c = c",
                       op_control=em_op_ctrl),
        # exponential moving sum
        ems_tick_decay(time_scale_ticks=100, cols="ema_a = a"),
        ems_tick_decay(time_scale_ticks=100, cols="ema_a = a", op_control=em_op_ctrl),
        ...
        emmin_tick_decay(time_scale_ticks=100, cols="ema_a = a", op_control=em_op_ctrl),
        ...
        emmax_tick_decay(time_scale_ticks=100, cols="ema_a = a", op_control=em_op_ctrl),
    ...
    rolling_ops = [
        ...
        rolling_count_time(ts_col="Timestamp", cols=["rcount_b = b", "rcount_e = e"], rev_time="00:00:10"),
        rolling_count_time(ts_col="Timestamp", cols=["rcount_b = b", "rcount_e = e"], rev_time=10_000_000_000,
                          fwd_time=-10_000_000_00),
        rolling_count_time(ts_col="Timestamp", cols=["rcount_b = b", "rcount_e = e"], rev_time="00:00:30",
                          fwd_time="-00:00:20"),
        ...
        rolling_std_time(ts_col="Timestamp", cols=["rstd_b = b", "rstd_e = e"], rev_time="00:00:10"),
        rolling_std_time(ts_col="Timestamp", cols=["rstd_b = b", "rstd_e = e"], rev_time=10_000_000_000,
                          fwd_time=-10_000_000_00),
        rolling_std_time(ts_col="Timestamp", cols=["rstd_b = b", "rstd_e = e"], rev_time="00:00:30",
                          fwd_time="-00:00:20"),
        ...
        rolling_wavg_time(ts_col="Timestamp", weight_col="b", cols=["rwavg_b = b", "rwavg_e = e"], rev_time="00:00:10"),
        rolling_wavg_time(ts_col="Timestamp", weight_col="b", cols=["rwavg_b = b", "rwavg_e = e"], rev_time=10_000_000_000, fwd_time=-10_000_000_00),
        rolling_wavg_time(ts_col="Timestamp", weight_col="b", cols=["rwavg_b = b", "rwavg_e = e"], rev_time="00:00:30", fwd_time="-00:00:20"),
    ]
