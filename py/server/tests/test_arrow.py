...
class ArrowTestCase(BaseTestCase):
    ...
    def test_arrow_extra_time_types(self):
        ...
        pa_data_no_tz = [
            pa.array(
                [
                    pd.Timestamp("2017-01-01T12:01:02"),
    ...
    def test_arrow_types_float16(self):
        ...
        pa_data = [
            pa.array(np.array([1.5, -2.5], dtype=np.float16()), type=pa.float16())
        ]
        self.verify_type_conversion(pa_types=pa_types, pa_data=pa_data)
    ...
    def test_arrow_types_month_day_nano(self):
        ...
        pa_data = [
            pa.array([(1, 15, 100), (2, 20, 200)], type=pa.month_day_nano_interval())
        ]
        self.verify_type_conversion(pa_types=pa_types, pa_data=pa_data)
    ...
    def test_arrow_types_decimal128(self):
        ...
        pa_data = [
            pa.array([Decimal("123.45"), Decimal("-67.89")], type=pa.decimal128(10, 2))
        ]
        self.verify_type_conversion(pa_types=pa_types, pa_data=pa_data)
    ...
    def test_arrow_types_decimal256(self):
        ...
        pa_data = [
            pa.array(
                [Decimal("123456.78901"), Decimal("-98765.43210")],
                type=pa.decimal256(20, 5),
            )
        ]
        self.verify_type_conversion(pa_types=pa_types, pa_data=pa_data)
