...
class ConstantsTestCase(BaseTestCase):
    def test_constants_values(self):
        ...
        self.assertEqual(MAX_FINITE_DOUBLE, 1.7976931348623157e308)
        self.assertEqual(MAX_FINITE_FLOAT, 3.4028234663852886e38)
        ...
        self.assertEqual(MIN_FINITE_DOUBLE, -1.7976931348623155e308)
        self.assertEqual(MIN_FINITE_FLOAT, -3.4028232635611926e38)
        ...
        self.assertEqual(NULL_DOUBLE, -1.7976931348623157e308)
        self.assertEqual(NULL_FLOAT, -3.4028234663852886e38)
