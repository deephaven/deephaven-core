...
if numba:
    def _parse_numba_signature(
        ...
        if sigs:
            ...
            _setup_return_converter(p_sig.ret_annotation)
...
def _setup_return_converter(pra: _ParsedReturnAnnotation) -> None:
    ...
    if t == 'H':
        ...
        pra.converter = lambda x: x if x is None else str(x)
    elif t == 'M':
