...
def auto_locking_ctx(*args, **kwargs):
    """A auto-locking aware context manager. It ensures that the enclosed code block runs under
    the UGP shared lock when ugp.auto_locking is True, the target table-like object is refreshing, and the current
