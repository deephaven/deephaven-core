...
def rolling_std_time(ts_col: str, cols: Union[str, List[str]], rev_time: Union[int, str],
    ...
    allowed and can be used to generate completely forward or completely reverse windows. A row containing a null in the
    timestamp column belongs to no window and will not be considered in the windows of other rows; its output will be null.
