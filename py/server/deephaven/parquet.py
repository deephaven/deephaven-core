...
class RowGroupInfo:
    ...
    @staticmethod
    def single_row_group() -> _JRowGroupInfo:
        """ All data is within a single RowGroup. This is the default RowGroupInfo implementation. """
        return _JRowGroupInfo.singleRowGroup()

    @staticmethod
    def split_evenly(num_row_groups: int) -> _JRowGroupInfo:
        """
        ...
        :param num_row_groups: The number of RowGroups to write
         """
        return _JRowGroupInfo.splitEvenly(num_row_groups)

    @staticmethod
    def with_max_rows(max_rows: int) -> _JRowGroupInfo:
        """
...
def _build_parquet_instructions(
    ...
    row_group_info: Optional[_JRowGroupInfo] = None,
    ...
    if row_group_info:
        builder.setRowGroupInfo(row_group_info)
...
def write(
    ...
    Args:
        ...
        index_columns (Optional[Sequence[Sequence[str]]]): sequence of sequence containing the column names for indexes
            ...
            demand.
        row_group_info (Optional[_JRowGroupInfo]): requested RowGroup instructions, as returned by a call against RowGroupInfo
