...
class UpdateByTestCase(BaseTestCase):
    ...
    def setUpClass(cls) -> None:
        ...
        cls.em_ops = [
            ...
            ema_time(ts_col="Timestamp", decay_time=1_000_000, cols="ema_c = c",
            ...
            ems_time(ts_col="Timestamp", decay_time=1_000_000, cols="ems_c = c",
                     op_control=cls.em_op_ctrl),
            ...
            emmin_time(ts_col="Timestamp", decay_time=1_000_000, cols="emmin_c = c",
                       op_control=cls.em_op_ctrl),
            ...
            emmax_time(ts_col="Timestamp", decay_time=1_000_000, cols="emmax_c = c",
                       op_control=cls.em_op_ctrl),
            ...
            emstd_time(ts_col="Timestamp", decay_time=1_000_000, cols="emtd_c = c",
                       op_control=cls.em_op_ctrl),
        ]
        ...
        cls.rolling_ops = [
            ...
            rolling_sum_time(ts_col="Timestamp", cols=["rsum_b = b", "rsum_e = e"], rev_time=30_000_000_000,
                             fwd_time=-20_000_000_000),
            # rolling group
            ...
            rolling_group_time(ts_col="Timestamp", cols=["rgroup_b = b", "rgroup_e = e"], rev_time=10_000_000_000,
                               fwd_time=-10_000_000_00),
            rolling_group_time(ts_col="Timestamp", cols=["rgroup_b = b", "rgroup_e = e"], rev_time=30_000_000_000,
                               fwd_time=-20_000_000_000),
            # rolling average
            ...
            rolling_avg_time(ts_col="Timestamp", cols=["ravg_b = b", "ravg_e = e"], rev_time=10_000_000_000,
                             fwd_time=-10_000_000_00),
            rolling_avg_time(ts_col="Timestamp", cols=["ravg_b = b", "ravg_e = e"], rev_time=30_000_000_000,
                             fwd_time=-20_000_000_000),
            # rolling minimum
            ...
            rolling_min_time(ts_col="Timestamp", cols=["rmin_b = b", "rmin_e = e"], rev_time=10_000_000_000,
                             fwd_time=-10_000_000_00),
            rolling_min_time(ts_col="Timestamp", cols=["rmin_b = b", "rmin_e = e"], rev_time=30_000_000_000,
                             fwd_time=-20_000_000_000),
            # rolling maximum
            ...
            rolling_max_time(ts_col="Timestamp", cols=["rmax_b = b", "rmax_e = e"], rev_time=10_000_000_000,
                             fwd_time=-10_000_000_00),
            rolling_max_time(ts_col="Timestamp", cols=["rmax_b = b", "rmax_e = e"], rev_time=30_000_000_000,
                             fwd_time=-20_000_000_000),
            # rolling product
            ...
            rolling_prod_time(ts_col="Timestamp", cols=["rprod_b = b", "rprod_e = e"], rev_time=10_000_000_000,
                              fwd_time=-10_000_000_00),
            rolling_prod_time(ts_col="Timestamp", cols=["rprod_b = b", "rprod_e = e"], rev_time=30_000_000_000,
                              fwd_time=-20_000_000_000),
            # rolling count
            ...
            rolling_count_time(ts_col="Timestamp", cols=["rcount_b = b", "rcount_e = e"], rev_time=10_000_000_000,
                               fwd_time=-10_000_000_00),
            rolling_count_time(ts_col="Timestamp", cols=["rcount_b = b", "rcount_e = e"], rev_time=30_000_000_000,
                               fwd_time=-20_000_000_000),
            ...
            rolling_std_time(ts_col="Timestamp", cols=["rstd_b = b", "rstd_e = e"], rev_time=10_000_000_000,
                             fwd_time=-10_000_000_00),
            rolling_std_time(ts_col="Timestamp", cols=["rstd_b = b", "rstd_e = e"], rev_time=30_000_000_000,
                             fwd_time=-20_000_000_000),
            ...
            rolling_wavg_time(ts_col="Timestamp", weight_col="b", cols=["rwavg_b = b", "rwavg_e = e"],
                              rev_time=10_000_000_000),
            rolling_wavg_time(ts_col="Timestamp", weight_col="b", cols=["rwavg_b = b", "rwavg_e = e"],
                              rev_time=10_000_000_000, fwd_time=-10_000_000_00),
            rolling_wavg_time(ts_col="Timestamp", weight_col="b", cols=["rwavg_b = b", "rwavg_e = e"],
                              rev_time=30_000_000_000, fwd_time=-20_000_000_000),
        ]
