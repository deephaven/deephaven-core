...
if _version_not_supported:
    raise RuntimeError(
        ...
        + ' but the generated code in deephaven_core/proto/session_pb2_grpc.py depends on'
...
def add_SessionServiceServicer_to_server(servicer, server):
    ...
    server.add_registered_method_handlers('io.deephaven.proto.backplane.grpc.SessionService', rpc_method_handlers)
