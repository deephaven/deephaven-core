...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_SETEXECUTIONCONTEXTRESPONSE']._serialized_end=861
  _globals['_REMOTEFILESOURCEPLUGINFETCHREQUEST']._serialized_start=863
  _globals['_REMOTEFILESOURCEPLUGINFETCHREQUEST']._serialized_end=982
