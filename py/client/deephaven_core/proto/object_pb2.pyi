...
class FetchObjectResponse(google.protobuf.message.Message):
    ...
    data: builtins.bytes
    @property
    def typed_export_ids(
        self,
    ) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[
        deephaven_core.proto.ticket_pb2.TypedTicket
    ]: ...
    def __init__(
        self,
        *,
        type: builtins.str = ...,
        data: builtins.bytes = ...,
        typed_export_ids: collections.abc.Iterable[
            deephaven_core.proto.ticket_pb2.TypedTicket
        ]
        | None = ...,
    ) -> None: ...
    def ClearField(
        ...
        field_name: typing.Literal[
            "data", b"data", "type", b"type", "typed_export_ids", b"typed_export_ids"
        ],
    ) -> None: ...
...
class ClientData(google.protobuf.message.Message):
    ...
    def __init__(
        ...
        *,
        payload: builtins.bytes = ...,
        references: collections.abc.Iterable[
            deephaven_core.proto.ticket_pb2.TypedTicket
        ]
        | None = ...,
    ) -> None: ...
    def ClearField(
        self,
        field_name: typing.Literal["payload", b"payload", "references", b"references"],
    ) -> None: ...
...
class ServerData(google.protobuf.message.Message):
    ...
    def __init__(
        ...
        *,
        payload: builtins.bytes = ...,
        exported_references: collections.abc.Iterable[
            deephaven_core.proto.ticket_pb2.TypedTicket
        ]
        | None = ...,
    ) -> None: ...
    def ClearField(
        self,
        field_name: typing.Literal[
            "exported_references", b"exported_references", "payload", b"payload"
        ],
    ) -> None: ...
...
class StreamRequest(google.protobuf.message.Message):
    ...
    def HasField(
        self,
        field_name: typing.Literal[
            "connect", b"connect", "data", b"data", "message", b"message"
        ],
    ) -> builtins.bool: ...
    def ClearField(
        self,
    ...
    ) -> typing.Literal["connect", "data"] | None: ...
...
class StreamResponse(google.protobuf.message.Message):
    ...
    def HasField(
        self, field_name: typing.Literal["data", b"data", "message", b"message"]
    ) -> builtins.bool: ...
    def ClearField(
        self, field_name: typing.Literal["data", b"data", "message", b"message"]
    ) -> None: ...
