...
from deephaven_core.proto import object_pb2 as deephaven__core_dot_proto_dot_object__pb2
...
if _version_not_supported:
    raise RuntimeError(
        ...
        + ' but the generated code in deephaven_core/proto/object_pb2_grpc.py depends on'
...
class ObjectServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.FetchObject = channel.unary_unary(
                ...
                request_serializer=deephaven__core_dot_proto_dot_object__pb2.FetchObjectRequest.SerializeToString,
                response_deserializer=deephaven__core_dot_proto_dot_object__pb2.FetchObjectResponse.FromString,
                _registered_method=True)
        self.MessageStream = channel.stream_stream(
                '/io.deephaven.proto.backplane.grpc.ObjectService/MessageStream',
                request_serializer=deephaven__core_dot_proto_dot_object__pb2.StreamRequest.SerializeToString,
                response_deserializer=deephaven__core_dot_proto_dot_object__pb2.StreamResponse.FromString,
                _registered_method=True)
        ...
        self.NextMessageStream = channel.unary_unary(
                ...
                request_serializer=deephaven__core_dot_proto_dot_object__pb2.StreamRequest.SerializeToString,
                response_deserializer=deephaven__core_dot_proto_dot_object__pb2.BrowserNextResponse.FromString,
                _registered_method=True)
...
def add_ObjectServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'FetchObject': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=deephaven__core_dot_proto_dot_object__pb2.FetchObjectRequest.FromString,
                    response_serializer=deephaven__core_dot_proto_dot_object__pb2.FetchObjectResponse.SerializeToString,
            ),
            'MessageStream': grpc.stream_stream_rpc_method_handler(
                    servicer.MessageStream,
                    request_deserializer=deephaven__core_dot_proto_dot_object__pb2.StreamRequest.FromString,
                    response_serializer=deephaven__core_dot_proto_dot_object__pb2.StreamResponse.SerializeToString,
            ),
            ...
            'NextMessageStream': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=deephaven__core_dot_proto_dot_object__pb2.StreamRequest.FromString,
                    response_serializer=deephaven__core_dot_proto_dot_object__pb2.BrowserNextResponse.SerializeToString,
            ),
    }
    generic_handler = grpc.method_handlers_generic_handler(
            'io.deephaven.proto.backplane.grpc.ObjectService', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('io.deephaven.proto.backplane.grpc.ObjectService', rpc_method_handlers)
...
class ObjectService(object):
    ...
    def FetchObject(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/io.deephaven.proto.backplane.grpc.ObjectService/FetchObject',
            deephaven__core_dot_proto_dot_object__pb2.FetchObjectRequest.SerializeToString,
            deephaven__core_dot_proto_dot_object__pb2.FetchObjectResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
    ...
    def MessageStream(request_iterator,
        ...
        return grpc.experimental.stream_stream(
            ...
            target,
            '/io.deephaven.proto.backplane.grpc.ObjectService/MessageStream',
            deephaven__core_dot_proto_dot_object__pb2.StreamRequest.SerializeToString,
            deephaven__core_dot_proto_dot_object__pb2.StreamResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
    ...
    def NextMessageStream(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            '/io.deephaven.proto.backplane.grpc.ObjectService/NextMessageStream',
            deephaven__core_dot_proto_dot_object__pb2.StreamRequest.SerializeToString,
            deephaven__core_dot_proto_dot_object__pb2.BrowserNextResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
