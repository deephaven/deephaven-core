...
from deephaven_core.proto import partitionedtable_pb2 as deephaven__core_dot_proto_dot_partitionedtable__pb2
...
if _version_not_supported:
    raise RuntimeError(
        ...
        + ' but the generated code in deephaven_core/proto/partitionedtable_pb2_grpc.py depends on'
...
class PartitionedTableServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.PartitionBy = channel.unary_unary(
                ...
                request_serializer=deephaven__core_dot_proto_dot_partitionedtable__pb2.PartitionByRequest.SerializeToString,
                response_deserializer=deephaven__core_dot_proto_dot_partitionedtable__pb2.PartitionByResponse.FromString,
                _registered_method=True)
        self.Merge = channel.unary_unary(
                '/io.deephaven.proto.backplane.grpc.PartitionedTableService/Merge',
                request_serializer=deephaven__core_dot_proto_dot_partitionedtable__pb2.MergeRequest.SerializeToString,
        ...
        self.GetTable = channel.unary_unary(
                ...
                request_serializer=deephaven__core_dot_proto_dot_partitionedtable__pb2.GetTableRequest.SerializeToString,
                response_deserializer=deephaven__core_dot_proto_dot_table__pb2.ExportedTableCreationResponse.FromString,
                _registered_method=True)
...
def add_PartitionedTableServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'PartitionBy': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=deephaven__core_dot_proto_dot_partitionedtable__pb2.PartitionByRequest.FromString,
                    response_serializer=deephaven__core_dot_proto_dot_partitionedtable__pb2.PartitionByResponse.SerializeToString,
            ),
            'Merge': grpc.unary_unary_rpc_method_handler(
                    servicer.Merge,
                    request_deserializer=deephaven__core_dot_proto_dot_partitionedtable__pb2.MergeRequest.FromString,
            ...
            'GetTable': grpc.unary_unary_rpc_method_handler(
                    servicer.GetTable,
                    request_deserializer=deephaven__core_dot_proto_dot_partitionedtable__pb2.GetTableRequest.FromString,
                    response_serializer=deephaven__core_dot_proto_dot_table__pb2.ExportedTableCreationResponse.SerializeToString,
            ),
    }
    ...
    server.add_registered_method_handlers('io.deephaven.proto.backplane.grpc.PartitionedTableService', rpc_method_handlers)
...
class PartitionedTableService(object):
    ...
    def PartitionBy(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/io.deephaven.proto.backplane.grpc.PartitionedTableService/PartitionBy',
            deephaven__core_dot_proto_dot_partitionedtable__pb2.PartitionByRequest.SerializeToString,
            deephaven__core_dot_proto_dot_partitionedtable__pb2.PartitionByResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
    ...
    def Merge(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/io.deephaven.proto.backplane.grpc.PartitionedTableService/Merge',
            deephaven__core_dot_proto_dot_partitionedtable__pb2.MergeRequest.SerializeToString,
    ...
    def GetTable(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/io.deephaven.proto.backplane.grpc.PartitionedTableService/GetTable',
            deephaven__core_dot_proto_dot_partitionedtable__pb2.GetTableRequest.SerializeToString,
            deephaven__core_dot_proto_dot_table__pb2.ExportedTableCreationResponse.FromString,
            options,
            channel_credentials,
            insecure,
