...
if _version_not_supported:
    raise RuntimeError(
        ...
        + ' but the generated code in deephaven_core/proto/application_pb2_grpc.py depends on'
...
def add_ApplicationServiceServicer_to_server(servicer, server):
    ...
    server.add_registered_method_handlers('io.deephaven.proto.backplane.grpc.ApplicationService', rpc_method_handlers)
