...
class WrappedAuthenticationRequest(google.protobuf.message.Message):
    ...
    def ClearField(
        self, field_name: typing.Literal["payload", b"payload", "type", b"type"]
    ) -> None: ...
...
class HandshakeRequest(google.protobuf.message.Message):
    ...
    def ClearField(
        ...
        field_name: typing.Literal[
            "auth_protocol", b"auth_protocol", "payload", b"payload"
        ],
    ) -> None: ...
...
class HandshakeResponse(google.protobuf.message.Message):
    ...
    def ClearField(
        ...
        field_name: typing.Literal[
            ...
            b"token_deadline_time_millis",
            "token_expiration_delay_millis",
            b"token_expiration_delay_millis",
        ],
    ) -> None: ...
...
class ExportNotification(google.protobuf.message.Message):
    ...
    class _StateEnumTypeWrapper(
        google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[
            ExportNotification._State.ValueType
        ],
        builtins.type,
    ):
...
class TerminationNotificationResponse(google.protobuf.message.Message):
    ...
    class StackTrace(google.protobuf.message.Message):
        ...
        def ClearField(
            self,
            field_name: typing.Literal[
                "elements", b"elements", "message", b"message", "type", b"type"
            ],
        ) -> None: ...
    ...
    def stack_traces(
        ...
        global___TerminationNotificationResponse.StackTrace
    ]:
    ...
    def __init__(
        ...
        *,
        ...
        reason: builtins.str = ...,
        is_from_uncaught_exception: builtins.bool = ...,
        stack_traces: collections.abc.Iterable[
            global___TerminationNotificationResponse.StackTrace
        ]
        | None = ...,
    ) -> None: ...
    def ClearField(
        ...
        field_name: typing.Literal[
            ...
            b"abnormal_termination",
            "is_from_uncaught_exception",
            b"is_from_uncaught_exception",
            "reason",
            b"reason",
            "stack_traces",
            b"stack_traces",
