...
class _RollupNodeTypeEnumTypeWrapper(
    google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[
        _RollupNodeType.ValueType
    ],
    builtins.type,
):
...
class RollupRequest(google.protobuf.message.Message):
    ...
    def aggregations(
        ...
        deephaven_core.proto.table_pb2.Aggregation
    ]:
    ...
    def __init__(
        ...
        *,
        ...
        aggregations: collections.abc.Iterable[
            deephaven_core.proto.table_pb2.Aggregation
        ]
        | None = ...,
        include_constituents: builtins.bool = ...,
    ...
    def HasField(
        ...
        field_name: typing.Literal[
            "result_rollup_table_id",
            b"result_rollup_table_id",
            "source_table_id",
            b"source_table_id",
        ],
    ) -> builtins.bool: ...
...
class UpdateViewRequest(google.protobuf.message.Message):
    ...
    def HasField(
        self, field_name: typing.Literal["column_spec", b"column_spec"]
    ) -> builtins.bool: ...
    def ClearField(
        self,
        field_name: typing.Literal[
            "column_spec", b"column_spec", "node_type", b"node_type"
        ],
    ) -> None: ...
...
class HierarchicalTableApplyRequest(google.protobuf.message.Message):
    ...
    def filters(
        ...
        deephaven_core.proto.table_pb2.Condition
    ]:
    ...
    def sorts(
        ...
        deephaven_core.proto.table_pb2.SortDescriptor
    ]:
    ...
    def __init__(
        self,
        *,
        result_hierarchical_table_id: deephaven_core.proto.ticket_pb2.Ticket
        | None = ...,
        input_hierarchical_table_id: deephaven_core.proto.ticket_pb2.Ticket
        | None = ...,
        filters: collections.abc.Iterable[deephaven_core.proto.table_pb2.Condition]
        | None = ...,
        sorts: collections.abc.Iterable[deephaven_core.proto.table_pb2.SortDescriptor]
        | None = ...,
    ...
    def HasField(
        self,
        field_name: typing.Literal[
            "input_hierarchical_table_id",
            b"input_hierarchical_table_id",
            "result_hierarchical_table_id",
            b"result_hierarchical_table_id",
        ],
    ) -> builtins.bool: ...
    def ClearField(
        self,
...
class HierarchicalTableDescriptor(google.protobuf.message.Message):
    ...
    def ClearField(
        self,
        field_name: typing.Literal[
            "is_static", b"is_static", "snapshot_schema", b"snapshot_schema"
        ],
    ) -> None: ...
...
class HierarchicalTableViewRequest(google.protobuf.message.Message):
    ...
    def HasField(
        ...
        field_name: typing.Literal[
            ...
            "expansions",
            b"expansions",
            "hierarchical_table_id",
            b"hierarchical_table_id",
            "result_view_id",
            b"result_view_id",
            "target",
            b"target",
    ...
    ) -> typing.Literal["hierarchical_table_id", "existing_view_id"] | None: ...
...
class HierarchicalTableViewKeyTableDescriptor(google.protobuf.message.Message):
    ...
    def HasField(
        self,
        field_name: typing.Literal[
            "_key_table_action_column",
            b"_key_table_action_column",
            "key_table_action_column",
            b"key_table_action_column",
            "key_table_id",
            b"key_table_id",
        ],
    ) -> builtins.bool: ...
    ...
    def WhichOneof(
        ...
        oneof_group: typing.Literal[
            "_key_table_action_column", b"_key_table_action_column"
        ],
    ) -> typing.Literal["key_table_action_column"] | None: ...

global___HierarchicalTableViewKeyTableDescriptor = (
