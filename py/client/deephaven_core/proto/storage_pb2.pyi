...
class ListItemsRequest(google.protobuf.message.Message):
    ...
    def HasField(
        ...
        field_name: typing.Literal[
            "_filter_glob", b"_filter_glob", "filter_glob", b"filter_glob"
        ],
    ) -> builtins.bool: ...
    def ClearField(
        self,
    ...
    def WhichOneof(
        self, oneof_group: typing.Literal["_filter_glob", b"_filter_glob"]
    ) -> typing.Literal["filter_glob"] | None: ...
...
class ItemInfo(google.protobuf.message.Message):
    ...
    def HasField(
        self, field_name: typing.Literal["_etag", b"_etag", "etag", b"etag"]
    ) -> builtins.bool: ...
    def ClearField(
        self,
        field_name: typing.Literal[
    ...
    def WhichOneof(
        self, oneof_group: typing.Literal["_etag", b"_etag"]
    ) -> typing.Literal["etag"] | None: ...
...
class ListItemsResponse(google.protobuf.message.Message):
    ...
    def ClearField(
        self,
        field_name: typing.Literal[
            "canonical_path", b"canonical_path", "items", b"items"
        ],
    ) -> None: ...
...
class FetchFileRequest(google.protobuf.message.Message):
    ...
    def ClearField(
        self,
        field_name: typing.Literal["_etag", b"_etag", "etag", b"etag", "path", b"path"],
    ) -> None: ...
    def WhichOneof(
        self, oneof_group: typing.Literal["_etag", b"_etag"]
    ) -> typing.Literal["etag"] | None: ...
...
class FetchFileResponse(google.protobuf.message.Message):
    ...
    def ClearField(
        self,
        field_name: typing.Literal[
            "_etag", b"_etag", "contents", b"contents", "etag", b"etag"
        ],
    ) -> None: ...
    def WhichOneof(
        self, oneof_group: typing.Literal["_etag", b"_etag"]
