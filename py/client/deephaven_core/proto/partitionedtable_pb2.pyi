...
class PartitionByRequest(google.protobuf.message.Message):
    ...
    def HasField(
        self,
        field_name: typing.Literal["result_id", b"result_id", "table_id", b"table_id"],
    ) -> builtins.bool: ...
    def ClearField(
        self,
...
class MergeRequest(google.protobuf.message.Message):
    ...
    def HasField(
        self,
        field_name: typing.Literal[
            "partitioned_table", b"partitioned_table", "result_id", b"result_id"
        ],
    ) -> builtins.bool: ...
    def ClearField(
        self,
...
class GetTableRequest(google.protobuf.message.Message):
    ...
    class _UniqueBehaviorEnumTypeWrapper(
        google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[
            GetTableRequest._UniqueBehavior.ValueType
        ],
        builtins.type,
    ):
        ...
        REQUIRE_UNIQUE_RESULTS_STATIC_SINGLE_KEY: (
            GetTableRequest._UniqueBehavior.ValueType
        )  # 1
    ...
    """The behavior is unset, in which case we default to requiring unique results."""
    REQUIRE_UNIQUE_RESULTS_STATIC_SINGLE_KEY: (
        GetTableRequest.UniqueBehavior.ValueType
    )  # 1
    """Only one key is permitted, the key table is snapshot if not static, and the resulting partitioned table must have exactly one key."""
...
class PartitionedTableDescriptor(google.protobuf.message.Message):
    ...
    def ClearField(
        ...
        field_name: typing.Literal[
            ...
            b"constituent_changes_permitted",
            "constituent_column_name",
            b"constituent_column_name",
            "constituent_definition_schema",
            b"constituent_definition_schema",
            "key_column_names",
            b"key_column_names",
            "unique_keys",
            b"unique_keys",
