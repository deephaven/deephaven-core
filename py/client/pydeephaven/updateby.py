...
def cum_count_all(cols: Union[str, List[str]]) -> UpdateByOperation:
    """Creates a cumulative count UpdateByOperation of all values in the supplied column names.
    ...
    Returns:
        UpdateByOperation
    """
    ub_spec_options = _GrpcAggCountType.COUNT_ALL
...
def cum_count_non_null(cols: Union[str, List[str]]) -> UpdateByOperation:
    ...
    Returns:
        UpdateByOperation
    """
    ub_spec_options = _GrpcAggCountType.COUNT_NON_NULL
    ub_spec = _GrpcUpdateBySpec(count=_GrpcUpdateBySpec.UpdateByCumulativeCount(count_type=ub_spec_options))
    ub_column = _GrpcUpdateByColumn(spec=ub_spec, match_pairs=to_list(cols))
    return UpdateByOperation(ub_column=ub_column)
...
def cum_count_null(cols: Union[str, List[str]]) -> UpdateByOperation:
    ...
    Returns:
        UpdateByOperation
    """
    ub_spec_options = _GrpcAggCountType.COUNT_NULL
    ub_spec = _GrpcUpdateBySpec(count=_GrpcUpdateBySpec.UpdateByCumulativeCount(count_type=ub_spec_options))
    ub_column = _GrpcUpdateByColumn(spec=ub_spec, match_pairs=to_list(cols))
    return UpdateByOperation(ub_column=ub_column)
...
def cum_count_neg(cols: Union[str, List[str]]) -> UpdateByOperation:
    ...
    Returns:
        UpdateByOperation
    """
    ub_spec_options = _GrpcAggCountType.COUNT_NEGATIVE
    ub_spec = _GrpcUpdateBySpec(count=_GrpcUpdateBySpec.UpdateByCumulativeCount(count_type=ub_spec_options))
    ub_column = _GrpcUpdateByColumn(spec=ub_spec, match_pairs=to_list(cols))
    return UpdateByOperation(ub_column=ub_column)
...
def cum_count_zero(cols: Union[str, List[str]]) -> UpdateByOperation:
    ...
    Returns:
        UpdateByOperation
    """
    ub_spec_options = _GrpcAggCountType.COUNT_ZERO
    ub_spec = _GrpcUpdateBySpec(count=_GrpcUpdateBySpec.UpdateByCumulativeCount(count_type=ub_spec_options))
    ub_column = _GrpcUpdateByColumn(spec=ub_spec, match_pairs=to_list(cols))
    return UpdateByOperation(ub_column=ub_column)
...
def cum_count_nan(cols: Union[str, List[str]]) -> UpdateByOperation:
    ...
    Returns:
        UpdateByOperation
    """
    ub_spec_options = _GrpcAggCountType.COUNT_NAN
    ub_spec = _GrpcUpdateBySpec(count=_GrpcUpdateBySpec.UpdateByCumulativeCount(count_type=ub_spec_options))
    ub_column = _GrpcUpdateByColumn(spec=ub_spec, match_pairs=to_list(cols))
    return UpdateByOperation(ub_column=ub_column)
...
def cum_count_inf(cols: Union[str, List[str]]) -> UpdateByOperation:
    ...
    Returns:
        UpdateByOperation
    """
    ub_spec_options = _GrpcAggCountType.COUNT_INFINITE
    ub_spec = _GrpcUpdateBySpec(count=_GrpcUpdateBySpec.UpdateByCumulativeCount(count_type=ub_spec_options))
    ub_column = _GrpcUpdateByColumn(spec=ub_spec, match_pairs=to_list(cols))
    return UpdateByOperation(ub_column=ub_column)
...
def cum_count_finite(cols: Union[str, List[str]]) -> UpdateByOperation:
    ...
    Returns:
        UpdateByOperation
    """
    ub_spec_options = _GrpcAggCountType.COUNT_FINITE
    ub_spec = _GrpcUpdateBySpec(count=_GrpcUpdateBySpec.UpdateByCumulativeCount(count_type=ub_spec_options))
    ub_column = _GrpcUpdateByColumn(spec=ub_spec, match_pairs=to_list(cols))
    return UpdateByOperation(ub_column=ub_column)
