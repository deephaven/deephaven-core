...
class PluginClient(ServerObject):
    ...
    Use resp_stream to read messages the the server has sent, and req_stream to send messages back to the server, if
    supported.
    """
...
class PluginRequestStream:
    ...
    def write(self, payload: bytes, references: List[ServerObject]):
        """
