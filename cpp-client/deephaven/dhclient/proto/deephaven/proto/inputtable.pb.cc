...
AddTableRequest::GetClassData() const {
...
::uint8_t* AddTableRequest::_InternalSerialize(
  ...
  if (cached_has_bits & 0x00000001u) {
    target = ::google::protobuf::internal::WireFormatLite::InternalWriteMessage(
        1, *_impl_.input_table_, _impl_.input_table_->GetCachedSize(), target, stream);
  }

  // .io.deephaven.proto.backplane.grpc.Ticket table_to_add = 2;
  if (cached_has_bits & 0x00000002u) {
    target = ::google::protobuf::internal::WireFormatLite::InternalWriteMessage(
        2, *_impl_.table_to_add_, _impl_.table_to_add_->GetCachedSize(), target, stream);
  }
...
::google::protobuf::Metadata AddTableRequest::GetMetadata() const {
  return ::_pbi::AssignDescriptors(&descriptor_table_deephaven_2fproto_2finputtable_2eproto_getter,
                                   &descriptor_table_deephaven_2fproto_2finputtable_2eproto_once,
...
::uint8_t* DeleteTableRequest::_InternalSerialize(
  ...
  if (cached_has_bits & 0x00000002u) {
    target = ::google::protobuf::internal::WireFormatLite::InternalWriteMessage(
        2, *_impl_.table_to_remove_, _impl_.table_to_remove_->GetCachedSize(), target, stream);
  }
