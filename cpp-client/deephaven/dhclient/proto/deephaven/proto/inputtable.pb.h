...
inline bool AddTableRequest::_internal_has_input_table() const {
  return this != internal_default_instance() && _impl_.input_table_ != nullptr;
}
...
inline bool AddTableRequest::_internal_has_table_to_add() const {
  return this != internal_default_instance() && _impl_.table_to_add_ != nullptr;
}
...
inline bool DeleteTableRequest::_internal_has_table_to_remove() const {
  return this != internal_default_instance() && _impl_.table_to_remove_ != nullptr;
}
