...
template<> ::io::deephaven::proto::backplane::grpc::PublishRequest* Arena::CreateMaybeMessage<::io::deephaven::proto::backplane::grpc::PublishRequest>(Arena*);
template<> ::io::deephaven::proto::backplane::grpc::PublishResponse* Arena::CreateMaybeMessage<::io::deephaven::proto::backplane::grpc::PublishResponse>(Arena*);
...
template<> ::io::deephaven::proto::backplane::grpc::WrappedAuthenticationRequest* Arena::CreateMaybeMessage<::io::deephaven::proto::backplane::grpc::WrappedAuthenticationRequest>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace io {
namespace deephaven {
namespace proto {
...
class WrappedAuthenticationRequest final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:io.deephaven.proto.backplane.grpc.WrappedAuthenticationRequest) */ {
 public:
  inline WrappedAuthenticationRequest() : WrappedAuthenticationRequest(nullptr) {}
  ~WrappedAuthenticationRequest() override;
  explicit PROTOBUF_CONSTEXPR WrappedAuthenticationRequest(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);

  WrappedAuthenticationRequest(const WrappedAuthenticationRequest& from);
  ...
  WrappedAuthenticationRequest* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
  ...
  protected:
  explicit WrappedAuthenticationRequest(::PROTOBUF_NAMESPACE_ID::Arena* arena,
...
class HandshakeRequest final :
 ...
 public:
  ...
  PROTOBUF_DEPRECATED void clear_auth_protocol();
  PROTOBUF_DEPRECATED int32_t auth_protocol() const;
  PROTOBUF_DEPRECATED void set_auth_protocol(int32_t value);
  private:
...
class HandshakeResponse final :
 ...
 public:
  ...
  PROTOBUF_DEPRECATED void clear_metadata_header();
  PROTOBUF_DEPRECATED const std::string& metadata_header() const;
  template <typename ArgT0 = const std::string&, typename... ArgT>
  PROTOBUF_DEPRECATED void set_metadata_header(ArgT0&& arg0, ArgT... args);
  PROTOBUF_DEPRECATED std::string* mutable_metadata_header();
  PROTOBUF_NODISCARD PROTOBUF_DEPRECATED std::string* release_metadata_header();
  PROTOBUF_DEPRECATED void set_allocated_metadata_header(std::string* metadata_header);
  private:
  ...
  PROTOBUF_DEPRECATED void clear_session_token();
  PROTOBUF_DEPRECATED const std::string& session_token() const;
  template <typename ArgT0 = const std::string&, typename... ArgT>
  PROTOBUF_DEPRECATED void set_session_token(ArgT0&& arg0, ArgT... args);
  PROTOBUF_DEPRECATED std::string* mutable_session_token();
  PROTOBUF_NODISCARD PROTOBUF_DEPRECATED std::string* release_session_token();
  PROTOBUF_DEPRECATED void set_allocated_session_token(std::string* session_token);
  private:
  ...
  PROTOBUF_DEPRECATED void clear_token_deadline_time_millis();
  PROTOBUF_DEPRECATED int64_t token_deadline_time_millis() const;
  PROTOBUF_DEPRECATED void set_token_deadline_time_millis(int64_t value);
  private:
  ...
  PROTOBUF_DEPRECATED void clear_token_expiration_delay_millis();
  PROTOBUF_DEPRECATED int64_t token_expiration_delay_millis() const;
  PROTOBUF_DEPRECATED void set_token_expiration_delay_millis(int64_t value);
  private:
...
class PublishRequest final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:io.deephaven.proto.backplane.grpc.PublishRequest) */ {
 public:
...
class PublishResponse final :
    public ::PROTOBUF_NAMESPACE_ID::internal::ZeroFieldsBase /* @@protoc_insertion_point(class_definition:io.deephaven.proto.backplane.grpc.PublishResponse) */ {
 public:
...
void WrappedAuthenticationRequest::set_type(ArgT0&& arg0, ArgT... args) {
 
 _impl_.type_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:io.deephaven.proto.backplane.grpc.WrappedAuthenticationRequest.type)
}
inline std::string* WrappedAuthenticationRequest::mutable_type() {
...
inline void WrappedAuthenticationRequest::set_allocated_type(std::string* type) {
  if (type != nullptr) {
...
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void WrappedAuthenticationRequest::set_payload(ArgT0&& arg0, ArgT... args) {
 
 _impl_.payload_.SetBytes(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:io.deephaven.proto.backplane.grpc.WrappedAuthenticationRequest.payload)
}
inline std::string* WrappedAuthenticationRequest::mutable_payload() {
...
inline void WrappedAuthenticationRequest::set_allocated_payload(std::string* payload) {
  if (payload != nullptr) {
...
void HandshakeResponse::set_metadata_header(ArgT0&& arg0, ArgT... args) {
 ...
 _impl_.metadata_header_.SetBytes(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline void HandshakeResponse::_internal_set_metadata_header(const std::string& value) {
  ...
  _impl_.metadata_header_.Set(value, GetArenaForAllocation());
}
inline std::string* HandshakeResponse::_internal_mutable_metadata_header() {
  
  return _impl_.metadata_header_.Mutable(GetArenaForAllocation());
}
...
inline void HandshakeResponse::set_allocated_metadata_header(std::string* metadata_header) {
  ...
  _impl_.metadata_header_.SetAllocated(metadata_header, GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
...
void HandshakeResponse::set_session_token(ArgT0&& arg0, ArgT... args) {
 ...
 _impl_.session_token_.SetBytes(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
// .io.deephaven.proto.backplane.grpc.Ticket source_id = 1;
inline bool PublishRequest::_internal_has_source_id() const {
  return this != internal_default_instance() && _impl_.source_id_ != nullptr;
}
...
inline const ::io::deephaven::proto::backplane::grpc::Ticket& PublishRequest::source_id() const {
  // @@protoc_insertion_point(field_get:io.deephaven.proto.backplane.grpc.PublishRequest.source_id)
  return _internal_source_id();
}
inline void PublishRequest::unsafe_arena_set_allocated_source_id(
    ::io::deephaven::proto::backplane::grpc::Ticket* source_id) {
  if (GetArenaForAllocation() == nullptr) {
    delete reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(_impl_.source_id_);
  }
...
inline void PublishRequest::set_allocated_source_id(::io::deephaven::proto::backplane::grpc::Ticket* source_id) {
  ::PROTOBUF_NAMESPACE_ID::Arena* message_arena = GetArenaForAllocation();
  if (message_arena == nullptr) {
    delete reinterpret_cast< ::PROTOBUF_NAMESPACE_ID::MessageLite*>(_impl_.source_id_);
  }
...
// .io.deephaven.proto.backplane.grpc.Ticket result_id = 2;
inline bool PublishRequest::_internal_has_result_id() const {
  return this != internal_default_instance() && _impl_.result_id_ != nullptr;
}
...
inline const ::io::deephaven::proto::backplane::grpc::Ticket& PublishRequest::result_id() const {
  // @@protoc_insertion_point(field_get:io.deephaven.proto.backplane.grpc.PublishRequest.result_id)
  return _internal_result_id();
}
inline void PublishRequest::unsafe_arena_set_allocated_result_id(
    ::io::deephaven::proto::backplane::grpc::Ticket* result_id) {
  if (GetArenaForAllocation() == nullptr) {
    delete reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(_impl_.result_id_);
  }
...
inline ::io::deephaven::proto::backplane::grpc::Ticket* PublishRequest::mutable_result_id() {
  ::io::deephaven::proto::backplane::grpc::Ticket* _msg = _internal_mutable_result_id();
  // @@protoc_insertion_point(field_mutable:io.deephaven.proto.backplane.grpc.PublishRequest.result_id)
  return _msg;
}
inline void PublishRequest::set_allocated_result_id(::io::deephaven::proto::backplane::grpc::Ticket* result_id) {
  ::PROTOBUF_NAMESPACE_ID::Arena* message_arena = GetArenaForAllocation();
  if (message_arena == nullptr) {
    delete reinterpret_cast< ::PROTOBUF_NAMESPACE_ID::MessageLite*>(_impl_.result_id_);
  }
...
void ExportNotification::set_dependent_handle(ArgT0&& arg0, ArgT... args) {
 ...
 _impl_.dependent_handle_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline void ExportNotification::_internal_set_dependent_handle(const std::string& value) {
  ...
  _impl_.dependent_handle_.Set(value, GetArenaForAllocation());
}
inline std::string* ExportNotification::_internal_mutable_dependent_handle() {
  
  return _impl_.dependent_handle_.Mutable(GetArenaForAllocation());
}
...
inline void ExportNotification::set_allocated_dependent_handle(std::string* dependent_handle) {
  ...
  _impl_.dependent_handle_.SetAllocated(dependent_handle, GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
...
inline void TerminationNotificationResponse_StackTrace::set_elements(int index, const std::string& value) {
  _impl_.elements_.Mutable(index)->assign(value);
...
inline void TerminationNotificationResponse_StackTrace::set_elements(int index, std::string&& value) {
  _impl_.elements_.Mutable(index)->assign(std::move(value));
  // @@protoc_insertion_point(field_set:io.deephaven.proto.backplane.grpc.TerminationNotificationResponse.StackTrace.elements)
}
...
inline void TerminationNotificationResponse_StackTrace::set_elements(int index, const char* value, size_t size) {
  _impl_.elements_.Mutable(index)->assign(
...
inline void TerminationNotificationResponse_StackTrace::add_elements(const std::string& value) {
  _impl_.elements_.Add()->assign(value);
...
inline void TerminationNotificationResponse_StackTrace::add_elements(std::string&& value) {
  _impl_.elements_.Add(std::move(value));
  // @@protoc_insertion_point(field_add:io.deephaven.proto.backplane.grpc.TerminationNotificationResponse.StackTrace.elements)
}
...
inline void TerminationNotificationResponse_StackTrace::add_elements(const char* value, size_t size) {
  _impl_.elements_.Add()->assign(reinterpret_cast<const char*>(value), size);
...
inline int TerminationNotificationResponse::_internal_stack_traces_size() const {
  return _impl_.stack_traces_.size();
}
...
inline ::io::deephaven::proto::backplane::grpc::TerminationNotificationResponse_StackTrace* TerminationNotificationResponse::mutable_stack_traces(int index) {
  ...
  return _impl_.stack_traces_.Mutable(index);
}
...
inline const ::io::deephaven::proto::backplane::grpc::TerminationNotificationResponse_StackTrace& TerminationNotificationResponse::_internal_stack_traces(int index) const {
  return _impl_.stack_traces_.Get(index);
}
...
inline ::io::deephaven::proto::backplane::grpc::TerminationNotificationResponse_StackTrace* TerminationNotificationResponse::_internal_add_stack_traces() {
  return _impl_.stack_traces_.Add();
}
