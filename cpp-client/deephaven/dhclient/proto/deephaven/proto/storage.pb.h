...
void ListItemsRequest::set_filter_glob(ArgT0&& arg0, ArgT... args) {
 _impl_._has_bits_[0] |= 0x00000001u;
 _impl_.filter_glob_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline std::string* ListItemsRequest::release_filter_glob() {
  ...
  _impl_._has_bits_[0] &= ~0x00000001u;
  auto* p = _impl_.filter_glob_.Release();
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
...
inline void ListItemsRequest::set_allocated_filter_glob(std::string* filter_glob) {
  ...
  _impl_.filter_glob_.SetAllocated(filter_glob, GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (_impl_.filter_glob_.IsDefault()) {
    _impl_.filter_glob_.Set("", GetArenaForAllocation());
  }
...
void MoveItemRequest::set_old_path(ArgT0&& arg0, ArgT... args) {
 ...
 _impl_.old_path_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline void MoveItemRequest::set_allocated_old_path(std::string* old_path) {
  ...
  _impl_.old_path_.SetAllocated(old_path, GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
...
void MoveItemRequest::set_new_path(ArgT0&& arg0, ArgT... args) {
 ...
 _impl_.new_path_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline void MoveItemRequest::set_allocated_new_path(std::string* new_path) {
  ...
  _impl_.new_path_.SetAllocated(new_path, GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
