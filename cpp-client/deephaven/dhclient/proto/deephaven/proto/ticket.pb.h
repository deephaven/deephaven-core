...
/* @@protoc_insertion_point(class_definition:io.deephaven.proto.backplane.grpc.Ticket) */ {
 public:
  ...
  Ticket* New(::google::protobuf::Arena* arena = nullptr) const PROTOBUF_FINAL {
 ...
 private:
  ...
  static ::absl::string_view FullMessageName() { return "io.deephaven.proto.backplane.grpc.Ticket"; }
...
class TypedTicket final : public ::google::protobuf::Message
/* @@protoc_insertion_point(class_definition:io.deephaven.proto.backplane.grpc.TypedTicket) */ {
 public:
  inline TypedTicket() : TypedTicket(nullptr) {}
  ~TypedTicket() PROTOBUF_FINAL;
  template <typename = void>
  explicit PROTOBUF_CONSTEXPR TypedTicket(
      ::google::protobuf::internal::ConstantInitialized);

  inline TypedTicket(const TypedTicket& from) : TypedTicket(nullptr, from) {}
  inline TypedTicket(TypedTicket&& from) noexcept
      : TypedTicket(nullptr, std::move(from)) {}
  ...
  friend void swap(TypedTicket& a, TypedTicket& b) { a.Swap(&b); }
  ...
  TypedTicket* New(::google::protobuf::Arena* arena = nullptr) const PROTOBUF_FINAL {
    return ::google::protobuf::Message::DefaultConstruct<TypedTicket>(arena);
  }
  using ::google::protobuf::Message::CopyFrom;
  void CopyFrom(const TypedTicket& from);
  using ::google::protobuf::Message::MergeFrom;
  void MergeFrom(const TypedTicket& from) { TypedTicket::MergeImpl(*this, from); }
 ...
 private:
  friend class ::google::protobuf::internal::AnyMetadata;
  static ::absl::string_view FullMessageName() { return "io.deephaven.proto.backplane.grpc.TypedTicket"; }

 protected:
  explicit TypedTicket(::google::protobuf::Arena* arena);
  TypedTicket(::google::protobuf::Arena* arena, const TypedTicket& from);
  TypedTicket(::google::protobuf::Arena* arena, TypedTicket&& from) noexcept
      : TypedTicket(arena) {
    *this = ::std::move(from);
  }
  const ::google::protobuf::Message::ClassData* GetClassData() const PROTOBUF_FINAL;
