 ...
 * Convenience typedef.
 */
typedef GenericChunk<char16_t> CharChunk;
/**
 * Convenience typedef.
 */
 ...
 * Convenience typedef.
 */
typedef GenericChunk<deephaven::dhcore::DateTime> DateTimeChunk;
 ...
 */
class AnyChunk {
  typedef std::variant<CharChunk, Int8Chunk, Int16Chunk, Int32Chunk, Int64Chunk, UInt64Chunk, FloatChunk,
