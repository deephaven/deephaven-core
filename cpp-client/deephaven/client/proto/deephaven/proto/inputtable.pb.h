...
class AddTableRequest final :
 ...
 public:
  ...
  explicit constexpr AddTableRequest(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  AddTableRequest* New(::PROTOBUF_NAMESPACE_ID::Arena* arena) const final {
  ...
  PROTOBUF_MUST_USE_RESULT ::io::deephaven::proto::backplane::grpc::Ticket* release_input_table();
  ...
  PROTOBUF_MUST_USE_RESULT ::io::deephaven::proto::backplane::grpc::Ticket* release_table_to_add();
...
class AddTableResponse final :
 ...
 public:
  ...
  explicit constexpr AddTableResponse(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  AddTableResponse* New(::PROTOBUF_NAMESPACE_ID::Arena* arena) const final {
...
class DeleteTableRequest final :
 ...
 public:
  ...
  PROTOBUF_MUST_USE_RESULT ::io::deephaven::proto::backplane::grpc::Ticket* release_table_to_remove();
...
class DeleteTableResponse final :
 ...
 public:
  ...
  explicit constexpr DeleteTableResponse(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
