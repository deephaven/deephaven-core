...
PROTOBUF_NAMESPACE_OPEN
template <>
::io::deephaven::proto::backplane::grpc::Ticket* Arena::CreateMaybeMessage<::io::deephaven::proto::backplane::grpc::Ticket>(Arena*);
template <>
::io::deephaven::proto::backplane::grpc::TypedTicket* Arena::CreateMaybeMessage<::io::deephaven::proto::backplane::grpc::TypedTicket>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
...
class Ticket final :
 ...
 public:
  ...
  void set_allocated_ticket(std::string* ptr);
...
inline PROTOBUF_ALWAYS_INLINE void Ticket::set_ticket(Arg_&& arg,
                                                     Args_... args) {
  ;
  _impl_.ticket_.SetBytes(static_cast<Arg_&&>(arg), args..., GetArenaForAllocation());
...
inline void Ticket::set_allocated_ticket(std::string* value) {
  _impl_.ticket_.SetAllocated(value, GetArenaForAllocation());
