...
::PROTOBUF_NAMESPACE_ID::Metadata descriptor_table_deephaven_2fproto_2fticket_2eproto_metadata_getter(int index);
namespace io {
namespace deephaven {
namespace proto {
namespace backplane {
...
class Ticket PROTOBUF_FINAL :
 ...
 public:
  ...
  static ::PROTOBUF_NAMESPACE_ID::Metadata GetMetadataStatic() {
    return ::descriptor_table_deephaven_2fproto_2fticket_2eproto_metadata_getter(kIndexInFileMessages);
  }
...
inline void Ticket::set_ticket(std::string&& value) {
  ...
  // @@protoc_insertion_point(field_set_rvalue:io.deephaven.proto.backplane.grpc.Ticket.ticket)
}
inline void Ticket::set_ticket(const char* value) {
  ...
  // @@protoc_insertion_point(field_set_char:io.deephaven.proto.backplane.grpc.Ticket.ticket)
}
inline void Ticket::set_ticket(const void* value,
    size_t size) {
  
  ticket_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::string(
      reinterpret_cast<const char*>(value), size), GetArena());
  // @@protoc_insertion_point(field_set_pointer:io.deephaven.proto.backplane.grpc.Ticket.ticket)
}
