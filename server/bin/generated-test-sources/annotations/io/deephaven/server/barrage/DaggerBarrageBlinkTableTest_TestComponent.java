...
public final class DaggerBarrageBlinkTableTest_TestComponent {
  private DaggerBarrageBlinkTableTest_TestComponent() {
  }

  public static BarrageBlinkTableTest.TestComponent.Builder builder() {
    return new Builder();
  }

  private static final class Builder implements BarrageBlinkTableTest.TestComponent.Builder {
    ...
    @Override
    public BarrageBlinkTableTest.TestComponent build() {
      Preconditions.checkBuilderRequirement(withScheduler, Scheduler.class);
      return new TestComponentImpl(withScheduler);
    }
  }

  private static final class TestComponentImpl implements BarrageBlinkTableTest.TestComponent {
