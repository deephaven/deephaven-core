 ...
 * 5 minutes, a scheduler pool size of 4, and a max inbound message size of 100 MiB. This is represented by the
 * following JSON:
 *
 * <pre>
 * {
 ...
 * </pre>
 *
 * @see io.deephaven.server.jetty.JettyMain
 * @see io.deephaven.server.jetty.JettyConfig
 */
