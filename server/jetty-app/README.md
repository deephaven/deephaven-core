...
1. Build and install wheels for deephaven-jpy and deephaven:
    ...
    $ pip install wheel
    $ export DEEPHAVEN_VERSION=0.15.2 # this should match the current version of your git repo

    $ cd py/jpy
    $ export JAVA_HOME=/path/to/your/java/home # Customize this to fit your computer
    $ python setup.py bdist_wheel
    $ pip install dist/deephaven_jpy-0.15.2-cp39-cp39-linux_x86_64.whl # This will vary by version/platform
    $ cd -

    $ cd Integrations/python
    $ python setup.py bdist_wheel
    $ pip install dist/deephaven-0.15.2-py2.py3-none-any.whl
    $ cd -
    ```
