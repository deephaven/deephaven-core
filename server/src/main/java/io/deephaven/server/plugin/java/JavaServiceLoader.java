...
public final class JavaServiceLoader {
    ...
    /**
     * Load all {@link Registration registrations} found via {@link ServiceLoader#load(Class)}, and register them into
     * {@code callback}.
     *
     * @param callback the plugin callback
     */
    public static void loadAllAndRegisterInto(Callback callback) {
