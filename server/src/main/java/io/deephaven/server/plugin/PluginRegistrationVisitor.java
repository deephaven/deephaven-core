...
final class PluginRegistrationVisitor
    ...
    private final ContentPluginRegistration contentPluginRegistration;

    @Inject
    public PluginRegistrationVisitor(ObjectTypeRegistration objectTypeRegistration,
            ContentPluginRegistration contentPluginRegistration) {
        this.objectTypeRegistration = Objects.requireNonNull(objectTypeRegistration);
        this.contentPluginRegistration = Objects.requireNonNull(contentPluginRegistration);
    }
    ...
    @Override
    public PluginRegistrationVisitor visit(ContentPlugin contentPlugin) {
        try {
            contentPluginRegistration.register(contentPlugin);
        } catch (IOException e) {
