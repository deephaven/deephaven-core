...
import static io.deephaven.server.table.ops.filter.NormalizeFilterUtil.doAnd;
import static io.deephaven.server.table.ops.filter.NormalizeFilterUtil.doInvert;
import static io.deephaven.server.table.ops.filter.NormalizeFilterUtil.doInvoke;
import static io.deephaven.server.table.ops.filter.NormalizeFilterUtil.doIsNull;
import static io.deephaven.server.table.ops.filter.NormalizeFilterUtil.doOr;
