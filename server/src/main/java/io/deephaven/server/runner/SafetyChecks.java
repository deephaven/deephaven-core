        ...
        private static void check() {
            ...
            if (isVulnerableVersion() && !hasWorkaround()) {
                throw exception(JDK_8287432.class, String.format(
                        "The current JVM is vulnerable to the bug https://bugs.openjdk.org/browse/JDK-8287432. Please update to 11.0.17+, 17.0.5+, or 21+. If that is not possible, you can apply a workaround '%s'.",
