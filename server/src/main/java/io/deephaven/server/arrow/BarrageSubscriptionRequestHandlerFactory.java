...
public class BarrageSubscriptionRequestHandlerFactory implements ExchangeRequestHandlerFactory {
    @Override
    public byte type() {
    ...
    public ArrowFlightUtil.DoExchangeMarshaller.Handler create(final ArrowFlightUtil.DoExchangeMarshaller marshaller,
        ...
        return new BarrageSubscriptionRequestHandler(marshaller, ticketRouter, session, listener,
