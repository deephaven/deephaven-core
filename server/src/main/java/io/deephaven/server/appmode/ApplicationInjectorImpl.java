...
/**
 * An implementation that sources from {@link Factory} and configuration.
 */
public class ApplicationInjectorImpl implements ApplicationInjector {

    private static final Logger log = LoggerFactory.getLogger(ApplicationInjectorImpl.class);

    /**
     * Binds {@link ApplicationInjectorImpl} as {@link ApplicationInjector}.
     */
    @dagger.Module
    public interface Module {

        @Binds
        ApplicationInjector bindsImpl(ApplicationInjectorImpl impl);
    }
    ...
    public void run() throws IOException, ClassNotFoundException {
        new ApplicationInjectorFactoryImpl(scriptSessionProvider, ticketResolver, applicationListener, factories).run();
