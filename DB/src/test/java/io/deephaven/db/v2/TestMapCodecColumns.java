...
public class TestMapCodecColumns {
    ...
    private static final Table TABLE = TableTools.newTable(TABLE_DEFINITION,
        TableTools.col("StrStrMap",
            CollectionUtil.mapFromArray(String.class, String.class, "AK", "AV", "BK", "BV"), null,
            Collections.singletonMap("Key", "Value")),
        TableTools.col("StrBoolMap",
            CollectionUtil.mapFromArray(String.class, Boolean.class, "True", true, "False", false,
                "Null", null),
            null, Collections.singletonMap("Truthiness", true)),
        TableTools.col("StrDoubleMap",
            CollectionUtil.mapFromArray(String.class, Double.class, "One", 1.0, "Two", 2.0, "Null",
                null),
            null, Collections.singletonMap("Pi", Math.PI)),
        TableTools.col("StrFloatMap",
            CollectionUtil.mapFromArray(String.class, Float.class, "Ten", 10.0f, "Twenty", 20.0f,
                "Null", null),
            null, Collections.singletonMap("e", (float) Math.E)),
        TableTools.col("StrIntMap",
            CollectionUtil.mapFromArray(String.class, Integer.class, "Million", 1_000_000,
                "Billion", 1_000_000_000, "Null", null),
