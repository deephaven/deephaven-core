...
public class TestComboBy extends LiveTableTestCase {
    ...
    public void testComboByMinMaxTypes() {
        ...
        final EvalNuggetInterface[] en = new EvalNuggetInterface[] {
                EvalNugget
                        .from(() -> queryTable.by(AggCombo(AggMin(queryTable.getDefinition().getColumnNamesArray())))),
                EvalNugget
                        .from(() -> queryTable.by(AggCombo(AggMax(queryTable.getDefinition().getColumnNamesArray())))),
                ...
                EvalNugget.Sorted.from(
                        () -> queryTable.by(AggCombo(AggMin(queryTable.getDefinition().getColumnNamesArray())), "Sym"),
                        "Sym"),
                new QueryTableTest.TableComparator(
                        queryTable.by(AggCombo(AggMin(queryTable.getDefinition().getColumnNamesArray())), "Sym")
                                .sort("Sym"),
    ...
    private void testComboByIncremental(final String ctxt, final int size) {
        ...
        EvalNuggetInterface en[] = new EvalNuggetInterface[] {
                new EvalNugget() {
                    public Table e() {
                        return queryTable.by(AggCombo(Agg(AggType.Avg, "MeanI=intCol", "MeanD=doubleCol"),
                                Agg(AggType.Std, "StdI=intCol", "StdD=doubleCol")), "Sym").sort("Sym");
                    }
                },
                new EvalNugget() {
                    public Table e() {
                        return queryTable.by(AggCombo(AggFormula("min(each)", "each", "MinI=intCol", "MinD=doubleCol"),
                ...
                new QueryTableTest.TableComparator(
                        ...
                        "UpdateView",
                        queryTable.by(new ComboAggregateFactory(Agg(new MinMaxByStateFactoryImpl(true), "MinI=intCol"),
                                Agg(new MinMaxByStateFactoryImpl(false), "MaxI=intCol")), "Sym").sort("Sym"),
                        "ComboBy"),
                new QueryTableTest.TableComparator(
                        queryTable.by("Sym").view("Sym", "MinD=min(doubleCol)", "MaxD=max(doubleCol)").sort("Sym"),
                        "UpdateView",
                        queryTable.by(AggCombo(Agg(new MinMaxByStateFactoryImpl(true), "MinD=doubleCol"),
                                Agg(new MinMaxByStateFactoryImpl(false), "MaxD=doubleCol")), "Sym").sort("Sym"),
                        "ComboBy"),
                new QueryTableTest.TableComparator(
                        queryTable.by("Sym")
                ...
                new QueryTableTest.TableComparator(
                        ...
                        "ComboBy"),
                new QueryTableTest.TableComparator(
                        queryTable.by().view("MinD=min(doubleCol)", "MaxI=max(intCol)", "MaxD=max(doubleCol)",
                                "MinI=min(intCol)",
    ...
    public void testAggUniqueDefaultValues() {
        ...
        expectException(IllegalArgumentException.class,
                ...
                () -> dataTable.by(AggCombo(AggUnique(false, -1, -2, "StringCol", "BoolCol", "DatTime", "CharCol",
