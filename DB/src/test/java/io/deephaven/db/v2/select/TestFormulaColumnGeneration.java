...
public class TestFormulaColumnGeneration {
    ...
    // is:
    // 1. Once the formula generation code is believed to be correct, uncomment @Test for this test
    // case below.
    ...
    public void generateFiles() throws FileNotFoundException {
        ...
        new ModelFileGenerator(FormulaKernelSample.class)
            .generateFile(fc.generateKernelClassBody());
    }
    ...
    public void validateFiles() throws IOException {
        ...
        new ModelFileGenerator(FormulaKernelSample.class)
            .validateFile(fc.generateKernelClassBody());
    }
    ...
    private static FormulaColumn getFormulaColumn() {
        ...
        final FormulaColumn fc =
            FormulaColumn.createFormulaColumn("Value", "I * II + q * ii + II_[i - 1]");
        fc.initInputs(table);
        return fc;
    }
}
