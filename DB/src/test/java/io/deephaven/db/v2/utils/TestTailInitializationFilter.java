...
public class TestTailInitializationFilter extends LiveTableTestCase {
    public void testSimple() {
        ...
        final QueryTable input = TstUtils.testRefreshingTable(builder.getIndex(), ColumnHolder.getDateTimeColumnHolder("Timestamp", false, data));
        ...
        final Table expected = LiveTableMonitor.DEFAULT.sharedLock().computeLocked(() -> TableTools.merge(slice0_100_filtered, slice100_200_filtered));
        ...
        final Table expected2 = LiveTableMonitor.DEFAULT.sharedLock().computeLocked(() -> TableTools.merge(slice0_100_filtered, slice100_102, slice102_202_filtered, slice202_204));
