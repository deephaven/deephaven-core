...
public class ParquetTableReadWriteTest {
    ...
    private void flatTable(String tableName, int size, boolean includeSerializable) {
        ...
        TableManagementTools.writeTableToDir(tableToSave, tableToSave.getDefinition(), dest, TableManagementTools.StorageFormat.Parquet);
    ...
    public void groupingByLongKey() {
        ...
        TableManagementTools.writeTableToDir(testTable, dest, TableManagementTools.StorageFormat.Parquet);
        final Table fromDisk = TableManagementTools.readTableFromDir(dest);
