 ...
 * like @Category or @RunWith(Suite.class), then instead of extending QueryTableTestBase, you should
 * instead create a `JUnit4QueryTableTestBase field;`, and call setUp/tearDown in @Before/@After
 * annotated methods.
 *
