...
public class TestColumnsToRowsTransform extends LiveTableTestCase {
    public void testStatic() {
        ...
        final Table ex1 = TableTools.newTable(stringCol("Sym", "AAPL", "AAPL", "SPY", "SPY"),
            intCol("Val3", 5, 5, 6, 6), stringCol("Name", "Val1", "Val2", "Val1", "Val2"),
            intCol("Value", 1, 3, 2, 4));
        assertTableEquals(ex1, out);

        final Table out2 =
            ColumnsToRowsTransform.columnsToRows(in, "Fribble", "Value", "Val1", "Val2", "Val3");
        TableTools.showWithIndex(out2);
        final Table ex2 =
            TableTools.newTable(stringCol("Sym", "AAPL", "AAPL", "AAPL", "SPY", "SPY", "SPY"),
        ...
        final Table ex3 =
            TableTools.newTable(stringCol("Sym", "AAPL", "AAPL", "AAPL", "SPY", "SPY", "SPY"),
                stringCol("Label", "First", "Second", "Third", "First", "Second", "Third"),
                intCol("Value", expected));
        ...
        final Table inMulti = TableTools.newTable(stringCol("Sym", "AAPL", "SPY"),
            intCol("Val1", 1, 2), doubleCol("D1", 7.7, 8.8), doubleCol("D2", 9.9, 10.1),
            intCol("Val2", 3, 4), intCol("Val3", 5, 6), doubleCol("D3", 11.11, 12.12));
        TableTools.show(inMulti);
        final Table outMulti =
            ColumnsToRowsTransform.columnsToRows(inMulti, "Name", new String[] {"IV", "DV"},
                new String[] {"Apple", "Banana", "Canteloupe"}, new String[][] {
                        new String[] {"Val1", "Val2", "Val3"}, new String[] {"D1", "D2", "D3"}});
        TableTools.show(outMulti);
        final Table expectMulti = TableTools.newTable(
            col("Sym", "AAPL", "AAPL", "AAPL", "SPY", "SPY", "SPY"),
    ...
    public void testBadSharedContext() {
        ...
        final Table in2 = TableTools.newTable(stringCol("Sym", "VXX", "TSLA", "AAPL", "SPY"),
            intCol("V1", 1, 2, 3, 4), intCol("V2", 5, 6, 7, 8));
        ...
        try (
            final WritableIntChunk<Attributes.Values> destination =
                WritableIntChunk.makeWritableChunk(2);
    ...
    public void testTypeMismatch() {
        ...
        try {
            ...
            TestCase.assertEquals("Incompatible transpose types Val1 is int, Val4 is double",
                iae.getMessage());
        }
    }
    ...
    public void testMisalignment() {
        final Table in = TableTools.newTable(stringCol("Sym", "AAPL", "SPY"), intCol("Val1", 1, 2),
            intCol("Val2", 3, 4), intCol("Val3", 5, 6), doubleCol("Val4", 7.0, 8.0));
        try {
            ColumnsToRowsTransform.columnsToRows(in, "Name", new String[] {"Foo", "Bar"},
                new String[] {"A", "B"},
                new String[][] {new String[] {"Val1", "Val2"}, new String[] {"Val4"}});
            TestCase.fail("Expected an exception for mismatched types.");
        } catch (IllegalArgumentException iae) {
            TestCase.assertEquals("2 labels defined, but 1 transpose columns defined for Bar.",
                iae.getMessage());
        }
    }
    ...
    private void testIncremental(int seed) {
        ...
        final QueryTable queryTable = getTable(size, random,
            columnInfo = initColumnInfos(
                new String[] {"Sym", "D1", "D2", "D3", "I1", "I2", "I3", "I4", "I5"},
        ...
        final EvalNuggetInterface[] en = new EvalNuggetInterface[] {
                ...
                EvalNugget.from(() -> ColumnsToRowsTransform.columnsToRows(queryTable, "Name",
                    "Value", "I1", "I2")),
                EvalNugget.from(
                    () -> ColumnsToRowsTransform.columnsToRows(queryTable, "Name", "Value", "I1")),
                ...
                new QueryTableTestBase.TableComparator(
                    ColumnsToRowsTransform.columnsToRows(queryTable, "Name", "Value", "I1", "I2",
                        "I3"),
                    LiveTableMonitor.DEFAULT.sharedLock()
                        .computeLocked(() -> queryTable
                            .update("Name=new String[]{`I1`, `I2`, `I3`}",
                                "Value=new int[]{I1, I2, I3}")
                ...
                EvalNugget.from(() -> ColumnsToRowsTransform.columnsToRows(queryTable, "Name",
                    ...
                    new String[][] {new String[] {"I1", "I2", "I3"},
                            new String[] {"D1", "D2", "D3"}})),
                new QueryTableTestBase.TableComparator(
                    ColumnsToRowsTransform.columnsToRows(queryTable, "Name",
                        new String[] {"IV", "DV"}, new String[] {"First", "Second", "Third"},
                        new String[][] {new String[] {"I1", "I2", "I3"},
                                new String[] {"D1", "D2", "D3"}}),
                    LiveTableMonitor.DEFAULT.sharedLock()
