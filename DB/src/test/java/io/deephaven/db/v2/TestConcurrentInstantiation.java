...
public class TestConcurrentInstantiation extends QueryTableTestBase {
    ...
    public void testTreeTableFilter() throws ExecutionException, InterruptedException {
        ...
        assertTrue(Arrays.equals(new int[] {1, 3, 4, 6, 9},
    ...
    public void testUpdateView() throws ExecutionException, InterruptedException {
        final QueryTable table =
            TstUtils.testRefreshingTable(i(2, 4, 6), c("x", 1, 2, 3), c("y", "a", "b", "c"));
        final Table tableStart = TstUtils.testRefreshingTable(i(2, 4, 6), c("x", 1, 2, 3),
    ...
    public void testView() throws ExecutionException, InterruptedException {
        final QueryTable table =
            TstUtils.testRefreshingTable(i(2, 4, 6), c("x", 1, 2, 3), c("y", "a", "b", "c"));
        final Table tableStart =
            TstUtils.testRefreshingTable(i(2, 4, 6), c("y", "a", "b", "c"), c("z", 4, 8, 12));
        final Table tableUpdate = TstUtils.testRefreshingTable(i(2, 3, 4, 6),
            c("y", "a", "d", "b", "c"), c("z", 4, 16, 8, 12));
    ...
    public void testDropColumns() throws ExecutionException, InterruptedException {
        final QueryTable table = TstUtils.testRefreshingTable(i(2, 4, 6), c("x", 1, 2, 3),
            c("y", "a", "b", "c"), c("z", 4, 8, 12));
        final Table tableStart =
            TstUtils.testRefreshingTable(i(2, 4, 6), c("x", 1, 2, 3), c("y", "a", "b", "c"));
        final Table tableUpdate = TstUtils.testRefreshingTable(i(2, 3, 4, 6), c("x", 1, 4, 2, 3),
    ...
    public void testWhere() throws ExecutionException, InterruptedException {
        final QueryTable table = TstUtils.testRefreshingTable(i(2, 4, 6), c("x", 1, 2, 3),
            c("y", "a", "b", "c"), c("z", true, false, true));
        final Table tableStart = TstUtils.testRefreshingTable(i(2, 6), c("x", 1, 3),
            c("y", "a", "c"), c("z", true, true));
        final Table tableUpdate = TstUtils.testRefreshingTable(i(2, 3, 6), c("x", 1, 4, 3),
            c("y", "a", "d", "c"), c("z", true, true, true));
    ...
    public void testWhere2() throws ExecutionException, InterruptedException {
        ...
        final Table tableStart = TstUtils.testRefreshingTable(i(2, 6), c("x", 1, 3),
            c("y", "a", "c"), c("z", true, true));
        final Table testUpdate = TstUtils.testRefreshingTable(i(3, 6), c("x", 4, 3),
            c("y", "d", "c"), c("z", true, true));
    ...
    public void testWhereDynamic() throws ExecutionException, InterruptedException {
        ...
        final DynamicWhereFilter filter = LiveTableMonitor.DEFAULT.exclusiveLock().computeLocked(
    ...
    public void testSort() throws ExecutionException, InterruptedException {
        final QueryTable table =
            TstUtils.testRefreshingTable(i(2, 4, 6), c("x", 1, 2, 3), c("y", "a", "b", "c"));
        final Table tableStart =
            TstUtils.testRefreshingTable(i(1, 2, 3), c("x", 3, 2, 1), c("y", "c", "b", "a"));
        final Table tableUpdate = TstUtils.testRefreshingTable(i(1, 2, 3, 4), c("x", 4, 3, 2, 1),
            c("y", "d", "c", "b", "a"));
    ...
    public void testReverse() throws ExecutionException, InterruptedException {
        ...
        final Table tableUpdate = TstUtils.testRefreshingTable(i(1, 2, 3, 4), c("x", 4, 3, 2, 1),
            c("y", "d", "c", "b", "a"));
        final Table tableUpdate2 = TstUtils.testRefreshingTable(i(1, 2, 3, 4, 5),
            c("x", 5, 4, 3, 2, 1), c("y", "e", "d", "c", "b", "a"));
        final Table tableUpdate3 = TstUtils.testRefreshingTable(i(1, 2, 3, 4, 5, 6),
    ...
    public void testSortOfByExternal() throws ExecutionException, InterruptedException {
        final QueryTable table =
            TstUtils.testRefreshingTable(i(2, 4, 6), c("x", 1, 2, 3), c("y", "a", "a", "a"));
        ...
        // We need to flush two notifications: one for the source table and one for the "withView"
        // table in the aggregation helper.
    ...
    public void testChain() throws ExecutionException, InterruptedException {
        final QueryTable table = TstUtils.testRefreshingTable(i(2, 4, 6), c("x", 1, 2, 3),
            c("y", "a", "b", "c"), c("z", true, false, true));
        final Table tableStart = TstUtils.testRefreshingTable(i(1, 3), c("x", 3, 1),
            c("y", "c", "a"), c("z", true, true), c("u", 12, 4));

        final Table tableUpdate = TstUtils.testRefreshingTable(i(1, 2, 4), c("x", 4, 3, 1),
            c("y", "d", "c", "a"), c("z", true, true, true), c("u", 16, 12, 4));

        final Callable<Table> callable =
            () -> table.updateView("u=x*4").where("z").sortDescending("x");
    ...
    public void testReverseLookupListener() throws ExecutionException, InterruptedException {
        ...
        final ReverseLookupListener rll = pool
            .submit(() -> ReverseLookupListener.makeReverseLookupListenerWithSnapshot(table, "x"))
            .get();
        ...
        final ReverseLookupListener rll2 = pool
            .submit(() -> ReverseLookupListener.makeReverseLookupListenerWithSnapshot(table, "x"))
            .get();
        ...
        final ReverseLookupListener rll3 = pool
            .submit(() -> ReverseLookupListener.makeReverseLookupListenerWithSnapshot(table, "x"))
            .get();
    ...
    public void testIterativeQuickFilter() {
        ...
        transformations.add(t -> t.where(DisjunctiveFilter.makeDisjunctiveFilter(
            SelectFilterFactory.expandQuickFilter(t, "10", QuickFilterMode.NORMAL))));
        transformations.add(t -> t.sortDescending("doubleCol"));
        transformations.add(Table::flatten);
    ...
    public void testIterativeDisjunctiveCondition() {
        final List<Function<Table, Table>> transformations = new ArrayList<>();
        transformations.add(t -> t.where(
            DisjunctiveFilter.makeDisjunctiveFilter(ConditionFilter.createConditionFilter("false"),
    ...
    private void testIterative(List<Function<Table, Table>> transformations, int seed,
        MutableInt numSteps) {
        ...
        final QueryTable table = getTable(size, random,
            columnInfos =
                initColumnInfos(new String[] {"Sym", "intCol", "boolCol", "boolCol2", "doubleCol"},
        ...
        final List<Pair<Callable<Table>, Function<Table, Table>>> splitCallables =
            new ArrayList<>();
        ...
        try {
            ...
            for (numSteps.setValue(0); numSteps.intValue() < maxSteps; numSteps.increment()) {
                ...
                if (beforeStartAndBeforeUpdate) {
                    final List<Table> beforeStartAndBeforeUpdateSplitResults =
                        new ArrayList<>(splitCallables.size());
                    for (int splitIndex = 0; splitIndex < splitCallables.size(); ++splitIndex) {
                        final int fSplitIndex = splitIndex;
                        final Table splitResult =
                            pool.submit(() -> splitCallables.get(fSplitIndex).second
                ...
                final Index[] updates =
                    GenerateTableUpdates.computeTableUpdates(size, random, table, columnInfos);
                ...
                if (beforeAndAfterUpdate) {
                    final List<Table> beforeAndAfterUpdateSplitResults =
                        new ArrayList<>(splitCallables.size());
                    for (int splitIndex = 0; splitIndex < splitCallables.size(); ++splitIndex) {
                        final int fSplitIndex = splitIndex;
                        final Table splitResult =
                ...
                if (beforeStartAndAfterUpdate) {
                    final List<Table> beforeStartAndAfterUpdateSplitResults =
                        new ArrayList<>(splitCallables.size());
                    for (int splitIndex = 0; splitIndex < splitCallables.size(); ++splitIndex) {
                        final int fSplitIndex = splitIndex;
                        final Table splitResult =
                ...
                if (beforeAndAfterNotify) {
                    final List<Table> beforeAndAfterNotifySplitResults =
                        new ArrayList<>(splitCallables.size());
                    for (int splitIndex = 0; splitIndex < splitCallables.size(); ++splitIndex) {
                        final int fSplitIndex = splitIndex;
                        final Table splitResult =
                ...
                if (beforeStartAndAfterNotify) {
                    final List<Table> beforeStartAndAfterNotifySplitResults =
                        new ArrayList<>(splitCallables.size());
                    for (int splitIndex = 0; splitIndex < splitCallables.size(); ++splitIndex) {
                        final int fSplitIndex = splitIndex;
                        final Table splitResult =
                ...
                if (beforeUpdateAndAfterNotify) {
                    final List<Table> beforeUpdateAndAfterNotifySplitResults =
                        new ArrayList<>(splitCallables.size());
                    for (int splitIndex = 0; splitIndex < splitCallables.size(); ++splitIndex) {
                        final int fSplitIndex = splitIndex;
                        final Table splitResult =
                ...
                for (int newResult = lastResultSize; newResult < results.size(); ++newResult) {
                    ...
                    final InstrumentedShiftAwareListenerAdapter listener =
                        new InstrumentedShiftAwareListenerAdapter("errorListener", dynamicTable,
                            false) {
                            @Override
                ...
                if (beforeStartAndAfterCycle) {
                    final List<Table> beforeStartAndAfterCycleSplitResults =
                        new ArrayList<>(splitCallables.size());
                    for (int splitIndex = 0; splitIndex < splitCallables.size(); ++splitIndex) {
                        final int fSplitIndex = splitIndex;
                        final Table splitResult =
                ...
                if (beforeUpdateAndAfterCycle) {
                    final List<Table> beforeUpdateAndAfterCycleSplitResults =
                        new ArrayList<>(splitCallables.size());
                    for (int splitIndex = 0; splitIndex < splitCallables.size(); ++splitIndex) {
                        final int fSplitIndex = splitIndex;
                        final Table splitResult =
                ...
                if (beforeNotifyAndAfterCycle) {
                    final List<Table> beforeNotifyAndAfterCycleSplitResults =
                        new ArrayList<>(splitCallables.size());
                    for (int splitIndex = 0; splitIndex < splitCallables.size(); ++splitIndex) {
                        final int fSplitIndex = splitIndex;
                        final Table splitResult =
                    ...
                    for (int splitIndex = 0; splitIndex < splitCallables.size(); ++splitIndex) {
                        final Table splitResult = splitCallables.get(splitIndex).second
                            .apply(beforeNotifyFirstHalf.get(splitIndex));
                        splitResult.setAttribute("Step", i);
                ...
                if (transformations.size() > 1) {
                    Assert.eqFalse(beforeCycleFirstHalf.isEmpty(),
                        "beforeCycleFirstHalf.isEmpty()");
                    final List<Table> beforeAndAfterCycleSplitResults =
                        new ArrayList<>(splitCallables.size());
                ...
                if (LiveTableTestCase.printTableUpdates) {
                    ...
                    System.out.println(
                        "Verifying " + results.size() + " tables (size = " + standard.size() + ")");
                }
                ...
                for (Table checkTable : results) {
                    ...
                    if (!diff.isEmpty() && LiveTableTestCase.printTableUpdates) {
                        System.out
                            .println("Check Table: " + checkTable.getAttribute("Step") + ", " +
    ...
    public void testSelectDistinct() throws ExecutionException, InterruptedException {
        final QueryTable table =
            TstUtils.testRefreshingTable(i(2, 4, 6, 8), c("y", "a", "b", "a", "c"));
    ...
    public void testMinMaxBy() throws Exception {
        ...
        testByConcurrent(t -> t.by(new AddOnlyMinMaxByStateFactoryImpl(true), "KeyColumn"), true,
            false, false, true);
        testByConcurrent(t -> t.by(new AddOnlyMinMaxByStateFactoryImpl(false), "KeyColumn"), true,
            false, false, true);
    }
    ...
    public void testPercentileBy() throws Exception {
        testByConcurrent(t -> t.dropColumns("KeyColumn").by(new PercentileByStateFactoryImpl(0.25)),
            false, false, true, true);
        testByConcurrent(t -> t.dropColumns("KeyColumn").by(new PercentileByStateFactoryImpl(0.75)),
            false, false, true, true);
        testByConcurrent(t -> t.medianBy("KeyColumn"));
    }

    public void testAggCombo() throws Exception {
        testByConcurrent(t -> t.by(AggCombo(AggAvg("AvgInt=IntCol"), AggCount("NumInts"),
    ...
    private void testByConcurrent(Function<Table, Table> function, boolean hasKeys,
        boolean withReset, boolean allowModifications, boolean haveBigNumerics) throws Exception {
        ...
        try {
            ...
            if (withReset) {
                ...
                callable = () -> {
                    ...
                    try {
                        ...
                        System.out
                            .println("Callable complete: " + (System.currentTimeMillis() - start));
                    }
                };
            } else {
                slowed = null;
            ...
            // We only care about the silent version of this table, as it's just a vessel to tick
            // and ensure that the resultant table
            ...
            // The column sources are redirected, and the underlying table has been updated without
            // a notification _yet_,
            // so the column sources have _already_ changed and we are inside an update cycle, so
            // the value of get() is indeterminate
            ...
            final Future<Table> future3 = pool.submit(callable);
            if (withReset) {
                while (((QueryTable) slowed).getLastNotificationStep() != LogicalClock.DEFAULT
                    .currentStep()) {
                    LiveTableMonitor.DEFAULT.flushOneNotificationForUnitTests();
                }
            }
    ...
    private void testByExternalConcurrent(boolean withReset) throws Exception {
        ...
        // We only care about the silent version of this table, as it's just a vessel to tick and
        // ensure that the resultant table
        // is computed using the appropriate version.
        final Table expected1 = LiveTableMonitor.DEFAULT.exclusiveLock()
    ...
    private QueryTable makeByConcurrentBaseTable(boolean haveBigNumerics) {
        final List<ColumnHolder> columnHolders = new ArrayList<>(Arrays.asList(
            ...
            longCol("LongCol", 10_000_000_000L, 20_000_000_000L, 30_000_000_000L,
                40_000_000_000L)));

        if (haveBigNumerics) {
            columnHolders
                .add(col("BigDecCol", BigDecimal.valueOf(10000.1), BigDecimal.valueOf(20000.2),
                    BigDecimal.valueOf(40000.3), BigDecimal.valueOf(40000.4)));
            columnHolders
                .add(col("BigIntCol", BigInteger.valueOf(100000), BigInteger.valueOf(200000),
    ...
    private QueryTable makeByConcurrentStep2Table(boolean allowModifications,
        boolean haveBigNumerics) {
    ...
    public void testConstructSnapshotException() throws ExecutionException, InterruptedException {
        ...
        final Future<String[]> future = pool.submit(() -> {
            ...
            ConstructSnapshot.callDataSnapshotFunction("testConstructSnapshotException",
                ConstructSnapshot.makeSnapshotControl(false, table), (usePrev, clock) -> {
                    ...
                    // on the first pass, we want to have an AAIOBE for the result1, which will
                    // occur, because 100ms
        ...
        // wait until we've had the future start, but before it's actually gotten completed, so we
        // know that it is
    ...
    public void testStaticSnapshot() throws ExecutionException, InterruptedException {
        ...
        final QueryTable table = TstUtils.testRefreshingTable(i(2, 4, 6), c("x", 1, 2, 3),
            c("y", "a", "b", "c"), c("z", true, false, true));
        final Table tableStart =
            TableTools.newTable(c("x", 1, 2, 3), c("y", "a", "b", "c"), c("z", true, false, true));
        final Table tableUpdate = TableTools.newTable(c("x", 1, 4, 2, 3),
            c("y", "a", "d", "b", "c"), c("z", true, true, false, true));
    ...
    public void testSnapshotLiveness() {
        ...
        LiveTableMonitor.DEFAULT.runWithinUnitTestCycle(() -> {
            final ShiftAwareListener.Update downstream =
                new ShiftAwareListener.Update(i(1), i(), i(),
