...
/**
 * A simple extension to the TreeMapSource that will not actually change any map values, and is thus immutable.
 * We need to have an immutable source available for use with the IndexGroupingTest, and this fits the bill.
 */
