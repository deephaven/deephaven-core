...
public class IndexGroupingTest extends LiveTableTestCase {
    ...
    public void testGrouping(final boolean immutableColumns, final Random random, final MutableInt numSteps) {
        ...
        if (immutableColumns) {
            ...
            columnInfo[0] = new TstUtils.ColumnInfo(new TstUtils.SetGenerator<>("a", "b", "c", "d", "e", "f"), "Sym", TstUtils.ColumnInfo.ColAttributes.Immutable);
            //noinspection unchecked
            columnInfo[1] = new TstUtils.ColumnInfo(new TstUtils.IntGenerator(10, 100), "intCol", TstUtils.ColumnInfo.ColAttributes.Immutable);
        } else {
            //noinspection unchecked
        ...
        final EvalNugget[] en = new EvalNugget[]{
                ...
                new EvalNugget() {
                    public Table e() {
                        return LiveTableMonitor.DEFAULT.exclusiveLock().computeLocked(() ->queryTable.update("intCol2 = intCol + 1"));
                    }
                },
                new EvalNugget() {
                    public Table e() {
                        return LiveTableMonitor.DEFAULT.exclusiveLock().computeLocked(() ->queryTable.update("intCol2 = intCol + 1").select());
                    }
                },
                new EvalNugget() {
                    public Table e() {
                        return LiveTableMonitor.DEFAULT.exclusiveLock().computeLocked(() ->queryTable.view("Sym", "intCol2 = intCol + 1"));
                    }
                },
                new EvalNugget() {
                    public Table e() {
                        return LiveTableMonitor.DEFAULT.exclusiveLock().computeLocked(() ->queryTable.avgBy("Sym").sort("Sym"));
                    }
                },
                new EvalNugget() {
                    public Table e() {
                        return LiveTableMonitor.DEFAULT.exclusiveLock().computeLocked(() ->queryTable.by("Sym", "intCol").sort("Sym", "intCol").view("doubleCol=max(doubleCol)"));
                    }
                },
                new EvalNugget() {
                    public Table e() {
                        return LiveTableMonitor.DEFAULT.exclusiveLock().computeLocked(() ->queryTable.avgBy("Sym", "doubleCol").sort("Sym", "doubleCol").view("intCol=min(intCol)"));
                    }
                },
        };
        ...
        Table merged = Require.neqNull(LiveTableMonitor.DEFAULT.exclusiveLock().computeLocked(() -> TableTools.merge(queryTable)), "TableTools.merge(queryTable)");
        addGroupingValidator((DynamicTable)merged, "merged");
        Table updated = LiveTableMonitor.DEFAULT.exclusiveLock().computeLocked(() -> merged.update("HiLo = intCol > 50 ? `Hi` : `Lo`"));
    ...
    public void testCombinedGrouping() throws IOException {
        ...
        //noinspection unchecked
        columnInfo[0] = new TstUtils.ColumnInfo(new TstUtils.SetGenerator<>("a", "b", "c", "d", "e", "f"), "Sym", TstUtils.ColumnInfo.ColAttributes.Immutable, TstUtils.ColumnInfo.ColAttributes.Grouped);
        //noinspection unchecked
        columnInfo[1] = new TstUtils.ColumnInfo(new TstUtils.SetGenerator<>("q", "r", "s", "t"), "Sym2", TstUtils.ColumnInfo.ColAttributes.Immutable, TstUtils.ColumnInfo.ColAttributes.Grouped);
        //noinspection unchecked
        columnInfo[2] = new TstUtils.ColumnInfo(new TstUtils.IntGenerator(10, 100), "intCol", TstUtils.ColumnInfo.ColAttributes.Immutable, TstUtils.ColumnInfo.ColAttributes.Grouped);
        //noinspection unchecked
        ...
        GroupingValidator.validateGrouping(new String[]{"Sym"}, countingTable.getIndex(), countingTable, "sym", symGrouping);
        ...
        GroupingValidator.validateGrouping(new String[]{"intCol"}, countingTable.getIndex(), countingTable, "intCol", intGrouping);
        countingTable.getColumnSources().forEach(x -> ((CountingTable.MethodCounter)x).clear());
        ...
        assertEquals(0, ((CountingTable.MethodCounter)intColumnSource).getMethodCount("get"));
        assertEquals(0, ((CountingTable.MethodCounter)intColumnSource).getMethodCount("getInt"));
        GroupingValidator.validateGrouping(new String[]{"intCol", "Sym"}, countingTable.getIndex(), countingTable, "intCol+sym", intSymGrouping);
        countingTable.getColumnSources().forEach(x -> ((CountingTable.MethodCounter)x).clear());

        final TupleSource intSymSym2TupleSource = TupleSourceFactory.makeTupleSource(intColumnSource, symColumnSource, sym2ColumnSource);
        ...
        assertEquals(0, ((CountingTable.MethodCounter)intColumnSource).getMethodCount("get"));
        assertEquals(0, ((CountingTable.MethodCounter)intColumnSource).getMethodCount("getInt"));
        GroupingValidator.validateGrouping(new String[]{"intCol", "Sym", "Sym2"}, countingTable.getIndex(), countingTable, "intCol+sym+sym2", intSymSym2Grouping);
        countingTable.getColumnSources().forEach(x -> ((CountingTable.MethodCounter)x).clear());

        final TupleSource intSymDoubleTupleSource = TupleSourceFactory.makeTupleSource(intColumnSource, symColumnSource, doubleColumnSource);
        ...
        GroupingValidator.validateGrouping(new String[]{"intCol", "Sym", "doubleCol"}, countingTable.getIndex(), countingTable, "intCol+sym+doubleCol", intSymDoubleGrouping);
        countingTable.getColumnSources().forEach(x -> ((CountingTable.MethodCounter)x).clear());

        final TupleSource intSymSym2DoubleTupleSource = TupleSourceFactory.makeTupleSource(intColumnSource, symColumnSource, sym2ColumnSource, doubleColumnSource);
        ...
        assertEquals(countingTable.size(), ((CountingTable.MethodCounter)doubleColumnSource).getMethodCount("get"));
        assertEquals(0, ((CountingTable.MethodCounter)doubleColumnSource).getMethodCount("getDouble"));
        GroupingValidator.validateGrouping(new String[]{"intCol", "Sym", "Sym2", "doubleCol"}, countingTable.getIndex(), countingTable, "intCol+sym+sym2+doubleCol", intSymSym2DoubleGrouping);
        countingTable.getColumnSources().forEach(x -> ((CountingTable.MethodCounter)x).clear());
    }
    ...
    public void testRestrictedGrouping() throws IOException {
        ...
        columnInfo[0] = new TstUtils.ColumnInfo(new TstUtils.SetGenerator<>("a", "b", "c", "d", "e", "f"), "Sym", TstUtils.ColumnInfo.ColAttributes.Immutable, TstUtils.ColumnInfo.ColAttributes.Grouped);
        //noinspection unchecked
        columnInfo[1] = new TstUtils.ColumnInfo(new TstUtils.SetGenerator<>("q", "r", "s", "t", "u", "v"), "Sym2", TstUtils.ColumnInfo.ColAttributes.Immutable, TstUtils.ColumnInfo.ColAttributes.Grouped);
        //noinspection unchecked
        columnInfo[2] = new TstUtils.ColumnInfo(new TstUtils.IntGenerator(10, 100), "intCol", TstUtils.ColumnInfo.ColAttributes.Immutable, TstUtils.ColumnInfo.ColAttributes.Grouped);
        //noinspection unchecked
        columnInfo[3] = new TstUtils.ColumnInfo(new TstUtils.SetGenerator<>(10.1, 20.1, 30.1), "doubleCol");
        ...
        assertFalse(countingTable.getIndex().hasGrouping(intColumnSource, symColumnSource));
        assertFalse(countingTable.getIndex().hasGrouping(intColumnSource, symColumnSource, sym2ColumnSource));
        assertFalse(countingTable.getIndex().hasGrouping(intColumnSource, symColumnSource, sym2ColumnSource, doubleColumnSource));
        assertFalse(countingTable.getIndex().hasGrouping(intColumnSource, symColumnSource, doubleColumnSource));
        ...
        GroupingValidator.validateRestrictedGrouping(new String[]{"Sym"}, countingTable.getIndex(), countingTable, "sym", symGrouping, keySet);
        ...
        assertEquals(0, ((CountingTable.MethodCounter)intColumnSource).getMethodCount("get"));
        assertEquals(0, ((CountingTable.MethodCounter)intColumnSource).getMethodCount("getInt"));
        GroupingValidator.validateRestrictedGrouping(new String[]{"intCol"}, countingTable.getIndex(), countingTable, "intCol", intGrouping, keySet);
        countingTable.getColumnSources().forEach(x -> ((CountingTable.MethodCounter)x).clear());

        keySet.clear();
        final TupleSource intSymFactory = TupleSourceFactory.makeTupleSource(intColumnSource, symColumnSource);
        TstUtils.selectSubIndexSet(5, countingTable.getIndex(), random).forEach(row -> keySet.add(intSymFactory.createTuple(row)));
        countingTable.getColumnSources().forEach(x -> ((CountingTable.MethodCounter)x).clear());

        final Map<Object, Index> intSymGrouping = countingTable.getIndex().getGroupingForKeySet(keySet, TupleSourceFactory.makeTupleSource(intColumnSource, symColumnSource));
        assertEquals(0, ((CountingTable.MethodCounter)symColumnSource).getMethodCount("get"));
        assertEquals(0, ((CountingTable.MethodCounter)intColumnSource).getMethodCount("get"));
        assertEquals(0, ((CountingTable.MethodCounter)intColumnSource).getMethodCount("getInt"));
        GroupingValidator.validateRestrictedGrouping(new String[]{"intCol", "Sym"}, countingTable.getIndex(), countingTable, "intCol+sym", intSymGrouping, keySet);
        countingTable.getColumnSources().forEach(x -> ((CountingTable.MethodCounter)x).clear());

        keySet.clear();
        final TupleSource intSymDoubleFactory = TupleSourceFactory.makeTupleSource(intColumnSource, symColumnSource, doubleColumnSource);
        TstUtils.selectSubIndexSet(5, countingTable.getIndex(), random).forEach(row -> keySet.add(intSymDoubleFactory.createTuple(row)));
        countingTable.getColumnSources().forEach(x -> ((CountingTable.MethodCounter)x).clear());

        final Map<Object, Index> intSymDoubleGrouping = countingTable.getIndex().getGroupingForKeySet(keySet, TupleSourceFactory.makeTupleSource(intColumnSource, symColumnSource, doubleColumnSource));
        assertEquals(0, ((CountingTable.MethodCounter)symColumnSource).getMethodCount("get"));
        assertEquals(0, ((CountingTable.MethodCounter)intColumnSource).getMethodCount("get"));
        assertEquals(0, ((CountingTable.MethodCounter)intColumnSource).getMethodCount("getInt"));
        ...
        GroupingValidator.validateRestrictedGrouping(new String[]{"intCol", "Sym", "doubleCol"}, countingTable.getIndex(), countingTable, "intCol+sym+doubleCol", intSymDoubleGrouping, keySet);

        keySet.clear();
        final TupleSource intSymSym2DoubleFactory = TupleSourceFactory.makeTupleSource(intColumnSource, symColumnSource, sym2ColumnSource, doubleColumnSource);
        TstUtils.selectSubIndexSet(5, countingTable.getIndex(), random).forEach(row -> keySet.add(intSymSym2DoubleFactory.createTuple(row)));
        countingTable.getColumnSources().forEach(x -> ((CountingTable.MethodCounter)x).clear());

        final Map<Object, Index> intSymSym2DoubleGrouping = countingTable.getIndex().getGroupingForKeySet(keySet, TupleSourceFactory.makeTupleSource(intColumnSource, symColumnSource, sym2ColumnSource, doubleColumnSource));
        assertEquals(0, ((CountingTable.MethodCounter)symColumnSource).getMethodCount("get"));
        assertEquals(0, ((CountingTable.MethodCounter)sym2ColumnSource).getMethodCount("get"));
        assertEquals(0, ((CountingTable.MethodCounter)intColumnSource).getMethodCount("get"));
        assertEquals(0, ((CountingTable.MethodCounter)intColumnSource).getMethodCount("getInt"));
        ...
        GroupingValidator.validateRestrictedGrouping(new String[]{"intCol", "Sym", "Sym2", "doubleCol"}, countingTable.getIndex(), countingTable, "intCol+sym+sym2+doubleCol", intSymSym2DoubleGrouping, keySet);
    }
