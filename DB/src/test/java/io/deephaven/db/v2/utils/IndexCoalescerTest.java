...
public class IndexCoalescerTest {
    ...
    public void testSuppressModifiedAdds() {
        ...
        final ShiftAwareListener.Update agg = validateFinalIndex(origIndex, up);
        Assert.equals(agg.added, "agg.added", Index.CURRENT_FACTORY.getIndexByValues(10), "Index.CURRENT_FACTORY.getIndexByValues(10)");
        Assert.equals(agg.modified, "agg.modified", Index.CURRENT_FACTORY.getEmptyIndex(), "Index.CURRENT_FACTORY.getEmptyIndex()");
    }
    ...
    public void testRemovedThenAdded() {
        ...
        final Index origIndex = i(2);
        final ShiftAwareListener.Update agg = validateFinalIndex(origIndex, up);
        Assert.equals(agg.added, "agg.added", Index.CURRENT_FACTORY.getIndexByValues(2), "Index.CURRENT_FACTORY.getIndexByValues(2)");
        Assert.equals(agg.removed, "agg.removed", Index.CURRENT_FACTORY.getIndexByValues(2), "Index.CURRENT_FACTORY.getIndexByValues(2)");
        Assert.equals(agg.modified, "agg.modified", Index.CURRENT_FACTORY.getEmptyIndex(), "Index.CURRENT_FACTORY.getEmptyIndex()");
    }
    ...
    public void testAddedThenRemoved() {
        ...
        final Index origIndex = i();
        final ShiftAwareListener.Update agg = validateFinalIndex(origIndex, up);
        Assert.equals(agg.added, "agg.added", Index.CURRENT_FACTORY.getEmptyIndex(), "Index.CURRENT_FACTORY.getEmptyIndex()");
        Assert.equals(agg.removed, "agg.removed", Index.CURRENT_FACTORY.getEmptyIndex(), "Index.CURRENT_FACTORY.getEmptyIndex()");
        Assert.equals(agg.modified, "agg.modified", Index.CURRENT_FACTORY.getEmptyIndex(), "Index.CURRENT_FACTORY.getEmptyIndex()");
    }
    ...
    public void testMergeWithDifferentMCS() {
        ...
        Assert.eqTrue(coalescer.modifiedColumnSet.containsAll(mcsTemplate), "coalescer.modifiedColumnSet.containsAll(mcsTemplate)");
    }
    ...
    public void testSortRegress1() {
        final ShiftAwareListener.Update[] up = newEmptyUpdates(4);
        // {added={1073741825,1073741827-1073741828,1073741832-1073741833}, removed={1073741825-1073741827}, modified={1073741829,1073741831}, shifted={[1073741828,1073741828]-2}, modifiedColumnSet={Sym,doubleCol,Keys}}
        ...
        // {added={1073741827,1073741832}, removed={1073741825,1073741828,1073741832-1073741833}, modified={1073741825-1073741826,1073741829-1073741831}, shifted={[1073741826,1073741827]-1}, modifiedColumnSet={Sym}}
        ...
        // {added={1073741823,1073741827,1073741832}, removed={1073741830}, modified={1073741824-1073741826,1073741829,1073741831,1073741833}, shifted={[1073741825,1073741827]-1,[1073741832,1073741832]+1}, modifiedColumnSet={Sym,intCol,Keys}}
        ...
        // {added={1073741820-1073741823,1073741826,1073741830}, removed={1073741823,1073741827}, modified={1073741819,1073741824-1073741825,1073741829,1073741831-1073741833}, shifted={[1073741824,1073741824]-5,[1073741825,1073741826]-1}, modifiedColumnSet={intCol,Keys}}
