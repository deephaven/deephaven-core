...
public class TestChunkColumnSource {
    ...
    private void checkDoubles(WritableDoubleChunk<Attributes.Values> doubleChunk1, WritableDoubleChunk<Attributes.Values> doubleChunk2, ChunkColumnSource<?> doubleColumnSource) {
    ...
    private void checkLongs(WritableLongChunk<Attributes.Values> longChunk1, WritableLongChunk<Attributes.Values> longChunk2, ChunkColumnSource<?> longColumnSource) {
