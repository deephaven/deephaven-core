...
public class JpyPlaypen {
    ...
    public static void main(String [] args) throws InterruptedException {
        ...
        System.setProperty("jpy.pythonLib", "/System/Library/Frameworks/Python.framework/Versions/2.7/lib/libpython2.7.dylib");
        ...
        if (s != null) {
            ...
            System.out.println("OV = \"" + objectValue + "\" (" + (objectValue != null ? objectValue.getClass().getCanonicalName() : "(null)") + ")");
        ...
        if (s != null) {
            ...
            System.out.println("Type = \"" + type + "\" (" + (type != null ? type.getClass().getCanonicalName() : "(null)") + ")");
