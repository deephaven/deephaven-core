...
public class TestDBColorUtil extends BaseArrayTestCase {
    ...
    public void testRowFormatWhereNew() {
        ...
        testRowFormatWhere(t1.formatRowWhere("X > 5", "`aliceblue`"), ALICEBLUE);
        testRowFormatWhere(
            t1.formatRowWhere("X > 5", "io.deephaven.gui.color.Color.color(`aliceblue`)"),
            ALICEBLUE);
    }
    ...
    public void testRowFormatWhereOld() {
        ...
        testRowFormatWhere(t1.formatRowWhere("X > 5", "`VIVID_RED`"), VIVID_RED);
        testRowFormatWhere(
            t1.formatRowWhere("X > 5", "io.deephaven.gui.color.Color.color(`VIVID_RED`)"),
            VIVID_RED);
    }
    ...
    public void testFormatColumnsNew() {
        ...
        testFormatColumns(t1.formatColumns("X = io.deephaven.gui.color.Color.color(`aliceblue`)"),
            ALICEBLUE);
    }
    ...
    public void testFormatColumnsOld() {
        ...
        testFormatColumns(t1.formatColumns("X = io.deephaven.gui.color.Color.color(`VIVID_RED`)"),
            VIVID_RED);
    }
    ...
    public void testForeground() {
        ...
        assertEquals(DBColorUtil.fg(ALICEBLUE),
            DBColorUtil.foreground(Color.colorRGB(240, 248, 255)));
    ...
    public void testForegroundOverride() {
        ...
        assertEquals(DBColorUtil.fgo(ALICEBLUE),
            DBColorUtil.foregroundOverride(Color.colorRGB(240, 248, 255)));
    ...
    public void testBackgroundOverride() {
        ...
        assertEquals(DBColorUtil.bgo(ALICEBLUE),
            DBColorUtil.backgroundOverride(Color.colorRGB(240, 248, 255)));
    ...
    public void testBackgroundForeground() {
        assertEquals("111111111111111111111111100000101111111111111111111111111",
            Long.toBinaryString(DBColorUtil.backgroundForeground(Color.colorRGB(255, 255, 255),
                Color.colorRGB(255, 255, 255))));
        assertEquals("100000000000000000000000000000101000000000000000000000000",
            Long.toBinaryString(DBColorUtil.backgroundForeground(Color.colorRGB(0, 0, 0),
                Color.colorRGB(0, 0, 0))));

        assertEquals(DBColorUtil.bgfg(ALICEBLUE, ANTIQUEWHITE), DBColorUtil
            .backgroundForeground(Color.colorRGB(240, 248, 255), Color.colorRGB(250, 235, 215)));
        assertEquals(DBColorUtil.bgfg(ALICEBLUE, ANTIQUEWHITE),
            DBColorUtil.backgroundForeground(ALICEBLUE, ANTIQUEWHITE));
        assertEquals(DBColorUtil.bgfg(ALICEBLUE, ANTIQUEWHITE),
            DBColorUtil.backgroundForeground("#F0F8FF", "#FAEBD7"));
        assertEquals(DBColorUtil.bgfg(ALICEBLUE, ANTIQUEWHITE),
            DBColorUtil.bgfg("#F0F8FF", "#FAEBD7"));
        assertEquals(DBColorUtil.bgfg(ALICEBLUE, ANTIQUEWHITE),
            DBColorUtil.bgfg(240, 248, 255, 250, 235, 215));
        ...
        assertFalse(
            DBColorUtil.isBackgroundSelectionOverride(DBColorUtil.bgfg(ALICEBLUE, ANTIQUEWHITE)));
        assertFalse(
            DBColorUtil.isForegroundSelectionOverride(DBColorUtil.bgfg(ALICEBLUE, ANTIQUEWHITE)));
    ...
    public void testBackgroundForegroundAuto() {
        ...
        assertEquals(DBColorUtil.bgfga(ALICEBLUE),
            DBColorUtil.backgroundForegroundAuto(Color.colorRGB(240, 248, 255)));
        assertEquals(DBColorUtil.bgfga(ALICEBLUE), DBColorUtil.backgroundForegroundAuto(ALICEBLUE));
        assertEquals(DBColorUtil.bgfga(ALICEBLUE),
            DBColorUtil.backgroundForegroundAuto("ALICEBLUE"));
    ...
    public void testHeatmapForeground() {
        ...
        assertEquals(DBColorUtil.fg(127, 0, 127),
    ...
    public void testToLong() {
        ...
        assertEquals(DBColorUtil.bgfga(ALICEBLUE),
            DBColorUtil.toLong(Color.colorRGB(240, 248, 255)));
        assertEquals(0L, DBColorUtil.toLong((Color) null));
    ...
    private void testRowFormatWhere(final Table colorTable, final Color color) {
        final long[] colorTableCol = colorTable
            .getColumn(
