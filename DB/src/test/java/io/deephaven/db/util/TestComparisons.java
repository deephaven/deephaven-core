...
public class TestComparisons {
    ...
    public void testCharCharComparisons() {
        ...
        TestCase.assertTrue(DhCharComparisons.eq(QueryConstants.NULL_CHAR, QueryConstants.NULL_CHAR));
    ...
    public void testLongLongComparisons() {
        ...
        TestCase.assertTrue(DhLongComparisons.eq(QueryConstants.NULL_LONG, QueryConstants.NULL_LONG));
    ...
    public void testFloatFloatComparisons() {
        ...
        TestCase.assertTrue(DhFloatComparisons.eq(QueryConstants.NULL_FLOAT, QueryConstants.NULL_FLOAT));
        ...
        TestCase.assertTrue(DhFloatComparisons.eq(Float.NEGATIVE_INFINITY, Float.NEGATIVE_INFINITY));
        TestCase.assertTrue(DhFloatComparisons.eq(Float.POSITIVE_INFINITY, Float.POSITIVE_INFINITY));
        ...
        TestCase.assertTrue(DhFloatComparisons.lt(Float.NEGATIVE_INFINITY, Float.POSITIVE_INFINITY));
        TestCase.assertTrue(DhFloatComparisons.gt(Float.POSITIVE_INFINITY, Float.NEGATIVE_INFINITY));
        TestCase.assertEquals(0, DhFloatComparisons.compare(Float.POSITIVE_INFINITY, Float.POSITIVE_INFINITY));
        TestCase.assertEquals(0, DhFloatComparisons.compare(Float.NEGATIVE_INFINITY, Float.NEGATIVE_INFINITY));
