...
public class SelectFilterFactoryTest extends TestCase {
    ...
    public void testInComplex() {
        ...
        SelectFilter filter = SelectFilterFactory.getExpression("Maturity in amExpiry,pmExpiry , \"AGAIN\"  ");
        assertEquals(MatchFilter.class, filter.getClass());
        TableDefinition tableDef = new TableDefinition(Collections.singletonList((Class) String.class), Collections.singletonList("Maturity"));
        ...
        assertEquals(MatchFilter.class, filter.getClass());
        tableDef = new TableDefinition(Collections.singletonList((Class) String.class), Collections.singletonList("Maturity"));

        try {
            filter.init(tableDef);
        } catch(IllegalArgumentException e) {
            assertEquals(e.getMessage(), "Failed to convert literal value <1> for column \"Maturity\" of type java.lang.String");
        }
    ...
    public void testIcase() {
        Table t = TableTools.newTable(TableTools.col("Opra","opra1","opra2","opra3","Opra1","Opra2","Opra3","Opra4", null));
    ...
    public void testInDateTimes() {
        ...
        Table t = TableTools.newTable(TableTools.col("Timestamp", new DBDateTime(mon.getNanos()), new DBDateTime(tues.getNanos()), new DBDateTime(thurs.getNanos())));
        // match one item
    ...
    public void testTypeInference() {
        checkResult("1", true, true, true, true, true, true, false, true, true, (byte)1, (short)1, 1, 1, new BigInteger("1"), 1.0, new BigDecimal("1"), '1');
        checkResult("-11", true, true, true, true, true, true, false, true, false, (byte)-11, (short)-11, -11, -11, new BigInteger("-11"), -11.0, new BigDecimal("-11"), '0');
        checkResult("1.", false, false, false, false, false, true, false, true, false, (byte)1, (short)1, 1, 1, null, 1.0, new BigDecimal("1.0"), '0');
        checkResult("-11.", false, false, false, false, false, true, false, true, false, (byte)1, (short)1, 1, 1, null, -11.0, new BigDecimal("-11.0"), '0');
        checkResult("1.1", false, false, false, false, false, true, false, true, false, (byte)1, (short)1, 1, 1, null, 1.1, new BigDecimal("1.1"), '0');
        checkResult("1.01", false, false, false, false, false, true, false, true, false, (byte)1, (short)1, 1, 1, null, 1.01, new BigDecimal("1.01"), '0');
        checkResult("128", false, true, true, true, true, true, false, true, false, (byte)1, (short)128, 128, 128, new BigInteger("128"), 128, new BigDecimal("128"), '0');
        checkResult("-128", true, true, true, true, true, true, false, true, false, (byte)-128, (short)-128, -128, -128, new BigInteger("-128"), -128, new BigDecimal("-128"), '0');
        checkResult("32768", false, false, true, true, true, true, false, true, false, (byte)0, (short)0, 32768, 32768, new BigInteger("32768"), 32768, new BigDecimal("32768"), '0');
        checkResult("-32768", false, true, true, true, true, true, false, true, false, (byte)0, (short)-32768, -32768, -32768, new BigInteger("-32768"), -32768, new BigDecimal("-32768"), '0');
        checkResult("2147483648", false, false, false, true, true, true, false, true, false, (byte)0, (short)0, 0, 2147483648l, new BigInteger("2147483648"), 2147483648l, new BigDecimal("2147483648"), '0');
        checkResult("-2147483648", false, false, true, true, true, true, false, true, false, (byte)0, (short)0, -2147483648, -2147483648, new BigInteger("-2147483648"), -2147483648, new BigDecimal("-2147483648"), '0');

        checkResult("true", false, false, false, false, false, false, true, false,   false, (byte)0, (short)0, 0, 0, null, 0, null, '0');
        checkResult("True", false, false, false, false, false, false, true, false,   false, (byte)0, (short)0, 0, 0, null, 0, null, '0');
        checkResult("TrUe", false, false, false, false, false, false, true, false,   false, (byte)0, (short)0, 0, 0, null, 0, null, '0');
        checkResult("TRUE", false, false, false, false, false, false, true, false,   false, (byte)0, (short)0, 0, 0, null, 0, null, '0');
        checkResult("tru3", false, false, false, false, false, false, false, false,  false,  (byte)0, (short)0, 0, 0, null, 0, null, '0');
        checkResult("false", false, false, false, false, false, false, true, false,  false,  (byte)0, (short)0, 0, 0, null, 0, null, '0');
        checkResult("False", false, false, false, false, false, false, true, false,  false,  (byte)0, (short)0, 0, 0, null, 0, null, '0');
        checkResult("FaLsE", false, false, false, false, false, false, true, false,  false,  (byte)0, (short)0, 0, 0, null, 0, null, '0');
        checkResult("FALSE", false, false, false, false, false, false, true, false,  false,  (byte)0, (short)0, 0, 0, null, 0, null, '0');
        checkResult("FALS3", false, false, false, false, false, false, false, false, false, (byte)0, (short)0, 0, 0, null, 0, null,'0');
        ...
        checkDateRange("2018-03-25 NY", DBTimeUtils.convertDateTime("2018-03-25 NY"), DBTimeUtils.convertDateTime("2018-03-26 NY"));
        checkDateRange("2018-03-25T18:00 NY", DBTimeUtils.convertDateTime("2018-03-25T18:00 NY"), DBTimeUtils.convertDateTime("2018-03-25T18:01 NY"));
        checkDateRange("2018-03-25T18:00:00 NY", DBTimeUtils.convertDateTime("2018-03-25T18:00:00 NY"), DBTimeUtils.convertDateTime("2018-03-25T18:00:01 NY"));
    }

    private DBDateTime makeDateTime(String timeStr) {
        ZonedDateTime zdt = ZonedDateTime.now(ZoneId.of("America/New_York")).truncatedTo(ChronoUnit.DAYS).plus(DBTimeUtils.convertTime(timeStr), ChronoUnit.NANOS);
    ...
    private void checkResult(String input, boolean isByte, boolean isShort, boolean isInt, boolean isLong, boolean isBigInt,
                             boolean isBigDecimal, boolean isBool, boolean isDouble, boolean isChar, byte byteVal, short shortVal, int intVal, long longVal, BigInteger biVal,
