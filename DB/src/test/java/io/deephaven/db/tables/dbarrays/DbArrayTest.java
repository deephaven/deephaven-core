...
public class DbArrayTest extends TestCase {
    ...
    public void testSubArrayByPositions() {
        ...
        DbArray<Integer> dbColumnArray = new DbArrayColumnWrapper<>(integerArraySource, Index.FACTORY.getIndexByRange(0, 5));
        ...
        for (int step = 0; step < 50; ++step) {
            ...
            DbArray<Integer> columnResult = dbColumnArray.subArrayByPositions(positions.toArray(new long[positions.size()]));
    ...
    /**
     * Verify that a DbArrayColumnWrapper can correctly invoke the 'getDirect' operation
     * even when one of the column sources is null.
     * */
