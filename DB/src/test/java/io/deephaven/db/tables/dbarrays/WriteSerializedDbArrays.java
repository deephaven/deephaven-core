...
public class WriteSerializedDbArrays {
    public static void main(String [] args) throws ClassNotFoundException {
        for (String className : new String[]{
                ...
                "io.deephaven.db.tables.dbarrays.DbArrayBooleanWrapper",
                "io.deephaven.db.tables.dbarrays.DbArrayByteWrapper",
                "io.deephaven.db.tables.dbarrays.DbArrayCharWrapper",
                "io.deephaven.db.tables.dbarrays.DbArrayShortWrapper",
                "io.deephaven.db.tables.dbarrays.DbArrayIntWrapper",
                "io.deephaven.db.tables.dbarrays.DbArrayLongWrapper",
                "io.deephaven.db.tables.dbarrays.DbArrayDoubleWrapper",
                "io.deephaven.db.tables.dbarrays.DbArrayFloatWrapper",
