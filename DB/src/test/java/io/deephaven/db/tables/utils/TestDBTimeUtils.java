...
public class TestDBTimeUtils extends BaseArrayTestCase {
    ...
    public void testNanos() throws Exception {
        ...
        assertEquals(io.deephaven.util.QueryConstants.NULL_LONG,
            DBTimeUtils.nanos((DBDateTime) null));
    }
    ...
    public void testMidnightConversion() throws Exception {
        ...
        assertEquals(jodaMidnight.getMillis(),
            DBTimeUtils.millisToDateAtMidnightNy(dateTime.getMillis()).getMillis());

        assertNull(
            DBTimeUtils.millisToDateAtMidnightNy(io.deephaven.util.QueryConstants.NULL_LONG));
    }
    ...
    public void testPlus() throws Exception {
        ...
        assertEquals(dateTime.getNanos() + 3600000000000L,
            DBTimeUtils.plus(dateTime, period).getNanos());
    ...
    public void testMinus() throws Exception {
        ...
        assertEquals(dateTime1.getNanos() - 3600000000000L,
            DBTimeUtils.minus(dateTime1, period).getNanos());
    ...
    /*
     * public void testMillisToNanosWithHack() throws Exception { // For this to pass,
     * ENABLE_MICROTIME_HACK in DBTimeUtils must be true (i.e. you have // to run the tests with
     * -DDBTimeUtils.enableMicrotimeHack=true) assertEquals(1_000_000,
     * DBTimeUtils.millisToNanos(1)); assertEquals(1_000_000_000, DBTimeUtils.millisToNanos(1_000));
    ...
    public void testConvertDateQuiet() throws Exception {
        ...
        // extremities of the format (LocalDate can store a much larger range than this but we
        ...
        assertEquals(LocalDate.of(2018, 1, 1),
            DBTimeUtils.convertDateQuiet("01/01/2018", DBTimeUtils.DateStyle.MDY));
        assertEquals(LocalDate.of(2018, 12, 31),
            DBTimeUtils.convertDateQuiet("12/31/2018", DBTimeUtils.DateStyle.MDY));
        assertEquals(LocalDate.of(2018, 12, 31),
            DBTimeUtils.convertDateQuiet("12/31/18", DBTimeUtils.DateStyle.MDY));
        assertEquals(LocalDate.of(2024, 6, 25),
            DBTimeUtils.convertDateQuiet("6/25/24", DBTimeUtils.DateStyle.MDY));
        assertEquals(LocalDate.of(2024, 6, 2),
            DBTimeUtils.convertDateQuiet("6/2/24", DBTimeUtils.DateStyle.MDY));
        assertEquals(LocalDate.of(2024, 6, 2),
            DBTimeUtils.convertDateQuiet("6/2/2024", DBTimeUtils.DateStyle.MDY));

        assertEquals(LocalDate.of(2018, 1, 1),
            DBTimeUtils.convertDateQuiet("01/01/2018", DBTimeUtils.DateStyle.DMY));
        assertEquals(LocalDate.of(2018, 12, 31),
            DBTimeUtils.convertDateQuiet("31/12/2018", DBTimeUtils.DateStyle.DMY));
        assertEquals(LocalDate.of(2018, 12, 31),
            DBTimeUtils.convertDateQuiet("31/12/18", DBTimeUtils.DateStyle.DMY));
        assertEquals(LocalDate.of(2024, 6, 25),
            DBTimeUtils.convertDateQuiet("25/6/24", DBTimeUtils.DateStyle.DMY));
        assertEquals(LocalDate.of(2024, 6, 2),
            DBTimeUtils.convertDateQuiet("2/6/24", DBTimeUtils.DateStyle.DMY));
        assertEquals(LocalDate.of(2024, 6, 2),
            DBTimeUtils.convertDateQuiet("2/6/2024", DBTimeUtils.DateStyle.DMY));


        assertEquals(LocalDate.of(2018, 1, 1),
            DBTimeUtils.convertDateQuiet("2018/01/01", DBTimeUtils.DateStyle.YMD));
        assertEquals(LocalDate.of(2018, 12, 31),
            DBTimeUtils.convertDateQuiet("2018/12/31", DBTimeUtils.DateStyle.YMD));
        assertEquals(LocalDate.of(2018, 12, 31),
            DBTimeUtils.convertDateQuiet("18/12/31", DBTimeUtils.DateStyle.YMD));
        assertEquals(LocalDate.of(2024, 6, 25),
            DBTimeUtils.convertDateQuiet("24/6/25", DBTimeUtils.DateStyle.YMD));
        assertEquals(LocalDate.of(2024, 6, 2),
            DBTimeUtils.convertDateQuiet("24/6/2", DBTimeUtils.DateStyle.YMD));
        assertEquals(LocalDate.of(2024, 6, 2),
            DBTimeUtils.convertDateQuiet("2024/6/2", DBTimeUtils.DateStyle.YMD));
    }

    public void testConvertLocalTimeQuiet() throws Exception {

        assertEquals(java.time.LocalTime.of(12, 59, 59),
            DBTimeUtils.convertLocalTimeQuiet("L12:59:59"));
        assertEquals(java.time.LocalTime.of(0, 0, 0),
            DBTimeUtils.convertLocalTimeQuiet("L00:00:00"));
        assertEquals(java.time.LocalTime.of(23, 59, 59),
            DBTimeUtils.convertLocalTimeQuiet("L23:59:59"));

        assertEquals(java.time.LocalTime.of(12, 59, 59),
            DBTimeUtils.convertLocalTimeQuiet("L125959"));
        assertEquals(java.time.LocalTime.of(0, 0, 0), DBTimeUtils.convertLocalTimeQuiet("L000000"));
        assertEquals(java.time.LocalTime.of(23, 59, 59),
            DBTimeUtils.convertLocalTimeQuiet("L235959"));
        ...
        assertEquals(java.time.LocalTime.of(12, 59, 0),
            DBTimeUtils.convertLocalTimeQuiet("L12:59"));
        assertEquals(java.time.LocalTime.of(12, 59, 59, 123_000_000),
            DBTimeUtils.convertLocalTimeQuiet("L12:59:59.123"));
        ...
        assertEquals(java.time.LocalTime.of(12, 59, 59, 123_456_789),
            DBTimeUtils.convertLocalTimeQuiet("L12:59:59.123456789"));

        assertEquals(java.time.LocalTime.of(12, 0, 0), DBTimeUtils.convertLocalTimeQuiet("L12"));
        assertEquals(java.time.LocalTime.of(12, 59, 0), DBTimeUtils.convertLocalTimeQuiet("L1259"));
        assertEquals(java.time.LocalTime.of(12, 59, 59, 123_000_000),
            DBTimeUtils.convertLocalTimeQuiet("L125959.123"));
        assertEquals(java.time.LocalTime.of(12, 59, 59, 123_456_000),
            DBTimeUtils.convertLocalTimeQuiet("L125959.123456"));
        assertEquals(java.time.LocalTime.of(12, 59, 59, 123_456_789),
            DBTimeUtils.convertLocalTimeQuiet("L125959.123456789"));
    }
    ...
    public void testConvertDateTimeQuiet() throws Exception {
        assertEquals(new DBDateTime(
            new DateTime("2010-01-01", DateTimeZone.forID("America/New_York")).getMillis()
                * 1000000),
            DBTimeUtils.convertDateTimeQuiet("2010-01-01 NY"));
        assertEquals(
            new DBDateTime(
                new DateTime("2010-01-01T12:00:00", DateTimeZone.forID("America/New_York"))
                    .getMillis() * 1000000),
            DBTimeUtils.convertDateTimeQuiet("2010-01-01T12:00:00 NY"));
        assertEquals(
            new DBDateTime(
                new DateTime("2010-01-01T12:00:00.1", DateTimeZone.forID("America/New_York"))
                    .getMillis() * 1000000),
            DBTimeUtils.convertDateTimeQuiet("2010-01-01T12:00:00.1 NY"));
        assertEquals(
            new DBDateTime(
                new DateTime("2010-01-01T12:00:00.123", DateTimeZone.forID("America/New_York"))
                    .getMillis() * 1000000),
            DBTimeUtils.convertDateTimeQuiet("2010-01-01T12:00:00.123 NY"));
        assertEquals(
            new DBDateTime(
                new DateTime("2010-01-01T12:00:00.123", DateTimeZone.forID("America/New_York"))
                    .getMillis() * 1000000 + 400000),
            DBTimeUtils.convertDateTimeQuiet("2010-01-01T12:00:00.1234 NY"));
        assertEquals(
            new DBDateTime(
                new DateTime("2010-01-01T12:00:00.123", DateTimeZone.forID("America/New_York"))
                    .getMillis() * 1000000 + 456789),
            DBTimeUtils.convertDateTimeQuiet("2010-01-01T12:00:00.123456789 NY"));

        assertEquals(new DBDateTime(
            new DateTime("2010-01-01", DateTimeZone.forID("America/Chicago")).getMillis()
                * 1000000),
            DBTimeUtils.convertDateTimeQuiet("2010-01-01 MN"));
        assertEquals(
            new DBDateTime(
                new DateTime("2010-01-01T12:00:00", DateTimeZone.forID("America/Chicago"))
                    .getMillis() * 1000000),
            DBTimeUtils.convertDateTimeQuiet("2010-01-01T12:00:00 MN"));
        assertEquals(
            new DBDateTime(
                new DateTime("2010-01-01T12:00:00.1", DateTimeZone.forID("America/Chicago"))
                    .getMillis() * 1000000),
            DBTimeUtils.convertDateTimeQuiet("2010-01-01T12:00:00.1 MN"));
        assertEquals(
            new DBDateTime(
                new DateTime("2010-01-01T12:00:00.123", DateTimeZone.forID("America/Chicago"))
                    .getMillis() * 1000000),
            DBTimeUtils.convertDateTimeQuiet("2010-01-01T12:00:00.123 MN"));
        assertEquals(
            new DBDateTime(
                new DateTime("2010-01-01T12:00:00.123", DateTimeZone.forID("America/Chicago"))
                    .getMillis() * 1000000 + 400000),
            DBTimeUtils.convertDateTimeQuiet("2010-01-01T12:00:00.1234 MN"));
        assertEquals(
            new DBDateTime(
                new DateTime("2010-01-01T12:00:00.123", DateTimeZone.forID("America/Chicago"))
                    .getMillis() * 1000000 + 456789),
            DBTimeUtils.convertDateTimeQuiet("2010-01-01T12:00:00.123456789 MN"));

        assertEquals(new DBDateTime(1503343549064106107L),
            DBTimeUtils.convertDateTimeQuiet("2017-08-21T15:25:49.064106107 NY"));

        // assertEquals(new DBDateTime(new DateTime("2010-01-01T12:00:00.123",
        // DateTimeZone.UTC).getMillis()*1000000),
        // DBTimeUtils.convertDateTimeQuiet("2010-01-01T12:00:00.123+0000"));
        // assertEquals(new DBDateTime(new DateTime("2010-01-01T12:00:00.123",
        // DateTimeZone.forID("America/New_York")).getMillis()*1000000),
        // DBTimeUtils.convertDateTimeQuiet("2010-01-01T12:00:00.123-0400"));
        // assertEquals(new DBDateTime(new DateTime("2010-01-01T12:00:00.123",
        // DateTimeZone.forID("Asia/Seoul")).getMillis()*1000000),
        // DBTimeUtils.convertDateTimeQuiet("2010-01-01T12:00:00.123+0900"));
    }
    ...
    public void testConvertTimeQuiet() throws Exception {
        assertEquals(new LocalTime("12:00").getMillisOfDay() * 1000000L,
            DBTimeUtils.convertTimeQuiet("12:00"));
        assertEquals(new LocalTime("12:00:00").getMillisOfDay() * 1000000L,
            DBTimeUtils.convertTimeQuiet("12:00:00"));
        assertEquals(new LocalTime("12:00:00.123").getMillisOfDay() * 1000000L,
            DBTimeUtils.convertTimeQuiet("12:00:00.123"));
        assertEquals(new LocalTime("12:00:00.123").getMillisOfDay() * 1000000L + 400000,
            DBTimeUtils.convertTimeQuiet("12:00:00.1234"));
        assertEquals(new LocalTime("12:00:00.123").getMillisOfDay() * 1000000L + 456789,
            DBTimeUtils.convertTimeQuiet("12:00:00.123456789"));

        assertEquals(new LocalTime("2:00").getMillisOfDay() * 1000000L,
            DBTimeUtils.convertTimeQuiet("2:00"));
        assertEquals(new LocalTime("2:00:00").getMillisOfDay() * 1000000L,
            DBTimeUtils.convertTimeQuiet("2:00:00"));
        assertEquals(new LocalTime("2:00:00.123").getMillisOfDay() * 1000000L,
            DBTimeUtils.convertTimeQuiet("2:00:00.123"));
        assertEquals(new LocalTime("2:00:00.123").getMillisOfDay() * 1000000L + 400000,
            DBTimeUtils.convertTimeQuiet("2:00:00.1234"));
        assertEquals(new LocalTime("2:00:00.123").getMillisOfDay() * 1000000L + 456789,
            DBTimeUtils.convertTimeQuiet("2:00:00.123456789"));

        assertEquals(new LocalTime("2:00").getMillisOfDay() * 1000000L
            + 3L * 1000000 * DateUtil.MILLIS_PER_DAY, DBTimeUtils.convertTimeQuiet("3T2:00"));
        assertEquals(
            new LocalTime("2:00:00").getMillisOfDay() * 1000000L
                + 3L * 1000000 * DateUtil.MILLIS_PER_DAY,
            DBTimeUtils.convertTimeQuiet("3T2:00:00"));
        assertEquals(
            new LocalTime("2:00:00.123").getMillisOfDay() * 1000000L
                + 3L * 1000000 * DateUtil.MILLIS_PER_DAY,
            DBTimeUtils.convertTimeQuiet("3T2:00:00.123"));
        assertEquals(
            new LocalTime("2:00:00.123").getMillisOfDay() * 1000000L + 400000
                + 3L * 1000000 * DateUtil.MILLIS_PER_DAY,
            DBTimeUtils.convertTimeQuiet("3T2:00:00.1234"));
        assertEquals(
            new LocalTime("2:00:00.123").getMillisOfDay() * 1000000L + 456789
                + 3L * 1000000 * DateUtil.MILLIS_PER_DAY,
            DBTimeUtils.convertTimeQuiet("3T2:00:00.123456789"));
    ...
    public void testTimeFormat() throws Exception {
        ...
        assertEquals("12:00:00.123000000",
            DBTimeUtils.format(DBTimeUtils.convertTimeQuiet("12:00:00.123")));
        assertEquals("12:00:00.123400000",
            DBTimeUtils.format(DBTimeUtils.convertTimeQuiet("12:00:00.1234")));
        assertEquals("12:00:00.123456789",
            DBTimeUtils.format(DBTimeUtils.convertTimeQuiet("12:00:00.123456789")));
        ...
        assertEquals("2:00:00.123000000",
            DBTimeUtils.format(DBTimeUtils.convertTimeQuiet("2:00:00.123")));
        assertEquals("2:00:00.123400000",
            DBTimeUtils.format(DBTimeUtils.convertTimeQuiet("2:00:00.1234")));
        assertEquals("2:00:00.123456789",
            DBTimeUtils.format(DBTimeUtils.convertTimeQuiet("2:00:00.123456789")));
        ...
        assertEquals("3T2:00:00.123000000",
            DBTimeUtils.format(DBTimeUtils.convertTimeQuiet("3T2:00:00.123")));
        assertEquals("3T2:00:00.123400000",
            DBTimeUtils.format(DBTimeUtils.convertTimeQuiet("3T2:00:00.1234")));
        assertEquals("3T2:00:00.123456789",
            DBTimeUtils.format(DBTimeUtils.convertTimeQuiet("3T2:00:00.123456789")));
    }

    public void testFormatDate() throws Exception {
        assertEquals("2010-01-01", DBTimeUtils
            .formatDate(DBTimeUtils.convertDateTimeQuiet("2010-01-01 NY"), DBTimeZone.TZ_NY));
    }
    ...
    public void testLowerBin() {
        ...
        assertEquals(DBTimeUtils.convertDateTime("2010-06-15T06:14:01 NY"),
            DBTimeUtils.lowerBin(time, second));
        assertEquals(DBTimeUtils.convertDateTime("2010-06-15T06:10:00 NY"),
            DBTimeUtils.lowerBin(time, 5 * minute));
        assertEquals(DBTimeUtils.convertDateTime("2010-06-15T06:00:00 NY"),
            DBTimeUtils.lowerBin(time, hour));
        ...
        assertEquals(DBTimeUtils.lowerBin(time, second),
            DBTimeUtils.lowerBin(DBTimeUtils.lowerBin(time, second), second));
    }
    ...
    public void testLowerBinWithOffset() {
        ...
        assertEquals(DBTimeUtils.convertDateTime("2010-06-15T06:11:00 NY"),
            DBTimeUtils.lowerBin(time, 5 * minute, minute));
        ...
        assertEquals(DBTimeUtils.lowerBin(time, second, second),
            DBTimeUtils.lowerBin(DBTimeUtils.lowerBin(time, second, second), second, second));
    }
    ...
    public void testUpperBin() {
        ...
        assertEquals(DBTimeUtils.convertDateTime("2010-06-15T06:14:02 NY"),
            DBTimeUtils.upperBin(time, second));
        assertEquals(DBTimeUtils.convertDateTime("2010-06-15T06:15:00 NY"),
            DBTimeUtils.upperBin(time, 5 * minute));
        assertEquals(DBTimeUtils.convertDateTime("2010-06-15T07:00:00 NY"),
            DBTimeUtils.upperBin(time, hour));
        ...
        assertEquals(DBTimeUtils.upperBin(time, second),
            DBTimeUtils.upperBin(DBTimeUtils.upperBin(time, second), second));
    }
    ...
    public void testUpperBinWithOffset() {
        ...
        assertEquals(DBTimeUtils.convertDateTime("2010-06-15T06:16:00 NY"),
            DBTimeUtils.upperBin(time, 5 * minute, minute));
        assertEquals(null, DBTimeUtils.upperBin(null, 5 * minute, minute));
        assertEquals(null,
            DBTimeUtils.upperBin(time, io.deephaven.util.QueryConstants.NULL_LONG, minute));
        assertEquals(null, DBTimeUtils.upperBin(time, 5 * minute, QueryConstants.NULL_LONG));

        assertEquals(DBTimeUtils.upperBin(time, second, second),
            DBTimeUtils.upperBin(DBTimeUtils.upperBin(time, second, second), second, second));
    }
    ...
    public void testGetExcelDate() {
        ...
        assertTrue(
            CompareUtils.doubleEquals(40344.666666666664, DBTimeUtils.getExcelDateTime(time)));
        assertTrue(CompareUtils.doubleEquals(40344.625,
            DBTimeUtils.getExcelDateTime(time, TimeZones.TZ_CHICAGO)));
        assertTrue(CompareUtils.doubleEquals(40344.625,
            DBTimeUtils.getExcelDateTime(time, DBTimeZone.TZ_MN)));
    }
    ...
    public void testAutoEpochToTime() {
        ...
        assertEquals("doTestAutoEpochToTime(inTheYear2035)", 2035,
            doTestAutoEpochToTime(inTheYear2035));
        long inTheYear1993 = 731966400;
        assertEquals("doTestAutoEpochToTime(inTheYear1993)", 1993,
            doTestAutoEpochToTime(inTheYear1993));
        long inTheYear2013 = 1363114800;
        assertEquals("doTestAutoEpochToTime(inTheYear2013)", 2013,
            doTestAutoEpochToTime(inTheYear2013));

        long inTheYear1904 = -2057338800;
        assertEquals("doTestAutoEpochToTime(inTheYear1904)", 1904,
            doTestAutoEpochToTime(inTheYear1904));
        long inTheYear1946 = -731966400;
        assertEquals("doTestAutoEpochToTime(inTheYear1946)", 1946,
            doTestAutoEpochToTime(inTheYear1946));
        long inTheYear1926 = -1363114800;
        assertEquals("doTestAutoEpochToTime(inTheYear1926)", 1926,
            doTestAutoEpochToTime(inTheYear1926));
    }

    public void testConvertExpression() throws Exception {
        assertEquals("_date0",
            DBTimeUtils.convertExpression("'2010-01-01 NY'").getConvertedFormula());
    ...
    public void testMicrosOfMilli() {
        assertEquals(0,
            DBTimeUtils.microsOfMilliNy(DBTimeUtils.convertDateTime("2015-07-31T20:40 NY")));
        assertEquals(0,
            DBTimeUtils.microsOfMilliNy(DBTimeUtils.convertDateTime("2015-07-31T20:40:00 NY")));
        assertEquals(0,
            DBTimeUtils.microsOfMilliNy(DBTimeUtils.convertDateTime("2015-07-31T20:40:00.123 NY")));
        assertEquals(400, DBTimeUtils
            .microsOfMilliNy(DBTimeUtils.convertDateTime("2015-07-31T20:40:00.1234 NY")));
        assertEquals(456, DBTimeUtils
            .microsOfMilliNy(DBTimeUtils.convertDateTime("2015-07-31T20:40:00.123456 NY")));
        assertEquals(457, DBTimeUtils
            .microsOfMilliNy(DBTimeUtils.convertDateTime("2015-07-31T20:40:00.1234567 NY"))); // this
                                                                                              // one
                                                                                              // should
                                                                                              // round
                                                                                              // up
        assertEquals(457, DBTimeUtils
            .microsOfMilliNy(DBTimeUtils.convertDateTime("2015-07-31T20:40:00.123456789 NY"))); // this
                                                                                                // one
                                                                                                // should
                                                                                                // round
                                                                                                // up
    ...
    public void testZonedDateTime() {
        ...
        final ZonedDateTime zonedDateTime1 = ZonedDateTime.of(2015, 7, 31, 20, 40, 0, 0,
            DBTimeZone.TZ_NY.getTimeZone().toTimeZone().toZoneId());
        ...
        assertEquals(dateTime2,
            DBTimeUtils.toDateTime(DBTimeUtils.getZonedDateTime(dateTime2, DBTimeZone.TZ_NY)));

        final DBDateTime dateTime3 = DBTimeUtils.convertDateTime("2050-07-31T20:40 NY");
        assertEquals(dateTime3,
            DBTimeUtils.toDateTime(DBTimeUtils.getZonedDateTime(dateTime3, DBTimeZone.TZ_NY)));
    }
}
