...
public class TestDBTimeUtils extends BaseArrayTestCase {
     ...
     * DBTimeUtils must be true (i.e. you have // to run the tests with -DDBTimeUtils.enableMicrotimeHack=true)
     * assertEquals(1_000_000, DBTimeUtils.millisToNanos(1)); assertEquals(1_000_000_000,
     * DBTimeUtils.millisToNanos(1_000)); assertEquals(1531315655_000_000_000L,
     * DBTimeUtils.millisToNanos(1531315655_000L)); assertEquals(1531315655_000_000_000L,
     * DBTimeUtils.millisToNanos(1531315655_000_000L)); }
     */
    ...
    public void testConvertDateTimeQuiet() throws Exception {
        assertEquals(
                new DBDateTime(
                        new DateTime("2010-01-01", DateTimeZone.forID("America/New_York")).getMillis() * 1000000),
                DBTimeUtils.convertDateTimeQuiet("2010-01-01 NY"));
        assertEquals(new DBDateTime(
                new DateTime("2010-01-01T12:00:00", DateTimeZone.forID("America/New_York")).getMillis() * 1000000),
                DBTimeUtils.convertDateTimeQuiet("2010-01-01T12:00:00 NY"));
        assertEquals(new DBDateTime(
                new DateTime("2010-01-01T12:00:00.1", DateTimeZone.forID("America/New_York")).getMillis() * 1000000),
                DBTimeUtils.convertDateTimeQuiet("2010-01-01T12:00:00.1 NY"));
        assertEquals(new DBDateTime(
                new DateTime("2010-01-01T12:00:00.123", DateTimeZone.forID("America/New_York")).getMillis() * 1000000),
        ...
        assertEquals(
                new DBDateTime(
                        new DateTime("2010-01-01T12:00:00.123", DateTimeZone.forID("America/New_York")).getMillis()
                                * 1000000 + 456789),
                DBTimeUtils.convertDateTimeQuiet("2010-01-01T12:00:00.123456789 NY"));

        assertEquals(
                new DBDateTime(new DateTime("2010-01-01", DateTimeZone.forID("America/Chicago")).getMillis() * 1000000),
                DBTimeUtils.convertDateTimeQuiet("2010-01-01 MN"));
        assertEquals(new DBDateTime(
                new DateTime("2010-01-01T12:00:00", DateTimeZone.forID("America/Chicago")).getMillis() * 1000000),
                DBTimeUtils.convertDateTimeQuiet("2010-01-01T12:00:00 MN"));
        assertEquals(new DBDateTime(
                new DateTime("2010-01-01T12:00:00.1", DateTimeZone.forID("America/Chicago")).getMillis() * 1000000),
                DBTimeUtils.convertDateTimeQuiet("2010-01-01T12:00:00.1 MN"));
        assertEquals(new DBDateTime(
                new DateTime("2010-01-01T12:00:00.123", DateTimeZone.forID("America/Chicago")).getMillis() * 1000000),
        ...
        assertEquals(
                new DBDateTime(
                        new DateTime("2010-01-01T12:00:00.123", DateTimeZone.forID("America/Chicago")).getMillis()
                                * 1000000 + 456789),
        ...
        // assertEquals(new DBDateTime(new DateTime("2010-01-01T12:00:00.123", DateTimeZone.UTC).getMillis()*1000000),
    ...
    public void testConvertTimeQuiet() throws Exception {
        ...
        assertEquals(new LocalTime("2:00").getMillisOfDay() * 1000000L + 3L * 1000000 * DateUtil.MILLIS_PER_DAY,
                DBTimeUtils.convertTimeQuiet("3T2:00"));
        ...
        assertEquals(new LocalTime("2:00:00.123").getMillisOfDay() * 1000000L + 400000
                + 3L * 1000000 * DateUtil.MILLIS_PER_DAY, DBTimeUtils.convertTimeQuiet("3T2:00:00.1234"));
        assertEquals(new LocalTime("2:00:00.123").getMillisOfDay() * 1000000L + 456789
                + 3L * 1000000 * DateUtil.MILLIS_PER_DAY, DBTimeUtils.convertTimeQuiet("3T2:00:00.123456789"));
    ...
    public void testFormatDate() throws Exception {
        assertEquals("2010-01-01",
                DBTimeUtils.formatDate(DBTimeUtils.convertDateTimeQuiet("2010-01-01 NY"), DBTimeZone.TZ_NY));
    }
    ...
    public void testMicrosOfMilli() {
        ...
        assertEquals(457, DBTimeUtils.microsOfMilliNy(DBTimeUtils.convertDateTime("2015-07-31T20:40:00.1234567 NY"))); // this
                                                                                                                       // one
                                                                                                                       // should
                                                                                                                       // round
                                                                                                                       // up
        assertEquals(457, DBTimeUtils.microsOfMilliNy(DBTimeUtils.convertDateTime("2015-07-31T20:40:00.123456789 NY"))); // this
                                                                                                                         // one
                                                                                                                         // should
                                                                                                                         // round
                                                                                                                         // up
    ...
    public void testZonedDateTime() {
        ...
        final ZonedDateTime zonedDateTime1 =
                ZonedDateTime.of(2015, 7, 31, 20, 40, 0, 0, DBTimeZone.TZ_NY.getTimeZone().toTimeZone().toZoneId());
