...
public class ReplicateTst {
    public static void main(String[] args) throws IOException {
        ...
        ReplicatePrimitiveCode.shortToAllIntegralTypes(TestShortNumericPrimitives.class, ReplicatePrimitiveCode.TEST_SRC);
        ReplicatePrimitiveCode.floatToAllFloatingPoints(TestFloatNumericPrimitives.class, ReplicatePrimitiveCode.TEST_SRC);
