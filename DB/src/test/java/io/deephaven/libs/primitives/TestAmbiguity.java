...
import static io.deephaven.libs.primitives.BooleanPrimitives.isNull;
import static io.deephaven.libs.primitives.ByteNumericPrimitives.max;
import static io.deephaven.libs.primitives.ByteNumericPrimitives.min;
import static io.deephaven.libs.primitives.ByteNumericPrimitives.sort;
import static io.deephaven.libs.primitives.ByteNumericPrimitives.sortDescending;
import static io.deephaven.libs.primitives.BytePrimitives.isNull;
import static io.deephaven.libs.primitives.CharacterPrimitives.isNull;
import static io.deephaven.libs.primitives.ComparePrimitives.max;
import static io.deephaven.libs.primitives.ComparePrimitives.min;
import static io.deephaven.libs.primitives.DoubleNumericPrimitives.max;
import static io.deephaven.libs.primitives.DoubleNumericPrimitives.min;
import static io.deephaven.libs.primitives.DoubleNumericPrimitives.sort;
import static io.deephaven.libs.primitives.DoubleNumericPrimitives.sortDescending;
import static io.deephaven.libs.primitives.DoublePrimitives.isNull;
import static io.deephaven.libs.primitives.FloatNumericPrimitives.max;
import static io.deephaven.libs.primitives.FloatNumericPrimitives.min;
import static io.deephaven.libs.primitives.FloatNumericPrimitives.sort;
import static io.deephaven.libs.primitives.FloatNumericPrimitives.sortDescending;
import static io.deephaven.libs.primitives.FloatPrimitives.isNull;
import static io.deephaven.libs.primitives.IntegerNumericPrimitives.max;
import static io.deephaven.libs.primitives.IntegerNumericPrimitives.min;
import static io.deephaven.libs.primitives.IntegerNumericPrimitives.sort;
import static io.deephaven.libs.primitives.IntegerNumericPrimitives.sortDescending;
import static io.deephaven.libs.primitives.IntegerPrimitives.isNull;
import static io.deephaven.libs.primitives.LongNumericPrimitives.max;
import static io.deephaven.libs.primitives.LongNumericPrimitives.min;
import static io.deephaven.libs.primitives.LongNumericPrimitives.sort;
import static io.deephaven.libs.primitives.LongNumericPrimitives.sortDescending;
import static io.deephaven.libs.primitives.LongPrimitives.isNull;
import static io.deephaven.libs.primitives.ObjectPrimitives.isNull;
import static io.deephaven.libs.primitives.ObjectPrimitives.max;
import static io.deephaven.libs.primitives.ObjectPrimitives.min;
import static io.deephaven.libs.primitives.ObjectPrimitives.sort;
import static io.deephaven.libs.primitives.ObjectPrimitives.sortDescending;
import static io.deephaven.libs.primitives.ShortNumericPrimitives.max;
import static io.deephaven.libs.primitives.ShortNumericPrimitives.min;
import static io.deephaven.libs.primitives.ShortNumericPrimitives.sort;
import static io.deephaven.libs.primitives.ShortNumericPrimitives.sortDescending;
import static io.deephaven.libs.primitives.ShortPrimitives.isNull;
...
public class TestAmbiguity {
    ...
    public void testMin() {
        ...
        assertEquals(new BigDecimal("0.5236598874"), min(new BigInteger("2"), 10, 2.0, 5.6f, 5l, (byte) 3, (short) 1, new BigDecimal("0.5236598874")));
        ...
        assertEquals(((double) QueryConstants.NULL_LONG) - 1d, min(QueryConstants.NULL_LONG, ((double) QueryConstants.NULL_LONG) - 1d), 0d);
        ...
        assertEquals(new Double("-1.34758724E20"), min(Long.MIN_VALUE + 1, new Double("-1.34758724E20"), Long.MAX_VALUE));
        assertEquals(new Double("-1.347587244542345673435434E20"), min(Long.MIN_VALUE + 1, new Double("-1.347587244542345673435434E20"), Long.MAX_VALUE));
        //Positive and negative infinity values (Order matters when both Double.NEGATIVE_INFINITY and Float.NEGATIVE_INFINITY are present)
        assertEquals(Double.NEGATIVE_INFINITY, min(Double.NEGATIVE_INFINITY, Float.NEGATIVE_INFINITY, Double.POSITIVE_INFINITY, Float.POSITIVE_INFINITY));
        assertEquals(Float.NEGATIVE_INFINITY, min(Float.NEGATIVE_INFINITY, Double.NEGATIVE_INFINITY, Double.NaN, Float.NaN));
        ...
        assertEquals(new Float("-1.347587244542345673435434E20"), min(Integer.MIN_VALUE + 1, new Float("-1.347587244542345673435434E20")), 0d);
        //Positive and negative infinity values (Order matters when both Double.NEGATIVE_INFINITY and Float.NEGATIVE_INFINITY are present)
        assertEquals(Double.NEGATIVE_INFINITY, min(Double.NEGATIVE_INFINITY, Float.NEGATIVE_INFINITY, Double.POSITIVE_INFINITY, Float.POSITIVE_INFINITY));
        assertEquals(Float.NEGATIVE_INFINITY, min(Float.NEGATIVE_INFINITY, Double.NEGATIVE_INFINITY, Double.NaN, Float.NaN));
        ...
        assertEquals(io.deephaven.util.QueryConstants.NULL_DOUBLE, min(io.deephaven.util.QueryConstants.NULL_DOUBLE, io.deephaven.util.QueryConstants.NULL_LONG), 0d);
        ...
        assertEquals(io.deephaven.util.QueryConstants.NULL_DOUBLE, min(io.deephaven.util.QueryConstants.NULL_LONG, io.deephaven.util.QueryConstants.NULL_DOUBLE), 0d);
        assertEquals(io.deephaven.util.QueryConstants.NULL_DOUBLE, min(io.deephaven.util.QueryConstants.NULL_LONG, Double.NaN), 0d);
    ...
    public void testMax() {
        ...
        assertEquals((short) (QueryConstants.NULL_BYTE - 1), max(QueryConstants.NULL_BYTE, (short) (QueryConstants.NULL_BYTE - 1)));
        ...
        assertEquals(new Double("1.347587244542345673435434E20"), max(Long.MAX_VALUE, new Double("1.347587244542345673435434E20"), 0d));
        //Positive and negative infinity values (Order matters when both Double.POSITIVE_INFINITY and Float.POSITIVE_INFINITY are present)
        assertEquals(Double.POSITIVE_INFINITY, max(Double.POSITIVE_INFINITY, Float.POSITIVE_INFINITY, Double.NEGATIVE_INFINITY, Float.NEGATIVE_INFINITY));
        assertEquals(Float.POSITIVE_INFINITY, max(Float.POSITIVE_INFINITY, Double.POSITIVE_INFINITY, Double.NaN, Float.NaN));
        ...
        assertEquals(new Float("1.347587244542345673435434E20"), max(Integer.MAX_VALUE - 1, new Float("1.347587244542345673435434E20")), 0d);
        ...
        //Positive and negative infinity values (Order matters when both Double.NEGATIVE_INFINITY and Float.NEGATIVE_INFINITY are present)
        assertEquals(Double.POSITIVE_INFINITY, max(Double.POSITIVE_INFINITY, Float.POSITIVE_INFINITY, Double.POSITIVE_INFINITY, Float.POSITIVE_INFINITY));
        assertEquals(Float.POSITIVE_INFINITY, max(Float.POSITIVE_INFINITY, Double.POSITIVE_INFINITY, Double.NaN, Float.NaN));
        ...
        assertEquals(io.deephaven.util.QueryConstants.NULL_DOUBLE, max(io.deephaven.util.QueryConstants.NULL_DOUBLE, io.deephaven.util.QueryConstants.NULL_LONG), 0d);
        ...
        assertEquals(io.deephaven.util.QueryConstants.NULL_DOUBLE, max(io.deephaven.util.QueryConstants.NULL_LONG, io.deephaven.util.QueryConstants.NULL_DOUBLE), 0d);
        assertEquals(io.deephaven.util.QueryConstants.NULL_DOUBLE, max(io.deephaven.util.QueryConstants.NULL_LONG, Double.NaN), 0d);
    ...
    public void testSort() {
        ...
        assertArrayEquals(new BigInteger[]{new BigInteger("1"), new BigInteger("2"), new BigInteger("3")}, sort(new BigInteger("1"), new BigInteger("2"), new BigInteger("3")));
    ...
    public void testSortDescending() {
        ...
        assertArrayEquals(new BigInteger[]{new BigInteger("3"), new BigInteger("2"), new BigInteger("1")}, sortDescending(new BigInteger("1"), new BigInteger("2"), new BigInteger("3")));
