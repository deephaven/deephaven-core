...
public class TestCasting extends BaseArrayTestCase {
    ...
    public void testCastLong() {
        ...
        assertEquals(new long[]{1,2,3,NULL_LONG}, castLong(new DbShortArrayDirect(new short[]{1,2,3,NULL_SHORT})));
    ...
    public void testCastDouble() {
        ...
        assertEquals(new double[]{1,2,3,NULL_DOUBLE}, castDouble(new DbByteArrayDirect(new byte[]{1,2,3,NULL_BYTE})));
        assertEquals(new double[]{1,2,3,NULL_DOUBLE}, castDouble(new DbShortArrayDirect(new short[]{1,2,3,NULL_SHORT})));
        assertEquals(new double[]{1,2,3,NULL_DOUBLE}, castDouble(new DbIntArrayDirect(new int[]{1,2,3,NULL_INT})));
        assertEquals(new double[]{1,2,3,NULL_DOUBLE}, castDouble(new DbLongArrayDirect(new long[]{1,2,3,NULL_LONG})));
        assertEquals(new double[]{1,2,3,NULL_DOUBLE}, castDouble(new DbFloatArrayDirect(new float[]{1,2,3,NULL_FLOAT})));
        assertEquals(new double[]{1,2,3,NULL_DOUBLE}, castDouble(new DbDoubleArrayDirect(new double[]{1,2,3,NULL_DOUBLE})));
    }
    ...
    public void testIntToDouble() {
        ...
        assertEquals(new double[]{1,2,3,NULL_DOUBLE}, intToDouble(new DbIntArrayDirect(new int[]{1,2,3,NULL_INT})).toArray());
    }
    ...
    public void testLongToDouble() {
        ...
        assertEquals(new double[]{1,2,3,NULL_DOUBLE}, longToDouble(new DbLongArrayDirect(new long[]{1,2,3,NULL_LONG})).toArray());
    }
}