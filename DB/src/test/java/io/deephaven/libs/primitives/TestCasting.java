...
public class TestCasting extends BaseArrayTestCase {
    ...
    public void testCastLong() {
        ...
        assertEquals(new long[] {1, 2, 3, NULL_LONG},
            castLong(new DbByteArrayDirect(new byte[] {1, 2, 3, NULL_BYTE})));
        assertEquals(new long[] {1, 2, 3, NULL_LONG},
            castLong(new DbShortArrayDirect(new short[] {1, 2, 3, NULL_SHORT})));
        assertEquals(new long[] {1, 2, 3, NULL_LONG},
            castLong(new DbIntArrayDirect(new int[] {1, 2, 3, NULL_INT})));
        assertEquals(new long[] {1, 2, 3, NULL_LONG},
            castLong(new DbLongArrayDirect(new long[] {1, 2, 3, NULL_LONG})));
    }
    ...
    public void testCastDouble() {
        ...
        assertEquals(new double[] {1, 2, 3, NULL_DOUBLE},
            castDouble(new byte[] {1, 2, 3, NULL_BYTE}));
        assertEquals(new double[] {1, 2, 3, NULL_DOUBLE},
            castDouble(new short[] {1, 2, 3, NULL_SHORT}));
        assertEquals(new double[] {1, 2, 3, NULL_DOUBLE},
            castDouble(new int[] {1, 2, 3, NULL_INT}));
        assertEquals(new double[] {1, 2, 3, NULL_DOUBLE},
            castDouble(new long[] {1, 2, 3, NULL_LONG}));
        assertEquals(new double[] {1, 2, 3, NULL_DOUBLE},
            castDouble(new float[] {1, 2, 3, NULL_FLOAT}));
        assertEquals(new double[] {1, 2, 3, NULL_DOUBLE},
            castDouble(new double[] {1, 2, 3, NULL_DOUBLE}));
    ...
    public void testIntToDouble() {
        ...
        assertEquals(new double[] {1, 2, 3, NULL_DOUBLE},
            intToDouble(new int[] {1, 2, 3, NULL_INT}));
    ...
    public void testLongToDouble() {
        ...
        assertEquals(new double[] {1, 2, 3, NULL_DOUBLE},
            longToDouble(new long[] {1, 2, 3, NULL_LONG}));
