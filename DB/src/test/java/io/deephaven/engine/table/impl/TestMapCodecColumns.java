...
public class TestMapCodecColumns {
    ...
    private static final Table TABLE = TableTools.newTable(TABLE_DEFINITION,
            TableTools.col("StrStrMap", CollectionUtil.mapFromArray(String.class, String.class, "AK", "AV", "BK", "BV"),
            ...
            TableTools.col("StrDoubleMap",
                    CollectionUtil.mapFromArray(String.class, Double.class, "One", 1.0, "Two", 2.0, "Null", null), null,
                    Collections.singletonMap("Pi", Math.PI)),
            TableTools.col("StrFloatMap",
                    CollectionUtil.mapFromArray(String.class, Float.class, "Ten", 10.0f, "Twenty", 20.0f, "Null", null),
