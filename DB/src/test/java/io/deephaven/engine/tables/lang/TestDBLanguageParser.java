...
import static io.deephaven.engine.tables.lang.DBLanguageParser.isWideningPrimitiveConversion;
...
public class TestDBLanguageParser extends BaseArrayTestCase {
    ...
    public void testBadFieldAccess() throws Exception {
        ...
        try {
            ...
            try {
                expression =
                        "io.deephaven.engine.tables.lang.DBLanguageParserDummyClass.interpolate(myDoubleDBArray.toArray(),myDoubleDBArray.toArray(),new double[]{myDouble},io.deephaven.engine.tables.lang.NestedEnum.ONE,false)[0]";
                resultExpression =
                        "io.deephaven.engine.tables.lang.DBLanguageParserDummyClass.interpolate(myDoubleDBArray.toArray(),myDoubleDBArray.toArray(),new double[]{myDouble},io.deephaven.engine.tables.lang.NestedEnum.ONE,false)[0]";
                check(expression, resultExpression, String.class, new String[] {});
                fail("Should have thrown a DBLanguageParser.QueryLanguageParseException");
    ...
    public void testEnums() throws Exception {
        ...
        expression = "io.deephaven.engine.tables.lang.DBLanguageParserDummyInterface.AnEnum.THING_ONE";
        resultExpression = "io.deephaven.engine.tables.lang.DBLanguageParserDummyInterface.AnEnum.THING_ONE";
        check(expression, resultExpression, DBLanguageParserDummyInterface.AnEnum.class, new String[] {});
    ...
    public void testUnboxAndWiden() throws Exception {
        ...
        String expression = "io.deephaven.engine.tables.utils.DBTimeUtils.plus(myDBDateTime, myLong)";
        String resultExpression = "io.deephaven.engine.tables.utils.DBTimeUtils.plus(myDBDateTime, myLong)";
        check(expression, resultExpression, DBDateTime.class, new String[] {"myDBDateTime", "myLong"});

        // check long unbox
        expression = "io.deephaven.engine.tables.utils.DBTimeUtils.plus(myDBDateTime, myLongObj)";
        resultExpression = "io.deephaven.engine.tables.utils.DBTimeUtils.plus(myDBDateTime, myLongObj.longValue())";
        check(expression, resultExpression, DBDateTime.class, new String[] {"myDBDateTime", "myLongObj"});

        // check int widen
        expression = "io.deephaven.engine.tables.utils.DBTimeUtils.plus(myDBDateTime, myInt)";
        resultExpression = "io.deephaven.engine.tables.utils.DBTimeUtils.plus(myDBDateTime, longCast(myInt))";
        check(expression, resultExpression, DBDateTime.class, new String[] {"myDBDateTime", "myInt"});

        // check int unbox and widen
        expression = "io.deephaven.engine.tables.utils.DBTimeUtils.plus(myDBDateTime, myIntObj)";
        resultExpression = "io.deephaven.engine.tables.utils.DBTimeUtils.plus(myDBDateTime, myIntObj.longValue())";
    ...
    public void testObjectConstruction() throws Exception {
        ...
        expression = "new io.deephaven.engine.tables.lang.DBLanguageParserDummyClass()";
        resultExpression = "new io.deephaven.engine.tables.lang.DBLanguageParserDummyClass()";
        ...
        resultExpression = "new io.deephaven.engine.tables.utils.DBDateTime(123L)";
    ...
    public void testInnerClasses() throws Exception {
        DBLanguageParser.Result result =
                new DBLanguageParser("io.deephaven.engine.tables.lang.TestDBLanguageParser.InnerEnum.YEAH!=null", null,
                        null, staticImports, null, null).getResult();
        assertEquals("!eq(io.deephaven.engine.tables.lang.TestDBLanguageParser.InnerEnum.YEAH, null)",
    ...
    public void testComplexExpressions() throws Exception {
        ...
        expression =
                "io.deephaven.engine.tables.lang.DBLanguageParserDummyClass.interpolate(myDoubleDBArray.toArray(),myDoubleDBArray.toArray(),new double[]{myDouble},io.deephaven.engine.tables.lang.DBLanguageParserDummyClass.NestedEnum.ONE,false)[0]";
        resultExpression =
                "io.deephaven.engine.tables.lang.DBLanguageParserDummyClass.interpolate(myDoubleDBArray.toArray(), myDoubleDBArray.toArray(), new double[]{ myDouble }, io.deephaven.engine.tables.lang.DBLanguageParserDummyClass.NestedEnum.ONE, false)[0]";
