...
public class TestDateTimeFormatter extends BaseArrayTestCase {
    ...
    public void test1() {
        ...
        assertEquals("2015-06-13T14:12:11.123456789 MN", dtf.format(t, TimeZone.TZ_MN));
    }
    ...
    public void test2() {
        ...
        assertEquals("2015-06-13 14:12:11.123456789 MN", dtf.format(t, TimeZone.TZ_MN));
    }
    ...
    public void test3() {
        ...
        assertEquals("14:12:11.123456789 MN", dtf.format(t, TimeZone.TZ_MN));
    }
    ...
    public void test4() {
        ...
        assertEquals("2015-06-13 MN", dtf.format(t, TimeZone.TZ_MN));
    }
    ...
    public void test5() {
        ...
        assertEquals("2015-06-13T14:12:11.1234 MN", dtf.format(t, TimeZone.TZ_MN));
    }
    ...
    public void test6() {
        ...
        assertEquals("2015-06-13T14:12:11.12 MN", dtf.format(t, TimeZone.TZ_MN));
    }
    ...
    public void test7() {
        ...
        assertEquals("2015-06-13T14:12:11.123456789", dtf.format(t, TimeZone.TZ_MN));
    }
}
