...
public class TestObjectArraySource {
    ...
    public void testGetChunk() {
        ...
        testGetChunkGeneric(new Object[0], new Object[0], 1, RowSetFactoryImpl.INSTANCE.getRowSetByValues());
        testGetChunkGeneric(new Object[0], new Object[0], 16, RowSetFactoryImpl.INSTANCE.getRowSetByValues());

        testGetChunkGeneric(ArrayGenerator.randomObjects(random, 16), ArrayGenerator.randomObjects(random, 16), 1, RowSetFactoryImpl.INSTANCE.getRowSetByValues(0));
        testGetChunkGeneric(ArrayGenerator.randomObjects(random, 16), ArrayGenerator.randomObjects(random, 16), 1, RowSetFactoryImpl.INSTANCE.getRowSetByValues(0, 1));
        testGetChunkGeneric(ArrayGenerator.randomObjects(random, 16), ArrayGenerator.randomObjects(random, 16), 1, RowSetFactoryImpl.INSTANCE.getRowSetByValues(4));
        testGetChunkGeneric(ArrayGenerator.randomObjects(random, 16), ArrayGenerator.randomObjects(random, 16), 1, RowSetFactoryImpl.INSTANCE.getRowSetByValues(4, 5, 6));
        testGetChunkGeneric(ArrayGenerator.randomObjects(random, 16), ArrayGenerator.randomObjects(random, 16), 1, RowSetFactoryImpl.INSTANCE.getRowSetByValues(4,  6));
        testGetChunkGeneric(ArrayGenerator.randomObjects(random, 16), ArrayGenerator.randomObjects(random, 16), 1, RowSetFactoryImpl.INSTANCE.getRowSetByValues(4, 5, 6, 7, 8));
        testGetChunkGeneric(ArrayGenerator.randomObjects(random, 16), ArrayGenerator.randomObjects(random, 16), 3, RowSetFactoryImpl.INSTANCE.getRowSetByValues(5, 6, 7));
        testGetChunkGeneric(ArrayGenerator.randomObjects(random, 16), ArrayGenerator.randomObjects(random, 16), 4, RowSetFactoryImpl.INSTANCE.getRowSetByValues(4, 5, 6, 7));
        testGetChunkGeneric(ArrayGenerator.randomObjects(random, 16), ArrayGenerator.randomObjects(random, 16), 5, RowSetFactoryImpl.INSTANCE.getRowSetByValues(4, 5, 6, 7, 8));
        testGetChunkGeneric(ArrayGenerator.randomObjects(random, 512), ArrayGenerator.randomObjects(random, 512), 4, RowSetFactoryImpl.INSTANCE.getRowSetByValues(254, 255, 256, 257));
        testGetChunkGeneric(ArrayGenerator.randomObjects(random, 512), ArrayGenerator.randomObjects(random, 512), 5, RowSetFactoryImpl.INSTANCE.getRowSetByValues(254, 255, 256, 257, 258));
    ...
    public void testGetChunkLazy() {
        final Random random = new Random(0);
        testGetChunkGenericLazy(new Object[0], 1, RowSetFactoryImpl.INSTANCE.getRowSetByValues());
        testGetChunkGenericLazy(new Object[0], 16, RowSetFactoryImpl.INSTANCE.getRowSetByValues());

        testGetChunkGenericLazy(ArrayGenerator.randomObjects(random, 16), 1, RowSetFactoryImpl.INSTANCE.getRowSetByValues(0));
        testGetChunkGenericLazy(ArrayGenerator.randomObjects(random, 16), 1, RowSetFactoryImpl.INSTANCE.getRowSetByValues(0, 1));
        testGetChunkGenericLazy(ArrayGenerator.randomObjects(random, 16), 1, RowSetFactoryImpl.INSTANCE.getRowSetByValues(4));
        testGetChunkGenericLazy(ArrayGenerator.randomObjects(random, 16), 1, RowSetFactoryImpl.INSTANCE.getRowSetByValues(4, 5, 6));
        testGetChunkGenericLazy(ArrayGenerator.randomObjects(random, 16), 1, RowSetFactoryImpl.INSTANCE.getRowSetByValues(4,  6));
        testGetChunkGenericLazy(ArrayGenerator.randomObjects(random, 16), 1, RowSetFactoryImpl.INSTANCE.getRowSetByValues(4, 5, 6, 7, 8));
        testGetChunkGenericLazy(ArrayGenerator.randomObjects(random, 16), 3, RowSetFactoryImpl.INSTANCE.getRowSetByValues(5, 6, 7));
        testGetChunkGenericLazy(ArrayGenerator.randomObjects(random, 16), 4, RowSetFactoryImpl.INSTANCE.getRowSetByValues(4, 5, 6, 7));
        testGetChunkGenericLazy(ArrayGenerator.randomObjects(random, 16), 5, RowSetFactoryImpl.INSTANCE.getRowSetByValues(4, 5, 6, 7, 8));
        testGetChunkGenericLazy(ArrayGenerator.randomObjects(random, 512), 4, RowSetFactoryImpl.INSTANCE.getRowSetByValues(254, 255, 256, 257));
        testGetChunkGenericLazy(ArrayGenerator.randomObjects(random, 512), 5, RowSetFactoryImpl.INSTANCE.getRowSetByValues(254, 255, 256, 257, 258));
    ...
    public void testFillChunk() {
        final Random random = new Random(0);
        testFillChunkGeneric(new Object[0], new Object[0], 1, RowSetFactoryImpl.INSTANCE.getRowSetByValues());
        testFillChunkGeneric(new Object[0], new Object[0], 16, RowSetFactoryImpl.INSTANCE.getRowSetByValues());

        testFillChunkGeneric(ArrayGenerator.randomObjects(random, 16), ArrayGenerator.randomObjects(random, 16), 1, RowSetFactoryImpl.INSTANCE.getRowSetByValues(0));
        testFillChunkGeneric(ArrayGenerator.randomObjects(random, 16), ArrayGenerator.randomObjects(random, 16), 1, RowSetFactoryImpl.INSTANCE.getRowSetByValues(0, 1));
        testFillChunkGeneric(ArrayGenerator.randomObjects(random, 16), ArrayGenerator.randomObjects(random, 16), 1, RowSetFactoryImpl.INSTANCE.getRowSetByValues(4));
        testFillChunkGeneric(ArrayGenerator.randomObjects(random, 16), ArrayGenerator.randomObjects(random, 16), 1, RowSetFactoryImpl.INSTANCE.getRowSetByValues(4, 5, 6));
        testFillChunkGeneric(ArrayGenerator.randomObjects(random, 16), ArrayGenerator.randomObjects(random, 16), 1, RowSetFactoryImpl.INSTANCE.getRowSetByValues(4,  6));
        testFillChunkGeneric(ArrayGenerator.randomObjects(random, 16), ArrayGenerator.randomObjects(random, 16), 1, RowSetFactoryImpl.INSTANCE.getRowSetByValues(4, 5, 6, 7, 8));
        testFillChunkGeneric(ArrayGenerator.randomObjects(random, 16), ArrayGenerator.randomObjects(random, 16), 3, RowSetFactoryImpl.INSTANCE.getRowSetByValues(5, 6, 7));
        testFillChunkGeneric(ArrayGenerator.randomObjects(random, 16), ArrayGenerator.randomObjects(random, 16), 4, RowSetFactoryImpl.INSTANCE.getRowSetByValues(4, 5, 6, 7));
        testFillChunkGeneric(ArrayGenerator.randomObjects(random, 16), ArrayGenerator.randomObjects(random, 16), 5, RowSetFactoryImpl.INSTANCE.getRowSetByValues(4, 5, 6, 7, 8));
        testFillChunkGeneric(ArrayGenerator.randomObjects(random, 512), ArrayGenerator.randomObjects(random, 512), 4, RowSetFactoryImpl.INSTANCE.getRowSetByValues(254, 255, 256, 257));
        testFillChunkGeneric(ArrayGenerator.randomObjects(random, 512), ArrayGenerator.randomObjects(random, 512), 5, RowSetFactoryImpl.INSTANCE.getRowSetByValues(254, 255, 256, 257, 258));
    ...
    public void testFillChunkLazy() {
        final Random random = new Random(0);
        testFillChunkLazyGeneric(new Object[0], 1, RowSetFactoryImpl.INSTANCE.getRowSetByValues());
        testFillChunkLazyGeneric(new Object[0], 16, RowSetFactoryImpl.INSTANCE.getRowSetByValues());

        testFillChunkLazyGeneric(ArrayGenerator.randomObjects(random, 16), 1, RowSetFactoryImpl.INSTANCE.getRowSetByValues(0));
        testFillChunkLazyGeneric(ArrayGenerator.randomObjects(random, 16), 1, RowSetFactoryImpl.INSTANCE.getRowSetByValues(0, 1));
        testFillChunkLazyGeneric(ArrayGenerator.randomObjects(random, 16), 1, RowSetFactoryImpl.INSTANCE.getRowSetByValues(4));
        testFillChunkLazyGeneric(ArrayGenerator.randomObjects(random, 16), 1, RowSetFactoryImpl.INSTANCE.getRowSetByValues(4, 5, 6));
        testFillChunkLazyGeneric(ArrayGenerator.randomObjects(random, 16), 1, RowSetFactoryImpl.INSTANCE.getRowSetByValues(4,  6));
        testFillChunkLazyGeneric(ArrayGenerator.randomObjects(random, 16), 1, RowSetFactoryImpl.INSTANCE.getRowSetByValues(4, 5, 6, 7, 8));
        testFillChunkLazyGeneric(ArrayGenerator.randomObjects(random, 16), 3, RowSetFactoryImpl.INSTANCE.getRowSetByValues(5, 6, 7));
        testFillChunkLazyGeneric(ArrayGenerator.randomObjects(random, 16), 4, RowSetFactoryImpl.INSTANCE.getRowSetByValues(4, 5, 6, 7));
        testFillChunkLazyGeneric(ArrayGenerator.randomObjects(random, 16), 5, RowSetFactoryImpl.INSTANCE.getRowSetByValues(4, 5, 6, 7, 8));
        testFillChunkLazyGeneric(ArrayGenerator.randomObjects(random, 512), 4, RowSetFactoryImpl.INSTANCE.getRowSetByValues(254, 255, 256, 257));
        testFillChunkLazyGeneric(ArrayGenerator.randomObjects(random, 512), 5, RowSetFactoryImpl.INSTANCE.getRowSetByValues(254, 255, 256, 257, 258));
