...
import static io.deephaven.engine.v2.TstUtils.testRefreshingTable;
import static io.deephaven.engine.v2.TstUtils.testTable;
...
public class QueryTableCrossJoinSmallRightBitsTest extends QueryTableCrossJoinTestBase {
    ...
    public void testLeftGroupChangesOnRightShift() {
        ...
        for (int grp = 0; grp < sizes.length; ++grp) {
            ...
            TstUtils.addToTable(rTable, TrackingMutableRowSet.FACTORY.getRowSetByRange(grp * 10, grp * 10 + data.length - 1),
                    intCol("A", data));
        }
