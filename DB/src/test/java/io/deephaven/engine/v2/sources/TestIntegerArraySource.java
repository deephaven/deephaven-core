...
public class TestIntegerArraySource {
    ...
    public void testGetChunk() {
        ...
        testGetChunkGeneric(new int[0], new int[0], 1, RowSetFactoryImpl.INSTANCE.fromKeys());
        testGetChunkGeneric(new int[0], new int[0], 16, RowSetFactoryImpl.INSTANCE.fromKeys());

        testGetChunkGeneric(ArrayGenerator.randomInts(random, 16), ArrayGenerator.randomInts(random, 16), 1, RowSetFactoryImpl.INSTANCE.fromKeys(0));
        testGetChunkGeneric(ArrayGenerator.randomInts(random, 16), ArrayGenerator.randomInts(random, 16), 1, RowSetFactoryImpl.INSTANCE.fromKeys(0, 1));
        testGetChunkGeneric(ArrayGenerator.randomInts(random, 16), ArrayGenerator.randomInts(random, 16), 1, RowSetFactoryImpl.INSTANCE.fromKeys(4));
        testGetChunkGeneric(ArrayGenerator.randomInts(random, 16), ArrayGenerator.randomInts(random, 16), 1, RowSetFactoryImpl.INSTANCE.fromKeys(4, 5, 6));
        testGetChunkGeneric(ArrayGenerator.randomInts(random, 16), ArrayGenerator.randomInts(random, 16), 1, RowSetFactoryImpl.INSTANCE.fromKeys(4,  6));
        testGetChunkGeneric(ArrayGenerator.randomInts(random, 16), ArrayGenerator.randomInts(random, 16), 1, RowSetFactoryImpl.INSTANCE.fromKeys(4, 5, 6, 7, 8));
        testGetChunkGeneric(ArrayGenerator.randomInts(random, 16), ArrayGenerator.randomInts(random, 16), 3, RowSetFactoryImpl.INSTANCE.fromKeys(5, 6, 7));
        testGetChunkGeneric(ArrayGenerator.randomInts(random, 16), ArrayGenerator.randomInts(random, 16), 4, RowSetFactoryImpl.INSTANCE.fromKeys(4, 5, 6, 7));
        testGetChunkGeneric(ArrayGenerator.randomInts(random, 16), ArrayGenerator.randomInts(random, 16), 5, RowSetFactoryImpl.INSTANCE.fromKeys(4, 5, 6, 7, 8));
        testGetChunkGeneric(ArrayGenerator.randomInts(random, 512), ArrayGenerator.randomInts(random, 512), 4, RowSetFactoryImpl.INSTANCE.fromKeys(254, 255, 256, 257));
        testGetChunkGeneric(ArrayGenerator.randomInts(random, 512), ArrayGenerator.randomInts(random, 512), 5, RowSetFactoryImpl.INSTANCE.fromKeys(254, 255, 256, 257, 258));
    ...
    public void testGetChunkLazy() {
        final Random random = new Random(0);
        testGetChunkGenericLazy(new int[0], 1, RowSetFactoryImpl.INSTANCE.fromKeys());
        testGetChunkGenericLazy(new int[0], 16, RowSetFactoryImpl.INSTANCE.fromKeys());

        testGetChunkGenericLazy(ArrayGenerator.randomInts(random, 16), 1, RowSetFactoryImpl.INSTANCE.fromKeys(0));
        testGetChunkGenericLazy(ArrayGenerator.randomInts(random, 16), 1, RowSetFactoryImpl.INSTANCE.fromKeys(0, 1));
        testGetChunkGenericLazy(ArrayGenerator.randomInts(random, 16), 1, RowSetFactoryImpl.INSTANCE.fromKeys(4));
        testGetChunkGenericLazy(ArrayGenerator.randomInts(random, 16), 1, RowSetFactoryImpl.INSTANCE.fromKeys(4, 5, 6));
        testGetChunkGenericLazy(ArrayGenerator.randomInts(random, 16), 1, RowSetFactoryImpl.INSTANCE.fromKeys(4,  6));
        testGetChunkGenericLazy(ArrayGenerator.randomInts(random, 16), 1, RowSetFactoryImpl.INSTANCE.fromKeys(4, 5, 6, 7, 8));
        testGetChunkGenericLazy(ArrayGenerator.randomInts(random, 16), 3, RowSetFactoryImpl.INSTANCE.fromKeys(5, 6, 7));
        testGetChunkGenericLazy(ArrayGenerator.randomInts(random, 16), 4, RowSetFactoryImpl.INSTANCE.fromKeys(4, 5, 6, 7));
        testGetChunkGenericLazy(ArrayGenerator.randomInts(random, 16), 5, RowSetFactoryImpl.INSTANCE.fromKeys(4, 5, 6, 7, 8));
        testGetChunkGenericLazy(ArrayGenerator.randomInts(random, 512), 4, RowSetFactoryImpl.INSTANCE.fromKeys(254, 255, 256, 257));
        testGetChunkGenericLazy(ArrayGenerator.randomInts(random, 512), 5, RowSetFactoryImpl.INSTANCE.fromKeys(254, 255, 256, 257, 258));
    ...
    public void testFillChunk() {
        final Random random = new Random(0);
        testFillChunkGeneric(new int[0], new int[0], 1, RowSetFactoryImpl.INSTANCE.fromKeys());
        testFillChunkGeneric(new int[0], new int[0], 16, RowSetFactoryImpl.INSTANCE.fromKeys());

        testFillChunkGeneric(ArrayGenerator.randomInts(random, 16), ArrayGenerator.randomInts(random, 16), 1, RowSetFactoryImpl.INSTANCE.fromKeys(0));
        testFillChunkGeneric(ArrayGenerator.randomInts(random, 16), ArrayGenerator.randomInts(random, 16), 1, RowSetFactoryImpl.INSTANCE.fromKeys(0, 1));
        testFillChunkGeneric(ArrayGenerator.randomInts(random, 16), ArrayGenerator.randomInts(random, 16), 1, RowSetFactoryImpl.INSTANCE.fromKeys(4));
        testFillChunkGeneric(ArrayGenerator.randomInts(random, 16), ArrayGenerator.randomInts(random, 16), 1, RowSetFactoryImpl.INSTANCE.fromKeys(4, 5, 6));
        testFillChunkGeneric(ArrayGenerator.randomInts(random, 16), ArrayGenerator.randomInts(random, 16), 1, RowSetFactoryImpl.INSTANCE.fromKeys(4,  6));
        testFillChunkGeneric(ArrayGenerator.randomInts(random, 16), ArrayGenerator.randomInts(random, 16), 1, RowSetFactoryImpl.INSTANCE.fromKeys(4, 5, 6, 7, 8));
        testFillChunkGeneric(ArrayGenerator.randomInts(random, 16), ArrayGenerator.randomInts(random, 16), 3, RowSetFactoryImpl.INSTANCE.fromKeys(5, 6, 7));
        testFillChunkGeneric(ArrayGenerator.randomInts(random, 16), ArrayGenerator.randomInts(random, 16), 4, RowSetFactoryImpl.INSTANCE.fromKeys(4, 5, 6, 7));
        testFillChunkGeneric(ArrayGenerator.randomInts(random, 16), ArrayGenerator.randomInts(random, 16), 5, RowSetFactoryImpl.INSTANCE.fromKeys(4, 5, 6, 7, 8));
        testFillChunkGeneric(ArrayGenerator.randomInts(random, 512), ArrayGenerator.randomInts(random, 512), 4, RowSetFactoryImpl.INSTANCE.fromKeys(254, 255, 256, 257));
        testFillChunkGeneric(ArrayGenerator.randomInts(random, 512), ArrayGenerator.randomInts(random, 512), 5, RowSetFactoryImpl.INSTANCE.fromKeys(254, 255, 256, 257, 258));
    ...
    public void testFillChunkLazy() {
        final Random random = new Random(0);
        testFillChunkLazyGeneric(new int[0], 1, RowSetFactoryImpl.INSTANCE.fromKeys());
        testFillChunkLazyGeneric(new int[0], 16, RowSetFactoryImpl.INSTANCE.fromKeys());

        testFillChunkLazyGeneric(ArrayGenerator.randomInts(random, 16), 1, RowSetFactoryImpl.INSTANCE.fromKeys(0));
        testFillChunkLazyGeneric(ArrayGenerator.randomInts(random, 16), 1, RowSetFactoryImpl.INSTANCE.fromKeys(0, 1));
        testFillChunkLazyGeneric(ArrayGenerator.randomInts(random, 16), 1, RowSetFactoryImpl.INSTANCE.fromKeys(4));
        testFillChunkLazyGeneric(ArrayGenerator.randomInts(random, 16), 1, RowSetFactoryImpl.INSTANCE.fromKeys(4, 5, 6));
        testFillChunkLazyGeneric(ArrayGenerator.randomInts(random, 16), 1, RowSetFactoryImpl.INSTANCE.fromKeys(4,  6));
        testFillChunkLazyGeneric(ArrayGenerator.randomInts(random, 16), 1, RowSetFactoryImpl.INSTANCE.fromKeys(4, 5, 6, 7, 8));
        testFillChunkLazyGeneric(ArrayGenerator.randomInts(random, 16), 3, RowSetFactoryImpl.INSTANCE.fromKeys(5, 6, 7));
        testFillChunkLazyGeneric(ArrayGenerator.randomInts(random, 16), 4, RowSetFactoryImpl.INSTANCE.fromKeys(4, 5, 6, 7));
        testFillChunkLazyGeneric(ArrayGenerator.randomInts(random, 16), 5, RowSetFactoryImpl.INSTANCE.fromKeys(4, 5, 6, 7, 8));
        testFillChunkLazyGeneric(ArrayGenerator.randomInts(random, 512), 4, RowSetFactoryImpl.INSTANCE.fromKeys(254, 255, 256, 257));
        testFillChunkLazyGeneric(ArrayGenerator.randomInts(random, 512), 5, RowSetFactoryImpl.INSTANCE.fromKeys(254, 255, 256, 257, 258));
