...
//        dumpChunk(valuesChunk);
    ...
    static private void verifyPartition(DoublePartitionKernel.PartitionKernelContext context, RowSet source, int size, List<DoubleLongTuple> javaTuples, DoubleChunk doubleChunk, LongChunk indexKeys, ColumnSource<Double> columnSource) {
