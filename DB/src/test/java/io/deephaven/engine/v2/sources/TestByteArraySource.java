...
public class TestByteArraySource {
    ...
    private void validateValues(int chunkSize, byte[] values, TrackingMutableRowSet rowSet, ByteArraySource source) {
        ...
        while (it.hasNext()) {
            ...
            if (ranges.size() > 2 || ranges.get(0) / ByteArraySource.BLOCK_SIZE != (ranges.get(1) / ByteArraySource.BLOCK_SIZE)) {
    ...
    private void validatePrevValues(int chunkSize, byte[] values, TrackingMutableRowSet rowSet, ByteArraySource source) {
        final RowSequence.Iterator rsIterator = rowSet.getRowSequenceIterator();
        final TrackingMutableRowSet.Iterator it = rowSet.iterator();
        final ChunkSource.GetContext context = source.makeGetContext(chunkSize);
        long pos = 0;
    ...
    public void testGetChunk() {
        ...
        testGetChunkGeneric(new byte[0], new byte[0], 1, TrackingMutableRowSet.FACTORY.getRowSetByValues());
        testGetChunkGeneric(new byte[0], new byte[0], 16, TrackingMutableRowSet.FACTORY.getRowSetByValues());

        testGetChunkGeneric(ArrayGenerator.randomBytes(random, 16), ArrayGenerator.randomBytes(random, 16), 1, TrackingMutableRowSet.FACTORY.getRowSetByValues(0));
        testGetChunkGeneric(ArrayGenerator.randomBytes(random, 16), ArrayGenerator.randomBytes(random, 16), 1, TrackingMutableRowSet.FACTORY.getRowSetByValues(0, 1));
        testGetChunkGeneric(ArrayGenerator.randomBytes(random, 16), ArrayGenerator.randomBytes(random, 16), 1, TrackingMutableRowSet.FACTORY.getRowSetByValues(4));
        testGetChunkGeneric(ArrayGenerator.randomBytes(random, 16), ArrayGenerator.randomBytes(random, 16), 1, TrackingMutableRowSet.FACTORY.getRowSetByValues(4, 5, 6));
        testGetChunkGeneric(ArrayGenerator.randomBytes(random, 16), ArrayGenerator.randomBytes(random, 16), 1, TrackingMutableRowSet.FACTORY.getRowSetByValues(4,  6));
        testGetChunkGeneric(ArrayGenerator.randomBytes(random, 16), ArrayGenerator.randomBytes(random, 16), 1, TrackingMutableRowSet.FACTORY.getRowSetByValues(4, 5, 6, 7, 8));
        testGetChunkGeneric(ArrayGenerator.randomBytes(random, 16), ArrayGenerator.randomBytes(random, 16), 3, TrackingMutableRowSet.FACTORY.getRowSetByValues(5, 6, 7));
        testGetChunkGeneric(ArrayGenerator.randomBytes(random, 16), ArrayGenerator.randomBytes(random, 16), 4, TrackingMutableRowSet.FACTORY.getRowSetByValues(4, 5, 6, 7));
        testGetChunkGeneric(ArrayGenerator.randomBytes(random, 16), ArrayGenerator.randomBytes(random, 16), 5, TrackingMutableRowSet.FACTORY.getRowSetByValues(4, 5, 6, 7, 8));
        testGetChunkGeneric(ArrayGenerator.randomBytes(random, 512), ArrayGenerator.randomBytes(random, 512), 4, TrackingMutableRowSet.FACTORY.getRowSetByValues(254, 255, 256, 257));
        testGetChunkGeneric(ArrayGenerator.randomBytes(random, 512), ArrayGenerator.randomBytes(random, 512), 5, TrackingMutableRowSet.FACTORY.getRowSetByValues(254, 255, 256, 257, 258));
    ...
    public void testGetChunkLazy() {
        final Random random = new Random(0);
        testGetChunkGenericLazy(new byte[0], 1, TrackingMutableRowSet.FACTORY.getRowSetByValues());
        testGetChunkGenericLazy(new byte[0], 16, TrackingMutableRowSet.FACTORY.getRowSetByValues());

        testGetChunkGenericLazy(ArrayGenerator.randomBytes(random, 16), 1, TrackingMutableRowSet.FACTORY.getRowSetByValues(0));
        testGetChunkGenericLazy(ArrayGenerator.randomBytes(random, 16), 1, TrackingMutableRowSet.FACTORY.getRowSetByValues(0, 1));
        testGetChunkGenericLazy(ArrayGenerator.randomBytes(random, 16), 1, TrackingMutableRowSet.FACTORY.getRowSetByValues(4));
        testGetChunkGenericLazy(ArrayGenerator.randomBytes(random, 16), 1, TrackingMutableRowSet.FACTORY.getRowSetByValues(4, 5, 6));
        testGetChunkGenericLazy(ArrayGenerator.randomBytes(random, 16), 1, TrackingMutableRowSet.FACTORY.getRowSetByValues(4,  6));
        testGetChunkGenericLazy(ArrayGenerator.randomBytes(random, 16), 1, TrackingMutableRowSet.FACTORY.getRowSetByValues(4, 5, 6, 7, 8));
        testGetChunkGenericLazy(ArrayGenerator.randomBytes(random, 16), 3, TrackingMutableRowSet.FACTORY.getRowSetByValues(5, 6, 7));
        testGetChunkGenericLazy(ArrayGenerator.randomBytes(random, 16), 4, TrackingMutableRowSet.FACTORY.getRowSetByValues(4, 5, 6, 7));
        testGetChunkGenericLazy(ArrayGenerator.randomBytes(random, 16), 5, TrackingMutableRowSet.FACTORY.getRowSetByValues(4, 5, 6, 7, 8));
        testGetChunkGenericLazy(ArrayGenerator.randomBytes(random, 512), 4, TrackingMutableRowSet.FACTORY.getRowSetByValues(254, 255, 256, 257));
        testGetChunkGenericLazy(ArrayGenerator.randomBytes(random, 512), 5, TrackingMutableRowSet.FACTORY.getRowSetByValues(254, 255, 256, 257, 258));
    ...
    private void validateValuesWithFill(int chunkSize, byte[] values, TrackingMutableRowSet rowSet, ByteArraySource source) {
        final RowSequence.Iterator rsIterator = rowSet.getRowSequenceIterator();
        final TrackingMutableRowSet.Iterator it = rowSet.iterator();
    ...
    private void validatePrevValuesWithFill(int chunkSize, byte[] values, TrackingMutableRowSet rowSet, ByteArraySource source) {
        final RowSequence.Iterator rsIterator = rowSet.getRowSequenceIterator();
        final TrackingMutableRowSet.Iterator it = rowSet.iterator();
        final ColumnSource.FillContext context = source.makeFillContext(chunkSize);
        final WritableByteChunk<Values> chunk = WritableByteChunk.makeWritableChunk(chunkSize);
    ...
    public void testFillChunk() {
        final Random random = new Random(0);
        testFillChunkGeneric(new byte[0], new byte[0], 1, TrackingMutableRowSet.FACTORY.getRowSetByValues());
        testFillChunkGeneric(new byte[0], new byte[0], 16, TrackingMutableRowSet.FACTORY.getRowSetByValues());

        testFillChunkGeneric(ArrayGenerator.randomBytes(random, 16), ArrayGenerator.randomBytes(random, 16), 1, TrackingMutableRowSet.FACTORY.getRowSetByValues(0));
        testFillChunkGeneric(ArrayGenerator.randomBytes(random, 16), ArrayGenerator.randomBytes(random, 16), 1, TrackingMutableRowSet.FACTORY.getRowSetByValues(0, 1));
        testFillChunkGeneric(ArrayGenerator.randomBytes(random, 16), ArrayGenerator.randomBytes(random, 16), 1, TrackingMutableRowSet.FACTORY.getRowSetByValues(4));
        testFillChunkGeneric(ArrayGenerator.randomBytes(random, 16), ArrayGenerator.randomBytes(random, 16), 1, TrackingMutableRowSet.FACTORY.getRowSetByValues(4, 5, 6));
        testFillChunkGeneric(ArrayGenerator.randomBytes(random, 16), ArrayGenerator.randomBytes(random, 16), 1, TrackingMutableRowSet.FACTORY.getRowSetByValues(4,  6));
        testFillChunkGeneric(ArrayGenerator.randomBytes(random, 16), ArrayGenerator.randomBytes(random, 16), 1, TrackingMutableRowSet.FACTORY.getRowSetByValues(4, 5, 6, 7, 8));
        testFillChunkGeneric(ArrayGenerator.randomBytes(random, 16), ArrayGenerator.randomBytes(random, 16), 3, TrackingMutableRowSet.FACTORY.getRowSetByValues(5, 6, 7));
        testFillChunkGeneric(ArrayGenerator.randomBytes(random, 16), ArrayGenerator.randomBytes(random, 16), 4, TrackingMutableRowSet.FACTORY.getRowSetByValues(4, 5, 6, 7));
        testFillChunkGeneric(ArrayGenerator.randomBytes(random, 16), ArrayGenerator.randomBytes(random, 16), 5, TrackingMutableRowSet.FACTORY.getRowSetByValues(4, 5, 6, 7, 8));
        testFillChunkGeneric(ArrayGenerator.randomBytes(random, 512), ArrayGenerator.randomBytes(random, 512), 4, TrackingMutableRowSet.FACTORY.getRowSetByValues(254, 255, 256, 257));
        testFillChunkGeneric(ArrayGenerator.randomBytes(random, 512), ArrayGenerator.randomBytes(random, 512), 5, TrackingMutableRowSet.FACTORY.getRowSetByValues(254, 255, 256, 257, 258));
    ...
    public void testFillChunkLazy() {
        final Random random = new Random(0);
        testFillChunkLazyGeneric(new byte[0], 1, TrackingMutableRowSet.FACTORY.getRowSetByValues());
        testFillChunkLazyGeneric(new byte[0], 16, TrackingMutableRowSet.FACTORY.getRowSetByValues());

        testFillChunkLazyGeneric(ArrayGenerator.randomBytes(random, 16), 1, TrackingMutableRowSet.FACTORY.getRowSetByValues(0));
        testFillChunkLazyGeneric(ArrayGenerator.randomBytes(random, 16), 1, TrackingMutableRowSet.FACTORY.getRowSetByValues(0, 1));
        testFillChunkLazyGeneric(ArrayGenerator.randomBytes(random, 16), 1, TrackingMutableRowSet.FACTORY.getRowSetByValues(4));
        testFillChunkLazyGeneric(ArrayGenerator.randomBytes(random, 16), 1, TrackingMutableRowSet.FACTORY.getRowSetByValues(4, 5, 6));
        testFillChunkLazyGeneric(ArrayGenerator.randomBytes(random, 16), 1, TrackingMutableRowSet.FACTORY.getRowSetByValues(4,  6));
        testFillChunkLazyGeneric(ArrayGenerator.randomBytes(random, 16), 1, TrackingMutableRowSet.FACTORY.getRowSetByValues(4, 5, 6, 7, 8));
        testFillChunkLazyGeneric(ArrayGenerator.randomBytes(random, 16), 3, TrackingMutableRowSet.FACTORY.getRowSetByValues(5, 6, 7));
        testFillChunkLazyGeneric(ArrayGenerator.randomBytes(random, 16), 4, TrackingMutableRowSet.FACTORY.getRowSetByValues(4, 5, 6, 7));
        testFillChunkLazyGeneric(ArrayGenerator.randomBytes(random, 16), 5, TrackingMutableRowSet.FACTORY.getRowSetByValues(4, 5, 6, 7, 8));
        testFillChunkLazyGeneric(ArrayGenerator.randomBytes(random, 512), 4, TrackingMutableRowSet.FACTORY.getRowSetByValues(254, 255, 256, 257));
        testFillChunkLazyGeneric(ArrayGenerator.randomBytes(random, 512), 5, TrackingMutableRowSet.FACTORY.getRowSetByValues(254, 255, 256, 257, 258));
