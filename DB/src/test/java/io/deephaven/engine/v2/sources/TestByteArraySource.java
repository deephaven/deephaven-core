...
public class TestByteArraySource {
    ...
    public void testGetChunk() {
        ...
        testGetChunkGeneric(ArrayGenerator.randomBytes(random, 16), ArrayGenerator.randomBytes(random, 16), 1, RowSetFactory.fromKeys(0));
        testGetChunkGeneric(ArrayGenerator.randomBytes(random, 16), ArrayGenerator.randomBytes(random, 16), 1, RowSetFactory.fromKeys(0, 1));
        testGetChunkGeneric(ArrayGenerator.randomBytes(random, 16), ArrayGenerator.randomBytes(random, 16), 1, RowSetFactory.fromKeys(4));
        testGetChunkGeneric(ArrayGenerator.randomBytes(random, 16), ArrayGenerator.randomBytes(random, 16), 1, RowSetFactory.fromKeys(4, 5, 6));
        testGetChunkGeneric(ArrayGenerator.randomBytes(random, 16), ArrayGenerator.randomBytes(random, 16), 1, RowSetFactory.fromKeys(4,  6));
        testGetChunkGeneric(ArrayGenerator.randomBytes(random, 16), ArrayGenerator.randomBytes(random, 16), 1, RowSetFactory.fromKeys(4, 5, 6, 7, 8));
        testGetChunkGeneric(ArrayGenerator.randomBytes(random, 16), ArrayGenerator.randomBytes(random, 16), 3, RowSetFactory.fromKeys(5, 6, 7));
        testGetChunkGeneric(ArrayGenerator.randomBytes(random, 16), ArrayGenerator.randomBytes(random, 16), 4, RowSetFactory.fromKeys(4, 5, 6, 7));
        testGetChunkGeneric(ArrayGenerator.randomBytes(random, 16), ArrayGenerator.randomBytes(random, 16), 5, RowSetFactory.fromKeys(4, 5, 6, 7, 8));
        testGetChunkGeneric(ArrayGenerator.randomBytes(random, 512), ArrayGenerator.randomBytes(random, 512), 4, RowSetFactory.fromKeys(254, 255, 256, 257));
        testGetChunkGeneric(ArrayGenerator.randomBytes(random, 512), ArrayGenerator.randomBytes(random, 512), 5, RowSetFactory.fromKeys(254, 255, 256, 257, 258));
    ...
    public void testGetChunkLazy() {
        ...
        testGetChunkGenericLazy(ArrayGenerator.randomBytes(random, 512), 5, RowSetFactory.fromKeys(254, 255, 256, 257, 258));
    ...
    public void testFillChunk() {
        ...
        testFillChunkGeneric(ArrayGenerator.randomBytes(random, 16), ArrayGenerator.randomBytes(random, 16), 1, RowSetFactory.fromKeys(0));
        testFillChunkGeneric(ArrayGenerator.randomBytes(random, 16), ArrayGenerator.randomBytes(random, 16), 1, RowSetFactory.fromKeys(0, 1));
        testFillChunkGeneric(ArrayGenerator.randomBytes(random, 16), ArrayGenerator.randomBytes(random, 16), 1, RowSetFactory.fromKeys(4));
        testFillChunkGeneric(ArrayGenerator.randomBytes(random, 16), ArrayGenerator.randomBytes(random, 16), 1, RowSetFactory.fromKeys(4, 5, 6));
        testFillChunkGeneric(ArrayGenerator.randomBytes(random, 16), ArrayGenerator.randomBytes(random, 16), 1, RowSetFactory.fromKeys(4,  6));
        testFillChunkGeneric(ArrayGenerator.randomBytes(random, 16), ArrayGenerator.randomBytes(random, 16), 1, RowSetFactory.fromKeys(4, 5, 6, 7, 8));
        testFillChunkGeneric(ArrayGenerator.randomBytes(random, 16), ArrayGenerator.randomBytes(random, 16), 3, RowSetFactory.fromKeys(5, 6, 7));
        testFillChunkGeneric(ArrayGenerator.randomBytes(random, 16), ArrayGenerator.randomBytes(random, 16), 4, RowSetFactory.fromKeys(4, 5, 6, 7));
        testFillChunkGeneric(ArrayGenerator.randomBytes(random, 16), ArrayGenerator.randomBytes(random, 16), 5, RowSetFactory.fromKeys(4, 5, 6, 7, 8));
    ...
    public void testFillChunkLazy() {
        ...
        testFillChunkLazyGeneric(ArrayGenerator.randomBytes(random, 512), 4, RowSetFactory.fromKeys(254, 255, 256, 257));
        testFillChunkLazyGeneric(ArrayGenerator.randomBytes(random, 512), 5, RowSetFactory.fromKeys(254, 255, 256, 257, 258));
