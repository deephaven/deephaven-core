...
import static io.deephaven.engine.v2.utils.TstRowSetUtil.rowSetFromString;
...
public class MutableRowSetImplTest extends TestCase {
    ...
    protected MutableRowSet getSortedIndex(long... keys) {
        final RowSetBuilderRandom treeIndexBuilder = RowSetFactoryImpl.INSTANCE.getRandomBuilder();
        for (long key : keys) {
    ...
    public void testSimple() {
        ...
        final RowSet.Iterator it = RowSetFactoryImpl.INSTANCE.getRowSetByRange(2, 2).iterator();
        assertEquals(2, it.nextLong());
        assertFalse(it.hasNext());
    }

    public void testSimpleRangeIterator() {
        final RowSet rowSet = RowSetFactoryImpl.INSTANCE.getRowSetByRange(3, 100);
    ...
    public void testSerialize() throws IOException, ClassNotFoundException {
        MutableRowSet rowSet = RowSetFactoryImpl.INSTANCE.getRowSetByRange(0, 100);
    ...
    public void testRange() {
        final MutableRowSet index = RowSetFactoryImpl.INSTANCE.getEmptyRowSet();
    ...
    public void testMinusSimple() {
        ...
        RowSet result = rowSet.minus(getFactory().getEmptyRowSet());
    ...
    public void testRandomInsertMinus() {
        ...
        final MutableRowSet check = getFactory().getEmptyRowSet();
    ...
    public void testAddIndex3() {
        ...
        final RowSet rowSetToAdd = RowSetFactoryImpl.INSTANCE.getRowSetByValues(3164, 3166);
    ...
    public void testAddIndex() {
        ...
        final RowSet rowSetToAdd = RowSetFactoryImpl.INSTANCE.getRowSetByValues(3164);
        idx.insert(rowSetToAdd);
        idx.validate();

        final MutableRowSet rowSetToAdd2 = RowSetFactoryImpl.INSTANCE.getRowSetByRange(3164, 3199);
        rowSetToAdd2.insert(idx2);
        rowSetToAdd2.validate();

        final RowSet rowSetToAdd3 = RowSetFactoryImpl.INSTANCE.getRowSetByRange(3164, 3199);
    ...
    public void testRandomBuilder() {
        ...
        for (int step = 0; step < 1000; ++step) {
            ...
            final RowSetBuilderRandom treeBuilder = RowSetFactoryImpl.INSTANCE.getRandomBuilder();
    ...
    public void testIteratorBinarySearchForSingleRangeIndex() {
        final RowSet sr = RowSetFactoryImpl.INSTANCE.getRowSetByRange(5, 9);
    ...
    public void testRangeIteratorAdvanceEmptyIndex() {
        final RowSet ix = RowSetFactoryImpl.INSTANCE.getEmptyRowSet();
    ...
    public void testRangeIteratorAdvanceBack() {
        final MutableRowSet ix = RowSetFactoryImpl.INSTANCE.getEmptyRowSet();
        final long s = 300;
        final long e = 600;
        ix.insertRange(s, e);
        final RowSet.RangeIterator it = ix.rangeIterator();
    ...
    public void testGetAverageRunLengthEstimate() {
        final RowSet e = RowSetFactoryImpl.INSTANCE.getEmptyRowSet();
        ...
        final MutableRowSet r2 = RowSetFactoryImpl.INSTANCE.getEmptyRowSet();
        r2.insert(1);
        r2.insert(3);
        r2.insert(5);
        r2.insert(7);
    ...
    public void testArrayOfSmallIndices() {
        ...
        final MutableRowSet r = RowSetFactoryImpl.INSTANCE.getEmptyRowSet();
        for (int i = 0; i < sz; ++i) {
            r.insert(ixs[i]);
        }
    ...
    public void testOneRangeIndexMinus() {
        final RowSet ix = RowSetFactoryImpl.INSTANCE.getRowSetByRange(1000, 5000);
        final RowSet r = ix.minus(RowSetFactoryImpl.INSTANCE.getRowSetByRange(1001, 4999));
    ...
    public void testSearchIteratorRegression0() {
        final MutableRowSet ix0 = RowSetFactoryImpl.INSTANCE.getEmptyRowSet();
    ...
    public void testAsKeyRangesChunk() {
        final MutableRowSet rowSet = RowSetFactoryImpl.INSTANCE.getEmptyRowSet();
    ...
    public void testIteratorAdvanceRegression1() {
        final RowSet ix = RowSetFactoryImpl.INSTANCE.getRowSetByValues(3, 5, 7, 9, 11, 21);
        final RowSet.RangeIterator rit = ix.rangeIterator();
