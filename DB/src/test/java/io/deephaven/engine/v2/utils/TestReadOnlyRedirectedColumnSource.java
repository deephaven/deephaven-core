...
public class TestReadOnlyRedirectedColumnSource {
    ...
    public void testIds6196() {
        ...
        final QueryTable qt =
                TstUtils.testRefreshingTable(RowSetFactoryImpl.INSTANCE.getFlatRowSet(6), intCol("IntVal", 0, 1, 2, 3, 4, 5));
        ...
        TstUtils.addToTable(qt, RowSetFactoryImpl.INSTANCE.getFlatRowSet(3), intCol("IntVal", 1, 2, 3));
        qt.notifyListeners(RowSetFactoryImpl.INSTANCE.getEmptyRowSet(), RowSetFactoryImpl.INSTANCE.getEmptyRowSet(), RowSetFactoryImpl.INSTANCE.getFlatRowSet(3));
