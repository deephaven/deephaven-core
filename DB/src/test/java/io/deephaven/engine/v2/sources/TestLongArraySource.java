...
public class TestLongArraySource {
    ...
    public void testGetChunk() {
        ...
        testGetChunkGeneric(new long[0], new long[0], 1, RowSetFactoryImpl.INSTANCE.getRowSetByValues());
        testGetChunkGeneric(new long[0], new long[0], 16, RowSetFactoryImpl.INSTANCE.getRowSetByValues());

        testGetChunkGeneric(ArrayGenerator.randomLongs(random, 16), ArrayGenerator.randomLongs(random, 16), 1, RowSetFactoryImpl.INSTANCE.getRowSetByValues(0));
        testGetChunkGeneric(ArrayGenerator.randomLongs(random, 16), ArrayGenerator.randomLongs(random, 16), 1, RowSetFactoryImpl.INSTANCE.getRowSetByValues(0, 1));
        testGetChunkGeneric(ArrayGenerator.randomLongs(random, 16), ArrayGenerator.randomLongs(random, 16), 1, RowSetFactoryImpl.INSTANCE.getRowSetByValues(4));
        testGetChunkGeneric(ArrayGenerator.randomLongs(random, 16), ArrayGenerator.randomLongs(random, 16), 1, RowSetFactoryImpl.INSTANCE.getRowSetByValues(4, 5, 6));
        testGetChunkGeneric(ArrayGenerator.randomLongs(random, 16), ArrayGenerator.randomLongs(random, 16), 1, RowSetFactoryImpl.INSTANCE.getRowSetByValues(4,  6));
        testGetChunkGeneric(ArrayGenerator.randomLongs(random, 16), ArrayGenerator.randomLongs(random, 16), 1, RowSetFactoryImpl.INSTANCE.getRowSetByValues(4, 5, 6, 7, 8));
        testGetChunkGeneric(ArrayGenerator.randomLongs(random, 16), ArrayGenerator.randomLongs(random, 16), 3, RowSetFactoryImpl.INSTANCE.getRowSetByValues(5, 6, 7));
        testGetChunkGeneric(ArrayGenerator.randomLongs(random, 16), ArrayGenerator.randomLongs(random, 16), 4, RowSetFactoryImpl.INSTANCE.getRowSetByValues(4, 5, 6, 7));
        testGetChunkGeneric(ArrayGenerator.randomLongs(random, 16), ArrayGenerator.randomLongs(random, 16), 5, RowSetFactoryImpl.INSTANCE.getRowSetByValues(4, 5, 6, 7, 8));
        testGetChunkGeneric(ArrayGenerator.randomLongs(random, 512), ArrayGenerator.randomLongs(random, 512), 4, RowSetFactoryImpl.INSTANCE.getRowSetByValues(254, 255, 256, 257));
        testGetChunkGeneric(ArrayGenerator.randomLongs(random, 512), ArrayGenerator.randomLongs(random, 512), 5, RowSetFactoryImpl.INSTANCE.getRowSetByValues(254, 255, 256, 257, 258));
    ...
    public void testGetChunkLazy() {
        final Random random = new Random(0);
        testGetChunkGenericLazy(new long[0], 1, RowSetFactoryImpl.INSTANCE.getRowSetByValues());
        testGetChunkGenericLazy(new long[0], 16, RowSetFactoryImpl.INSTANCE.getRowSetByValues());

        testGetChunkGenericLazy(ArrayGenerator.randomLongs(random, 16), 1, RowSetFactoryImpl.INSTANCE.getRowSetByValues(0));
        testGetChunkGenericLazy(ArrayGenerator.randomLongs(random, 16), 1, RowSetFactoryImpl.INSTANCE.getRowSetByValues(0, 1));
        testGetChunkGenericLazy(ArrayGenerator.randomLongs(random, 16), 1, RowSetFactoryImpl.INSTANCE.getRowSetByValues(4));
        testGetChunkGenericLazy(ArrayGenerator.randomLongs(random, 16), 1, RowSetFactoryImpl.INSTANCE.getRowSetByValues(4, 5, 6));
        testGetChunkGenericLazy(ArrayGenerator.randomLongs(random, 16), 1, RowSetFactoryImpl.INSTANCE.getRowSetByValues(4,  6));
        testGetChunkGenericLazy(ArrayGenerator.randomLongs(random, 16), 1, RowSetFactoryImpl.INSTANCE.getRowSetByValues(4, 5, 6, 7, 8));
        testGetChunkGenericLazy(ArrayGenerator.randomLongs(random, 16), 3, RowSetFactoryImpl.INSTANCE.getRowSetByValues(5, 6, 7));
        testGetChunkGenericLazy(ArrayGenerator.randomLongs(random, 16), 4, RowSetFactoryImpl.INSTANCE.getRowSetByValues(4, 5, 6, 7));
        testGetChunkGenericLazy(ArrayGenerator.randomLongs(random, 16), 5, RowSetFactoryImpl.INSTANCE.getRowSetByValues(4, 5, 6, 7, 8));
        testGetChunkGenericLazy(ArrayGenerator.randomLongs(random, 512), 4, RowSetFactoryImpl.INSTANCE.getRowSetByValues(254, 255, 256, 257));
        testGetChunkGenericLazy(ArrayGenerator.randomLongs(random, 512), 5, RowSetFactoryImpl.INSTANCE.getRowSetByValues(254, 255, 256, 257, 258));
    ...
    public void testFillChunk() {
        final Random random = new Random(0);
        testFillChunkGeneric(new long[0], new long[0], 1, RowSetFactoryImpl.INSTANCE.getRowSetByValues());
        testFillChunkGeneric(new long[0], new long[0], 16, RowSetFactoryImpl.INSTANCE.getRowSetByValues());

        testFillChunkGeneric(ArrayGenerator.randomLongs(random, 16), ArrayGenerator.randomLongs(random, 16), 1, RowSetFactoryImpl.INSTANCE.getRowSetByValues(0));
        testFillChunkGeneric(ArrayGenerator.randomLongs(random, 16), ArrayGenerator.randomLongs(random, 16), 1, RowSetFactoryImpl.INSTANCE.getRowSetByValues(0, 1));
        testFillChunkGeneric(ArrayGenerator.randomLongs(random, 16), ArrayGenerator.randomLongs(random, 16), 1, RowSetFactoryImpl.INSTANCE.getRowSetByValues(4));
        testFillChunkGeneric(ArrayGenerator.randomLongs(random, 16), ArrayGenerator.randomLongs(random, 16), 1, RowSetFactoryImpl.INSTANCE.getRowSetByValues(4, 5, 6));
        testFillChunkGeneric(ArrayGenerator.randomLongs(random, 16), ArrayGenerator.randomLongs(random, 16), 1, RowSetFactoryImpl.INSTANCE.getRowSetByValues(4,  6));
        testFillChunkGeneric(ArrayGenerator.randomLongs(random, 16), ArrayGenerator.randomLongs(random, 16), 1, RowSetFactoryImpl.INSTANCE.getRowSetByValues(4, 5, 6, 7, 8));
        testFillChunkGeneric(ArrayGenerator.randomLongs(random, 16), ArrayGenerator.randomLongs(random, 16), 3, RowSetFactoryImpl.INSTANCE.getRowSetByValues(5, 6, 7));
        testFillChunkGeneric(ArrayGenerator.randomLongs(random, 16), ArrayGenerator.randomLongs(random, 16), 4, RowSetFactoryImpl.INSTANCE.getRowSetByValues(4, 5, 6, 7));
        testFillChunkGeneric(ArrayGenerator.randomLongs(random, 16), ArrayGenerator.randomLongs(random, 16), 5, RowSetFactoryImpl.INSTANCE.getRowSetByValues(4, 5, 6, 7, 8));
        testFillChunkGeneric(ArrayGenerator.randomLongs(random, 512), ArrayGenerator.randomLongs(random, 512), 4, RowSetFactoryImpl.INSTANCE.getRowSetByValues(254, 255, 256, 257));
        testFillChunkGeneric(ArrayGenerator.randomLongs(random, 512), ArrayGenerator.randomLongs(random, 512), 5, RowSetFactoryImpl.INSTANCE.getRowSetByValues(254, 255, 256, 257, 258));
    ...
    public void testFillChunkLazy() {
        final Random random = new Random(0);
        testFillChunkLazyGeneric(new long[0], 1, RowSetFactoryImpl.INSTANCE.getRowSetByValues());
        testFillChunkLazyGeneric(new long[0], 16, RowSetFactoryImpl.INSTANCE.getRowSetByValues());

        testFillChunkLazyGeneric(ArrayGenerator.randomLongs(random, 16), 1, RowSetFactoryImpl.INSTANCE.getRowSetByValues(0));
        testFillChunkLazyGeneric(ArrayGenerator.randomLongs(random, 16), 1, RowSetFactoryImpl.INSTANCE.getRowSetByValues(0, 1));
        testFillChunkLazyGeneric(ArrayGenerator.randomLongs(random, 16), 1, RowSetFactoryImpl.INSTANCE.getRowSetByValues(4));
        testFillChunkLazyGeneric(ArrayGenerator.randomLongs(random, 16), 1, RowSetFactoryImpl.INSTANCE.getRowSetByValues(4, 5, 6));
        testFillChunkLazyGeneric(ArrayGenerator.randomLongs(random, 16), 1, RowSetFactoryImpl.INSTANCE.getRowSetByValues(4,  6));
        testFillChunkLazyGeneric(ArrayGenerator.randomLongs(random, 16), 1, RowSetFactoryImpl.INSTANCE.getRowSetByValues(4, 5, 6, 7, 8));
        testFillChunkLazyGeneric(ArrayGenerator.randomLongs(random, 16), 3, RowSetFactoryImpl.INSTANCE.getRowSetByValues(5, 6, 7));
        testFillChunkLazyGeneric(ArrayGenerator.randomLongs(random, 16), 4, RowSetFactoryImpl.INSTANCE.getRowSetByValues(4, 5, 6, 7));
        testFillChunkLazyGeneric(ArrayGenerator.randomLongs(random, 16), 5, RowSetFactoryImpl.INSTANCE.getRowSetByValues(4, 5, 6, 7, 8));
        testFillChunkLazyGeneric(ArrayGenerator.randomLongs(random, 512), 4, RowSetFactoryImpl.INSTANCE.getRowSetByValues(254, 255, 256, 257));
        testFillChunkLazyGeneric(ArrayGenerator.randomLongs(random, 512), 5, RowSetFactoryImpl.INSTANCE.getRowSetByValues(254, 255, 256, 257, 258));
