...
public class TestLongArraySource {
    ...
    public void testGetChunk() {
        ...
        testGetChunkGeneric(new long[0], new long[0], 1, RowSetFactoryImpl.INSTANCE.fromKeys());
        testGetChunkGeneric(new long[0], new long[0], 16, RowSetFactoryImpl.INSTANCE.fromKeys());

        testGetChunkGeneric(ArrayGenerator.randomLongs(random, 16), ArrayGenerator.randomLongs(random, 16), 1, RowSetFactoryImpl.INSTANCE.fromKeys(0));
        testGetChunkGeneric(ArrayGenerator.randomLongs(random, 16), ArrayGenerator.randomLongs(random, 16), 1, RowSetFactoryImpl.INSTANCE.fromKeys(0, 1));
        testGetChunkGeneric(ArrayGenerator.randomLongs(random, 16), ArrayGenerator.randomLongs(random, 16), 1, RowSetFactoryImpl.INSTANCE.fromKeys(4));
        testGetChunkGeneric(ArrayGenerator.randomLongs(random, 16), ArrayGenerator.randomLongs(random, 16), 1, RowSetFactoryImpl.INSTANCE.fromKeys(4, 5, 6));
        testGetChunkGeneric(ArrayGenerator.randomLongs(random, 16), ArrayGenerator.randomLongs(random, 16), 1, RowSetFactoryImpl.INSTANCE.fromKeys(4,  6));
        testGetChunkGeneric(ArrayGenerator.randomLongs(random, 16), ArrayGenerator.randomLongs(random, 16), 1, RowSetFactoryImpl.INSTANCE.fromKeys(4, 5, 6, 7, 8));
        testGetChunkGeneric(ArrayGenerator.randomLongs(random, 16), ArrayGenerator.randomLongs(random, 16), 3, RowSetFactoryImpl.INSTANCE.fromKeys(5, 6, 7));
        testGetChunkGeneric(ArrayGenerator.randomLongs(random, 16), ArrayGenerator.randomLongs(random, 16), 4, RowSetFactoryImpl.INSTANCE.fromKeys(4, 5, 6, 7));
        testGetChunkGeneric(ArrayGenerator.randomLongs(random, 16), ArrayGenerator.randomLongs(random, 16), 5, RowSetFactoryImpl.INSTANCE.fromKeys(4, 5, 6, 7, 8));
        testGetChunkGeneric(ArrayGenerator.randomLongs(random, 512), ArrayGenerator.randomLongs(random, 512), 4, RowSetFactoryImpl.INSTANCE.fromKeys(254, 255, 256, 257));
        testGetChunkGeneric(ArrayGenerator.randomLongs(random, 512), ArrayGenerator.randomLongs(random, 512), 5, RowSetFactoryImpl.INSTANCE.fromKeys(254, 255, 256, 257, 258));
    ...
    public void testGetChunkLazy() {
        final Random random = new Random(0);
        testGetChunkGenericLazy(new long[0], 1, RowSetFactoryImpl.INSTANCE.fromKeys());
        testGetChunkGenericLazy(new long[0], 16, RowSetFactoryImpl.INSTANCE.fromKeys());

        testGetChunkGenericLazy(ArrayGenerator.randomLongs(random, 16), 1, RowSetFactoryImpl.INSTANCE.fromKeys(0));
        testGetChunkGenericLazy(ArrayGenerator.randomLongs(random, 16), 1, RowSetFactoryImpl.INSTANCE.fromKeys(0, 1));
        testGetChunkGenericLazy(ArrayGenerator.randomLongs(random, 16), 1, RowSetFactoryImpl.INSTANCE.fromKeys(4));
        testGetChunkGenericLazy(ArrayGenerator.randomLongs(random, 16), 1, RowSetFactoryImpl.INSTANCE.fromKeys(4, 5, 6));
        testGetChunkGenericLazy(ArrayGenerator.randomLongs(random, 16), 1, RowSetFactoryImpl.INSTANCE.fromKeys(4,  6));
        testGetChunkGenericLazy(ArrayGenerator.randomLongs(random, 16), 1, RowSetFactoryImpl.INSTANCE.fromKeys(4, 5, 6, 7, 8));
        testGetChunkGenericLazy(ArrayGenerator.randomLongs(random, 16), 3, RowSetFactoryImpl.INSTANCE.fromKeys(5, 6, 7));
        testGetChunkGenericLazy(ArrayGenerator.randomLongs(random, 16), 4, RowSetFactoryImpl.INSTANCE.fromKeys(4, 5, 6, 7));
        testGetChunkGenericLazy(ArrayGenerator.randomLongs(random, 16), 5, RowSetFactoryImpl.INSTANCE.fromKeys(4, 5, 6, 7, 8));
        testGetChunkGenericLazy(ArrayGenerator.randomLongs(random, 512), 4, RowSetFactoryImpl.INSTANCE.fromKeys(254, 255, 256, 257));
        testGetChunkGenericLazy(ArrayGenerator.randomLongs(random, 512), 5, RowSetFactoryImpl.INSTANCE.fromKeys(254, 255, 256, 257, 258));
    ...
    public void testFillChunk() {
        final Random random = new Random(0);
        testFillChunkGeneric(new long[0], new long[0], 1, RowSetFactoryImpl.INSTANCE.fromKeys());
        testFillChunkGeneric(new long[0], new long[0], 16, RowSetFactoryImpl.INSTANCE.fromKeys());

        testFillChunkGeneric(ArrayGenerator.randomLongs(random, 16), ArrayGenerator.randomLongs(random, 16), 1, RowSetFactoryImpl.INSTANCE.fromKeys(0));
        testFillChunkGeneric(ArrayGenerator.randomLongs(random, 16), ArrayGenerator.randomLongs(random, 16), 1, RowSetFactoryImpl.INSTANCE.fromKeys(0, 1));
        testFillChunkGeneric(ArrayGenerator.randomLongs(random, 16), ArrayGenerator.randomLongs(random, 16), 1, RowSetFactoryImpl.INSTANCE.fromKeys(4));
        testFillChunkGeneric(ArrayGenerator.randomLongs(random, 16), ArrayGenerator.randomLongs(random, 16), 1, RowSetFactoryImpl.INSTANCE.fromKeys(4, 5, 6));
        testFillChunkGeneric(ArrayGenerator.randomLongs(random, 16), ArrayGenerator.randomLongs(random, 16), 1, RowSetFactoryImpl.INSTANCE.fromKeys(4,  6));
        testFillChunkGeneric(ArrayGenerator.randomLongs(random, 16), ArrayGenerator.randomLongs(random, 16), 1, RowSetFactoryImpl.INSTANCE.fromKeys(4, 5, 6, 7, 8));
        testFillChunkGeneric(ArrayGenerator.randomLongs(random, 16), ArrayGenerator.randomLongs(random, 16), 3, RowSetFactoryImpl.INSTANCE.fromKeys(5, 6, 7));
        testFillChunkGeneric(ArrayGenerator.randomLongs(random, 16), ArrayGenerator.randomLongs(random, 16), 4, RowSetFactoryImpl.INSTANCE.fromKeys(4, 5, 6, 7));
        testFillChunkGeneric(ArrayGenerator.randomLongs(random, 16), ArrayGenerator.randomLongs(random, 16), 5, RowSetFactoryImpl.INSTANCE.fromKeys(4, 5, 6, 7, 8));
        testFillChunkGeneric(ArrayGenerator.randomLongs(random, 512), ArrayGenerator.randomLongs(random, 512), 4, RowSetFactoryImpl.INSTANCE.fromKeys(254, 255, 256, 257));
        testFillChunkGeneric(ArrayGenerator.randomLongs(random, 512), ArrayGenerator.randomLongs(random, 512), 5, RowSetFactoryImpl.INSTANCE.fromKeys(254, 255, 256, 257, 258));
    ...
    public void testFillChunkLazy() {
        final Random random = new Random(0);
        testFillChunkLazyGeneric(new long[0], 1, RowSetFactoryImpl.INSTANCE.fromKeys());
        testFillChunkLazyGeneric(new long[0], 16, RowSetFactoryImpl.INSTANCE.fromKeys());

        testFillChunkLazyGeneric(ArrayGenerator.randomLongs(random, 16), 1, RowSetFactoryImpl.INSTANCE.fromKeys(0));
        testFillChunkLazyGeneric(ArrayGenerator.randomLongs(random, 16), 1, RowSetFactoryImpl.INSTANCE.fromKeys(0, 1));
        testFillChunkLazyGeneric(ArrayGenerator.randomLongs(random, 16), 1, RowSetFactoryImpl.INSTANCE.fromKeys(4));
        testFillChunkLazyGeneric(ArrayGenerator.randomLongs(random, 16), 1, RowSetFactoryImpl.INSTANCE.fromKeys(4, 5, 6));
        testFillChunkLazyGeneric(ArrayGenerator.randomLongs(random, 16), 1, RowSetFactoryImpl.INSTANCE.fromKeys(4,  6));
        testFillChunkLazyGeneric(ArrayGenerator.randomLongs(random, 16), 1, RowSetFactoryImpl.INSTANCE.fromKeys(4, 5, 6, 7, 8));
        testFillChunkLazyGeneric(ArrayGenerator.randomLongs(random, 16), 3, RowSetFactoryImpl.INSTANCE.fromKeys(5, 6, 7));
        testFillChunkLazyGeneric(ArrayGenerator.randomLongs(random, 16), 4, RowSetFactoryImpl.INSTANCE.fromKeys(4, 5, 6, 7));
        testFillChunkLazyGeneric(ArrayGenerator.randomLongs(random, 16), 5, RowSetFactoryImpl.INSTANCE.fromKeys(4, 5, 6, 7, 8));
        testFillChunkLazyGeneric(ArrayGenerator.randomLongs(random, 512), 4, RowSetFactoryImpl.INSTANCE.fromKeys(254, 255, 256, 257));
        testFillChunkLazyGeneric(ArrayGenerator.randomLongs(random, 512), 5, RowSetFactoryImpl.INSTANCE.fromKeys(254, 255, 256, 257, 258));
