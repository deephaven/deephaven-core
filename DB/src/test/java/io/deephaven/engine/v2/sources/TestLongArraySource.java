...
public class TestLongArraySource {
    ...
    private void testGetChunkGeneric(long[] values, long[] newValues, int chunkSize, TrackingMutableRowSet rowSet) {
    ...
    private void validateValues(int chunkSize, long[] values, TrackingMutableRowSet rowSet, LongArraySource source) {
    ...
    private void validatePrevValues(int chunkSize, long[] values, TrackingMutableRowSet rowSet, LongArraySource source) {
        final RowSequence.Iterator rsIterator = rowSet.getRowSequenceIterator();
        final TrackingMutableRowSet.Iterator it = rowSet.iterator();
        final ChunkSource.GetContext context = source.makeGetContext(chunkSize);
        long pos = 0;
    ...
    public void testGetChunk() {
        ...
        testGetChunkGeneric(new long[0], new long[0], 1, TrackingMutableRowSet.FACTORY.getRowSetByValues());
        testGetChunkGeneric(new long[0], new long[0], 16, TrackingMutableRowSet.FACTORY.getRowSetByValues());

        testGetChunkGeneric(ArrayGenerator.randomLongs(random, 16), ArrayGenerator.randomLongs(random, 16), 1, TrackingMutableRowSet.FACTORY.getRowSetByValues(0));
        testGetChunkGeneric(ArrayGenerator.randomLongs(random, 16), ArrayGenerator.randomLongs(random, 16), 1, TrackingMutableRowSet.FACTORY.getRowSetByValues(0, 1));
        testGetChunkGeneric(ArrayGenerator.randomLongs(random, 16), ArrayGenerator.randomLongs(random, 16), 1, TrackingMutableRowSet.FACTORY.getRowSetByValues(4));
        testGetChunkGeneric(ArrayGenerator.randomLongs(random, 16), ArrayGenerator.randomLongs(random, 16), 1, TrackingMutableRowSet.FACTORY.getRowSetByValues(4, 5, 6));
        testGetChunkGeneric(ArrayGenerator.randomLongs(random, 16), ArrayGenerator.randomLongs(random, 16), 1, TrackingMutableRowSet.FACTORY.getRowSetByValues(4,  6));
        testGetChunkGeneric(ArrayGenerator.randomLongs(random, 16), ArrayGenerator.randomLongs(random, 16), 1, TrackingMutableRowSet.FACTORY.getRowSetByValues(4, 5, 6, 7, 8));
        testGetChunkGeneric(ArrayGenerator.randomLongs(random, 16), ArrayGenerator.randomLongs(random, 16), 3, TrackingMutableRowSet.FACTORY.getRowSetByValues(5, 6, 7));
        testGetChunkGeneric(ArrayGenerator.randomLongs(random, 16), ArrayGenerator.randomLongs(random, 16), 4, TrackingMutableRowSet.FACTORY.getRowSetByValues(4, 5, 6, 7));
        testGetChunkGeneric(ArrayGenerator.randomLongs(random, 16), ArrayGenerator.randomLongs(random, 16), 5, TrackingMutableRowSet.FACTORY.getRowSetByValues(4, 5, 6, 7, 8));
        testGetChunkGeneric(ArrayGenerator.randomLongs(random, 512), ArrayGenerator.randomLongs(random, 512), 4, TrackingMutableRowSet.FACTORY.getRowSetByValues(254, 255, 256, 257));
        testGetChunkGeneric(ArrayGenerator.randomLongs(random, 512), ArrayGenerator.randomLongs(random, 512), 5, TrackingMutableRowSet.FACTORY.getRowSetByValues(254, 255, 256, 257, 258));
    ...
    // region lazy
    private void testGetChunkGenericLazy(long[] values, int chunkSize, TrackingMutableRowSet rowSet) {
    ...
    public void testGetChunkLazy() {
        final Random random = new Random(0);
        testGetChunkGenericLazy(new long[0], 1, TrackingMutableRowSet.FACTORY.getRowSetByValues());
        testGetChunkGenericLazy(new long[0], 16, TrackingMutableRowSet.FACTORY.getRowSetByValues());

        testGetChunkGenericLazy(ArrayGenerator.randomLongs(random, 16), 1, TrackingMutableRowSet.FACTORY.getRowSetByValues(0));
        testGetChunkGenericLazy(ArrayGenerator.randomLongs(random, 16), 1, TrackingMutableRowSet.FACTORY.getRowSetByValues(0, 1));
        testGetChunkGenericLazy(ArrayGenerator.randomLongs(random, 16), 1, TrackingMutableRowSet.FACTORY.getRowSetByValues(4));
        testGetChunkGenericLazy(ArrayGenerator.randomLongs(random, 16), 1, TrackingMutableRowSet.FACTORY.getRowSetByValues(4, 5, 6));
        testGetChunkGenericLazy(ArrayGenerator.randomLongs(random, 16), 1, TrackingMutableRowSet.FACTORY.getRowSetByValues(4,  6));
        testGetChunkGenericLazy(ArrayGenerator.randomLongs(random, 16), 1, TrackingMutableRowSet.FACTORY.getRowSetByValues(4, 5, 6, 7, 8));
        testGetChunkGenericLazy(ArrayGenerator.randomLongs(random, 16), 3, TrackingMutableRowSet.FACTORY.getRowSetByValues(5, 6, 7));
        testGetChunkGenericLazy(ArrayGenerator.randomLongs(random, 16), 4, TrackingMutableRowSet.FACTORY.getRowSetByValues(4, 5, 6, 7));
        testGetChunkGenericLazy(ArrayGenerator.randomLongs(random, 16), 5, TrackingMutableRowSet.FACTORY.getRowSetByValues(4, 5, 6, 7, 8));
        testGetChunkGenericLazy(ArrayGenerator.randomLongs(random, 512), 4, TrackingMutableRowSet.FACTORY.getRowSetByValues(254, 255, 256, 257));
        testGetChunkGenericLazy(ArrayGenerator.randomLongs(random, 512), 5, TrackingMutableRowSet.FACTORY.getRowSetByValues(254, 255, 256, 257, 258));
    ...
    private void testFillChunkGeneric(long[] values, long[] newValues, int chunkSize, TrackingMutableRowSet rowSet) {
        final LongArraySource source;
        LiveTableMonitor.DEFAULT.startCycleForUnitTests();
        try {
            source = forArray(values);
    ...
    private void validateValuesWithFill(int chunkSize, long[] values, TrackingMutableRowSet rowSet, LongArraySource source) {
        final RowSequence.Iterator rsIterator = rowSet.getRowSequenceIterator();
        final TrackingMutableRowSet.Iterator it = rowSet.iterator();
    ...
    private void validatePrevValuesWithFill(int chunkSize, long[] values, TrackingMutableRowSet rowSet, LongArraySource source) {
        final RowSequence.Iterator rsIterator = rowSet.getRowSequenceIterator();
        final TrackingMutableRowSet.Iterator it = rowSet.iterator();
        final ColumnSource.FillContext context = source.makeFillContext(chunkSize);
        final WritableLongChunk<Values> chunk = WritableLongChunk.makeWritableChunk(chunkSize);
    ...
    public void testFillChunk() {
        final Random random = new Random(0);
        testFillChunkGeneric(new long[0], new long[0], 1, TrackingMutableRowSet.FACTORY.getRowSetByValues());
        testFillChunkGeneric(new long[0], new long[0], 16, TrackingMutableRowSet.FACTORY.getRowSetByValues());

        testFillChunkGeneric(ArrayGenerator.randomLongs(random, 16), ArrayGenerator.randomLongs(random, 16), 1, TrackingMutableRowSet.FACTORY.getRowSetByValues(0));
        testFillChunkGeneric(ArrayGenerator.randomLongs(random, 16), ArrayGenerator.randomLongs(random, 16), 1, TrackingMutableRowSet.FACTORY.getRowSetByValues(0, 1));
        testFillChunkGeneric(ArrayGenerator.randomLongs(random, 16), ArrayGenerator.randomLongs(random, 16), 1, TrackingMutableRowSet.FACTORY.getRowSetByValues(4));
        testFillChunkGeneric(ArrayGenerator.randomLongs(random, 16), ArrayGenerator.randomLongs(random, 16), 1, TrackingMutableRowSet.FACTORY.getRowSetByValues(4, 5, 6));
        testFillChunkGeneric(ArrayGenerator.randomLongs(random, 16), ArrayGenerator.randomLongs(random, 16), 1, TrackingMutableRowSet.FACTORY.getRowSetByValues(4,  6));
        testFillChunkGeneric(ArrayGenerator.randomLongs(random, 16), ArrayGenerator.randomLongs(random, 16), 1, TrackingMutableRowSet.FACTORY.getRowSetByValues(4, 5, 6, 7, 8));
        testFillChunkGeneric(ArrayGenerator.randomLongs(random, 16), ArrayGenerator.randomLongs(random, 16), 3, TrackingMutableRowSet.FACTORY.getRowSetByValues(5, 6, 7));
        testFillChunkGeneric(ArrayGenerator.randomLongs(random, 16), ArrayGenerator.randomLongs(random, 16), 4, TrackingMutableRowSet.FACTORY.getRowSetByValues(4, 5, 6, 7));
        testFillChunkGeneric(ArrayGenerator.randomLongs(random, 16), ArrayGenerator.randomLongs(random, 16), 5, TrackingMutableRowSet.FACTORY.getRowSetByValues(4, 5, 6, 7, 8));
        testFillChunkGeneric(ArrayGenerator.randomLongs(random, 512), ArrayGenerator.randomLongs(random, 512), 4, TrackingMutableRowSet.FACTORY.getRowSetByValues(254, 255, 256, 257));
        testFillChunkGeneric(ArrayGenerator.randomLongs(random, 512), ArrayGenerator.randomLongs(random, 512), 5, TrackingMutableRowSet.FACTORY.getRowSetByValues(254, 255, 256, 257, 258));
    ...
    // region lazygeneric
    private void testFillChunkLazyGeneric(long[] values, int chunkSize, TrackingMutableRowSet rowSet) {
        final LongArraySource sourceOrigin = forArray(values);
        final FormulaColumn formulaColumn = FormulaColumn.createFormulaColumn("Foo", "origin");
        final SequentialRowSetBuilder sequentialBuilder = TrackingMutableRowSet.FACTORY.getSequentialBuilder();
        if (values.length > 0) {
    ...
    public void testFillChunkLazy() {
        final Random random = new Random(0);
        testFillChunkLazyGeneric(new long[0], 1, TrackingMutableRowSet.FACTORY.getRowSetByValues());
        testFillChunkLazyGeneric(new long[0], 16, TrackingMutableRowSet.FACTORY.getRowSetByValues());

        testFillChunkLazyGeneric(ArrayGenerator.randomLongs(random, 16), 1, TrackingMutableRowSet.FACTORY.getRowSetByValues(0));
        testFillChunkLazyGeneric(ArrayGenerator.randomLongs(random, 16), 1, TrackingMutableRowSet.FACTORY.getRowSetByValues(0, 1));
        testFillChunkLazyGeneric(ArrayGenerator.randomLongs(random, 16), 1, TrackingMutableRowSet.FACTORY.getRowSetByValues(4));
        testFillChunkLazyGeneric(ArrayGenerator.randomLongs(random, 16), 1, TrackingMutableRowSet.FACTORY.getRowSetByValues(4, 5, 6));
        testFillChunkLazyGeneric(ArrayGenerator.randomLongs(random, 16), 1, TrackingMutableRowSet.FACTORY.getRowSetByValues(4,  6));
        testFillChunkLazyGeneric(ArrayGenerator.randomLongs(random, 16), 1, TrackingMutableRowSet.FACTORY.getRowSetByValues(4, 5, 6, 7, 8));
        testFillChunkLazyGeneric(ArrayGenerator.randomLongs(random, 16), 3, TrackingMutableRowSet.FACTORY.getRowSetByValues(5, 6, 7));
        testFillChunkLazyGeneric(ArrayGenerator.randomLongs(random, 16), 4, TrackingMutableRowSet.FACTORY.getRowSetByValues(4, 5, 6, 7));
        testFillChunkLazyGeneric(ArrayGenerator.randomLongs(random, 16), 5, TrackingMutableRowSet.FACTORY.getRowSetByValues(4, 5, 6, 7, 8));
        testFillChunkLazyGeneric(ArrayGenerator.randomLongs(random, 512), 4, TrackingMutableRowSet.FACTORY.getRowSetByValues(254, 255, 256, 257));
        testFillChunkLazyGeneric(ArrayGenerator.randomLongs(random, 512), 5, TrackingMutableRowSet.FACTORY.getRowSetByValues(254, 255, 256, 257, 258));
