...
/**
 * When you want to extend LiveTableTestCase, but you need to use JUnit 4 annotations,
 * like @Category or @RunWith(Suite.class), then instead of extending LiveTableTestCase,
 * you should instead create a `JUnit4LiveTableTestCase field;`, and call setUp/tearDown in @Before/@After annotated methods.
 *
