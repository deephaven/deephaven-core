...
/**
 * When you want to extend BaseArrayTestCase, but you need to use JUnit 4 annotations, like @Category
 * or @RunWith(Suite.class), then instead of extending BaseArrayTestCase, you should instead create a
 * `JUnit4BaseArrayTestCase field;`, and call setUp/tearDown in @Before/@After annotated methods.
 *
