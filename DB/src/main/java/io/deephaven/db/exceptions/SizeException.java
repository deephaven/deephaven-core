...
/**
 * <p>Unchecked exception thrown when {@link Index}, {@link io.deephaven.db.tables.Table} or
 * {@link io.deephaven.db.tables.DataColumn} operations are invoked (directly, or indirectly as data updates)
 * that cannot be completed correctly due to size constraints on the underlying data structures.
 * <p>For example, the current implementations of {@link io.deephaven.db.v2.utils.RedirectionIndex}, required for
...
public class SizeException extends UncheckedDeephavenException {
    ...
    public SizeException(@Nullable final String messagePrefix, final long inputSize, final long maximumSize) {
        super((messagePrefix == null ? "" : messagePrefix + ": ") + "Input size " + inputSize + " larger than maximum " + maximumSize);
    }
