...
/**
 * An {@link UncheckedPermissionException} derivative which indicates a table may not be accessed for one reason or another.
 */
public class TableAccessException extends UncheckedPermissionException {
    ...
    public TableAccessException(@Nullable String namespace, @NotNull String tableName, @NotNull AuthContext authContext, @Nullable String reason) {
        super(makeDescription(namespace, tableName, authContext, reason));
    }

    private static String makeDescription(@Nullable String namespace, @NotNull String tableName, @NotNull AuthContext authContext, @Nullable String reason) {
