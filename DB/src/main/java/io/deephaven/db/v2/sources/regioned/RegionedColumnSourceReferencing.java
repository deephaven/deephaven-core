...
abstract class RegionedColumnSourceReferencing<DATA_TYPE, ATTR extends Attributes.Values, NATIVE_DATA_TYPE, NATIVE_REGION_TYPE extends ColumnRegion<ATTR>>
    ...
    interface NativeSourceCreator<DATA_TYPE, ATTR extends Attributes.Values, NATIVE_DATA_TYPE, NATIVE_REGION_TYPE extends ColumnRegion<ATTR>> {
        NativeColumnSource<DATA_TYPE, ATTR, NATIVE_DATA_TYPE, NATIVE_REGION_TYPE>
        create(RegionedColumnSourceBase<DATA_TYPE, ATTR, ColumnRegionReferencing<ATTR, NATIVE_REGION_TYPE>> outerSource);
    }
    ...
    abstract static class NativeColumnSource<DATA_TYPE, ATTR extends Attributes.Values, NATIVE_DATA_TYPE, NATIVE_REGION_TYPE extends ColumnRegion<ATTR>>
            extends RegionedColumnSourceInner<NATIVE_DATA_TYPE, ATTR, NATIVE_REGION_TYPE, DATA_TYPE, ColumnRegionReferencing<ATTR, NATIVE_REGION_TYPE>>
        ...
        @Override
        public final <ALTERNATE_DATA_TYPE> boolean allowsReinterpret(@NotNull final Class<ALTERNATE_DATA_TYPE> alternateDataType) {
            return getOuterColumnSource().getType() == alternateDataType;
        }

        @Override
        protected final <ALTERNATE_DATA_TYPE> ColumnSource<ALTERNATE_DATA_TYPE> doReinterpret(@NotNull final Class<ALTERNATE_DATA_TYPE> alternateDataType) {
            //noinspection unchecked
