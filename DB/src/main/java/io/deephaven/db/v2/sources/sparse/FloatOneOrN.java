...
public final class FloatOneOrN {
    private static final int ONE_UNINITIALIZED = -1;
    private static final int HAVE_MORE_THAN_ONE = -2;

    private FloatOneOrN() {
        throw new IllegalStateException("FloatOneOrN class should never be constructed.");
    }
    ...
    static public final class Block0 {
        ...
        public void enumerate(float nullValue, LongConsumer consumer) {
            if (oneIndex == ONE_UNINITIALIZED) {
                return;
            }
    ...
    static public final class Block1 {
        ...
        void enumerate(float nullValue, LongConsumer consumer, long offset) {
            if (oneIndex == ONE_UNINITIALIZED) {
                return;
            }
            if (oneIndex != HAVE_MORE_THAN_ONE) {
    ...
    static public final class Block2 {
        ...
        public void ensureIndex(int idx, SoftRecycler<float [][]> recycler) {
            if (oneIndex == idx || oneIndex == HAVE_MORE_THAN_ONE) {
                return;
            }
            if (oneIndex == ONE_UNINITIALIZED) {
        ...
        public void maybeRecycle(SoftRecycler<float [][]> recycler) {
            if (array != null) {
                recycler.returnItem(array);
            }
        }
        ...
        private static void enumerateInner(float nullValue, float[] inner, LongConsumer consumer, long offset) {
