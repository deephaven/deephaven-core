...
public interface FormulaGenerator {
    List<String> initDef(Map<String, ColumnDefinition> columnDefinitionMap, Map<String, ? extends ColumnSource> columnsOverride);

    Formula getFormula(Index index, Class returnType, boolean initLazyMap, Map<String, ? extends ColumnSource> columnsToData,
