...
import io.deephaven.db.util.tuples.generated.LongShortIntTuple;
...
/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types DBDateTime, Short, and Integer.
...
public class DateTimeShortIntegerColumnTupleSource extends AbstractTupleSource<LongShortIntTuple> {
    ...
    public static final ThreeColumnTupleSourceFactory<LongShortIntTuple, DBDateTime, Short, Integer> FACTORY = new Factory();
    ...
    @Override
    public Class<LongShortIntTuple> getNativeType() {
        return LongShortIntTuple.class;
    }
    ...
    protected void convertChunks(@NotNull WritableChunk<? super Attributes.Values> destination, int chunkSize, Chunk<Attributes.Values> [] chunks) {
        ...
        for (int ii = 0; ii < chunkSize; ++ii) {
            destinationObjectChunk.set(ii, new LongShortIntTuple(DBTimeUtils.nanos(chunk1.get(ii)), chunk2.get(ii), chunk3.get(ii)));
        }
        destinationObjectChunk.setSize(chunkSize);
    }

    /** {@link ThreeColumnTupleSourceFactory} for instances of {@link DateTimeShortIntegerColumnTupleSource}. **/
    private static final class Factory implements ThreeColumnTupleSourceFactory<LongShortIntTuple, DBDateTime, Short, Integer> {
