...
public class ByteFindRunsKernel {
     ...
     */
    static void findRuns(ByteChunk sortedValues, WritableIntChunk<ChunkPositions> offsetsOut, WritableIntChunk<ChunkLengths> lengthsOut) {
     ...
     * @param lengthsOut an output chunk, parallel to offsetsOut, with the lengths of found runs
     */
    public static void findRunsSingles(ByteChunk sortedValues, WritableIntChunk<ChunkPositions> offsetsOut, WritableIntChunk<ChunkLengths> lengthsOut) {
        offsetsOut.setSize(0);
        lengthsOut.setSize(0);
     ...
     */
    public static void findRuns(ByteChunk sortedValues, IntChunk<ChunkPositions> offsetsIn, IntChunk<ChunkLengths> lengthsIn, WritableIntChunk<ChunkPositions> offsetsOut, WritableIntChunk<ChunkLengths> lengthsOut) {
        offsetsOut.setSize(0);
        lengthsOut.setSize(0);
    ...
    private static void findRuns(ByteChunk sortedValues, int offset, int length, WritableIntChunk<ChunkPositions> offsetsOut, WritableIntChunk<ChunkLengths> lengthsOut, boolean includeSingles) {
        if (length == 0) {
            return;
        }
        int startRun = offset;
    ...
    private static boolean neq(byte last, byte next) {
        // region neq
        return next != last;
        // endregion neq
    }

    private static class ByteFindRunsKernelContext implements FindRunsKernel {
        @Override
        public void findRuns(Chunk sortedValues, IntChunk<ChunkPositions> offsetsIn, IntChunk<ChunkLengths> lengthsIn, WritableIntChunk<ChunkPositions> offsetsOut, WritableIntChunk<ChunkLengths> lengthsOut) {
            ByteFindRunsKernel.findRuns(sortedValues.asByteChunk(), offsetsIn, lengthsIn, offsetsOut, lengthsOut);
        }
        ...
        public void findRuns(Chunk sortedValues, WritableIntChunk<ChunkPositions> offsetsOut, WritableIntChunk<ChunkLengths> lengthsOut) {
            ByteFindRunsKernel.findRuns(sortedValues.asByteChunk(), offsetsOut, lengthsOut);
        }
        ...
        public void findRunsSingles(Chunk sortedValues, WritableIntChunk<ChunkPositions> offsetsOut, WritableIntChunk<ChunkLengths> lengthsOut) {
            ByteFindRunsKernel.findRunsSingles(sortedValues.asByteChunk(), offsetsOut, lengthsOut);
        }
    }
