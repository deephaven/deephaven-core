...
import io.deephaven.db.util.tuples.generated.FloatCharTuple;
...
public class FloatCharacterColumnTupleSource extends AbstractTupleSource<FloatCharTuple> {
    ...
    @Override
    public final FloatCharTuple createTuple(final long indexKey) {
    ...
    @Override
    public final FloatCharTuple createPreviousTuple(final long indexKey) {
        return new FloatCharTuple(
    ...
    @Override
    public final <ELEMENT_TYPE> void exportElement(@NotNull final FloatCharTuple tuple, final int elementIndex, @NotNull final WritableSource<ELEMENT_TYPE> writableSource, final long destinationIndexKey) {
        if (elementIndex == 0) {
    ...
    @Override
    public Class<FloatCharTuple> getNativeType() { return FloatCharTuple.class; }

    protected void convertChunks(@NotNull WritableChunk<? super Attributes.Values> destination, int chunkSize, Chunk<Attributes.Values> [] chunks) {
        WritableObjectChunk<FloatCharTuple, ? super Attributes.Values> destinationObjectChunk = destination.asWritableObjectChunk();
