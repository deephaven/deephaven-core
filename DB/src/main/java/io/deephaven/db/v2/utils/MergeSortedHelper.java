...
public class MergeSortedHelper {
    ...
    static public class SortedMergeColumnSource<T> extends AbstractColumnSource<T> {
        ...
        public SortedMergeColumnSource(TIntArrayList tableIndex, TLongArrayList columnIndex, ColumnSource<T> firstSource) {
        ...
        void addSource(ColumnSource<T> source) {
            ...
            Require.eq(source.getType(), "source.getType()", innerSources.get(0).getType(), "innerSources.get(0).getType()");
        }
