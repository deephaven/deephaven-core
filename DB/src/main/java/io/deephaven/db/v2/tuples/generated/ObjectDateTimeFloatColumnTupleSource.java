...
import io.deephaven.db.util.tuples.generated.ObjectLongFloatTuple;
...
/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types Object, DBDateTime, and Float.
...
public class ObjectDateTimeFloatColumnTupleSource extends AbstractTupleSource<ObjectLongFloatTuple> {
    ...
    public static final ThreeColumnTupleSourceFactory<ObjectLongFloatTuple, Object, DBDateTime, Float> FACTORY = new Factory();
    ...
    @Override
    public Class<ObjectLongFloatTuple> getNativeType() {
        return ObjectLongFloatTuple.class;
    }
    ...
    protected void convertChunks(@NotNull WritableChunk<? super Attributes.Values> destination, int chunkSize, Chunk<Attributes.Values> [] chunks) {
        ...
        for (int ii = 0; ii < chunkSize; ++ii) {
            destinationObjectChunk.set(ii, new ObjectLongFloatTuple(chunk1.get(ii), DBTimeUtils.nanos(chunk2.get(ii)), chunk3.get(ii)));
        }
        destinationObjectChunk.setSize(chunkSize);
    }

    /** {@link ThreeColumnTupleSourceFactory} for instances of {@link ObjectDateTimeFloatColumnTupleSource}. **/
    private static final class Factory implements ThreeColumnTupleSourceFactory<ObjectLongFloatTuple, Object, DBDateTime, Float> {
