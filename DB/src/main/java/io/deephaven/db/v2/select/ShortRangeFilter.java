...
public class ShortRangeFilter extends AbstractRangeFilter {
    ...
    private long bound(Index selection, boolean usePrev, ColumnSource<Short> longColumnSource, long minPosition, long maxPosition, short targetValue, boolean inclusive, int compareSign, boolean end) {
