...
/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types DBDateTime and Character.
...
public class DateTimeCharacterColumnTupleSource extends AbstractTupleSource<LongCharTuple> {
    ...
    public static final TwoColumnTupleSourceFactory<LongCharTuple, DBDateTime, Character> FACTORY = new Factory();
    ...
    @Override
    public Class<LongCharTuple> getNativeType() { return LongCharTuple.class; }
    ...
    protected void convertChunks(@NotNull WritableChunk<? super Attributes.Values> destination, int chunkSize, Chunk<Attributes.Values> [] chunks) {
        ...
        for (int ii = 0; ii < chunkSize; ++ii) {
            destinationObjectChunk.set(ii, new LongCharTuple(DBTimeUtils.nanos(chunk1.get(ii)), chunk2.get(ii)));
        }
        destination.setSize(chunkSize);
    }

    /** {@link TwoColumnTupleSourceFactory} for instances of {@link DateTimeCharacterColumnTupleSource}. **/
    private static final class Factory implements TwoColumnTupleSourceFactory<LongCharTuple, DBDateTime, Character> {
