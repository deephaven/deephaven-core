...
abstract class BaseAddOnlyFirstOrLastChunkedOperator implements IterativeChunkedAggregationOperator {
    ...
    BaseAddOnlyFirstOrLastChunkedOperator(boolean isFirst, MatchPair[] resultPairs, Table originalTable, String exposeRedirectionAs) {
        ...
        for (final MatchPair mp : resultPairs) {
            ...
            resultColumns.put(mp.left(), new ReadOnlyRedirectedColumnSource(redirectionIndex, originalTable.getColumnSource(mp.right())));
        }
