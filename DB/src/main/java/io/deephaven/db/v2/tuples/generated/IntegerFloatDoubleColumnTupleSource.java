...
import io.deephaven.db.util.tuples.generated.IntFloatDoubleTuple;
...
public class IntegerFloatDoubleColumnTupleSource extends AbstractTupleSource<IntFloatDoubleTuple> {
    ...
    @Override
    public final <ELEMENT_TYPE> void exportElement(@NotNull final IntFloatDoubleTuple tuple, final int elementIndex, @NotNull final WritableSource<ELEMENT_TYPE> writableSource, final long destinationIndexKey) {
        if (elementIndex == 0) {
    ...
    @Override
    public Class<IntFloatDoubleTuple> getNativeType() {
        return IntFloatDoubleTuple.class;
    }
