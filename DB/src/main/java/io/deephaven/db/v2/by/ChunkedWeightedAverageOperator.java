...
class ChunkedWeightedAverageOperator implements IterativeChunkedAggregationOperator {
    ...
    ChunkedWeightedAverageOperator(ChunkType chunkType, DoubleWeightRecordingInternalOperator weightOperator, String name) {
    ...
    private boolean modifyChunk(DoubleChunk<? extends Values> prevDoubleValues, DoubleChunk<? extends Values> prevWeightValues, DoubleChunk<? extends Values> newDoubleValues, DoubleChunk<? extends Values> newWeightValues, int start, int length, long destination) {
        ...
        sumChunks(prevDoubleValues, prevWeightValues, start, length, nanOut, normalOut, sumOfWeightsOut, weightedSumOut);
        ...
        if (totalNormal > 0) {
            ...
            final double totalSumOfWeights = NullSafeAddition.plusDouble(existingSumOfWeights, newSumOfWeights - prevSumOfWeights);
