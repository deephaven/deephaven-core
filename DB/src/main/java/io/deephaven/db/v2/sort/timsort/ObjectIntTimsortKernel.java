...
public class ObjectIntTimsortKernel {
    ...
    // region Context
    public static class ObjectIntSortKernelContext<ATTR extends Any, KEY_INDICES extends Keys> implements IntSortKernel<ATTR, KEY_INDICES> {
        int minGallop;
        int runCount = 0;
    ...
    public static <ATTR extends Any, KEY_INDICES extends Keys> ObjectIntSortKernelContext<ATTR, KEY_INDICES> createContext(int size) {
     ...
     */
    static <ATTR extends Any, KEY_INDICES extends Keys> void sort(ObjectIntSortKernelContext<ATTR, KEY_INDICES> context, WritableIntChunk<KEY_INDICES> indexKeys, WritableObjectChunk<Object, ATTR> valuesToSort, IntChunk<? extends ChunkPositions> offsetsIn, IntChunk<? extends ChunkLengths> lengthsIn) {
     ...
     * runs sorted on each pass.
     */
    public static <ATTR extends Any, KEY_INDICES extends Keys> void sort(ObjectIntSortKernelContext<ATTR, KEY_INDICES> context, WritableIntChunk<KEY_INDICES> indexKeys, WritableObjectChunk<Object, ATTR> valuesToSort) {
        timSort(context, indexKeys, valuesToSort, 0, indexKeys.size());
    }

    static private <ATTR extends Any, KEY_INDICES extends Keys> void timSort(ObjectIntSortKernelContext<ATTR, KEY_INDICES> context, WritableIntChunk<KEY_INDICES> indexKeys, WritableObjectChunk<Object, ATTR> valuesToSort, int offset, int length) {
        if (length <= 1) {
            return;
        }
     ...
     */
    private static <ATTR extends Any, KEY_INDICES extends Keys> void ensureMergeInvariants(ObjectIntSortKernelContext<ATTR, KEY_INDICES> context, WritableIntChunk<KEY_INDICES> indexKeys, WritableObjectChunk<Object, ATTR> valuesToSort) {
        while (context.runCount > 1) {
    ...
    private static <ATTR extends Any, KEY_INDICES extends Keys> void merge(ObjectIntSortKernelContext<ATTR, KEY_INDICES> context, WritableIntChunk<KEY_INDICES> indexKeys, WritableObjectChunk<Object, ATTR> valuesToSort, int start1, int length1, int length2) {
     ...
     */
    private static <ATTR extends Any, KEY_INDICES extends Keys> void frontMerge(ObjectIntSortKernelContext<ATTR, KEY_INDICES> context, WritableIntChunk<KEY_INDICES> indexKeys, WritableObjectChunk<Object, ATTR> valuesToSort, final int mergeStartPosition, final int start2, final int length2) {
        int tempCursor = 0;
     ...
     * We eventually need to do galloping here, but are skipping that for now
     */
    private static <ATTR extends Any, KEY_INDICES extends Keys> void backMerge(ObjectIntSortKernelContext<ATTR, KEY_INDICES> context, WritableIntChunk<KEY_INDICES> indexKeys, WritableObjectChunk<Object, ATTR> valuesToSort, final int mergeStartPosition, final int length1) {
    ...
    private static <ATTR extends Any, KEY_INDICES extends Keys> void copyToTemporary(ObjectIntSortKernelContext<ATTR, KEY_INDICES> context, WritableIntChunk<KEY_INDICES> indexKeys, WritableObjectChunk<Object, ATTR> valuesToSort, int mergeStartPosition, int remaining1) {
    ...
    private static <ATTR extends Any, KEY_INDICES extends Keys> void copyToChunk(IntChunk<KEY_INDICES> indexSource, ObjectChunk<Object, ATTR> valuesSource, WritableIntChunk<KEY_INDICES> indexDest, WritableObjectChunk<Object, ATTR> valuesDest, int sourceStart, int destStart, int length) {
    ...
    private static void insertionSort(WritableIntChunk<? extends Keys> indexKeys, WritableObjectChunk<Object, ?> valuesToSort, int offset, int length) {
    ...
    static private void swap(WritableIntChunk<? extends Keys> indexKeys, WritableObjectChunk<Object, ?> valuesToSort, int a, int b) {
