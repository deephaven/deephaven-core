...
public interface AggregationStateFactory {
     ...
     *
     * <p>If two AggregationStateFactories have equal memoKeys, then {@link Table#by} operations that have the same
     * group by columns may be memoized.  In that case instead of recomputing the result; the original result will be
     * used.</p>
     *
     * <p>If null is returned, the operation will not be memoized.</p>
     *
