...
/**
 *  This column source wraps another column source, and returns the values in the opposite order.  It must be paired
 *  with a ReverseOperation (that can be shared among reversed column sources) that implements the index transformations
 *  for this source.
 */
