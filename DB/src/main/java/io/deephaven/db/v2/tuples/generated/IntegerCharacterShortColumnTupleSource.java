...
import io.deephaven.db.util.tuples.generated.IntCharShortTuple;
...
public class IntegerCharacterShortColumnTupleSource extends AbstractTupleSource<IntCharShortTuple> {
    ...
    @Override
    public final <ELEMENT_TYPE> void exportElement(@NotNull final IntCharShortTuple tuple, final int elementIndex, @NotNull final WritableSource<ELEMENT_TYPE> writableSource, final long destinationIndexKey) {
        if (elementIndex == 0) {
    ...
    @Override
    public Class<IntCharShortTuple> getNativeType() {
        return IntCharShortTuple.class;
    }
