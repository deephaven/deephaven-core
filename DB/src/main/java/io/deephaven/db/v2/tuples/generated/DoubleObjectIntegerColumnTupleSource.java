...
import io.deephaven.db.util.tuples.generated.DoubleObjectIntTuple;
...
public class DoubleObjectIntegerColumnTupleSource extends AbstractTupleSource<DoubleObjectIntTuple> {
    ...
    @Override
    public final <ELEMENT_TYPE> void exportElement(@NotNull final DoubleObjectIntTuple tuple, final int elementIndex, @NotNull final WritableSource<ELEMENT_TYPE> writableSource, final long destinationIndexKey) {
        if (elementIndex == 0) {
    ...
    @Override
    public Class<DoubleObjectIntTuple> getNativeType() {
        return DoubleObjectIntTuple.class;
    }
