...
/**
 * Base class with shared boilerplate for {@link StreamFirstChunkedOperator} and
 * {@link StreamLastChunkedOperator}.
 */
public abstract class BaseStreamFirstOrLastChunkedOperator
    ...
    /**
     * The number of result columns. This is the size of {@link #resultColumns} and the length of
     * {@link #inputColumns} and {@link #outputColumns}.
     */
     ...
     * <p>
     * These are the source columns from the upstream table, reinterpreted to primitives where
     * applicable.
     */
    ...
    /**
     * Map from destination slot to first key. Only used during a step to keep track of the
     * appropriate rows to copy into the output columns.
     */
    ...
    protected BaseStreamFirstOrLastChunkedOperator(@NotNull final MatchPair[] resultPairs,
        ...
        final Map<String, ArrayBackedColumnSource<?>> resultColumnsMutable =
            new LinkedHashMap<>(numResultColumns);
        for (int ci = 0; ci < numResultColumns; ++ci) {
            ...
            final ArrayBackedColumnSource<?> resultSource = ArrayBackedColumnSource
            ...
            // Note that ArrayBackedColumnSources implementations reinterpret very efficiently where
            // applicable.
            outputColumns[ci] =
                (WritableSource<?>) ReinterpretUtilities.maybeConvertToPrimitive(resultSource);
    ...
    @Override
    public final void removeChunk(BucketedContext bucketedContext,
    ...
    @Override
    public final void modifyChunk(BucketedContext bucketedContext,
    ...
    @Override
    public final void shiftChunk(BucketedContext bucketedContext,
        Chunk<? extends Attributes.Values> previousValues,
        Chunk<? extends Attributes.Values> newValues,
        LongChunk<? extends Attributes.KeyIndices> preShiftIndices,
        LongChunk<? extends Attributes.KeyIndices> postShiftIndices,
        IntChunk<Attributes.KeyIndices> destinations,
        IntChunk<Attributes.ChunkPositions> startPositions,
        IntChunk<Attributes.ChunkLengths> length,
    ...
    @Override
    public final void modifyIndices(BucketedContext context,
        LongChunk<? extends Attributes.KeyIndices> inputIndices,
        IntChunk<Attributes.KeyIndices> destinations,
        IntChunk<Attributes.ChunkPositions> startPositions,
        IntChunk<Attributes.ChunkLengths> length,
    ...
    @Override
    public final boolean modifyIndices(SingletonContext context,
        LongChunk<? extends Attributes.KeyIndices> indices, long destination) {
        throw new UnsupportedOperationException();
    }
}
