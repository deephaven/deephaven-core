...
/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types Byte and DBDateTime.
...
public class ReinterpretedBooleanDateTimeColumnTupleSource extends AbstractTupleSource<ByteLongTuple> {
    ...
    public static final TwoColumnTupleSourceFactory<ByteLongTuple, Byte, DBDateTime> FACTORY = new Factory();
    ...
    @Override
    public Class<ByteLongTuple> getNativeType() { return ByteLongTuple.class; }
    ...
    protected void convertChunks(@NotNull WritableChunk<? super Attributes.Values> destination, int chunkSize, Chunk<Attributes.Values> [] chunks) {
        ...
        for (int ii = 0; ii < chunkSize; ++ii) {
            destinationObjectChunk.set(ii, new ByteLongTuple(chunk1.get(ii), DBTimeUtils.nanos(chunk2.get(ii))));
        }
        destination.setSize(chunkSize);
    }

    /** {@link TwoColumnTupleSourceFactory} for instances of {@link ReinterpretedBooleanDateTimeColumnTupleSource}. **/
    private static final class Factory implements TwoColumnTupleSourceFactory<ByteLongTuple, Byte, DBDateTime> {
