...
import io.deephaven.db.util.tuples.generated.FloatShortFloatTuple;
...
public class FloatShortFloatColumnTupleSource extends AbstractTupleSource<FloatShortFloatTuple> {
    ...
    @Override
    public final FloatShortFloatTuple createTuple(final long indexKey) {
    ...
    @Override
    public final FloatShortFloatTuple createPreviousTuple(final long indexKey) {
        return new FloatShortFloatTuple(
    ...
    @Override
    public final <ELEMENT_TYPE> void exportElement(@NotNull final FloatShortFloatTuple tuple, final int elementIndex, @NotNull final WritableSource<ELEMENT_TYPE> writableSource, final long destinationIndexKey) {
        if (elementIndex == 0) {
    ...
    @Override
    public final Object exportToExternalKey(@NotNull final FloatShortFloatTuple tuple) {
        return new SmartKey(
    ...
    @Override
    public Class<FloatShortFloatTuple> getNativeType() {
        return FloatShortFloatTuple.class;
    }

    @Override
    protected void convertChunks(@NotNull WritableChunk<? super Attributes.Values> destination, int chunkSize, Chunk<Attributes.Values> [] chunks) {
        WritableObjectChunk<FloatShortFloatTuple, ? super Attributes.Values> destinationObjectChunk = destination.asWritableObjectChunk();
