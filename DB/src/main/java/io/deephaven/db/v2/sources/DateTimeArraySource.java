...
public class DateTimeArraySource extends AbstractLongArraySource<DBDateTime> {
    ...
    @Override
    public void fillChunk(@NotNull ColumnSource.FillContext context, @NotNull WritableChunk<? super Values> dest, @NotNull OrderedKeys orderedKeys) {
    ...
    @Override
    public void fillPrevChunk(@NotNull ColumnSource.FillContext context, @NotNull WritableChunk<? super Values> dest, @NotNull OrderedKeys orderedKeys) {
        final ChunkFiller filler = dest.getChunkFiller();
        if (orderedKeys.getAverageRunLengthEstimate() > USE_RANGES_AVERAGE_RUN_LENGTH) {
    ...
    @Override
    protected void fillSparseChunkUnordered(@NotNull final WritableChunk<? super Values> destGeneric, @NotNull final LongChunk<? extends Attributes.KeyIndices> indices) {
        super.fillSparseChunkUnordered(destGeneric, indices, DBTimeUtils::nanosToTime);
    }

    @Override
    protected void fillSparsePrevChunkUnordered(@NotNull final WritableChunk<? super Values> destGeneric, @NotNull final LongChunk<? extends Attributes.KeyIndices> indices) {
    ...
    private class ReinterpretedAsLong extends AbstractColumnSource<Long> implements MutableColumnSourceGetDefaults.ForLong, FillUnordered, WritableSource<Long> {
        ...
        public void fillChunk(@NotNull final ColumnSource.FillContext context, @NotNull final WritableChunk<? super Values> destination, @NotNull final OrderedKeys orderedKeys) {
            // can't defer this case to super as they will ultimately call a method on DateTimeArraySource instead of AbstractLongArraySource
            if (orderedKeys.getAverageRunLengthEstimate() < USE_RANGES_AVERAGE_RUN_LENGTH) {
        ...
        public void fillPrevChunk(@NotNull final ColumnSource.FillContext context, @NotNull final WritableChunk<? super Values> destination, @NotNull final OrderedKeys orderedKeys) {
            // can't defer these two cases to super as they will ultimately call a method on DateTimeArraySource instead of AbstractLongArraySource
            if (prevFlusher == null) {
        ...
        @Override
        public void fillChunkUnordered(@NotNull final FillContext context, @NotNull final WritableChunk<? super Values> destination, @NotNull final LongChunk<? extends Attributes.KeyIndices> keyIndices) {
            fillSparseLongChunkUnordered(destination, keyIndices);
        }

        @Override
        public void fillPrevChunkUnordered(@NotNull final FillContext context, @NotNull final WritableChunk<? super Values> destination, @NotNull final LongChunk<? extends Attributes.KeyIndices> keyIndices) {
        ...
        public void fillFromChunk(@NotNull FillFromContext context, @NotNull Chunk<? extends Values> src,
            ...
            // Note: we cannot call super.fillFromChunk here as that method will call the override versions that expect ObjectChunks.
            if (orderedKeys.getAverageRunLengthEstimate() < USE_RANGES_AVERAGE_RUN_LENGTH) {
