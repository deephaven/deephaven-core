...
import io.deephaven.db.util.tuples.generated.ObjectByteObjectTuple;
...
public class ObjectReinterpretedBooleanObjectColumnTupleSource extends AbstractTupleSource<ObjectByteObjectTuple> {

    /** {@link ThreeColumnTupleSourceFactory} instance to create instances of {@link ObjectReinterpretedBooleanObjectColumnTupleSource}. **/
    ...
    public ObjectReinterpretedBooleanObjectColumnTupleSource(
    ...
    @Override
    public final ObjectByteObjectTuple createTuple(final long indexKey) {
    ...
    @Override
    public final ObjectByteObjectTuple createPreviousTuple(final long indexKey) {
        return new ObjectByteObjectTuple(
    ...
    @Override
    public final <ELEMENT_TYPE> void exportElement(@NotNull final ObjectByteObjectTuple tuple, final int elementIndex, @NotNull final WritableSource<ELEMENT_TYPE> writableSource, final long destinationIndexKey) {
        if (elementIndex == 0) {
    ...
    @Override
    public Class<ObjectByteObjectTuple> getNativeType() {
        return ObjectByteObjectTuple.class;
    }

    @Override
    protected void convertChunks(@NotNull WritableChunk<? super Attributes.Values> destination, int chunkSize, Chunk<Attributes.Values> [] chunks) {
        WritableObjectChunk<ObjectByteObjectTuple, ? super Attributes.Values> destinationObjectChunk = destination.asWritableObjectChunk();
    ...
    /** {@link ThreeColumnTupleSourceFactory} for instances of {@link ObjectReinterpretedBooleanObjectColumnTupleSource}. **/
    private static final class Factory implements ThreeColumnTupleSourceFactory<ObjectByteObjectTuple, Object, Byte, Object> {
        ...
        public TupleSource<ObjectByteObjectTuple> create(
            ...
            return new ObjectReinterpretedBooleanObjectColumnTupleSource(
                    columnSource1,
                    columnSource2,
                    columnSource3
            );
