...
import io.deephaven.db.util.tuples.generated.FloatFloatCharTuple;
...
public class FloatFloatCharacterColumnTupleSource extends AbstractTupleSource<FloatFloatCharTuple> {
    ...
    @Override
    public final FloatFloatCharTuple createTuple(final long indexKey) {
    ...
    @Override
    public final FloatFloatCharTuple createPreviousTuple(final long indexKey) {
        return new FloatFloatCharTuple(
    ...
    @Override
    public final <ELEMENT_TYPE> void exportElement(@NotNull final FloatFloatCharTuple tuple, final int elementIndex, @NotNull final WritableSource<ELEMENT_TYPE> writableSource, final long destinationIndexKey) {
        if (elementIndex == 0) {
    ...
    @Override
    public Class<FloatFloatCharTuple> getNativeType() {
        return FloatFloatCharTuple.class;
    }

    @Override
    protected void convertChunks(@NotNull WritableChunk<? super Attributes.Values> destination, int chunkSize, Chunk<Attributes.Values> [] chunks) {
        WritableObjectChunk<FloatFloatCharTuple, ? super Attributes.Values> destinationObjectChunk = destination.asWritableObjectChunk();
