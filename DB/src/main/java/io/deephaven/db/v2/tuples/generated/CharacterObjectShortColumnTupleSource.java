...
import io.deephaven.db.util.tuples.generated.CharObjectShortTuple;
...
public class CharacterObjectShortColumnTupleSource extends AbstractTupleSource<CharObjectShortTuple> {
    ...
    @Override
    public final <ELEMENT_TYPE> void exportElement(@NotNull final CharObjectShortTuple tuple, final int elementIndex, @NotNull final WritableSource<ELEMENT_TYPE> writableSource, final long destinationIndexKey) {
        if (elementIndex == 0) {
    ...
    @Override
    public Class<CharObjectShortTuple> getNativeType() {
        return CharObjectShortTuple.class;
    }
