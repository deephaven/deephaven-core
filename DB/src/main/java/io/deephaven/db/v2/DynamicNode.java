...
public interface DynamicNode {
     ...
     * @return True if the object is a {@link DynamicNode} and its {@link DynamicNode#isRefreshing()} returns true, false otherwise
     */
     ...
     *
     * @param object The object
     * @return True if the object is not a {@link DynamicNode} or its {@link DynamicNode#isRefreshing()} returns false, false otherwise
     */
     ...
     *
     * @param object The object
     * @return True if the object is not a {@link DynamicNode} or if its {@link DynamicNode#isRefreshing()} returns true, false otherwise
     */
