...
/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types Character, Boolean, and DBDateTime.
...
public class CharacterBooleanDateTimeColumnTupleSource extends AbstractTupleSource<CharByteLongTuple> {
    ...
    public static final ThreeColumnTupleSourceFactory<CharByteLongTuple, Character, Boolean, DBDateTime> FACTORY = new Factory();
    ...
    @Override
    public Class<CharByteLongTuple> getNativeType() {
        return CharByteLongTuple.class;
    }
    ...
    protected void convertChunks(@NotNull WritableChunk<? super Attributes.Values> destination, int chunkSize, Chunk<Attributes.Values> [] chunks) {
        ...
        for (int ii = 0; ii < chunkSize; ++ii) {
            destinationObjectChunk.set(ii, new CharByteLongTuple(chunk1.get(ii), BooleanUtils.booleanAsByte(chunk2.get(ii)), DBTimeUtils.nanos(chunk3.get(ii))));
        }
        destinationObjectChunk.setSize(chunkSize);
    }

    /** {@link ThreeColumnTupleSourceFactory} for instances of {@link CharacterBooleanDateTimeColumnTupleSource}. **/
    private static final class Factory implements ThreeColumnTupleSourceFactory<CharByteLongTuple, Character, Boolean, DBDateTime> {
