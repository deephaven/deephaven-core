...
{
    /**
     * Get a reverse-lookup function for all non-null values stored in this column source at {@code keys <= highestKeyNeeded}.
     *
     ...
     * @return              The key, between 0 and highestIndex, for the value.  A value outside this range if the value
     *                      has no mapping in the range.
     */
