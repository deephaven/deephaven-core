...
/**
 * {@link TableLocationKeyFinder Location finder} that will traverse a directory hierarchy and infer
 * partitions from key-value pairs in the directory names, for example:
 * 
 * <pre>
 ...
 */
public final class KeyValuePartitionLayout<TLK extends TableLocationKey>
    implements TableLocationKeyFinder<TLK> {

    public static TableLocationKeyFinder<ParquetTableLocationKey> forParquet(
