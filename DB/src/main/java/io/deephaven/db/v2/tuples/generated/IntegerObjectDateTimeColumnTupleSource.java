...
/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types Integer, Object, and DBDateTime.
...
public class IntegerObjectDateTimeColumnTupleSource extends AbstractTupleSource<IntObjectLongTuple> {
    ...
    public static final ThreeColumnTupleSourceFactory<IntObjectLongTuple, Integer, Object, DBDateTime> FACTORY = new Factory();
    ...
    @Override
    public Class<IntObjectLongTuple> getNativeType() {
        return IntObjectLongTuple.class;
    }
    ...
    protected void convertChunks(@NotNull WritableChunk<? super Attributes.Values> destination, int chunkSize, Chunk<Attributes.Values> [] chunks) {
        ...
        for (int ii = 0; ii < chunkSize; ++ii) {
            destinationObjectChunk.set(ii, new IntObjectLongTuple(chunk1.get(ii), chunk2.get(ii), DBTimeUtils.nanos(chunk3.get(ii))));
        }
        destinationObjectChunk.setSize(chunkSize);
    }

    /** {@link ThreeColumnTupleSourceFactory} for instances of {@link IntegerObjectDateTimeColumnTupleSource}. **/
    private static final class Factory implements ThreeColumnTupleSourceFactory<IntObjectLongTuple, Integer, Object, DBDateTime> {
