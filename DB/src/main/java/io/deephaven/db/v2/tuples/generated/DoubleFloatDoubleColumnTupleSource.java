...
import io.deephaven.db.util.tuples.generated.DoubleFloatDoubleTuple;
...
public class DoubleFloatDoubleColumnTupleSource extends AbstractTupleSource<DoubleFloatDoubleTuple> {
    ...
    @Override
    public final DoubleFloatDoubleTuple createTuple(final long indexKey) {
    ...
    @Override
    public final DoubleFloatDoubleTuple createPreviousTuple(final long indexKey) {
        return new DoubleFloatDoubleTuple(
    ...
    @Override
    public final <ELEMENT_TYPE> void exportElement(@NotNull final DoubleFloatDoubleTuple tuple, final int elementIndex, @NotNull final WritableSource<ELEMENT_TYPE> writableSource, final long destinationIndexKey) {
        if (elementIndex == 0) {
    ...
    @Override
    public Class<DoubleFloatDoubleTuple> getNativeType() {
        return DoubleFloatDoubleTuple.class;
    }

    @Override
    protected void convertChunks(@NotNull WritableChunk<? super Attributes.Values> destination, int chunkSize, Chunk<Attributes.Values> [] chunks) {
        WritableObjectChunk<DoubleFloatDoubleTuple, ? super Attributes.Values> destinationObjectChunk = destination.asWritableObjectChunk();
