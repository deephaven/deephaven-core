...
public class IndexPeformanceTest {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Range iteration per item time = " + (System.currentTimeMillis() - start)/(SIZE/1000000) + "ns " + sum);
        ...
        System.out.println("Random construction per item time = " + (System.currentTimeMillis() - start)/(SIZE/1000000) +
                "ns " + sum + " " + runningValue);
        ...
        System.out.println("Random iteration per item time = " + (System.currentTimeMillis() - start)/(SIZE/1000000) + "ns " + sum);
    }
}
