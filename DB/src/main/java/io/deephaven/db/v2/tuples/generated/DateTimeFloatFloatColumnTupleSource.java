...
/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types DBDateTime, Float, and Float.
...
public class DateTimeFloatFloatColumnTupleSource extends AbstractTupleSource<LongFloatFloatTuple> {
    ...
    public static final ThreeColumnTupleSourceFactory<LongFloatFloatTuple, DBDateTime, Float, Float> FACTORY = new Factory();
    ...
    @Override
    public Class<LongFloatFloatTuple> getNativeType() {
        return LongFloatFloatTuple.class;
    }
    ...
    protected void convertChunks(@NotNull WritableChunk<? super Attributes.Values> destination, int chunkSize, Chunk<Attributes.Values> [] chunks) {
        ...
        for (int ii = 0; ii < chunkSize; ++ii) {
            destinationObjectChunk.set(ii, new LongFloatFloatTuple(DBTimeUtils.nanos(chunk1.get(ii)), chunk2.get(ii), chunk3.get(ii)));
        }
        destinationObjectChunk.setSize(chunkSize);
    }

    /** {@link ThreeColumnTupleSourceFactory} for instances of {@link DateTimeFloatFloatColumnTupleSource}. **/
    private static final class Factory implements ThreeColumnTupleSourceFactory<LongFloatFloatTuple, DBDateTime, Float, Float> {
