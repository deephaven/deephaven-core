...
import io.deephaven.db.util.tuples.generated.FloatCharLongTuple;
...
/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types Float, Character, and DBDateTime.
...
public class FloatCharacterDateTimeColumnTupleSource extends AbstractTupleSource<FloatCharLongTuple> {
    ...
    public static final ThreeColumnTupleSourceFactory<FloatCharLongTuple, Float, Character, DBDateTime> FACTORY = new Factory();
    ...
    @Override
    public Class<FloatCharLongTuple> getNativeType() {
        return FloatCharLongTuple.class;
    }
    ...
    protected void convertChunks(@NotNull WritableChunk<? super Attributes.Values> destination, int chunkSize, Chunk<Attributes.Values> [] chunks) {
        ...
        for (int ii = 0; ii < chunkSize; ++ii) {
            destinationObjectChunk.set(ii, new FloatCharLongTuple(chunk1.get(ii), chunk2.get(ii), DBTimeUtils.nanos(chunk3.get(ii))));
        }
        destinationObjectChunk.setSize(chunkSize);
    }

    /** {@link ThreeColumnTupleSourceFactory} for instances of {@link FloatCharacterDateTimeColumnTupleSource}. **/
    private static final class Factory implements ThreeColumnTupleSourceFactory<FloatCharLongTuple, Float, Character, DBDateTime> {
