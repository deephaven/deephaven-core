...
public interface TableLocationFactory<TK extends TableKey, TLK extends TableLocationKey> {
     ...
     * @param locationKey The {@link TableLocationKey} (or an immutable equivalent) returned by a
     *        paired {@link TableLocationKeyFinder}
     * @param refreshService An optional {@link TableDataRefreshService}, non-null if the enclosing
     *        provider {@link TableLocationProvider#supportsSubscriptions() supports subscriptions}
