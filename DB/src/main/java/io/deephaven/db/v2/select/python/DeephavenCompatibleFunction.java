...
public class DeephavenCompatibleFunction {
    ...
    public static DeephavenCompatibleFunction create(
        ...
        return new DeephavenCompatibleFunction(function, (Class)returnedType, Arrays.asList(columnNames), isVectorized);
    }
    ...
    public FormulaKernel toFormulaKernel() {
        return isVectorized ?
            new FormulaKernelPythonChunkedFunction(function) :
    ...
    public FilterKernel<Context> toFilterKernel() {
        ...
        return isVectorized ?
            new FilterKernelPythonChunkedFunction(function) :
