...
import io.deephaven.db.util.tuples.generated.DoubleObjectFloatTuple;
...
public class DoubleObjectFloatColumnTupleSource extends AbstractTupleSource<DoubleObjectFloatTuple> {
    ...
    @Override
    public final DoubleObjectFloatTuple createTuple(final long indexKey) {
    ...
    @Override
    public final DoubleObjectFloatTuple createPreviousTuple(final long indexKey) {
        return new DoubleObjectFloatTuple(
    ...
    @Override
    public final <ELEMENT_TYPE> void exportElement(@NotNull final DoubleObjectFloatTuple tuple, final int elementIndex, @NotNull final WritableSource<ELEMENT_TYPE> writableSource, final long destinationIndexKey) {
        if (elementIndex == 0) {
    ...
    @Override
    public Class<DoubleObjectFloatTuple> getNativeType() {
        return DoubleObjectFloatTuple.class;
    }

    @Override
    protected void convertChunks(@NotNull WritableChunk<? super Attributes.Values> destination, int chunkSize, Chunk<Attributes.Values> [] chunks) {
        WritableObjectChunk<DoubleObjectFloatTuple, ? super Attributes.Values> destinationObjectChunk = destination.asWritableObjectChunk();
