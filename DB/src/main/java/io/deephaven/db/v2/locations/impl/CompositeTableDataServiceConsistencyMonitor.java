...
public class CompositeTableDataServiceConsistencyMonitor {
    ...
    public static class ConsistentSupplier<T>
        extends FunctionConsistencyMonitor.ConsistentSupplier<T> {
    ...
    /**
     * Get the consistent value of currentDateNy() as defined by
    ...
    /**
     * The same thing as {@link #currentDateNy()}, but with a different name so you can import it
     * more easily and be sure you are getting the right value.
     */
