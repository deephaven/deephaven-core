...
/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types Byte, Byte, and DBDateTime.
...
public class ReinterpretedBooleanReinterpretedBooleanDateTimeColumnTupleSource extends AbstractTupleSource<ByteByteLongTuple> {
    ...
    public static final ThreeColumnTupleSourceFactory<ByteByteLongTuple, Byte, Byte, DBDateTime> FACTORY = new Factory();
    ...
    protected void convertChunks(@NotNull WritableChunk<? super Attributes.Values> destination, int chunkSize, Chunk<Attributes.Values> [] chunks) {
        ...
        for (int ii = 0; ii < chunkSize; ++ii) {
            destinationObjectChunk.set(ii, new ByteByteLongTuple(chunk1.get(ii), chunk2.get(ii), DBTimeUtils.nanos(chunk3.get(ii))));
        }
    ...
    private static final class Factory implements ThreeColumnTupleSourceFactory<ByteByteLongTuple, Byte, Byte, DBDateTime> {
