...
import io.deephaven.db.util.tuples.generated.CharLongFloatTuple;
...
/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types Character, DBDateTime, and Float.
...
public class CharacterDateTimeFloatColumnTupleSource extends AbstractTupleSource<CharLongFloatTuple> {
    ...
    public static final ThreeColumnTupleSourceFactory<CharLongFloatTuple, Character, DBDateTime, Float> FACTORY = new Factory();
    ...
    @Override
    public Class<CharLongFloatTuple> getNativeType() {
        return CharLongFloatTuple.class;
    }
    ...
    protected void convertChunks(@NotNull WritableChunk<? super Attributes.Values> destination, int chunkSize, Chunk<Attributes.Values> [] chunks) {
        ...
        for (int ii = 0; ii < chunkSize; ++ii) {
            destinationObjectChunk.set(ii, new CharLongFloatTuple(chunk1.get(ii), DBTimeUtils.nanos(chunk2.get(ii)), chunk3.get(ii)));
        }
        destinationObjectChunk.setSize(chunkSize);
    }

    /** {@link ThreeColumnTupleSourceFactory} for instances of {@link CharacterDateTimeFloatColumnTupleSource}. **/
    private static final class Factory implements ThreeColumnTupleSourceFactory<CharLongFloatTuple, Character, DBDateTime, Float> {
