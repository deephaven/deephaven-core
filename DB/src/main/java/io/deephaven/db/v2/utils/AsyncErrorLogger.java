...
public class AsyncErrorLogger {
    ...
    private static final DynamicTableWriter tableWriter = new DynamicTableWriter(
            new String[] { "Time", "EvaluationNumber", "OperationNumber", "Description", "SourceQueryEvaluationNumber", "SourceQueryOperationNumber", "SourceQueryDescription", "Cause", "WorkerName", "HostName" },
            new Class[] { DBDateTime.class, int.class, int.class, String.class, int.class, int.class, String.class, Exception.class, String.class, String.class }
    );
    ...
    private static final RowSetter<Integer> failingEvaluationNumberSetter = tableWriter.getSetter("SourceQueryEvaluationNumber");
    private static final RowSetter<Integer> failingOperationNumberSetter = tableWriter.getSetter("SourceQueryOperationNumber");
    ...
    public static void log(DBDateTime time, UpdatePerformanceTracker.Entry entry, UpdatePerformanceTracker.Entry sourceEntry, Throwable originalException) throws IOException {
        timeSetter.set(time);
        if (entry != null) {
