...
import io.deephaven.db.util.tuples.generated.CharCharIntTuple;
...
public class CharacterCharacterIntegerColumnTupleSource extends AbstractTupleSource<CharCharIntTuple> {
    ...
    @Override
    public final CharCharIntTuple createTuple(final long indexKey) {
    ...
    @Override
    public final CharCharIntTuple createPreviousTuple(final long indexKey) {
        return new CharCharIntTuple(
    ...
    @Override
    public final <ELEMENT_TYPE> void exportElement(@NotNull final CharCharIntTuple tuple, final int elementIndex, @NotNull final WritableSource<ELEMENT_TYPE> writableSource, final long destinationIndexKey) {
        if (elementIndex == 0) {
    ...
    @Override
    public Class<CharCharIntTuple> getNativeType() {
        return CharCharIntTuple.class;
    }

    @Override
    protected void convertChunks(@NotNull WritableChunk<? super Attributes.Values> destination, int chunkSize, Chunk<Attributes.Values> [] chunks) {
        WritableObjectChunk<CharCharIntTuple, ? super Attributes.Values> destinationObjectChunk = destination.asWritableObjectChunk();
