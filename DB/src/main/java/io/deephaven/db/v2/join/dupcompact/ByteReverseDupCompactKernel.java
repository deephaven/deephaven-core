...
public class ByteReverseDupCompactKernel implements DupCompactKernel {
    ...
    private ByteReverseDupCompactKernel() {} // use through the instance
    ...
    private static int compactDuplicates(WritableByteChunk<? extends Any> chunkToCompact, WritableLongChunk<Attributes.KeyIndices> keyIndices) {
