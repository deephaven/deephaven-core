...
/**
 * Adds region factory for deferred column regions implementations. Deferred regions serve as
 * placeholders, constructing (and usually swapping themselves for) the "real" region on first
 * access.
 */
