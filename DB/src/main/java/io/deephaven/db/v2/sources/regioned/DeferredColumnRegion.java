 ...
 */
interface DeferredColumnRegion<ATTR extends Attributes.Any,
        REGION_TYPE extends ColumnRegion<ATTR>> extends ColumnRegion<ATTR> {
    ...
    static <ATTR extends Attributes.Any, REGION_TYPE extends ColumnRegion<ATTR>,
            INNER_REGION_TYPE extends REGION_TYPE> REGION_TYPE materialize(INNER_REGION_TYPE region) {
        //noinspection unchecked
        return region instanceof DeferredColumnRegion ?
                ((DeferredColumnRegion<ATTR, REGION_TYPE>) region).getResultRegion() : region;
    }
}
