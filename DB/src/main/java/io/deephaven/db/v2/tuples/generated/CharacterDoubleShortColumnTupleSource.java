...
import io.deephaven.db.util.tuples.generated.CharDoubleShortTuple;
...
public class CharacterDoubleShortColumnTupleSource extends AbstractTupleSource<CharDoubleShortTuple> {
    ...
    @Override
    public final <ELEMENT_TYPE> void exportElement(@NotNull final CharDoubleShortTuple tuple, final int elementIndex, @NotNull final WritableSource<ELEMENT_TYPE> writableSource, final long destinationIndexKey) {
        if (elementIndex == 0) {
    ...
    @Override
    public Class<CharDoubleShortTuple> getNativeType() {
        return CharDoubleShortTuple.class;
    }
