...
/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types DBDateTime, Object, and Object.
...
public class DateTimeObjectObjectColumnTupleSource extends AbstractTupleSource<LongObjectObjectTuple> {
    ...
    public static final ThreeColumnTupleSourceFactory<LongObjectObjectTuple, DBDateTime, Object, Object> FACTORY = new Factory();
    ...
    @Override
    public Class<LongObjectObjectTuple> getNativeType() {
        return LongObjectObjectTuple.class;
    }
    ...
    protected void convertChunks(@NotNull WritableChunk<? super Attributes.Values> destination, int chunkSize, Chunk<Attributes.Values> [] chunks) {
        ...
        for (int ii = 0; ii < chunkSize; ++ii) {
            destinationObjectChunk.set(ii, new LongObjectObjectTuple(DBTimeUtils.nanos(chunk1.get(ii)), chunk2.get(ii), chunk3.get(ii)));
        }
        destinationObjectChunk.setSize(chunkSize);
    }

    /** {@link ThreeColumnTupleSourceFactory} for instances of {@link DateTimeObjectObjectColumnTupleSource}. **/
    private static final class Factory implements ThreeColumnTupleSourceFactory<LongObjectObjectTuple, DBDateTime, Object, Object> {
