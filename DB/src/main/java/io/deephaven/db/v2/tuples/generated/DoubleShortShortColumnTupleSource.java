...
import io.deephaven.db.util.tuples.generated.DoubleShortShortTuple;
...
public class DoubleShortShortColumnTupleSource extends AbstractTupleSource<DoubleShortShortTuple> {
    ...
    @Override
    public final <ELEMENT_TYPE> void exportElement(@NotNull final DoubleShortShortTuple tuple, final int elementIndex, @NotNull final WritableSource<ELEMENT_TYPE> writableSource, final long destinationIndexKey) {
        if (elementIndex == 0) {
    ...
    @Override
    public Class<DoubleShortShortTuple> getNativeType() {
        return DoubleShortShortTuple.class;
    }
