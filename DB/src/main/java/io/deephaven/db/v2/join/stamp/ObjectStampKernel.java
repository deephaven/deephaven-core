...
public class ObjectStampKernel implements StampKernel {
    ...
    static private void computeRedirections(ObjectChunk<Object, Values> leftStamps, ObjectChunk<Object, Values> rightStamps, LongChunk<KeyIndices> rightKeyIndices, WritableLongChunk<KeyIndices> leftRedirections) {
