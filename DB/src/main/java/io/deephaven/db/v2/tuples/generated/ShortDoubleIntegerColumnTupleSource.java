...
import io.deephaven.db.util.tuples.generated.ShortDoubleIntTuple;
...
/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types Short, Double, and Integer.
...
public class ShortDoubleIntegerColumnTupleSource extends AbstractTupleSource<ShortDoubleIntTuple> {
    ...
    public static final ThreeColumnTupleSourceFactory<ShortDoubleIntTuple, Short, Double, Integer> FACTORY = new Factory();
    ...
    @Override
    public Class<ShortDoubleIntTuple> getNativeType() {
        return ShortDoubleIntTuple.class;
    }
    ...
    private static final class Factory implements ThreeColumnTupleSourceFactory<ShortDoubleIntTuple, Short, Double, Integer> {
