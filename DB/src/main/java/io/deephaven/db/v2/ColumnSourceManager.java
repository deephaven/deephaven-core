...
public interface ColumnSourceManager {
    ...
    /**
     * Get a map of name to {@link DeferredGroupingColumnSource} for the column sources maintained by
     * this manager.
     *
    ...
    /**
     * Turn off column grouping, and clear the groupings on all GROUPING column sources.
     * Note that this does *not* affect PARTITIONING columns.
     */
    ...
    /**
     * Get the added locations, first the ones that have been "included" (found to exist with non-zero size) in order
     * of inclusion, then the remainder in order of discovery.
