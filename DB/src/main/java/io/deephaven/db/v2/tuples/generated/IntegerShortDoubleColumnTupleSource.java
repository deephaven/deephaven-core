...
import io.deephaven.db.util.tuples.generated.IntShortDoubleTuple;
...
public class IntegerShortDoubleColumnTupleSource extends AbstractTupleSource<IntShortDoubleTuple> {
    ...
    @Override
    public final <ELEMENT_TYPE> void exportElement(@NotNull final IntShortDoubleTuple tuple, final int elementIndex, @NotNull final WritableSource<ELEMENT_TYPE> writableSource, final long destinationIndexKey) {
        if (elementIndex == 0) {
    ...
    @Override
    public Class<IntShortDoubleTuple> getNativeType() {
        return IntShortDoubleTuple.class;
    }
