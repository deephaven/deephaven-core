...
/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types Double, DBDateTime, and Object.
...
public class DoubleDateTimeObjectColumnTupleSource extends AbstractTupleSource<DoubleLongObjectTuple> {
    ...
    public static final ThreeColumnTupleSourceFactory<DoubleLongObjectTuple, Double, DBDateTime, Object> FACTORY = new Factory();
    ...
    protected void convertChunks(@NotNull WritableChunk<? super Attributes.Values> destination, int chunkSize, Chunk<Attributes.Values> [] chunks) {
        ...
        for (int ii = 0; ii < chunkSize; ++ii) {
            destinationObjectChunk.set(ii, new DoubleLongObjectTuple(chunk1.get(ii), DBTimeUtils.nanos(chunk2.get(ii)), chunk3.get(ii)));
        }
        destinationObjectChunk.setSize(chunkSize);
    }

    /** {@link ThreeColumnTupleSourceFactory} for instances of {@link DoubleDateTimeObjectColumnTupleSource}. **/
    private static final class Factory implements ThreeColumnTupleSourceFactory<DoubleLongObjectTuple, Double, DBDateTime, Object> {
