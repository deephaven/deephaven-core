...
import io.deephaven.db.util.tuples.generated.CharObjectObjectTuple;
...
public class CharacterObjectObjectColumnTupleSource extends AbstractTupleSource<CharObjectObjectTuple> {
    ...
    @Override
    public final CharObjectObjectTuple createTuple(final long indexKey) {
    ...
    @Override
    public final CharObjectObjectTuple createPreviousTuple(final long indexKey) {
        return new CharObjectObjectTuple(
    ...
    @Override
    public final <ELEMENT_TYPE> void exportElement(@NotNull final CharObjectObjectTuple tuple, final int elementIndex, @NotNull final WritableSource<ELEMENT_TYPE> writableSource, final long destinationIndexKey) {
        if (elementIndex == 0) {
    ...
    @Override
    public Class<CharObjectObjectTuple> getNativeType() {
        return CharObjectObjectTuple.class;
    }

    @Override
    protected void convertChunks(@NotNull WritableChunk<? super Attributes.Values> destination, int chunkSize, Chunk<Attributes.Values> [] chunks) {
        WritableObjectChunk<CharObjectObjectTuple, ? super Attributes.Values> destinationObjectChunk = destination.asWritableObjectChunk();
