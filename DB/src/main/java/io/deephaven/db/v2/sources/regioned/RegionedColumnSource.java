 ...
 * assigning {@link #REGION_INDEX_ADDRESS_BITS some bits} of each index key (element address) to the region index, and
 * the {@link #SUB_REGION_ELEMENT_INDEX_ADDRESS_BITS remaining bits} to the sub-region element index.
 *
 * <p>
