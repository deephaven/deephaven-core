...
public interface TreeIndexImpl {
    ...
    void ixRelease();
    @VisibleForTesting int ixRefCount();
     ...
     */
    static TreeIndexImpl fromChunk(final LongChunk<OrderedKeyIndices> keys, final int offset, final int length, final boolean disposable) {
        if (length == 0) {
            return EMPTY;
        }
    ...
    TreeIndexImpl EMPTY = new TreeIndexImpl() {
        @Override public TreeIndexImpl ixCowRef() { return this; }
        @Override public void ixRelease() { }
        @Override public int ixRefCount() { return 1; }
        @Override public TreeIndexImpl ixInsert(final long key) {
            return SingleRange.make(key, key);
        }
        @Override public TreeIndexImpl ixInsertRange(final long startKey, final long endKey) {
            return SingleRange.make(startKey, endKey);
        }
        @Override public TreeIndexImpl ixInsertSecondHalf(final LongChunk<OrderedKeyIndices> keys, final int offset, final int length) {
            return fromChunk(keys, offset, length, false);
        }
        @Override public TreeIndexImpl ixRemoveSecondHalf(final LongChunk<OrderedKeyIndices> keys, final int offset, final int length) {
            throw new IllegalStateException();
        }
        @Override public TreeIndexImpl ixAppendRange(final long startKey, final long endKey) {
            return ixInsertRange(startKey, endKey);
        }
        @Override public TreeIndexImpl ixRemove(long key) { return this; }
        @Override public long ixLastKey() { return -1; }
        @Override public long ixFirstKey() { return -1; }
        @Override public boolean ixForEachLong(LongAbortableConsumer lc) { return true; }
        @Override public boolean ixForEachLongRange(LongRangeAbortableConsumer larc) { return true; }
        @Override public TreeIndexImpl ixSubindexByPosOnNew(long startPos, long endPos) { return this; }
        @Override public TreeIndexImpl ixSubindexByKeyOnNew(long startKey, long endKey) { return this; }
        @Override public long ixGet(long pos) { return Index.NULL_KEY; }
        @Override public long ixFind(long key) { return Index.NULL_KEY; }
        @Override public void ixGetKeysForPositions(PrimitiveIterator.OfLong inputPositions, LongConsumer outputKeys) {
            while (inputPositions.hasNext()) {
                inputPositions.nextLong();
                outputKeys.accept(Index.NULL_KEY);
            }
        }
        @Override public Index.Iterator ixIterator() { return Index.EMPTY_ITERATOR; }
        @Override public Index.SearchIterator ixSearchIterator() { return Index.EMPTY_ITERATOR; }
        @Override public Index.SearchIterator ixReverseIterator() { return Index.EMPTY_ITERATOR; }
        @Override public Index.RangeIterator ixRangeIterator() { return Index.RangeIterator.empty; }
        @Override public long ixCardinality() { return 0; }
        @Override public boolean ixIsEmpty() { return true; }
        @Override public TreeIndexImpl ixUpdate(TreeIndexImpl added, TreeIndexImpl removed) {
            if (added.ixIsEmpty()) {
                return this;
            }
            return added.ixCowRef();
        }
        @Override public TreeIndexImpl ixRemove(TreeIndexImpl removed) { return this; }
        @Override public TreeIndexImpl ixRemoveRange(long startKey, long endKey) { return this; }
        @Override public TreeIndexImpl ixRetain(TreeIndexImpl toIntersect) { return this; }
        @Override public TreeIndexImpl ixRetainRange(final long start, final long end) { return this; }
        @Override public TreeIndexImpl ixIntersectOnNew(TreeIndexImpl range) { return this; }
        @Override public boolean ixContainsRange(final long start, final long end) { return false; }
        @Override public boolean ixOverlaps(TreeIndexImpl impl) { return false; }
        @Override public boolean ixOverlapsRange(long start, long end) { return false; }
        @Override public boolean ixSubsetOf(TreeIndexImpl impl) { return true; }
        @Override public TreeIndexImpl ixMinusOnNew(TreeIndexImpl set) { return this; }
        @Override public TreeIndexImpl ixUnionOnNew(final TreeIndexImpl set) { return set.ixCowRef(); }
        @Override public TreeIndexImpl ixShiftOnNew(final long shiftAmount) { return this; }
        @Override public TreeIndexImpl ixShiftInPlace(final long shiftAmount) { return this; }
        @Override public TreeIndexImpl ixInsert(final TreeIndexImpl added) { return added.ixCowRef(); }
        @Override public TreeIndexImpl ixInsertWithShift(final long shiftAmount, final TreeIndexImpl other) {
            return other.ixShiftOnNew(shiftAmount);
        }
        @Override public OrderedKeys ixGetOrderedKeysByPosition(long startPositionInclusive, long length) { return OrderedKeys.EMPTY; }
        @Override public OrderedKeys ixGetOrderedKeysByKeyRange(long startKeyInclusive, long endKeyInclusive) { return OrderedKeys.EMPTY; }
        @Override public OrderedKeys.Iterator ixGetOrderedKeysIterator() { return OrderedKeys.Iterator.EMPTY; }
        @Override public long ixRangesCountUpperBound() { return 0; }
        @Override public long ixGetAverageRunLengthEstimate() { return 1; }
        @Override public TreeIndexImpl ixInvertOnNew(TreeIndexImpl keys, long maximumPosition) { return this; }
        @Override public TreeIndexImpl ixCompact() { return this; }
        @Override public void ixValidate(final String failmsg) { }
        @Override public RspBitmap ixToRspOnNew() { return new RspBitmap(); }
