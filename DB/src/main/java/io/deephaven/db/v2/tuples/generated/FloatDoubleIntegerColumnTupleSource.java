...
import io.deephaven.db.util.tuples.generated.FloatDoubleIntTuple;
...
public class FloatDoubleIntegerColumnTupleSource extends AbstractTupleSource<FloatDoubleIntTuple> {
    ...
    @Override
    public final <ELEMENT_TYPE> void exportElement(@NotNull final FloatDoubleIntTuple tuple, final int elementIndex, @NotNull final WritableSource<ELEMENT_TYPE> writableSource, final long destinationIndexKey) {
        if (elementIndex == 0) {
    ...
    @Override
    public Class<FloatDoubleIntTuple> getNativeType() {
        return FloatDoubleIntTuple.class;
    }
