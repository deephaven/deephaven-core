    ...
    // endregion extensions
{
    ...
    int buildFromRightSide(OrderedKeys rightIndex, ColumnSource<?>[] rightSources, @NotNull final LongArraySource addedSlots) {
    ...
    void probeLeft(OrderedKeys leftIndex, ColumnSource<?>[] leftSources)  {
        if (leftIndex.isEmpty()) {
            return;
        }
    ...
    int probeLeft(OrderedKeys leftIndex, ColumnSource<?>[] leftSources, LongArraySource slots, Index.RandomBuilder foundBuilder)  {
        if (leftIndex.isEmpty()) {
            return 0;
        }
        try (final ProbeContext pc = makeProbeContext(leftSources, leftIndex.size())) {
    ...
    void probeRight(OrderedKeys rightIndex, ColumnSource<?>[] rightSources)  {
        if (rightIndex.isEmpty()) {
            return;
        }
