...
import io.deephaven.db.util.tuples.generated.DoubleIntLongTuple;
...
/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types Double, Integer, and DBDateTime.
...
public class DoubleIntegerDateTimeColumnTupleSource extends AbstractTupleSource<DoubleIntLongTuple> {
    ...
    public static final ThreeColumnTupleSourceFactory<DoubleIntLongTuple, Double, Integer, DBDateTime> FACTORY = new Factory();
    ...
    @Override
    public Class<DoubleIntLongTuple> getNativeType() {
        return DoubleIntLongTuple.class;
    }
    ...
    protected void convertChunks(@NotNull WritableChunk<? super Attributes.Values> destination, int chunkSize, Chunk<Attributes.Values> [] chunks) {
        ...
        for (int ii = 0; ii < chunkSize; ++ii) {
            destinationObjectChunk.set(ii, new DoubleIntLongTuple(chunk1.get(ii), chunk2.get(ii), DBTimeUtils.nanos(chunk3.get(ii))));
        }
        destinationObjectChunk.setSize(chunkSize);
    }

    /** {@link ThreeColumnTupleSourceFactory} for instances of {@link DoubleIntegerDateTimeColumnTupleSource}. **/
    private static final class Factory implements ThreeColumnTupleSourceFactory<DoubleIntLongTuple, Double, Integer, DBDateTime> {
