...
import io.deephaven.db.util.tuples.generated.IntFloatObjectTuple;
...
public class IntegerFloatObjectColumnTupleSource extends AbstractTupleSource<IntFloatObjectTuple> {
    ...
    @Override
    public final IntFloatObjectTuple createTuple(final long indexKey) {
    ...
    @Override
    public final IntFloatObjectTuple createPreviousTuple(final long indexKey) {
        return new IntFloatObjectTuple(
    ...
    @Override
    public final <ELEMENT_TYPE> void exportElement(@NotNull final IntFloatObjectTuple tuple, final int elementIndex, @NotNull final WritableSource<ELEMENT_TYPE> writableSource, final long destinationIndexKey) {
        if (elementIndex == 0) {
    ...
    @Override
    public Class<IntFloatObjectTuple> getNativeType() {
        return IntFloatObjectTuple.class;
    }

    @Override
    protected void convertChunks(@NotNull WritableChunk<? super Attributes.Values> destination, int chunkSize, Chunk<Attributes.Values> [] chunks) {
        WritableObjectChunk<IntFloatObjectTuple, ? super Attributes.Values> destinationObjectChunk = destination.asWritableObjectChunk();
