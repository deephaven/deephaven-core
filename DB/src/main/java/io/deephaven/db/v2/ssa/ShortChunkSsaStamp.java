...
public class ShortChunkSsaStamp implements ChunkSsaStamp {
    ...
    private static void processEntry(ShortChunk<Values> leftStampValues, Chunk<KeyIndices> leftStampKeys, ShortSegmentedSortedArray ssa, WritableLongChunk<KeyIndices> rightKeysForLeft, boolean disallowExactMatch) {
