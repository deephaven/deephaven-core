...
import io.deephaven.db.util.tuples.generated.FloatLongShortTuple;
...
/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types Float, DBDateTime, and Short.
...
public class FloatDateTimeShortColumnTupleSource extends AbstractTupleSource<FloatLongShortTuple> {
    ...
    public static final ThreeColumnTupleSourceFactory<FloatLongShortTuple, Float, DBDateTime, Short> FACTORY = new Factory();
    ...
    @Override
    public Class<FloatLongShortTuple> getNativeType() {
        return FloatLongShortTuple.class;
    }
    ...
    protected void convertChunks(@NotNull WritableChunk<? super Attributes.Values> destination, int chunkSize, Chunk<Attributes.Values> [] chunks) {
        ...
        for (int ii = 0; ii < chunkSize; ++ii) {
            destinationObjectChunk.set(ii, new FloatLongShortTuple(chunk1.get(ii), DBTimeUtils.nanos(chunk2.get(ii)), chunk3.get(ii)));
        }
        destinationObjectChunk.setSize(chunkSize);
    }

    /** {@link ThreeColumnTupleSourceFactory} for instances of {@link FloatDateTimeShortColumnTupleSource}. **/
    private static final class Factory implements ThreeColumnTupleSourceFactory<FloatLongShortTuple, Float, DBDateTime, Short> {
