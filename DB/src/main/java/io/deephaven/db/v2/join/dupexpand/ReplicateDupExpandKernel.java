...
public class ReplicateDupExpandKernel {
    public static void main(String[] args) throws IOException {
        ...
        fixupObjectDupCompact(ReplicatePrimitiveCode.charToObject(CharDupExpandKernel.class, ReplicatePrimitiveCode.MAIN_SRC));
    }
    ...
    private static void fixupObjectDupCompact(String objectPath) throws IOException {
        ...
        FileUtils.writeLines(objectFile, ReplicateSortKernel.fixupObjectComparisons(ReplicateUtilities.fixupChunkAttributes(lines)));
    }
}
