...
import io.deephaven.db.util.tuples.generated.CharShortObjectTuple;
...
public class CharacterShortObjectColumnTupleSource extends AbstractTupleSource<CharShortObjectTuple> {
    ...
    @Override
    public final CharShortObjectTuple createTuple(final long indexKey) {
    ...
    @Override
    public final CharShortObjectTuple createPreviousTuple(final long indexKey) {
        return new CharShortObjectTuple(
    ...
    @Override
    public final <ELEMENT_TYPE> void exportElement(@NotNull final CharShortObjectTuple tuple, final int elementIndex, @NotNull final WritableSource<ELEMENT_TYPE> writableSource, final long destinationIndexKey) {
        if (elementIndex == 0) {
    ...
    @Override
    public final Object exportToExternalKey(@NotNull final CharShortObjectTuple tuple) {
        return new SmartKey(
    ...
    @Override
    public Class<CharShortObjectTuple> getNativeType() {
        return CharShortObjectTuple.class;
    }

    @Override
    protected void convertChunks(@NotNull WritableChunk<? super Attributes.Values> destination, int chunkSize, Chunk<Attributes.Values> [] chunks) {
        WritableObjectChunk<CharShortObjectTuple, ? super Attributes.Values> destinationObjectChunk = destination.asWritableObjectChunk();
