...
public class ReplicateSourcesAndChunks {
    ...
    public static void main(String... args) throws IOException {
        ...
        ReplicatePrimitiveCode.charToAllButBooleanAndLong(CharacterArraySource.class,
            ReplicatePrimitiveCode.MAIN_SRC);
        ReplicatePrimitiveCode.charToAllButBoolean(CharAggregateColumnSource.class,
            ReplicatePrimitiveCode.MAIN_SRC);
        ...
        ReplicatePrimitiveCode.charToAllButBoolean(UngroupedBoxedCharArrayColumnSource.class,
            ReplicatePrimitiveCode.MAIN_SRC);
        ReplicatePrimitiveCode.charToAllButBoolean(ImmutableCharArraySource.class,
            ReplicatePrimitiveCode.MAIN_SRC);
    ...
    private static void replicateSingleValues() throws IOException {
        ReplicatePrimitiveCode.charToAllButBoolean(CharacterSingleValueSource.class,
            ReplicatePrimitiveCode.MAIN_SRC);
        replicateObjectSingleValue();
    }

    private static void replicateObjectSingleValue() throws IOException {
        final String className = ReplicatePrimitiveCode
            .charToObject(CharacterSingleValueSource.class, ReplicatePrimitiveCode.MAIN_SRC);
    ...
    private static void replicateChunkColumnSource() throws IOException {
        ReplicatePrimitiveCode.charToAllButBoolean(CharChunkColumnSource.class,
            ReplicatePrimitiveCode.MAIN_SRC);
        replicateObjectChunkColumnSource();
    }

    private static void replicateObjectChunkColumnSource() throws IOException {
        final String className = ReplicatePrimitiveCode.charToObject(CharChunkColumnSource.class,
            ReplicatePrimitiveCode.MAIN_SRC);
        final File classFile = new File(className);
        List<String> lines = FileUtils.readLines(classFile, Charset.defaultCharset());
        lines = globalReplacements(lines,
            ...
            "Object getObject", "T get",
            "Object current", "T current",
            "ObjectChunk<\\? extends Attributes.Values>",
            "ObjectChunk<T, ? extends Attributes.Values>",
    ...
    private static void replicateChunks() throws IOException {
        ReplicatePrimitiveCode.charToAllButBooleanAndByte(CharChunk.class,
            ReplicatePrimitiveCode.MAIN_SRC);
        replicateByteChunks();
    ...
    private static void replicateByteChunks() throws IOException {
        final String className =
            ReplicatePrimitiveCode.charToByte(CharChunk.class, ReplicatePrimitiveCode.MAIN_SRC);
        final File classFile = new File(className);
    ...
    private static void replicateBooleanChunks() throws IOException {
        final String className =
            ReplicatePrimitiveCode.charToBoolean(CharChunk.class, ReplicatePrimitiveCode.MAIN_SRC);
        final File classFile = new File(className);
        List<String> classLines = FileUtils.readLines(classFile, Charset.defaultCharset());
    ...
    private static void replicateObjectChunks() throws IOException {
        final String className =
            ReplicatePrimitiveCode.charToObject(CharChunk.class, ReplicatePrimitiveCode.MAIN_SRC);
        final File classFile = new File(className);
        List<String> lines = FileUtils.readLines(classFile, Charset.defaultCharset());
        lines = globalReplacements(lines,
            "Object\\[\\]", "T[]",
    ...
    private static void replicateObjectChunkChunks() throws IOException {
        final String className = ReplicatePrimitiveCode.charToObject(CharChunkChunk.class,
            ReplicatePrimitiveCode.MAIN_SRC);
        final File classFile = new File(className);
        List<String> lines = FileUtils.readLines(classFile, Charset.defaultCharset());
        lines = globalReplacements(lines,
    ...
    private static void replicateWritableChunks() throws IOException {
        final List<String> files = ReplicatePrimitiveCode
            .charToAllButBoolean(WritableCharChunk.class, ReplicatePrimitiveCode.MAIN_SRC);
    ...
    private static void replicateWritableBooleanChunks() throws IOException {
        final String writableBooleanChunkClassName = ReplicatePrimitiveCode
            .charToBoolean(WritableCharChunk.class, ReplicatePrimitiveCode.MAIN_SRC);
        ...
        writableBooleanChunkClassLines = ReplicateUtilities
            .removeRegion(writableBooleanChunkClassLines, "FillWithNullValueImports");
        writableBooleanChunkClassLines = ReplicateUtilities
            .removeRegion(writableBooleanChunkClassLines, "FillWithNullValueImpl");
        writableBooleanChunkClassLines =
            ReplicateUtilities.removeRegion(writableBooleanChunkClassLines, "sort");
    ...
    private static void replicateWritableObjectChunks() throws IOException {
        final String className = ReplicatePrimitiveCode.charToObject(WritableCharChunk.class,
            ReplicatePrimitiveCode.MAIN_SRC);
        final File classFile = new File(className);
        List<String> lines = FileUtils.readLines(classFile, Charset.defaultCharset());
        lines = globalReplacements(lines,
    ...
    private static void replicateWritableChunkChunks() throws IOException {
        ReplicatePrimitiveCode.charToAllButBoolean(WritableCharChunkChunk.class,
            ReplicatePrimitiveCode.MAIN_SRC);
    ...
    private static void replicateWritableBooleanChunkChunks() throws IOException {
        final String writableBooleanChunkClassName = ReplicatePrimitiveCode
            .charToBoolean(WritableCharChunkChunk.class, ReplicatePrimitiveCode.MAIN_SRC);
        final File writableBooleanChunkClassFile = new File(writableBooleanChunkClassName);
        List<String> writableBooleanChunkClassLines =
            FileUtils.readLines(writableBooleanChunkClassFile, Charset.defaultCharset());
        writableBooleanChunkClassLines =
    ...
    private static void replicateWritableObjectChunkChunks() throws IOException {
        final String className = ReplicatePrimitiveCode.charToObject(WritableCharChunkChunk.class,
            ReplicatePrimitiveCode.MAIN_SRC);
        final File classFile = new File(className);
        List<String> lines = FileUtils.readLines(classFile, Charset.defaultCharset());
        lines = globalReplacements(lines,
    ...
    private static void replicateResettableChunks() throws IOException {
        ReplicatePrimitiveCode.charToAll(ResettableCharChunk.class,
            ReplicatePrimitiveCode.MAIN_SRC);
        replicateResettableObjectChunks();
    }

    private static void replicateResettableObjectChunks() throws IOException {
        final String className = ReplicatePrimitiveCode.charToObject(ResettableCharChunk.class,
            ReplicatePrimitiveCode.MAIN_SRC);
        final File classFile = new File(className);
        List<String> lines = FileUtils.readLines(classFile, Charset.defaultCharset());
        lines = globalReplacements(lines,
    ...
    private static void replicateResettableWritableChunks() throws IOException {
        ReplicatePrimitiveCode.charToAll(ResettableWritableCharChunk.class,
            ReplicatePrimitiveCode.MAIN_SRC);
    ...
    private static void replicateResettableWritableObjectChunks() throws IOException {
        final String className = ReplicatePrimitiveCode
            .charToObject(ResettableWritableCharChunk.class, ReplicatePrimitiveCode.MAIN_SRC);
        final File classFile = new File(className);
        List<String> lines = FileUtils.readLines(classFile, Charset.defaultCharset());
        lines = globalReplacements(lines,
            " <ATTR_BASE", " <T, ATTR_BASE",
    ...
    private static void replicateResettableWritableChunkChunks() throws IOException {
        ReplicatePrimitiveCode.charToAll(ResettableWritableCharChunkChunk.class,
            ReplicatePrimitiveCode.MAIN_SRC);
    ...
    private static void replicateResettableWritableObjectChunkChunks() throws IOException {
        final String className = ReplicatePrimitiveCode
            .charToObject(ResettableWritableCharChunkChunk.class, ReplicatePrimitiveCode.MAIN_SRC);
        final File classFile = new File(className);
        List<String> lines = FileUtils.readLines(classFile, Charset.defaultCharset());
        lines = globalReplacements(lines,
            "<ATTR extends Any>", "<T, ATTR extends Any>",
    ...
    private static void replicateResettableChunkChunks() throws IOException {
        ReplicatePrimitiveCode.charToAll(ResettableCharChunkChunk.class,
            ReplicatePrimitiveCode.MAIN_SRC);
        replicateResettableObjectChunkChunks();
    }

    private static void replicateResettableObjectChunkChunks() throws IOException {
        final String className = ReplicatePrimitiveCode.charToObject(ResettableCharChunkChunk.class,
            ReplicatePrimitiveCode.MAIN_SRC);
        final File classFile = new File(className);
        List<String> lines = FileUtils.readLines(classFile, Charset.defaultCharset());
        lines = globalReplacements(lines,
    ...
    private static void replicateFactories() throws IOException {
        ReplicatePrimitiveCode.charToAllButBoolean(CharChunkFactory.class,
            ReplicatePrimitiveCode.MAIN_SRC);
        final String className = ReplicatePrimitiveCode.charToBoolean(CharChunkFactory.class,
            ReplicatePrimitiveCode.MAIN_SRC);
        final File classFile = new File(className);
        List<String> classLines = FileUtils.readLines(classFile, Charset.defaultCharset());
    ...
    private static void replicateObjectChunkFiller() throws IOException {
        final String className = ReplicatePrimitiveCode.charToObject(CharChunkFiller.class,
            ReplicatePrimitiveCode.MAIN_SRC);
        final File classFile = new File(className);
        List<String> lines = FileUtils.readLines(classFile, Charset.defaultCharset());
        lines = globalReplacements(lines,
    ...
    private static void replicateSparseLongSource() throws IOException {
        ...
        final String longBasePath = ReplicatePrimitiveCode
            .basePathForClass(LongSparseArraySource.class, ReplicatePrimitiveCode.MAIN_SRC);
        ...
        final String longSparseCode =
            FileUtils.readFileToString(longSparseArraySourceFile, Charset.defaultCharset());
        ReplicatePrimitiveCode.charToLong(CharacterSparseArraySource.class,
        ...
        FileUtils.writeStringToFile(longSparseArraySourceFile, longSparseCode,
            Charset.defaultCharset());

        List<String> abstractLines =
            FileUtils.readLines(abstractLongSparseArraySourceFile, Charset.defaultCharset());
        abstractLines = globalReplacements(abstractLines, "LongSparseArraySource",
        ...
        abstractLines = simpleFixup(abstractLines, "getChunk", "LongChunk<Values> getChunk",
    ...
    private static void replicateSparseBooleanSource() throws IOException {
        final String booleanPath =
            ReplicatePrimitiveCode.charToBooleanAsByte(CharacterSparseArraySource.class,
                ReplicatePrimitiveCode.MAIN_SRC, Collections.emptyMap());
        ...
        lines = addImport(lines,
            "import static " + BooleanUtils.class.getCanonicalName() + ".NULL_BOOLEAN_AS_BYTE;\n");
        ...
        lines = simpleFixup(lines, "primitive get", "NULL_BOOLEAN", "NULL_BOOLEAN_AS_BYTE",
            "getBoolean", "getByte", "getPrevBoolean", "getPrevByte");
        ...
        lines = applyFixup(lines, "fillByKeys", "(.*chunk.set\\(.*, )(ctx\\.block.*)(\\);.*)",
            m -> Collections.singletonList(
                m.group(1) + "BooleanUtils.byteAsBoolean(" + m.group(2) + ")" + m.group(3)));
        lines = applyFixup(lines, "fillByUnorderedKeys",
            "(.*byteChunk.set\\(.*, )(block.*)(\\);.*)", m -> Collections.singletonList(
                m.group(1) + "BooleanUtils.byteAsBoolean(" + m.group(2) + ")" + m.group(3)));
        lines =
            applyFixup(lines, "fillFromChunkByKeys", "(.*)(chunk.get\\(.*\\));", m -> Collections
                .singletonList(m.group(1) + "BooleanUtils.booleanAsByte(" + m.group(2) + ");"));
        lines =
            applyFixup(lines, "fillFromChunkUnordered", "(.*)(chunk.get\\(.*\\));", m -> Collections
                .singletonList(m.group(1) + "BooleanUtils.booleanAsByte(" + m.group(2) + ");"));

        lines =
            simpleFixup(lines, "allocateNullFilledBlock", "NULL_BOOLEAN", "NULL_BOOLEAN_AS_BYTE");
        lines = simpleFixup(lines, "boxed methods", "box\\(getBoolean\\(",
            "BooleanUtils.byteAsBoolean(getByte(", "box\\(getPrevBoolean\\(",
            "BooleanUtils.byteAsBoolean(getPrevByte(");
    ...
    private static void replicateSparseObjectSource() throws IOException {
        final String objectPath = ReplicatePrimitiveCode
            .charToObject(CharacterSparseArraySource.class, ReplicatePrimitiveCode.MAIN_SRC);
