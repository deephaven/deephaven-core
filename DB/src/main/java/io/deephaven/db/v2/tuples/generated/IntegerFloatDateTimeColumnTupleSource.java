...
import io.deephaven.db.util.tuples.generated.IntFloatLongTuple;
...
/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types Integer, Float, and DBDateTime.
...
public class IntegerFloatDateTimeColumnTupleSource extends AbstractTupleSource<IntFloatLongTuple> {
    ...
    public static final ThreeColumnTupleSourceFactory<IntFloatLongTuple, Integer, Float, DBDateTime> FACTORY = new Factory();
    ...
    @Override
    public Class<IntFloatLongTuple> getNativeType() {
        return IntFloatLongTuple.class;
    }
    ...
    protected void convertChunks(@NotNull WritableChunk<? super Attributes.Values> destination, int chunkSize, Chunk<Attributes.Values> [] chunks) {
        ...
        for (int ii = 0; ii < chunkSize; ++ii) {
            destinationObjectChunk.set(ii, new IntFloatLongTuple(chunk1.get(ii), chunk2.get(ii), DBTimeUtils.nanos(chunk3.get(ii))));
        }
        destinationObjectChunk.setSize(chunkSize);
    }

    /** {@link ThreeColumnTupleSourceFactory} for instances of {@link IntegerFloatDateTimeColumnTupleSource}. **/
    private static final class Factory implements ThreeColumnTupleSourceFactory<IntFloatLongTuple, Integer, Float, DBDateTime> {
