...
/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types DBDateTime, Byte, and Object.
 * <p>Generated by {@link io.deephaven.db.v2.tuples.TupleSourceCodeGenerator}.
 */
@SuppressWarnings({"unused", "WeakerAccess"})
public class DateTimeByteObjectColumnTupleSource extends AbstractTupleSource<LongByteObjectTuple> {

    /** {@link ThreeColumnTupleSourceFactory} instance to create instances of {@link DateTimeByteObjectColumnTupleSource}. **/
    public static final ThreeColumnTupleSourceFactory<LongByteObjectTuple, DBDateTime, Byte, Object> FACTORY = new Factory();

    private final ColumnSource<DBDateTime> columnSource1;
    private final ColumnSource<Byte> columnSource2;
    private final ColumnSource<Object> columnSource3;

    public DateTimeByteObjectColumnTupleSource(
    ...
    @Override
    public Class<LongByteObjectTuple> getNativeType() {
        return LongByteObjectTuple.class;
    }
    ...
    protected void convertChunks(@NotNull WritableChunk<? super Attributes.Values> destination, int chunkSize, Chunk<Attributes.Values> [] chunks) {
        ...
        for (int ii = 0; ii < chunkSize; ++ii) {
            destinationObjectChunk.set(ii, new LongByteObjectTuple(DBTimeUtils.nanos(chunk1.get(ii)), chunk2.get(ii), chunk3.get(ii)));
        }
        destinationObjectChunk.setSize(chunkSize);
    }

    /** {@link ThreeColumnTupleSourceFactory} for instances of {@link DateTimeByteObjectColumnTupleSource}. **/
    private static final class Factory implements ThreeColumnTupleSourceFactory<LongByteObjectTuple, DBDateTime, Byte, Object> {
        ...
        public TupleSource<LongByteObjectTuple> create(
            ...
            return new DateTimeByteObjectColumnTupleSource(
                    columnSource1,
                    columnSource2,
                    columnSource3
            );
