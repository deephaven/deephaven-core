...
/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types Boolean, DBDateTime, and Double.
...
public class BooleanDateTimeDoubleColumnTupleSource extends AbstractTupleSource<ByteLongDoubleTuple> {
    ...
    public static final ThreeColumnTupleSourceFactory<ByteLongDoubleTuple, Boolean, DBDateTime, Double> FACTORY = new Factory();
    ...
    protected void convertChunks(@NotNull WritableChunk<? super Attributes.Values> destination, int chunkSize, Chunk<Attributes.Values> [] chunks) {
        ...
        for (int ii = 0; ii < chunkSize; ++ii) {
            destinationObjectChunk.set(ii, new ByteLongDoubleTuple(BooleanUtils.booleanAsByte(chunk1.get(ii)), DBTimeUtils.nanos(chunk2.get(ii)), chunk3.get(ii)));
        }
        destinationObjectChunk.setSize(chunkSize);
    }

    /** {@link ThreeColumnTupleSourceFactory} for instances of {@link BooleanDateTimeDoubleColumnTupleSource}. **/
    private static final class Factory implements ThreeColumnTupleSourceFactory<ByteLongDoubleTuple, Boolean, DBDateTime, Double> {
