...
import io.deephaven.db.util.tuples.generated.DoubleCharTuple;
...
public class DoubleCharacterColumnTupleSource extends AbstractTupleSource<DoubleCharTuple> {
    ...
    @Override
    public final <ELEMENT_TYPE> void exportElement(@NotNull final DoubleCharTuple tuple, final int elementIndex, @NotNull final WritableSource<ELEMENT_TYPE> writableSource, final long destinationIndexKey) {
        if (elementIndex == 0) {
    ...
    @Override
    public Class<DoubleCharTuple> getNativeType() { return DoubleCharTuple.class; }
