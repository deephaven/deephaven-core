...
import io.deephaven.db.util.tuples.generated.LongDoubleShortTuple;
...
/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types DBDateTime, Double, and Short.
...
public class DateTimeDoubleShortColumnTupleSource extends AbstractTupleSource<LongDoubleShortTuple> {
    ...
    public static final ThreeColumnTupleSourceFactory<LongDoubleShortTuple, DBDateTime, Double, Short> FACTORY = new Factory();
    ...
    @Override
    public Class<LongDoubleShortTuple> getNativeType() {
        return LongDoubleShortTuple.class;
    }
    ...
    protected void convertChunks(@NotNull WritableChunk<? super Attributes.Values> destination, int chunkSize, Chunk<Attributes.Values> [] chunks) {
        ...
        for (int ii = 0; ii < chunkSize; ++ii) {
            destinationObjectChunk.set(ii, new LongDoubleShortTuple(DBTimeUtils.nanos(chunk1.get(ii)), chunk2.get(ii), chunk3.get(ii)));
        }
        destinationObjectChunk.setSize(chunkSize);
    }

    /** {@link ThreeColumnTupleSourceFactory} for instances of {@link DateTimeDoubleShortColumnTupleSource}. **/
    private static final class Factory implements ThreeColumnTupleSourceFactory<LongDoubleShortTuple, DBDateTime, Double, Short> {
