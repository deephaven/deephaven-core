 ...
 */
public class ComplementRangeIterator implements ReadableIndex.RangeIterator {
    private final ReadableIndex.RangeIterator it;
    private long currStart;
    private long currEnd;
    private long nextStart;
    private long nextEnd;

    public ComplementRangeIterator(ReadableIndex.RangeIterator it) {
        this.it = it;
        currStart = -1;
        currEnd = -1;
        if (!it.hasNext()) {
