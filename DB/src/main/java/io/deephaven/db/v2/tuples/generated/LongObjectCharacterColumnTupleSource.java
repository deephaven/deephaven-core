...
import io.deephaven.db.util.tuples.generated.LongObjectCharTuple;
...
public class LongObjectCharacterColumnTupleSource extends AbstractTupleSource<LongObjectCharTuple> {
    ...
    @Override
    public final <ELEMENT_TYPE> void exportElement(@NotNull final LongObjectCharTuple tuple, final int elementIndex, @NotNull final WritableSource<ELEMENT_TYPE> writableSource, final long destinationIndexKey) {
        if (elementIndex == 0) {
    ...
    @Override
    public Class<LongObjectCharTuple> getNativeType() {
        return LongObjectCharTuple.class;
    }
