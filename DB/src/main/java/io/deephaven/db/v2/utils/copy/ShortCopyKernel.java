...
public class ShortCopyKernel implements CopyKernel {
    public static final ShortCopyKernel INSTANCE = new ShortCopyKernel();

    private ShortCopyKernel() {} // use through the instance
    ...
    public static <T extends Any> void conditionalCopy(
            WritableShortChunk<T> output, short[] baseInput, short[] overInput, long[] useOverInput,
    ...
    public <T extends Any> void conditionalCopy(
            ...
            int srcOffset, int dstOffset, int length)
    {
        short[] typedBaseInput = (short[]) baseInput;
        short[] typedOverInput = (short[]) overInput;
