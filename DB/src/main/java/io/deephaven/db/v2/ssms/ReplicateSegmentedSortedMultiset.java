...
public class ReplicateSegmentedSortedMultiset {
    public static void main(String[] args) throws IOException {
        ...
        insertDbDateTimeExtensions(ReplicatePrimitiveCode
            .charToLong(CharSegmentedSortedMultiset.class, ReplicatePrimitiveCode.MAIN_SRC));

        String objectSsm = ReplicatePrimitiveCode.charToObject(CharSegmentedSortedMultiset.class,
            ReplicatePrimitiveCode.MAIN_SRC);
        ...
        ReplicatePrimitiveCode.charToAllButBoolean(
            io.deephaven.db.v2.by.ssmminmax.CharSetResult.class, ReplicatePrimitiveCode.MAIN_SRC);
        fixupObjectSsm(
            ReplicatePrimitiveCode.charToObject(io.deephaven.db.v2.by.ssmminmax.CharSetResult.class,
                ReplicatePrimitiveCode.MAIN_SRC),
            ReplicateSegmentedSortedMultiset::fixupNulls);

        ReplicatePrimitiveCode.charToAllButBoolean(CharPercentileTypeHelper.class,
            ReplicatePrimitiveCode.MAIN_SRC);
        fixupObjectSsm(ReplicatePrimitiveCode.charToObject(CharPercentileTypeHelper.class,
            ReplicatePrimitiveCode.MAIN_SRC), ReplicateSegmentedSortedMultiset::fixupNulls);

        ReplicatePrimitiveCode.charToIntegers(CharPercentileTypeMedianHelper.class,
            ReplicatePrimitiveCode.MAIN_SRC);
        ReplicatePrimitiveCode.floatToAllFloatingPoints(FloatPercentileTypeMedianHelper.class,
            ReplicatePrimitiveCode.MAIN_SRC);

        ReplicatePrimitiveCode.charToAllButBoolean(CharSsmBackedSource.class,
            ReplicatePrimitiveCode.MAIN_SRC);
        objectSsm = ReplicatePrimitiveCode.charToObject(CharSsmBackedSource.class,
            ReplicatePrimitiveCode.MAIN_SRC);
        ...
        ReplicatePrimitiveCode.charToAllButBoolean(CharChunkedCountDistinctOperator.class,
            ReplicatePrimitiveCode.MAIN_SRC);
        fixupObjectKernelOperator(ReplicatePrimitiveCode.charToObject(
            CharChunkedCountDistinctOperator.class, ReplicatePrimitiveCode.MAIN_SRC), "ssms");

        ReplicatePrimitiveCode.charToAllButBooleanAndLong(CharChunkedDistinctOperator.class,
            ReplicatePrimitiveCode.MAIN_SRC);
        fixupLongKernelOperator(
            ReplicatePrimitiveCode.charToLong(CharChunkedDistinctOperator.class,
                ReplicatePrimitiveCode.MAIN_SRC),
            "    externalResult = new DbDateTimeSsmSourceWrapper(internalResult);");
        fixupObjectKernelOperator(ReplicatePrimitiveCode.charToObject(
            CharChunkedDistinctOperator.class, ReplicatePrimitiveCode.MAIN_SRC), "internalResult");

        ReplicatePrimitiveCode.charToAllButBooleanAndLong(CharChunkedUniqueOperator.class,
            ReplicatePrimitiveCode.MAIN_SRC);
        fixupLongKernelOperator(
            ReplicatePrimitiveCode.charToLong(CharChunkedUniqueOperator.class,
                ReplicatePrimitiveCode.MAIN_SRC),
            "    externalResult = new BoxedColumnSource.OfDateTime(internalResult);");
        fixupObjectKernelOperator(ReplicatePrimitiveCode.charToObject(
            CharChunkedUniqueOperator.class, ReplicatePrimitiveCode.MAIN_SRC), "ssms");

        ReplicatePrimitiveCode.charToAllButBoolean(CharRollupCountDistinctOperator.class,
            ReplicatePrimitiveCode.MAIN_SRC);
        fixupObjectKernelOperator(ReplicatePrimitiveCode.charToObject(
            CharRollupCountDistinctOperator.class, ReplicatePrimitiveCode.MAIN_SRC), "ssms");

        ReplicatePrimitiveCode.charToAllButBooleanAndLong(CharRollupDistinctOperator.class,
            ReplicatePrimitiveCode.MAIN_SRC);
        fixupLongKernelOperator(
            ReplicatePrimitiveCode.charToLong(CharRollupDistinctOperator.class,
                ReplicatePrimitiveCode.MAIN_SRC),
            "    externalResult = new DbDateTimeSsmSourceWrapper(internalResult);");
        fixupObjectKernelOperator(ReplicatePrimitiveCode.charToObject(
            CharRollupDistinctOperator.class, ReplicatePrimitiveCode.MAIN_SRC), "internalResult");

        ReplicatePrimitiveCode.charToAllButBooleanAndLong(CharRollupUniqueOperator.class,
            ReplicatePrimitiveCode.MAIN_SRC);
        fixupLongKernelOperator(
            ReplicatePrimitiveCode.charToLong(CharRollupUniqueOperator.class,
                ReplicatePrimitiveCode.MAIN_SRC),
            "    externalResult = new BoxedColumnSource.OfDateTime(internalResult);");
        fixupObjectKernelOperator(ReplicatePrimitiveCode
            .charToObject(CharRollupUniqueOperator.class, ReplicatePrimitiveCode.MAIN_SRC), "ssms");
    }

    private static void fixupLongKernelOperator(String longPath, String externalResultSetter)
        throws IOException {
        final File longFile = new File(longPath);
        List<String> lines = FileUtils.readLines(longFile, Charset.defaultCharset());
        lines = addImport(lines, BoxedColumnSource.class, DBDateTime.class,
            DbDateTimeSsmSourceWrapper.class);
    ...
    private static void fixupObjectKernelOperator(String objectPath, String ssmVarName)
        throws IOException {
        ...
        lines = replaceRegion(lines, "SsmCreation",
            indent(Collections
                .singletonList("this." + ssmVarName + " = new ObjectSsmBackedSource(type);"), 8));
        lines = replaceRegion(lines, "ResultCreation",
            indent(Collections.singletonList("this.internalResult = new ObjectArraySource(type);"),
                8));
    ...
    private static void fixupObjectSsm(String objectPath,
        Function<List<String>, List<String>>... mutators) throws IOException {
        final File objectFile = new File(objectPath);
        List<String> lines = FileUtils.readLines(objectFile, Charset.defaultCharset());
