...
import io.deephaven.db.util.tuples.generated.LongCharFloatTuple;
...
public class LongCharacterFloatColumnTupleSource extends AbstractTupleSource<LongCharFloatTuple> {

    /** {@link ThreeColumnTupleSourceFactory} instance to create instances of {@link LongCharacterFloatColumnTupleSource}. **/
    ...
    public LongCharacterFloatColumnTupleSource(
    ...
    @Override
    public final <ELEMENT_TYPE> void exportElement(@NotNull final LongCharFloatTuple tuple, final int elementIndex, @NotNull final WritableSource<ELEMENT_TYPE> writableSource, final long destinationIndexKey) {
        if (elementIndex == 0) {
    ...
    /** {@link ThreeColumnTupleSourceFactory} for instances of {@link LongCharacterFloatColumnTupleSource}. **/
    private static final class Factory implements ThreeColumnTupleSourceFactory<LongCharFloatTuple, Long, Character, Float> {
        ...
        public TupleSource<LongCharFloatTuple> create(
            ...
            return new LongCharacterFloatColumnTupleSource(
                    columnSource1,
                    columnSource2,
                    columnSource3
            );
