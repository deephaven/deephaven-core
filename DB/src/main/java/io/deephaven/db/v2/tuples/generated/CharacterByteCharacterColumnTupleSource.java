...
import io.deephaven.db.util.tuples.generated.CharByteCharTuple;
...
/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types Character, Byte, and Character.
...
public class CharacterByteCharacterColumnTupleSource extends AbstractTupleSource<CharByteCharTuple> {
    ...
    public static final ThreeColumnTupleSourceFactory<CharByteCharTuple, Character, Byte, Character> FACTORY = new Factory();
    ...
    @Override
    public final <ELEMENT_TYPE> void exportElement(@NotNull final CharByteCharTuple tuple, final int elementIndex, @NotNull final WritableSource<ELEMENT_TYPE> writableSource, final long destinationIndexKey) {
        if (elementIndex == 0) {
    ...
    @Override
    public Class<CharByteCharTuple> getNativeType() {
        return CharByteCharTuple.class;
    }
    ...
    private static final class Factory implements ThreeColumnTupleSourceFactory<CharByteCharTuple, Character, Byte, Character> {
