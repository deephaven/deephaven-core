...
public abstract class IterativeIndexStateFactory extends ReaggregatableStatefactory {
    ...
    // if we have multiple aggregations, we do not want them to have conflicting column names, so we use an identifier to find them
    ...
    class RedirectionValueColumnSource extends AbstractColumnSource<Long> implements MutableColumnSourceGetDefaults.ForLong {
