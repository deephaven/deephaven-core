...
/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types Integer, DBDateTime, and Double.
...
public class IntegerDateTimeDoubleColumnTupleSource extends AbstractTupleSource<IntLongDoubleTuple> {
    ...
    public static final ThreeColumnTupleSourceFactory<IntLongDoubleTuple, Integer, DBDateTime, Double> FACTORY = new Factory();
    ...
    @Override
    public Class<IntLongDoubleTuple> getNativeType() {
        return IntLongDoubleTuple.class;
    }
    ...
    protected void convertChunks(@NotNull WritableChunk<? super Attributes.Values> destination, int chunkSize, Chunk<Attributes.Values> [] chunks) {
        ...
        for (int ii = 0; ii < chunkSize; ++ii) {
            destinationObjectChunk.set(ii, new IntLongDoubleTuple(chunk1.get(ii), DBTimeUtils.nanos(chunk2.get(ii)), chunk3.get(ii)));
        }
        destinationObjectChunk.setSize(chunkSize);
    }

    /** {@link ThreeColumnTupleSourceFactory} for instances of {@link IntegerDateTimeDoubleColumnTupleSource}. **/
    private static final class Factory implements ThreeColumnTupleSourceFactory<IntLongDoubleTuple, Integer, DBDateTime, Double> {
