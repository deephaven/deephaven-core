...
public final class ShortReverseSegmentedSortedArray implements SegmentedSortedArray {
    ...
    /**
     * Create a ShortReverseSegmentedSortedArray with the given leafSize.
     *
     * @param leafSize the maximumSize for any leaf
     */
    public ShortReverseSegmentedSortedArray(int leafSize) {
     ...
     */
    private <T extends Any> int findNext(ShortChunk<T> stampValues, LongChunk<? extends KeyIndices> stampIndices, WritableShortChunk<T> nextValues) {
    ...
    private static <T extends Any> int findNextOneLeaf(int offset, ShortChunk<T> stampValues, LongChunk<? extends KeyIndices> stampIndices, WritableShortChunk<T> nextValues, int leafSize, short [] leafValues, long [] leafKeys) {
        int lo = 0;
     ...
     */
    void insert(ShortChunk<? extends Any> valuesToInsert, LongChunk<? extends KeyIndices> indicesToInsert) {
    ...
    private void copyToLeaf(int leafOffset, short[] leafValues, ShortChunk<? extends Any> insertValues, long[] leafIndices, LongChunk<? extends KeyIndices> insertIndices) {
        copyToLeaf(leafOffset, leafValues, insertValues, leafIndices, insertIndices, 0, insertIndices.size());
    }

    private void copyToLeaf(int leafOffset, short[] leafValues, ShortChunk<? extends Any> insertValues, long[] leafIndices, LongChunk<? extends KeyIndices> insertIndices, int srcOffset, int length) {
    ...
    private void moveLeafValues(short[] leafValues, long[] leafIndices, int srcPos, int destPos, int length) {
        System.arraycopy(leafValues, srcPos, leafValues, destPos, length);
        System.arraycopy(leafIndices, srcPos, leafIndices, destPos, length);
    }
    ...
    private void distributeValues(int targetSize, int startingLeaf, int distributionSlots, ShortChunk<? extends Any> valuesToInsert, LongChunk<? extends KeyIndices> indices) {
    ...
    private void makeSingletonLeaf(ShortChunk<? extends Any> values, LongChunk<? extends KeyIndices> indices) {
    ...
    private void makeLeavesInitial(ShortChunk<? extends Any> values, LongChunk<? extends KeyIndices> indices) {
    ...
    private void insertIntoLeaf(int leafSize, short [] leafValues, ShortChunk<? extends Any> insertValues, long [] leafIndices, LongChunk<? extends KeyIndices> insertIndices) {
    ...
    private boolean isAfterLeaf(int leafSize, short[] leafValues, ShortChunk<? extends Any> insertValues, long[] leafIndices, LongChunk<? extends KeyIndices> insertIndices) {
    ...
    private void removeFromLeaf(int leafSize, short [] leafValues, ShortChunk<? extends Any> removeValues, long [] leafIndices, LongChunk<? extends KeyIndices> removeIndices, @Nullable WritableLongChunk<? extends KeyIndices> priorRedirections, long firstPriorRedirection) {
    ...
    private static int lowerBound(ShortChunk<? extends Any> valuesToSearch, LongChunk<? extends KeyIndices> indicesToSearch, int lo, int hi, short searchValue, long searchKey) {
        while (lo < hi) {
    ...
    private static int upperBound(ShortChunk<? extends Any> valuesToSearch, LongChunk<? extends KeyIndices> indicesToSearch, int lo, int hi, short searchValue, long searchKey) {
        while (lo < hi) {
            final int mid = (lo + hi) >>> 1;
            final short testValue = valuesToSearch.get(mid);
            final int comparison = doComparison(testValue, searchValue);
    ...
    private static int lowerBound(short [] valuesToSearch, long [] indicesToSearch, int lo, int hi, short searchValue, long searchKey) {
        while (lo < hi) {
            final int mid = (lo + hi) >>> 1;
     ...
     */
    private static int bound(short [] valuesToSearch, long [] indicesToSearch, final short searchValue, long searchIndex, int lo, int hi) {
        while (lo < hi) {
            final int mid = (lo + hi) >>> 1;
            final short testValue = valuesToSearch[mid];
            final int comparison = doComparison(testValue, searchValue);
    ...
    public void remove(Chunk<? extends Any> valuesToRemove, LongChunk<? extends KeyIndices> indicesToRemove) {
        remove(valuesToRemove.asShortChunk(), indicesToRemove);
    }
    ...
    public void removeAndGetPrior(Chunk<? extends Any> stampChunk, LongChunk<? extends KeyIndices> indicesToRemove, WritableLongChunk<? extends KeyIndices> priorRedirections) {
        removeAndGetNextInternal(stampChunk.asShortChunk(), indicesToRemove, priorRedirections);
    }

    private void remove(ShortChunk<? extends Any> valuesToRemove, LongChunk<? extends KeyIndices> indicesToRemove) {
     ...
     */
    private void removeAndGetNextInternal(ShortChunk<? extends Any> valuesToRemove, LongChunk<? extends KeyIndices> indicesToRemove, @Nullable WritableLongChunk<? extends KeyIndices> priorRedirections) {
        validate();
    ...
    private void applyShift(ShortChunk<? extends Any> stampChunk, LongChunk<? extends KeyIndices> keyChunk, long shiftDelta) {
        validate();
    ...
    private void shiftLeaf(int leafSize, short [] leafValues, ShortChunk<? extends Any> shiftValues, long [] leafIndices, LongChunk<? extends KeyIndices> shiftIndices, long shiftDelta) {
        Assert.leq(leafSize, "leafSize", this.leafSize, "this.leafSize");
    ...
    private void applyShiftReverse(ShortChunk<? extends Any> stampChunk, LongChunk<? extends KeyIndices> keyChunk, long shiftDelta) {
        validate();
        final int shiftSize = stampChunk.size();
        if (shiftSize == 0) {
            return;
    ...
    private void shiftLeafReverse(int leafSize, short [] leafValues, ShortChunk<? extends Any> shiftValues, long [] leafIndices, LongChunk<? extends KeyIndices> shiftIndices, long shiftDelta) {
        Assert.leq(leafSize, "leafSize", this.leafSize, "this.leafSize");
        final int shiftSize = shiftValues.size();
    ...
    private static void validateLeaf(short[] values, long[] indices, int size) {
        if (!SEGMENTED_SORTED_ARRAY_VALIDATION) {
            return;
        }
     ...
     */
    ShortChunk<? extends Any> asShortChunk() {
    ...
    final class Iterator {
         ...
         */
        void advanceToLast(short value) {
         ...
         * @param value the value we are searching for
         */
        void advanceToBeforeFirst(short value) {
    ...
    public SsaChecker makeChecker() {
        return ShortReverseSsaChecker.INSTANCE;
    }
}
