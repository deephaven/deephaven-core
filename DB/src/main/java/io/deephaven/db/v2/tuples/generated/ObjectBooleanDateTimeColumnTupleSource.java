...
/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types Object, Boolean, and DBDateTime.
...
public class ObjectBooleanDateTimeColumnTupleSource extends AbstractTupleSource<ObjectByteLongTuple> {
    ...
    public static final ThreeColumnTupleSourceFactory<ObjectByteLongTuple, Object, Boolean, DBDateTime> FACTORY = new Factory();
    ...
    @Override
    public Class<ObjectByteLongTuple> getNativeType() {
        return ObjectByteLongTuple.class;
    }
    ...
    protected void convertChunks(@NotNull WritableChunk<? super Attributes.Values> destination, int chunkSize, Chunk<Attributes.Values> [] chunks) {
        ...
        for (int ii = 0; ii < chunkSize; ++ii) {
            destinationObjectChunk.set(ii, new ObjectByteLongTuple(chunk1.get(ii), BooleanUtils.booleanAsByte(chunk2.get(ii)), DBTimeUtils.nanos(chunk3.get(ii))));
        }
        destinationObjectChunk.setSize(chunkSize);
    }

    /** {@link ThreeColumnTupleSourceFactory} for instances of {@link ObjectBooleanDateTimeColumnTupleSource}. **/
    private static final class Factory implements ThreeColumnTupleSourceFactory<ObjectByteLongTuple, Object, Boolean, DBDateTime> {
