 ...
 * the algorithm.
 */
public class DoubleIntTimsortDescendingKernel {
    private DoubleIntTimsortDescendingKernel() {
        throw new UnsupportedOperationException();
    }

    // region Context
    public static class DoubleIntSortKernelContext<ATTR extends Any, KEY_INDICES extends Keys> implements IntSortKernel<ATTR, KEY_INDICES> {
        int minGallop;
        int runCount = 0;
        ...
        private DoubleIntSortKernelContext(int size) {
        ...
        public void sort(WritableIntChunk<KEY_INDICES> indexKeys, WritableChunk<ATTR> valuesToSort) {
            DoubleIntTimsortDescendingKernel.sort(this, indexKeys, valuesToSort.asWritableDoubleChunk());
        }
        ...
        public void sort(WritableIntChunk<KEY_INDICES> indexKeys, WritableChunk<ATTR> valuesToSort, IntChunk<? extends ChunkPositions> offsetsIn, IntChunk<? extends ChunkLengths> lengthsIn) {
            DoubleIntTimsortDescendingKernel.sort(this, indexKeys, valuesToSort.asWritableDoubleChunk(), offsetsIn, lengthsIn);
        }
    ...
    public static <ATTR extends Any, KEY_INDICES extends Keys> DoubleIntSortKernelContext<ATTR, KEY_INDICES> createContext(int size) {
        return new DoubleIntSortKernelContext<>(size);
    }
     ...
     */
    static <ATTR extends Any, KEY_INDICES extends Keys> void sort(DoubleIntSortKernelContext<ATTR, KEY_INDICES> context, WritableIntChunk<KEY_INDICES> indexKeys, WritableDoubleChunk<ATTR> valuesToSort, IntChunk<? extends ChunkPositions> offsetsIn, IntChunk<? extends ChunkLengths> lengthsIn) {
     ...
     * runs sorted on each pass.
     */
    public static <ATTR extends Any, KEY_INDICES extends Keys> void sort(DoubleIntSortKernelContext<ATTR, KEY_INDICES> context, WritableIntChunk<KEY_INDICES> indexKeys, WritableDoubleChunk<ATTR> valuesToSort) {
        timSort(context, indexKeys, valuesToSort, 0, indexKeys.size());
    }

    static private <ATTR extends Any, KEY_INDICES extends Keys> void timSort(DoubleIntSortKernelContext<ATTR, KEY_INDICES> context, WritableIntChunk<KEY_INDICES> indexKeys, WritableDoubleChunk<ATTR> valuesToSort, int offset, int length) {
        if (length <= 1) {
            return;
        }
     ...
     */
    private static <ATTR extends Any, KEY_INDICES extends Keys> void ensureMergeInvariants(DoubleIntSortKernelContext<ATTR, KEY_INDICES> context, WritableIntChunk<KEY_INDICES> indexKeys, WritableDoubleChunk<ATTR> valuesToSort) {
        while (context.runCount > 1) {
    ...
    private static <ATTR extends Any, KEY_INDICES extends Keys> void merge(DoubleIntSortKernelContext<ATTR, KEY_INDICES> context, WritableIntChunk<KEY_INDICES> indexKeys, WritableDoubleChunk<ATTR> valuesToSort, int start1, int length1, int length2) {
     ...
     */
    private static <ATTR extends Any, KEY_INDICES extends Keys> void frontMerge(DoubleIntSortKernelContext<ATTR, KEY_INDICES> context, WritableIntChunk<KEY_INDICES> indexKeys, WritableDoubleChunk<ATTR> valuesToSort, final int mergeStartPosition, final int start2, final int length2) {
        int tempCursor = 0;
     ...
     * We eventually need to do galloping here, but are skipping that for now
     */
    private static <ATTR extends Any, KEY_INDICES extends Keys> void backMerge(DoubleIntSortKernelContext<ATTR, KEY_INDICES> context, WritableIntChunk<KEY_INDICES> indexKeys, WritableDoubleChunk<ATTR> valuesToSort, final int mergeStartPosition, final int length1) {
    ...
    private static <ATTR extends Any, KEY_INDICES extends Keys> void copyToTemporary(DoubleIntSortKernelContext<ATTR, KEY_INDICES> context, WritableIntChunk<KEY_INDICES> indexKeys, WritableDoubleChunk<ATTR> valuesToSort, int mergeStartPosition, int remaining1) {
    ...
    private static <ATTR extends Any, KEY_INDICES extends Keys> void copyToChunk(IntChunk<KEY_INDICES> indexSource, DoubleChunk<ATTR> valuesSource, WritableIntChunk<KEY_INDICES> indexDest, WritableDoubleChunk<ATTR> valuesDest, int sourceStart, int destStart, int length) {
    ...
    private static void insertionSort(WritableIntChunk<? extends Keys> indexKeys, WritableDoubleChunk<?> valuesToSort, int offset, int length) {
    ...
    static private void swap(WritableIntChunk<? extends Keys> indexKeys, WritableDoubleChunk<?> valuesToSort, int a, int b) {
...
//    private static void doCheck(Chunk.IntChunk indexKeys, Chunk.DoubleChunk valuesToSort, int startCheck, int mergeEnd) {
//        double lastCheck;
