...
public class ByteLongTimsortDescendingKernel {
    ...
    // region Context
    public static class ByteLongSortKernelContext<ATTR extends Any, KEY_INDICES extends Keys> implements LongSortKernel<ATTR, KEY_INDICES> {
        int minGallop;
        int runCount = 0;
    ...
    public static <ATTR extends Any, KEY_INDICES extends Keys> ByteLongSortKernelContext<ATTR, KEY_INDICES> createContext(int size) {
     ...
     */
    static <ATTR extends Any, KEY_INDICES extends Keys> void sort(ByteLongSortKernelContext<ATTR, KEY_INDICES> context, WritableLongChunk<KEY_INDICES> indexKeys, WritableByteChunk<ATTR> valuesToSort, IntChunk<? extends ChunkPositions> offsetsIn, IntChunk<? extends ChunkLengths> lengthsIn) {
     ...
     * runs sorted on each pass.
     */
    public static <ATTR extends Any, KEY_INDICES extends Keys> void sort(ByteLongSortKernelContext<ATTR, KEY_INDICES> context, WritableLongChunk<KEY_INDICES> indexKeys, WritableByteChunk<ATTR> valuesToSort) {
        timSort(context, indexKeys, valuesToSort, 0, indexKeys.size());
    }

    static private <ATTR extends Any, KEY_INDICES extends Keys> void timSort(ByteLongSortKernelContext<ATTR, KEY_INDICES> context, WritableLongChunk<KEY_INDICES> indexKeys, WritableByteChunk<ATTR> valuesToSort, int offset, int length) {
        if (length <= 1) {
            return;
        }
     ...
     */
    private static <ATTR extends Any, KEY_INDICES extends Keys> void ensureMergeInvariants(ByteLongSortKernelContext<ATTR, KEY_INDICES> context, WritableLongChunk<KEY_INDICES> indexKeys, WritableByteChunk<ATTR> valuesToSort) {
        while (context.runCount > 1) {
    ...
    private static <ATTR extends Any, KEY_INDICES extends Keys> void merge(ByteLongSortKernelContext<ATTR, KEY_INDICES> context, WritableLongChunk<KEY_INDICES> indexKeys, WritableByteChunk<ATTR> valuesToSort, int start1, int length1, int length2) {
     ...
     */
    private static <ATTR extends Any, KEY_INDICES extends Keys> void frontMerge(ByteLongSortKernelContext<ATTR, KEY_INDICES> context, WritableLongChunk<KEY_INDICES> indexKeys, WritableByteChunk<ATTR> valuesToSort, final int mergeStartPosition, final int start2, final int length2) {
        int tempCursor = 0;
     ...
     * We eventually need to do galloping here, but are skipping that for now
     */
    private static <ATTR extends Any, KEY_INDICES extends Keys> void backMerge(ByteLongSortKernelContext<ATTR, KEY_INDICES> context, WritableLongChunk<KEY_INDICES> indexKeys, WritableByteChunk<ATTR> valuesToSort, final int mergeStartPosition, final int length1) {
    ...
    private static <ATTR extends Any, KEY_INDICES extends Keys> void copyToTemporary(ByteLongSortKernelContext<ATTR, KEY_INDICES> context, WritableLongChunk<KEY_INDICES> indexKeys, WritableByteChunk<ATTR> valuesToSort, int mergeStartPosition, int remaining1) {
    ...
    private static <ATTR extends Any, KEY_INDICES extends Keys> void copyToChunk(LongChunk<KEY_INDICES> indexSource, ByteChunk<ATTR> valuesSource, WritableLongChunk<KEY_INDICES> indexDest, WritableByteChunk<ATTR> valuesDest, int sourceStart, int destStart, int length) {
    ...
    private static void insertionSort(WritableLongChunk<? extends Keys> indexKeys, WritableByteChunk<?> valuesToSort, int offset, int length) {
    ...
    static private void swap(WritableLongChunk<? extends Keys> indexKeys, WritableByteChunk<?> valuesToSort, int a, int b) {
