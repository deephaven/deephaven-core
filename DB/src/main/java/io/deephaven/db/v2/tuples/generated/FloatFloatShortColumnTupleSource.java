...
import io.deephaven.db.util.tuples.generated.FloatFloatShortTuple;
...
public class FloatFloatShortColumnTupleSource extends AbstractTupleSource<FloatFloatShortTuple> {
    ...
    @Override
    public final <ELEMENT_TYPE> void exportElement(@NotNull final FloatFloatShortTuple tuple, final int elementIndex, @NotNull final WritableSource<ELEMENT_TYPE> writableSource, final long destinationIndexKey) {
        if (elementIndex == 0) {
    ...
    @Override
    public Class<FloatFloatShortTuple> getNativeType() {
        return FloatFloatShortTuple.class;
    }

    @Override
    protected void convertChunks(@NotNull WritableChunk<? super Attributes.Values> destination, int chunkSize, Chunk<Attributes.Values> [] chunks) {
        WritableObjectChunk<FloatFloatShortTuple, ? super Attributes.Values> destinationObjectChunk = destination.asWritableObjectChunk();
