...
import io.deephaven.db.util.tuples.generated.DoubleDoubleDoubleTuple;
...
public class DoubleDoubleDoubleColumnTupleSource extends AbstractTupleSource<DoubleDoubleDoubleTuple> {
    ...
    @Override
    public final DoubleDoubleDoubleTuple createTuple(final long indexKey) {
    ...
    @Override
    public final DoubleDoubleDoubleTuple createPreviousTuple(final long indexKey) {
        return new DoubleDoubleDoubleTuple(
    ...
    @Override
    public final <ELEMENT_TYPE> void exportElement(@NotNull final DoubleDoubleDoubleTuple tuple, final int elementIndex, @NotNull final WritableSource<ELEMENT_TYPE> writableSource, final long destinationIndexKey) {
        if (elementIndex == 0) {
    ...
    @Override
    public Class<DoubleDoubleDoubleTuple> getNativeType() {
        return DoubleDoubleDoubleTuple.class;
    }

    @Override
    protected void convertChunks(@NotNull WritableChunk<? super Attributes.Values> destination, int chunkSize, Chunk<Attributes.Values> [] chunks) {
        WritableObjectChunk<DoubleDoubleDoubleTuple, ? super Attributes.Values> destinationObjectChunk = destination.asWritableObjectChunk();
