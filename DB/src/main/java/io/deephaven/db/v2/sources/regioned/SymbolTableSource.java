...
/**
 * <p>
 * Interface for {@link io.deephaven.db.v2.sources.ColumnSource}s that can provide a {@link Table} view of their symbol
...
public interface SymbolTableSource<SYMBOL_TYPE> extends ColumnSource<SYMBOL_TYPE> {
     ...
     *
     * <p>
     * The result will be refreshing if {@code table} is a refreshing {@link io.deephaven.db.v2.DynamicTable}.
     *
