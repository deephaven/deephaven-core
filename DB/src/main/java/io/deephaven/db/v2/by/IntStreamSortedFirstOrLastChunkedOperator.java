...
/**
 * Chunked aggregation operator for sorted first/last-by using a int sort-column on stream tables.
 */
public class IntStreamSortedFirstOrLastChunkedOperator extends CopyingPermutedStreamFirstOrLastChunkedOperator {
    ...
    IntStreamSortedFirstOrLastChunkedOperator(
    ...
    public void addChunk(final BucketedContext bucketedContext, // Unused
        ...
        for (int ii = 0; ii < startPositions.size(); ++ii) {
            ...
            stateModified.set(ii, addChunk(values.asIntChunk(), inputIndices, startPosition, runLength, destination));
        }
    }
