...
/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types Integer, DBDateTime, and Boolean.
...
public class IntegerDateTimeBooleanColumnTupleSource extends AbstractTupleSource<IntLongByteTuple> {
    ...
    public static final ThreeColumnTupleSourceFactory<IntLongByteTuple, Integer, DBDateTime, Boolean> FACTORY = new Factory();
    ...
    @Override
    public Class<IntLongByteTuple> getNativeType() {
        return IntLongByteTuple.class;
    }
    ...
    protected void convertChunks(@NotNull WritableChunk<? super Attributes.Values> destination, int chunkSize, Chunk<Attributes.Values> [] chunks) {
        ...
        for (int ii = 0; ii < chunkSize; ++ii) {
            destinationObjectChunk.set(ii, new IntLongByteTuple(chunk1.get(ii), DBTimeUtils.nanos(chunk2.get(ii)), BooleanUtils.booleanAsByte(chunk3.get(ii))));
        }
        destinationObjectChunk.setSize(chunkSize);
    }

    /** {@link ThreeColumnTupleSourceFactory} for instances of {@link IntegerDateTimeBooleanColumnTupleSource}. **/
    private static final class Factory implements ThreeColumnTupleSourceFactory<IntLongByteTuple, Integer, DBDateTime, Boolean> {
