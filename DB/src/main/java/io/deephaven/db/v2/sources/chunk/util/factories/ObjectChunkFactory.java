...
import io.deephaven.db.tables.dbarrays.DbArraySlice;
import io.deephaven.db.v2.sources.chunk.*;
import io.deephaven.db.v2.sources.chunk.Attributes.Any;
import io.deephaven.db.v2.sources.chunk.page.ObjectChunkPage;
...
public final class ObjectChunkFactory<T> implements ChunkFactory {
    ...
    @Override
    public final <ATTR extends Any> ObjectChunkPage<T, ATTR> pageWrap(long beginRow, Object array, long mask) {
        //noinspection unchecked
        T[] typedArray = (T[]) array;
        return ObjectChunkPage.pageWrap(beginRow, typedArray, mask);
    }

    @NotNull
    @Override
    public final <ATTR extends Any> ObjectChunkPage<T, ATTR> pageWrap(long beginRow, Object array, int offset, int capacity, long mask) {
        //noinspection unchecked
        T[] typedArray = (T[]) array;
        return ObjectChunkPage.pageWrap(beginRow, typedArray, offset, capacity, mask);
    }
