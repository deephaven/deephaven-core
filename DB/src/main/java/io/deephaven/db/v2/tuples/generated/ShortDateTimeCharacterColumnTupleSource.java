...
/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types Short, DBDateTime, and Character.
...
public class ShortDateTimeCharacterColumnTupleSource extends AbstractTupleSource<ShortLongCharTuple> {
    ...
    public static final ThreeColumnTupleSourceFactory<ShortLongCharTuple, Short, DBDateTime, Character> FACTORY = new Factory();
    ...
    @Override
    public Class<ShortLongCharTuple> getNativeType() {
        return ShortLongCharTuple.class;
    }
    ...
    protected void convertChunks(@NotNull WritableChunk<? super Attributes.Values> destination, int chunkSize, Chunk<Attributes.Values> [] chunks) {
        ...
        for (int ii = 0; ii < chunkSize; ++ii) {
            destinationObjectChunk.set(ii, new ShortLongCharTuple(chunk1.get(ii), DBTimeUtils.nanos(chunk2.get(ii)), chunk3.get(ii)));
        }
        destinationObjectChunk.setSize(chunkSize);
    }

    /** {@link ThreeColumnTupleSourceFactory} for instances of {@link ShortDateTimeCharacterColumnTupleSource}. **/
    private static final class Factory implements ThreeColumnTupleSourceFactory<ShortLongCharTuple, Short, DBDateTime, Character> {
