...
public interface GetContextMaker {
    /**
     * Allocate a new {@link ChunkSource.GetContext} for retrieving chunks from this {@code GetContextMaker},
    ...
    /**
     * Allocate a new {@link ChunkSource.GetContext} for retrieving chunks from this {@code FillContextMaker},
     * typically a {@code ChunkSource} without a {@link SharedContext}.
     *
     * @param chunkCapacity The maximum size required for any {@link WritableChunk} allocated as part of the result.
     * @return A context for use with get operations
     */
