...
/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types DBDateTime, Boolean, and Double.
...
public class DateTimeBooleanDoubleColumnTupleSource extends AbstractTupleSource<LongByteDoubleTuple> {
    ...
    public static final ThreeColumnTupleSourceFactory<LongByteDoubleTuple, DBDateTime, Boolean, Double> FACTORY = new Factory();
    ...
    @Override
    public Class<LongByteDoubleTuple> getNativeType() {
        return LongByteDoubleTuple.class;
    }
    ...
    protected void convertChunks(@NotNull WritableChunk<? super Attributes.Values> destination, int chunkSize, Chunk<Attributes.Values> [] chunks) {
        ...
        for (int ii = 0; ii < chunkSize; ++ii) {
            destinationObjectChunk.set(ii, new LongByteDoubleTuple(DBTimeUtils.nanos(chunk1.get(ii)), BooleanUtils.booleanAsByte(chunk2.get(ii)), chunk3.get(ii)));
        }
        destinationObjectChunk.setSize(chunkSize);
    }

    /** {@link ThreeColumnTupleSourceFactory} for instances of {@link DateTimeBooleanDoubleColumnTupleSource}. **/
    private static final class Factory implements ThreeColumnTupleSourceFactory<LongByteDoubleTuple, DBDateTime, Boolean, Double> {
