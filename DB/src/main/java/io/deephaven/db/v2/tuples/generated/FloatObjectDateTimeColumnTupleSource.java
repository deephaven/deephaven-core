...
/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types Float, Object, and DBDateTime.
...
public class FloatObjectDateTimeColumnTupleSource extends AbstractTupleSource<FloatObjectLongTuple> {
    ...
    public static final ThreeColumnTupleSourceFactory<FloatObjectLongTuple, Float, Object, DBDateTime> FACTORY = new Factory();
    ...
    @Override
    public Class<FloatObjectLongTuple> getNativeType() {
        return FloatObjectLongTuple.class;
    }
    ...
    protected void convertChunks(@NotNull WritableChunk<? super Attributes.Values> destination, int chunkSize, Chunk<Attributes.Values> [] chunks) {
        ...
        for (int ii = 0; ii < chunkSize; ++ii) {
            destinationObjectChunk.set(ii, new FloatObjectLongTuple(chunk1.get(ii), chunk2.get(ii), DBTimeUtils.nanos(chunk3.get(ii))));
        }
        destinationObjectChunk.setSize(chunkSize);
    }

    /** {@link ThreeColumnTupleSourceFactory} for instances of {@link FloatObjectDateTimeColumnTupleSource}. **/
    private static final class Factory implements ThreeColumnTupleSourceFactory<FloatObjectLongTuple, Float, Object, DBDateTime> {
