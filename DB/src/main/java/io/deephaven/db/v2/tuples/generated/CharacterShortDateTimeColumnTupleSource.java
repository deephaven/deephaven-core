...
import io.deephaven.db.util.tuples.generated.CharShortLongTuple;
...
/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types Character, Short, and DBDateTime.
...
public class CharacterShortDateTimeColumnTupleSource extends AbstractTupleSource<CharShortLongTuple> {
    ...
    public static final ThreeColumnTupleSourceFactory<CharShortLongTuple, Character, Short, DBDateTime> FACTORY = new Factory();
    ...
    protected void convertChunks(@NotNull WritableChunk<? super Attributes.Values> destination, int chunkSize, Chunk<Attributes.Values> [] chunks) {
        ...
        for (int ii = 0; ii < chunkSize; ++ii) {
            destinationObjectChunk.set(ii, new CharShortLongTuple(chunk1.get(ii), chunk2.get(ii), DBTimeUtils.nanos(chunk3.get(ii))));
        }
        destinationObjectChunk.setSize(chunkSize);
    }

    /** {@link ThreeColumnTupleSourceFactory} for instances of {@link CharacterShortDateTimeColumnTupleSource}. **/
    private static final class Factory implements ThreeColumnTupleSourceFactory<CharShortLongTuple, Character, Short, DBDateTime> {
