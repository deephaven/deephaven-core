...
/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types Integer and DBDateTime.
...
public class IntegerDateTimeColumnTupleSource extends AbstractTupleSource<IntLongTuple> {
    ...
    public static final TwoColumnTupleSourceFactory<IntLongTuple, Integer, DBDateTime> FACTORY = new Factory();
    ...
    protected void convertChunks(@NotNull WritableChunk<? super Attributes.Values> destination, int chunkSize, Chunk<Attributes.Values> [] chunks) {
        ...
        for (int ii = 0; ii < chunkSize; ++ii) {
            destinationObjectChunk.set(ii, new IntLongTuple(chunk1.get(ii), DBTimeUtils.nanos(chunk2.get(ii))));
        }
        destination.setSize(chunkSize);
    }

    /** {@link TwoColumnTupleSourceFactory} for instances of {@link IntegerDateTimeColumnTupleSource}. **/
    private static final class Factory implements TwoColumnTupleSourceFactory<IntLongTuple, Integer, DBDateTime> {
