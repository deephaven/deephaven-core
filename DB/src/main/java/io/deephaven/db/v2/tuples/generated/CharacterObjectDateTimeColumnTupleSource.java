...
import io.deephaven.db.util.tuples.generated.CharObjectLongTuple;
...
/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types Character, Object, and DBDateTime.
...
public class CharacterObjectDateTimeColumnTupleSource extends AbstractTupleSource<CharObjectLongTuple> {
    ...
    public static final ThreeColumnTupleSourceFactory<CharObjectLongTuple, Character, Object, DBDateTime> FACTORY = new Factory();
    ...
    @Override
    public Class<CharObjectLongTuple> getNativeType() {
        return CharObjectLongTuple.class;
    }
    ...
    protected void convertChunks(@NotNull WritableChunk<? super Attributes.Values> destination, int chunkSize, Chunk<Attributes.Values> [] chunks) {
        ...
        for (int ii = 0; ii < chunkSize; ++ii) {
            destinationObjectChunk.set(ii, new CharObjectLongTuple(chunk1.get(ii), chunk2.get(ii), DBTimeUtils.nanos(chunk3.get(ii))));
        }
        destinationObjectChunk.setSize(chunkSize);
    }

    /** {@link ThreeColumnTupleSourceFactory} for instances of {@link CharacterObjectDateTimeColumnTupleSource}. **/
    private static final class Factory implements ThreeColumnTupleSourceFactory<CharObjectLongTuple, Character, Object, DBDateTime> {
