...
import io.deephaven.db.util.tuples.generated.DoubleCharShortTuple;
...
public class DoubleCharacterShortColumnTupleSource extends AbstractTupleSource<DoubleCharShortTuple> {
    ...
    @Override
    public final <ELEMENT_TYPE> void exportElement(@NotNull final DoubleCharShortTuple tuple, final int elementIndex, @NotNull final WritableSource<ELEMENT_TYPE> writableSource, final long destinationIndexKey) {
        if (elementIndex == 0) {
    ...
    @Override
    public Class<DoubleCharShortTuple> getNativeType() {
        return DoubleCharShortTuple.class;
    }
