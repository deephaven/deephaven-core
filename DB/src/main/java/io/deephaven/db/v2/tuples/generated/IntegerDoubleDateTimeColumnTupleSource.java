...
/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types Integer, Double, and DBDateTime.
...
public class IntegerDoubleDateTimeColumnTupleSource extends AbstractTupleSource<IntDoubleLongTuple> {
    ...
    public static final ThreeColumnTupleSourceFactory<IntDoubleLongTuple, Integer, Double, DBDateTime> FACTORY = new Factory();
    ...
    @Override
    public Class<IntDoubleLongTuple> getNativeType() {
        return IntDoubleLongTuple.class;
    }
    ...
    protected void convertChunks(@NotNull WritableChunk<? super Attributes.Values> destination, int chunkSize, Chunk<Attributes.Values> [] chunks) {
        ...
        for (int ii = 0; ii < chunkSize; ++ii) {
            destinationObjectChunk.set(ii, new IntDoubleLongTuple(chunk1.get(ii), chunk2.get(ii), DBTimeUtils.nanos(chunk3.get(ii))));
        }
        destinationObjectChunk.setSize(chunkSize);
    }

    /** {@link ThreeColumnTupleSourceFactory} for instances of {@link IntegerDoubleDateTimeColumnTupleSource}. **/
    private static final class Factory implements ThreeColumnTupleSourceFactory<IntDoubleLongTuple, Integer, Double, DBDateTime> {
