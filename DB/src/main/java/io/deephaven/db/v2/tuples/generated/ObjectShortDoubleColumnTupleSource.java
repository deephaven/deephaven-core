...
import io.deephaven.db.util.tuples.generated.ObjectShortDoubleTuple;
...
public class ObjectShortDoubleColumnTupleSource extends AbstractTupleSource<ObjectShortDoubleTuple> {
    ...
    @Override
    public final ObjectShortDoubleTuple createTuple(final long indexKey) {
    ...
    @Override
    public final ObjectShortDoubleTuple createPreviousTuple(final long indexKey) {
        return new ObjectShortDoubleTuple(
    ...
    @Override
    public final <ELEMENT_TYPE> void exportElement(@NotNull final ObjectShortDoubleTuple tuple, final int elementIndex, @NotNull final WritableSource<ELEMENT_TYPE> writableSource, final long destinationIndexKey) {
        if (elementIndex == 0) {
    ...
    @Override
    public final Object exportToExternalKey(@NotNull final ObjectShortDoubleTuple tuple) {
        return new SmartKey(
    ...
    @Override
    public Class<ObjectShortDoubleTuple> getNativeType() {
        return ObjectShortDoubleTuple.class;
    }

    @Override
    protected void convertChunks(@NotNull WritableChunk<? super Attributes.Values> destination, int chunkSize, Chunk<Attributes.Values> [] chunks) {
        WritableObjectChunk<ObjectShortDoubleTuple, ? super Attributes.Values> destinationObjectChunk = destination.asWritableObjectChunk();
