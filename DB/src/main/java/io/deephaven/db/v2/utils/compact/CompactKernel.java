...
public interface CompactKernel {
    /**
     * Compacts values into the front of the chunk, retaining only values where the parallel
     * retainValues chunk has a true value.
     *
     * @param values a chunk of values, input and output
     * @param retainValues the values to retain
     */
    void compact(WritableChunk<? extends Attributes.Any> values,
        BooleanChunk<Attributes.Any> retainValues);

    /**
     * Sort valuesChunk, eliminate duplicates, and write the number of times a value occurred into
     ...
     * @param counts an output chunk parallel to valueChunk with the number of times a value
     *        occurred
     */
    ...
    /**
     * For each run in valuesChunk, sort it, eliminate duplicates, and write the number of times a
     * value occurred into the parallel slot within counts. null values are removed from the chunk.
     *
     * @param valueChunk a chunk of values, input and output
     * @param counts an output chunk parallel to valueChunk with the number of times a value
     *        occurred
    ...
    /**
     * For each run in valuesChunk, sort it, eliminate duplicates, and write the number of times a
     * value occurred into the parallel slot within counts.
     *
     * @param valueChunk a chunk of values, input and output
     * @param counts an output chunk parallel to valueChunk with the number of times a value
     *        occurred
