...
import io.deephaven.db.util.tuples.generated.IntShortIntTuple;
...
public class IntegerShortIntegerColumnTupleSource extends AbstractTupleSource<IntShortIntTuple> {
    ...
    @Override
    public final IntShortIntTuple createTuple(final long indexKey) {
    ...
    @Override
    public final IntShortIntTuple createPreviousTuple(final long indexKey) {
        return new IntShortIntTuple(
    ...
    @Override
    public final <ELEMENT_TYPE> void exportElement(@NotNull final IntShortIntTuple tuple, final int elementIndex, @NotNull final WritableSource<ELEMENT_TYPE> writableSource, final long destinationIndexKey) {
        if (elementIndex == 0) {
    ...
    @Override
    public Class<IntShortIntTuple> getNativeType() {
        return IntShortIntTuple.class;
    }

    @Override
    protected void convertChunks(@NotNull WritableChunk<? super Attributes.Values> destination, int chunkSize, Chunk<Attributes.Values> [] chunks) {
        WritableObjectChunk<IntShortIntTuple, ? super Attributes.Values> destinationObjectChunk = destination.asWritableObjectChunk();
