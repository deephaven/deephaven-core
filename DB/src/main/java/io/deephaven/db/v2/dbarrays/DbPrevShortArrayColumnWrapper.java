...
public class DbPrevShortArrayColumnWrapper extends DbShortArray.Indirect {
    ...
    public DbPrevShortArrayColumnWrapper(@NotNull final ColumnSource<Short> columnSource, @NotNull final Index index) {
    ...
    private DbPrevShortArrayColumnWrapper(@NotNull final ColumnSource<Short> columnSource, @NotNull final Index index,
    ...
    public DbShortArray subArray(long fromIndex, long toIndex) {
        ...
        return new DbPrevShortArrayColumnWrapper(columnSource, index.subindexByPos(realFrom, realTo), newStartPadding, newEndPadding, true);
    }
    ...
    public DbShortArray subArrayByPositions(long[] positions) {
        ...
        return new DbPrevShortArrayColumnWrapper(columnSource, builder.getIndex(), 0, 0);
    }
