...
public final class NullAwareCharSegmentedSortedArray implements SegmentedSortedArray {
     ...
     */
    private <T extends Any> int findNext(CharChunk<T> stampValues, LongChunk<? extends KeyIndices> stampIndices, WritableCharChunk<T> nextValues) {
    ...
    private static <T extends Any> int findNextOneLeaf(int offset, CharChunk<T> stampValues, LongChunk<? extends KeyIndices> stampIndices, WritableCharChunk<T> nextValues, int leafSize, char [] leafValues, long [] leafKeys) {
        int lo = 0;
     ...
     */
    void insert(CharChunk<? extends Any> valuesToInsert, LongChunk<? extends KeyIndices> indicesToInsert) {
    ...
    private void copyToLeaf(int leafOffset, char[] leafValues, CharChunk<? extends Any> insertValues, long[] leafIndices, LongChunk<? extends KeyIndices> insertIndices) {
        copyToLeaf(leafOffset, leafValues, insertValues, leafIndices, insertIndices, 0, insertIndices.size());
    }

    private void copyToLeaf(int leafOffset, char[] leafValues, CharChunk<? extends Any> insertValues, long[] leafIndices, LongChunk<? extends KeyIndices> insertIndices, int srcOffset, int length) {
    ...
    private void distributeValues(int targetSize, int startingLeaf, int distributionSlots, CharChunk<? extends Any> valuesToInsert, LongChunk<? extends KeyIndices> indices) {
    ...
    private void makeSingletonLeaf(CharChunk<? extends Any> values, LongChunk<? extends KeyIndices> indices) {
    ...
    private void makeLeavesInitial(CharChunk<? extends Any> values, LongChunk<? extends KeyIndices> indices) {
    ...
    private void insertIntoLeaf(int leafSize, char [] leafValues, CharChunk<? extends Any> insertValues, long [] leafIndices, LongChunk<? extends KeyIndices> insertIndices) {
    ...
    private boolean isAfterLeaf(int leafSize, char[] leafValues, CharChunk<? extends Any> insertValues, long[] leafIndices, LongChunk<? extends KeyIndices> insertIndices) {
    ...
    private void removeFromLeaf(int leafSize, char [] leafValues, CharChunk<? extends Any> removeValues, long [] leafIndices, LongChunk<? extends KeyIndices> removeIndices, @Nullable WritableLongChunk<? extends KeyIndices> priorRedirections, long firstPriorRedirection) {
    ...
    private static int lowerBound(CharChunk<? extends Any> valuesToSearch, LongChunk<? extends KeyIndices> indicesToSearch, int lo, int hi, char searchValue, long searchKey) {
        while (lo < hi) {
    ...
    private static int upperBound(CharChunk<? extends Any> valuesToSearch, LongChunk<? extends KeyIndices> indicesToSearch, int lo, int hi, char searchValue, long searchKey) {
        while (lo < hi) {
            final int mid = (lo + hi) >>> 1;
            final char testValue = valuesToSearch.get(mid);
            final int comparison = doComparison(testValue, searchValue);
    ...
    private void remove(CharChunk<? extends Any> valuesToRemove, LongChunk<? extends KeyIndices> indicesToRemove) {
     ...
     */
    private void removeAndGetNextInternal(CharChunk<? extends Any> valuesToRemove, LongChunk<? extends KeyIndices> indicesToRemove, @Nullable WritableLongChunk<? extends KeyIndices> priorRedirections) {
        validate();
    ...
    private void applyShift(CharChunk<? extends Any> stampChunk, LongChunk<? extends KeyIndices> keyChunk, long shiftDelta) {
        validate();
    ...
    private void shiftLeaf(int leafSize, char [] leafValues, CharChunk<? extends Any> shiftValues, long [] leafIndices, LongChunk<? extends KeyIndices> shiftIndices, long shiftDelta) {
        Assert.leq(leafSize, "leafSize", this.leafSize, "this.leafSize");
    ...
    private void applyShiftReverse(CharChunk<? extends Any> stampChunk, LongChunk<? extends KeyIndices> keyChunk, long shiftDelta) {
        validate();
        final int shiftSize = stampChunk.size();
        if (shiftSize == 0) {
            return;
    ...
    private void shiftLeafReverse(int leafSize, char [] leafValues, CharChunk<? extends Any> shiftValues, long [] leafIndices, LongChunk<? extends KeyIndices> shiftIndices, long shiftDelta) {
        Assert.leq(leafSize, "leafSize", this.leafSize, "this.leafSize");
        final int shiftSize = shiftValues.size();
