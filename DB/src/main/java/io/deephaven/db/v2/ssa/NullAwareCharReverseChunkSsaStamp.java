...
public class NullAwareCharReverseChunkSsaStamp implements ChunkSsaStamp {
    ...
    private static void processEntry(CharChunk<Values> leftStampValues, Chunk<KeyIndices> leftStampKeys, NullAwareCharReverseSegmentedSortedArray ssa, WritableLongChunk<KeyIndices> rightKeysForLeft, boolean disallowExactMatch) {
