...
public final class ParquetTableLocationKey extends FileTableLocationKey {
     ...
     */
    public ParquetTableLocationKey(@NotNull final File file, final int order, @Nullable final Map<String, Comparable<?>> partitions) {
     ...
     * Always clears cached {@link ParquetMetadata} and {@link RowGroup} indices.
     *
    ...
    /**
     * Get previously-{@link #setRowGroupIndices(int[]) set} or on-demand created
     * {@link RowGroup} indices for this location key's current {@link ParquetFileReader}.
     *
