...
public class JavaKernelBuilder {
    ...
    public static Result create(String cookedFormulaString, Class returnedType,
        ...
        final JavaKernelBuilder jkf =
            new JavaKernelBuilder(cookedFormulaString, returnedType, timeInstanceVariables,
    ...
    private JavaKernelBuilder(String cookedFormulaString, Class returnedType,
        String timeInstanceVariables,
        Map<String, RichType> columns, Map<String, Class> arrays, Map<String, Class> params) {
    ...
    private String generateKernelClassBody() {
        ...
        final CodeGenerator g = CodeGenerator.create(
            ...
            "public class $CLASSNAME$ implements [[FORMULA_KERNEL_INTERFACE_CANONICAL]]",
            CodeGenerator.block(
    ...
    private CodeGenerator generateFactoryLambda() {
        ...
        g.replace("FORMULA_KERNEL_FACTORY_CANONICAL",
            FormulaKernelFactory.class.getCanonicalName());
    ...
    private CodeGenerator generateKernelConstructor() {
        final CodeGenerator g = CodeGenerator.create(
            ...
            CodeGenerator.block(
                ...
                CodeGenerator.repeated("getParam",
                    "[[NAME]] = ([[TYPE]])__params[[[INDEX]]].getValue();")));
    ...
    private CodeGenerator generateApplyFormulaChunk(TypeAnalyzer ta) {
        final CodeGenerator g = CodeGenerator.create(
            "@Override",
            "public void applyFormulaChunk([[CANONICAL_FORMULA_FILLCONTEXT]] __context,",
    ...
    private CodeGenerator generateApplyFormulaPerItem(final TypeAnalyzer ta) {
        ...
        final String joinedFormulaString =
            CompilerTools.createEscapedJoinedString(cookedFormulaString);
    ...
    private <T> List<T> visitFormulaParameters(
        ...
        if (chunkLambda != null) {
            for (Map.Entry<String, RichType> entry : columns.entrySet()) {
                ...
                final ChunkParameter cp =
                    new ChunkParameter(name, rt.getBareType(), rt.getCanonicalName());
        ...
        if (columnArrayLambda != null) {
            for (Map.Entry<String, Class> entry : arrays.entrySet()) {
                ...
                final ColumnArrayParameter cap =
                    new ColumnArrayParameter(name, dbArrayType, dbArrayTypeAsString);
    ...
    private static Class compileFormula(final String what, final String classBody,
        final String className) {
        // System.out.printf("compileFormula: formulaString is %s. Code is...%n%s%n", what,
        // classBody);
        try (final QueryPerformanceNugget nugget =
            ...
            return AccessController
                .doPrivileged((PrivilegedExceptionAction<Class>) () -> CompilerTools
