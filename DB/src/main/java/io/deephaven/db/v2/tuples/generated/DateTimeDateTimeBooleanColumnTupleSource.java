...
/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types DBDateTime, DBDateTime, and Boolean.
...
public class DateTimeDateTimeBooleanColumnTupleSource extends AbstractTupleSource<LongLongByteTuple> {
    ...
    public static final ThreeColumnTupleSourceFactory<LongLongByteTuple, DBDateTime, DBDateTime, Boolean> FACTORY = new Factory();
    ...
    protected void convertChunks(@NotNull WritableChunk<? super Attributes.Values> destination, int chunkSize, Chunk<Attributes.Values> [] chunks) {
        ...
        for (int ii = 0; ii < chunkSize; ++ii) {
            destinationObjectChunk.set(ii, new LongLongByteTuple(DBTimeUtils.nanos(chunk1.get(ii)), DBTimeUtils.nanos(chunk2.get(ii)), BooleanUtils.booleanAsByte(chunk3.get(ii))));
        }
        destinationObjectChunk.setSize(chunkSize);
    }

    /** {@link ThreeColumnTupleSourceFactory} for instances of {@link DateTimeDateTimeBooleanColumnTupleSource}. **/
    private static final class Factory implements ThreeColumnTupleSourceFactory<LongLongByteTuple, DBDateTime, DBDateTime, Boolean> {
