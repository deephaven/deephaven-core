...
import io.deephaven.db.util.tuples.generated.ShortDoubleDoubleTuple;
...
public class ShortDoubleDoubleColumnTupleSource extends AbstractTupleSource<ShortDoubleDoubleTuple> {
    ...
    @Override
    public final ShortDoubleDoubleTuple createTuple(final long indexKey) {
    ...
    @Override
    public final ShortDoubleDoubleTuple createPreviousTuple(final long indexKey) {
        return new ShortDoubleDoubleTuple(
    ...
    @Override
    public final <ELEMENT_TYPE> void exportElement(@NotNull final ShortDoubleDoubleTuple tuple, final int elementIndex, @NotNull final WritableSource<ELEMENT_TYPE> writableSource, final long destinationIndexKey) {
        if (elementIndex == 0) {
    ...
    @Override
    public final Object exportToExternalKey(@NotNull final ShortDoubleDoubleTuple tuple) {
        return new SmartKey(
    ...
    @Override
    public Class<ShortDoubleDoubleTuple> getNativeType() {
        return ShortDoubleDoubleTuple.class;
    }

    @Override
    protected void convertChunks(@NotNull WritableChunk<? super Attributes.Values> destination, int chunkSize, Chunk<Attributes.Values> [] chunks) {
        WritableObjectChunk<ShortDoubleDoubleTuple, ? super Attributes.Values> destinationObjectChunk = destination.asWritableObjectChunk();
