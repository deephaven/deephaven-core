...
import io.deephaven.db.util.tuples.generated.ByteCharShortTuple;
...
public class ReinterpretedBooleanCharacterShortColumnTupleSource extends AbstractTupleSource<ByteCharShortTuple> {
    ...
    @Override
    public final <ELEMENT_TYPE> void exportElement(@NotNull final ByteCharShortTuple tuple, final int elementIndex, @NotNull final WritableSource<ELEMENT_TYPE> writableSource, final long destinationIndexKey) {
        if (elementIndex == 0) {
    ...
    @Override
    public Class<ByteCharShortTuple> getNativeType() {
        return ByteCharShortTuple.class;
    }
