...
public final class ObjectSegmentedSortedArray implements SegmentedSortedArray {
     ...
     */
    private <T extends Any> int findNext(ObjectChunk<Object, T> stampValues, LongChunk<? extends KeyIndices> stampIndices, WritableObjectChunk<Object, T> nextValues) {
    ...
    private static <T extends Any> int findNextOneLeaf(int offset, ObjectChunk<Object, T> stampValues, LongChunk<? extends KeyIndices> stampIndices, WritableObjectChunk<Object, T> nextValues, int leafSize, Object [] leafValues, long [] leafKeys) {
        int lo = 0;
     ...
     */
    void insert(ObjectChunk<Object, ? extends Any> valuesToInsert, LongChunk<? extends KeyIndices> indicesToInsert) {
    ...
    private void copyToLeaf(int leafOffset, Object[] leafValues, ObjectChunk<Object, ? extends Any> insertValues, long[] leafIndices, LongChunk<? extends KeyIndices> insertIndices) {
        copyToLeaf(leafOffset, leafValues, insertValues, leafIndices, insertIndices, 0, insertIndices.size());
    }

    private void copyToLeaf(int leafOffset, Object[] leafValues, ObjectChunk<Object, ? extends Any> insertValues, long[] leafIndices, LongChunk<? extends KeyIndices> insertIndices, int srcOffset, int length) {
    ...
    private void distributeValues(int targetSize, int startingLeaf, int distributionSlots, ObjectChunk<Object, ? extends Any> valuesToInsert, LongChunk<? extends KeyIndices> indices) {
    ...
    private void makeSingletonLeaf(ObjectChunk<Object, ? extends Any> values, LongChunk<? extends KeyIndices> indices) {
    ...
    private void makeLeavesInitial(ObjectChunk<Object, ? extends Any> values, LongChunk<? extends KeyIndices> indices) {
    ...
    private void insertIntoLeaf(int leafSize, Object [] leafValues, ObjectChunk<Object, ? extends Any> insertValues, long [] leafIndices, LongChunk<? extends KeyIndices> insertIndices) {
    ...
    private boolean isAfterLeaf(int leafSize, Object[] leafValues, ObjectChunk<Object, ? extends Any> insertValues, long[] leafIndices, LongChunk<? extends KeyIndices> insertIndices) {
    ...
    private void removeFromLeaf(int leafSize, Object [] leafValues, ObjectChunk<Object, ? extends Any> removeValues, long [] leafIndices, LongChunk<? extends KeyIndices> removeIndices, @Nullable WritableLongChunk<? extends KeyIndices> priorRedirections, long firstPriorRedirection) {
    ...
    private static int lowerBound(ObjectChunk<Object, ? extends Any> valuesToSearch, LongChunk<? extends KeyIndices> indicesToSearch, int lo, int hi, Object searchValue, long searchKey) {
        while (lo < hi) {
    ...
    private static int upperBound(ObjectChunk<Object, ? extends Any> valuesToSearch, LongChunk<? extends KeyIndices> indicesToSearch, int lo, int hi, Object searchValue, long searchKey) {
        while (lo < hi) {
            final int mid = (lo + hi) >>> 1;
            final Object testValue = valuesToSearch.get(mid);
            final int comparison = doComparison(testValue, searchValue);
    ...
    private void remove(ObjectChunk<Object, ? extends Any> valuesToRemove, LongChunk<? extends KeyIndices> indicesToRemove) {
     ...
     */
    private void removeAndGetNextInternal(ObjectChunk<Object, ? extends Any> valuesToRemove, LongChunk<? extends KeyIndices> indicesToRemove, @Nullable WritableLongChunk<? extends KeyIndices> priorRedirections) {
        validate();
    ...
    private void applyShift(ObjectChunk<Object, ? extends Any> stampChunk, LongChunk<? extends KeyIndices> keyChunk, long shiftDelta) {
        validate();
    ...
    private void shiftLeaf(int leafSize, Object [] leafValues, ObjectChunk<Object, ? extends Any> shiftValues, long [] leafIndices, LongChunk<? extends KeyIndices> shiftIndices, long shiftDelta) {
        Assert.leq(leafSize, "leafSize", this.leafSize, "this.leafSize");
    ...
    private void applyShiftReverse(ObjectChunk<Object, ? extends Any> stampChunk, LongChunk<? extends KeyIndices> keyChunk, long shiftDelta) {
        validate();
        final int shiftSize = stampChunk.size();
        if (shiftSize == 0) {
            return;
    ...
    private void shiftLeafReverse(int leafSize, Object [] leafValues, ObjectChunk<Object, ? extends Any> shiftValues, long [] leafIndices, LongChunk<? extends KeyIndices> shiftIndices, long shiftDelta) {
        Assert.leq(leafSize, "leafSize", this.leafSize, "this.leafSize");
        final int shiftSize = shiftValues.size();
