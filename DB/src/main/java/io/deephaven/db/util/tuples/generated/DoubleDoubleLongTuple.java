...
/**
 * <p>3-Tuple (triple) key class composed of double, double, and long elements.
 * <p>Generated by {@link io.deephaven.db.util.tuples.TupleCodeGenerator}.
 */
public class DoubleDoubleLongTuple implements Comparable<DoubleDoubleLongTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<DoubleDoubleLongTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final DoubleDoubleLongTuple typedOther = (DoubleDoubleLongTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final DoubleDoubleLongTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public DoubleDoubleLongTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        return this;
    }
}
