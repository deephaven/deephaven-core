...
/**
 * <p>2-Tuple (double) key class composed of char and Object elements.
 * <p>Generated by {@link io.deephaven.db.util.tuples.TupleCodeGenerator}.
 */
public class CharObjectTuple implements Comparable<CharObjectTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<CharObjectTuple> {
    ...
    @Override
    public final int compareTo(@NotNull final CharObjectTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    public String toString() {
        return "CharObjectTuple{" +
                element1 + ", " +
                element2 + '}';
    }

    @Override
    public CharObjectTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        final Object canonicalizedElement2 = canonicalizer.apply(element2);
        return canonicalizedElement2 == element2
                ? this : new CharObjectTuple(element1, canonicalizedElement2);
    }
}
