...
/**
 * <p>3-Tuple (triple) key class composed of char, short, and Object elements.
 * <p>Generated by {@link io.deephaven.db.util.tuples.TupleCodeGenerator}.
 */
public class CharShortObjectTuple implements Comparable<CharShortObjectTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<CharShortObjectTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final CharShortObjectTuple typedOther = (CharShortObjectTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final CharShortObjectTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public CharShortObjectTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        final Object canonicalizedElement3 = canonicalizer.apply(element3);
        return canonicalizedElement3 == element3
                ? this : new CharShortObjectTuple(element1, element2, canonicalizedElement3);
    }
}
