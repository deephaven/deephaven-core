...
/**
 * <p>3-Tuple (triple) key class composed of char, long, and short elements.
 * <p>Generated by {@link io.deephaven.db.util.tuples.TupleCodeGenerator}.
 */
public class CharLongShortTuple implements Comparable<CharLongShortTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<CharLongShortTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final CharLongShortTuple typedOther = (CharLongShortTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final CharLongShortTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public CharLongShortTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        return this;
    }
}
