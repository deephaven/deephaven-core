...
/**
 * <p>3-Tuple (triple) key class composed of double, float, and long elements.
 * <p>Generated by {@link io.deephaven.db.util.tuples.TupleCodeGenerator}.
 */
public class DoubleFloatLongTuple implements Comparable<DoubleFloatLongTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<DoubleFloatLongTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final DoubleFloatLongTuple typedOther = (DoubleFloatLongTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final DoubleFloatLongTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public DoubleFloatLongTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        return this;
    }
}
