...
/**
 * <p>3-Tuple (triple) key class composed of float, short, and double elements.
 * <p>Generated by {@link io.deephaven.db.util.tuples.TupleCodeGenerator}.
 */
public class FloatShortDoubleTuple implements Comparable<FloatShortDoubleTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<FloatShortDoubleTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final FloatShortDoubleTuple typedOther = (FloatShortDoubleTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final FloatShortDoubleTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public FloatShortDoubleTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        return this;
    }
}
