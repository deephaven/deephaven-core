...
/**
 * <p>3-Tuple (triple) key class composed of byte, long, and int elements.
 * <p>Generated by {@link io.deephaven.db.util.tuples.TupleCodeGenerator}.
 */
public class ByteLongIntTuple implements Comparable<ByteLongIntTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<ByteLongIntTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final ByteLongIntTuple typedOther = (ByteLongIntTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final ByteLongIntTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public ByteLongIntTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        return this;
    }
}
