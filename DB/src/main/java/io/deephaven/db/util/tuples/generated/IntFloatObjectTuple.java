...
/**
 * <p>3-Tuple (triple) key class composed of int, float, and Object elements.
 * <p>Generated by {@link io.deephaven.db.util.tuples.TupleCodeGenerator}.
 */
public class IntFloatObjectTuple implements Comparable<IntFloatObjectTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<IntFloatObjectTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final IntFloatObjectTuple typedOther = (IntFloatObjectTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final IntFloatObjectTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public IntFloatObjectTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        final Object canonicalizedElement3 = canonicalizer.apply(element3);
        return canonicalizedElement3 == element3
                ? this : new IntFloatObjectTuple(element1, element2, canonicalizedElement3);
    }
}
