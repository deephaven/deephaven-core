...
/**
 * <p>3-Tuple (triple) key class composed of long, double, and char elements.
 * <p>Generated by {@link io.deephaven.db.util.tuples.TupleCodeGenerator}.
 */
public class LongDoubleCharTuple implements Comparable<LongDoubleCharTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<LongDoubleCharTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final LongDoubleCharTuple typedOther = (LongDoubleCharTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final LongDoubleCharTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public LongDoubleCharTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        return this;
    }
}
