...
/**
 * <p>3-Tuple (triple) key class composed of short, char, and short elements.
 * <p>Generated by {@link io.deephaven.db.util.tuples.TupleCodeGenerator}.
 */
public class ShortCharShortTuple implements Comparable<ShortCharShortTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<ShortCharShortTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final ShortCharShortTuple typedOther = (ShortCharShortTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final ShortCharShortTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public ShortCharShortTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        return this;
    }
}
