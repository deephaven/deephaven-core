...
/**
 * <p>3-Tuple (triple) key class composed of Object, Object, and double elements.
 * <p>Generated by {@link io.deephaven.db.util.tuples.TupleCodeGenerator}.
 */
public class ObjectObjectDoubleTuple implements Comparable<ObjectObjectDoubleTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<ObjectObjectDoubleTuple> {
    ...
    public ObjectObjectDoubleTuple(
    ...
    public final boolean equals(final Object other) {
        ...
        final ObjectObjectDoubleTuple typedOther = (ObjectObjectDoubleTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final ObjectObjectDoubleTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    public String toString() {
        return "ObjectObjectDoubleTuple{" +
                element1 + ", " +
                element2 + ", " +
                element3 + '}';
    }
    ...
    @Override
    public ObjectObjectDoubleTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        ...
        return canonicalizedElement1 == element1 && canonicalizedElement2 == element2
                ? this : new ObjectObjectDoubleTuple(canonicalizedElement1, canonicalizedElement2, element3);
    }
}
