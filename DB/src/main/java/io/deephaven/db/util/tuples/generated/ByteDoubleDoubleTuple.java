...
/**
 * <p>3-Tuple (triple) key class composed of byte, double, and double elements.
 * <p>Generated by {@link io.deephaven.db.util.tuples.TupleCodeGenerator}.
 */
public class ByteDoubleDoubleTuple implements Comparable<ByteDoubleDoubleTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<ByteDoubleDoubleTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final ByteDoubleDoubleTuple typedOther = (ByteDoubleDoubleTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final ByteDoubleDoubleTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public ByteDoubleDoubleTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        return this;
    }
}
