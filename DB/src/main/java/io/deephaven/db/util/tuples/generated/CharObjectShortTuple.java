...
/**
 * <p>3-Tuple (triple) key class composed of char, Object, and short elements.
 * <p>Generated by {@link io.deephaven.db.util.tuples.TupleCodeGenerator}.
 */
public class CharObjectShortTuple implements Comparable<CharObjectShortTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<CharObjectShortTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final CharObjectShortTuple typedOther = (CharObjectShortTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final CharObjectShortTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public CharObjectShortTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        final Object canonicalizedElement2 = canonicalizer.apply(element2);
        return canonicalizedElement2 == element2
                ? this : new CharObjectShortTuple(element1, canonicalizedElement2, element3);
    }
}
