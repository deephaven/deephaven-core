...
/**
 * <p>3-Tuple (triple) key class composed of int, long, and byte elements.
 * <p>Generated by {@link io.deephaven.db.util.tuples.TupleCodeGenerator}.
 */
public class IntLongByteTuple implements Comparable<IntLongByteTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<IntLongByteTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final IntLongByteTuple typedOther = (IntLongByteTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final IntLongByteTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public IntLongByteTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        return this;
    }
}
