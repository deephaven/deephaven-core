...
/**
 * <p>3-Tuple (triple) key class composed of double, byte, and float elements.
 * <p>Generated by {@link io.deephaven.db.util.tuples.TupleCodeGenerator}.
 */
public class DoubleByteFloatTuple implements Comparable<DoubleByteFloatTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<DoubleByteFloatTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final DoubleByteFloatTuple typedOther = (DoubleByteFloatTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final DoubleByteFloatTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public DoubleByteFloatTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        return this;
    }
}
