...
/**
 * <p>3-Tuple (triple) key class composed of int, long, and float elements.
 * <p>Generated by {@link io.deephaven.db.util.tuples.TupleCodeGenerator}.
 */
public class IntLongFloatTuple implements Comparable<IntLongFloatTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<IntLongFloatTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final IntLongFloatTuple typedOther = (IntLongFloatTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final IntLongFloatTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public IntLongFloatTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        return this;
    }
}
