...
public class LivenessScopeStack {
    ...
    /**
     * <p>Push a scope onto the current thread's scope stack.
     *
    ...
    /**
     * <p>Pop a scope from the current thread's scope stack.
     * <p>Must be the current top of the stack.
     *
     * @param scope The scope
     */
    ...
    /**
     * <p>Get the scope at the top of the current thread's scope stack, or the base manager if no scopes have been
     * pushed but not popped on this thread.
     * <p>This method defines the manager that should be used for all new {@link LivenessArtifact}s.
     *
    ...
    /**
     * <p>Push a scope onto the scope stack, and get an {@link SafeCloseable} that pops it.
     * <p>This is useful for enclosing scope usage in a try-with-resources block.
     *
     * @param scope          The scope
    ...
    /**
     * <p>Push an anonymous scope onto the scope stack, and get an {@link SafeCloseable} that pops it and then
     * {@link LivenessScope#release()}s it.
     * <p>This is useful enclosing a series of query engine actions whose results must be explicitly retained externally
