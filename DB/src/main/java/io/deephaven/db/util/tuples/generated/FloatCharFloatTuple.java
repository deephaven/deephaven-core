...
/**
 * <p>3-Tuple (triple) key class composed of float, char, and float elements.
 * <p>Generated by {@link io.deephaven.db.util.tuples.TupleCodeGenerator}.
 */
public class FloatCharFloatTuple implements Comparable<FloatCharFloatTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<FloatCharFloatTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final FloatCharFloatTuple typedOther = (FloatCharFloatTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final FloatCharFloatTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public FloatCharFloatTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        return this;
    }
}
