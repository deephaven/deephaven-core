...
/**
 * <p>3-Tuple (triple) key class composed of char, float, and long elements.
 * <p>Generated by {@link io.deephaven.db.util.tuples.TupleCodeGenerator}.
 */
public class CharFloatLongTuple implements Comparable<CharFloatLongTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<CharFloatLongTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final CharFloatLongTuple typedOther = (CharFloatLongTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final CharFloatLongTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public CharFloatLongTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        return this;
    }
}
