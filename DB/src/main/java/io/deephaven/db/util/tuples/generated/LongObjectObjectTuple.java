...
/**
 * <p>3-Tuple (triple) key class composed of long, Object, and Object elements.
 * <p>Generated by {@link io.deephaven.db.util.tuples.TupleCodeGenerator}.
 */
public class LongObjectObjectTuple implements Comparable<LongObjectObjectTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<LongObjectObjectTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final LongObjectObjectTuple typedOther = (LongObjectObjectTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final LongObjectObjectTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public LongObjectObjectTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        ...
        return canonicalizedElement2 == element2 && canonicalizedElement3 == element3
                ? this : new LongObjectObjectTuple(element1, canonicalizedElement2, canonicalizedElement3);
    }
}
