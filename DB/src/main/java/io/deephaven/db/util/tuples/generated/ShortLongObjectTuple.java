...
/**
 * <p>3-Tuple (triple) key class composed of short, long, and Object elements.
 * <p>Generated by {@link io.deephaven.db.util.tuples.TupleCodeGenerator}.
 */
public class ShortLongObjectTuple implements Comparable<ShortLongObjectTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<ShortLongObjectTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final ShortLongObjectTuple typedOther = (ShortLongObjectTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final ShortLongObjectTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public ShortLongObjectTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        final Object canonicalizedElement3 = canonicalizer.apply(element3);
        return canonicalizedElement3 == element3
                ? this : new ShortLongObjectTuple(element1, element2, canonicalizedElement3);
    }
}
