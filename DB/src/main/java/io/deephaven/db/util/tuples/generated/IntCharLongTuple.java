...
/**
 * <p>3-Tuple (triple) key class composed of int, char, and long elements.
 * <p>Generated by {@link io.deephaven.db.util.tuples.TupleCodeGenerator}.
 */
public class IntCharLongTuple implements Comparable<IntCharLongTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<IntCharLongTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final IntCharLongTuple typedOther = (IntCharLongTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final IntCharLongTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public IntCharLongTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        return this;
    }
}
