...
/**
 * <p>3-Tuple (triple) key class composed of char, char, and long elements.
 * <p>Generated by {@link io.deephaven.db.util.tuples.TupleCodeGenerator}.
 */
public class CharCharLongTuple implements Comparable<CharCharLongTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<CharCharLongTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final CharCharLongTuple typedOther = (CharCharLongTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final CharCharLongTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public CharCharLongTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        return this;
    }
}
