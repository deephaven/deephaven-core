...
/**
 * <p>3-Tuple (triple) key class composed of double, int, and char elements.
 * <p>Generated by {@link io.deephaven.db.util.tuples.TupleCodeGenerator}.
 */
public class DoubleIntCharTuple implements Comparable<DoubleIntCharTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<DoubleIntCharTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final DoubleIntCharTuple typedOther = (DoubleIntCharTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final DoubleIntCharTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public DoubleIntCharTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        return this;
    }
}
