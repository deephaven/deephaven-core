...
/**
 * <p>3-Tuple (triple) key class composed of Object, long, and long elements.
 * <p>Generated by {@link io.deephaven.db.util.tuples.TupleCodeGenerator}.
 */
public class ObjectLongLongTuple implements Comparable<ObjectLongLongTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<ObjectLongLongTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final ObjectLongLongTuple typedOther = (ObjectLongLongTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final ObjectLongLongTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public ObjectLongLongTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        final Object canonicalizedElement1 = canonicalizer.apply(element1);
        return canonicalizedElement1 == element1
                ? this : new ObjectLongLongTuple(canonicalizedElement1, element2, element3);
    }
}
