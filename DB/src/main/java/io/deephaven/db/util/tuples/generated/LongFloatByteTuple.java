...
/**
 * <p>3-Tuple (triple) key class composed of long, float, and byte elements.
 * <p>Generated by {@link io.deephaven.db.util.tuples.TupleCodeGenerator}.
 */
public class LongFloatByteTuple implements Comparable<LongFloatByteTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<LongFloatByteTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final LongFloatByteTuple typedOther = (LongFloatByteTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final LongFloatByteTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public LongFloatByteTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        return this;
    }
}
