...
/**
 * <p>3-Tuple (triple) key class composed of byte, byte, and short elements.
 * <p>Generated by {@link io.deephaven.db.util.tuples.TupleCodeGenerator}.
 */
public class ByteByteShortTuple implements Comparable<ByteByteShortTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<ByteByteShortTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final ByteByteShortTuple typedOther = (ByteByteShortTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final ByteByteShortTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public ByteByteShortTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        return this;
    }
}
