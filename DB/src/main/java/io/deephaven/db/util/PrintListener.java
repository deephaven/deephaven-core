 ...
 *
 * <p>This can be used to debug the performance of a query by attaching to various tables in an effort to understand
 * the update pattern.  Optionally, you can also print out the head of the table.</p>
 *
