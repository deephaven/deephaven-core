...
/**
 * <p>3-Tuple (triple) key class composed of char, byte, and char elements.
 * <p>Generated by {@link io.deephaven.db.util.tuples.TupleCodeGenerator}.
 */
public class CharByteCharTuple implements Comparable<CharByteCharTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<CharByteCharTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final CharByteCharTuple typedOther = (CharByteCharTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final CharByteCharTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public CharByteCharTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        return this;
    }
}
