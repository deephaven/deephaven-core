...
/**
 * <p>3-Tuple (triple) key class composed of double, char, and long elements.
 * <p>Generated by {@link io.deephaven.db.util.tuples.TupleCodeGenerator}.
 */
public class DoubleCharLongTuple implements Comparable<DoubleCharLongTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<DoubleCharLongTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final DoubleCharLongTuple typedOther = (DoubleCharLongTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final DoubleCharLongTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public DoubleCharLongTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        return this;
    }
}
