...
/**
 * <p>3-Tuple (triple) key class composed of int, double, and int elements.
 * <p>Generated by {@link io.deephaven.db.util.tuples.TupleCodeGenerator}.
 */
public class IntDoubleIntTuple implements Comparable<IntDoubleIntTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<IntDoubleIntTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final IntDoubleIntTuple typedOther = (IntDoubleIntTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final IntDoubleIntTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public IntDoubleIntTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        return this;
    }
}
