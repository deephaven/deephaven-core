...
/**
 * <p>3-Tuple (triple) key class composed of char, float, and float elements.
 * <p>Generated by {@link io.deephaven.db.util.tuples.TupleCodeGenerator}.
 */
public class CharFloatFloatTuple implements Comparable<CharFloatFloatTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<CharFloatFloatTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final CharFloatFloatTuple typedOther = (CharFloatFloatTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final CharFloatFloatTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public CharFloatFloatTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        return this;
    }
}
