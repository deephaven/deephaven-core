...
public interface LongSizedDataStructure {
    ...
    /**
     <p>Returns {@link #size()} cast to an int, if this can be done without losing precision. Otherwise,
     * throws {@link SizeException}.
    ...
    /**
     * Returns the size argument cast to an int, if this can be done without losing precision. Otherwise,
     * throws {@link SizeException}.
     * @param operation A description of the operation that requires an int size
     * @param size The size
