...
/**
 * <p>3-Tuple (triple) key class composed of float, float, and char elements.
 * <p>Generated by {@link io.deephaven.db.util.tuples.TupleCodeGenerator}.
 */
public class FloatFloatCharTuple implements Comparable<FloatFloatCharTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<FloatFloatCharTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final FloatFloatCharTuple typedOther = (FloatFloatCharTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final FloatFloatCharTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public FloatFloatCharTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        return this;
    }
}
