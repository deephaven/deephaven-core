...
/**
 * <p>3-Tuple (triple) key class composed of double, short, and byte elements.
 * <p>Generated by {@link io.deephaven.db.util.tuples.TupleCodeGenerator}.
 */
public class DoubleShortByteTuple implements Comparable<DoubleShortByteTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<DoubleShortByteTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final DoubleShortByteTuple typedOther = (DoubleShortByteTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final DoubleShortByteTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public DoubleShortByteTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        return this;
    }
}
