...
/**
 * <p>3-Tuple (triple) key class composed of long, int, and char elements.
 * <p>Generated by {@link io.deephaven.db.util.tuples.TupleCodeGenerator}.
 */
public class LongIntCharTuple implements Comparable<LongIntCharTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<LongIntCharTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final LongIntCharTuple typedOther = (LongIntCharTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final LongIntCharTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public LongIntCharTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        return this;
    }
}
