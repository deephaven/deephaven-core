...
/**
 * <p>2-Tuple (double) key class composed of float and int elements.
 * <p>Generated by {@link io.deephaven.db.util.tuples.TupleCodeGenerator}.
 */
public class FloatIntTuple implements Comparable<FloatIntTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<FloatIntTuple> {
    ...
    @Override
    public final int compareTo(@NotNull final FloatIntTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    public String toString() {
        return "FloatIntTuple{" +
                element1 + ", " +
                element2 + '}';
    }

    @Override
    public FloatIntTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        return this;
    }
}
