...
public interface InputTableRowSetter {
    /**
     * Set the values of the column specified by the input, filling in missing data using the parameter 'table' as the
    ...
    /**
     * Add the specified row to the table. Duplicate keys will be overwritten. This method will execute asynchronously.
     * Users may use {@link #addRow(Map, boolean, InputTableStatusListener)} to handle the result of the asynchronous
     * write.
     *
    ...
    /**
     * Add the specified rows to the table. Duplicate keys will be overwritten. This method will execute asynchronously.
     * Users may use {@link #addRows(Map[], boolean, InputTableStatusListener)} to handle the asynchronous result.
     *
