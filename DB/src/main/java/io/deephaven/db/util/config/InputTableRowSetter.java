...
public interface InputTableRowSetter {
     ...
     * parameter 'table' as the previous value source.
     * This method will be invoked asynchronously. Users may use {@link #setRows(Table, int[], Map[], InputTableStatusListener)}
     * to be notified of asynchronous results.
     *
     ...
     * Set the values of the columns specified by the input, filling in missing data using the
     * parameter 'table' as the previous value source.
     * This method will be invoked asynchronously. The input listener will be notified on success/failure
     *
     * @param table The table to use as the previous value source
     * @param rowArray The row indices to update.
     * @param valueArray The new values.
    ...
    /**
     * Add the specified row to the table.  Duplicate keys will be overwritten.
     * This method will execute asynchronously.  Users may use {@link #addRow(Map, boolean, InputTableStatusListener)} to handle
     * the result of the asynchronous write.
     *
    ...
    /**
     * Add the specified rows to the table.  Duplicate keys will be overwritten.
     * This method will execute asynchronously. Users may use {@link #addRows(Map[], boolean, InputTableStatusListener)} to
     ...
     * This method will execute asynchronously, the input listener will be notified on success/failure.
     *
