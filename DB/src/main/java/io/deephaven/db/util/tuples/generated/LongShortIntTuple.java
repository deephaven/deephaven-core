...
/**
 * <p>3-Tuple (triple) key class composed of long, short, and int elements.
 * <p>Generated by {@link io.deephaven.db.util.tuples.TupleCodeGenerator}.
 */
public class LongShortIntTuple implements Comparable<LongShortIntTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<LongShortIntTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final LongShortIntTuple typedOther = (LongShortIntTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final LongShortIntTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public LongShortIntTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        return this;
    }
}
