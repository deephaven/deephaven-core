...
/**
 * <p>3-Tuple (triple) key class composed of short, double, and Object elements.
 * <p>Generated by {@link io.deephaven.db.util.tuples.TupleCodeGenerator}.
 */
public class ShortDoubleObjectTuple implements Comparable<ShortDoubleObjectTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<ShortDoubleObjectTuple> {
    ...
    @Override
    public final int compareTo(@NotNull final ShortDoubleObjectTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public ShortDoubleObjectTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        final Object canonicalizedElement3 = canonicalizer.apply(element3);
        return canonicalizedElement3 == element3
                ? this : new ShortDoubleObjectTuple(element1, element2, canonicalizedElement3);
    }
}
