...
/**
 * <p>3-Tuple (triple) key class composed of double, double, and int elements.
 * <p>Generated by {@link io.deephaven.db.util.tuples.TupleCodeGenerator}.
 */
public class DoubleDoubleIntTuple implements Comparable<DoubleDoubleIntTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<DoubleDoubleIntTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final DoubleDoubleIntTuple typedOther = (DoubleDoubleIntTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final DoubleDoubleIntTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public DoubleDoubleIntTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        return this;
    }
}
