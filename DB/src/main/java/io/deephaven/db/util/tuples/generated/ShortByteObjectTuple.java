...
/**
 * <p>3-Tuple (triple) key class composed of short, byte, and Object elements.
 * <p>Generated by {@link io.deephaven.db.util.tuples.TupleCodeGenerator}.
 */
public class ShortByteObjectTuple implements Comparable<ShortByteObjectTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<ShortByteObjectTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final ShortByteObjectTuple typedOther = (ShortByteObjectTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final ShortByteObjectTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public ShortByteObjectTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        final Object canonicalizedElement3 = canonicalizer.apply(element3);
        return canonicalizedElement3 == element3
                ? this : new ShortByteObjectTuple(element1, element2, canonicalizedElement3);
    }
}
