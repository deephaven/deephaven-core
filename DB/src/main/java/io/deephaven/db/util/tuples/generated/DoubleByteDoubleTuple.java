...
/**
 * <p>3-Tuple (triple) key class composed of double, byte, and double elements.
 * <p>Generated by {@link io.deephaven.db.util.tuples.TupleCodeGenerator}.
 */
public class DoubleByteDoubleTuple implements Comparable<DoubleByteDoubleTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<DoubleByteDoubleTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final DoubleByteDoubleTuple typedOther = (DoubleByteDoubleTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final DoubleByteDoubleTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public DoubleByteDoubleTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        return this;
    }
}
