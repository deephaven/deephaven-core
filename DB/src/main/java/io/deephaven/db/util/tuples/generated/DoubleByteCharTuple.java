...
/**
 * <p>3-Tuple (triple) key class composed of double, byte, and char elements.
 * <p>Generated by {@link io.deephaven.db.util.tuples.TupleCodeGenerator}.
 */
public class DoubleByteCharTuple implements Comparable<DoubleByteCharTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<DoubleByteCharTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final DoubleByteCharTuple typedOther = (DoubleByteCharTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final DoubleByteCharTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public DoubleByteCharTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        return this;
    }
}
