...
/**
 * <p>3-Tuple (triple) key class composed of float, char, and short elements.
 * <p>Generated by {@link io.deephaven.db.util.tuples.TupleCodeGenerator}.
 */
public class FloatCharShortTuple implements Comparable<FloatCharShortTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<FloatCharShortTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final FloatCharShortTuple typedOther = (FloatCharShortTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final FloatCharShortTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public FloatCharShortTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        return this;
    }
}
