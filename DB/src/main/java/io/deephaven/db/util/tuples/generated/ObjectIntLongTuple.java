...
/**
 * <p>3-Tuple (triple) key class composed of Object, int, and long elements.
 * <p>Generated by {@link io.deephaven.db.util.tuples.TupleCodeGenerator}.
 */
public class ObjectIntLongTuple implements Comparable<ObjectIntLongTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<ObjectIntLongTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final ObjectIntLongTuple typedOther = (ObjectIntLongTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final ObjectIntLongTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public ObjectIntLongTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        final Object canonicalizedElement1 = canonicalizer.apply(element1);
        return canonicalizedElement1 == element1
                ? this : new ObjectIntLongTuple(canonicalizedElement1, element2, element3);
    }
}
