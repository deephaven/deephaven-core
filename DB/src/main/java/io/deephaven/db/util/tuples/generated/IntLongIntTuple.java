...
/**
 * <p>3-Tuple (triple) key class composed of int, long, and int elements.
 * <p>Generated by {@link io.deephaven.db.util.tuples.TupleCodeGenerator}.
 */
public class IntLongIntTuple implements Comparable<IntLongIntTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<IntLongIntTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final IntLongIntTuple typedOther = (IntLongIntTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final IntLongIntTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public IntLongIntTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        return this;
    }
}
