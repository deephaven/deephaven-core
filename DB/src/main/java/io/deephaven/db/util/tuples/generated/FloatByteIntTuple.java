...
/**
 * <p>3-Tuple (triple) key class composed of float, byte, and int elements.
 * <p>Generated by {@link io.deephaven.db.util.tuples.TupleCodeGenerator}.
 */
public class FloatByteIntTuple implements Comparable<FloatByteIntTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<FloatByteIntTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final FloatByteIntTuple typedOther = (FloatByteIntTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final FloatByteIntTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public FloatByteIntTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        return this;
    }
}
