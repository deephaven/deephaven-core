...
/**
 * <p>3-Tuple (triple) key class composed of byte, byte, and float elements.
 * <p>Generated by {@link io.deephaven.db.util.tuples.TupleCodeGenerator}.
 */
public class ByteByteFloatTuple implements Comparable<ByteByteFloatTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<ByteByteFloatTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final ByteByteFloatTuple typedOther = (ByteByteFloatTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final ByteByteFloatTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public ByteByteFloatTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        return this;
    }
}
