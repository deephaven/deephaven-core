...
public class ReplicateDbArrays {
    ...
    public static void main(String[] args) throws IOException {
        ...
        serialVersionUIDs.put("io.deephaven.db.tables.dbarrays.DbShortArray", -6562228894877343013L);
        serialVersionUIDs.put("io.deephaven.db.tables.dbarrays.DbByteArray", 8519130615638683196L);
        serialVersionUIDs.put("io.deephaven.db.tables.dbarrays.DbDoubleArray", 7218901311693729986L);
        serialVersionUIDs.put("io.deephaven.db.tables.dbarrays.DbFloatArray", -1889118072737983807L);
        serialVersionUIDs.put("io.deephaven.db.tables.dbarrays.DbCharArrayDirect", 3636374971797603565L);
        serialVersionUIDs.put("io.deephaven.db.tables.dbarrays.DbLongArrayDirect", 1233975234000551534L);
        serialVersionUIDs.put("io.deephaven.db.tables.dbarrays.DbIntArrayDirect", -7790095389322728763L);
        serialVersionUIDs.put("io.deephaven.db.tables.dbarrays.DbShortArrayDirect", -4415134364550246624L);
        serialVersionUIDs.put("io.deephaven.db.tables.dbarrays.DbByteArrayDirect", 5978679490703697461L);
