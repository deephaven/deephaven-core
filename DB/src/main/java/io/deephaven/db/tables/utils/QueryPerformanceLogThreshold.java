...
public class QueryPerformanceLogThreshold {
     ...
     * <ul><li>"" is for instrumented QueryPerformanceLog/QueryOperationPerformanceLog nuggets</li>
     ...
     */
    private QueryPerformanceLogThreshold(String kind, long defaultDuration, long defaultRepeatedReads, long defaultInitialReads) {
        minimumDurationNanos = Configuration.getInstance().getLongWithDefault("QueryPerformance.minimum" + kind + "LogDurationNanos", defaultDuration);
    }
    ...
    /**
     * The minimum duration for an QueryPerformanceNugget to be logged based on its duration (or entry interval usage for the
     * UpdatePerformanceLog).  The value 0 logs everything.  The value -1 will not log anything based on duration.
     */
