...
/**
 * <p>LiveWidgets may implement this interface to restrict the users who can see a particular widget.</p>
 *
 * <p>This interface only enables the widget developer to limit the users who may open the widget; it does not provide
 * any control over what users can see after the widget is opened.  The widget itself is responsible for determining
 * which data should be presented to the user and applying any appropriate viewer permissions.  </p>
 *
