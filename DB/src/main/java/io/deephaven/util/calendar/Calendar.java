 ...
 * the corresponding method on a String with {@code DBDateTime.toDateString}.
...
public interface Calendar {
     ...
     * @return the number of days between {@code start} and {@code end}, inclusive and {@code endInclusive} respectively.
     */
