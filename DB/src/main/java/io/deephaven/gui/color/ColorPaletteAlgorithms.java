...
public enum ColorPaletteAlgorithms implements ColorPaletteAlgorithm {
    ...
    TRIAD_MIXING(c -> {
        ...
        return new Color((mixRatio1 * c1.javaColor().getRed() + mixRatio2 * c2.javaColor().getRed() + mixRatio3 * c3.javaColor().getRed()) % 1,
                (mixRatio1 * c1.javaColor().getGreen() + mixRatio2 * c2.javaColor().getGreen() + mixRatio3 * c3.javaColor().getGreen()) % 1,
                (mixRatio1 * c1.javaColor().getBlue() + mixRatio2 * c2.javaColor().getBlue() + mixRatio3 * c3.javaColor().getBlue()) % 1);
    }, null);
    ...
    private static Random randy() { return randy; }
     ...
     */
    public static ColorPaletteAlgorithms colorPaletteAlgorithm(@SuppressWarnings("ConstantConditions") final String name) {
        if (name == null) {
