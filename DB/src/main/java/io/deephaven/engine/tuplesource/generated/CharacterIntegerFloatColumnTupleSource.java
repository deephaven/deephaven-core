...
import io.deephaven.engine.tuple.generated.CharIntFloatTuple;
...
public class CharacterIntegerFloatColumnTupleSource extends AbstractTupleSource<CharIntFloatTuple> {
    ...
    @Override
    public final CharIntFloatTuple createTuple(final long indexKey) {
    ...
    @Override
    public final CharIntFloatTuple createPreviousTuple(final long indexKey) {
        return new CharIntFloatTuple(
    ...
    @Override
    public final <ELEMENT_TYPE> void exportElement(@NotNull final CharIntFloatTuple tuple, final int elementIndex, @NotNull final WritableSource<ELEMENT_TYPE> writableSource, final long destinationIndexKey) {
        if (elementIndex == 0) {
    ...
    @Override
    public final Object exportToExternalKey(@NotNull final CharIntFloatTuple tuple) {
        return new SmartKey(
    ...
    protected void convertChunks(@NotNull WritableChunk<? super Attributes.Values> destination, int chunkSize, Chunk<Attributes.Values> [] chunks) {
        WritableObjectChunk<CharIntFloatTuple, ? super Attributes.Values> destinationObjectChunk = destination.asWritableObjectChunk();
