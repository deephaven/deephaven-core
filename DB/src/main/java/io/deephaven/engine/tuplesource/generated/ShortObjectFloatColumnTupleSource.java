...
public class ShortObjectFloatColumnTupleSource extends AbstractTupleSource<ShortObjectFloatTuple> {
    ...
    @Override
    public final <ELEMENT_TYPE> void exportElement(@NotNull final ShortObjectFloatTuple tuple, final int elementIndex, @NotNull final WritableSource<ELEMENT_TYPE> writableSource, final long destinationIndexKey) {
        if (elementIndex == 0) {
