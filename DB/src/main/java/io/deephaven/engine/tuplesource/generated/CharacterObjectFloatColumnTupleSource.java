...
/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types Character, Object, and Float.
...
public class CharacterObjectFloatColumnTupleSource extends AbstractTupleSource<CharObjectFloatTuple> {
    ...
    public static final ThreeColumnTupleSourceFactory<CharObjectFloatTuple, Character, Object, Float> FACTORY = new Factory();
    ...
    @Override
    public final <ELEMENT_TYPE> void exportElement(@NotNull final CharObjectFloatTuple tuple, final int elementIndex, @NotNull final WritableSource<ELEMENT_TYPE> writableSource, final long destinationIndexKey) {
        if (elementIndex == 0) {
    ...
    private static final class Factory implements ThreeColumnTupleSourceFactory<CharObjectFloatTuple, Character, Object, Float> {
