...
/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types Integer, Boolean, and Boolean.
...
public class IntegerBooleanBooleanColumnTupleSource extends AbstractTupleSource<IntByteByteTuple> {
    ...
    public static final ThreeColumnTupleSourceFactory<IntByteByteTuple, Integer, Boolean, Boolean> FACTORY = new Factory();
    ...
    private static final class Factory implements ThreeColumnTupleSourceFactory<IntByteByteTuple, Integer, Boolean, Boolean> {
