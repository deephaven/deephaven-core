...
/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types Double, Character, and DateTime.
...
public class DoubleCharacterDateTimeColumnTupleSource extends AbstractTupleSource<DoubleCharLongTuple> {
    ...
    public static final ThreeColumnTupleSourceFactory<DoubleCharLongTuple, Double, Character, DateTime> FACTORY = new Factory();
    ...
    private static final class Factory implements ThreeColumnTupleSourceFactory<DoubleCharLongTuple, Double, Character, DateTime> {
