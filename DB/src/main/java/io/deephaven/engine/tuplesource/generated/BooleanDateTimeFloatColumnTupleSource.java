...
/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types Boolean, DateTime, and Float.
...
public class BooleanDateTimeFloatColumnTupleSource extends AbstractTupleSource<ByteLongFloatTuple> {
    ...
    public static final ThreeColumnTupleSourceFactory<ByteLongFloatTuple, Boolean, DateTime, Float> FACTORY = new Factory();
    ...
    protected void convertChunks(@NotNull WritableChunk<? super Attributes.Values> destination, int chunkSize, Chunk<Attributes.Values> [] chunks) {
        ...
        for (int ii = 0; ii < chunkSize; ++ii) {
            destinationObjectChunk.set(ii, new ByteLongFloatTuple(BooleanUtils.booleanAsByte(chunk1.get(ii)), DateTimeUtils.nanos(chunk2.get(ii)), chunk3.get(ii)));
        }
        destinationObjectChunk.setSize(chunkSize);
    }

    /** {@link ThreeColumnTupleSourceFactory} for instances of {@link BooleanDateTimeFloatColumnTupleSource}. **/
    private static final class Factory implements ThreeColumnTupleSourceFactory<ByteLongFloatTuple, Boolean, DateTime, Float> {
