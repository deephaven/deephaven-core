...
public interface RedirectionIndex {
    ...
    /**
     * Provide a default, empty {@link ChunkSink.FillFromContext} for use with our default
     * {@link ChunkSink#fillFromChunk}.
     */
    ...
    ChunkSink.FillFromContext EMPTY_CONTEXT = new ChunkSink.FillFromContext() {};

    /**
     * Our default, inefficient, implementation. Inheritors who care should provide a better implementation.
     */
    default void fillFromChunk(@NotNull ChunkSink.FillFromContext context, @NotNull Chunk<? extends Values> src,
