...
public class DbArraySlice<T> extends DbArray.Indirect<T> {
    ...
    private DbArraySlice(@NotNull final DbArray<T> innerArray, final long offsetIndex, final long length,
    ...
    public DbArray<T> subArrayByPositions(final long[] positions) {
        return innerArray.subArrayByPositions(Arrays.stream(positions)
