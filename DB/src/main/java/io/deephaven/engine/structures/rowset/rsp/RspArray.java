...
import io.deephaven.engine.structures.rowset.sortedranges.SortedRangesInt;
import org.apache.commons.lang3.mutable.MutableLong;
import org.apache.commons.lang3.mutable.MutableObject;
import io.deephaven.engine.structures.rowset.rsp.container.Container;
import io.deephaven.engine.structures.rowset.rsp.container.ArrayContainer;
import io.deephaven.engine.structures.rowset.rsp.container.BitmapContainer;
import io.deephaven.engine.structures.rowset.rsp.container.TwoValuesContainer;
import io.deephaven.engine.structures.rowset.rsp.container.SingleRangeContainer;
import io.deephaven.engine.structures.rowset.rsp.container.RunContainer;
...
public abstract class RspArray<T extends RspArray> extends RefCountedCow<T> {
    ...
    public long rangesCountUpperBound(final int startIdx, final int endIdx) {
        ...
        for (int idx = startIdx; idx <= endIdx; ++idx) {
            ...
            if (isSingletonSpan(s)) {
                ++nRanges;
            } else if (s instanceof io.deephaven.engine.structures.rowset.rsp.container.RunContainer) {
                nRanges += ((io.deephaven.engine.structures.rowset.rsp.container.RunContainer) s).numberOfRanges();
            } else if (s instanceof io.deephaven.engine.structures.rowset.rsp.container.SingleRangeContainer) {
                nRanges += 1;
            } else if (s instanceof io.deephaven.engine.structures.rowset.rsp.container.TwoValuesContainer) {
                nRanges += 2;
