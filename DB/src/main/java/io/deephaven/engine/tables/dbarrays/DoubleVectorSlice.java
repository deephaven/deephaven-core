...
import static io.deephaven.engine.tables.dbarrays.Vector.clampIndex;
...
public class DoubleVectorSlice extends DoubleVector.Indirect {
    ...
    public DoubleVectorSlice(@NotNull final DoubleVector innerArray, final long offsetIndex, final long length, final long innerArrayValidFromInclusive, final long innerArrayValidToExclusive) {
    ...
    public DoubleVectorSlice(@NotNull final DoubleVector innerArray, final long offsetIndex, final long length) {
    ...
    public DoubleVector subVector(final long fromIndexInclusive, final long toIndexExclusive) {
            ...
            return new DoubleVectorSlice(innerArray, newOffsetIndex, newLength,
    ...
    public double[] toArray() {
        if (innerArray instanceof DoubleVectorDirect && offsetIndex >= innerArrayValidFromInclusive && offsetIndex + length <= innerArrayValidToExclusive) {
