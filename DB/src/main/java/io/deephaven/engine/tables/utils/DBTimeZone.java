...
public enum DBTimeZone {
     ...
     */
    public static io.deephaven.engine.tables.utils.DBTimeZone getTzDefault() {
        return TZ_DEFAULT;
    }
     ...
     */
    public static void setTzDefault(io.deephaven.engine.tables.utils.DBTimeZone tzDefault) {
