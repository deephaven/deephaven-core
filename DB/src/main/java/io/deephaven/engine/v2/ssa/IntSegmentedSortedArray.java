...
public final class IntSegmentedSortedArray implements SegmentedSortedArray {
     ...
     */
    private <T extends Any> int findNext(IntChunk<T> stampValues, LongChunk<? extends KeyIndices> stampIndices, WritableIntChunk<T> nextValues) {
    ...
    private static <T extends Any> int findNextOneLeaf(int offset, IntChunk<T> stampValues, LongChunk<? extends KeyIndices> stampIndices, WritableIntChunk<T> nextValues, int leafSize, int [] leafValues, long [] leafKeys) {
        int lo = 0;
     ...
     */
    void insert(IntChunk<? extends Any> valuesToInsert, LongChunk<? extends KeyIndices> indicesToInsert) {
    ...
    private void copyToLeaf(int leafOffset, int[] leafValues, IntChunk<? extends Any> insertValues, long[] leafIndices, LongChunk<? extends KeyIndices> insertIndices) {
        copyToLeaf(leafOffset, leafValues, insertValues, leafIndices, insertIndices, 0, insertIndices.size());
    }

    private void copyToLeaf(int leafOffset, int[] leafValues, IntChunk<? extends Any> insertValues, long[] leafIndices, LongChunk<? extends KeyIndices> insertIndices, int srcOffset, int length) {
    ...
    private void distributeValues(int targetSize, int startingLeaf, int distributionSlots, IntChunk<? extends Any> valuesToInsert, LongChunk<? extends KeyIndices> indices) {
    ...
    private void makeSingletonLeaf(IntChunk<? extends Any> values, LongChunk<? extends KeyIndices> indices) {
    ...
    private void makeLeavesInitial(IntChunk<? extends Any> values, LongChunk<? extends KeyIndices> indices) {
    ...
    private void insertIntoLeaf(int leafSize, int [] leafValues, IntChunk<? extends Any> insertValues, long [] leafIndices, LongChunk<? extends KeyIndices> insertIndices) {
    ...
    private boolean isAfterLeaf(int leafSize, int[] leafValues, IntChunk<? extends Any> insertValues, long[] leafIndices, LongChunk<? extends KeyIndices> insertIndices) {
    ...
    private void removeFromLeaf(int leafSize, int [] leafValues, IntChunk<? extends Any> removeValues, long [] leafIndices, LongChunk<? extends KeyIndices> removeIndices, @Nullable WritableLongChunk<? extends KeyIndices> priorRedirections, long firstPriorRedirection) {
    ...
    private static int lowerBound(IntChunk<? extends Any> valuesToSearch, LongChunk<? extends KeyIndices> indicesToSearch, int lo, int hi, int searchValue, long searchKey) {
        while (lo < hi) {
    ...
    private static int upperBound(IntChunk<? extends Any> valuesToSearch, LongChunk<? extends KeyIndices> indicesToSearch, int lo, int hi, int searchValue, long searchKey) {
        while (lo < hi) {
            final int mid = (lo + hi) >>> 1;
            final int testValue = valuesToSearch.get(mid);
            final int comparison = doComparison(testValue, searchValue);
    ...
    private void remove(IntChunk<? extends Any> valuesToRemove, LongChunk<? extends KeyIndices> indicesToRemove) {
     ...
     */
    private void removeAndGetNextInternal(IntChunk<? extends Any> valuesToRemove, LongChunk<? extends KeyIndices> indicesToRemove, @Nullable WritableLongChunk<? extends KeyIndices> priorRedirections) {
        validate();
    ...
    private void applyShift(IntChunk<? extends Any> stampChunk, LongChunk<? extends KeyIndices> keyChunk, long shiftDelta) {
        validate();
    ...
    private void shiftLeaf(int leafSize, int [] leafValues, IntChunk<? extends Any> shiftValues, long [] leafIndices, LongChunk<? extends KeyIndices> shiftIndices, long shiftDelta) {
        Assert.leq(leafSize, "leafSize", this.leafSize, "this.leafSize");
    ...
    private void applyShiftReverse(IntChunk<? extends Any> stampChunk, LongChunk<? extends KeyIndices> keyChunk, long shiftDelta) {
        validate();
        final int shiftSize = stampChunk.size();
        if (shiftSize == 0) {
            return;
    ...
    private void shiftLeafReverse(int leafSize, int [] leafValues, IntChunk<? extends Any> shiftValues, long [] leafIndices, LongChunk<? extends KeyIndices> shiftIndices, long shiftDelta) {
        Assert.leq(leafSize, "leafSize", this.leafSize, "this.leafSize");
        final int shiftSize = shiftValues.size();
