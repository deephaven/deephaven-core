...
public class SyncTableFilter {
    ...
    private static class KeyState {
        MutableRowSet pendingRows = RowSetFactoryImpl.INSTANCE.getEmptyRowSet();
        MutableRowSet matchedRows = RowSetFactoryImpl.INSTANCE.getEmptyRowSet();
    ...
    private SyncTableFilter(final List<SyncTableDescription> tables) {
        ...
        for (int ii = 0; ii < tableCount; ++ii) {
            ...
            resultRowSet[ii] = RowSetFactoryImpl.INSTANCE.getEmptyRowSet().convertToTracking();
