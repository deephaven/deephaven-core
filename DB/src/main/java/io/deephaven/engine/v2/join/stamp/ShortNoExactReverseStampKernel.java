...
public class ShortNoExactReverseStampKernel implements StampKernel {
    ...
    static private void computeRedirections(ShortChunk<Values> leftStamps, ShortChunk<Values> rightStamps, LongChunk<Attributes.RowKeys> rightKeyIndices, WritableLongChunk<RowKeys> leftRedirections) {
