...
public class IntReverseChunkSsaStamp implements ChunkSsaStamp {
    ...
    private static void processEntry(IntChunk<Values> leftStampValues, Chunk<KeyIndices> leftStampKeys, IntReverseSegmentedSortedArray ssa, WritableLongChunk<KeyIndices> rightKeysForLeft, boolean disallowExactMatch) {
