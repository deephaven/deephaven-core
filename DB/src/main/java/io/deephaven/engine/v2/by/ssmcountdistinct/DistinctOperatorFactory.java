...
import io.deephaven.engine.v2.by.ssmcountdistinct.unique.*;
 ...
 * {@link io.deephaven.engine.v2.by.AggType#Distinct} {@link io.deephaven.engine.v2.by.AggType#CountDistinct},
 * {@link io.deephaven.engine.v2.by.AggType#Unique} and their rollup counterparts
 */
public interface DistinctOperatorFactory {
     ...
     * {@link io.deephaven.engine.v2.by.AggType#CountDistinct} aggregation.
     *
    ...
    /**
     * Create an {@link IterativeChunkedAggregationOperator operator} for the
     * {@link io.deephaven.engine.v2.by.AggType#Distinct} aggregation.
     *
     * @param type the type of the column
     * @param resultName the name of the result column
     * @param countNulls true if null values should be counted as important values, or false if they should be ignored.
    ...
    /**
     * Create an {@link IterativeChunkedAggregationOperator operator} for the
     * {@link io.deephaven.engine.v2.by.AggType#Unique} aggregation.
     *
     * @param type the type of the column
     * @param resultName the name of the result column
     * @param countNulls true if null values should be counted as important values, or false if they should be ignored.
