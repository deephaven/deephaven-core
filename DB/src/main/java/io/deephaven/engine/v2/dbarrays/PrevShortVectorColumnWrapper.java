...
public class PrevShortVectorColumnWrapper extends ShortVector.Indirect {
    ...
    public PrevShortVectorColumnWrapper(@NotNull final ColumnSource<Short> columnSource,
                                       @NotNull final RowSet rowSet) {
        this(columnSource, rowSet, 0, 0);
    }

    private PrevShortVectorColumnWrapper(@NotNull final ColumnSource<Short> columnSource,
    ...
    public ShortVector subVectorByPositions(long[] positions) {
        ...
        return new PrevShortVectorColumnWrapper(columnSource, builder.build(), 0, 0);
    }
