...
public interface TupleExporter<TUPLE_TYPE> {
    ...
    /**
     * <p>
     * Export this tuple's element list as a key suitable for use in keying table maps. This is a legacy utility that
     * may be discontinued by <a href=https://github.com/deephaven/deephaven-core/issues/37>table map support
     * revisions</a>.
     * <p>
