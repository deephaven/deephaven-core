 ...
 *
 * @see io.deephaven.engine.v2.select.python.FormulaKernelPythonSingularFunction
 */
class FormulaKernelPythonChunkedFunction extends FormulaKernelTypedBase implements FormulaKernel {
    ...
    public void applyFormulaChunk(
        ...
        final io.deephaven.engine.v2.select.python.ArgumentsChunked args =
                io.deephaven.engine.v2.select.python.ArgumentsChunked.buildArguments(__sources);
