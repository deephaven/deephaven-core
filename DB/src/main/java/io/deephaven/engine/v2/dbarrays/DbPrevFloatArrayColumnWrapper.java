...
public class DbPrevFloatArrayColumnWrapper extends DbFloatArray.Indirect {
    ...
    public DbPrevFloatArrayColumnWrapper(@NotNull final ColumnSource<Float> columnSource,
            @NotNull final RowSet rowSet) {
        this(columnSource, rowSet, 0, 0);
    }

    private DbPrevFloatArrayColumnWrapper(@NotNull final ColumnSource<Float> columnSource, @NotNull final RowSet rowSet,
    ...
    public DbFloatArray subArray(long fromIndex, long toIndex) {
        ...
        return new DbPrevFloatArrayColumnWrapper(columnSource, rowSet.subSetByPositionRange(realFrom, realTo),
    ...
    public DbFloatArray subArrayByPositions(long[] positions) {
        ...
        return new DbPrevFloatArrayColumnWrapper(columnSource, builder.build(), 0, 0);
    }
