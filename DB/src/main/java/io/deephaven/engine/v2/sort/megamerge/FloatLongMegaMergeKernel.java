...
public class FloatLongMegaMergeKernel {
    ...
    // region Context
    public static class FloatLongMegaMergeKernelContext<ATTR extends Any, KEY_INDICES extends Keys> implements LongMegaMergeKernel<ATTR, KEY_INDICES> {
    ...
    public static <ATTR extends Any, KEY_INDICES extends Keys> FloatLongMegaMergeKernelContext<ATTR, KEY_INDICES> createContext() {
