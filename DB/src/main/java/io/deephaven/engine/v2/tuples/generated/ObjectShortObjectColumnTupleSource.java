...
import io.deephaven.engine.util.tuples.generated.ObjectShortObjectTuple;
...
public class ObjectShortObjectColumnTupleSource extends AbstractTupleSource<ObjectShortObjectTuple> {
    ...
    @Override
    public final <ELEMENT_TYPE> void exportElement(@NotNull final ObjectShortObjectTuple tuple, final int elementIndex, @NotNull final WritableSource<ELEMENT_TYPE> writableSource, final long destinationIndexKey) {
        if (elementIndex == 0) {
