...
public class CharLongMegaMergeKernel {
    ...
    // region Context
    public static class CharLongMegaMergeKernelContext<ATTR extends Any, KEY_INDICES extends Indices> implements LongMegaMergeKernel<ATTR, KEY_INDICES> {
    ...
    public static <ATTR extends Any, KEY_INDICES extends Indices> CharLongMegaMergeKernelContext<ATTR, KEY_INDICES> createContext() {
