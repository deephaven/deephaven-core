...
public class DbPrevCharArrayColumnWrapper extends DbCharArray.Indirect {
    ...
    public DbPrevCharArrayColumnWrapper(@NotNull final ColumnSource<Character> columnSource, @NotNull final TrackingMutableRowSet rowSet) {
    ...
    private DbPrevCharArrayColumnWrapper(@NotNull final ColumnSource<Character> columnSource, @NotNull final TrackingMutableRowSet rowSet,
