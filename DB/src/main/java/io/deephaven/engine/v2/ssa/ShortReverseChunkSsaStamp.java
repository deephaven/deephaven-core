...
public class ShortReverseChunkSsaStamp implements ChunkSsaStamp {
    ...
    private static void processEntry(ShortChunk<Values> leftStampValues, Chunk<KeyIndices> leftStampKeys, ShortReverseSegmentedSortedArray ssa, WritableLongChunk<KeyIndices> rightKeysForLeft, boolean disallowExactMatch) {
    ...
    private static void processInsertion(ShortChunk<Values> leftStampValues, LongChunk<KeyIndices> leftStampKeys, ShortChunk<? extends Values> rightStampChunk, LongChunk<KeyIndices> rightKeys, ShortChunk<Values> nextRightValue, RedirectionIndex redirectionIndex, Index.RandomBuilder modifiedBuilder, boolean endsWithLastValue, boolean disallowExactMatch) {
    ...
    private static int findModified(int leftLowIdx, ShortChunk<Values> leftStampValues, LongChunk<KeyIndices> leftStampKeys, RedirectionIndex redirectionIndex, ShortChunk<? extends Values> rightStampChunk, LongChunk<KeyIndices> rightStampIndices, Index.RandomBuilder modifiedBuilder, boolean disallowExactMatch) {
        for (int ii = 0; ii < rightStampChunk.size(); ++ii) {
            final short rightStampValue = rightStampChunk.get(ii);
    ...
    private void applyShift(ShortChunk<Values> leftStampValues, LongChunk<KeyIndices> leftStampKeys, ShortChunk<? extends Values> rightStampChunk, LongChunk<KeyIndices> rightStampKeys, long shiftDelta, RedirectionIndex redirectionIndex, boolean disallowExactMatch) {
        int leftLowIdx = 0;
        for (int ii = 0; ii < rightStampChunk.size(); ++ii) {
            final short rightStampValue = rightStampChunk.get(ii);
