...
public class DoubleSsaSsaStamp implements SsaSsaStamp {
    ...
    private static void processEntry(DoubleSegmentedSortedArray leftSsa, DoubleSegmentedSortedArray rightSsa, MutableRowRedirection rowRedirection, boolean disallowExactMatch) {
    ...
    private static void fillWithNull(MutableRowRedirection rowRedirection, DoubleSegmentedSortedArray.Iterator leftIt) {
        while (leftIt.hasNext()) {
            leftIt.next();
            rowRedirection.removeVoid(leftIt.getKey());
        }
    ...
    private static void fillWithValue(MutableRowRedirection rowRedirection, DoubleSegmentedSortedArray.Iterator leftIt, long rightKey) {
        while (leftIt.hasNext()) {
            leftIt.next();
    ...
    static private void processInsertion(DoubleSegmentedSortedArray leftSsa, DoubleChunk<? extends Values> rightStampChunk, LongChunk<Attributes.RowKeys> rightKeys, DoubleChunk<Values> nextRightValue, MutableRowRedirection rowRedirection, RowSetBuilderRandom modifiedBuilder, boolean endsWithLastValue, boolean disallowExactMatch) {
    ...
    private static void findModified(DoubleSegmentedSortedArray leftSsa, RowRedirection rowRedirection, DoubleChunk<? extends Values> rightStampChunk, LongChunk<Attributes.RowKeys> rightStampIndices, RowSetBuilderRandom modifiedBuilder, boolean disallowExactMatch) {
        final DoubleSegmentedSortedArray.Iterator leftIt = leftSsa.iterator(disallowExactMatch, false);
    ...
    private void applyShift(DoubleSegmentedSortedArray leftSsa, DoubleChunk<? extends Values> rightStampChunk, LongChunk<Attributes.RowKeys> rightStampKeys, long shiftDelta, MutableRowRedirection rowRedirection, boolean disallowExactMatch) {
        final DoubleSegmentedSortedArray.Iterator leftIt = leftSsa.iterator(disallowExactMatch, false);
