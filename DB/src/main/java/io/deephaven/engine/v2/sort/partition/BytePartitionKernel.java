...
//    }
    ...
    private static void samplePivots(Index index, int nPartitions, WritableLongChunk<RowKeys> pivotKeys, WritableByteChunk<Any> pivotValues, ColumnSource<Byte> columnSource) {
        pivotKeys.setSize(0);
