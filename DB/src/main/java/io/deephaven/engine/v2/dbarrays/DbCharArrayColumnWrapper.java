...
public class DbCharArrayColumnWrapper extends DbCharArray.Indirect {
    ...
    public DbCharArrayColumnWrapper(@NotNull final ColumnSource<Character> columnSource, @NotNull final TrackingMutableRowSet rowSet){
    ...
    public DbCharArray subArray(long fromIndex, long toIndex) {
        ...
        return new DbCharArrayColumnWrapper(columnSource, rowSet.subSetByPositionRange(realFrom, realTo), newStartPadding, newEndPadding);
    }
    ...
    public DbCharArray subArrayByPositions(long [] positions) {
        ...
        return new DbCharArrayColumnWrapper(columnSource, builder.build(), 0, 0);
    }
