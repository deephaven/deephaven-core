...
import io.deephaven.engine.util.tuples.generated.LongIntDoubleTuple;
...
/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types DBDateTime, Integer, and Double.
...
public class DateTimeIntegerDoubleColumnTupleSource extends AbstractTupleSource<LongIntDoubleTuple> {
    ...
    public static final ThreeColumnTupleSourceFactory<LongIntDoubleTuple, DBDateTime, Integer, Double> FACTORY = new Factory();
    ...
    protected void convertChunks(@NotNull WritableChunk<? super Attributes.Values> destination, int chunkSize, Chunk<Attributes.Values> [] chunks) {
        ...
        for (int ii = 0; ii < chunkSize; ++ii) {
            destinationObjectChunk.set(ii, new LongIntDoubleTuple(DBTimeUtils.nanos(chunk1.get(ii)), chunk2.get(ii), chunk3.get(ii)));
        }
        destinationObjectChunk.setSize(chunkSize);
    }

    /** {@link ThreeColumnTupleSourceFactory} for instances of {@link DateTimeIntegerDoubleColumnTupleSource}. **/
    private static final class Factory implements ThreeColumnTupleSourceFactory<LongIntDoubleTuple, DBDateTime, Integer, Double> {
