...
public class NullAwareCharSsaSsaStamp implements SsaSsaStamp {
    ...
    private static void processEntry(NullAwareCharSegmentedSortedArray leftSsa, NullAwareCharSegmentedSortedArray rightSsa, MutableRowRedirection rowRedirection, boolean disallowExactMatch) {
    ...
    private static void fillWithNull(MutableRowRedirection rowRedirection, NullAwareCharSegmentedSortedArray.Iterator leftIt) {
        while (leftIt.hasNext()) {
            leftIt.next();
            rowRedirection.removeVoid(leftIt.getKey());
        }
    ...
    private static void fillWithValue(MutableRowRedirection rowRedirection, NullAwareCharSegmentedSortedArray.Iterator leftIt, long rightKey) {
        while (leftIt.hasNext()) {
            leftIt.next();
    ...
    private void applyShift(NullAwareCharSegmentedSortedArray leftSsa, CharChunk<? extends Values> rightStampChunk, LongChunk<Attributes.RowKeys> rightStampKeys, long shiftDelta, MutableRowRedirection rowRedirection, boolean disallowExactMatch) {
        final NullAwareCharSegmentedSortedArray.Iterator leftIt = leftSsa.iterator(disallowExactMatch, false);
