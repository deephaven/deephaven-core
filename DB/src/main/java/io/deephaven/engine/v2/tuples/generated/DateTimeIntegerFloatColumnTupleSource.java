...
import io.deephaven.engine.util.tuples.generated.LongIntFloatTuple;
...
/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types DBDateTime, Integer, and Float.
...
public class DateTimeIntegerFloatColumnTupleSource extends AbstractTupleSource<LongIntFloatTuple> {
    ...
    public static final ThreeColumnTupleSourceFactory<LongIntFloatTuple, DBDateTime, Integer, Float> FACTORY = new Factory();
    ...
    protected void convertChunks(@NotNull WritableChunk<? super Attributes.Values> destination, int chunkSize, Chunk<Attributes.Values> [] chunks) {
        ...
        for (int ii = 0; ii < chunkSize; ++ii) {
            destinationObjectChunk.set(ii, new LongIntFloatTuple(DBTimeUtils.nanos(chunk1.get(ii)), chunk2.get(ii), chunk3.get(ii)));
        }
        destinationObjectChunk.setSize(chunkSize);
    }

    /** {@link ThreeColumnTupleSourceFactory} for instances of {@link DateTimeIntegerFloatColumnTupleSource}. **/
    private static final class Factory implements ThreeColumnTupleSourceFactory<LongIntFloatTuple, DBDateTime, Integer, Float> {
