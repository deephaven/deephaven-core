...
import io.deephaven.engine.util.tuples.generated.IntIntObjectTuple;
...
public class IntegerIntegerObjectColumnTupleSource extends AbstractTupleSource<IntIntObjectTuple> {
    ...
    @Override
    public final <ELEMENT_TYPE> void exportElement(@NotNull final IntIntObjectTuple tuple, final int elementIndex, @NotNull final WritableSource<ELEMENT_TYPE> writableSource, final long destinationIndexKey) {
        if (elementIndex == 0) {
