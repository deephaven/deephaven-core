...
/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types Boolean, DBDateTime, and Object.
...
public class BooleanDateTimeObjectColumnTupleSource extends AbstractTupleSource<ByteLongObjectTuple> {
    ...
    public static final ThreeColumnTupleSourceFactory<ByteLongObjectTuple, Boolean, DBDateTime, Object> FACTORY = new Factory();
    ...
    protected void convertChunks(@NotNull WritableChunk<? super Attributes.Values> destination, int chunkSize, Chunk<Attributes.Values> [] chunks) {
        ...
        for (int ii = 0; ii < chunkSize; ++ii) {
            destinationObjectChunk.set(ii, new ByteLongObjectTuple(BooleanUtils.booleanAsByte(chunk1.get(ii)), DBTimeUtils.nanos(chunk2.get(ii)), chunk3.get(ii)));
        }
        destinationObjectChunk.setSize(chunkSize);
    }

    /** {@link ThreeColumnTupleSourceFactory} for instances of {@link BooleanDateTimeObjectColumnTupleSource}. **/
    private static final class Factory implements ThreeColumnTupleSourceFactory<ByteLongObjectTuple, Boolean, DBDateTime, Object> {
