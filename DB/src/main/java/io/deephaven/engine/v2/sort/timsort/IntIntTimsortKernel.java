...
public class IntIntTimsortKernel {
    ...
    private static <ATTR extends Any, KEY_INDICES extends Indices> void copyToChunk(IntChunk<KEY_INDICES> indexSource, IntChunk<ATTR> valuesSource, WritableIntChunk<KEY_INDICES> indexDest, WritableIntChunk<ATTR> valuesDest, int sourceStart, int destStart, int length) {
