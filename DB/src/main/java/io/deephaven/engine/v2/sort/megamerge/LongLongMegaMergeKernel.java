...
public class LongLongMegaMergeKernel {
    ...
    // region Context
    public static class LongLongMegaMergeKernelContext<ATTR extends Any, KEY_INDICES extends Attributes.Indices> implements LongMegaMergeKernel<ATTR, KEY_INDICES> {
    ...
    public static <ATTR extends Any, KEY_INDICES extends Attributes.Indices> LongLongMegaMergeKernelContext<ATTR, KEY_INDICES> createContext() {
    ...
    private static <ATTR extends Any, KEY_INDICES extends Attributes.Indices> void copyChunkToDest(LongChunk<KEY_INDICES> keysChunk, LongChunk<ATTR> valuesChunk, LongArraySource destinationKeys, LongArraySource destinationValues, int sourceStart, long destStart, int length) {
