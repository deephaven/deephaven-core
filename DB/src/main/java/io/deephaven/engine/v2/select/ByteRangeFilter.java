...
public class ByteRangeFilter extends AbstractRangeFilter {
    ...
    private long bound(TrackingMutableRowSet selection, boolean usePrev, ColumnSource<Byte> longColumnSource, long minPosition, long maxPosition, byte targetValue, boolean inclusive, int compareSign, boolean end) {
