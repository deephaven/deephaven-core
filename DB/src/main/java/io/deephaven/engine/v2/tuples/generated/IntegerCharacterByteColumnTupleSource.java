...
import io.deephaven.engine.util.tuples.generated.IntCharByteTuple;
...
public class IntegerCharacterByteColumnTupleSource extends AbstractTupleSource<IntCharByteTuple> {
    ...
    @Override
    public final <ELEMENT_TYPE> void exportElement(@NotNull final IntCharByteTuple tuple, final int elementIndex, @NotNull final WritableSource<ELEMENT_TYPE> writableSource, final long destinationIndexKey) {
        if (elementIndex == 0) {
