...
import io.deephaven.engine.v2.select.ConditionFilter.FilterKernel.Context;
import io.deephaven.engine.v2.select.formula.FormulaKernel;
 ...
 * implement {@link io.deephaven.engine.v2.select.AbstractConditionFilter} and {@link FormulaColumnPython}.
 */
public class DeephavenCompatibleFunction {
    ...
    public FormulaKernel toFormulaKernel() {
        return isVectorized ? new FormulaKernelPythonChunkedFunction(function)
                : new io.deephaven.engine.v2.select.python.FormulaKernelPythonSingularFunction(function);
    }
