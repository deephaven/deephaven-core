...
public class IntChunkSsaStamp implements ChunkSsaStamp {
    ...
    private static void processEntry(IntChunk<Values> leftStampValues, Chunk<KeyIndices> leftStampKeys, IntSegmentedSortedArray ssa, WritableLongChunk<KeyIndices> rightKeysForLeft, boolean disallowExactMatch) {
    ...
    private static void processInsertion(IntChunk<Values> leftStampValues, LongChunk<KeyIndices> leftStampKeys, IntChunk<? extends Values> rightStampChunk, LongChunk<KeyIndices> rightKeys, IntChunk<Values> nextRightValue, RedirectionIndex redirectionIndex, Index.RandomBuilder modifiedBuilder, boolean endsWithLastValue, boolean disallowExactMatch) {
    ...
    private static int findModified(int leftLowIdx, IntChunk<Values> leftStampValues, LongChunk<KeyIndices> leftStampKeys, RedirectionIndex redirectionIndex, IntChunk<? extends Values> rightStampChunk, LongChunk<KeyIndices> rightStampIndices, Index.RandomBuilder modifiedBuilder, boolean disallowExactMatch) {
        for (int ii = 0; ii < rightStampChunk.size(); ++ii) {
            final int rightStampValue = rightStampChunk.get(ii);
    ...
    private void applyShift(IntChunk<Values> leftStampValues, LongChunk<KeyIndices> leftStampKeys, IntChunk<? extends Values> rightStampChunk, LongChunk<KeyIndices> rightStampKeys, long shiftDelta, RedirectionIndex redirectionIndex, boolean disallowExactMatch) {
        int leftLowIdx = 0;
        for (int ii = 0; ii < rightStampChunk.size(); ++ii) {
            final int rightStampValue = rightStampChunk.get(ii);
