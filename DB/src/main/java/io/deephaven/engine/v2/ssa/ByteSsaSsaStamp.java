...
public class ByteSsaSsaStamp implements SsaSsaStamp {
    ...
    static private void processRemovals(ByteSegmentedSortedArray leftSsa, ByteChunk<? extends Values> rightStampChunk, LongChunk<Attributes.RowKeys> rightKeys, WritableLongChunk<Attributes.RowKeys> nextRedirections, RedirectionIndex redirectionIndex, Index.RandomBuilder modifiedBuilder, boolean disallowExactMatch) {
    ...
    private static void findModified(ByteSegmentedSortedArray leftSsa, RedirectionIndex redirectionIndex, ByteChunk<? extends Values> rightStampChunk, LongChunk<RowKeys> rightStampIndices, Index.RandomBuilder modifiedBuilder, boolean disallowExactMatch) {
        final ByteSegmentedSortedArray.Iterator leftIt = leftSsa.iterator(disallowExactMatch, false);
