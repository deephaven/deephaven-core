...
public class LongIntTimsortDescendingKernel {
    ...
    private static <ATTR extends Any, KEY_INDICES extends Indices> void copyToChunk(IntChunk<KEY_INDICES> indexSource, LongChunk<ATTR> valuesSource, WritableIntChunk<KEY_INDICES> indexDest, WritableLongChunk<ATTR> valuesDest, int sourceStart, int destStart, int length) {
