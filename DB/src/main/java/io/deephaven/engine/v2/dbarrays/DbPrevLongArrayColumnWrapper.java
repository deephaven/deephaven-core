...
public class DbPrevLongArrayColumnWrapper extends DbLongArray.Indirect {
    ...
    public DbPrevLongArrayColumnWrapper(@NotNull final ColumnSource<Long> columnSource, @NotNull final RowSet rowSet) {
        this(columnSource, rowSet, 0, 0);
    }

    private DbPrevLongArrayColumnWrapper(@NotNull final ColumnSource<Long> columnSource, @NotNull final RowSet rowSet,
    ...
    public DbLongArray subArray(long fromIndex, long toIndex) {
        ...
        return new DbPrevLongArrayColumnWrapper(columnSource, rowSet.subSetByPositionRange(realFrom, realTo),
