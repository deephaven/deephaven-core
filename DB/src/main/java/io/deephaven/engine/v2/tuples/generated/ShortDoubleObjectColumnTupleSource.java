...
import io.deephaven.engine.util.tuples.generated.ShortDoubleObjectTuple;
...
public class ShortDoubleObjectColumnTupleSource extends AbstractTupleSource<ShortDoubleObjectTuple> {
    ...
    @Override
    public final ShortDoubleObjectTuple createTuple(final long indexKey) {
    ...
    @Override
    public final ShortDoubleObjectTuple createPreviousTuple(final long indexKey) {
        return new ShortDoubleObjectTuple(
    ...
    @Override
    public final <ELEMENT_TYPE> void exportElement(@NotNull final ShortDoubleObjectTuple tuple, final int elementIndex, @NotNull final WritableSource<ELEMENT_TYPE> writableSource, final long destinationIndexKey) {
        if (elementIndex == 0) {
    ...
    @Override
    public final Object exportToExternalKey(@NotNull final ShortDoubleObjectTuple tuple) {
        return new SmartKey(
    ...
    protected void convertChunks(@NotNull WritableChunk<? super Attributes.Values> destination, int chunkSize, Chunk<Attributes.Values> [] chunks) {
        WritableObjectChunk<ShortDoubleObjectTuple, ? super Attributes.Values> destinationObjectChunk = destination.asWritableObjectChunk();
