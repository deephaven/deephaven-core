...
import io.deephaven.engine.util.tuples.generated.IntShortTuple;
...
public class IntegerShortColumnTupleSource extends AbstractTupleSource<IntShortTuple> {
    ...
    @Override
    public final <ELEMENT_TYPE> void exportElement(@NotNull final IntShortTuple tuple, final int elementIndex, @NotNull final WritableSource<ELEMENT_TYPE> writableSource, final long destinationIndexKey) {
        if (elementIndex == 0) {
