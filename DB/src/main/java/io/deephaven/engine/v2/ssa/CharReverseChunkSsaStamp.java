...
public class CharReverseChunkSsaStamp implements ChunkSsaStamp {
    ...
    private static void processEntry(CharChunk<Values> leftStampValues, Chunk<Attributes.RowKeys> leftStampKeys, CharReverseSegmentedSortedArray ssa, WritableLongChunk<Attributes.RowKeys> rightKeysForLeft, boolean disallowExactMatch) {
