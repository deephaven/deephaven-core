...
/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types DBDateTime, Byte, and Byte.
...
public class DateTimeReinterpretedBooleanReinterpretedBooleanColumnTupleSource extends AbstractTupleSource<LongByteByteTuple> {
    ...
    public static final ThreeColumnTupleSourceFactory<LongByteByteTuple, DBDateTime, Byte, Byte> FACTORY = new Factory();
    ...
    protected void convertChunks(@NotNull WritableChunk<? super Attributes.Values> destination, int chunkSize, Chunk<Attributes.Values> [] chunks) {
        ...
        for (int ii = 0; ii < chunkSize; ++ii) {
            destinationObjectChunk.set(ii, new LongByteByteTuple(DBTimeUtils.nanos(chunk1.get(ii)), chunk2.get(ii), chunk3.get(ii)));
        }
    ...
    private static final class Factory implements ThreeColumnTupleSourceFactory<LongByteByteTuple, DBDateTime, Byte, Byte> {
