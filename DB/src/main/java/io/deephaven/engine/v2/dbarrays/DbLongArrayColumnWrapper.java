...
public class DbLongArrayColumnWrapper extends DbLongArray.Indirect {
    ...
    public DbLongArray subArray(long fromIndex, long toIndex) {
        ...
        return new DbLongArrayColumnWrapper(columnSource, rowSet.subSetByPositionRange(realFrom, realTo), newStartPadding, newEndPadding);
    }
    ...
    public DbLongArray subArrayByPositions(long [] positions) {
        ...
        return new DbLongArrayColumnWrapper(columnSource, builder.build(), 0, 0);
    }
