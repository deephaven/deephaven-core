...
public class IntLongMegaMergeKernel {
    ...
    // region Context
    public static class IntLongMegaMergeKernelContext<ATTR extends Any, KEY_INDICES extends Keys> implements LongMegaMergeKernel<ATTR, KEY_INDICES> {
    ...
    public static <ATTR extends Any, KEY_INDICES extends Keys> IntLongMegaMergeKernelContext<ATTR, KEY_INDICES> createContext() {
