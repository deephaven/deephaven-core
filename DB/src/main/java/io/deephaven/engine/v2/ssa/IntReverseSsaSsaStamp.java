...
public class IntReverseSsaSsaStamp implements SsaSsaStamp {
    ...
    private static void processEntry(IntReverseSegmentedSortedArray leftSsa, IntReverseSegmentedSortedArray rightSsa, WritableRowRedirection rowRedirection, boolean disallowExactMatch) {
    ...
    private static void fillWithValue(WritableRowRedirection rowRedirection, IntReverseSegmentedSortedArray.Iterator leftIt, long rightKey) {
        while (leftIt.hasNext()) {
            leftIt.next();
    ...
    private void applyShift(IntReverseSegmentedSortedArray leftSsa, IntChunk<? extends Values> rightStampChunk, LongChunk<Attributes.RowKeys> rightStampKeys, long shiftDelta, WritableRowRedirection rowRedirection, boolean disallowExactMatch) {
        final IntReverseSegmentedSortedArray.Iterator leftIt = leftSsa.iterator(disallowExactMatch, false);
