...
/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types Long, Integer, and DBDateTime.
...
public class ReinterpretedDateTimeIntegerDateTimeColumnTupleSource extends AbstractTupleSource<LongIntLongTuple> {
    ...
    public static final ThreeColumnTupleSourceFactory<LongIntLongTuple, Long, Integer, DBDateTime> FACTORY = new Factory();
    ...
    protected void convertChunks(@NotNull WritableChunk<? super Attributes.Values> destination, int chunkSize, Chunk<Attributes.Values> [] chunks) {
        ...
        for (int ii = 0; ii < chunkSize; ++ii) {
            destinationObjectChunk.set(ii, new LongIntLongTuple(chunk1.get(ii), chunk2.get(ii), DBTimeUtils.nanos(chunk3.get(ii))));
        }
        destinationObjectChunk.setSize(chunkSize);
    }

    /** {@link ThreeColumnTupleSourceFactory} for instances of {@link ReinterpretedDateTimeIntegerDateTimeColumnTupleSource}. **/
    private static final class Factory implements ThreeColumnTupleSourceFactory<LongIntLongTuple, Long, Integer, DBDateTime> {
