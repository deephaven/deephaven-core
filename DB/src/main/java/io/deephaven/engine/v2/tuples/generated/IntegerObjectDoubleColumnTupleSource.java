...
import io.deephaven.engine.util.tuples.generated.IntObjectDoubleTuple;
...
public class IntegerObjectDoubleColumnTupleSource extends AbstractTupleSource<IntObjectDoubleTuple> {
    ...
    @Override
    public final IntObjectDoubleTuple createTuple(final long indexKey) {
    ...
    @Override
    public final IntObjectDoubleTuple createPreviousTuple(final long indexKey) {
        return new IntObjectDoubleTuple(
    ...
    @Override
    public final <ELEMENT_TYPE> void exportElement(@NotNull final IntObjectDoubleTuple tuple, final int elementIndex, @NotNull final WritableSource<ELEMENT_TYPE> writableSource, final long destinationIndexKey) {
        if (elementIndex == 0) {
    ...
    protected void convertChunks(@NotNull WritableChunk<? super Attributes.Values> destination, int chunkSize, Chunk<Attributes.Values> [] chunks) {
        WritableObjectChunk<IntObjectDoubleTuple, ? super Attributes.Values> destinationObjectChunk = destination.asWritableObjectChunk();
