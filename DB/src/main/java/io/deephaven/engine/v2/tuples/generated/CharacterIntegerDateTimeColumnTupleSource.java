...
/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types Character, Integer, and DateTime.
...
public class CharacterIntegerDateTimeColumnTupleSource extends AbstractTupleSource<CharIntLongTuple> {
    ...
    public static final ThreeColumnTupleSourceFactory<CharIntLongTuple, Character, Integer, DateTime> FACTORY = new Factory();
    ...
    private static final class Factory implements ThreeColumnTupleSourceFactory<CharIntLongTuple, Character, Integer, DateTime> {
