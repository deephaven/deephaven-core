...
import io.deephaven.engine.util.tuples.generated.CharIntLongTuple;
...
/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types Character, Integer, and DBDateTime.
...
public class CharacterIntegerDateTimeColumnTupleSource extends AbstractTupleSource<CharIntLongTuple> {
    ...
    public static final ThreeColumnTupleSourceFactory<CharIntLongTuple, Character, Integer, DBDateTime> FACTORY = new Factory();
    ...
    protected void convertChunks(@NotNull WritableChunk<? super Attributes.Values> destination, int chunkSize, Chunk<Attributes.Values> [] chunks) {
        ...
        for (int ii = 0; ii < chunkSize; ++ii) {
            destinationObjectChunk.set(ii, new CharIntLongTuple(chunk1.get(ii), chunk2.get(ii), DBTimeUtils.nanos(chunk3.get(ii))));
        }
        destinationObjectChunk.setSize(chunkSize);
    }

    /** {@link ThreeColumnTupleSourceFactory} for instances of {@link CharacterIntegerDateTimeColumnTupleSource}. **/
    private static final class Factory implements ThreeColumnTupleSourceFactory<CharIntLongTuple, Character, Integer, DBDateTime> {
