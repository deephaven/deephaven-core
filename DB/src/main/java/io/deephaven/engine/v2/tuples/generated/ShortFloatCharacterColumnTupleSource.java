...
import io.deephaven.engine.util.tuples.generated.ShortFloatCharTuple;
...
public class ShortFloatCharacterColumnTupleSource extends AbstractTupleSource<ShortFloatCharTuple> {
    ...
    @Override
    public final <ELEMENT_TYPE> void exportElement(@NotNull final ShortFloatCharTuple tuple, final int elementIndex, @NotNull final WritableSource<ELEMENT_TYPE> writableSource, final long destinationIndexKey) {
        if (elementIndex == 0) {
