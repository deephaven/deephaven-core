...
public class DbShortArrayColumnWrapper extends DbShortArray.Indirect {
    ...
    public DbShortArrayColumnWrapper(@NotNull final ColumnSource<Short> columnSource, @NotNull final TrackingMutableRowSet rowSet){
    ...
    public DbShortArray subArray(long fromIndex, long toIndex) {
        ...
        return new DbShortArrayColumnWrapper(columnSource, rowSet.subSetByPositionRange(realFrom, realTo), newStartPadding, newEndPadding);
    }
    ...
    public DbShortArray subArrayByPositions(long [] positions) {
        ...
        return new DbShortArrayColumnWrapper(columnSource, builder.build(), 0, 0);
    }
