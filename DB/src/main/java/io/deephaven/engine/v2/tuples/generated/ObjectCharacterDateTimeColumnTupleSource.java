...
import io.deephaven.engine.util.tuples.generated.ObjectCharLongTuple;
...
/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types Object, Character, and DBDateTime.
...
public class ObjectCharacterDateTimeColumnTupleSource extends AbstractTupleSource<ObjectCharLongTuple> {
    ...
    public static final ThreeColumnTupleSourceFactory<ObjectCharLongTuple, Object, Character, DBDateTime> FACTORY = new Factory();
    ...
    protected void convertChunks(@NotNull WritableChunk<? super Attributes.Values> destination, int chunkSize, Chunk<Attributes.Values> [] chunks) {
        ...
        for (int ii = 0; ii < chunkSize; ++ii) {
            destinationObjectChunk.set(ii, new ObjectCharLongTuple(chunk1.get(ii), chunk2.get(ii), DBTimeUtils.nanos(chunk3.get(ii))));
        }
        destinationObjectChunk.setSize(chunkSize);
    }

    /** {@link ThreeColumnTupleSourceFactory} for instances of {@link ObjectCharacterDateTimeColumnTupleSource}. **/
    private static final class Factory implements ThreeColumnTupleSourceFactory<ObjectCharLongTuple, Object, Character, DBDateTime> {
