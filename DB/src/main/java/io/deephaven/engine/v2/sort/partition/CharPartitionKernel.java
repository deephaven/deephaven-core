...
//    }
    ...
    private static void samplePivots(Index index, int nPartitions, WritableLongChunk<RowKeys> pivotKeys, WritableCharChunk<Any> pivotValues, ColumnSource<Character> columnSource) {
        pivotKeys.setSize(0);
