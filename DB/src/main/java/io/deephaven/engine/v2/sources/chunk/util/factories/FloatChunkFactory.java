...
import io.deephaven.engine.v2.sources.chunk.page.FloatChunkPage;
...
public class FloatChunkFactory implements ChunkFactory {
    ...
    @NotNull
    @Override
    public final FloatVectorDirect vectorWrap(Object array) {
        final float[] typedArray = (float[])array;
        return new FloatVectorDirect(typedArray);
    }
