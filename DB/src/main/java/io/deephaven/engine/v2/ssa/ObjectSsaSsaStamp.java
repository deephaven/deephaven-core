...
public class ObjectSsaSsaStamp implements SsaSsaStamp {
    ...
    static private void processRemovals(ObjectSegmentedSortedArray leftSsa, ObjectChunk<Object, ? extends Values> rightStampChunk, LongChunk<RowKeys> rightKeys, WritableLongChunk<Attributes.RowKeys> nextRedirections, RedirectionIndex redirectionIndex, Index.RandomBuilder modifiedBuilder, boolean disallowExactMatch) {
    ...
    private static void findModified(ObjectSegmentedSortedArray leftSsa, RedirectionIndex redirectionIndex, ObjectChunk<Object, ? extends Values> rightStampChunk, LongChunk<Attributes.RowKeys> rightStampIndices, Index.RandomBuilder modifiedBuilder, boolean disallowExactMatch) {
        final ObjectSegmentedSortedArray.Iterator leftIt = leftSsa.iterator(disallowExactMatch, false);
    ...
    private void applyShift(ObjectSegmentedSortedArray leftSsa, ObjectChunk<Object, ? extends Values> rightStampChunk, LongChunk<RowKeys> rightStampKeys, long shiftDelta, RedirectionIndex redirectionIndex, boolean disallowExactMatch) {
        final ObjectSegmentedSortedArray.Iterator leftIt = leftSsa.iterator(disallowExactMatch, false);
