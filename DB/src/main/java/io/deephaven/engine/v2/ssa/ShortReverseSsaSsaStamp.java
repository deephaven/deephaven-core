...
public class ShortReverseSsaSsaStamp implements SsaSsaStamp {
    ...
    static private void processRemovals(ShortReverseSegmentedSortedArray leftSsa, ShortChunk<? extends Values> rightStampChunk, LongChunk<RowKeys> rightKeys, WritableLongChunk<Attributes.RowKeys> nextRedirections, RedirectionIndex redirectionIndex, RowSetBuilder modifiedBuilder, boolean disallowExactMatch) {
    ...
    private static void findModified(ShortReverseSegmentedSortedArray leftSsa, RedirectionIndex redirectionIndex, ShortChunk<? extends Values> rightStampChunk, LongChunk<Attributes.RowKeys> rightStampIndices, RowSetBuilder modifiedBuilder, boolean disallowExactMatch) {
        final ShortReverseSegmentedSortedArray.Iterator leftIt = leftSsa.iterator(disallowExactMatch, false);
