...
public class FloatSparseArraySource extends SparseArrayColumnSource<Float> implements MutableColumnSourceGetDefaults.ForFloat {
    ...
    */
    ...
    public FloatChunk<Values> getChunk(@NotNull GetContext context, @NotNull RowSequence rowSequence) {
        ...
        return getChunkByFilling(context, rowSequence).asFloatChunk();
    }
    // endregion getChunk

    // region getPrevChunk
    @Override
    public FloatChunk<Values> getPrevChunk(@NotNull GetContext context, @NotNull RowSequence rowSequence) {
        if (prevFlusher == null) {
            return getChunk(context, rowSequence);
        }
        return getPrevChunkByFilling(context, rowSequence).asFloatChunk();
    }
