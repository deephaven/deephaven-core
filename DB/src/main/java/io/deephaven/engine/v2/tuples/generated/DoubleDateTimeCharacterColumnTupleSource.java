...
import io.deephaven.engine.util.tuples.generated.DoubleLongCharTuple;
...
/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types Double, DBDateTime, and Character.
...
public class DoubleDateTimeCharacterColumnTupleSource extends AbstractTupleSource<DoubleLongCharTuple> {
    ...
    public static final ThreeColumnTupleSourceFactory<DoubleLongCharTuple, Double, DBDateTime, Character> FACTORY = new Factory();
    ...
    protected void convertChunks(@NotNull WritableChunk<? super Attributes.Values> destination, int chunkSize, Chunk<Attributes.Values> [] chunks) {
        ...
        for (int ii = 0; ii < chunkSize; ++ii) {
            destinationObjectChunk.set(ii, new DoubleLongCharTuple(chunk1.get(ii), DBTimeUtils.nanos(chunk2.get(ii)), chunk3.get(ii)));
        }
        destinationObjectChunk.setSize(chunkSize);
    }

    /** {@link ThreeColumnTupleSourceFactory} for instances of {@link DoubleDateTimeCharacterColumnTupleSource}. **/
    private static final class Factory implements ThreeColumnTupleSourceFactory<DoubleLongCharTuple, Double, DBDateTime, Character> {
