...
public class IntCopyKernel implements CopyKernel {
    public static final IntCopyKernel INSTANCE = new IntCopyKernel();

    private IntCopyKernel() {} // use through the instance
    ...
    public static <T extends Any> void conditionalCopy(
            WritableIntChunk<T> output, int[] baseInput, int[] overInput, long[] useOverInput,
    ...
    public <T extends Any> void conditionalCopy(
            ...
            int srcOffset, int dstOffset, int length)
    {
        int[] typedBaseInput = (int[]) baseInput;
        int[] typedOverInput = (int[]) overInput;
        conditionalCopy(output.asWritableIntChunk(), typedBaseInput, typedOverInput, useOverInput, srcOffset, dstOffset, length);
    }
}
