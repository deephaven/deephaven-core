...
public class ObjectIntTimsortDescendingKernel {
    ...
    public static class ObjectIntSortKernelContext<ATTR extends Any, KEY_INDICES extends Indices> implements IntSortKernel<ATTR, KEY_INDICES> {
        ...
        public void sort(WritableIntChunk<KEY_INDICES> indexKeys, WritableChunk<ATTR> valuesToSort) {
            ObjectIntTimsortDescendingKernel.sort(this, indexKeys, valuesToSort.asWritableObjectChunk());
        }
        ...
        public void sort(WritableIntChunk<KEY_INDICES> indexKeys, WritableChunk<ATTR> valuesToSort, IntChunk<? extends ChunkPositions> offsetsIn, IntChunk<? extends ChunkLengths> lengthsIn) {
            ObjectIntTimsortDescendingKernel.sort(this, indexKeys, valuesToSort.asWritableObjectChunk(), offsetsIn, lengthsIn);
        }
    ...
    private static <ATTR extends Any, KEY_INDICES extends Indices> void copyToChunk(IntChunk<KEY_INDICES> indexSource, ObjectChunk<Object, ATTR> valuesSource, WritableIntChunk<KEY_INDICES> indexDest, WritableObjectChunk<Object, ATTR> valuesDest, int sourceStart, int destStart, int length) {
