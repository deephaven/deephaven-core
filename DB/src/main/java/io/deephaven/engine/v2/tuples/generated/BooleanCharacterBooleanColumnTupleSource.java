...
/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types Boolean, Character, and Boolean.
...
public class BooleanCharacterBooleanColumnTupleSource extends AbstractTupleSource<ByteCharByteTuple> {
    ...
    public static final ThreeColumnTupleSourceFactory<ByteCharByteTuple, Boolean, Character, Boolean> FACTORY = new Factory();
    ...
    private static final class Factory implements ThreeColumnTupleSourceFactory<ByteCharByteTuple, Boolean, Character, Boolean> {
