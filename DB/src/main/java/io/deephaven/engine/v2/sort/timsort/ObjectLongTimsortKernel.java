 ...
 * the algorithm.
 */
public class ObjectLongTimsortKernel {
    private ObjectLongTimsortKernel() {
    ...
    public static class ObjectLongSortKernelContext<ATTR extends Any, KEY_INDICES extends Indices> implements LongSortKernel<ATTR, KEY_INDICES> {
        ...
        public void sort(WritableLongChunk<KEY_INDICES> indexKeys, WritableChunk<ATTR> valuesToSort) {
            ObjectLongTimsortKernel.sort(this, indexKeys, valuesToSort.asWritableObjectChunk());
        }
        ...
        public void sort(WritableLongChunk<KEY_INDICES> indexKeys, WritableChunk<ATTR> valuesToSort, IntChunk<? extends ChunkPositions> offsetsIn, IntChunk<? extends ChunkLengths> lengthsIn) {
            ObjectLongTimsortKernel.sort(this, indexKeys, valuesToSort.asWritableObjectChunk(), offsetsIn, lengthsIn);
        }
    ...
    private static <ATTR extends Any, KEY_INDICES extends Indices> void copyToChunk(LongChunk<KEY_INDICES> rowSetSource, ObjectChunk<Object, ATTR> valuesSource, WritableLongChunk<KEY_INDICES> indexDest, WritableObjectChunk<Object, ATTR> valuesDest, int sourceStart, int destStart, int length) {
...
//    private static void doCheck(Chunk.LongChunk indexKeys, Chunk.ObjectChunk valuesToSort, int startCheck, int mergeEnd) {
//        Object lastCheck;
