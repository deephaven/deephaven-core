...
import io.deephaven.engine.util.tuples.generated.FloatShortObjectTuple;
...
public class FloatShortObjectColumnTupleSource extends AbstractTupleSource<FloatShortObjectTuple> {
    ...
    @Override
    public final FloatShortObjectTuple createTuple(final long indexKey) {
    ...
    @Override
    public final FloatShortObjectTuple createPreviousTuple(final long indexKey) {
        return new FloatShortObjectTuple(
    ...
    @Override
    public final <ELEMENT_TYPE> void exportElement(@NotNull final FloatShortObjectTuple tuple, final int elementIndex, @NotNull final WritableSource<ELEMENT_TYPE> writableSource, final long destinationIndexKey) {
        if (elementIndex == 0) {
    ...
    @Override
    public final Object exportToExternalKey(@NotNull final FloatShortObjectTuple tuple) {
        return new SmartKey(
    ...
    protected void convertChunks(@NotNull WritableChunk<? super Attributes.Values> destination, int chunkSize, Chunk<Attributes.Values> [] chunks) {
        WritableObjectChunk<FloatShortObjectTuple, ? super Attributes.Values> destinationObjectChunk = destination.asWritableObjectChunk();
