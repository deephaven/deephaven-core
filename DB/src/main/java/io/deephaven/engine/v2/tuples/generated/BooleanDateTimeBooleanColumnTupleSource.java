...
/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types Boolean, DateTime, and Boolean.
...
public class BooleanDateTimeBooleanColumnTupleSource extends AbstractTupleSource<ByteLongByteTuple> {
    ...
    public static final ThreeColumnTupleSourceFactory<ByteLongByteTuple, Boolean, DateTime, Boolean> FACTORY = new Factory();
    ...
    private static final class Factory implements ThreeColumnTupleSourceFactory<ByteLongByteTuple, Boolean, DateTime, Boolean> {
