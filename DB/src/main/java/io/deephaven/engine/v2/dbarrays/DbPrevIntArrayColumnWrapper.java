...
public class DbPrevIntArrayColumnWrapper extends DbIntArray.Indirect {
    ...
    public DbPrevIntArrayColumnWrapper(@NotNull final ColumnSource<Integer> columnSource,
            @NotNull final RowSet rowSet) {
        this(columnSource, rowSet, 0, 0);
    }

    private DbPrevIntArrayColumnWrapper(@NotNull final ColumnSource<Integer> columnSource, @NotNull final RowSet rowSet,
    ...
    public DbIntArray subArray(long fromIndex, long toIndex) {
        ...
        return new DbPrevIntArrayColumnWrapper(columnSource, rowSet.subSetByPositionRange(realFrom, realTo),
