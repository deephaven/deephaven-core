...
public class DbPrevIntArrayColumnWrapper extends DbIntArray.Indirect {
    ...
    public DbPrevIntArrayColumnWrapper(@NotNull final ColumnSource<Integer> columnSource, @NotNull final TrackingRowSet rowSet) {
    ...
    private DbPrevIntArrayColumnWrapper(@NotNull final ColumnSource<Integer> columnSource, @NotNull final TrackingRowSet rowSet,
