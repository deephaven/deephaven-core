...
public class IntLongMegaMergeDescendingKernel {
    ...
    // region Context
    public static class IntLongMegaMergeDescendingKernelContext<ATTR extends Any, KEY_INDICES extends Indices> implements LongMegaMergeKernel<ATTR, KEY_INDICES> {
