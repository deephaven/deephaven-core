...
public class ByteLongMegaMergeDescendingKernel {
    ...
    // region Context
    public static class ByteLongMegaMergeDescendingKernelContext<ATTR extends Any, KEY_INDICES extends Keys> implements LongMegaMergeKernel<ATTR, KEY_INDICES> {
        ...
        public void merge(LongArraySource indexDestinationSource, ArrayBackedColumnSource<?> valuesDestinationSource, long destinationOffset, long destinationSize, LongChunk<KEY_INDICES> indexKeys, Chunk<ATTR> valuesToMerge) {
            ByteLongMegaMergeDescendingKernel.merge(indexDestinationSource, (ByteArraySource)valuesDestinationSource, destinationOffset, destinationSize, indexKeys, valuesToMerge.asByteChunk());
        }
    }
    // endregion Context

    public static <ATTR extends Any, KEY_INDICES extends Keys> ByteLongMegaMergeDescendingKernelContext<ATTR, KEY_INDICES> createContext() {
