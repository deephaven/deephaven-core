...
public final class ShortReverseSegmentedSortedArray implements SegmentedSortedArray {
    ...
    private static <T extends Any> int findNextOneLeaf(int offset, ShortChunk<T> stampValues, LongChunk<? extends RowKeys> stampIndices, WritableShortChunk<T> nextValues, int leafSize, short [] leafValues, long [] leafKeys) {
        int lo = 0;
     ...
     */
    void insert(ShortChunk<? extends Any> valuesToInsert, LongChunk<? extends RowKeys> indicesToInsert) {
    ...
    private void copyToLeaf(int leafOffset, short[] leafValues, ShortChunk<? extends Any> insertValues, long[] leafIndices, LongChunk<? extends RowKeys> insertIndices, int srcOffset, int length) {
    ...
    private void distributeValues(int targetSize, int startingLeaf, int distributionSlots, ShortChunk<? extends Any> valuesToInsert, LongChunk<? extends RowKeys> indices) {
    ...
    private void makeSingletonLeaf(ShortChunk<? extends Any> values, LongChunk<? extends RowKeys> indices) {
    ...
    private void insertIntoLeaf(int leafSize, short [] leafValues, ShortChunk<? extends Any> insertValues, long [] leafIndices, LongChunk<? extends RowKeys> insertIndices) {
    ...
    private void removeFromLeaf(int leafSize, short [] leafValues, ShortChunk<? extends Any> removeValues, long [] leafIndices, LongChunk<? extends Attributes.RowKeys> removeIndices, @Nullable WritableLongChunk<? extends RowKeys> priorRedirections, long firstPriorRedirection) {
    ...
    private void remove(ShortChunk<? extends Any> valuesToRemove, LongChunk<? extends RowKeys> indicesToRemove) {
     ...
     */
    private void removeAndGetNextInternal(ShortChunk<? extends Any> valuesToRemove, LongChunk<? extends RowKeys> indicesToRemove, @Nullable WritableLongChunk<? extends RowKeys> priorRedirections) {
        validate();
