...
import io.deephaven.engine.util.tuples.generated.FloatLongCharTuple;
...
/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types Float, DBDateTime, and Character.
...
public class FloatDateTimeCharacterColumnTupleSource extends AbstractTupleSource<FloatLongCharTuple> {
    ...
    public static final ThreeColumnTupleSourceFactory<FloatLongCharTuple, Float, DBDateTime, Character> FACTORY = new Factory();
    ...
    protected void convertChunks(@NotNull WritableChunk<? super Attributes.Values> destination, int chunkSize, Chunk<Attributes.Values> [] chunks) {
        ...
        for (int ii = 0; ii < chunkSize; ++ii) {
            destinationObjectChunk.set(ii, new FloatLongCharTuple(chunk1.get(ii), DBTimeUtils.nanos(chunk2.get(ii)), chunk3.get(ii)));
        }
        destinationObjectChunk.setSize(chunkSize);
    }

    /** {@link ThreeColumnTupleSourceFactory} for instances of {@link FloatDateTimeCharacterColumnTupleSource}. **/
    private static final class Factory implements ThreeColumnTupleSourceFactory<FloatLongCharTuple, Float, DBDateTime, Character> {
