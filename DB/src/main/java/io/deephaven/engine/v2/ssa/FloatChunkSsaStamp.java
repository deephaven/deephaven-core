...
public class FloatChunkSsaStamp implements ChunkSsaStamp {
    ...
    private static void processEntry(FloatChunk<Values> leftStampValues, Chunk<KeyIndices> leftStampKeys, FloatSegmentedSortedArray ssa, WritableLongChunk<KeyIndices> rightKeysForLeft, boolean disallowExactMatch) {
