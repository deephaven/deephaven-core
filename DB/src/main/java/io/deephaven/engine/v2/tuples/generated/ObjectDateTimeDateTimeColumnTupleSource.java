...
/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types Object, DateTime, and DateTime.
...
public class ObjectDateTimeDateTimeColumnTupleSource extends AbstractTupleSource<ObjectLongLongTuple> {
    ...
    public static final ThreeColumnTupleSourceFactory<ObjectLongLongTuple, Object, DateTime, DateTime> FACTORY = new Factory();
    ...
    protected void convertChunks(@NotNull WritableChunk<? super Attributes.Values> destination, int chunkSize, Chunk<Attributes.Values> [] chunks) {
        ...
        for (int ii = 0; ii < chunkSize; ++ii) {
            destinationObjectChunk.set(ii, new ObjectLongLongTuple(chunk1.get(ii), DateTimeUtils.nanos(chunk2.get(ii)), DateTimeUtils.nanos(chunk3.get(ii))));
        }
        destinationObjectChunk.setSize(chunkSize);
    }

    /** {@link ThreeColumnTupleSourceFactory} for instances of {@link ObjectDateTimeDateTimeColumnTupleSource}. **/
    private static final class Factory implements ThreeColumnTupleSourceFactory<ObjectLongLongTuple, Object, DateTime, DateTime> {
