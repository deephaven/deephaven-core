...
import io.deephaven.engine.util.tuples.generated.LongDoubleLongTuple;
...
/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types DBDateTime, Double, and DBDateTime.
 * <p>Generated by {@link io.deephaven.engine.v2.tuples.TupleSourceCodeGenerator}.
 */
@SuppressWarnings({"unused", "WeakerAccess"})
public class DateTimeDoubleDateTimeColumnTupleSource extends AbstractTupleSource<LongDoubleLongTuple> {

    /** {@link ThreeColumnTupleSourceFactory} instance to create instances of {@link DateTimeDoubleDateTimeColumnTupleSource}. **/
    public static final ThreeColumnTupleSourceFactory<LongDoubleLongTuple, DBDateTime, Double, DBDateTime> FACTORY = new Factory();

    private final ColumnSource<DBDateTime> columnSource1;
    private final ColumnSource<Double> columnSource2;
    private final ColumnSource<DBDateTime> columnSource3;

    public DateTimeDoubleDateTimeColumnTupleSource(
    ...
    protected void convertChunks(@NotNull WritableChunk<? super Attributes.Values> destination, int chunkSize, Chunk<Attributes.Values> [] chunks) {
        ...
        for (int ii = 0; ii < chunkSize; ++ii) {
            destinationObjectChunk.set(ii, new LongDoubleLongTuple(DBTimeUtils.nanos(chunk1.get(ii)), chunk2.get(ii), DBTimeUtils.nanos(chunk3.get(ii))));
        }
        destinationObjectChunk.setSize(chunkSize);
    }

    /** {@link ThreeColumnTupleSourceFactory} for instances of {@link DateTimeDoubleDateTimeColumnTupleSource}. **/
    private static final class Factory implements ThreeColumnTupleSourceFactory<LongDoubleLongTuple, DBDateTime, Double, DBDateTime> {
        ...
        public TupleSource<LongDoubleLongTuple> create(
            ...
            return new DateTimeDoubleDateTimeColumnTupleSource(
                    columnSource1,
                    columnSource2,
                    columnSource3
            );
