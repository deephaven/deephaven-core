...
/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types DateTime, Double, and DateTime.
...
public class DateTimeDoubleDateTimeColumnTupleSource extends AbstractTupleSource<LongDoubleLongTuple> {
    ...
    public static final ThreeColumnTupleSourceFactory<LongDoubleLongTuple, DateTime, Double, DateTime> FACTORY = new Factory();
    ...
    protected void convertChunks(@NotNull WritableChunk<? super Attributes.Values> destination, int chunkSize, Chunk<Attributes.Values> [] chunks) {
        ...
        for (int ii = 0; ii < chunkSize; ++ii) {
            destinationObjectChunk.set(ii, new LongDoubleLongTuple(DateTimeUtils.nanos(chunk1.get(ii)), chunk2.get(ii), DateTimeUtils.nanos(chunk3.get(ii))));
        }
        destinationObjectChunk.setSize(chunkSize);
    }

    /** {@link ThreeColumnTupleSourceFactory} for instances of {@link DateTimeDoubleDateTimeColumnTupleSource}. **/
    private static final class Factory implements ThreeColumnTupleSourceFactory<LongDoubleLongTuple, DateTime, Double, DateTime> {
