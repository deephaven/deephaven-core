...
public class MatchFilter extends SelectFilterImpl {
    ...
    public MatchFilter renameFilter(String newName) {
        io.deephaven.engine.v2.select.MatchFilter.MatchType matchType =
                invertMatch ? io.deephaven.engine.v2.select.MatchFilter.MatchType.Inverted
                        : io.deephaven.engine.v2.select.MatchFilter.MatchType.Regular;
