...
import io.deephaven.engine.util.tuples.generated.ShortLongObjectTuple;
...
/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types Short, DateTime, and Object.
...
public class ShortDateTimeObjectColumnTupleSource extends AbstractTupleSource<ShortLongObjectTuple> {
    ...
    public static final ThreeColumnTupleSourceFactory<ShortLongObjectTuple, Short, DateTime, Object> FACTORY = new Factory();
    ...
    protected void convertChunks(@NotNull WritableChunk<? super Attributes.Values> destination, int chunkSize, Chunk<Attributes.Values> [] chunks) {
        ...
        for (int ii = 0; ii < chunkSize; ++ii) {
            destinationObjectChunk.set(ii, new ShortLongObjectTuple(chunk1.get(ii), DateTimeUtils.nanos(chunk2.get(ii)), chunk3.get(ii)));
        }
        destinationObjectChunk.setSize(chunkSize);
    }

    /** {@link ThreeColumnTupleSourceFactory} for instances of {@link ShortDateTimeObjectColumnTupleSource}. **/
    private static final class Factory implements ThreeColumnTupleSourceFactory<ShortLongObjectTuple, Short, DateTime, Object> {
