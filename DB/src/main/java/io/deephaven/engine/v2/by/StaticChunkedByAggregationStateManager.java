    ...
    // endregion extensions
{
    ...
    private void buildTable(final BuildContext bc,
        ...
        try (final RowSequence.Iterator rsIt = buildIndex.getRowSequenceIterator();
            ...
            final WritableIntChunk<RowKeys> sourceChunkInsertedHashSlots = WritableIntChunk.makeWritableChunk(bc.chunkSize);
            ...
            while (rsIt.hasMore()) {
                ...
                chunkOk.fillRowKeyChunk(sourceChunkIndexKeys);
    ...
    public void doRehash(BuildContext bc
                          ...
                          , WritableIntChunk<RowKeys> sourceChunkInsertedHashSlots
