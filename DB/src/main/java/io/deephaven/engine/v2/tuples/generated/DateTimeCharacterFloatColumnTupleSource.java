...
import io.deephaven.engine.util.tuples.generated.LongCharFloatTuple;
...
/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types DBDateTime, Character, and Float.
...
public class DateTimeCharacterFloatColumnTupleSource extends AbstractTupleSource<LongCharFloatTuple> {
    ...
    public static final ThreeColumnTupleSourceFactory<LongCharFloatTuple, DBDateTime, Character, Float> FACTORY = new Factory();
    ...
    protected void convertChunks(@NotNull WritableChunk<? super Attributes.Values> destination, int chunkSize, Chunk<Attributes.Values> [] chunks) {
        ...
        for (int ii = 0; ii < chunkSize; ++ii) {
            destinationObjectChunk.set(ii, new LongCharFloatTuple(DBTimeUtils.nanos(chunk1.get(ii)), chunk2.get(ii), chunk3.get(ii)));
        }
        destinationObjectChunk.setSize(chunkSize);
    }

    /** {@link ThreeColumnTupleSourceFactory} for instances of {@link DateTimeCharacterFloatColumnTupleSource}. **/
    private static final class Factory implements ThreeColumnTupleSourceFactory<LongCharFloatTuple, DBDateTime, Character, Float> {
