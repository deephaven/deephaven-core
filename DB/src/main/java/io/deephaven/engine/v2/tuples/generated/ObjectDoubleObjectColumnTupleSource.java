...
import io.deephaven.engine.util.tuples.generated.ObjectDoubleObjectTuple;
...
public class ObjectDoubleObjectColumnTupleSource extends AbstractTupleSource<ObjectDoubleObjectTuple> {
    ...
    @Override
    public final ObjectDoubleObjectTuple createTuple(final long indexKey) {
    ...
    @Override
    public final ObjectDoubleObjectTuple createPreviousTuple(final long indexKey) {
        return new ObjectDoubleObjectTuple(
    ...
    @Override
    public final <ELEMENT_TYPE> void exportElement(@NotNull final ObjectDoubleObjectTuple tuple, final int elementIndex, @NotNull final WritableSource<ELEMENT_TYPE> writableSource, final long destinationIndexKey) {
        if (elementIndex == 0) {
    ...
    @Override
    public final Object exportToExternalKey(@NotNull final ObjectDoubleObjectTuple tuple) {
        return new SmartKey(
    ...
    protected void convertChunks(@NotNull WritableChunk<? super Attributes.Values> destination, int chunkSize, Chunk<Attributes.Values> [] chunks) {
        WritableObjectChunk<ObjectDoubleObjectTuple, ? super Attributes.Values> destinationObjectChunk = destination.asWritableObjectChunk();
