 ...
 * rowSet key.
 */
public final class ObjectSegmentedSortedArray implements SegmentedSortedArray {
     ...
     */
    public ObjectSegmentedSortedArray(int leafSize) {
    ...
    public void insert(Chunk<? extends Any> valuesToInsert, LongChunk<? extends Attributes.RowKeys> indicesToInsert) {
        insert(valuesToInsert.asObjectChunk(), indicesToInsert);
    }
    ...
    public <T extends Any> int insertAndGetNextValue(Chunk<T> valuesToInsert, LongChunk<? extends Attributes.RowKeys> indicesToInsert, WritableChunk<T> nextValue) {
        ...
        return findNext(valuesToInsert.asObjectChunk(), indicesToInsert, nextValue.asWritableObjectChunk());
    }
     ...
     */
    private <T extends Any> int findNext(ObjectChunk<Object, T> stampValues, LongChunk<? extends Attributes.RowKeys> stampIndices, WritableObjectChunk<Object, T> nextValues) {
    ...
    private static <T extends Any> int findNextOneLeaf(int offset, ObjectChunk<Object, T> stampValues, LongChunk<? extends Attributes.RowKeys> stampIndices, WritableObjectChunk<Object, T> nextValues, int leafSize, Object [] leafValues, long [] leafKeys) {
        int lo = 0;
     ...
     */
    void insert(ObjectChunk<Object, ? extends Any> valuesToInsert, LongChunk<? extends RowKeys> indicesToInsert) {
    ...
    private void copyToLeaf(int leafOffset, Object[] leafValues, ObjectChunk<Object, ? extends Any> insertValues, long[] leafIndices, LongChunk<? extends Attributes.RowKeys> insertIndices) {
        copyToLeaf(leafOffset, leafValues, insertValues, leafIndices, insertIndices, 0, insertIndices.size());
    }

    private void copyToLeaf(int leafOffset, Object[] leafValues, ObjectChunk<Object, ? extends Any> insertValues, long[] leafIndices, LongChunk<? extends Attributes.RowKeys> insertIndices, int srcOffset, int length) {
    ...
    private void moveLeafValues(Object[] leafValues, long[] leafIndices, int srcPos, int destPos, int length) {
        System.arraycopy(leafValues, srcPos, leafValues, destPos, length);
        System.arraycopy(leafIndices, srcPos, leafIndices, destPos, length);
    }
    ...
    private void distributeValues(int targetSize, int startingLeaf, int distributionSlots, ObjectChunk<Object, ? extends Any> valuesToInsert, LongChunk<? extends Attributes.RowKeys> indices) {
    ...
    private void makeSingletonLeaf(ObjectChunk<Object, ? extends Any> values, LongChunk<? extends Attributes.RowKeys> indices) {
    ...
    private void makeLeavesInitial(ObjectChunk<Object, ? extends Any> values, LongChunk<? extends RowKeys> indices) {
    ...
    private void insertIntoLeaf(int leafSize, Object [] leafValues, ObjectChunk<Object, ? extends Any> insertValues, long [] leafIndices, LongChunk<? extends Attributes.RowKeys> insertIndices) {
    ...
    private boolean isAfterLeaf(int leafSize, Object[] leafValues, ObjectChunk<Object, ? extends Any> insertValues, long[] leafIndices, LongChunk<? extends RowKeys> insertIndices) {
    ...
    private void removeFromLeaf(int leafSize, Object [] leafValues, ObjectChunk<Object, ? extends Any> removeValues, long [] leafIndices, LongChunk<? extends RowKeys> removeIndices, @Nullable WritableLongChunk<? extends Attributes.RowKeys> priorRedirections, long firstPriorRedirection) {
    ...
    private static int lowerBound(ObjectChunk<Object, ? extends Any> valuesToSearch, LongChunk<? extends Attributes.RowKeys> indicesToSearch, int lo, int hi, Object searchValue, long searchKey) {
        while (lo < hi) {
    ...
    private static int upperBound(ObjectChunk<Object, ? extends Any> valuesToSearch, LongChunk<? extends RowKeys> indicesToSearch, int lo, int hi, Object searchValue, long searchKey) {
        while (lo < hi) {
            final int mid = (lo + hi) >>> 1;
            final Object testValue = valuesToSearch.get(mid);
            final int comparison = doComparison(testValue, searchValue);
    ...
    private static int lowerBound(Object [] valuesToSearch, long [] indicesToSearch, int lo, int hi, Object searchValue, long searchKey) {
        while (lo < hi) {
            final int mid = (lo + hi) >>> 1;
     ...
     */
    private static int bound(Object [] valuesToSearch, long [] indicesToSearch, final Object searchValue, long searchIndex, int lo, int hi) {
        while (lo < hi) {
            final int mid = (lo + hi) >>> 1;
            final Object testValue = valuesToSearch[mid];
            final int comparison = doComparison(testValue, searchValue);
    ...
    public void remove(Chunk<? extends Any> valuesToRemove, LongChunk<? extends Attributes.RowKeys> indicesToRemove) {
        remove(valuesToRemove.asObjectChunk(), indicesToRemove);
    }
    ...
    public void removeAndGetPrior(Chunk<? extends Any> stampChunk, LongChunk<? extends RowKeys> indicesToRemove, WritableLongChunk<? extends Attributes.RowKeys> priorRedirections) {
        removeAndGetNextInternal(stampChunk.asObjectChunk(), indicesToRemove, priorRedirections);
    }

    private void remove(ObjectChunk<Object, ? extends Any> valuesToRemove, LongChunk<? extends Attributes.RowKeys> indicesToRemove) {
     ...
     */
    private void removeAndGetNextInternal(ObjectChunk<Object, ? extends Any> valuesToRemove, LongChunk<? extends RowKeys> indicesToRemove, @Nullable WritableLongChunk<? extends Attributes.RowKeys> priorRedirections) {
        validate();
    ...
    private void shiftLeaf(int leafSize, Object [] leafValues, ObjectChunk<Object, ? extends Any> shiftValues, long [] leafIndices, LongChunk<? extends Attributes.RowKeys> shiftIndices, long shiftDelta) {
        Assert.leq(leafSize, "leafSize", this.leafSize, "this.leafSize");
    ...
    private void shiftLeafReverse(int leafSize, Object [] leafValues, ObjectChunk<Object, ? extends Any> shiftValues, long [] leafIndices, LongChunk<? extends Attributes.RowKeys> shiftIndices, long shiftDelta) {
        Assert.leq(leafSize, "leafSize", this.leafSize, "this.leafSize");
        final int shiftSize = shiftValues.size();
    ...
    private static void validateLeaf(Object[] values, long[] indices, int size) {
        if (!SEGMENTED_SORTED_ARRAY_VALIDATION) {
            return;
        }
     ...
     */
    ObjectChunk<Object, ? extends Any> asObjectChunk() {
    ...
    public SsaChecker makeChecker() {
        return ObjectSsaChecker.INSTANCE;
    }
}
