 ...
 *
 * @see io.deephaven.engine.v2.select.python.FilterKernelPythonSingularFunction
 */
class FilterKernelPythonChunkedFunction implements FilterKernel<FilterKernel.Context> {
    ...
    public LongChunk<OrderedRowKeys> filter(
        ...
        final io.deephaven.engine.v2.select.python.ArgumentsChunked arguments =
                io.deephaven.engine.v2.select.python.ArgumentsChunked.buildArguments(inputChunks);
