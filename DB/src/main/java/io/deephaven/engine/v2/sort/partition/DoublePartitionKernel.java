...
//    }
    ...
    private static void samplePivots(Index index, int nPartitions, WritableLongChunk<RowKeys> pivotKeys, WritableDoubleChunk<Any> pivotValues, ColumnSource<Double> columnSource) {
        pivotKeys.setSize(0);
