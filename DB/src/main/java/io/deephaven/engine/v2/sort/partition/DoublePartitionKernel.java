...
//    }
    ...
    public static PartitionKernelContext createContext(RowSet rowSet, ColumnSource<Double> columnSource, int chunkSize, int nPartitions, boolean preserveEquality) {
    ...
    private static void samplePivots(RowSet rowSet, int nPartitions, WritableLongChunk<RowKeys> pivotKeys, WritableDoubleChunk<Any> pivotValues, ColumnSource<Double> columnSource) {
        pivotKeys.setSize(0);
