...
public class IntChunkedUniqueOperator implements IterativeChunkedAggregationOperator {
    ...
    private UpdateCommitter<IntChunkedUniqueOperator> prevFlusher = null;
    ...
    public IntChunkedUniqueOperator(
            ...
            String name, boolean countNulls, boolean exposeInternal, int noValueKey, int nonUniqueKey) {
        this.name = name;
    ...
    private static void flushPrevious(IntChunkedUniqueOperator op) {
