...
/**
 * Chunked aggregation operator for sorted first/last-by using a Object sort-column on stream tables.
 */
public class ObjectStreamSortedFirstOrLastChunkedOperator extends CopyingPermutedStreamFirstOrLastChunkedOperator {
