...
/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types Short, DateTime, and DateTime.
...
public class ShortDateTimeDateTimeColumnTupleSource extends AbstractTupleSource<ShortLongLongTuple> {
    ...
    public static final ThreeColumnTupleSourceFactory<ShortLongLongTuple, Short, DateTime, DateTime> FACTORY = new Factory();
    ...
    protected void convertChunks(@NotNull WritableChunk<? super Attributes.Values> destination, int chunkSize, Chunk<Attributes.Values> [] chunks) {
        ...
        for (int ii = 0; ii < chunkSize; ++ii) {
            destinationObjectChunk.set(ii, new ShortLongLongTuple(chunk1.get(ii), DateTimeUtils.nanos(chunk2.get(ii)), DateTimeUtils.nanos(chunk3.get(ii))));
        }
        destinationObjectChunk.setSize(chunkSize);
    }

    /** {@link ThreeColumnTupleSourceFactory} for instances of {@link ShortDateTimeDateTimeColumnTupleSource}. **/
    private static final class Factory implements ThreeColumnTupleSourceFactory<ShortLongLongTuple, Short, DateTime, DateTime> {
