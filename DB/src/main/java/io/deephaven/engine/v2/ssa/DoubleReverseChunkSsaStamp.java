...
public class DoubleReverseChunkSsaStamp implements ChunkSsaStamp {
    ...
    private static void processEntry(DoubleChunk<Values> leftStampValues, Chunk<Attributes.RowKeys> leftStampKeys, DoubleReverseSegmentedSortedArray ssa, WritableLongChunk<Attributes.RowKeys> rightKeysForLeft, boolean disallowExactMatch) {
    ...
    private static void processInsertion(DoubleChunk<Values> leftStampValues, LongChunk<Attributes.RowKeys> leftStampKeys, DoubleChunk<? extends Values> rightStampChunk, LongChunk<Attributes.RowKeys> rightKeys, DoubleChunk<Values> nextRightValue, WritableRowRedirection rowRedirection, RowSetBuilderRandom modifiedBuilder, boolean endsWithLastValue, boolean disallowExactMatch) {
    ...
    private static int findModified(int leftLowIdx, DoubleChunk<Values> leftStampValues, LongChunk<Attributes.RowKeys> leftStampKeys, RowRedirection rowRedirection, DoubleChunk<? extends Values> rightStampChunk, LongChunk<Attributes.RowKeys> rightStampIndices, RowSetBuilderRandom modifiedBuilder, boolean disallowExactMatch) {
        for (int ii = 0; ii < rightStampChunk.size(); ++ii) {
            final double rightStampValue = rightStampChunk.get(ii);
    ...
    private void applyShift(DoubleChunk<Values> leftStampValues, LongChunk<Attributes.RowKeys> leftStampKeys, DoubleChunk<? extends Values> rightStampChunk, LongChunk<Attributes.RowKeys> rightStampKeys, long shiftDelta, WritableRowRedirection rowRedirection, boolean disallowExactMatch) {
        int leftLowIdx = 0;
        for (int ii = 0; ii < rightStampChunk.size(); ++ii) {
            final double rightStampValue = rightStampChunk.get(ii);
