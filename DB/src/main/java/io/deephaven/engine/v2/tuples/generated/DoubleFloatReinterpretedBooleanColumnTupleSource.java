...
import io.deephaven.engine.util.tuples.generated.DoubleFloatByteTuple;
...
public class DoubleFloatReinterpretedBooleanColumnTupleSource extends AbstractTupleSource<DoubleFloatByteTuple> {

    /** {@link ThreeColumnTupleSourceFactory} instance to create instances of {@link DoubleFloatReinterpretedBooleanColumnTupleSource}. **/
    ...
    public DoubleFloatReinterpretedBooleanColumnTupleSource(
    ...
    @Override
    public final <ELEMENT_TYPE> void exportElement(@NotNull final DoubleFloatByteTuple tuple, final int elementIndex, @NotNull final WritableSource<ELEMENT_TYPE> writableSource, final long destinationIndexKey) {
        if (elementIndex == 0) {
    ...
    /** {@link ThreeColumnTupleSourceFactory} for instances of {@link DoubleFloatReinterpretedBooleanColumnTupleSource}. **/
    private static final class Factory implements ThreeColumnTupleSourceFactory<DoubleFloatByteTuple, Double, Float, Byte> {
        ...
        public TupleSource<DoubleFloatByteTuple> create(
            ...
            return new DoubleFloatReinterpretedBooleanColumnTupleSource(
                    columnSource1,
                    columnSource2,
                    columnSource3
            );
