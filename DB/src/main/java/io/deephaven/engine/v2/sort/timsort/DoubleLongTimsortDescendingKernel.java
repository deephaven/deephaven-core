...
public class DoubleLongTimsortDescendingKernel {
    ...
    // region Context
    public static class DoubleLongSortKernelContext<ATTR extends Any, KEY_INDICES extends Keys> implements LongSortKernel<ATTR, KEY_INDICES> {
        int minGallop;
        int runCount = 0;
    ...
    public static <ATTR extends Any, KEY_INDICES extends Keys> DoubleLongSortKernelContext<ATTR, KEY_INDICES> createContext(int size) {
     ...
     */
    static <ATTR extends Any, KEY_INDICES extends Keys> void sort(DoubleLongSortKernelContext<ATTR, KEY_INDICES> context, WritableLongChunk<KEY_INDICES> indexKeys, WritableDoubleChunk<ATTR> valuesToSort, IntChunk<? extends ChunkPositions> offsetsIn, IntChunk<? extends ChunkLengths> lengthsIn) {
     ...
     * runs sorted on each pass.
     */
    public static <ATTR extends Any, KEY_INDICES extends Keys> void sort(DoubleLongSortKernelContext<ATTR, KEY_INDICES> context, WritableLongChunk<KEY_INDICES> indexKeys, WritableDoubleChunk<ATTR> valuesToSort) {
        timSort(context, indexKeys, valuesToSort, 0, indexKeys.size());
    }

    static private <ATTR extends Any, KEY_INDICES extends Keys> void timSort(DoubleLongSortKernelContext<ATTR, KEY_INDICES> context, WritableLongChunk<KEY_INDICES> indexKeys, WritableDoubleChunk<ATTR> valuesToSort, int offset, int length) {
        if (length <= 1) {
            return;
        }
     ...
     */
    private static <ATTR extends Any, KEY_INDICES extends Keys> void ensureMergeInvariants(DoubleLongSortKernelContext<ATTR, KEY_INDICES> context, WritableLongChunk<KEY_INDICES> indexKeys, WritableDoubleChunk<ATTR> valuesToSort) {
        while (context.runCount > 1) {
    ...
    private static <ATTR extends Any, KEY_INDICES extends Keys> void merge(DoubleLongSortKernelContext<ATTR, KEY_INDICES> context, WritableLongChunk<KEY_INDICES> indexKeys, WritableDoubleChunk<ATTR> valuesToSort, int start1, int length1, int length2) {
     ...
     */
    private static <ATTR extends Any, KEY_INDICES extends Keys> void frontMerge(DoubleLongSortKernelContext<ATTR, KEY_INDICES> context, WritableLongChunk<KEY_INDICES> indexKeys, WritableDoubleChunk<ATTR> valuesToSort, final int mergeStartPosition, final int start2, final int length2) {
        int tempCursor = 0;
     ...
     * We eventually need to do galloping here, but are skipping that for now
     */
    private static <ATTR extends Any, KEY_INDICES extends Keys> void backMerge(DoubleLongSortKernelContext<ATTR, KEY_INDICES> context, WritableLongChunk<KEY_INDICES> indexKeys, WritableDoubleChunk<ATTR> valuesToSort, final int mergeStartPosition, final int length1) {
    ...
    private static <ATTR extends Any, KEY_INDICES extends Keys> void copyToTemporary(DoubleLongSortKernelContext<ATTR, KEY_INDICES> context, WritableLongChunk<KEY_INDICES> indexKeys, WritableDoubleChunk<ATTR> valuesToSort, int mergeStartPosition, int remaining1) {
    ...
    private static <ATTR extends Any, KEY_INDICES extends Keys> void copyToChunk(LongChunk<KEY_INDICES> indexSource, DoubleChunk<ATTR> valuesSource, WritableLongChunk<KEY_INDICES> indexDest, WritableDoubleChunk<ATTR> valuesDest, int sourceStart, int destStart, int length) {
    ...
    private static void insertionSort(WritableLongChunk<? extends Keys> indexKeys, WritableDoubleChunk<?> valuesToSort, int offset, int length) {
    ...
    static private void swap(WritableLongChunk<? extends Keys> indexKeys, WritableDoubleChunk<?> valuesToSort, int a, int b) {
