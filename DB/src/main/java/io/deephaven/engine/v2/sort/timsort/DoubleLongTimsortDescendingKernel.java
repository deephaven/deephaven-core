...
public class DoubleLongTimsortDescendingKernel {
    ...
    private static <ATTR extends Any, KEY_INDICES extends Indices> void copyToChunk(LongChunk<KEY_INDICES> indexSource, DoubleChunk<ATTR> valuesSource, WritableLongChunk<KEY_INDICES> indexDest, WritableDoubleChunk<ATTR> valuesDest, int sourceStart, int destStart, int length) {
