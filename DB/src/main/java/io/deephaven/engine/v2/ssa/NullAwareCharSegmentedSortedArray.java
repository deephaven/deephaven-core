 ...
 * rowSet key.
 */
public final class NullAwareCharSegmentedSortedArray implements SegmentedSortedArray {
    ...
    /**
     * Create a NullAwareCharSegmentedSortedArray with the given leafSize.
     *
     * @param leafSize the maximumSize for any leaf
     */
    public NullAwareCharSegmentedSortedArray(int leafSize) {
