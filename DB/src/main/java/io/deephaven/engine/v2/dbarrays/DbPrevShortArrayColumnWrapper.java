...
public class DbPrevShortArrayColumnWrapper extends DbShortArray.Indirect {
    ...
    public DbPrevShortArrayColumnWrapper(@NotNull final ColumnSource<Short> columnSource, @NotNull final TrackingMutableRowSet rowSet) {
    ...
    private DbPrevShortArrayColumnWrapper(@NotNull final ColumnSource<Short> columnSource, @NotNull final TrackingMutableRowSet rowSet,
    ...
    public DbShortArray subArray(long fromIndex, long toIndex) {
        ...
        return new DbPrevShortArrayColumnWrapper(columnSource, rowSet.subSetByPositionRange(realFrom, realTo), newStartPadding, newEndPadding, true);
    }
