...
public class DbPrevShortArrayColumnWrapper extends DbShortArray.Indirect {
    ...
    public DbPrevShortArrayColumnWrapper(@NotNull final ColumnSource<Short> columnSource, @NotNull final TrackingRowSet rowSet) {
    ...
    private DbPrevShortArrayColumnWrapper(@NotNull final ColumnSource<Short> columnSource, @NotNull final TrackingRowSet rowSet,
