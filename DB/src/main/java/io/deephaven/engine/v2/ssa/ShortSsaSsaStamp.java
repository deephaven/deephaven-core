...
public class ShortSsaSsaStamp implements SsaSsaStamp {
    ...
    static private void processRemovals(ShortSegmentedSortedArray leftSsa, ShortChunk<? extends Values> rightStampChunk, LongChunk<RowKeys> rightKeys, WritableLongChunk<RowKeys> nextRedirections, RedirectionIndex redirectionIndex, Index.RandomBuilder modifiedBuilder, boolean disallowExactMatch) {
    ...
    static private void processInsertion(ShortSegmentedSortedArray leftSsa, ShortChunk<? extends Values> rightStampChunk, LongChunk<RowKeys> rightKeys, ShortChunk<Values> nextRightValue, RedirectionIndex redirectionIndex, Index.RandomBuilder modifiedBuilder, boolean endsWithLastValue, boolean disallowExactMatch) {
    ...
    private static void findModified(ShortSegmentedSortedArray leftSsa, RedirectionIndex redirectionIndex, ShortChunk<? extends Values> rightStampChunk, LongChunk<RowKeys> rightStampIndices, Index.RandomBuilder modifiedBuilder, boolean disallowExactMatch) {
        final ShortSegmentedSortedArray.Iterator leftIt = leftSsa.iterator(disallowExactMatch, false);
    ...
    private void applyShift(ShortSegmentedSortedArray leftSsa, ShortChunk<? extends Values> rightStampChunk, LongChunk<RowKeys> rightStampKeys, long shiftDelta, RedirectionIndex redirectionIndex, boolean disallowExactMatch) {
        final ShortSegmentedSortedArray.Iterator leftIt = leftSsa.iterator(disallowExactMatch, false);
