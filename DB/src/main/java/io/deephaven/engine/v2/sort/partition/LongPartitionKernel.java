...
//    }
    ...
    private static void samplePivots(Index index, int nPartitions, WritableLongChunk<RowKeys> pivotKeys, WritableLongChunk<Any> pivotValues, ColumnSource<Long> columnSource) {
        pivotKeys.setSize(0);
