...
//    }
    ...
    public static PartitionKernelContext createContext(RowSet rowSet, ColumnSource<Long> columnSource, int chunkSize, int nPartitions, boolean preserveEquality) {
    ...
    private static void samplePivots(RowSet rowSet, int nPartitions, WritableLongChunk<RowKeys> pivotKeys, WritableLongChunk<Any> pivotValues, ColumnSource<Long> columnSource) {
        pivotKeys.setSize(0);
