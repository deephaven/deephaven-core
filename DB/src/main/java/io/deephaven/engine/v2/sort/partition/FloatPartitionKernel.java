...
//    }
    ...
    public static PartitionKernelContext createContext(RowSet rowSet, ColumnSource<Float> columnSource, int chunkSize, int nPartitions, boolean preserveEquality) {
    ...
    private static void samplePivots(RowSet rowSet, int nPartitions, WritableLongChunk<RowKeys> pivotKeys, WritableFloatChunk<Any> pivotValues, ColumnSource<Float> columnSource) {
        pivotKeys.setSize(0);
