...
//    }
    ...
    private static void samplePivots(Index index, int nPartitions, WritableLongChunk<RowKeys> pivotKeys, WritableFloatChunk<Any> pivotValues, ColumnSource<Float> columnSource) {
        pivotKeys.setSize(0);
