...
import io.deephaven.engine.util.tuples.generated.IntLongShortTuple;
...
public class IntegerReinterpretedDateTimeShortColumnTupleSource extends AbstractTupleSource<IntLongShortTuple> {
    ...
    @Override
    public final <ELEMENT_TYPE> void exportElement(@NotNull final IntLongShortTuple tuple, final int elementIndex, @NotNull final WritableSource<ELEMENT_TYPE> writableSource, final long destinationIndexKey) {
        if (elementIndex == 0) {
