...
public class IntRangeFilter extends AbstractRangeFilter {
    ...
    private long bound(TrackingMutableRowSet selection, boolean usePrev, ColumnSource<Integer> longColumnSource, long minPosition, long maxPosition, int targetValue, boolean inclusive, int compareSign, boolean end) {
