...
import io.deephaven.engine.util.tuples.generated.IntLongIntTuple;
...
/**
 * <p>{@link TupleSource} that produces key column values from {@link ColumnSource} types Integer, DateTime, and Integer.
...
public class IntegerDateTimeIntegerColumnTupleSource extends AbstractTupleSource<IntLongIntTuple> {
    ...
    public static final ThreeColumnTupleSourceFactory<IntLongIntTuple, Integer, DateTime, Integer> FACTORY = new Factory();
    ...
    private static final class Factory implements ThreeColumnTupleSourceFactory<IntLongIntTuple, Integer, DateTime, Integer> {
