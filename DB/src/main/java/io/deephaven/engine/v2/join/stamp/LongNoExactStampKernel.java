...
public class LongNoExactStampKernel implements StampKernel {
    ...
    static private void computeRedirections(LongChunk<Values> leftStamps, LongChunk<Values> rightStamps, LongChunk<Attributes.RowKeys> rightKeyIndices, WritableLongChunk<Attributes.RowKeys> leftRedirections) {
