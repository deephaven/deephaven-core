...
import io.deephaven.engine.util.tuples.generated.LongShortIntTuple;
...
public class ReinterpretedDateTimeShortIntegerColumnTupleSource extends AbstractTupleSource<LongShortIntTuple> {
    ...
    @Override
    public final <ELEMENT_TYPE> void exportElement(@NotNull final LongShortIntTuple tuple, final int elementIndex, @NotNull final WritableSource<ELEMENT_TYPE> writableSource, final long destinationIndexKey) {
        if (elementIndex == 0) {
