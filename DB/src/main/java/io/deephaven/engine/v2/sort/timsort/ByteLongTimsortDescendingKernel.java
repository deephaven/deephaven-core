...
public class ByteLongTimsortDescendingKernel {
    ...
    private static <ATTR extends Any, KEY_INDICES extends Indices> void copyToChunk(LongChunk<KEY_INDICES> indexSource, ByteChunk<ATTR> valuesSource, WritableLongChunk<KEY_INDICES> indexDest, WritableByteChunk<ATTR> valuesDest, int sourceStart, int destStart, int length) {
