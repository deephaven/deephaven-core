...
//    }
    ...
    private static void samplePivots(Index index, int nPartitions, WritableLongChunk<RowKeys> pivotKeys, WritableObjectChunk<Object, Any> pivotValues, ColumnSource<Object> columnSource) {
        pivotKeys.setSize(0);
