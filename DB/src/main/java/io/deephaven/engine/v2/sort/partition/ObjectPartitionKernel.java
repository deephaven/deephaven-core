...
//    }
    ...
    public static PartitionKernelContext createContext(TrackingMutableRowSet rowSet, ColumnSource<Object> columnSource, int chunkSize, int nPartitions, boolean preserveEquality) {
    ...
    private static void samplePivots(TrackingMutableRowSet rowSet, int nPartitions, WritableLongChunk<RowKeys> pivotKeys, WritableObjectChunk<Object, Any> pivotValues, ColumnSource<Object> columnSource) {
        pivotKeys.setSize(0);
