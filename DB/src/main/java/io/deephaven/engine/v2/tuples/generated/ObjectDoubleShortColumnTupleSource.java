...
import io.deephaven.engine.util.tuples.generated.ObjectDoubleShortTuple;
...
public class ObjectDoubleShortColumnTupleSource extends AbstractTupleSource<ObjectDoubleShortTuple> {
    ...
    @Override
    public final ObjectDoubleShortTuple createTuple(final long indexKey) {
    ...
    @Override
    public final ObjectDoubleShortTuple createPreviousTuple(final long indexKey) {
        return new ObjectDoubleShortTuple(
    ...
    @Override
    public final <ELEMENT_TYPE> void exportElement(@NotNull final ObjectDoubleShortTuple tuple, final int elementIndex, @NotNull final WritableSource<ELEMENT_TYPE> writableSource, final long destinationIndexKey) {
        if (elementIndex == 0) {
    ...
    protected void convertChunks(@NotNull WritableChunk<? super Attributes.Values> destination, int chunkSize, Chunk<Attributes.Values> [] chunks) {
        WritableObjectChunk<ObjectDoubleShortTuple, ? super Attributes.Values> destinationObjectChunk = destination.asWritableObjectChunk();
