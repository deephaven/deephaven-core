...
public class FloatSsaSsaStamp implements SsaSsaStamp {
    ...
    private static void processEntry(FloatSegmentedSortedArray leftSsa, FloatSegmentedSortedArray rightSsa, MutableRowRedirection rowRedirection, boolean disallowExactMatch) {
    ...
    private static void fillWithNull(MutableRowRedirection rowRedirection, FloatSegmentedSortedArray.Iterator leftIt) {
        while (leftIt.hasNext()) {
            leftIt.next();
            rowRedirection.removeVoid(leftIt.getKey());
        }
    ...
    private static void fillWithValue(MutableRowRedirection rowRedirection, FloatSegmentedSortedArray.Iterator leftIt, long rightKey) {
        while (leftIt.hasNext()) {
            leftIt.next();
    ...
    private void applyShift(FloatSegmentedSortedArray leftSsa, FloatChunk<? extends Values> rightStampChunk, LongChunk<Attributes.RowKeys> rightStampKeys, long shiftDelta, MutableRowRedirection rowRedirection, boolean disallowExactMatch) {
        final FloatSegmentedSortedArray.Iterator leftIt = leftSsa.iterator(disallowExactMatch, false);
