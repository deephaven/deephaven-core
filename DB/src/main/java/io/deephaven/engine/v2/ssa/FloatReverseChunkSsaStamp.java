...
public class FloatReverseChunkSsaStamp implements ChunkSsaStamp {
    ...
    private static void processEntry(FloatChunk<Values> leftStampValues, Chunk<KeyIndices> leftStampKeys, FloatReverseSegmentedSortedArray ssa, WritableLongChunk<KeyIndices> rightKeysForLeft, boolean disallowExactMatch) {
    ...
    private static void processInsertion(FloatChunk<Values> leftStampValues, LongChunk<KeyIndices> leftStampKeys, FloatChunk<? extends Values> rightStampChunk, LongChunk<KeyIndices> rightKeys, FloatChunk<Values> nextRightValue, RedirectionIndex redirectionIndex, Index.RandomBuilder modifiedBuilder, boolean endsWithLastValue, boolean disallowExactMatch) {
    ...
    private static int findModified(int leftLowIdx, FloatChunk<Values> leftStampValues, LongChunk<KeyIndices> leftStampKeys, RedirectionIndex redirectionIndex, FloatChunk<? extends Values> rightStampChunk, LongChunk<KeyIndices> rightStampIndices, Index.RandomBuilder modifiedBuilder, boolean disallowExactMatch) {
        for (int ii = 0; ii < rightStampChunk.size(); ++ii) {
            final float rightStampValue = rightStampChunk.get(ii);
    ...
    private void applyShift(FloatChunk<Values> leftStampValues, LongChunk<KeyIndices> leftStampKeys, FloatChunk<? extends Values> rightStampChunk, LongChunk<KeyIndices> rightStampKeys, long shiftDelta, RedirectionIndex redirectionIndex, boolean disallowExactMatch) {
        int leftLowIdx = 0;
        for (int ii = 0; ii < rightStampChunk.size(); ++ii) {
            final float rightStampValue = rightStampChunk.get(ii);
