...
public class BooleanCopyKernel implements CopyKernel {
    public static final BooleanCopyKernel INSTANCE = new BooleanCopyKernel();

    private BooleanCopyKernel() {} // use through the instance
    ...
    public static <T extends Any> void conditionalCopy(
            WritableBooleanChunk<T> output, boolean[] baseInput, boolean[] overInput, long[] useOverInput,
    ...
    public <T extends Any> void conditionalCopy(
            ...
            int srcOffset, int dstOffset, int length)
    {
        boolean[] typedBaseInput = (boolean[]) baseInput;
        boolean[] typedOverInput = (boolean[]) overInput;
