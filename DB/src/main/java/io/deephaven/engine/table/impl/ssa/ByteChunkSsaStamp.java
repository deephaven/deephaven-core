...
public class ByteChunkSsaStamp implements ChunkSsaStamp {
    ...
    private static void processEntry(ByteChunk<Values> leftStampValues, Chunk<Attributes.RowKeys> leftStampKeys, ByteSegmentedSortedArray ssa, WritableLongChunk<Attributes.RowKeys> rightKeysForLeft, boolean disallowExactMatch) {
