 ...
 */
public class FloatChunkedCountDistinctOperator implements IterativeChunkedAggregationOperator {
    ...
    private static void flushPrevious(FloatChunkedCountDistinctOperator op) {
    ...
    public void startTrackingPrevValues() {
        ...
        if(exposeInternal) {
            ...
            prevFlusher = new UpdateCommitter<>(this, FloatChunkedCountDistinctOperator::flushPrevious);
