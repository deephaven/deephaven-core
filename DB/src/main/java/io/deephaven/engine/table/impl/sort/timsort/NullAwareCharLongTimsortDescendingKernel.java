 ...
 * the algorithm.
 */
public class NullAwareCharLongTimsortDescendingKernel {
    ...
    public static class CharLongSortKernelContext<ATTR extends Any, KEY_INDICES extends Indices> implements LongSortKernel<ATTR, KEY_INDICES> {
        ...
        public void sort(WritableLongChunk<KEY_INDICES> indexKeys, WritableChunk<ATTR> valuesToSort) {
            NullAwareCharLongTimsortDescendingKernel.sort(this, indexKeys, valuesToSort.asWritableCharChunk());
        }
        ...
        public void sort(WritableLongChunk<KEY_INDICES> indexKeys, WritableChunk<ATTR> valuesToSort, IntChunk<? extends ChunkPositions> offsetsIn, IntChunk<? extends ChunkLengths> lengthsIn) {
            NullAwareCharLongTimsortDescendingKernel.sort(this, indexKeys, valuesToSort.asWritableCharChunk(), offsetsIn, lengthsIn);
        }
