 ...
 */
public class DoubleRollupDistinctOperator implements IterativeChunkedAggregationOperator {
    ...
    private UpdateCommitter<DoubleRollupDistinctOperator> prevFlusher = null;
    private WritableRowSet touchedStates;

    public DoubleRollupDistinctOperator(
                                      // region Constructor
    ...
    public void startTrackingPrevValues() {
        ...
        prevFlusher = new UpdateCommitter<>(this, DoubleRollupDistinctOperator::flushPrevious);
        touchedStates = RowSetFactory.empty();
        internalResult.startTrackingPrevValues();
    }

    private static void flushPrevious(DoubleRollupDistinctOperator op) {
