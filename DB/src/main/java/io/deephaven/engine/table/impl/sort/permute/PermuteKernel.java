...
import static io.deephaven.engine.chunk.Attributes.ChunkPositions;
...
public interface PermuteKernel {
     ...
     * @param outputPositions a chunk of positions, parallel to inputValues, that indicates the position in outputValues
     *        for the corresponding inputValues value
     * @param outputValues an output chunk, which must be at least as big as the largest value in outputPositions
     */
    <T extends Any> void permute(Chunk<? extends T> inputValues, IntChunk<ChunkPositions> outputPositions,
     ...
     *
     * @param inputPositions a chunk of positions that indicates the position in inputValues to copy to the outputValues
     *        chunk
     * @param inputValues a chunk of values, which must be at least as large as the largest value in inputPositions
     * @param outputPositions a chunk of positions, parallel to inputPositions, that indicates the position in
     *        outputValues for the corresponding inputValues value
     * @param outputValues an output chunk, which must be at least as big as the largest value in outputPositions
     */
    <T extends Any> void permute(IntChunk<ChunkPositions> inputPositions, Chunk<? extends T> inputValues,
     ...
     *
     * @param inputValues a chunk of values, which must be at least as big as the largest value in inputPositions
     * @param inputPositions a chunk of positions, parallel to outputValues, that indicates the position in inputValues
     ...
     */
    <T extends Any> void permuteInput(Chunk<? extends T> inputValues, IntChunk<ChunkPositions> inputPositions,
            WritableChunk<? super T> outputValues);
}
