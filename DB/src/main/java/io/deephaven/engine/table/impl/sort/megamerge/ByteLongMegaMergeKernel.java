...
public class ByteLongMegaMergeKernel {
    ...
    // region Context
    public static class ByteLongMegaMergeKernelContext<ATTR extends Any, KEY_INDICES extends Indices>
        ...
        public void merge(LongArraySource indexDestinationSource, ArrayBackedColumnSource<?> valuesDestinationSource,
            ...
            ByteLongMegaMergeKernel.merge(indexDestinationSource, (ByteArraySource) valuesDestinationSource,
