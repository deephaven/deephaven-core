 ...
 * the algorithm.
 */
public class LongLongTimsortDescendingKernel {
    private LongLongTimsortDescendingKernel() {
    ...
    public static class LongLongSortKernelContext<ATTR extends Any, KEY_INDICES extends Indices> implements LongSortKernel<ATTR, KEY_INDICES> {
        ...
        private LongLongSortKernelContext(int size) {
        ...
        public void sort(WritableLongChunk<KEY_INDICES> indexKeys, WritableChunk<ATTR> valuesToSort) {
            LongLongTimsortDescendingKernel.sort(this, indexKeys, valuesToSort.asWritableLongChunk());
        }
        ...
        public void sort(WritableLongChunk<KEY_INDICES> indexKeys, WritableChunk<ATTR> valuesToSort, IntChunk<? extends ChunkPositions> offsetsIn, IntChunk<? extends ChunkLengths> lengthsIn) {
            LongLongTimsortDescendingKernel.sort(this, indexKeys, valuesToSort.asWritableLongChunk(), offsetsIn, lengthsIn);
        }
    ...
    private static <ATTR extends Any, KEY_INDICES extends Indices> void copyToChunk(LongChunk<KEY_INDICES> rowSetSource, LongChunk<ATTR> valuesSource, WritableLongChunk<KEY_INDICES> indexDest, WritableLongChunk<ATTR> valuesDest, int sourceStart, int destStart, int length) {
...
//    private static void doCheck(Chunk.LongChunk indexKeys, Chunk.LongChunk valuesToSort, int startCheck, int mergeEnd) {
//        long lastCheck;
