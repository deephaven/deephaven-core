 ...
 * ------------------------------------------------------------------------------------------------------------------ */
package io.deephaven.engine.table.impl.utils.compact;
...
public class ByteCompactKernel implements CompactKernel {
     ...
     */
     public static void compact(WritableByteChunk<? extends Any> values, BooleanChunk<Any> retainValues) {
        int writePosition = 0;
    ...
    public static void compactAndCount(WritableByteChunk<? extends Attributes.Values> valueChunk, WritableIntChunk<Attributes.ChunkLengths> counts) {
         compactAndCount(valueChunk, counts, false);
    }

    public static void compactAndCount(WritableByteChunk<? extends Attributes.Values> valueChunk, WritableIntChunk<Attributes.ChunkLengths> counts, boolean countNull) {
    ...
    public static void compactAndCount(WritableByteChunk<? extends Attributes.Values> valueChunk, WritableIntChunk<Attributes.ChunkLengths> counts, IntChunk<Attributes.ChunkPositions> startPositions, WritableIntChunk<Attributes.ChunkLengths> lengths, boolean countNull) {
    ...
    public static int compactAndCount(WritableByteChunk<? extends Attributes.Values> valueChunk, WritableIntChunk<Attributes.ChunkLengths> counts, final int start, final int length, boolean countNull) {
        int wpos = -1;
