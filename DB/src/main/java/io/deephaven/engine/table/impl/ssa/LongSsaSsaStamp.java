...
public class LongSsaSsaStamp implements SsaSsaStamp {
    ...
    private static void findModified(LongSegmentedSortedArray leftSsa, RowRedirection rowRedirection, LongChunk<? extends Values> rightStampChunk, LongChunk<Attributes.RowKeys> rightStampIndices, RowSetBuilderRandom modifiedBuilder, boolean disallowExactMatch) {
        final LongSegmentedSortedArray.Iterator leftIt = leftSsa.iterator(disallowExactMatch, false);
    ...
    private void applyShift(LongSegmentedSortedArray leftSsa, LongChunk<? extends Values> rightStampChunk, LongChunk<Attributes.RowKeys> rightStampKeys, long shiftDelta, WritableRowRedirection rowRedirection, boolean disallowExactMatch) {
        final LongSegmentedSortedArray.Iterator leftIt = leftSsa.iterator(disallowExactMatch, false);
