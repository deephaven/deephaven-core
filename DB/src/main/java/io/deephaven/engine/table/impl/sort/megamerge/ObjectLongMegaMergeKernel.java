...
public class ObjectLongMegaMergeKernel {
    ...
    // region Context
    public static class ObjectLongMegaMergeKernelContext<ATTR extends Any, KEY_INDICES extends Indices>
        ...
        public void merge(LongArraySource indexDestinationSource, ArrayBackedColumnSource<?> valuesDestinationSource,
            ...
            ObjectLongMegaMergeKernel.merge(indexDestinationSource, (ObjectArraySource) valuesDestinationSource,
