...
public class DoubleSsaSsaStamp implements SsaSsaStamp {
    ...
    private void applyShift(DoubleSegmentedSortedArray leftSsa, DoubleChunk<? extends Values> rightStampChunk, LongChunk<Attributes.RowKeys> rightStampKeys, long shiftDelta, WritableRowRedirection rowRedirection, boolean disallowExactMatch) {
        final DoubleSegmentedSortedArray.Iterator leftIt = leftSsa.iterator(disallowExactMatch, false);
