...
/**
 * <p>3-Tuple (triple) key class composed of Object, int, and short elements.
 * <p>Generated by {@link io.deephaven.engine.util.tuples.TupleCodeGenerator}.
 */
public class ObjectIntShortTuple implements Comparable<ObjectIntShortTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<ObjectIntShortTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final ObjectIntShortTuple typedOther = (ObjectIntShortTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final ObjectIntShortTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public ObjectIntShortTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        final Object canonicalizedElement1 = canonicalizer.apply(element1);
        return canonicalizedElement1 == element1
                ? this : new ObjectIntShortTuple(canonicalizedElement1, element2, element3);
    }
}
