...
/**
 * <p>3-Tuple (triple) key class composed of byte, int, and char elements.
 * <p>Generated by {@link io.deephaven.engine.util.tuples.TupleCodeGenerator}.
 */
public class ByteIntCharTuple implements Comparable<ByteIntCharTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<ByteIntCharTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final ByteIntCharTuple typedOther = (ByteIntCharTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final ByteIntCharTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public ByteIntCharTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        return this;
    }
}
