...
/**
 * <p>3-Tuple (triple) key class composed of int, float, and float elements.
 * <p>Generated by {@link io.deephaven.engine.util.tuples.TupleCodeGenerator}.
 */
public class IntFloatFloatTuple implements Comparable<IntFloatFloatTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<IntFloatFloatTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final IntFloatFloatTuple typedOther = (IntFloatFloatTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final IntFloatFloatTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public IntFloatFloatTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        return this;
    }
}
