...
/**
 * <p>3-Tuple (triple) key class composed of long, int, and float elements.
 * <p>Generated by {@link io.deephaven.engine.util.tuples.TupleCodeGenerator}.
 */
public class LongIntFloatTuple implements Comparable<LongIntFloatTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<LongIntFloatTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final LongIntFloatTuple typedOther = (LongIntFloatTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final LongIntFloatTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public LongIntFloatTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        return this;
    }
}
