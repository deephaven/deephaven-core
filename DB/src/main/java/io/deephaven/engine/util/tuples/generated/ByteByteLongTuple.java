...
/**
 * <p>3-Tuple (triple) key class composed of byte, byte, and long elements.
 * <p>Generated by {@link io.deephaven.engine.util.tuples.TupleCodeGenerator}.
 */
public class ByteByteLongTuple implements Comparable<ByteByteLongTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<ByteByteLongTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final ByteByteLongTuple typedOther = (ByteByteLongTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final ByteByteLongTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public ByteByteLongTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        return this;
    }
}
