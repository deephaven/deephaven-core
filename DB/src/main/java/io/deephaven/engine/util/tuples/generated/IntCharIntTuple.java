...
/**
 * <p>3-Tuple (triple) key class composed of int, char, and int elements.
 * <p>Generated by {@link io.deephaven.engine.util.tuples.TupleCodeGenerator}.
 */
public class IntCharIntTuple implements Comparable<IntCharIntTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<IntCharIntTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final IntCharIntTuple typedOther = (IntCharIntTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final IntCharIntTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public IntCharIntTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        return this;
    }
}
