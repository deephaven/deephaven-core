...
/**
 * <p>3-Tuple (triple) key class composed of byte, double, and float elements.
 * <p>Generated by {@link io.deephaven.engine.util.tuples.TupleCodeGenerator}.
 */
public class ByteDoubleFloatTuple implements Comparable<ByteDoubleFloatTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<ByteDoubleFloatTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final ByteDoubleFloatTuple typedOther = (ByteDoubleFloatTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final ByteDoubleFloatTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public ByteDoubleFloatTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        return this;
    }
}
