...
/**
 * <p>3-Tuple (triple) key class composed of float, int, and short elements.
 * <p>Generated by {@link io.deephaven.engine.util.tuples.TupleCodeGenerator}.
 */
public class FloatIntShortTuple implements Comparable<FloatIntShortTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<FloatIntShortTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final FloatIntShortTuple typedOther = (FloatIntShortTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final FloatIntShortTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public FloatIntShortTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        return this;
    }
}
