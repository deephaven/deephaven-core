...
/**
 * <p>3-Tuple (triple) key class composed of byte, char, and float elements.
 * <p>Generated by {@link io.deephaven.engine.util.tuples.TupleCodeGenerator}.
 */
public class ByteCharFloatTuple implements Comparable<ByteCharFloatTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<ByteCharFloatTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final ByteCharFloatTuple typedOther = (ByteCharFloatTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final ByteCharFloatTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public ByteCharFloatTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        return this;
    }
}
