...
/**
 * <p>3-Tuple (triple) key class composed of short, byte, and short elements.
 * <p>Generated by {@link io.deephaven.engine.util.tuples.TupleCodeGenerator}.
 */
public class ShortByteShortTuple implements Comparable<ShortByteShortTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<ShortByteShortTuple> {
    ...
    @Override
    public final int compareTo(@NotNull final ShortByteShortTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public ShortByteShortTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        return this;
    }
}
