...
/**
 * <p>3-Tuple (triple) key class composed of float, char, and long elements.
 * <p>Generated by {@link io.deephaven.engine.util.tuples.TupleCodeGenerator}.
 */
public class FloatCharLongTuple implements Comparable<FloatCharLongTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<FloatCharLongTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final FloatCharLongTuple typedOther = (FloatCharLongTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final FloatCharLongTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public FloatCharLongTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        return this;
    }
}
