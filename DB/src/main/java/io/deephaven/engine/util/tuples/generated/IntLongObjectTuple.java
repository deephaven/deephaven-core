...
/**
 * <p>3-Tuple (triple) key class composed of int, long, and Object elements.
 * <p>Generated by {@link io.deephaven.engine.util.tuples.TupleCodeGenerator}.
 */
public class IntLongObjectTuple implements Comparable<IntLongObjectTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<IntLongObjectTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final IntLongObjectTuple typedOther = (IntLongObjectTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final IntLongObjectTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public IntLongObjectTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        final Object canonicalizedElement3 = canonicalizer.apply(element3);
        return canonicalizedElement3 == element3
                ? this : new IntLongObjectTuple(element1, element2, canonicalizedElement3);
    }
}
