...
/**
 * <p>3-Tuple (triple) key class composed of float, char, and int elements.
 * <p>Generated by {@link io.deephaven.engine.util.tuples.TupleCodeGenerator}.
 */
public class FloatCharIntTuple implements Comparable<FloatCharIntTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<FloatCharIntTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final FloatCharIntTuple typedOther = (FloatCharIntTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final FloatCharIntTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public FloatCharIntTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        return this;
    }
}
