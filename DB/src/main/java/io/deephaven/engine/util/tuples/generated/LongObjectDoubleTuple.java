...
/**
 * <p>3-Tuple (triple) key class composed of long, Object, and double elements.
 * <p>Generated by {@link io.deephaven.engine.util.tuples.TupleCodeGenerator}.
 */
public class LongObjectDoubleTuple implements Comparable<LongObjectDoubleTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<LongObjectDoubleTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final LongObjectDoubleTuple typedOther = (LongObjectDoubleTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final LongObjectDoubleTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public LongObjectDoubleTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        final Object canonicalizedElement2 = canonicalizer.apply(element2);
        return canonicalizedElement2 == element2
                ? this : new LongObjectDoubleTuple(element1, canonicalizedElement2, element3);
    }
}
