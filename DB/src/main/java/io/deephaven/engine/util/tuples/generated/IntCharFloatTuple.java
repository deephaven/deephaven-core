...
/**
 * <p>3-Tuple (triple) key class composed of int, char, and float elements.
 * <p>Generated by {@link io.deephaven.engine.util.tuples.TupleCodeGenerator}.
 */
public class IntCharFloatTuple implements Comparable<IntCharFloatTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<IntCharFloatTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final IntCharFloatTuple typedOther = (IntCharFloatTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final IntCharFloatTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public IntCharFloatTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        return this;
    }
}
