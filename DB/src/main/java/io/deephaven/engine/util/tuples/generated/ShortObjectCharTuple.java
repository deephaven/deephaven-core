...
/**
 * <p>3-Tuple (triple) key class composed of short, Object, and char elements.
 * <p>Generated by {@link io.deephaven.engine.util.tuples.TupleCodeGenerator}.
 */
public class ShortObjectCharTuple implements Comparable<ShortObjectCharTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<ShortObjectCharTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final ShortObjectCharTuple typedOther = (ShortObjectCharTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final ShortObjectCharTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public ShortObjectCharTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        final Object canonicalizedElement2 = canonicalizer.apply(element2);
        return canonicalizedElement2 == element2
                ? this : new ShortObjectCharTuple(element1, canonicalizedElement2, element3);
    }
}
