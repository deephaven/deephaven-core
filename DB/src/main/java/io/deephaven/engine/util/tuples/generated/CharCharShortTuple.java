...
/**
 * <p>3-Tuple (triple) key class composed of char, char, and short elements.
 * <p>Generated by {@link io.deephaven.engine.util.tuples.TupleCodeGenerator}.
 */
public class CharCharShortTuple implements Comparable<CharCharShortTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<CharCharShortTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final CharCharShortTuple typedOther = (CharCharShortTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final CharCharShortTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public CharCharShortTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        return this;
    }
}
