...
/**
 * <p>3-Tuple (triple) key class composed of Object, double, and byte elements.
 * <p>Generated by {@link io.deephaven.engine.util.tuples.TupleCodeGenerator}.
 */
public class ObjectDoubleByteTuple implements Comparable<ObjectDoubleByteTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<ObjectDoubleByteTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final ObjectDoubleByteTuple typedOther = (ObjectDoubleByteTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final ObjectDoubleByteTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public ObjectDoubleByteTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        final Object canonicalizedElement1 = canonicalizer.apply(element1);
        return canonicalizedElement1 == element1
                ? this : new ObjectDoubleByteTuple(canonicalizedElement1, element2, element3);
    }
}
