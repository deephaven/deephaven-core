...
/**
 * <p>3-Tuple (triple) key class composed of char, double, and long elements.
 * <p>Generated by {@link io.deephaven.engine.util.tuples.TupleCodeGenerator}.
 */
public class CharDoubleLongTuple implements Comparable<CharDoubleLongTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<CharDoubleLongTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final CharDoubleLongTuple typedOther = (CharDoubleLongTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final CharDoubleLongTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public CharDoubleLongTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        return this;
    }
}
