...
/**
 * <p>3-Tuple (triple) key class composed of byte, long, and short elements.
 * <p>Generated by {@link io.deephaven.engine.util.tuples.TupleCodeGenerator}.
 */
public class ByteLongShortTuple implements Comparable<ByteLongShortTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<ByteLongShortTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final ByteLongShortTuple typedOther = (ByteLongShortTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final ByteLongShortTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public ByteLongShortTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        return this;
    }
}
