...
/**
 * <p>3-Tuple (triple) key class composed of int, byte, and char elements.
 * <p>Generated by {@link io.deephaven.engine.util.tuples.TupleCodeGenerator}.
 */
public class IntByteCharTuple implements Comparable<IntByteCharTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<IntByteCharTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final IntByteCharTuple typedOther = (IntByteCharTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final IntByteCharTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public IntByteCharTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        return this;
    }
}
