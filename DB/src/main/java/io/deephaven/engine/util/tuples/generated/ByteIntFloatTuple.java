...
/**
 * <p>3-Tuple (triple) key class composed of byte, int, and float elements.
 * <p>Generated by {@link io.deephaven.engine.util.tuples.TupleCodeGenerator}.
 */
public class ByteIntFloatTuple implements Comparable<ByteIntFloatTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<ByteIntFloatTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final ByteIntFloatTuple typedOther = (ByteIntFloatTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final ByteIntFloatTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public ByteIntFloatTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        return this;
    }
}
