...
/**
 * <p>3-Tuple (triple) key class composed of float, short, and float elements.
 * <p>Generated by {@link io.deephaven.engine.util.tuples.TupleCodeGenerator}.
 */
public class FloatShortFloatTuple implements Comparable<FloatShortFloatTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<FloatShortFloatTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final FloatShortFloatTuple typedOther = (FloatShortFloatTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final FloatShortFloatTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public FloatShortFloatTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        return this;
    }
}
