...
/**
 * <p>3-Tuple (triple) key class composed of char, int, and int elements.
 * <p>Generated by {@link io.deephaven.engine.util.tuples.TupleCodeGenerator}.
 */
public class CharIntIntTuple implements Comparable<CharIntIntTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<CharIntIntTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final CharIntIntTuple typedOther = (CharIntIntTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final CharIntIntTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public CharIntIntTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        return this;
    }
}
