...
/**
 * <p>3-Tuple (triple) key class composed of char, char, and float elements.
 * <p>Generated by {@link io.deephaven.engine.util.tuples.TupleCodeGenerator}.
 */
public class CharCharFloatTuple implements Comparable<CharCharFloatTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<CharCharFloatTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final CharCharFloatTuple typedOther = (CharCharFloatTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final CharCharFloatTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public CharCharFloatTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        return this;
    }
}
