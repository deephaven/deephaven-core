...
/**
 * <p>3-Tuple (triple) key class composed of double, byte, and long elements.
 * <p>Generated by {@link io.deephaven.engine.util.tuples.TupleCodeGenerator}.
 */
public class DoubleByteLongTuple implements Comparable<DoubleByteLongTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<DoubleByteLongTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final DoubleByteLongTuple typedOther = (DoubleByteLongTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final DoubleByteLongTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public DoubleByteLongTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        return this;
    }
}
