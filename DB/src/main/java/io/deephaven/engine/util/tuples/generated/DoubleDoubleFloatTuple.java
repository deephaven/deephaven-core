...
/**
 * <p>3-Tuple (triple) key class composed of double, double, and float elements.
 * <p>Generated by {@link io.deephaven.engine.util.tuples.TupleCodeGenerator}.
 */
public class DoubleDoubleFloatTuple implements Comparable<DoubleDoubleFloatTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<DoubleDoubleFloatTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final DoubleDoubleFloatTuple typedOther = (DoubleDoubleFloatTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final DoubleDoubleFloatTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public DoubleDoubleFloatTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        return this;
    }
}
