...
/**
 * <p>3-Tuple (triple) key class composed of long, byte, and byte elements.
 * <p>Generated by {@link io.deephaven.engine.util.tuples.TupleCodeGenerator}.
 */
public class LongByteByteTuple implements Comparable<LongByteByteTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<LongByteByteTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final LongByteByteTuple typedOther = (LongByteByteTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final LongByteByteTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public LongByteByteTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        return this;
    }
}
