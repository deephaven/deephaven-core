...
/**
 * <p>3-Tuple (triple) key class composed of double, float, and int elements.
 * <p>Generated by {@link io.deephaven.engine.util.tuples.TupleCodeGenerator}.
 */
public class DoubleFloatIntTuple implements Comparable<DoubleFloatIntTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<DoubleFloatIntTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final DoubleFloatIntTuple typedOther = (DoubleFloatIntTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final DoubleFloatIntTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public DoubleFloatIntTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        return this;
    }
}
