...
/**
 * <p>3-Tuple (triple) key class composed of float, byte, and Object elements.
 * <p>Generated by {@link io.deephaven.engine.util.tuples.TupleCodeGenerator}.
 */
public class FloatByteObjectTuple implements Comparable<FloatByteObjectTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<FloatByteObjectTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final FloatByteObjectTuple typedOther = (FloatByteObjectTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final FloatByteObjectTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public FloatByteObjectTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        final Object canonicalizedElement3 = canonicalizer.apply(element3);
        return canonicalizedElement3 == element3
                ? this : new FloatByteObjectTuple(element1, element2, canonicalizedElement3);
    }
}
