...
/**
 * <p>3-Tuple (triple) key class composed of byte, float, and byte elements.
 * <p>Generated by {@link io.deephaven.engine.util.tuples.TupleCodeGenerator}.
 */
public class ByteFloatByteTuple implements Comparable<ByteFloatByteTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<ByteFloatByteTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final ByteFloatByteTuple typedOther = (ByteFloatByteTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final ByteFloatByteTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public ByteFloatByteTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        return this;
    }
}
