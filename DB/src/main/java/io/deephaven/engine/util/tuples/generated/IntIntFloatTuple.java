...
/**
 * <p>3-Tuple (triple) key class composed of int, int, and float elements.
 * <p>Generated by {@link io.deephaven.engine.util.tuples.TupleCodeGenerator}.
 */
public class IntIntFloatTuple implements Comparable<IntIntFloatTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<IntIntFloatTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final IntIntFloatTuple typedOther = (IntIntFloatTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final IntIntFloatTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public IntIntFloatTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        return this;
    }
}
