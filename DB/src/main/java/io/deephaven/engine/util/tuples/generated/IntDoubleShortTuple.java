...
/**
 * <p>3-Tuple (triple) key class composed of int, double, and short elements.
 * <p>Generated by {@link io.deephaven.engine.util.tuples.TupleCodeGenerator}.
 */
public class IntDoubleShortTuple implements Comparable<IntDoubleShortTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<IntDoubleShortTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final IntDoubleShortTuple typedOther = (IntDoubleShortTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final IntDoubleShortTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public IntDoubleShortTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        return this;
    }
}
