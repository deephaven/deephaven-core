...
/**
 * <p>3-Tuple (triple) key class composed of short, short, and int elements.
 * <p>Generated by {@link io.deephaven.engine.util.tuples.TupleCodeGenerator}.
 */
public class ShortShortIntTuple implements Comparable<ShortShortIntTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<ShortShortIntTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final ShortShortIntTuple typedOther = (ShortShortIntTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final ShortShortIntTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public ShortShortIntTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        return this;
    }
}
