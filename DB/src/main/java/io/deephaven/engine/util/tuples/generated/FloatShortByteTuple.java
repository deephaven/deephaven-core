...
/**
 * <p>3-Tuple (triple) key class composed of float, short, and byte elements.
 * <p>Generated by {@link io.deephaven.engine.util.tuples.TupleCodeGenerator}.
 */
public class FloatShortByteTuple implements Comparable<FloatShortByteTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<FloatShortByteTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final FloatShortByteTuple typedOther = (FloatShortByteTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final FloatShortByteTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public FloatShortByteTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        return this;
    }
}
