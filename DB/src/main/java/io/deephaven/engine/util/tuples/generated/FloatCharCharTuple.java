...
/**
 * <p>3-Tuple (triple) key class composed of float, char, and char elements.
 * <p>Generated by {@link io.deephaven.engine.util.tuples.TupleCodeGenerator}.
 */
public class FloatCharCharTuple implements Comparable<FloatCharCharTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<FloatCharCharTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final FloatCharCharTuple typedOther = (FloatCharCharTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final FloatCharCharTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public FloatCharCharTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        return this;
    }
}
