...
/**
 * <p>3-Tuple (triple) key class composed of short, float, and char elements.
 * <p>Generated by {@link io.deephaven.engine.util.tuples.TupleCodeGenerator}.
 */
public class ShortFloatCharTuple implements Comparable<ShortFloatCharTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<ShortFloatCharTuple> {
    ...
    @Override
    public final int compareTo(@NotNull final ShortFloatCharTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public ShortFloatCharTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        return this;
    }
}
