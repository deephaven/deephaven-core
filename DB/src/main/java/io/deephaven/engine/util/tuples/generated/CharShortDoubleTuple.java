...
/**
 * <p>3-Tuple (triple) key class composed of char, short, and double elements.
 * <p>Generated by {@link io.deephaven.engine.util.tuples.TupleCodeGenerator}.
 */
public class CharShortDoubleTuple implements Comparable<CharShortDoubleTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<CharShortDoubleTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final CharShortDoubleTuple typedOther = (CharShortDoubleTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final CharShortDoubleTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public CharShortDoubleTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        return this;
    }
}
