...
/**
 * <p>3-Tuple (triple) key class composed of Object, float, and long elements.
 * <p>Generated by {@link io.deephaven.engine.util.tuples.TupleCodeGenerator}.
 */
public class ObjectFloatLongTuple implements Comparable<ObjectFloatLongTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<ObjectFloatLongTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final ObjectFloatLongTuple typedOther = (ObjectFloatLongTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final ObjectFloatLongTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public ObjectFloatLongTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        final Object canonicalizedElement1 = canonicalizer.apply(element1);
        return canonicalizedElement1 == element1
                ? this : new ObjectFloatLongTuple(canonicalizedElement1, element2, element3);
    }
}
