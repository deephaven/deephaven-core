...
public class TupleCodeGenerator {
    ...
    private static final File OUTPUT_RELATIVE_PATH =
            new File("DB/src/main/java/io/deephaven/engine/util/tuples/generated");
    ...
    private enum ElementType {
        ...
        ElementType(@NotNull final String nameText,
            ...
            this.imports = Arrays.stream(importClasses).map(Class::getName).toArray(String[]::new);
        }
     ...
     *
     * @param classes The element classes
