...
/**
 * <p>3-Tuple (triple) key class composed of Object, float, and double elements.
 * <p>Generated by {@link io.deephaven.engine.util.tuples.TupleCodeGenerator}.
 */
public class ObjectFloatDoubleTuple implements Comparable<ObjectFloatDoubleTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<ObjectFloatDoubleTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final ObjectFloatDoubleTuple typedOther = (ObjectFloatDoubleTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final ObjectFloatDoubleTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public ObjectFloatDoubleTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        final Object canonicalizedElement1 = canonicalizer.apply(element1);
        return canonicalizedElement1 == element1
                ? this : new ObjectFloatDoubleTuple(canonicalizedElement1, element2, element3);
    }
}
