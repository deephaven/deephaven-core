...
/**
 * <p>3-Tuple (triple) key class composed of Object, int, and char elements.
 * <p>Generated by {@link io.deephaven.engine.util.tuples.TupleCodeGenerator}.
 */
public class ObjectIntCharTuple implements Comparable<ObjectIntCharTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<ObjectIntCharTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final ObjectIntCharTuple typedOther = (ObjectIntCharTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final ObjectIntCharTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public ObjectIntCharTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        final Object canonicalizedElement1 = canonicalizer.apply(element1);
        return canonicalizedElement1 == element1
                ? this : new ObjectIntCharTuple(canonicalizedElement1, element2, element3);
    }
}
