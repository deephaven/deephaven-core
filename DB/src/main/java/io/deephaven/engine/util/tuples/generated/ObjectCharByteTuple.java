...
/**
 * <p>3-Tuple (triple) key class composed of Object, char, and byte elements.
 * <p>Generated by {@link io.deephaven.engine.util.tuples.TupleCodeGenerator}.
 */
public class ObjectCharByteTuple implements Comparable<ObjectCharByteTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<ObjectCharByteTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final ObjectCharByteTuple typedOther = (ObjectCharByteTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final ObjectCharByteTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public ObjectCharByteTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        final Object canonicalizedElement1 = canonicalizer.apply(element1);
        return canonicalizedElement1 == element1
                ? this : new ObjectCharByteTuple(canonicalizedElement1, element2, element3);
    }
}
