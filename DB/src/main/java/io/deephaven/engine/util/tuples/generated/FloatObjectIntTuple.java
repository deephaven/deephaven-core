...
/**
 * <p>3-Tuple (triple) key class composed of float, Object, and int elements.
 * <p>Generated by {@link io.deephaven.engine.util.tuples.TupleCodeGenerator}.
 */
public class FloatObjectIntTuple implements Comparable<FloatObjectIntTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<FloatObjectIntTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final FloatObjectIntTuple typedOther = (FloatObjectIntTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final FloatObjectIntTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public FloatObjectIntTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        final Object canonicalizedElement2 = canonicalizer.apply(element2);
        return canonicalizedElement2 == element2
                ? this : new FloatObjectIntTuple(element1, canonicalizedElement2, element3);
    }
}
