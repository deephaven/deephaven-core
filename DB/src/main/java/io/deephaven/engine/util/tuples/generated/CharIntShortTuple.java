...
/**
 * <p>3-Tuple (triple) key class composed of char, int, and short elements.
 * <p>Generated by {@link io.deephaven.engine.util.tuples.TupleCodeGenerator}.
 */
public class CharIntShortTuple implements Comparable<CharIntShortTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<CharIntShortTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final CharIntShortTuple typedOther = (CharIntShortTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final CharIntShortTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public CharIntShortTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        return this;
    }
}
