...
/**
 * <p>3-Tuple (triple) key class composed of int, short, and byte elements.
 * <p>Generated by {@link io.deephaven.engine.util.tuples.TupleCodeGenerator}.
 */
public class IntShortByteTuple implements Comparable<IntShortByteTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<IntShortByteTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final IntShortByteTuple typedOther = (IntShortByteTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final IntShortByteTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public IntShortByteTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        return this;
    }
}
