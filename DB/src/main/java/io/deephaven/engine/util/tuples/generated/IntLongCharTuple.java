...
/**
 * <p>3-Tuple (triple) key class composed of int, long, and char elements.
 * <p>Generated by {@link io.deephaven.engine.util.tuples.TupleCodeGenerator}.
 */
public class IntLongCharTuple implements Comparable<IntLongCharTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<IntLongCharTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final IntLongCharTuple typedOther = (IntLongCharTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final IntLongCharTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public IntLongCharTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        return this;
    }
}
