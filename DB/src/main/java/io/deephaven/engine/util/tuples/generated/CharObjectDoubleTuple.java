...
/**
 * <p>3-Tuple (triple) key class composed of char, Object, and double elements.
 * <p>Generated by {@link io.deephaven.engine.util.tuples.TupleCodeGenerator}.
 */
public class CharObjectDoubleTuple implements Comparable<CharObjectDoubleTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<CharObjectDoubleTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final CharObjectDoubleTuple typedOther = (CharObjectDoubleTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final CharObjectDoubleTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public CharObjectDoubleTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        final Object canonicalizedElement2 = canonicalizer.apply(element2);
        return canonicalizedElement2 == element2
                ? this : new CharObjectDoubleTuple(element1, canonicalizedElement2, element3);
    }
}
