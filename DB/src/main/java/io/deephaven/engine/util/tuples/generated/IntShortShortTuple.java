...
/**
 * <p>3-Tuple (triple) key class composed of int, short, and short elements.
 * <p>Generated by {@link io.deephaven.engine.util.tuples.TupleCodeGenerator}.
 */
public class IntShortShortTuple implements Comparable<IntShortShortTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<IntShortShortTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final IntShortShortTuple typedOther = (IntShortShortTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final IntShortShortTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public IntShortShortTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        return this;
    }
}
