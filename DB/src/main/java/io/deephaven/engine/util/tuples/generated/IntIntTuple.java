...
/**
 * <p>2-Tuple (double) key class composed of int and int elements.
 * <p>Generated by {@link io.deephaven.engine.util.tuples.TupleCodeGenerator}.
 */
public class IntIntTuple implements Comparable<IntIntTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<IntIntTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final IntIntTuple typedOther = (IntIntTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final IntIntTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public IntIntTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        return this;
    }
}
