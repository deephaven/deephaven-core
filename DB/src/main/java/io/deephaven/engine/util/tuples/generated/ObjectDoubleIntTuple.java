...
/**
 * <p>3-Tuple (triple) key class composed of Object, double, and int elements.
 * <p>Generated by {@link io.deephaven.engine.util.tuples.TupleCodeGenerator}.
 */
public class ObjectDoubleIntTuple implements Comparable<ObjectDoubleIntTuple>, Externalizable, StreamingExternalizable, CanonicalizableTuple<ObjectDoubleIntTuple> {
    ...
    public final boolean equals(final Object other) {
        ...
        final ObjectDoubleIntTuple typedOther = (ObjectDoubleIntTuple) other;
        // @formatter:off
    ...
    @Override
    public final int compareTo(@NotNull final ObjectDoubleIntTuple other) {
        if (this == other) {
            return 0;
        }
        int comparison;
    ...
    @Override
    public ObjectDoubleIntTuple canonicalize(@NotNull final UnaryOperator<Object> canonicalizer) {
        final Object canonicalizedElement1 = canonicalizer.apply(element1);
        return canonicalizedElement1 == element1
                ? this : new ObjectDoubleIntTuple(canonicalizedElement1, element2, element3);
    }
}
