...
public class BlackScholes {
     ...
     */
    public static double price(final boolean isCall, final double S, final double X, final double T, final double r, final double b, final double v) {
     ...
     */
    public static double delta(final boolean isCall, final double S, final double X, final double T, final double r, final double b, final double v) {
        final double d1 = (Math.log(S / X) + (b + v * v / 2) * T) / (v * Math.sqrt(T));
     ...
     * @return theoretical option price
     */
    public static double gamma(final double S, final double X, final double T, final double r, final double b, final double v) {
        final double d1 = (Math.log(S / X) + (b + v * v / 2) * T) / (v * Math.sqrt(T));
     ...
     * @return theoretical option price
     */
    public static double gammaP(final double S, final double X, final double T, final double r, final double b, final double v) {
     ...
     * @return theoretical option price
     */
    public static double vega(final double S, final double X, final double T, final double r, final double b, final double v) {
        final double d1 = (Math.log(S / X) + (b + v * v / 2) * T) / (v * Math.sqrt(T));
     ...
     * @return theoretical option price
     */
    public static double vegaP(final double S, final double X, final double T, final double r, final double b, final double v) {
     ...
     * @return theoretical option price
     */
    public static double vomma(final double S, final double X, final double T, final double r, final double b, final double v) {
        final double d1 = (Math.log(S / X) + (b + v * v / 2) * T) / (v * Math.sqrt(T));
        final double d2 = d1 - (v * Math.sqrt(T));
     ...
     * @return theoretical option price
     */
    public static double vommaP(final double S, final double X, final double T, final double r, final double b, final double v) {
        final double d1 = (Math.log(S / X) + (b + v * v / 2) * T) / (v * Math.sqrt(T));
        final double d2 = d1 - (v * Math.sqrt(T));
     ...
     * @return theoretical option price
     */
    public static double vegaBleed(final double S, final double X, final double T, final double r, final double b, final double v) {
        final double d1 = (Math.log(S / X) + (b + v * v / 2) * T) / (v * Math.sqrt(T));
        final double d2 = d1 - (v * Math.sqrt(T));
     ...
     * @return theoretical option price
     */
    public static double charm(final boolean isCall, final double S, final double X, final double T, final double r, final double b, final double v) {
        final double d1 = (Math.log(S / X) + (b + v * v / 2) * T) / (v * Math.sqrt(T));
        final double d2 = d1 - (v * Math.sqrt(T));
        if (isCall) {
            return -Math.exp((b - r) * T) * ((nd.density(d1) * (b / (v * Math.sqrt(T)) - d2 / (2 * T))) + (b - r) * CND(d1));
        } else {
            return -Math.exp((b - r) * T) * ((nd.density(d1) * (b / (v * Math.sqrt(T)) - d2 / (2 * T))) - (b - r) * CND(-d1));
        }
    }
     ...
     * @return theoretical option price
     */
    public static double theta(final boolean isCall, final double S, final double X, final double T, final double r, final double b, final double v) {
        final double d1 = (Math.log(S / X) + (b + v * v / 2) * T) / (v * Math.sqrt(T));
        final double d2 = d1 - (v * Math.sqrt(T));
        if (isCall) {
            return ((-S * Math.exp((b - r) * T) * nd.density(d1) * v) / (2 * Math.sqrt(T))) - ((b - r) * S * Math.exp((b - r) * T) * CND(d1)) - (r * X * Math.exp(-r * T) * CND(d2));
        } else {
            return ((-S * Math.exp((b - r) * T) * nd.density(d1) * v) / (2 * Math.sqrt(T))) + ((b - r) * S * Math.exp((b - r) * T) * CND(-d1)) + (r * X * Math.exp(-r * T) * CND(-d2));
        }
    }
     ...
     * @return theoretical option price
     */
    public static double driftlessTheta(final double S, final double X, final double T, final double r, final double b, final double v) {
        final double d1 = (Math.log(S / X) + (b + v * v / 2) * T) / (v * Math.sqrt(T));
     ...
     * @return theoretical option price
     */
    public static double rho(final boolean isCall, final double S, final double X, final double T, final double r, final double b, final double v) {
        final double d1 = (Math.log(S / X) + (b + v * v / 2) * T) / (v * Math.sqrt(T));
        final double d2 = d1 - (v * Math.sqrt(T));
        if (isCall) {
     ...
     * @return theoretical option price
     */
    public static double carryRho(final boolean isCall, final double S, final double X, final double T, final double r, final double b, final double v) {
        final double d1 = (Math.log(S / X) + (b + v * v / 2) * T) / (v * Math.sqrt(T));
        if (isCall) {
     ...
     * @return theoretical option price
     */
    public static double strikeDelta(final boolean isCall, final double S, final double X, final double T, final double r, final double b, final double v) {
        final double d1 = (Math.log(S / X) + (b + v * v / 2) * T) / (v * Math.sqrt(T));
        final double d2 = d1 - (v * Math.sqrt(T));
        if (isCall) {
     ...
     */
    public static double impliedVolBisect(final double P, final Boolean isCall, final double S, final double X, final double T, final double r, final double b) {
     ...
     * @return implied volatility
     */
    public static double impliedVolBisect(final double P, final Boolean isCall, final double S, final double X, final double T, final double r, final double b, final double eps, final int maxIters) {
        if (P == NULL_DOUBLE || isCall == null || S == NULL_DOUBLE || X == NULL_DOUBLE || T == NULL_DOUBLE || r == NULL_DOUBLE || b == NULL_DOUBLE) {
            return NULL_DOUBLE;
        }
     ...
     * @return implied volatility
     */
    public static double impliedVolNewton(final double P, final Boolean isCall, final double S, final double X, final double T, final double r, final double b) {
     ...
     * @return implied volatility
     */
    public static double impliedVolNewton(final double P, final Boolean isCall, final double S, final double X, final double T, final double r, final double b, final double eps, final int maxIters) {
        if (P == NULL_DOUBLE || isCall == null || S == NULL_DOUBLE || X == NULL_DOUBLE || T == NULL_DOUBLE || r == NULL_DOUBLE || b == NULL_DOUBLE) {
            return NULL_DOUBLE;
        }
     ...
     * @return implied volatility
     */
    public static double impliedVolNewtonP(final double P, final Boolean isCall, final double S, final double X, final double T, final double r, final double b) {
     ...
     * @return implied volatility
     */
    public static double impliedVolNewtonP(final double P, final Boolean isCall, final double S, final double X, final double T, final double r, final double b, final double eps, final int maxIters) {
        if (P == NULL_DOUBLE || isCall == null || S == NULL_DOUBLE || X == NULL_DOUBLE || T == NULL_DOUBLE || r == NULL_DOUBLE || b == NULL_DOUBLE) {
            return NULL_DOUBLE;
        }
     ...
     */
    public static double strikeFromDeltaBisect(final double delta, final Boolean isCall, final double S, final double T, final double r, final double b, final double v) {
     ...
     * @return strike associated with the delta
     */
    public static double strikeFromDeltaBisect(final double delta, final Boolean isCall, final double S, final double T, final double r, final double b, final double v, final double eps, final int maxIters) {
        if (delta == NULL_DOUBLE || isCall == null || S == NULL_DOUBLE || v == NULL_DOUBLE || T == NULL_DOUBLE || r == NULL_DOUBLE || b == NULL_DOUBLE) {
            return NULL_DOUBLE;
        }
