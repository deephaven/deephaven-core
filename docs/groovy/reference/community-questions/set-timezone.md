...
```sh
docker run --rm --name deephaven -p 10000:10000 --env START_OPTS="-Dauthentication.psk=YOUR_PASSWORD_HERE -Duser.timezone=America/New_York" ghcr.io/deephaven/server-slim:latest
```
