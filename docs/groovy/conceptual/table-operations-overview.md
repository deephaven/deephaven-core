...
| Add columns (computed on demand)                      | [`updateView("NewCol = formula")`](../reference/table-operations/select/update-view.md)                               |
...
| Join lookup data                                      | [`naturalJoin(other, "Key", "AddedCol")`](../reference/table-operations/join/natural-join.md)                         |
| Join requiring exactly one match                      | [`exactJoin(other, "Key", "AddedCol")`](../reference/table-operations/join/exact-join.md)                             |
