...
AWS EC2 2022 Linux instances come with [amazon-linux-extras](https://aws.amazon.com/premiumsupport/knowledge-center/ec2-install-extras-library-software/) installed. Java 11 (required by source builds) can be easily installed on an AWS Linux instance with this command.
