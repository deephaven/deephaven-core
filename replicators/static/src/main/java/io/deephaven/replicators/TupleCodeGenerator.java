...
public class TupleCodeGenerator {
    ...
    private enum ElementType {
        ...
        // @formatter:off
         ...
         OBJECT( "Object",  Object.class, "ObjectComparisons.eq(" + LHS + ", " + RHS + ")",   "Objects.hashCode(" + VAL + ")", "ObjectComparisons.compare(" + LHS + ", " + RHS + ")", OUT + ".writeObject(" + VAL + ')', IN + ".readObject()", "io.deephaven.util.compare.ObjectComparisons"),
        ;
        // @formatter:on
