...
public class TupleSourceCodeGenerator {
    ...
    private static final String TWO_COLUMN_FACTORY_NAME = "io.deephaven.engine.tuplesource.TwoColumnTupleSourceFactory";
    ...
    private String generateTwoColumnTupleSource(@NotNull final String className, @NotNull final ColumnSourceType type1,
        ...
        code.append(" * <p>Generated by TupleSourceCodeGenerator.")
                .append(NEW_LINE);
        code.append(" */").append(NEW_LINE);
        ...
        code.append(indenter).append("/** {@link ").append(TWO_COLUMN_FACTORY_NAME)
                .append("} instance to create instances of {@link ").append(className).append("}. **/")
                .append(NEW_LINE);
        code.append(indenter).append("public static final ").append(TWO_COLUMN_FACTORY_NAME)
                .append('<')
        ...
        code.append(indenter).append("private static final class Factory implements ")
                .append(TWO_COLUMN_FACTORY_NAME)
    ...
    private String generateThreeColumnTupleSource(@NotNull final String className,
        ...
        final String tupleClassName = TupleCodeGenerator.getTupleClassName(sourceClass1Name,
        ...
        code.append(indenter).append("/** {@link ").append(THREE_COLUMN_FACTORY_NAME)
                .append("} instance to create instances of {@link ").append(className).append("}. **/")
                .append(NEW_LINE);
        code.append(indenter).append("public static final ").append(THREE_COLUMN_FACTORY_NAME)
                .append('<')
                .append(tupleClassName).append(", ").append(sourceClass1Name).append(", ").append(sourceClass2Name)
        ...
        code.append(indenter).append("/** {@link ").append(THREE_COLUMN_FACTORY_NAME)
                .append("} for instances of {@link ").append(className).append("}. **/").append(NEW_LINE);
        code.append(indenter).append("private static final class Factory implements ")
                .append(THREE_COLUMN_FACTORY_NAME)
                .append('<').append(tupleClassName).append(", ").append(sourceClass1Name).append(", ")
