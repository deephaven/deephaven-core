...
public class GeneratePlottingConvenience {
    ...
    public static void main(String[] args) throws ClassNotFoundException, IOException {
        ...
        final String[] staticImports = {
                ...
                "io.deephaven.db.plot.PlotStyle.plotStyleNames",

                "io.deephaven.db.plot.LineStyle.lineEndStyle",
                "io.deephaven.db.plot.LineStyle.lineEndStyleNames",
                "io.deephaven.db.plot.LineStyle.lineJoinStyle",
                "io.deephaven.db.plot.LineStyle.lineJoinStyleNames",
                "io.deephaven.db.plot.LineStyle.lineStyle",

                "io.deephaven.db.plot.Font.fontStyle",
                "io.deephaven.db.plot.Font.fontStyleNames",
                "io.deephaven.db.plot.Font.font",
                "io.deephaven.db.plot.Font.fontFamilyNames",
                "io.deephaven.db.plot.Font.fontStyles",
                ...
                "io.deephaven.db.plot.composite.ScatterPlotMatrix.scatterPlotMatrix",

                "io.deephaven.db.plot.FigureFactory.figure",
        };

        final String[] imports = {
                "io.deephaven.db.plot.FigureImpl",
        };
