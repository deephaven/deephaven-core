...
public class GenerateFigureImmutable {
    ...
    private static final String CLASS_NAME_INTERFACE = "io.deephaven.engine.plot.Figure";
    private static final String CLASS_NAME_IMPLEMENTATION = "io.deephaven.engine.plot.FigureImpl";
    ...
    private static String createInstanceGetter(final JavaFunction f) {
        switch (f.getClassName()) {
            case "io.deephaven.engine.plot.BaseFigure":
                return "figure(fc)";
            case "io.deephaven.engine.plot.Chart":
                return "chart(fc)";
            case "io.deephaven.engine.plot.Axes":
                return "axes(fc)";
            case "io.deephaven.engine.plot.Axis":
                return "axis(fc)";
            case "io.deephaven.engine.plot.datasets.DataSeries":
                return "series(fc)";
            case "io.deephaven.engine.plot.datasets.multiseries.MultiSeries":
                return "series(fc)";
            default:
    ...
    private String createFunction(final JavaFunction f) {
        ...
        if (returnClass != null && BaseFigure.class.isAssignableFrom(returnClass)) {
            ...
            s += indent(2) + "final AxesImpl axes = (AxesImpl) " + createInstanceGetter(f) + "."
                ...
                && f.getClassName().equals("io.deephaven.engine.plot.Axes")) {
    ...
    private static void generateFile(final String devroot, final boolean assertNoChange, final boolean isInterface)
        ...
        final String[] imports = {
                "io.deephaven.engine.plot.datasets.DataSeriesInternal",
                "io.deephaven.engine.plot.datasets.multiseries.MultiSeriesInternal",
                "io.deephaven.base.verify.Require",
                "java.util.Map",
                "java.util.HashMap",
                "java.util.Arrays",
                "io.deephaven.engine.plot.util.PlotUtils",
                "io.deephaven.engine.plot.errors.PlotRuntimeException",
                "io.deephaven.engine.plot.errors.PlotUnsupportedOperationException"
        };

        final String[] interfaces = {
                "io.deephaven.engine.plot.BaseFigure",
                "io.deephaven.engine.plot.Chart",
                "io.deephaven.engine.plot.Axes",
                "io.deephaven.engine.plot.Axis"
        };
        ...
        final String[] seriesInterfaces = {
                ...
                "io.deephaven.engine.plot.datasets.ohlc.OHLCDataSeries",
