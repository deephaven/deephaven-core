...
public class GeneratePlottingConvenience {
    ...
    private static final String OUTPUT_CLASS = "io.deephaven.engine.plot.PlottingConvenience";
    ...
    private String generateCode() {
        ...
        code += "package io.deephaven.engine.plot;\n\n";
    ...
    public static void main(String[] args) throws ClassNotFoundException, IOException {
        ...
        final String[] staticImports = {
                ...
                "io.deephaven.engine.plot.PlotStyle.plotStyleNames",

                "io.deephaven.engine.plot.LineStyle.lineEndStyle",
                "io.deephaven.engine.plot.LineStyle.lineEndStyleNames",
                "io.deephaven.engine.plot.LineStyle.lineJoinStyle",
                "io.deephaven.engine.plot.LineStyle.lineJoinStyleNames",
                "io.deephaven.engine.plot.LineStyle.lineStyle",

                "io.deephaven.engine.plot.Font.fontStyle",
                "io.deephaven.engine.plot.Font.fontStyleNames",
                "io.deephaven.engine.plot.Font.font",
                "io.deephaven.engine.plot.Font.fontFamilyNames",
                "io.deephaven.engine.plot.Font.fontStyles",

                "io.deephaven.engine.plot.axistransformations.AxisTransforms.axisTransform",
                "io.deephaven.engine.plot.axistransformations.AxisTransforms.axisTransformNames",

                "io.deephaven.engine.plot.filters.Selectables.oneClick",
                "io.deephaven.engine.plot.filters.Selectables.linked",

                "io.deephaven.engine.plot.composite.ScatterPlotMatrix.scatterPlotMatrix",

                "io.deephaven.engine.plot.FigureFactory.figure",
        };

        final String[] imports = {
                "io.deephaven.engine.plot.FigureImpl",
        };
        ...
        final String code = gen.generateCode()
                .replace("io.deephaven.engine.plot.FigureImpl", "io.deephaven.engine.plot.Figure");
        log.info("\n\n**************************************\n\n");
        log.info(code);
