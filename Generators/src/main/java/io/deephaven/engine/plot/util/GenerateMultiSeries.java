...
import static io.deephaven.engine.plot.util.PlotGeneratorUtils.indent;
...
public class GenerateMultiSeries {
    ...
    public static void main(String[] args) throws ClassNotFoundException, IOException, NoSuchMethodException {
        ...
        skip.add(Class.forName("io.deephaven.engine.plot.datasets.DataSeries").getMethod("pointSize", int.class));
        skip.add(Class.forName("io.deephaven.engine.plot.datasets.DataSeries").getMethod("pointSize", double.class));
        skip.add(Class.forName("io.deephaven.engine.plot.datasets.DataSeries").getMethod("pointSize", long.class));

        new Generator("io.deephaven.engine.plot.datasets.multiseries.MultiSeries",
                "DataSeriesInternal",
                false,
                false,
                false,
                "io.deephaven.engine.plot.datasets.DataSeries",
                "io.deephaven.engine.plot.datasets.category.CategoryDataSeries",
                "io.deephaven.engine.plot.datasets.xy.XYDataSeries",
                "io.deephaven.engine.plot.datasets.ohlc.OHLCDataSeries").generateCode(devroot, assertNoChange, skip);

        new Generator("io.deephaven.engine.plot.datasets.multiseries.AbstractMultiSeries",
                "DataSeriesInternal",
                true,
                false,
                false,
        ...
        new Generator(
                "io.deephaven.engine.plot.datasets.multiseries.MultiCatSeries",
                "CategoryDataSeriesInternal",
                false,
                false,
                false,
                "io.deephaven.engine.plot.datasets.category.CategoryDataSeries").generateCode(devroot, assertNoChange,
                        skip);

        new Generator(
                "io.deephaven.engine.plot.datasets.multiseries.MultiCatErrorBarSeries",
        ...
        new Generator(
                "io.deephaven.engine.plot.datasets.multiseries.MultiCatErrorBarSeriesSwappable",
                "CategoryErrorBarDataSeriesInternal",
                false,
                false,
                true,
        ...
        new Generator(
                "io.deephaven.engine.plot.datasets.multiseries.MultiXYErrorBarSeries",
                "XYErrorBarDataSeriesInternal",
                false,
                false,
                false,
                "io.deephaven.engine.plot.datasets.xy.XYDataSeries").generateCode(devroot, assertNoChange, skip);
        new Generator(
                "io.deephaven.engine.plot.datasets.multiseries.MultiXYErrorBarSeriesSwappable",
                "XYErrorBarDataSeriesInternal",
                false,
                false,
                true,
        ...
        new Generator(
                "io.deephaven.engine.plot.datasets.multiseries.MultiCatSeriesSwappable",
                "CategoryDataSeriesInternal",
                false,
                false,
                true,
        ...
        new Generator("io.deephaven.engine.plot.datasets.multiseries.MultiXYSeries",
        ...
        new Generator("io.deephaven.engine.plot.datasets.multiseries.MultiXYSeriesSwappable",
                "XYDataSeriesInternal",
                false,
                false,
                true,
        ...
        new Generator("io.deephaven.engine.plot.datasets.multiseries.MultiOHLCSeries",
        ...
        new Generator("io.deephaven.engine.plot.datasets.multiseries.MultiOHLCSeriesSwappable",
                "OHLCDataSeriesInternal",
                false,
                false,
                true,
    ...
    static class Generator {
        ...
        private String createMap(String mapType, final String mapName) {
            return indent(1) + "private " + mapType + " " + mapName + " = new io.deephaven.engine.plot.util.PlotUtils" +
                    ".HashMapWithDefault<>();\n";
        }
        ...
        private String createFunctionalBody(final String returnClass, GroovyStaticImportGenerator.JavaFunction function)
            ...
            if (function.getParameterTypes()[0].getTypeName().startsWith("groovy.lang.Closure")) {
                return indent(2) + "return " + function.getMethodName()
                        + "(new io.deephaven.engine.plot.util.functions.ClosureFunction<>("
            ...
            return indent(2) + "final String newColumn = " + getColumnNameConstant(function.getMethodName())
                    ...
                    indent(2)
                    + "chart().figure().registerFigureFunction(new io.deephaven.engine.plot.util.functions.FigureImplFunction(f -> f."
                    +
                    tableMethodName +
        ...
        private String getFigureFunctionInput(final String returnClass,
            ...
            if (function.getMethodName().equals("pointColorByY")) {
                final Class c = Class.forName("io.deephaven.engine.plot.datasets.multiseries." + returnClass);
        ...
        private String getColumnNameConstant(String methodName) {
            ...
            if (methodName.startsWith("pointColor")) {
                return "io.deephaven.engine.plot.datasets.ColumnNameConstants.POINT_COLOR";
            } else if (methodName.equals("pointSize")) {
                return "io.deephaven.engine.plot.datasets.ColumnNameConstants.POINT_SIZE";
            } else if (methodName.equals("pointShape")) {
                return "io.deephaven.engine.plot.datasets.ColumnNameConstants.POINT_SHAPE";
            } else if (methodName.equals("pointLabel")) {
                return "io.deephaven.engine.plot.datasets.ColumnNameConstants.POINT_LABEL";
            }
            ...
            for (int i = 0; i < vars.length; i++) {
                ...
                if (var.getTypeName().equals("io.deephaven.engine.tables.Table")) {
                    ...
                    code.append(indent(1)).append("final io.deephaven.engine.plot.util.tables.TableHandle ")
                            .append(handleName).append(" = new io.deephaven.engine.plot.util.tables.TableHandle(")
                            .append(names[i]);
    ...
    private static String getMapType(GroovyStaticImportGenerator.JavaFunction function) {
        ...
        return "io.deephaven.engine.plot.util.PlotUtils.HashMapWithDefault<String, " + className + ">";
    }
