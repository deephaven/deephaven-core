...
public class GenerateMultiSeries {
    ...
    public static void main(String[] args) throws ClassNotFoundException, IOException, NoSuchMethodException {
        ...
        new Generator("io.deephaven.plot.datasets.multiseries.MultiSeries",
                ...
                "io.deephaven.plot.datasets.ohlc.OHLCDataSeries").generateCode(devroot, assertNoChange, skip);

        new Generator("io.deephaven.plot.datasets.multiseries.AbstractMultiSeries",
                "DataSeriesInternal",
                true,
                false,
                false,
        ...
        new Generator(
                "io.deephaven.plot.datasets.multiseries.MultiCatSeries",
                "CategoryDataSeriesInternal",
                false,
                false,
                false,
                "io.deephaven.plot.datasets.category.CategoryDataSeries").generateCode(devroot, assertNoChange,
                        skip);

        new Generator(
                "io.deephaven.plot.datasets.multiseries.MultiCatErrorBarSeries",
        ...
        new Generator(
                "io.deephaven.plot.datasets.multiseries.MultiCatErrorBarSeriesSwappable",
                "CategoryErrorBarDataSeriesInternal",
                false,
                false,
                true,
        ...
        new Generator(
                "io.deephaven.plot.datasets.multiseries.MultiXYErrorBarSeries",
                "XYErrorBarDataSeriesInternal",
                false,
                false,
                false,
                "io.deephaven.plot.datasets.xy.XYDataSeries").generateCode(devroot, assertNoChange, skip);
        new Generator(
                "io.deephaven.plot.datasets.multiseries.MultiXYErrorBarSeriesSwappable",
                "XYErrorBarDataSeriesInternal",
                false,
                false,
                true,
        ...
        new Generator(
                "io.deephaven.plot.datasets.multiseries.MultiCatSeriesSwappable",
                "CategoryDataSeriesInternal",
                false,
                false,
                true,
        ...
        new Generator("io.deephaven.plot.datasets.multiseries.MultiXYSeries",
        ...
        new Generator("io.deephaven.plot.datasets.multiseries.MultiXYSeriesSwappable",
                "XYDataSeriesInternal",
                false,
                false,
                true,
        ...
        new Generator("io.deephaven.plot.datasets.multiseries.MultiOHLCSeries",
        ...
        new Generator("io.deephaven.plot.datasets.multiseries.MultiOHLCSeriesSwappable",
                "OHLCDataSeriesInternal",
                false,
                false,
                true,
    ...
    static class Generator {
                ...
                if (!oneArg) {
                    ...
                    for (int i = 0; i < types.length; i++) {
                        ...
                        if (typeName.equals("io.deephaven.engine.table.Table")) {
                            arg = "((io.deephaven.plot.util.tables.TableHandle) objectArray[" + i
                                    + "]).getTable()";
        ...
        private String createMap(String mapType, final String mapName) {
            return indent(1) + "private " + mapType + " " + mapName + " = new io.deephaven.plot.util.PlotUtils" +
                    ".HashMapWithDefault<>();\n";
        }
        ...
        private String createFunctionalBody(final String returnClass, GroovyStaticImportGenerator.JavaFunction function)
            ...
            return indent(2) + "final String newColumn = " + getColumnNameConstant(function.getMethodName())
                    ...
                    indent(2)
                    + "chart().figure().registerFigureFunction(new io.deephaven.plot.util.functions.FigureImplFunction(f -> f."
                    +
                    tableMethodName +
        ...
        private String getColumnNameConstant(String methodName) {
            ...
            if (methodName.startsWith("pointColor")) {
                return "io.deephaven.plot.datasets.ColumnNameConstants.POINT_COLOR";
            } else if (methodName.equals("pointSize")) {
                return "io.deephaven.plot.datasets.ColumnNameConstants.POINT_SIZE";
            } else if (methodName.equals("pointShape")) {
                return "io.deephaven.plot.datasets.ColumnNameConstants.POINT_SHAPE";
            } else if (methodName.equals("pointLabel")) {
                return "io.deephaven.plot.datasets.ColumnNameConstants.POINT_LABEL";
            }
        ...
        private String createMapCode(final GroovyStaticImportGenerator.JavaFunction function, final String mapName) {
            ...
            for (int i = 0; i < vars.length; i++) {
                ...
                if (var.getTypeName().equals("io.deephaven.engine.table.Table")) {
                    ...
                    code.append(indent(1)).append("final io.deephaven.plot.util.tables.TableHandle ")
                            .append(handleName).append(" = new io.deephaven.plot.util.tables.TableHandle(")
                            .append(names[i]);
    ...
    private static String getMapType(GroovyStaticImportGenerator.JavaFunction function) {
        ...
        return "io.deephaven.plot.util.PlotUtils.HashMapWithDefault<String, " + className + ">";
    }
