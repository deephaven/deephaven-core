...
/**
 * Provides logic for an arbitrarily nested leaf in the tree.
 * The implementation allows for both repeating and optional levels.
 * The required levels are being ignored as they are implicitly present OR the controller should not be used for leaves
 * where the entire path it required (in that case we have a simple straight copy of column data to the leaf array)
 */
class LevelsController {
    ...
    LevelsController(Type.Repetition... levels) {
        ...
        repeatLevelToDefLevel = new int[(int) Arrays.stream(levels).filter(levelType -> levelType == Type.Repetition.REPEATED).count()];
        int rlPos = 0;
    ...
    /* reason around something that has 3 nested repeating
         V              DL      RL
        {}              0       0
        {{}}            1       0
        {{{}}}          2       0
...
addElements(0,0,1):
    levels[0].addValues(1) -> l[0] = {1},cvc=1
    levels[1].addNulls(1) -> l[1] = {0}, cvc=0

addElements(1,0,1):
    levels[0].addValues(1) -> l[0] = {2},cvc=2
    levels[1].addElement(1) -> l[1] = {0,1}, cvc = 1
    levels[2].addNull() -> l[2] = {0}, cvc = 0

addElements(2,0,1):
    levels[0].addValues(1) -> l[0] = {3},cvc=3
    levels[1].addElement(1) -> l[1] = {0,1,2}, cvc = 2
    levels[2].addElement(1) -> l[2] = {0,1}, cvc = 1
    levels[3].addNull() -> l[3] = {0}, cvc = 0

addElements(0,0,2):
    levels[0].addValues(2) -> l[0] = {5},cvc=5
    levels[1].addNulls(2) -> l[1] = {0,1,2,2,2}, cvc=2
addElements(1,0,1):
    levels[0].addValues(1) -> l[0] = {6},cvc=6
    levels[1].addElement(1) -> l[1] = {0,1,2,2,2,3}, cvc = 3
    levels[2].addNull() -> l[2] = {0,1,1}, cvc = 1
addElements(1,1,1):
    levels[1].addValues(1) -> l[1] = {0,1,2,2,2,4}, cvc = 4
    levels[2].addNull() -> l[2] = {0,1,1,1}, cvc = 1
addElements(2,0,1):
    levels[0].addValues(1) -> l[0] = {7},cvc=7
    levels[1].addElement(1) -> l[1] = {0,1,2,2,2,4,5}, cvc = 5
    levels[2].addElement(1) -> l[2] = {0,1,1,1,2}, cvc = 2
    levels[3].addNull() -> l[3] = {0,0}, cvc = 0
addElements(2,2,1):
    levels[2].addValues(1) -> l[2] = {0,1,1,1,3}, cvc = 3
    levels[3].addNull() -> l[3] = {0,0,0}, cvc = 0
addElements(3,0,1):
    levels[0].addValues(1) -> l[0] = {8},cvc=8
    levels[1].addElement(1) -> l[1] = {0,1,2}, cvc = 2
    levels[2].addElement(1) -> l[2] = {0,1,1,1,2,3}, cvc = 3
    levels[3].addElement(1) -> l[3] = {0,0,0,1}, cvc = 1
addElements(3,3,1):
    levels[3].addValues(1) -> l[3] = {0,0,0,2}, cvc = 2
addElements(2,2,1):
    levels[2].addValues(1) -> l[2] = {0,1,1,1,3}, cvc = 3
    levels[3].addNull() -> l[3] = {0,0,0,2,0}, cvc = 2
addElements(3,2,1):
    levels[2].addValues(1) -> l[2] = {0,1,1,1,4}, cvc = 4
    levels[3].addElement(1) -> l[3] = {0,0,0,2,0,3}, cvc = 3
addElements(3,3,2):
...
*/
/*
reason around something that has 3 nested optionals
        V           DL  RL
        null        0   0
        a.null      1   0
        a.b.null    2   0
...
addElements(0,0,1):
    levels[0].addValues(1) -> l[0] = {1},cvc=1
    levels[1].addNulls(1) -> l[1] = {0}, cvc=1
addElements(1,0,1):
    levels[0].addValues(1) -> l[0] = {2},cvc=2
    levels[1].addElements(1) -> l[1]={0} cvc = 2
    levels[2].addNulls(1) -> l[2] = {0}, cvc=1
addElements(2,0,1):
    levels[0].addValues(1) -> l[0] = {3},cvc=3
    levels[1].addElements(1) -> l[1]={0} cvc = 3
    levels[2].addElements(1) -> l[2]={0} cvc = 2
    levels[3].addNulls(1) -> l[3] = {0}, cvc=1
addElements(0,0,2):
    levels[0].addValues(2) -> l[0] = {5},cvc=5
    levels[1].addNulls(2) -> l[1] = {0,3,4}, cvc=5
addElements(1,0,2):
    levels[0].addValues(2) -> l[0] = {7},cvc=7
    levels[1].addElements(2) -> l[1]={0,3,4} cvc = 7
    levels[2].addNulls(2) -> l[2] = {0,2,3}, cvc=4
addElements(2,0,2):
    levels[0].addValues(2) -> l[0] = {9},cvc=9
    levels[1].addElements(2) -> l[1]={0,3,4} cvc = 9
    levels[2].addElements(2) -> l[2]={0,2,3} cvc = 6
    levels[3].addNulls(2) -> l[3] = {0,1,2}, cvc=3

addElements(3,0,2):
    levels[0].addValues(2) -> l[0] = {11},cvc=11
    levels[1].addElements(2) -> l[1]={0,3,4} cvc = 11
    levels[2].addElements(2) -> l[2]={0,2,3} cvc = 8
    levels[3].addElements(2) -> l[3] = {0,1,2}, cvc=5

addElements(2,0,2):
    levels[0].addValues(1) -> l[0] = {12},cvc=12
    levels[1].addElements(1) -> l[1]={0,3,4} cvc = 12
    levels[2].addElements(1) -> l[2]={0,2,3} cvc = 9
    levels[3].addNulls(1) -> l[3] = {0,1,2,5}, cvc = 6

addElements(3,0,2):
    levels[0].addValues(3) -> l[0] = {15},cvc=15
    levels[1].addElements(3) -> l[1]={0,3,4} cvc = 15
    levels[2].addElements(3) -> l[2]={0,2,3} cvc = 12
