...
public interface ColumnPageReader extends AutoCloseable{
     ...
     */
    default long numRows() throws IOException { return numValues(); }

    /**
     * Triggers the value decompression and decoding
     * @param nullValue The value to be stored under the null entries
     * @return the data for that page in a format that makes sense for the given type - typically array of something that makes sense
     */
