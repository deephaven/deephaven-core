...
public class ReplicateUpdateBy {
    public static void main(String[] args) throws IOException {
        List<String> files = ReplicatePrimitiveCode.charToAll("engine/table/src/main/java/io/deephaven/engine/table/impl/updateby/fill/CharFillByOperator.java");
        ...
        String objectResult = ReplicatePrimitiveCode.charToObject("engine/table/src/main/java/io/deephaven/engine/table/impl/updateby/fill/CharFillByOperator.java");
        ...
        files = ReplicatePrimitiveCode.charToAllButBooleanAndFloats("engine/table/src/main/java/io/deephaven/engine/table/impl/updateby/internal/BaseCharUpdateByOperator.java", exemptions);
        for(final String f : files) {
            if(f.contains("Int")) {
                fixupInteger(f);
            }
        ...
        objectResult = ReplicatePrimitiveCode.charToObject("engine/table/src/main/java/io/deephaven/engine/table/impl/updateby/internal/BaseCharUpdateByOperator.java");
        fixupStandardObject(objectResult, "BaseObjectUpdateByOperator", true);
        ReplicatePrimitiveCode.floatToAllFloatingPoints("engine/table/src/main/java/io/deephaven/engine/table/impl/updateby/internal/BaseFloatUpdateByOperator.java", exemptions);

        replicateNumericOperator("engine/table/src/main/java/io/deephaven/engine/table/impl/updateby/sum/ShortCumSumOperator.java", "engine/table/src/main/java/io/deephaven/engine/table/impl/updateby/sum/FloatCumSumOperator.java");
        replicateNumericOperator("engine/table/src/main/java/io/deephaven/engine/table/impl/updateby/minmax/ShortCumMinMaxOperator.java", "engine/table/src/main/java/io/deephaven/engine/table/impl/updateby/minmax/FloatCumMinMaxOperator.java");
        replicateNumericOperator("engine/table/src/main/java/io/deephaven/engine/table/impl/updateby/prod/ShortCumProdOperator.java", "engine/table/src/main/java/io/deephaven/engine/table/impl/updateby/prod/FloatCumProdOperator.java");
        replicateNumericOperator("engine/table/src/main/java/io/deephaven/engine/table/impl/updateby/ema/ShortEMAOperator.java", "engine/table/src/main/java/io/deephaven/engine/table/impl/updateby/ema/FloatEMAOperator.java");
    }

    private static void replicateNumericOperator(@NotNull final String shortClass, @NotNull final String floatClass) throws IOException {
    ...
    private static void fixupByteBase(String byteResult) throws IOException {
        ...
        lines = replaceRegion(lines, "constructor", Collections.singletonList("        this.nullValue = getNullValue();"));
    ...
    private static void fixupByte(String byteResult) throws IOException {
        ...
        List<String> lines = FileUtils.readLines(objectFile, Charset.defaultCharset());
        lines = replaceRegion(lines, "extra-fields", Collections.singletonList("    final byte nullValue;"));
        lines = replaceRegion(lines, "extra-constructor-args", Collections.singletonList("                               ,final byte nullValue"));
    ...
    private static void fixupStandardObject(String objectResult, final String className, boolean augmentConstructorAndFields,
        ...
        lines = ReplicationUtils.replaceRegion(lines, "extra-constructor-args", Collections.singletonList("                                      , final Class<T> colType"));
        if(augmentConstructorAndFields) {
            lines = ReplicationUtils.replaceRegion(lines, "extra-fields", Collections.singletonList("    private final Class<T> colType;"));
            lines = ReplicationUtils.replaceRegion(lines, "constructor", Collections.singletonList("        this.colType = colType;"));
        }
        FileUtils.writeLines(objectFile, lines);
    }
