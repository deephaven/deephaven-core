...
public class TupleSourceCodeGenerator {
    ...
    enum ColumnSourceType {
        ...
        R_DATETIME("ReinterpretedDateTime", "long",                              null,         null,  true,                                 CS + ".getLong("    + IK + ")" ,                                 CS + ".getPrevLong("    + IK + ")" , "DateTimeUtil.nanosToTime("   + VAL + ')', "DateTimeUtil.nanos("            + VAL + ')', "(DateTime)"  + VAL, "io.deephaven.util.type.TypeUtils", "io.deephaven.engine.time.DateTime", "io.deephaven.engine.time.DateTimeUtil"),
          DATETIME(             "DateTime", "io.deephaven.engine.time.DateTime", "long", R_DATETIME, false,         "DateTimeUtil.nanos(" + CS + ".get("        + IK + "))",         "DateTimeUtil.nanos(" + CS + ".getPrev("        + IK + "))", "DateTimeUtil.nanosToTime("   + VAL + ')', "DateTimeUtil.nanos("            + VAL + ')', "(DateTime)"  + VAL, "io.deephaven.engine.time.DateTime","io.deephaven.engine.time.DateTimeUtil"                                     ),
        ;
        // @formatter:on
