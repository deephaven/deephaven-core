...
public class TupleCodeGenerator {
    ...
    private enum ElementType {
        ...
        // @formatter:off
          ...
          FLOAT(  "Float",   float.class, "FloatComparisons.eq(" + LHS + ", " + RHS + ")"   ,     "Float.hashCode(" + VAL + ")", "FloatComparisons.compare("  + LHS + ", " + RHS + ")", OUT + ".writeFloat("  + VAL + ')', IN + ".readFloat()" , "io.deephaven.util.compare.FloatComparisons"                      ),
         DOUBLE( "Double",  double.class, "DoubleComparisons.eq(" + LHS + ", " + RHS + ")"  ,    "Double.hashCode(" + VAL + ")", "DoubleComparisons.compare(" + LHS + ", " + RHS + ")", OUT + ".writeDouble(" + VAL + ')', IN + ".readDouble()", "io.deephaven.util.compare.DoubleComparisons"                     ),
