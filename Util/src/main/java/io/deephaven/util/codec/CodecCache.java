...
public enum CodecCache {
     ...
     * @throws CodecCacheException If an error occurred while instantiating the named codec class from the supplied arguments
     */
    public synchronized <TYPE> ObjectCodec<TYPE> getCodec(@NotNull final String className,
        ...
        return (ObjectCodec<TYPE>) items
                ...
                .computeIfAbsent(arguments, (a) -> new Item(className, a))
                .codec;
    }
