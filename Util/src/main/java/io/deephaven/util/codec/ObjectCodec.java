...
/**
 * <p>Codec interface for Object translation to/from byte arrays for serialization and deserialization.
...
public interface ObjectCodec<TYPE> extends ObjectDecoder<TYPE> {
     ...
     * (e.g. {@link io.deephaven.datastructures.util.CollectionUtil#ZERO_LENGTH_BYTE_ARRAY}) is strongly encouraged.
     *
    ...
    /**
     * If applicable, the maximum encodable precision. If precision is not applicable (i.e. for non-numeric types)
    ...
    /**
     * If applicable, the maximum encodable scale. If scale is not applicable (i.e. for non-numeric types)
     * this method should return zero.
     *
