...
public class EncodingUtil {
     ...
     * present within a file of the specified encoding.  This is intended for use with {@link org.apache.commons.io.input.BOMInputStream}
     *
     ...
     *
     * @param destination a ByteBuffer in which to encode the string. The buffer must be big enough for the encoded string.
     ...
     * The buffer must be positioned at the start of the encoding, which is an int length followed by the UTF-8 encoded bytes.
     * The buffer is advanced to the end of the string.
     *
