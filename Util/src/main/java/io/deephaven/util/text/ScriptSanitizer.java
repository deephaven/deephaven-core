...
public class ScriptSanitizer {
    /**
     * Replaces unwanted characters like smart quotes with the standard equivalent. Used so that
     * copy and paste operations from tools like Outlook or Slack don't result in unusable scripts.
     *
