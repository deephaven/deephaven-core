...
public class TestThreadSafeLenientFixedSizePool extends TestCase {
    ...
    public void testThreadSafeLenientFixedSizePool() {
        ...
        Pool<Object> pool= io.deephaven.base.pool.ThreadSafeLenientFixedSizePool.FACTORY.create(OBJECTS.length, m_mockObjectFactory, m_mockClearingProcedure);
    ...
    public void testThreadSafeLenientFixedSizePoolNoClearingProcedure() {
        ...
        // create pool
        for (Object object : OBJECTS) { m_mockObjectFactory.add(object); }
        Pool<Object> pool= io.deephaven.base.pool.ThreadSafeLenientFixedSizePool.FACTORY.create(OBJECTS.length, m_mockObjectFactory, null);
        assertEquals("call()call()call()call()call()call()call()call()call()call()call()call()call()call()", m_mockObjectFactory.getActivityRecordAndReset());
    ...
    public void testThreadSafeLenientFixedSizePoolNoFactory() {
        ...
        try {
            new io.deephaven.base.pool.ThreadSafeLenientFixedSizePool<Object>(OBJECTS.length, (Function.Unary<Object, io.deephaven.base.pool.ThreadSafeLenientFixedSizePool<Object>>)null, m_mockClearingProcedure);
...
//            assertTrue(requirementFailure.isThisStackFrameCulprit(0));
        ...
        // too small
        try {
            new io.deephaven.base.pool.ThreadSafeLenientFixedSizePool<Object>(6, m_mockObjectFactory, m_mockClearingProcedure);
        } catch (RequirementFailure requirementFailure) {
            assertTrue(requirementFailure.isThisStackFrameCulprit(0));
        }
        ...
        // no factory
        try {
            io.deephaven.base.pool.ThreadSafeLenientFixedSizePool.FACTORY.create(OBJECTS.length, null, m_mockClearingProcedure);
        } catch (RequirementFailure requirementFailure) {
            assertTrue(requirementFailure.isThisStackFrameCulprit(0));
        }
        ...
        // too small
        try {
            io.deephaven.base.pool.ThreadSafeLenientFixedSizePool.FACTORY.create(6, m_mockObjectFactory, m_mockClearingProcedure);
        } catch (RequirementFailure requirementFailure) {
            assertTrue(requirementFailure.isThisStackFrameCulprit(0));
        }
