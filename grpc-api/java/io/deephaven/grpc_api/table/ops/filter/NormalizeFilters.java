 ...
 */
public class NormalizeFilters implements FilterVisitor<Condition> {
    public static final NormalizeFilters INSTANCE = new NormalizeFilters();
    ...
    public Condition onComparison(CompareCondition.CompareOperation operation, Value lhs, Value rhs) {
        return NormalizeFilterUtil.doComparison(operation, lhs, rhs);
    }
    ...
    public static Condition exec(Condition filter) {
        return FilterVisitor.accept(filter, NormalizeFilters.INSTANCE);
    }
}
 ...
 * </ul>
 */
class NormalizeInvertedFilters implements FilterVisitor<Condition> {
    public static final NormalizeInvertedFilters INSTANCE = new NormalizeInvertedFilters();
    ...
    public Condition onNot(Condition filter) {
        ...
        return NormalizeFilterUtil.doNot(filter, NormalizeFilters.INSTANCE);
    }
