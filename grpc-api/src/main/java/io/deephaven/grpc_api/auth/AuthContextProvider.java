...
/**
 * The AuthContextProvider's job is to manage all authentication and authorization responsibilities. If audit
 * logging is required, an implementation of this (and its companion AuthContext) is the correct way path forward.
 */
