...
public class ExportTableUpdateListenerTest {
    ...
    public void testLifeCycleStaticTable() {
        ...
        final QueryTable src = TstUtils.testTable(RowSetFactoryImpl.INSTANCE.getFlatRowSet(100));
    ...
    public void testRefreshStaticTable() {
        // create and export the table
        final QueryTable src = TstUtils.testTable(RowSetFactoryImpl.INSTANCE.getFlatRowSet(1024));
        final SessionState.ExportObject<QueryTable> t1 = session.newServerSideExport(src);
    ...
    public void testLifeCycleTickingTable() {
        ...
        // create and export the table
        final QueryTable src = TstUtils.testRefreshingTable(RowSetFactoryImpl.INSTANCE.getFlatRowSet(42));
