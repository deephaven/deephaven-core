        ...
        assertFilterEquals("flip various leaf expressions",
            not(or(
                ...
                compare(CompareCondition.CompareOperation.LESS_THAN_OR_EQUAL, reference("ColumnA"),
                    reference("ColumnB")),
                compare(CompareCondition.CompareOperation.GREATER_THAN_OR_EQUAL,
                    reference("ColumnA"), reference("ColumnB")),
                compare(CompareCondition.CompareOperation.EQUALS, reference("ColumnA"),
                    reference("ColumnB")),
                ...
                NormalizeFilterUtil.doContains(
                    Reference.newBuilder().setColumnName("ColumnA").build(), "asdf",
