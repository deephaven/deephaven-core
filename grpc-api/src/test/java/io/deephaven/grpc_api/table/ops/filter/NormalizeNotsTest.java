...
public class NormalizeNotsTest extends AbstractNormalizingFilterTest {
    ...
    public void testNormalizeNots() {
        ...
        assertFilterEquals("two nots within a tree",
                not(and(
                        not(or(
                                invoke("methodA", reference("ColumnA")),//invoke used since it can't be rewritten to handle a NOT
        ...
        assertFilterEquals("flip various leaf expressions",
                not(or(
                        compare(CompareCondition.CompareOperation.LESS_THAN, reference("ColumnA"), reference("ColumnB")),
                        compare(CompareCondition.CompareOperation.GREATER_THAN, reference("ColumnA"), reference("ColumnB")),
                        compare(CompareCondition.CompareOperation.LESS_THAN_OR_EQUAL, reference("ColumnA"), reference("ColumnB")),
                        compare(CompareCondition.CompareOperation.GREATER_THAN_OR_EQUAL, reference("ColumnA"), reference("ColumnB")),
                        compare(CompareCondition.CompareOperation.EQUALS, reference("ColumnA"), reference("ColumnB")),
                        compare(CompareCondition.CompareOperation.EQUALS, CaseSensitivity.IGNORE_CASE, reference("ColumnA"), reference("ColumnB")),
                        compare(CompareCondition.CompareOperation.NOT_EQUALS, reference("ColumnA"), reference("ColumnB")),
                        compare(CompareCondition.CompareOperation.NOT_EQUALS, CaseSensitivity.IGNORE_CASE, reference("ColumnA"), reference("ColumnB")),
                        ...
                        NormalizeFilterUtil.doContains(Reference.newBuilder().setColumnName("ColumnA").build(), "asdf", CaseSensitivity.MATCH_CASE, MatchType.REGULAR))),
                and(
                        compare(CompareCondition.CompareOperation.GREATER_THAN_OR_EQUAL, reference("ColumnA"), reference("ColumnB")),
                        compare(CompareCondition.CompareOperation.LESS_THAN_OR_EQUAL, reference("ColumnA"), reference("ColumnB")),
                        compare(CompareCondition.CompareOperation.GREATER_THAN, reference("ColumnA"), reference("ColumnB")),
                        ...
                        in(reference("ColumnA"), reference("ColumnB")),
                        inICase(reference("ColumnA"), reference("ColumnB")),
                        NormalizeFilterUtil.doContains(Reference.newBuilder().setColumnName("ColumnA").build(), "asdf", CaseSensitivity.MATCH_CASE, MatchType.INVERTED)
                )
        );
    }
