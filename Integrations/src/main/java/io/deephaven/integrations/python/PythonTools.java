...
public class PythonTools {
     ...
     *
     * @param map the map to convert to function; the caller gives up ownership to the returned
     *        object
     ...
     */
    @SuppressWarnings("unused")
    public static Function<String, String> functionFromMapWithIdentityDefaults(
        final Map<String, String> map) {
