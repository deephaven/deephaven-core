...
public class PythonFunction<T> implements Function<T, Object> {
     ...
     *                 only really useful if `classOut` is one of String, double, float, long, int, short, byte, or
     *                 boolean. Otherwise, the return element will likely just remain PyObject, and not be particularly
     *                 usable inside Java.
     */
