 ...
 * This is specifically intended to improve performance in integration with Python, where conversion of primitive
 * type arrays involves direct copy of a memory buffer, and is much more performant than element-by-element inspection.
 */
public class PrimitiveArrayConversionUtility{
    /**
     * Translates a java.lang.Boolean array to a byte array. The mapping will be performed as
     * null -> -1, false -> 0, and true -> 1. This is the (psuedo)inverse of `translateArrayByteToBoolean`.
     *
    ...
    /**
     * Translates a byte array to a Boolean array. The mapping will be performed as
     * <0 -> null, 0 -> false, >0 -> true. This is the (psuedo)inverse of `translateArrayBooleanToByte`.
     *
