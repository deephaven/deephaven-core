...
DBTimeZone = None  #: Deephaven timezone class (io.deephaven.engine.tables.utils.TimeZone).
DateTime = None  #: Deephaven date-time class (io.deephaven.engine.tables.utils.DateTime).
Period = None    #: Deephaven time period class (io.deephaven.engine.tables.utils.Period).
...
def _defineSymbols():
    ...
    _java_type_ = jpy.get_type("io.deephaven.engine.tables.utils.DateTimeUtils")
    DBTimeZone = jpy.get_type("io.deephaven.engine.tables.utils.TimeZone")
    DateTime = jpy.get_type("io.deephaven.engine.tables.utils.DateTime")
    Period = jpy.get_type("io.deephaven.engine.tables.utils.Period")
...
def autoEpochToTime(epoch):
    """
    Converts a long offset from Epoch value to a DateTime. This method uses expected date ranges to infer
    ...
    :param epoch: (long) - The long Epoch offset value to convert.
    :return: (io.deephaven.engine.tables.utils.DateTime) null, if the input is equal to QueryConstants.NULL_LONG, otherwise a DateTime based on
...
def cappedTimeOffset(original, period, cap):
    ...
    :param cap: (io.deephaven.engine.tables.utils.DateTime) - A DateTime value to use as the maximum return value.
    :return: (io.deephaven.engine.tables.utils.DateTime) a null DateTime if either original or period are null; the starting DateTime plus the
...
def convertDateQuiet(*args):
    ...
    *Overload 2*  
      ...
      :param dateStyle: (io.deephaven.engine.tables.utils.DateTimeUtils.DateStyle) - indicates how to interpret slash-delimited dates
...
def convertDateTimeQuiet(s):
    ...
    :param s: (java.lang.String) - String to be converted, usually in the form yyyy-MM-ddThh:mm:ss and with optional sub-seconds after an
            optional decimal point, followed by a mandatory time zone character code
    :return: (io.deephaven.engine.tables.utils.DateTime) A DateTime from the parsed String, or null if the format is not recognized or an exception occurs
    """
...
def convertPeriod(s):
    """
    Converts a String into a Period object.
    ...
    :param s: (java.lang.String) - The String to convert in the form of numbertype, e.g. 1W for one week, and Tnumbertype for times, e.g.
            T1M for one minute.
    :return: io.deephaven.engine.tables.utils.Period
    """
...
def convertPeriodQuiet(s):
    ...
    :param s: (java.lang.String) - The String to convert in the form of numbertype, e.g. 1W for one week, and Tnumbertype for times, e.g.
            T1M for one minute.
    :return: (io.deephaven.engine.tables.utils.Period) null if the String cannot be parsed, otherwise a Period object.
    """
...
def currentDate(timeZone):
    ...
    :param timeZone: (io.deephaven.engine.tables.utils.TimeZone) - The TimeZone to reference when evaluating the current date for "now".
...
def currentTime():
    ...
    :return: (io.deephaven.engine.tables.utils.DateTime) A DateTime of the current date and time from the system or from the configured alternate time
             provider.
    """
...
def dayOfMonth(dateTime, timeZone):
    ...
    :param dateTime: (io.deephaven.engine.tables.utils.DateTime) - The DateTime for which to find the day of the month.
...
def dayOfYear(dateTime, timeZone):
    ...
    :param dateTime: (io.deephaven.engine.tables.utils.DateTime) - The DateTime for which to find the day of the year.
    :param timeZone: (io.deephaven.engine.tables.utils.TimeZone) - The TimeZone to use when interpreting the date/time.
...
def diffDay(start, end):
    ...
    :param start: (io.deephaven.engine.tables.utils.DateTime) - The first DateTime.
...
def format(*args):
    ...
    *Overload 1*  
      :param dateTime: (io.deephaven.engine.tables.utils.DateTime) - The DateTime to format as a String.
      :param timeZone: (io.deephaven.engine.tables.utils.TimeZone) - The TimeZone to use when formatting the String.
...
def getExcelDateTime(*args):
    ...
    *Overload 1*  
      :param dateTime: (io.deephaven.engine.tables.utils.DateTime) - The DateTime to convert.
      :param timeZone: (io.deephaven.engine.tables.utils.TimeZone) - The TimeZone to use when interpreting the date/time.
...
def getZonedDateTime(*args):
    ...
    *Overload 1*  
      :param dateTime: (io.deephaven.engine.tables.utils.DateTime) - The a DateTime to convert.
      :return: (java.time.ZonedDateTime) A ZonedDateTime using the default time zone for the session as indicated by
               TimeZone.TZ_DEFAULT.
      
    *Overload 2*  
      :param dateTime: (io.deephaven.engine.tables.utils.DateTime) - The a DateTime to convert.
      :param timeZone: (io.deephaven.engine.tables.utils.TimeZone) - The TimeZone to use for the conversion.
...
def isAfter(d1, d2):
    ...
    :param d1: (io.deephaven.engine.tables.utils.DateTime) - The first DateTime value to compare.
    :param d2: (io.deephaven.engine.tables.utils.DateTime) - The second DateTime value to compare.
...
def lowerBin(*args):
    ...
    *Overload 1*  
      :param dateTime: (io.deephaven.engine.tables.utils.DateTime) - The DateTime for which to evaluate the start of the containing window.
      :param intervalNanos: (long) - The size of the window in nanoseconds.
      :return: (io.deephaven.engine.tables.utils.DateTime) Null if either input is null, otherwise a DateTime representing the start of the window.
...
def microsToTime(micros):
    ...
    :return: (io.deephaven.engine.tables.utils.DateTime) QueryConstants.NULL_LONG if the input is null, otherwise, a DateTime representation of
             the input.
    """
...
def millis(dateTime):
    ...
    :param dateTime: (io.deephaven.engine.tables.utils.DateTime) - The DateTime for which the milliseconds offset should be returned.
...
def millisOfDay(dateTime, timeZone):
    ...
    :param dateTime: (io.deephaven.engine.tables.utils.DateTime) - The DateTime for which to find the milliseconds since midnight.
    :param timeZone: (io.deephaven.engine.tables.utils.TimeZone) - The TimeZone to use when interpreting the date/time.
...
def millisToDateAtMidnight(millis, timeZone):
    ...
    :param millis: (long) - A long value of the number of milliseconds from Epoch for which the DateTime is to be
            calculated.
    :param timeZone: (io.deephaven.engine.tables.utils.TimeZone) - TimeZone for which the new value at midnight should be calculated.
    :return: (io.deephaven.engine.tables.utils.DateTime) A DateTime rounded down to midnight in the selected time zone for the specified number of
             milliseconds from Epoch.
    """
...
def millisToDateAtMidnightNy(millis):
    """
    Returns a DateTime representing midnight in New York time zone on the date specified by the a number of
     milliseconds from Epoch.
    
    :param millis: (long) - A long value of the number of milliseconds from Epoch for which the DateTime is to be
            calculated.
    :return: (io.deephaven.engine.tables.utils.DateTime) A DateTime rounded down to midnight in the New York time zone for the specified number of
             milliseconds from Epoch.
    """
...
def minuteOfDay(dateTime, timeZone):
    ...
    :param dateTime: (io.deephaven.engine.tables.utils.DateTime) - The DateTime for which to find the minutes.
    :param timeZone: (io.deephaven.engine.tables.utils.TimeZone) - The TimeZone to use when interpreting the date/time.
...
def nanos(*args):
    ...
    *Overload 1*  
      :param dateTime: (io.deephaven.engine.tables.utils.DateTime) - The DateTime for which the nanoseconds offset should be returned.
...
def nanosOfDay(dateTime, timeZone):
    ...
    :param dateTime: (io.deephaven.engine.tables.utils.DateTime) - The DateTime for which to find the nanoseconds since midnight.
    :param timeZone: (io.deephaven.engine.tables.utils.TimeZone) - The TimeZone to use when interpreting the date/time.
...
def nanosToTime(nanos):
    ...
    :return: (io.deephaven.engine.tables.utils.DateTime) A DateTime for nanos, or null if nanos is equal to
             NULL_LONG.
    """
...
def upperBin(*args):
    ...
    *Overload 1*  
      :param dateTime: (io.deephaven.engine.tables.utils.DateTime) - The DateTime for which to evaluate the end of the containing window.
      :param intervalNanos: (long) - The size of the window in nanoseconds.
      :return: (io.deephaven.engine.tables.utils.DateTime) Null if either input is null, otherwise a DateTime representing the end of the window.
...
def year(dateTime, timeZone):
    ...
    :param dateTime: (io.deephaven.engine.tables.utils.DateTime) - The DateTime for which to find the year.
    :param timeZone: (io.deephaven.engine.tables.utils.TimeZone) - The TimeZone to use when interpreting the date/time.
