...
"""
The AggregationFactory combines one or more aggregations into an operator for use with
 Table.groupBy(AggregationSpec).

 
 The intended use of this class is to call the AggCombo(AggregationElement...) method with a set of aggregations defined
 by:
...
def _defineSymbols():
    ...
    if _java_type_ is None:
        ...
        _java_type_ = jpy.get_type("io.deephaven.engine.table.impl.groupBy.AggregationFactory")
...
def Agg(*args):
    ...
    *Overload 1*  
      :param factory: (io.deephaven.engine.table.impl.groupBy.AggregationSpec) - aggregation factory.
      ...
      :return: (io.deephaven.engine.table.impl.groupBy.AggregationFactory.AggregationElement) a AggregationElement object suitable for passing to AggCombo(AggregationElement...)
    ...
    *Overload 3*  
      :param factoryType: (io.deephaven.engine.table.impl.groupBy.AggType) - aggregation factory type.
      :param matchPairs: (java.lang.String...) - the columns to apply the aggregation to in the form Output=Input, if the Output and Input have
              the same name, then the column name can be specified.
      :return: (io.deephaven.engine.table.impl.groupBy.AggregationFactory.AggregationElement) a AggregationElement object suitable for passing to AggCombo(AggregationElement...)
...
def AggCombo(*aggregations):
    """
    Create a new AggregationFactory suitable for passing to Table.groupBy(AggregationSpec, String...).
    
    :param aggregations: (io.deephaven.engine.table.impl.groupBy.AggregationFactory.AggregationElement...) - the aggregations to compute
    :return: (io.deephaven.engine.table.impl.groupBy.AggregationFactory) a new table with the specified aggregations.
    """
...
def AggCountDistinct(*args):
    ...
    *Overload 1*  
      :param matchPairs: (java.lang.String...) - the columns to apply the aggregation to in the form Output=Input, if the Output and Input have
              the same name, then the column name can be specified.
      :return: (io.deephaven.engine.table.impl.groupBy.AggregationFactory.AggregationElement) a AggregationElement object suitable for passing to AggCombo(AggregationElement...). Null values are not counted.
...
def AggDistinct(*args):
    ...
    *Overload 1*  
      :param matchPairs: (java.lang.String...) - the columns to apply the aggregation to in the form Output=Input, if the Output and Input have
              the same name, then the column name can be specified.
      :return: (io.deephaven.engine.table.impl.groupBy.AggregationFactory.AggregationElement) a AggregationElement object suitable for passing to AggCombo(AggregationElement...). Null values are ignored.
...
def AggUnique(*args):
    ...
    *Overload 2*  
      ...
      :param matchPairs: (java.lang.String...) - the columns to apply the aggregation to in the form Output=Input, if the Output and Input have
              the same name, then the column name can be specified.
      :return: (io.deephaven.engine.table.impl.groupBy.AggregationFactory.AggregationElement) a AggregationElement object suitable for passing to AggCombo(AggregationElement...). Output columns contain null if
