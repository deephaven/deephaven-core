...
def _defineSymbols():
    ...
    if _java_type_ is None:
        ...
        _java_type_ = jpy.get_type("io.deephaven.engine.v2.groupBy.AggregationFactory")
...
def AggCombo(*aggregations):
    ...
    :param aggregations: (io.deephaven.engine.v2.groupBy.AggregationFactory.AggregationElement...) - the aggregations to compute
    :return: (io.deephaven.engine.v2.groupBy.AggregationFactory) a new table with the specified aggregations.
    """
...
def AggCountDistinct(*args):
    ...
    *Overload 1*  
      :param matchPairs: (java.lang.String...) - the columns to apply the aggregation to in the form Output=Input, if the Output and Input have
              the same name, then the column name can be specified.
      :return: (io.deephaven.engine.v2.groupBy.AggregationFactory.AggregationElement) a AggregationElement object suitable for passing to AggCombo(AggregationElement...). Null values are not counted.
...
def AggDistinct(*args):
    ...
    *Overload 1*  
      :param matchPairs: (java.lang.String...) - the columns to apply the aggregation to in the form Output=Input, if the Output and Input have
              the same name, then the column name can be specified.
      :return: (io.deephaven.engine.v2.groupBy.AggregationFactory.AggregationElement) a AggregationElement object suitable for passing to AggCombo(AggregationElement...). Null values are ignored.
...
def AggUnique(*args):
    ...
    *Overload 2*  
      ...
      :param matchPairs: (java.lang.String...) - the columns to apply the aggregation to in the form Output=Input, if the Output and Input have
              the same name, then the column name can be specified.
      :return: (io.deephaven.engine.v2.groupBy.AggregationFactory.AggregationElement) a AggregationElement object suitable for passing to AggCombo(AggregationElement...). Output columns contain null if
