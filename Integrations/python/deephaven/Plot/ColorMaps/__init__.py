...
def _defineSymbols():
    ...
    if _java_type_ is None:
        ...
        _java_type_ = jpy.get_type("io.deephaven.engine.plot.colors.ColorMaps")
...
def predicateMap(*args):
    ...
    *Overload 1*  
      ...
      :param map: (java.util.Map<io.deephaven.engine.plot.colors.ColorMaps.SerializablePredicate<java.lang.Double>,COLOR>) - map from ColorMaps.SerializablePredicate to color
