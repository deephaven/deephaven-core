...
def _defineSymbols():
    ...
    if _plotting_convenience_ is None:
        ...
        _plotting_convenience_ = jpy.get_type("io.deephaven.engine.plot.PlottingConvenience")
        _figure_widget_ = jpy.get_type('io.deephaven.engine.plot.FigureWidget')
...
def _is_widget_(obj):
    ...
    cond = False
    try:
        cond = getJavaClassObject('io.deephaven.engine.plot.FigureWidget').isAssignableFrom(obj)
    except Exception:
        pass
    return cond
...
class FigureWrapper(object):
    ...
    def axes(self, *args):
        ...
        *Overload 1*  
          ...
          :return: (io.deephaven.engine.plot.Figure) selected axes.
    ...
    def axesRemoveSeries(self, *names):
        ...
        :return: (io.deephaven.engine.plot.Figure) this Chart
        """
    ...
    def axis(self, dim):
        ...
        :return: (io.deephaven.engine.plot.Figure) Axis at dimension dim
        """
    ...
    def axisColor(self, color):
        ...
        *Overload 1*  
          ...
          :return: (io.deephaven.engine.plot.Figure) this Axis
    ...
    def axisFormat(self, format):
        ...
        :param format: (io.deephaven.engine.plot.axisformatters.AxisFormat) - axis format
        :return: (io.deephaven.engine.plot.Figure) this Axis
        """
    ...
    def axisLabelFont(self, *args):
        ...
        *Overload 1*  
          :param font: (io.deephaven.engine.plot.Font) - font
          :return: (io.deephaven.engine.plot.Figure) this Axis
    ...
    def businessTime(self, *args):
        ...
        *Overload 1*  
          :return: (io.deephaven.engine.plot.Figure) this Axis using the default business calendar.
          
        *Overload 2*  
          :param calendar: (io.deephaven.util.calendar.BusinessCalendar) - business calendar of the AxisTransformBusinessCalendar
          :return: (io.deephaven.engine.plot.Figure) this Axis using the specified business calendar.
          
        *Overload 3*  
          :param sds: (io.deephaven.engine.plot.filters.SelectableDataSet) - selectable data set (e.g. OneClick filterable table) containing the business calendar.
          :param valueColumn: (java.lang.String) - name of a column containing String values, where each value is the name of a
                  BusinessCalendar.
          :return: (io.deephaven.engine.plot.Figure) this Axis using the business calendar from row 0 of the filtered sds for the business calendar.
    ...
    def catErrorBar(self, *args):
        ...
        *Overload 6*  
          ...
          :param seriesName: (java.lang.Comparable) - name of the created dataset
          :param categories: (T0[]) - discrete data
          :param values: (io.deephaven.engine.tables.utils.DBDateTime[]) - numeric data
          :param yLow: (io.deephaven.engine.tables.utils.DBDateTime[]) - low value in y dimension
          :param yHigh: (io.deephaven.engine.tables.utils.DBDateTime[]) - high value in y dimension
          :return: (io.deephaven.engine.plot.Figure) dataset created by the plot
        ...
        *Overload 17*  
          :param seriesName: (java.lang.Comparable) - name of the created dataset
          :param sds: (io.deephaven.engine.plot.filters.SelectableDataSet) - selectable dataset (e.g. OneClick filterable table).
    ...
    def catHistPlot(self, *args):
        ...
        *Overload 7*  
          :param seriesName: (java.lang.Comparable) - name of the created dataset
          :param sds: (io.deephaven.engine.plot.filters.SelectableDataSet) - selectable data set (e.g. OneClick filterable table)
    ...
    def catPlot(self, *args):
        ...
        *Overload 10*  
          ...
          :param seriesName: (java.lang.Comparable) - name of the created dataset
          :param categories: (io.deephaven.engine.plot.datasets.data.IndexableData<T1>) - discrete data
          :param values: (io.deephaven.engine.plot.datasets.data.IndexableNumericData) - numeric data
          :return: (io.deephaven.engine.plot.Figure) dataset created for plot
    ...
    def chartTitle(self, *args):
        ...
        *Overload 2*  
          :param sds: (io.deephaven.engine.plot.filters.SelectableDataSet) - selectable data set (e.g. OneClick table)
    ...
    def errorBarX(self, *args):
        ...
        *Overload 2*  
          ...
          :param xLow: (T1[]) - low value in x dimension
          :param xHigh: (T2[]) - high value in x dimension
          :param y: (io.deephaven.engine.tables.utils.DBDateTime[]) - y-values
          :return: (io.deephaven.engine.plot.Figure) dataset created by the plot
        ...
        *Overload 16*  
          ...
          :param seriesName: (java.lang.Comparable) - name of the created dataset
          :param x: (io.deephaven.engine.tables.utils.DBDateTime[]) - x-values
          :param xLow: (io.deephaven.engine.tables.utils.DBDateTime[]) - low value in x dimension
          :param xHigh: (io.deephaven.engine.tables.utils.DBDateTime[]) - high value in x dimension
          :param y: (T3[]) - y-values
          :return: (io.deephaven.engine.plot.Figure) dataset created by the plot
    ...
    def figureRemoveSeries(self, *names):
        ...
        :param names: (java.lang.String...) - series names
        :return: (io.deephaven.engine.plot.Figure) this Figure
        """
    ...
    def funcNPoints(self, npoints):
        ...
        :return: (io.deephaven.engine.plot.Figure) this data series with the specified number of points.
        """
    ...
    def funcRange(self, *args):
        ...
        *Overload 1*  
          ...
          :return: (io.deephaven.engine.plot.Figure) this data series with the new range
    ...
    def invert(self, *args):
        ...
        *Overload 1*  
          :return: (io.deephaven.engine.plot.Figure) this Axes
    ...
    def lineStyle(self, *args):
        ...
        *Overload 1*  
          :param style: (io.deephaven.engine.plot.LineStyle) - style
          :return: (io.deephaven.engine.plot.Figure) this data series.
          
        *Overload 2*  
          :param style: io.deephaven.engine.plot.LineStyle
          :param keys: java.lang.Object...
          :return: io.deephaven.engine.plot.Figure
        """
    ...
    def max(self, *args):
        ...
        *Overload 2*  
          :param sds: (io.deephaven.engine.plot.filters.SelectableDataSet) - selectable dataset
    ...
    def newAxes(self, *args):
        ...
        *Overload 1*  
          :return: (io.deephaven.engine.plot.Figure) newly created Axes with dimension 2 on this Chart
        ...
        *Overload 3*  
          ...
          :return: (io.deephaven.engine.plot.Figure) newly created Axes with dimension dim on this Chart
    ...
    def newChart(self, *args):
        ...
        *Overload 1*  
          :return: (io.deephaven.engine.plot.Figure) the new Chart. The Chart is placed in the next available grid space, starting at the
    ...
    def ohlcPlot(self, *args):
        ...
        *Overload 1*  
          :param seriesName: (java.lang.Comparable) - name of the created dataset
          :param time: (io.deephaven.engine.tables.utils.DBDateTime[]) - time data
        ...
        *Overload 15*  
          :param seriesName: (java.lang.Comparable) - name of the created dataset
          :param time: (io.deephaven.engine.plot.datasets.data.IndexableNumericData) - time data
          :param open: (io.deephaven.engine.plot.datasets.data.IndexableNumericData) - open data
          :param high: (io.deephaven.engine.plot.datasets.data.IndexableNumericData) - high data
          :param low: (io.deephaven.engine.plot.datasets.data.IndexableNumericData) - low data
          :param close: (io.deephaven.engine.plot.datasets.data.IndexableNumericData) - close data
          :return: (io.deephaven.engine.plot.Figure) dataset created for plot
    ...
    def piePlot(self, *args):
        ...
        *Overload 8*  
          ...
          :param seriesName: (java.lang.Comparable) - name of the created dataset
          :param categories: (io.deephaven.engine.plot.datasets.data.IndexableData<T1>) - categories
          :param values: (io.deephaven.engine.plot.datasets.data.IndexableNumericData) - data values
          :return: (io.deephaven.engine.plot.Figure) dataset created for plot
    ...
    def plot(self, *args):
        ...
        *Overload 86*  
          :param seriesName: (java.lang.Comparable) - name of the created dataset
          :param x: (io.deephaven.engine.plot.datasets.data.IndexableNumericData) - x-values
          :param y: (io.deephaven.engine.plot.datasets.data.IndexableNumericData) - y-values
    ...
    def plotStyle(self, style):
        ...
        *Overload 1*  
          :param style: (io.deephaven.engine.plot.PlotStyle) - style
          :return: (io.deephaven.engine.plot.Figure) this Axes
    ...
    def pointColor(self, *args):
        ...
        *Overload 5*  
          :param sds: (io.deephaven.engine.plot.filters.SelectableDataSet) - selectable data set (e.g. OneClick filterable table) containing colors
          :param columnName: (java.lang.String) - column in sds containing colors. The color data for point i comes from row i.
          :return: (io.deephaven.engine.plot.Figure) this XYDataSeries
          
        *Overload 6*  
          :param sds: io.deephaven.engine.plot.filters.SelectableDataSet
        ...
        *Overload 36*  
          ...
          :param colors: io.deephaven.engine.plot.datasets.data.IndexableData<T>
          :param keys: java.lang.Object...
          :return: io.deephaven.engine.plot.Figure
        """
    ...
    def pointColorInteger(self, *args):
        ...
        *Overload 2*  
          :param colors: io.deephaven.engine.plot.datasets.data.IndexableData<java.lang.Integer>
          :param keys: java.lang.Object...
          :return: io.deephaven.engine.plot.Figure
    ...
    def pointLabel(self, *args):
        ...
        *Overload 1*  
          :param labels: (io.deephaven.engine.plot.datasets.data.IndexableData<?>) - labels
          :return: (io.deephaven.engine.plot.Figure) this XYDataSeries
          
        *Overload 2*  
          :param labels: io.deephaven.engine.plot.datasets.data.IndexableData<?>
          :param keys: java.lang.Object...
          :return: io.deephaven.engine.plot.Figure
          
        *Overload 3*  
          :param sds: (io.deephaven.engine.plot.filters.SelectableDataSet) - selectable data set (e.g. OneClick filterable table) containing labels
    ...
    def pointShape(self, *args):
        ...
        *Overload 3*  
          :param shapes: (io.deephaven.engine.plot.datasets.data.IndexableData<java.lang.String>) - shapes
          :return: (io.deephaven.engine.plot.Figure) this XYDataSeries
          
        *Overload 4*  
          :param shapes: io.deephaven.engine.plot.datasets.data.IndexableData<java.lang.String>
          :param keys: java.lang.Object...
          :return: io.deephaven.engine.plot.Figure
          
        *Overload 5*  
          :param sds: (io.deephaven.engine.plot.filters.SelectableDataSet) - selectable data set (e.g. OneClick filterable table) containing shapes
    ...
    def pointSize(self, *args):
        ...
        *Overload 7*  
          :param factors: (io.deephaven.engine.plot.datasets.data.IndexableData<java.lang.Double>) - factors to multiply the default size (1) by
          :return: (io.deephaven.engine.plot.Figure) this XYDataSeries
          
        *Overload 8*  
          :param factors: io.deephaven.engine.plot.datasets.data.IndexableData<java.lang.Double>
          :param keys: java.lang.Object...
          :return: io.deephaven.engine.plot.Figure
          
        *Overload 9*  
          :param sds: (io.deephaven.engine.plot.filters.SelectableDataSet) - selectable data set (e.g. OneClick filterable table) containing factors to multiply the default size
                  (1) by
    ...
    def save(self, *args):
        ...
        *Overload 1*  
          ...
          :return: (io.deephaven.engine.plot.Figure) figure
    ...
    def series(self, *args):
        ...
        *Overload 1*  
          ...
          :return: (io.deephaven.engine.plot.Figure) selected data series.
    ...
    def transform(self, transform):
        ...
        :param transform: (io.deephaven.engine.plot.axistransformations.AxisTransform) - transform
        :return: (io.deephaven.engine.plot.Figure) this Axis
        """
    ...
    def twin(self, *args):
        ...
        *Overload 1*  
          :return: (io.deephaven.engine.plot.Figure) the new Axes instance.  The axes name will be equal to the string representation of the axes id.
          
        *Overload 2*  
          :param name: (java.lang.String) - Name for the axes
          :return: (io.deephaven.engine.plot.Figure) the new Axes instance
    ...
    def xAxis(self):
        ...
        :return: (io.deephaven.engine.plot.Figure) x-dimension Axis
        """
    ...
    def xBusinessTime(self, *args):
        ...
        *Overload 1*  
          :return: (io.deephaven.engine.plot.Figure) this Axes using the default BusinessCalendar for the x-Axis.
          
        *Overload 2*  
          :param calendar: (io.deephaven.util.calendar.BusinessCalendar) - business calendar for the AxisTransformBusinessCalendar
          :return: (io.deephaven.engine.plot.Figure) this Axes using the calendar for the x-Axis business calendar.
        ...
        *Overload 3*  
          ...
          :return: (io.deephaven.engine.plot.Figure) this Axes using the business calendar from row 0 of the filtered sds for the x-Axis business calendar.  If no value is found, no transform will be applied.
        """
    ...
    def xFormat(self, format):
        ...
        :param format: (io.deephaven.engine.plot.axisformatters.AxisFormat) - format
        :return: (io.deephaven.engine.plot.Figure) this Axes
        """
    ...
    def yAxis(self):
        ...
        :return: (io.deephaven.engine.plot.Figure) y-dimension Axis
        """
    ...
    def yBusinessTime(self, *args):
        ...
        *Overload 1*  
          :return: (io.deephaven.engine.plot.Figure) this Axes using the default BusinessCalendar for the y-Axis.
          
        *Overload 2*  
          :param calendar: (io.deephaven.util.calendar.BusinessCalendar) - business calendar for the AxisTransformBusinessCalendar
          :return: (io.deephaven.engine.plot.Figure) this Axes using the calendar for the y-Axis business calendar.
          
        *Overload 3*  
          :param sds: (io.deephaven.engine.plot.filters.SelectableDataSet) - selectable data set (e.g. OneClick filterable table) containing the business calendar.
          :param valueColumn: (java.lang.String) - name of a column containing String values, where each value is the name of a BusinessCalendar.
          :return: (io.deephaven.engine.plot.Figure) this Axes using the business calendar from row 0 of the filtered sds for the y-Axis business calendar.  If no value is found, no transform will be applied.
        """
