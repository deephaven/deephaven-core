...
class FigureWrapper(object):
    ...
    def businessTime(self, *args):
        ...
        *Overload 2*  
          :param calendar: (io.deephaven.engine.time.calendar.BusinessCalendar) - business calendar of the AxisTransformBusinessCalendar
    ...
    def xBusinessTime(self, *args):
        ...
        *Overload 2*  
          :param calendar: (io.deephaven.engine.time.calendar.BusinessCalendar) - business calendar for the AxisTransformBusinessCalendar
