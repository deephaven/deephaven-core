...
def _defineSymbols():
    ...
    if _java_type_ is None:
        ...
        _java_type_ = jpy.get_type("io.deephaven.engine.table.impl.by.AggregationFactory")
...
@_passThrough
def AggGroup(*matchPairs):
    """
    Create a group aggregation, equivalent to Table.groupBy(String...).
    ...
    return _java_type_.AggGroup(*matchPairs)
