...
def _defineSymbols():
    ...
    if _java_type_ is None:
        ...
        _java_type_ = jpy.get_type("io.deephaven.engine.time.calendar.Calendars")
...
def calendar(*args):
    ...
    *Overload 1*  
      ...
      :return: (io.deephaven.engine.time.calendar.BusinessCalendar) business calendar
      
    *Overload 2*  
      :return: (io.deephaven.engine.time.calendar.BusinessCalendar) default business calendar. The deault is specified by the Calendar.default property.
    """
