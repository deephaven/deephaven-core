...
LayoutHintBuilder = None        #: Builder class for use in assembling layout hints suitable for use with {@link io.deephaven.engine.tables.Table#layoutHints(LayoutHintBuilder)} or {@link io.deephaven.engine.tables.Table#layoutHints(String)} (io.deephaven.engine.table.LayoutHintBuilder).
...
def _defineSymbols():
    ...
    if ColumnRenderersBuilder is None:
        ...
        LayoutHintBuilder = jpy.get_type('io.deephaven.engine.table.LayoutHintBuilder')
        ...
        TotalsTableBuilder = jpy.get_type('io.deephaven.engine.v2.TotalsTableBuilder')
