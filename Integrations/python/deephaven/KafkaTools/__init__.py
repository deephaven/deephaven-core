...
def avro(schema, schema_version:str = None, mapping:dict = None, mapping_only:dict = None):
    ...
    :param mapping: A string to string mapping from Avro field name to Deephaven table column name;
    ...
    :param mapping_only: A string to string mapping from Avro field name to Deephaven table column name;
       the fields mentioned in the mapping will have their column names defined by it; any other
