...
def _defineSymbols():
    ...
    if _java_type_ is None:
        ...
        _java_type_ = jpy.get_type("io.deephaven.engine.v2.utils.TableLoggers")
...
def processInfoLog():
    ...
    :return: (io.deephaven.engine.v2.QueryTable) A table with process information for the current engine process.
    """
...
def processMemoryLog():
    ...
    :return: (io.deephaven.engine.v2.QueryTable) A table with memory and GC data.
    """
...
def processMetricsLog():
    ...
    :return: (io.deephaven.engine.v2.QueryTable) A table with metrics fopr the current engine process.
    """
...
def queryOperationPerformanceLog():
    ...
    :return: (io.deephaven.engine.v2.QueryTable) A table with subquery performance data.
    """
...
def queryPerformanceLog():
    ...
    :return: (io.deephaven.engine.v2.QueryTable) A table with query performance data.
    """
...
def updatePerformanceLog():
    ...
    :return: (io.deephaven.engine.v2.QueryTable) A table with update performance data.
    """
